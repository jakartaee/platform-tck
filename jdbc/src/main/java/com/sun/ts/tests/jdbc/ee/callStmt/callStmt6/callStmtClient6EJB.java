...
public class callStmtClient6EJB extends callStmtClient6 implements Serializable {
	...
	public static EnterpriseArchive createDeploymentEJB(@ArquillianResource TestArchiveProcessor archiveProcessor) throws IOException {
		...
		resURL = callStmtClient6EJB.class
				.getResource("/com/sun/ts/tests/jdbc/ee/callStmt/callStmt6/callStmt6_ejb_vehicle_client.jar.sun-application-client.xml");
		if (resURL != null) {
		...
		resURL = callStmtClient6EJB.class.getResource("/com/sun/ts/tests/jdbc/ee/callStmt/callStmt6/ejb_vehicle_ejb.xml");

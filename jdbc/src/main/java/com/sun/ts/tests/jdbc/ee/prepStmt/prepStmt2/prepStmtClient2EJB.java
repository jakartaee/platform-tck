  ...
  @Deployment(name = "ejb",  testable = true)
	public static EnterpriseArchive createDeploymentejb(@ArquillianResource TestArchiveProcessor archiveProcessor) throws IOException {
		...
		resURL = prepStmtClient2EJB.class
				.getResource("/com/sun/ts/tests/jdbc/ee/prepStmt/prepStmt2/prepStmt2_ejb_vehicle_client.jar.sun-application-client.xml");
		if (resURL != null) {
		...
		resURL = prepStmtClient2EJB.class.getResource("/com/sun/ts/tests/jdbc/ee/prepStmt/prepStmt2/ejb_vehicle_ejb.xml");

...
public class prepStmtClient5Servlet extends batchUpdateClient implements Serializable {
  ...
  @Deployment(name = "servlet", testable = true)
	public static WebArchive createDeploymentservlet(@ArquillianResource TestArchiveProcessor archiveProcessor) throws IOException {
		...
		archive.addClasses(prepStmtClient5Servlet.class, batchUpdateClient.class);

  ...
  @OverProtocol("appclient")
	...
	public static EnterpriseArchive createDeploymentejb(@ArquillianResource TestArchiveProcessor archiveProcessor) throws IOException {
		...
		resURL = prepStmtClient3EJB.class
				.getResource("/com/sun/ts/tests/jdbc/ee/prepStmt/prepStmt3/prepStmt3_ejb_vehicle_client.jar.sun-application-client.xml");
		if (resURL != null) {
		...
		resURL = prepStmtClient3EJB.class.getResource("/com/sun/ts/tests/jdbc/ee/prepStmt/prepStmt3/ejb_vehicle_ejb.xml");

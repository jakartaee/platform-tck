  ...
  @Deployment(name = "ejb", testable = true)
	public static EnterpriseArchive createDeploymentejb(@ArquillianResource TestArchiveProcessor archiveProcessor) throws IOException {
		...
		resURL = resultSetClient47EJB.class
				.getResource("/com/sun/ts/tests/jdbc/ee/resultSet/resultSet47/resultSet47_ejb_vehicle_client.jar.sun-application-client.xml");
		if (resURL != null) {
		...
		resURL = resultSetClient47EJB.class.getResource("/com/sun/ts/tests/jdbc/ee/resultSet/resultSet47/ejb_vehicle_ejb.xml");

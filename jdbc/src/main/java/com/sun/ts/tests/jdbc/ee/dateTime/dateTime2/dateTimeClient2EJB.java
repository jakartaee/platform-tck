  ...
  @OverProtocol("appclient")
	...
	public static EnterpriseArchive createDeploymentejb(@ArquillianResource TestArchiveProcessor archiveProcessor) throws IOException {
		...
		resURL = dateTimeClient2EJB.class
				.getResource("/com/sun/ts/tests/jdbc/ee/dateTime/dateTime2/dateTime2_ejb_vehicle_client.jar.sun-application-client.xml");
		if (resURL != null) {
		...
		resURL = dateTimeClient2EJB.class.getResource("/com/sun/ts/tests/jdbc/ee/dateTime/dateTime2/ejb_vehicle_ejb.xml");

  ...
  @OverProtocol("appclient")
	...
	public static EnterpriseArchive createDeploymentejb(@ArquillianResource TestArchiveProcessor archiveProcessor) throws IOException {
		...
		resURL = callStmtClient21EJB.class
				.getResource("/com/sun/ts/tests/jdbc/ee/callStmt/callStmt21/callStmt21_ejb_vehicle_client.jar.sun-application-client.xml");
		if (resURL != null) {
		...
		resURL = callStmtClient21EJB.class.getResource("/com/sun/ts/tests/jdbc/ee/callStmt/callStmt21/ejb_vehicle_ejb.xml");

  ...
  @Deployment(name = "ejb", testable = true)
	public static EnterpriseArchive createDeploymentejb(@ArquillianResource TestArchiveProcessor archiveProcessor) throws IOException {
		...
		resURL = resultSetClient10EJB.class
				.getResource("/com/sun/ts/tests/jdbc/ee/resultSet/resultSet10/resultSet10_ejb_vehicle_client.jar.sun-application-client.xml");
		if (resURL != null) {
		...
		resURL = resultSetClient10EJB.class.getResource("/com/sun/ts/tests/jdbc/ee/resultSet/resultSet10/ejb_vehicle_ejb.xml");

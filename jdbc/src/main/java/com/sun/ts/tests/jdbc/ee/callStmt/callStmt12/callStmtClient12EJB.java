...
import com.sun.ts.tests.jdbc.ee.callStmt.callStmt11.callStmtClient11EJB;
...
public class callStmtClient12EJB extends callStmtClient12 implements Serializable {
	...
	public static EnterpriseArchive createDeploymentejb(@ArquillianResource TestArchiveProcessor archiveProcessor) throws IOException {
		...
		resURL = callStmtClient11EJB.class
				.getResource("/com/sun/ts/tests/jdbc/ee/callStmt/callStmt12/callStmt12_ejb_vehicle_client.jar.sun-application-client.xml");
		if (resURL != null) {
		...
		resURL = callStmtClient12EJB.class.getResource("/com/sun/ts/tests/jdbc/ee/callStmt/callStmt12/ejb_vehicle_ejb.xml");

  ...
  @Deployment(name = "ejb", testable = true)
	public static EnterpriseArchive createDeploymentejb(@ArquillianResource TestArchiveProcessor archiveProcessor) throws IOException {
		...
		resURL = resultSetClient14EJB.class
				.getResource("/com/sun/ts/tests/jdbc/ee/resultSet/resultSet14/resultSet14_ejb_vehicle_client.jar.sun-application-client.xml");
		if (resURL != null) {
		...
		resURL = resultSetClient14EJB.class.getResource("/com/sun/ts/tests/jdbc/ee/resultSet/resultSet14/ejb_vehicle_ejb.xml");

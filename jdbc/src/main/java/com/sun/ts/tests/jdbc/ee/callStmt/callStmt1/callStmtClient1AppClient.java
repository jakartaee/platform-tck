...
public class callStmtClient1AppClient extends callStmtClient1 implements Serializable {
	...
	public static EnterpriseArchive createDeploymentAppclient(@ArquillianResource TestArchiveProcessor archiveProcessor) throws IOException {
		...
		archive.addClasses(callStmtClient1AppClient.class, callStmtClient1.class);
	     ...
	     URL appClientUrl = callStmtClient1AppClient.class.getResource("/com/sun/ts/tests/jdbc/ee/callStmt1/appclient_vehicle_client.xml");
	     if(appClientUrl != null) {
	     	archive.addAsManifestResource(appClientUrl, "application-client.xml");
	     }
	     // The sun appclient-client descriptor
	     URL sunAppClientUrl = callStmtClient1AppClient.class.getResource("/com/sun/ts/tests/common/vehicle/appclient/appclient_vehicle_client.jar.sun-application-client.xml");

  ...
  @Deployment(name = "ejb", testable = true)
	public static EnterpriseArchive createDeploymentejb(@ArquillianResource TestArchiveProcessor archiveProcessor) throws IOException {
		...
		ejbClient.addPackages(true, "com.sun.ts.lib.harness");
		  ...
		  URL resURL = batchUpdateClientEJB.class.getResource("com/sun/ts/tests/common/vehicle/ejb/ejb_vehicle_client.xml");
	        if(resURL != null) {
		...
		ejb.addClasses(batchUpdateClientEJB.class, batchUpdateClient.class);
		

		ejb.addAsManifestResource(batchUpdateClientEJB.class.getPackage(), "ejb_vehicle_ejb.xml", "ejb-jar.xml");

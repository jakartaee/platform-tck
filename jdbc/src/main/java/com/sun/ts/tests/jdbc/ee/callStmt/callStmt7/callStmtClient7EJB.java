...
public class callStmtClient7EJB extends callStmtClient7 implements Serializable {
	...
	public static EnterpriseArchive createDeploymentEJB(@ArquillianResource TestArchiveProcessor archiveProcessor) throws IOException {
		...
		resURL = callStmtClient7EJB.class
				.getResource("/com/sun/ts/tests/jdbc/ee/callStmt/callStmt7/callStmt7_ejb_vehicle_client.jar.sun-application-client.xml");
		if (resURL != null) {
		...
		resURL = callStmtClient7EJB.class.getResource("/com/sun/ts/tests/jdbc/ee/callStmt/callStmt7/ejb_vehicle_ejb.xml");

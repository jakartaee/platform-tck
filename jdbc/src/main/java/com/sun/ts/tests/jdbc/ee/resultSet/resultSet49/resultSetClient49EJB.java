  ...
  @Deployment(name = "ejb", testable = true)
	public static EnterpriseArchive createDeploymentejb(@ArquillianResource TestArchiveProcessor archiveProcessor) throws IOException {
		...
		resURL = resultSetClient49EJB.class
				.getResource("/com/sun/ts/tests/jdbc/ee/resultSet/resultSet49/resultSet49_ejb_vehicle_client.jar.sun-application-client.xml");
		if (resURL != null) {
		...
		resURL = resultSetClient49EJB.class.getResource("/com/sun/ts/tests/jdbc/ee/resultSet/resultSet49/ejb_vehicle_ejb.xml");

  ...
  @OverProtocol("appclient")
	...
	public static EnterpriseArchive createDeploymentejb(@ArquillianResource TestArchiveProcessor archiveProcessor) throws IOException {
		...
		resURL = dateTimeClient3EJB.class
				.getResource("/com/sun/ts/tests/jdbc/ee/dateTime/dateTime3/dateTime3_ejb_vehicle_client.jar.sun-application-client.xml");
		if (resURL != null) {
		...
		resURL = dateTimeClient3EJB.class.getResource("/com/sun/ts/tests/jdbc/ee/dateTime/dateTime3/ejb_vehicle_ejb.xml");

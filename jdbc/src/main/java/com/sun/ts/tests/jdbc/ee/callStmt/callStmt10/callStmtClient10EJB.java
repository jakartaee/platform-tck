...
public class callStmtClient10EJB extends callStmtClient10 implements Serializable {
	...
	public static EnterpriseArchive createDeploymentEJB(@ArquillianResource TestArchiveProcessor archiveProcessor) throws IOException {
		...
		URL resURL = callStmtClient10EJB.class.getResource("/com/sun/ts/tests/common/vehicle/ejb/ejb_vehicle_client.xml");
		if (resURL != null) {
			ejbClient.addAsManifestResource(resURL, "application-client.xml");
		}
		
		resURL = callStmtClient10EJB.class
				.getResource("/com/sun/ts/tests/jdbc/ee/callStmt/callStmt10/callStmt10_ejb_vehicle_client.jar.sun-application-client.xml");
		if (resURL != null) {
		...
		resURL = callStmtClient10EJB.class.getResource("/com/sun/ts/tests/jdbc/ee/callStmt/callStmt10/ejb_vehicle_ejb.xml");

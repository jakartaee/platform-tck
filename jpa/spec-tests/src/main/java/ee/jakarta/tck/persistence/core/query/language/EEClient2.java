...
public static Archive<?> getEarTestArchive()
    {
        ...
        }
        {
            ...
            jpa_core_query_language_appmanagedNoTx_vehicle_ejb_jar.addClass(ee.jakarta.tck.persistence.core.query.language.Client2.class);
        ...
        }
        {
            ...
            jpa_core_query_language_appmanaged_vehicle_ejb_jar.addClass(ee.jakarta.tck.persistence.core.query.language.Client2.class);
        ...
        }
        {
            ...
            jpa_core_query_language_pmservlet_vehicle_web_war.addClass(ee.jakarta.tck.persistence.core.query.language.Client2.class);
        ...
        }
        {
            ...
            jpa_core_query_language_puservlet_vehicle_web_war.addClass(ee.jakarta.tck.persistence.core.query.language.Client2.class);
        ...
        }
        {
            ...
            jpa_core_query_language_stateful3_vehicle_ejb_jar.addClass(ee.jakarta.tck.persistence.core.query.language.Client2.class);
        ...
        }
        {
            ...
            jpa_core_query_language_stateless3_vehicle_ejb_jar.addClass(ee.jakarta.tck.persistence.core.query.language.Client2.class);

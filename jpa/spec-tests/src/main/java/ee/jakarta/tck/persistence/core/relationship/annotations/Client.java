...
public class Client extends PMClientBase {
	...
	public void annotationMappingPersistTest1() throws Exception {
		...
		try {
			...
			if (personFound != null && projectFound != null) {
				...
				logErr( "Failed to find persisted Person or Project: " + " personFound: "
	...
	public void annotationMappingTest2() throws Exception {
		...
		try {
				...
				while (i1.hasNext()) {
					...
					for (int l = 0; l < 3; l++) {
						if (expectedTeam1[l].equals((String) o1.getName())) {
							logTrace( "Found Team 1:" + (String) o1.getName());
							foundTeam1++;
							break;
						}
					}
				...
				while (i2.hasNext()) {
					...
					for (int l = 0; l < 2; l++) {
						if (expectedTeam2[l].equals((String) o2.getName())) {
							logTrace( "Found Team 2:" + (String) o2.getName());
							foundTeam2++;
							break;
						}
					}
			...
			if ((foundTeam1 != 3) || (foundTeam2 != 2)) {
				logErr( "annotationMappingTest2: Did not get expected results");
				pass2 = false;
			} else {
				logTrace( "Expected results received");
				pass2 = true;
	...
	public void annotationMappingTest6() throws Exception {
		...
		try {
				...
				while (i1.hasNext()) {
					...
					for (int l = 0; l < 3; l++) {
						if (expectedResults1[l].equals((Long) o1.getProjId())) {
							logTrace( "Found Project for Karen Tegan: " + (String) o1.getName());
							foundProject1++;
							break;
						}
					}
			...
			if ((foundProject1 != 3) || (foundProject2 != 3)) {
				logErr( "annotationMappingTest6: Did not get expected results");
				pass2 = false;
			} else {
				logTrace( "Expected results received");
				pass2 = true;
	...
	public void annotationMappingTest7() throws Exception {
		...
		try {
			...
			if ((foundCol1 != 4) || (foundCol2 != 2) || (foundCol3 != 2) || (foundCol4 != 2) || (foundCol5 != 4)) {
				...
				logErr( "annotationMappingTest7: Did not get expected results");
				pass2 = false;
			} else {
				logTrace( "Expected results received");
				pass2 = true;
	...
	public void annotationMappingTest8() throws Exception {
		...
		try {
			...
			if ((foundInsurance1 != 2) || (foundInsurance2 != 2) || (foundInsurance3 != 3)) {
				logErr( "annotationMappingTest8: Did not get expected results");
				pass2 = false;
			} else {
				logTrace( "Expected results received");
				pass2 = true;
	...
	private void createPeople(boolean persist) throws Exception {
		logTrace( "CreatePeople(persist=" + persist + ")");
	...
	private void createProjects(boolean persist) throws Exception {
		logTrace( "Create 5 Projects (persist=" + persist + ")");

...
public static Archive<?> getEarTestArchive()
    {
        ...
        }
        {
            ...
            jpa_core_query_apitests_appmanagedNoTx_vehicle_ejb_jar.addClass(ee.jakarta.tck.persistence.core.query.apitests.Client4.class);
        ...
        }
        {
            ...
            jpa_core_query_apitests_pmservlet_vehicle_web_war.addClass(ee.jakarta.tck.persistence.core.query.apitests.Client4.class);
        ...
        }
        {
            ...
            jpa_core_query_apitests_puservlet_vehicle_web_war.addClass(ee.jakarta.tck.persistence.core.query.apitests.Client4.class);
        ...
        }
        {
            ...
            jpa_core_query_apitests_stateless3_vehicle_ejb_jar.addClass(ee.jakarta.tck.persistence.core.query.apitests.Client4.class);

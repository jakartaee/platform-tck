...
public static Archive<?> getEarTestArchive()
    {
        ...
        }
        {
            ...
            jpa_core_criteriaapi_Join_appmanagedNoTx_vehicle_ejb_jar.addClass(ee.jakarta.tck.persistence.core.criteriaapi.Join.Client3.class);
        ...
        }
        {
            ...
            jpa_core_criteriaapi_Join_appmanaged_vehicle_ejb_jar.addClass(ee.jakarta.tck.persistence.core.criteriaapi.Join.Client3.class);
        ...
        }
        {
            ...
            jpa_core_criteriaapi_Join_pmservlet_vehicle_web_war.addClass(ee.jakarta.tck.persistence.core.criteriaapi.Join.Client3.class);
        ...
        }
        {
            ...
            jpa_core_criteriaapi_Join_puservlet_vehicle_web_war.addClass(ee.jakarta.tck.persistence.core.criteriaapi.Join.Client3.class);
        ...
        }
        {
            ...
            jpa_core_criteriaapi_Join_stateful3_vehicle_ejb_jar.addClass(ee.jakarta.tck.persistence.core.criteriaapi.Join.Client3.class);
        ...
        }
        {
            ...
            jpa_core_criteriaapi_Join_stateless3_vehicle_ejb_jar.addClass(ee.jakarta.tck.persistence.core.criteriaapi.Join.Client3.class);

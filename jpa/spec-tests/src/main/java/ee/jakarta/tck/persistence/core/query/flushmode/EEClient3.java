...
public static Archive<?> getEarTestArchive()
    {
        ...
        }
        {
            ...
            jpa_core_query_flushmode_appmanagedNoTx_vehicle_ejb_jar.addClass(ee.jakarta.tck.persistence.core.query.flushmode.Client3.class);
        ...
        }
        {
            ...
            jpa_core_query_flushmode_pmservlet_vehicle_web_war.addClass(ee.jakarta.tck.persistence.core.query.flushmode.Client3.class);
        ...
        }
        {
            ...
            jpa_core_query_flushmode_puservlet_vehicle_web_war.addClass(ee.jakarta.tck.persistence.core.query.flushmode.Client3.class);
        ...
        }
        {
            ...
            jpa_core_query_flushmode_stateless3_vehicle_ejb_jar.addClass(ee.jakarta.tck.persistence.core.query.flushmode.Client3.class);

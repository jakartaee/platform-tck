    ...
    static final String VEHICLE_ARCHIVE = "jpa_core_criteriaapi_CriteriaQuery_appmanagedNoTx_vehicle";
        ...
        */
        ...
        // Client
            ...
            JavaArchive jpa_core_criteriaapi_CriteriaQuery_appmanagedNoTx_vehicle_client = ShrinkWrap.create(JavaArchive.class, "jpa_core_criteriaapi_CriteriaQuery_appmanagedNoTx_vehicle_client.jar");
            // The class files
            ...
            jpa_core_criteriaapi_CriteriaQuery_appmanagedNoTx_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + Client1.class.getName() + "\n"), "MANIFEST.MF");
            // Call the archive processor
            archiveProcessor.processClientArchive(jpa_core_criteriaapi_CriteriaQuery_appmanagedNoTx_vehicle_client, Client1.class, resURL);
        ...
        // Ejb
            ...
            if(ejbResURL != null) {
              jpa_core_criteriaapi_CriteriaQuery_appmanagedNoTx_vehicle_ejb.addAsManifestResource(ejbResURL, "ejb-jar.xml");
            }
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_criteriaapi_CriteriaQuery_appmanagedNoTx_vehicle_ejb, Client1.class, ejbResURL);

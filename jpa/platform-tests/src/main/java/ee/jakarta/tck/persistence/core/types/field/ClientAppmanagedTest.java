...
public class ClientAppmanagedTest extends ee.jakarta.tck.persistence.core.types.field.Client {
    static final String VEHICLE_ARCHIVE = "jpa_core_types_field_appmanaged_vehicle";
        ...
        */
        ...
        // Client
            ...
            JavaArchive jpa_core_types_field_appmanaged_vehicle_client = ShrinkWrap.create(JavaArchive.class, "jpa_core_types_field_appmanaged_vehicle_client.jar");
            // The class files
            jpa_core_types_field_appmanaged_vehicle_client.addClasses(
            ...
            if(resURL != null) {
              jpa_core_types_field_appmanaged_vehicle_client.addAsManifestResource(resURL, "application-client.xml");
            }
            ...
            jpa_core_types_field_appmanaged_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + Client.class.getName() + "\n"), "MANIFEST.MF");
            archiveProcessor.processClientArchive(jpa_core_types_field_appmanaged_vehicle_client, Client.class, resURL);


        // Ejb
            // the jar with the correct archive name
            JavaArchive jpa_core_types_field_appmanaged_vehicle_ejb = ShrinkWrap.create(JavaArchive.class, "jpa_core_types_field_appmanaged_vehicle_ejb.jar");
            // The class files
            jpa_core_types_field_appmanaged_vehicle_ejb.addClasses(
            ...
            if(ejbResURL != null) {
              jpa_core_types_field_appmanaged_vehicle_ejb.addAsManifestResource(ejbResURL, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL = Client.class.getResource("//vehicle/appmanaged/appmanaged_vehicle_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL != null) {
              jpa_core_types_field_appmanaged_vehicle_ejb.addAsManifestResource(ejbResURL, "sun-ejb-jar.xml");
            }
            archiveProcessor.processEjbArchive(jpa_core_types_field_appmanaged_vehicle_ejb, Client.class, ejbResURL);
        ...
        // Ear
            ...
            jpa_core_types_field_vehicles_ear.addAsModule(jpa_core_types_field_appmanaged_vehicle_ejb);
            jpa_core_types_field_vehicles_ear.addAsModule(jpa_core_types_field_appmanaged_vehicle_client);

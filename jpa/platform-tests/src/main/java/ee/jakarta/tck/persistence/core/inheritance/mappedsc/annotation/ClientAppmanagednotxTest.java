    ...
    static final String VEHICLE_ARCHIVE = "jpa_core_inherit_msc_annotation_appmanagedNoTx_vehicle";
        ...
        */
        ...
        // Client
            ...
            jpa_core_inherit_msc_annotation_appmanagedNoTx_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: com.sun.ts.tests.common.vehicle.VehicleClient\n"), "MANIFEST.MF");
        ...
        // Par
            ...
            if(mappingURL != null) {
              jpa_core_inherit_msc_annotation.addAsManifestResource(mappingURL, "myMappingFile.xml");
            }
            mappingURL = Client.class.getResource("myMappingFile1.xml");
            if(mappingURL != null) {
              jpa_core_inherit_msc_annotation.addAsManifestResource(mappingURL, "myMappingFile1.xml");
            }
            mappingURL = Client.class.getResource("myMappingFile2.xml");
            if(mappingURL != null) {
              jpa_core_inherit_msc_annotation.addAsManifestResource(mappingURL, "myMappingFile2.xml");
            }

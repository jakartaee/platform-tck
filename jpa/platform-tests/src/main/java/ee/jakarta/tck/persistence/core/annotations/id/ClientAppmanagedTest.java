...
public class ClientAppmanagedTest extends ee.jakarta.tck.persistence.core.annotations.id.Client {
    static final String VEHICLE_ARCHIVE = "jpa_core_annotations_basic_appmanaged_vehicle";
        ...
        */
        ...
        // Client
            ...
            archiveProcessor.processClientArchive(jpa_core_annotations_basic_appmanaged_vehicle_client, Client.class, resURL);
        ...
        // Ejb 1
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_annotations_basic_appmanaged_vehicle_ejb, Client.class, ejbResURL1);

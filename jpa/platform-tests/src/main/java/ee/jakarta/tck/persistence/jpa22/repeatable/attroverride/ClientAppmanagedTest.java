...
public class ClientAppmanagedTest extends ee.jakarta.tck.persistence.jpa22.repeatable.attroverride.Client {
    static final String VEHICLE_ARCHIVE = "jpa_jpa22_repeatable_attroverride_appmanaged_vehicle";
        ...
        */
        ...
        // Client
            ...
            JavaArchive jpa_jpa22_repeatable_attroverride_appmanaged_vehicle_client = ShrinkWrap.create(JavaArchive.class, "jpa_jpa22_repeatable_attroverride_appmanaged_vehicle_client.jar");
            // The class files
            jpa_jpa22_repeatable_attroverride_appmanaged_vehicle_client.addClasses(
            ...
            if(resURL != null) {
              jpa_jpa22_repeatable_attroverride_appmanaged_vehicle_client.addAsManifestResource(resURL, "application-client.xml");
            }
            ...
            jpa_jpa22_repeatable_attroverride_appmanaged_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + Client.class.getName() + "\n"), "MANIFEST.MF");
            archiveProcessor.processClientArchive(jpa_jpa22_repeatable_attroverride_appmanaged_vehicle_client, Client.class, resURL);


        // Ejb
            // the jar with the correct archive name
            JavaArchive jpa_jpa22_repeatable_attroverride_appmanaged_vehicle_ejb = ShrinkWrap.create(JavaArchive.class, "jpa_jpa22_repeatable_attroverride_appmanaged_vehicle_ejb.jar");
            // The class files
            jpa_jpa22_repeatable_attroverride_appmanaged_vehicle_ejb.addClasses(
            ...
            if(ejbResURL != null) {
              jpa_jpa22_repeatable_attroverride_appmanaged_vehicle_ejb.addAsManifestResource(ejbResURL, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL = Client.class.getResource("//vehicle/appmanaged/appmanaged_vehicle_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL != null) {
              jpa_jpa22_repeatable_attroverride_appmanaged_vehicle_ejb.addAsManifestResource(ejbResURL, "sun-ejb-jar.xml");
            }
            archiveProcessor.processEjbArchive(jpa_jpa22_repeatable_attroverride_appmanaged_vehicle_ejb, Client.class, ejbResURL);
        ...
        // Ear
            ...
            jpa_jpa22_repeatable_attroverride_vehicles_ear.addAsModule(jpa_jpa22_repeatable_attroverride_appmanaged_vehicle_ejb);
            jpa_jpa22_repeatable_attroverride_vehicles_ear.addAsModule(jpa_jpa22_repeatable_attroverride_appmanaged_vehicle_client);

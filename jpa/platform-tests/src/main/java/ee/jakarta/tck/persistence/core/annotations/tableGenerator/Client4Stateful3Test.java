    ...
    static final String VEHICLE_ARCHIVE = "jpa_core_annotations_tableGenerator_stateful3_vehicle";
        ...
        */
        ...
        // Client
            ...
            jpa_core_annotations_tableGenerator_stateful3_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + Client4.class.getName() + "\n"), "MANIFEST.MF");
        ...
        // Ejb
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_annotations_tableGenerator_stateful3_vehicle_ejb, Client4.class, ejbResURL);
        ...
        // Ear
            ...
            URL earResURL = Client4.class.getResource("/com/sun/ts/tests/jpa/core/annotations/tableGenerator/");
            if(earResURL != null) {
              jpa_core_annotations_tableGenerator_vehicles_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client4.class.getResource("/com/sun/ts/tests/jpa/core/annotations/tableGenerator/.ear.sun-application.xml");
            if(earResURL != null) {

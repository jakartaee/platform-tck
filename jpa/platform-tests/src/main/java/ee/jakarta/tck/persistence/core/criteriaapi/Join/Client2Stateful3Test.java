...
public class Client2Stateful3Test extends ee.jakarta.tck.persistence.core.criteriaapi.Join.Client2 {
    static final String VEHICLE_ARCHIVE = "jpa_core_criteriaapi_Join_stateful3_vehicle";
        ...
        */
        ...
        // Client
            ...
            jpa_core_criteriaapi_Join_stateful3_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + Client2.class.getName() + "\n"), "MANIFEST.MF");
            archiveProcessor.processClientArchive(jpa_core_criteriaapi_Join_stateful3_vehicle_client, Client2.class, resURL);
        ...
        // Ejb
            ...
            archiveProcessor.processEjbArchive(jpa_core_criteriaapi_Join_stateful3_vehicle_ejb, Client2.class, ejbResURL);
        ...
        // Ear
            ...
            URL earResURL = Client2.class.getResource("/com/sun/ts/tests/jpa/core/criteriaapi/Join/");
            if(earResURL != null) {
              jpa_core_criteriaapi_Join_vehicles_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client2.class.getResource("/com/sun/ts/tests/jpa/core/criteriaapi/Join/.ear.sun-application.xml");
            if(earResURL != null) {

...
public class ClientAppmanagedTest extends ee.jakarta.tck.persistence.core.inheritance.abstractentity.Client {
    static final String VEHICLE_ARCHIVE = "jpa_core_inheritance_abstractentity_appmanaged_vehicle";
        ...
        */
        ...
        // Client
            ...
            jpa_core_inheritance_abstractentity_appmanaged_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: com.sun.ts.tests.common.vehicle.VehicleClient\n"), "MANIFEST.MF");
            // Call the archive processor
            archiveProcessor.processClientArchive(jpa_core_inheritance_abstractentity_appmanaged_vehicle_client, Client.class, resURL);

        // Ejb 1
            // the jar with the correct archive name
            JavaArchive jpa_core_inheritance_abstractentity_appmanaged_vehicle_ejb = ShrinkWrap.create(JavaArchive.class, "jpa_core_inheritance_abstractentity_appmanaged_vehicle_ejb.jar");
            // The class files
            jpa_core_inheritance_abstractentity_appmanaged_vehicle_ejb.addClasses(
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_inheritance_abstractentity_appmanaged_vehicle_ejb, Client.class, ejbResURL1);
        ...
        // Ear
            ...
            jpa_core_inheritance_abstractentity_vehicles_ear.addAsModule(jpa_core_inheritance_abstractentity_appmanaged_vehicle_ejb);
            jpa_core_inheritance_abstractentity_vehicles_ear.addAsModule(jpa_core_inheritance_abstractentity_appmanaged_vehicle_client);

...
public class Client2PmservletTest extends ee.jakarta.tck.persistence.core.criteriaapi.parameter.Client2 {
    static final String VEHICLE_ARCHIVE = "jpa_core_criteriaapi_parameter_pmservlet_vehicle";
        ...
        */
        ...
        // War
            ...
            WebArchive jpa_core_criteriaapi_parameter_pmservlet_vehicle_web = ShrinkWrap.create(WebArchive.class, "jpa_core_criteriaapi_parameter_pmservlet_vehicle_web.war");
            // The class files
            jpa_core_criteriaapi_parameter_pmservlet_vehicle_web.addClasses(
            ...
            if(warResURL != null) {
              jpa_core_criteriaapi_parameter_pmservlet_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = Client2.class.getResource("//com/sun/ts/tests/common/vehicle/pmservlet/pmservlet_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
              jpa_core_criteriaapi_parameter_pmservlet_vehicle_web.addAsWebInfResource(warResURL, "sun-web.xml");
            }
            ...
            if(warResURL != null) {
              jpa_core_criteriaapi_parameter_pmservlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/lib/jpa_core_criteriaapi_parameter.jar");
            }
            warResURL = Client2.class.getResource("/com/sun/ts/tests/common/vehicle/pmservlet/pmservlet_vehicle_web.xml");
            if(warResURL != null) {
              jpa_core_criteriaapi_parameter_pmservlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/pmservlet_vehicle_web.xml");
            }

           // Call the archive processor
           archiveProcessor.processWebArchive(jpa_core_criteriaapi_parameter_pmservlet_vehicle_web, Client2.class, warResURL);
        ...
        // Ear
            ...
            jpa_core_criteriaapi_parameter_vehicles_ear.addAsModule(jpa_core_criteriaapi_parameter_pmservlet_vehicle_web);

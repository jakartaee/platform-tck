...
public class Client2PmservletTest extends ee.jakarta.tck.persistence.core.query.language.Client2 {
    static final String VEHICLE_ARCHIVE = "jpa_core_query_language_pmservlet_vehicle";
        ...
        */
        ...
        // War
           ...
           archiveProcessor.processWebArchive(jpa_core_query_language_pmservlet_vehicle_web, Client2.class, warResURL);

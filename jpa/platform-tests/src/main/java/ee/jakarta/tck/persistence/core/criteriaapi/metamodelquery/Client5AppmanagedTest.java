    ...
    static final String VEHICLE_ARCHIVE = "jpa_core_criteriaapi_metamodelquery_appmanaged_vehicle";
        ...
        */
        ...
        // Client
            ...
            jpa_core_criteriaapi_metamodelquery_appmanaged_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + Client5.class.getName() + "\n"), "MANIFEST.MF");
        ...
        // Ejb
            ...
            archiveProcessor.processEjbArchive(jpa_core_criteriaapi_metamodelquery_appmanaged_vehicle_ejb, Client5.class, ejbResURL);

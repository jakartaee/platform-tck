...
public class Client1Stateless3Test extends ee.jakarta.tck.persistence.core.annotations.ordercolumn.Client1 {
    static final String VEHICLE_ARCHIVE = "jpa_core_annotations_ordercolumn_stateless3_vehicle";
        ...
        */
        ...
        // Client
            ...
            JavaArchive jpa_core_annotations_ordercolumn_stateless3_vehicle_client = ShrinkWrap.create(JavaArchive.class, "jpa_core_annotations_ordercolumn_stateless3_vehicle_client.jar");
            // The class files
            ...
            jpa_core_annotations_ordercolumn_stateless3_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + Client1.class.getName() + "\n"), "MANIFEST.MF");
            // Call the archive processor
            archiveProcessor.processClientArchive(jpa_core_annotations_ordercolumn_stateless3_vehicle_client, Client1.class, resURL);
        ...
        // Ejb
            ...
            if(ejbResURL != null) {
              jpa_core_annotations_ordercolumn_stateless3_vehicle_ejb.addAsManifestResource(ejbResURL, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL = Client1.class.getResource("//vehicle/stateless3/stateless3_vehicle_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL != null) {
              jpa_core_annotations_ordercolumn_stateless3_vehicle_ejb.addAsManifestResource(ejbResURL, "sun-ejb-jar.xml");
            }
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_annotations_ordercolumn_stateless3_vehicle_ejb, Client1.class, ejbResURL);

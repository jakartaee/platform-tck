...
public class Client3PmservletTest extends ee.jakarta.tck.persistence.core.criteriaapi.Join.Client3 {
    static final String VEHICLE_ARCHIVE = "jpa_core_criteriaapi_Join_pmservlet_vehicle";
        ...
        */
        ...
        // War
            ...
            WebArchive jpa_core_criteriaapi_Join_pmservlet_vehicle_web = ShrinkWrap.create(WebArchive.class, "jpa_core_criteriaapi_Join_pmservlet_vehicle_web.war");
            // The class files
            jpa_core_criteriaapi_Join_pmservlet_vehicle_web.addClasses(
            ...
            if(warResURL != null) {
              jpa_core_criteriaapi_Join_pmservlet_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            ...
            // Web content
            warResURL = Client3.class.getResource("/com/sun/ts/tests/jpa/core/criteriaapi/Join/jpa_core_criteriaapi_Join.jar");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(jpa_core_criteriaapi_Join_pmservlet_vehicle_web, Client3.class, warResURL);
        ...
        // Ear
            ...
            jpa_core_criteriaapi_Join_vehicles_ear.addAsModule(jpa_core_criteriaapi_Join_pmservlet_vehicle_web);

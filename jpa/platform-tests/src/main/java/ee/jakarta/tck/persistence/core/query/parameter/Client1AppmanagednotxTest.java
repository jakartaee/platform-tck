    ...
    public void setup(String[] args, Properties p) throws Exception {
        ...
        */
        ...
        // Client
            ...
            JavaArchive jpa_core_query_parameter_appmanagedNoTx_vehicle_client = ShrinkWrap.create(JavaArchive.class, "jpa_core_query_parameter_vehicles_client.jar");
            // The class files
            ...
            if(resURL != null) {
              jpa_core_query_parameter_appmanagedNoTx_vehicle_client.addAsManifestResource(resURL, "sun-application-client.xml");
            }

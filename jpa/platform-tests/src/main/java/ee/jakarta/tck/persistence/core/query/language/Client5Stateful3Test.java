...
public class Client5Stateful3Test extends ee.jakarta.tck.persistence.core.query.language.Client5 {
    static final String VEHICLE_ARCHIVE = "jpa_core_query_language_stateful3_vehicle";
        ...
        */
        ...
        // Client
            ...
            JavaArchive jpa_core_query_language_stateful3_vehicle_client = ShrinkWrap.create(JavaArchive.class, "jpa_core_query_language_stateful3_vehicle_client.jar");
            // The class files
            ...
            jpa_core_query_language_stateful3_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + Client5.class.getName() + "\n"), "MANIFEST.MF");
            archiveProcessor.processClientArchive(jpa_core_query_language_stateful3_vehicle_client, Client5.class, resURL);
        ...
        // Ejb
            ...
            if(ejbResURL != null) {
              jpa_core_query_language_stateful3_vehicle_ejb.addAsManifestResource(ejbResURL, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL = Client5.class.getResource("//vehicle/stateful3/stateful3_vehicle_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL != null) {
              jpa_core_query_language_stateful3_vehicle_ejb.addAsManifestResource(ejbResURL, "sun-ejb-jar.xml");
            }
            archiveProcessor.processEjbArchive(jpa_core_query_language_stateful3_vehicle_ejb, Client5.class, ejbResURL);
        ...
        // Ear
            ...
            URL earResURL = Client5.class.getResource("/com/sun/ts/tests/jpa/core/query/language/");
            if(earResURL != null) {
              jpa_core_query_language_vehicles_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client5.class.getResource("/com/sun/ts/tests/jpa/core/query/language/.ear.sun-application.xml");
            if(earResURL != null) {

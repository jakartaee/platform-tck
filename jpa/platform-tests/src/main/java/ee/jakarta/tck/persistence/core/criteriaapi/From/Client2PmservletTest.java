...
public class Client2PmservletTest extends ee.jakarta.tck.persistence.core.criteriaapi.From.Client2 {
    static final String VEHICLE_ARCHIVE = "jpa_core_criteriaapi_From_pmservlet_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client2.class.getResource("/com/sun/ts/tests/jpa/core/criteriaapi/From/jpa_core_criteriaapi_From.jar");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(jpa_core_criteriaapi_From_pmservlet_vehicle_web, Client2.class, warResURL);

    ...
    static final String VEHICLE_ARCHIVE = "jpa_core_criteriaapi_From_appmanagedNoTx_vehicle";
        ...
        */
        ...
        // Client
            ...
            jpa_core_criteriaapi_From_appmanagedNoTx_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + Client2.class.getName() + "\n"), "MANIFEST.MF");
        ...
        // Ejb
            ...
            archiveProcessor.processEjbArchive(jpa_core_criteriaapi_From_appmanagedNoTx_vehicle_ejb, Client2.class, ejbResURL);

...
public class Client2PuservletTest extends ee.jakarta.tck.persistence.core.criteriaapi.strquery.Client2 {
    static final String VEHICLE_ARCHIVE = "jpa_core_criteriaapi_strquery_puservlet_vehicle";
        ...
        */
        ...
        // War
           ...
           archiveProcessor.processWebArchive(jpa_core_criteriaapi_strquery_puservlet_vehicle_web, Client2.class, warResURL);
        ...
        // Ear
            ...
            jpa_core_criteriaapi_strquery_vehicles_ear.addAsModule(jpa_core_criteriaapi_strquery_puservlet_vehicle_web);

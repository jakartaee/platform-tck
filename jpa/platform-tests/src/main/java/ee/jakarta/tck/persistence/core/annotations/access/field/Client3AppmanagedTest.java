...
public class Client3AppmanagedTest extends ee.jakarta.tck.persistence.core.annotations.access.field.Client3 {
    static final String VEHICLE_ARCHIVE = "jpa_core_annotations_access_field_appmanaged_vehicle";
        ...
        */
        ...
        // Ejb
            ...
            if(ejbResURL != null) {
              jpa_core_annotations_access_field_appmanaged_vehicle_ejb.addAsManifestResource(ejbResURL, "ejb-jar.xml");
            }
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_annotations_access_field_appmanaged_vehicle_ejb, Client3.class, ejbResURL);

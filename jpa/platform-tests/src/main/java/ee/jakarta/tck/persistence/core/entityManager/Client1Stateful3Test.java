...
public class Client1Stateful3Test extends ee.jakarta.tck.persistence.core.entityManager.Client1 {
    static final String VEHICLE_ARCHIVE = "jpa_core_entityManager_stateful3_vehicle";
        ...
        */
        ...
        // Client
            ...
            archiveProcessor.processClientArchive(jpa_core_entityManager_stateful3_vehicle_client, Client1.class, resURL);
        ...
        // Ejb 1
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_entityManager_stateful3_vehicle_ejb, Client1.class, ejbResURL1);

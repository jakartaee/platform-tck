...
public class Client5Stateful3Test extends ee.jakarta.tck.persistence.core.criteriaapi.metamodelquery.Client5 {
    static final String VEHICLE_ARCHIVE = "jpa_core_criteriaapi_metamodelquery_stateful3_vehicle";
        ...
        */
        ...
        // Client
            ...
            jpa_core_criteriaapi_metamodelquery_stateful3_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + Client5.class.getName() + "\n"), "MANIFEST.MF");
            archiveProcessor.processClientArchive(jpa_core_criteriaapi_metamodelquery_stateful3_vehicle_client, Client5.class, resURL);
        ...
        // Ejb
            ...
            archiveProcessor.processEjbArchive(jpa_core_criteriaapi_metamodelquery_stateful3_vehicle_ejb, Client5.class, ejbResURL);
        ...
        // Ear
            ...
            URL earResURL = Client5.class.getResource("/com/sun/ts/tests/jpa/core/criteriaapi/metamodelquery/");
            if(earResURL != null) {
              jpa_core_criteriaapi_metamodelquery_vehicles_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client5.class.getResource("/com/sun/ts/tests/jpa/core/criteriaapi/metamodelquery/.ear.sun-application.xml");
            if(earResURL != null) {

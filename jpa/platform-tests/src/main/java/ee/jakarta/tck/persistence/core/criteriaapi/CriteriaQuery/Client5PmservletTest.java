...
public class Client5PmservletTest extends ee.jakarta.tck.persistence.core.criteriaapi.CriteriaQuery.Client5 {
    static final String VEHICLE_ARCHIVE = "jpa_core_criteriaapi_CriteriaQuery_pmservlet_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client5.class.getResource("/com/sun/ts/tests/jpa/core/criteriaapi/CriteriaQuery/jpa_core_criteriaapi_CriteriaQuery.jar");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(jpa_core_criteriaapi_CriteriaQuery_pmservlet_vehicle_web, Client5.class, warResURL);

...
public class Client4AppmanagednotxTest extends ee.jakarta.tck.persistence.core.criteriaapi.strquery.Client4 {
    static final String VEHICLE_ARCHIVE = "jpa_core_criteriaapi_strquery_appmanagedNoTx_vehicle";
        ...
        */
        ...
        // Client
            ...
            JavaArchive jpa_core_criteriaapi_strquery_appmanagedNoTx_vehicle_client = ShrinkWrap.create(JavaArchive.class, "jpa_core_criteriaapi_strquery_appmanagedNoTx_vehicle_client.jar");
            // The class files
            ...
            jpa_core_criteriaapi_strquery_appmanagedNoTx_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + Client4.class.getName() + "\n"), "MANIFEST.MF");
            archiveProcessor.processClientArchive(jpa_core_criteriaapi_strquery_appmanagedNoTx_vehicle_client, Client4.class, resURL);
        ...
        // Ejb
            ...
            if(ejbResURL != null) {
              jpa_core_criteriaapi_strquery_appmanagedNoTx_vehicle_ejb.addAsManifestResource(ejbResURL, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL = Client4.class.getResource("//vehicle/appmanagedNoTx/appmanagedNoTx_vehicle_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL != null) {
              jpa_core_criteriaapi_strquery_appmanagedNoTx_vehicle_ejb.addAsManifestResource(ejbResURL, "sun-ejb-jar.xml");
            }
            archiveProcessor.processEjbArchive(jpa_core_criteriaapi_strquery_appmanagedNoTx_vehicle_ejb, Client4.class, ejbResURL);

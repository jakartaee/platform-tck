...
public class Client2Stateless3Test extends ee.jakarta.tck.persistence.core.StoredProcedureQuery.Client2 {
    static final String VEHICLE_ARCHIVE = "jpa_core_StoredProcedureQuery_stateless3_vehicle";
        ...
        */
        ...
        // Ejb 1
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_StoredProcedureQuery_stateless3_vehicle_ejb, Client2.class, ejbResURL1);

...
public class Client4Stateless3Test extends ee.jakarta.tck.persistence.core.query.apitests.Client4 {
    static final String VEHICLE_ARCHIVE = "jpa_core_query_apitests_stateless3_vehicle";
        ...
        */
        ...
        // Ejb 1
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_query_apitests_stateless3_vehicle_ejb, Client4.class, ejbResURL1);

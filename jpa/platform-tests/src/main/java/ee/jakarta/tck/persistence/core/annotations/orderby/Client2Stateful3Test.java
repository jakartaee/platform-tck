...
public class Client2Stateful3Test extends ee.jakarta.tck.persistence.core.annotations.orderby.Client2 {
    static final String VEHICLE_ARCHIVE = "jpa_core_annotations_orderby_stateful3_vehicle";
        ...
        */
        ...
        // Client
            ...
            archiveProcessor.processClientArchive(jpa_core_annotations_orderby_stateful3_vehicle_client, Client2.class, resURL);
        ...
        // Ejb 1
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_annotations_orderby_stateful3_vehicle_ejb, Client2.class, ejbResURL1);

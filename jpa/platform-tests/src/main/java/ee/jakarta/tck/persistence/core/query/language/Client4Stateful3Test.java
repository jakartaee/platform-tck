...
public class Client4Stateful3Test extends ee.jakarta.tck.persistence.core.query.language.Client4 {
    static final String VEHICLE_ARCHIVE = "jpa_core_query_language_stateful3_vehicle";
        ...
        */
        ...
        // Client
            ...
            archiveProcessor.processClientArchive(jpa_core_query_language_stateful3_vehicle_client, Client4.class, resURL);
        ...
        // Ejb 1
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_query_language_stateful3_vehicle_ejb, Client4.class, ejbResURL1);

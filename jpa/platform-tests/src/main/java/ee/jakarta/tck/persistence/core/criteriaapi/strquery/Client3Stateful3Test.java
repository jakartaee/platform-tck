...
public class Client3Stateful3Test extends ee.jakarta.tck.persistence.core.criteriaapi.strquery.Client3 {
    static final String VEHICLE_ARCHIVE = "jpa_core_criteriaapi_strquery_stateful3_vehicle";
        ...
        */
        ...
        // Ejb 1
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_criteriaapi_strquery_stateful3_vehicle_ejb, Client3.class, ejbResURL1);

    ...
    static final String VEHICLE_ARCHIVE = "jpa_core_annotations_mapkey_appmanaged_vehicle";
        ...
        */
        ...
        // Client
            ...
            JavaArchive jpa_core_annotations_mapkey_appmanaged_vehicle_client = ShrinkWrap.create(JavaArchive.class, "jpa_core_annotations_mapkey_appmanaged_vehicle_client.jar");
            // The class files
            ...
            jpa_core_annotations_mapkey_appmanaged_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + Client2.class.getName() + "\n"), "MANIFEST.MF");
        ...
        // Ejb
            ...
            if(ejbResURL != null) {
              jpa_core_annotations_mapkey_appmanaged_vehicle_ejb.addAsManifestResource(ejbResURL, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL = Client2.class.getResource("//vehicle/appmanaged/appmanaged_vehicle_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL != null) {
              jpa_core_annotations_mapkey_appmanaged_vehicle_ejb.addAsManifestResource(ejbResURL, "sun-ejb-jar.xml");
            }
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_annotations_mapkey_appmanaged_vehicle_ejb, Client2.class, ejbResURL);

...
public class Client2PuservletTest extends ee.jakarta.tck.persistence.core.annotations.ordercolumn.Client2 {
    static final String VEHICLE_ARCHIVE = "jpa_core_annotations_ordercolumn_puservlet_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client2.class.getResource("/com/sun/ts/tests/jpa/core/annotations/ordercolumn/jpa_core_annotations_ordercolumn.jar");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(jpa_core_annotations_ordercolumn_puservlet_vehicle_web, Client2.class, warResURL);

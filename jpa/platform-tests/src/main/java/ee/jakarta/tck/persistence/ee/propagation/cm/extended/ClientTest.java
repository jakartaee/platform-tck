    ...
    /**
        ...
        */
        ...
        // Par
            ...
            if(mappingURL != null) {
              jpa_ee_propagation_cm_ext.addAsManifestResource(mappingURL, "myMappingFile.xml");
            }
            mappingURL = Client.class.getResource("myMappingFile1.xml");
            if(mappingURL != null) {
              jpa_ee_propagation_cm_ext.addAsManifestResource(mappingURL, "myMappingFile1.xml");
            }
            mappingURL = Client.class.getResource("myMappingFile2.xml");
            if(mappingURL != null) {
              jpa_ee_propagation_cm_ext.addAsManifestResource(mappingURL, "myMappingFile2.xml");
            }

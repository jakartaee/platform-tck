...
public class Client1Stateful3Test extends ee.jakarta.tck.persistence.core.criteriaapi.misc.Client1 {
    static final String VEHICLE_ARCHIVE = "jpa_core_criteriaapi_misc_stateful3_vehicle";
        ...
        */
        ...
        // Client
            ...
            JavaArchive jpa_core_criteriaapi_misc_stateful3_vehicle_client = ShrinkWrap.create(JavaArchive.class, "jpa_core_criteriaapi_misc_stateful3_vehicle_client.jar");
            // The class files
            ...
            jpa_core_criteriaapi_misc_stateful3_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: com.sun.ts.tests.common.vehicle.VehicleClient\n"), "MANIFEST.MF");
            // Call the archive processor
            archiveProcessor.processClientArchive(jpa_core_criteriaapi_misc_stateful3_vehicle_client, Client1.class, resURL);
        ...
        // Ejb 1
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_criteriaapi_misc_stateful3_vehicle_ejb, Client1.class, ejbResURL1);

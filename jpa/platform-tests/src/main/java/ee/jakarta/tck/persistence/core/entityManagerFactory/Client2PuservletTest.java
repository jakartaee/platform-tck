...
public class Client2PuservletTest extends ee.jakarta.tck.persistence.core.entityManagerFactory.Client2 {
    static final String VEHICLE_ARCHIVE = "jpa_core_entityManagerFactory_puservlet_vehicle";
        ...
        */
        ...
        // War
           ...
           archiveProcessor.processWebArchive(jpa_core_entityManagerFactory_puservlet_vehicle_web, Client2.class, warResURL);

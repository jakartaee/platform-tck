...
import ee.jakarta.tck.persistence.core.query.flushmode.Client1;
import java.net.URL;
...
public class Client1Stateless3Test extends ee.jakarta.tck.persistence.core.query.flushmode.Client1 {
    static final String VEHICLE_ARCHIVE = "jpa_core_query_flushmode_stateless3_vehicle";
        ...
        */
        ...
        // Client
            ...
            jpa_core_query_flushmode_stateless3_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + Client1.class.getName() + "\n"), "MANIFEST.MF");
            archiveProcessor.processClientArchive(jpa_core_query_flushmode_stateless3_vehicle_client, Client1.class, resURL);
        ...
        // Ejb
            ...
            jpa_core_query_flushmode_stateless3_vehicle_ejb.addClasses(
                ...
                com.sun.ts.tests.common.vehicle.VehicleRunnable.class,
                com.sun.ts.tests.common.vehicle.ejb3share.UserTransactionWrapper.class,
                ee.jakarta.tck.persistence.core.query.flushmode.Client1.class,
            ...
            archiveProcessor.processEjbArchive(jpa_core_query_flushmode_stateless3_vehicle_ejb, Client1.class, ejbResURL);
        ...
        // Ear
            ...
            URL earResURL = Client1.class.getResource("/com/sun/ts/tests/jpa/core/query/flushmode/");
            if(earResURL != null) {
              jpa_core_query_flushmode_vehicles_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client1.class.getResource("/com/sun/ts/tests/jpa/core/query/flushmode/.ear.sun-application.xml");
            if(earResURL != null) {
        ...
        public void flushModeTest1() throws java.lang.Exception {
            super.flushModeTest1();
        }

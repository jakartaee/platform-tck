...
public class Client1Stateful3Test extends ee.jakarta.tck.persistence.core.types.generator.Client1 {
    static final String VEHICLE_ARCHIVE = "jpa_core_types_generator_stateful3_vehicle";
        ...
        */
        ...
        // Client
            ...
            jpa_core_types_generator_stateful3_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + Client1.class.getName() + "\n"), "MANIFEST.MF");
            // Call the archive processor
            archiveProcessor.processClientArchive(jpa_core_types_generator_stateful3_vehicle_client, Client1.class, resURL);
        ...
        // Ejb
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_types_generator_stateful3_vehicle_ejb, Client1.class, ejbResURL);
        ...
        // Ear
            ...
            URL earResURL = Client1.class.getResource("/com/sun/ts/tests/jpa/core/types/generator/");
            if(earResURL != null) {
              jpa_core_types_generator_vehicles_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client1.class.getResource("/com/sun/ts/tests/jpa/core/types/generator/.ear.sun-application.xml");
            if(earResURL != null) {

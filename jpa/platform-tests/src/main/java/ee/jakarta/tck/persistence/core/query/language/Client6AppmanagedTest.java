...
public class Client6AppmanagedTest extends ee.jakarta.tck.persistence.core.query.language.Client6 {
    static final String VEHICLE_ARCHIVE = "jpa_core_query_language_appmanaged_vehicle";
        ...
        */
        ...
        // Client
            ...
            jpa_core_query_language_appmanaged_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: com.sun.ts.tests.common.vehicle.VehicleClient\n"), "MANIFEST.MF");
            // Call the archive processor
            archiveProcessor.processClientArchive(jpa_core_query_language_appmanaged_vehicle_client, Client6.class, resURL);
        ...
        // Ejb 1
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_query_language_appmanaged_vehicle_ejb, Client6.class, ejbResURL1);

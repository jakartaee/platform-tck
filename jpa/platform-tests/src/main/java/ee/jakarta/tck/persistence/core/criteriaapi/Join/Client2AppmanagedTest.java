    ...
    static final String VEHICLE_ARCHIVE = "jpa_core_criteriaapi_Join_appmanaged_vehicle";
        ...
        */
        ...
        // Client
            ...
            jpa_core_criteriaapi_Join_appmanaged_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + Client2.class.getName() + "\n"), "MANIFEST.MF");
            // Call the archive processor
            archiveProcessor.processClientArchive(jpa_core_criteriaapi_Join_appmanaged_vehicle_client, Client2.class, resURL);
        ...
        // Ejb
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_criteriaapi_Join_appmanaged_vehicle_ejb, Client2.class, ejbResURL);

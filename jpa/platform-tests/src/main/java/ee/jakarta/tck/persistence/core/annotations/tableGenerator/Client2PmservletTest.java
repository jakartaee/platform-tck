...
public class Client2PmservletTest extends ee.jakarta.tck.persistence.core.annotations.tableGenerator.Client2 {
    static final String VEHICLE_ARCHIVE = "jpa_core_annotations_tableGenerator_pmservlet_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client2.class.getResource("/com/sun/ts/tests/jpa/core/annotations/tableGenerator/jpa_core_annotations_tableGenerator.jar");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(jpa_core_annotations_tableGenerator_pmservlet_vehicle_web, Client2.class, warResURL);

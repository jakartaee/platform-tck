...
import ee.jakarta.tck.persistence.core.query.apitests.Client2;
import java.net.URL;
...
public class Client2AppmanagednotxTest extends ee.jakarta.tck.persistence.core.query.apitests.Client2 {
    static final String VEHICLE_ARCHIVE = "jpa_core_query_apitests_appmanagedNoTx_vehicle";
        ...
        */
        ...
        // Client
            ...
            JavaArchive jpa_core_query_apitests_appmanagedNoTx_vehicle_client = ShrinkWrap.create(JavaArchive.class, "jpa_core_query_apitests_appmanagedNoTx_vehicle_client.jar");
            // The class files
            ...
            jpa_core_query_apitests_appmanagedNoTx_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + Client2.class.getName() + "\n"), "MANIFEST.MF");
            // Call the archive processor
            archiveProcessor.processClientArchive(jpa_core_query_apitests_appmanagedNoTx_vehicle_client, Client2.class, resURL);
        ...
        // Ejb
            ...
            jpa_core_query_apitests_appmanagedNoTx_vehicle_ejb.addClasses(
                ee.jakarta.tck.persistence.core.query.apitests.Client2.class,
            ...
            if(ejbResURL != null) {
              jpa_core_query_apitests_appmanagedNoTx_vehicle_ejb.addAsManifestResource(ejbResURL, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL = Client2.class.getResource("//vehicle/appmanagedNoTx/appmanagedNoTx_vehicle_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL != null) {
              jpa_core_query_apitests_appmanagedNoTx_vehicle_ejb.addAsManifestResource(ejbResURL, "sun-ejb-jar.xml");
            }
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_query_apitests_appmanagedNoTx_vehicle_ejb, Client2.class, ejbResURL);
        ...
        // Par
            ...
            // Call the archive processor
            archiveProcessor.processParArchive(jpa_core_query_apitests, Client2.class, parURL);
            // The orm.xml file
        ...
        // Ear
            ...
            URL earResURL = Client2.class.getResource("/com/sun/ts/tests/jpa/core/query/apitests/");
            if(earResURL != null) {
              jpa_core_query_apitests_vehicles_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client2.class.getResource("/com/sun/ts/tests/jpa/core/query/apitests/.ear.sun-application.xml");
            if(earResURL != null) {
              jpa_core_query_apitests_vehicles_ear.addAsManifestResource(earResURL, "sun-application.xml");
            }
            // Call the archive processor
            archiveProcessor.processEarArchive(jpa_core_query_apitests_vehicles_ear, Client2.class, earResURL);
        ...
        public void getParameterIntIllegalArgumentException2Test() throws java.lang.Exception {
            super.getParameterIntIllegalArgumentException2Test();
        }

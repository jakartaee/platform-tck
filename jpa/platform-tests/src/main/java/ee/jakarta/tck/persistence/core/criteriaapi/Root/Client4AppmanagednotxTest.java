...
public class Client4AppmanagednotxTest extends ee.jakarta.tck.persistence.core.criteriaapi.Root.Client4 {
    static final String VEHICLE_ARCHIVE = "jpa_core_criteriaapi_Root_appmanagedNoTx_vehicle";
        ...
        */
        ...
        // Client
            ...
            jpa_core_criteriaapi_Root_appmanagedNoTx_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + Client4.class.getName() + "\n"), "MANIFEST.MF");
            archiveProcessor.processClientArchive(jpa_core_criteriaapi_Root_appmanagedNoTx_vehicle_client, Client4.class, resURL);
        ...
        // Ejb
            ...
            archiveProcessor.processEjbArchive(jpa_core_criteriaapi_Root_appmanagedNoTx_vehicle_ejb, Client4.class, ejbResURL);
        ...
        // Ear
            ...
            URL earResURL = Client4.class.getResource("/com/sun/ts/tests/jpa/core/criteriaapi/Root/");
            if(earResURL != null) {
              jpa_core_criteriaapi_Root_vehicles_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client4.class.getResource("/com/sun/ts/tests/jpa/core/criteriaapi/Root/.ear.sun-application.xml");
            if(earResURL != null) {

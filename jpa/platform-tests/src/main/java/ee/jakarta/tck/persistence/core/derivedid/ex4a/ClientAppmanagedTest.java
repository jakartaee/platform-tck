    ...
    static final String VEHICLE_ARCHIVE = "jpa_core_deriverdid_ex4a_appmanaged_vehicle";
        ...
        */
        ...
        // Client
            ...
            JavaArchive jpa_core_deriverdid_ex4a_appmanaged_vehicle_client = ShrinkWrap.create(JavaArchive.class, "jpa_core_deriverdid_ex4a_vehicles_client.jar");
            // The class files
            ...
            if(resURL != null) {
              jpa_core_deriverdid_ex4a_appmanaged_vehicle_client.addAsManifestResource(resURL, "sun-application-client.xml");
            }

    ...
    static final String VEHICLE_ARCHIVE = "jpa_core_criteriaapi_metamodelquery_stateful3_vehicle";
        ...
        */
        ...
        // Client
            ...
            jpa_core_criteriaapi_metamodelquery_stateful3_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + Client7.class.getName() + "\n"), "MANIFEST.MF");
        ...
        // Ejb
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_criteriaapi_metamodelquery_stateful3_vehicle_ejb, Client7.class, ejbResURL);
        ...
        // Ear
            ...
            URL earResURL = Client7.class.getResource("/com/sun/ts/tests/jpa/core/criteriaapi/metamodelquery/");
            if(earResURL != null) {
              jpa_core_criteriaapi_metamodelquery_vehicles_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client7.class.getResource("/com/sun/ts/tests/jpa/core/criteriaapi/metamodelquery/.ear.sun-application.xml");
            if(earResURL != null) {

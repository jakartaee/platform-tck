...
public class Client1Stateless3Test extends ee.jakarta.tck.persistence.core.annotations.basic.Client1 {
    static final String VEHICLE_ARCHIVE = "jpa_core_annotations_basic_stateless3_vehicle";
        ...
        */
        ...
        // Ejb 1
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_annotations_basic_stateless3_vehicle_ejb, Client1.class, ejbResURL1);

...
public class Client2AppmanagednotxTest extends ee.jakarta.tck.persistence.core.criteriaapi.misc.Client2 {
    static final String VEHICLE_ARCHIVE = "jpa_core_criteriaapi_misc_appmanagedNoTx_vehicle";
        ...
        */
        ...
        // Client
            ...
            jpa_core_criteriaapi_misc_appmanagedNoTx_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: com.sun.ts.tests.common.vehicle.VehicleClient\n"), "MANIFEST.MF");
            // Call the archive processor
            archiveProcessor.processClientArchive(jpa_core_criteriaapi_misc_appmanagedNoTx_vehicle_client, Client2.class, resURL);
        ...
        // Ejb 1
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_criteriaapi_misc_appmanagedNoTx_vehicle_ejb, Client2.class, ejbResURL1);

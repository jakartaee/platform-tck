...
public class Client4Stateful3Test extends ee.jakarta.tck.persistence.core.criteriaapi.Root.Client4 {
    static final String VEHICLE_ARCHIVE = "jpa_core_criteriaapi_Root_stateful3_vehicle";
        ...
        */
        ...
        // Client
            ...
            jpa_core_criteriaapi_Root_stateful3_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + Client4.class.getName() + "\n"), "MANIFEST.MF");
            // Call the archive processor
            archiveProcessor.processClientArchive(jpa_core_criteriaapi_Root_stateful3_vehicle_client, Client4.class, resURL);
        ...
        // Ejb
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_criteriaapi_Root_stateful3_vehicle_ejb, Client4.class, ejbResURL);

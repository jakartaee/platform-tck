...
public class Client1Stateless3Test extends ee.jakarta.tck.persistence.core.annotations.tableGenerator.Client1 {
    static final String VEHICLE_ARCHIVE = "jpa_core_annotations_tableGenerator_stateless3_vehicle";
        ...
        */
        ...
        // Client
            ...
            jpa_core_annotations_tableGenerator_stateless3_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + Client1.class.getName() + "\n"), "MANIFEST.MF");
            archiveProcessor.processClientArchive(jpa_core_annotations_tableGenerator_stateless3_vehicle_client, Client1.class, resURL);
        ...
        // Ejb
            ...
            archiveProcessor.processEjbArchive(jpa_core_annotations_tableGenerator_stateless3_vehicle_ejb, Client1.class, ejbResURL);

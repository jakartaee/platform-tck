...
public class Client1PmservletTest extends ee.jakarta.tck.persistence.core.query.parameter.Client1 {
    static final String VEHICLE_ARCHIVE = "jpa_core_query_parameter_pmservlet_vehicle";
        ...
        */
        ...
        // War
            ...
            // The class files
            jpa_core_query_parameter_pmservlet_vehicle_web.addClasses(
            ...
            // Web content
            warResURL = Client1.class.getResource("/com/sun/ts/tests/jpa/core/query/parameter/jpa_core_query_parameter.jar");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(jpa_core_query_parameter_pmservlet_vehicle_web, Client1.class, warResURL);

...
public class Client3Stateless3Test extends ee.jakarta.tck.persistence.core.annotations.version.Client3 {
    static final String VEHICLE_ARCHIVE = "jpa_core_annotations_version_stateless3_vehicle";
        ...
        */
        ...
        // Client
            ...
            JavaArchive jpa_core_annotations_version_stateless3_vehicle_client = ShrinkWrap.create(JavaArchive.class, "jpa_core_annotations_version_stateless3_vehicle_client.jar");
            // The class files
            jpa_core_annotations_version_stateless3_vehicle_client.addClasses(
            ...
            if(resURL != null) {
              jpa_core_annotations_version_stateless3_vehicle_client.addAsManifestResource(resURL, "application-client.xml");
            }
            ...
            jpa_core_annotations_version_stateless3_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: com.sun.ts.tests.common.vehicle.VehicleClient\n"), "MANIFEST.MF");
            // Call the archive processor
            archiveProcessor.processClientArchive(jpa_core_annotations_version_stateless3_vehicle_client, Client3.class, resURL);

        // Ejb 1
            // the jar with the correct archive name
            JavaArchive jpa_core_annotations_version_stateless3_vehicle_ejb = ShrinkWrap.create(JavaArchive.class, "jpa_core_annotations_version_stateless3_vehicle_ejb.jar");
            // The class files
            jpa_core_annotations_version_stateless3_vehicle_ejb.addClasses(
            ...
            if(ejbResURL1 != null) {
              jpa_core_annotations_version_stateless3_vehicle_ejb.addAsManifestResource(ejbResURL1, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL1 = Client3.class.getResource("//vehicle/stateless3/stateless3_vehicle_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL1 != null) {
              jpa_core_annotations_version_stateless3_vehicle_ejb.addAsManifestResource(ejbResURL1, "sun-ejb-jar.xml");
            }
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_annotations_version_stateless3_vehicle_ejb, Client3.class, ejbResURL1);
        ...
        // Ear
            ...
            jpa_core_annotations_version_vehicles_ear.addAsModule(jpa_core_annotations_version_stateless3_vehicle_ejb);
            jpa_core_annotations_version_vehicles_ear.addAsModule(jpa_core_annotations_version_stateless3_vehicle_client);

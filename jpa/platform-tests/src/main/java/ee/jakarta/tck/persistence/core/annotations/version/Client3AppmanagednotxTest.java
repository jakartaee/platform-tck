...
import ee.jakarta.tck.persistence.core.annotations.version.Client3;
import java.net.URL;
...
public class Client3AppmanagednotxTest extends ee.jakarta.tck.persistence.core.annotations.version.Client3 {
    static final String VEHICLE_ARCHIVE = "jpa_core_annotations_version_appmanagedNoTx_vehicle";
        ...
        */
        ...
        // Client
            ...
            JavaArchive jpa_core_annotations_version_appmanagedNoTx_vehicle_client = ShrinkWrap.create(JavaArchive.class, "jpa_core_annotations_version_appmanagedNoTx_vehicle_client.jar");
            // The class files
            jpa_core_annotations_version_appmanagedNoTx_vehicle_client.addClasses(
            ...
            if(resURL != null) {
              jpa_core_annotations_version_appmanagedNoTx_vehicle_client.addAsManifestResource(resURL, "application-client.xml");
            }
            ...
            jpa_core_annotations_version_appmanagedNoTx_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: com.sun.ts.tests.common.vehicle.VehicleClient\n"), "MANIFEST.MF");
            // Call the archive processor
            archiveProcessor.processClientArchive(jpa_core_annotations_version_appmanagedNoTx_vehicle_client, Client3.class, resURL);

        // Ejb 1
            // the jar with the correct archive name
            JavaArchive jpa_core_annotations_version_appmanagedNoTx_vehicle_ejb = ShrinkWrap.create(JavaArchive.class, "jpa_core_annotations_version_appmanagedNoTx_vehicle_ejb.jar");
            // The class files
            jpa_core_annotations_version_appmanagedNoTx_vehicle_ejb.addClasses(
                ...
                ee.jakarta.tck.persistence.common.PMClientBase.class,
                com.sun.ts.tests.common.vehicle.VehicleRunnable.class,
                ee.jakarta.tck.persistence.core.annotations.version.Client3.class,
                com.sun.ts.tests.common.vehicle.ejb3share.UserTransactionWrapper.class,
                com.sun.ts.lib.harness.EETest.class,
                com.sun.ts.lib.harness.ServiceEETest.class,
                com.sun.ts.tests.common.vehicle.ejb3share.EntityTransactionWrapper.class,
            ...
            if(ejbResURL1 != null) {
              jpa_core_annotations_version_appmanagedNoTx_vehicle_ejb.addAsManifestResource(ejbResURL1, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL1 = Client3.class.getResource("//vehicle/appmanagedNoTx/appmanagedNoTx_vehicle_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL1 != null) {
              jpa_core_annotations_version_appmanagedNoTx_vehicle_ejb.addAsManifestResource(ejbResURL1, "sun-ejb-jar.xml");
            }
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_annotations_version_appmanagedNoTx_vehicle_ejb, Client3.class, ejbResURL1);
        ...
        // Par
            ...
            if(mappingURL != null) {
              jpa_core_annotations_version.addAsManifestResource(mappingURL, "myMappingFile.xml");
            }
            mappingURL = Client3.class.getResource("myMappingFile1.xml");
            if(mappingURL != null) {
              jpa_core_annotations_version.addAsManifestResource(mappingURL, "myMappingFile1.xml");
            }
            mappingURL = Client3.class.getResource("myMappingFile2.xml");
            if(mappingURL != null) {
              jpa_core_annotations_version.addAsManifestResource(mappingURL, "myMappingFile2.xml");
            }

            // Call the archive processor
            archiveProcessor.processParArchive(jpa_core_annotations_version, Client3.class, parURL);
        ...
        // Ear
            ...
            jpa_core_annotations_version_vehicles_ear.addAsModule(jpa_core_annotations_version_appmanagedNoTx_vehicle_ejb);
            jpa_core_annotations_version_vehicles_ear.addAsModule(jpa_core_annotations_version_appmanagedNoTx_vehicle_client);
            ...
            // Call the archive processor
            archiveProcessor.processEarArchive(jpa_core_annotations_version_vehicles_ear, Client3.class, earResURL);
        ...
        public void longFieldTest() throws java.lang.Exception {
            super.longFieldTest();
        }
        ...
        @Override
        @TargetVehicle("appmanagedNoTx")
        public void longPropertyTest() throws java.lang.Exception {
            super.longPropertyTest();
        }

        @Test
        @Override
        @TargetVehicle("appmanagedNoTx")
        public void longClassFieldTest() throws java.lang.Exception {
            super.longClassFieldTest();
        }

        @Test
        @Override
        @TargetVehicle("appmanagedNoTx")
        public void longClassPropertyTest() throws java.lang.Exception {
            super.longClassPropertyTest();
        }

      ...
      s.exit();
        ...
        */
        ...
        // Client
            ...
            JavaArchive jpa_core_relationship_bidirmanyxmany_appmanagedNoTx_vehicle_client = ShrinkWrap.create(JavaArchive.class, "jpa_core_relationship_bidirmanyxmany_vehicles_client.jar");
            // The class files
            ...
            if(resURL != null) {
              jpa_core_relationship_bidirmanyxmany_appmanagedNoTx_vehicle_client.addAsManifestResource(resURL, "sun-application-client.xml");
            }

    ...
    static final String VEHICLE_ARCHIVE = "jpa_core_criteriaapi_From_stateless3_vehicle";
        ...
        */
        ...
        // Client
            ...
            jpa_core_criteriaapi_From_stateless3_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: com.sun.ts.tests.common.vehicle.VehicleClient\n"), "MANIFEST.MF");
        ...
        // Ejb 1
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_criteriaapi_From_stateless3_vehicle_ejb, Client3.class, ejbResURL1);

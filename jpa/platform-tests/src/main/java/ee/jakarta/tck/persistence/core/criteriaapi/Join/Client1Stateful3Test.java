...
import ee.jakarta.tck.persistence.core.criteriaapi.Join.Client1;
import java.net.URL;
...
public class Client1Stateful3Test extends ee.jakarta.tck.persistence.core.criteriaapi.Join.Client1 {
    static final String VEHICLE_ARCHIVE = "jpa_core_criteriaapi_Join_stateful3_vehicle";
        ...
        */
        ...
        // Client
            ...
            jpa_core_criteriaapi_Join_stateful3_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + Client1.class.getName() + "\n"), "MANIFEST.MF");
            archiveProcessor.processClientArchive(jpa_core_criteriaapi_Join_stateful3_vehicle_client, Client1.class, resURL);
        ...
        // Ejb
            ...
            archiveProcessor.processEjbArchive(jpa_core_criteriaapi_Join_stateful3_vehicle_ejb, Client1.class, ejbResURL);
        ...
        // Ear
            ...
            URL earResURL = Client1.class.getResource("/com/sun/ts/tests/jpa/core/criteriaapi/Join/");
            if(earResURL != null) {
              jpa_core_criteriaapi_Join_vehicles_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client1.class.getResource("/com/sun/ts/tests/jpa/core/criteriaapi/Join/.ear.sun-application.xml");
            if(earResURL != null) {

...
public class Client3AppmanagedTest extends ee.jakarta.tck.persistence.core.entityManager.Client3 {
    static final String VEHICLE_ARCHIVE = "jpa_core_entityManager_appmanaged_vehicle";
        ...
        */
        ...
        // Ejb
            ...
            if(ejbResURL != null) {
              jpa_core_entityManager_appmanaged_vehicle_ejb.addAsManifestResource(ejbResURL, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL = Client3.class.getResource("//vehicle/appmanaged/appmanaged_vehicle_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL != null) {
              jpa_core_entityManager_appmanaged_vehicle_ejb.addAsManifestResource(ejbResURL, "sun-ejb-jar.xml");
            }
            archiveProcessor.processEjbArchive(jpa_core_entityManager_appmanaged_vehicle_ejb, Client3.class, ejbResURL);

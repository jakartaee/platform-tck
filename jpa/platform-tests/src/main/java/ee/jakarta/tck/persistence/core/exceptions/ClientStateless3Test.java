    ...
    static final String VEHICLE_ARCHIVE = "jpa_core_exceptions_stateless3_vehicle";
        ...
        */
        ...
        // Ejb
            ...
            if(ejbResURL != null) {
              jpa_core_exceptions_stateless3_vehicle_ejb.addAsManifestResource(ejbResURL, "ejb-jar.xml");
            }
        ...
        // Ear
            ...
            URL earResURL = Client.class.getResource("/com/sun/ts/tests/jpa/core/exceptions/");
            if(earResURL != null) {
              jpa_core_exceptions_vehicles_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client.class.getResource("/com/sun/ts/tests/jpa/core/exceptions/.ear.sun-application.xml");
            if(earResURL != null) {

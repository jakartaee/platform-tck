    ...
    static final String VEHICLE_ARCHIVE = "jpa_core_annotations_ordercolumn_appmanagedNoTx_vehicle";
        ...
        */
        ...
        // Client
            ...
            jpa_core_annotations_ordercolumn_appmanagedNoTx_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + Client2.class.getName() + "\n"), "MANIFEST.MF");
        ...
        // Ejb
            ...
            if(ejbResURL != null) {
              jpa_core_annotations_ordercolumn_appmanagedNoTx_vehicle_ejb.addAsManifestResource(ejbResURL, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL = Client2.class.getResource("//vehicle/appmanagedNoTx/appmanagedNoTx_vehicle_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL != null) {
              jpa_core_annotations_ordercolumn_appmanagedNoTx_vehicle_ejb.addAsManifestResource(ejbResURL, "sun-ejb-jar.xml");
            }
            archiveProcessor.processEjbArchive(jpa_core_annotations_ordercolumn_appmanagedNoTx_vehicle_ejb, Client2.class, ejbResURL);
        ...
        // Ear
            ...
            URL earResURL = Client2.class.getResource("/com/sun/ts/tests/jpa/core/annotations/ordercolumn/");
            if(earResURL != null) {
              jpa_core_annotations_ordercolumn_vehicles_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client2.class.getResource("/com/sun/ts/tests/jpa/core/annotations/ordercolumn/.ear.sun-application.xml");
            if(earResURL != null) {

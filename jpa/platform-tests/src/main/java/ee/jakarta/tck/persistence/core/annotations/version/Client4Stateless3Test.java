...
public class Client4Stateless3Test extends ee.jakarta.tck.persistence.core.annotations.version.Client4 {
    static final String VEHICLE_ARCHIVE = "jpa_core_annotations_version_stateless3_vehicle";
        ...
        */
        ...
        // Client
            ...
            jpa_core_annotations_version_stateless3_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + Client4.class.getName() + "\n"), "MANIFEST.MF");
            archiveProcessor.processClientArchive(jpa_core_annotations_version_stateless3_vehicle_client, Client4.class, resURL);
        ...
        // Ejb
            ...
            URL ejbResURL = Client4.class.getResource("//vehicle/stateless3/stateless3_vehicle_ejb.xml");
            if(ejbResURL != null) {
              jpa_core_annotations_version_stateless3_vehicle_ejb.addAsManifestResource(ejbResURL, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL = Client4.class.getResource("//vehicle/stateless3/stateless3_vehicle_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL != null) {
              jpa_core_annotations_version_stateless3_vehicle_ejb.addAsManifestResource(ejbResURL, "sun-ejb-jar.xml");
            }
            archiveProcessor.processEjbArchive(jpa_core_annotations_version_stateless3_vehicle_ejb, Client4.class, ejbResURL);

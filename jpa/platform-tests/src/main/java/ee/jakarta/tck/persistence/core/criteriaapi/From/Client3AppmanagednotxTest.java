...
public class Client3AppmanagednotxTest extends ee.jakarta.tck.persistence.core.criteriaapi.From.Client3 {
    static final String VEHICLE_ARCHIVE = "jpa_core_criteriaapi_From_appmanagedNoTx_vehicle";
        ...
        */
        ...
        // Client
            ...
            JavaArchive jpa_core_criteriaapi_From_appmanagedNoTx_vehicle_client = ShrinkWrap.create(JavaArchive.class, "jpa_core_criteriaapi_From_appmanagedNoTx_vehicle_client.jar");
            // The class files
            jpa_core_criteriaapi_From_appmanagedNoTx_vehicle_client.addClasses(
            ...
            if(resURL != null) {
              jpa_core_criteriaapi_From_appmanagedNoTx_vehicle_client.addAsManifestResource(resURL, "application-client.xml");
            }
            ...
            jpa_core_criteriaapi_From_appmanagedNoTx_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + Client3.class.getName() + "\n"), "MANIFEST.MF");
            archiveProcessor.processClientArchive(jpa_core_criteriaapi_From_appmanagedNoTx_vehicle_client, Client3.class, resURL);


        // Ejb
            // the jar with the correct archive name
            JavaArchive jpa_core_criteriaapi_From_appmanagedNoTx_vehicle_ejb = ShrinkWrap.create(JavaArchive.class, "jpa_core_criteriaapi_From_appmanagedNoTx_vehicle_ejb.jar");
            // The class files
            jpa_core_criteriaapi_From_appmanagedNoTx_vehicle_ejb.addClasses(
            ...
            if(ejbResURL != null) {
              jpa_core_criteriaapi_From_appmanagedNoTx_vehicle_ejb.addAsManifestResource(ejbResURL, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL = Client3.class.getResource("//vehicle/appmanagedNoTx/appmanagedNoTx_vehicle_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL != null) {
              jpa_core_criteriaapi_From_appmanagedNoTx_vehicle_ejb.addAsManifestResource(ejbResURL, "sun-ejb-jar.xml");
            }
            archiveProcessor.processEjbArchive(jpa_core_criteriaapi_From_appmanagedNoTx_vehicle_ejb, Client3.class, ejbResURL);
        ...
        // Ear
            ...
            jpa_core_criteriaapi_From_vehicles_ear.addAsModule(jpa_core_criteriaapi_From_appmanagedNoTx_vehicle_ejb);
            jpa_core_criteriaapi_From_vehicles_ear.addAsModule(jpa_core_criteriaapi_From_appmanagedNoTx_vehicle_client);
            ...
            URL earResURL = Client3.class.getResource("/com/sun/ts/tests/jpa/core/criteriaapi/From/");
            if(earResURL != null) {
              jpa_core_criteriaapi_From_vehicles_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client3.class.getResource("/com/sun/ts/tests/jpa/core/criteriaapi/From/.ear.sun-application.xml");
            if(earResURL != null) {

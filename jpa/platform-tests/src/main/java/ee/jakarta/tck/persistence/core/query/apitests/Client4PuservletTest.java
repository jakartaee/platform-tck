...
public class Client4PuservletTest extends ee.jakarta.tck.persistence.core.query.apitests.Client4 {
    static final String VEHICLE_ARCHIVE = "jpa_core_query_apitests_puservlet_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client4.class.getResource("/com/sun/ts/tests/jpa/core/query/apitests/jpa_core_query_apitests.jar");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(jpa_core_query_apitests_puservlet_vehicle_web, Client4.class, warResURL);

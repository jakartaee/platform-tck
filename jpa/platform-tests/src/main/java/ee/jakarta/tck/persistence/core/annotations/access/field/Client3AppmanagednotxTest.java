...
public class Client3AppmanagednotxTest extends ee.jakarta.tck.persistence.core.annotations.access.field.Client3 {
    static final String VEHICLE_ARCHIVE = "jpa_core_annotations_access_field_appmanagedNoTx_vehicle";
        ...
        */
        ...
        // Ejb
            // the jar with the correct archive name
            JavaArchive jpa_core_annotations_access_field_appmanagedNoTx_vehicle_ejb = ShrinkWrap.create(JavaArchive.class, "jpa_core_annotations_access_field_appmanagedNoTx_vehicle_ejb.jar");
            // The class files
            jpa_core_annotations_access_field_appmanagedNoTx_vehicle_ejb.addClasses(
            ...
            if(ejbResURL != null) {
              jpa_core_annotations_access_field_appmanagedNoTx_vehicle_ejb.addAsManifestResource(ejbResURL, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL = Client3.class.getResource("//vehicle/appmanagedNoTx/appmanagedNoTx_vehicle_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL != null) {
              jpa_core_annotations_access_field_appmanagedNoTx_vehicle_ejb.addAsManifestResource(ejbResURL, "sun-ejb-jar.xml");
            }
            archiveProcessor.processEjbArchive(jpa_core_annotations_access_field_appmanagedNoTx_vehicle_ejb, Client3.class, ejbResURL);
        ...
        // Ear
            ...
            jpa_core_annotations_access_field_vehicles_ear.addAsModule(jpa_core_annotations_access_field_appmanagedNoTx_vehicle_ejb);
            jpa_core_annotations_access_field_vehicles_ear.addAsModule(jpa_core_annotations_access_field_appmanagedNoTx_vehicle_client);
            ...
            URL earResURL = Client3.class.getResource("/com/sun/ts/tests/jpa/core/annotations/access/field/");
            if(earResURL != null) {
              jpa_core_annotations_access_field_vehicles_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client3.class.getResource("/com/sun/ts/tests/jpa/core/annotations/access/field/.ear.sun-application.xml");
            if(earResURL != null) {

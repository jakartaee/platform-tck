    ...
    static final String VEHICLE_ARCHIVE = "jpa_core_annotations_nativequery_puservlet_vehicle";
        ...
        */
        ...
        // War
            ...
            if(warResURL != null) {
              jpa_core_annotations_nativequery_puservlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/lib/jpa_core_annotations_nativequery.jar");
            }
            warResURL = Client.class.getResource("/com/sun/ts/tests/common/vehicle/puservlet/puservlet_vehicle_web.xml");
            if(warResURL != null) {
              jpa_core_annotations_nativequery_puservlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/puservlet_vehicle_web.xml");
            }

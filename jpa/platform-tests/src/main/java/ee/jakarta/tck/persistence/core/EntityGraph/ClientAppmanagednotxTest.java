    ...
    static final String VEHICLE_ARCHIVE = "jpa_core_EntityGraph_appmanagedNoTx_vehicle";
        ...
        */
        ...
        // Ejb 1
            ...
            // The class files
            jpa_core_EntityGraph_appmanagedNoTx_vehicle_ejb.addClasses(
        ...
        // Par
            ...
            if(mappingURL != null) {
              jpa_core_EntityGraph.addAsManifestResource(mappingURL, "myMappingFile.xml");
            }
            mappingURL = Client.class.getResource("myMappingFile1.xml");
            if(mappingURL != null) {
              jpa_core_EntityGraph.addAsManifestResource(mappingURL, "myMappingFile1.xml");
            }
            mappingURL = Client.class.getResource("myMappingFile2.xml");
            if(mappingURL != null) {
              jpa_core_EntityGraph.addAsManifestResource(mappingURL, "myMappingFile2.xml");
            }
        ...
        // Ear
            ...
            jpa_core_EntityGraph_vehicles_ear.addAsModule(jpa_core_EntityGraph_appmanagedNoTx_vehicle_ejb);
            jpa_core_EntityGraph_vehicles_ear.addAsModule(jpa_core_EntityGraph_appmanagedNoTx_vehicle_client);

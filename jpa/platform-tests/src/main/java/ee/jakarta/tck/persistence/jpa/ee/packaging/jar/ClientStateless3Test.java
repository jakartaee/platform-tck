    ...
    static final String VEHICLE_ARCHIVE = "jpa_ee_packaging_jar_stateless3_vehicle";
        ...
        */
        ...
        // Client
            ...
            JavaArchive jpa_ee_packaging_jar_stateless3_vehicle_client = ShrinkWrap.create(JavaArchive.class, "jpa_ee_packaging_jar_stateless3_vehicle_client.jar");
            // The class files
        ...
        // Ejb
            ...
            if(ejbResURL != null) {
              jpa_ee_packaging_jar_stateless3_vehicle_ejb.addAsManifestResource(ejbResURL, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL = Client.class.getResource("//vehicle/stateless3/stateless3_vehicle_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL != null) {
              jpa_ee_packaging_jar_stateless3_vehicle_ejb.addAsManifestResource(ejbResURL, "sun-ejb-jar.xml");
            }
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_ee_packaging_jar_stateless3_vehicle_ejb, Client.class, ejbResURL);

...
import ee.jakarta.tck.persistence.core.criteriaapi.CriteriaBuilder.Client8;
import java.net.URL;
...
public class Client8Stateful3Test extends ee.jakarta.tck.persistence.core.criteriaapi.CriteriaBuilder.Client8 {
    static final String VEHICLE_ARCHIVE = "jpa_core_criteriapia_CriteriaBuilder_stateful3_vehicle";
        ...
        */
        ...
        // Client
            ...
            JavaArchive jpa_core_criteriapia_CriteriaBuilder_stateful3_vehicle_client = ShrinkWrap.create(JavaArchive.class, "jpa_core_criteriapia_CriteriaBuilder_vehicles_client.jar");
            // The class files
            ...
            resURL = Client8.class.getResource("//com/sun/ts/tests/common/vehicle/stateful3/stateful3_vehicle_client.jar.sun-application-client.xml");
            if(resURL != null) {
              jpa_core_criteriapia_CriteriaBuilder_stateful3_vehicle_client.addAsManifestResource(resURL, "sun-application-client.xml");
            }
            jpa_core_criteriapia_CriteriaBuilder_stateful3_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + Client8.class.getName() + "\n"), "MANIFEST.MF");
            // Call the archive processor
            archiveProcessor.processClientArchive(jpa_core_criteriapia_CriteriaBuilder_stateful3_vehicle_client, Client8.class, resURL);
        ...
        // Ejb 1
            ...
            jpa_core_criteriapia_CriteriaBuilder_stateful3_vehicle_ejb.addClasses(
                ...
                com.sun.ts.tests.common.vehicle.stateful3.Stateful3VehicleIF.class,
                com.sun.ts.tests.common.vehicle.ejb3share.UserTransactionWrapper.class,
                ee.jakarta.tck.persistence.core.criteriaapi.CriteriaBuilder.Client8.class,
                com.sun.ts.lib.harness.EETest.class,
                com.sun.ts.lib.harness.ServiceEETest.class,
                com.sun.ts.tests.common.vehicle.ejb3share.EntityTransactionWrapper.class,
                com.sun.ts.lib.harness.EETest.SetupException.class,
            ...
            URL ejbResURL1 = Client8.class.getResource("//com/sun/ts/tests/common/vehicle/stateful3/stateful3_vehicle_client.xml");
            if(ejbResURL1 != null) {
//              jpa_core_criteriapia_CriteriaBuilder_stateful3_vehicle_ejb.addAsManifestResource(ejbResURL1, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL1 = Client8.class.getResource("//com/sun/ts/tests/common/vehicle/stateful3/stateful3_vehicle_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL1 != null) {
              jpa_core_criteriapia_CriteriaBuilder_stateful3_vehicle_ejb.addAsManifestResource(ejbResURL1, "sun-ejb-jar.xml");
            }
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_criteriapia_CriteriaBuilder_stateful3_vehicle_ejb, Client8.class, ejbResURL1);
        ...
        // Ear
            ...
            earResURL = Client8.class.getResource("/.ear.sun-application.xml");
            if(earResURL != null) {
        ...
        public void trimExpTest() throws java.lang.Exception {
            super.trimExpTest();
        }
        ...
        @Override
        @TargetVehicle("stateful3")
        public void trimTrailingCharExpTest() throws java.lang.Exception {
            super.trimTrailingCharExpTest();
        }

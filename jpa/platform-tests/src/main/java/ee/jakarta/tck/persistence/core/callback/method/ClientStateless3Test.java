      ...
      s.exit();
        ...
        */
        ...
        // Client
            ...
            JavaArchive jpa_core_callback_method_stateless3_vehicle_client = ShrinkWrap.create(JavaArchive.class, "jpa_core_callback_method_vehicles_client.jar");
            // The class files
            ...
            if(resURL != null) {
              jpa_core_callback_method_stateless3_vehicle_client.addAsManifestResource(resURL, "sun-application-client.xml");
            }
        ...
        // Ejb 1
            ...
            if(ejbResURL1 != null) {
              jpa_core_callback_method_stateless3_vehicle_ejb.addAsManifestResource(ejbResURL1, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL1 = Client.class.getResource("/vehicle/stateless3/stateless3_vehicle_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL1 != null) {
              jpa_core_callback_method_stateless3_vehicle_ejb.addAsManifestResource(ejbResURL1, "sun-ejb-jar.xml");
            }
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_callback_method_stateless3_vehicle_ejb, Client.class, ejbResURL1);

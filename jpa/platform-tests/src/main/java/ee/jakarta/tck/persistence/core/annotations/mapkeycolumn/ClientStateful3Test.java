    ...
    static final String VEHICLE_ARCHIVE = "jpa_core_annotations_mapkeycolumn_stateful3_vehicle";
        ...
        */
        ...
        // Client
            ...
            jpa_core_annotations_mapkeycolumn_stateful3_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: com.sun.ts.tests.common.vehicle.VehicleClient\n"), "MANIFEST.MF");
        ...
        // Ejb 1
            ...
            if(ejbResURL1 != null) {
              jpa_core_annotations_mapkeycolumn_stateful3_vehicle_ejb.addAsManifestResource(ejbResURL1, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL1 = Client.class.getResource("//vehicle/stateful3/stateful3_vehicle_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL1 != null) {
              jpa_core_annotations_mapkeycolumn_stateful3_vehicle_ejb.addAsManifestResource(ejbResURL1, "sun-ejb-jar.xml");
            }
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_annotations_mapkeycolumn_stateful3_vehicle_ejb, Client.class, ejbResURL1);

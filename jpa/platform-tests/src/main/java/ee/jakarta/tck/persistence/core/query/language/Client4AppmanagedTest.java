...
public class Client4AppmanagedTest extends ee.jakarta.tck.persistence.core.query.language.Client4 {
    static final String VEHICLE_ARCHIVE = "jpa_core_query_language_appmanaged_vehicle";
        ...
        */
        ...
        // Client
            ...
            jpa_core_query_language_appmanaged_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + Client4.class.getName() + "\n"), "MANIFEST.MF");
            archiveProcessor.processClientArchive(jpa_core_query_language_appmanaged_vehicle_client, Client4.class, resURL);
        ...
        // Ejb
            ...
            archiveProcessor.processEjbArchive(jpa_core_query_language_appmanaged_vehicle_ejb, Client4.class, ejbResURL);

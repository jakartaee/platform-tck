...
public class Client6Stateless3Test extends ee.jakarta.tck.persistence.core.criteriaapi.CriteriaQuery.Client6 {
    static final String VEHICLE_ARCHIVE = "jpa_core_criteriaapi_CriteriaQuery_stateless3_vehicle";
        ...
        */
        ...
        // Client
            ...
            jpa_core_criteriaapi_CriteriaQuery_stateless3_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + Client6.class.getName() + "\n"), "MANIFEST.MF");
            // Call the archive processor
            archiveProcessor.processClientArchive(jpa_core_criteriaapi_CriteriaQuery_stateless3_vehicle_client, Client6.class, resURL);
        ...
        // Ejb
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_criteriaapi_CriteriaQuery_stateless3_vehicle_ejb, Client6.class, ejbResURL);

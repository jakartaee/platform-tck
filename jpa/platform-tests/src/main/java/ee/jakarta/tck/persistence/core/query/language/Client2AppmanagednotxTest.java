...
public class Client2AppmanagednotxTest extends ee.jakarta.tck.persistence.core.query.language.Client2 {
    static final String VEHICLE_ARCHIVE = "jpa_core_query_language_appmanagedNoTx_vehicle";
        ...
        */
        ...
        // Client
            ...
            jpa_core_query_language_appmanagedNoTx_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + Client2.class.getName() + "\n"), "MANIFEST.MF");
            // Call the archive processor
            archiveProcessor.processClientArchive(jpa_core_query_language_appmanagedNoTx_vehicle_client, Client2.class, resURL);
        ...
        // Ejb
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_query_language_appmanagedNoTx_vehicle_ejb, Client2.class, ejbResURL);
        ...
        // Ear
            ...
            URL earResURL = Client2.class.getResource("/com/sun/ts/tests/jpa/core/query/language/");
            if(earResURL != null) {
              jpa_core_query_language_vehicles_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client2.class.getResource("/com/sun/ts/tests/jpa/core/query/language/.ear.sun-application.xml");
            if(earResURL != null) {

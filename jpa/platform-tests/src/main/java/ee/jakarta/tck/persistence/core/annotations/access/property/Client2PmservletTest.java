...
public class Client2PmservletTest extends ee.jakarta.tck.persistence.core.annotations.access.property.Client2 {
    static final String VEHICLE_ARCHIVE = "jpa_core_annotations_access_property_pmservlet_vehicle";
        ...
        */
        ...
        // War
            ...
            // The class files
            jpa_core_annotations_access_property_pmservlet_vehicle_web.addClasses(
            ...
            if(warResURL != null) {
              jpa_core_annotations_access_property_pmservlet_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = Client2.class.getResource("//com/sun/ts/tests/common/vehicle/pmservlet/pmservlet_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
              jpa_core_annotations_access_property_pmservlet_vehicle_web.addAsWebInfResource(warResURL, "sun-web.xml");
            }

            // Any libraries added to the war

            // Web content
            warResURL = Client2.class.getResource("/com/sun/ts/tests/jpa/core/annotations/access/property/jpa_core_annotations_access_property.jar");
            if(warResURL != null) {
              jpa_core_annotations_access_property_pmservlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/lib/jpa_core_annotations_access_property.jar");
            }
            warResURL = Client2.class.getResource("/com/sun/ts/tests/common/vehicle/pmservlet/pmservlet_vehicle_web.xml");
            if(warResURL != null) {
              jpa_core_annotations_access_property_pmservlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/pmservlet_vehicle_web.xml");
            }

           // Call the archive processor
           archiveProcessor.processWebArchive(jpa_core_annotations_access_property_pmservlet_vehicle_web, Client2.class, warResURL);

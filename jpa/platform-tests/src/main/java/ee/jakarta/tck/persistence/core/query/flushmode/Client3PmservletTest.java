...
public class Client3PmservletTest extends ee.jakarta.tck.persistence.core.query.flushmode.Client3 {
    static final String VEHICLE_ARCHIVE = "jpa_core_query_flushmode_pmservlet_vehicle";
        ...
        */
        ...
        // War
            ...
            WebArchive jpa_core_query_flushmode_pmservlet_vehicle_web = ShrinkWrap.create(WebArchive.class, "jpa_core_query_flushmode_pmservlet_vehicle_web.war");
            // The class files
            jpa_core_query_flushmode_pmservlet_vehicle_web.addClasses(
            ...
            // Web content
            warResURL = Client3.class.getResource("/com/sun/ts/tests/jpa/core/query/flushmode/jpa_core_query_flushmode.jar");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(jpa_core_query_flushmode_pmservlet_vehicle_web, Client3.class, warResURL);
        ...
        // Ear
            ...
            jpa_core_query_flushmode_vehicles_ear.addAsModule(jpa_core_query_flushmode_pmservlet_vehicle_web);

...
public class ClientPmservletTest extends ee.jakarta.tck.persistence.jpa22.repeatable.namedstoredprocedurequery.Client {
    static final String VEHICLE_ARCHIVE = "jpa_jpa22_repeatable_namedstoredprocedure_pmservlet_vehicle";
        ...
        */
        ...
        // War
            ...
            WebArchive jpa_jpa22_repeatable_namedstoredprocedure_pmservlet_vehicle_web = ShrinkWrap.create(WebArchive.class, "jpa_jpa22_repeatable_namedstoredprocedure_pmservlet_vehicle_web.war");
            // The class files
            jpa_jpa22_repeatable_namedstoredprocedure_pmservlet_vehicle_web.addClasses(
            ...
            if(warResURL != null) {
              jpa_jpa22_repeatable_namedstoredprocedure_pmservlet_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = Client.class.getResource("//com/sun/ts/tests/common/vehicle/pmservlet/pmservlet_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
              jpa_jpa22_repeatable_namedstoredprocedure_pmservlet_vehicle_web.addAsWebInfResource(warResURL, "sun-web.xml");
            }
            ...
            if(warResURL != null) {
              jpa_jpa22_repeatable_namedstoredprocedure_pmservlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/lib/jpa_jpa22_repeatable_namedstoredprocedure.jar");
            }
            warResURL = Client.class.getResource("/com/sun/ts/tests/common/vehicle/pmservlet/pmservlet_vehicle_web.xml");
            if(warResURL != null) {
              jpa_jpa22_repeatable_namedstoredprocedure_pmservlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/pmservlet_vehicle_web.xml");
            }

           // Call the archive processor
           archiveProcessor.processWebArchive(jpa_jpa22_repeatable_namedstoredprocedure_pmservlet_vehicle_web, Client.class, warResURL);
        ...
        // Ear
            ...
            jpa_jpa22_repeatable_namedstoredprocedure_vehicles_ear.addAsModule(jpa_jpa22_repeatable_namedstoredprocedure_pmservlet_vehicle_web);

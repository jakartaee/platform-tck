...
public class Client5PuservletTest extends ee.jakarta.tck.persistence.core.query.language.Client5 {
    static final String VEHICLE_ARCHIVE = "jpa_core_query_language_puservlet_vehicle";
        ...
        */
        ...
        // War
           ...
           archiveProcessor.processWebArchive(jpa_core_query_language_puservlet_vehicle_web, Client5.class, warResURL);

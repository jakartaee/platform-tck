...
import ee.jakarta.tck.persistence.core.criteriaapi.Root.Client1;
import java.net.URL;
...
public class Client1Stateful3Test extends ee.jakarta.tck.persistence.core.criteriaapi.Root.Client1 {
    static final String VEHICLE_ARCHIVE = "jpa_core_criteriaapi_Root_stateful3_vehicle";
        ...
        */
        ...
        // Client
            ...
            JavaArchive jpa_core_criteriaapi_Root_stateful3_vehicle_client = ShrinkWrap.create(JavaArchive.class, "jpa_core_criteriaapi_Root_stateful3_vehicle_client.jar");
            // The class files
            jpa_core_criteriaapi_Root_stateful3_vehicle_client.addClasses(
            ...
            if(resURL != null) {
              jpa_core_criteriaapi_Root_stateful3_vehicle_client.addAsManifestResource(resURL, "application-client.xml");
            }
            ...
            jpa_core_criteriaapi_Root_stateful3_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + Client1.class.getName() + "\n"), "MANIFEST.MF");
            archiveProcessor.processClientArchive(jpa_core_criteriaapi_Root_stateful3_vehicle_client, Client1.class, resURL);


        // Ejb
            // the jar with the correct archive name
            JavaArchive jpa_core_criteriaapi_Root_stateful3_vehicle_ejb = ShrinkWrap.create(JavaArchive.class, "jpa_core_criteriaapi_Root_stateful3_vehicle_ejb.jar");
            // The class files
            jpa_core_criteriaapi_Root_stateful3_vehicle_ejb.addClasses(
                ee.jakarta.tck.persistence.core.criteriaapi.Root.Client1.class,
            ...
            if(ejbResURL != null) {
              jpa_core_criteriaapi_Root_stateful3_vehicle_ejb.addAsManifestResource(ejbResURL, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL = Client1.class.getResource("//vehicle/stateful3/stateful3_vehicle_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL != null) {
              jpa_core_criteriaapi_Root_stateful3_vehicle_ejb.addAsManifestResource(ejbResURL, "sun-ejb-jar.xml");
            }
            archiveProcessor.processEjbArchive(jpa_core_criteriaapi_Root_stateful3_vehicle_ejb, Client1.class, ejbResURL);
        ...
        // Par
            ...
            archiveProcessor.processParArchive(jpa_core_criteriaapi_Root, Client1.class, parURL);
            // The orm.xml file
        ...
        // Ear
            ...
            jpa_core_criteriaapi_Root_vehicles_ear.addAsModule(jpa_core_criteriaapi_Root_stateful3_vehicle_ejb);
            jpa_core_criteriaapi_Root_vehicles_ear.addAsModule(jpa_core_criteriaapi_Root_stateful3_vehicle_client);
            ...
            URL earResURL = Client1.class.getResource("/com/sun/ts/tests/jpa/core/criteriaapi/Root/");
            if(earResURL != null) {
              jpa_core_criteriaapi_Root_vehicles_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client1.class.getResource("/com/sun/ts/tests/jpa/core/criteriaapi/Root/.ear.sun-application.xml");
            if(earResURL != null) {
              jpa_core_criteriaapi_Root_vehicles_ear.addAsManifestResource(earResURL, "sun-application.xml");
            }
            archiveProcessor.processEarArchive(jpa_core_criteriaapi_Root_vehicles_ear, Client1.class, earResURL);
        ...
        @Override
        @TargetVehicle("stateful3")
        public void rootGetCorrelationParentIllegalStateExceptionTest() throws java.lang.Exception {
            super.rootGetCorrelationParentIllegalStateExceptionTest();
        }

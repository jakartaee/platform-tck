...
public class Client2PuservletTest extends ee.jakarta.tck.persistence.core.criteriaapi.From.Client2 {
    static final String VEHICLE_ARCHIVE = "jpa_core_criteriaapi_From_puservlet_vehicle";
        ...
        */
        ...
        // War
           ...
           archiveProcessor.processWebArchive(jpa_core_criteriaapi_From_puservlet_vehicle_web, Client2.class, warResURL);

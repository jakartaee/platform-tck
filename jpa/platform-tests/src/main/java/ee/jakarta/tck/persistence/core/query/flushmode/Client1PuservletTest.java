...
public class Client1PuservletTest extends ee.jakarta.tck.persistence.core.query.flushmode.Client1 {
    static final String VEHICLE_ARCHIVE = "jpa_core_query_flushmode_puservlet_vehicle";
        ...
        */
        ...
        // War
           ...
           archiveProcessor.processWebArchive(jpa_core_query_flushmode_puservlet_vehicle_web, Client1.class, warResURL);

...
public class Client2PuservletTest extends ee.jakarta.tck.persistence.core.types.generator.Client2 {
    static final String VEHICLE_ARCHIVE = "jpa_core_types_generator_puservlet_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client2.class.getResource("/com/sun/ts/tests/jpa/core/types/generator/jpa_core_types_generator.jar");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(jpa_core_types_generator_puservlet_vehicle_web, Client2.class, warResURL);

...
public class Client6AppmanagednotxTest extends ee.jakarta.tck.persistence.core.query.language.Client6 {
    static final String VEHICLE_ARCHIVE = "jpa_core_query_language_appmanagedNoTx_vehicle";
        ...
        */
        ...
        // Client
            ...
            archiveProcessor.processClientArchive(jpa_core_query_language_appmanagedNoTx_vehicle_client, Client6.class, resURL);
        ...
        // Ejb 1
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_query_language_appmanagedNoTx_vehicle_ejb, Client6.class, ejbResURL1);

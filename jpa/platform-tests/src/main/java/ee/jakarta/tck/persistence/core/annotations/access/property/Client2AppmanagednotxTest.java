...
public class Client2AppmanagednotxTest extends ee.jakarta.tck.persistence.core.annotations.access.property.Client2 {
    static final String VEHICLE_ARCHIVE = "jpa_core_annotations_access_property_appmanagedNoTx_vehicle";
        ...
        */
        ...
        // Client
            ...
            JavaArchive jpa_core_annotations_access_property_appmanagedNoTx_vehicle_client = ShrinkWrap.create(JavaArchive.class, "jpa_core_annotations_access_property_appmanagedNoTx_vehicle_client.jar");
            // The class files
            ...
            archiveProcessor.processClientArchive(jpa_core_annotations_access_property_appmanagedNoTx_vehicle_client, Client2.class, resURL);
        ...
        // Ejb
            ...
            if(ejbResURL != null) {
              jpa_core_annotations_access_property_appmanagedNoTx_vehicle_ejb.addAsManifestResource(ejbResURL, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL = Client2.class.getResource("//vehicle/appmanagedNoTx/appmanagedNoTx_vehicle_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL != null) {
              jpa_core_annotations_access_property_appmanagedNoTx_vehicle_ejb.addAsManifestResource(ejbResURL, "sun-ejb-jar.xml");
            }
            archiveProcessor.processEjbArchive(jpa_core_annotations_access_property_appmanagedNoTx_vehicle_ejb, Client2.class, ejbResURL);

...
public class Client4PmservletTest extends ee.jakarta.tck.persistence.core.types.generator.Client4 {
    static final String VEHICLE_ARCHIVE = "jpa_core_types_generator_pmservlet_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client4.class.getResource("/com/sun/ts/tests/jpa/core/types/generator/jpa_core_types_generator.jar");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(jpa_core_types_generator_pmservlet_vehicle_web, Client4.class, warResURL);

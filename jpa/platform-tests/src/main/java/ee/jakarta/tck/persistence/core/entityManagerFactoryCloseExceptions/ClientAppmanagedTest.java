...
public class ClientAppmanagedTest extends ee.jakarta.tck.persistence.core.entityManagerFactoryCloseExceptions.Client {
    static final String VEHICLE_ARCHIVE = "jpa_core_entityManagerFactoryCloseException_appmanaged_vehicle";
        ...
        */
        ...
        // Client
            ...
            JavaArchive jpa_core_entityManagerFactoryCloseException_appmanaged_vehicle_client = ShrinkWrap.create(JavaArchive.class, "jpa_core_entityManagerFactoryCloseException_appmanaged_vehicle_client.jar");
            // The class files
            jpa_core_entityManagerFactoryCloseException_appmanaged_vehicle_client.addClasses(
            ...
            if(resURL != null) {
              jpa_core_entityManagerFactoryCloseException_appmanaged_vehicle_client.addAsManifestResource(resURL, "application-client.xml");
            }
        ...
        // Ejb
            // the jar with the correct archive name
            JavaArchive jpa_core_entityManagerFactoryCloseException_appmanaged_vehicle_ejb = ShrinkWrap.create(JavaArchive.class, "jpa_core_entityManagerFactoryCloseException_appmanaged_vehicle_ejb.jar");
            // The class files
            jpa_core_entityManagerFactoryCloseException_appmanaged_vehicle_ejb.addClasses(
            ...
            if(ejbResURL != null) {
              jpa_core_entityManagerFactoryCloseException_appmanaged_vehicle_ejb.addAsManifestResource(ejbResURL, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL = Client.class.getResource("//vehicle/appmanaged/appmanaged_vehicle_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL != null) {
              jpa_core_entityManagerFactoryCloseException_appmanaged_vehicle_ejb.addAsManifestResource(ejbResURL, "sun-ejb-jar.xml");
            }
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_entityManagerFactoryCloseException_appmanaged_vehicle_ejb, Client.class, ejbResURL);

...
public class Client4Stateless3Test extends ee.jakarta.tck.persistence.core.criteriaapi.metamodelquery.Client4 {
    static final String VEHICLE_ARCHIVE = "jpa_core_criteriaapi_metamodelquery_stateless3_vehicle";
        ...
        */
        ...
        // Client
            ...
            archiveProcessor.processClientArchive(jpa_core_criteriaapi_metamodelquery_stateless3_vehicle_client, Client4.class, resURL);
        ...
        // Ejb 1
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_criteriaapi_metamodelquery_stateless3_vehicle_ejb, Client4.class, ejbResURL1);

...
public class Client1AppmanagedTest extends ee.jakarta.tck.persistence.core.annotations.access.property.Client1 {
    static final String VEHICLE_ARCHIVE = "jpa_core_annotations_access_property_appmanaged_vehicle";
        ...
        */
        ...
        // Client
            ...
            jpa_core_annotations_access_property_appmanaged_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + Client1.class.getName() + "\n"), "MANIFEST.MF");
            archiveProcessor.processClientArchive(jpa_core_annotations_access_property_appmanaged_vehicle_client, Client1.class, resURL);
        ...
        // Ejb
            ...
            archiveProcessor.processEjbArchive(jpa_core_annotations_access_property_appmanaged_vehicle_ejb, Client1.class, ejbResURL);
        ...
        // Ear
            ...
            URL earResURL = Client1.class.getResource("/com/sun/ts/tests/jpa/core/annotations/access/property/");
            if(earResURL != null) {
              jpa_core_annotations_access_property_vehicles_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client1.class.getResource("/com/sun/ts/tests/jpa/core/annotations/access/property/.ear.sun-application.xml");
            if(earResURL != null) {

...
import ee.jakarta.tck.persistence.core.query.language.Client4;
import java.net.URL;
...
public class Client4AppmanagednotxTest extends ee.jakarta.tck.persistence.core.query.language.Client4 {
    static final String VEHICLE_ARCHIVE = "jpa_core_query_language_appmanagedNoTx_vehicle";
        ...
        */
        ...
        // Client
            ...
            JavaArchive jpa_core_query_language_appmanagedNoTx_vehicle_client = ShrinkWrap.create(JavaArchive.class, "jpa_core_query_language_appmanagedNoTx_vehicle_client.jar");
            // The class files
            ...
            jpa_core_query_language_appmanagedNoTx_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + Client4.class.getName() + "\n"), "MANIFEST.MF");
            archiveProcessor.processClientArchive(jpa_core_query_language_appmanagedNoTx_vehicle_client, Client4.class, resURL);
        ...
        // Ejb
            ...
            if(ejbResURL != null) {
              jpa_core_query_language_appmanagedNoTx_vehicle_ejb.addAsManifestResource(ejbResURL, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL = Client4.class.getResource("//vehicle/appmanagedNoTx/appmanagedNoTx_vehicle_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL != null) {
              jpa_core_query_language_appmanagedNoTx_vehicle_ejb.addAsManifestResource(ejbResURL, "sun-ejb-jar.xml");
            }
            archiveProcessor.processEjbArchive(jpa_core_query_language_appmanagedNoTx_vehicle_ejb, Client4.class, ejbResURL);
        ...
        // Ear
            ...
            URL earResURL = Client4.class.getResource("/com/sun/ts/tests/jpa/core/query/language/");
            if(earResURL != null) {
              jpa_core_query_language_vehicles_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client4.class.getResource("/com/sun/ts/tests/jpa/core/query/language/.ear.sun-application.xml");
            if(earResURL != null) {
              jpa_core_query_language_vehicles_ear.addAsManifestResource(earResURL, "sun-application.xml");
            }
            archiveProcessor.processEarArchive(jpa_core_query_language_vehicles_ear, Client4.class, earResURL);

...
public class ClientPuservletTest extends ee.jakarta.tck.persistence.core.override.entity.Client {
    static final String VEHICLE_ARCHIVE = "jpa_core_override_entity_puservlet_vehicle";
        ...
        */
        ...
        // War
            ...
            WebArchive jpa_core_override_entity_puservlet_vehicle_web = ShrinkWrap.create(WebArchive.class, "jpa_core_override_entity_puservlet_vehicle_web.war");
            // The class files
            jpa_core_override_entity_puservlet_vehicle_web.addClasses(
            ...
            if(warResURL != null) {
              jpa_core_override_entity_puservlet_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = Client.class.getResource("//com/sun/ts/tests/common/vehicle/puservlet/puservlet_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
              jpa_core_override_entity_puservlet_vehicle_web.addAsWebInfResource(warResURL, "sun-web.xml");
            }

            // Any libraries added to the war

            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/jpa/core/override/entity/jpa_core_override_entity.jar");
            if(warResURL != null) {
              jpa_core_override_entity_puservlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/lib/jpa_core_override_entity.jar");
            }
            warResURL = Client.class.getResource("/com/sun/ts/tests/common/vehicle/puservlet/puservlet_vehicle_web.xml");
            if(warResURL != null) {
              jpa_core_override_entity_puservlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/puservlet_vehicle_web.xml");
            }

           // Call the archive processor
           archiveProcessor.processWebArchive(jpa_core_override_entity_puservlet_vehicle_web, Client.class, warResURL);
        ...
        // Ear
            ...
            jpa_core_override_entity_vehicles_ear.addAsModule(jpa_core_override_entity_puservlet_vehicle_web);

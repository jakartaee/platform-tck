...
public class Client1PuservletTest extends ee.jakarta.tck.persistence.core.query.language.Client1 {
    static final String VEHICLE_ARCHIVE = "jpa_core_query_language_puservlet_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client1.class.getResource("/com/sun/ts/tests/jpa/core/query/language/jpa_core_query_language.jar");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(jpa_core_query_language_puservlet_vehicle_web, Client1.class, warResURL);

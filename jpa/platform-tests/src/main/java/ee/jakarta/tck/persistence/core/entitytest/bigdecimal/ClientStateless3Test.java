    ...
    static final String VEHICLE_ARCHIVE = "jpa_core_entitytest_bigdecimal_stateless3_vehicle";
        ...
        */
        ...
        // Client
            ...
            JavaArchive jpa_core_entitytest_bigdecimal_stateless3_vehicle_client = ShrinkWrap.create(JavaArchive.class, "jpa_core_entitytest_bigdecimal_stateless3_vehicle_client.jar");
            // The class files
            ...
            jpa_core_entitytest_bigdecimal_stateless3_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: com.sun.ts.tests.common.vehicle.VehicleClient\n"), "MANIFEST.MF");

...
import ee.jakarta.tck.persistence.core.query.parameter.Client2;
import java.net.URL;
...
public class Client2AppmanagednotxTest extends ee.jakarta.tck.persistence.core.query.parameter.Client2 {
    static final String VEHICLE_ARCHIVE = "jpa_core_query_parameter_appmanagedNoTx_vehicle";
        ...
        */
        ...
        // Client
            ...
            archiveProcessor.processClientArchive(jpa_core_query_parameter_appmanagedNoTx_vehicle_client, Client2.class, resURL);
        ...
        // Ejb 1
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_query_parameter_appmanagedNoTx_vehicle_ejb, Client2.class, ejbResURL1);

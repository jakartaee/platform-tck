...
public class Client2PuservletTest extends ee.jakarta.tck.persistence.core.annotations.basic.Client2 {
    static final String VEHICLE_ARCHIVE = "jpa_core_annotations_basic_puservlet_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client2.class.getResource("/com/sun/ts/tests/jpa/core/annotations/basic/jpa_core_annotations_basic.jar");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(jpa_core_annotations_basic_puservlet_vehicle_web, Client2.class, warResURL);
        ...
        // Ear
            ...
            jpa_core_annotations_basic_vehicles_ear.addAsModule(jpa_core_annotations_basic_puservlet_vehicle_web);

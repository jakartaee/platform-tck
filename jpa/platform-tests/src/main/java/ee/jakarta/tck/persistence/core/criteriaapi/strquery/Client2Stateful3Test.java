    ...
    static final String VEHICLE_ARCHIVE = "jpa_core_criteriaapi_strquery_stateful3_vehicle";
        ...
        */
        ...
        // Ejb
            ...
            if(ejbResURL != null) {
              jpa_core_criteriaapi_strquery_stateful3_vehicle_ejb.addAsManifestResource(ejbResURL, "ejb-jar.xml");
            }
            ...
            archiveProcessor.processEjbArchive(jpa_core_criteriaapi_strquery_stateful3_vehicle_ejb, Client2.class, ejbResURL);

...
public class Client1PmservletTest extends ee.jakarta.tck.persistence.core.annotations.elementcollection.Client1 {
    static final String VEHICLE_ARCHIVE = "jpa_core_annotations_elementcollection_pmservlet_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client1.class.getResource("/com/sun/ts/tests/jpa/core/annotations/elementcollection/jpa_core_annotations_elementcollection.jar");
            if(warResURL != null) {
        ...
        // Ear
            ...
            jpa_core_annotations_elementcollection_vehicles_ear.addAsModule(jpa_core_annotations_elementcollection_pmservlet_vehicle_web);

...
public class ClientPmservletTest extends ee.jakarta.tck.persistence.ee.entityManager.Client {
    static final String VEHICLE_ARCHIVE = "jpa_ee_entityManager_pmservlet_vehicle";
        ...
        */
        ...
        // War
            ...
            // The class files
            jpa_ee_entityManager_pmservlet_vehicle_web.addClasses(
            ...
            if(warResURL != null) {
              jpa_ee_entityManager_pmservlet_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = Client.class.getResource("//com/sun/ts/tests/common/vehicle/pmservlet/pmservlet_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
              jpa_ee_entityManager_pmservlet_vehicle_web.addAsWebInfResource(warResURL, "sun-web.xml");
            }

            // Any libraries added to the war

            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/jpa/ee/entityManager/jpa_ee_entityManager.jar");
            if(warResURL != null) {
              jpa_ee_entityManager_pmservlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/lib/jpa_ee_entityManager.jar");
            }
            warResURL = Client.class.getResource("/com/sun/ts/tests/common/vehicle/pmservlet/pmservlet_vehicle_web.xml");
            if(warResURL != null) {
              jpa_ee_entityManager_pmservlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/pmservlet_vehicle_web.xml");
            }

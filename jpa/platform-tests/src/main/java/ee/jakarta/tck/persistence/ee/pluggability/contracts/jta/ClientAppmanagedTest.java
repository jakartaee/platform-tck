    ...
    static final String VEHICLE_ARCHIVE = "jpa_ee_pluggability_contracts_jta_appmanaged_vehicle";
        ...
        */
        ...
        // Client
            ...
            JavaArchive jpa_ee_pluggability_contracts_jta_appmanaged_vehicle_client = ShrinkWrap.create(JavaArchive.class, "jpa_ee_pluggability_contracts_jta_appmanaged_vehicle_client.jar");
            // The class files
            jpa_ee_pluggability_contracts_jta_appmanaged_vehicle_client.addClasses(
        ...
        // Ejb
            // the jar with the correct archive name
            JavaArchive jpa_ee_pluggability_contracts_jta_appmanaged_vehicle_ejb = ShrinkWrap.create(JavaArchive.class, "jpa_ee_pluggability_contracts_jta_appmanaged_vehicle_ejb.jar");
            // The class files
            jpa_ee_pluggability_contracts_jta_appmanaged_vehicle_ejb.addClasses(
        ...
        // Ear
            ...
            jpa_ee_pluggability_contracts_jta_vehicles_ear.addAsModule(jpa_ee_pluggability_contracts_jta_appmanaged_vehicle_ejb);

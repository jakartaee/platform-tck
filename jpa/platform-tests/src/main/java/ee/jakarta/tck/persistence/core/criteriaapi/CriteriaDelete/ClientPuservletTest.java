...
public class ClientPuservletTest extends ee.jakarta.tck.persistence.core.criteriaapi.CriteriaDelete.Client {
    static final String VEHICLE_ARCHIVE = "jpa_core_criteriapia_CriteriaDelete_puservlet_vehicle";
        ...
        */
        ...
        // War
            ...
            // The class files
            jpa_core_criteriapia_CriteriaDelete_puservlet_vehicle_web.addClasses(
            ...
            if(warResURL != null) {
              jpa_core_criteriapia_CriteriaDelete_puservlet_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }

...
public class Client3AppmanagedTest extends ee.jakarta.tck.persistence.core.entityManagerFactory.Client3 {
    static final String VEHICLE_ARCHIVE = "jpa_core_entityManagerFactory_appmanaged_vehicle";
        ...
        */
        ...
        // Client
            ...
            archiveProcessor.processClientArchive(jpa_core_entityManagerFactory_appmanaged_vehicle_client, Client3.class, resURL);
        ...
        // Ejb 1
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_entityManagerFactory_appmanaged_vehicle_ejb, Client3.class, ejbResURL1);

    ...
    static final String VEHICLE_ARCHIVE = "jpa_core_criteriaapi_metamodelquery_stateless3_vehicle";
        ...
        */
        ...
        // Client
            ...
            jpa_core_criteriaapi_metamodelquery_stateless3_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + Client7.class.getName() + "\n"), "MANIFEST.MF");
        ...
        // Ejb
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_criteriaapi_metamodelquery_stateless3_vehicle_ejb, Client7.class, ejbResURL);

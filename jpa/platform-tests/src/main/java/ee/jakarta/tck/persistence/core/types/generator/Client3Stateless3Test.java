...
public class Client3Stateless3Test extends ee.jakarta.tck.persistence.core.types.generator.Client3 {
    static final String VEHICLE_ARCHIVE = "jpa_core_types_generator_stateless3_vehicle";
        ...
        */
        ...
        // Client
            ...
            jpa_core_types_generator_stateless3_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + Client3.class.getName() + "\n"), "MANIFEST.MF");
            archiveProcessor.processClientArchive(jpa_core_types_generator_stateless3_vehicle_client, Client3.class, resURL);
        ...
        // Ejb
            ...
            archiveProcessor.processEjbArchive(jpa_core_types_generator_stateless3_vehicle_ejb, Client3.class, ejbResURL);

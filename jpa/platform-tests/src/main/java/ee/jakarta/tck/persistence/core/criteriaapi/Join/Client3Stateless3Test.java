...
public class Client3Stateless3Test extends ee.jakarta.tck.persistence.core.criteriaapi.Join.Client3 {
    static final String VEHICLE_ARCHIVE = "jpa_core_criteriaapi_Join_stateless3_vehicle";
        ...
        */
        ...
        // Ejb
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_criteriaapi_Join_stateless3_vehicle_ejb, Client3.class, ejbResURL);

    ...
    static final String VEHICLE_ARCHIVE = "jpa_ee_entityManagerFactory_pmservlet_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/jpa/ee/entityManagerFactory/jpa_ee_entityManagerFactory.jar");
            if(warResURL != null) {
              jpa_ee_entityManagerFactory_pmservlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/lib/jpa_ee_entityManagerFactory.jar");
            }
            warResURL = Client.class.getResource("/com/sun/ts/tests/common/vehicle/pmservlet/pmservlet_vehicle_web.xml");
            if(warResURL != null) {
              jpa_ee_entityManagerFactory_pmservlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/pmservlet_vehicle_web.xml");
            }
        ...
        // Ear
            ...
            jpa_ee_entityManagerFactory_vehicles_ear.addAsModule(jpa_ee_entityManagerFactory_pmservlet_vehicle_web);

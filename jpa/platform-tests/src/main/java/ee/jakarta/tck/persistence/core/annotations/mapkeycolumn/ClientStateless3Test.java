...
public class ClientStateless3Test extends ee.jakarta.tck.persistence.core.annotations.mapkeycolumn.Client {
    static final String VEHICLE_ARCHIVE = "jpa_core_annotations_mapkeycolumn_stateless3_vehicle";
        ...
        */
        ...
        // Client
            ...
            JavaArchive jpa_core_annotations_mapkeycolumn_stateless3_vehicle_client = ShrinkWrap.create(JavaArchive.class, "jpa_core_annotations_mapkeycolumn_stateless3_vehicle_client.jar");
            // The class files
            jpa_core_annotations_mapkeycolumn_stateless3_vehicle_client.addClasses(
            ...
            if(resURL != null) {
              jpa_core_annotations_mapkeycolumn_stateless3_vehicle_client.addAsManifestResource(resURL, "application-client.xml");
            }
            ...
            jpa_core_annotations_mapkeycolumn_stateless3_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + Client.class.getName() + "\n"), "MANIFEST.MF");
            // Call the archive processor
            archiveProcessor.processClientArchive(jpa_core_annotations_mapkeycolumn_stateless3_vehicle_client, Client.class, resURL);

        // Ejb
            // the jar with the correct archive name
            JavaArchive jpa_core_annotations_mapkeycolumn_stateless3_vehicle_ejb = ShrinkWrap.create(JavaArchive.class, "jpa_core_annotations_mapkeycolumn_stateless3_vehicle_ejb.jar");
            // The class files
            jpa_core_annotations_mapkeycolumn_stateless3_vehicle_ejb.addClasses(
            ...
            if(ejbResURL != null) {
              jpa_core_annotations_mapkeycolumn_stateless3_vehicle_ejb.addAsManifestResource(ejbResURL, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL = Client.class.getResource("//vehicle/stateless3/stateless3_vehicle_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL != null) {
              jpa_core_annotations_mapkeycolumn_stateless3_vehicle_ejb.addAsManifestResource(ejbResURL, "sun-ejb-jar.xml");
            }
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_annotations_mapkeycolumn_stateless3_vehicle_ejb, Client.class, ejbResURL);
        ...
        // Ear
            ...
            jpa_core_annotations_mapkeycolumn_vehicles_ear.addAsModule(jpa_core_annotations_mapkeycolumn_stateless3_vehicle_ejb);
            jpa_core_annotations_mapkeycolumn_vehicles_ear.addAsModule(jpa_core_annotations_mapkeycolumn_stateless3_vehicle_client);

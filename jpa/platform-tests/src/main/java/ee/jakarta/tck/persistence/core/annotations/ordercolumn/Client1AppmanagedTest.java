...
public class Client1AppmanagedTest extends ee.jakarta.tck.persistence.core.annotations.ordercolumn.Client1 {
    static final String VEHICLE_ARCHIVE = "jpa_core_annotations_ordercolumn_appmanaged_vehicle";
        ...
        */
        ...
        // Client
            ...
            JavaArchive jpa_core_annotations_ordercolumn_appmanaged_vehicle_client = ShrinkWrap.create(JavaArchive.class, "jpa_core_annotations_ordercolumn_appmanaged_vehicle_client.jar");
            // The class files
            jpa_core_annotations_ordercolumn_appmanaged_vehicle_client.addClasses(
            ...
            if(resURL != null) {
              jpa_core_annotations_ordercolumn_appmanaged_vehicle_client.addAsManifestResource(resURL, "application-client.xml");
            }
            ...
            jpa_core_annotations_ordercolumn_appmanaged_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + Client1.class.getName() + "\n"), "MANIFEST.MF");
            // Call the archive processor
            archiveProcessor.processClientArchive(jpa_core_annotations_ordercolumn_appmanaged_vehicle_client, Client1.class, resURL);

        // Ejb
            // the jar with the correct archive name
            JavaArchive jpa_core_annotations_ordercolumn_appmanaged_vehicle_ejb = ShrinkWrap.create(JavaArchive.class, "jpa_core_annotations_ordercolumn_appmanaged_vehicle_ejb.jar");
            // The class files
            jpa_core_annotations_ordercolumn_appmanaged_vehicle_ejb.addClasses(
                com.sun.ts.tests.common.vehicle.ejb3share.EJB3ShareBaseBean.class,
                ee.jakarta.tck.persistence.core.annotations.ordercolumn.Client1.class,
                com.sun.ts.tests.common.vehicle.VehicleRunnerFactory.class,
                com.sun.ts.tests.common.vehicle.ejb3share.UseEntityManager.class,
                com.sun.ts.tests.common.vehicle.ejb3share.EJB3ShareIF.class,
                com.sun.ts.lib.harness.EETest.Fault.class,
            ...
            if(ejbResURL != null) {
              jpa_core_annotations_ordercolumn_appmanaged_vehicle_ejb.addAsManifestResource(ejbResURL, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL = Client1.class.getResource("//vehicle/appmanaged/appmanaged_vehicle_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL != null) {
              jpa_core_annotations_ordercolumn_appmanaged_vehicle_ejb.addAsManifestResource(ejbResURL, "sun-ejb-jar.xml");
            }
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_annotations_ordercolumn_appmanaged_vehicle_ejb, Client1.class, ejbResURL);
        ...
        // Par
            ...
            // Call the archive processor
            archiveProcessor.processParArchive(jpa_core_annotations_ordercolumn, Client1.class, parURL);
            // The orm.xml file
        ...
        // Ear
            ...
            jpa_core_annotations_ordercolumn_vehicles_ear.addAsModule(jpa_core_annotations_ordercolumn_appmanaged_vehicle_ejb);
            jpa_core_annotations_ordercolumn_vehicles_ear.addAsModule(jpa_core_annotations_ordercolumn_appmanaged_vehicle_client);
            ...
            URL earResURL = Client1.class.getResource("/com/sun/ts/tests/jpa/core/annotations/ordercolumn/");
            if(earResURL != null) {
              jpa_core_annotations_ordercolumn_vehicles_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client1.class.getResource("/com/sun/ts/tests/jpa/core/annotations/ordercolumn/.ear.sun-application.xml");
            if(earResURL != null) {
              jpa_core_annotations_ordercolumn_vehicles_ear.addAsManifestResource(earResURL, "sun-application.xml");
            }
            // Call the archive processor
            archiveProcessor.processEarArchive(jpa_core_annotations_ordercolumn_vehicles_ear, Client1.class, earResURL);
        ...
        public void orderColumn() throws java.lang.Exception {
            super.orderColumn();
        }

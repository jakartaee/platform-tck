...
public class Client3AppmanagednotxTest extends ee.jakarta.tck.persistence.core.query.flushmode.Client3 {
    static final String VEHICLE_ARCHIVE = "jpa_core_query_flushmode_appmanagedNoTx_vehicle";
        ...
        */
        ...
        // Client
            ...
            JavaArchive jpa_core_query_flushmode_appmanagedNoTx_vehicle_client = ShrinkWrap.create(JavaArchive.class, "jpa_core_query_flushmode_appmanagedNoTx_vehicle_client.jar");
            // The class files
            ...
            jpa_core_query_flushmode_appmanagedNoTx_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + Client3.class.getName() + "\n"), "MANIFEST.MF");
            archiveProcessor.processClientArchive(jpa_core_query_flushmode_appmanagedNoTx_vehicle_client, Client3.class, resURL);
        ...
        // Ejb
            ...
            if(ejbResURL != null) {
              jpa_core_query_flushmode_appmanagedNoTx_vehicle_ejb.addAsManifestResource(ejbResURL, "ejb-jar.xml");
            }
            ...
            archiveProcessor.processEjbArchive(jpa_core_query_flushmode_appmanagedNoTx_vehicle_ejb, Client3.class, ejbResURL);

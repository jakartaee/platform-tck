...
public class Client3PuservletTest extends ee.jakarta.tck.persistence.core.criteriaapi.misc.Client3 {
    static final String VEHICLE_ARCHIVE = "jpa_core_criteriaapi_misc_puservlet_vehicle";
        ...
        */
        ...
        // War
           ...
           archiveProcessor.processWebArchive(jpa_core_criteriaapi_misc_puservlet_vehicle_web, Client3.class, warResURL);

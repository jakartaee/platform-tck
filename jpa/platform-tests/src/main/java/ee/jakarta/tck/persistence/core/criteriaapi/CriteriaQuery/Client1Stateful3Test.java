...
import ee.jakarta.tck.persistence.core.criteriaapi.CriteriaQuery.Client1;
import java.net.URL;
...
public class Client1Stateful3Test extends ee.jakarta.tck.persistence.core.criteriaapi.CriteriaQuery.Client1 {
    static final String VEHICLE_ARCHIVE = "jpa_core_criteriaapi_CriteriaQuery_stateful3_vehicle";
        ...
        */
        ...
        // Client
            ...
            jpa_core_criteriaapi_CriteriaQuery_stateful3_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + Client1.class.getName() + "\n"), "MANIFEST.MF");
            // Call the archive processor
            archiveProcessor.processClientArchive(jpa_core_criteriaapi_CriteriaQuery_stateful3_vehicle_client, Client1.class, resURL);
        ...
        // Ejb
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_criteriaapi_CriteriaQuery_stateful3_vehicle_ejb, Client1.class, ejbResURL);
        ...
        // Par
            ...
            // Call the archive processor
            archiveProcessor.processParArchive(jpa_core_criteriaapi_CriteriaQuery, Client1.class, parURL);
            // The orm.xml file
        ...
        // Ear
            ...
            URL earResURL = Client1.class.getResource("/com/sun/ts/tests/jpa/core/criteriaapi/CriteriaQuery/");
            if(earResURL != null) {
              jpa_core_criteriaapi_CriteriaQuery_vehicles_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client1.class.getResource("/com/sun/ts/tests/jpa/core/criteriaapi/CriteriaQuery/.ear.sun-application.xml");
            if(earResURL != null) {
        ...
        public void fromClass() throws java.lang.Exception {
            super.fromClass();
        }
        ...
        @Override
        @TargetVehicle("stateful3")
        public void fromEntityType() throws java.lang.Exception {
            super.fromEntityType();
        }
        ...
        @Override
        @TargetVehicle("stateful3")
        public void fromGetParentPathTest() throws java.lang.Exception {
            super.fromGetParentPathTest();
        }

        @Test
        @Override
        @TargetVehicle("stateful3")
        public void getParameters() throws java.lang.Exception {
            super.getParameters();
        }

...
public class Client2AppmanagednotxTest extends ee.jakarta.tck.persistence.core.annotations.access.field.Client2 {
    static final String VEHICLE_ARCHIVE = "jpa_core_annotations_access_field_appmanagedNoTx_vehicle";
        ...
        */
        ...
        // Ejb 1
            ...
            if(ejbResURL1 != null) {
              jpa_core_annotations_access_field_appmanagedNoTx_vehicle_ejb.addAsManifestResource(ejbResURL1, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL1 = Client2.class.getResource("//vehicle/appmanagedNoTx/appmanagedNoTx_vehicle_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL1 != null) {
              jpa_core_annotations_access_field_appmanagedNoTx_vehicle_ejb.addAsManifestResource(ejbResURL1, "sun-ejb-jar.xml");
            }
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_annotations_access_field_appmanagedNoTx_vehicle_ejb, Client2.class, ejbResURL1);

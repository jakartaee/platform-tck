    ...
    /**
        ...
        */
        ...
        // Client
            ...
            URL resURL = Client.class.getResource("com/sun/ts/tests/jpa/ee/packaging/ejb/exclude/");
            if(resURL != null) {
              jpa_ee_packaging_ejb_exclude_client.addAsManifestResource(resURL, "application-client.xml");
            }
            // The sun-application-client.xml file need to be added or should this be in in the vendor Arquillian extension?
            resURL = Client.class.getResource("/com/sun/ts/tests/jpa/ee/packaging/ejb/exclude/.jar.sun-application-client.xml");
            if(resURL != null) {
              jpa_ee_packaging_ejb_exclude_client.addAsManifestResource(resURL, "application-client.xml");
            }
        ...
        // Ejb
            ...
            URL ejbResURL = Client.class.getResource("/com/sun/ts/tests/jpa/ee/packaging/ejb/exclude/");
            if(ejbResURL != null) {
              jpa_ee_packaging_ejb_exclude_ejb.addAsManifestResource(ejbResURL, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL = Client.class.getResource("/com/sun/ts/tests/jpa/ee/packaging/ejb/exclude/.jar.sun-ejb-jar.xml");
            if(ejbResURL != null) {
              jpa_ee_packaging_ejb_exclude_ejb.addAsManifestResource(ejbResURL, "sun-ejb-jar.xml");
            }
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_ee_packaging_ejb_exclude_ejb, Client.class, ejbResURL);
        ...
        // Ear
            ...
            URL earResURL = Client.class.getResource("/com/sun/ts/tests/jpa/ee/packaging/ejb/exclude/");
            if(earResURL != null) {
              jpa_ee_packaging_ejb_exclude_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client.class.getResource("/com/sun/ts/tests/jpa/ee/packaging/ejb/exclude/.ear.sun-application.xml");
            if(earResURL != null) {

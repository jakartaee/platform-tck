...
public class Client4PmservletTest extends ee.jakarta.tck.persistence.core.criteriaapi.Root.Client4 {
    static final String VEHICLE_ARCHIVE = "jpa_core_criteriaapi_Root_pmservlet_vehicle";
        ...
        */
        ...
        // War
           ...
           archiveProcessor.processWebArchive(jpa_core_criteriaapi_Root_pmservlet_vehicle_web, Client4.class, warResURL);

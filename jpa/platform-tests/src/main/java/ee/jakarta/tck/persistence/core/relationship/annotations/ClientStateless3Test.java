    ...
    static final String VEHICLE_ARCHIVE = "jpa_core_relationship_annotations_stateless3_vehicle";
        ...
        */
        ...
        // Client
            ...
            jpa_core_relationship_annotations_stateless3_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: com.sun.ts.tests.common.vehicle.VehicleClient\n"), "MANIFEST.MF");
        ...
        // Ejb 1
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_relationship_annotations_stateless3_vehicle_ejb, Client.class, ejbResURL1);

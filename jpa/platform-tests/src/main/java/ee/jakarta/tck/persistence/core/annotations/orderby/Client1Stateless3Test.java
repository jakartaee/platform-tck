    ...
    static final String VEHICLE_ARCHIVE = "jpa_core_annotations_orderby_stateless3_vehicle";
        ...
        */
        ...
        // Client
            ...
            jpa_core_annotations_orderby_stateless3_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + Client1.class.getName() + "\n"), "MANIFEST.MF");
        ...
        // Ejb
            ...
            if(ejbResURL != null) {
              jpa_core_annotations_orderby_stateless3_vehicle_ejb.addAsManifestResource(ejbResURL, "ejb-jar.xml");
            }
            ...
            archiveProcessor.processEjbArchive(jpa_core_annotations_orderby_stateless3_vehicle_ejb, Client1.class, ejbResURL);

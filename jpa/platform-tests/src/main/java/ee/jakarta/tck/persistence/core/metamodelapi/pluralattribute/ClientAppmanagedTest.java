...
public class ClientAppmanagedTest extends ee.jakarta.tck.persistence.core.metamodelapi.pluralattribute.Client {
    static final String VEHICLE_ARCHIVE = "jpa_core_metamodelapi_pluralattribute_appmanaged_vehicle";
        ...
        */
        ...
        // Client
            ...
            JavaArchive jpa_core_metamodelapi_pluralattribute_appmanaged_vehicle_client = ShrinkWrap.create(JavaArchive.class, "jpa_core_metamodelapi_pluralattribute_appmanaged_vehicle_client.jar");
            // The class files
            jpa_core_metamodelapi_pluralattribute_appmanaged_vehicle_client.addClasses(
            ...
            if(resURL != null) {
              jpa_core_metamodelapi_pluralattribute_appmanaged_vehicle_client.addAsManifestResource(resURL, "application-client.xml");
            }
            ...
            jpa_core_metamodelapi_pluralattribute_appmanaged_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: com.sun.ts.tests.common.vehicle.VehicleClient\n"), "MANIFEST.MF");
            // Call the archive processor
            archiveProcessor.processClientArchive(jpa_core_metamodelapi_pluralattribute_appmanaged_vehicle_client, Client.class, resURL);

        // Ejb 1
            // the jar with the correct archive name
            JavaArchive jpa_core_metamodelapi_pluralattribute_appmanaged_vehicle_ejb = ShrinkWrap.create(JavaArchive.class, "jpa_core_metamodelapi_pluralattribute_appmanaged_vehicle_ejb.jar");
            // The class files
            jpa_core_metamodelapi_pluralattribute_appmanaged_vehicle_ejb.addClasses(
            ...
            if(ejbResURL1 != null) {
              jpa_core_metamodelapi_pluralattribute_appmanaged_vehicle_ejb.addAsManifestResource(ejbResURL1, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL1 = Client.class.getResource("//vehicle/appmanaged/appmanaged_vehicle_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL1 != null) {
              jpa_core_metamodelapi_pluralattribute_appmanaged_vehicle_ejb.addAsManifestResource(ejbResURL1, "sun-ejb-jar.xml");
            }
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_metamodelapi_pluralattribute_appmanaged_vehicle_ejb, Client.class, ejbResURL1);
        ...
        // Par
            ...
            if(mappingURL != null) {
              jpa_core_metamodelapi_pluralattribute.addAsManifestResource(mappingURL, "myMappingFile.xml");
            }
            mappingURL = Client.class.getResource("myMappingFile1.xml");
            if(mappingURL != null) {
              jpa_core_metamodelapi_pluralattribute.addAsManifestResource(mappingURL, "myMappingFile1.xml");
            }
            mappingURL = Client.class.getResource("myMappingFile2.xml");
            if(mappingURL != null) {
              jpa_core_metamodelapi_pluralattribute.addAsManifestResource(mappingURL, "myMappingFile2.xml");
            }
        ...
        // Ear
            ...
            jpa_core_metamodelapi_pluralattribute_vehicles_ear.addAsModule(jpa_core_metamodelapi_pluralattribute_appmanaged_vehicle_ejb);
            jpa_core_metamodelapi_pluralattribute_vehicles_ear.addAsModule(jpa_core_metamodelapi_pluralattribute_appmanaged_vehicle_client);

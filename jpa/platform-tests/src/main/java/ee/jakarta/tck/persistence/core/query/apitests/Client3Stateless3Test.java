...
public class Client3Stateless3Test extends ee.jakarta.tck.persistence.core.query.apitests.Client3 {
    static final String VEHICLE_ARCHIVE = "jpa_core_query_apitests_stateless3_vehicle";
        ...
        */
        ...
        // Client
            ...
            archiveProcessor.processClientArchive(jpa_core_query_apitests_stateless3_vehicle_client, Client3.class, resURL);
        ...
        // Ejb 1
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_query_apitests_stateless3_vehicle_ejb, Client3.class, ejbResURL1);

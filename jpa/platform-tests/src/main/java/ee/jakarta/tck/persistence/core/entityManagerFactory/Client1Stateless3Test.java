    ...
    static final String VEHICLE_ARCHIVE = "jpa_core_entityManagerFactory_stateless3_vehicle";
        ...
        */
        ...
        // Client
            ...
            jpa_core_entityManagerFactory_stateless3_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + Client1.class.getName() + "\n"), "MANIFEST.MF");
        ...
        // Ejb
            ...
            if(ejbResURL != null) {
              jpa_core_entityManagerFactory_stateless3_vehicle_ejb.addAsManifestResource(ejbResURL, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL = Client1.class.getResource("//vehicle/stateless3/stateless3_vehicle_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL != null) {
              jpa_core_entityManagerFactory_stateless3_vehicle_ejb.addAsManifestResource(ejbResURL, "sun-ejb-jar.xml");
            }
            archiveProcessor.processEjbArchive(jpa_core_entityManagerFactory_stateless3_vehicle_ejb, Client1.class, ejbResURL);
        ...
        // Ear
            ...
            URL earResURL = Client1.class.getResource("/com/sun/ts/tests/jpa/core/entityManagerFactory/");
            if(earResURL != null) {
              jpa_core_entityManagerFactory_vehicles_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client1.class.getResource("/com/sun/ts/tests/jpa/core/entityManagerFactory/.ear.sun-application.xml");
            if(earResURL != null) {

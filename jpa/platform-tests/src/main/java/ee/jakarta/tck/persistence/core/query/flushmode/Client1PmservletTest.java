...
public class Client1PmservletTest extends ee.jakarta.tck.persistence.core.query.flushmode.Client1 {
    static final String VEHICLE_ARCHIVE = "jpa_core_query_flushmode_pmservlet_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client1.class.getResource("/com/sun/ts/tests/jpa/core/query/flushmode/jpa_core_query_flushmode.jar");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(jpa_core_query_flushmode_pmservlet_vehicle_web, Client1.class, warResURL);

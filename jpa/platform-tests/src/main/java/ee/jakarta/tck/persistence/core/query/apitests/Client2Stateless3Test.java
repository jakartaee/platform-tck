    ...
    static final String VEHICLE_ARCHIVE = "jpa_core_query_apitests_stateless3_vehicle";
        ...
        */
        ...
        // Client
            ...
            jpa_core_query_apitests_stateless3_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + Client2.class.getName() + "\n"), "MANIFEST.MF");
            archiveProcessor.processClientArchive(jpa_core_query_apitests_stateless3_vehicle_client, Client2.class, resURL);
        ...
        // Ejb
            ...
            if(ejbResURL != null) {
              jpa_core_query_apitests_stateless3_vehicle_ejb.addAsManifestResource(ejbResURL, "ejb-jar.xml");
            }
            ...
            archiveProcessor.processEjbArchive(jpa_core_query_apitests_stateless3_vehicle_ejb, Client2.class, ejbResURL);

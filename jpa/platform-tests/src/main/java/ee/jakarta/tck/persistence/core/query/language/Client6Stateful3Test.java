...
public class Client6Stateful3Test extends ee.jakarta.tck.persistence.core.query.language.Client6 {
    static final String VEHICLE_ARCHIVE = "jpa_core_query_language_stateful3_vehicle";
        ...
        */
        ...
        // Ejb 1
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_query_language_stateful3_vehicle_ejb, Client6.class, ejbResURL1);

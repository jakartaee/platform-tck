...
public class Client3AppmanagednotxTest extends ee.jakarta.tck.persistence.core.criteriaapi.metamodelquery.Client3 {
    static final String VEHICLE_ARCHIVE = "jpa_core_criteriaapi_metamodelquery_appmanagedNoTx_vehicle";
        ...
        */
        ...
        // Client
            ...
            jpa_core_criteriaapi_metamodelquery_appmanagedNoTx_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + Client3.class.getName() + "\n"), "MANIFEST.MF");
            // Call the archive processor
            archiveProcessor.processClientArchive(jpa_core_criteriaapi_metamodelquery_appmanagedNoTx_vehicle_client, Client3.class, resURL);
        ...
        // Ejb
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_criteriaapi_metamodelquery_appmanagedNoTx_vehicle_ejb, Client3.class, ejbResURL);

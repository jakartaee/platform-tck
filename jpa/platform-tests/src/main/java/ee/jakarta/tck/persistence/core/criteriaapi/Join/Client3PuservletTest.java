...
public class Client3PuservletTest extends ee.jakarta.tck.persistence.core.criteriaapi.Join.Client3 {
    static final String VEHICLE_ARCHIVE = "jpa_core_criteriaapi_Join_puservlet_vehicle";
        ...
        */
        ...
        // War
           ...
           archiveProcessor.processWebArchive(jpa_core_criteriaapi_Join_puservlet_vehicle_web, Client3.class, warResURL);
        ...
        // Ear
            ...
            jpa_core_criteriaapi_Join_vehicles_ear.addAsModule(jpa_core_criteriaapi_Join_puservlet_vehicle_web);

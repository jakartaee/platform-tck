...
public class Client3PmservletTest extends ee.jakarta.tck.persistence.core.entityManagerFactory.Client3 {
    static final String VEHICLE_ARCHIVE = "jpa_core_entityManagerFactory_pmservlet_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client3.class.getResource("/com/sun/ts/tests/jpa/core/entityManagerFactory/jpa_core_entityManagerFactory.jar");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(jpa_core_entityManagerFactory_pmservlet_vehicle_web, Client3.class, warResURL);

...
public class ClientAppmanagednotxTest extends ee.jakarta.tck.persistence.jpa22.query.stream.Client {
    static final String VEHICLE_ARCHIVE = "jpa_jpa22_query_stream_appmanagedNoTx_vehicle";
        ...
        */
        ...
        // Client
            ...
            JavaArchive jpa_jpa22_query_stream_appmanagedNoTx_vehicle_client = ShrinkWrap.create(JavaArchive.class, "jpa_jpa22_query_stream_appmanagedNoTx_vehicle_client.jar");
            // The class files
            jpa_jpa22_query_stream_appmanagedNoTx_vehicle_client.addClasses(
            ...
            if(resURL != null) {
              jpa_jpa22_query_stream_appmanagedNoTx_vehicle_client.addAsManifestResource(resURL, "application-client.xml");
            }
            ...
            jpa_jpa22_query_stream_appmanagedNoTx_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: com.sun.ts.tests.common.vehicle.VehicleClient\n"), "MANIFEST.MF");
            // Call the archive processor
            archiveProcessor.processClientArchive(jpa_jpa22_query_stream_appmanagedNoTx_vehicle_client, Client.class, resURL);

        // Ejb 1
            // the jar with the correct archive name
            JavaArchive jpa_jpa22_query_stream_appmanagedNoTx_vehicle_ejb = ShrinkWrap.create(JavaArchive.class, "jpa_jpa22_query_stream_appmanagedNoTx_vehicle_ejb.jar");
            // The class files
            jpa_jpa22_query_stream_appmanagedNoTx_vehicle_ejb.addClasses(
            ...
            if(ejbResURL1 != null) {
              jpa_jpa22_query_stream_appmanagedNoTx_vehicle_ejb.addAsManifestResource(ejbResURL1, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL1 = Client.class.getResource("//vehicle/appmanagedNoTx/appmanagedNoTx_vehicle_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL1 != null) {
              jpa_jpa22_query_stream_appmanagedNoTx_vehicle_ejb.addAsManifestResource(ejbResURL1, "sun-ejb-jar.xml");
            }
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_jpa22_query_stream_appmanagedNoTx_vehicle_ejb, Client.class, ejbResURL1);
        ...
        // Par
            ...
            if(mappingURL != null) {
              jpa_jpa22_query_stream.addAsManifestResource(mappingURL, "myMappingFile.xml");
            }
            mappingURL = Client.class.getResource("myMappingFile1.xml");
            if(mappingURL != null) {
              jpa_jpa22_query_stream.addAsManifestResource(mappingURL, "myMappingFile1.xml");
            }
            mappingURL = Client.class.getResource("myMappingFile2.xml");
            if(mappingURL != null) {
              jpa_jpa22_query_stream.addAsManifestResource(mappingURL, "myMappingFile2.xml");
            }
        ...
        // Ear
            ...
            jpa_jpa22_query_stream_vehicles_ear.addAsModule(jpa_jpa22_query_stream_appmanagedNoTx_vehicle_ejb);
            jpa_jpa22_query_stream_vehicles_ear.addAsModule(jpa_jpa22_query_stream_appmanagedNoTx_vehicle_client);

...
public class Client1AppmanagedTest extends ee.jakarta.tck.persistence.core.criteriaapi.CriteriaQuery.Client1 {
    static final String VEHICLE_ARCHIVE = "jpa_core_criteriaapi_CriteriaQuery_appmanaged_vehicle";
        ...
        */
        ...
        // Client
            ...
            jpa_core_criteriaapi_CriteriaQuery_appmanaged_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + Client1.class.getName() + "\n"), "MANIFEST.MF");
            archiveProcessor.processClientArchive(jpa_core_criteriaapi_CriteriaQuery_appmanaged_vehicle_client, Client1.class, resURL);
        ...
        // Ejb
            ...
            archiveProcessor.processEjbArchive(jpa_core_criteriaapi_CriteriaQuery_appmanaged_vehicle_ejb, Client1.class, ejbResURL);

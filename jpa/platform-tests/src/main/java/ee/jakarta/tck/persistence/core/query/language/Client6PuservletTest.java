...
public class Client6PuservletTest extends ee.jakarta.tck.persistence.core.query.language.Client6 {
    static final String VEHICLE_ARCHIVE = "jpa_core_query_language_puservlet_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client6.class.getResource("/com/sun/ts/tests/jpa/core/query/language/jpa_core_query_language.jar");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(jpa_core_query_language_puservlet_vehicle_web, Client6.class, warResURL);
        ...
        // Ear
            ...
            jpa_core_query_language_vehicles_ear.addAsModule(jpa_core_query_language_puservlet_vehicle_web);

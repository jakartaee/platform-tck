    ...
    static final String VEHICLE_ARCHIVE = "jpa_core_criteriaapi_From_appmanagedNoTx_vehicle";
        ...
        */
        ...
        // Client
            ...
            jpa_core_criteriaapi_From_appmanagedNoTx_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: com.sun.ts.tests.common.vehicle.VehicleClient\n"), "MANIFEST.MF");
        ...
        // Ejb 1
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_criteriaapi_From_appmanagedNoTx_vehicle_ejb, Client4.class, ejbResURL1);
        ...
        // Par
            ...
            if(mappingURL != null) {
              jpa_core_criteriaapi_From.addAsManifestResource(mappingURL, "myMappingFile.xml");
            }
            mappingURL = Client4.class.getResource("myMappingFile1.xml");
            if(mappingURL != null) {
              jpa_core_criteriaapi_From.addAsManifestResource(mappingURL, "myMappingFile1.xml");
            }
            mappingURL = Client4.class.getResource("myMappingFile2.xml");
            if(mappingURL != null) {
              jpa_core_criteriaapi_From.addAsManifestResource(mappingURL, "myMappingFile2.xml");
            }

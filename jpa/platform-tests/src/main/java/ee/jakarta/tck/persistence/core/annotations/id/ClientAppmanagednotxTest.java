...
public class ClientAppmanagednotxTest extends ee.jakarta.tck.persistence.core.annotations.id.Client {
    static final String VEHICLE_ARCHIVE = "jpa_core_annotations_basic_appmanagedNoTx_vehicle";
        ...
        */
        ...
        // Client
            ...
            archiveProcessor.processClientArchive(jpa_core_annotations_basic_appmanagedNoTx_vehicle_client, Client.class, resURL);
        ...
        // Ejb 1
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_annotations_basic_appmanagedNoTx_vehicle_ejb, Client.class, ejbResURL1);

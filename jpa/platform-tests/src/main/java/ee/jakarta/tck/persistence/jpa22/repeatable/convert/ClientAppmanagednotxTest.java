    ...
    static final String VEHICLE_ARCHIVE = "jpa_jpa22_repeatable_converts_appmanagedNoTx_vehicle";
        ...
        */
        ...
        // Client
            ...
            jpa_jpa22_repeatable_converts_appmanagedNoTx_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: com.sun.ts.tests.common.vehicle.VehicleClient\n"), "MANIFEST.MF");

    ...
    static final String VEHICLE_ARCHIVE = "jpa_core_annotations_elementcollection_stateful3_vehicle";
        ...
        */
        ...
        // Ejb
            ...
            if(ejbResURL != null) {
              jpa_core_annotations_elementcollection_stateful3_vehicle_ejb.addAsManifestResource(ejbResURL, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL = Client1.class.getResource("//vehicle/stateful3/stateful3_vehicle_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL != null) {
              jpa_core_annotations_elementcollection_stateful3_vehicle_ejb.addAsManifestResource(ejbResURL, "sun-ejb-jar.xml");
            }
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_annotations_elementcollection_stateful3_vehicle_ejb, Client1.class, ejbResURL);

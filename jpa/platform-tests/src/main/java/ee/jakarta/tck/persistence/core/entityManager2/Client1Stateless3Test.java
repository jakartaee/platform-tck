...
import ee.jakarta.tck.persistence.core.entityManager2.Client1;
import java.net.URL;
...
public class Client1Stateless3Test extends ee.jakarta.tck.persistence.core.entityManager2.Client1 {
    static final String VEHICLE_ARCHIVE = "jpa_core_entityManager2_stateless3_vehicle";
        ...
        */
        ...
        // Client
            ...
            archiveProcessor.processClientArchive(jpa_core_entityManager2_stateless3_vehicle_client, Client1.class, resURL);
        ...
        // Ejb
            ...
            archiveProcessor.processEjbArchive(jpa_core_entityManager2_stateless3_vehicle_ejb, Client1.class, ejbResURL);
        ...
        // Ear
            ...
            URL earResURL = Client1.class.getResource("/com/sun/ts/tests/jpa/core/entityManager2/");
            if(earResURL != null) {
              jpa_core_entityManager2_vehicles_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client1.class.getResource("/com/sun/ts/tests/jpa/core/entityManager2/.ear.sun-application.xml");
            if(earResURL != null) {

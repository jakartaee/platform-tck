    ...
    static final String VEHICLE_ARCHIVE = "jpa_core_criteriaapi_parameter_appmanaged_vehicle";
        ...
        */
        ...
        // Client
            ...
            JavaArchive jpa_core_criteriaapi_parameter_appmanaged_vehicle_client = ShrinkWrap.create(JavaArchive.class, "jpa_core_criteriaapi_parameter_appmanaged_vehicle_client.jar");
            // The class files
            jpa_core_criteriaapi_parameter_appmanaged_vehicle_client.addClasses(
            ...
            jpa_core_criteriaapi_parameter_appmanaged_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + Client2.class.getName() + "\n"), "MANIFEST.MF");
            // Call the archive processor
            archiveProcessor.processClientArchive(jpa_core_criteriaapi_parameter_appmanaged_vehicle_client, Client2.class, resURL);
        ...
        // Ejb
            ...
            // The class files
            jpa_core_criteriaapi_parameter_appmanaged_vehicle_ejb.addClasses(
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_criteriaapi_parameter_appmanaged_vehicle_ejb, Client2.class, ejbResURL);
        ...
        // Ear
            ...
            jpa_core_criteriaapi_parameter_vehicles_ear.addAsModule(jpa_core_criteriaapi_parameter_appmanaged_vehicle_ejb);
            jpa_core_criteriaapi_parameter_vehicles_ear.addAsModule(jpa_core_criteriaapi_parameter_appmanaged_vehicle_client);

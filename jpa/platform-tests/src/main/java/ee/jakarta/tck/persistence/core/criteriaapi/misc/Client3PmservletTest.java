...
public class Client3PmservletTest extends ee.jakarta.tck.persistence.core.criteriaapi.misc.Client3 {
    static final String VEHICLE_ARCHIVE = "jpa_core_criteriaapi_misc_pmservlet_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client3.class.getResource("/com/sun/ts/tests/jpa/core/criteriaapi/misc/jpa_core_criteriaapi_misc.jar");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(jpa_core_criteriaapi_misc_pmservlet_vehicle_web, Client3.class, warResURL);

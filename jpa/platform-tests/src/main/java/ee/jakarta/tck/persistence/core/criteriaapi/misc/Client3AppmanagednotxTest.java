...
public class Client3AppmanagednotxTest extends ee.jakarta.tck.persistence.core.criteriaapi.misc.Client3 {
    static final String VEHICLE_ARCHIVE = "jpa_core_criteriaapi_misc_appmanagedNoTx_vehicle";
        ...
        */
        ...
        // Client
            ...
            JavaArchive jpa_core_criteriaapi_misc_appmanagedNoTx_vehicle_client = ShrinkWrap.create(JavaArchive.class, "jpa_core_criteriaapi_misc_appmanagedNoTx_vehicle_client.jar");
            // The class files
            ...
            jpa_core_criteriaapi_misc_appmanagedNoTx_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + Client3.class.getName() + "\n"), "MANIFEST.MF");
            // Call the archive processor
            archiveProcessor.processClientArchive(jpa_core_criteriaapi_misc_appmanagedNoTx_vehicle_client, Client3.class, resURL);
        ...
        // Ejb
            ...
            if(ejbResURL != null) {
              jpa_core_criteriaapi_misc_appmanagedNoTx_vehicle_ejb.addAsManifestResource(ejbResURL, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL = Client3.class.getResource("//vehicle/appmanagedNoTx/appmanagedNoTx_vehicle_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL != null) {
              jpa_core_criteriaapi_misc_appmanagedNoTx_vehicle_ejb.addAsManifestResource(ejbResURL, "sun-ejb-jar.xml");
            }
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_criteriaapi_misc_appmanagedNoTx_vehicle_ejb, Client3.class, ejbResURL);

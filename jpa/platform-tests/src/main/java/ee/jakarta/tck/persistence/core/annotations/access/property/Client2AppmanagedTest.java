...
import ee.jakarta.tck.persistence.core.annotations.access.property.Client2;
import java.net.URL;
    ...
    static final String VEHICLE_ARCHIVE = "jpa_core_annotations_access_property_appmanaged_vehicle";
        ...
        */
        ...
        // Client
            ...
            JavaArchive jpa_core_annotations_access_property_appmanaged_vehicle_client = ShrinkWrap.create(JavaArchive.class, "jpa_core_annotations_access_property_appmanaged_vehicle_client.jar");
            // The class files
            jpa_core_annotations_access_property_appmanaged_vehicle_client.addClasses(
            ...
            if(resURL != null) {
              jpa_core_annotations_access_property_appmanaged_vehicle_client.addAsManifestResource(resURL, "application-client.xml");
            }
            ...
            jpa_core_annotations_access_property_appmanaged_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + Client2.class.getName() + "\n"), "MANIFEST.MF");
            archiveProcessor.processClientArchive(jpa_core_annotations_access_property_appmanaged_vehicle_client, Client2.class, resURL);


        // Ejb
            // the jar with the correct archive name
            JavaArchive jpa_core_annotations_access_property_appmanaged_vehicle_ejb = ShrinkWrap.create(JavaArchive.class, "jpa_core_annotations_access_property_appmanaged_vehicle_ejb.jar");
            // The class files
            jpa_core_annotations_access_property_appmanaged_vehicle_ejb.addClasses(
            ...
            if(ejbResURL != null) {
              jpa_core_annotations_access_property_appmanaged_vehicle_ejb.addAsManifestResource(ejbResURL, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL = Client2.class.getResource("//vehicle/appmanaged/appmanaged_vehicle_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL != null) {
              jpa_core_annotations_access_property_appmanaged_vehicle_ejb.addAsManifestResource(ejbResURL, "sun-ejb-jar.xml");
            }
            archiveProcessor.processEjbArchive(jpa_core_annotations_access_property_appmanaged_vehicle_ejb, Client2.class, ejbResURL);
        ...
        // Par
            ...
            archiveProcessor.processParArchive(jpa_core_annotations_access_property, Client2.class, parURL);
            // The orm.xml file
        ...
        // Ear
            ...
            jpa_core_annotations_access_property_vehicles_ear.addAsModule(jpa_core_annotations_access_property_appmanaged_vehicle_ejb);
            jpa_core_annotations_access_property_vehicles_ear.addAsModule(jpa_core_annotations_access_property_appmanaged_vehicle_client);
            ...
            URL earResURL = Client2.class.getResource("/com/sun/ts/tests/jpa/core/annotations/access/property/");
            if(earResURL != null) {
              jpa_core_annotations_access_property_vehicles_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client2.class.getResource("/com/sun/ts/tests/jpa/core/annotations/access/property/.ear.sun-application.xml");
            if(earResURL != null) {
              jpa_core_annotations_access_property_vehicles_ear.addAsManifestResource(earResURL, "sun-application.xml");
            }
            archiveProcessor.processEarArchive(jpa_core_annotations_access_property_vehicles_ear, Client2.class, earResURL);

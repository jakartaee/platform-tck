...
public class Client4PuservletTest extends ee.jakarta.tck.persistence.core.criteriaapi.strquery.Client4 {
    static final String VEHICLE_ARCHIVE = "jpa_core_criteriaapi_strquery_puservlet_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client4.class.getResource("/com/sun/ts/tests/jpa/core/criteriaapi/strquery/jpa_core_criteriaapi_strquery.jar");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(jpa_core_criteriaapi_strquery_puservlet_vehicle_web, Client4.class, warResURL);

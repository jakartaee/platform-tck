...
import ee.jakarta.tck.persistence.core.types.generator.Client4;
import java.net.URL;
...
public class Client4Stateful3Test extends ee.jakarta.tck.persistence.core.types.generator.Client4 {
    static final String VEHICLE_ARCHIVE = "jpa_core_types_generator_stateful3_vehicle";
        ...
        */
        ...
        // Client
            ...
            jpa_core_types_generator_stateful3_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + Client4.class.getName() + "\n"), "MANIFEST.MF");
            // Call the archive processor
            archiveProcessor.processClientArchive(jpa_core_types_generator_stateful3_vehicle_client, Client4.class, resURL);
        ...
        // Ejb
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_types_generator_stateful3_vehicle_ejb, Client4.class, ejbResURL);
        ...
        // Ear
            ...
            URL earResURL = Client4.class.getResource("/com/sun/ts/tests/jpa/core/types/generator/");
            if(earResURL != null) {
              jpa_core_types_generator_vehicles_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client4.class.getResource("/com/sun/ts/tests/jpa/core/types/generator/.ear.sun-application.xml");
            if(earResURL != null) {

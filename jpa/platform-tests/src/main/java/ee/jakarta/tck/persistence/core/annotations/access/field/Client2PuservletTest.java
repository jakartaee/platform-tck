    ...
    static final String VEHICLE_ARCHIVE = "jpa_core_annotations_access_field_puservlet_vehicle";
        ...
        */
        ...
        // Ear
            ...
            URL earResURL = Client2.class.getResource("/com/sun/ts/tests/jpa/core/annotations/access/field/");
            if(earResURL != null) {
              jpa_core_annotations_access_field_vehicles_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client2.class.getResource("/com/sun/ts/tests/jpa/core/annotations/access/field/.ear.sun-application.xml");
            if(earResURL != null) {

...
import ee.jakarta.tck.persistence.core.annotations.access.field.Client2;
import java.net.URL;
...
public class Client2PuservletTest extends ee.jakarta.tck.persistence.core.annotations.access.field.Client2 {
    static final String VEHICLE_ARCHIVE = "jpa_core_annotations_access_field_puservlet_vehicle";
        ...
        */
        ...
        // War
            ...
            WebArchive jpa_core_annotations_access_field_puservlet_vehicle_web = ShrinkWrap.create(WebArchive.class, "jpa_core_annotations_access_field_puservlet_vehicle_web.war");
            // The class files
            jpa_core_annotations_access_field_puservlet_vehicle_web.addClasses(
            ...
            if(warResURL != null) {
              jpa_core_annotations_access_field_puservlet_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = Client2.class.getResource("//com/sun/ts/tests/common/vehicle/puservlet/puservlet_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
              jpa_core_annotations_access_field_puservlet_vehicle_web.addAsWebInfResource(warResURL, "sun-web.xml");
            }
            ...
            if(warResURL != null) {
              jpa_core_annotations_access_field_puservlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/lib/jpa_core_annotations_access_field.jar");
            }
            warResURL = Client2.class.getResource("/com/sun/ts/tests/common/vehicle/puservlet/puservlet_vehicle_web.xml");
            if(warResURL != null) {
              jpa_core_annotations_access_field_puservlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/puservlet_vehicle_web.xml");
            }

           // Call the archive processor
           archiveProcessor.processWebArchive(jpa_core_annotations_access_field_puservlet_vehicle_web, Client2.class, warResURL);
        ...
        // Par
            ...
            if(mappingURL != null) {
              jpa_core_annotations_access_field.addAsManifestResource(mappingURL, "myMappingFile.xml");
            }
            mappingURL = Client2.class.getResource("myMappingFile1.xml");
            if(mappingURL != null) {
              jpa_core_annotations_access_field.addAsManifestResource(mappingURL, "myMappingFile1.xml");
            }
            mappingURL = Client2.class.getResource("myMappingFile2.xml");
            if(mappingURL != null) {
              jpa_core_annotations_access_field.addAsManifestResource(mappingURL, "myMappingFile2.xml");
            }
        ...
        // Ear
            ...
            jpa_core_annotations_access_field_vehicles_ear.addAsModule(jpa_core_annotations_access_field_puservlet_vehicle_web);
            ...
            // Call the archive processor
            archiveProcessor.processEarArchive(jpa_core_annotations_access_field_vehicles_ear, Client2.class, earResURL);

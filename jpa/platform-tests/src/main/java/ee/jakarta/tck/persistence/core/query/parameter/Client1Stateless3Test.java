...
import ee.jakarta.tck.persistence.core.query.parameter.Client1;
import java.net.URL;
...
public class Client1Stateless3Test extends ee.jakarta.tck.persistence.core.query.parameter.Client1 {
    static final String VEHICLE_ARCHIVE = "jpa_core_query_parameter_stateless3_vehicle";
        ...
        */
        ...
        // Client
            ...
            JavaArchive jpa_core_query_parameter_stateless3_vehicle_client = ShrinkWrap.create(JavaArchive.class, "jpa_core_query_parameter_stateless3_vehicle_client.jar");
            // The class files
            jpa_core_query_parameter_stateless3_vehicle_client.addClasses(
            ...
            if(resURL != null) {
              jpa_core_query_parameter_stateless3_vehicle_client.addAsManifestResource(resURL, "application-client.xml");
            }
            ...
            jpa_core_query_parameter_stateless3_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: com.sun.ts.tests.common.vehicle.VehicleClient\n"), "MANIFEST.MF");
            // Call the archive processor
            archiveProcessor.processClientArchive(jpa_core_query_parameter_stateless3_vehicle_client, Client1.class, resURL);

        // Ejb 1
            // the jar with the correct archive name
            JavaArchive jpa_core_query_parameter_stateless3_vehicle_ejb = ShrinkWrap.create(JavaArchive.class, "jpa_core_query_parameter_stateless3_vehicle_ejb.jar");
            // The class files
            jpa_core_query_parameter_stateless3_vehicle_ejb.addClasses(
                ...
                com.sun.ts.tests.common.vehicle.VehicleRunnable.class,
                com.sun.ts.tests.common.vehicle.ejb3share.UserTransactionWrapper.class,
                ee.jakarta.tck.persistence.core.query.parameter.Client1.class,
            ...
            if(ejbResURL1 != null) {
              jpa_core_query_parameter_stateless3_vehicle_ejb.addAsManifestResource(ejbResURL1, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL1 = Client1.class.getResource("//vehicle/stateless3/stateless3_vehicle_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL1 != null) {
              jpa_core_query_parameter_stateless3_vehicle_ejb.addAsManifestResource(ejbResURL1, "sun-ejb-jar.xml");
            }
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_query_parameter_stateless3_vehicle_ejb, Client1.class, ejbResURL1);
        ...
        // Par
            ...
            if(mappingURL != null) {
              jpa_core_query_parameter.addAsManifestResource(mappingURL, "myMappingFile.xml");
            }
            mappingURL = Client1.class.getResource("myMappingFile1.xml");
            if(mappingURL != null) {
              jpa_core_query_parameter.addAsManifestResource(mappingURL, "myMappingFile1.xml");
            }
            mappingURL = Client1.class.getResource("myMappingFile2.xml");
            if(mappingURL != null) {
              jpa_core_query_parameter.addAsManifestResource(mappingURL, "myMappingFile2.xml");
            }

            // Call the archive processor
            archiveProcessor.processParArchive(jpa_core_query_parameter, Client1.class, parURL);
        ...
        // Ear
            ...
            jpa_core_query_parameter_vehicles_ear.addAsModule(jpa_core_query_parameter_stateless3_vehicle_ejb);
            jpa_core_query_parameter_vehicles_ear.addAsModule(jpa_core_query_parameter_stateless3_vehicle_client);
            ...
            // Call the archive processor
            archiveProcessor.processEarArchive(jpa_core_query_parameter_vehicles_ear, Client1.class, earResURL);
        ...
        @Override
        @TargetVehicle("stateless3")
        public void parameterTestTQ1() throws java.lang.Exception {
        ...
        @Override
        @TargetVehicle("stateless3")
        public void parameterTQTest2() throws java.lang.Exception {
        ...
        @Override
        @TargetVehicle("stateless3")
        public void parameterTest5() throws java.lang.Exception {
        ...
        @Override
        @TargetVehicle("stateless3")
        public void getParametersTQTest() throws java.lang.Exception {
        ...
        @Override
        @TargetVehicle("stateless3")
        public void getParametersNoParametersTest() throws java.lang.Exception {

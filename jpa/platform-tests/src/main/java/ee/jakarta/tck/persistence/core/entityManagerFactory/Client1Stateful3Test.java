...
public class Client1Stateful3Test extends ee.jakarta.tck.persistence.core.entityManagerFactory.Client1 {
    static final String VEHICLE_ARCHIVE = "jpa_core_entityManagerFactory_stateful3_vehicle";
        ...
        */
        ...
        // Ejb
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_entityManagerFactory_stateful3_vehicle_ejb, Client1.class, ejbResURL);

...
public class Client3PmservletTest extends ee.jakarta.tck.persistence.core.annotations.tableGenerator.Client3 {
    static final String VEHICLE_ARCHIVE = "jpa_core_annotations_tableGenerator_pmservlet_vehicle";
        ...
        */
        ...
        // War
            ...
            WebArchive jpa_core_annotations_tableGenerator_pmservlet_vehicle_web = ShrinkWrap.create(WebArchive.class, "jpa_core_annotations_tableGenerator_pmservlet_vehicle_web.war");
            // The class files
            jpa_core_annotations_tableGenerator_pmservlet_vehicle_web.addClasses(
            ...
            if(warResURL != null) {
              jpa_core_annotations_tableGenerator_pmservlet_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = Client3.class.getResource("//com/sun/ts/tests/common/vehicle/pmservlet/pmservlet_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
              jpa_core_annotations_tableGenerator_pmservlet_vehicle_web.addAsWebInfResource(warResURL, "sun-web.xml");
            }

            // Any libraries added to the war

            // Web content
            warResURL = Client3.class.getResource("/com/sun/ts/tests/jpa/core/annotations/tableGenerator/jpa_core_annotations_tableGenerator.jar");
            if(warResURL != null) {
              jpa_core_annotations_tableGenerator_pmservlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/lib/jpa_core_annotations_tableGenerator.jar");
            }
            warResURL = Client3.class.getResource("/com/sun/ts/tests/common/vehicle/pmservlet/pmservlet_vehicle_web.xml");
            if(warResURL != null) {
              jpa_core_annotations_tableGenerator_pmservlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/pmservlet_vehicle_web.xml");
            }

           // Call the archive processor
           archiveProcessor.processWebArchive(jpa_core_annotations_tableGenerator_pmservlet_vehicle_web, Client3.class, warResURL);
        ...
        // Ear
            ...
            jpa_core_annotations_tableGenerator_vehicles_ear.addAsModule(jpa_core_annotations_tableGenerator_pmservlet_vehicle_web);

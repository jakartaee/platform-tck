    ...
    static final String VEHICLE_ARCHIVE = "jpa_core_annotations_access_field_stateless3_vehicle";
        ...
        */
        ...
        // Ejb
            ...
            if(ejbResURL != null) {
              jpa_core_annotations_access_field_stateless3_vehicle_ejb.addAsManifestResource(ejbResURL, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL = Client2.class.getResource("//vehicle/stateless3/stateless3_vehicle_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL != null) {
              jpa_core_annotations_access_field_stateless3_vehicle_ejb.addAsManifestResource(ejbResURL, "sun-ejb-jar.xml");
            }
            archiveProcessor.processEjbArchive(jpa_core_annotations_access_field_stateless3_vehicle_ejb, Client2.class, ejbResURL);

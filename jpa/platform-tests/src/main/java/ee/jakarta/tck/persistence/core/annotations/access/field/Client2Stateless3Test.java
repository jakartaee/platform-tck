...
public class Client2Stateless3Test extends ee.jakarta.tck.persistence.core.annotations.access.field.Client2 {
    static final String VEHICLE_ARCHIVE = "jpa_core_annotations_access_field_stateless3_vehicle";
        ...
        */
        ...
        // Ejb 1
            // the jar with the correct archive name
            JavaArchive jpa_core_annotations_access_field_stateless3_vehicle_ejb = ShrinkWrap.create(JavaArchive.class, "jpa_core_annotations_access_field_stateless3_vehicle_ejb.jar");
            // The class files
            jpa_core_annotations_access_field_stateless3_vehicle_ejb.addClasses(
            ...
            if(ejbResURL1 != null) {
              jpa_core_annotations_access_field_stateless3_vehicle_ejb.addAsManifestResource(ejbResURL1, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL1 = Client2.class.getResource("//vehicle/stateless3/stateless3_vehicle_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL1 != null) {
              jpa_core_annotations_access_field_stateless3_vehicle_ejb.addAsManifestResource(ejbResURL1, "sun-ejb-jar.xml");
            }
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_annotations_access_field_stateless3_vehicle_ejb, Client2.class, ejbResURL1);
        ...
        // Ear
            ...
            jpa_core_annotations_access_field_vehicles_ear.addAsModule(jpa_core_annotations_access_field_stateless3_vehicle_ejb);
            jpa_core_annotations_access_field_vehicles_ear.addAsModule(jpa_core_annotations_access_field_stateless3_vehicle_client);

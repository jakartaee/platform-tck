    ...
    static final String VEHICLE_ARCHIVE = "jpa_core_callback_listeneroverride_appmanagedNoTx_vehicle";
        ...
        */
        ...
        // Client
            ...
            JavaArchive jpa_core_callback_listeneroverride_appmanagedNoTx_vehicle_client = ShrinkWrap.create(JavaArchive.class, "jpa_core_callback_listeneroverride_appmanagedNoTx_vehicle_client.jar");
            // The class files
            ...
            jpa_core_callback_listeneroverride_appmanagedNoTx_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: com.sun.ts.tests.common.vehicle.VehicleClient\n"), "MANIFEST.MF");
        ...
        // Par
            ...
            if(mappingURL != null) {
              jpa_core_callback_listeneroverride.addAsManifestResource(mappingURL, "myMappingFile.xml");
            }
            mappingURL = Client.class.getResource("myMappingFile1.xml");
            if(mappingURL != null) {
              jpa_core_callback_listeneroverride.addAsManifestResource(mappingURL, "myMappingFile1.xml");
            }
            mappingURL = Client.class.getResource("myMappingFile2.xml");
            if(mappingURL != null) {
              jpa_core_callback_listeneroverride.addAsManifestResource(mappingURL, "myMappingFile2.xml");
            }

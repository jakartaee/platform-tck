...
public class Client2PuservletTest extends ee.jakarta.tck.persistence.core.query.apitests.Client2 {
    static final String VEHICLE_ARCHIVE = "jpa_core_query_apitests_puservlet_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client2.class.getResource("/com/sun/ts/tests/jpa/core/query/apitests/jpa_core_query_apitests.jar");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(jpa_core_query_apitests_puservlet_vehicle_web, Client2.class, warResURL);
        ...
        // Ear
            ...
            jpa_core_query_apitests_vehicles_ear.addAsModule(jpa_core_query_apitests_puservlet_vehicle_web);

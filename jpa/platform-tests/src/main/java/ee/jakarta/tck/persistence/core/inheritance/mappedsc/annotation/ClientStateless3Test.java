    ...
    static final String VEHICLE_ARCHIVE = "jpa_core_inherit_msc_annotation_stateless3_vehicle";
        ...
        */
        ...
        // Client
            ...
            jpa_core_inherit_msc_annotation_stateless3_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + Client.class.getName() + "\n"), "MANIFEST.MF");
        ...
        // Ejb
            ...
            if(ejbResURL != null) {
              jpa_core_inherit_msc_annotation_stateless3_vehicle_ejb.addAsManifestResource(ejbResURL, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL = Client.class.getResource("//vehicle/stateless3/stateless3_vehicle_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL != null) {
              jpa_core_inherit_msc_annotation_stateless3_vehicle_ejb.addAsManifestResource(ejbResURL, "sun-ejb-jar.xml");
            }
            archiveProcessor.processEjbArchive(jpa_core_inherit_msc_annotation_stateless3_vehicle_ejb, Client.class, ejbResURL);

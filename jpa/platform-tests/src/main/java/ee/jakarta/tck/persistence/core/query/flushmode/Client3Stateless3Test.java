...
import ee.jakarta.tck.persistence.core.query.flushmode.Client3;
import java.net.URL;
...
public class Client3Stateless3Test extends ee.jakarta.tck.persistence.core.query.flushmode.Client3 {
    static final String VEHICLE_ARCHIVE = "jpa_core_query_flushmode_stateless3_vehicle";
        ...
        */
        ...
        // Client
            ...
            JavaArchive jpa_core_query_flushmode_stateless3_vehicle_client = ShrinkWrap.create(JavaArchive.class, "jpa_core_query_flushmode_stateless3_vehicle_client.jar");
            // The class files
            jpa_core_query_flushmode_stateless3_vehicle_client.addClasses(
            ...
            if(resURL != null) {
              jpa_core_query_flushmode_stateless3_vehicle_client.addAsManifestResource(resURL, "application-client.xml");
            }
            ...
            jpa_core_query_flushmode_stateless3_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + Client3.class.getName() + "\n"), "MANIFEST.MF");
            // Call the archive processor
            archiveProcessor.processClientArchive(jpa_core_query_flushmode_stateless3_vehicle_client, Client3.class, resURL);

        // Ejb
            // the jar with the correct archive name
            JavaArchive jpa_core_query_flushmode_stateless3_vehicle_ejb = ShrinkWrap.create(JavaArchive.class, "jpa_core_query_flushmode_stateless3_vehicle_ejb.jar");
            // The class files
            jpa_core_query_flushmode_stateless3_vehicle_ejb.addClasses(
                ...
                ee.jakarta.tck.persistence.common.schema30.Util.class,
                com.sun.ts.tests.common.vehicle.VehicleRunnable.class,
                ee.jakarta.tck.persistence.core.query.flushmode.Client3.class,
                com.sun.ts.tests.common.vehicle.ejb3share.UserTransactionWrapper.class,
            ...
            if(ejbResURL != null) {
              jpa_core_query_flushmode_stateless3_vehicle_ejb.addAsManifestResource(ejbResURL, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL = Client3.class.getResource("//vehicle/stateless3/stateless3_vehicle_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL != null) {
              jpa_core_query_flushmode_stateless3_vehicle_ejb.addAsManifestResource(ejbResURL, "sun-ejb-jar.xml");
            }
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_query_flushmode_stateless3_vehicle_ejb, Client3.class, ejbResURL);
        ...
        // Par
            ...
            // Call the archive processor
            archiveProcessor.processParArchive(jpa_core_query_flushmode, Client3.class, parURL);
            // The orm.xml file
        ...
        // Ear
            ...
            jpa_core_query_flushmode_vehicles_ear.addAsModule(jpa_core_query_flushmode_stateless3_vehicle_ejb);
            jpa_core_query_flushmode_vehicles_ear.addAsModule(jpa_core_query_flushmode_stateless3_vehicle_client);
            ...
            URL earResURL = Client3.class.getResource("/com/sun/ts/tests/jpa/core/query/flushmode/");
            if(earResURL != null) {
              jpa_core_query_flushmode_vehicles_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client3.class.getResource("/com/sun/ts/tests/jpa/core/query/flushmode/.ear.sun-application.xml");
            if(earResURL != null) {
              jpa_core_query_flushmode_vehicles_ear.addAsManifestResource(earResURL, "sun-application.xml");
            }
            // Call the archive processor
            archiveProcessor.processEarArchive(jpa_core_query_flushmode_vehicles_ear, Client3.class, earResURL);
        ...
        public void secondaryTablesValueTest() throws java.lang.Exception {
            super.secondaryTablesValueTest();
        }

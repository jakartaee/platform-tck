...
import ee.jakarta.tck.persistence.core.entityManager2.Client2;
import java.net.URL;
    ...
    static final String VEHICLE_ARCHIVE = "jpa_core_entityManager2_stateless3_vehicle";
        ...
        */
        ...
        // Client
            ...
            JavaArchive jpa_core_entityManager2_stateless3_vehicle_client = ShrinkWrap.create(JavaArchive.class, "jpa_core_entityManager2_stateless3_vehicle_client.jar");
            // The class files
            jpa_core_entityManager2_stateless3_vehicle_client.addClasses(
            ...
            jpa_core_entityManager2_stateless3_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + Client2.class.getName() + "\n"), "MANIFEST.MF");
            archiveProcessor.processClientArchive(jpa_core_entityManager2_stateless3_vehicle_client, Client2.class, resURL);


        // Ejb
            // the jar with the correct archive name
            JavaArchive jpa_core_entityManager2_stateless3_vehicle_ejb = ShrinkWrap.create(JavaArchive.class, "jpa_core_entityManager2_stateless3_vehicle_ejb.jar");
            // The class files
            jpa_core_entityManager2_stateless3_vehicle_ejb.addClasses(
                ...
                com.sun.ts.tests.common.vehicle.stateless3.Stateless3VehicleIF.class,
                ee.jakarta.tck.persistence.core.entityManager2.Client2.class,
                com.sun.ts.lib.harness.EETest.class,
                com.sun.ts.lib.harness.ServiceEETest.class,
                com.sun.ts.tests.common.vehicle.ejb3share.EntityTransactionWrapper.class,
                com.sun.ts.lib.harness.EETest.SetupException.class,
            ...
            if(ejbResURL != null) {
              jpa_core_entityManager2_stateless3_vehicle_ejb.addAsManifestResource(ejbResURL, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL = Client2.class.getResource("//vehicle/stateless3/stateless3_vehicle_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL != null) {
              jpa_core_entityManager2_stateless3_vehicle_ejb.addAsManifestResource(ejbResURL, "sun-ejb-jar.xml");
            }
            archiveProcessor.processEjbArchive(jpa_core_entityManager2_stateless3_vehicle_ejb, Client2.class, ejbResURL);
        ...
        // Ear
            ...
            jpa_core_entityManager2_vehicles_ear.addAsModule(jpa_core_entityManager2_stateless3_vehicle_ejb);
            jpa_core_entityManager2_vehicles_ear.addAsModule(jpa_core_entityManager2_stateless3_vehicle_client);
            ...
            URL earResURL = Client2.class.getResource("/com/sun/ts/tests/jpa/core/entityManager2/");
            if(earResURL != null) {
              jpa_core_entityManager2_vehicles_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client2.class.getResource("/com/sun/ts/tests/jpa/core/entityManager2/.ear.sun-application.xml");
            if(earResURL != null) {
        ...
        public void lockTransactionRequiredExceptionTest() throws java.lang.Exception {
            super.lockTransactionRequiredExceptionTest();
        }

        @Test
        @Override
        @TargetVehicle("stateless3")
        public void refreshTransactionRequiredExceptionTest() throws java.lang.Exception {
            super.refreshTransactionRequiredExceptionTest();
        }

        @Test
        @Override
        @TargetVehicle("stateless3")
        public void lockTransactionRequiredException2Test() throws java.lang.Exception {
            super.lockTransactionRequiredException2Test();
        }

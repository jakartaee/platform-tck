...
public class Client2PuservletTest extends ee.jakarta.tck.persistence.core.criteriaapi.parameter.Client2 {
    static final String VEHICLE_ARCHIVE = "jpa_core_criteriaapi_parameter_puservlet_vehicle";
        ...
        */
        ...
        // War
            ...
            WebArchive jpa_core_criteriaapi_parameter_puservlet_vehicle_web = ShrinkWrap.create(WebArchive.class, "jpa_core_criteriaapi_parameter_puservlet_vehicle_web.war");
            // The class files
            jpa_core_criteriaapi_parameter_puservlet_vehicle_web.addClasses(
            ...
            if(warResURL != null) {
              jpa_core_criteriaapi_parameter_puservlet_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
        ...
        // Ear
            ...
            jpa_core_criteriaapi_parameter_vehicles_ear.addAsModule(jpa_core_criteriaapi_parameter_puservlet_vehicle_web);

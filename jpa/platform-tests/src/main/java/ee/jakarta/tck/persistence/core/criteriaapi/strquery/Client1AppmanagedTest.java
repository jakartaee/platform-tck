...
public class Client1AppmanagedTest extends ee.jakarta.tck.persistence.core.criteriaapi.strquery.Client1 {
    static final String VEHICLE_ARCHIVE = "jpa_core_criteriaapi_strquery_appmanaged_vehicle";
        ...
        */
        ...
        // Client
            ...
            archiveProcessor.processClientArchive(jpa_core_criteriaapi_strquery_appmanaged_vehicle_client, Client1.class, resURL);
        ...
        // Ejb 1
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_criteriaapi_strquery_appmanaged_vehicle_ejb, Client1.class, ejbResURL1);

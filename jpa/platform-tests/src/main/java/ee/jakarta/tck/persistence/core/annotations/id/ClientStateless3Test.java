    ...
    static final String VEHICLE_ARCHIVE = "jpa_core_annotations_basic_stateless3_vehicle";
        ...
        */
        ...
        // Client
            ...
            jpa_core_annotations_basic_stateless3_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + Client.class.getName() + "\n"), "MANIFEST.MF");
        ...
        // Ejb
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_annotations_basic_stateless3_vehicle_ejb, Client.class, ejbResURL);

    ...
    static final String VEHICLE_ARCHIVE = "jpa_core_annotations_entity_appmanagedNoTx_vehicle";
        ...
        */
        ...
        // Ejb
            ...
            if(ejbResURL != null) {
              jpa_core_annotations_entity_appmanagedNoTx_vehicle_ejb.addAsManifestResource(ejbResURL, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL = Client.class.getResource("//vehicle/appmanagedNoTx/appmanagedNoTx_vehicle_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL != null) {
              jpa_core_annotations_entity_appmanagedNoTx_vehicle_ejb.addAsManifestResource(ejbResURL, "sun-ejb-jar.xml");
            }
            archiveProcessor.processEjbArchive(jpa_core_annotations_entity_appmanagedNoTx_vehicle_ejb, Client.class, ejbResURL);

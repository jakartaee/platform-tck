...
import ee.jakarta.tck.persistence.core.query.flushmode.Client2;
import java.net.URL;
    ...
    static final String VEHICLE_ARCHIVE = "jpa_core_query_flushmode_stateless3_vehicle";
        ...
        */
        ...
        // Ejb 1
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_query_flushmode_stateless3_vehicle_ejb, Client2.class, ejbResURL1);

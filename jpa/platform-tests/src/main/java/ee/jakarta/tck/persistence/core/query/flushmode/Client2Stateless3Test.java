    ...
    static final String VEHICLE_ARCHIVE = "jpa_core_query_flushmode_stateless3_vehicle";
        ...
        */
        ...
        // Ejb
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_query_flushmode_stateless3_vehicle_ejb, Client2.class, ejbResURL);
        ...
        // Ear
            ...
            URL earResURL = Client2.class.getResource("/com/sun/ts/tests/jpa/core/query/flushmode/");
            if(earResURL != null) {
              jpa_core_query_flushmode_vehicles_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client2.class.getResource("/com/sun/ts/tests/jpa/core/query/flushmode/.ear.sun-application.xml");
            if(earResURL != null) {

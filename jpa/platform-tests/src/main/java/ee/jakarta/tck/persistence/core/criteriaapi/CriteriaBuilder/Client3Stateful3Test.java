...
public class Client3Stateful3Test extends ee.jakarta.tck.persistence.core.criteriaapi.CriteriaBuilder.Client3 {
    static final String VEHICLE_ARCHIVE = "jpa_core_criteriapia_CriteriaBuilder_stateful3_vehicle";
        ...
        */
        ...
        // Client
            ...
            jpa_core_criteriapia_CriteriaBuilder_stateful3_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + Client3.class.getName() + "\n"), "MANIFEST.MF");
            // Call the archive processor
            archiveProcessor.processClientArchive(jpa_core_criteriapia_CriteriaBuilder_stateful3_vehicle_client, Client3.class, resURL);
        ...
        // Ejb 1
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_criteriapia_CriteriaBuilder_stateful3_vehicle_ejb, Client3.class, ejbResURL1);

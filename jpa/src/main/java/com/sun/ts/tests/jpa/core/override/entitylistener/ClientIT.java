...
public class ClientIT extends PMClientBase {
	...
	public static JavaArchive createDeployment() throws Exception {
		...
		String[] classes = { pkgName + "ListenerA", pkgName + "ListenerB", pkgName + "ListenerC", pkgName + "ListenerD",
				pkgName + "NoEntityListener", pkgName + "NoListener", pkgName + "OverrridenListener" };
		return createDeploymentJar("jpa_core_override_entitylistener.jar", pkgNameWithoutSuffix, classes);

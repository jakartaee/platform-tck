...
public class ServletTest extends HttpTCKServlet {
	...
	public void test1(final HttpServletRequest req, final HttpServletResponse res)
		...
		try {
			...
			if (status) {
				...
				pw.println(Data.FAILED + ".  ERROR: Account entities are not identical");
			}
		} catch (Exception e) {
	...
	public void test1a(final HttpServletRequest req, final HttpServletResponse res)
			throws ServletException, IOException {
		String accounts;
		PrintWriter pw = res.getWriter();
	...
	public void test2(final HttpServletRequest req, final HttpServletResponse res)
		...
		try {
			...
			if (EXPECTED_BALANCE.compareTo(balance) == 0) {
				...
				System.out.println("test2: TEST FAILED - Account balance is not correct.  Expected: " + EXPECTED_BALANCE
						+ "got: " + balance);
				pw.println(Data.FAILED + ".  ERROR: Account balance is not correct.  Expected: " + EXPECTED_BALANCE
						+ "got: " + balance);
			}
	...
	public void test3(final HttpServletRequest req, final HttpServletResponse res)
		...
		try {
			...
			if (INITIAL_BALANCE.compareTo(balance) == 0) {
				...
				System.out.println("test3: TEST FAILED - Account balance is not correct.  Expected: " + INITIAL_BALANCE
						+ "got: " + balance);
				pw.println(Data.FAILED + ".  ERROR: Account balance is not correct.  Expected: " + INITIAL_BALANCE
						+ "got: " + balance);
			}
		} catch (Exception e) {
	...
	public void getTransactionIllegalStateException(final HttpServletRequest req, final HttpServletResponse res)
			throws ServletException, IOException {
		boolean pass = true;
		PrintWriter pw = res.getWriter();
		...
		try {
			...
			pass = false;
			System.out.println(
					testName + ": Unexpected exception caught in " + testName + ":" + convertExceptionToString(e));
			pw.println(testName + ": Unexpected exception caught in " + testName + ":" + convertExceptionToString(e));
	...
	public void closeObjectTransactionRequiredExceptionTest(final HttpServletRequest req, final HttpServletResponse res)
			throws ServletException, IOException {
		boolean pass = false;
		PrintWriter pw = res.getWriter();
	...
	public void mergeObjectTransactionRequiredExceptionTest(final HttpServletRequest req, final HttpServletResponse res)
			throws ServletException, IOException {
		PrintWriter pw = res.getWriter();
		boolean pass = false;
	...
	public void persistObjectTransactionRequiredExceptionTest(final HttpServletRequest req,
	...
	public void refreshObjectTransactionRequiredExceptionTest(final HttpServletRequest req,
			final HttpServletResponse res) throws ServletException, IOException {
		PrintWriter pw = res.getWriter();
		boolean pass = false;
	...
	public void refreshObjectMapTransactionRequiredExceptionTest(final HttpServletRequest req,
			final HttpServletResponse res) throws ServletException, IOException {
		PrintWriter pw = res.getWriter();
		boolean pass = false;
	...
	public void refreshObjectLockModeTypeTransactionRequiredExceptionTest(final HttpServletRequest req,
			final HttpServletResponse res) throws ServletException, IOException {
		PrintWriter pw = res.getWriter();
		boolean pass = false;
	...
	public void refreshObjectLockModeTypeMapTransactionRequiredExceptionTest(final HttpServletRequest req,
			final HttpServletResponse res) throws ServletException, IOException {
		PrintWriter pw = res.getWriter();
		boolean pass = false;
	...
	public void removeObjectTransactionRequiredExceptionTest(final HttpServletRequest req,
			final HttpServletResponse res) throws ServletException, IOException {
		PrintWriter pw = res.getWriter();
		boolean pass = false;

...
public class ClientIT extends PMClientBase {
  ...
  public static JavaArchive createDeployment() throws Exception {
     ...
     String[] classes = { pkgName + "XAddress", pkgName + "XAnnualReview",
    		 pkgName + "XCompany", pkgName + "XInsurance",
    		 pkgName + "XPerson", pkgName + "XProject",
    		 pkgName + "XTeam"};
     return createDeploymentJar("jpa_core_relationship_descriptors.jar", pkgNameWithoutSuffix, classes);
...
@Test
  public void descriptorMappingTest1() throws Exception {
    ...
    TestUtil.logTrace("Begin descriptorMappingTest1");
    boolean pass = false;
...
@Test
  public void descriptorMappingTest2() throws Exception {
    ...
    TestUtil.logTrace("Begin descriptorMappingTest2");
    boolean pass1 = true;
    boolean pass2 = false;
    Vector<XTeam> v1;
    Vector<XTeam> v2;
    int foundTeam1 = 0;
    int foundTeam2 = 0;
    final String[] expectedTeam1 = new String[] { "Engineering", "Marketing",
        "Sales" };
    ...
    try {
      ...
      if ((t1.size() != 3) || (t2.size() != 2)) {
        TestUtil.logErr("descriptorMappingTest2: Did not get expected results."
        ...
        while (i1.hasNext()) {
          ...
          for (int l = 0; l < 3; l++) {
            if (expectedTeam1[l].equals(o1.getXName())) {
              TestUtil.logTrace("Found Team 1:" + o1.getXName());
              foundTeam1++;
              break;
            }
          }
        ...
        while (i2.hasNext()) {
          ...
          for (int l = 0; l < 2; l++) {
            if (expectedTeam2[l].equals(o2.getXName())) {
              TestUtil.logTrace("Found Team 2:" + o2.getXName());
              foundTeam2++;
              break;
            }
          }
...
@Test
  public void descriptorMappingTest3() throws Exception {
    ...
    TestUtil.logTrace("Begin descriptorMappingTest3");
    boolean pass = false;
    Vector v1;
    Vector v2;
    ...
    try {
      ...
      if ((t1.getXCompany().getXCompanyId() == 25501L)
          && (t2.getXCompany().getXCompanyId() == 25501L)
          && (t3.getXCompany().getXCompanyId() == 37560L)
          && (t4.getXCompany().getXCompanyId() == 37560L)
...
@Test
  public void descriptorMappingTest4() throws Exception {
    ...
    TestUtil.logTrace("Begin descriptorMappingTest4");
    boolean pass = false;
...
@Test
  public void descriptorMappingTest5() throws Exception {
    TestUtil.logTrace("Begin descriptorMappingTest5");
    boolean pass = false;
...
@Test
  public void descriptorMappingTest6() throws Exception {
    TestUtil.logTrace("Begin descriptorMappingTest6");
    boolean pass1 = true;
    boolean pass2 = false;
    int foundProject1 = 0;
    int foundProject2 = 0;
    final Long[] expectedResults1 = new Long[] { 123456789L, 345678901L,
        567890123L };
    final Long[] expectedResults2 = new Long[] { 234567890L, 345678901L,
        456789012L };
    ...
    try {
      ...
      if ((projCol1.size() != 3) || (projCol2.size() != 3)) {
        TestUtil.logErr("descriptorMappingTest6: Did not get expected results."
        ...
        while (i1.hasNext()) {
          ...
          for (int l = 0; l < 3; l++) {
            if (expectedResults1[l].equals(o1.getXProjId())) {
              TestUtil
                  .logTrace("Found Project for Karen Tegan: " + o1.getXName());
              foundProject1++;
              break;
            }
          }
        ...
        while (i2.hasNext()) {
          ...
          for (int l = 0; l < 3; l++) {
            if (expectedResults2[l].equals(o2.getXProjId())) {
              TestUtil.logTrace(
                  "Found Project for William Keaton: " + o2.getXName());
              foundProject2++;
              break;
            }
          }
...
@Test
  public void descriptorMappingTest7() throws Exception {
    TestUtil.logTrace("Begin descriptorMappingTest7");
    boolean pass1 = true;
    boolean pass2 = false;
    ...
    try {
      ...
      if ((col1.size() != 4) || (col2.size() != 2 || col3.size() != 2
          || col4.size() != 2 || col5.size() != 4)) {
        TestUtil.logErr("descriptorMappingTest7: Did not get expected results."
            + "Expected 4 reviews for Mary Macy (PK 12) , got: " + col1.size()
            + ", Expected 2 reviews for Julie OClaire (PK 14), got: "
            + col2.size() + ", Expected 2 reviews for Kellie Lee (PK 16), got: "
            + col3.size()
        ...
        while (i1.hasNext()) {
          ...
          for (int l = 0; l < 5; l++) {
            if (expectedCol1[l].equals(o1.getXService())) {
              TestUtil
                  .logTrace("Found Mary Macy Annual Review for Service Year: "
                      + o1.getXService());
              foundCol1++;
              break;
            }
        ...
        while (i2.hasNext()) {
          ...
          for (int l = 0; l < 2; l++) {
            if (expectedCol2[l].equals(o2.getXService())) {
              TestUtil.logTrace(
                  "Found Julie OClaire Annual Review for Service Year: "
                      + o2.getXService());
              foundCol2++;
              break;
            }
        ...
        while (i3.hasNext()) {
          ...
          for (int l = 0; l < 2; l++) {
            if (expectedCol3[l].equals(o3.getXService())) {
              TestUtil
                  .logTrace("Found Kellie Lee Annual Review for Service Year: "
                      + o3.getXService());
              foundCol3++;
              break;
            }
        ...
        while (i4.hasNext()) {
          ...
          for (int l = 0; l < 2; l++) {
            if (expectedCol4[l].equals(o4.getXService())) {
              TestUtil.logTrace(
                  "Found Mark Francis Annual Review for Service Year: "
                      + o4.getXService());
              foundCol4++;
              break;
            }
        ...
        while (i5.hasNext()) {
          ...
          for (int l = 0; l < 5; l++) {
            if (expectedCol5[l].equals(o5.getXService())) {
              TestUtil
                  .logTrace("Found Katy Hughes Annual Review for Service Year: "
                      + o5.getXService());
              foundCol5++;
              break;
            }
      ...
      if ((foundCol1 != 4) || (foundCol2 != 2) || (foundCol3 != 2)
          || (foundCol4 != 2) || (foundCol5 != 4)) {
...
@Test
  public void descriptorMappingTest8() throws Exception {
    ...
    try {
      ...
      if ((insCol1.size() != 2) || (insCol2.size() != 2)
          || (insCol3.size() != 3)) {
        TestUtil.logErr("descriptorMappingTest8: Did not get expected results."
        ...
        while (i1.hasNext()) {
          ...
          for (int l = 0; l < 2; l++) {
            if (expectedResults1[l].equals(o1.getXInsId())) {
              TestUtil.logTrace("Found Insurance Carrier for Shelly McGowan: "
                  + o1.getXCarrier());
              foundInsurance1++;
              break;
            }
        ...
        while (i2.hasNext()) {
          ...
          for (int l = 0; l < 2; l++) {
            if (expectedResults2[l].equals(o2.getXInsId())) {
              TestUtil.logTrace("Found Insurance Carrier for Cheng Fang: "
                  + o2.getXCarrier());
              foundInsurance2++;
              break;
            }
        ...
        while (i3.hasNext()) {
          ...
          for (int l = 0; l < 3; l++) {
            if (expectedResults3[l].equals(o3.getXInsId())) {
              TestUtil.logTrace("Found Insurance Carrier for Nicole Martin: "
                  + o3.getXCarrier());
              foundInsurance3++;
              break;
            }
      ...
      if ((foundInsurance1 != 2) || (foundInsurance2 != 2)
          || (foundInsurance3 != 3)) {
        TestUtil.logErr("descriptorMappingTest8: Did not get expected results");
        pass2 = false;
      } else {
  ...
  private void createPeople() throws Exception {
    TestUtil.logTrace("CreatePeople");
    ...
    for (XPerson p : pRef) {
      ...
      TestUtil.logTrace("persisted person " + p);
    }
    getEntityTransaction().commit();
  }
  ...
  private void createProjects() throws Exception {
    TestUtil.logTrace("Create 5 Projects");
    projRef[0] = new XProject(123456789L, "Sidewinder",
        new BigDecimal("20500.0"));
    ...
    projRef[3] = new XProject(456789012L, "King Cobra",
  ...
  private void createAddress() throws Exception {
    ...
    aRef[0] = new XAddress("100", "1 Network Drive", "Burlington", "MA",
        "01803");
    aRef[1] = new XAddress("200", "4150 Network Drive", "Santa Clara", "CA",
        "95054");
  ...
  private void removeTestData() {
    ...
    try {
      getEntityTransaction().begin();
      getEntityManager().createNativeQuery("DELETE FROM PERSON_INSURANCE")
          .executeUpdate();
      getEntityManager().createNativeQuery("DELETE FROM PERSON_ANNUALREVIEW")
          .executeUpdate();
      getEntityManager().createNativeQuery("DELETE FROM INSURANCE")
          .executeUpdate();
      getEntityManager().createNativeQuery("DELETE FROM ANNUALREVIEW")
          .executeUpdate();
      getEntityManager().createNativeQuery("DELETE FROM PERSON")
          .executeUpdate();
      getEntityManager().createNativeQuery("DELETE FROM TEAM").executeUpdate();
      getEntityManager().createNativeQuery("DELETE FROM COMPANY")
          .executeUpdate();
      getEntityManager().createNativeQuery("DELETE FROM ADDRESS")
          .executeUpdate();
      getEntityManager().createNativeQuery("DELETE FROM PROJECT_PERSON")
          .executeUpdate();
      getEntityManager().createNativeQuery("DELETE FROM PROJECT")
          .executeUpdate();
      getEntityTransaction().commit();
    } catch (Exception e) {

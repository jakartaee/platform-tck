...
public class ClientIT extends PMClientBase {
  ...
  public static JavaArchive createDeployment() throws Exception {
     ...
     String[] classes = { pkgName + "Course", pkgName + "Semester", 
    		 pkgName + "Student"};
     return createDeploymentJar("jpa_jpa22_repeatable_mapkeyjoincolumn.jar", pkgNameWithoutSuffix, (String[]) classes);

...
public class ClientIT4 extends Client{
	 ...
	 @BeforeEach
	  ...
	  public void testExtractDateYear() throws Exception {
	    try {
	      ...
	      if (y != TD4_YEAR) {
	        throw new Exception("EXTRACT(YEAR FROM date) returned wrong value: expeted " + TD4_YEAR + " but got " + y);
	      }
	    } catch (Exception ex) {
	  ...
	  public void testExtractDateQuarter() throws Exception {
	    try {
	      ...
	      if (q != TD4_QUARTER) {
	        throw new Exception("EXTRACT(QUARTER FROM date) returned wrong value: expeted " + TD4_QUARTER + " but got " + q);
	      }
	  ...
	  public void testExtractDateMonth() throws Exception {
	    try {
	      ...
	      if (m != TD4_MONTH) {
	        throw new Exception("EXTRACT(MONTH FROM date) returned wrong value: expeted " + TD4_MONTH + " but got " + m);
	      }
	  ...
	  public void testExtractDateDay() throws Exception {
	    try {
	      ...
	      if (d != TD4_DAY) {
	        throw new Exception("EXTRACT(DAY FROM date) returned wrong value: expeted " + TD4_DAY + " but got " + d);
	      }
	  ...
	  public void testExtractTimeHour() throws Exception {
	    try {
	      ...
	      if (h != TD4_HOUR) {
	        throw new Exception("EXTRACT(HOUR FROM time) returned wrong value: expeted " + TD4_HOUR + " but got " + h);
	      }
	  ...
	  public void testExtractTimeMinute() throws Exception {
	    try {
	      ...
	      long m = q1.getSingleResult().longValue();
	      if (m != TD4_MINUTE) {
	        throw new Exception("EXTRACT(MINUTE FROM time) returned wrong value: expeted " + TD4_MINUTE + " but got " + m);
	      }
	  ...
	  public void testExtractTimeSecond() throws Exception {
	    try {
	      ...
	      if (s != TD4_SECOND) {
	        throw new Exception("EXTRACT(SECOND FROM time) returned wrong value: expeted " + TD4_SECOND + " but got " + s);
	      }
	  ...
	  public void testExtractDateTimeYear() throws Exception {
	    try {
	      ...
	      System.out.println("DATETIME -- YEAR: " + y);
	      if (y != TD4_YEAR) {
	        throw new Exception("EXTRACT(YEAR FROM timestamp) returned wrong value: expeted " + TD4_YEAR + " but got " + y);
	      }
	    } catch (Exception ex) {
	      throw new Exception(ex);
	    }
	  ...
	  public void testExtractDateTimeQuarter() throws Exception {
	    try {
	      ...
	      long q = q1.getSingleResult().longValue();
	      if (q != TD4_QUARTER) {
	        throw new Exception("EXTRACT(QUARTER FROM timestamp) returned wrong value: expeted " + TD4_QUARTER + " but got " + q);
	      }
	      System.out.println("DATETIME -- QUARTER: " + q);
	    } catch (Exception ex) {
	      throw new Exception(ex);
	  ...
	  public void testExtractDateTimeMonth() throws Exception {
	    try {
	      ...
	      long m = q1.getSingleResult().longValue();
	      if (m != TD4_MONTH) {
	        throw new Exception("EXTRACT(MONTH FROM timestamp) returned wrong value: expeted " + TD4_MONTH + " but got " + m);
	      }
	      System.out.println("DATETIME -- MONTH: " + m);
	    } catch (Exception ex) {
	      throw new Exception(ex);
	  ...
	  public void testExtractDateTimeDay() throws Exception {
	    try {
	      ...
	      long d = q1.getSingleResult().longValue();
	      if (d != TD4_DAY) {
	        throw new Exception("EXTRACT(DAY FROM timestamp) returned wrong value: expeted " + TD4_DAY + " but got " + d);
	      }
	      System.out.println("DATETIME -- DAY: " + d);
	    } catch (Exception ex) {
	      throw new Exception(ex);
	  ...
	  public void testExtractDateTimeHour() throws Exception {
	    try {
	      ...
	      long h = q1.getSingleResult().longValue();
	      if (h != TD4_HOUR) {
	        throw new Exception("EXTRACT(HOUR FROM timestamp) returned wrong value: expeted " + TD4_HOUR + " but got " + h);
	      }
	      System.out.println("DATETIME -- HOUR: " + h);
	    } catch (Exception ex) {
	      throw new Exception(ex);
	  ...
	  public void testExtractDateTimeMinute() throws Exception {
	    try {
	      ...
	      long m = q1.getSingleResult().longValue();
	      if (m != TD4_MINUTE) {
	        throw new Exception("EXTRACT(MINUTE FROM timestamp) returned wrong value: expeted " + TD4_MINUTE + " but got " + m);
	      }
	      System.out.println("DATETIME -- MINUTE: " + m);
	    } catch (Exception ex) {
	      throw new Exception(ex);
	  ...
	  public void testExtractDateTimeSecond() throws Exception {
	    try {
	      ...
	      long s = q1.getSingleResult().longValue();
	      if (s != TD4_SECOND) {
	        throw new Exception("EXTRACT(SECOND FROM timestamp) returned wrong value: expeted " + TD4_SECOND + " but got " + s);
	      }
	      System.out.println("DATETIME -- SECOND: " + s);
	    } catch (Exception ex) {
	      throw new Exception(ex);

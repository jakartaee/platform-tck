...
public class ClientIT extends PMClientBase {
  ...
  public static JavaArchive createDeployment() throws Exception {
     ...
     return createDeploymentJar("jpa_se_schemaGeneration_annotations_secondaryTable.jar", pkgNameWithoutSuffix, (String[]) classes);
  ...
  public void secondaryTableTest() throws Exception {
    ...
    expected.add(
        "CONSTRAINT MYCONSTRAINT FOREIGN KEY (SECONDARY_ID) REFERENCES SCHEMAGENSIMPLE (SIMPLEID)");
     ...
     * SCHEMAGENSIMPLE_SECOND ADD CONSTRAINT MYCONSTRAINT FOREIGN KEY
     * (SECONDARY_ID) REFERENCES SCHEMAGENSIMPLE (SIMPLEID)
     */

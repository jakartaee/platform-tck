...
public class ClientIT extends PMClientBase {
  ...
  public static JavaArchive createDeployment() throws Exception {
     ...
     String[] classes = { pkgName + "Consumer",
    		    pkgName + "Customers",
    		    pkgName + "Department",
    		    pkgName + "Employee",
    		    pkgName + "EmployeeComparator",
    		    pkgName + "RetailOrder",
    		    pkgName + "RetailOrderCostComparatorDESC",
    		    pkgName + "Store",
    		    pkgName + "TheatreCompany",
    		    pkgName + "TheatreLocation" };
     return createDeploymentJar("jpa_core_override_mapkey.jar", pkgNameWithoutSuffix, classes);

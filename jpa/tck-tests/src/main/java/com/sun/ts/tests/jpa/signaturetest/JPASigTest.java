...
package com.sun.ts.tests.jpa.signaturetest;
...
public class JPASigTest extends SigTest {
  ...
  public void signatureTest() throws Exception {
    ...
    InputStream inStreamMapfile = JPASigTest.class.getClassLoader().getResourceAsStream("com/sun/ts/tests/jpa/signaturetest/sig-test.map");
    ...
    InputStream inStreamPackageFile = JPASigTest.class.getClassLoader().getResourceAsStream("com/sun/ts/tests/jpa/signaturetest/sig-test-pkg-list.txt");
    ...
    InputStream inStreamSigFile = JPASigTest.class.getClassLoader().getResourceAsStream("com/sun/ts/tests/jpa/signaturetest/jakarta.persistence.sig_"+packageVersion);

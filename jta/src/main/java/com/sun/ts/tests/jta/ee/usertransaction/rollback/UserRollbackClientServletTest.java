    ...
    static final String VEHICLE_ARCHIVE = "rollback_servlet_vehicle";
        ...
        */
        ...
        // War
            ...
            URL warResURL = UserRollbackClient.class.getResource("servlet_vehicle_web.xml");
            if(warResURL != null) {
            ...
            // Web content
           archiveProcessor.processWebArchive(rollback_servlet_vehicle_web, UserRollbackClient.class, warResURL);

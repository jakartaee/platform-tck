...
import com.sun.ts.tests.jta.ee.transactional.Client;
import java.net.URL;
...
public class ClientEjblitejsfTest extends com.sun.ts.tests.jta.ee.transactional.Client {
    static final String VEHICLE_ARCHIVE = "transactional_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
           ...
           archiveProcessor.processWebArchive(transactional_ejblitejsf_vehicle_web, Client.class, warResURL);

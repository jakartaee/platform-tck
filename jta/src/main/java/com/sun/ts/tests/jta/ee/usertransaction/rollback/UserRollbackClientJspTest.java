    ...
    static final String VEHICLE_ARCHIVE = "rollback_jsp_vehicle";
        ...
        */
        ...
        // War
            ...
            URL warResURL = UserRollbackClient.class.getResource("jsp_vehicle_web.xml");
            if(warResURL != null) {
            ...
            // Web content
            warResURL = UserRollbackClient.class.getResource("/com/sun/ts/tests/common/vehicle/jsp/contentRoot/client.html");
            rollback_jsp_vehicle_web.addAsWebResource(warResURL, "/client.html");
            warResURL = UserRollbackClient.class.getResource("/com/sun/ts/tests/common/vehicle/jsp/contentRoot/jsp_vehicle.jsp");
            rollback_jsp_vehicle_web.addAsWebResource(warResURL, "/jsp_vehicle.jsp");

           archiveProcessor.processWebArchive(rollback_jsp_vehicle_web, UserRollbackClient.class, warResURL);

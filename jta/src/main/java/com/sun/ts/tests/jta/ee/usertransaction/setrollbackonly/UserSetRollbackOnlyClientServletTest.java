    ...
    static final String VEHICLE_ARCHIVE = "setrollbackonly_servlet_vehicle";
        ...
        */
        ...
        // War
            ...
            URL warResURL = UserSetRollbackOnlyClient.class.getResource("servlet_vehicle_web.xml");
            if(warResURL != null) {
            ...
            // Web content
           archiveProcessor.processWebArchive(setrollbackonly_servlet_vehicle_web, UserSetRollbackOnlyClient.class, warResURL);

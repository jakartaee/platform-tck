    ...
    static final String VEHICLE_ARCHIVE = "begin_ejb_vehicle";
        ...
        */
        ...
        // Client
            ...
            resURL = UserBeginClient.class.getResource("//com/sun/ts/tests/common/vehicle/ejb/ejb_vehicle_client.jar.sun-application-client.xml");
            if(resURL != null) {
              begin_ejb_vehicle_client.addAsManifestResource(resURL, "application-client.xml");
            }
            begin_ejb_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + UserBeginClient.class.getName() + "\n"), "MANIFEST.MF");
            archiveProcessor.processClientArchive(begin_ejb_vehicle_client, UserBeginClient.class, resURL);
        ...
        // Ejb
            ...
            URL ejbResURL = UserBeginClient.class.getResource("/ejb_vehicle_ejb.xml");
            if(ejbResURL != null) {
              begin_ejb_vehicle_ejb.addAsManifestResource(ejbResURL, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL = UserBeginClient.class.getResource("/ejb_vehicle_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL != null) {

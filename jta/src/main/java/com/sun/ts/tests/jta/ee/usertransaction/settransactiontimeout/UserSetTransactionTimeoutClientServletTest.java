    ...
    static final String VEHICLE_ARCHIVE = "settransactiontimeout_servlet_vehicle";
        ...
        */
        ...
        // War
            ...
            URL warResURL = UserSetTransactionTimeoutClient.class.getResource("servlet_vehicle_web.xml");
            if(warResURL != null) {
              settransactiontimeout_servlet_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = UserSetTransactionTimeoutClient.class.getResource("/settransactiontimeout_servlet_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
              settransactiontimeout_servlet_vehicle_web.addAsWebInfResource(warResURL, "sun-web.xml");
            }
            // Web content
           archiveProcessor.processWebArchive(settransactiontimeout_servlet_vehicle_web, UserSetTransactionTimeoutClient.class, warResURL);

    ...
    static final String VEHICLE_ARCHIVE = "commit_jsp_vehicle";
        ...
        */
        ...
        // War
            ...
            URL warResURL = UserCommitClient.class.getResource("jsp_vehicle_web.xml");
            if(warResURL != null) {
              commit_jsp_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = UserCommitClient.class.getResource("/commit_jsp_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
              commit_jsp_vehicle_web.addAsWebInfResource(warResURL, "sun-web.xml");
            }
            // Web content
            warResURL = UserCommitClient.class.getResource("/com/sun/ts/tests/common/vehicle/jsp/contentRoot/client.html");
            commit_jsp_vehicle_web.addAsWebResource(warResURL, "/client.html");
            warResURL = UserCommitClient.class.getResource("/com/sun/ts/tests/common/vehicle/jsp/contentRoot/jsp_vehicle.jsp");
            commit_jsp_vehicle_web.addAsWebResource(warResURL, "/jsp_vehicle.jsp");

           archiveProcessor.processWebArchive(commit_jsp_vehicle_web, UserCommitClient.class, warResURL);
        ...
        // Ear
            ...
            // if(earResURL != null) {
            //   commit_jsp_vehicle_ear.addAsManifestResource(earResURL, "application.xml");
            // }
            ...
            // if(earResURL != null) {
            //   commit_jsp_vehicle_ear.addAsManifestResource(earResURL, "sun-application.xml");
            // }
            // archiveProcessor.processEarArchive(commit_jsp_vehicle_ear, UserCommitClient.class, earResURL);

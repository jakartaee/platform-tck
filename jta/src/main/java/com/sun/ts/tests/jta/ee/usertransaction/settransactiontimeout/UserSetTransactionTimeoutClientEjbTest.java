    ...
    static final String VEHICLE_ARCHIVE = "settransactiontimeout_ejb_vehicle";
        ...
        */
        ...
        // Client
            ...
            URL resURL = UserSetTransactionTimeoutClient.class.getResource("/com/sun/ts/tests/common/vehicle/ejb/ejb_vehicle_client.xml");
            if(resURL != null) {
        ...
        // Ejb
            ...
            URL ejbResURL = UserSetTransactionTimeoutClient.class.getResource("/ejb_vehicle_ejb.xml");
            if(ejbResURL != null) {
            ...
            archiveProcessor.processEjbArchive(settransactiontimeout_ejb_vehicle_ejb, UserSetTransactionTimeoutClient.class, ejbResURL);
        ...
        // Ear
            ...
            archiveProcessor.processEarArchive(settransactiontimeout_ejb_vehicle_ear, UserSetTransactionTimeoutClient.class, earResURL);

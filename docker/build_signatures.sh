...
# jakarta.decorator
java $CLASSNAME Setup ${OPTIONS} -classpath ${sigTestClasspath} -apiVersion 4.0  -package jakarta.decorator -FileName ${SIGFILEPATH}/jakarta.decorator.sig
# jakarta.ejb
java $CLASSNAME Setup ${OPTIONS} -classpath ${sigTestClasspath} -apiVersion 4.0  -package jakarta.ejb -FileName ${SIGFILEPATH}/jakarta.ejb.sig
# jakarta.el
java $CLASSNAME Setup ${OPTIONS} -classpath ${sigTestClasspath} -apiVersion 5.0  -package jakarta.el -FileName ${SIGFILEPATH}/jakarta.el.sig
# jakarta.enterprise
java $CLASSNAME Setup ${OPTIONS} -classpath ${sigTestClasspath} -apiVersion 4.0  -Exclude jakarta.enterprise.concurrent -package jakarta.enterprise -FileName ${SIGFILEPATH}/jakarta.enterprise.sig
# jakarta.enterprise.concurrent
java $CLASSNAME Setup ${OPTIONS} -classpath ${sigTestClasspath} -apiVersion 3.0  -package jakarta.enterprise.concurrent -FileName ${SIGFILEPATH}/jakarta.enterprise.concurrent.sig
# jakarta.faces
java $CLASSNAME Setup ${OPTIONS} -classpath ${sigTestClasspath} -apiVersion 4.0  -package jakarta.faces -FileName ${SIGFILEPATH}/jakarta.faces.sig
# jakarta.inject
java $CLASSNAME Setup ${OPTIONS} -classpath ${sigTestClasspath} -apiVersion 2.0  -package jakarta.inject -FileName ${SIGFILEPATH}/jakarta.inject.sig
# jakarta.interceptor
java $CLASSNAME Setup ${OPTIONS} -classpath ${sigTestClasspath} -apiVersion 2.1  -package jakarta.interceptor -FileName ${SIGFILEPATH}/jakarta.interceptor.sig
# jakarta.jms
java $CLASSNAME Setup ${OPTIONS} -classpath ${sigTestClasspath} -apiVersion 3.0  -package jakarta.jms -FileName ${SIGFILEPATH}/jakarta.jms.sig
# jakarta.json
java $CLASSNAME Setup ${OPTIONS} -classpath ${sigTestClasspath} -apiVersion 2.1  -Exclude jakarta.json.bind -package jakarta.json -FileName ${SIGFILEPATH}/jakarta.json.sig
# jakarta.json.bind
java $CLASSNAME Setup ${OPTIONS} -classpath ${sigTestClasspath} -apiVersion 3.0  -package jakarta.json.bind -FileName ${SIGFILEPATH}/jakarta.json.bind.sig
# jakarta.mail
java $CLASSNAME Setup ${OPTIONS} -classpath ${sigTestClasspath} -apiVersion 2.1  -package jakarta.mail -FileName ${SIGFILEPATH}/jakarta.mail.sig
# jakarta.persistence
java $CLASSNAME Setup ${OPTIONS} -classpath ${sigTestClasspath} -apiVersion 3.1  -package jakarta.persistence -FileName ${SIGFILEPATH}/jakarta.persistence.sig
# jakarta.resource
java $CLASSNAME Setup ${OPTIONS} -classpath ${sigTestClasspath} -apiVersion 2.1  -package jakarta.resource -FileName ${SIGFILEPATH}/jakarta.resource.sig
# jakarta.security.enterprise
java $CLASSNAME Setup ${OPTIONS} -classpath ${sigTestClasspath} -apiVersion 2.0  -package jakarta.security.enterprise -FileName ${SIGFILEPATH}/jakarta.security.enterprise.sig
# jakarta.security.auth.message
java $CLASSNAME Setup ${OPTIONS} -classpath ${sigTestClasspath} -apiVersion 2.0  -package jakarta.security.auth.message -FileName ${SIGFILEPATH}/jakarta.security.auth.message.sig
# jakarta.servlet (exclude jakarta.servlet.jsp)
java $CLASSNAME Setup ${OPTIONS} -classpath ${sigTestClasspath} -apiVersion 6.0  -Exclude jakarta.servlet.jsp -package jakarta.servlet -FileName ${SIGFILEPATH}/jakarta.servlet.sig
# jakarta.servlet.jsp (exclude jakarta.servlet.jsp.jstl)
java $CLASSNAME Setup ${OPTIONS} -classpath ${sigTestClasspath} -apiVersion 3.1  -Exclude jakarta.servlet.jsp.jstl -package jakarta.servlet.jsp -FileName ${SIGFILEPATH}/jakarta.servlet.jsp.sig
# jakarta.servlet.jsp.jstl
java $CLASSNAME Setup ${OPTIONS} -classpath ${sigTestClasspath} -apiVersion 3.0  -package jakarta.servlet.jsp.jstl -FileName ${SIGFILEPATH}/jakarta.servlet.jsp.jstl.sig
# jakarta.transaction
java $CLASSNAME Setup ${OPTIONS} -classpath ${sigTestClasspath} -apiVersion 2.0  -package jakarta.transaction -FileName ${SIGFILEPATH}/jakarta.transaction.sig
# jakarta.validation
java $CLASSNAME Setup ${OPTIONS} -classpath ${sigTestClasspath} -apiVersion 3.0  -package jakarta.validation -FileName ${SIGFILEPATH}/jakarta.validation.sig
# jakarta.websocket
java $CLASSNAME Setup ${OPTIONS} -classpath ${sigTestClasspath} -apiVersion 2.1  -package jakarta.websocket -FileName ${SIGFILEPATH}/jakarta.websocket.sig
# jakarta.ws.rs
java $CLASSNAME Setup ${OPTIONS} -classpath ${sigTestClasspath} -apiVersion 3.1  -package jakarta.ws.rs -FileName ${SIGFILEPATH}/jakarta.ws.rs.sig
# jakarta.xml.ws
java $CLASSNAME Setup ${OPTIONS} -classpath ${sigTestClasspath} -apiVersion 4.0  -package jakarta.xml.ws -FileName ${SIGFILEPATH}/jakarta.xml.ws.sig
# jakarta.xml.soap
java $CLASSNAME Setup ${OPTIONS} -classpath ${sigTestClasspath} -apiVersion 3.0  -package jakarta.xml.soap -FileName ${SIGFILEPATH}/jakarta.xml.soap.sig
# javax.rmi (only check on JDK11+)
java $CLASSNAME Setup ${OPTIONS} -classpath ${sigTestClasspath} -apiVersion 1.0  -package javax.rmi  -FileName ${SIGFILEPATH}/javax.rmi.sig

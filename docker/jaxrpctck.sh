...
elif [ -f "${WORKSPACE}/standalone-bundles/eclipse-jaxrpctck-1.1_latest.zip" ];then
  echo "Using stashed eclipse bundle created during the build phase"
  unzip ${WORKSPACE}/standalone-bundles/eclipse-jaxrpctck-1.1_latest.zip -d ${TCK_HOME}
else

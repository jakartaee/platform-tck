...
if [ -f "${WORKSPACE}/standalone-bundles/concurrencytck-1.0_latest.zip" ];then
  ...
  wget http://blr00akv.in.oracle.com/tck-builds/links/builds/tcks/javaee_cts/8.1/nightly/concurrencytck-1.0_Latest.zip -O ${WORKSPACE}/standalone-bundles/concurrencytck-1.0_latest.zip
fi
unzip ${WORKSPACE}/standalone-bundles/concurrencytck-1.0_latest.zip -d ${TCK_HOME}

...
elif [ -f "${WORKSPACE}/standalone-bundles/eclipse-connectortck-1.7_latest.zip" ];then
  echo "Using stashed eclipse bundle created during the build phase"
  unzip ${WORKSPACE}/standalone-bundles/eclipse-connectortck-1.7_latest.zip -d ${TCK_HOME}
else

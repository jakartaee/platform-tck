...
if [ -f "${WORKSPACE}/standalone-bundles/connectortck-1.7_latest.zip" ];then
  ...
  wget http://blr00akv.in.oracle.com/tck-builds/links/builds/tcks/javaee_cts/8.1/nightly/connectortck-1.7_Latest.zip -O ${WORKSPACE}/standalone-bundles/connectortck-1.7_latest.zip
fi
unzip ${WORKSPACE}/standalone-bundles/connectortck-1.7_latest.zip -d ${TCK_HOME}

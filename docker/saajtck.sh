...
if [ -f "${WORKSPACE}/standalone-bundles/saajtck-1.4_latest.zip" ];then
  ...
  wget http://blr00akv.in.oracle.com/tck-builds/links/builds/tcks/javaee_cts/8.1/nightly/saajtck-1.4_Latest.zip -O ${WORKSPACE}/standalone-bundles/saajtck-1.4_latest.zip
fi

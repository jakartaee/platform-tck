...
if [ -f "${WORKSPACE}/standalone-bundles/securityapitck-1.0_latest.zip" ];then
  ...
  wget http://blr00akv.in.oracle.com/tck-builds/links/builds/tcks/javaee_cts/8.1/nightly/securityapitck-1.0_Latest.zip -O ${WORKSPACE}/standalone-bundles/securityapitck-1.0_latest.zip
fi

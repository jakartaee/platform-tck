...
if [ -f "${WORKSPACE}/standalone-bundles/cajtck-1.3_latest.zip" ];then
  ...
  wget http://blr00akv.in.oracle.com/tck-builds/links/builds/tcks/javaee_cts/8.1/nightly/cajtck-1.3_Latest.zip -O ${WORKSPACE}/standalone-bundles/cajtck-1.3_latest.zip
fi

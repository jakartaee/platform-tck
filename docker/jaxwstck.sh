...
if [ -f "${WORKSPACE}/standalone-bundles/jaxwstck-2.3_latest.zip" ];then
  ...
  wget http://blr00akv.in.oracle.com/tck-builds/links/builds/tcks/javaee_cts/8.1/nightly/jaxwstck-2.3_Latest.zip -O ${WORKSPACE}/standalone-bundles/jaxwstck-2.3_latest.zip
fi

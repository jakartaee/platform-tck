...
export ANT_OPTS="-Djava.endorsed.dirs=$TCK_HOME/glassfish7/glassfish/modules/endorsed -Djavax.xml.accessExternalStylesheet=all -Djavax.xml.accessExternalSchema=all -Djavax.xml.accessExternalDTD=file,http,https"

cd $TS_HOME/bin
ant config.vi

RI_DOMAIN_CONFIG_FILE=$TCK_HOME/ri/glassfish7/glassfish/domains/domain1/config/domain.xml
rm -rf $TCK_HOME/ri/*

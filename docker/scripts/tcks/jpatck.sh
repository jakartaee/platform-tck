...
./asadmin start-database --dbhome $TCK_HOME/glassfish7/glassfish/databases --dbport 1527 --jvmoptions "-Djava.security.manager -Djava.security.policy=$TS_HOME/bin/security.policy"

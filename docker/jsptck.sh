...
if [ -f "${WORKSPACE}/standalone-bundles/jsptck-2.3_latest.zip" ];then
  ...
  wget http://blr00akv.in.oracle.com/tck-builds/links/builds/tcks/javaee_cts/8.1/nightly/jsptck-2.3_Latest.zip -O ${WORKSPACE}/standalone-bundles/jsptck-2.3_latest.zip
fi

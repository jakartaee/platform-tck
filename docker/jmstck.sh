...
cd $TCK_HOME
if [ -f "${WORKSPACE}/standalone-bundles/jmstck-2.0_latest.zip" ];then
  ...
  wget http://blr00akv.in.oracle.com/tck-builds/links/builds/tcks/javaee_cts/8.1/nightly/jmstck-2.0_Latest.zip -O ${WORKSPACE}/standalone-bundles/jmstck-2.0_latest.zip
fi
unzip ${WORKSPACE}/standalone-bundles/jmstck-2.0_latest.zip -d ${TCK_HOME}

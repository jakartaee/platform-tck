...
if [ -f "${WORKSPACE}/standalone-bundles/jpatck-2.2_latest.zip" ];then
  ...
  wget http://blr00akv.in.oracle.com/tck-builds/links/builds/tcks/javaee_cts/8.1/nightly/jpatck-2.2_Latest.zip -O ${WORKSPACE}/standalone-bundles/jpatck-2.2_latest.zip
fi

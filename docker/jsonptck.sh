...
if [ -f "${WORKSPACE}/standalone-bundles/jsonptck-1.1_latest.zip" ];then
  ...
  wget http://blr00akv.in.oracle.com/tck-builds/links/builds/tcks/javaee_cts/8.1/nightly/jsonptck-1.1_Latest.zip -O ${WORKSPACE}/standalone-bundles/jsonptck-1.1_latest.zip
fi

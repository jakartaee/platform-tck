...
if [ -f "${WORKSPACE}/standalone-bundles/jstltck-1.2_latest.zip" ];then
  ...
  wget http://blr00akv.in.oracle.com/tck-builds/links/builds/tcks/javaee_cts/8.1/nightly/jstltck-1.2_Latest.zip -O ${WORKSPACE}/standalone-bundles/jstltck-1.2_latest.zip
fi
unzip ${WORKSPACE}/standalone-bundles/jstltck-1.2_latest.zip -d ${TCK_HOME}

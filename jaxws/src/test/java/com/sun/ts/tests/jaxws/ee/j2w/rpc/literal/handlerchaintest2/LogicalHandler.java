...
public class LogicalHandler
  ...
  public void HandlerChainOnSEITest(LogicalMessageContext context,
      String direction) {
    ...
    String newTmp = tmp.replaceAll("HandlerChainOnSEITest",
        "HandlerChainOnSEITest" + direction + HANDLER_NAME);

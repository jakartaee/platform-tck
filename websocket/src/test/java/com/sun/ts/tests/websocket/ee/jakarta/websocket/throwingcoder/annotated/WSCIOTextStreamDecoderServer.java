...
import com.sun.ts.tests.websocket.ee.jakarta.websocket.throwingcoder.ThrowingIOTextStreamDecoder;
...
@ServerEndpoint(value = "/iotextstreamdecoder", decoders = {
    ThrowingIOTextStreamDecoder.class })

...
public class Client extends EETest {
  ...
  public void EJBMethodPermissionTest() throws Exception {
    ...
    if (!verified) {
      throw new Exception("EJBMethodPermissionTest failed: "
  ...
  public void EJBMethodPermissionAddToRole() throws Exception {
    ...
    if (bAdminFound && bManagerFound) {
      ...
      throw new Exception("EJBMethodPermissionAddToRole failed: "
          + "addToRole policy statements verification failed");
    }
  ...
  public void EJBRoleRefPermission() throws Exception {
    ...
    if (!verified) {
      throw new Exception("EJBRoleRefPermission failed: "
          + "addToRole policy statements verification failed");
    } else {
      TestUtil.logMsg("addToRole policy statements verification successful");
    }

...
<html>
<head><title>negativeUrlContextUrlInvalidValueTest</title></head>
<body>
    ...
    Invalid value provided to context attribute, and Exception was thrown.  Test PASSED!<br>

    Context specified relative path without leading slash:<br>
    
        
    Invalid value provided to value attribute, and Exception was thrown.  Test PASSED!<br>

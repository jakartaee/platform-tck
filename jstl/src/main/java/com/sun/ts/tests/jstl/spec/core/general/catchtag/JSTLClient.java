...
public class JSTLClient extends AbstractUrlClient {
  ...
  public static WebArchive createDeployment() throws IOException {
    ...
    archive.setWebXML(JSTLClient.class.getClassLoader().getResource(packagePath+"/jstl_core_gen_catch_web.xml"));

    archive.add(new UrlAsset(JSTLClient.class.getClassLoader().getResource(packagePath+"/positiveCatchTest.jsp")), "positiveCatchTest.jsp");
  ...
  public void positiveCatchTest() throws Exception {
    InputStream gfStream = JSTLClient.class.getClassLoader().getResourceAsStream(packagePath+"/positiveCatchTest.gf");

...
public class JSTLClient extends AbstractUrlClient {
  ...
  public static WebArchive createDeployment() throws IOException {
    ...
    archive.setWebXML(JSTLClient.class.getClassLoader().getResource(packagePath+"/jstl_xml_types_web.xml"));

    archive.add(new UrlAsset(JSTLClient.class.getClassLoader().getResource(packagePath+"/positiveJavaToXPathTypesTest.jsp")), "positiveJavaToXPathTypesTest.jsp");
    archive.add(new UrlAsset(JSTLClient.class.getClassLoader().getResource(packagePath+"/positiveXPathToJavaTypesTest.jsp")), "positiveXPathToJavaTypesTest.jsp");
  ...
  public void positiveJavaToXPathTypesTest() throws Exception {
    InputStream gfStream = JSTLClient.class.getClassLoader().getResourceAsStream(packagePath+"/positiveJavaToXPathTypesTest.gf");
  ...
  public void positiveXPathToJavaTypesTest() throws Exception {
    InputStream gfStream = JSTLClient.class.getClassLoader().getResourceAsStream(packagePath+"/positiveXPathToJavaTypesTest.gf");
    setGoldenFileStream(gfStream);

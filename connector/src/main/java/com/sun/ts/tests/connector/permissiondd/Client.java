...
public class Client extends ServiceEETest implements Serializable {
   ...
   *
   */
  public void testValidateCustomPerm() throws Exception {
    Vector log = null;
    boolean b1 = false;
    ...
    if (b1) {
      ...
      if (!b1) {
        ...
        throw new Exception("testValidateCustomPerm FAILED.");
      }
    }
   ...
   *
   */
  public void testValidateRequiredPermSet() throws Exception {
    Vector log = null;
    boolean b1 = false;
    ...
    if (b1) {
      ...
      if (!b1) {
        TestUtil.logMsg(
            "Failures can occur if you are not running with Security Manager enabled in your appserver.");
        throw new Exception("testValidateRequiredPermSet FAILED.");
      }
    }
   ...
   *
   */
  public void testValidateMissingPermFails() throws Exception {
    Vector log = null;
    boolean b1 = false;
    ...
    if (b1) {
      ...
      if (!b1) {
        TestUtil.logMsg(
            "Failures can occur if you are not running with Security Manager enabled in your appserver.");
        throw new Exception("testValidateMissingPermFails FAILED.");
      }
    }
   ...
   *
   */
  public void testValidateRestrictedLocalPerm() throws Exception {
    Vector log = null;
    boolean b1 = false;
    ...
    if (b1) {
      ...
      if (!b1) {
        TestUtil.logMsg(
            "Failures can occur if you are not running with Security Manager enabled in your appserver.");
        throw new Exception("testValidateRestrictedLocalPerm FAILED.");
      }
    }
   ...
   *
   */
  public void testValidateLocalPermsInvalidName() throws Exception {
    Vector log = null;
    boolean b1 = false;
    ...
    if (b1) {
      ...
      if (!b1) {
        TestUtil.logMsg(
            "Failures can occur if you are not running with Security Manager enabled in your appserver.");
        throw new Exception("testValidateLocalPermsInvalidName FAILED.");
      }
    }

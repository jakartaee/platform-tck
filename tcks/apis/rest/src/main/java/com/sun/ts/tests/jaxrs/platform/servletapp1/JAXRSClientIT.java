...
public class JAXRSClientIT extends JAXRSCommonClient {
    ...
    public static WebArchive createDeployment() throws IOException {
        ...
        WebArchive archive = ShrinkWrap.create(WebArchive.class, "jaxrs_platform_servletapp1_web.war");
        archive.addClasses(TSAppConfig.class, ParentResource.class, ChildResource.class, ParentResource1.class, ChildResource1.class);
        // archive.addAsWebInfResource(JAXRSClientIT.class.getPackage(), "jaxrs_platform_servletapp1_web.xml", "web.xml"); //can
        // use if the web.xml.template doesn't need to be modified.
        return archive;
     ...
     * Application subclass name in web.xml; Package all resource in web.war file; Client sends a request on a resource at
     * /InheritanceTest, Verify that inheritance works; Verify deploy JAX-RS resource as Servlet application with
     * Application with @ApplicationPath works;.
     */
    @Test
    public void test1() throws Exception {
        setProperty(Property.REQUEST_HEADERS, buildAccept(MediaType.TEXT_PLAIN_TYPE));
        setProperty(Property.REQUEST, buildRequest(Request.GET, "ServletApp1/InheritanceTest"));
     ...
     * @test_Strategy: Create Application subclass annotated with @ApplicationPath; Create servlet-name with fully qualified
     * Application subclass name in web.xml; Package all resource in web.war file; Client sends a request on a resource at
     * /InheritanceTest1, Verify that inheritance works. Verify deploy JAX-RS resource as Servlet application with
     * Application with @ApplicationPath works;.
     */
    @Test
    public void test2() throws Exception {
        setProperty(Property.REQUEST_HEADERS, buildAccept(MediaType.TEXT_HTML_TYPE));
        setProperty(Property.REQUEST, buildRequest(Request.GET, "ServletApp1/InheritanceTest1"));

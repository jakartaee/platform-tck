...
public class JAXRSClientIT extends JaxrsCommonClient {
    ...
    public JAXRSClientIT() {
        setup();
        setContextRoot("/jaxrs_platform_beanvalidation_constraintviolationexceptionmapper_web/resource");
    }
    ...
    public static WebArchive createDeployment() throws IOException {
        ...
        InputStream inStream = JAXRSClientIT.class.getClassLoader()
                .getResourceAsStream("com/sun/ts/tests/jaxrs/platform/beanvalidation/constraintviolationexceptionmapper/web.xml.template");
        ...
        inStream = JAXRSClientIT.class.getClassLoader()
                .getResourceAsStream("com/sun/ts/tests/jaxrs/platform/beanvalidation/constraintviolationexceptionmapper/beans.xml");
        String beansXml = toString(inStream);

        WebArchive archive = ShrinkWrap.create(WebArchive.class,
                "jaxrs_platform_beanvalidation_constraintviolationexceptionmapper_web.war");
        archive.addClasses(TSAppConfig.class, Resource.class, ConstraintDeclarationAnnotation.class, ConstraintDeclarationResource.class,
                ...
                StringBeanEntityProvider.class, ConstraintViolationExceptionMapper.class);
    ...
    public void constraintDeclarationExceptionThrownTest() throws Exception {
        ...
        setProperty(Property.STATUS_CODE, getStatusCode(Status.INTERNAL_SERVER_ERROR));
        invoke();
        logMsg("ExceptionMapper works as expected");

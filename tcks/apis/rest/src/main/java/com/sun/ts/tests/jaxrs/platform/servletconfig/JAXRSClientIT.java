...
public class JAXRSClientIT extends JAXRSCommonClient {
    ...
    public static WebArchive createDeployment() throws IOException {
        ...
        WebArchive archive = ShrinkWrap.create(WebArchive.class, "jaxrs_platform_servletconfig_web.war");
        archive.addClasses(TSAppConfig.class, ParentResource.class, ChildResource.class, ParentResource1.class, ChildResource1.class);
        archive.addAsWebInfResource(JAXRSClientIT.class.getPackage(), "jaxrs_platform_servletconfig_web.xml", "web.xml"); // can use if the
                                                                                                                          // web.xml.template
                                                                                                                          // doesn't need to
                                                                                                                          // be modified.
        return archive;
    ...
    public void test1() throws Exception {
        ...
        setProperty(Property.REQUEST, buildRequest(Request.GET, "ServletConfig/InheritanceTest"));
    ...
    public void test2() throws Exception {
        ...
        setProperty(Property.REQUEST, buildRequest(Request.GET, "ServletConfig/InheritanceTest1"));

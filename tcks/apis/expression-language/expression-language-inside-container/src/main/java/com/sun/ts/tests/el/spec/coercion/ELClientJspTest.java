...
public class ELClientJspTest extends ServiceEETest {
  ...
  static final String VEHICLE_ARCHIVE = "coercion_jsp_vehicle";
  ...
  public static WebArchive createDeploymentVehicle() throws IOException {
    ...
    WebArchive jsp_vehicle_web = ShrinkWrap.create(WebArchive.class, "coercion_jsp_vehicle_web.war");
    ...
    jsp_vehicle_web.addClasses(
        ...
        com.sun.ts.tests.el.spec.coercion.ELClientJspTest.class
    );
    ...
    /*
    EnterpriseArchive jsp_vehicle_ear = ShrinkWrap.create(EnterpriseArchive.class, "coercion_jsp_vehicle.ear");
  ...
  public void elCoerceToArrayTest() throws Exception {
    ...
    try {
      ...
      elp0.defineFunction("", "", "com.sun.ts.tests.el.spec.coercion.ELClientJspTest", "testPrimitiveBooleanArray");
      ...
      elp1.defineFunction("", "", "com.sun.ts.tests.el.spec.coercion.ELClientJspTest", "testPrimitiveBooleanArray");
      ...
      elp2.defineFunction("", "", "com.sun.ts.tests.el.spec.coercion.ELClientJspTest", "testPrimitiveBooleanArray");
      ...
      elp3.defineFunction("", "", "com.sun.ts.tests.el.spec.coercion.ELClientJspTest", "testPrimitiveBooleanArray");
      try {
      ...
      elp4.defineFunction("", "", "com.sun.ts.tests.el.spec.coercion.ELClientJspTest", "testPrimitiveBooleanArray");
      try {
  ...
  public void elCoerceLambdaExpressionToFunctionalInterfaceTest() throws Exception {
    ...
    try {
      ...
      ELProcessor elp0 = new ELProcessor();
      elp0.defineFunction("", "", "com.sun.ts.tests.el.spec.coercion.ELClientJspTest", "testPredicateString");
      ...
      ELProcessor elp1 = new ELProcessor();
      elp1.defineFunction("", "", "com.sun.ts.tests.el.spec.coercion.ELClientJspTest", "testPredicateString");
      ...
      ELProcessor elp2 = new ELProcessor();
      elp2.defineFunction("", "", "com.sun.ts.tests.el.spec.coercion.ELClientJspTest", "testPredicateString");
      try {
      ...
      ELProcessor elp3 = new ELProcessor();      
      elp3.defineFunction("", "", "com.sun.ts.tests.el.spec.coercion.ELClientJspTest", "testPredicateLong");
      try {
      ...
      ELProcessor elp4 = new ELProcessor();
      elp4.defineFunction("", "", "com.sun.ts.tests.el.spec.coercion.ELClientJspTest", "testPredicateString");
      try {
      ...
      elp5.defineFunction("", "", "com.sun.ts.tests.el.spec.coercion.ELClientJspTest", "testPredicateLong");
      try {

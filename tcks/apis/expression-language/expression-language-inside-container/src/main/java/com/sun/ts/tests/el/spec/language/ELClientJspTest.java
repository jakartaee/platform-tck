...
public class ELClientJspTest extends ServiceEETest {
  ...
  public static WebArchive createDeploymentVehicle() throws IOException {
    ...
    WebArchive jsp_vehicle_web = ShrinkWrap.create(WebArchive.class, "language_jsp_vehicle_web.war");
    ...
    jsp_vehicle_web.addClasses(
        ...
        com.sun.ts.tests.el.spec.language.ELClientJspTest.class
    );
    ...
    /*
    EnterpriseArchive jsp_vehicle_ear = ShrinkWrap.create(EnterpriseArchive.class, "language_jsp_vehicle.ear");

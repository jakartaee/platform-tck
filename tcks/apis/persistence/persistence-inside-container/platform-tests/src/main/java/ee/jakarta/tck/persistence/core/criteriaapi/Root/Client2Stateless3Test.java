    ...
    public void setup(String[] args, Properties p) throws Exception {
        ...
        */
        ...
        // Client
            ...
            archiveProcessor.processClientArchive(jpa_core_criteriaapi_Root_stateless3_vehicle_client, Client2.class, resURL);
...
//              jpa_core_criteriaapi_Root_stateless3_vehicle_ejb.addAsManifestResource(ejbResURL1, "ejb-jar.xml");
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_criteriaapi_Root_stateless3_vehicle_ejb, Client2.class, ejbResURL1);

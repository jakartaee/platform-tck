...
public class Client4AppmanagednotxTest extends ee.jakarta.tck.persistence.core.annotations.access.field.Client4 {
    ...
    public static void main(String[] args) {
        Client4AppmanagednotxTest theTests = new Client4AppmanagednotxTest();
      ...
      public void setup(String[] args, Properties p) throws Exception {
        ...
        */
        ...
        // Client
            ...
            jpa_core_annotations_access_field_appmanagedNoTx_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + com.sun.ts.tests.common.vehicle.VehicleClient.class.getName() + "\n"), "MANIFEST.MF");

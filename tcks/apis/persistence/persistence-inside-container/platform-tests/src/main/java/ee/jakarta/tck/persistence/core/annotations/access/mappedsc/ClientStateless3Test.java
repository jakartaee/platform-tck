      ...
      s.exit();
        ...
        */
        ...
        // Client
            ...
            JavaArchive jpa_core_anno_access_mappedsc_stateless3_vehicle_client = ShrinkWrap.create(JavaArchive.class, "jpa_core_anno_access_mappedsc_vehicles_client.jar");
            // The class files
            ...
            jpa_core_anno_access_mappedsc_stateless3_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + com.sun.ts.tests.common.vehicle.VehicleClient.class.getName() + "\n"), "MANIFEST.MF");

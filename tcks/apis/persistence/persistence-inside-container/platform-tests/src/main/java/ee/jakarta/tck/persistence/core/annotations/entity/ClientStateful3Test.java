...
public class ClientStateful3Test extends ee.jakarta.tck.persistence.core.annotations.entity.Client {
    static final String VEHICLE_ARCHIVE = "jpa_core_annotations_entity_stateful3_vehicle";
        ...
        */
        ...
        // Client
            ...
            JavaArchive jpa_core_annotations_entity_stateful3_vehicle_client = ShrinkWrap.create(JavaArchive.class, "jpa_core_annotations_entity_vehicles_client.jar");
            // The class files
            jpa_core_annotations_entity_stateful3_vehicle_client.addClasses(
            ...
            if(resURL != null) {
              jpa_core_annotations_entity_stateful3_vehicle_client.addAsManifestResource(resURL, "sun-application-client.xml");
            }
            jpa_core_annotations_entity_stateful3_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + com.sun.ts.tests.common.vehicle.VehicleClient.class.getName() + "\n"), "MANIFEST.MF");
        ...
        // Ejb 1
            ...
            // The class files
            jpa_core_annotations_entity_stateful3_vehicle_ejb.addClasses(
...
//              jpa_core_annotations_entity_stateful3_vehicle_ejb.addAsManifestResource(ejbResURL1, "ejb-jar.xml");
        ...
        // Ear
            ...
            jpa_core_annotations_entity_vehicles_ear.addAsModule(jpa_core_annotations_entity_stateful3_vehicle_ejb);
            jpa_core_annotations_entity_vehicles_ear.addAsModule(jpa_core_annotations_entity_stateful3_vehicle_client);

    ...
    static final String VEHICLE_ARCHIVE = "jpa_core_criteriaapi_metamodelquery_stateful3_vehicle";
        ...
        */
        ...
        // Client
            ...
            JavaArchive jpa_core_criteriaapi_metamodelquery_stateful3_vehicle_client = ShrinkWrap.create(JavaArchive.class, "jpa_core_criteriaapi_metamodelquery_vehicles_client.jar");
            // The class files
            ...
            if(resURL != null) {
              jpa_core_criteriaapi_metamodelquery_stateful3_vehicle_client.addAsManifestResource(resURL, "sun-application-client.xml");
            }
            jpa_core_criteriaapi_metamodelquery_stateful3_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + com.sun.ts.tests.common.vehicle.VehicleClient.class.getName() + "\n"), "MANIFEST.MF");
...
//              jpa_core_criteriaapi_metamodelquery_stateful3_vehicle_ejb.addAsManifestResource(ejbResURL1, "ejb-jar.xml");
        ...
        // Par
            ...
            // The class files
            jpa_core_criteriaapi_metamodelquery.addClasses(ee.jakarta.tck.persistence.common.schema30.Util.getSchema30classes());

...
public class Client5AppmanagedTest extends ee.jakarta.tck.persistence.core.criteriaapi.metamodelquery.Client5 {
    static final String VEHICLE_ARCHIVE = "jpa_core_criteriaapi_metamodelquery_appmanaged_vehicle";
        ...
        */
        ...
        // Client
            ...
            archiveProcessor.processClientArchive(jpa_core_criteriaapi_metamodelquery_appmanaged_vehicle_client, Client5.class, resURL);
...
//              jpa_core_criteriaapi_metamodelquery_appmanaged_vehicle_ejb.addAsManifestResource(ejbResURL1, "ejb-jar.xml");
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_criteriaapi_metamodelquery_appmanaged_vehicle_ejb, Client5.class, ejbResURL1);

    ...
    static final String VEHICLE_ARCHIVE = "jpa_ee_entityManager_appmanaged_vehicle";
        ...
        */
        ...
        // Client
            ...
            JavaArchive jpa_ee_entityManager_appmanaged_vehicle_client = ShrinkWrap.create(JavaArchive.class, "jpa_ee_entityManager_vehicles_client.jar");
            // The class files
            ...
            if(resURL != null) {
              jpa_ee_entityManager_appmanaged_vehicle_client.addAsManifestResource(resURL, "sun-application-client.xml");
            }
            jpa_ee_entityManager_appmanaged_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + com.sun.ts.tests.common.vehicle.VehicleClient.class.getName() + "\n"), "MANIFEST.MF");

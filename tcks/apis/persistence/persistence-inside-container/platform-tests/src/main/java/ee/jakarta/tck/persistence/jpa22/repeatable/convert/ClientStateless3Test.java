      ...
      s.exit();
        ...
        */
        ...
        // Client
            ...
            JavaArchive jpa_jpa22_repeatable_converts_stateless3_vehicle_client = ShrinkWrap.create(JavaArchive.class, "jpa_jpa22_repeatable_converts_vehicles_client.jar");
            // The class files
            ...
            jpa_jpa22_repeatable_converts_stateless3_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + com.sun.ts.tests.common.vehicle.VehicleClient.class.getName() + "\n"), "MANIFEST.MF");

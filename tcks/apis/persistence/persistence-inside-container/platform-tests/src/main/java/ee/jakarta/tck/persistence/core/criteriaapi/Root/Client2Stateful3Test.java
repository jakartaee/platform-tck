...
public class Client2Stateful3Test extends ee.jakarta.tck.persistence.core.criteriaapi.Root.Client2 {
    static final String VEHICLE_ARCHIVE = "jpa_core_criteriaapi_Root_stateful3_vehicle";
        ...
        */
        ...
        // Client
            ...
            archiveProcessor.processClientArchive(jpa_core_criteriaapi_Root_stateful3_vehicle_client, Client2.class, resURL);
...
//              jpa_core_criteriaapi_Root_stateful3_vehicle_ejb.addAsManifestResource(ejbResURL1, "ejb-jar.xml");
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_criteriaapi_Root_stateful3_vehicle_ejb, Client2.class, ejbResURL1);

...
public class Client2Stateful3Test extends ee.jakarta.tck.persistence.core.StoredProcedureQuery.Client2 {
    ...
    public void setup(String[] args, Properties p) throws Exception {
        ...
        */
        ...
        // Client
            ...
            if(resURL != null) {
              jpa_core_StoredProcedureQuery_stateful3_vehicle_client.addAsManifestResource(resURL, "sun-application-client.xml");
            }
            jpa_core_StoredProcedureQuery_stateful3_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + com.sun.ts.tests.common.vehicle.VehicleClient.class.getName() + "\n"), "MANIFEST.MF");
            // Call the archive processor
            archiveProcessor.processClientArchive(jpa_core_StoredProcedureQuery_stateful3_vehicle_client, Client2.class, resURL);

        // Ejb 1
            // the jar with the correct archive name
            JavaArchive jpa_core_StoredProcedureQuery_stateful3_vehicle_ejb = ShrinkWrap.create(JavaArchive.class, "jpa_core_StoredProcedureQuery_stateful3_vehicle_ejb.jar");
            // The class files
            jpa_core_StoredProcedureQuery_stateful3_vehicle_ejb.addClasses(
            ...
            if(ejbResURL1 != null) {
//              jpa_core_StoredProcedureQuery_stateful3_vehicle_ejb.addAsManifestResource(ejbResURL1, "ejb-jar.xml");
            }
            ...
            if(ejbResURL1 != null) {
              jpa_core_StoredProcedureQuery_stateful3_vehicle_ejb.addAsManifestResource(ejbResURL1, "sun-ejb-jar.xml");
            }
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_StoredProcedureQuery_stateful3_vehicle_ejb, Client2.class, ejbResURL1);
        ...
        // Ear
            ...
            jpa_core_StoredProcedureQuery_vehicles_ear.addAsModule(jpa_core_StoredProcedureQuery_stateful3_vehicle_ejb);
            jpa_core_StoredProcedureQuery_vehicles_ear.addAsModule(jpa_core_StoredProcedureQuery_stateful3_vehicle_client);

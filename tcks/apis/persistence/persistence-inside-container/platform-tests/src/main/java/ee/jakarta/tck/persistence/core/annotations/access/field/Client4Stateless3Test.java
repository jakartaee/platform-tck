...
public class Client4Stateless3Test extends ee.jakarta.tck.persistence.core.annotations.access.field.Client4 {
    ...
    public static void main(String[] args) {
        Client4Stateless3Test theTests = new Client4Stateless3Test();
      ...
      public void setup(String[] args, Properties p) throws Exception {
        ...
        */
        ...
        // Client
            ...
            jpa_core_annotations_access_field_stateless3_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + com.sun.ts.tests.common.vehicle.VehicleClient.class.getName() + "\n"), "MANIFEST.MF");

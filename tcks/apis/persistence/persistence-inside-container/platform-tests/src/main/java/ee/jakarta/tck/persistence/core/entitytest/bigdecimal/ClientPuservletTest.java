...
public class ClientPuservletTest extends ee.jakarta.tck.persistence.core.entitytest.bigdecimal.Client {
    static final String VEHICLE_ARCHIVE = "jpa_core_entitytest_bigdecimal_puservlet_vehicle";
        ...
        */
        ...
        // War
            ...
            WebArchive jpa_core_entitytest_bigdecimal_puservlet_vehicle_web = ShrinkWrap.create(WebArchive.class, "jpa_core_entitytest_bigdecimal_puservlet_vehicle_web.war");
            // The class files
            jpa_core_entitytest_bigdecimal_puservlet_vehicle_web.addClasses(
            ...
            if(warResURL != null) {
              jpa_core_entitytest_bigdecimal_puservlet_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
        ...
        // Par
            ...
            jpa_core_entitytest_bigdecimal_puservlet_vehicle_web.addAsLibrary(jpa_core_entitytest_bigdecimal);
            return jpa_core_entitytest_bigdecimal_puservlet_vehicle_web;
        }

...
public class Client1Stateful3Test extends ee.jakarta.tck.persistence.core.criteriaapi.CriteriaBuilder.Client1 {
    static final String VEHICLE_ARCHIVE = "jpa_core_criteriapia_CriteriaBuilder_stateful3_vehicle";
        ...
        */
        ...
        // Client
            ...
            archiveProcessor.processClientArchive(jpa_core_criteriapia_CriteriaBuilder_stateful3_vehicle_client, Client1.class, resURL);
...
//              jpa_core_criteriapia_CriteriaBuilder_stateful3_vehicle_ejb.addAsManifestResource(ejbResURL1, "ejb-jar.xml");
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_criteriapia_CriteriaBuilder_stateful3_vehicle_ejb, Client1.class, ejbResURL1);

    ...
    static final String VEHICLE_ARCHIVE = "jpa_core_callback_inheritance_pmservlet_vehicle";
        ...
        */
        ...
        // Par
            ...
            jpa_core_callback_inheritance_pmservlet_vehicle_web.addAsLibrary(jpa_core_callback_inheritance);
            return jpa_core_callback_inheritance_pmservlet_vehicle_web;
        }

...
public class Client3Stateful3Test extends ee.jakarta.tck.persistence.core.annotations.access.field.Client3 {
    ...
    public static void main(String[] args) {
      Client3Stateful3Test theTests = new Client3Stateful3Test();
    ...
    public void setup(String[] args, Properties p) throws Exception {
        ...
        */
        ...
        // Client
            ...
            jpa_core_annotations_access_field_stateful3_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + com.sun.ts.tests.common.vehicle.VehicleClient.class.getName() + "\n"), "MANIFEST.MF");

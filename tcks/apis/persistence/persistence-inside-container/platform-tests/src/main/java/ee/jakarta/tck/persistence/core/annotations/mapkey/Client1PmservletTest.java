...
public class Client1PmservletTest extends ee.jakarta.tck.persistence.core.annotations.mapkey.Client1 {
    static final String VEHICLE_ARCHIVE = "jpa_core_annotations_mapkey_pmservlet_vehicle";
        ...
        */
        ...
        // War
            ...
            WebArchive jpa_core_annotations_mapkey_pmservlet_vehicle_web = ShrinkWrap.create(WebArchive.class, "jpa_core_annotations_mapkey_pmservlet_vehicle_web.war");
            // The class files
            jpa_core_annotations_mapkey_pmservlet_vehicle_web.addClasses(
            ...
            if(warResURL != null) {
              jpa_core_annotations_mapkey_pmservlet_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = Client1.class.getResource("/com/sun/ts/tests/common/vehicle/pmservlet/pmservlet_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
              jpa_core_annotations_mapkey_pmservlet_vehicle_web.addAsWebInfResource(warResURL, "sun-web.xml");
            }

            // Any libraries added to the war

            // Web content
            warResURL = Client1.class.getResource("/com/sun/ts/tests/jpa/core/annotations/mapkey/jpa_core_annotations_mapkey.jar");
            if(warResURL != null) {
              jpa_core_annotations_mapkey_pmservlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/lib/jpa_core_annotations_mapkey.jar");
            }
            warResURL = Client1.class.getResource("/com/sun/ts/tests/common/vehicle/pmservlet/pmservlet_vehicle_web.xml");
            if(warResURL != null) {
              jpa_core_annotations_mapkey_pmservlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/pmservlet_vehicle_web.xml");
            }

           // Call the archive processor
           archiveProcessor.processWebArchive(jpa_core_annotations_mapkey_pmservlet_vehicle_web, Client1.class, warResURL);
        ...
        // Par
            ...
            jpa_core_annotations_mapkey_pmservlet_vehicle_web.addAsLibrary(jpa_core_annotations_mapkey);
            return jpa_core_annotations_mapkey_pmservlet_vehicle_web;
        }

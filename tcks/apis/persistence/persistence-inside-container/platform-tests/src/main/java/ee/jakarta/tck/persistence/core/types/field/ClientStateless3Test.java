      ...
      s.exit();
        ...
        */
        ...
        // Client
            ...
            JavaArchive jpa_core_types_field_stateless3_vehicle_client = ShrinkWrap.create(JavaArchive.class, "jpa_core_types_field_vehicles_client.jar");
            // The class files
            ...
            if(resURL != null) {
              jpa_core_types_field_stateless3_vehicle_client.addAsManifestResource(resURL, "sun-application-client.xml");
            }
            jpa_core_types_field_stateless3_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + com.sun.ts.tests.common.vehicle.VehicleClient.class.getName() + "\n"), "MANIFEST.MF");

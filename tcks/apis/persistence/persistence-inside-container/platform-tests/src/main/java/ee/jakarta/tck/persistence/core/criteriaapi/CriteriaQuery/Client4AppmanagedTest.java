...
public class Client4AppmanagedTest extends ee.jakarta.tck.persistence.core.criteriaapi.CriteriaQuery.Client4 {
    static final String VEHICLE_ARCHIVE = "jpa_core_criteriaapi_CriteriaQuery_appmanaged_vehicle";
        ...
        */
        ...
        // Client
            ...
            archiveProcessor.processClientArchive(jpa_core_criteriaapi_CriteriaQuery_appmanaged_vehicle_client, Client4.class, resURL);
...
//              jpa_core_criteriaapi_CriteriaQuery_appmanaged_vehicle_ejb.addAsManifestResource(ejbResURL1, "ejb-jar.xml");
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_criteriaapi_CriteriaQuery_appmanaged_vehicle_ejb, Client4.class, ejbResURL1);

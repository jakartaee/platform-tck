    ...
    static final String VEHICLE_ARCHIVE = "jpa_core_annotations_discrinimatorValue_appmanaged_vehicle";
        ...
        */
        ...
        // Client
            ...
            jpa_core_annotations_discrinimatorValue_appmanaged_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + com.sun.ts.tests.common.vehicle.VehicleClient.class.getName() + "\n"), "MANIFEST.MF");

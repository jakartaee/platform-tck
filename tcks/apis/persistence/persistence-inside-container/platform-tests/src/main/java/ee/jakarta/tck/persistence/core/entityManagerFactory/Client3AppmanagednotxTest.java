...
public class Client3AppmanagednotxTest extends ee.jakarta.tck.persistence.core.entityManagerFactory.Client3 {
    static final String VEHICLE_ARCHIVE = "jpa_core_entityManagerFactory_appmanagedNoTx_vehicle";
        ...
        */
        ...
        // Client
            ...
            JavaArchive jpa_core_entityManagerFactory_appmanagedNoTx_vehicle_client = ShrinkWrap.create(JavaArchive.class, "jpa_core_entityManagerFactory_vehicles_client.jar");
            // The class files
            ...
            if(resURL != null) {
              jpa_core_entityManagerFactory_appmanagedNoTx_vehicle_client.addAsManifestResource(resURL, "sun-application-client.xml");
            }
            jpa_core_entityManagerFactory_appmanagedNoTx_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + com.sun.ts.tests.common.vehicle.VehicleClient.class.getName() + "\n"), "MANIFEST.MF");
            // Call the archive processor
            archiveProcessor.processClientArchive(jpa_core_entityManagerFactory_appmanagedNoTx_vehicle_client, Client3.class, resURL);
        ...
        // Ejb 1
            ...
            if(ejbResURL1 != null) {
//              jpa_core_entityManagerFactory_appmanagedNoTx_vehicle_ejb.addAsManifestResource(ejbResURL1, "ejb-jar.xml");
            }
            ...
            if(ejbResURL1 != null) {
              jpa_core_entityManagerFactory_appmanagedNoTx_vehicle_ejb.addAsManifestResource(ejbResURL1, "sun-ejb-jar.xml");
            }
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_entityManagerFactory_appmanagedNoTx_vehicle_ejb, Client3.class, ejbResURL1);

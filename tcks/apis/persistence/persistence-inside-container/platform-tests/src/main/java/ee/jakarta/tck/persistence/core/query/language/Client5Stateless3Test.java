...
public class Client5Stateless3Test extends ee.jakarta.tck.persistence.core.query.language.Client5 {
    static final String VEHICLE_ARCHIVE = "jpa_core_query_language_stateless3_vehicle";
        ...
        */
        ...
        // Client
            ...
            archiveProcessor.processClientArchive(jpa_core_query_language_stateless3_vehicle_client, Client5.class, resURL);
...
//              jpa_core_query_language_stateless3_vehicle_ejb.addAsManifestResource(ejbResURL1, "ejb-jar.xml");
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_query_language_stateless3_vehicle_ejb, Client5.class, ejbResURL1);

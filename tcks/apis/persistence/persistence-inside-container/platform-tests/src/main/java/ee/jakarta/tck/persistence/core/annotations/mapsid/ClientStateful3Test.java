...
public class ClientStateful3Test extends ee.jakarta.tck.persistence.core.annotations.mapsid.Client {
    static final String VEHICLE_ARCHIVE = "jpa_core_annotations_mapsid_stateful3_vehicle";
        ...
        */
        ...
        // Client
            ...
            JavaArchive jpa_core_annotations_mapsid_stateful3_vehicle_client = ShrinkWrap.create(JavaArchive.class, "jpa_core_annotations_mapsid_vehicles_client.jar");
            // The class files
            jpa_core_annotations_mapsid_stateful3_vehicle_client.addClasses(
            ...
            if(resURL != null) {
              jpa_core_annotations_mapsid_stateful3_vehicle_client.addAsManifestResource(resURL, "application-client.xml");
            }
            ...
            if(resURL != null) {
              jpa_core_annotations_mapsid_stateful3_vehicle_client.addAsManifestResource(resURL, "sun-application-client.xml");
            }
            jpa_core_annotations_mapsid_stateful3_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + com.sun.ts.tests.common.vehicle.VehicleClient.class.getName() + "\n"), "MANIFEST.MF");
            // Call the archive processor
            archiveProcessor.processClientArchive(jpa_core_annotations_mapsid_stateful3_vehicle_client, Client.class, resURL);

        // Ejb 1
            // the jar with the correct archive name
            JavaArchive jpa_core_annotations_mapsid_stateful3_vehicle_ejb = ShrinkWrap.create(JavaArchive.class, "jpa_core_annotations_mapsid_stateful3_vehicle_ejb.jar");
            // The class files
            jpa_core_annotations_mapsid_stateful3_vehicle_ejb.addClasses(
            ...
            if(ejbResURL1 != null) {
//              jpa_core_annotations_mapsid_stateful3_vehicle_ejb.addAsManifestResource(ejbResURL1, "ejb-jar.xml");
            }
            ...
            if(ejbResURL1 != null) {
              jpa_core_annotations_mapsid_stateful3_vehicle_ejb.addAsManifestResource(ejbResURL1, "sun-ejb-jar.xml");
            }
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_annotations_mapsid_stateful3_vehicle_ejb, Client.class, ejbResURL1);
        ...
        // Ear
            ...
            jpa_core_annotations_mapsid_vehicles_ear.addAsModule(jpa_core_annotations_mapsid_stateful3_vehicle_ejb);
            jpa_core_annotations_mapsid_vehicles_ear.addAsModule(jpa_core_annotations_mapsid_stateful3_vehicle_client);

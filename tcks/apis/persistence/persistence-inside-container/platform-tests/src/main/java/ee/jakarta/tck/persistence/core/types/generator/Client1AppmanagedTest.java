    ...
    static final String VEHICLE_ARCHIVE = "jpa_core_types_generator_appmanaged_vehicle";
        ...
        */
        ...
        // Client
            ...
            jpa_core_types_generator_appmanaged_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + com.sun.ts.tests.common.vehicle.VehicleClient.class.getName() + "\n"), "MANIFEST.MF");
...
//              jpa_core_types_generator_appmanaged_vehicle_ejb.addAsManifestResource(ejbResURL1, "ejb-jar.xml");
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_types_generator_appmanaged_vehicle_ejb, Client1.class, ejbResURL1);

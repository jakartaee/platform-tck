...
public class Client1Stateful3Test extends ee.jakarta.tck.persistence.core.annotations.mapkey.Client1 {
    static final String VEHICLE_ARCHIVE = "jpa_core_annotations_mapkey_stateful3_vehicle";
        ...
        */
        ...
        // Client
            ...
            if(resURL != null) {
              jpa_core_annotations_mapkey_stateful3_vehicle_client.addAsManifestResource(resURL, "sun-application-client.xml");
            }
            jpa_core_annotations_mapkey_stateful3_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + com.sun.ts.tests.common.vehicle.VehicleClient.class.getName() + "\n"), "MANIFEST.MF");
            // Call the archive processor
            archiveProcessor.processClientArchive(jpa_core_annotations_mapkey_stateful3_vehicle_client, Client1.class, resURL);
        ...
        // Ejb 1
            ...
            if(ejbResURL1 != null) {
//              jpa_core_annotations_mapkey_stateful3_vehicle_ejb.addAsManifestResource(ejbResURL1, "ejb-jar.xml");
            }
            ...
            if(ejbResURL1 != null) {
              jpa_core_annotations_mapkey_stateful3_vehicle_ejb.addAsManifestResource(ejbResURL1, "sun-ejb-jar.xml");
            }
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_annotations_mapkey_stateful3_vehicle_ejb, Client1.class, ejbResURL1);

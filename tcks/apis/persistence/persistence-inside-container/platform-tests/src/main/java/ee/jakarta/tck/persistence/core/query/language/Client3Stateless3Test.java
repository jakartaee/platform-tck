...
public class Client3Stateless3Test extends ee.jakarta.tck.persistence.core.query.language.Client3 {
    static final String VEHICLE_ARCHIVE = "jpa_core_query_language_stateless3_vehicle";
        ...
        */
        ...
        // Client
            ...
            archiveProcessor.processClientArchive(jpa_core_query_language_stateless3_vehicle_client, Client3.class, resURL);
...
//              jpa_core_query_language_stateless3_vehicle_ejb.addAsManifestResource(ejbResURL1, "ejb-jar.xml");
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_query_language_stateless3_vehicle_ejb, Client3.class, ejbResURL1);

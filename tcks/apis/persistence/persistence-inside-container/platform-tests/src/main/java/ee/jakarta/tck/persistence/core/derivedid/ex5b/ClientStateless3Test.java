      ...
      s.exit();
        ...
        */
        ...
        // Client
            ...
            JavaArchive jpa_core_deriverdid_ex5b_stateless3_vehicle_client = ShrinkWrap.create(JavaArchive.class, "jpa_core_deriverdid_ex5b_vehicles_client.jar");
            // The class files
            ...
            if(resURL != null) {
              jpa_core_deriverdid_ex5b_stateless3_vehicle_client.addAsManifestResource(resURL, "sun-application-client.xml");
            }
            jpa_core_deriverdid_ex5b_stateless3_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + com.sun.ts.tests.common.vehicle.VehicleClient.class.getName() + "\n"), "MANIFEST.MF");
        ...
        // Ejb 1
            ...
            if(ejbResURL1 != null) {
//              jpa_core_deriverdid_ex5b_stateless3_vehicle_ejb.addAsManifestResource(ejbResURL1, "ejb-jar.xml");
            }
            ...
            if(ejbResURL1 != null) {
              jpa_core_deriverdid_ex5b_stateless3_vehicle_ejb.addAsManifestResource(ejbResURL1, "sun-ejb-jar.xml");
            }
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_deriverdid_ex5b_stateless3_vehicle_ejb, Client.class, ejbResURL1);

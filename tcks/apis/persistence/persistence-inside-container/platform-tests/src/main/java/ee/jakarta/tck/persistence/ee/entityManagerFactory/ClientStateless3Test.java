...
public class ClientStateless3Test extends ee.jakarta.tck.persistence.ee.entityManagerFactory.Client {
    static final String VEHICLE_ARCHIVE = "jpa_ee_entityManagerFactory_stateless3_vehicle";
      ...
      s.exit();
        ...
        */
        ...
        // Client
            ...
            JavaArchive jpa_ee_entityManagerFactory_stateless3_vehicle_client = ShrinkWrap.create(JavaArchive.class, "jpa_ee_entityManagerFactory_vehicles_client.jar");
            // The class files
            jpa_ee_entityManagerFactory_stateless3_vehicle_client.addClasses(
            ...
            if(resURL != null) {
              jpa_ee_entityManagerFactory_stateless3_vehicle_client.addAsManifestResource(resURL, "application-client.xml");
            }
            ...
            if(resURL != null) {
              jpa_ee_entityManagerFactory_stateless3_vehicle_client.addAsManifestResource(resURL, "sun-application-client.xml");
            }
            jpa_ee_entityManagerFactory_stateless3_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + com.sun.ts.tests.common.vehicle.VehicleClient.class.getName() + "\n"), "MANIFEST.MF");
            // Call the archive processor
            archiveProcessor.processClientArchive(jpa_ee_entityManagerFactory_stateless3_vehicle_client, Client.class, resURL);

        // Ejb 1
            // the jar with the correct archive name
            JavaArchive jpa_ee_entityManagerFactory_stateless3_vehicle_ejb = ShrinkWrap.create(JavaArchive.class, "jpa_ee_entityManagerFactory_stateless3_vehicle_ejb.jar");
            // The class files
            jpa_ee_entityManagerFactory_stateless3_vehicle_ejb.addClasses(
            ...
            if(ejbResURL1 != null) {
//              jpa_ee_entityManagerFactory_stateless3_vehicle_ejb.addAsManifestResource(ejbResURL1, "ejb-jar.xml");
            }
            ...
            if(ejbResURL1 != null) {
              jpa_ee_entityManagerFactory_stateless3_vehicle_ejb.addAsManifestResource(ejbResURL1, "sun-ejb-jar.xml");
            }
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_ee_entityManagerFactory_stateless3_vehicle_ejb, Client.class, ejbResURL1);
        ...
        // Par
            ...
            if(mappingURL != null) {
              jpa_ee_entityManagerFactory.addAsResource(mappingURL, "myMappingFile.xml");
            }
            mappingURL = Client.class.getResource("myMappingFile1.xml");
            if(mappingURL != null) {
              jpa_ee_entityManagerFactory.addAsResource(mappingURL, "myMappingFile1.xml");
            }
            mappingURL = Client.class.getResource("myMappingFile2.xml");
            if(mappingURL != null) {
              jpa_ee_entityManagerFactory.addAsResource(mappingURL, "myMappingFile2.xml");
            }
            // Call the archive processor
            archiveProcessor.processParArchive(jpa_ee_entityManagerFactory, Client.class, parURL);
            parURL = Client.class.getResource("orm.xml");
            if(parURL != null) {
              jpa_ee_entityManagerFactory.addAsManifestResource(parURL, "orm.xml");
            }

        // Ear
            EnterpriseArchive jpa_ee_entityManagerFactory_vehicles_ear = ShrinkWrap.create(EnterpriseArchive.class, "jpa_ee_entityManagerFactory_vehicles.ear");

            // Any libraries added to the ear

            // The component jars built by the package target
            jpa_ee_entityManagerFactory_vehicles_ear.addAsModule(jpa_ee_entityManagerFactory_stateless3_vehicle_ejb);
            jpa_ee_entityManagerFactory_vehicles_ear.addAsModule(jpa_ee_entityManagerFactory_stateless3_vehicle_client);

            jpa_ee_entityManagerFactory_vehicles_ear.addAsLibrary(jpa_ee_entityManagerFactory);
            ...
            // Call the archive processor
            archiveProcessor.processEarArchive(jpa_ee_entityManagerFactory_vehicles_ear, Client.class, earResURL);
        return jpa_ee_entityManagerFactory_vehicles_ear;
        }

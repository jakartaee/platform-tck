    ...
    static final String VEHICLE_ARCHIVE = "jpa_core_metamodelapi_metamodel_stateful3_vehicle";
        ...
        */
        ...
        // Client
            ...
            if(resURL != null) {
              jpa_core_metamodelapi_metamodel_stateful3_vehicle_client.addAsManifestResource(resURL, "sun-application-client.xml");
            }
            jpa_core_metamodelapi_metamodel_stateful3_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + com.sun.ts.tests.common.vehicle.VehicleClient.class.getName() + "\n"), "MANIFEST.MF");

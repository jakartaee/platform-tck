    ...
    static final String VEHICLE_ARCHIVE = "jpa_ee_pluggability_contracts_jta_stateful3_vehicle";
        ...
        */
        ...
        // Client
            ...
            jpa_ee_pluggability_contracts_jta_stateful3_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + com.sun.ts.tests.common.vehicle.VehicleClient.class.getName() + "\n"), "MANIFEST.MF");
        ...
        // Ejb
            ...
            ejbResURL = Client.class.getResource("/com/sun/ts/tests/common/vehicle/stateful3/stateful3_vehicle_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL != null) {

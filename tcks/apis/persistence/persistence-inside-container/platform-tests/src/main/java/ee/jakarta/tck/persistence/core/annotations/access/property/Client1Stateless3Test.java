      ...
      s.exit();
        ...
        */
        ...
        // Client
            ...
            if(resURL != null) {
              jpa_core_annotations_access_property_stateless3_vehicle_client.addAsManifestResource(resURL, "sun-application-client.xml");
            }
            jpa_core_annotations_access_property_stateless3_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + com.sun.ts.tests.common.vehicle.VehicleClient.class.getName() + "\n"), "MANIFEST.MF");
...
//              jpa_core_annotations_access_property_stateless3_vehicle_ejb.addAsManifestResource(ejbResURL1, "ejb-jar.xml");
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_annotations_access_property_stateless3_vehicle_ejb, Client1.class, ejbResURL1);

...
public class Client1Stateless3Test extends ee.jakarta.tck.persistence.core.query.language.Client1 {
      ...
      s.exit();
        ...
        */
        ...
        // Client
            ...
            archiveProcessor.processClientArchive(jpa_core_query_language_stateless3_vehicle_client, Client1.class, resURL);
...
//              jpa_core_query_language_stateless3_vehicle_ejb.addAsManifestResource(ejbResURL1, "ejb-jar.xml");
            ...
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_core_query_language_stateless3_vehicle_ejb, Client1.class, ejbResURL1);

      ...
      s.exit();
        ...
        */
        ...
        // Client
            ...
            jpa_core_annotations_discrinimatorValue_stateless3_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + com.sun.ts.tests.common.vehicle.VehicleClient.class.getName() + "\n"), "MANIFEST.MF");

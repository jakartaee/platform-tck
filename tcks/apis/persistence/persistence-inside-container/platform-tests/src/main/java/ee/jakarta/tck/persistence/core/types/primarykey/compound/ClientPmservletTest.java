    ...
    static final String VEHICLE_ARCHIVE = "jpa_core_types_pkey_compound_pmservlet_vehicle";
        ...
        */
        ...
        // War
            ...
            if(warResURL != null) {
              jpa_core_types_pkey_compound_pmservlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/lib/jpa_core_types_pkey_compound.jar");
            }
            warResURL = Client.class.getResource("/com/sun/ts/tests/common/vehicle/pmservlet/pmservlet_vehicle_web.xml");
            if(warResURL != null) {
              jpa_core_types_pkey_compound_pmservlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/pmservlet_vehicle_web.xml");
            }
        ...
        // Par
            ...
            jpa_core_types_pkey_compound_pmservlet_vehicle_web.addAsLibrary(jpa_core_types_pkey_compound);
            return jpa_core_types_pkey_compound_pmservlet_vehicle_web;
        }

...
public class ClientAppmanagedTest extends ee.jakarta.tck.persistence.ee.entityManagerFactory.Client {
    static final String VEHICLE_ARCHIVE = "jpa_ee_entityManagerFactory_appmanaged_vehicle";
        ...
        */
        ...
        // Client
            ...
            JavaArchive jpa_ee_entityManagerFactory_appmanaged_vehicle_client = ShrinkWrap.create(JavaArchive.class, "jpa_ee_entityManagerFactory_vehicles_client.jar");
            // The class files
            jpa_ee_entityManagerFactory_appmanaged_vehicle_client.addClasses(
            ...
            if(resURL != null) {
              jpa_ee_entityManagerFactory_appmanaged_vehicle_client.addAsManifestResource(resURL, "sun-application-client.xml");
            }
            jpa_ee_entityManagerFactory_appmanaged_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + com.sun.ts.tests.common.vehicle.VehicleClient.class.getName() + "\n"), "MANIFEST.MF");
            // Call the archive processor
            archiveProcessor.processClientArchive(jpa_ee_entityManagerFactory_appmanaged_vehicle_client, Client.class, resURL);

        // Ejb 1
            // the jar with the correct archive name
            JavaArchive jpa_ee_entityManagerFactory_appmanaged_vehicle_ejb = ShrinkWrap.create(JavaArchive.class, "jpa_ee_entityManagerFactory_appmanaged_vehicle_ejb.jar");
            // The class files
            jpa_ee_entityManagerFactory_appmanaged_vehicle_ejb.addClasses(
            ...
            if(ejbResURL1 != null) {
//              jpa_ee_entityManagerFactory_appmanaged_vehicle_ejb.addAsManifestResource(ejbResURL1, "ejb-jar.xml");
            }
            ...
            if(ejbResURL1 != null) {
              jpa_ee_entityManagerFactory_appmanaged_vehicle_ejb.addAsManifestResource(ejbResURL1, "sun-ejb-jar.xml");
            }
            // Call the archive processor
            archiveProcessor.processEjbArchive(jpa_ee_entityManagerFactory_appmanaged_vehicle_ejb, Client.class, ejbResURL1);
        ...
        // Ear
            ...
            jpa_ee_entityManagerFactory_vehicles_ear.addAsModule(jpa_ee_entityManagerFactory_appmanaged_vehicle_ejb);
            jpa_ee_entityManagerFactory_vehicles_ear.addAsModule(jpa_ee_entityManagerFactory_appmanaged_vehicle_client);

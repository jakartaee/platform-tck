...
public class ClientAppmanagedTest extends ee.jakarta.tck.persistence.jpa22.query.stream.Client {
    static final String VEHICLE_ARCHIVE = "jpa_jpa22_query_stream_appmanaged_vehicle";
        ...
        */
        ...
        // Client
            ...
            JavaArchive jpa_jpa22_query_stream_appmanaged_vehicle_client = ShrinkWrap.create(JavaArchive.class, "jpa_jpa22_query_stream_vehicles_client.jar");
            // The class files
            jpa_jpa22_query_stream_appmanaged_vehicle_client.addClasses(
            ...
            if(resURL != null) {
              jpa_jpa22_query_stream_appmanaged_vehicle_client.addAsManifestResource(resURL, "sun-application-client.xml");
            }
            jpa_jpa22_query_stream_appmanaged_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: " + com.sun.ts.tests.common.vehicle.VehicleClient.class.getName() + "\n"), "MANIFEST.MF");
        ...
        // Ejb 1
            ...
            // The class files
            jpa_jpa22_query_stream_appmanaged_vehicle_ejb.addClasses(
...
//              jpa_jpa22_query_stream_appmanaged_vehicle_ejb.addAsManifestResource(ejbResURL1, "ejb-jar.xml");
        ...
        // Ear
            ...
            jpa_jpa22_query_stream_vehicles_ear.addAsModule(jpa_jpa22_query_stream_appmanaged_vehicle_ejb);
            jpa_jpa22_query_stream_vehicles_ear.addAsModule(jpa_jpa22_query_stream_appmanaged_vehicle_client);

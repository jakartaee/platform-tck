...
public class PMDManagedConnectionFactory
    ...
    public void setResourceAdapter(ResourceAdapter ra) throws ResourceException {
        count++;
        String newStr1 = new String("PMDManagedConnectionFactory setResourceAdapter " + count);
        debug(newStr1);
    ...
    public ManagedConnection createManagedConnection(Subject subject, ConnectionRequestInfo info) throws ResourceException {
        ...
        try {
            ...
            ConnectorStatus.getConnectorStatus().logAPI("PMDManagedConnectionFactory.createManagedConnection", "subject|info",
                    "TSManagedConnection");
            TSConnection con = null;
            PasswordCredential pc = Util.getPasswordCredential(this, subject, info);
            if (pc == null) {
                debug("PMDManagedConnectionFactory.createManagedConnection():  pc == null");
    ...
    public ManagedConnection matchManagedConnections(Set connectionSet, Subject subject, ConnectionRequestInfo info)
        ...
        ConnectorStatus.getConnectorStatus().logAPI("PMDManagedConnectionFactory.matchManagedConnection", "connectionSet|subject|info",
                "TSEISDataSource");

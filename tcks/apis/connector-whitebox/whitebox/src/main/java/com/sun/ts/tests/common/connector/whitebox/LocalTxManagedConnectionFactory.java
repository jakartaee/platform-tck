...
public class LocalTxManagedConnectionFactory
    ...
    public Object createConnectionFactory(ConnectionManager cxManager) throws ResourceException {
        ConnectorStatus.getConnectorStatus().logAPI("LocalTxManagedConnectionFactory.createConnectionFactory", "cxManager",
                "TSEISDataSource");
    ...
    public Object createConnectionFactory() throws ResourceException {
        ConnectorStatus.getConnectorStatus().logAPI("LocalTxManagedConnectionFactory.createConnectionFactory", "", "TSEISDataSource");
    ...
    public void setResourceAdapter(ResourceAdapter ra) throws ResourceException {
        count++;
        String newStr1 = "LocalTxManagedConnectionFactory setResourceAdapter " + count;
    ...
    public ManagedConnection createManagedConnection(Subject subject, ConnectionRequestInfo info) throws ResourceException {
        ...
        try {
            ...
            ConnectorStatus.getConnectorStatus().logAPI("LocalTxManagedConnectionFactory.createManagedConnection", "subject|info",
                    "TSManagedConnection");
            TSConnection con = null;
            PasswordCredential pc = Util.getPasswordCredential(this, subject, info);
            if (pc == null) {
                System.out.println("LocalTxManagedConnectionFactory.createManagedConnection():  pc == null");
                ...
                System.out.println("LocalTxManagedConnectionFactory.createManagedConnection() with pc.getUserName()=" + pc.getUserName()
                        + " pc.getPassword()=" + new String(pc.getPassword()));
                con = new TSConnectionImpl().getConnection(pc.getUserName(), pc.getPassword());
            }
            TSManagedConnection tcon = new TSManagedConnection(this, pc, null, con, false, true);
    ...
    public ManagedConnection matchManagedConnections(Set connectionSet, Subject subject, ConnectionRequestInfo info)
        ...
        ConnectorStatus.getConnectorStatus().logAPI("LocalTxManagedConnectionFactory.matchManagedConnection", "connectionSet|subject|info",
                "TSEISDataSource");
        PasswordCredential pc = Util.getPasswordCredential(this, subject, info);
    ...
    public void setLogWriter(PrintWriter out) throws ResourceException {
        ConnectorStatus.getConnectorStatus().logAPI("LocalTxManagedConnectionFactory.setLogWriter", "out", "");
    }
    ...
    public PrintWriter getLogWriter() throws ResourceException {
        ConnectorStatus.getConnectorStatus().logAPI("LocalTxManagedConnectionFactory.getLogWriter", "", "");
        return null;
    }

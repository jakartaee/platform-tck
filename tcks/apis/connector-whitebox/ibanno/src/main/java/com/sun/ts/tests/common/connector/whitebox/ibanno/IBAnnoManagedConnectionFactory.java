...
public class IBAnnoManagedConnectionFactory
    ...
    public String getUserName() {
        debug("IBAnnoManagedConnectionFactory.getUserName() returning:  " + userName);
        return userName;
    }
    ...
    public String getPassword() {
        debug("IBAnnoManagedConnectionFactory.getPassword() returning:  " + password);
        return password;
    }
    ...
    public Object createConnectionFactory(ConnectionManager cxManager) throws ResourceException {
        ConnectorStatus.getConnectorStatus().logAPI("IBAnnoManagedConnectionFactory.createConnectionFactory", "cxManager",
                "TSEISDataSource");
    ...
    public void setResourceAdapter(ResourceAdapter ra) throws ResourceException {
        count++;
        String newStr1 = "IBAnnoManagedConnectionFactory setResourceAdapter " + count;
        debug(newStr1);
    ...
    public ManagedConnection createManagedConnection(Subject subject, ConnectionRequestInfo info) throws ResourceException {
        ...
        try {
            ...
            ConnectorStatus.getConnectorStatus().logAPI("IBAnnoManagedConnectionFactory.createManagedConnection", "subject|info",
                    "TSManagedConnection");
    ...
    public ManagedConnection matchManagedConnections(Set connectionSet, Subject subject, ConnectionRequestInfo info)
        ...
        ConnectorStatus.getConnectorStatus().logAPI("IBAnnoManagedConnectionFactory.matchManagedConnection", "connectionSet|subject|info",
                "TSEISDataSource");

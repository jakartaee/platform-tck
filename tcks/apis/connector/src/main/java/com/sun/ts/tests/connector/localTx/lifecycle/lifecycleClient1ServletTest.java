...
public class lifecycleClient1ServletTest extends com.sun.ts.tests.connector.localTx.lifecycle.lifecycleClient1 {
    static final String VEHICLE_ARCHIVE = "localTx_lifecycle_servlet_vehicle";
        ...
        /com/sun/ts/tests/connector/localTx/lifecycle/servlet_vehicle_web.xml
        ...
        */
        ...
        // War
            ...
            WebArchive localTx_lifecycle_servlet_vehicle_web = ShrinkWrap.create(WebArchive.class, "localTx_lifecycle_servlet_vehicle_web.war");
            // The class files
            localTx_lifecycle_servlet_vehicle_web.addClasses(
            ...
            URL warResURL = lifecycleClient1.class.getResource("localTx_lifecycle_servlet_vehicle_servlet.xml");
            if(warResURL != null) {
              localTx_lifecycle_servlet_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = lifecycleClient1.class.getResource("localTx_lifecycle_servlet_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
              localTx_lifecycle_servlet_vehicle_web.addAsWebInfResource(warResURL, "sun-web.xml");
            }

            // Any libraries added to the war

           // Call the archive processor
           archiveProcessor.processWebArchive(localTx_lifecycle_servlet_vehicle_web, lifecycleClient1.class, warResURL);

        // Ear
            EnterpriseArchive localTx_lifecycle_servlet_vehicle_ear = ShrinkWrap.create(EnterpriseArchive.class, "localTx_lifecycle_servlet_vehicle.ear");

            // Any libraries added to the ear

            // The component jars built by the package target
            localTx_lifecycle_servlet_vehicle_ear.addAsModule(localTx_lifecycle_servlet_vehicle_web);
            ...
            URL earResURL = null;
            // Call the archive processor
            archiveProcessor.processEarArchive(localTx_lifecycle_servlet_vehicle_ear, lifecycleClient1.class, earResURL);
        return localTx_lifecycle_servlet_vehicle_ear;
        }

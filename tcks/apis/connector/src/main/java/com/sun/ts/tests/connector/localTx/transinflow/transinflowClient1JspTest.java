...
public class transinflowClient1JspTest extends com.sun.ts.tests.connector.localTx.transinflow.transinflowClient1 {
    static final String VEHICLE_ARCHIVE = "localTx_transinflow_jsp_vehicle";
        ...
        /com/sun/ts/tests/connector/localTx/transinflow/jsp_vehicle_web.xml
        ...
        */
        ...
        // War
            ...
            WebArchive localTx_transinflow_jsp_vehicle_web = ShrinkWrap.create(WebArchive.class, "localTx_transinflow_jsp_vehicle_web.war");
            // The class files
            localTx_transinflow_jsp_vehicle_web.addClasses(
            ...
            URL warResURL = transinflowClient1.class.getResource("transinflow_jsp_vehicle_web.xml");
            if(warResURL != null) {
            ...
            // Web content
            warResURL = transinflowClient1.class.getResource("/com/sun/ts/tests/common/vehicle/jsp/contentRoot/client.html");
            if(warResURL != null) {
              localTx_transinflow_jsp_vehicle_web.addAsWebResource(warResURL, "/client.html");
            }
            warResURL = transinflowClient1.class.getResource("/com/sun/ts/tests/common/vehicle/jsp/contentRoot/jsp_vehicle.jsp");
            if(warResURL != null) {
              localTx_transinflow_jsp_vehicle_web.addAsWebResource(warResURL, "/jsp_vehicle.jsp");
            }

           // Call the archive processor
           archiveProcessor.processWebArchive(localTx_transinflow_jsp_vehicle_web, transinflowClient1.class, warResURL);

        // Ear
            EnterpriseArchive localTx_transinflow_jsp_vehicle_ear = ShrinkWrap.create(EnterpriseArchive.class, "localTx_transinflow_jsp_vehicle.ear");

            // Any libraries added to the ear

            // The component jars built by the package target
            localTx_transinflow_jsp_vehicle_ear.addAsModule(localTx_transinflow_jsp_vehicle_web);


            // The application.xml descriptor
            URL earResURL = null;
            // Call the archive processor
            archiveProcessor.processEarArchive(localTx_transinflow_jsp_vehicle_ear, transinflowClient1.class, earResURL);
        return localTx_transinflow_jsp_vehicle_ear;
        }

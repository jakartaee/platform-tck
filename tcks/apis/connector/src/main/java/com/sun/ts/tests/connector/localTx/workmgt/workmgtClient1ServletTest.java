...
public class workmgtClient1ServletTest extends com.sun.ts.tests.connector.localTx.workmgt.workmgtClient1 {
    static final String VEHICLE_ARCHIVE = "localTx_workmgt_servlet_vehicle";
        ...
        /com/sun/ts/tests/connector/localTx/workmgt/servlet_vehicle_web.xml
        ...
        */
        ...
        // War
            ...
            WebArchive localTx_workmgt_servlet_vehicle_web = ShrinkWrap.create(WebArchive.class, "localTx_workmgt_servlet_vehicle_web.war");
            // The class files
            localTx_workmgt_servlet_vehicle_web.addClasses(
            ...
            URL warResURL = workmgtClient1.class.getResource("localTx_workmgt_servlet_vehicle_servlet.xml");
            if(warResURL != null) {
              localTx_workmgt_servlet_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = workmgtClient1.class.getResource("localTx_workmgt_servlet_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
              localTx_workmgt_servlet_vehicle_web.addAsWebInfResource(warResURL, "sun-web.xml");
            }

            // Any libraries added to the war

           // Call the archive processor
           archiveProcessor.processWebArchive(localTx_workmgt_servlet_vehicle_web, workmgtClient1.class, warResURL);

        // Ear
            EnterpriseArchive localTx_workmgt_servlet_vehicle_ear = ShrinkWrap.create(EnterpriseArchive.class, "localTx_workmgt_servlet_vehicle.ear");

            // Any libraries added to the ear

            // The component jars built by the package target
            localTx_workmgt_servlet_vehicle_ear.addAsModule(localTx_workmgt_servlet_vehicle_web);
            ...
            URL earResURL = null;
            // Call the archive processor
            archiveProcessor.processEarArchive(localTx_workmgt_servlet_vehicle_ear, workmgtClient1.class, earResURL);
        return localTx_workmgt_servlet_vehicle_ear;
        }

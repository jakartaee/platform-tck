...
public class lifecycleClient1 extends ServiceEETest implements Serializable {
   ...
   *
   */
  public void testAssociationMCFandRA() throws Exception {
   ...
   *
   */
  public void testAssociationMCFandRA2() throws Exception {
   ...
   *
   */
  public void testBootstrapforNull() throws Exception {
    ...
    if (b1) {
      ...
      throw new Exception("ResourceAdapter not Instantiated");
    }
   ...
   *
   */
  public void testInstantiationOfRA() throws Exception {
   ...
   *
   */
  public void testRASharability() throws Exception {
    ...
    if (b1 && b2) {
      ...
      throw new Exception("Resource Adapter is Shared or reused.");
    }
   ...
   *
   */
  public void testMCFcalledOnce() throws Exception {
   ...
   *
   */
  public void testRAforJavaBean() throws Exception {

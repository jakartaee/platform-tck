...
public class lifecycleClient1EjbTest extends com.sun.ts.tests.connector.localTx.lifecycle.lifecycleClient1 {
    static final String VEHICLE_ARCHIVE = "localTx_lifecycle_ejb_vehicle";
        ...
        /com/sun/ts/tests/connector/localTx/lifecycle/localTx_lifecycle_ejb_vehicle_client.xml
        /com/sun/ts/tests/common/vehicle/ejb/ejb_vehicle_client.xml
        Ejb:

        /com/sun/ts/tests/connector/localTx/lifecycle/localTx_lifecycle_ejb_vehicle_ejb.xml
        /com/sun/ts/tests/connector/localTx/lifecycle/ejb_vehicle_ejb.xml
        ...
        */
        ...
        // Client
            ...
            if(resURL != null) {
              localTx_lifecycle_ejb_vehicle_client.addAsManifestResource(resURL, "application-client.xml");
            }
            // The sun-application-client.xml file need to be added or should this be in in the vendor Arquillian extension?
            resURL = lifecycleClient1.class.getResource("localTx_lifecycle_ejb_vehicle_client.jar.sun-application-client.xml");
            if(resURL != null) {
              localTx_lifecycle_ejb_vehicle_client.addAsManifestResource(resURL, "sun-application-client.xml");
            }
            localTx_lifecycle_ejb_vehicle_client.addAsManifestResource(new StringAsset("Main-Class: com.sun.ts.tests.common.vehicle.VehicleClient\n"), "MANIFEST.MF");
            // Call the archive processor
            archiveProcessor.processClientArchive(localTx_lifecycle_ejb_vehicle_client, lifecycleClient1.class, resURL);

        // Ejb 1
            // the jar with the correct archive name
            JavaArchive localTx_lifecycle_ejb_vehicle_ejb = ShrinkWrap.create(JavaArchive.class, "localTx_lifecycle_ejb_vehicle_ejb.jar");
            // The class files
            localTx_lifecycle_ejb_vehicle_ejb.addClasses(
                com.sun.ts.tests.common.vehicle.VehicleRunnable.class,
                com.sun.ts.tests.common.vehicle.VehicleRunnerFactory.class,
                com.sun.ts.tests.common.vehicle.ejb.EJBVehicleRemote.class,
                com.sun.ts.lib.harness.EETest.Fault.class,
            ...
            URL ejbResURL1 = lifecycleClient1.class.getResource("localTx_lifecycle_ejb_vehicle_ejb.xml");
            if(ejbResURL1 != null) {
              localTx_lifecycle_ejb_vehicle_ejb.addAsManifestResource(ejbResURL1, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL1 = lifecycleClient1.class.getResource("localTx_lifecycle_ejb_vehicle_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL1 != null) {
              localTx_lifecycle_ejb_vehicle_ejb.addAsManifestResource(ejbResURL1, "sun-ejb-jar.xml");
            }
            // Call the archive processor
            ...
            localTx_lifecycle_ejb_vehicle_ear.addAsModule(localTx_lifecycle_ejb_vehicle_ejb);
            localTx_lifecycle_ejb_vehicle_ear.addAsModule(localTx_lifecycle_ejb_vehicle_client);


            // The application.xml descriptor
            URL earResURL = null;
            // Call the archive processor
            archiveProcessor.processEarArchive(localTx_lifecycle_ejb_vehicle_ear, lifecycleClient1.class, earResURL);
        return localTx_lifecycle_ejb_vehicle_ear;
        }

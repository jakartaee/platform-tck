...
/*
 * @(#)workmgtClient1.java	1.5 03/05/16
 */
...
public class workmgtClient1 extends ServiceEETest implements Serializable {
   ...
   *
   */
  public void testWorkManagerImplementaion() throws Exception {
    ...
    String toCheck1 = "LocalTxResourceAdapter WorkManager Not Null";
    ...
    for (int i = 0; i < log.size(); i++) {
      ...
      if (str.startsWith(toCheck1)) {
        b1 = true;
        TestUtil.logMsg("LocalTxResourceAdapter WorkManager Not Null.");
      }

      if (str.startsWith(toCheck2)) {
        b2 = true;
        TestUtil.logMsg("Work Object Submitted.");
      }
    }
    ...
    if (b1 && b2) {
      ...
      if (!b1) {
        TestUtil.logMsg("Error - LocalTxResourceAdapter WorkManager == Null.");
      }
      if (!b2) {
        TestUtil.logMsg("Error - Work Object not Submitted.");
      }
      throw new Exception("WorkManager is null or corrupted");
    }
   ...
   *
   */
  public void testWorkListenerImplementation() throws Exception {
   ...
   *
   */
  public void testScheduleWorkListener() throws Exception {
   ...
   *
   */
  public void testWorkCompletedException() throws Exception {
    ...
    if (b1) {
      ...
      throw new Exception("WorkCompletedException not thrown");
    }
   ...
   *
   */
  public void testForUnsharedTimer() throws Exception {
    ...
    for (int i = 0; i < log.size(); i++) {
      ...
      if (str.startsWith(toCheck1)) {
        b1 = true;
        TestUtil.logMsg(toCheck1);
      }
      if (str.startsWith(toCheck2)) {
        b2 = true;
        TestUtil.logMsg(toCheck2);
      }
      if (str.startsWith(toCheck3)) {
        b3 = true;
        TestUtil.logMsg(toCheck3);
      }
      if (str.startsWith(toCheck4)) {
        b4 = true;
        TestUtil.logMsg(toCheck4);
      }
    }
    ...
    if (b1 || b2 || b3) {
      ...
      throw new Exception("createTimer is not implemented correctly");
    }
   ...
   *
   */
  public void testNestedWork() throws Exception {
   ...
   *
   */
  public void testUnknownWorkDuration() throws Exception {
    ...
    if (b1) {
      ...
      throw new Exception("WorkManager returned value less than -1");
    }

...
public class WorkContextClientServletTest extends com.sun.ts.tests.connector.localTx.workcontext.WorkContextClient {
    static final String VEHICLE_ARCHIVE = "workcontext_servlet_vehicle";
        ...
        /com/sun/ts/tests/connector/localTx/workcontext/servlet_vehicle_web.xml
        ...
        */
        ...
        // War
            ...
            WebArchive workcontext_servlet_vehicle_web = ShrinkWrap.create(WebArchive.class, "workcontext_servlet_vehicle_web.war");
            // The class files
            workcontext_servlet_vehicle_web.addClasses(
            ...
            URL warResURL = WorkContextClient.class.getResource("workcontext_servlet_vehicle_servlet.xml");
            if(warResURL != null) {
              workcontext_servlet_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = WorkContextClient.class.getResource("workcontext_servlet_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
              workcontext_servlet_vehicle_web.addAsWebInfResource(warResURL, "sun-web.xml");
            }

            // Any libraries added to the war

           // Call the archive processor
           archiveProcessor.processWebArchive(workcontext_servlet_vehicle_web, WorkContextClient.class, warResURL);



        // Ear
            EnterpriseArchive workcontext_servlet_vehicle_ear = ShrinkWrap.create(EnterpriseArchive.class, "workcontext_servlet_vehicle.ear");

            // Any libraries added to the ear

            // The component jars built by the package target
            workcontext_servlet_vehicle_ear.addAsModule(workcontext_servlet_vehicle_web);
            ...
            URL earResURL = null;
            // Call the archive processor
            archiveProcessor.processEarArchive(workcontext_servlet_vehicle_ear, WorkContextClient.class, earResURL);
        return workcontext_servlet_vehicle_ear;
        }

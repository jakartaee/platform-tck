...
public class paClient extends ServiceEETest implements Serializable {
   ...
   * 
   */
  public void testMixedModeConfigPropertyMCF() throws Exception {
    ...
    if (b1) {
      ...
      throw new Exception("Mixed mode config prop Failure.");
    }
  }
   ...
   * 
   */
  public void testNoDefaultVallAnnoElement() throws Exception {
   ...
   * 
   */
  public void testMixedModeConfigPropertyRA() throws Exception {
    ...
    if (b1) {
      ...
      throw new Exception("Mixed mode config prop used correctly.");
    }
  }
   ...
   * 
   */
  public void testMixedModeConfigPropertyOverride() throws Exception {
   ...
   * 
   */
  public void testMixedModeConfigPropertyNoOverride() throws Exception {
    ...
    if (b1) {
      ...
      throw new Exception("Mixed mode config prop from DD used correctly.");
    }
  }
   ...
   */
  public void testDDOverridesAnno() throws Exception {
    ...
    if (b1) {
      ...
      throw new Exception("Failure - DD did not override annotation.");
    }
  }

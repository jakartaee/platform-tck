...
public class workmgtClient1JspTest extends com.sun.ts.tests.connector.xa.workmgt.workmgtClient1 {
    static final String VEHICLE_ARCHIVE = "xa_workmgt_jsp_vehicle";
        ...
        /com/sun/ts/tests/connector/xa/workmgt/xa_workmgt_jsp_vehicle_web.xml
        /com/sun/ts/tests/connector/xa/workmgt/jsp_vehicle_web.xml
        ...
        */
        ...
        // War
            ...
            WebArchive xa_workmgt_jsp_vehicle_web = ShrinkWrap.create(WebArchive.class, "xa_workmgt_jsp_vehicle_web.war");
            // The class files
            xa_workmgt_jsp_vehicle_web.addClasses(
            ...
            URL warResURL = workmgtClient1.class.getResource("xa_workmgt_jsp_vehicle_web.xml");
            if(warResURL != null) {
              xa_workmgt_jsp_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = workmgtClient1.class.getResource("xa_workmgt_jsp_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
              xa_workmgt_jsp_vehicle_web.addAsWebInfResource(warResURL, "sun-web.xml");
            }
            ...
            if(warResURL != null) {
              xa_workmgt_jsp_vehicle_web.addAsWebResource(warResURL, "/client.html");
            }
            warResURL = workmgtClient1.class.getResource("/com/sun/ts/tests/common/vehicle/jsp/contentRoot/jsp_vehicle.jsp");
            if(warResURL != null) {
              xa_workmgt_jsp_vehicle_web.addAsWebResource(warResURL, "/jsp_vehicle.jsp");
            }

           // Call the archive processor
           archiveProcessor.processWebArchive(xa_workmgt_jsp_vehicle_web, workmgtClient1.class, warResURL);

        // Ear
            EnterpriseArchive xa_workmgt_jsp_vehicle_ear = ShrinkWrap.create(EnterpriseArchive.class, "xa_workmgt_jsp_vehicle.ear");

            // Any libraries added to the ear

            // The component jars built by the package target
            xa_workmgt_jsp_vehicle_ear.addAsModule(xa_workmgt_jsp_vehicle_web);


            // The application.xml descriptor
            URL earResURL = null;
            // Call the archive processor
            archiveProcessor.processEarArchive(xa_workmgt_jsp_vehicle_ear, workmgtClient1.class, earResURL);
        return xa_workmgt_jsp_vehicle_ear;
        }

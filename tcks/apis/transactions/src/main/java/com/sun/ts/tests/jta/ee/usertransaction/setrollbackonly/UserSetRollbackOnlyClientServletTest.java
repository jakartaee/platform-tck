...
public class UserSetRollbackOnlyClientServletTest
        extends com.sun.ts.tests.jta.ee.usertransaction.setrollbackonly.UserSetRollbackOnlyClient {
    ...
    public static WebArchive createDeploymentVehicle(@ArquillianResource TestArchiveProcessor archiveProcessor) {
        ...
        setrollbackonly_servlet_vehicle_web.addClasses(com.sun.ts.tests.common.vehicle.VehicleRunnerFactory.class,
        ...
        warResURL = UserSetRollbackOnlyClientServletTest.class.getClassLoader()
                .getResource(packagePath + "/setrollbackonly_servlet_vehicle_web.war.sun-web.xml");
        if (warResURL != null) {
        ...
        // Ear
        // EnterpriseArchive setrollbackonly_servlet_vehicle_ear = ShrinkWrap.create(EnterpriseArchive.class,
        // "setrollbackonly_servlet_vehicle.ear");

...
public class UserSetTransactionTimeoutClientEjbTest
    ...
    public static EnterpriseArchive createDeploymentVehicle(@ArquillianResource TestArchiveProcessor archiveProcessor) {
        JavaArchive settransactiontimeout_ejb_vehicle_client = ShrinkWrap.create(JavaArchive.class,
                "settransactiontimeout_ejb_vehicle_client.jar");
        settransactiontimeout_ejb_vehicle_client.addClasses(com.sun.ts.tests.common.vehicle.VehicleRunnable.class,
                ...
                com.sun.ts.tests.jta.ee.common.InitFailedException.class, UserSetTransactionTimeoutClient.class,
        ...
        resURL = UserSetTransactionTimeoutClientEjbTest.class.getClassLoader()
                .getResource(packagePath + "/settransactiontimeout_ejb_vehicle_client.jar.sun-application-client.xml");
        if (resURL != null) {
        ...
        JavaArchive settransactiontimeout_ejb_vehicle_ejb = ShrinkWrap.create(JavaArchive.class,
                "settransactiontimeout_ejb_vehicle_ejb.jar");
        settransactiontimeout_ejb_vehicle_ejb.addClasses(com.sun.ts.tests.common.vehicle.VehicleRunnerFactory.class,
                ...
                ServiceEETest.class, SetupException.class,
                com.sun.ts.tests.common.vehicle.VehicleClient.class, UserSetTransactionTimeoutClientEjbTest.class);
        ...
        ejbResURL = UserSetTransactionTimeoutClientEjbTest.class.getClassLoader()
                .getResource(packagePath + "/settransactiontimeout_ejb_vehicle_ejb.jar.sun-ejb-jar.xml");
        if (ejbResURL != null) {
        ...
        EnterpriseArchive settransactiontimeout_ejb_vehicle_ear = ShrinkWrap.create(EnterpriseArchive.class,
                "settransactiontimeout_ejb_vehicle.ear");

...
public class UserRollbackClientServletTest extends com.sun.ts.tests.jta.ee.usertransaction.rollback.UserRollbackClient {
    ...
    public static WebArchive createDeploymentVehicle(@ArquillianResource TestArchiveProcessor archiveProcessor) {
        ...
        rollback_servlet_vehicle_web.addClasses(com.sun.ts.tests.common.vehicle.VehicleRunnerFactory.class,
        ...
        warResURL = UserRollbackClientServletTest.class.getClassLoader()
                .getResource(packagePath + "/rollback_servlet_vehicle_web.war.sun-web.xml");
        if (warResURL != null) {
        ...
        // EnterpriseArchive rollback_servlet_vehicle_ear = ShrinkWrap.create(EnterpriseArchive.class,
        // "rollback_servlet_vehicle.ear");

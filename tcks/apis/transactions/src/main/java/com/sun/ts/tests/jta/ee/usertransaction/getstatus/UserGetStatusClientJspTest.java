...
public class UserGetStatusClientJspTest extends com.sun.ts.tests.jta.ee.usertransaction.getstatus.UserGetStatusClient {
    ...
    public static WebArchive createDeploymentVehicle(@ArquillianResource TestArchiveProcessor archiveProcessor) {
        ...
        getstatus_jsp_vehicle_web.addClasses(com.sun.ts.tests.jta.ee.usertransaction.getstatus.UserGetStatusClient.class,
                com.sun.ts.tests.common.vehicle.VehicleRunnerFactory.class, com.sun.ts.lib.harness.EETest.Fault.class,
        ...
        warResURL = UserGetStatusClientJspTest.class.getClassLoader()
                .getResource(packagePath + "/getstatus_jsp_vehicle_web.war.sun-web.xml");
        if (warResURL != null) {
        ...
        // EnterpriseArchive getstatus_jsp_vehicle_ear = ShrinkWrap.create(EnterpriseArchive.class,
        // "getstatus_jsp_vehicle.ear");

...
public final class Helper {
  ...
  public static String compareResultList(final List expected,
      final List actual) {
    String reason;
    if (expected.equals(actual)) {
      ...
      reason = TestUtil.NEW_LINE + "Expecting result list: " + expected
          + TestUtil.NEW_LINE + "         , but actual: " + actual;
      throw new RuntimeException(reason);
    }
    return reason;
  }

  public static String compareResult(final String expected,
      final String actual) {
    String reason;
    if (expected.equals(actual)) {
      ...
      reason = TestUtil.NEW_LINE + "Expecting result : " + expected
          + TestUtil.NEW_LINE + "         , but actual: " + actual;
      throw new RuntimeException(reason);
    }
    return reason;
  ...
  public static String compareResultList(final String[] expected,
      final List actual) {
   ...
   */
  public static String assertEquals(final String messagePrefix,
  ...
  public static String assertNotEquals(final String messagePrefix,
      final Object expected, final Object actual) throws RuntimeException {
    final StringBuilder sb = new StringBuilder();
  ...
  public static void assertCloseEnough(final String messagePrefix,
      long expected, long actual, long ignoreableDiff, StringBuilder sb) {
    sb.append(TestUtil.NEW_LINE);
    if (messagePrefix != null) {
      sb.append(messagePrefix).append(" ");
    }
    ...
    if (dif <= ignoreableDiff) {
      ...
      sb.append("the diff between expected " + expected + ", and actual "
          + actual + " is " + dif + ", equals or less than the ignoreableDiff "
          + ignoreableDiff);
    } else {
      throw new RuntimeException("the diff between expected " + expected
          + ", and actual " + actual + " is " + dif
          + ", greater than the ignoreableDiff " + ignoreableDiff);
    }
  }

  public static String assertGreaterThan(final String messagePrefix, long arg1,
  ...
  public static void assertGreaterThan(final String messagePrefix, long arg1,
      long arg2, final StringBuilder sb) throws RuntimeException {
    sb.append(TestUtil.NEW_LINE);
    if (messagePrefix != null) {
      sb.append(messagePrefix).append(" ");
    }
    if (arg1 > arg2) {
      sb.append("Got the expected result:").append(arg1).append(">")
          .append(arg2).append("\t");
    } else {
      sb.append("Expecting ").append(arg1).append(">").append(arg2)
          .append(", but failed");
      throw new RuntimeException(sb.toString());
    }
  }

...
public final class Helper {
    ...
    public static String compareResultList(final List expected, final List actual) {
        ...
        if (expected.equals(actual)) {
            ...
            reason = TestUtil.NEW_LINE + "Expecting result list: " + expected + TestUtil.NEW_LINE + "         , but actual: " + actual;
    ...
    public static String compareResult(final String expected, final String actual) {
        ...
        if (expected.equals(actual)) {
            ...
            reason = TestUtil.NEW_LINE + "Expecting result : " + expected + TestUtil.NEW_LINE + "         , but actual: " + actual;
            throw new RuntimeException(reason);
        }
        return reason;
    }

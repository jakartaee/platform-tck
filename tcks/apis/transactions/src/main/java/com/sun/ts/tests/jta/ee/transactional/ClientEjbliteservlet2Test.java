...
public class ClientEjbliteservlet2Test extends com.sun.ts.tests.jta.ee.transactional.Client {
    ...
    public static WebArchive createDeploymentVehicle() {
        ...
        WebArchive transactional_ejbliteservlet2_vehicle_web = ShrinkWrap.create(WebArchive.class,
                "transactional_ejbliteservlet2_vehicle_web.war");
        transactional_ejbliteservlet2_vehicle_web.addClasses(com.sun.ts.tests.common.vehicle.VehicleRunnerFactory.class,

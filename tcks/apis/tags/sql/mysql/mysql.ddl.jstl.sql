...
create table jstl_tab1(idNum INT NOT NULL, firstName VARCHAR(20) NOT NULL, lastName VARCHAR(20) NOT NULL, primary key(idNum)) ENGINE=InnoDB DEFAULT CHARSET=latin1 !

drop table jstl_tab2 !
create table jstl_tab2(idNum INT NOT NULL, dob DATE NOT NULL, firstName VARCHAR(20) NOT NULL, lastName VARCHAR(20) NOT NULL, rank INT NOT NULL, rating NUMERIC(10,2) NULL)  ENGINE=InnoDB DEFAULT CHARSET=latin1 !

drop table jstl_tab3 !
create table jstl_tab3(idNum INTEGER NOT NULL, aDate DATE NULL, aTime TIME NULL, aTimestamp TIMESTAMP NULL)  ENGINE=InnoDB DEFAULT CHARSET=latin1 !

    ...
    static final String VEHICLE_ARCHIVE = "jmsproducertopictests_jsp_vehicle";
        ...
        */
        ...
        // War
            ...
            URL warResURL = Client.class.getResource("/com/sun/ts/tests/jms/core20/jmsproducertopictests/jsp_vehicle_web.xml");
            if(warResURL != null) {
              jmsproducertopictests_jsp_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = Client.class.getResource("/com/sun/ts/tests/jms/core20/jmsproducertopictests/jmsproducertopictests_jsp_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {

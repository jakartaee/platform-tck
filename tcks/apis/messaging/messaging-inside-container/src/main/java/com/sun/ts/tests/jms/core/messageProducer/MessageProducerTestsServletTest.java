    ...
    static final String VEHICLE_ARCHIVE = "messageProducer_servlet_vehicle";
        ...
        */
        ...
        // War
            ...
            URL warResURL = MessageProducerTests.class.getResource("/com/sun/ts/tests/jms/core/messageProducer/servlet_vehicle_web.xml");
            if(warResURL != null) {
              messageProducer_servlet_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = MessageProducerTests.class.getResource("/com/sun/ts/tests/jms/core/messageProducer/messageProducer_servlet_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {

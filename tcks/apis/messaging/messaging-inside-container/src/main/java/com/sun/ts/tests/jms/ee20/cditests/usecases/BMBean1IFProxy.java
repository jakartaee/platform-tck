...
public class BMBean1IFProxy implements InvocationHandler {

    private Properties testProps;

    public static BMBean1IF newInstance(Properties testProps) {
        return (BMBean1IF) Proxy.newProxyInstance(
            BMBean1IF.class.getClassLoader(),
                new Class[] { BMBean1IF.class },
                new BMBean1IFProxy(testProps));
    }

    private  BMBean1IFProxy(Properties testProps) {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        if(methodName.equals("init")) {
            //sendPost();
            ok = true;
        } else if(methodName.startsWith("cleanupQueue")) {

...
import com.sun.ts.tests.jms.core.selectorTopic.MsgSelectorTopicTests;
import java.net.URL;
...
public class MsgSelectorTopicTestsJspTest extends com.sun.ts.tests.jms.core.selectorTopic.MsgSelectorTopicTests {
    static final String VEHICLE_ARCHIVE = "selectorTopic_jsp_vehicle";
        ...
        /com/sun/ts/tests/jms/core/selectorTopic/jsp_vehicle_web.xml
        ...
        */
        ...
        // War
            ...
            WebArchive selectorTopic_jsp_vehicle_web = ShrinkWrap.create(WebArchive.class, "selectorTopic_jsp_vehicle_web.war");
            // The class files
            selectorTopic_jsp_vehicle_web.addClasses(
            ...
            warResURL = MsgSelectorTopicTests.class.getResource("/com/sun/ts/tests/common/vehicle/jsp/contentRoot/jsp_vehicle.jsp");
            if(warResURL != null) {
              selectorTopic_jsp_vehicle_web.addAsWebResource(warResURL, "/jsp_vehicle.jsp");
            }

           // Call the archive processor
           archiveProcessor.processWebArchive(selectorTopic_jsp_vehicle_web, MsgSelectorTopicTests.class, warResURL);

        // Ear
            EnterpriseArchive selectorTopic_jsp_vehicle_ear = ShrinkWrap.create(EnterpriseArchive.class, "selectorTopic_jsp_vehicle.ear");

            // Any libraries added to the ear

            // The component jars built by the package target
            selectorTopic_jsp_vehicle_ear.addAsModule(selectorTopic_jsp_vehicle_web);

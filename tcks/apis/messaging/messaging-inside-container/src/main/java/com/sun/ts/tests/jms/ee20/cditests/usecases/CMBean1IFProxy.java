...
public class CMBean1IFProxy implements InvocationHandler {

    private Properties testProps;

    public static CMBean1IF newInstance(Properties testProps) {
        return (CMBean1IF) Proxy.newProxyInstance(
            CMBean1IF.class.getClassLoader(),
                new Class[] { CMBean1IF.class },
                new CMBean1IFProxy(testProps));
    }

    private  CMBean1IFProxy(Properties testProps) {

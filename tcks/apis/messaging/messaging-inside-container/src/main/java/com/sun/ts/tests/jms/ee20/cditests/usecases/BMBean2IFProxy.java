...
public class BMBean2IFProxy implements InvocationHandler {

    private Properties testProps;

    public static BMBean2IF newInstance(Properties testProps) {
        return (BMBean2IF) Proxy.newProxyInstance(
            BMBean2IF.class.getClassLoader(),
                new Class[] { BMBean2IF.class },
                new BMBean2IFProxy(testProps));
    }

    private  BMBean2IFProxy(Properties testProps) {

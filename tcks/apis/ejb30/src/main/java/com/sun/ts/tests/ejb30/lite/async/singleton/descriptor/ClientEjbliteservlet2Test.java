...
import com.sun.ts.tests.ejb30.lite.async.singleton.descriptor.Client;
import java.net.URL;
...
public class ClientEjbliteservlet2Test extends com.sun.ts.tests.ejb30.lite.async.singleton.descriptor.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_async_singleton_descriptor_ejbliteservlet2_vehicle";
        ...
        */
        ...
        // War
           ...
           archiveProcessor.processWebArchive(ejblite_async_singleton_descriptor_ejbliteservlet2_vehicle_web, Client.class, warResURL);

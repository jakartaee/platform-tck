...
import com.sun.ts.tests.ejb30.lite.view.stateful.annotated.JsfClient;
import java.net.URL;
...
public class JsfClientEjblitejsfTest extends com.sun.ts.tests.ejb30.lite.view.stateful.annotated.JsfClient {
    static final String VEHICLE_ARCHIVE = "ejblite_view_stateful_annotated_ejblitejsf_vehicle";

        /**
        EE10 Deployment Descriptors:
        ejblite_view_stateful_annotated_ejblitejsf_vehicle_web: WEB-INF/beans.xml,WEB-INF/faces-config.xml,WEB-INF/web.xml
        ejblite_view_stateful_annotated_ejblitejsp_vehicle_web: 
        ejblite_view_stateful_annotated_ejbliteservlet_vehicle_web: WEB-INF/web.xml
        ejblite_view_stateful_annotated_ejbliteservlet2_vehicle_web: WEB-INF/web.xml
        ...
        */
        ...
        // War
            ...
            WebArchive ejblite_view_stateful_annotated_ejblitejsf_vehicle_web = ShrinkWrap.create(WebArchive.class, "ejblite_view_stateful_annotated_ejblitejsf_vehicle_web.war");
            // The class files
            ejblite_view_stateful_annotated_ejblitejsf_vehicle_web.addClasses(
            ...
            com.sun.ts.tests.ejb30.lite.view.stateful.annotated.SubclassExtendsPOJOBean.class,
            ...
            com.sun.ts.tests.ejb30.lite.view.stateful.annotated.BusinessBean.class,
            ...
            com.sun.ts.tests.ejb30.lite.view.stateful.annotated.JsfClient.class,
            com.sun.ts.tests.ejb30.common.busiface.BusinessLocalIF1.class,
            com.sun.ts.tests.ejb30.lite.view.stateful.annotated.AnnotatedInterfaceBean.class,
            com.sun.ts.tests.ejb30.common.busiface.Constants.class,
            com.sun.ts.tests.ejb30.common.lite.NumberEnum.class,
            com.sun.ts.tests.ejb30.lite.view.stateful.annotated.LocalAndNoInterfaceBean.class,
            ...
            if(warResURL != null) {
              ejblite_view_stateful_annotated_ejblitejsf_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            ...
            if(warResURL != null) {
              ejblite_view_stateful_annotated_ejblitejsf_vehicle_web.addAsWebInfResource(warResURL, "sun-web.xml");
            }

            // Any libraries added to the war

            // Web content
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/lite/view/stateful/annotated/beans.xml");
            if(warResURL != null) {
              ejblite_view_stateful_annotated_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/beans.xml");
            }
            ...
            if(warResURL != null) {
              ejblite_view_stateful_annotated_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/ejblitejsf_vehicle_web.xml");
            }
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/lite/view/stateful/annotated/faces-config.xml");
            if(warResURL != null) {
              ejblite_view_stateful_annotated_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/faces-config.xml");
            }
            ...
            if(warResURL != null) {
              ejblite_view_stateful_annotated_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/ejblitejsf_vehicle.xhtml");
            }

           // Call the archive processor
           archiveProcessor.processWebArchive(ejblite_view_stateful_annotated_ejblitejsf_vehicle_web, JsfClient.class, warResURL);

        return ejblite_view_stateful_annotated_ejblitejsf_vehicle_web;
        }

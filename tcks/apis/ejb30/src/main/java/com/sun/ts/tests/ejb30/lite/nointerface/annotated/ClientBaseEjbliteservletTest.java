...
public class ClientBaseEjbliteservletTest extends com.sun.ts.tests.ejb30.lite.nointerface.annotated.ClientBase {
    static final String VEHICLE_ARCHIVE = "ejblite_nointerface_annotated_ejbliteservlet_vehicle";
        ...
        */
        ...
        // War
            ...
            URL warResURL = ClientBase.class.getResource("ejbliteservlet_vehicle_web.xml");
            if(warResURL != null) {
              ejblite_nointerface_annotated_ejbliteservlet_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = ClientBase.class.getResource("/ejbliteservlet_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
            ...
            // Web content
            warResURL = ClientBase.class.getResource("/com/sun/ts/tests/common/vehicle/ejbliteservlet/ejbliteservlet_vehicle_web.xml");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_nointerface_annotated_ejbliteservlet_vehicle_web, ClientBase.class, warResURL);

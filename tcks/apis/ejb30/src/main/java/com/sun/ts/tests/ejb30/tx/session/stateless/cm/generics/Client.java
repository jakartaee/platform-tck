...
public class Client extends AbstractUrlClient {
   ...
   */
  public void genericsTxMandatoryRemote() throws Exception {
   ...
   * @test_Strategy: httpclient -> servlet -> RemoteGreetingBean
   */
  public void genericsTxMandatoryLocal() throws Exception {
   ...
   */
  public void genericLocalBusinessInterfaceTxMandatory() throws Exception {
   ...
   */
  public void parameterizedParamLocalTxMandatory() throws Exception {
   ...
   * transaction attribute (Mandatory).
   */
  public void parameterizedReturnLocalTxMandatory() throws Exception {
   ...
   * transaction attribute (Mandatory).
   */
  public void parameterizedParamRemoteTxMandatory() throws Exception {
   ...
   * transaction attribute (Mandatory).
   */
  public void parameterizedReturnRemoteTxMandatory() throws Exception {
   ...
   */
  public void rolesAllowedLocalDateGreeting() throws Exception {
   ...
   * return types are processed properly.
   */
  public void rolesAllowedRemoteIntGreet() throws Exception {
   ...
   * return types are processed properly.
   */
  public void rolesAllowedLocalIntGreet() throws Exception {
   ...
   */
  public void rolesAllowedNoArgLocalDateGreeting() throws Exception {
   ...
   * are processed properly.
   */
  public void rolesAllowedNoArgRemoteIntGreet() throws Exception {
   ...
   * are processed properly.
   */
  public void rolesAllowedNoArgLocalIntGreet() throws Exception {

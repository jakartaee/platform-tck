...
import com.sun.ts.tests.ejb30.lite.basic.singleton.Client;
import java.net.URL;
...
public class ClientEjblitejspTest extends com.sun.ts.tests.ejb30.lite.basic.singleton.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_basic_singleton_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/basic/singleton/ejblitejsp.tld");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_basic_singleton_ejblitejsp_vehicle_web, Client.class, warResURL);

...
import com.sun.ts.tests.ejb30.lite.packaging.war.mbean.interceptor.lifecycleejbcdi.Client;
import java.net.URL;
...
public class ClientEjblitejspTest extends com.sun.ts.tests.ejb30.lite.packaging.war.mbean.interceptor.lifecycleejbcdi.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_packaging_war_mbean_interceptor_lifecycleejbcdi_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/packaging/war/mbean/interceptor/lifecycleejbcdi/ejblitejsp.tld");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_packaging_war_mbean_interceptor_lifecycleejbcdi_ejblitejsp_vehicle_web, Client.class, warResURL);

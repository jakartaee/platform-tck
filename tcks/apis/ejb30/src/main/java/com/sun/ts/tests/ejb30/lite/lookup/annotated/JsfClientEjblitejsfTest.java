...
public class JsfClientEjblitejsfTest extends com.sun.ts.tests.ejb30.lite.lookup.annotated.JsfClient {
    static final String VEHICLE_ARCHIVE = "ejblite_lookup_annotated_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/lite/lookup/annotated/beans.xml");
            if(warResURL != null) {
            ...
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/lite/lookup/annotated/faces-config.xml");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_lookup_annotated_ejblitejsf_vehicle_web, JsfClient.class, warResURL);

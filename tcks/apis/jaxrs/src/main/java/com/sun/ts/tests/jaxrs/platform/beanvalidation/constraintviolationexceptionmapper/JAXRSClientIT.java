...
public class JAXRSClientIT extends JaxrsCommonClient {
  ...
  public static WebArchive createDeployment() throws IOException {
    ...
    InputStream inStream = JAXRSClientIT.class.getClassLoader().getResourceAsStream("com/sun/ts/tests/jaxrs/platform/beanvalidation/constraintviolationexceptionmapper/web.xml.template");
    // Replace the servlet_adaptor in web.xml.template with the System variable set as servlet adaptor
    String webXml = editWebXmlString(inStream);
    inStream = JAXRSClientIT.class.getClassLoader().getResourceAsStream("com/sun/ts/tests/jaxrs/platform/beanvalidation/constraintviolationexceptionmapper/beans.xml");
    String beansXml = toString(inStream);

    WebArchive archive = ShrinkWrap.create(WebArchive.class, "jaxrs_platform_beanvalidation_constraintviolationexceptionmapper_web.war");
    archive.addClasses(
      TSAppConfig.class, 
      Resource.class, 

...
abstract public class ClientBase extends EETest implements Constants {
  ...
  protected EjbLinkIF lookupBean1() throws Exception {
    Object obj = null;
    try {
      obj = ServiceLocator.lookup(BEAN1_REF_NAME);
    } catch (NamingException e) {
      throw new Exception("Failed to lookup " + BEAN1_REF_NAME, e);
    }
    return (EjbLinkIF) obj;
  }

  protected EjbLinkIF lookupBean2() throws Exception {
    Object obj = null;
    try {
      obj = ServiceLocator.lookup(BEAN2_REF_NAME);
    } catch (NamingException e) {
      throw new Exception("Failed to lookup " + BEAN2_REF_NAME, e);
    }
    return (EjbLinkIF) obj;
  }
   ...
   *
   */
  public void callBean1() throws Exception {
    try {
      getBean1().call();
   ...
   *
   */
  public void callBean2() throws Exception {
    try {
      getBean2().call();
    } catch (TestFailedException e) {
      throw new Exception("Test failed", e);
   ...
   *
   */
  public void callBean1Bean2() throws Exception {
    try {
      getBean1().callTwo();
    } catch (TestFailedException e) {
      throw new Exception("Test failed", e);
   ...
   *
   */
  public void callBean2Bean1() throws Exception {
    try {
      getBean2().callOne();
    } catch (TestFailedException e) {
      throw new Exception("Test failed", e);
   ...
   *
   */
  public void callBean2Bean3() throws Exception {
    try {
      getBean2().callThree();
    } catch (TestFailedException e) {
      throw new Exception("Test failed", e);
   ...
   *
   */
  public void callBean2Bean1Local() throws Exception {
    try {
   ...
   *
   */
  public void callInjectedBean1() throws Exception {
    try {
      injectedBean1.call();
    } catch (TestFailedException e) {
      throw new Exception(e);

...
public class JsfClientEjblitejsfTest extends com.sun.ts.tests.ejb30.lite.tx.cm.singleton.annotated.JsfClient {
    static final String VEHICLE_ARCHIVE = "ejblite_tx_cm_singleton_annotated_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/lite/tx/cm/singleton/annotated/beans.xml");
            if(warResURL != null) {
            ...
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/lite/tx/cm/singleton/annotated/faces-config.xml");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_tx_cm_singleton_annotated_ejblitejsf_vehicle_web, JsfClient.class, warResURL);

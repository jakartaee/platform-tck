...
public class ClientEjbliteservletTest extends com.sun.ts.tests.ejb30.lite.tx.cm.singleton.rw.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_tx_cm_singleton_rw_ejbliteservlet_vehicle";
        ...
        */
        ...
        // War
            ...
            WebArchive ejblite_tx_cm_singleton_rw_ejbliteservlet_vehicle_web = ShrinkWrap.create(WebArchive.class, "ejblite_tx_cm_singleton_rw_ejbliteservlet_vehicle_web.war");
            // The class files
            ejblite_tx_cm_singleton_rw_ejbliteservlet_vehicle_web.addClasses(
            ...
            com.sun.ts.tests.ejb30.lite.tx.cm.singleton.rw.EJBLiteServletVehicle.class,
            ...
            if(warResURL != null) {
              ejblite_tx_cm_singleton_rw_ejbliteservlet_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = Client.class.getResource("/ejbliteservlet_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
              ejblite_tx_cm_singleton_rw_ejbliteservlet_vehicle_web.addAsWebInfResource(warResURL, "sun-web.xml");
            }
            ...
            if(warResURL != null) {
              ejblite_tx_cm_singleton_rw_ejbliteservlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/ejbliteservlet_vehicle_web.xml");
            }
            // ejblite-pu persistence unit
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/tx/cm/common/persistence.xml");
            ejblite_tx_cm_singleton_rw_ejbliteservlet_vehicle_web.addAsWebInfResource(warResURL, "classes/META-INF/persistence.xml");

           // Call the archive processor
           archiveProcessor.processWebArchive(ejblite_tx_cm_singleton_rw_ejbliteservlet_vehicle_web, Client.class, warResURL);

        return ejblite_tx_cm_singleton_rw_ejbliteservlet_vehicle_web;
        }

...
import com.sun.ts.tests.ejb30.bb.session.stateful.ejblink.one.Client;
import java.net.URL;
...
public class ClientTest extends com.sun.ts.tests.ejb30.bb.session.stateful.ejblink.one.Client {
    /**
        EE10 Deployment Descriptors:
        ejb3_stateful_ejblink_one: 
        ejb3_stateful_ejblink_one_client: META-INF/application-client.xml,jar.sun-application-client.xml

        Found Descriptors:
        Client:

        /com/sun/ts/tests/ejb30/bb/session/stateful/ejblink/one/ejb3_stateful_ejblink_one_client.xml
        /com/sun/ts/tests/ejb30/bb/session/stateful/ejblink/one/ejb3_stateful_ejblink_one_client.jar.sun-application-client.xml
        Ejb:

        /com/sun/ts/tests/ejb30/bb/session/stateful/ejblink/one/one_ejb.xml
        /com/sun/ts/tests/ejb30/bb/session/stateful/ejblink/one/one_ejb.jar.sun-ejb-jar.xml
        Ear:

        */
        @TargetsContainer("tck-appclient")
        @OverProtocol("appclient")
        @Deployment(name = "ejb3_stateful_ejblink_one", order = 2)
        public static EnterpriseArchive createDeployment(@ArquillianResource TestArchiveProcessor archiveProcessor) {
        // Client
            // the jar with the correct archive name
            JavaArchive ejb3_stateful_ejblink_one_client = ShrinkWrap.create(JavaArchive.class, "ejb3_stateful_ejblink_one_client.jar");
            // The class files
            ejb3_stateful_ejblink_one_client.addClasses(
            ...
            archiveProcessor.processClientArchive(ejb3_stateful_ejblink_one_client, Client.class, resURL);
        ...
        // Ejb
            ...
            URL ejbResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/bb/session/stateful/ejblink/one/one_ejb.xml");
            if(ejbResURL != null) {
              one_ejb.addAsManifestResource(ejbResURL, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/bb/session/stateful/ejblink/one/one_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL != null) {
        ...
        // Ear
            ...
            ejb3_stateful_ejblink_one_ear.addAsModule(two_ejb);
            ejb3_stateful_ejblink_one_ear.addAsModule(one_ejb);
            ejb3_stateful_ejblink_one_ear.addAsModule(ejb3_stateful_ejblink_one_client);



            // The application.xml descriptor
            URL earResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/bb/session/stateful/ejblink/one/application.xml");
            if(earResURL != null) {
              ejb3_stateful_ejblink_one_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/bb/session/stateful/ejblink/one/application.ear.sun-application.xml");
            if(earResURL != null) {
              ejb3_stateful_ejblink_one_ear.addAsManifestResource(earResURL, "sun-application.xml");
            }
            // Call the archive processor
            archiveProcessor.processEarArchive(ejb3_stateful_ejblink_one_ear, Client.class, earResURL);
        return ejb3_stateful_ejblink_one_ear;
        }

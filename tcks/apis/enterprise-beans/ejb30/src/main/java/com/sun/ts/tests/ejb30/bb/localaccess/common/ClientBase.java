...
public abstract class ClientBase extends EETest implements Constants {
   ...
   */
  public void passByValueTest() throws Exception {
   ...
   * @test_Strategy:
   */
  public void passByReferenceTest1() throws Exception {
    try {
   ...
   * @test_Strategy:
   */
  public void runtimeExceptionTest1() throws Exception {
    try {
   ...
   * @test_Strategy:
   */
  public void passByReferenceTest2() throws Exception {
    try {
      getBean().passByReferenceTest(new String[] { CLIENT_MSG },
   ...
   * @test_Strategy:
   */
  public void runtimeExceptionTest2() throws Exception {
    try {
   ...
   * @test_Strategy:
   */
  public void passByReferenceTest3() throws Exception {
    try {
      getBean().passByReferenceTest(new String[] { CLIENT_MSG },
   ...
   * @test_Strategy:
   */
  public void runtimeExceptionTest3() throws Exception {
    try {
   ...
   * @test_Strategy:
   */
  public void passByReferenceTest4() throws Exception {
    try {
      getBean().passByReferenceTest(new String[] { CLIENT_MSG },
   ...
   * @test_Strategy:
   */
  public void runtimeExceptionTest4() throws Exception {
    try {
   ...
   * @test_Strategy:
   */
  public void passByReferenceTest5() throws Exception {
    try {
      getBean().passByReferenceTest(new String[] { CLIENT_MSG },
   ...
   * @test_Strategy:
   */
  public void runtimeExceptionTest5() throws Exception {
    try {

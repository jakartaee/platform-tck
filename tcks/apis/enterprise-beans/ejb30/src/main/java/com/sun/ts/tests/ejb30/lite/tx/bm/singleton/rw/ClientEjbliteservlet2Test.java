...
public class ClientEjbliteservlet2Test extends com.sun.ts.tests.ejb30.lite.tx.bm.singleton.rw.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_tx_bm_singleton_rw_ejbliteservlet2_vehicle";
        ...
        */
        ...
        // War
            ...
            if(warResURL != null) {
                ejblite_tx_bm_singleton_rw_ejbliteservlet2_vehicle_web.addAsWebInfResource(warResURL, "classes/META-INF/persistence.xml");
            }
           ...
           archiveProcessor.processWebArchive(ejblite_tx_bm_singleton_rw_ejbliteservlet2_vehicle_web, Client.class, warResURL);

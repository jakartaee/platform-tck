...
public class ClientEjblitejspTest extends com.sun.ts.tests.ejb30.lite.nointerface.descriptor.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_nointerface_descriptor_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/nointerface/descriptor/ejblitejsp.tld");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_nointerface_descriptor_ejblitejsp_vehicle_web, Client.class, warResURL);

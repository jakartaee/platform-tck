...
public class ClientEjblitejspTest extends com.sun.ts.tests.ejb30.bb.async.singleton.descriptor.Client {
    static final String VEHICLE_ARCHIVE = "ejbbb_async_singleton_descriptor_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/bb/async/singleton/descriptor/ejblitejsp.tld");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejbbb_async_singleton_descriptor_ejblitejsp_vehicle_web, Client.class, warResURL);

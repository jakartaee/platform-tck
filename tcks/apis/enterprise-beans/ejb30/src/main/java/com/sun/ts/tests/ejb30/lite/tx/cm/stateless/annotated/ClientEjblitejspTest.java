...
import com.sun.ts.tests.ejb30.lite.tx.cm.stateless.annotated.Client;
import java.net.URL;
...
public class ClientEjblitejspTest extends com.sun.ts.tests.ejb30.lite.tx.cm.stateless.annotated.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_tx_cm_stateless_annotated_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/tx/cm/stateless/annotated/ejblitejsp.tld");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_tx_cm_stateless_annotated_ejblitejsp_vehicle_web, Client.class, warResURL);

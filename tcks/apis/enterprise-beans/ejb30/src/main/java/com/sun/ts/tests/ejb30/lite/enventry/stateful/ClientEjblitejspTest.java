...
public class ClientEjblitejspTest extends com.sun.ts.tests.ejb30.lite.enventry.stateful.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_enventry_stateful_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/enventry/stateful/ejblitejsp.tld");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_enventry_stateful_ejblitejsp_vehicle_web, Client.class, warResURL);

...
public class ClientTest extends com.sun.ts.tests.ejb30.bb.session.stateful.annotation.appexception.override.Client {
    /**
        EE10 Deployment Descriptors:
        ejb3_stateful_appexception_override: 
        ejb3_stateful_appexception_override_client: 
        ejb3_stateful_appexception_override_ejb: META-INF/ejb-jar.xml,jar.sun-ejb-jar.xml
        ...
        /com/sun/ts/tests/ejb30/bb/session/stateful/annotation/appexception/override/ejb3_stateful_appexception_override_ejb.xml
        /com/sun/ts/tests/ejb30/bb/session/stateful/annotation/appexception/override/ejb3_stateful_appexception_override_ejb.jar.sun-ejb-jar.xml
        Ear:

        */
        @TargetsContainer("tck-appclient")
        @OverProtocol("appclient")
        @Deployment(name = "ejb3_stateful_appexception_override", order = 2)
        public static EnterpriseArchive createDeployment(@ArquillianResource TestArchiveProcessor archiveProcessor) {
        // Client
            // the jar with the correct archive name
            JavaArchive ejb3_stateful_appexception_override_client = ShrinkWrap.create(JavaArchive.class, "ejb3_stateful_appexception_override_client.jar");
            // The class files
            ...
            if(resURL != null) {
              ejb3_stateful_appexception_override_client.addAsManifestResource(resURL, "application-client.xml");
            }
            // The sun-application-client.xml file need to be added or should this be in in the vendor Arquillian extension?
            resURL = Client.class.getResource("/com/sun/ts/tests/ejb30/bb/session/stateful/annotation/appexception/override/ejb3_stateful_appexception_override_client.jar.sun-application-client.xml");
            if(resURL != null) {
              ejb3_stateful_appexception_override_client.addAsManifestResource(resURL, "sun-application-client.xml");
            }
            ejb3_stateful_appexception_override_client.addAsManifestResource(new StringAsset("Main-Class: " + Client.class.getName() + "\n"), "MANIFEST.MF");
            // Call the archive processor
            archiveProcessor.processClientArchive(ejb3_stateful_appexception_override_client, Client.class, resURL);

        // Ejb
            // the jar with the correct archive name
            JavaArchive ejb3_stateful_appexception_override_ejb = ShrinkWrap.create(JavaArchive.class, "ejb3_stateful_appexception_override_ejb.jar");
            // The class files
            ejb3_stateful_appexception_override_ejb.addClasses(
                com.sun.ts.tests.ejb30.common.helper.TestFailedException.class,
                ...
                com.sun.ts.tests.ejb30.bb.session.stateful.annotation.appexception.override.AppExceptionBean.class,
                com.sun.ts.tests.ejb30.common.appexception.AtCheckedRollbackAppException.class,
                com.sun.ts.tests.ejb30.common.appexception.RollbackIF.class,
                com.sun.ts.tests.ejb30.common.appexception.UncheckedAppException.class,
                com.sun.ts.tests.ejb30.common.appexception.CheckedAppException.class,
                ...
                com.sun.ts.tests.ejb30.bb.session.stateful.annotation.appexception.override.RollbackBean.class,
                com.sun.ts.tests.ejb30.common.appexception.RollbackOverrideBeanBase.class,
                com.sun.ts.tests.ejb30.common.appexception.AtUncheckedRollbackAppException.class
            );
            // The ejb-jar.xml descriptor
            URL ejbResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/bb/session/stateful/annotation/appexception/override/ejb3_stateful_appexception_override_ejb.xml");
            if(ejbResURL != null) {
              ejb3_stateful_appexception_override_ejb.addAsManifestResource(ejbResURL, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/bb/session/stateful/annotation/appexception/override/ejb3_stateful_appexception_override_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL != null) {
              ejb3_stateful_appexception_override_ejb.addAsManifestResource(ejbResURL, "sun-ejb-jar.xml");
            }
            // Call the archive processor
            archiveProcessor.processEjbArchive(ejb3_stateful_appexception_override_ejb, Client.class, ejbResURL);

        // Ear
            EnterpriseArchive ejb3_stateful_appexception_override_ear = ShrinkWrap.create(EnterpriseArchive.class, "ejb3_stateful_appexception_override.ear");

            // Any libraries added to the ear

            // The component jars built by the package target
            ejb3_stateful_appexception_override_ear.addAsModule(ejb3_stateful_appexception_override_ejb);
            ejb3_stateful_appexception_override_ear.addAsModule(ejb3_stateful_appexception_override_client);



            // The application.xml descriptor
            URL earResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/bb/session/stateful/annotation/appexception/override/application.xml");
            if(earResURL != null) {
              ejb3_stateful_appexception_override_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/bb/session/stateful/annotation/appexception/override/application.ear.sun-application.xml");
            if(earResURL != null) {
              ejb3_stateful_appexception_override_ear.addAsManifestResource(earResURL, "sun-application.xml");
            }
            // Call the archive processor
            archiveProcessor.processEarArchive(ejb3_stateful_appexception_override_ear, Client.class, earResURL);
        return ejb3_stateful_appexception_override_ear;
        }

...
public class ClientEjbliteservletTest extends com.sun.ts.tests.ejb30.bb.session.stateful.concurrency.metadata.annotated.Client {
    static final String VEHICLE_ARCHIVE = "bb_stateful_concurrency_metadata_annotated_ejbliteservlet_vehicle";
        ...
        */
        ...
        // War
            ...
            WebArchive bb_stateful_concurrency_metadata_annotated_ejbliteservlet_vehicle_web = ShrinkWrap.create(WebArchive.class, "bb_stateful_concurrency_metadata_annotated_ejbliteservlet_vehicle_web.war");
            // The class files
            bb_stateful_concurrency_metadata_annotated_ejbliteservlet_vehicle_web.addClasses(
            ...
            com.sun.ts.tests.ejb30.bb.session.stateful.concurrency.metadata.annotated.EJBLiteServletVehicle.class,
            ...
            if(warResURL != null) {
              bb_stateful_concurrency_metadata_annotated_ejbliteservlet_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = Client.class.getResource("/ejbliteservlet_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
              bb_stateful_concurrency_metadata_annotated_ejbliteservlet_vehicle_web.addAsWebInfResource(warResURL, "sun-web.xml");
            }
            ...
            if(warResURL != null) {
              bb_stateful_concurrency_metadata_annotated_ejbliteservlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/ejbliteservlet_vehicle_web.xml");
            }

           // Call the archive processor
           archiveProcessor.processWebArchive(bb_stateful_concurrency_metadata_annotated_ejbliteservlet_vehicle_web, Client.class, warResURL);

        return bb_stateful_concurrency_metadata_annotated_ejbliteservlet_vehicle_web;
        }

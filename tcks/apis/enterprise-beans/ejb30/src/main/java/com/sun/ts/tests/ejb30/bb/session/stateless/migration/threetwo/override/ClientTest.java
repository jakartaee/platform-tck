    ...
    /**
        ...
        */
        ...
        // Client
            ...
            if(resURL != null) {
              stateless_migration_threetwo_override_client.addAsManifestResource(resURL, "sun-application-client.xml");
            }
        ...
        // Ejb
            ...
            // The ejb-jar.xml descriptor
            ejbResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/bb/session/stateless/migration/threetwo/override/two_ejb.xml");
            if(ejbResURL != null) {
                two_ejb.addAsManifestResource(ejbResURL, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/bb/session/stateless/migration/threetwo/override/two_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL != null) {

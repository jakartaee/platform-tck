...
public class Client extends ClientBase3 {
   ...
   * See bug 6486752
   */
  public void ejbCreateTreatedAsPostConstruct() throws Exception {
   ...
   * @test_Strategy:
   */
  public void injectionDoneInEjbCreate() throws Exception {
    ...
    if (b) {
      ...
      throw new Exception("injection has not completed when ejbCreate is called in "
          + ejbCreateCallbackBean);
    }
  }
}

...
public class ClientEjblitejspTest extends com.sun.ts.tests.ejb30.lite.lookup.annotated.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_lookup_annotated_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/lookup/annotated/ejblitejsp.tld");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_lookup_annotated_ejblitejsp_vehicle_web, Client.class, warResURL);

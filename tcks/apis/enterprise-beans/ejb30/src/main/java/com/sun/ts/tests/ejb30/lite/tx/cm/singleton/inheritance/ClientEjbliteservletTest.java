...
public class ClientEjbliteservletTest extends com.sun.ts.tests.ejb30.lite.tx.cm.singleton.inheritance.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_tx_cm_singleton_inheritance_ejbliteservlet_vehicle";
        ...
        */
        ...
        // War
           ...
           archiveProcessor.processWebArchive(ejblite_tx_cm_singleton_inheritance_ejbliteservlet_vehicle_web, Client.class, warResURL);

...
import com.sun.ts.tests.ejb30.bb.session.stateful.cm.allowed.Client;
import java.net.URL;
    ...
    /**
        ...
        */
        ...
        // Client
            ...
            URL resURL = Client.class.getResource("/com/sun/ts/tests/ejb30/bb/session/stateful/cm/allowed/ejb3_bb_stateful_cm_allowed_client.xml");
            if(resURL != null) {
              ejb3_bb_stateful_cm_allowed_client.addAsManifestResource(resURL, "application-client.xml");
            }
            // The sun-application-client.xml file need to be added or should this be in in the vendor Arquillian extension?
            resURL = Client.class.getResource("/com/sun/ts/tests/ejb30/bb/session/stateful/cm/allowed/ejb3_bb_stateful_cm_allowed_client.jar.sun-application-client.xml");
            if(resURL != null) {

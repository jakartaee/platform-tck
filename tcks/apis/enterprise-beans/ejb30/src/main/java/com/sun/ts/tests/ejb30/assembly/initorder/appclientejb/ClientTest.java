...
public class ClientTest extends com.sun.ts.tests.ejb30.assembly.initorder.appclientejb.Client {
    ...
    /**
        ...
        ejb3_assembly_initorder_appclientejb: META-INF/application.xml
        ejb3_assembly_initorder_appclientejb_client: 
        ...
        /com/sun/ts/tests/ejb30/assembly/initorder/appclientejb/one_ejb.jar.sun-ejb-jar.xml
        Ear:

        /com/sun/ts/tests/ejb30/assembly/initorder/appclientejb/application.xml
        */
        @TargetsContainer("tck-appclient")
        @OverProtocol("appclient")
        @Deployment(name = "ejb3_assembly_initorder_appclientejb", order = 2)
        ...
        // Client
            ...
            URL resURL = Client.class.getResource("/com/sun/ts/tests/ejb30/assembly/initorder/appclientejb/ejb3_assembly_initorder_appclientejb_client.xml");
            if(resURL != null) {
              ejb3_assembly_initorder_appclientejb_client.addAsManifestResource(resURL, "application-client.xml");
            }
            // The sun-application-client.xml file need to be added or should this be in in the vendor Arquillian extension?
            resURL = Client.class.getResource("/com/sun/ts/tests/ejb30/assembly/initorder/appclientejb/ejb3_assembly_initorder_appclientejb_client.jar.sun-application-client.xml");
            if(resURL != null) {
              ejb3_assembly_initorder_appclientejb_client.addAsManifestResource(resURL, "sun-application-client.xml");
            }
            ejb3_assembly_initorder_appclientejb_client.addAsManifestResource(new StringAsset("Main-Class: " + Client.class.getName() + "\n"), "MANIFEST.MF");
            // Call the archive processor
            archiveProcessor.processClientArchive(ejb3_assembly_initorder_appclientejb_client, Client.class, resURL);
        ...
        // Ejb
            ...
            URL ejbResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/assembly/initorder/appclientejb/one_ejb.xml");
            if(ejbResURL != null) {
              one_ejb.addAsManifestResource(ejbResURL, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/assembly/initorder/appclientejb/one_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL != null) {
            ...
            two_ejb.addClasses(
                    com.sun.ts.tests.ejb30.assembly.initorder.appclientejb.InitOrder2Bean.class
            );
            // The ejb-jar.xml descriptor
            ejbResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/assembly/initorder/appclientejb/two_ejb.xml");
            if(ejbResURL != null) {
                two_ejb.addAsManifestResource(ejbResURL, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/assembly/initorder/appclientejb/two_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL != null) {
        ...
        // Ear
            EnterpriseArchive ejb3_assembly_initorder_appclientejb_ear = ShrinkWrap.create(EnterpriseArchive.class, "ejb3_assembly_initorder_appclientejb.ear");

            // Any libraries added to the ear

            // The component jars built by the package target
            ejb3_assembly_initorder_appclientejb_ear.addAsModule(two_ejb);
        ...
        @Test
        @Override
        @OperateOnDeployment("ejb3_assembly_initorder_appclientejb")

...
public class JsfClientEjblitejsfTest extends com.sun.ts.tests.ejb30.lite.naming.context.JsfClient {
    static final String VEHICLE_ARCHIVE = "ejblite_naming_context_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/lite/naming/context/beans.xml");
            if(warResURL != null) {
            ...
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/lite/naming/context/faces-config.xml");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_naming_context_ejblitejsf_vehicle_web, JsfClient.class, warResURL);

...
public class ClientEjblitejspTest extends com.sun.ts.tests.ejb30.lite.appexception.stateless.override.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_appexception_stateless_override_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/appexception/stateless/override/ejblitejsp.tld");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_appexception_stateless_override_ejblitejsp_vehicle_web, Client.class, warResURL);

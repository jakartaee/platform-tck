...
import com.sun.ts.tests.ejb30.bb.session.stateful.basic.Client;
import java.net.URL;
    ...
    /**
        ...
        */
        ...
        // Client
            ...
            resURL = Client.class.getResource("/com/sun/ts/tests/ejb30/bb/session/stateful/basic/ejb3_bb_stateful_basic_client.jar.sun-application-client.xml");
            if(resURL != null) {

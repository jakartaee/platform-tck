...
public class ClientEjblitejspTest extends com.sun.ts.tests.ejb30.lite.interceptor.singleton.lifecycle.annotated.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_interceptor_singleton_lifecycle_annotated_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/interceptor/singleton/lifecycle/annotated/ejblitejsp.tld");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_interceptor_singleton_lifecycle_annotated_ejblitejsp_vehicle_web, Client.class, warResURL);

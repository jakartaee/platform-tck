    ...
    /**
        ...
        */
        ...
        // Client
            ...
            URL resURL = Client.class.getResource("/com/sun/ts/tests/ejb30/bb/session/stateless/interceptor/method/descriptor/ejb3_bb_stateless_interceptor_method_descriptor_client.sun-application-client.xml");
            if(resURL != null) {
              ejb3_bb_stateless_interceptor_method_descriptor_client.addAsManifestResource(resURL, "sun-application-client.xml");
            }

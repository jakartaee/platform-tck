...
public class JsfClientEjblitejsfTest extends com.sun.ts.tests.ejb30.lite.tx.cm.stateful.webrw.JsfClient {
    static final String VEHICLE_ARCHIVE = "ejb_lite_tx_cm_stateful_webrw_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/lite/tx/cm/stateful/webrw/beans.xml");
            if(warResURL != null) {
            ...
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/lite/tx/cm/stateful/webrw/faces-config.xml");
            if(warResURL != null) {

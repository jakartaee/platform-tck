...
import com.sun.ts.tests.ejb30.lite.appexception.singleton.inheritance.Client;
import java.net.URL;
...
public class ClientEjblitejspTest extends com.sun.ts.tests.ejb30.lite.appexception.singleton.inheritance.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_appexception_singleton_inherited_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/appexception/singleton/inheritance/ejblitejsp.tld");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_appexception_singleton_inherited_ejblitejsp_vehicle_web, Client.class, warResURL);

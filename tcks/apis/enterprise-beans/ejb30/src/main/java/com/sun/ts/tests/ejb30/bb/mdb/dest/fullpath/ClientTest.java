package com.sun.ts.tests.ejb30.bb.mdb.dest.fullpath;

import com.sun.ts.tests.ejb30.bb.mdb.dest.fullpath.Client;
import java.net.URL;
...
public class ClientTest extends com.sun.ts.tests.ejb30.bb.mdb.dest.fullpath.Client {
    /**
        EE10 Deployment Descriptors:
        mdb_dest_fullpath: 
        mdb_dest_fullpath_client: META-INF/application-client.xml,jar.sun-application-client.xml

        Found Descriptors:
        Client:

        /com/sun/ts/tests/ejb30/bb/mdb/dest/fullpath/mdb_dest_fullpath_client.xml
        /com/sun/ts/tests/ejb30/bb/mdb/dest/fullpath/mdb_dest_fullpath_client.jar.sun-application-client.xml
        Ejb:

        /com/sun/ts/tests/ejb30/bb/mdb/dest/fullpath/one_ejb.xml
        /com/sun/ts/tests/ejb30/bb/mdb/dest/fullpath/one_ejb.jar.sun-ejb-jar.xml
        Ear:

        */
        @TargetsContainer("tck-appclient")
        @OverProtocol("appclient")
        @Deployment(name = "mdb_dest_fullpath", order = 2)
        public static EnterpriseArchive createDeployment(@ArquillianResource TestArchiveProcessor archiveProcessor) {
        // Client
            // the jar with the correct archive name
            JavaArchive mdb_dest_fullpath_client = ShrinkWrap.create(JavaArchive.class, "mdb_dest_fullpath_client.jar");
            // The class files
            mdb_dest_fullpath_client.addClasses(
            com.sun.ts.tests.jms.commonee.Client.class,
            com.sun.ts.tests.ejb30.bb.mdb.dest.fullpath.Client.class,
            ...
            archiveProcessor.processClientArchive(mdb_dest_fullpath_client, Client.class, resURL);
        ...
        // Ejb
            ...
            URL ejbResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/bb/mdb/dest/fullpath/one_ejb.xml");
            if(ejbResURL != null) {
              one_ejb.addAsManifestResource(ejbResURL, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/bb/mdb/dest/fullpath/one_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL != null) {
        ...
        // Ear
            ...
            mdb_dest_fullpath_ear.addAsModule(two_ejb);
            mdb_dest_fullpath_ear.addAsModule(one_ejb);
            mdb_dest_fullpath_ear.addAsModule(mdb_dest_fullpath_client);



            // The application.xml descriptor
            URL earResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/bb/mdb/dest/fullpath/application.xml");
            if(earResURL != null) {
              mdb_dest_fullpath_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/bb/mdb/dest/fullpath/application.ear.sun-application.xml");
            if(earResURL != null) {
              mdb_dest_fullpath_ear.addAsManifestResource(earResURL, "sun-application.xml");
            }
            // Call the archive processor
            archiveProcessor.processEarArchive(mdb_dest_fullpath_ear, Client.class, earResURL);
        return mdb_dest_fullpath_ear;
        }

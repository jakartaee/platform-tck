...
public class ClientEjblitejspTest extends com.sun.ts.tests.ejb30.lite.xmloverride.ejbref.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_xmloverride_ejbref_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/xmloverride/ejbref/ejblitejsp.tld");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_xmloverride_ejbref_ejblitejsp_vehicle_web, Client.class, warResURL);

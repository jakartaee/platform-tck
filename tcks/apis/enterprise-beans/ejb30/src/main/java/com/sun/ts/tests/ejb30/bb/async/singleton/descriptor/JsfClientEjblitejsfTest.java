...
public class JsfClientEjblitejsfTest extends com.sun.ts.tests.ejb30.bb.async.singleton.descriptor.JsfClient {
    static final String VEHICLE_ARCHIVE = "ejbbb_async_singleton_descriptor_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/bb/async/singleton/descriptor/beans.xml");
            if(warResURL != null) {
            ...
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/bb/async/singleton/descriptor/faces-config.xml");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejbbb_async_singleton_descriptor_ejblitejsf_vehicle_web, JsfClient.class, warResURL);

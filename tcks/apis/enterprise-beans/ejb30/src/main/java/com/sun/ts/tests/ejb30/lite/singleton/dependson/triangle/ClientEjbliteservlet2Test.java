...
public class ClientEjbliteservlet2Test extends com.sun.ts.tests.ejb30.lite.singleton.dependson.triangle.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_singleton_dependson_triangle_ejbliteservlet2_vehicle";
        ...
        */
        ...
        // War
           ...
           archiveProcessor.processWebArchive(ejblite_singleton_dependson_triangle_ejbliteservlet2_vehicle_web, Client.class, warResURL);

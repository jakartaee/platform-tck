...
public class ClientEjbliteservletTest extends com.sun.ts.tests.ejb30.lite.lookup.annotated.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_lookup_annotated_ejbliteservlet_vehicle";
        ...
        */
        ...
        // War
           ...
           archiveProcessor.processWebArchive(ejblite_lookup_annotated_ejbliteservlet_vehicle_web, Client.class, warResURL);

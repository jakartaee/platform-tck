...
public class ClientEjbliteservlet2Test extends com.sun.ts.tests.ejb30.lite.packaging.war.webinflibonly.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_packaging_war_webinflibonly_ejbliteservlet2_vehicle";
        ...
        */
        ...
        // War
            ...
            WebArchive ejblite_packaging_war_webinflibonly_ejbliteservlet2_vehicle_web = ShrinkWrap.create(WebArchive.class, "ejblite_packaging_war_webinflibonly_ejbliteservlet2_vehicle_web.war");
            // The class files
            ejblite_packaging_war_webinflibonly_ejbliteservlet2_vehicle_web.addClasses(
            ...
            com.sun.ts.tests.ejb30.lite.packaging.war.webinflibonly.EJBLiteServlet2Filter.class,
            ...
            if(warResURL != null) {
              ejblite_packaging_war_webinflibonly_ejbliteservlet2_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = Client.class.getResource("/ejbliteservlet2_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
              ejblite_packaging_war_webinflibonly_ejbliteservlet2_vehicle_web.addAsWebInfResource(warResURL, "sun-web.xml");
            }
            ...
            // Any libraries added to the war
                ...
                ejblite_packaging_war_webinflibonly_ejbliteservlet2_vehicle_web.addAsLibrary(x3_lib);


            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/common/vehicle/ejbliteservlet2/ejbliteservlet2_vehicle_web.xml");
            if(warResURL != null) {
              ejblite_packaging_war_webinflibonly_ejbliteservlet2_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/ejbliteservlet2_vehicle_web.xml");
            }
            warResURL = Client.class.getResource("/com/sun/ts/tests/common/vehicle/ejbliteservlet2/ejbliteservlet2_vehicle.jsp");
            if(warResURL != null) {
              ejblite_packaging_war_webinflibonly_ejbliteservlet2_vehicle_web.addAsWebResource(warResURL, "/ejbliteservlet2_vehicle.jsp");
            }

           // Call the archive processor
           archiveProcessor.processWebArchive(ejblite_packaging_war_webinflibonly_ejbliteservlet2_vehicle_web, Client.class, warResURL);

        return ejblite_packaging_war_webinflibonly_ejbliteservlet2_vehicle_web;
        }

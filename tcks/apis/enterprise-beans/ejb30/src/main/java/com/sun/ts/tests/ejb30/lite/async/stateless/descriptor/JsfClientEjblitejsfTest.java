...
public class JsfClientEjblitejsfTest extends com.sun.ts.tests.ejb30.lite.async.stateless.descriptor.JsfClient {
    static final String VEHICLE_ARCHIVE = "ejblite_async_stateless_descriptor_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/lite/async/stateless/descriptor/beans.xml");
            if(warResURL != null) {
            ...
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/lite/async/stateless/descriptor/faces-config.xml");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_async_stateless_descriptor_ejblitejsf_vehicle_web, JsfClient.class, warResURL);

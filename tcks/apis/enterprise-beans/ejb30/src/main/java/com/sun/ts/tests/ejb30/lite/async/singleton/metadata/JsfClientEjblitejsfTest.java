...
public class JsfClientEjblitejsfTest extends com.sun.ts.tests.ejb30.lite.async.singleton.metadata.JsfClient {
    static final String VEHICLE_ARCHIVE = "ejblite_async_singleton_metadata_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/lite/async/singleton/metadata/beans.xml");
            if(warResURL != null) {
            ...
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/lite/async/singleton/metadata/faces-config.xml");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_async_singleton_metadata_ejblitejsf_vehicle_web, JsfClient.class, warResURL);

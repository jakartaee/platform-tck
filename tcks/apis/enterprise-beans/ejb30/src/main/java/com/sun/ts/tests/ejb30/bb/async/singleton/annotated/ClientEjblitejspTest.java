...
public class ClientEjblitejspTest extends com.sun.ts.tests.ejb30.bb.async.singleton.annotated.Client {
    static final String VEHICLE_ARCHIVE = "ejbbb_async_singleton_annotated_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/bb/async/singleton/annotated/ejblitejsp.tld");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejbbb_async_singleton_annotated_ejblitejsp_vehicle_web, Client.class, warResURL);

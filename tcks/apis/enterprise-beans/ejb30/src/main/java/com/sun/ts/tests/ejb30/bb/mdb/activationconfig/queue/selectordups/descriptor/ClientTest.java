...
import com.sun.ts.tests.ejb30.bb.mdb.activationconfig.queue.selectordups.descriptor.Client;
import java.net.URL;
...
public class ClientTest extends com.sun.ts.tests.ejb30.bb.mdb.activationconfig.queue.selectordups.descriptor.Client {
    /**
        ...
        /com/sun/ts/tests/ejb30/bb/mdb/activationconfig/queue/selectordups/descriptor/queue_selectordups_descriptor_client.jar.sun-application-client.xml
        Ejb:

        /com/sun/ts/tests/ejb30/bb/mdb/activationconfig/queue/selectordups/descriptor/queue_selectordups_descriptor_ejb.xml
        /com/sun/ts/tests/ejb30/bb/mdb/activationconfig/queue/selectordups/descriptor/queue_selectordups_descriptor_ejb.jar.sun-ejb-jar.xml
        Ear:
        ...
        */
        ...
        // Client
            ...
            com.sun.ts.tests.ejb30.bb.mdb.activationconfig.queue.selectordups.descriptor.Client.class,
            ...
            URL resURL = Client.class.getResource("/com/sun/ts/tests/ejb30/bb/mdb/activationconfig/queue/selectordups/descriptor/queue_selectordups_descriptor_client.xml");
            if(resURL != null) {
              queue_selectordups_descriptor_client.addAsManifestResource(resURL, "application-client.xml");
            }
            // The sun-application-client.xml file need to be added or should this be in in the vendor Arquillian extension?
            resURL = Client.class.getResource("/com/sun/ts/tests/ejb30/bb/mdb/activationconfig/queue/selectordups/descriptor/queue_selectordups_descriptor_client.jar.sun-application-client.xml");
            if(resURL != null) {
        ...
        // Ejb
            ...
            URL ejbResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/bb/mdb/activationconfig/queue/selectordups/descriptor/queue_selectordups_descriptor_ejb.xml");
            if(ejbResURL != null) {
              queue_selectordups_descriptor_ejb.addAsManifestResource(ejbResURL, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/bb/mdb/activationconfig/queue/selectordups/descriptor/queue_selectordups_descriptor_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL != null) {
        ...
        // Ear
            ...
            URL earResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/bb/mdb/activationconfig/queue/selectordups/descriptor/application.xml");
            if(earResURL != null) {
              queue_selectordups_descriptor_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/bb/mdb/activationconfig/queue/selectordups/descriptor/application.ear.sun-application.xml");
            if(earResURL != null) {

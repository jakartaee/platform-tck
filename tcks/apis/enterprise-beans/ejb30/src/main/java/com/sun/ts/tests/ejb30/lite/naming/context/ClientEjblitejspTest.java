...
public class ClientEjblitejspTest extends com.sun.ts.tests.ejb30.lite.naming.context.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_naming_context_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/naming/context/ejblitejsp.tld");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_naming_context_ejblitejsp_vehicle_web, Client.class, warResURL);

...
import com.sun.ts.tests.ejb30.lite.enventry.stateful.JsfClient;
import java.net.URL;
...
public class JsfClientEjblitejsfTest extends com.sun.ts.tests.ejb30.lite.enventry.stateful.JsfClient {
    static final String VEHICLE_ARCHIVE = "ejblite_enventry_stateful_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            WebArchive ejblite_enventry_stateful_ejblitejsf_vehicle_web = ShrinkWrap.create(WebArchive.class, "ejblite_enventry_stateful_ejblitejsf_vehicle_web.war");
            // The class files
            ejblite_enventry_stateful_ejblitejsf_vehicle_web.addClasses(
            ...
            if(warResURL != null) {
              ejblite_enventry_stateful_ejblitejsf_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            ...
            if(warResURL != null) {
              ejblite_enventry_stateful_ejblitejsf_vehicle_web.addAsWebInfResource(warResURL, "sun-web.xml");
            }

            // Any libraries added to the war

            // Web content
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/lite/enventry/stateful/beans.xml");
            if(warResURL != null) {
              ejblite_enventry_stateful_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/beans.xml");
            }
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/common/vehicle/ejblitejsf/beans.xml");
            if(warResURL != null) {
              ejblite_enventry_stateful_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/beans.xml");
            }
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/lite/enventry/stateful/ejb-jar.xml");
            if(warResURL != null) {
              ejblite_enventry_stateful_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/ejb-jar.xml");
            }
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/common/vehicle/ejblitejsf/ejblitejsf_vehicle_web.xml");
            if(warResURL != null) {
              ejblite_enventry_stateful_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/ejblitejsf_vehicle_web.xml");
            }
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/lite/enventry/stateful/faces-config.xml");
            if(warResURL != null) {
              ejblite_enventry_stateful_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/faces-config.xml");
            }
            ...
            if(warResURL != null) {
              ejblite_enventry_stateful_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/ejblitejsf_vehicle.xhtml");
            }

           // Call the archive processor
           archiveProcessor.processWebArchive(ejblite_enventry_stateful_ejblitejsf_vehicle_web, JsfClient.class, warResURL);

        return ejblite_enventry_stateful_ejblitejsf_vehicle_web;
        }

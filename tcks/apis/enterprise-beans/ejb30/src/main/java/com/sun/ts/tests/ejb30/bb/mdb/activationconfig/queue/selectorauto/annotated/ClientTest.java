...
import com.sun.ts.tests.ejb30.bb.mdb.activationconfig.queue.selectorauto.annotated.Client;
import java.net.URL;
...
public class ClientTest extends com.sun.ts.tests.ejb30.bb.mdb.activationconfig.queue.selectorauto.annotated.Client {
    /**
        ...
        /com/sun/ts/tests/ejb30/bb/mdb/activationconfig/queue/selectorauto/annotated/queue_selectorauto_annotated_ejb.jar.sun-ejb-jar.xml
        Ear:
        ...
        */
        ...
        // Client
            ...
            com.sun.ts.tests.ejb30.bb.mdb.activationconfig.queue.selectorauto.annotated.Client.class,
            ...
            URL resURL = Client.class.getResource("/com/sun/ts/tests/ejb30/bb/mdb/activationconfig/queue/selectorauto/annotated/queue_selectorauto_annotated_client.xml");
            if(resURL != null) {
              queue_selectorauto_annotated_client.addAsManifestResource(resURL, "application-client.xml");
            }
            // The sun-application-client.xml file need to be added or should this be in in the vendor Arquillian extension?
            resURL = Client.class.getResource("/com/sun/ts/tests/ejb30/bb/mdb/activationconfig/queue/selectorauto/annotated/queue_selectorauto_annotated_client.jar.sun-application-client.xml");
            if(resURL != null) {
              queue_selectorauto_annotated_client.addAsManifestResource(resURL, "sun-application-client.xml");
            }
        ...
        // Ejb
            ...
            queue_selectorauto_annotated_ejb.addClasses(
                ...
                com.sun.ts.tests.ejb30.bb.mdb.activationconfig.queue.selectorauto.annotated.ActivationConfigBean.class,
                com.sun.ts.tests.ejb30.common.helper.TLogger.class
            );
            // The ejb-jar.xml descriptor
            URL ejbResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/bb/mdb/activationconfig/queue/selectorauto/annotated/queue_selectorauto_annotated_ejb.xml");
            if(ejbResURL != null) {
              queue_selectorauto_annotated_ejb.addAsManifestResource(ejbResURL, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/bb/mdb/activationconfig/queue/selectorauto/annotated/queue_selectorauto_annotated_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL != null) {
        ...
        // Ear
            ...
            URL earResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/bb/mdb/activationconfig/queue/selectorauto/annotated/application.xml");
            if(earResURL != null) {
              queue_selectorauto_annotated_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/bb/mdb/activationconfig/queue/selectorauto/annotated/application.ear.sun-application.xml");
            if(earResURL != null) {

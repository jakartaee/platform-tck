...
public class ClientEjblitejspTest extends com.sun.ts.tests.ejb32.lite.timer.basic.xa.Client {
    static final String VEHICLE_ARCHIVE = "ejb32_lite_timer_basic_xa_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb32/lite/timer/basic/xa/ejblitejsp.tld");
            if(warResURL != null) {

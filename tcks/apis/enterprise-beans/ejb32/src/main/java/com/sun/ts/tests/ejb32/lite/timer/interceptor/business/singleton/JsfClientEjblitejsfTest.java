    ...
    static final String VEHICLE_ARCHIVE = "ejb32_lite_timer_interceptor_business_singleton_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb32/lite/timer/interceptor/business/singleton/beans.xml");
            if(warResURL != null) {
            ...
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb32/lite/timer/interceptor/business/singleton/faces-config.xml");
            if(warResURL != null) {

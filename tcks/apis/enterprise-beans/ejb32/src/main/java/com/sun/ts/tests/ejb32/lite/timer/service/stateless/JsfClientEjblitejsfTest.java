    ...
    static final String VEHICLE_ARCHIVE = "ejb32_lite_timer_service_stateless_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb32/lite/timer/service/stateless/beans.xml");
            if(warResURL != null) {
              ejb32_lite_timer_service_stateless_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/beans.xml");
            }
            ...
            if(warResURL != null) {
              ejb32_lite_timer_service_stateless_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/ejblitejsf_vehicle_web.xml");
            }
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb32/lite/timer/service/stateless/faces-config.xml");
            if(warResURL != null) {
              ejb32_lite_timer_service_stateless_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/faces-config.xml");
            }

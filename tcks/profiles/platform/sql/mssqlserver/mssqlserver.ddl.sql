...
drop table Bit_Tab !
create table Bit_Tab (MAX_VAL BIT, MIN_VAL BIT, NULL_VAL SMALLINT NULL ) !
...
create table Tinyint_Tab (MAX_VAL TINYINT, MIN_VAL TINYINT, NULL_VAL TINYINT NULL) !
...
create table Bigint_Tab (MAX_VAL NUMERIC(20,0), MIN_VAL NUMERIC(20,0), NULL_VAL NUMERIC(20,0) NULL) !
...
drop table Date_Tab !
create table Date_Tab (MFG_DATE DATETIME, NULL_VAL DATETIME NULL) !

drop table Time_Tab !
create table Time_Tab (BRK_TIME DATETIME, NULL_VAL DATETIME NULL) !

drop table Timestamp_Tab !
create table Timestamp_Tab (IN_TIME DATETIME, NULL_VAL DATETIME NULL) !

drop table Binary_Tab !
create table Binary_Tab (BINARY_VAL Binary(24) null) !

drop table Varbinary_Tab !
create table Varbinary_Tab (VARBINARY_VAL Varbinary(255) null) !

drop table Longvarbinary_Tab !
create table Longvarbinary_Tab (LONGVARBINARY_VAL varbinary(255) null) !



drop TABLE ctstable3 !
CREATE TABLE ctstable3(STRING1 VARCHAR(20), STRING2 VARCHAR(20), STRING3 VARCHAR(20), NUMCOL NUMERIC, FLOATCOL FLOAT, DATECOL DATETIME, TIMECOL DATETIME, TSCOL1 DATETIME, TSCOL2 DATETIME) !
...
create table Deploy_Tab3 (KEY_ID INT NOT NULL, BRAND_NAME varchar(32), PRICE float, primary key(KEY_ID)) !
...
create table Deploy_Tab5 (KEY_ID1 int NOT NULL, KEY_ID2 varchar(100) NOT NULL, KEY_ID3 float NOT NULL, BRAND_NAME varchar(32), PRICE float, primary key(KEY_ID3)) !
...
CREATE TABLE COFFEEEJBLITE (ID INTEGER NOT NULL, BRANDNAME VARCHAR(25), PRICE REAL) !

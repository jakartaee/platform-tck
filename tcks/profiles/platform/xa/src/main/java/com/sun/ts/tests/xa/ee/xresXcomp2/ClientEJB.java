...
public class ClientEJB extends Client implements Serializable {
    ...
    public static EnterpriseArchive createDeploymentAppclient(@ArquillianResource TestArchiveProcessor archiveProcessor)
        ...
        resURL = ClientEJB.class
                .getResource("/com/sun/ts/tests/xa/ee/xresXcomp2/xa_xresXcomp2_ejb_vehicle_client.jar.sun-application-client.xml");
        if (resURL != null) {
        ...
        JavaArchive ejbVehicle = ShrinkWrap.create(JavaArchive.class, "xa_xresXcomp2_ejb_vehicle_ejb.jar");
        ...
        resURL = ClientEJB.class.getResource("/com/sun/ts/tests/xa/ee/xresXcomp2/xa_xresXcomp2_ejb_vehicle_ejb.jar.sun-ejb-jar.xml");
        if (resURL != null) {
            ejbVehicle.addAsManifestResource(resURL, "sun-ejb-jar.xml");
        }

        JavaArchive ejb = ShrinkWrap.create(JavaArchive.class, "xa_xresXcomp2_ee_txpropagate1_ejb.jar");
        ...
        resURL = ClientEJB.class.getResource("/com/sun/ts/tests/xa/ee/xresXcomp2/xa_xresXcomp2_ee_txpropagate1_ejb.jar.sun-ejb-jar.xml");

        if (resURL != null) {
            ejb.addAsManifestResource(resURL, "sun-ejb-jar.xml");
        }

        resURL = ClientEJB.class.getResource("/com/sun/ts/tests/xa/ee/xresXcomp2/xa_xresXcomp2_ee_txpropagate1_ejb.xml");

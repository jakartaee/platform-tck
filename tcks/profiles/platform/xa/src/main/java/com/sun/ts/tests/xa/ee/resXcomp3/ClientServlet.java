...
public class ClientServlet extends Client implements Serializable {
	  ...
	  @Deployment(name = "servlet", testable = true)
		public static EnterpriseArchive createDeploymentServlet(@ArquillianResource TestArchiveProcessor archiveProcessor) throws IOException {
		  	...
		  	servletVehicleArchive.addAsWebInfResource(ClientServlet.class.getPackage(), "xa_resXcomp3_servlet_vehicle_web.war.sun-web.xml", "sun-web.xml");
		  	...
		  	javaAchive.addAsManifestResource(ClientServlet.class.getPackage(), "xa_resXcomp3_ee_txpropagate2_ejb.jar.sun-ejb-jar.xml", "sun-ejb-jar.xml");

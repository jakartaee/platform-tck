...
public class callStmtClient1EJB extends callStmtClient1 implements Serializable {
	...
	public static EnterpriseArchive createDeploymentEJB(@ArquillianResource TestArchiveProcessor archiveProcessor)
		...
		ejbClient.addClasses(callStmtClient1.class, ServiceEETest.class, EETest.class);
		...
		ejb.addClasses(callStmtClient1EJB.class, callStmtClient1.class, ServiceEETest.class, EETest.class);

  ...
  @OverProtocol("appclient")
	...
	public static EnterpriseArchive createDeploymentejb(@ArquillianResource TestArchiveProcessor archiveProcessor) throws IOException {
		...
		resURL = callStmtClient17EJB.class
				.getResource("/com/sun/ts/tests/jdbc/ee/callStmt/callStmt17/callStmt17_ejb_vehicle_client.jar.sun-application-client.xml");
		if (resURL != null) {
		...
		resURL = callStmtClient17EJB.class.getResource("/com/sun/ts/tests/jdbc/ee/callStmt/callStmt17/ejb_vehicle_ejb.xml");

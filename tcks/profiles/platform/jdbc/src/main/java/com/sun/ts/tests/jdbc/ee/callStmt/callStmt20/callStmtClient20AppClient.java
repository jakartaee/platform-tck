...
public class callStmtClient20AppClient extends callStmtClient20 implements Serializable {
	...
	public static EnterpriseArchive createDeploymentAppclient(@ArquillianResource TestArchiveProcessor archiveProcessor) throws IOException {
		...
		archive.addClasses(callStmtClient20AppClient.class, callStmtClient20.class);
	     ...
	     URL appClientUrl = callStmtClient20AppClient.class.getResource("/com/sun/ts/tests/jdbc/ee/callStmt/callStmt20/appclient_vehicle_client.xml");
	     if(appClientUrl != null) {
	     	archive.addAsManifestResource(appClientUrl, "application-client.xml");
	     }
	     // The sun appclient-client descriptor
	     URL sunAppClientUrl = callStmtClient20AppClient.class.getResource("//com/sun/ts/tests/common/vehicle/appclient/appclient_vehicle_client.jar.sun-application-client.xml");

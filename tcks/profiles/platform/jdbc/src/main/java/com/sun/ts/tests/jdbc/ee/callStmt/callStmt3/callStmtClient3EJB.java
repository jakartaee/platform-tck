  ...
  @OverProtocol("appclient")
	...
	public static EnterpriseArchive createDeploymentejb(@ArquillianResource TestArchiveProcessor archiveProcessor) throws IOException {
		...
		resURL = callStmtClient3EJB.class
				.getResource("/com/sun/ts/tests/jdbc/ee/callStmt/callStmt3/callStmt3_ejb_vehicle_client.jar.sun-application-client.xml");
		if (resURL != null) {
		...
		resURL = callStmtClient3EJB.class.getResource("/com/sun/ts/tests/jdbc/ee/callStmt/callStmt3/ejb_vehicle_ejb.xml");

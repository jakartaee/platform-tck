  ...
  @OverProtocol("appclient")
	...
	public static EnterpriseArchive createDeploymentejb(@ArquillianResource TestArchiveProcessor archiveProcessor) throws IOException {
		...
		resURL = resultSetClient1EJB.class
				.getResource("/com/sun/ts/tests/jdbc/ee/resultSet/resultSet1/resultSet1_ejb_vehicle_client.jar.sun-application-client.xml");
		if (resURL != null) {
		...
		resURL = resultSetClient1EJB.class.getResource("/com/sun/ts/tests/jdbc/ee/resultSet/resultSet1/ejb_vehicle_ejb.xml");

  ...
  @OverProtocol("appclient")
	...
	public static EnterpriseArchive createDeploymentejb(@ArquillianResource TestArchiveProcessor archiveProcessor) throws IOException {
		...
		resURL = prepStmtClient9EJB.class
				.getResource("/com/sun/ts/tests/jdbc/ee/prepStmt/prepStmt9/prepStmt9_ejb_vehicle_client.jar.sun-application-client.xml");
		if (resURL != null) {
		...
		resURL = prepStmtClient9EJB.class.getResource("/com/sun/ts/tests/jdbc/ee/prepStmt/prepStmt9/ejb_vehicle_ejb.xml");

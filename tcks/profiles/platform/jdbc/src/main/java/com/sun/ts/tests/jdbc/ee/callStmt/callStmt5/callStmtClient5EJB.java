...
public class callStmtClient5EJB extends callStmtClient5 implements Serializable {
	...
	public static EnterpriseArchive createDeploymentejb(@ArquillianResource TestArchiveProcessor archiveProcessor) throws IOException {
		...
		resURL = callStmtClient5EJB.class
				.getResource("/com/sun/ts/tests/jdbc/ee/callStmt/callStmt5/callStmt5_ejb_vehicle_client.jar.sun-application-client.xml");
		if (resURL != null) {
		...
		resURL = callStmtClient5EJB.class.getResource("/com/sun/ts/tests/jdbc/ee/callStmt/callStmt5/ejb_vehicle_ejb.xml");

  ...
  @OverProtocol("appclient")
	...
	public static EnterpriseArchive createDeploymentejb(@ArquillianResource TestArchiveProcessor archiveProcessor) throws IOException {
		...
		resURL = scalarClient1EJB.class
				.getResource("/com/sun/ts/tests/jdbc/ee/escapeSyntax/scalar1/scalar1_ejb_vehicle_client.jar.sun-application-client.xml");
		if (resURL != null) {
		...
		resURL = scalarClient1EJB.class.getResource("/com/sun/ts/tests/jdbc/ee/escapeSyntax/scalar1/ejb_vehicle_ejb.xml");

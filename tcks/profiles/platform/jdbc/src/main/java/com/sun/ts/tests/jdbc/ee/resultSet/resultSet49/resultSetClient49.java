...
public class resultSetClient49 extends ServiceEETest implements Serializable {
	...
	public void setup(String[] args, Properties p) throws Exception {
		try {
			try {
				...
				/*
				 * sqlp=new Properties(); sqlStmt= p.getProperty("rsQuery",""); InputStream
	...
	public void testGetTime16() throws Exception {
		...
		try {
			...
			String Timestamp_Query_Null = sqlp.getProperty("Timestamp_Query_Null", null);
	...
	public void testGetTimestamp12() throws Exception {
		...
		try {
			...
			String sPrepStatement = sqlp.getProperty("Longvarchar_Tab_Name_Update", null);
			PreparedStatement pstmt = conn.prepareStatement(sPrepStatement);
			// Convert the string str into a Timestamp object
			brkVal = Timestamp.valueOf(str);
			pstmt.setString(1, str);
			pstmt.executeUpdate();
			msg.setMsg("perform query to get the value of Timestamp from Timestamp_Tab");
			String Longvarchar_Query_Name = sqlp.getProperty("Longvarchar_Query_Name", null);

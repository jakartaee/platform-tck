...
public abstract class BaseUrlClient {
  ...
  protected static final Logger logger = System.getLogger(BaseUrlClient.class.getName());
  ...
  public void setup(String[] args, Properties p) throws Exception {
    ...
    logger.log(Logger.Level.DEBUG, "[BaseUrlClient] Test setup OK using properties {}" + p);
  }
  ...
  public void cleanup() throws Exception {
    logger.log(Logger.Level.INFO, "[BaseUrlClient] Test cleanup OK");
  }

...
public class Client extends EETest {
  ...
  public static EnterpriseArchive createDeploymentVehicle(@ArquillianResource TestArchiveProcessor archiveProcessor) {
    ...
    JavaArchive assembly_classpath_appclient_client = ShrinkWrap.create(JavaArchive.class, "assembly_classpath_appclient_client.jar");
    ...
    EnterpriseArchive assembly_classpath_appclient_ear = ShrinkWrap.create(EnterpriseArchive.class, "assembly_classpath_appclient.ear");
    assembly_classpath_appclient_ear.add(new ArchiveAsset(direct_classpath_util, ZipExporter.class), "libs/direct_classpath_util.jar");
    assembly_classpath_appclient_ear.add(new ArchiveAsset(indirect_classpath_util, ZipExporter.class), "libs/indirect_classpath_util.jar");

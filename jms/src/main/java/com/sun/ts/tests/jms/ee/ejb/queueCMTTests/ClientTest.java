...
import com.sun.ts.tests.jms.ee.ejb.queueCMTTests.Client;
import java.net.URL;
    ...
    /**
        ...
        */
        ...
        // Ear
            ...
            URL earResURL = Client.class.getResource("/com/sun/ts/tests/jms/ee/ejb/queueCMTTests/");
            if(earResURL != null) {
              jms_ejb_queueCMTTests_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client.class.getResource("/com/sun/ts/tests/jms/ee/ejb/queueCMTTests/.ear.sun-application.xml");
            if(earResURL != null) {

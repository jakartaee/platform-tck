    ...
    static final String VEHICLE_ARCHIVE = "resourcedefs_descriptor_ejb_vehicle";
        ...
        */
        ...
        // Ear
            ...
            if(earResURL != null) {
              resourcedefs_descriptor_ejb_vehicle_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client.class.getResource("/com/sun/ts/tests/jms/ee20/resourcedefs/descriptor/.ear.sun-application.xml");
            if(earResURL != null) {
              resourcedefs_descriptor_ejb_vehicle_ear.addAsManifestResource(earResURL, "sun-application.xml");
            }
            // Call the archive processor

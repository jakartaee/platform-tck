...
import com.sun.ts.tests.jms.core.exceptionQueue.ExceptionQueueTests;
import java.net.URL;
    ...
    static final String VEHICLE_ARCHIVE = "exceptionQueue_servlet_vehicle";
        ...
        */
        ...
        // War
            ...
            URL warResURL = ExceptionQueueTests.class.getResource("/com/sun/ts/tests/common/vehicle/servlet/servlet_vehicle_web.xml");
            if(warResURL != null) {
              exceptionQueue_servlet_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = ExceptionQueueTests.class.getResource("//com/sun/ts/tests/common/vehicle/servlet/servlet_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
            ...
            // Web content
            warResURL = ExceptionQueueTests.class.getResource("/com/sun/ts/tests/common/vehicle/servlet/servlet_vehicle_web.xml");
            if(warResURL != null) {
              exceptionQueue_servlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/servlet_vehicle_web.xml");
            }
            warResURL = ExceptionQueueTests.class.getResource("/com/sun/ts/tests/jms/core/exceptionQueue/servlet_vehicle_web.xml");
            if(warResURL != null) {
              exceptionQueue_servlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/servlet_vehicle_web.xml");
            }
        ...
        // Ear
            ...
            if(earResURL != null) {
              exceptionQueue_servlet_vehicle_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = ExceptionQueueTests.class.getResource("/com/sun/ts/tests/jms/core/exceptionQueue/.ear.sun-application.xml");
            if(earResURL != null) {
              exceptionQueue_servlet_vehicle_ear.addAsManifestResource(earResURL, "sun-application.xml");
            }
            // Call the archive processor
            archiveProcessor.processEarArchive(exceptionQueue_servlet_vehicle_ear, ExceptionQueueTests.class, earResURL);

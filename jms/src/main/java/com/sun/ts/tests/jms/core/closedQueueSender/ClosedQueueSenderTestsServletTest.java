...
import com.sun.ts.tests.jms.core.closedQueueSender.ClosedQueueSenderTests;
import java.net.URL;
    ...
    static final String VEHICLE_ARCHIVE = "closedQueueSender_servlet_vehicle";
        ...
        */
        ...
        // War
            ...
            URL warResURL = ClosedQueueSenderTests.class.getResource("/com/sun/ts/tests/common/vehicle/servlet/servlet_vehicle_web.xml");
            if(warResURL != null) {
              closedQueueSender_servlet_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = ClosedQueueSenderTests.class.getResource("//com/sun/ts/tests/common/vehicle/servlet/servlet_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
            ...
            // Web content
            warResURL = ClosedQueueSenderTests.class.getResource("/com/sun/ts/tests/common/vehicle/servlet/servlet_vehicle_web.xml");
            if(warResURL != null) {
              closedQueueSender_servlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/servlet_vehicle_web.xml");
            }
            warResURL = ClosedQueueSenderTests.class.getResource("/com/sun/ts/tests/jms/core/closedQueueSender/servlet_vehicle_web.xml");
            if(warResURL != null) {
              closedQueueSender_servlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/servlet_vehicle_web.xml");
            }
        ...
        // Ear
            ...
            URL earResURL = ClosedQueueSenderTests.class.getResource("/com/sun/ts/tests/jms/core/closedQueueSender/");
            if(earResURL != null) {
              closedQueueSender_servlet_vehicle_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = ClosedQueueSenderTests.class.getResource("/com/sun/ts/tests/jms/core/closedQueueSender/.ear.sun-application.xml");
            if(earResURL != null) {
              closedQueueSender_servlet_vehicle_ear.addAsManifestResource(earResURL, "sun-application.xml");
            }
            // Call the archive processor
            archiveProcessor.processEarArchive(closedQueueSender_servlet_vehicle_ear, ClosedQueueSenderTests.class, earResURL);

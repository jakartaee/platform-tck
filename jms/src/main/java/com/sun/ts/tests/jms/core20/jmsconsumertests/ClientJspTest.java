...
import com.sun.ts.tests.jms.core20.jmsconsumertests.Client;
import java.net.URL;
    ...
    static final String VEHICLE_ARCHIVE = "jmsconsumertests_jsp_vehicle";
        ...
        */
        ...
        // War
            ...
            if(warResURL != null) {
              jmsconsumertests_jsp_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/jsp_vehicle_web.xml");
            }
            warResURL = Client.class.getResource("/com/sun/ts/tests/jms/core20/jmsconsumertests/jsp_vehicle_web.xml");
            if(warResURL != null) {
              jmsconsumertests_jsp_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/jsp_vehicle_web.xml");
            }
        ...
        // Ear
            ...
            if(earResURL != null) {
              jmsconsumertests_jsp_vehicle_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client.class.getResource("/com/sun/ts/tests/jms/core20/jmsconsumertests/.ear.sun-application.xml");
            if(earResURL != null) {
              jmsconsumertests_jsp_vehicle_ear.addAsManifestResource(earResURL, "sun-application.xml");
            }
            // Call the archive processor
            archiveProcessor.processEarArchive(jmsconsumertests_jsp_vehicle_ear, Client.class, earResURL);

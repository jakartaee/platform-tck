...
import com.sun.ts.tests.jms.core20.jmscontexttopictests.Client;
import java.net.URL;
    ...
    static final String VEHICLE_ARCHIVE = "jmscontexttopictests_servlet_vehicle";
        ...
        */
        ...
        // War
            ...
            if(warResURL != null) {
              jmscontexttopictests_servlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/servlet_vehicle_web.xml");
            }
            warResURL = Client.class.getResource("/com/sun/ts/tests/jms/core20/jmscontexttopictests/servlet_vehicle_web.xml");
            if(warResURL != null) {
              jmscontexttopictests_servlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/servlet_vehicle_web.xml");
            }
        ...
        // Ear
            ...
            URL earResURL = Client.class.getResource("/com/sun/ts/tests/jms/core20/jmscontexttopictests/");
            if(earResURL != null) {
              jmscontexttopictests_servlet_vehicle_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client.class.getResource("/com/sun/ts/tests/jms/core20/jmscontexttopictests/.ear.sun-application.xml");
            if(earResURL != null) {
              jmscontexttopictests_servlet_vehicle_ear.addAsManifestResource(earResURL, "sun-application.xml");
            }
            // Call the archive processor
            archiveProcessor.processEarArchive(jmscontexttopictests_servlet_vehicle_ear, Client.class, earResURL);

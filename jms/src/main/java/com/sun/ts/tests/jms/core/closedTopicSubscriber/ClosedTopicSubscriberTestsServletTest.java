    ...
    static final String VEHICLE_ARCHIVE = "closedTopicSubscriber_servlet_vehicle";
        ...
        */
        ...
        // War
            ...
            URL warResURL = ClosedTopicSubscriberTests.class.getResource("/com/sun/ts/tests/common/vehicle/servlet/servlet_vehicle_web.xml");
            if(warResURL != null) {
              closedTopicSubscriber_servlet_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = ClosedTopicSubscriberTests.class.getResource("//com/sun/ts/tests/common/vehicle/servlet/servlet_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
            ...
            // Web content
            warResURL = ClosedTopicSubscriberTests.class.getResource("/com/sun/ts/tests/common/vehicle/servlet/servlet_vehicle_web.xml");
            if(warResURL != null) {
              closedTopicSubscriber_servlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/servlet_vehicle_web.xml");
            }
            warResURL = ClosedTopicSubscriberTests.class.getResource("/com/sun/ts/tests/jms/core/closedTopicSubscriber/servlet_vehicle_web.xml");
            if(warResURL != null) {
              closedTopicSubscriber_servlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/servlet_vehicle_web.xml");
            }
        ...
        // Ear
            ...
            URL earResURL = ClosedTopicSubscriberTests.class.getResource("/com/sun/ts/tests/jms/core/closedTopicSubscriber/");
            if(earResURL != null) {
              closedTopicSubscriber_servlet_vehicle_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = ClosedTopicSubscriberTests.class.getResource("/com/sun/ts/tests/jms/core/closedTopicSubscriber/.ear.sun-application.xml");
            if(earResURL != null) {
              closedTopicSubscriber_servlet_vehicle_ear.addAsManifestResource(earResURL, "sun-application.xml");
            }
            // Call the archive processor
            archiveProcessor.processEarArchive(closedTopicSubscriber_servlet_vehicle_ear, ClosedTopicSubscriberTests.class, earResURL);

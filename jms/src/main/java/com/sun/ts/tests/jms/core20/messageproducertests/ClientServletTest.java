...
import com.sun.ts.tests.jms.core20.messageproducertests.Client;
import java.net.URL;
    ...
    static final String VEHICLE_ARCHIVE = "messageproducertests_servlet_vehicle";
        ...
        */
        ...
        // War
            ...
            if(warResURL != null) {
              messageproducertests_servlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/servlet_vehicle_web.xml");
            }
            warResURL = Client.class.getResource("/com/sun/ts/tests/jms/core20/messageproducertests/servlet_vehicle_web.xml");
            if(warResURL != null) {
              messageproducertests_servlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/servlet_vehicle_web.xml");
            }
        ...
        // Ear
            ...
            URL earResURL = Client.class.getResource("/com/sun/ts/tests/jms/core20/messageproducertests/");
            if(earResURL != null) {
              messageproducertests_servlet_vehicle_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client.class.getResource("/com/sun/ts/tests/jms/core20/messageproducertests/.ear.sun-application.xml");
            if(earResURL != null) {
              messageproducertests_servlet_vehicle_ear.addAsManifestResource(earResURL, "sun-application.xml");
            }
            // Call the archive processor
            archiveProcessor.processEarArchive(messageproducertests_servlet_vehicle_ear, Client.class, earResURL);

...
import com.sun.ts.tests.jms.ee20.ra.activationconfig.topic.selectorautociddurable.descriptor.Client;
import java.net.URL;
    ...
    /**
        ...
        */
        ...
        // Client
            ...
            URL resURL = Client.class.getResource("com/sun/ts/tests/jms/ee20/ra/activationconfig/topic/selectorautociddurable/descriptor/topic_selectorautociddurable_descriptor_client.xml");
            if(resURL != null) {
        ...
        // Ear
            ...
            URL earResURL = Client.class.getResource("/com/sun/ts/tests/jms/ee20/ra/activationconfig/topic/selectorautociddurable/descriptor/application.xml");
            if(earResURL != null) {

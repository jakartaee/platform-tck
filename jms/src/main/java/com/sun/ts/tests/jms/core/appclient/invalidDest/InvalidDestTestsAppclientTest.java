    ...
    static final String VEHICLE_ARCHIVE = "invalidDest_appclient_vehicle";
        ...
        */
        ...
        // Client
            ...
            URL resURL = InvalidDestTests.class.getResource("/com/sun/ts/tests/common/vehicle/appclient/appclient_vehicle_client.xml");
            if(resURL != null) {
              invalidDest_appclient_vehicle_client.addAsManifestResource(resURL, "application-client.xml");
            }
            // The sun-application-client.xml file need to be added or should this be in in the vendor Arquillian extension?
            resURL = InvalidDestTests.class.getResource("//com/sun/ts/tests/common/vehicle/appclient/appclient_vehicle_client.jar.sun-application-client.xml");
            if(resURL != null) {
              invalidDest_appclient_vehicle_client.addAsManifestResource(resURL, "application-client.xml");
            }
        ...
        // Ear
            ...
            // Call the archive processor
            archiveProcessor.processEarArchive(invalidDest_appclient_vehicle_ear, InvalidDestTests.class, earResURL);

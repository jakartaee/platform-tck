    ...
    static final String VEHICLE_ARCHIVE = "topicConnection_appclient_vehicle";
        ...
        */
        ...
        // Client
            ...
            URL resURL = TopicConnectionTests.class.getResource("/com/sun/ts/tests/common/vehicle/appclient/appclient_vehicle_client.xml");
            if(resURL != null) {
              topicConnection_appclient_vehicle_client.addAsManifestResource(resURL, "application-client.xml");
            }
            // The sun-application-client.xml file need to be added or should this be in in the vendor Arquillian extension?
            resURL = TopicConnectionTests.class.getResource("//com/sun/ts/tests/common/vehicle/appclient/appclient_vehicle_client.jar.sun-application-client.xml");
            if(resURL != null) {
              topicConnection_appclient_vehicle_client.addAsManifestResource(resURL, "application-client.xml");
            }
        ...
        // Ear
            ...
            if(earResURL != null) {
              topicConnection_appclient_vehicle_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = TopicConnectionTests.class.getResource("/com/sun/ts/tests/jms/core/topicConnection/.ear.sun-application.xml");
            if(earResURL != null) {
              topicConnection_appclient_vehicle_ear.addAsManifestResource(earResURL, "sun-application.xml");
            }
            // Call the archive processor
            archiveProcessor.processEarArchive(topicConnection_appclient_vehicle_ear, TopicConnectionTests.class, earResURL);

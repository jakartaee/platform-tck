...
public class MDBClient extends Client {
	 ...
	 *
	 * @test_Strategy: Invoke an bmt mdb by writing to MDB_QUEUE_BMT. The mdb begins
	 * a jakarta.transaction.UserTransaction, then attempts a MessageDrivenContext
	 * getRollBackOnly() method. Return verification message that a
	 ...
	 * @test_Strategy: Invoke an bmt mdb by writing to MDB_QUEUE_BMT. The mdb begins
	 * a jakarta.transaction.UserTransaction, then attempts a MessageDrivenContext
	 * setRollBackOnly() method. Return verification message that a
	 * java.lang.IllegalStateException was thrown.
	 *
	 */
	@Test
	 ...
	 * attempts a MessageDrivenContext setRollBackOnly() method. Return verification
	 ...
	 *
	 * @test_Strategy: Invoke an cmt mdb by writing to MDB_QUEUETXNS_CMT. The mdb
	 * attempts a MessageDrivenContext getRollBackOnly() method. Return verification
	 * message that a java.lang.IllegalStateException was thrown.
	 *
	 */
	@Test
	 ...
	 *
	 * @test_Strategy: Invoke an bmt mdb by writing to MDB_QUEUE_BMT. The mdb begins
	 * a jakarta.transaction.UserTransaction. The mdb begins another

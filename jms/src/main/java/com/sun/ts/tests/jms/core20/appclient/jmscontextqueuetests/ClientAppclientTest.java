...
import com.sun.ts.tests.jms.core20.appclient.jmscontextqueuetests.Client;
import java.net.URL;
    ...
    static final String VEHICLE_ARCHIVE = "jmscontextqueuetests_appclient_vehicle";
        ...
        */
        ...
        // Ear
            ...
            URL earResURL = Client.class.getResource("/com/sun/ts/tests/jms/core20/appclient/jmscontextqueuetests/");
            if(earResURL != null) {
              jmscontextqueuetests_appclient_vehicle_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client.class.getResource("/com/sun/ts/tests/jms/core20/appclient/jmscontextqueuetests/.ear.sun-application.xml");
            if(earResURL != null) {
              jmscontextqueuetests_appclient_vehicle_ear.addAsManifestResource(earResURL, "sun-application.xml");
            }
            // Call the archive processor
            archiveProcessor.processEarArchive(jmscontextqueuetests_appclient_vehicle_ear, Client.class, earResURL);

...
import com.sun.ts.tests.jms.core20.appclient.jmsconsumertests.Client;
import java.net.URL;
    ...
    static final String VEHICLE_ARCHIVE = "jmsconsumertests_appclient_vehicle";
        ...
        */
        ...
        // Ear
            ...
            URL earResURL = Client.class.getResource("/com/sun/ts/tests/jms/core20/appclient/jmsconsumertests/");
            if(earResURL != null) {
              jmsconsumertests_appclient_vehicle_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client.class.getResource("/com/sun/ts/tests/jms/core20/appclient/jmsconsumertests/.ear.sun-application.xml");
            if(earResURL != null) {

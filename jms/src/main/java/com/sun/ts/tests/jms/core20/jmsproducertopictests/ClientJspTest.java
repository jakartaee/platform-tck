...
public class ClientJspTest extends com.sun.ts.tests.jms.core20.jmsproducertopictests.Client {
    static final String VEHICLE_ARCHIVE = "jmsproducertopictests_jsp_vehicle";
        ...
        /com/sun/ts/tests/jms/core20/jmsproducertopictests/jsp_vehicle_web.xml
        ...
        */
        ...
        // War
            ...
            WebArchive jmsproducertopictests_jsp_vehicle_web = ShrinkWrap.create(WebArchive.class, "jmsproducertopictests_jsp_vehicle_web.war");
            // The class files
            jmsproducertopictests_jsp_vehicle_web.addClasses(
            ...
            if(warResURL != null) {
              jmsproducertopictests_jsp_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = Client.class.getResource("//com/sun/ts/tests/common/vehicle/jsp/jsp_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
              jmsproducertopictests_jsp_vehicle_web.addAsWebInfResource(warResURL, "sun-web.xml");
            }
            ...
            if(warResURL != null) {
              jmsproducertopictests_jsp_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/jsp_vehicle_web.xml");
            }
            ...
            if(warResURL != null) {
              jmsproducertopictests_jsp_vehicle_web.addAsWebResource(warResURL, "/client.html");
            }
            warResURL = Client.class.getResource("/com/sun/ts/tests/common/vehicle/jsp/contentRoot/jsp_vehicle.jsp");
            if(warResURL != null) {
              jmsproducertopictests_jsp_vehicle_web.addAsWebResource(warResURL, "/jsp_vehicle.jsp");
            }

           // Call the archive processor
           archiveProcessor.processWebArchive(jmsproducertopictests_jsp_vehicle_web, Client.class, warResURL);

        // Ear
            EnterpriseArchive jmsproducertopictests_jsp_vehicle_ear = ShrinkWrap.create(EnterpriseArchive.class, "jmsproducertopictests_jsp_vehicle.ear");

            // Any libraries added to the ear

            // The component jars built by the package target
            jmsproducertopictests_jsp_vehicle_ear.addAsModule(jmsproducertopictests_jsp_vehicle_web);
            ...
            if(earResURL != null) {
              jmsproducertopictests_jsp_vehicle_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client.class.getResource("/com/sun/ts/tests/jms/core20/jmsproducertopictests/.ear.sun-application.xml");
            if(earResURL != null) {
              jmsproducertopictests_jsp_vehicle_ear.addAsManifestResource(earResURL, "sun-application.xml");
            }
            // Call the archive processor
            archiveProcessor.processEarArchive(jmsproducertopictests_jsp_vehicle_ear, Client.class, earResURL);
        return jmsproducertopictests_jsp_vehicle_ear;
        }

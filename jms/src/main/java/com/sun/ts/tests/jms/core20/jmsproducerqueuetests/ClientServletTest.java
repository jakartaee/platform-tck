    ...
    static final String VEHICLE_ARCHIVE = "jmsproducerqueuetests_servlet_vehicle";
        ...
        */
        ...
        // War
            ...
            if(warResURL != null) {
              jmsproducerqueuetests_servlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/servlet_vehicle_web.xml");
            }
            warResURL = Client.class.getResource("/com/sun/ts/tests/jms/core20/jmsproducerqueuetests/servlet_vehicle_web.xml");
            if(warResURL != null) {
              jmsproducerqueuetests_servlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/servlet_vehicle_web.xml");
            }
        ...
        // Ear
            ...
            if(earResURL != null) {
              jmsproducerqueuetests_servlet_vehicle_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client.class.getResource("/com/sun/ts/tests/jms/core20/jmsproducerqueuetests/.ear.sun-application.xml");
            if(earResURL != null) {
              jmsproducerqueuetests_servlet_vehicle_ear.addAsManifestResource(earResURL, "sun-application.xml");
            }
            // Call the archive processor
            archiveProcessor.processEarArchive(jmsproducerqueuetests_servlet_vehicle_ear, Client.class, earResURL);

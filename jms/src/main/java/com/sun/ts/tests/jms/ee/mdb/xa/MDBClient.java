...
public class MDBClient extends Client {
	...
	public void setup() throws Exception {
		...
		super.setup(new String[0], props);
	 ...
	 * @testName: Test1
	 *
	 * @assertion_ids: JMS:SPEC:13; JMS:SPEC:129; JMS:SPEC:246.10; JMS:JAVADOC:371;
	 * EJB:SPEC:586.1; EJB:SPEC:586.1.1; EJB:SPEC:583.2; EJB:SPEC:583.2.1;
	 *
	 ...
	 * tests if this is the first time this message was received by checking the
	 * JMSRedelivered flag. Send a msg, rollback. Second time the msg is received is
	 * a pass! If the message is not requeued and received again this is a failure.
	 */
	@Test
	 ...
	 * transaction, sends a msg to MDB_QUEUE. mdb commits. Verify that MDB_QUEUE has
	 * the msg sent. .
	 *
	 */
	@Test
	 ...
	 * @assertion_ids: EJB:SPEC:543; EJB:SPEC:543.1;
	 *
	 * @test_Strategy: Invoke an bmt mdb by writing to MDB_DURABLE_BMT. mdb begins a
	 * transaction, sends a msg to MDB_QUEUE_REPLY. mdb commits. Verify that
	 ...
	 *
	 * @test_Strategy: Invoke an bmt mdb by writing to MDB_QUEUE_BMT. mdb begins a
	 * transaction, sends a msg to MDB_QUEUE. then rollsback. Verify the 2nd msg is
	 * received.
	 * 
	 *
	 */
	 ...
	 *
	 * @test_Strategy: Invoke an bmt mdb by writing to MDB_DURABLE_BMT. mdb begins a
	 * transaction, sends a msg to MDB_QUEUE_REPLY. then rollsback. Send msg and
	 ...
	 * @test_Strategy: Send a test message to a container managed queue. The mdb
	 * tests if this is the first time this message was received by checking the
	 * JMSRedelivered flag. Send a msg, rollback. send a second message, pass if 2nd
	 * msg received.
	 * 
	 *
	 */

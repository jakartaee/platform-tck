    ...
    static final String VEHICLE_ARCHIVE = "topicMsgProperties_servlet_vehicle";
        ...
        */
        ...
        // War
            ...
            URL warResURL = TopicPropertyTests.class.getResource("/com/sun/ts/tests/common/vehicle/servlet/servlet_vehicle_web.xml");
            if(warResURL != null) {
              topicMsgProperties_servlet_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = TopicPropertyTests.class.getResource("//com/sun/ts/tests/common/vehicle/servlet/servlet_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
            ...
            // Web content
            warResURL = TopicPropertyTests.class.getResource("/com/sun/ts/tests/common/vehicle/servlet/servlet_vehicle_web.xml");
            if(warResURL != null) {
              topicMsgProperties_servlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/servlet_vehicle_web.xml");
            }
            warResURL = TopicPropertyTests.class.getResource("/com/sun/ts/tests/jms/core/topicMsgProperties/servlet_vehicle_web.xml");
            if(warResURL != null) {
              topicMsgProperties_servlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/servlet_vehicle_web.xml");
            }
        ...
        // Ear
            ...
            URL earResURL = TopicPropertyTests.class.getResource("/com/sun/ts/tests/jms/core/topicMsgProperties/");
            if(earResURL != null) {
              topicMsgProperties_servlet_vehicle_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = TopicPropertyTests.class.getResource("/com/sun/ts/tests/jms/core/topicMsgProperties/.ear.sun-application.xml");
            if(earResURL != null) {
              topicMsgProperties_servlet_vehicle_ear.addAsManifestResource(earResURL, "sun-application.xml");
            }
            // Call the archive processor
            archiveProcessor.processEarArchive(topicMsgProperties_servlet_vehicle_ear, TopicPropertyTests.class, earResURL);

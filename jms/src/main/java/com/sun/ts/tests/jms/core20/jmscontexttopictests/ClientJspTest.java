    ...
    static final String VEHICLE_ARCHIVE = "jmscontexttopictests_jsp_vehicle";
        ...
        */
        ...
        // War
            ...
            if(warResURL != null) {
              jmscontexttopictests_jsp_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/jsp_vehicle_web.xml");
            }
        ...
        // Ear
            ...
            if(earResURL != null) {
              jmscontexttopictests_jsp_vehicle_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client.class.getResource("/com/sun/ts/tests/jms/core20/jmscontexttopictests/.ear.sun-application.xml");
            if(earResURL != null) {
              jmscontexttopictests_jsp_vehicle_ear.addAsManifestResource(earResURL, "sun-application.xml");
            }
            // Call the archive processor
            archiveProcessor.processEarArchive(jmscontexttopictests_jsp_vehicle_ear, Client.class, earResURL);

...
import com.sun.ts.tests.jms.core.appclient.closedQueueConnection.ClosedQueueConnectionTests;
import java.net.URL;
    ...
    static final String VEHICLE_ARCHIVE = "closedQueueConnection_appclient_vehicle";
        ...
        */
        ...
        // Ear
            ...
            URL earResURL = ClosedQueueConnectionTests.class.getResource("/com/sun/ts/tests/jms/core/appclient/closedQueueConnection/");
            if(earResURL != null) {
              closedQueueConnection_appclient_vehicle_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = ClosedQueueConnectionTests.class.getResource("/com/sun/ts/tests/jms/core/appclient/closedQueueConnection/.ear.sun-application.xml");
            if(earResURL != null) {

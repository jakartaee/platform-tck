...
import com.sun.ts.tests.jms.core.topicMsgHeaders.TopicHeaderTests;
import java.net.URL;
    ...
    static final String VEHICLE_ARCHIVE = "topicMsgHeaders_servlet_vehicle";
        ...
        */
        ...
        // War
            ...
            URL warResURL = TopicHeaderTests.class.getResource("/com/sun/ts/tests/common/vehicle/servlet/servlet_vehicle_web.xml");
            if(warResURL != null) {
              topicMsgHeaders_servlet_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = TopicHeaderTests.class.getResource("//com/sun/ts/tests/common/vehicle/servlet/servlet_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
            ...
            // Web content
            warResURL = TopicHeaderTests.class.getResource("/com/sun/ts/tests/common/vehicle/servlet/servlet_vehicle_web.xml");
            if(warResURL != null) {
              topicMsgHeaders_servlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/servlet_vehicle_web.xml");
            }
            warResURL = TopicHeaderTests.class.getResource("/com/sun/ts/tests/jms/core/topicMsgHeaders/servlet_vehicle_web.xml");
            if(warResURL != null) {
              topicMsgHeaders_servlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/servlet_vehicle_web.xml");
            }
        ...
        // Ear
            ...
            URL earResURL = TopicHeaderTests.class.getResource("/com/sun/ts/tests/jms/core/topicMsgHeaders/");
            if(earResURL != null) {
              topicMsgHeaders_servlet_vehicle_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = TopicHeaderTests.class.getResource("/com/sun/ts/tests/jms/core/topicMsgHeaders/.ear.sun-application.xml");
            if(earResURL != null) {
              topicMsgHeaders_servlet_vehicle_ear.addAsManifestResource(earResURL, "sun-application.xml");
            }
            // Call the archive processor
            archiveProcessor.processEarArchive(topicMsgHeaders_servlet_vehicle_ear, TopicHeaderTests.class, earResURL);

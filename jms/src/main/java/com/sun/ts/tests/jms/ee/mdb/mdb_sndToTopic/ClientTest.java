...
import com.sun.ts.tests.jms.ee.mdb.mdb_sndToTopic.MDBClient;
import java.net.URL;
    ...
    /**
        ...
        */
        ...
        // Client
            ...
            URL resURL = MDBClient.class.getResource("com/sun/ts/tests/jms/ee/mdb/mdb_sndToTopic/mdb_sndToTopic_client.xml");
            if(resURL != null) {
              mdb_sndToTopic_client.addAsManifestResource(resURL, "application-client.xml");
            }
            // The sun-application-client.xml file need to be added or should this be in in the vendor Arquillian extension?
            resURL = MDBClient.class.getResource("/com/sun/ts/tests/jms/ee/mdb/mdb_sndToTopic/mdb_sndToTopic_client.jar.sun-application-client.xml");
            if(resURL != null) {
              mdb_sndToTopic_client.addAsManifestResource(resURL, "application-client.xml");
            }
        ...
        // Ejb
            ...
            URL ejbResURL = MDBClient.class.getResource("/com/sun/ts/tests/jms/ee/mdb/mdb_sndToTopic/mdb_sndToTopic_ejb.xml");
            if(ejbResURL != null) {
              mdb_sndToTopic_ejb.addAsManifestResource(ejbResURL, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL = MDBClient.class.getResource("/com/sun/ts/tests/jms/ee/mdb/mdb_sndToTopic/mdb_sndToTopic_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL != null) {
        ...
        // Ear
            ...
            URL earResURL = MDBClient.class.getResource("/com/sun/ts/tests/jms/ee/mdb/mdb_sndToTopic/");
            if(earResURL != null) {
              mdb_sndToTopic_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = MDBClient.class.getResource("/com/sun/ts/tests/jms/ee/mdb/mdb_sndToTopic/.ear.sun-application.xml");
            if(earResURL != null) {
              mdb_sndToTopic_ear.addAsManifestResource(earResURL, "sun-application.xml");
            }
            // Call the archive processor
            archiveProcessor.processEarArchive(mdb_sndToTopic_ear, MDBClient.class, earResURL);

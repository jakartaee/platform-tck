    ...
    static final String VEHICLE_ARCHIVE = "jmsconsumertests_servlet_vehicle";
        ...
        */
        ...
        // War
            ...
            if(warResURL != null) {
              jmsconsumertests_servlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/servlet_vehicle_web.xml");
            }
            warResURL = Client.class.getResource("/com/sun/ts/tests/jms/core20/jmsconsumertests/servlet_vehicle_web.xml");
            if(warResURL != null) {
              jmsconsumertests_servlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/servlet_vehicle_web.xml");
            }
        ...
        // Ear
            ...
            // Call the archive processor
            archiveProcessor.processEarArchive(jmsconsumertests_servlet_vehicle_ear, Client.class, earResURL);

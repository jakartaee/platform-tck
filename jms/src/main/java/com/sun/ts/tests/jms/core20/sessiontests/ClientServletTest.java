...
import com.sun.ts.tests.jms.core20.sessiontests.Client;
import java.net.URL;
    ...
    static final String VEHICLE_ARCHIVE = "sessiontests_servlet_vehicle";
        ...
        */
        ...
        // War
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/jms/core20/sessiontests/servlet_vehicle_web.xml");
            if(warResURL != null) {
              sessiontests_servlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/servlet_vehicle_web.xml");
            }
        ...
        // Ear
            ...
            URL earResURL = Client.class.getResource("/com/sun/ts/tests/jms/core20/sessiontests/");
            if(earResURL != null) {
              sessiontests_servlet_vehicle_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client.class.getResource("/com/sun/ts/tests/jms/core20/sessiontests/.ear.sun-application.xml");
            if(earResURL != null) {
              sessiontests_servlet_vehicle_ear.addAsManifestResource(earResURL, "sun-application.xml");
            }
            // Call the archive processor
            archiveProcessor.processEarArchive(sessiontests_servlet_vehicle_ear, Client.class, earResURL);

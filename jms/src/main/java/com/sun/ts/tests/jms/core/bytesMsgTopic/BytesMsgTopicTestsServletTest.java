...
public class BytesMsgTopicTestsServletTest extends com.sun.ts.tests.jms.core.bytesMsgTopic.BytesMsgTopicTests {
    static final String VEHICLE_ARCHIVE = "bytesMsgTopic_servlet_vehicle";
        ...
        /com/sun/ts/tests/jms/core/bytesMsgTopic/servlet_vehicle_web.xml
        ...
        */
        ...
        // War
            ...
            URL warResURL = BytesMsgTopicTests.class.getResource("/com/sun/ts/tests/jms/core/bytesMsgTopic/servlet_vehicle_web.xml");
            if(warResURL != null) {
              bytesMsgTopic_servlet_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = BytesMsgTopicTests.class.getResource("/com/sun/ts/tests/jms/core/bytesMsgTopic/bytesMsgTopic_servlet_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
            ...
            // // Web content
            // warResURL = BytesMsgTopicTests.class.getResource("/com/sun/ts/tests/common/vehicle/servlet/servlet_vehicle_web.xml");
            // if(warResURL != null) {
            //   bytesMsgTopic_servlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/servlet_vehicle_web.xml");
            // }
            // warResURL = BytesMsgTopicTests.class.getResource("/com/sun/ts/tests/jms/core/bytesMsgTopic/servlet_vehicle_web.xml");
            // if(warResURL != null) {
            //   bytesMsgTopic_servlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/servlet_vehicle_web.xml");
            // }

           // Call the archive processor
           archiveProcessor.processWebArchive(bytesMsgTopic_servlet_vehicle_web, BytesMsgTopicTests.class, warResURL);
        ...
        // Ear
            ...
            // }
            // // Call the archive processor
            // archiveProcessor.processEarArchive(bytesMsgTopic_servlet_vehicle_ear, BytesMsgTopicTests.class, earResURL);

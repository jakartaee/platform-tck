    ...
    static final String VEHICLE_ARCHIVE = "jmsproducertopictests_servlet_vehicle";
        ...
        */
        ...
        // War
            ...
            if(warResURL != null) {
              jmsproducertopictests_servlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/servlet_vehicle_web.xml");
            }
            warResURL = Client.class.getResource("/com/sun/ts/tests/jms/core20/jmsproducertopictests/servlet_vehicle_web.xml");
            if(warResURL != null) {
              jmsproducertopictests_servlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/servlet_vehicle_web.xml");
            }
        ...
        // Ear
            ...
            if(earResURL != null) {
              jmsproducertopictests_servlet_vehicle_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client.class.getResource("/com/sun/ts/tests/jms/core20/jmsproducertopictests/.ear.sun-application.xml");
            if(earResURL != null) {
              jmsproducertopictests_servlet_vehicle_ear.addAsManifestResource(earResURL, "sun-application.xml");
            }
            // Call the archive processor
            archiveProcessor.processEarArchive(jmsproducertopictests_servlet_vehicle_ear, Client.class, earResURL);

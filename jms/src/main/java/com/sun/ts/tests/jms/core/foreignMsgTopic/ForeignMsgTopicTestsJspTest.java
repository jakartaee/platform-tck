    ...
    static final String VEHICLE_ARCHIVE = "foreignMsgTopic_jsp_vehicle";
        ...
        */
        ...
        // War
            ...
            URL warResURL = ForeignMsgTopicTests.class.getResource("/com/sun/ts/tests/common/vehicle/jsp/jsp_vehicle_web.xml");
            if(warResURL != null) {
              foreignMsgTopic_jsp_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = ForeignMsgTopicTests.class.getResource("//com/sun/ts/tests/common/vehicle/jsp/jsp_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
            ...
            // Web content
            warResURL = ForeignMsgTopicTests.class.getResource("/com/sun/ts/tests/common/vehicle/jsp/jsp_vehicle_web.xml");
            if(warResURL != null) {
              foreignMsgTopic_jsp_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/jsp_vehicle_web.xml");
            }
        ...
        // Ear
            ...
            if(earResURL != null) {
              foreignMsgTopic_jsp_vehicle_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = ForeignMsgTopicTests.class.getResource("/com/sun/ts/tests/jms/core/foreignMsgTopic/.ear.sun-application.xml");
            if(earResURL != null) {
              foreignMsgTopic_jsp_vehicle_ear.addAsManifestResource(earResURL, "sun-application.xml");
            }
            // Call the archive processor
            archiveProcessor.processEarArchive(foreignMsgTopic_jsp_vehicle_ear, ForeignMsgTopicTests.class, earResURL);

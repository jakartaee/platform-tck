    ...
    static final String VEHICLE_ARCHIVE = "sessiontests_servlet_vehicle";
        ...
        */
        ...
        // War
            ...
            URL warResURL = SessionTests.class.getResource("/com/sun/ts/tests/common/vehicle/servlet/servlet_vehicle_web.xml");
            if(warResURL != null) {
              sessiontests_servlet_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = SessionTests.class.getResource("//com/sun/ts/tests/common/vehicle/servlet/servlet_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
            ...
            // Web content
            warResURL = SessionTests.class.getResource("/com/sun/ts/tests/common/vehicle/servlet/servlet_vehicle_web.xml");
            if(warResURL != null) {
              sessiontests_servlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/servlet_vehicle_web.xml");
            }
            warResURL = SessionTests.class.getResource("/com/sun/ts/tests/jms/core/sessiontests/servlet_vehicle_web.xml");
            if(warResURL != null) {
              sessiontests_servlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/servlet_vehicle_web.xml");
            }
        ...
        // Ear
            ...
            if(earResURL != null) {
              sessiontests_servlet_vehicle_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = SessionTests.class.getResource("/com/sun/ts/tests/jms/core/sessiontests/.ear.sun-application.xml");
            if(earResURL != null) {
              sessiontests_servlet_vehicle_ear.addAsManifestResource(earResURL, "sun-application.xml");
            }
            // Call the archive processor
            archiveProcessor.processEarArchive(sessiontests_servlet_vehicle_ear, SessionTests.class, earResURL);

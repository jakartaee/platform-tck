...
import com.sun.ts.tests.jms.core.closedTopicSession.ClosedTopicSessionTests;
import java.net.URL;
    ...
    static final String VEHICLE_ARCHIVE = "closedTopicSession_servlet_vehicle";
        ...
        */
        ...
        // War
            ...
            URL warResURL = ClosedTopicSessionTests.class.getResource("/com/sun/ts/tests/common/vehicle/servlet/servlet_vehicle_web.xml");
            if(warResURL != null) {
              closedTopicSession_servlet_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = ClosedTopicSessionTests.class.getResource("//com/sun/ts/tests/common/vehicle/servlet/servlet_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
            ...
            // Web content
            warResURL = ClosedTopicSessionTests.class.getResource("/com/sun/ts/tests/common/vehicle/servlet/servlet_vehicle_web.xml");
            if(warResURL != null) {
              closedTopicSession_servlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/servlet_vehicle_web.xml");
            }
            warResURL = ClosedTopicSessionTests.class.getResource("/com/sun/ts/tests/jms/core/closedTopicSession/servlet_vehicle_web.xml");
            if(warResURL != null) {
              closedTopicSession_servlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/servlet_vehicle_web.xml");
            }
        ...
        // Ear
            ...
            URL earResURL = ClosedTopicSessionTests.class.getResource("/com/sun/ts/tests/jms/core/closedTopicSession/");
            if(earResURL != null) {
              closedTopicSession_servlet_vehicle_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = ClosedTopicSessionTests.class.getResource("/com/sun/ts/tests/jms/core/closedTopicSession/.ear.sun-application.xml");
            if(earResURL != null) {
              closedTopicSession_servlet_vehicle_ear.addAsManifestResource(earResURL, "sun-application.xml");
            }
            // Call the archive processor
            archiveProcessor.processEarArchive(closedTopicSession_servlet_vehicle_ear, ClosedTopicSessionTests.class, earResURL);

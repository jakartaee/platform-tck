    ...
    static final String VEHICLE_ARCHIVE = "objectMsgQueue_servlet_vehicle";
        ...
        */
        ...
        // War
            ...
            URL warResURL = ObjectMsgQueueTests.class.getResource("/com/sun/ts/tests/common/vehicle/servlet/servlet_vehicle_web.xml");
            if(warResURL != null) {
              objectMsgQueue_servlet_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = ObjectMsgQueueTests.class.getResource("//com/sun/ts/tests/common/vehicle/servlet/servlet_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
            ...
            // Web content
            warResURL = ObjectMsgQueueTests.class.getResource("/com/sun/ts/tests/common/vehicle/servlet/servlet_vehicle_web.xml");
            if(warResURL != null) {
              objectMsgQueue_servlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/servlet_vehicle_web.xml");
            }
            warResURL = ObjectMsgQueueTests.class.getResource("/com/sun/ts/tests/jms/core/objectMsgQueue/servlet_vehicle_web.xml");
            if(warResURL != null) {
              objectMsgQueue_servlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/servlet_vehicle_web.xml");
            }
        ...
        // Ear
            ...
            URL earResURL = ObjectMsgQueueTests.class.getResource("/com/sun/ts/tests/jms/core/objectMsgQueue/");
            if(earResURL != null) {
              objectMsgQueue_servlet_vehicle_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = ObjectMsgQueueTests.class.getResource("/com/sun/ts/tests/jms/core/objectMsgQueue/.ear.sun-application.xml");
            if(earResURL != null) {
              objectMsgQueue_servlet_vehicle_ear.addAsManifestResource(earResURL, "sun-application.xml");
            }
            // Call the archive processor
            archiveProcessor.processEarArchive(objectMsgQueue_servlet_vehicle_ear, ObjectMsgQueueTests.class, earResURL);

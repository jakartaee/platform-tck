...
import com.sun.ts.tests.jms.core.appclient.closedQueueReceiver.ClosedQueueReceiverTests;
import java.net.URL;
    ...
    static final String VEHICLE_ARCHIVE = "closedQueueReceiver_appclient_vehicle";
        ...
        */
        ...
        // Ear
            ...
            URL earResURL = ClosedQueueReceiverTests.class.getResource("/com/sun/ts/tests/jms/core/appclient/closedQueueReceiver/");
            if(earResURL != null) {
              closedQueueReceiver_appclient_vehicle_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = ClosedQueueReceiverTests.class.getResource("/com/sun/ts/tests/jms/core/appclient/closedQueueReceiver/.ear.sun-application.xml");
            if(earResURL != null) {

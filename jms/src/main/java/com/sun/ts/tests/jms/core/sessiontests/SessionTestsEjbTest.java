    ...
    static final String VEHICLE_ARCHIVE = "sessiontests_ejb_vehicle";
        ...
        */
        ...
        // Client
            ...
            resURL = SessionTests.class.getResource("//com/sun/ts/tests/common/vehicle/ejb/ejb_vehicle_client.jar.sun-application-client.xml");
            if(resURL != null) {
              sessiontests_ejb_vehicle_client.addAsManifestResource(resURL, "application-client.xml");
            }
        ...
        // Ejb
            ...
            URL ejbResURL = SessionTests.class.getResource("//com/sun/ts/tests/common/vehicle/ejb/ejb_vehicle_ejb.xml");
            if(ejbResURL != null) {
              sessiontests_ejb_vehicle_ejb.addAsManifestResource(ejbResURL, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL = SessionTests.class.getResource("//com/sun/ts/tests/common/vehicle/ejb/ejb_vehicle_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL != null) {
        ...
        // Ear
            ...
            if(earResURL != null) {
              sessiontests_ejb_vehicle_ear.addAsManifestResource(earResURL, "application.xml");
            }
            ...
            // Call the archive processor
            archiveProcessor.processEarArchive(sessiontests_ejb_vehicle_ear, SessionTests.class, earResURL);

    ...
    static final String VEHICLE_ARCHIVE = "closedTopicSubscriber_jsp_vehicle";
        ...
        */
        ...
        // War
            ...
            URL warResURL = ClosedTopicSubscriberTests.class.getResource("/com/sun/ts/tests/common/vehicle/jsp/jsp_vehicle_web.xml");
            if(warResURL != null) {
              closedTopicSubscriber_jsp_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = ClosedTopicSubscriberTests.class.getResource("//com/sun/ts/tests/common/vehicle/jsp/jsp_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
            ...
            // Web content
            warResURL = ClosedTopicSubscriberTests.class.getResource("/com/sun/ts/tests/common/vehicle/jsp/jsp_vehicle_web.xml");
            if(warResURL != null) {
              closedTopicSubscriber_jsp_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/jsp_vehicle_web.xml");
            }
        ...
        // Ear
            ...
            if(earResURL != null) {
              closedTopicSubscriber_jsp_vehicle_ear.addAsManifestResource(earResURL, "application.xml");
            }
            ...
            if(earResURL != null) {
              closedTopicSubscriber_jsp_vehicle_ear.addAsManifestResource(earResURL, "sun-application.xml");
            }
            // Call the archive processor
            archiveProcessor.processEarArchive(closedTopicSubscriber_jsp_vehicle_ear, ClosedTopicSubscriberTests.class, earResURL);

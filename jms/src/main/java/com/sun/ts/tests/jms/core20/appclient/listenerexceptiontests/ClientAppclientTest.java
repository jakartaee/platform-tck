    ...
    static final String VEHICLE_ARCHIVE = "listenerexceptiontests_appclient_vehicle";
        ...
        */
        ...
        // Ear
            ...
            URL earResURL = Client.class.getResource("/com/sun/ts/tests/jms/core20/appclient/listenerexceptiontests/");
            if(earResURL != null) {
              listenerexceptiontests_appclient_vehicle_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client.class.getResource("/com/sun/ts/tests/jms/core20/appclient/listenerexceptiontests/.ear.sun-application.xml");
            if(earResURL != null) {

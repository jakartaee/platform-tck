...
public class ClientServletTest extends com.sun.ts.tests.jms.ee20.resourcedefs.descriptor.Client {
    static final String VEHICLE_ARCHIVE = "resourcedefs_descriptor_servlet_vehicle";
        ...
        /com/sun/ts/tests/jms/ee20/resourcedefs/descriptor/servlet_vehicle_web.xml
        ...
        */
        ...
        // War
            ...
            WebArchive resourcedefs_descriptor_servlet_vehicle_web = ShrinkWrap.create(WebArchive.class, "resourcedefs_descriptor_servlet_vehicle_web.war");
            // The class files
            resourcedefs_descriptor_servlet_vehicle_web.addClasses(
            ...
            if(warResURL != null) {
              resourcedefs_descriptor_servlet_vehicle_web.addAsWebInfResource(warResURL, "sun-web.xml");
            }
        ...
        // Ear
            EnterpriseArchive resourcedefs_descriptor_servlet_vehicle_ear = ShrinkWrap.create(EnterpriseArchive.class, "resourcedefs_descriptor_servlet_vehicle.ear");

            // Any libraries added to the ear

            // The component jars built by the package target
            resourcedefs_descriptor_servlet_vehicle_ear.addAsModule(resourcedefs_descriptor_servlet_vehicle_web);



            // The application.xml descriptor
            URL earResURL = Client.class.getResource("/com/sun/ts/tests/jms/ee20/resourcedefs/descriptor/");
            if(earResURL != null) {
              resourcedefs_descriptor_servlet_vehicle_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client.class.getResource("/com/sun/ts/tests/jms/ee20/resourcedefs/descriptor/.ear.sun-application.xml");
            if(earResURL != null) {
              resourcedefs_descriptor_servlet_vehicle_ear.addAsManifestResource(earResURL, "sun-application.xml");
            }
            // Call the archive processor
            archiveProcessor.processEarArchive(resourcedefs_descriptor_servlet_vehicle_ear, Client.class, earResURL);
        return resourcedefs_descriptor_servlet_vehicle_ear;
        }

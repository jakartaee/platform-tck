    ...
    static final String VEHICLE_ARCHIVE = "connectionfactorytests_jsp_vehicle";
        ...
        */
        ...
        // War
            ...
            if(warResURL != null) {
              connectionfactorytests_jsp_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/jsp_vehicle_web.xml");
            }
            warResURL = Client.class.getResource("/com/sun/ts/tests/jms/core20/connectionfactorytests/jsp_vehicle_web.xml");
            if(warResURL != null) {
              connectionfactorytests_jsp_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/jsp_vehicle_web.xml");
            }
        ...
        // Ear
            ...
            URL earResURL = Client.class.getResource("/com/sun/ts/tests/jms/core20/connectionfactorytests/");
            if(earResURL != null) {
              connectionfactorytests_jsp_vehicle_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client.class.getResource("/com/sun/ts/tests/jms/core20/connectionfactorytests/.ear.sun-application.xml");
            if(earResURL != null) {
              connectionfactorytests_jsp_vehicle_ear.addAsManifestResource(earResURL, "sun-application.xml");
            }
            // Call the archive processor
            archiveProcessor.processEarArchive(connectionfactorytests_jsp_vehicle_ear, Client.class, earResURL);

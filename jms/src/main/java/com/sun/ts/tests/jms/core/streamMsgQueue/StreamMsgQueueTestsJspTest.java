    ...
    static final String VEHICLE_ARCHIVE = "streamMsgQueue_jsp_vehicle";
        ...
        */
        ...
        // War
            ...
            URL warResURL = StreamMsgQueueTests.class.getResource("/com/sun/ts/tests/common/vehicle/jsp/jsp_vehicle_web.xml");
            if(warResURL != null) {
              streamMsgQueue_jsp_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = StreamMsgQueueTests.class.getResource("//com/sun/ts/tests/common/vehicle/jsp/jsp_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
            ...
            // Web content
            warResURL = StreamMsgQueueTests.class.getResource("/com/sun/ts/tests/common/vehicle/jsp/jsp_vehicle_web.xml");
            if(warResURL != null) {
              streamMsgQueue_jsp_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/jsp_vehicle_web.xml");
            }
            warResURL = StreamMsgQueueTests.class.getResource("/com/sun/ts/tests/jms/core/streamMsgQueue/jsp_vehicle_web.xml");
            if(warResURL != null) {
              streamMsgQueue_jsp_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/jsp_vehicle_web.xml");
            }
        ...
        // Ear
            ...
            if(earResURL != null) {
              streamMsgQueue_jsp_vehicle_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = StreamMsgQueueTests.class.getResource("/com/sun/ts/tests/jms/core/streamMsgQueue/.ear.sun-application.xml");
            if(earResURL != null) {
              streamMsgQueue_jsp_vehicle_ear.addAsManifestResource(earResURL, "sun-application.xml");
            }
            // Call the archive processor
            archiveProcessor.processEarArchive(streamMsgQueue_jsp_vehicle_ear, StreamMsgQueueTests.class, earResURL);

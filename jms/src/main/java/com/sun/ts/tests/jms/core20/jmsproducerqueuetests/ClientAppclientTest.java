    ...
    static final String VEHICLE_ARCHIVE = "jmsproducerqueuetests_appclient_vehicle";
        ...
        */
        ...
        // Ear
            ...
            if(earResURL != null) {
              jmsproducerqueuetests_appclient_vehicle_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client.class.getResource("/com/sun/ts/tests/jms/core20/jmsproducerqueuetests/.ear.sun-application.xml");
            if(earResURL != null) {
              jmsproducerqueuetests_appclient_vehicle_ear.addAsManifestResource(earResURL, "sun-application.xml");
            }
            // Call the archive processor
            archiveProcessor.processEarArchive(jmsproducerqueuetests_appclient_vehicle_ear, Client.class, earResURL);

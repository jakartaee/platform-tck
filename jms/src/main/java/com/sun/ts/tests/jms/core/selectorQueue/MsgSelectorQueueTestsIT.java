...
public class MsgSelectorQueueTestsIT {
	...
	private static final Logger logger = (Logger) System.getLogger(MsgSelectorQueueTestsIT.class.getName());
	...
	/*
	 * The beginning of the test creates receiver and message. This is broken apart
	 * from the rest of the test so that the user can specify message properties
	 * before sending the message.
	 */
	private void startTest(String selector, String headerValue) throws Exception {
		logger.log(Logger.Level.TRACE, "startTest(): Creating receiver with message selector");

		tempQ = session.createTemporaryQueue();
		qReceiver = session.createReceiver(tempQ, selector);

		logger.log(Logger.Level.TRACE, "Creating message");
	...
	private void finishTestReceive() throws Exception {
		logger.log(Logger.Level.TRACE, "finishTestReceive(): Sending test message");
		msg.setBooleanProperty("first_message", true);
		qSender = session.createSender(tempQ);

		qSender.send(msg);
		logger.log(Logger.Level.TRACE, "Attempt to receive message");
		Message msg1 = qReceiver.receive(jms_timeout);
		logger.log(Logger.Level.TRACE, "Received message: " + msg1);
		...
		if (msg1 == null) {
			...
			logger.log(Logger.Level.INFO, "Received completely unexpected message.");
	...
	private void sendFirstMessage() throws JMSException {
		logger.log(Logger.Level.TRACE, "sendFirstMessage(): Sending message that does not match selector");
	...
	private void finishTest() throws Exception {
		logger.log(Logger.Level.TRACE, "time_out is " + jms_timeout);
		logger.log(Logger.Level.TRACE, "finishTest: Sending message that should match selector");
		msg.setBooleanProperty("second_message", true);
		qSender = session.createSender(tempQ);
		qSender.send(msg);

		logger.log(Logger.Level.TRACE, "Attempt to receive message. Should receive second message only.");
		Message msg1 = qReceiver.receive(jms_timeout);
		logger.log(Logger.Level.TRACE, "Received message: " + msg1);
	...
	public void setup() throws Exception {
		try {
			jms_timeout = Long.parseLong(System.getProperty("jms_timeout"));
			...
			JmsTool tool = new JmsTool(JmsTool.QUEUE_FACTORY, jmsUser, jmsPassword, mode);
			qFactory = tool.getQueueConnectionFactory();
			qConnect = qFactory.createQueueConnection(jmsUser, jmsPassword);
			qConnect.start();

			session = qConnect.createQueueSession(transacted, Session.AUTO_ACKNOWLEDGE);
		} catch (Exception e) {
	...
	public void cleanup() throws Exception {
		try {
			logger.log(Logger.Level.TRACE, " closing connection");
			qConnect.close();
			tempQ = null;
			session.close();
	...
	public void selectorTest03() throws Exception {
		try {
			String selector = "myProp0=" + Long.MIN_VALUE + "L AND myProp1=" + Long.MAX_VALUE + "L";
			String value = ""; // set for JMSType automatically
			logger.log(Logger.Level.TRACE, selector);
	 ...
	 * @assertion_ids: JMS:SPEC:36; JMS:SPEC:55; JMS:SPEC:49; JMS:SPEC:40;
	 * 
	 * @test_Strategy: create receiver with selector containing hexadecimal set msg
	 * properties to include numeric value send message check receipt of message
	 */
	@Test
	 ...
	 * @assertion_ids: JMS:SPEC:36; JMS:SPEC:49; JMS:SPEC:45;
	 * 
	 * @test_Strategy: create receiver with selector containing 'BETWEEN' check for
	 * proper exception
	 */
	@Test
	 ...
	 * 
	 * @test_Strategy: create receiver with selector send message check that message
	 * is not received
	 */
	@Test
	 ...
	 * 
	 * @test_Strategy: create receiver with selector send message with TRUE boolean
	 * property check receipt of message
	 */
	@Test
	 ...
	 * @assertion_ids: JMS:SPEC:36; JMS:SPEC:49; JMS:SPEC:54;
	 * 
	 * @test_Strategy: create receiver with selector send message with FALSE boolean
	 * property check that message is not received
	 */
	@Test
	 ...
	 * @assertion_ids: JMS:SPEC:36; JMS:SPEC:49; JMS:SPEC:54;
	 * 
	 * @test_Strategy: create receiver with selector referenceing null property send
	...
	public void comparisonTest01() throws Exception {
		try {
			String selector = "myProp0 = 'foo' AND " + "myProp1 > 0 AND " + "myProp2 >= 2 AND " + "myProp3 >= 2 AND "
					+ "myProp4 < 5 AND " + "myProp5 <= 6 AND " + "myProp6 <= 6 AND " + "myProp7 <> 7";
			String value = ""; // set for JMSType automatically
	...
	public void comparisonTest02() throws Exception {
		try {
			String selector = "myProp0 = 'foo' OR " + "myProp1 > 0 OR " + "myProp2 >= 2 OR " + "myProp3 < 5 OR "
					+ "myProp4 <= 6 OR " + "myProp5 <> 7";
			String value = ""; // set for JMSType automatically
	 ...
	 * 
	 * @test_Strategy: create receiver with selector containing > and string should
	...
	public void comparisonTest04() throws Exception {
		try {
			...
			logger.log(Logger.Level.TRACE, "Test passed. Received expected exception.");
		} catch (Exception e) {
			TestUtil.printStackTrace(e);
			throw new Exception("test failed");
		}
	 ...
	 * 
	 * @test_Strategy: create receiver with selector containing BETWEEN send message
	 * matching selector check receipt of message
	 */
	@Test
	public void betweenTest1() throws Exception {
		try {
			String selector = "myProp0 BETWEEN 5 and 10 AND " + "myProp1 BETWEEN -1 and 1 AND "
					+ "myProp2 BETWEEN 0 and 2";
			String value = ""; // set for JMSType automatically
	...
	public void betweenTest4() throws Exception {
		try {
			String selector = "myProp0 NOT BETWEEN 5 and 10 OR " + "myProp1 NOT BETWEEN -1 and 1 OR "
					+ "myProp2 NOT BETWEEN 0 and 2";
			String value = ""; // set for JMSType automatically
	 ...
	 * 
	 * @test_Strategy: create receiver with selector containing BETWEEN send message
	 * with property that is not arithmetic check that message is not received
	 */
	@Test
	 ...
	 * @assertion_ids: JMS:SPEC:36; JMS:SPEC:49; JMS:SPEC:65;
	 * 
	 * @test_Strategy: create receiver with selector containing IN send message not
	 ...
	 * @assertion_ids: JMS:SPEC:36; JMS:SPEC:49; JMS:SPEC:65;
	 * 
	 * @test_Strategy: create receiver with selector containing NOT IT send message
	 * matching selector check receipt of message
	 */
	@Test
	 ...
	 * @assertion_ids: JMS:SPEC:36; JMS:SPEC:49; JMS:SPEC:65;
	 * 
	 * @test_Strategy: create receiver with selector containing NOT IN send message
	 * not matching selector check that message is not received
	 */
	@Test
	 ...
	 * @assertion_ids: JMS:SPEC:36; JMS:SPEC:49; JMS:SPEC:65;
	 * 
	 * @test_Strategy: create receiver with selector containing NOT IN msg selector
	 * references an unknown property send message check that message is not
	 * received
	 */
	@Test
	 ...
	 * @assertion_ids: JMS:SPEC:36; JMS:SPEC:49; JMS:SPEC:66;
	 * 
	 * @test_Strategy: create receiver with message selector selector contains LIKE
	 * statement using '_' send message matching selector check receipt of message
	 */
	@Test
	 ...
	 * 
	 * @test_Strategy: create receiver with message selector selector contains LIKE
	 * statement using '%' send message matching selector check receipt of message
	 */
	@Test
	public void likeTest03() throws Exception {
		try {
			String selector = "JMSType LIKE 's%tor' AND " + "myProp0 LIKE '%cd' AND " + "myProp1 LIKE '1%' AND "
					+ "myProp2 LIKE 'AB%CD' AND " + "myProp3 LIKE '%'";
			String value = "selector"; // set for JMSType automatically
	 ...
	 * 
	 * @test_Strategy: create receiver with message selector selector contains LIKE
	 * statement using ESCAPE character send message matching selector check receipt
	 * of message
	 */
	@Test
	 ...
	 * 
	 * @test_Strategy: create receiver with message selector selector contains LIKE
	 * statement using '_' send message not matching selector check that message is
	 * not received
	 */
	@Test
	 ...
	 * 
	 * @test_Strategy: create receiver with message selector selector contains LIKE
	 * statement using '%' send message not matching selector check that message is
	 * not received
	 */
	@Test
	 ...
	 * 
	 * @test_Strategy: create receiver with message selector selector contains LIKE
	 * statement using ESCAPE character send message not matching selector check
	...
	public void likeTest10() throws Exception {
		try {
			String selector = "JMSType NOT LIKE 's_ector' AND " + "myProp0 NOT LIKE '_cd' AND "
					+ "myProp1 NOT LIKE '12_'";
			String value = "selector"; // set for JMSType automatically
	...
	public void likeTest11() throws Exception {
		try {
			String selector = "myProp0 NOT LIKE '%cde' AND " + "myProp1 NOT LIKE '01%' AND "
					+ "myProp2 NOT LIKE 'A%x%D'";
			String value = ""; // set for JMSType automatically
	...
	public void likeTest14() throws Exception {
		try {
			String selector = "JMSType NOT LIKE 'se_ector' OR " + "myProp0 NOT LIKE '_bcd' OR "
					+ "myProp1 NOT LIKE '123_'";
			String value = "selector"; // set for JMSType automatically
	 ...
	 * @assertion_ids: JMS:SPEC:36; JMS:SPEC:49; JMS:SPEC:60; JMS:SPEC:66;
	 * 
	 * @test_Strategy: create receiver with message selector using NOT LIKE selector
	 * references unknown property send message check that message is not received
	 */
	@Test
	 ...
	 * @assertion_ids: JMS:SPEC:36; JMS:SPEC:49; JMS:SPEC:66;
	 * 
	 * @test_Strategy: create receiver with message selector using LIKE send message
	 * with non-string property check that message is not received
	 */
	@Test
	 ...
	 * 
	 * @test_Strategy: create receiver with message selector containing IS NULL
	 * selector references existing property send message check that message is not
	 * received
	 */
	@Test
	 ...
	 * 
	 * @test_Strategy: create receiver with message selector containing IS NOT NULL
	 * selector references existing property send message check receipt of message
	 */
	@Test
	 ...
	 * 
	 * @test_Strategy: create receiver with message selector selector contains lower
	 * case versions of selector operators send message matching selector check
	 * receipt of message
	 */
	@Test
	public void caseTest1() throws Exception {
		try {
			String selector = "myProp0 is null and " + "myProp1 like 'fooG_%' escape 'G' and "
					+ "myProp2 in ('a', 'b') and " + "myProp3 not between 0 and 10 and " + "(myProp4 or false)";
			String value = ""; // set for JMSType automatically
	 ...
	 * @assertion_ids: JMS:SPEC:36; JMS:SPEC:49; JMS:SPEC:58;
	 * 
	 * @test_Strategy: create receiver with message selector containing AND and NOT
	 * send message matching selector check receipt of message
	 */
	@Test
	 ...
	 * 
	 * @test_Strategy: create receiver with message selector containing AND and OR
	 * send message matching selector check receipt of message TvT&F = Tv(T&F) = TvF
	 * = T incorrect order would be TvT&F -> (TvT)&F = T&F = F
	 */
	@Test
	 ...
	 * 
	 * @test_Strategy: create receiver with selector containing AND each comparison
	 * should evaluate to FALSE send message check that message is not received
	 */
	@Test
	public void nullTest05() throws Exception {
		try {
			String selector = "(myTrueProp AND myFalseProp) OR " + "(myTrueProp AND myNullProp) OR "
					+ "(myFalseProp AND myTrueProp) OR " + "(myFalseProp AND myFalseProp) OR "
					+ "(myFalseProp AND myNullProp) OR " + "(MyNullProp AND myTrueProp) OR "
	...
	public void nullTest06() throws Exception {
		try {
			String selector = "(myTrueProp OR myTrueProp) AND " + "(myTrueProp OR myFalseProp) AND "
					+ "(myTrueProp OR myNullProp) AND " + "(myFalseProp OR myTrueProp) AND "
					+ "(myNullProp OR myTrueProp)";
			String value = ""; // set for JMSType automatically
	...
	public void nullTest07() throws Exception {
		try {
			String selector = "(myFalseProp OR myFalseProp) OR " + "(myFalseProp OR myNullProp) OR "
	 ...
	 * 
	 * @test_Strategy: create receiver with selector containing NOT send message not
	 * matching selector check that message is not received
	 */
	@Test

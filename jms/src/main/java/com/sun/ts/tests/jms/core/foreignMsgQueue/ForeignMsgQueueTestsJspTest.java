    ...
    static final String VEHICLE_ARCHIVE = "foreignMsgQueue_jsp_vehicle";
        ...
        */
        ...
        // War
            ...
            URL warResURL = ForeignMsgQueueTests.class.getResource("/com/sun/ts/tests/common/vehicle/jsp/jsp_vehicle_web.xml");
            if(warResURL != null) {
              foreignMsgQueue_jsp_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = ForeignMsgQueueTests.class.getResource("//com/sun/ts/tests/common/vehicle/jsp/jsp_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
            ...
            // Web content
            warResURL = ForeignMsgQueueTests.class.getResource("/com/sun/ts/tests/common/vehicle/jsp/jsp_vehicle_web.xml");
            if(warResURL != null) {
              foreignMsgQueue_jsp_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/jsp_vehicle_web.xml");
            }
            warResURL = ForeignMsgQueueTests.class.getResource("/com/sun/ts/tests/jms/core/foreignMsgQueue/jsp_vehicle_web.xml");
            if(warResURL != null) {
              foreignMsgQueue_jsp_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/jsp_vehicle_web.xml");
            }
        ...
        // Ear
            ...
            if(earResURL != null) {
              foreignMsgQueue_jsp_vehicle_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = ForeignMsgQueueTests.class.getResource("/com/sun/ts/tests/jms/core/foreignMsgQueue/.ear.sun-application.xml");
            if(earResURL != null) {
              foreignMsgQueue_jsp_vehicle_ear.addAsManifestResource(earResURL, "sun-application.xml");
            }
            // Call the archive processor
            archiveProcessor.processEarArchive(foreignMsgQueue_jsp_vehicle_ear, ForeignMsgQueueTests.class, earResURL);

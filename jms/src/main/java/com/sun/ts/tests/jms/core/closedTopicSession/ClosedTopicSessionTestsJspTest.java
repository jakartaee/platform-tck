    ...
    static final String VEHICLE_ARCHIVE = "closedTopicSession_jsp_vehicle";
        ...
        */
        ...
        // War
            ...
            URL warResURL = ClosedTopicSessionTests.class.getResource("/com/sun/ts/tests/common/vehicle/jsp/jsp_vehicle_web.xml");
            if(warResURL != null) {
              closedTopicSession_jsp_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = ClosedTopicSessionTests.class.getResource("//com/sun/ts/tests/common/vehicle/jsp/jsp_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
            ...
            // Web content
            warResURL = ClosedTopicSessionTests.class.getResource("/com/sun/ts/tests/common/vehicle/jsp/jsp_vehicle_web.xml");
            if(warResURL != null) {
              closedTopicSession_jsp_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/jsp_vehicle_web.xml");
            }
            warResURL = ClosedTopicSessionTests.class.getResource("/com/sun/ts/tests/jms/core/closedTopicSession/jsp_vehicle_web.xml");
            if(warResURL != null) {
              closedTopicSession_jsp_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/jsp_vehicle_web.xml");
            }
        ...
        // Ear
            ...
            if(earResURL != null) {
              closedTopicSession_jsp_vehicle_ear.addAsManifestResource(earResURL, "application.xml");
            }
            ...
            if(earResURL != null) {
              closedTopicSession_jsp_vehicle_ear.addAsManifestResource(earResURL, "sun-application.xml");
            }
            // Call the archive processor
            archiveProcessor.processEarArchive(closedTopicSession_jsp_vehicle_ear, ClosedTopicSessionTests.class, earResURL);

    ...
    static final String VEHICLE_ARCHIVE = "mapMsgQueue_servlet_vehicle";
        ...
        */
        ...
        // War
            ...
            URL warResURL = MapMsgQueueTests.class.getResource("/com/sun/ts/tests/common/vehicle/servlet/servlet_vehicle_web.xml");
            if(warResURL != null) {
              mapMsgQueue_servlet_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = MapMsgQueueTests.class.getResource("//com/sun/ts/tests/common/vehicle/servlet/servlet_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
            ...
            // Web content
            warResURL = MapMsgQueueTests.class.getResource("/com/sun/ts/tests/common/vehicle/servlet/servlet_vehicle_web.xml");
            if(warResURL != null) {
              mapMsgQueue_servlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/servlet_vehicle_web.xml");
            }
            warResURL = MapMsgQueueTests.class.getResource("/com/sun/ts/tests/jms/core/mapMsgQueue/servlet_vehicle_web.xml");
            if(warResURL != null) {
              mapMsgQueue_servlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/servlet_vehicle_web.xml");
            }
        ...
        // Ear
            ...
            // Call the archive processor
            archiveProcessor.processEarArchive(mapMsgQueue_servlet_vehicle_ear, MapMsgQueueTests.class, earResURL);

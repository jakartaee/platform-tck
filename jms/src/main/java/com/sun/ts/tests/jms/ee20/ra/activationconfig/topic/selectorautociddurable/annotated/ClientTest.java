...
import com.sun.ts.tests.jms.ee20.ra.activationconfig.topic.selectorautociddurable.annotated.Client;
import java.net.URL;
    ...
    /**
        ...
        */
        ...
        // Client
            ...
            URL resURL = Client.class.getResource("com/sun/ts/tests/jms/ee20/ra/activationconfig/topic/selectorautociddurable/annotated/topic_selectorautociddurable_annotated_client.xml");
            if(resURL != null) {
        ...
        // Ear
            ...
            URL earResURL = Client.class.getResource("/com/sun/ts/tests/jms/ee20/ra/activationconfig/topic/selectorautociddurable/annotated/application.xml");
            if(earResURL != null) {

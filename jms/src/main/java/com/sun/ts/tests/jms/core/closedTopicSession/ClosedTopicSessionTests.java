...
public class ClosedTopicSessionTests {
	...
	public void closedTopicSessionCreateDurableSubscriberTest() throws Exception {
		...
		try {
			createAndCloseSession(JmsTool.TOPIC);
			logger.log(Logger.Level.INFO, "Try to create DurableSubscriber with closed session.");
			try {
				TopicSubscriber tS = tool.getDefaultTopicSession().createDurableSubscriber(tool.getDefaultTopic(),
	...
	public void closedTopicSessionCreateTopicTest() throws Exception {
		...
		try {
			createAndCloseSession(JmsTool.TOPIC);
			logger.log(Logger.Level.INFO, "Try to create topic with closed session.");
			try {
				Topic t = tool.getDefaultTopicSession().createTopic("closedTopicSessionCreateTopicTest");
			} catch (jakarta.jms.IllegalStateException ise) {
				logger.log(Logger.Level.INFO, "Caught expected exception");
				passed = true;
			}
	...
	public void closedTopicSessionCreateSubscriberTest() throws Exception {
		...
		try {
			createAndCloseSession(JmsTool.TOPIC);
			logger.log(Logger.Level.INFO, "Try to create Subscriber with closed session.");
			try {
	...
	public void closedTopicSessionCreatePublisherTest() throws Exception {
		...
		try {
			createAndCloseSession(JmsTool.TOPIC);
			logger.log(Logger.Level.INFO, "Try to create Publisher with closed session.");
			try {
	...
	public void closedTopicSessionCreateTempTopicTest() throws Exception {
		...
		try {
			createAndCloseSession(JmsTool.TOPIC);
			logger.log(Logger.Level.INFO, "Try to create TemporaryTopic with closed session.");
			try {
	...
	public void closedTopicSessionUnsubscribeTest() throws Exception {
		...
		try {
			createAndCloseSession(JmsTool.TOPIC);
			logger.log(Logger.Level.INFO, "Try to call unsubscribe with closed session.");
			try {
	...
	public void closedTopicSessionCreateObject2MessageTest() throws Exception {
		...
		try {
			...
			try {
				...
				if (m != null)
					logger.log(Logger.Level.INFO, "ObjectMessage=" + m);
			} catch (jakarta.jms.IllegalStateException ise) {
				logger.log(Logger.Level.INFO, "Caught expected exception");
				passed = true;
			}

    ...
    static final String VEHICLE_ARCHIVE = "closedQueueReceiver_jsp_vehicle";
        ...
        */
        ...
        // War
            ...
            URL warResURL = ClosedQueueReceiverTests.class.getResource("/com/sun/ts/tests/common/vehicle/jsp/jsp_vehicle_web.xml");
            if(warResURL != null) {
              closedQueueReceiver_jsp_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = ClosedQueueReceiverTests.class.getResource("//com/sun/ts/tests/common/vehicle/jsp/jsp_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
            ...
            // Web content
            warResURL = ClosedQueueReceiverTests.class.getResource("/com/sun/ts/tests/common/vehicle/jsp/jsp_vehicle_web.xml");
            if(warResURL != null) {
              closedQueueReceiver_jsp_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/jsp_vehicle_web.xml");
            }
            warResURL = ClosedQueueReceiverTests.class.getResource("/com/sun/ts/tests/jms/core/closedQueueReceiver/jsp_vehicle_web.xml");
            if(warResURL != null) {
              closedQueueReceiver_jsp_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/jsp_vehicle_web.xml");
            }
        ...
        // Ear
            ...
            // Call the archive processor
            archiveProcessor.processEarArchive(closedQueueReceiver_jsp_vehicle_ear, ClosedQueueReceiverTests.class, earResURL);

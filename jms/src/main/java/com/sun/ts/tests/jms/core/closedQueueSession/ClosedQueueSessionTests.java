...
public class ClosedQueueSessionTests {
	...
	private void createAndCloseSession(int type, String user, String password) throws Exception {
		if ((type == JmsTool.QUEUE) || (type == JmsTool.TX_QUEUE)) {
			...
			logger.log(Logger.Level.INFO, "Closing QueueSession");
			tool.getDefaultQueueSession().close();

		} else if (type == JmsTool.COMMON_QTX) {
			tool = new JmsTool(type, user, password, mode);
			tool.getDefaultConnection().start();
			logger.log(Logger.Level.INFO, "Closing Session");
			tool.getDefaultSession().close();
		} else {
			logger.log(Logger.Level.ERROR, "Unspecified type");
		}
	}
	...
	public void cleanup() throws Exception {
		try {
			if (tool != null) {
				logger.log(Logger.Level.INFO, "Cleanup: Closing QueueConnection");
	 ...
	 * 
	 * @test_Strategy: Close default session and call createBrowser on it. Check for
	...
	public void closedQueueSessionCreateBrowserTest() throws Exception {
		...
		try {
			createAndCloseSession(JmsTool.QUEUE, user, password);
			logger.log(Logger.Level.INFO, "Try to create QueueBrowser with closed session.");
			try {
				...
				logger.log(Logger.Level.INFO, "Caught expected exception");
				return;
			}
	 ...
	 * 
	 * @test_Strategy: Close default session and call method on it. Check for proper
	 * JMSException.
	 */
	@Test
	...
	public void closedQueueSessionCreateQueueTest() throws Exception {
		...
		try {
			createAndCloseSession(JmsTool.QUEUE, user, password);
			logger.log(Logger.Level.INFO, "Try to create queue with closed session.");
			try {
	...
	public void closedQueueSessionCreateReceiverTest() throws Exception {
		...
		try {
			createAndCloseSession(JmsTool.QUEUE, user, password);
			logger.log(Logger.Level.INFO, "Try to create Receiver with closed session.");
			try {
	...
	public void closedQueueSessionCreateSenderTest() throws Exception {
		...
		try {
			createAndCloseSession(JmsTool.QUEUE, user, password);
			logger.log(Logger.Level.INFO, "Try to create Sender with closed session.");
			try {
	...
	public void closedQueueSessionCreateTempQueueTest() throws Exception {
		...
		try {
			createAndCloseSession(JmsTool.QUEUE, user, password);
			logger.log(Logger.Level.INFO, "Try to create TemporaryQueue with closed session.");
			try {
	...
	public void closedQueueSessionCreateMessageTest() throws Exception {
		...
		try {
			createAndCloseSession(JmsTool.QUEUE, user, password);
			logger.log(Logger.Level.INFO, "Try to create message with closed session.");
			try {
	...
	public void closedQueueSessionCreateBytesMessageTest() throws Exception {
		...
		try {
			createAndCloseSession(JmsTool.QUEUE, user, password);
			logger.log(Logger.Level.INFO, "Try to create BytesMessage with closed session.");
			try {
	...
	public void closedQueueSessionCreateMapMessageTest() throws Exception {
		...
		try {
			createAndCloseSession(JmsTool.QUEUE, user, password);
			logger.log(Logger.Level.INFO, "Try to create MapMessage with closed session.");
			try {
	...
	public void closedQueueSessionCreateObjectMessageTest() throws Exception {
		...
		try {
			createAndCloseSession(JmsTool.QUEUE, user, password);
			logger.log(Logger.Level.INFO, "Try to create ObjectMessage with closed session.");
			try {
	...
	public void closedQueueSessionCreateObject2MessageTest() throws Exception {
		...
		try {
			createAndCloseSession(JmsTool.QUEUE, user, password);
			logger.log(Logger.Level.INFO, "Try to create ObjectMessage(object) with closed session.");
			try {
	...
	public void closedQueueSessionCreateStreamMessageTest() throws Exception {
		...
		try {
			createAndCloseSession(JmsTool.QUEUE, user, password);
			logger.log(Logger.Level.INFO, "Try to create StreamMessage with closed session.");
			try {
	...
	public void closedQueueSessionCreateTextMessageTest() throws Exception {
		...
		try {
			createAndCloseSession(JmsTool.QUEUE, user, password);
			logger.log(Logger.Level.INFO, "Try to create TextMessage with closed session.");
			try {
	...
	public void closedQueueSessionSend4Test() throws Exception {
		...
		try {
			...
			try {
				tool.getDefaultQueueSender().send(new MessageTestImpl(), Message.DEFAULT_DELIVERY_MODE,
						Message.DEFAULT_PRIORITY, Message.DEFAULT_TIME_TO_LIVE);
				logger.log(Logger.Level.ERROR, "Fail: Exception was not thrown!");
			} catch (jakarta.jms.IllegalStateException ise) {
				logger.log(Logger.Level.TRACE, "Pass: threw expected error");
				return;
			} catch (Exception e) {
	...
	public void closedQueueSessionRecoverTest() throws Exception {
		try {
			...
			logger.log(Logger.Level.INFO, "Try to call recover() with closed session.");
			try {
			...
			logger.log(Logger.Level.ERROR, "closedQueueSessionRecoverTest failed: ", e);
	...
	public void closedQueueSessionCommitTest() throws Exception {
		...
		try {
			createAndCloseSession(JmsTool.TX_QUEUE, user, password);
			logger.log(Logger.Level.INFO, "Try to call commit with closed session.");
			try {
	...
	public void closedQueueSessionGetTransactedTest() throws Exception {
		...
		try {
			createAndCloseSession(JmsTool.TX_QUEUE, user, password);
			logger.log(Logger.Level.INFO, "Try to call getTransacted() with closed session.");
			try {
	...
	public void closedQueueSessionRollbackTest() throws Exception {
		...
		try {
			createAndCloseSession(JmsTool.TX_QUEUE, user, password);
			logger.log(Logger.Level.INFO, "Try to call rollback() with closed session.");
			try {

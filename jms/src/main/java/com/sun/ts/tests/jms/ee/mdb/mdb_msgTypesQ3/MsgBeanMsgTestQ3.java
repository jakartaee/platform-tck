...
public class MsgBeanMsgTestQ3 implements MessageDrivenBean, MessageListener {
	...
	private static final Logger logger = (Logger) System.getLogger(MsgBeanMsgTestQ3.class.getName());
	...
	public void ejbCreate() {
		logger.log(Logger.Level.TRACE, "jms.ee.mdb.mdb_msgTypesQ3  - @MsgBeanMsgTest3-ejbCreate() !!");
		try {
	...
	public void onMessage(Message msg) {
		...
		logger.log(Logger.Level.TRACE, "from jms.ee.mdb.mdb_msgTypesQ3 @onMessage!" + msg);
		...
		try {
			...
			if (msg.getStringProperty("TestCase").equals("msgClearBodyQueueTextTestCreate")) {
				...
				logger.log(Logger.Level.TRACE, "@onMessage - running msgResetQueueTest - read and verify the message");
				msgResetQueueTest();
	...
	private void msgClearBodyQueueMapTest(jakarta.jms.MapMessage messageReceivedMapMessage) {
		...
		try {
			...
			if (messageReceivedMapMessage.getString("aString") == null) {
				...
				logger.log(Logger.Level.TRACE, "Contains: " + messageReceivedMapMessage.getString("aString"));
				pass = false;
			}
	...
	public void setMessageDrivenContext(MessageDrivenContext mdc) {
		logger.log(Logger.Level.TRACE, "jms.ee.mdb.mdb_msgTypesQ3  In MsgBeanMsgTest3::setMessageDrivenContext()!!");
		this.mdc = mdc;
	}

	public void ejbRemove() {
		logger.log(Logger.Level.TRACE, "jms.ee.mdb.mdb_msgTypesQ3  In MsgBeanMsgTest3::remove()!!");
	}
}

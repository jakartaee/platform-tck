...
public class ExceptionTest {
	 ...
	 * 
	 * @test_Strategy: Construct TransactionRolledBackException(String, String) the
	 * correct message in it.
	 */
	@Test
	public void transactionRolledBackExceptionTest1() throws Exception {
		...
		try {
			...
			jakarta.jms.TransactionRolledBackException exceptionToTest = new TransactionRolledBackException(cause,
					errorCode);
	...
	public void testTransactionInProgressException1() throws Exception {
		try {
			...
			jakarta.jms.TransactionInProgressException exceptionToTest = new TransactionInProgressException(cause,
					errorCode);
			try {
				throw exceptionToTest;
	...
	public void testResourceAllocationException1() throws Exception {
		...
		try {
			...
			jakarta.jms.ResourceAllocationException exceptionToTest = new ResourceAllocationException(cause, errorCode);
	...
	public void testMessageNotWriteableException1() throws Exception {
		...
		try {
			...
			jakarta.jms.MessageNotWriteableException exceptionToTest = new MessageNotWriteableException(cause,
					errorCode);
	...
	public void testMessageNotReadableException1() throws Exception {
		...
		try {
			...
			jakarta.jms.MessageNotReadableException exceptionToTest = new MessageNotReadableException(cause, errorCode);
	...
	public void testMessageFormatException1() throws Exception {
		...
		try {
			...
			jakarta.jms.MessageFormatException exceptionToTest = new MessageFormatException(cause, errorCode);
	...
	public void testMessageEOFException1() throws Exception {
		...
		try {
			...
			jakarta.jms.MessageEOFException exceptionToTest = new MessageEOFException(cause, errorCode);
	...
	public void testMessageEOFException2() throws Exception {
		try {
			jakarta.jms.MessageEOFException exceptionToTest = new MessageEOFException("It is a byte, not an int.");
			try {
				throw exceptionToTest;
			} catch (MessageEOFException e) {
			}
	...
	public void testJMSSecurityException1() throws Exception {
		...
		try {
			...
			jakarta.jms.JMSSecurityException exceptionToTest = new JMSSecurityException(cause, errorCode);
	...
	public void testJMSSecurityException2() throws Exception {
		try {
			jakarta.jms.JMSSecurityException exceptionToTest = new JMSSecurityException("Cannot find the user.");
			try {
				throw exceptionToTest;
			} catch (JMSSecurityException e) {
			}
	...
	public void testJMSException1() throws Exception {
		...
		try {
			...
			jakarta.jms.JMSException exceptionToTest = new JMSException(cause, errorCode);
	...
	public void testJMSException2() throws Exception {
		...
		try {
			...
			if (!exceptionToTest.getLinkedException().getMessage().equals(exceptionToTest1.getMessage()))
				throw new Exception("Linked Exception does not return correct message "
	...
	public void invalidSelectorExceptionTest1() throws Exception {
		...
		try {
			...
			jakarta.jms.InvalidSelectorException exceptionToTest = new InvalidSelectorException(cause, errorCode);
	...
	public void invalidSelectorExceptionTest2() throws Exception {
		try {
			jakarta.jms.InvalidSelectorException exceptionToTest = new InvalidSelectorException("unknown variable");
			try {
				throw exceptionToTest;
			} catch (InvalidSelectorException e) {
			}
	...
	public void invalidDestinationExceptionTest1() throws Exception {
		...
		try {
			...
			jakarta.jms.InvalidDestinationException exceptionToTest = new InvalidDestinationException(cause, errorCode);
	...
	public void invalidClientIDExceptionTest1() throws Exception {
		...
		try {
			...
			jakarta.jms.InvalidClientIDException exceptionToTest = new InvalidClientIDException(cause, errorCode);
	...
	public void invalidClientIDExceptionTest2() throws Exception {
		try {
			jakarta.jms.InvalidClientIDException exceptionToTest = new InvalidClientIDException("Duplicate Client ID");
			try {
				throw exceptionToTest;
			} catch (InvalidClientIDException e) {
			}
	...
	public void illegalStateExceptionTest1() throws Exception {
		...
		try {
			...
			jakarta.jms.IllegalStateException exceptionToTest = new jakarta.jms.IllegalStateException(cause, errorCode);

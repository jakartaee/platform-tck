...
import com.sun.ts.tests.jms.core.closedTopicConnection.ClosedTopicConnectionTests;
import java.net.URL;
    ...
    static final String VEHICLE_ARCHIVE = "closedTopicConnection_servlet_vehicle";
        ...
        */
        ...
        // War
            ...
            URL warResURL = ClosedTopicConnectionTests.class.getResource("/com/sun/ts/tests/common/vehicle/servlet/servlet_vehicle_web.xml");
            if(warResURL != null) {
              closedTopicConnection_servlet_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = ClosedTopicConnectionTests.class.getResource("//com/sun/ts/tests/common/vehicle/servlet/servlet_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
            ...
            // Web content
            warResURL = ClosedTopicConnectionTests.class.getResource("/com/sun/ts/tests/common/vehicle/servlet/servlet_vehicle_web.xml");
            if(warResURL != null) {
              closedTopicConnection_servlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/servlet_vehicle_web.xml");
            }
            warResURL = ClosedTopicConnectionTests.class.getResource("/com/sun/ts/tests/jms/core/closedTopicConnection/servlet_vehicle_web.xml");
            if(warResURL != null) {
              closedTopicConnection_servlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/servlet_vehicle_web.xml");
            }
        ...
        // Ear
            ...
            URL earResURL = ClosedTopicConnectionTests.class.getResource("/com/sun/ts/tests/jms/core/closedTopicConnection/");
            if(earResURL != null) {
              closedTopicConnection_servlet_vehicle_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = ClosedTopicConnectionTests.class.getResource("/com/sun/ts/tests/jms/core/closedTopicConnection/.ear.sun-application.xml");
            if(earResURL != null) {
              closedTopicConnection_servlet_vehicle_ear.addAsManifestResource(earResURL, "sun-application.xml");
            }
            // Call the archive processor
            archiveProcessor.processEarArchive(closedTopicConnection_servlet_vehicle_ear, ClosedTopicConnectionTests.class, earResURL);

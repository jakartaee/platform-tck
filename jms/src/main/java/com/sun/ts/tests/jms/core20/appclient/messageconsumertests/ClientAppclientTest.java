...
import com.sun.ts.tests.jms.core20.appclient.messageconsumertests.Client;
import java.net.URL;
    ...
    static final String VEHICLE_ARCHIVE = "messageconsumertests_appclient_vehicle";
        ...
        */
        ...
        // Ear
            ...
            URL earResURL = Client.class.getResource("/com/sun/ts/tests/jms/core20/appclient/messageconsumertests/");
            if(earResURL != null) {
              messageconsumertests_appclient_vehicle_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client.class.getResource("/com/sun/ts/tests/jms/core20/appclient/messageconsumertests/.ear.sun-application.xml");
            if(earResURL != null) {
              messageconsumertests_appclient_vehicle_ear.addAsManifestResource(earResURL, "sun-application.xml");
            }
            // Call the archive processor
            archiveProcessor.processEarArchive(messageconsumertests_appclient_vehicle_ear, Client.class, earResURL);

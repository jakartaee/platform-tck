...
import com.sun.ts.tests.jms.core.closedQueueConnection.ClosedQueueConnectionTests;
import java.net.URL;
    ...
    static final String VEHICLE_ARCHIVE = "closedQueueConnection_servlet_vehicle";
        ...
        */
        ...
        // War
            ...
            URL warResURL = ClosedQueueConnectionTests.class.getResource("/com/sun/ts/tests/common/vehicle/servlet/servlet_vehicle_web.xml");
            if(warResURL != null) {
              closedQueueConnection_servlet_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = ClosedQueueConnectionTests.class.getResource("//com/sun/ts/tests/common/vehicle/servlet/servlet_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
            ...
            // Web content
            warResURL = ClosedQueueConnectionTests.class.getResource("/com/sun/ts/tests/common/vehicle/servlet/servlet_vehicle_web.xml");
            if(warResURL != null) {
              closedQueueConnection_servlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/servlet_vehicle_web.xml");
            }
            warResURL = ClosedQueueConnectionTests.class.getResource("/com/sun/ts/tests/jms/core/closedQueueConnection/servlet_vehicle_web.xml");
            if(warResURL != null) {
              closedQueueConnection_servlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/servlet_vehicle_web.xml");
            }
        ...
        // Ear
            ...
            URL earResURL = ClosedQueueConnectionTests.class.getResource("/com/sun/ts/tests/jms/core/closedQueueConnection/");
            if(earResURL != null) {
              closedQueueConnection_servlet_vehicle_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = ClosedQueueConnectionTests.class.getResource("/com/sun/ts/tests/jms/core/closedQueueConnection/.ear.sun-application.xml");
            if(earResURL != null) {
              closedQueueConnection_servlet_vehicle_ear.addAsManifestResource(earResURL, "sun-application.xml");
            }
            // Call the archive processor
            archiveProcessor.processEarArchive(closedQueueConnection_servlet_vehicle_ear, ClosedQueueConnectionTests.class, earResURL);

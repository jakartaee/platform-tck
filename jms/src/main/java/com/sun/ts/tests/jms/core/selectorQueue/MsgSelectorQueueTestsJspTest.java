    ...
    static final String VEHICLE_ARCHIVE = "selectorQueue_jsp_vehicle";
        ...
        */
        ...
        // Ear
            ...
            if(earResURL != null) {
              selectorQueue_jsp_vehicle_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = MsgSelectorQueueTests.class.getResource("/com/sun/ts/tests/jms/core/selectorQueue/.ear.sun-application.xml");
            if(earResURL != null) {
              selectorQueue_jsp_vehicle_ear.addAsManifestResource(earResURL, "sun-application.xml");
            }
            // Call the archive processor
            archiveProcessor.processEarArchive(selectorQueue_jsp_vehicle_ear, MsgSelectorQueueTests.class, earResURL);

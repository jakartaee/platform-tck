    ...
    static final String VEHICLE_ARCHIVE = "jmsproducerqueuetests_jsp_vehicle";
        ...
        */
        ...
        // War
            ...
            if(warResURL != null) {
              jmsproducerqueuetests_jsp_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/jsp_vehicle_web.xml");
            }
            warResURL = Client.class.getResource("/com/sun/ts/tests/jms/core20/jmsproducerqueuetests/jsp_vehicle_web.xml");
            if(warResURL != null) {
              jmsproducerqueuetests_jsp_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/jsp_vehicle_web.xml");
            }
        ...
        // Ear
            ...
            // Call the archive processor
            archiveProcessor.processEarArchive(jmsproducerqueuetests_jsp_vehicle_ear, Client.class, earResURL);

...
public class QueuePropertyTests {
	 ...
	 * JMS:SPEC:28; JMS:SPEC:29; JMS:SPEC:31; JMS:SPEC:32; JMS:SPEC:34; JMS:SPEC:19;
	 * JMS:SPEC:70; JMS:SPEC:71; JMS:JAVADOC:411; JMS:JAVADOC:413; JMS:JAVADOC:415;
		...
		try {
			...
			if (i == numPropertyNames) {
				...
				logger.log(Logger.Level.INFO,
						"Error: expected " + numPropertyNames + " property names, but returned " + i);
				pass = false;
			}
			...
			do {
				...
				if (tmp.indexOf("JMS") != 0) {
					...
					if (tmp.equals("TESTBOOLEAN") || tmp.equals("TESTBYTE") || tmp.equals("TESTINT")
						...
						logger.log(Logger.Level.TRACE, "+++++++Appclication Property set by client is: " + tmp);
					...
					logger.log(Logger.Level.TRACE, "+++++++   JMSProperty Name is: " + tmp);
				}
			} while (propertyNames.hasMoreElements());

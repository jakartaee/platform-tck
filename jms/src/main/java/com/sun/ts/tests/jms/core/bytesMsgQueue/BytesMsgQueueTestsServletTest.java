    ...
    static final String VEHICLE_ARCHIVE = "bytesMsgQueue_servlet_vehicle";
        ...
        */
        ...
        // War
            ...
            URL warResURL = BytesMsgQueueTests.class.getResource("/com/sun/ts/tests/common/vehicle/servlet/servlet_vehicle_web.xml");
            if(warResURL != null) {
              bytesMsgQueue_servlet_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = BytesMsgQueueTests.class.getResource("//com/sun/ts/tests/common/vehicle/servlet/servlet_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
        ...
        // Ear
            ...
            if(earResURL != null) {
              bytesMsgQueue_servlet_vehicle_ear.addAsManifestResource(earResURL, "application.xml");
            }

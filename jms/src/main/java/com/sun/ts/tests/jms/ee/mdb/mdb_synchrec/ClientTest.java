...
import com.sun.ts.tests.jms.ee.mdb.mdb_synchrec.MDBClient;
import java.net.URL;
    ...
    /**
        ...
        */
        ...
        // Client
            ...
            URL resURL = MDBClient.class.getResource("com/sun/ts/tests/jms/ee/mdb/mdb_synchrec/mdb_synchrec_client.xml");
            if(resURL != null) {
              mdb_synchrec_client.addAsManifestResource(resURL, "application-client.xml");
            }
            // The sun-application-client.xml file need to be added or should this be in in the vendor Arquillian extension?
            resURL = MDBClient.class.getResource("/com/sun/ts/tests/jms/ee/mdb/mdb_synchrec/mdb_synchrec_client.jar.sun-application-client.xml");
            if(resURL != null) {
              mdb_synchrec_client.addAsManifestResource(resURL, "application-client.xml");
            }
        ...
        // Ejb
            ...
            URL ejbResURL = MDBClient.class.getResource("/com/sun/ts/tests/jms/ee/mdb/mdb_synchrec/mdb_synchrec_ejb.xml");
            if(ejbResURL != null) {
              mdb_synchrec_ejb.addAsManifestResource(ejbResURL, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL = MDBClient.class.getResource("/com/sun/ts/tests/jms/ee/mdb/mdb_synchrec/mdb_synchrec_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL != null) {
        ...
        // Ear
            ...
            URL earResURL = MDBClient.class.getResource("/com/sun/ts/tests/jms/ee/mdb/mdb_synchrec/");
            if(earResURL != null) {
              mdb_synchrec_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = MDBClient.class.getResource("/com/sun/ts/tests/jms/ee/mdb/mdb_synchrec/.ear.sun-application.xml");
            if(earResURL != null) {
              mdb_synchrec_ear.addAsManifestResource(earResURL, "sun-application.xml");
            }
            // Call the archive processor
            archiveProcessor.processEarArchive(mdb_synchrec_ear, MDBClient.class, earResURL);

...
public class URLClient extends Client {
	 ...
	 *
	 * @test_Strategy: Call SOAPBody.addBodyElement(Name) method and verify creation
	 * of a new SOAPBodyElement.
	 *
	 ...
	 *
	 * @test_Strategy: Call SOAPBody.addFault() method and verify the creation of a
	 ...
	 *
	 * @test_Strategy: Call SOAPBody.getFault() method and verify the return of the
	 * SOAPFault object.
	 *
	 ...
	 *
	 * @test_Strategy: Call SOAPBody.addBodyElement(org.w3c.dom.Document) method and
	 * verify
	 *
	 * Description: Create a SOAPBodyElement object
	 *
	...
	public void extractContentAsDocumentTest1() throws Exception {
		...
		try {
			...
			logger.log(Logger.Level.INFO, "extractContentAsDocumentTest1: extract content as DOM Document");
			logger.log(Logger.Level.INFO, "Creating url to test servlet.....");
			url = tsurl.getURL(PROTOCOL, hostname, portnum, SOAPBODY_TESTSERVLET);
			logger.log(Logger.Level.INFO, url.toString());
			for (int i = 0; i < 2; i++) {
	...
	public void extractContentAsDocumentTest2() throws Exception {
		...
		try {
			...
			logger.log(Logger.Level.INFO, "extractContentAsDocumentTest2: negative test case for SOAPException");
			logger.log(Logger.Level.INFO, "Creating url to test servlet.....");
			url = tsurl.getURL(PROTOCOL, hostname, portnum, SOAPBODY_TESTSERVLET);
			logger.log(Logger.Level.INFO, url.toString());
			for (int i = 0; i < 2; i++) {

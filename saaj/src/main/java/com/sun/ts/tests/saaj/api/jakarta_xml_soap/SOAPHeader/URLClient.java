...
public class URLClient extends Client {
	...
	public static WebArchive createDeployment() throws IOException {
		...
		archive.addPackages(false, "com.sun.ts.lib.porting");
	...
	public void addNotUnderstoodHeaderElementTest() throws Exception {
		...
		try {
			...
			for (int i = 0; i < 2; i++) {
				logger.log(Logger.Level.INFO, "Sending post request to test servlet.....");
				if (i == 0) {
					props.setProperty("TESTNAME", "addNotUnderstoodHeaderElementSOAP11Test");
					props.setProperty("SOAPVERSION", "soap11");
				} else {
					props.setProperty("TESTNAME", "addNotUnderstoodHeaderElementSOAP12Test");
					props.setProperty("SOAPVERSION", "soap12");
				}
				urlConn = TestUtil.sendPostData(props, url);
				logger.log(Logger.Level.INFO, "Getting response from test servlet.....");
	 ...
	 *
	 * @test_Strategy: Call SOAPHeader.addUpgradeHeaderElement(Iterator) method and
	 ...
	 *
	 * @test_Strategy: Call SOAPHeader.examineAllHeaderElements() method and verify
	 * correct SOAPHeaderElements returned. Single element test.
	 *
	 ...
	 *
	 * @test_Strategy: Call SOAPHeader.examineAllHeaderElements() method and verify
	 * correct SOAPHeaderElements returned. Multiple element test same actor.
	 *
	 ...
	 *
	 * @test_Strategy: Call SOAPHeader.examineAllHeaderElements() method and verify
	 * correct SOAPHeaderElements returned. Multiple element test different actors.
	 *
	 * Description: Examine all SOAPHeaderElements.
	 *
	 */
	...
	public void examineMustUnderstandHeaderElementsTest1() throws Exception {
		boolean pass = true;
		try {
			logger.log(Logger.Level.INFO, "examineMustUnderstandHeaderElementsTest1: examine MustUnderstand");
			logger.log(Logger.Level.INFO, "Creating url to test servlet.....");
			url = tsurl.getURL(PROTOCOL, hostname, portnum, SOAPHEADER_TESTSERVLET);
			logger.log(Logger.Level.INFO, url.toString());
			logger.log(Logger.Level.INFO, "Sending post request to test servlet.....");
	...
	public void examineMustUnderstandHeaderElementsTest2() throws Exception {
		boolean pass = true;
		try {
			logger.log(Logger.Level.INFO, "examineMustUnderstandHeaderElementsTest2: examine MustUnderstand");
			logger.log(Logger.Level.INFO, "Creating url to test servlet.....");
			url = tsurl.getURL(PROTOCOL, hostname, portnum, SOAPHEADER_TESTSERVLET);
			logger.log(Logger.Level.INFO, url.toString());
			logger.log(Logger.Level.INFO, "Sending post request to test servlet.....");
	...
	public void examineMustUnderstandHeaderElementsTest3() throws Exception {
		boolean pass = true;
		try {
			logger.log(Logger.Level.INFO, "examineMustUnderstandHeaderElementsTest3: examine MustUnderstand");
			logger.log(Logger.Level.INFO, "Creating url to test servlet.....");
			url = tsurl.getURL(PROTOCOL, hostname, portnum, SOAPHEADER_TESTSERVLET);
			logger.log(Logger.Level.INFO, url.toString());
			logger.log(Logger.Level.INFO, "Sending post request to test servlet.....");
	 ...
	 *
	 * @test_Strategy: Call SOAPHeader.extractAllHeaderElements() method and verify
	 * correct SOAPHeaderElements returned. Single element test.
	 *
	 * Description: Examine all SOAPHeaderElements.
	 *

...
public class URLClient extends Client {
	...
	public static WebArchive createDeployment() throws IOException {
		WebArchive archive = ShrinkWrap.create(WebArchive.class, "SOAPFault_web.war");
		archive.addPackages(false, Filters.exclude(URLClient.class),
				"com.sun.ts.tests.saaj.api.jakarta_xml_soap.SOAPFault");
	 ...
	 *
	 * @test_Strategy: Call SOAPFault.setFaultCode/getFaultCode with a string. Must
	 * succeed.
	 *
	 */
	@Test
	 ...
	 *
	 * Description: Calling SOAPFault.addFaultReasonText() on a SOAP1.1 message must
	 ...
	 *
	 * Description: Calling SOAPFault.addFaultReasonText() on a SOAP1.2 message must
	 * succeed.
	 *
	 */
	@Test
	 ...
	 *
	 * Description: Calling SOAPFault.getFaultReasonText() on a SOAP1.1 message must
	 * throw UnsupportedOperationException.
	 *
	 */
	@Test
	 ...
	 * @assertion_ids: SAAJ:JAVADOC:214; SAAJ:JAVADOC:215;
	 *
	 * @test_Strategy: Call SOAPFault.getFaultReasonText() on a SOAP1.2 message that
	 * added 3 FaultReasonTexts. Two using Locale.ENGLISH and on with Locale.UK.
	 * Only the text associated with Locale.UK should be returned.
	 *
	 * Description: Calling SOAPFault.getFaultReasonText() on a SOAP1.2 message must
	 * succeed.
	 *
	 */
	@Test
	 ...
	 * SOAPFault.addFaultReasonText() twice, the first time to set a reason text and
	 * the second to replace the old text with a new text value
	 *
	 */
	@Test
	 ...
	 *
	 * Description: Calling SOAPFault.setFaultNode() on a SOAP1.1 message must throw
	 ...
	 *
	 * @test_Strategy: Call SOAPFault.setFaultNode() and getFaultNode() on a SOAP1.2
	 ...
	 *
	 * Description: Calling SOAPFault.getFaultNode() on a SOAP1.1 message must throw
	 * UnsupportedOperationException.
	 *
	 */
	@Test
	 ...
	 *
	 * Description: Calling SOAPFault.setFaultRole() on a SOAP1.1 message must throw
	 * UnsupportedOperationException.
	 *
	 */
	@Test
	 ...
	 *
	 * @test_Strategy: Call SOAPFault.setFaultRole/getFaultRole on a SOAP1.2 message
	 * must succeed.
	 *
	 */
	@Test
	 ...
	 *
	 * Description: Calling SOAPFault.getFaultRole() on a SOAP1.1 message must throw
	 * UnsupportedOperationException.
	 *
	 */
	@Test
	 ...
	 * @assertion_ids: SAAJ:JAVADOC:221;
	 *
	 * @test_Strategy: Call SOAPFault.getFaultRole() on a SOAP1.2 message that does
	 * not have a role set.
	 *
	 */
	@Test
	 ...
	 *
	 * @test_Strategy: Call SOAPFault.getFaultStringLocale where a fault string was
	 * set but not the locale
	 *
	 */
	@Test
	 ...
	 *
	 * @test_Strategy: Call SOAPFault.setFaultCodeAsName() and getFaultCodeAsName()
	 * to return Name.
	 *
	 */
	@Test
	 ...
	 *
	 * Description: Calling SOAPFault.appendFaultSubcode() on a SOAP1.1 message must
	 * throw UnsupportedOperationException.
	 *
	 */
	@Test
	 ...
	 *
	 * Description: Calling SOAPFault.removeAllFaultSubcodes() on a SOAP1.1 message
	 * must throw UnsupportedOperationException.
	 *
	 */
	@Test
	 ...
	 * @assertion_ids: SAAJ:JAVADOC:193;
	 *
	 * @test_Strategy: Call SOAPFault.removeAllFaultSubcodes() on a SOAP1.2 message
	 * that contains 2 Subcodes. Then call getFaultSubcodes() is ensure an empty
	 * interator is returned
	 *
	 */
	@Test
	 ...
	 *
	 * @test_Strategy: Call SOAPFault.setFaultCode with a non qualified Name object.
	 ...
	 *
	 * @test_Strategy: Call SOAPFault.appendFaultSubcode with a non qualified QName
	 * object. Must throw SOAPException.
	 *
	 */
	@Test

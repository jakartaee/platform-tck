...
public class SOAPHeaderTestServlet extends HttpServlet {
	...
	public void init(ServletConfig servletConfig) throws ServletException {
		...
		logger.log(Logger.Level.TRACE,"SOAPHeaderTestServlet:init (Entering)");
		SOAP_Util.doServletInit(servletConfig);
		logger.log(Logger.Level.TRACE,"SOAPHeaderTestServlet:init (Leaving)");
	}
	...
	private void addNotUnderstoodHeaderElementSOAP11Test(HttpServletRequest req, HttpServletResponse res)
			throws ServletException, IOException {
		logger.log(Logger.Level.TRACE, "addNotUnderstoodHeaderElementSOAP11Test");
		...
		try {
			...
			logger.log(Logger.Level.INFO,
					"Calling addNotUnderstoodHeaderElement() should" + " throw UnsupportedOperationException");
	...
	private void addNotUnderstoodHeaderElementSOAP12Test(HttpServletRequest req, HttpServletResponse res)
			throws ServletException, IOException {
		logger.log(Logger.Level.TRACE, "addNotUnderstoodHeaderElementSOAP12Test");
		Properties resultProps = new Properties();
		boolean pass = true;
	...
	private void addUpgradeHeaderElementTest1(HttpServletRequest req, HttpServletResponse res)
			throws ServletException, IOException {
		logger.log(Logger.Level.TRACE, "addUpgradeHeaderElementTest1");
		Properties resultProps = new Properties();
		boolean pass = true;
		...
		try {
			...
			if (pass) {
				...
				if (SOAP_Util.getSOAPVersion().equals("soap11")) {
					logger.log(Logger.Level.INFO,
							"Validate the URI which must be " + SOAPConstants.URI_NS_SOAP_ENVELOPE);
					if (!uri.equals(SOAPConstants.URI_NS_SOAP_ENVELOPE)) {
						logger.log(Logger.Level.ERROR,
								"Got URI: " + uri + "\nExpected URI: " + SOAPConstants.URI_NS_SOAP_ENVELOPE);
						pass = false;
					}
				} else {
					logger.log(Logger.Level.INFO,
	...
	private void addUpgradeHeaderElementTest2(HttpServletRequest req, HttpServletResponse res)
			throws ServletException, IOException {
		logger.log(Logger.Level.TRACE, "addUpgradeHeaderElementTest2");
		Properties resultProps = new Properties();
		boolean pass = true;
	...
	private void addUpgradeHeaderElementTest3(HttpServletRequest req, HttpServletResponse res)
			throws ServletException, IOException {
		logger.log(Logger.Level.TRACE, "addUpgradeHeaderElementTest3");
		Properties resultProps = new Properties();
		boolean pass = true;
	...
	private void addHeaderElementTest1(HttpServletRequest req, HttpServletResponse res)
			throws ServletException, IOException {
		logger.log(Logger.Level.TRACE, "addHeaderElementTest1");
		Properties resultProps = new Properties();
		boolean pass = true;
	...
	private void addHeaderElementTest2(HttpServletRequest req, HttpServletResponse res)
			throws ServletException, IOException {
		logger.log(Logger.Level.TRACE, "addHeaderElementTest2");
		Properties resultProps = new Properties();
		boolean pass = true;
	...
	private void examineAllHeaderElementsTest1(HttpServletRequest req, HttpServletResponse res)
			throws ServletException, IOException {
		logger.log(Logger.Level.TRACE, "examineAllHeaderElementsTest1");
		Properties resultProps = new Properties();
		boolean pass = true;
		...
		try {
			...
			if (cnt != 1) {
				logger.log(Logger.Level.ERROR, "SOAPHeaderElement count mismatch: expected 1, received " + cnt);
				pass = false;
			} else
	...
	private void examineAllHeaderElementsTest2(HttpServletRequest req, HttpServletResponse res)
			throws ServletException, IOException {
		logger.log(Logger.Level.TRACE, "examineAllHeaderElementsTest2");
		Properties resultProps = new Properties();
		boolean pass = true;
		...
		try {
			...
			she2 = hdr.addHeaderElement(envelope.createName("foo2", "f2", "foo2-URI"));
			...
			if (cnt != 2) {
				logger.log(Logger.Level.ERROR, "SOAPHeaderElement count mismatch: expected 2, received " + cnt);
				pass = false;
			} else
	...
	private void examineAllHeaderElementsTest3(HttpServletRequest req, HttpServletResponse res)
			throws ServletException, IOException {
		logger.log(Logger.Level.TRACE, "examineAllHeaderElementsTest3");
		Properties resultProps = new Properties();
		boolean pass = true;
	...
	private void examineHeaderElementsTest1(HttpServletRequest req, HttpServletResponse res)
			throws ServletException, IOException {
		logger.log(Logger.Level.TRACE, "examineHeaderElementsTest1");
		Properties resultProps = new Properties();
		boolean pass = true;
		...
		try {
			...
			if (SOAP_Util.getSOAPVersion().equals(SOAP_Util.SOAP11)) {
				logger.log(Logger.Level.INFO, "Examing SOAPHeaderElements with actor actor-URI again ...");
				iterator = hdr.examineHeaderElements("actor-URI");
			} else {
	...
	private void examineHeaderElementsTest2(HttpServletRequest req, HttpServletResponse res)
			throws ServletException, IOException {
		logger.log(Logger.Level.TRACE, "examineHeaderElementsTest2");
		Properties resultProps = new Properties();
		boolean pass = true;
	...
	private void examineHeaderElementsTest3(HttpServletRequest req, HttpServletResponse res)
			throws ServletException, IOException {
		logger.log(Logger.Level.TRACE, "examineHeaderElementsTest3");
		Properties resultProps = new Properties();
		boolean pass = true;
		...
		try {
			...
			if (cnt != 0) {
				logger.log(Logger.Level.ERROR, "SOAPHeaderElement count mismatch: expected 0, received " + cnt);
				pass = false;
			} else
	...
	private void examineHeaderElementsTest4(HttpServletRequest req, HttpServletResponse res)
			throws ServletException, IOException {
		logger.log(Logger.Level.TRACE, "examineHeaderElementsTest4");
		Properties resultProps = new Properties();
		boolean pass = true;
		...
		try {
			...
			SOAPElement se = hdr.addHeaderElement(envelope.createName("Header1", "prefix", "http://myuri"))
			...
			se = hdr.addHeaderElement(envelope.createName("Header2", "prefix", "http://myuri"))
					.addTextNode("This is Header2");
			she = (SOAPHeaderElement) se;
			she.setMustUnderstand(false);

			logger.log(Logger.Level.INFO, "Add SOAP HeaderElement Header3");
			se = hdr.addHeaderElement(envelope.createName("Header3", "prefix", "http://myuri"))
					.addTextNode("This is Header3");
			she = (SOAPHeaderElement) se;
			she.setMustUnderstand(true);

			logger.log(Logger.Level.INFO, "Add SOAP HeaderElement Header4");
			se = hdr.addHeaderElement(envelope.createName("Header4", "prefix", "http://myuri"))
			...
			if (cnt != 4) {
				logger.log(Logger.Level.ERROR, "SOAPHeaderElement count mismatch: expected 4, received " + cnt);
				pass = false;
			}
	...
	private void examineMustUnderstandHeaderElementsTest1(HttpServletRequest req, HttpServletResponse res)
			throws ServletException, IOException {

		logger.log(Logger.Level.TRACE, "examineMustUnderstandHeaderElementsTest1");
		Properties resultProps = new Properties();
		boolean pass = true;
	...
	private void examineMustUnderstandHeaderElementsTest2(HttpServletRequest req, HttpServletResponse res)
			throws ServletException, IOException {

		logger.log(Logger.Level.TRACE, "examineMustUnderstandHeaderElementsTest2");
		Properties resultProps = new Properties();
		boolean pass = true;
	...
	private void examineMustUnderstandHeaderElementsTest3(HttpServletRequest req, HttpServletResponse res)
			throws ServletException, IOException {

		logger.log(Logger.Level.TRACE, "examineMustUnderstandHeaderElementsTest3");
		Properties resultProps = new Properties();
		boolean pass = true;
		...
		try {
			...
			she3 = hdr.addHeaderElement(envelope.createName("foo3", "f3", "foo3-URI"));
	...
	private void extractAllHeaderElementsTest1(HttpServletRequest req, HttpServletResponse res)
			throws ServletException, IOException {
		logger.log(Logger.Level.TRACE, "extractAllHeaderElementsTest1");
		Properties resultProps = new Properties();
		boolean pass = true;
	...
	private void extractAllHeaderElementsTest2(HttpServletRequest req, HttpServletResponse res)
			throws ServletException, IOException {
		logger.log(Logger.Level.TRACE, "extractAllHeaderElementsTest2");
		Properties resultProps = new Properties();
		boolean pass = true;
	...
	private void extractAllHeaderElementsTest3(HttpServletRequest req, HttpServletResponse res)
			throws ServletException, IOException {
		logger.log(Logger.Level.TRACE, "extractAllHeaderElementsTest3");
		Properties resultProps = new Properties();
		boolean pass = true;
	...
	private void extractHeaderElementsTest1(HttpServletRequest req, HttpServletResponse res)
			throws ServletException, IOException {
		logger.log(Logger.Level.TRACE, "extractHeaderElementsTest1");
		Properties resultProps = new Properties();
		boolean pass = true;
		...
		try {
			...
			if (SOAP_Util.getSOAPVersion().equals(SOAP_Util.SOAP11)) {
				logger.log(Logger.Level.INFO, "Extract SOAPHeaderElements with actor actor-URI again ...");
				iterator = hdr.extractHeaderElements("actor-URI");
			} else {
	...
	private void extractHeaderElementsTest2(HttpServletRequest req, HttpServletResponse res)
			throws ServletException, IOException {
		logger.log(Logger.Level.TRACE, "extractHeaderElementsTest2");
		Properties resultProps = new Properties();
		boolean pass = true;
	...
	private void extractHeaderElementsTest3(HttpServletRequest req, HttpServletResponse res)
			throws ServletException, IOException {
		logger.log(Logger.Level.TRACE, "extractHeaderElementsTest3");
		Properties resultProps = new Properties();
		boolean pass = true;

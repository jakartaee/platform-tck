...
public class URLClient extends Client {
	...
	public static WebArchive createDeployment() throws IOException {
		...
		archive.addPackages(false, Filters.exclude(URLClient.class), "com.sun.ts.tests.saaj.api.jakarta_xml_soap.Node");
	 ...
	 *
	 * @test_Strategy: Call Node.detachNode() method and verify that the given node
	 * is indeed removed.
	 *
	 ...
	 *
	 * @test_Strategy: Call Node.recycleNode() method and verify that the given node
	 * is indeed recycled.
	 *
	 ...
	 *
	 * Description: Through the Node interface you can get parent node element of a
	 * Node that has a parent.
	 *
	 */
	@Test
	 ...
	 *
	 * Description: Through the Node interface you cannot get parent node element of
	 * a Node that does not have a parent.
	 *
	 */
	@Test
	 ...
	 *
	 * Description: Through the Node interface you cannot set parent node element to
	 * an improper parent.
	 *
	 */
	@Test
	 ...
	 *
	 * @test_Strategy: Call Node.setValue() method to set the value of this node
	 * element. Try setting value on a Node which is not a Text Node. Should get an
	...
	public void setValueTest3() throws Exception {
		...
		try {
			...
			logger.log(Logger.Level.INFO, "setValueTest3: set value of non Text Node (IllegalStateException)");
			logger.log(Logger.Level.INFO, "Creating url to test servlet.....");
			url = tsurl.getURL(PROTOCOL, hostname, portnum, NODE_TESTSERVLET);
			logger.log(Logger.Level.INFO, url.toString());
			logger.log(Logger.Level.INFO, "Sending post request to test servlet.....");

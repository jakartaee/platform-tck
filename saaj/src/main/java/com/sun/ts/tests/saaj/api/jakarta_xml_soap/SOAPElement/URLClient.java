...
public class URLClient extends Client {
	...
	public void addAttributeTest1() throws Exception {
		boolean pass = true;
		try {
			logger.log(Logger.Level.INFO, "addAttributeTest1: add an attribute to " + "this SOAPElement object");
	...
	public void addAttributeTest2() throws Exception {
		boolean pass = true;
		try {
			logger.log(Logger.Level.INFO, "addAttributeTest2: add an attribute to " + "this SOAPElement object");
			logger.log(Logger.Level.INFO, "Creating url to test servlet.....");
			url = tsurl.getURL(PROTOCOL, hostname, portnum, SOAPELEMENT_TESTSERVLET);
			logger.log(Logger.Level.INFO, url.toString());
			for (int i = 0; i < 2; i++) {
	...
	public void getAttributeValueTest1() throws Exception {
		...
		try {
			logger.log(Logger.Level.INFO,
					"getAttributeValueTest1: get attribute value " + "of this SOAPElement object");
			logger.log(Logger.Level.INFO, "Creating url to test servlet.....");
			url = tsurl.getURL(PROTOCOL, hostname, portnum, SOAPELEMENT_TESTSERVLET);
			logger.log(Logger.Level.INFO, url.toString());
			for (int i = 0; i < 2; i++) {
	...
	public void getAttributeValueTest2() throws Exception {
		...
		try {
			logger.log(Logger.Level.INFO,
					"getAttributeValueTest2: get attribute value " + "of this SOAPElement object");
			logger.log(Logger.Level.INFO, "Creating url to test servlet.....");
			url = tsurl.getURL(PROTOCOL, hostname, portnum, SOAPELEMENT_TESTSERVLET);
			logger.log(Logger.Level.INFO, url.toString());
			for (int i = 0; i < 2; i++) {
	...
	public void getElementNameTest() throws Exception {
		...
		try {
			...
			logger.log(Logger.Level.INFO, "getElementNameTest: return name of " + "this SOAPElement object");
			logger.log(Logger.Level.INFO, "Creating url to test servlet.....");
			url = tsurl.getURL(PROTOCOL, hostname, portnum, SOAPELEMENT_TESTSERVLET);
			logger.log(Logger.Level.INFO, url.toString());
			for (int i = 0; i < 2; i++) {
	...
	public void getElementQNameTest() throws Exception {
		...
		try {
			...
			logger.log(Logger.Level.INFO, "getElementQNameTest: return name of " + "this SOAPElement object");
			logger.log(Logger.Level.INFO, "Creating url to test servlet.....");
			url = tsurl.getURL(PROTOCOL, hostname, portnum, SOAPELEMENT_TESTSERVLET);
			logger.log(Logger.Level.INFO, url.toString());
			for (int i = 0; i < 2; i++) {
	...
	public void removeNamespaceDeclarationTest() throws Exception {
		...
		try {
			...
			logger.log(Logger.Level.INFO,
					"removeNamespaceDeclarationTest: remove namespace " + "declaration with specified prefix");
			logger.log(Logger.Level.INFO, "Creating url to test servlet.....");
			url = tsurl.getURL(PROTOCOL, hostname, portnum, SOAPELEMENT_TESTSERVLET);
			logger.log(Logger.Level.INFO, url.toString());
			for (int i = 0; i < 2; i++) {
	...
	public void getNamespacePrefixesTest() throws Exception {
		...
		try {
			...
			logger.log(Logger.Level.INFO, "getNamespacePrefixesTest: return all " + "namespace prefixes");
			logger.log(Logger.Level.INFO, "Creating url to test servlet.....");
			url = tsurl.getURL(PROTOCOL, hostname, portnum, SOAPELEMENT_TESTSERVLET);
			logger.log(Logger.Level.INFO, url.toString());
			for (int i = 0; i < 2; i++) {
	...
	public void getNamespaceURITest() throws Exception {
		...
		try {
			...
			logger.log(Logger.Level.INFO,
					"getNamespaceURITest: return the URI " + "of the namespace with a given prefix");
			logger.log(Logger.Level.INFO, "Creating url to test servlet.....");
			url = tsurl.getURL(PROTOCOL, hostname, portnum, SOAPELEMENT_TESTSERVLET);
			logger.log(Logger.Level.INFO, url.toString());
			for (int i = 0; i < 2; i++) {
	 ...
	 * object and adds this new element to this SOAPElement object.
	 *
	 */
	@Test
	 ...
	 *
	 * Description: Creates a new SOAPElement object initialized with the given
	 * specified local name and prefix and adds this new element to this SOAPElement
	 * object.
	 *
	 */
	@Test
	...
	public void getVisibleNamespacePrefixesTest() throws Exception {
		...
		try {
			...
			logger.log(Logger.Level.INFO, "getVisibleNamespacePrefixesTest: return all " + "namespace prefixes");
			logger.log(Logger.Level.INFO, "Creating url to test servlet.....");
			url = tsurl.getURL(PROTOCOL, hostname, portnum, SOAPELEMENT_TESTSERVLET);
			logger.log(Logger.Level.INFO, url.toString());
			logger.log(Logger.Level.INFO, "Sending post request to test servlet.....");
	...
	public void setElementQNameTest1() throws Exception {
		...
		try {
			...
			logger.log(Logger.Level.INFO, "setElementQNameTest1: return qname of " + "this SOAPElement object");
			logger.log(Logger.Level.INFO, "Creating url to test servlet.....");
			url = tsurl.getURL(PROTOCOL, hostname, portnum, SOAPELEMENT_TESTSERVLET);
			logger.log(Logger.Level.INFO, url.toString());
			logger.log(Logger.Level.INFO, "Sending post request to test servlet.....");
	...
	public void setElementQNameTest2() throws Exception {
		...
		try {
			...
			logger.log(Logger.Level.INFO, "setElementQNameTest2: negative test case" + " for SOAPException");
			logger.log(Logger.Level.INFO, "Creating url to test servlet.....");
			url = tsurl.getURL(PROTOCOL, hostname, portnum, SOAPELEMENT_TESTSERVLET);
			logger.log(Logger.Level.INFO, url.toString());
			logger.log(Logger.Level.INFO, "Sending post request to test servlet.....");
	...
	public void createQNameTest1() throws Exception {
		...
		try {
			...
			logger.log(Logger.Level.INFO, "createQNameTest1: return qname of " + "this SOAPElement object");
			logger.log(Logger.Level.INFO, "Creating url to test servlet.....");
			url = tsurl.getURL(PROTOCOL, hostname, portnum, SOAPELEMENT_TESTSERVLET);
			logger.log(Logger.Level.INFO, url.toString());
			logger.log(Logger.Level.INFO, "Sending post request to test servlet.....");
	...
	public void createQNameTest2() throws Exception {
		...
		try {
			...
			logger.log(Logger.Level.INFO, "createQNameTest2: negative test case" + " for SOAPException");
			logger.log(Logger.Level.INFO, "Creating url to test servlet.....");
			url = tsurl.getURL(PROTOCOL, hostname, portnum, SOAPELEMENT_TESTSERVLET);
			logger.log(Logger.Level.INFO, url.toString());
			logger.log(Logger.Level.INFO, "Sending post request to test servlet.....");

...
public class ClientServlet extends Client implements Serializable {
	  ...
	  @Deployment(name = "servlet", testable = true)
		public static EnterpriseArchive createDeploymentServlet(@ArquillianResource TestArchiveProcessor archiveProcessor) throws IOException {
		  	...
		  	servletVehicleArchive.addAsWebInfResource(ClientServlet.class.getPackage(), "xa_xresXcomp2_servlet_vehicle_web.war.sun-web.xml", "sun-web.xml");
			System.out.println(servletVehicleArchive.toString(true));
		  	...
		  	javaAchive.addAsManifestResource(ClientServlet.class.getPackage(), "xa_xresXcomp2_ee_txpropagate2_ejb.jar.sun-ejb-jar.xml", "sun-ejb-jar.xml");

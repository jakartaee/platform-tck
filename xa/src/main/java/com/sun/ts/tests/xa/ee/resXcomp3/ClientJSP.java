	  ...
	  @Deployment(name = "jsp", testable = true)
		public static EnterpriseArchive createDeploymentJsp(@ArquillianResource TestArchiveProcessor archiveProcessor) throws IOException {
	        ...
	        jspVehicleArchive.add(new ByteArrayAsset(clientHtml), "client.html");
		  	...
		  	jspVehicleArchive.addAsWebInfResource(ClientServlet.class.getPackage(), "xa_resXcomp3_jsp_vehicle_web.war.sun-web.xml", "sun-web.xml");
			System.out.println(jspVehicleArchive.toString(true));
		  	...
		  	javaAchive.addAsManifestResource(ClientServlet.class.getPackage(), "xa_resXcomp3_ee_txpropagate3_ejb.jar.sun-ejb-jar.xml", "sun-ejb-jar.xml");

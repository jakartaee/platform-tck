 ...
 * $Id$
 */
package com.sun.ts.tests.jsf.api.jakarta_faces.component.uiselectitem;
...
public class URLClient extends BaseUIComponentClient {
  ...
  private static final String CONTEXT_ROOT = "/jsf_comp_selitem_web";
   ...
   * @assertion_ids: JSF:JAVADOC:517; JSF:JAVADOC:855
  ...
  // -----------------------------------------------------------------UISelectItem
  /**
   * @testName: uiSelectItemGetSetValueTest
   * @assertion_ids: JSF:JAVADOC:870; JSF:JAVADOC:859; JSF:JAVADOC:869
   * @test_Strategy: Verify {get,set}Value() - if a value is set, the same value
   *                 is returned.
   */
  public void uiSelectItemGetSetValueTest() throws EETest.Fault {
    TEST_PROPS.setProperty(APITEST, "uiSelectItemGetSetValueTest");
    invoke();
  }

  /**
   * @testName: uiSelectItemGetSetItemValueTest
   * @assertion_ids: JSF:JAVADOC:870; JSF:JAVADOC:834; JSF:JAVADOC:858
   * @test_Strategy: Verify {get,set}ItemValue() - if a value is set, the same
   *                 value is returned.
   */
  public void uiSelectItemGetSetItemValueTest() throws EETest.Fault {
    TEST_PROPS.setProperty(APITEST, "uiSelectItemGetSetItemValueTest");
    invoke();
  }

  /**
   * @testName: uiSelectItemGetSetItemDescriptionTest
   * @assertion_ids: JSF:JAVADOC:870; JSF:JAVADOC:859; JSF:JAVADOC:856;
   *                 JSF:JAVADOC:863
   * @test_Strategy: Verify {get, set}ItemDescription() returns the expected
   *                 value.
   */
  public void uiSelectItemGetSetItemDescriptionTest() throws EETest.Fault {
    TEST_PROPS.setProperty(APITEST, "uiSelectItemGetSetItemDescriptionTest");
    invoke();
  }

  /**
   * @testName: uiSelectItemGetSetItemLabelTest
   * @assertion_ids: JSF:JAVADOC:870; JSF:JAVADOC:859; JSF:JAVADOC:857;
   *                 JSF:JAVADOC:866
   * @test_Strategy: Verify {get, set}ItemLabel() returns the expected value.
   */
  public void uiSelectItemGetSetItemLabelTest() throws EETest.Fault {
    TEST_PROPS.setProperty(APITEST, "uiSelectItemGetSetItemLabelTest");
    invoke();
  }

  /**
   * @testName: uiSelectItemIsSetItemDisabledTest
   * @assertion_ids: JSF:JAVADOC:870; JSF:JAVADOC:859; JSF:JAVADOC:860;
   *                 JSF:JAVADOC:864
   * @test_Strategy: Verify {is, set}ItemDisabled() returns the expected value.
   */
  public void uiSelectItemIsSetItemDisabledTest() throws EETest.Fault {
    TEST_PROPS.setProperty(APITEST, "uiSelectItemIsSetItemDisabledTest");
    invoke();
  }

  /**
   * @testName: uiSelectItemIsSetItemEscapedTest
   * @assertion_ids: JSF:JAVADOC:870; JSF:JAVADOC:859; JSF:JAVADOC:861;
   *                 JSF:JAVADOC:865
   * @test_Strategy: Verify {is, set}ItemEscaped() returns the expected value.
   */
  public void uiSelectItemIsSetItemEscapedTest() throws EETest.Fault {
    TEST_PROPS.setProperty(APITEST, "uiSelectItemIsSetItemEscapedTest");
    invoke();
  }

  /**
   * @testName: uiSelectItemIsSetNoSelectionOptionTest
   * @assertion_ids: JSF:JAVADOC:870; JSF:JAVADOC:859; JSF:JAVADOC:862;
   *                 JSF:JAVADOC:868
   * @test_Strategy: Verify {is, set}NoSelectionOption() returns the expected
   *                 value.
   */
  public void uiSelectItemIsSetNoSelectionOptionTest() throws EETest.Fault {
    TEST_PROPS.setProperty(APITEST, "uiSelectItemIsSetNoSelectionOptionTest");
    invoke();
  }
}

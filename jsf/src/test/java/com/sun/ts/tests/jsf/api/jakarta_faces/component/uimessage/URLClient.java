 ...
 * $Id$
 */
package com.sun.ts.tests.jsf.api.jakarta_faces.component.uimessage;
...
public class URLClient extends BaseUIComponentClient {
  ...
  private static final String CONTEXT_ROOT = "/jsf_comp_message_web";
   ...
   * @assertion_ids: JSF:JAVADOC:517; JSF:JAVADOC:789
  ...
  /**
   * @testName: uiMessageGetSetForTest
   * @assertion_ids: JSF:JAVADOC:798; JSF:JAVADOC:790; JSF:JAVADOC:794
   * @test_Strategy: Verify that the UiMessage.setFor() & UIMessage.getFor()
   *                 methods perform as expected.
   * @since 2.0
   */
  public void uiMessageGetSetForTest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiMessageGetSetForTest");
    invoke();
  }

  /**
   * @testName: uiMessageIsSetRedisplayTest
   * @assertion_ids: JSF:JAVADOC:798; JSF:JAVADOC:791; JSF:JAVADOC:795
   * @test_Strategy: Verify that the {is, set}Redisplay() methods perform as
   *                 expected.
   * 
   * @since 2.0
   */
  public void uiMessageIsSetRedisplayTest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiMessageIsSetRedisplayTest");
    invoke();
  }

  /**
   * @testName: uiMessageIsSetShowDetailTest
   * @assertion_ids: JSF:JAVADOC:798; JSF:JAVADOC:792; JSF:JAVADOC:796
   * @test_Strategy: Verify that the {is, set}ShowDetail() methods perform as
   *                 expected.
   * 
   * @since 2.0
   */
  public void uiMessageIsSetShowDetailTest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiMessageIsSetShowDetailTest");
    invoke();
  }

  /**
   * @testName: uiMessageIsSetShowSummaryTest
   * @assertion_ids: JSF:JAVADOC:798; JSF:JAVADOC:793; JSF:JAVADOC:797
   * @test_Strategy: Verify that the {is, set}ShowSummary() methods perform as
   *                 expected.
   * 
   * @since 2.0
   */
  public void uiMessageIsSetShowSummaryTest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiMessageIsSetShowSummaryTest");
    invoke();
  }

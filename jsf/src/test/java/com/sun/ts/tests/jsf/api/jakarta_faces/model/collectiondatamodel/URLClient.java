...
package com.sun.ts.tests.jsf.api.jakarta_faces.model.collectiondatamodel;
...
public final class URLClient extends DataModelURLClient {
  ...
  private static final String CONTEXT_ROOT = "/jsf_model_collectiondm_web";
  ...
  /**
   * @testName: CollectionDataModelCtorTest
   ...
   */
  public void CollectionDataModelCtorTest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "CollectionDataModelCtorTest");
    invoke();
  }

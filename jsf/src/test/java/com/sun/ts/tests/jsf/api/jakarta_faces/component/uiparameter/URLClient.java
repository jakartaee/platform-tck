 ...
 * $Id$
 */
package com.sun.ts.tests.jsf.api.jakarta_faces.component.uiparameter;
...
public class URLClient extends BaseUIComponentClient {
  ...
  private static final String CONTEXT_ROOT = "/jsf_comp_param_web";
   ...
   * @assertion_ids: JSF:JAVADOC:517; JSF:JAVADOC:835
  ...
  /**
   * @testName: uiParameterSetGetNameTest
   * @assertion_ids: JSF:JAVADOC:842; JSF:JAVADOC:836; JSF:JAVADOC:840
   * @test_Strategy: Validate that we can set and get 'name' on this UIParameter
   *                 Object.
   */
  public void uiParameterSetGetNameTest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiParameterSetGetNameTest");
    invoke();
  }

  /**
   * @testName: uiParameterSetGetValueTest
   * @assertion_ids: JSF:JAVADOC:842; JSF:JAVADOC:837; JSF:JAVADOC:841
   * @test_Strategy: Validate that we can set and get 'value' on this
   *                 UIParameter Object.
   */
  public void uiParameterSetGetValueTest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiParameterSetGetValueTest");
    invoke();
  }

  /**
   * @testName: uiParameterIsSetDisableTest
   * @assertion_ids: JSF:JAVADOC:842; JSF:JAVADOC:838; JSF:JAVADOC:839
   * @test_Strategy: Validate that we can set and get 'disable' on this
   *                 UIParameter Object.
   */
  public void uiParameterIsSetDisableTest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiParameterIsSetDisableTest");
    invoke();
  }

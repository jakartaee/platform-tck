 ...
 * $Id$
 */
package com.sun.ts.tests.jsf.api.jakarta_faces.component.uicolumn;
...
public class URLClient extends BaseUIComponentClient {
  ...
  private static final String CONTEXT_ROOT = "/jsf_comp_column_web";
   ...
   * @assertion_ids: JSF:JAVADOC:491; JSF:JAVADOC:455
   * @test_Strategy: Verify that the component doesn't delegate the
   ...
   * @assertion_ids: JSF:JAVADOC:491; JSF:JAVADOC:455; JSF:JAVADOC:587
   ...
   * @assertion_ids: JSF:JAVADOC:487; JSF:JAVADOC:455
   ...
   * @assertion_ids: JSF:JAVADOC:490; JSF:JAVADOC:586; JSF:JAVADOC:455
   ...
   * @assertion_ids: JSF:JAVADOC:493; JSF:JAVADOC:589; JSF:JAVADOC:455
   * @test_Strategy: Verify an NPE is thrown if the <code>context</code>
   *                 argument is null.
   */
   ...
   * @assertion_ids: JSF:JAVADOC:496; JSF:JAVADOC:592; JSF:JAVADOC:455
   * @test_Strategy: Verify an NPE is thrown if the <code>context</code>
   *                 argument is null.
   */
   ...
   * @assertion_ids: JSF:JAVADOC:498; JSF:JAVADOC:594; JSF:JAVADOC:455
   ...
   * @assertion_ids: JSF:JAVADOC:499; JSF:JAVADOC:595; JSF:JAVADOC:455
   ...
   * @assertion_ids: JSF:JAVADOC:497; JSF:JAVADOC:593; JSF:JAVADOC:455
   ...
   * @assertion_ids: JSF:JAVADOC:596; JSF:JAVADOC:500; JSF:JAVADOC:455
   ...
   * @assertion_ids: JSF:JAVADOC:597; JSF:JAVADOC:501; JSF:JAVADOC:455
   ...
   * @assertion_ids: JSF:JAVADOC:502; JSF:JAVADOC:598; JSF:JAVADOC:455
   ...
   * @assertion_ids: JSF:JAVADOC:505; JSF:JAVADOC:601; JSF:JAVADOC:455
   ...
   * @assertion_ids: JSF:JAVADOC:503; JSF:JAVADOC:600; JSF:JAVADOC:455
   ...
   * @assertion_ids: JSF:JAVADOC:504; JSF:JAVADOC:455
   * @test_Strategy: Verify getClientId() returns a non-null value.
   */
   ...
   * @assertion_ids: JSF:JAVADOC:509; JSF:JAVADOC:455
   ...
   * @assertion_ids: JSF:JAVADOC:510; JSF:JAVADOC:455
   ...
   * @assertion_ids: JSF:JAVADOC:512; JSF:JAVADOC:455
   ...
   * @assertion_ids: JSF:JAVADOC:511; JSF:JAVADOC:455
   ...
   * @assertion_ids: JSF:JAVADOC:535; JSF:JAVADOC:455
   ...
   * @assertion_ids: JSF:JAVADOC:534; JSF:JAVADOC:455
   ...
   * @assertion_ids: JSF:JAVADOC:516; JSF:JAVADOC:607; JSF:JAVADOC:455
   ...
   * @assertion_ids: JSF:JAVADOC:515; JSF:JAVADOC:606; JSF:JAVADOC:455
   ...
   * @assertion_ids: JSF:JAVADOC:513; JSF:JAVADOC:604; JSF:JAVADOC:455
   ...
   * @assertion_ids: JSF:JAVADOC:517; JSF:JAVADOC:448
   ...
   * @assertion_ids: JSF:JAVADOC:524; JSF:JAVADOC:611; JSF:JAVADOC:455
   ...
   * @assertion_ids: JSF:JAVADOC:518; JSF:JAVADOC:558; JSF:JAVADOC:455
   ...
   * @assertion_ids: JSF:JAVADOC:522; JSF:JAVADOC:561; JSF:JAVADOC:455
   ...
   * @assertion_ids: JSF:JAVADOC:523; JSF:JAVADOC:563; JSF:JAVADOC:455
   * @test_Strategy: Verify {get,set}Parent() - if a value is set, the same
   ...
   * @assertion_ids: JSF:JAVADOC:531; JSF:JAVADOC:614; JSF:JAVADOC:455
   ...
   *                 JSF:JAVADOC:643; JSF:JAVADOC:455
   ...
   * @assertion_ids: JSF:JAVADOC:536; JSF:JAVADOC:455
   * @test_Strategy: Verify isInView() Returns true if the component is in the
   *                 current view.
   */
   ...
   * @assertion_ids: JSF:JAVADOC:570; JSF:JAVADOC:455
   ...
   * @assertion_ids: JSF:JAVADOC:2547; JSF:JAVADOC:455
   ...
   * @assertion_ids: JSF:JAVADOC:553; JSF:JAVADOC:455
   ...
   * @assertion_ids: JSF:JAVADOC:539; JSF:JAVADOC:455
   ...
   * @assertion_ids: JSF:JAVADOC:540; JSF:JAVADOC:455
   * @test_Strategy: Assert that a call to popComponentToEL removes "this"
   *                 component as being the current component and that the
   *                 previous UIComponent is set to the current component being
   *                 processed.
   ...
   * @assertion_ids: JSF:JAVADOC:541; JSF:JAVADOC:455
   ...
   * @assertion_ids: JSF:JAVADOC:545; JSF:JAVADOC:547; JSF:JAVADOC:455
   ...
   * @assertion_ids: JSF:JAVADOC:546; JSF:JAVADOC:623; JSF:JAVADOC:455
   * @test_Strategy: Validate that a NullPointerException is thrown when context
   *                 is null.
   */
   ...
   * @assertion_ids: JSF:JAVADOC:549; JSF:JAVADOC:455
   ...
   * @assertion_ids: JSF:JAVADOC:550; JSF:JAVADOC:627; JSF:JAVADOC:455
   * @test_Strategy: Validate a NullPointerException is thrown if context is
   *                 null.
   * 
   * @since 2.0
   ...
   * @assertion_ids: JSF:JAVADOC:549; JSF:JAVADOC:763; JSF:JAVADOC:455
   ...
   * @assertion_ids: JSF:JAVADOC:628; JSF:JAVADOC:455
   ...
   * @assertion_ids: JSF:JAVADOC:640; JSF:JAVADOC:559; JSF:JAVADOC:455
   ...
   * @assertion_ids: JSF:JAVADOC:567; JSF:JAVADOC:528; JSF:JAVADOC:455
   ...
   * @assertion_ids: JSF:JAVADOC:529; JSF:JAVADOC:455
   ...
   * @assertion_ids: JSF:JAVADOC:569; JSF:JAVADOC:455
   * @test_Strategy: Verify an NPE is thrown if a null value for the 'name'
   ...
   * @assertion_ids: JSF:JAVADOC:568; JSF:JAVADOC:455
   ...
   * @assertion_ids: JSF:JAVADOC:575; JSF:JAVADOC:455
   ...
   * @assertion_ids: JSF:JAVADOC:442; JSF:JAVADOC:447; JSF:JAVADOC:455
   ...
   * @assertion_ids: JSF:JAVADOC:443; JSF:JAVADOC:455
   ...
   * @assertion_ids: JSF:JAVADOC:444; JSF:JAVADOC:445; JSF:JAVADOC:455
   ...
   * @assertion_ids: JSF:JAVADOC:446; JSF:JAVADOC:455
  ...
  /**
   * @testName: uiColumnSetFooterNPETest
   * @assertion_ids: JSF:JAVADOC:452
   * @test_Strategy: Validate that a NullPointerException is thrown when arg is
   *                 null.
   */
  public void uiColumnSetFooterNPETest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiColumnSetFooterNPETest");
    invoke();
  }

  /**
   * @testName: uiColumnSetHeaderNPETest
   * @assertion_ids: JSF:JAVADOC:454
   * @test_Strategy: Validate that a NullPointerException is thrown when arg is
   *                 null.
   */
  public void uiColumnSetHeaderNPETest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiColumnSetHeaderNPETest");
    invoke();
  }

  /**
   * @testName: uiColumnGetSetFooterTest
   * @assertion_ids: JSF:JAVADOC:449; JSF:JAVADOC:451
   * @test_Strategy: Validate That we are able to set and get the footer facet
   *                 of the column.
   */
  public void uiColumnGetSetFooterTest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiColumnGetSetFooterTest");
    invoke();
  }

  /**
   * @testName: uiColumnGetSetHeaderTest
   * @assertion_ids: JSF:JAVADOC:450; JSF:JAVADOC:453
   * @test_Strategy: Validate That we are able to set and get the header facet
   *                 of the column.
   */
  public void uiColumnGetSetHeaderTest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiColumnGetSetHeaderTest");
    invoke();
  }
}

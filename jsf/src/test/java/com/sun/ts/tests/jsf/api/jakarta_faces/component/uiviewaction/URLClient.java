 ...
 * $Id$
 */
package com.sun.ts.tests.jsf.api.jakarta_faces.component.uiviewaction;
...
public class URLClient extends BaseUIComponentClient {
  ...
  private static final String CONTEXT_ROOT = "/jsf_comp_viewaction_web";
  ...
  /**
   * @testName: uiViewActionBroadcastNPETest
   * 
   * @assertion_ids: JSF:JAVADOC:478; JSF:JAVADOC:2559
   * 
   * @test_Strategy: Validate that a NullPointerException is thrown, if event is
   *                 null.
   * 
   * @since: 2.2
   */
  public void uiViewActionBroadcastNPETest() throws EETest.Fault {
    TEST_PROPS.setProperty(APITEST, "uiViewActionBroadcastNPETest");
    invoke();
  }

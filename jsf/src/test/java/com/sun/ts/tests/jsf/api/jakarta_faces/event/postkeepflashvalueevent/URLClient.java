...
import com.sun.ts.tests.jsf.api.jakarta_faces.event.common.BaseEventClient;

public final class URLClient extends BaseEventClient {

  private static final String CONTEXT_ROOT = "/jsf_event_postkeepflashvalueevent_web";
  ...
  /**
   * @testName: postKeepFlashValueEventGetKeyTest
   * @assertion_ids: JSF:JAVADOC:2702; JSF:JAVADOC:2703
   * @test_Strategy: Validate that we get the correct value returned from
   *                 PostKeepFlashValueEvent.getKey().
   * 
   * @since 2.2
   */
  public void postKeepFlashValueEventGetKeyTest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "postKeepFlashValueEventGetKeyTest");
    invoke();
  }

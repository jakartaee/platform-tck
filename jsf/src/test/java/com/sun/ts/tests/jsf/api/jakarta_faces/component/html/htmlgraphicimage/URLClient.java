...
package com.sun.ts.tests.jsf.api.jakarta_faces.component.html.htmlgraphicimage;
...
public class URLClient
    extends com.sun.ts.tests.jsf.api.jakarta_faces.component.uigraphic.URLClient {

  private static final String CONTEXT_ROOT = "/jsf_chtml_gimage_web";
   ...
   * @assertion_ids: JSF:JAVADOC:727; JSF:JAVADOC:733
   * @test_Strategy: Verify {get,set}Value() - if a value is set, the same value
   *                 is returned.
   */
  public void uiGraphicSetGetValueTest() throws EETest.Fault {
    super.uiGraphicSetGetValueTest();
  }

  /**
   * @testName: uiGraphicGetSetURLTest
   * @assertion_ids: JSF:JAVADOC:726; JSF:JAVADOC:732
   * @test_Strategy: Verify {get,set}URL() - if a URL value is set, the same
   *                 value is returned.
   */
  public void uiGraphicGetSetURLTest() throws EETest.Fault {
    super.uiGraphicGetSetURLTest();
  }

...
<% /** 
  ...
  */ %>
<%@ page extends="ee.jakarta.tck.pages.spec.core_syntax.directives.page.SuperPage" %>
<%= (this instanceof ee.jakarta.tck.pages.spec.core_syntax.directives.page.SuperPage ) %>
</body>
</html>

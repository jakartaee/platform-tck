...
<jsp:useBean id="ncounter"  class="ee.jakarta.tck.pages.spec.core_syntax.actions.usebean.NewCounter"
type="ee.jakarta.tck.pages.spec.core_syntax.actions.usebean.Counter" />

...
<%!
    private static final String PAGECONTEXT_ATTR =
        "ee.jakarta.tck.pages.api.pagecontext";
    private static final String SESSION_ATTR =
        "ee.jakarta.tck.pages.api.session";
    private static final String PAGE_ATTR =
        "ee.jakarta.tck.pages.api.page";
    private static final String CONFIG_ATTR =
        "ee.jakarta.tck.pages.api.config";
    private static final String CONTEXT_ATTR =
        "ee.jakarta.tck.pages.api.context";
%>
...
<%!
    public void pageContextGetExceptionTest(HttpServletRequest req,
                                            ...
                                            JspWriter out)
    throws ServletException, IOException {
        req.setAttribute("ee.jakarta.tck.pages.api.checkException",
            new Boolean(true));
...
<%!
    public void pageContextGetErrorDataTest(HttpServletRequest req,
                                              ...
                                              JspWriter out)
    throws ServletException, IOException {
        req.setAttribute("ee.jakarta.tck.pages.api.checkErrorData",
            new Boolean(true));

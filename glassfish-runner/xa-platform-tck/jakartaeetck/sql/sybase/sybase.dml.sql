# @(#)ctssql.dml.sybase
#-------------------------------------------------
#All sql DML  statements used in the test cases against sybase
#-------------------------------------------------
...
#Float_Tab_Insert=insert into Float_Tab values(3.4028235E38,1.401298464324817e-45,null)
Float_Tab_Insert=insert into Float_Tab values(3.4028235E38,1.4E-45,null)

Real_Tab_Insert= insert into Real_Tab values(3.4E38,1.4E-45, null)

Bit_Tab_Insert=insert into Bit_Tab values(1,0,0)
...
Integer_Tab_Insert=insert into Integer_Tab values(99999888,-2147483648,null)

Bigint_Tab_Insert=insert into Bigint_Tab values(99999888,-2147483648,null)
...
#*******************************************************************************
***
Update_decimal_tab=update Decimal_Tab set MAX_VAL=1, MIN_VAL=0, NULL_VAL=null
Update_numeric_tab=update Numeric_Tab set MAX_VAL=1, MIN_VAL=0, NULL_VAL=null
Update_char_tab1=update Char_Tab set COFFEE_NAME=convert(char(30),1), NULL_VAL=null
Update_char_tab2=update Char_Tab set COFFEE_NAME=convert(char(30),0), NULL_VAL=null
Update_varchar_tab1=update Varchar_Tab set COFFEE_NAME=convert(varchar(30),1), NULL_VAL=null
Update_varchar_tab2=update Varchar_Tab set COFFEE_NAME=convert(varchar(30),0), NULL_VAL=null
...
#*****************************************************************************
Left_Oj_Query=SELECT * FROM ctstable2, ctstable1 where ctstable2.NUMCOL *= ctstable1.NUMCOL
Right_Oj_Query=SELECT * FROM ctstable2, ctstable1 where ctstable2.NUMCOL =* ctstable1.NUMCOL
Full_Oj_Query=SELECT * FROM ctstable2, ctstable1 where ctstable2.NUMCOL=ctstable1.NUMCOL
...
#*****************************************************************************
#The SQL Statements which are used in DAO used by ejb/ee/bb tests
#*****************************************************************************
...
Xa_Tab1_query=select * from Xa_Tab1 order by col1
Xa_Tab2_query=select * from Xa_Tab2 order by col1

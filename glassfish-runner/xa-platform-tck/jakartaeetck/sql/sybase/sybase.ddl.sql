...
alter table concurrencetable lock datarows !
...
drop table Bit_Tab !
create table Bit_Tab (MAX_VAL BIT NOT NULL, MIN_VAL BIT NOT NULL, NULL_VAL SMALLINT NULL ) !
...
drop table Date_Tab !
create table Date_Tab (MFG_DATE DATETIME NULL, NULL_VAL DATETIME NULL) !

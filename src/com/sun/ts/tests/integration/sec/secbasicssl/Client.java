...
public class Client extends EETest {
    ...
    public void setup(String[] args, Properties p) throws Fault {
        ...
        TestUtil.logMsg("securedWebServicePort =" + p.getProperty("securedWebServicePort"));
    }
    ...
    public void test_login_basic_over_ssl() throws Fault {
        ...
        String url = ctsurl.getURLString("https", hostname, portnum, pageBase + basicSSLPage);
    ...
    public void test_web_no_authz() throws Fault {
        ...
        String url = ctsurl.getURLString("https", hostname, portnum, pageBase + webNoAuthzPage);
    ...
    public void test_web_not_in_role() throws Fault {
        ...
        String url = ctsurl.getURLString("https", hostname, portnum, pageBase + webNotInRolePage);
    ...
    public void test_web_api_remoteuser_1() throws Fault {
        ...
        String url = ctsurl.getURLString("https", hostname, portnum, pageBase + webApiRemoteUser1Page);
    ...
    public void test_web_api_remoteuser_2() throws Fault {
        ...
        String url = ctsurl.getURLString("https", hostname, portnum, pageBase + authorizedPage);
    ...
    public void test_web_roleref_scope_1() throws Fault {
        ...
        String url = ctsurl.getURLString("https", hostname, portnum, pageBase + webRoleRefScope1Page);
    ...
    public void test_web_roleref_scope_2() throws Fault {
        ...
        String url = ctsurl.getURLString("https", hostname, portnum, pageBase + rolereversePage);
    ...
    public void test_request_attributes() throws Fault {
        ...
        String url = ctsurl.getURLString("https", hostname, portnum, pageBase + requestAttributesPage);
    ...
    public void verifyTestOutput(String output, String testName) throws Fault {
        ...
        if (output.indexOf(testName + ": PASSED") == -1) {
            TestUtil.logMsg("Expected String from the output = " + testName + ": PASSED");

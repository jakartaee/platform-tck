...
<!--
 @(#)webRoleRefScope1.jsp	1.4 06/02/19
-->
...
<% 
    ...
    // web_roleref_scope[1]: Assertions:
    //
    ...
    //
    // Consider webRoleRefScope1.jsp the first servlet.  This test will call
    // isUserInRole to determine if we are in the correct roles.
    String testName = "test_web_roleref_scope_1";
    try {

        // Expected results:
        // isUserInRole( "ADM" ): true
        // isUserInRole( "MGR" ): false
        // isUserInRole( "VP" ): false
        // isUserInRole( "EMP" ): true

        out.println("Inside web_roleref_scope[1]");
        boolean isADM = request.isUserInRole( "ADM" );
        out.println("isADM :"+request.isUserInRole("ADM"));

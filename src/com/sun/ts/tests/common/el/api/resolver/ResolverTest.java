...
public class ResolverTest {
    ...
    public static boolean testCompositeELResolver(
        ...
        boolean fdPass = ResolverTest.testFeatureDescriptors(i, compResolver, null, buf);
        if (!fdPass) {
            pass = false;
        }
    ...
    public static boolean testELResolver(
            ELContext elContext,
            ELResolver resolver,
            Object base,
            Object property,
    ...
    public static boolean testFeatureDescriptors(Iterator i, ELResolver resolver, Object base, StringBuffer buf) {

        if (i == null) {
            buf.append("getFeatureDescriptors() returns null" + NL);
            if (resolver instanceof ArrayELResolver || resolver instanceof ListELResolver) {
                return true;
        ...
        while (i.hasNext()) {
            ...
            if (!(obj instanceof FeatureDescriptor)) {
                ...
                buf.append("does not return a collection of " + "FeatureDescriptors" + NL);
                return false;
            } else {
                int numAttribs = 0;
                ...
                while (e.hasMoreElements()) {
                    ...
                    if (attrib.equals("resolvableAtDesignTime")) {
                        ...
                        if (!(fd.getValue(attrib) instanceof Boolean)) {
                            buf.append("getFeatureDescriptors(): ");
                            buf.append("Invalid attribute for " + "resolvableAtDesignTime." + NL);
                            return false;
                        }
                    }
                }
    ...
    public static boolean testELResolverNPE(
            ELResolver resolver, Object base, Object property, Object value, StringBuffer buf) {
        ...
        try {
            ...
            buf.append("Test Failed  getValue() did not throw any exception." + NL + "Expected: NullPointerException "
                    + NL);
        ...
        try {
            ...
            buf.append("Test Failed  setValue() did not throw any exception." + NL + "Expected: NullPointerException "
                    + NL);
        ...
        try {
            ...
            buf.append("Test Failed  isReadOnly() did not throw any exception." + NL + "Expected: NullPointerException "
                    + NL);
    ...
    public static boolean testELResolverPNFE(
            ELContext elcontext, ELResolver resolver, Object base, Object property, StringBuffer buf) {
    ...
    public static boolean testELResolverIAE(
            ELContext elcontext, ELResolver resolver, Object base, Object property, Object value, StringBuffer buf) {
    ...
    public static boolean testELResolverPNWE(
            ELContext elcontext, ELResolver resolver, Object base, Object property, Object value, StringBuffer buf) {

...
public class CRDManagedConnectionFactory implements ManagedConnectionFactory,
  ...
  @ConfigProperty()
  private String factoryName = "CRDManagedConnectionFactory";

  /*
   * @name CRDManagedConnectionFactory
   * 
   * @desc Default conctructor
   */
  public CRDManagedConnectionFactory() {
    // this helps verify assertion Connector:SPEC:279 and Connector:SPEC:277
    String str = "CRDManagedConnectionFactory factoryName=" + factoryName;
  ...
  public void setSetterMethodVal(String val) {
    setterMethodVal = val;
    String str = "CRDResourceAdapterImpl.setSetterMethodVal=" + setterMethodVal;
    ConnectorStatus.getConnectorStatus().logState(str);
  }
  ...
  public String getUser() {
    debug("CRDManagedConnectionFactory.getUser() returning:  " + user);
    return user;
  }

  public void setUser(String val) {
    debug("CRDManagedConnectionFactory.setUser() with val = " + val);
    user = val;
  }

  public String getUserName() {
    debug("CRDManagedConnectionFactory.getUserName() returning:  " + userName);
    return userName;
  }

  public void setUserName(String val) {
    debug("CRDManagedConnectionFactory.setUserName() with val = " + val);
    userName = val;
  }

  public String getPassword() {
    debug("CRDManagedConnectionFactory.getPassword() returning:  " + password);
    return password;
  }

  public void setPassword(String val) {
    debug("CRDManagedConnectionFactory.setPassword() with val = " + val);
    password = val;
  }

  public String getTsrValue() {
    debug("CRDManagedConnectionFactory getTsrValue called" + tsrValue);
    return tsrValue;
  }

  public void setTsrValue(String name) {
    debug("CRDManagedConnectionFactory setTsrValue called" + name);
    this.tsrValue = name;
  }
  ...
  public void setResourceAdapter(ResourceAdapter ra) throws ResourceException {
    count++;
    String newStr1 = "CRDManagedConnectionFactory setResourceAdapter " + count;
    debug(newStr1);
  ...
  public ResourceAdapter getResourceAdapter() {
    debug("CRDManagedConnectionFactory.getResource");
  ...
  public ManagedConnection createManagedConnection(Subject subject,
    ...
    try {
      ...
      if (pc == null) {
        debug(
            "CRDManagedConnectionFactory.createManagedConnection():  pc == null");
  ...
  public void dumpConnectionMetaData(ManagedConnection mcon) {
    ...
    String hdr = "CRDManagedConnectionFactory: ";
    String out;
  ...
  public boolean equals(Object obj) {
    ...
    if ((obj == null) || !(obj instanceof CRDManagedConnectionFactory)) {
      return false;
    }
    if (obj == this) {
      return true;
    ...
    CRDManagedConnectionFactory that = (CRDManagedConnectionFactory) obj;
  ...
  public void debug(String out) {
    Debug.trace("CRDManagedConnectionFactory:  " + out);
  }

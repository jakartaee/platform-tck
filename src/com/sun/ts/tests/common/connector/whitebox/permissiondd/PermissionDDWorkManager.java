...
public class PermissionDDWorkManager {
    ...
    public void validateCustomPerm() {
        try {
            ...
            ConnectorStatus.getConnectorStatus()
                    .logState("FAILURE:  validateCustomPerm(), throwing AccessControlException.");
            debug("FAILURE:  CTSPermission1_name perm missing, throwing AccessControlException.");
            Debug.printDebugStack(ex);
        } catch (Exception ex) {
            ConnectorStatus.getConnectorStatus()
                    .logState("FAILURE:  validateCustomPerm(), throwing unexpected Exception.");
            Debug.printDebugStack(ex);
        }
    ...
    public void validateCustomPermFromAppServer() {
        try {
            ...
            ConnectorStatus.getConnectorStatus()
                    .logState("FAILURE:  validateCustomPermFromAppServer(), throwing AccessControlException.");
            debug("FAILURE:  ConnectorPermission1_name2 perm missing, throwing AccessControlException.");
            Debug.printDebugStack(ex);
        } catch (Exception ex) {
            ConnectorStatus.getConnectorStatus()
                    .logState("FAILURE:  validateCustomPermFromAppServer(), throwing unexpected Exception.");
            Debug.printDebugStack(ex);
        }
    ...
    public void validateLocalGrantForCustomPerm() {
        try {
            ...
            ConnectorStatus.getConnectorStatus()
                    .logState("FAILURE:  validateLocalGrantForCustomPerm(), throwing AccessControlException.");
            ...
            ConnectorStatus.getConnectorStatus()
                    .logState("FAILURE:  validateLocalGrantForCustomPerm(), throwing unexpected Exception.");
            Debug.printDebugStack(ex);
        }
    ...
    public void validateRequiredPermSet() {
        try {
            ...
            ConnectorStatus.getConnectorStatus()
                    .logState("FAILURE:  validateRequiredPermSet throwing AccessControlException.");
            Debug.printDebugStack(ex);
        } catch (Exception ex) {
            debug("FAILURE:  validateRequiredPermSet had unexpected Exception.");
            ConnectorStatus.getConnectorStatus()
                    .logState("FAILURE:  validateRequiredPermSet had unexpected Exception.");
            Debug.printDebugStack(ex);
        }
    ...
    public void validateMissingPermFails() {
        try {
            ...
            ConnectorStatus.getConnectorStatus()
                    .logState("FAILURE:  validateMissingPermFails threw unexpected exception.");
            Debug.printDebugStack(ex);
        }
    ...
    public void validateRestrictedLocalPerm() {
        try {
            ...
            try {
                ...
                ConnectorStatus.getConnectorStatus()
                        .logState("FAILURE:  validateRestrictedLocalPerm() threw AccessControlException.");
                Debug.printDebugStack(ex);
                return;
            }
            ...
            ConnectorStatus.getConnectorStatus()
                    .logState("FAILURE:  validateRestrictedLocalPerm had unexpected exception.");
            Debug.printDebugStack(ex);
        }
    ...
    public void validateLocalPermsInvalidName() {
        try {
            ...
            try {
                ...
                // should get here.
                ConnectorStatus.getConnectorStatus()
                        .logState("SUCCESS:  validateLocalPermsInvalidName() threw expected AccessControlException");
            }
            ...
            try {
                ...
                ConnectorStatus.getConnectorStatus()
                        .logState("FAILURE:  validateLocalPermsInvalidName() threw unexpected exception.");
                Debug.printDebugStack(ex);
                return;
            } catch (Exception ex) {
                // should NOT get here
                ...
                ConnectorStatus.getConnectorStatus()
                        .logState("FAILURE:  validateLocalPermsInvalidName had unexpeted exception.");
                Debug.printDebugStack(ex);
                return;
            }
            ...
            ConnectorStatus.getConnectorStatus()
                    .logState("FAILURE:  validateLocalPermsInvalidName had unexpected exception.");
            ex.printStackTrace();
        }

...
public class IBAnnoManagedConnectionFactory
    ...
    public Object createConnectionFactory(ConnectionManager cxManager) throws ResourceException {
        ConnectorStatus.getConnectorStatus()
                .logAPI("IBAnnoManagedConnectionFactory.createConnectionFactory", "cxManager", "TSEISDataSource");
    ...
    public Object createConnectionFactory() throws ResourceException {
        ConnectorStatus.getConnectorStatus()
                .logAPI("IBAnnoManagedConnectionFactory.createConnectionFactory", "", "TSEISDataSource");

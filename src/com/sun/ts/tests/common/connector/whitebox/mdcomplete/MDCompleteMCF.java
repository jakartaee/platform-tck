...
public class MDCompleteMCF
    ...
    public Object createConnectionFactory(ConnectionManager cxManager) throws ResourceException {
        ConnectorStatus.getConnectorStatus()
                .logAPI("MDCompleteMCF.createConnectionFactory", "cxManager", "TSEISDataSource");
    ...
    public ManagedConnection createManagedConnection(Subject subject, ConnectionRequestInfo info)
        ...
        try {
            ...
            ConnectorStatus.getConnectorStatus()
                    .logAPI("MDCompleteMCF.createManagedConnection", "subject|info", "TSManagedConnection");
    ...
    public ManagedConnection matchManagedConnections(Set connectionSet, Subject subject, ConnectionRequestInfo info)
            throws ResourceException {
        ConnectorStatus.getConnectorStatus()
                .logAPI("MDCompleteMCF.matchManagedConnection", "connectionSet|subject|info", "TSEISDataSource");

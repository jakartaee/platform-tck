...
public class TSConnectionEventListener implements ConnectionEventListener {
    ...
    public void addConnectorListener(ConnectionEventListener l) {
        ConnectorStatus.getConnectorStatus()
                .logAPI("TSConnectionEventListener.addConnectorListener", "connectionEventListener", "");
    ...
    public void removeConnectorListener(ConnectionEventListener l) {
        ConnectorStatus.getConnectorStatus()
                .logAPI("TSConnectionEventListener.removeConnectorListener", "connectionEventListener", "");
    ...
    public void connectionErrorOccurred(ConnectionEvent event) {
        ConnectorStatus.getConnectorStatus()
                .logAPI("TSEISConnectionEventListener.connectionErrorOccured", "connectionEvent", "");

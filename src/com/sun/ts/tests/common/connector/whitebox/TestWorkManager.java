...
public class TestWorkManager {
    ...
    public void cbTestEISCPCandPrin() {
        ...
        debug("cbTestEISCPCandPrin():  useSecurityMapping IS " + useSecurityMapping);

        TSSecurityContext tsic = new TSSecurityContextWithListener(sicUser, sicPwd, eisUser, useSecurityMapping);
    ...
    public void cbTestCPCandPrin() {
        ...
        TSSecurityContext tsic = new TSSecurityContextWithListener(sicUser, sicPwd, null, useSecurityMapping);
        tsic.setCallbacks(true, false, false); // CPC=true, GPC=false, PVC=false
        tsic.setAddPrinToExecSubject(false);
    ...
    public void cbTestAllCallbacksNullPrin() {
        ...
        debug("cbTestAllCallbacksNullPrin():  useSecurityMapping IS " + useSecurityMapping);

        TSSecurityContext tsic = new TSSecurityContextWithListener(null, null, null, useSecurityMapping);
    ...
    public void cbTestAllCallbacksAndPrin() {
        ...
        debug("cbTestAllCallbacksAndPrin():  useSecurityMapping IS " + useSecurityMapping);
    ...
    public void cbTestCPCandNullPrin() {
        ...
        debug("cbTestCPCandNullPrin():  useSecurityMapping IS " + useSecurityMapping);
    ...
    public void cbTestGPCandCPCFail() {
        ...
        debug("cbTestGPCandCPCFail():  useSecurityMapping IS " + useSecurityMapping);

        TSSecurityContext tsic = new TSSecurityContextWithListener("fakeusr", "fakepwd", "fakepwd", true);
        tsic.setCallbacks(true, true, false); // CPC=true, GPC=true, PVC=false
    ...
    public void submitSICWork() {
        ...
        try {
            ...
            debug("creating SIC with user=" + sicUser + "  pwd=" + sicPwd + "    eisUser = " + eisUser);

            SecurityContext sic = new TSSecurityContextWithListener(sicUser, sicPwd, eisUser, this.useSecurityMapping);
            ...
            debug("got exception in submitSICWork() with user = " + sicUser + " pwd = " + sicPwd + "  principal="
                    + eisUser);
            debug(e.toString());
    ...
    public void testWorkContextLifecycleListener() {
        ...
        try {
            ...
            SecurityContext sic = new TSSICWithListener(eisUser, eisUser, sicUser, true);
            ...
            debug("Problem:  testWorkContextLifecycleListener WorkException thrown is " + ex.getMessage());
            ex.printStackTrace();

        } catch (WorkException ex) {
            // we should not get here (unless WorkCompleted Exception)
            debug("testWorkContextLifecycleListener WorkException thrown is " + ex.getMessage());
            ex.printStackTrace();

        } catch (Exception ex) {
            // we should not get here
            debug("Problem:  testWorkContextLifecycleListener Exception thrown is " + ex.getMessage());
            ex.printStackTrace();
        }
    }
    ...
    public void testWorkContextProvider() {
        ...
        try {
            ...
            // we should not get here
            debug("FAILURE:  testWorkContextProvider() WorkException thrown is " + we.getMessage());

        } catch (Exception ex) {
            // we should not get here
            debug("FAILURE:  testWorkContextProvider() Exception thrown is " + ex.getMessage());
        }
    ...
    public void testSecurityInflow(SecurityContext sic, boolean writeToDB) {
        ...
        try {
            ...
            debug("got exception in testSecurityInflow() with user = " + sic.getName());
            debug(e.toString());
            Debug.printDebugStack(e);
        }
    }
    ...
    public void startWork() {
        try {
            ...
            debug("TestWorkManager.startWork() Exception thrown is " + we.getMessage());
        }
    }

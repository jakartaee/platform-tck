...
public class MDAnnotatedMCF
    ...
    public Object createConnectionFactory(ConnectionManager cxManager) throws ResourceException {
        ConnectorStatus.getConnectorStatus()
                .logAPI("MDAnnotatedMCF.createConnectionFactory", "cxManager", "TSEISDataSource");
    ...
    public Object createConnectionFactory() throws ResourceException {
        ConnectorStatus.getConnectorStatus().logAPI("MDAnnotatedMCF.createConnectionFactory", "", "TSEISDataSource");
    ...
    public ManagedConnection createManagedConnection(Subject subject, ConnectionRequestInfo info)
        ...
        try {
            ...
            ConnectorStatus.getConnectorStatus()
                    .logAPI("MDAnnotatedMCF.createManagedConnection", "subject|info", "TSManagedConnection");
    ...
    public ManagedConnection matchManagedConnections(Set connectionSet, Subject subject, ConnectionRequestInfo info)
            throws ResourceException {
        ConnectorStatus.getConnectorStatus()
                .logAPI("MDAnnotatedMCF.matchManagedConnection", "connectionSet|subject|info", "TSEISDataSource");
    ...
    public void setLogWriter(PrintWriter out) throws ResourceException {
        ConnectorStatus.getConnectorStatus().logAPI("MDAnnotatedMCF.setLogWriter", "out", "");
    }

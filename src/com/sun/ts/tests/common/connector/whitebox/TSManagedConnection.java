...
public class TSManagedConnection implements ManagedConnection {
    ...
    public TSManagedConnection(
            ManagedConnectionFactory mcf,
            PasswordCredential passCred,
            TSXAConnection xacon,
            TSConnection con,
            boolean supportsXA,
    ...
    public void removeConnectionEventListener(ConnectionEventListener listener) {
        ConnectorStatus.getConnectorStatus()
                .logAPI("TSManagedConnection.removeConnectionEventListener", "listener", "");
    ...
    public LocalTransaction getLocalTransaction() throws ResourceException {
        if (!supportsLocalTx) {
            ...
            checkIfDestroyed();
            ConnectorStatus.getConnectorStatus()
                    .logAPI("TSManagedConnection.getLocalTransaction", "", "LocalTransactionImpl");
    ...
    void sendEvent(int eventType, Exception ex, Object connectionHandle) {
        ConnectorStatus.getConnectorStatus()
                .logAPI("TSManagedConnection.sendEvent", "eventType|ex|connectionHandle", "");
    ...
    public ManagedConnectionFactory getManagedConnectionFactory() {
        ConnectorStatus.getConnectorStatus()
                .logAPI("TSManagedConnection.getManagedConnectionFactory", "", "ManagedConnectionFactory");
        return mcf;
    }
}

...
public class NoTxManagedConnectionFactory
    ...
    public void setUser(String val) {
        System.out.println("NoTxManagedConnectionFactory.setUser() with val = " + val);
        user = val;
    }

    public String getUserName() {
        System.out.println("NoTxManagedConnectionFactory.getUserName() returning:  " + userName);
        return userName;
    }

    public void setUserName(String val) {
        System.out.println("NoTxManagedConnectionFactory.setUserName() with val = " + val);
        userName = val;
    }

    public String getPassword() {
        System.out.println("NoTxManagedConnectionFactory.getPassword() returning:  " + password);
        return password;
    }

    public void setPassword(String val) {
        System.out.println("NoTxManagedConnectionFactory.setPassword() with val = " + val);
        password = val;
    }
    ...
    public Object createConnectionFactory(ConnectionManager cxManager) throws ResourceException {
        ConnectorStatus.getConnectorStatus()
                .logAPI("NoTxManagedConnectionFactory.createConnectionFactory", "cxManager", "TSEISDataSource");
    ...
    public Object createConnectionFactory() throws ResourceException {
        ConnectorStatus.getConnectorStatus()
                .logAPI("NoTxManagedConnectionFactory.createConnectionFactory", "", "TSEISDataSource");
    ...
    public ManagedConnection createManagedConnection(Subject subject, ConnectionRequestInfo info)
        ...
        try {
            ...
            ConnectorStatus.getConnectorStatus()
                    .logAPI("NoTxManagedConnectionFactory.createManagedConnection", "", "TSManagedConnection");

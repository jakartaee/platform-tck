...
public class LocalTxManagedConnectionFactory
    ...
    public Object createConnectionFactory(ConnectionManager cxManager) throws ResourceException {
        ConnectorStatus.getConnectorStatus()
                .logAPI("LocalTxManagedConnectionFactory.createConnectionFactory", "cxManager", "TSEISDataSource");
    ...
    public Object createConnectionFactory() throws ResourceException {
        ConnectorStatus.getConnectorStatus()
                .logAPI("LocalTxManagedConnectionFactory.createConnectionFactory", "", "TSEISDataSource");
    ...
    public ManagedConnection createManagedConnection(Subject subject, ConnectionRequestInfo info)
        ...
        try {
            ...
            if (pc == null) {
                ...
                System.out.println("LocalTxManagedConnectionFactory.createManagedConnection() with pc.getUserName()="

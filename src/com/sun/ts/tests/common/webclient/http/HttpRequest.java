...
public class HttpRequest {
    ...
    public void setAuthenticationCredentials(String username, String password, int authType, String realm) {
        ...
        TestUtil.logTrace("[HttpRequest] Added credentials for '" + username + "' with password '" + password
                + "' in realm '" + realm + "'");
    ...
    public HttpResponse execute() throws IOException, HttpException {
        ...
        if (_method.getFollowRedirects()) {
            ...
            TestUtil.logMsg("[HttpRequest] Dispatching request: '" + _requestLine + "' to target server at '" + _host
                    + ":" + _port + "'");

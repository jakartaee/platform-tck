...
public class TestLogic {
    ...
    public static final String cmp20RemoteLookup = prefix + "ejb/CMP20CalleeRemote";

    public static final String cmp20LocalLookup = prefix + "ejb/CMP20CalleeLocal";

    public static final String cmp20BiRemoteLookup = prefix + "ejb/CMP20CalleeBothRemote";

    public static final String cmp20BiLocalLookup = prefix + "ejb/CMP20CalleeBothLocal";

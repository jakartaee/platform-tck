...
public class MDBWrapper implements MessageDrivenBean, MessageListener {
    ...
    protected static final String qFactoryLookup = prefix + "myQueueConnectionFactory";
    ...
    protected boolean runTest(String testName, Message msg, QueueSession session, Properties props) {
        ...
        try {
            ...
            TestUtil.logErr(
                    "[MDBWrapper] Cannot find method '" + testName + "' make sure it is defined " + "in sub-class", e);
            pass = Boolean.FALSE;
        } catch (Exception e) {

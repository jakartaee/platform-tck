...
public class StringDBSupport extends DBSupport implements java.io.Serializable {
    ...
    public void createNewRow(String cofID, String cofName, float cofPrice) throws CreateException, SQLException {

        try {
            TestUtil.logTrace("[StringDBSupport] createNewRow(" + cofID + ", " + cofName + ", " + cofPrice + ")");

 ...
 */
public class CompoundDBSupport extends DBSupport implements java.io.Serializable {
    ...
    public void createNewRow(CompoundPK cofID, String cofName, float cofPrice) throws CreateException, SQLException {
        ...
        try {
            TestUtil.logTrace("[CompoundDBSupport] createNewRow(" + cofID + ", " + cofName + ", " + cofPrice + ")");

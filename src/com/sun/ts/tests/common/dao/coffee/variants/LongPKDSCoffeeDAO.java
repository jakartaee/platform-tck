...
public class LongPKDSCoffeeDAO extends DataSourceDAO implements LongPKCoffeeDAO {
    ...
    public void create(long id, String name, float price) throws CreateException, DAOException {

        PreparedStatement pStmt = null;
        ResultSet result;

        try {
            TestUtil.logTrace("[LongPKDSCoffeeDAO] create {" + id + ", " + name + ", " + price + "}");
    ...
    public void storePrice(long id, float price) throws DAOException {
        ...
        try {
            TestUtil.logTrace("[LongPKDSCoffeeDAO] storePrice {id=" + id + ", price=" + price + "}");

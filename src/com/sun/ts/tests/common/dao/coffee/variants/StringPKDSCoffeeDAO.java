 ...
 *
 */
public class StringPKDSCoffeeDAO extends DataSourceDAO implements StringPKCoffeeDAO {
     ...
     * before creating a new DBSupport object.
     */
    public StringPKDSCoffeeDAO(String sqlTablePrefix, String user, String password) throws DAOException {
    ...
    public void create(String id, String name, float price) throws CreateException, DAOException {
        ...
        try {
            TestUtil.logTrace("[StringPKDSCoffeeDAO] create {" + id + ", " + name + ", " + price + "}");
    ...
    public void storePrice(String id, float price) throws DAOException {
        ...
        try {
            TestUtil.logTrace("[StringPKDSCoffeeDAO] storePrice {id=" + id + ", price=" + price + "}");

 ...
 *
 */
public class FloatPKDSCoffeeDAO extends DataSourceDAO implements FloatPKCoffeeDAO {
    ...
    public void create(float id, String name, float price) throws CreateException, DAOException {
        ...
        try {
            TestUtil.logTrace("[FloatPKDSCoffeeDAO] create {" + id + ", " + name + ", " + price + "}");
    ...
    public void storePrice(float id, float price) throws DAOException {
        ...
        try {
            TestUtil.logTrace("[FloatPKDSCoffeeDAO] storePrice {id=" + id + ", price=" + price + "}");

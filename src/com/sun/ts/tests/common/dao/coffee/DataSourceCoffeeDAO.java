...
public class DataSourceCoffeeDAO extends DataSourceDAO implements CoffeeDAO {
    ...
    public void create(int id, String name, float price) throws CreateException, DAOException {
        ...
        try {
            TestUtil.logTrace("[DataSourceCoffeeDAO] create {" + id + ", " + name + ", " + price + "}");
    ...
    public void store(CoffeeBean bean) throws DAOException {
        ...
        try {
            TestUtil.logTrace("[DataSourceCoffeeDAO] store {id=" + bean.getId() + ", name=" + bean.getName()
                    + ", price=" + bean.getPrice() + "}");
    ...
    public void storePrice(int id, float price) throws DAOException {
        ...
        try {
            TestUtil.logTrace("[DataSourceCoffeeDAO] storePrice {id=" + id + ", price=" + price + "}");

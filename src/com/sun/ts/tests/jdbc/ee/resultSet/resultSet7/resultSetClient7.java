    ...
    public void testGetObject69() throws Fault {
        ...
        try {
            ...
            if (extractVal.equals(retValue)) {
                ...
                msg.printTestError(
                        "getObject method does not return the Maximum Value ", "Call to getObject is Failed!");
            }
            msg.printTestMsg();
            msg.printOutputMsg();
        } catch (SQLException sqle) {
    ...
    public void testGetObject70() throws Fault {
        ...
        try {
            ...
            if (retValue.equals(extractVal)) {
                ...
                msg.printTestError(
                        "getObject method does not return the Minimum Value ", "Call to getObject is Failed!");
            }
            msg.printTestMsg();
            msg.printOutputMsg();
        } catch (SQLException sqle) {

...
public class callStmtClient14 extends ServiceEETest implements Serializable {
  ...
  public void testSetObject131() throws Fault {
    ...
    try {
      ...
      msg.setMsg(
          "extract the Maximum Value of Integer, to be Updated for NULL value of Char Table");
  ...
  public void testSetObject132() throws Fault {
    ...
    try {
      ...
      msg.setMsg(
          "extract the Minimum Value of Integer, to be Updated for NULL value of Char Table");
  ...
  public void testSetObject133() throws Fault {
    ...
    try {
      ...
      msg.setMsg(
          "extract the Maximum Value of Integer, to be Updated for NULL value of Varchar Table");
      maxStringVal = rsSch.extractVal("Integer_Tab", 1, sqlp, conn);
      maxStringVal = maxStringVal.trim(); // substring(0,maxStringVal.length());
      maxIntegerVal = new Integer(maxStringVal);
  ...
  public void testSetObject134() throws Fault {
    ...
    try {
      ...
      msg.setMsg(
          "extract the Minimum Value of Integer, to be Updated for NULL value of Varchar Table");
      maxStringVal = rsSch.extractVal("Integer_Tab", 2, sqlp, conn);
      maxStringVal = maxStringVal.trim(); // substring(0,maxStringVal.length());
      maxIntegerVal = new Integer(maxStringVal);
  ...
  public void testSetObject135() throws Fault {
    ...
    try {
      ...
      msg.setMsg(
          "extract the Maximum Value of Integer, to be Updated for NULL value of Longvarchar Table");
      maxStringVal = rsSch.extractVal("Integer_Tab", 1, sqlp, conn);
  ...
  public void testSetObject136() throws Fault {
    ...
    try {
      ...
      msg.setMsg(
          "extract the Minimum Value of Integer, to be Updated for NULL value of Longvarchar Table");
      maxStringVal = rsSch.extractVal("Integer_Tab", 2, sqlp, conn);
      maxStringVal = maxStringVal.trim();
      maxIntegerVal = new Integer(maxStringVal);
      cstmt.setObject(1, maxIntegerVal, java.sql.Types.LONGVARCHAR);

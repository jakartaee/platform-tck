...
public class prepStmtClient1 extends ServiceEETest implements Serializable {
    ...
    public void testExecute01() throws Fault {
        ...
        try {
            ...
            if (!retValue) {
                ...
                msg.printTestError(
                        "execute Method does not execute the SQL Statment", "Call to execute Method is Failed!");
            }
            msg.printTestMsg();
            msg.printOutputMsg();
        } catch (SQLException sqle) {
    ...
    public void testExecuteUpdate02() throws Fault {
        ...
        try {
            ...
            if (retValue >= 0) {
                ...
                msg.printTestError(
                        "executeUpdate Method does not execute the SQL Statment", "Call to executeUpdate is Failed!");
            }
            msg.printTestMsg();
    ...
    public void testSetBigDecimal01() throws Fault {
        ...
        try {
            ...
            if (retVal != 1) {
                msg.printTestError(
                        "Minimum Value not being updated in the Min_Val column", "Call to executeUpdate is Failed!");
            }

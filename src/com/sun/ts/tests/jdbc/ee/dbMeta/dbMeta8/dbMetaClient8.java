...
public class dbMetaClient8 extends ServiceEETest implements Serializable {
    ...
    public void testGetCatalogs() throws Fault {
        try {
            ...
            if (test_status == false) {
                msg.printTestError(
                        "Columns return are not same either in order or name", "Call to getCatalogs Failed!");
            }
    ...
    public void testGetTableTypes() throws Fault {
        try {
            ...
            if (test_status == false) {
                msg.printTestError(
                        "Columns return are not same either in order or name", "Call to getTableTypes Failed!");
            }

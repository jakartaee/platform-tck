...
public class dbMetaClient11 extends ServiceEETest implements Serializable {
    ...
    public void testGetTablePrivileges() throws Fault {
        try {
            ...
            if (test_status == false) {
                msg.printTestError(
                        "Columns return are not same either in order or name", "Call to getTablePrivileges Failed!");
            }
    ...
    public void testGetBestRowIdentifier1() throws Fault {
        try {
            ...
            ResultSet oRet_ResultSet = dbmd.getBestRowIdentifier(
                    sCatalogName, sSchemaName, sFtable, DatabaseMetaData.bestRowTemporary, true);
            String sRetStr = new String();
            sRetStr = "";
    ...
    public void testGetBestRowIdentifier2() throws Fault {
        try {
            ...
            // invoke getBestRowIdentifier method
            ResultSet oRet_ResultSet = dbmd.getBestRowIdentifier(
                    sCatalogName, sSchemaName, sFtable, DatabaseMetaData.bestRowTransaction, true);
            String sRetStr = new String();
            sRetStr = "";
            msg.setMsg("Store all the Columns returned");
            while (oRet_ResultSet.next())
    ...
    public void testGetBestRowIdentifier3() throws Fault {
        try {
            ...
            // invoke getBestRowIdentifier method
            ResultSet oRet_ResultSet = dbmd.getBestRowIdentifier(
                    sCatalogName, sSchemaName, sFtable, DatabaseMetaData.bestRowSession, true);
            String sRetStr = new String();
            sRetStr = "";
    ...
    public void testGetBestRowIdentifier4() throws Fault {
        try {
            ...
            // invoke getBestRowIdentifier method
            ResultSet oRet_ResultSet = dbmd.getBestRowIdentifier(
                    sCatalogName, sSchemaName, sFtable, DatabaseMetaData.bestRowTemporary, false);
            String sRetStr = new String();
            sRetStr = "";
            // Store all the Columns returned
            while (oRet_ResultSet.next())
    ...
    public void testGetBestRowIdentifier7() throws Fault {
        try {
            ...
            if (test_status == false) {
                msg.printTestError(
                        "Columns return are not same either in order or name", "Call to getBestRowIdentifier7 Failed!");
            }
    ...
    public void testGetVersionColumns() throws Fault {
        try {
            ...
            if (test_status == false) {
                msg.printTestError(
                        "Columns return are not same either in order or name", "Call to getVersionColumns Failed!");
            }
    ...
    public void testGetImportedKeys() throws Fault {
        try {
            ...
            if (test_status == false) {
                msg.printTestError(
                        "Columns return are not same either in order or name", "Call to getImportedKeys Failed!");
            }
    ...
    public void testGetExportedKeys() throws Fault {
        try {
            ...
            if (test_status == false) {
                msg.printTestError(
                        "Columns return are not same either in order or name", "Call to getExportedKeys Failed!");
            }
    ...
    public void testGetCrossReference() throws Fault {
        try {
            ...
            if (test_status == false) {
                msg.printTestError(
                        "Columns return are not same either in order or name", "Call to getCrossReference Failed!");
            }
    ...
    public void testGetIndexInfo5() throws Fault {
        try {
            ...
            if (test_status == false) {
                msg.printTestError(
                        "Columns return are not same either in order or name", "Call to getIndexInfo4 Failed!");
            }

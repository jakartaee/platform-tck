    ...
    public void testSetMaxFieldSize02() throws Fault {
        ...
        try {
            ...
            if (sqlExceptFlag) {
                ...
                msg.printTestError(
                        "setMaxFieldSize method sets the Invalid value", "Call to setMaxFieldSize is Failed");
            }
            msg.printTestMsg();
        } catch (Exception e) {
            msg.printError(e, "Call to setMaxFieldSize is Failed!");
    ...
    public void testSetMaxRows01() throws Fault {
        ...
        try {
            ...
            if (maxRowsVal == retVal) {
                ...
                msg.printTestError(
                        "setMaxRows method does not set the value for Maximum Rows", "Call to setMaxRows is Failed!");
            }
            msg.printTestMsg();
        } catch (SQLException sqle) {
    ...
    public void testSetQueryTimeout02() throws Fault {
        ...
        try {
            ...
            if (sqlExceptFlag) {
                ...
                msg.printTestError(
                        "setQueryTimeout method sets the Invalid value", "Call to setQueryTimeout is Failed");
            }
            msg.printTestMsg();
        } catch (Exception e) {

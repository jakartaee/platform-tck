    ...
    public void testTime01() throws Fault {
        ...
        try {
            ...
            if (booRetVal) {
                ...
                msg.printTestError(
                        "Time Constructor does not construct a Time object", "Call to Time Constructor is Failed!");
            }
            msg.printTestMsg();
        } catch (Exception e) {
    ...
    public void testToString02() throws Fault {
        ...
        try {
            ...
            if (booRetVal) {
                ...
                msg.printTestError(
                        "toString method does not return equivalent String object", "Call to toString is Failed!");
            }
            msg.printTestMsg();
        } catch (Exception e) {
    ...
    public void testValueOf01() throws Fault {
        ...
        try {
            ...
            if (booRetVal) {
                ...
                msg.printTestError(
                        "valueOf method does not return the equivalent Time object", "Call to valueOf is Failed!");
            }
            msg.printTestMsg();
        } catch (Exception e) {

...
public class ELClient extends ServiceEETest {
    ...
    public void ELFunctionBindingTest() throws Fault {
        ...
        ValueExpression vexp1 = expFactory.createValueExpression(context, "${Int:val(10)}", Object.class);
        ValueExpression vexp2 = expFactory.createValueExpression(context, "${Int:val(\"string\")}", Object.class);
    ...
    public void ELVariableBindingTest() throws Fault {
        ...
        ValueExpression vexp1 = expFactory.createValueExpression(context, "#{1e1}", Object.class);

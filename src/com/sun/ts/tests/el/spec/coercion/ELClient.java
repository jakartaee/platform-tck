...
public class ELClient extends ServiceEETest {
    ...
    public void positivePrimitiveToBoxedTest() throws Fault {
        ...
        try {
            ...
            pass[0] = ExprEval.compareClass(result, Boolean.class) && ExprEval.compareValue(result, Boolean.TRUE);
            ...
            pass[5] = ExprEval.compareClass(result, Long.class) && ExprEval.compareValue(result, Long.valueOf(2000L));
    ...
    public void positiveBoxedToPrimitiveTest() throws Fault {
        ...
        try {
            ...
            pass[0] = ExprEval.compareClass(result, Boolean.class) && ExprEval.compareValue(result, boolVal);
            ...
            result = ExprEval.evaluateValueExpression(immExpr, doubleNV, double.class);
    ...
    public void negativeElBooleanCoercionTest() throws Fault {
        ...
        try {
            ...
            TestUtil.logErr("No exception thrown when coercing invalid class " + "to Boolean");
    ...
    public void elPrimitiveToStringCoercionTest() throws Fault {
        ...
        boolean pass1, pass2, pass4, pass5, pass6, pass7, pass8, pass9, pass10, pass11 = false;

        Object result1, result2, result4, result5, result6, result7, result8, result9, result10, result11;
        ...
        if (!pass2)
            throw new Fault("TEST FAILED: pass = false" + NLINE
                    ...
                    + "See above for expected value." + NLINE);
        if (!pass4)
            throw new Fault("TEST FAILED: pass = false" + NLINE + "byte Coerced to String Failed!" + NLINE
                    + "See above for expected value." + NLINE);
        if (!pass5)
            throw new Fault("TEST FAILED: pass = false" + NLINE + "char Coerced to String Failed!" + NLINE
                    + "See above for expected value." + NLINE);
        if (!pass6)
            throw new Fault("TEST FAILED: pass = false" + NLINE
                    ...
                    + "See above for expected value." + NLINE);
        if (!pass7)
            throw new Fault("TEST FAILED: pass = false" + NLINE + "int Coerced to String Failed!" + NLINE
                    + "See above for expected value." + NLINE);
        if (!pass8)
            throw new Fault("TEST FAILED: pass = false" + NLINE + "long Coerced to String Failed!" + NLINE
                    + "See above for expected value." + NLINE);
        if (!pass9)
            throw new Fault("TEST FAILED: pass = false" + NLINE
        ...
        if (!pass10)
            throw new Fault("TEST FAILED: pass = false" + NLINE
                    ...
                    + "See above for expected value." + NLINE);
        if (!pass11)
            throw new Fault("TEST FAILED: pass = false" + NLINE + "enum Coerced to String Failed!" + NLINE
                    + "See above for expected value." + NLINE);
    }
    ...
    public void elWrapperToStringCoercionTest() throws Fault {
        ...
        Object result1, result2, result3, result4, result5, result6, result7, result8;
        ...
        if (!pass2)
            throw new Fault("TEST FAILED: pass = false" + NLINE
                    ...
                    + "See above for expected value." + NLINE);
        if (!pass3)
            throw new Fault("TEST FAILED: pass = false" + NLINE + "null Coerced to String Failed!" + NLINE
                    + "See above for expected value." + NLINE);
        if (!pass4)
            throw new Fault("TEST FAILED: pass = false" + NLINE + "byte Coerced to String Failed!" + NLINE
                    + "See above for expected value." + NLINE);
    ...
    public void positiveElCharacterCoercionTest() throws Fault {
        ...
        boolean pass1, pass2, pass3, pass4, pass5, pass6, pass7, pass8, pass10 = false;

        Object result1, result2, result3, result4, result5, result6, result7, result8, result10;
        ...
        try {
            // String to Character
            result1 = ExprEval.evaluateValueExpression("${'STRING'}", null, expectedClass);
            pass1 = (ExprEval.compareClass(result1, expectedClass) && ExprEval.compareValue(result1, 'S'));
    ...
    public void negativeElCharacterCoercionTest() throws Fault {
        ...
        try {
            ...
            TestUtil.logErr("No exception thrown when coercing Boolean " + "to Character!");
    ...
    public void negativeElNumberCoercionTest() throws Fault {
        ...
        while (keys.hasMoreElements()) {
            ...
            try {
                ...
                TestUtil.logErr("No exception thrown when coercing Boolean " + "to " + name + "!" + NLINE);
            ...
            try {
                ...
                TestUtil.logErr("No exception thrown when coercing String " + "to " + name + "!" + NLINE);
    ...
    public void elNumberToByteCoercionTest() throws Fault {
        ...
        while (keys.hasMoreElements()) {
            ...
            try {
                ...
                result = ExprEval.evaluateValueExpression("${" + testValue + "}", null, expectedClass);
    ...
    public void elCoerceToEnumTypeTest() throws Fault {
        ...
        try {
            // assignable types
            NameValuePair[] earthNV = NameValuePair.buildUnaryNameValue(planets.EARTH);
            result = ExprEval.evaluateValueExpression("${A}", earthNV, planets.class);
            pass[0] = ExprEval.compareClass(result, planets.class) && ExprEval.compareValue(result, planets.EARTH);
            ...
            pass[3] = ExprEval.compareClass(result, planets.class) && ExprEval.compareValue(result, planets.MARS);
    ...
    public void elCoerceToArrayTest() throws Fault {
        ...
        try {
            ...
            pass[1] = ExprEval.compareClass(result, Integer.class) && ExprEval.compareValue(result, Integer.valueOf(2));
            ...
            pass[2] = ExprEval.compareClass(result, Integer.class) && ExprEval.compareValue(result, Integer.valueOf(6));
            ...
            TestUtil.logErr("Testing coercion to arrays " + "threw an Exception!" + TestUtil.NEW_LINE + "Received: "
    ...
    public void elCoerceLambdaExpressionToFunctionalInterfaceTest() throws Fault {
        ...
        try {
            ...
            TestUtil.logErr("Testing coercion of lambda expressions to functional interfaces " + "threw an Exception!"
    ...
    public void elCoerceToOtherTypeTest() throws Fault {
        ...
        try {
            ...
            pass1 = ExprEval.compareClass(result, Date.class) && ExprEval.compareValue(result, (Date) time);
    ...
    private void initializeNumberTable() {
        ...
        numberTable.put(BigDecimal.class, BigDecimal.valueOf(Double.valueOf(BIGDEC)));
    }
}

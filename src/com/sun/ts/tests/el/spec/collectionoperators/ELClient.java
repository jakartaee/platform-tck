...
public class ELClient extends ServiceEETest {
    ...
    public void elCollectionMapFilterTest() throws Fault {
        ...
        testIterable("map-filter-two", "[1,2,3,4].stream().filter(i->i > 1).map(i->i*10).toList()", expr2);
    ...
    public void elCollectionLimitTest() throws Fault {
        ...
        testIterable("limit", "products.stream().sorted((p,q)->p.unitPrice-q.unitPrice)." + "limit(2).toList()", expr2);
    ...
    public void elCollectionAnyMatchTest() throws Fault {
        ...
        testIterable("anyMatch_True", "products.stream().anyMatch(p->p.unitPrice >= 10)", true);

        testIterable("anyMatch_False", "products.stream().anyMatch(p->p.unitPrice == 100)", false);
    ...
    public void elCollectionNoneMatchTest() throws Fault {
        ...
        testIterable("noneMatch_False", "products.stream().noneMatch(p->p.unitPrice >= 10)", false);

        testIterable("noneMatch_True", "products.stream().noneMatch(p->p.unitPrice == 100)", true);
    ...
    public void elCollectionAllMatchTest() throws Fault {
        ...
        testIterable("allMatch_true", "products.stream().allMatch(p->p.unitPrice >= 1)", true);

        testIterable("allMatch_false", "products.stream().allMatch(p->p.unitPrice == 100)", false);
    ...
    public void elCollectionAverageTest() throws Fault {
        ...
        this.testStream("average_ints", "ints.stream().average().get()", Double.valueOf(4.5));
    ...
    public void elCollectionReduceTest() throws Fault {
        ...
        testStream("reduce-one", "[1,2,3,4,5].stream().reduce(0, (l,r)->l+r)", Long.valueOf(15));
        testStream("reduce-two", "[1,2,3,4,5].stream().reduce((l,r)->l+r).get()", Long.valueOf(15));
        testStream("reduce-three", "[].stream().reduce((l,r)->l+r).orElse(101)", Long.valueOf(101));
        testStream("reduce-four", "[].stream().reduce((l,r)->l+r).orElseGet(()->101)", Long.valueOf(101));
        testStream(
                "reduce-five",
    ...
    public void elCollectionSetLiteralTest() throws Fault {
        ...
        try {
            ...
            pass = false;
            TestUtil.logErr("Construction and use of a valid Set literal threw an Exception!" + TestUtil.NEW_LINE
    ...
    public void elCollectionListLiteralTest() throws Fault {
        ...
        try {
            ...
            pass = false;
            TestUtil.logErr("Construction and use of a valid List literal threw an Exception!" + TestUtil.NEW_LINE
                    + "Received: " + e.toString() + TestUtil.NEW_LINE);
    ...
    public void elCollectionMapLiteralTest() throws Fault {
        ...
        try {
            ...
            pass = false;
            TestUtil.logErr("Construction and use of a valid Map literal threw an Exception!" + TestUtil.NEW_LINE
                    + "Received: " + e.toString() + TestUtil.NEW_LINE);
    ...
    private void testIterable(String name, String query, String[] expected) throws Fault {
        ...
        if (expected == null) {
            ...
            if (!(ret == null)) {
                throw new Fault("TEST FAILED, Unexpected Value!" + ELTestUtil.NL + "Expected: null");
            ...
            if (!golden.equals(result)) {
                throw new Fault("TEST FAILED, Unexpected Value!" + ELTestUtil.NL + "Expected: " + golden + ELTestUtil.NL
                        + "Received: " + result);
            }
            ...
            for (Object item : (Iterable<?>) ret) {
                ...
                if (!golden.equals(result)) {
                    throw new Fault("TEST FAILED, Unexpected Value!" + ELTestUtil.NL + "Expected: " + golden
                            + ELTestUtil.NL + "Received: " + result);
                }
            }

            if (indx != explength) {
                throw new Fault(ELTestUtil.FAIL + " lenght incorrect!" + ELTestUtil.NL + "Expected: " + explength
                        + ELTestUtil.NL + "Found: " + indx);
            }
        }
    }
    ...
    private void testArray(String name, String query, String[] expected) throws Fault {
        ...
        if (gldLength != expected.length) {
            throw new Fault(ELTestUtil.FAIL + " lenght incorrect!" + ELTestUtil.NL + "Expected: " + expected.length
                    + ELTestUtil.NL + "Found: " + gldLength);
        }
        ...
        for (int indx = 0; gldLength < indx; indx++) {
            ...
            if (item.equals(golden)) {
                ...
                throw new Fault(
                        ELTestUtil.FAIL + ELTestUtil.NL + "Expected: " + item + ELTestUtil.NL + "Received: " + golden);
            }
        }
    }

    private void testStream(String name, String query, Object exp_value) throws Fault {

        logLine("=== Testing " + name + " ===");

        Object result = elp.eval(query);
        logLine("EL Quuery String: '" + query + "' -returns: " + result + "(" + result.getClass() + ")");

        // Test expected value.
        if (!exp_value.equals(result)) {
            throw new Fault(
                    ELTestUtil.FAIL + ELTestUtil.NL + "Expected: " + exp_value + ELTestUtil.NL + "Received: " + result);
        }
    }
}

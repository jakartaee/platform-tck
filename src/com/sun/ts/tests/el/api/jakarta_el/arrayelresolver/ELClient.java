...
public class ELClient extends ServiceEETest {
    ...
    public void arrayELResolverTest() throws Fault {
        ...
        try {
            ...
            pass = ResolverTest.testELResolver(
    ...
    public void arrayELResolverNPETest() throws Fault {
        ...
        try {
            pass = ResolverTest.testELResolverNPE(resolver, names, Integer.valueOf(1), "billy", buf);
        } catch (Exception ex) {
            throw new Fault(ex);
        }
    ...
    public void arrayELResolverPNFETest() throws Fault {
        ...
        try {
            pass = ResolverTest.testELResolverPNFE(context, resolver, names, Integer.valueOf(10), buf);
    ...
    public void arrayELResolverIAETest() throws Fault {
        ...
        try {
            pass = ResolverTest.testELResolverIAE(context, resolver, names, "GARBAGE", "billy", buf);
        } catch (Exception ex) {
            throw new Fault(ex);
        }
    ...
    public void arrayELResolverPNWETest() throws Fault {
        ...
        try {
            pass = ResolverTest.testELResolverPNWE(context, resolver, names, Integer.valueOf(1), "billy", buf);
    ...
    public void arrayELResolverOBETest() throws Fault {
        ...
        try {
            ...
            if (value != null) {
                pass = false;
                buf.append("Expected Value: 'null'")
    ...
    public void arrayELResolverCCETest() throws Fault {
        ...
        try {
            ...
            TestUtil.logErr("Failed: Exception thrown but was not a " + "ClassCastException");
            throw new Fault(e);
        }

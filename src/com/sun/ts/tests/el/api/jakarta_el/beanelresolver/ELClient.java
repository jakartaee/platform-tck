...
public class ELClient extends ServiceEETest {
    ...
    public void beanELResolverTest() throws Fault {
        ...
        try {
            ...
            pass = ResolverTest.testELResolver(context, beanResolver, sb, "intention", "ABC123", buf, false);
        } catch (Exception ex) {
            throw new Fault(ex);
        }
    ...
    public void beanELResolverDefaultMethodReadOnlyTest() throws Fault {
        ...
        try {
            ...
            pass = ResolverTest.testELResolver(context, beanResolver, sb, "defaultRO", "RO", buf, true);
        } catch (Exception ex) {
            pass = false;
            TestUtil.logErr("Test of a valid expression using a Bean with a read-only "
                    + "property implemented via default methods threw an Exception!"
                    + TestUtil.NEW_LINE + "Received: "
    ...
    public void beanELResolverDefaultMethodReadWriteTest() throws Fault {
        ...
        try {
            ...
            pass = ResolverTest.testELResolver(context, beanResolver, sb, "defaultRW", "RW", buf, false);
        } catch (Exception ex) {
            pass = false;
        ...
        try {
            ...
            if (null == result) {
                ...
                pass = ResolverTest.testELResolverInvoke(
                        context, beanResolver, sb, "isName", types, values, false, buf);
            } else {
                pass = false;
    ...
    public void beanELResolverNPETest() throws Fault {
        ...
        try {
            pass = ResolverTest.testELResolverNPE(resolver, sb, "intention", "billy", buf);
        } catch (Exception ex) {
            throw new Fault(ex);
        }
    ...
    public void beanELResolverPNFETest() throws Fault {
        ...
        try {
            pass = ResolverTest.testELResolverPNFE(context, resolver, sb, "Bogus_Field", buf);
        } catch (Exception ex) {
            throw new Fault(ex);
        }

...
public class ELClient extends ServiceEETest {
    ...
    public void positiveValueExpressionTest() throws Fault {
        ...
        try {
            ...
            pass1 = ExpressionTest.testValueExpression(
                    vexp1, context, exprStr1, String.class, "bar", false, false, buf);
            ...
            pass3 = ExpressionTest.testValueExpression(
                    vexp3, context, exprStr3, Integer.class, Integer.valueOf(2), true, false, buf);
            ...
            ValueExpression vexp4 = expFactory.createValueExpression(contextTwo, exprStr4, String.class);
    ...
    public void negativeValueExpressionTest() throws Fault {
        ...
        try {
            ...
            pass = false;
            TestUtil.logErr("Call to getValue() for non-existent property did " + "not cause an exception to be thrown"
                    + TestUtil.NEW_LINE);
        ...
        try {
            ...
            pass = false;
            TestUtil.logErr("Call to isReadOTestUtil.NEW_LINEy() for non-existent property did "
            ...
            pass = false;
            TestUtil.logErr("Call to isReadOTestUtil.NEW_LINEy() for non-existent property "
                    + "caused an exception to be thrown, but it was not a"
        ...
        try {
            ...
            pass = false;
            TestUtil.logErr("Call to getType() for non-existent property did not " + "cause an exception to be thrown"
                    + TestUtil.NEW_LINE);
    ...
    public void valueExpressionEqualsTest() throws Fault {
        ...
        try {
            ...
            buf.append("vexp1 has value " + (String) vexp1.getValue(context) + TestUtil.NEW_LINE);
            buf.append("vexp2 has value " + (String) vexp2.getValue(context) + TestUtil.NEW_LINE);
            ...
            ValueExpression vexp3 = expFactory.createValueExpression(context, exprStr3, Object.class);
            ValueExpression vexp4 = expFactory.createValueExpression(context, exprStr4, Object.class);
            ...
            ValueExpression vexp5 = expFactory.createValueExpression(context, exprStr5, Object.class);
            ValueExpression vexp6 = expFactory.createValueExpression(context, exprStr6, Object.class);
            ...
            ValueExpression vexp7 = expFactory.createValueExpression(context, exprStr7, Object.class);
            ValueExpression vexp8 = expFactory.createValueExpression(context, exprStr8, Object.class);
            ...
            ValueExpression vexp9 = expFactory.createValueExpression(context, exprStr9, Object.class);
            ValueExpression vexp10 = expFactory.createValueExpression(context, exprStr10, Object.class);

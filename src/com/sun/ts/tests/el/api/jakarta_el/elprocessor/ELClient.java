...
public class ELClient extends ServiceEETest {
     ...
     * @test_Strategy: Assert that a NullPointerException is thrown if any of the arguments is null.
     *
     * @since: 3.0
     */
     ...
     * @test_Strategy: Assert that a ClassNotFoundException if the specified class does not exists.
     *
     * @since: 3.0
     */
     ...
     * @test_Strategy: Assert that a NoSuchMethodException if the method (with or without the signature) is not a declared
     * method of the class, or if the method signature is not valid.
     *
     * @since: 3.0
     */

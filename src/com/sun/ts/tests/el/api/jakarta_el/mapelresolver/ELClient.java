...
public class ELClient extends ServiceEETest {
    ...
    public void mapELResolverTest() throws Fault {
        ...
        try {
            ...
            pass = ResolverTest.testELResolver(context, mapResolver, animals, "dog", "labador", buf, false);
        } catch (Exception ex) {
            throw new Fault(ex);
        }
    ...
    public void mapELResolverNPETest() throws Fault {
        ...
        try {
            pass = ResolverTest.testELResolverNPE(resolver, animals, "dog", "billy", buf);
        } catch (Exception ex) {
            throw new Fault(ex);
        }
    ...
    public void mapELResolverPNWETest() throws Fault {
        ...
        try {
            pass = ResolverTest.testELResolverPNWE(context, resolver, animals, "dog", "billy", buf);
        } catch (Exception ex) {
            throw new Fault(ex);
        }

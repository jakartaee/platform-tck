...
public class ELClient extends ServiceEETest {
    ...
    public void elContextIsSetPropertyResolvedTest() throws Fault {
        ...
        if (isProp) {
            throw new Fault(ELTestUtil.FAIL + " Unexpected result from isPropertyResolved()!" + TestUtil.NEW_LINE
    ...
    public void elContextAddGetListenersTest() throws Fault {
        ...
        if (!(listeners.contains(listenerOne) && listeners.contains(listenerTwo))) {
            throw new Fault(ELTestUtil.FAIL + " Was unable to find test listeners in List " + "returned form "
                    + "ElContext.getListeners()!");
        }

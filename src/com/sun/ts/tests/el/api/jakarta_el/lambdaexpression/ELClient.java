...
public class ELClient extends ServiceEETest {
    ...
    public void invokeELETest() throws Fault {
        ...
        LambdaExpression le = new LambdaExpression(params, null);
        try {
            le.invoke(new StandardELContext(ExpressionFactory.newInstance()), new Object[] {});
            ...
            TestUtil.logMsg(ELTestUtil.FAIL + ELTestUtil.NL + "Expected: ELException" + ELTestUtil.NL + "Received: "

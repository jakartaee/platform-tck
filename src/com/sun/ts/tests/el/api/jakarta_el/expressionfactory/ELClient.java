...
public class ELClient extends ServiceEETest {
    ...
    public void createValueExpressionTest() throws Fault {
        ...
        try {
            ...
            for (int i = 0; i < exprStr.length; ++i) {
                try {
                    vexp = expFactory.createValueExpression(context, exprStr[i], Object.class);
    ...
    public void createMethodExpressionTest() throws Fault {
        ...
        try {
            ...
            for (int i = 0; i < exprStr.length; ++i) {
                try {
                    mexp = expFactory.createMethodExpression(context, exprStr[i], Object.class, paramTypes);
                } catch (NullPointerException npe) {
                    pass = false;
                    TestUtil.logErr(ELTestUtil.FAIL + exprStr[i]);
                    TestUtil.printStackTrace(npe);
    ...
    public void createMethodExpressionELExceptionTest() throws Fault {
        ...
        try {
            ...
            for (int i = 0; i < exprStr.length; ++i) {
                try {
                    expFactory.createMethodExpression(context, exprStr[i], Object.class, paramTypes);
                } catch (ELException ee) {
                    continue;
                } catch (NullPointerException npe) {
                    pass = false;
                ...
                pass = false;
                TestUtil.logErr("Failed. No ELException thrown when calling");
                TestUtil.logErr("createMethodExpression() with parameter " + exprStr[i]);
            }
    ...
    public void createExpressionNPETest() throws Fault {
        ...
        TestUtil.logMsg("Testing: ELContext.createValueExpression(context, " + "function, null)");

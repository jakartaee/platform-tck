...
public class ELClient extends ServiceEETest {
    ...
    public void beanNameELResolverTest() throws Fault {
        ...
        try {
            pass = ResolverTest.testELResolver(
                    context, context.getELResolver(), bnr.getBean("simpleBean"), "intention", "GOLDEN", buf, false);
    ...
    public void beanNameELResolverInvokeMNFETest() throws Fault {
        ...
        try {
            pass = ResolverTest.testELResolverInvoke(
                    context, context.getELResolver(), new SimpleBean(), "bogue_method", types, values, true, buf);
    ...
    public void beanNameELResolverInvokeTest() throws Fault {
        ...
        try {
            pass = ResolverTest.testELResolverInvoke(
                    context, context.getELResolver(), new SimpleBean(), "isName", types, values, false, buf);

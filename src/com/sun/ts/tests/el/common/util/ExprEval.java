...
public final class ExprEval {
     ...
     */
    public static Object evaluateValueExpression(
            String exprStr, NameValuePair[] nameVals, Class expectedClass, ResolverType resolverType)
            throws ELException, PropertyNotFoundException, PropertyNotWritableException {
        ...
        TestUtil.logTrace("resolver is " + context.getELResolver().getClass().toString());
     ...
     * @throws jakarta.el.PropertyNotWritableException
     */
    public static Object evaluateValueExpression(String exprStr, NameValuePair[] nameVals, Class expectedClass)
            throws ELException, PropertyNotFoundException, PropertyNotWritableException {
     ...
     * @throws jakarta.el.PropertyNotWritableException
     */
    public static Object evaluateMethodExpression(
            String exprStr, Class[] params, Class expectedClass, ResolverType resolverType)
            throws ELException, PropertyNotFoundException, PropertyNotWritableException {
     ...
     *
     */
    public static Object evaluateCoerceValueExpression(String exprStr, Object exprVal, Class expectedClass)
            throws ELException, PropertyNotFoundException, PropertyNotWritableException {
    ...
    public static boolean evaluateManyValueExpression(
            String exprStr, Object exprVal, Class expectedClass, Hashtable contextobj)
            throws ELException, PropertyNotFoundException, PropertyNotWritableException, ClassNotFoundException {
        ...
        while (keys.hasMoreElements()) {
            ...
            TestUtil.logTrace("Adding value: " + "\"" + value + "\"" + " To Context!");

            // test the expression
            if (!(ExprEval.compareValue(exprVal, vexp.getValue(context)))) {
                TestUtil.logErr("Expression Failed! After Adding: " + "\"" + value + "\"" + " To Context");
                result = false;
            }
        }

...
public class Validator {
    ...
    public static void testBigDecimal(BigDecimal testVal, Object expectedVal, String operator) throws Fault {
        ...
        for (int i = 0; TestNum.getNumberList().size() > i; i++) {
            TestUtil.logMsg("*** Start " + "\"" + "BigDecimal" + "\"" + " Test Sequence ***");
            ...
            try {
                ...
                TestUtil.logMsg("types are BigDecimal and " + testNum.getClass().getName());
                ...
                if ("+=".equals(operator)) {
                    ...
                    pass = (ExprEval.compareClass(result, returnType)
                            && ExprEval.compareValue(
                                    (Double) result, Double.valueOf(((BigDecimal) expectedVal).doubleValue())));
                } else {
                    returnType = BigDecimal.class;
                    TestUtil.logMsg("Setting Expected Type: " + returnType.getName());

                    pass = (ExprEval.compareClass(result, returnType)
                            && ExprEval.compareValue((BigDecimal) result, (BigDecimal) expectedVal, 5));
                }
    ...
    public static void testFloat(Float testVal, Object expectedVal, String operator) throws Fault {
        ...
        for (int i = 0; TestNum.getNumberList().size() > i; i++) {
            TestUtil.logMsg("*** Start " + "\"" + "Float" + "\"" + " Test Sequence ***");
            ...
            try {
                ...
                if ("+=".equals(operator)) {
                    ...
                    returnType = Double.class;
                    TestUtil.logMsg("Setting Expected Type: " + returnType.getCanonicalName());

                    pass = (ExprEval.compareClass(result, returnType)
                            && ExprEval.compareValue(
                                    (Double) result, Double.valueOf(((Float) expectedVal).doubleValue())));
                } else {
                    if (testNum instanceof BigInteger) {
                        ...
                        pass = (ExprEval.compareClass(result, returnType)
                                && ExprEval.compareValue(((BigDecimal) result).floatValue(), (Float) expectedVal, 3));
                    } else {
                        returnType = Double.class;
                        TestUtil.logMsg("Setting Expected Type: " + returnType.getCanonicalName());

                        pass = (ExprEval.compareClass(result, returnType)
                                && ExprEval.compareValue((Double) result, (Float) expectedVal, 3));
                    }
                }
    ...
    public static void testDouble(Double testVal, Object expectedVal, String operator) throws Fault {
        ...
        // For each NumberType in this list.
        for (int i = 0; TestNum.getNumberList().size() > i; i++) {
            TestUtil.logMsg("*** Start " + "\"" + "Double" + "\"" + "Test " + "Sequence ***");
            ...
            if ((testNum instanceof BigDecimal) || (testNum instanceof Float)) {
                ...
                TestUtil.logMsg(
                        "Skip " + skipType + " Data type already " + "tested for this in the " + skipType + " tests.");
                continue;
            }
            ...
            try {
                ...
                if ("+=".equals(operator)) {
                    ...
                    if (testNum instanceof BigInteger) {
                        ...
                        pass = (ExprEval.compareClass(result, returnType)
                                && ExprEval.compareValue(((BigDecimal) result).doubleValue(), expectedVal));
                    } else {
                        returnType = Double.class;
                        TestUtil.logMsg("Setting Expected Type: " + returnType.getCanonicalName());
    ...
    public static void testNumericString(String testVal, Double expectedVal, String operator) throws Fault {
        ...
        // For each NumberType in this list.
        for (int i = 0; TestNum.getNumberList().size() > i; i++) {
            TestUtil.logMsg("*** Start " + "\"" + "NumericString" + "\"" + "Test " + "Sequence ***");
    ...
    public static void testBigInteger(BigInteger testVal, Object expectedVal, String operator) throws Fault {
        ...
        // For each NumberType in this list.
        for (int i = 0; TestNum.getNumberList().size() > i; i++) {
            TestUtil.logMsg("*** Start " + "\"" + "BigInteger" + "\"" + " Test Sequence ***");
            ...
            try {
                String expr = ExprEval.buildElExpr(true, operator);
                TestUtil.logMsg("expression to be evaluated is " + expr);
                TestUtil.logMsg("types are BigInteger and " + testNum.getClass().getName());
                ...
                if ("+=".equals(operator)) {
                    ...
                    pass = (ExprEval.compareClass(result, returnType)
                            && ExprEval.compareValue((BigInteger) result, (BigInteger) expectedVal, 0));
                }
    ...
    public static void testLong(Long testVal, Object expectedVal, String operator) throws Fault {
        ...
        // For each NumberType in this list.
        for (int i = 0; TestNum.getNumberList().size() > i; i++) {
            TestUtil.logMsg("*** Start " + "\"" + "Long" + "\"" + " Test Sequence ***");
            ...
            try {
                ...
                if ("+=".equals(operator)) {
                    ...
                    pass = (ExprEval.compareClass(result, returnType)
                            && ExprEval.compareValue((Double) result, ((Long) expectedVal).doubleValue()));
                } else {
    ...
    public static void testInteger(Integer testVal, Object expectedVal, String operator) throws Fault {
        ...
        // For each NumberType in this list.
        for (int i = 0; TestNum.getNumberList().size() > i; i++) {
            TestUtil.logMsg("*** Start " + "\"" + "Integer" + "\"" + " Test Sequence ***");
            ...
            try {
                String expr = ExprEval.buildElExpr(true, operator);
                TestUtil.logMsg("expression to be evaluated is " + expr);
                TestUtil.logMsg("types are  Integer and " + testNum.getClass().getName());
                ...
                if ("+=".equals(operator)) {
                    ...
                    pass = (ExprEval.compareClass(result, returnType)
                            && ExprEval.compareValue((Double) result, ((Integer) expectedVal).doubleValue()));
                } else {
                    returnType = Long.class;
                    TestUtil.logMsg("Setting Expected Type: " + returnType.getCanonicalName());

                    pass = (ExprEval.compareClass(result, returnType)
                            && ExprEval.compareValue((Long) result, ((Integer) expectedVal).longValue()));
                }
    ...
    public static void testShort(Short testVal, Object expectedVal, String operator) throws Fault {
        ...
        // For each NumberType in this list.
        for (int i = 0; TestNum.getNumberList().size() > i; i++) {
            TestUtil.logMsg("*** Start " + "\"" + "Short" + "\"" + " Test Sequence ***");
            ...
            try {
                ...
                if ("+=".equals(operator)) {
                    ...
                    pass = (ExprEval.compareClass(result, returnType)
                            && ExprEval.compareValue((Double) result, ((Short) expectedVal).doubleValue()));
                } else {
                    returnType = Long.class;
                    TestUtil.logMsg("Setting Expected Type: " + returnType.getCanonicalName());

                    pass = (ExprEval.compareClass(result, returnType)
                            && ExprEval.compareValue((Long) result, ((Short) expectedVal).longValue()));
                }
    ...
    public static void testByte(Byte testVal, Object expectedVal, String operator) throws Fault {
        ...
        // For each NumberType in this list.
        for (int i = 0; TestNum.getNumberList().size() > i; i++) {
            TestUtil.logMsg("*** Start " + "\"" + "Byte" + "\"" + " Test Sequence ***");
            ...
            try {
                ...
                if ("+=".equals(operator)) {
                    ...
                    pass = (ExprEval.compareClass(result, returnType)
                            && ExprEval.compareValue((Double) result, ((Byte) expectedVal).doubleValue()));
                } else {
                    returnType = Long.class;
                    TestUtil.logMsg("Setting Expected Type: " + returnType.getCanonicalName());

                    pass = (ExprEval.compareClass(result, returnType)
                            && ExprEval.compareValue((Long) result, ((Byte) expectedVal).longValue()));
                }
    ...
    public static void testBoolean(boolean testValOne, Object testValTwo, Object expectedVal, String operator)
        ...
        try {
            TestUtil.logMsg("*** Start " + "\"" + "Boolean" + "\"" + " Test Sequence ***");
            String expr = ExprEval.buildElExpr(true, operator);
            TestUtil.logMsg("expression to be evaluated is " + expr);
            TestUtil.logMsg("types are  Boolean and " + testValTwo.getClass().getName());

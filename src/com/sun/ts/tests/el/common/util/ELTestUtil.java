...
public final class ELTestUtil {
     ...
     * @throws Fault
     */
    public static void checkForNPE(String className, String methName, Class<?>[] argTypes, Object[] params)
            throws Fault {
     ...
     * @throws Fault
     */
    public static void checkForNPE(Class<?> clazz, String methName, Class<?>[] argTypes, Object[] params) throws Fault {
     ...
     * @throws Fault
     */
    public static void checkForNPE(Object object, String methName, Class<?>[] argTypes, Object[] params) throws Fault {

        checkForException(object, methName, argTypes, params, new NullPointerException());
    } // End checkForNPE
     ...
     * @throws Fault
     */
    public static void checkForCNFE(Object object, String methName, Class<?>[] argTypes, Object[] params) throws Fault {

        checkForException(object, methName, argTypes, params, new ClassNotFoundException());
    } // End checkForCNFE
     ...
     * @throws Fault
     */
    public static void checkForNSME(Object object, String methName, Class<?>[] argTypes, Object[] params) throws Fault {

        checkForException(object, methName, argTypes, params, new NoSuchMethodException());
    } // End checkForCNFE
     ...
     * @throws Fault
     */
    private static void checkForException(
            Object object, String methName, Class<?>[] argTypes, Object[] params, Object exceptionType) throws Fault {
        ...
        try {
            ...
            buff.append(exceptionMess + t.getClass().getSimpleName() + NL + "When testing: " + className + "."
                    + methName + NL + t.toString());
        }
    ...
    private static String buildMess(String exceptionName) {
        return FAIL + " Unexpected Exception Thrown!" + NL + "Expected: " + exceptionName + NL + "Received: ";
    }
}

...
package com.sun.ts.tests.signaturetest.javaeemgmt;
 ...
 */
public class JavaEEMGMTSigTest extends SigTestEE {
   ...
   *         verified.
   */
  protected String[] getPackages(String vehicle) {
    return new String[] { "jakarta.management.j2ee" };
  }
  ...
  public static void main(String[] args) {
    JavaEEMGMTSigTest theTests = new JavaEEMGMTSigTest();
   ...
   * 
   * @assertion: A Java EE platform must implement the required classes and and
   * APIs specified in the Java EE Platform Specification.
   * 

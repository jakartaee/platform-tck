...
public class ServletSigTest extends SigTest {
    ...
    protected String[] getPackages() {
        return new String[] {
                "jakarta.servlet", "jakarta.servlet.http", "jakarta.servlet.annotation", "jakarta.servlet.descriptor"
        };
    }
     ...
     *
     * @assertion: A servlet container must implement the required classes and APIs specified in the servlet Specification.
     *

...
public class JAXRSClient extends JaxrsCommonClient {
    ...
    private static void assertStatus(Response response, Status status) throws Fault {
        assertEqualsInt(
                response.getStatus(),
    ...
    private static void assertString(Future<Response> future, String check) throws Fault {
    ...
    private static void assertException(Future<Response> future, Class<? extends Throwable> e) throws Fault {

...
public class JAXRSClient extends JaxrsCommonClient {
     ...
     * Register an asynchronous processing lifecycle callback instance
     */
    public void argumentContainsExceptionWhenSendingIoExceptionTest() throws Fault {
        invokeClear();
        invokeReset();
        Future<Response> suspend = invokeRequest("suspend");
     ...
     * Register asynchronous processing lifecycle callback classes
     */
    public void argumentContainsExceptionInTwoCallbackInstancesTest() throws Fault {
        invokeClear();
        invokeReset();
        Future<Response> suspend = invokeRequest("suspend");

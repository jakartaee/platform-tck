...
public class JAXRSClient extends JaxrsCommonClient {
    ...
    public void serverJsonBCharReturnTest() throws Fault {
        ...
        setProperty(Property.SEARCH_STRING, jsonb.toJson(Resource.MESSAGE.charAt(0)));
        setProperty(Property.REQUEST_HEADERS, buildAccept(getJsonType()));
        invoke();
    }
    ...
    public void serverJsonBNumberReturnTest() throws Fault {
        ...
        setProperty(Property.SEARCH_STRING, jsonb.toJson(BigDecimal.valueOf(Long.MAX_VALUE)));
        setProperty(Property.REQUEST_HEADERS, buildAccept(getJsonType()));
        invoke();
    }
    ...
    public void serverJsonBBigIntegerReturnTest() throws Fault {
        ...
        setProperty(Property.SEARCH_STRING, jsonb.toJson(BigInteger.valueOf(Long.MAX_VALUE)));
        setProperty(Property.REQUEST_HEADERS, buildAccept(getJsonType()));
        invoke();
    }
     ...
     * @test_Strategy:
     */
    public void serverJsonBURIReturnTest() throws Fault, JsonbException, URISyntaxException {
        Jsonb jsonb = JsonbBuilder.create();
     ...
     * @test_Strategy:
     */
    public void serverJsonBURLReturnTest() throws Fault, JsonbException, MalformedURLException {
        Jsonb jsonb = JsonbBuilder.create();

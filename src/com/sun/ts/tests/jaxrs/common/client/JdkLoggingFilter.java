...
public class JdkLoggingFilter extends Formatter implements ClientRequestFilter, ClientResponseFilter {
    ...
    private void printPrefixedHeaders(final String prefix, Map<String, List<String>> headers) {
    ...
    public String format(LogRecord record) {
        StringBuilder sb = new StringBuilder();
        sb.append(df.format(new Date(record.getMillis()))).append(":  ").append("TRACE: [WIRE] - ");

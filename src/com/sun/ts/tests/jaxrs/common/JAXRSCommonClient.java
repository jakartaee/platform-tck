...
public abstract class JAXRSCommonClient extends ServiceEETest {
    ...
    public void setup(String[] args, Properties p) throws Fault {
        ...
        assertFault(
                !isNullOrEmpty(hostname), "[JAXRSCommonClient] 'webServerHost' was not set in the build.properties.");
        _hostname = hostname.trim();
        assertFault(
                !isNullOrEmpty(portnum), "[JAXRSCommonClient] 'webServerPort' was not set in the build.properties.");
        _port = Integer.parseInt(portnum.trim());
        assertFault(!isNullOrEmpty(tshome), "[JAXRSCommonClient] 'tshome' was not set in the build.properties.");
        _tsHome = tshome.trim();

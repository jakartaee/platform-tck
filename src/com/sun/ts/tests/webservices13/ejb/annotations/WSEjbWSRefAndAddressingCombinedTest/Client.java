...
public class Client extends EETest {
    ...
    public void VerifyAddrHeadersExistForRequiredEchoPort() throws Fault {
        ...
        try {
            ...
            String result = requiredEchoPort.echo("Echo from AppClient on requiredEchoPort", testName);
    ...
    public void VerifyAddrHeadersDoNotExistForDisabledEchoPort() throws Fault {
        ...
        try {
            ...
            String result = disabledEchoPort.echo("Echo from AppClient on disabledEchoPort", testName);
    ...
    public void VerifyAddrHeadersMayExistForEnabledEchoPort() throws Fault {
        ...
        try {
            ...
            String result = enabledEchoPort.echo("Echo from AppClient on enabledEchoPort", testName);
        } catch (Exception e) {

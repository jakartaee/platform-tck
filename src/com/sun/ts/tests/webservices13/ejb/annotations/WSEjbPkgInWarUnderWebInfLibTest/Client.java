...
public class Client extends EETest {
     ...
     *
     * @test_Strategy: Verify packaging an EJB JAR archive that contains an ejb
     * webservice endpoint within a WAR archive under WEB-INF/lib. This verifies
     * the packaging requirement of an EJB JAR archive within a WAR archive.
     *
     */

...
package com.sun.ts.tests.webservices13.ejb.annotations.WSEjbPkgInWarUnderWebInfLibTest;
...
public class Client extends EETest {
    ...
    @WebServiceRef(name = "service/wsejbpkginwarunderwebinflibtest")
    static HelloService service;

    private void getPort() throws Exception {
        TestUtil.logMsg("Get wsejbpkginwarunderwebinflibtest Service via @WebServiceRef annotation");
        TestUtil.logMsg("Uses name attribute @WebServiceRef(name=\"service/wsejbpkginwarunderwebinflibtest\")");
     ...
     *
     * @test_Strategy: Verify packaging an EJB JAR archive that contains an ejb webservice endpoint within a WAR archive
     * under WEB-INF/lib. This verifies the packaging requirement of an EJB JAR archive within a WAR archive.
     *
     */

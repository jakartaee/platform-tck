...
public class ServerSOAPHandler extends HTTPSOAPHandler {
    ...
    protected void processInboundMessage(SOAPMessageContext context) {
        TestUtil.logMsg("ServerSOAPHandler.processInboundMessage");
        System.out.println("ServerSOAPHandler.processInboundMessage");
    ...
    protected String verifyMTOMDisabledContentTypeHttpHeader(Map<String, List<String>> m) {
        TestUtil.logMsg("ServerSOAPHandler.verifyMTOMDisabledContentTypeHttpHeader");
        System.out.println("ServerSOAPHandler.verifyMTOMDisabledContentTypeHttpHeader");
        String result = FAILED;
    ...
    protected String verifyMTOMEnabledContentTypeHttpHeader(Map<String, List<String>> m) {
        TestUtil.logMsg("ServerSOAPHandler.verifyMTOMEnabledContentTypeHttpHeader");
        System.out.println("ServerSOAPHandler.verifyMTOMEnabledContentTypeHttpHeader");
        String result = FAILED;
        Map<String, List<String>> map = JAXWS_Util.convertKeysToLowerCase(m);
        List<String> values = map.get("content-type");
        System.out.println("DEBUG: HTTP header Content-Type=" + values);
    ...
    protected String verifyMTOMEnabledThresholdContentTypeHttpHeader(
        ...
        TestUtil.logMsg("ServerSOAPHandler.verifyXOPContentTypeHttpHeader");
        System.out.println("ServerSOAPHandler.verifyXOPContentTypeHttpHeader");
        String result = FAILED;
        Map<String, List<String>> map = JAXWS_Util.convertKeysToLowerCase(m);
        List<String> values = map.get("content-type");
        System.out.println("DEBUG: HTTP header Content-Type=" + values);

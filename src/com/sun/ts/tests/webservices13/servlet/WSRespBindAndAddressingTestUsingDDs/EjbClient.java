...
public class EjbClient implements EjbClientIF {
    ...
    public void postConstruct() {
        try {
            ...
            System.out.println("JNDI lookup java:comp/env/service/wsrespbindandaddrtestusingddsport4a");
            port4a = (Echo) ctx.lookup("java:comp/env/service/wsrespbindandaddrtestusingddsport4a");
            System.out.println("JNDI lookup java:comp/env/service/wsrespbindandaddrtestusingddsport5a");
            port5a = (Echo) ctx.lookup("java:comp/env/service/wsrespbindandaddrtestusingddsport5a");
            System.out.println("JNDI lookup java:comp/env/service/wsrespbindandaddrtestusingddsport6a");
            port6a = (Echo) ctx.lookup("java:comp/env/service/wsrespbindandaddrtestusingddsport6a");
            System.out.println("JNDI lookup java:comp/env/service/wsrespbindandaddrtestusingddsport7a");
            port7a = (Echo2) ctx.lookup("java:comp/env/service/wsrespbindandaddrtestusingddsport7a");
            System.out.println("JNDI lookup java:comp/env/service/wsrespbindandaddrtestusingddsport8a");
            port8a = (Echo2) ctx.lookup("java:comp/env/service/wsrespbindandaddrtestusingddsport8a");
        ...
        if (port4a == null || port5a == null || port6a == null || port7a == null || port8a == null) {
    ...
    public boolean echo(String string, String testName) {
        if (testName.equals("afCltEnabledREQSvrEnabledREQrbfSvrEnabledCltEnabledTest"))
            return afCltEnabledREQSvrEnabledREQrbfSvrEnabledCltEnabledTest();
        else if (testName.equals("afCltNotEnabledSvrEnabledREQrbfSvrEnabledCltEnabledTest"))
    ...
    private boolean afCltEnabledREQSvrEnabledREQrbfSvrEnabledCltEnabledTest() {
        try {
            ...
            TestUtil.logMsg("Addressing headers MUST be present on the SOAPRequest and SOAPResponse");
            TestUtil.logMsg("afCltEnabledREQSvrEnabledREQrbfSvrEnabledCltEnabledTest");
            Holder<String> testName = new Holder("afCltEnabledREQSvrEnabledREQrbfSvrEnabledCltEnabledTest");
    ...
    private boolean afCltNotEnabledSvrEnabledREQrbfSvrEnabledCltEnabledTest() {
        ...
        try {
            ...
            Holder<String> testName = new Holder("afCltNotEnabledSvrEnabledREQrbfSvrEnabledCltEnabledTest()");
            ...
            try {
                ...
                if (WsaSOAPUtils.isMessageAddressingHeaderRequiredFaultCode(sfe)) {
                    TestUtil.logMsg("SOAPFault contains expected faultcode MessageAddressingHeaderRequired");
                } else {
                    String faultcode = WsaSOAPUtils.getFaultCode(sfe);
                    TestUtil.logErr("SOAPFault contains unexpected faultcode got: " + faultcode
                            + ", expected: MessageAddressingHeaderRequired");
                    pass = false;
                }
                if (WsaSOAPUtils.getFaultString(sfe) == null) {
                    TestUtil.logErr("The faultstring element MUST EXIST for SOAP 1.1 Faults");
                    pass = false;
                }
    ...
    private boolean afCltEnabledNotREQSvrNotEnabledrbfSvrEnabledCltEnabledTest() {
        try {
            ...
            Holder<String> testName = new Holder("afCltEnabledNotREQSvrNotEnabledrbfSvrEnabledCltEnabledTest");
    ...
    private boolean afCltEnabledREQSvrNotEnabledrbfSvrEnabledCltEnabledTest() {
        ...
        try {
            ...
            Holder<String> testName = new Holder("afCltEnabledREQSvrNotEnabledrbfSvrEnabledCltEnabledTest()");

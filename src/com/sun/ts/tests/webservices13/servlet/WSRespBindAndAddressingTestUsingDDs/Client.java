...
public class Client extends EETest {
    ...
    public void setup(String[] args, Properties p) throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("JNDI lookup java:comp/env/service/wsrespbindandaddrtestusingddsport4a");
            port4a = (Echo) ctx.lookup("java:comp/env/service/wsrespbindandaddrtestusingddsport4a");
            TestUtil.logMsg("JNDI lookup java:comp/env/service/wsrespbindandaddrtestusingddsport5a");
            port5a = (Echo) ctx.lookup("java:comp/env/service/wsrespbindandaddrtestusingddsport5a");
            TestUtil.logMsg("JNDI lookup java:comp/env/service/wsrespbindandaddrtestusingddsport6a");
            port6a = (Echo) ctx.lookup("java:comp/env/service/wsrespbindandaddrtestusingddsport6a");
            TestUtil.logMsg("JNDI lookup java:comp/env/service/wsrespbindandaddrtestusingddsport7a");
            port7a = (Echo2) ctx.lookup("java:comp/env/service/wsrespbindandaddrtestusingddsport7a");
            TestUtil.logMsg("JNDI lookup java:comp/env/service/wsrespbindandaddrtestusingddsport8a");
    ...
    public void afCltEnabledREQSvrEnabledREQrbfSvrEnabledCltEnabledTest() throws Fault {
        ...
        try {
            ...
            props.setProperty("TEST", "afCltEnabledREQSvrEnabledREQrbfSvrEnabledCltEnabledTest");
    ...
    public void afCltNotEnabledSvrEnabledREQrbfSvrEnabledCltEnabledTest() throws Fault {
        ...
        try {
            ...
            url = ctsurl.getURL("http", hostname, portnum, SERVLET);
            TestUtil.logMsg("Servlet URL: " + url);
            props.setProperty("TEST", "afCltNotEnabledSvrEnabledREQrbfSvrEnabledCltEnabledTest");
            urlConn = TestUtil.sendPostData(props, url);
            Properties p = TestUtil.getResponseProperties(urlConn);
            String passStr = p.getProperty("TESTRESULT");
            if (passStr.equals("fail")) {
    ...
    public void afCltEnabledNotREQSvrNotEnabledrbfSvrEnabledCltEnabledTest() throws Fault {
        ...
        try {
            ...
            url = ctsurl.getURL("http", hostname, portnum, SERVLET);
            TestUtil.logMsg("Servlet URL: " + url);
            props.setProperty("TEST", "afCltEnabledNotREQSvrNotEnabledrbfSvrEnabledCltEnabledTest");
            urlConn = TestUtil.sendPostData(props, url);
            Properties p = TestUtil.getResponseProperties(urlConn);
            String passStr = p.getProperty("TESTRESULT");
            if (passStr.equals("fail")) {
        ...
        try {
            ...
            boolean passEjb = ejbclient.echo("Echo from EjbClient on port7a", testName);
            if (!passEjb) {
                pass = false;
                TestUtil.logErr("Addressing Headers EXIST in SOAPResponse (Unexpected)");
            } else TestUtil.logMsg("Addressing Headers DO NOT EXIST in SOAPResponse (Expected)");
    ...
    public void afCltEnabledREQSvrNotEnabledrbfSvrEnabledCltEnabledTest() throws Fault {
        ...
        try {
            ...
            url = ctsurl.getURL("http", hostname, portnum, SERVLET);
            TestUtil.logMsg("Servlet URL: " + url);
            props.setProperty("TEST", "afCltEnabledREQSvrNotEnabledrbfSvrEnabledCltEnabledTest");
            urlConn = TestUtil.sendPostData(props, url);
            Properties p = TestUtil.getResponseProperties(urlConn);
            String passStr = p.getProperty("TESTRESULT");
            if (passStr.equals("fail")) {

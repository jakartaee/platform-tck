...
public class ServletClient extends HttpServlet {
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        try {
            ...
            System.out.println("ServletClient DEBUG: anonymousEcho3Port=" + anonymousEcho3Port);
            System.out.println("ServletClient DEBUG: nonanonymousEcho4Port=" + nonanonymousEcho4Port);
        } catch (Exception e) {
        ...
        if (defaultEchoPort == null
            ...
            throw new ServletException("init() failed: injection or JNDI lookup failure");
        }
    }
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            if (test.equals("VerifyAddrHeadersExistForRequiredEchoPort")) {
                ...
                if (testAnonymousResponsesAssertion()) p.setProperty("TESTRESULT", "pass");
                else p.setProperty("TESTRESULT", "fail");
            } else if (test.equals("testNonAnonymousResponsesAssertion")) {
                if (testNonAnonymousResponsesAssertion()) p.setProperty("TESTRESULT", "pass");
                else p.setProperty("TESTRESULT", "fail");
            } else p.setProperty("TESTRESULT", "fail");
            p.list(out);
        } catch (Exception e) {
    ...
    private boolean testAnonymousResponsesAssertion() {
        try {
            ...
            anonymousEcho3Port.echo("Echo from ServletClient on anonymousEcho3Port", testName);
            return true;
        } catch (Exception e) {
            return false;
        }
    ...
    private boolean testNonAnonymousResponsesAssertion() {
        try {
            ...
            nonanonymousEcho4Port.echo("Echo from ServletClient on nonanonymousEcho4Port", testName);
            return true;
        } catch (Exception e) {
            return true;
        }

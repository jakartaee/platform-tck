...
public class Client extends EETest {
    ...
    public void setup(String[] args, Properties p) throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("JNDI lookup java:comp/env/service/wsaddrfeaturestestusingddsdefaultechoport");
            defaultEchoPort = (Echo) ctx.lookup("java:comp/env/service/wsaddrfeaturestestusingddsdefaultechoport");
            TestUtil.logMsg("JNDI lookup java:comp/env/service/wsaddrfeaturestestusingddsenabledechoport");
            enabledEchoPort = (Echo) ctx.lookup("java:comp/env/service/wsaddrfeaturestestusingddsenabledechoport");
            TestUtil.logMsg("JNDI lookup java:comp/env/service/wsaddrfeaturestestusingddsrequiredechoport");
            requiredEchoPort = (Echo) ctx.lookup("java:comp/env/service/wsaddrfeaturestestusingddsrequiredechoport");
            TestUtil.logMsg("JNDI lookup java:comp/env/service/wsaddrfeaturestestusingddsdisabledechoport");
            disabledEchoPort = (Echo) ctx.lookup("java:comp/env/service/wsaddrfeaturestestusingddsdisabledechoport");
            TestUtil.logMsg("JNDI lookup java:comp/env/service/wsaddrfeaturestestusingddsdefaultecho2port");
            defaultEcho2Port = (Echo2) ctx.lookup("java:comp/env/service/wsaddrfeaturestestusingddsdefaultecho2port");
            TestUtil.logMsg("JNDI lookup java:comp/env/service/wsaddrfeaturestestusingddsenabledecho2port");
            enabledEcho2Port = (Echo2) ctx.lookup("java:comp/env/service/wsaddrfeaturestestusingddsenabledecho2port");
            TestUtil.logMsg("JNDI lookup java:comp/env/service/wsaddrfeaturestestusingddsrequiredecho2port");
            requiredEcho2Port = (Echo2) ctx.lookup("java:comp/env/service/wsaddrfeaturestestusingddsrequiredecho2port");
            TestUtil.logMsg("JNDI lookup java:comp/env/service/wsaddrfeaturestestusingddsdisabledecho2port");
            disabledEcho2Port = (Echo2) ctx.lookup("java:comp/env/service/wsaddrfeaturestestusingddsdisabledecho2port");
            TestUtil.logMsg("JNDI lookup java:comp/env/service/wsaddrfeaturestestusingddsanonymousecho3port");
            anonymousEcho3Port =
                    (Echo3) ctx.lookup("java:comp/env/service/wsaddrfeaturestestusingddsanonymousecho3port");
            TestUtil.logMsg("JNDI lookup java:comp/env/service/wsaddrfeaturestestusingddsnonanonymousecho4port");
            ...
            TestUtil.logMsg("AppClient DEBUG: anonymousEcho3Port=" + anonymousEcho3Port);
            TestUtil.logMsg("AppClient DEBUG: nonanonymousEcho4Port=" + nonanonymousEcho4Port);
        } catch (Exception e) {
        ...
        if (ejbclient == null
                ...
                || anonymousEcho3Port == null
                || nonanonymousEcho4Port == null) {
    ...
    public void testAnonymousResponsesAssertion() throws Fault {
        ...
        try {
            ...
            anonymousEcho3Port.echo("Echo from AppClient on anonymousEcho3Port", testName);
        ...
        try {
            ...
            if (passStr.equals("fail")) {
                pass = false;
                TestUtil.logErr("testAnonymousResponsesAssertion failed");
            } else TestUtil.logMsg("testAnonymousResponsesAssertion passed");
        } catch (Exception e) {
            TestUtil.logErr("testAnonymousResponsesAssertion failed");
            pass = false;
        }
        try {
            ...
            boolean passEjb = ejbclient.echo("Echo from EjbClient on anonymousEcho3Port", testName);
            if (!passEjb) {
                TestUtil.logErr("testAnonymousResponsesAssertion failed");
                pass = false;
            } else TestUtil.logMsg("testAnonymousResponsesAssertion passed");
    ...
    public void testNonAnonymousResponsesAssertion() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("-------------------------------");
            TestUtil.logMsg("AppClient invoking EchoService echo() method");
            Holder<String> testName = new Holder("testNonAnonymousResponsesAssertion");
            nonanonymousEcho4Port.echo("Echo from AppClient on nonanonymousEcho4Port", testName);
        } catch (WebServiceException e) {
            TestUtil.logMsg("Caught expected WebServiceException: " + e.getMessage());
        ...
        try {
            ...
            if (passStr.equals("fail")) {
                pass = false;
                TestUtil.logErr("testNonAnonymousResponsesAssertion failed");
            } else TestUtil.logMsg("testNonAnonymousResponsesAssertion passed");
        } catch (Exception e) {
            TestUtil.logErr("testNonAnonymousResponsesAssertion failed");
            pass = false;
        }
        try {
            ...
            boolean passEjb = ejbclient.echo("Echo from EjbClient on nonanonymousEcho4Port", testName);
            if (!passEjb) {
                TestUtil.logErr("testNonAnonymousResponsesAssertion failed");
                pass = false;
            } else TestUtil.logMsg("testNonAnonymousResponsesAssertion passed");

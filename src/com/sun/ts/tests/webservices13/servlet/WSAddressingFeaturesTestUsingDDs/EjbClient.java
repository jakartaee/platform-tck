...
public class EjbClient implements EjbClientIF {
    ...
    public void postConstruct() {
        try {
            ...
            System.out.println("JNDI lookup java:comp/env/service/wsaddrfeaturestestusingddsdefaultechoport");
            defaultEchoPort = (Echo) ctx.lookup("java:comp/env/service/wsaddrfeaturestestusingddsdefaultechoport");
            System.out.println("JNDI lookup java:comp/env/service/wsaddrfeaturestestusingddsenabledechoport");
            enabledEchoPort = (Echo) ctx.lookup("java:comp/env/service/wsaddrfeaturestestusingddsenabledechoport");
            System.out.println("JNDI lookup java:comp/env/service/wsaddrfeaturestestusingddsrequiredechoport");
            requiredEchoPort = (Echo) ctx.lookup("java:comp/env/service/wsaddrfeaturestestusingddsrequiredechoport");
            System.out.println("JNDI lookup java:comp/env/service/wsaddrfeaturestestusingddsdisabledechoport");
            disabledEchoPort = (Echo) ctx.lookup("java:comp/env/service/wsaddrfeaturestestusingddsdisabledechoport");
            System.out.println("JNDI lookup java:comp/env/service/wsaddrfeaturestestusingddsdefaultecho2port");
            defaultEcho2Port = (Echo2) ctx.lookup("java:comp/env/service/wsaddrfeaturestestusingddsdefaultecho2port");
            System.out.println("JNDI lookup java:comp/env/service/wsaddrfeaturestestusingddsenabledecho2port");
            enabledEcho2Port = (Echo2) ctx.lookup("java:comp/env/service/wsaddrfeaturestestusingddsenabledecho2port");
            System.out.println("JNDI lookup java:comp/env/service/wsaddrfeaturestestusingddsrequiredecho2port");
            ...
            System.out.println("EjbClient DEBUG: requiredEcho2Port=" + requiredEcho2Port);
            System.out.println("EjbClient DEBUG: disabledEcho2Port=" + disabledEcho2Port);
            System.out.println("EjbClient DEBUG: anonymousEcho3Port=" + anonymousEcho3Port);
            System.out.println("EjbClient DEBUG: nonanonymousEcho4Port=" + nonanonymousEcho4Port);
        } catch (Exception e) {
            System.err.println("EjbClient:postConstruct() Exception: " + e);
            e.printStackTrace();
        }
        if (defaultEchoPort == null
            ...
            throw new EJBException("postConstruct failed: injection or JNDI lookup failure");
        }
    }
    ...
    private boolean VerifyAddrHeadersExistForRequiredEchoPort() {
        try {
            ...
            requiredEchoPort.echo("Echo from EjbClient on requiredEchoPort", testName);
            return true;
        } catch (Exception e) {
            return false;
        }
    ...
    private boolean VerifyAddrHeadersDoNotExistForDisabledEchoPort() {
        try {
            ...
            disabledEchoPort.echo("Echo from EjbClient on disabledEchoPort", testName);
            return true;
        } catch (Exception e) {
            return false;
        }
    ...
    private boolean VerifyExceptionThrownForRequiredEcho2Port() {
        try {
            ...
            requiredEcho2Port.echo("Echo from EjbClient on requiredEcho2Port", testName);
    ...
    private boolean VerifyAddrHeadersMayExistForEnabledEcho2Port() {
        try {
            ...
            enabledEcho2Port.echo("Echo from EjbClient on enabledEcho2Port", testName);
            return true;
        } catch (Exception e) {
            return false;
        }
    ...
    private boolean testAnonymousResponsesAssertion() {
        try {
            ...
            anonymousEcho3Port.echo("Echo from EjbClient on anonymousEcho3Port", testName);
            return true;
        } catch (Exception e) {
            return false;
        }
    ...
    private boolean testNonAnonymousResponsesAssertion() {
        try {
            ...
            nonanonymousEcho4Port.echo("Echo from EjbClient on nonanonymousEcho4Port", testName);
            return true;
        } catch (Exception e) {
            return true;
        }

...
public class Client extends EETest {
  ...
  public void setup(String[] args, Properties p) throws Fault {
    ...
    if (service == null || port4a == null || port5a == null || port6a == null
        || port7a == null || port8a == null || ejbclient == null) {
  ...
  public void afCltEnabledREQSvrEnabledREQrbfSvrEnabledCltEnabledTest()
    ...
    try {
      ...
      boolean passEjb = ejbclient.echo("Echo from EjbClient on port5a",
          testName);
      if (!passEjb) {
        TestUtil.logErr("Addressing Headers DO NOT Exist (Unexpected)");
        pass = false;
  ...
  public void afCltNotEnabledSvrEnabledREQrbfSvrEnabledCltEnabledTest()
    ...
    try {
      ...
      boolean passEjb = ejbclient.echo("Echo from EjbClient on port6a",
          testName);
      if (!passEjb) {
        TestUtil.logErr(
            "afCltNotEnabledSvrEnabledREQrbfSvrEnabledCltEnabledTest (Unexpected)");

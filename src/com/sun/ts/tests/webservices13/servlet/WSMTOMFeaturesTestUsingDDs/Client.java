...
public class Client extends EETest {
    ...
    private static final String CTXROOT = "/WSMTOMFeaturesTestUsingDDs_web";

    private String SERVLET_CLIENT = "/WSMTOMFeaturesTestUsingDDsClnt_web/ServletTest";
    ...
    @EJB(name = "ejb/WSMTOMFeaturesTestUsingDDsClntBean")
    static EjbClientIF ejbclient;

    private void getPortJavaEE() throws Exception {
        InitialContext ctx = new InitialContext();
        TestUtil.logMsg("JNDI lookup java:comp/env/service/wsmtomfeaturestestusingddsport1_1");
        port1_1 = (MTOMTest1) ctx.lookup("java:comp/env/service/wsmtomfeaturestestusingddsport1_1");
        TestUtil.logMsg("JNDI lookup java:comp/env/service/wsmtomfeaturestestusingddsport1_2");
        port1_2 = (MTOMTest1) ctx.lookup("java:comp/env/service/wsmtomfeaturestestusingddsport1_2");
        TestUtil.logMsg("JNDI lookup java:comp/env/service/wsmtomfeaturestestusingddsport2");
        port2 = (MTOMTest2) ctx.lookup("java:comp/env/service/wsmtomfeaturestestusingddsport2");
        TestUtil.logMsg("JNDI lookup java:comp/env/service/wsmtomfeaturestestusingddsport3_1");
        port3_1 = (MTOMTest3) ctx.lookup("java:comp/env/service/wsmtomfeaturestestusingddsport3_1");
        TestUtil.logMsg("JNDI lookup java:comp/env/service/wsmtomfeaturestestusingddsport3_2");
        port3_2 = (MTOMTest3) ctx.lookup("java:comp/env/service/wsmtomfeaturestestusingddsport3_2");
        TestUtil.logMsg("JNDI lookup java:comp/env/service/wsmtomfeaturestestusingddsport3_3");
        port3_3 = (MTOMTest3) ctx.lookup("java:comp/env/service/wsmtomfeaturestestusingddsport3_3");
        TestUtil.logMsg("JNDI lookup java:comp/env/service/wsmtomfeaturestestusingddsport4");
        port4 = (MTOMTest4) ctx.lookup("java:comp/env/service/wsmtomfeaturestestusingddsport4");
     ...
     * WS4EE:SPEC:4015; WS4EE:SPEC:4019;
     *
    ...
    public void ClientEnabledServerEnabledMTOMInTest() throws Fault {
        ...
        try {
            ...
            data.setDoc(doc);
            TestUtil.logMsg("Send 1 document using MTOM via webservice method mtomIn()");
        ...
        if (!execute_servlet_client("ClientEnabledServerEnabledMTOMInTest", SDOC1, sdocURL1)) {
            pass = false;
        }
        if (!execute_ejb_client("ClientEnabledServerEnabledMTOMInTest", SDOC1, sdocURL1)) {
            pass = false;
        }
    ...
    public void ClientEnabledServerDisabledMTOMInTest() throws Fault {
        ...
        if (!execute_servlet_client("ClientEnabledServerDisabledMTOMInTest", SDOC1, sdocURL1)) {
            pass = false;
        }
    ...
    public void ClientEnabledServerEnabledMTOMInDefaultTest() throws Fault {
        ...
        if (!execute_servlet_client("ClientEnabledServerEnabledMTOMInDefaultTest", SDOC1, sdocURL1)) {
            pass = false;
        }
        if (!execute_ejb_client("ClientEnabledServerEnabledMTOMInDefaultTest", SDOC1, sdocURL1)) {
            pass = false;
        }
    ...
    public void ClientEnabledServerEnabledGT2000Test() throws Fault {
        ...
        if (!execute_servlet_client("ClientEnabledServerEnabledGT2000Test", SDOC2, sdocURL2)) {
            pass = false;
        }
    ...
    public void ClientEnabledServerEnabledGT2000DefaultTest() throws Fault {
        ...
        if (!execute_servlet_client("ClientEnabledServerEnabledGT2000DefaultTest", SDOC2, sdocURL2)) {
            pass = false;
        }
    ...
    public void ClientDisabledServerEnabledGT2000Test() throws Fault {
        ...
        if (!execute_servlet_client("ClientDisabledServerEnabledGT2000Test", SDOC2, sdocURL2)) {
            pass = false;
        }
    ...
    public void ClientEnabledServerDisabledGT2000Test() throws Fault {
        ...
        if (!execute_servlet_client("ClientEnabledServerDisabledGT2000Test", SDOC2, sdocURL2)) {
            pass = false;
        }
    ...
    public void ClientEnabledServerEnabledLT2000Test() throws Fault {
        ...
        if (!execute_servlet_client("ClientEnabledServerEnabledLT2000Test", SDOC3, sdocURL3)) {
            pass = false;
        }
    ...
    private boolean execute_ejb_client(String testname, String SDOC, String sdocURL) {
        boolean pass = true;
        TestUtil.logMsg("----------------------------------");

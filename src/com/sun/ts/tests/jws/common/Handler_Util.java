...
public final class Handler_Util {
    ...
    public static String getValueFromMsg(MessageContext context, String name, String whichHandlerType) {
        String value = "";
    ...
    public static boolean VerifyCloseCallBacks(
            String who, List<String> calls, String contextType, boolean expection, String direction) {
        boolean pass = true;

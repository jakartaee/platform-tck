...
public class Client extends ServiceEETest implements SchemaConstants, DescriptionConstants {
    ...
    private void getPortStandalone() throws Exception {
        port = (WebParam3WebService) JWS_Util.getPort(
                wsdlurl, SERVICE_QNAME, WebParam3WebServiceService.class, PORT_QNAME, WebParam3WebService.class);
    ...
    public void testWSDL1() throws Fault {
        ...
        if (pass) {
            TestUtil.logMsg(" testWSDL1() passed :  Found the part element with name : " + EXPECTED_PART_QNAME_1
                    + " in the WSDL ");
        } else {
            throw new Fault("testWSDL1 failed : could not find part element with name : " + EXPECTED_PART_QNAME_1
                    + " in the WSDL ");
        }
    }
    ...
    public void testWSDL2() throws Fault {
        ...
        if (pass) {
            TestUtil.logMsg(" testWSDL2() passed :  Found the part element with name : " + EXPECTED_PART_QNAME_2
                    + " in the WSDL ");
        } else {
            throw new Fault("testWSDL2 failed : could not find part element with name : " + EXPECTED_PART_QNAME_2
                    + " in the WSDL ");
        }
    }
    ...
    public void testWSDL3() throws Fault {
        ...
        try {
            ...
            messageElement = com.sun.ts.tests.jws.common.WsdlUtils.findMessageElement(
                    doc, PORTTYPE_QNAME, operationQName, "input");
            if (messageElement != null) {
                partElement = com.sun.ts.tests.jws.common.WsdlUtils.findPartElement(
                        doc, messageElement, EXPECTED_DEFAULT_PART_QNAME_1);
            }
        ...
        if (pass) {
            TestUtil.logMsg(" testWSDL3() passed :  Found the part element with default name : "
                    + EXPECTED_DEFAULT_PART_QNAME_1 + " in the WSDL ");
        } else {
            throw new Fault("testWSDL3 failed : could not find part element with default name : "
                    + EXPECTED_DEFAULT_PART_QNAME_1 + " in the WSDL ");
        }
    }
    ...
    public void testWSDL4() throws Fault {
        ...
        try {
            ...
            operationElement = com.sun.ts.tests.jws.common.WsdlUtils.findOperationElement(
                    doc, EXPECTED_OPERATION_QNAME_1, SERVICE_QNAME, PORT_QNAME);

            if (operationElement != null) {

                soapHeaderElement = com.sun.ts.tests.jws.common.WsdlUtils.findSoapHeaderElement(
                        doc, operationElement, "input", "id", PORTTYPE_QNAME, EXPECTED_OPERATION_QNAME_1);
            }
        ...
        if (pass) {
            ...
            throw new Fault("testWSDL4 failed : could not find soap header element : " + EXPECTED_PART_ELEMENT_QNAME_1
                    + " in the WSDL ");
        }
    }
    ...
    public void testWSDL5() throws Fault {
        ...
        try {
            ...
            inputMessageElement = WsdlUtils.findMessageElement(doc, PORTTYPE_QNAME, operationQName, "input");
            if (inputMessageElement != null) {
                inputPartElement = WsdlUtils.findPartElement(doc, inputMessageElement, EXPECTED_PART_QNAME_3);
            }

            outputMessageElement = WsdlUtils.findMessageElement(doc, PORTTYPE_QNAME, operationQName, "output");
            if (outputMessageElement != null) {
                outputPartElement = com.sun.ts.tests.jws.common.WsdlUtils.findPartElement(
    ...
    public void testWSDL6() throws Fault {
        ...
        try {
            ...
            messageElement = com.sun.ts.tests.jws.common.WsdlUtils.findMessageElement(
                    doc, PORTTYPE_QNAME, operationQName, "output");
            if (messageElement != null) {
                partElement = com.sun.ts.tests.jws.common.WsdlUtils.findPartElement(
        ...
        if (pass) {
            TestUtil.logMsg(" testWSDL6() passed :  Found the part element with name : " + EXPECTED_PART_QNAME_4
                    + " in the output message in the WSDL ");
        } else {
            throw new Fault("testWSDL6 failed : could not find part element with name : " + EXPECTED_PART_QNAME_4
                    + "in the output message in the WSDL ");
        }
    }
    ...
    public void testWSDL7() throws Fault {
        ...
        try {
            ...
            operationElement = WsdlUtils.findPortTypeOperationElement(portTypeElement, EXPECTED_OPERATION_QNAME_2);
            if (operationElement != null) {
                inputParameterOrder = operationElement.getAttribute(WSDL_PARAMETERORDER_ATTR);
                ...
                if (!inputParameterOrder.equals("")) {
                    ...
                    if (!EXPECTED_INPUT_PARAMETER_ORDER.equals(inputParameterOrder.trim())) {
            ...
            if (messageElement != null) {
                Element[] elements = DescriptionUtils.getPartElements(doc, messageElement.getAttribute(WSDL_NAME_ATTR));
                for (int i = 0; i < elements.length; i++) {
                    outputParameterOrder.append(elements[i].getAttribute(WSDL_NAME_ATTR) + " ");
                }
            }
        ...
        if (pass) {
            TestUtil.logMsg(" testWSDL7() passed : parameter order is set correctly in the WSDL ");
        } else {
            throw new Fault("Output Parameter Order is set to " + outputParameterOrder + " instead of "
                    + EXPECTED_OUTPUT_PARAMETER_ORDER);
        }
    }
}

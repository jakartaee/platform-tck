...
public class Client extends ServiceEETest {
    ...
    private QName EXPECTED_PART_ELEMENT_QNAME_3 = new QName(EXPECTED_ELEMENT_TARGETNAMESPACE_3, EXPECTED_PART_ELEMENT_NAME_3);
     ...
     * @testName: testWSDL2
     *
     * @assertion_ids: JWS:SPEC:5009; JWS:SPEC:6007; JWS:SPEC:6003; JWS:SPEC:3014; JWS:SPEC:5010
     *
    ...
    public void testWSDL5() throws Fault {
        ...
        try {
            ...
            inputMessageElement = WsdlUtils.findMessageElement(doc, PORTTYPE_QNAME, EXPECTED_OPERATION_QNAME_3, "input");
            ...
            outputMessageElement = WsdlUtils.findMessageElement(doc, PORTTYPE_QNAME, EXPECTED_OPERATION_QNAME_3, "output");
            if (outputMessageElement != null) {
                outputPartElement = WsdlUtils.findPartElement(doc, outputMessageElement, EXPECTED_INOUT_PART_QNAME, true);
            }

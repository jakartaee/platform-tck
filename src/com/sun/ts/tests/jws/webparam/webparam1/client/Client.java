...
public class Client extends ServiceEETest {
    ...
    private QName EXPECTED_DEFAULT_PART_QNAME = new QName(NAMESPACEURI, EXPECTED_DEFAULT_PART_NAME);

    private QName EXPECTED_INOUT_PART_QNAME = new QName(EXPECTED_ELEMENT_TARGETNAMESPACE_4, EXPECTED_INOUT_PART_NAME);
    ...
    private QName EXPECTED_OUT_PART_QNAME = new QName(NAMESPACEURI, EXPECTED_OUT_PART_NAME);

    private QName EXPECTED_PART_ELEMENT_QNAME_2 =
            new QName(EXPECTED_ELEMENT_TARGETNAMESPACE_2, EXPECTED_PART_ELEMENT_NAME_2);

    private QName EXPECTED_PART_ELEMENT_QNAME_3 =
            new QName(EXPECTED_ELEMENT_TARGETNAMESPACE_3, EXPECTED_PART_ELEMENT_NAME_3);

    private QName EXPECTED_PART_ELEMENT_QNAME_4 = new QName(NAMESPACEURI, EXPECTED_PART_ELEMENT_NAME_3);
    ...
    private void getPortStandalone() throws Exception {
        port = (WebParamWebService) JWS_Util.getPort(
                wsdlurl, SERVICE_QNAME, WebParamWebServiceService.class, PORT_QNAME, WebParamWebService.class);
    ...
    public void testHelloString2() throws Fault {
        ...
        if (!pass) throw new Fault("testHelloString2 failed");
    ...
    public void testHelloString3() throws Fault {
        ...
        try {
            TestUtil.logMsg("Invoke the helloString3() method of WebMethodWebService");
            name.setFirstName("k");
            name.setLastName("l");
        ...
        if (!pass) throw new Fault("testHelloString3 failed");
    ...
    public void testHelloString4() throws Fault {
        ...
        try {
            TestUtil.logMsg("Invoke the helloString4() method of WebMethodWebService");
        ...
        if (!pass) throw new Fault("testHelloString4 failed");
    ...
    public void testHelloString5() throws Fault {
        ...
        try {
            ...
            if (!result.equals(EXPECTED_RESULT_5)) pass = false;
        ...
        if (!pass) throw new Fault("testHelloString5 failed, returned value : " + result);
    ...
    public void testHelloString6() throws Fault {
        ...
        try {
            ...
            if (!result.equals(EXPECTED_RESULT_6)) pass = false;
        ...
        if (!pass) throw new Fault("testHelloString6 failed, returned value : " + result);
    ...
    public void testHelloString7() throws Fault {
        ...
        try {
            TestUtil.logMsg("Invoke the helloString7() method of WebMethodWebService");
    ...
    public void testHelloString8() throws Fault {
        ...
        try {
            ...
            if (!result.equals(EXPECTED_RESULT_8)) pass = false;
        ...
        if (!pass) throw new Fault("testHelloString8 failed, returned value : " + result);
    ...
    public void testWSDL1() throws Fault {
        ...
        try {
            ...
            messageElement = WsdlUtils.findMessageElement(doc, PORTTYPE_QNAME, operationQName, "input");
        ...
        if (pass) {
            TestUtil.logMsg(" testWSDL1() passed :  Found the part element with name : " + EXPECTED_PART_NAME_1
                    + " in the WSDL ");
        } else {
            throw new Fault("testWSDL1 failed : could not find part element with name : " + EXPECTED_PART_NAME_1
                    + " in the WSDL ");
        }
    }
    ...
    public void testWSDL2() throws Fault {
        ...
        try {
            ...
            messageElement = WsdlUtils.findMessageElement(doc, PORTTYPE_QNAME, operationQName, "input");
            if (messageElement != null) {
                partElement = WsdlUtils.findPartElement(doc, messageElement, EXPECTED_PART_QNAME_2);
            }
            ...
            if (partElement != null) {
                ...
                if (ele != null) {
                    ...
                    if (elementQName.equals(EXPECTED_PART_ELEMENT_QNAME_2)) pass = true;
                }
            }
        ...
        if (pass) {
            TestUtil.logMsg(" testWSDL2() passed :  Found the part element with element name : " + elementQName
                    + " in the WSDL ");
        } else {
            throw new Fault("testWSDL2 failed : could not find part element with element name : "
    ...
    public void testWSDL3() throws Fault {
        ...
        try {
            ...
            if (messageElement != null) {
                partElement = com.sun.ts.tests.jws.common.WsdlUtils.findPartElement(
                        doc, messageElement, EXPECTED_DEFAULT_PART_QNAME);
            }
            ...
            if (partElement != null) {
                ...
                if (ele != null) {
                    ...
                    elementValue = ele.getValue();
                    elementQName = WsdlUtils.createQName(partElement, elementValue);
                    if (elementQName.equals(EXPECTED_DEFAULT_PART_QNAME)) pass = true;
                }
            }
    ...
    public void testWSDL4() throws Fault {
        ...
        try {
            ...
            operationElement = com.sun.ts.tests.jws.common.WsdlUtils.findOperationElement(
                    doc, EXPECTED_OPERATION_QNAME_3, SERVICE_QNAME, PORT_QNAME);

            if (operationElement != null) {

                soapHeaderElement = com.sun.ts.tests.jws.common.WsdlUtils.findSoapHeaderElement(
                        doc,
                        operationElement,
                        "input",
            ...
            if (messageElement != null) {
                ...
                partElement = WsdlUtils.findPartElement(doc, messageElement, EXPECTED_PART_ELEMENT_QNAME_3, true);
            }
        ...
        if (pass) {
            ...
            throw new Fault("testWSDL4 failed : could not find soap header element : " + EXPECTED_PART_ELEMENT_QNAME_3
                    + " in the WSDL ");
        }
    }
    ...
    public void testWSDL5() throws Fault {
        ...
        try {
            ...
            inputMessageElement =
                    WsdlUtils.findMessageElement(doc, PORTTYPE_QNAME, EXPECTED_OPERATION_QNAME_3, "input");
            if (inputMessageElement != null) {
                inputPartElement = WsdlUtils.findPartElement(doc, inputMessageElement, EXPECTED_INOUT_PART_QNAME, true);
            }

            outputMessageElement =
                    WsdlUtils.findMessageElement(doc, PORTTYPE_QNAME, EXPECTED_OPERATION_QNAME_3, "output");
            if (outputMessageElement != null) {
                outputPartElement =
                        WsdlUtils.findPartElement(doc, outputMessageElement, EXPECTED_INOUT_PART_QNAME, true);
            }
    ...
    public void testWSDL6() throws Fault {
        ...
        try {
            ...
            if (messageElement != null) {
                partElement = WsdlUtils.findPartElement(doc, messageElement, EXPECTED_OUT_PART_QNAME, true);
            }
        ...
        if (pass) {
            ...
            throw new Fault("testWSDL6 failed : could not find part element with name : " + EXPECTED_OUT_PART_QNAME
                    + "in the output message in the WSDL ");
        }
    }
}

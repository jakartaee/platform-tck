 ...
 * @keywords webservice
 */
public class Client extends ServiceEETest implements SchemaConstants, DescriptionConstants {
    ...
    private QName EXPECTED_PART_QNAME_2 = new QName(NAMESPACEURI, EXPECTED_PART_NAME_2);

    private QName EXPECTED_OPERATION_QNAME_1 = new QName(NAMESPACEURI, EXPECTED_OPERATION_NAME_1);

    private QName EXPECTED_OPERATION_QNAME_2 = new QName(NAMESPACEURI, EXPECTED_OPERATION_NAME_2);

    private QName EXPECTED_OPERATION_QNAME_3 = new QName(NAMESPACEURI, EXPECTED_OPERATION_NAME_3);

    private QName EXPECTED_OPERATION_QNAME_4 = new QName(NAMESPACEURI, EXPECTED_OPERATION_NAME_4);
    ...
    private QName EXPECTED_DEFAULT_PART_ELEMENT_QNAME_1 = new QName(NAMESPACEURI, EXPECTED_DEFAULT_PART_ELEMENT_NAME_1);

    private QName EXPECTED_DEFAULT_PART_ELEMENT_QNAME_2 = new QName(NAMESPACEURI, EXPECTED_DEFAULT_PART_ELEMENT_NAME_2);
    ...
    private void getPortStandalone() throws Exception {
        port = (WebParam2WebService) JWS_Util.getPort(
                wsdlurl, SERVICE_QNAME, WebParam2WebServiceService.class, PORT_QNAME, WebParam2WebService.class);
    ...
    private boolean findParameterElement(
            Document document, Element complexType, URL baseURL, QName qName, boolean checkList) throws Exception {
        ...
        TestUtil.logMsg(
                "Got Complex Type Element : " + targetNameSpace + ":" + complexType.getAttribute(XSD_NAME_ATTR));
        NodeList list = complexType.getElementsByTagNameNS(XSD_NAMESPACE_URI, XSD_ELEMENT_LOCAL_NAME);
        ...
        if (parameterRefElement != null) {
            ...
            if (DescriptionUtils.isSchema(document)) {
                ...
                parameterElement = WsdlUtils.getSchemasElementName(document, qName, baseURL);
                if (parameterElement == null) {
                    Document[] schemas = DescriptionUtils.getSchemaDocuments(document, baseURL);
    ...
    public void testWSDL1() throws Fault {
        ...
        try {
            ...
            if (messageElement != null) {
                ...
                partElement = WsdlUtils.findPartElement(doc, messageElement, EXPECTED_OPERATION_QNAME_1, true);
            }
            ...
            if (partElement != null) {
                ...
                if (wrapperElement != null) {
                    String targetNameSpace = DescriptionUtils.getTargetNamespaceAttr(currentDoc);
                    ...
                    Element complexType = DescriptionUtils.getChildElement(
                            wrapperElement, XSD_NAMESPACE_URI, XSD_COMPLEXTYPE_LOCAL_NAME);
                    if (complexType == null) {
                    ...
                    if (complexType != null) {
                        pass = findParameterElement(
                                currentDoc, complexType, baseURL, EXPECTED_PART_ELEMENT_QNAME_1, true);
                    } else {
        ...
        if (pass) {
            TestUtil.logMsg(" testWSDL1() passed :  Found the part element with name : "
                    + EXPECTED_PART_ELEMENT_NAME_1 + " in the message "
                    + partElementName);
        } else {
            throw new Fault("testWSDL1 failed : could not find part element with name : "
                    + EXPECTED_PART_ELEMENT_NAME_1 + " in the message "
                    + partElementName);
        }
    }
    ...
    public void testWSDL2() throws Fault {
        ...
        try {
            ...
            if (messageElement != null) {
                messageElement.getAttribute(WSDL_NAME_ATTR);
                partElement = WsdlUtils.findPartElement(doc, messageElement, EXPECTED_OPERATION_QNAME_2, true);
            }
            ...
            if (partElement != null) {
                ...
                if (wrapperElement != null) {
                    ...
                    if (complexType != null) {
                        pass = findParameterElement(
                                currentDoc, complexType, baseURL, EXPECTED_PART_ELEMENT_QNAME_2, false);
                    } else {
                        throw new Fault("Cannot Find Complex Type " + wrapperElement.getAttribute(XSD_TYPE_ATTR));
                    }
                }
        ...
        if (pass) {
            TestUtil.logMsg(" testWSDL2() passed :  Found the part element with name : " + EXPECTED_PART_ELEMENT_QNAME_2
                    + " in the WSDL ");
        } else {
            throw new Fault("testWSDL2 failed : could not find part element with name : "
    ...
    public void testWSDL3() throws Fault {
        ...
        try {
            ...
            baseURL = new URL(url);
            WsdlUtils.setBaseUrl(url);
            messageElement = WsdlUtils.findMessageElement(doc, PORTTYPE_QNAME, EXPECTED_OPERATION_QNAME_3, "input");
            if (messageElement != null) {
                messageElement.getAttribute(WSDL_NAME_ATTR);
                partElement = WsdlUtils.findPartElement(doc, messageElement, EXPECTED_OPERATION_QNAME_3, true);
            }
        ...
        if (pass) {
            TestUtil.logMsg(" testWSDL3() passed :  Found the part element with name : "
                    + EXPECTED_DEFAULT_PART_ELEMENT_NAME_1 + " in the message "
                    + partElementName);
        } else {
            throw new Fault("testWSDL3 failed : could not find part element with name : "
                    + EXPECTED_DEFAULT_PART_ELEMENT_NAME_1 + " in the message "
                    + partElementName);
        }
    }
    ...
    public void testWSDL4() throws Fault {
        ...
        try {
            ...
            baseURL = new URL(url);
            WsdlUtils.setBaseUrl(url);
            messageElement = WsdlUtils.findMessageElement(doc, PORTTYPE_QNAME, EXPECTED_OPERATION_QNAME_4, "input");
            if (messageElement != null) {
                messageName = messageElement.getAttribute(WSDL_NAME_ATTR);
                partElement = WsdlUtils.findPartElement(doc, messageElement, EXPECTED_OPERATION_QNAME_4, true);
            }
            ...
            if (partElement != null) {
                ...
                if (wrapperElement != null) {
                    ...
                    if (complexType != null) {
                        pass = findParameterElement(
                                currentDoc, complexType, baseURL, EXPECTED_PART_ELEMENT_QNAME_4, false);
                    } else {
                        throw new Fault("Cannot Find Complex Type " + wrapperElement.getAttribute(XSD_TYPE_ATTR));
                    }
                }
        ...
        if (pass) {
            TestUtil.logMsg(" testWSDL4() passed :  Found the part element with name : "
                    + EXPECTED_PART_ELEMENT_QNAME_4 + " in the input message "
                    + messageName + " in the WSDL ");
        } else {
            throw new Fault("testWSDL4 failed : could not find part element with name : "
                    + EXPECTED_PART_ELEMENT_QNAME_4 + " in the input message "
                    + messageName + " in the WSDL ");
        }
    }
    ...
    public void testWSDL5() throws Fault {
        ...
        try {
            ...
            if (messageElement != null) {
                messageName = messageElement.getAttribute(WSDL_NAME_ATTR);
                partElement = WsdlUtils.findPartElement(
                        doc, messageElement, new QName(NAMESPACEURI, "helloString4Response"), true);
            }
        ...
        if (pass) {
            TestUtil.logMsg(" testWSDL5() passed :  Found the part element with name : "
                    + EXPECTED_PART_ELEMENT_QNAME_4 + " in the output message "
                    + messageName + " in the WSDL ");
        } else {
            throw new Fault("testWSDL5 failed : could not find part element with name : "
                    + EXPECTED_PART_ELEMENT_QNAME_4 + " in the output message "
                    + messageName + " in the WSDL ");
        }
    }
    ...
    public void testWSDL6() throws Fault {
        ...
        try {
            ...
            baseURL = new URL(url);
            WsdlUtils.setBaseUrl(url);
            messageElement = WsdlUtils.findMessageElement(doc, PORTTYPE_QNAME, EXPECTED_OPERATION_QNAME_4, "output");
            if (messageElement != null) {
                messageName = messageElement.getAttribute(WSDL_NAME_ATTR);
                partElement = WsdlUtils.findPartElement(
                        doc, messageElement, new QName(NAMESPACEURI, "helloString4Response"), true);
            ...
            if (partElement != null) {
                ...
                if (wrapperElement != null) {
                    ...
                    if (complexType != null) {
                        pass = findParameterElement(
                                currentDoc, complexType, baseURL, EXPECTED_PART_ELEMENT_QNAME_5, true);
                    } else {
                        throw new Fault("Cannot Find Complex Type " + wrapperElement.getAttribute(XSD_TYPE_ATTR));
                    }
                }
        ...
        if (pass) {
            TestUtil.logMsg(" testWSDL6() passed :  Found the part element with name : "
                    + EXPECTED_PART_ELEMENT_NAME_5 + " in the output message "
                    + messageName + " in the WSDL ");
        } else {
            throw new Fault("testWSDL6 failed : could not find part element with name : "
                    + EXPECTED_PART_ELEMENT_NAME_5 + " in the output message "
                    + messageName + " in the WSDL ");
        }
    }
    ...
    public void testWSDL7() throws Fault {
        ...
        try {
            ...
            if (operationElement != null) {
                ...
                soapHeaderElement = WsdlUtils.findSoapHeaderElement(
                        doc,
                        operationElement,
                        "input",
                        EXPECTED_HEADER_PART_ELEMENT_NAME_1,
                        PORTTYPE_QNAME,
                        EXPECTED_OPERATION_QNAME_5);
            }

            messageElement = WsdlUtils.findMessageElement(doc, PORTTYPE_QNAME, EXPECTED_OPERATION_QNAME_5, "input");

            if (messageElement != null) {

                partElement = com.sun.ts.tests.jws.common.WsdlUtils.findPartElement(

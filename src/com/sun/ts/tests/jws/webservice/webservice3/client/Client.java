...
public class Client extends ServiceEETest {
    ...
    public void testHelloWSDL() throws Fault {
        ...
        boolean pass = true;
        try {
            TestUtil.logMsg("Get the WSDL of nameServiceNametargetNamespaceWebService");
    ...
    public void testWSDL1() throws Fault {
        ...
        try {
            ...
            if (elm == null) {
                throw new Fault("testWSDL1 failed : could not find service element with name " + SERVICE_QNAME
                        + " in the WSDL");
            }

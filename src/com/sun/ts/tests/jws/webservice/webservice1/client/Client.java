...
public class Client extends ServiceEETest {
    ...
    private void getPortStandalone() throws Exception {
        port = (DefaultWebService) JWS_Util.getPort(
                wsdlurl, SERVICE_QNAME, DefaultWebServiceService.class, PORT_QNAME, DefaultWebService.class);
     ...
     * @test_Strategy:
     */
    public void testPing() throws Fault {

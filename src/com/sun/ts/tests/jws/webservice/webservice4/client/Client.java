...
public class Client extends ServiceEETest {
    ...
    private QName PORTTYPE_QNAME = new QName(PORTTYPE_NAMESPACEURI, PORTTYPE_NAME);
    ...
    private void getPortJavaEE() throws Exception {
        ...
        port = (EndpointInterface2WebServiceEI) service.getPort(EndpointInterface2WebServiceEI.class);
        TestUtil.logMsg("port=" + port);
        TestUtil.logMsg("Obtained port");
    }

    private void getPortStandalone() throws Exception {
        port = (EndpointInterface2WebServiceEI) JWS_Util.getPort(
                wsdlurl,
                SERVICE_QNAME,
                EndpointInterface2WebServiceService.class,
                PORT_QNAME,
            ...
            if (portElement != null) {
                ...
                if (att != null && att.getValue().equals(PORT_NAME)) {
                    ...
                    if (bindingAttr != null && bindingAttr.getValue() != null) {
                        ...
                        bindingQName = com.sun.ts.tests.jws.common.WsdlUtils.createQName(portElement, bindingValue);
    ...
    public void testWSDL2() throws Fault {
        ...
        try {
            ...
            if (elm == null)
                throw new Fault(
                        "testWSDL2 failed : could not find service element with name " + SERVICE_NAME + " in the WSDL");
        ...
        if (pass) {
            ...
            throw new Fault("testWSDL2 failed : could not find port element with name " + PORT_NAME + " in the WSDL");
        }
    }
    ...
    public void testWSDL3() throws Fault {
        ...
        if (pass) {
            TestUtil.logMsg(" testWSDL3() passed :  Found the portType element " + PORTTYPE_QNAME + " in the WSDL ");
        } else {
            throw new Fault(
                    "testWSDL3 failed : could not find portType element with name " + PORTTYPE_QNAME + " in the WSDL");
        }
    }
}

 ...
 * $Id$
 */
package com.sun.ts.tests.jws.webservice.webservice2.client;
...
public class Client extends ServiceEETest {
    ...
    static EndpointInterfaceWebServiceService service = null;

    // URL properties used by the test
    private static final String ENDPOINT_URL = "jwstest.endpointinterfacewebservice.endpoint.1";
    ...
    private static final String NAMESPACEURI = "http://server.webservice2.webservice.jws.tests.ts.sun.com/";

    private static final String PKG_NAME = "com.sun.ts.tests.jws.webservice.webservice2.client.";

    private static final String PORT_NAME = "endpointInterfaceWebServicePort";
    ...
    private static final String SERVICE_NAME = "endpointInterfaceWebServiceService";
    ...
    private static final String WSDLLOC_URL = "jwstest.endpointinterfacewebservice.wsdlloc.1";
    ...
    private EndpointInterfaceWebServiceEI port;
    ...
    private void getPortJavaEE() throws Exception {
        ...
        port = (EndpointInterfaceWebServiceEI) service.getPort(EndpointInterfaceWebServiceEI.class);
        TestUtil.logMsg("port=" + port);
        TestUtil.logMsg("Obtained port");
    }

    private void getPortStandalone() throws Exception {
        port = (EndpointInterfaceWebServiceEI) JWS_Util.getPort(
                wsdlurl,
                SERVICE_QNAME,
                EndpointInterfaceWebServiceService.class,
                PORT_QNAME,
                EndpointInterfaceWebServiceEI.class);
    ...
    public void setup(String[] args, Properties p) throws Fault {
        ...
        try {
            ...
            if (modeProperty.equals("standalone")) {
                ...
                service = (EndpointInterfaceWebServiceService) getSharedObject();
                getPortJavaEE();
            }
    ...
    public void testHello() throws Fault {
        ...
        boolean pass = true;
        try {
            TestUtil.logMsg("Invoke the hello() method of DefaulWebService");
     ...
     *
     * @assertion_ids: JWS:SPEC:3005; JWS:SPEC:3004
     *
    ...
    public void testHelloWSDL() throws Fault {
        ...
        boolean pass = true;
        try {
            TestUtil.logMsg("Get the WSDL of endpointInterfaceWebService");
    ...
    public void testWSDL1() throws Fault {
        ...
        try {
            ...
            Element elm = com.sun.ts.tests.jws.common.WsdlUtils.findServiceElement(doc, SERVICE_QNAME);

            if (elm == null) {
                throw new Fault(
                        "testWSDL1 failed : could not find service element with name " + SERVICE_NAME + " in the WSDL");
            }
                ...
                if (att != null && att.getValue().equals(PORT_NAME)) {
                    ...
                    if (bindingAttr != null && bindingAttr.getValue() != null) {
                        ...
                        if (bindingQName != null) {
                            ...
                            Element bindingElement = WsdlUtils.findSoapBindingElement(doc, bindingQName);

                            if (bindingElement != null) {

                                NodeList soapBindingElementList = bindingElement.getChildNodes();
    ...
    public void testWSDL2() throws Fault {
        ...
        try {
            ...
            if (elm == null)
                throw new Fault("testWSDL2 failed : could not find service element with name " + SERVICE_QNAME
                        + " in the WSDL");
            Element portElement = com.sun.ts.tests.jws.common.WsdlUtils.findPortElement(doc, elm, PORT_QNAME);
            if (portElement != null) {
        ...
        if (pass) {
            TestUtil.logMsg(" testWSDL2() passed :  Found the service element " + SERVICE_QNAME
                    + " and the port element " + PORT_QNAME + " in the WSDL ");
        } else {
            throw new Fault("testWSDL2 failed : could not find port element with name " + PORT_QNAME + " in the WSDL");
        }
    }
}

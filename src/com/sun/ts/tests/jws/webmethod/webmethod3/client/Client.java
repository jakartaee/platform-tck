...
public class Client extends ServiceEETest {
    ...
    private QName EXCLUDED_OPERATION_QNAME = new QName(NAMESPACEURI, EXCLUDED_OPERATION_NAME);

    private QName EXCPECTED_OPERATION_QNAME = new QName(NAMESPACEURI, EXCPECTED_OPERATION_NAME);
    ...
    private void getPortStandalone() throws Exception {
        port = (WebMethodWebService) JWS_Util.getPort(
                wsdlurl, SERVICE_QNAME, WebMethodWebServiceService.class, PORT_QNAME, WebMethodWebService.class);
    ...
    public void testWSDL1() throws Fault {
        ...
        try {
            ...
            operationElement = com.sun.ts.tests.jws.common.WsdlUtils.findOperationElement(
                    doc, EXCPECTED_OPERATION_QNAME, SERVICE_QNAME, PORT_QNAME);
    ...
    public void testWSDL2() throws Fault {
        ...
        if (pass) {
            TestUtil.logMsg(" testWSDL2() passed :  The operation " + EXCLUDED_OPERATION_QNAME
                    + " is not exposed in the WSDL ");
        } else {
            throw new Fault(
                    " testWSDL2() failed :  The operation " + EXCLUDED_OPERATION_QNAME + " is exposed in the WSDL ");
        }
    }
}

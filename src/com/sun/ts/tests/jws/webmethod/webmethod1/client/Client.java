...
public class Client extends ServiceEETest {
    ...
    private void getPortJavaEE() throws Exception {
        ...
        port = (DefaultWebMethodWebService) service.getPort(DefaultWebMethodWebService.class);
        TestUtil.logMsg("port=" + port);
        TestUtil.logMsg("Obtained port");
    }

    private void getPortStandalone() throws Exception {
        port = (DefaultWebMethodWebService) JWS_Util.getPort(
                wsdlurl,
                SERVICE_QNAME,
                DefaultWebMethodWebServiceService.class,
                PORT_QNAME,

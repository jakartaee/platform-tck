...
public class Client extends ServiceEETest {
    ...
    private QName EXPECTED_OPERATION_QNAME = new QName(NAMESPACEURI, EXPECTED_OPERATION_NAME);
    ...
    private void getPortJavaEE() throws Exception {
        ...
        port = (DefaultWebMethod2WebService) service.getPort(DefaultWebMethod2WebService.class);
        TestUtil.logMsg("port=" + port);
        TestUtil.logMsg("Obtained port");
    }

    private void getPortStandalone() throws Exception {
        port = (DefaultWebMethod2WebService) JWS_Util.getPort(
                wsdlurl,
                SERVICE_QNAME,
                DefaultWebMethod2WebServiceService.class,
                PORT_QNAME,
    ...
    public void testWSDL1() throws Fault {
        ...
        try {
            ...
            operationElement = com.sun.ts.tests.jws.common.WsdlUtils.findOperationElement(
                    doc, EXPECTED_OPERATION_QNAME, SERVICE_QNAME, PORT_QNAME);

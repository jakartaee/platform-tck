...
public class Client extends ServiceEETest {
    ...
    private void getPortJavaEE() throws Exception {
        ...
        port = (HandlerChainWebServiceInterface) service.getPort(HandlerChainWebServiceInterface.class);
        TestUtil.logMsg("port=" + port);
        TestUtil.logMsg("Obtained port");
    }

    private void getPortStandalone() throws Exception {
        port = (HandlerChainWebServiceInterface) JWS_Util.getPort(
                wsdlurl,
                SERVICE_QNAME,
                HandlerChainWebServiceService.class,
                PORT_QNAME,
    ...
    public void testHelloRPC_WithHandler() throws Fault {
        ...
        try {
            ...
            if (result.equals("Sam")) {
                ...
                TestUtil.logErr("Returned result=" + result + " (incorrect) expected Sam");
                pass = false;
            }
        } catch (Exception e) {
    ...
    public void testHelloRPC_WithoutHandler() throws Fault {
        ...
        try {
            ...
            if (result.equals(name)) {
                ...
                TestUtil.logErr("Returned result=" + result + " (incorrect) expected Bob");
                pass = false;
            }
        } catch (Exception e) {
            TestUtil.logErr("Exception occurred: " + e.getMessage());

...
public class Client extends ServiceEETest {
    ...
    private QName EXPECTED_PART_QNAME_5 = new QName(NAMESPACEURI, EXPECTED_PART_NAME_5);
    ...
    private void getPortJ2ee() throws Exception {
        ...
        jakarta.xml.ws.Service svc = (jakarta.xml.ws.Service) ctx.lookup("java:comp/env/service/WebResultwebservice");
    ...
    private void getPortStandalone() throws Exception {
        port = (WebResult3WebService) JWS_Util.getPort(
                wsdlurl, SERVICE_QNAME, WebResult3WebServiceService.class, PORT_QNAME, WebResult3WebService.class);
    ...
    public void testWSDL1() throws Fault {
        ...
        try {
            ...
            if (messageElement != null) {
                partElement = WsdlUtils.findPartElement(doc, messageElement, EXPECTED_DEFAULT_PART_QNAME_1);
            }
        ...
        if (pass) {
            TestUtil.logMsg(" testWSDL1() passed :  Found the part element with default name : "
                    + EXPECTED_DEFAULT_PART_QNAME_1 + " in the WSDL ");
        } else {
            throw new Fault("testWSDL1 failed : could not find part element with default name : "
                    + EXPECTED_DEFAULT_PART_QNAME_1 + " in the WSDL ");
        }
    }
    ...
    public void testWSDL2() throws Fault {
        ...
        try {
            ...
            if (messageElement != null) {
                partElement = com.sun.ts.tests.jws.common.WsdlUtils.findPartElement(
                        doc, messageElement, EXPECTED_DEFAULT_PART_QNAME_2);
            }
        ...
        if (pass) {
            TestUtil.logMsg(" testWSDL2() passed :  Found the part element with default name : "
                    + EXPECTED_DEFAULT_PART_QNAME_2 + " in the WSDL ");
        } else {
            throw new Fault("testWSDL2 failed : could not find part element with default name : "
                    + EXPECTED_DEFAULT_PART_QNAME_2 + " in the WSDL ");
        }
    }
    /*
    ...
    public void testWSDL3() throws Fault {
        ...
        if (pass) {
            TestUtil.logMsg(" testWSDL3() passed :  Found the part element with name : " + EXPECTED_PART_QNAME_3
                    + " in the WSDL ");
        } else {
            throw new Fault("testWSDL3 failed : could not find part element with name : " + EXPECTED_PART_QNAME_3
                    + " in the WSDL ");
        }
    }
    ...
    public void testWSDL4() throws Fault {
        ...
        try {
            ...
            if (messageElement != null) {
                partElement = WsdlUtils.findPartElement(doc, messageElement, EXPECTED_PART_QNAME_4);
            }
        ...
        if (pass) {
            TestUtil.logMsg(" testWSDL4() passed :  Found the part element with name : " + EXPECTED_PART_QNAME_4
                    + " in the WSDL ");
        } else {
            throw new Fault("testWSDL4 failed : could not find part element with name : " + EXPECTED_PART_QNAME_4
                    + " in the WSDL ");
        }
    }
    ...
    public void testWSDL5() throws Fault {
        ...
        try {
            ...
            operationElement = com.sun.ts.tests.jws.common.WsdlUtils.findOperationElement(
                    doc, EXPECTED_OPERATION_QNAME_5, SERVICE_QNAME, PORT_QNAME);
        ...
        if (pass) {
            ...
            throw new Fault("testWSDL5 failed : could not find soap header element : " + EXPECTED_PART_ELEMENT_QNAME_5
                    + " in the WSDL ");
        }
    }
}

...
public class Client extends ServiceEETest {
    ...
    private void getPortStandalone() throws Exception {
        port = (WebResultWebService) JWS_Util.getPort(
                wsdlurl, SERVICE_QNAME, WebResultWebServiceService.class, PORT_QNAME, WebResultWebService.class);
    ...
    public void testWSDL1() throws Fault {
        ...
        try {
            ...
            messageElement = WsdlUtils.findMessageElement(doc, PORTTYPE_QNAME, operationQName, "output");
        ...
        if (pass) {
            TestUtil.logMsg(" testWSDL1() passed :  Found the part element with element name : " + elementQName
                    + " in the WSDL ");
        } else {
    ...
    public void testWSDL3() throws Fault {
        ...
        if (pass) {
            TestUtil.logMsg(" testWSDL3() passed :  Found the part element with element name : " + elementQName
                    + " in the WSDL ");
        } else {
    ...
    public void testWSDL4() throws Fault {
        ...
        if (pass) {
            TestUtil.logMsg(" testWSDL4() passed :  Found the part element with element name : " + elementQName
                    + " in the WSDL ");
        } else {
            throw new Fault("testWSDL4 failed : could not find part element with element name : "

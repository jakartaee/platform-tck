...
public class Client extends ServiceEETest implements DescriptionConstants, SchemaConstants {
    ...
    private QName EXPECTED_DEFAULT_PART_QNAME_1 = new QName(NAMESPACEURI, EXPECTED_DEFAULT_PART_NAME_1);

    private QName EXPECTED_DEFAULT_PART_QNAME_2 = new QName(NAMESPACEURI, EXPECTED_DEFAULT_PART_NAME_2);
    ...
    private QName EXPECTED_PART_ELEMENT_QNAME_2 = new QName(NAMESPACEURI, EXPECTED_PART_ELEMENT_NAME_2);
    ...
    private void getPortStandalone() throws Exception {
        port = (WebResult2WebService) JWS_Util.getPort(
                wsdlurl, SERVICE_QNAME, WebResult2WebServiceService.class, PORT_QNAME, WebResult2WebService.class);
    ...
    private Element getGlobalSchemaElement(Document doc, URL baseURL, Element partElement) throws Exception {
        ...
        if (elementAtt != null) {
            ...
            if (DescriptionUtils.isSchema(doc)) {
                ...
                if (element == null) {
                    ...
                    Document[] schemas = DescriptionUtils.getSchemaDocuments(doc, baseURL);
                    for (int i = 0; i < schemas.length; i++) {
                        Node[] parameterNodes = WsdlUtils.getParameterElement(doc, baseURL, partQName);
    ...
    private Node[] getGlobalComplexTypeElement(Document doc, URL baseURL, Element headerElement) throws Exception {
        Element complexTypeElement = null;
        Node[] complexTypeNodes = WsdlUtils.getComplexType(doc, headerElement, baseURL);
    ...
    private boolean findParameterElement(
            Document document, Element element, URL baseURL, QName qName, boolean checkList) throws Exception {

        boolean pass = false;

        NodeList list = element.getElementsByTagNameNS(XSD_NAMESPACE_URI, XSD_ELEMENT_LOCAL_NAME);
    ...
    public void testWSDL1() throws Fault {
        ...
        try {
            ...
            if (messageElement != null) {
                partElement = WsdlUtils.findPartElement(
                        doc, messageElement, new QName(NAMESPACEURI, "helloStringResponse"), true);
            }
            ...
            if (partElement != null) {
                ...
                if (complexTypeElement != null) {
                    pass = findParameterElement(
                            currentDoc, complexTypeElement, baseURL, EXPECTED_PART_ELEMENT_QNAME_1, true);
                } else {
        ...
        if (pass) {
            TestUtil.logMsg(" testWSDL1() passed :  Found the part element with element name : "
                    + EXPECTED_PART_ELEMENT_NAME_1 + " in the message "
                    + partElementName);
        } else {
            throw new Fault("testWSDL1 failed : could not find part element with element name : "
                    + EXPECTED_PART_ELEMENT_NAME_1 + " in the message "
                    + partElementName);
        }
    }
    ...
    public void testWSDL2() throws Fault {
        ...
        try {
            ...
            if (messageElement != null) {
                partElement = WsdlUtils.findPartElement(
                        doc, messageElement, new QName(NAMESPACEURI, "helloString2Response"), true);
            }
            ...
            if (partElement != null) {
                ...
                if (complexTypeElement != null) {
                    pass = findParameterElement(
                            currentDoc, complexTypeElement, baseURL, EXPECTED_PART_ELEMENT_QNAME_2, true);
                } else {
                    throw new Fault("Cannot Find Complex Type " + wrapperElement.getAttribute(XSD_TYPE_ATTR));
                }
            }
        ...
        if (pass) {
            TestUtil.logMsg(" testWSDL2() passed :  Found the part element with element name : "
    ...
    public void testWSDL3() throws Fault {
        ...
        try {
            ...
            baseURL = new URL(url);
            WsdlUtils.setBaseUrl(url);
            messageElement = WsdlUtils.findMessageElement(doc, PORTTYPE_QNAME, EXPECTED_OPERATION_QNAME_3, "output");
            if (messageElement != null) {
                partElement = WsdlUtils.findPartElement(
                        doc, messageElement, new QName(NAMESPACEURI, "helloString3Response"), true);
            }
            ...
            if (partElement != null) {
                ...
                if (complexTypeElement != null) {
                    pass = findParameterElement(
                            currentDoc, complexTypeElement, baseURL, EXPECTED_PART_ELEMENT_QNAME_3, true);
                } else {
                    throw new Fault("Cannot Find Complex Type " + wrapperElement.getAttribute(XSD_TYPE_ATTR));
                }
            }
        ...
        if (pass) {
            TestUtil.logMsg(" testWSDL3() passed :  Found the part element with element name : "
                    + EXPECTED_PART_ELEMENT_NAME_3 + " in the message "
                    + partElementName);
        } else {
            throw new Fault("testWSDL3 failed : could not find part element with element name : "
                    + EXPECTED_PART_ELEMENT_NAME_3 + " in the message "
                    + partElementName);
        }
    }
    ...
    public void testWSDL4() throws Fault {
        ...
        try {
            ...
            operationElement = com.sun.ts.tests.jws.common.WsdlUtils.findOperationElement(
                    doc, EXPECTED_OPERATION_QNAME_4, SERVICE_QNAME, PORT_QNAME);
            ...
            if (messageElement != null) {
                partElement = WsdlUtils.findPartElement(doc, messageElement, EXPECTED_PART_ELEMENT_QNAME_4, true);
            }
        ...
        if (pass) {
            ...
            throw new Fault("testWSDL4 failed : could not find soap header element : " + EXPECTED_HEADER_PART_NAME_4
                    + " in the WSDL ");
        }
    }
    ...
    public void testWSDL5() throws Fault {
        ...
        try {
            ...
            messageElement = WsdlUtils.findMessageElement(doc, PORTTYPE_QNAME, EXPECTED_OPERATION_QNAME_5, "output");
            if (messageElement != null) {
                TestUtil.logMsg("Found Message Element");
                WsdlUtils.setBaseUrl(url);
                partElement = WsdlUtils.findPartElement(
                        doc, messageElement, new QName(NAMESPACEURI, "helloString5Response"), true);
            }
            ...
            if (partElement != null) {
                ...
                if (complexTypeElement != null) {
                    pass = findParameterElement(
                            currentDoc, complexTypeElement, baseURL, EXPECTED_PART_ELEMENT_QNAME_5, false);
                } else {
                    throw new Fault("Cannot Find Complex Type " + wrapperElement.getAttribute(XSD_TYPE_ATTR));
                }
            }
        ...
        if (pass) {
            TestUtil.logMsg(" testWSDL5() passed :  Found the part element with element name : "
                    + EXPECTED_PART_ELEMENT_QNAME_5 + " in the Schema");
        } else {
            throw new Fault("testWSDL5 failed : could not find part element with element name : "

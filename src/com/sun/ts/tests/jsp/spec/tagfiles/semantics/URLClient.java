...
public class URLClient extends AbstractUrlClient {
    ...
    public void jspTagSemanticsJspContextWrapperTest() throws Fault {
        TEST_PROPS.setProperty(
                REQUEST, "GET /jsp_tagfile_semantics_web/JspTagSemanticsJspContextWrapperTest.jsp HTTP/1.1");
    ...
    public void jspTagSemanticsDeclaredAttributesTest() throws Fault {
        TEST_PROPS.setProperty(
                REQUEST, "GET /jsp_tagfile_semantics_web/JspTagSemanticsDeclaredAttributesTest.jsp HTTP/1.1");
        TEST_PROPS.setProperty(SEARCH_STRING, "Test PASSED");
        TEST_PROPS.setProperty(UNEXPECTED_RESPONSE_MATCH, "Test FAILED");
        invoke();
    }
    ...
    public void jspTagSemanticsAttributeNotSpecifiedTest() throws Fault {
        TEST_PROPS.setProperty(
                REQUEST, "GET /jsp_tagfile_semantics_web/JspTagSemanticsAttributeNotSpecifiedTest.jsp HTTP/1.1");
        TEST_PROPS.setProperty(SEARCH_STRING, "Test PASSED");
        TEST_PROPS.setProperty(UNEXPECTED_RESPONSE_MATCH, "Test FAILED");
        invoke();
    }
    ...
    public void jspTagSemanticsDynamicAttributesTest() throws Fault {
        TEST_PROPS.setProperty(
                REQUEST, "GET /jsp_tagfile_semantics_web/JspTagSemanticsDynamicAttributesTest.jsp HTTP/1.1");
        TEST_PROPS.setProperty(SEARCH_STRING, "Test PASSED");
        TEST_PROPS.setProperty(UNEXPECTED_RESPONSE_MATCH, "Test FAILED");
        invoke();
    }

...
public class URLClient extends AbstractUrlClient {
     ...
     *
     * @test_Strategy: [PoundDollarSameMeaning] In a jsp page, set an EL variable, then pass it to a tag handler as both
     * ${expr} and #{expr}. Verify that the tag handler's evaluation of both forms is identical.
     */
     ...
     *
     * @test_Strategy: [ExprParsedEvalMany] In a jsp page, verify that once an expression is parsed, it can be evaluated
     * multiple times.
     */
     ...
     *
     * @test_Strategy: [CompositeExprEval] Verify that in a composite expression eval-expressions are coerced to Strings
     * according to the EL type conversion rules and concatenated with any intervening literal-expressions.
     */
     ...
     * @assertion_ids: EL:SPEC:11
     *
     * @test_Strategy: [CompositeExprEval] Verify that in a composite expression eval-expressions are evaluated left to
     * right, coerced to Strings according to the EL type conversion rules, and concatenated with any intervening
     * literal-expressions.
     */

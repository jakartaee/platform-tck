...
public class URLClient extends AbstractUrlClient {
    ...
    public void precompileFalseTest() throws Fault {
        ...
        TEST_PROPS.setProperty(
                REQUEST, "GET /jsp_misc_precompilation_web/precompile.jsp?jsp_precompile=false HTTP/1.0");
        TEST_PROPS.setProperty(UNEXPECTED_RESPONSE_MATCH, "Got the Request");
        invoke();
    }
    ...
    public void precompileNegativeTest() throws Fault {
        ...
        TEST_PROPS.setProperty(TEST_NAME, testName + "Test");
        TEST_PROPS.setProperty(
                REQUEST, "GET /jsp_misc_precompilation_web/precompile.jsp?jsp_precompile=any_invalid_value HTTP/1.0");

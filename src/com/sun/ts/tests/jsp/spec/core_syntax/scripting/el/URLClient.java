...
public class URLClient extends AbstractUrlClient {
     ...
     *
     * @test_Strategy: Validate EL expression will be evaluated by the container when provided as attribute values for
     * actions that accept dynamic values, as body content when body content type is not tagdependent, as template text, and
     * that the expression is only evaluated using the construct ${expr}.
     */
     ...
     *
     * @test_Strategy: Validate EL expressions provided to an action that does not accept dynamic attributes will result in
     * a translation error.
     */
     ...
     *
     * @test_Strategy: Validate that if no scope qualifier is provided, attributes are located in the PageContext using the
     * semantics of PageContext.findAttribute(String). If no attribute can be found, the expression evaluation must be null.
     */
     ...
     *
     * @test_Strategy: Validate that EL Floating Point literal evaluated as expected.
     */
     ...
     *
     * @test_Strategy: Validate the binary operators, '+', '-', and '*' when using Doubles, Floats, and Strings.
     */
     ...
     *
     * @test_Strategy: Validate the binary operators, '/' and 'div' when using different types.
     */
     ...
     *
     * @test_Strategy: Validate the binary operator '%' and 'mod' when using different types.
     */
     ...
     *
     * @test_Strategy: Validate the binary operator '&&', 'and', '||', and "or' when using different types.
     */
     ...
     *
     * @assertion_ids: JSP:SPEC:110.1;JSP:SPEC:110.2.1;JSP:SPEC:110.2.2; JSP:SPEC:110.2.3;JSP:SPEC:110.3
     *
     * @test_Strategy: Validate the unary minus ('-') operator with variaous types and validate the evaluation of the
     ...
     *
     * @test_Strategy: Validate the unary minus ('!' and 'not') returns the expected value.
     */
     ...
     *
     * @assertion_ids: JSP:SPEC:111.1;JSP:SPEC:111.2;JSP:SPEC:111.3; JSP:SPEC:111.4;JSP:SPEC:111.8;JSP:SPEC:111.5;
     * JSP:SPEC:111.6
     *
     * @test_Strategy: Validate the relational operators '<', '>', '<=', '>=', 'lt', 'gt', 'le', 'ge' when one value is
     * null, as well as the various types (Double, Float, Short, etc). Verify the relational operation behaves as expected.
     */
     ...
     *
     * @assertion_ids: JSP:SPEC:112.1;JSP:SPEC:112.2;JSP:SPEC:112.3; JSP:SPEC:112.4;JSP:SPEC:112.5;JSP:SPEC:112.6;
     * JSP:SPEC:112.6.2
     *
     * @test_Strategy: Validate the relational operators '==', '!=', 'ne', 'eq', when one value is null or both values are
     * null, as well as the various types (Double, Float, Short, etc). Verify the relational operation behaves as expected.
     */
     ...
     *
     * @assertion_ids: JSP:SPEC:115.1;JSP:SPEC:115.2;JSP:SPEC:115.3; JSP:SPEC:115.4;JSP:SPEC:115.5;JSP:SPEC:115.6
     *
     * @test_Strategy: Validate the behavior of the EL 'empty' operator when used to evaluate null, String, array, Map, and
     * Collection values (on the case of the array, map, and Collection, provide emtpy and non-empty values)
     */
     ...
     *
     * @assertion_ids: JSP:SPEC:135.1;JSP:SPEC:135.2;JSP:SPEC:135.4; JSP:SPEC:134.5
     *
     * @testStrategy: Validate that various can be successfully corerced to a String using the EL string coercion rules.
     * Also validate any error conditions that can occur during the coercion.
     */
     ...
     *
     * @assertion_ids: JSP:SPEC:136.1;JSP:SPEC:136.2;JSP:SPEC:136.3; JSP:SPEC:136.4;JSP:SPEC:136.5;JSP:SPEC:136.6;
     * JSP:SPEC:136.7;JSP:SPEC:136.8
     *
     * @testStrategy: Validate the EL is able to convert between the various number types successfully based on varying
     * input and target values. Also validate any error conditions that can occur during the coercion.
     */
     ...
     *
     * @assertion_ids: JSP:SPEC:137.1;JSP:SPEC:137.2;JSP:SPEC:137.3; JSP:SPEC:137.4;JSP:SPEC:137.5;JSP:SPEC:137.6
     *
     * @testStrategy: Validate that the EL is able to convert various types to a Character. Also validate any error
     ...
     *
     * @assertion_ids: JSP:SPEC:138.1;JSP:SPEC:138.2;JSP:SPEC:138.3; JSP:SPEC:138.4;JSP:SPEC:138.5
     *
     * @testStrategy: Validate that the EL is able to convert various types to a Boolean. Also validate any error conditions
     * that can occur during the coercion.
     */
     ...
     *
     * @assertion_ids: JSP:SPEC:139.1;JSP:SPEC:139.2;JSP:SPEC:139.3; JSP:SPEC:139.6
     *
     * @testStrategy: Validate that the EL is able to convert various types including invoking propery editors if target
     * type has PropertyEditory. Additionally validate any specified error conditions.
     */
     ...
     *
     * @testStrategy: Validate that if the target type is primitive and the resulting EL evaluation is a boxed type, the
     * result is 'unboxed' and passed to the attribute. If a runtime error doens't occur due to a type problem, the test
     * passes.
     */
    public void elPrimitiveBoxedTypeConversionTest() throws Fault {
        TEST_PROPS.setProperty(
                REQUEST, "GET /jsp_coresyntx_script_el_web/ElPrimitiveBoxedTypeConversionTest.jsp HTTP/1.1");
     ...
     *
     * @test_Strategy: Validate a translation error occurs if the specified function name doesn't exist in the imported
     * taglibrary.
     */
     ...
     *
     * @test_Strategy: Validate a translation error occurs if the specified function find a matching name, but the signature
     * doesn't match.
     */
    public void elNonMatchingFunctionSignatureTest() throws Fault {
        TEST_PROPS.setProperty(
                REQUEST, "GET /jsp_coresyntx_script_el_web/ElNonMatchingFunctionSignatureTest.jsp HTTP/1.1");
        TEST_PROPS.setProperty(STATUS_CODE, INTERNAL_SERVER_ERROR);
        invoke();
    }
     ...
     *
     * @test_Strategy: Validate a translation error occurs if the specified function is not defined a public static.
     */
     ...
     *
     * @test_Strategy: Validate the operation/evaluation of the container when presented with ternary operator expressions.
     */
     ...
     * @assertion_ids: PENDING
     *
     * @test_Strategy: Validate the operation/evaluation of the container when presented with binary operator expressions
     * with parentheses.
     */
    public void elBinaryOperatorParenthesesTest() throws Fault {
        TEST_PROPS.setProperty(
                REQUEST, "GET /jsp_coresyntx_script_el_web/elBinaryOperatorParenthesesTest.jsp HTTP/1.1");

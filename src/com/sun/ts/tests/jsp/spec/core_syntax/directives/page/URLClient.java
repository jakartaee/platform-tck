...
public class URLClient extends AbstractUrlClient {
    ...
    public void positiveBuffAutoflushTest() throws Fault {
        ...
        TEST_PROPS.setProperty(REQUEST, "GET /jsp_coresyntx_directive_page_web/" + testName + ".jsp HTTP/1.0");
    ...
    public void negativeBufferSuffixTest() throws Fault {
        ...
        TEST_PROPS.setProperty(STATUS_CODE, INTERNAL_SERVER_ERROR);
        invoke();
        TEST_PROPS.setProperty(REQUEST, "GET /jsp_coresyntx_directive_page_web/" + testName + "2.jsp HTTP/1.0");
        TEST_PROPS.setProperty(STATUS_CODE, INTERNAL_SERVER_ERROR);
        invoke();
    }

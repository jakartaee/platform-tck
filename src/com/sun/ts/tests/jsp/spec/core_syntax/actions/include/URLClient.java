...
public class URLClient extends AbstractUrlClient {
    ...
    public void staticStaticTest() throws Fault {
        TEST_PROPS.setProperty(REQUEST, "GET " + CONTEXT_ROOT + "/staticStatic_A.jsp HTTP/1.1");
    ...
    public void dynamicDynamicTest() throws Fault {
        TEST_PROPS.setProperty(REQUEST, "GET " + CONTEXT_ROOT + "/dynamicDynamic_A.jsp HTTP/1.1");
        TEST_PROPS.setProperty(SEARCH_STRING, "In /include/C.jsp");
        invoke();
    }
    ...
    public void dynamicStaticTest() throws Fault {
        TEST_PROPS.setProperty(REQUEST, "GET " + CONTEXT_ROOT + "/dynamicStatic_A.jsp HTTP/1.1");
        TEST_PROPS.setProperty(SEARCH_STRING, "In /include/C.jsp");
        invoke();
    }
    ...
    public void staticDynamicTest() throws Fault {
        TEST_PROPS.setProperty(REQUEST, "GET " + CONTEXT_ROOT + "/staticDynamic_A.jsp HTTP/1.1");

...
public class URLClient extends AbstractUrlClient {
    ...
    public void jspRootVersionAttrAllowableValuesTest() throws Fault {
        TEST_PROPS.setProperty(
                REQUEST, "GET /jsp_core_act_root_web/JspRootVersionAttrAllowableValuesTest1.jspx HTTP/1.1");
        TEST_PROPS.setProperty(SEARCH_STRING, "<status>Test PASSED</status>");
        TEST_PROPS.setProperty(UNEXPECTED_RESPONSE_MATCH, "jsp:root");
        invoke();
        TEST_PROPS.setProperty(
                REQUEST, "GET /jsp_core_act_root_web/JspRootVersionAttrAllowableValuesTest2.jspx HTTP/1.1");
        TEST_PROPS.setProperty(SEARCH_STRING, "<status>Test PASSED</status>");
        TEST_PROPS.setProperty(UNEXPECTED_RESPONSE_MATCH, "jsp:root");
        invoke();
    }

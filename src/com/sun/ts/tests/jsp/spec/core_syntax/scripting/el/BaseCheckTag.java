...
/**
 * Base class to perform validation of the JSP 2.0 expression language. This class provides facilities to set a control
 * object which a test object is compared against. It's up to the concrete implementation of this class to provided the
...
public abstract class BaseCheckTag extends TagSupport {
     ...
     *
     * @param o - the implicit object under test
     */
    ...
    /**
     * Displays the status of the current test, or set of nested tests. If a particular tag has the <tt>display</tt>
     * attribute set to <tt>true</tt>, this method will recurse though it's ancestor tags and obtain any failure
     * notifications.
     *
     * If this particular instance doesn't have the display attribute set, then the error generated by the check will be
     * stored to be retrieved by another action nested further down.
     *
     * @param message - the message to display or store
     * @throws JspException - if an error occurs
     */
    ...
    /**
     * Recurses through any available ancestor tags and retrieves any error messages they may have. If the ancestor returns
     * null for the message, then the test succeeded, otherwise take the returned message and add it to a list to be

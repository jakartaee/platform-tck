...
public class URLClient extends AbstractUrlClient {
    ...
    public void positiveSetPropAllTest() throws Fault {
        ...
        TEST_PROPS.setProperty(
                REQUEST,
                "GET /jsp_coresyntx_act_setproperty_web/" + testName
                        + ".jsp?name=Frodo&num=116165&str=Validated HTTP/1.0");
    ...
    public void positiveSetPropNoParamTest() throws Fault {
        ...
        TEST_PROPS.setProperty(GOLDENFILE, testName + ".gf");
        TEST_PROPS.setProperty(
                REQUEST, "GET /jsp_coresyntx_act_setproperty_web/" + testName + ".jsp?str=SAPPOTA HTTP/1.0");
    ...
    public void positiveSetPropParamTest() throws Fault {
        ...
        TEST_PROPS.setProperty(GOLDENFILE, testName + ".gf");
        TEST_PROPS.setProperty(
                REQUEST, "GET /jsp_coresyntx_act_setproperty_web/" + testName + ".jsp?Name=MANGO HTTP/1.0");

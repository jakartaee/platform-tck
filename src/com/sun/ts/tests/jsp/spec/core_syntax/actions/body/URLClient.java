...
public class URLClient extends AbstractUrlClient {
    ...
    public void jspBodyTest() throws Fault {
        ...
        TEST_PROPS.setProperty(SEARCH_STRING, "Test PASSED|Test PASSED|Test PASSED|Test PASSED");
        invoke();
    }
    ...
    public void jspBodyUsageContextTest() throws Fault {
        for (int i = 0; i < 5; i++) {
            TEST_PROPS.setProperty(
                    REQUEST, "GET /jsp_core_act_body_web/JspBodyUsageContextTest" + (i + 1) + ".jsp HTTP/1.1");

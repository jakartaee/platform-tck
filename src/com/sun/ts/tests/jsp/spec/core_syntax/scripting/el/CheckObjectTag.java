...
public class CheckObjectTag extends BaseCheckTag {
     ...
     * <ul>
     * <li>If the object under test is an instance of PageContext, make sure it's the same PageContext as the control
     * object.</li>
     * <li>All other implicit objects aside from pageContext must be instances of java.util.Map. Validate the keys and
     * values based on the what is contained in the control object provided.</li>
     * </ul>
     *
    ...
    /**
     * Creates a Map object from the provide string. The String can take the following forms:
     * <ul>
     * <li>key,value,key1,value1</li>
     * <li>key,[value1:value2],key2,value2
     * <ul>
     * <p/>
     * In the first case, the string is treated as a comma separated list where each odd numbered element represents a key,
     * and the even elements represent the value of the key. In the second case, the string is again treated as a comma
     * separated list, but if the value is surrounded with '[' and ']' then the string contained between the brackets is
     * parsed and an String array is created. NOTE: the separator for the array elements is ':'.
     *
     * @param s - the string to create a Map instance from
    ...
    private static Map getMapFromString(String s) {
        ...
        for (StringTokenizer st = new StringTokenizer(s, ","); st.hasMoreTokens();) {
            ...
            if (value.charAt(0) == '[' && value.charAt(length - 1) == ']') {
                ...
                for (StringTokenizer st1 = new StringTokenizer(value, ":"); st1.hasMoreTokens();) {
    ...
    /**
     * Compares the test mape to the control map. The test map must contain the keys and values defined in the control map.
     *
     * @param name - the name of the implicit object currently under test
     * @param control - the map of keys and values the implicit object must contain
     * @param testMap - the implicit object provided by the container
     * @return a message containing information about the success or failure of the comparison.
     */
    ...
    /**
     * Wrapper method for JspTestUtil.debug(String). This wrapper will prepend this classes name to the provided message.
     *

...
public class URLClient extends AbstractUrlClient {
     ...
     *
     * @test_Strategy: Validate that if the web application uses a 2.4 deployment descriptor and the jsp-property-group
     * element nor the JSP identified by the jsp-property-group specifies no EL evaluation information, EL will be evaluated
     * by the container. This validates both JSPs in standard syntax and JSP documents.
     */
     ...
     *
     * @test_Strategy: Validate that if the web application uses a 2.4 deployment descriptor and the jsp-property-group
     * element sets the el-ignored element to false, and the JSP page specifies no special EL handling, that EL expressions
     * will be evaluated. This validates both JSPs in standard syntax and JSP documents.
     */
     ...
     *
     * @test_Strategy: Validate that if the web application uses a 2.4 deployment descriptor and the jsp-property-group
     * element sets the el-ignored element to true, and the JSP page specifies no special EL handling, that EL expressions
     * will not be evaluated. This validates both JSPs in standard syntax and JSP documents.
     */
     ...
     *
     * @test_Strategy: Validate that if the web application uses a 2.4 deployment descriptor, that the page directive
     * attribute isELIgnored takes precedence over the configuration of the JSP property group.
     */
     ...
     *
     * @test_Strategy: Validate a JSP 2.0 container when presented with a 2.3 based web application, and it encounters a JSP
     * with an EL-like construct (i.e. ${expr}), that EL Evaluation is not performed.
     */

...
public class URLClient extends AbstractUrlClient {
    ...
    public void deferredSyntaxAllowedAsLiteralFalseTemplateTextTest() throws Fault {
        TEST_PROPS.setProperty(
                REQUEST, "GET " + CONTEXT_ROOT + "/deferredSyntaxAllowedAsLiteralFalseTemplateTextTest.jsp HTTP/1.1");
    ...
    public void deferredSyntaxAllowedAsLiteralFalseActionTest() throws Fault {
        TEST_PROPS.setProperty(
                REQUEST, "GET " + CONTEXT_ROOT + "/deferredSyntaxAllowedAsLiteralFalseActionTest.jsp HTTP/1.1");
        TEST_PROPS.setProperty(STATUS_CODE, INTERNAL_SERVER_ERROR);
        invoke();
    }
    ...
    public void noDeferredSyntaxAllowedAsLiteralTemplateTextTest() throws Fault {
        TEST_PROPS.setProperty(
                REQUEST, "GET " + CONTEXT_ROOT + "/noDeferredSyntaxAllowedAsLiteralTemplateTextTest.jsp HTTP/1.1");
        TEST_PROPS.setProperty(STATUS_CODE, INTERNAL_SERVER_ERROR);
        invoke();
    }
    ...
    public void noDeferredSyntaxAllowedAsLiteralActionTest() throws Fault {
        TEST_PROPS.setProperty(
                REQUEST, "GET " + CONTEXT_ROOT + "/noDeferredSyntaxAllowedAsLiteralActionTest.jsp HTTP/1.1");
        TEST_PROPS.setProperty(STATUS_CODE, INTERNAL_SERVER_ERROR);
        invoke();
    }
}

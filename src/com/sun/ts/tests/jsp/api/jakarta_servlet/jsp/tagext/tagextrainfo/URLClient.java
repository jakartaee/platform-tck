...
public class URLClient extends AbstractUrlClient {
    ...
    public void tagExtraInfoTest() throws Fault {
        ...
        invoke();
        TEST_PROPS.setProperty(REQUEST, "GET /jsp_tagextrainfo_web/TagExtraInfoEmptyReturnTest.jsp HTTP/1.1");
        TEST_PROPS.setProperty(SEARCH_STRING, "Test PASSED.");
        invoke();
        TEST_PROPS.setProperty(REQUEST, "GET /jsp_tagextrainfo_web/TagExtraInfoNonEmptyReturnTest.jsp HTTP/1.1");
        TEST_PROPS.setProperty(STATUS_CODE, INTERNAL_SERVER_ERROR);
        invoke();
        TEST_PROPS.setProperty(REQUEST, "GET /jsp_tagextrainfo_web/TagExtraInfoDefaultImplTest.jsp HTTP/1.1");
        TEST_PROPS.setProperty(SEARCH_STRING, "Test PASSED.");
        invoke();
    }
}

    ...
    public int doStartTag() throws JspException {
        if (_context == null) {
            throw new JspException(
                    "Test FAILED.  setPageContext() was not" + " called by the container before calling doStartTag().");
        }
                        ...
                        if (tag != null) {
                            if (tag instanceof ParentTag) {
                                ...
                                out.println("Test FAILED.  getParent() returned an "
                                        + "unexpected value.  Expected: com.sun.ts.tests.jsp.api.jakarta_servlet.jsp.tagext.tagsupport.ParentTag"
                                        + ".  Received: " + tag.getClass().getName());
                            }
                        } else {
                            out.println("Test FAILED.  setParent() was not called by the container"

...
public class URLClient extends AbstractUrlClient {
     ...
     *
     * @assertion_ids: JSP:JAVADOC:427; JSP:JAVADOC:428; JSP:JAVADOC:429; JSP:JAVADOC:430; JSP:JAVADOC:431; JSP:JAVADOC:433
     *
     * @test_Strategy: Obtain an ScopedAttributeELResolver via the PageContext and verify that API calls work as expected:
     * setValue() getValue() getType() isReadOnly() getCommonPropertyType() getFeatureDescriptors()
     */

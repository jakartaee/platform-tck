...
public class TagVarInfoTEI extends BaseTCKExtraInfo {
    ...
    public String getClassName() {
        ...
        if (!"java.lang.Integer".equals(class1)) {
            return "Test FAILED.  Expected getClassName() for var1 to return 'java.lang.Integer'.  " + "Received: "
                    + class1;
        }

        if (!"java.lang.String".equals(class2)) {
            return "Test FAILED.  Expected getClassName() for var2 to return 'java.lang.String.  " + "Received: "
                    + class2;
        }
        return null;
    }
    ...
    public String getNameFromAttribute() {
        ...
        if (!"test".equals(_var4.getNameFromAttribute())) {
            return "Test FAILED.  Expected getNameFromAttribute() to return 'test'.  " + "Received: "
                    + _var4.getNameFromAttribute();
        }
        return null;
    }
    ...
    public String getNameGiven() {
        ...
        if (!"var1".equals(_var1.getNameGiven())) {
            return "Test FAILED.  Expected getNameGiven() for var1 to return 'var1'.  " + "Received: "
                    + _var1.getNameGiven();
        }
        return null;
    }
    ...
    public String getScope() {
        ...
        if (var1Scope != VariableInfo.NESTED) {
            return "Test FAILED.  Expected getScope() for var1 to return NESTED.  " + "Received: "
                    + getVariableScope(var1Scope);
        }

        if (var2Scope != VariableInfo.AT_END) {
            return "Test FAILED.  Expected getScope for var2 to return AT_END.  " + "Received: "
                    + getVariableScope(var2Scope);
        }

        if (var3Scope != VariableInfo.NESTED) {
            return "Test FAILED.  Expected getScope for var3 to return NESTED" + "Received: "
                    + getVariableScope(var3Scope);
        }

        if (var4Scope != VariableInfo.AT_BEGIN) {
            return "Test FAILED.  Expected getScope for var4 to return AT_BEGIN" + "Received: "
                    + getVariableScope(var3Scope);
        }
        return null;
    }

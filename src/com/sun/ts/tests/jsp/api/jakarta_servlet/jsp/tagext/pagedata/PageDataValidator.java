...
public class PageDataValidator extends TagLibraryValidator {
    ...
    private static class PageHandler extends DefaultHandler {
        ...
        public ValidationMessage[] getParsingResults() {
            ...
            if (_scrWasFound == 0) {
                messageList.add("Unable to find the jsp:scriptlet element in theXML view of the processed JSP page.\n");
            }
            if (_scrWasFound > 1) {
            ...
            if (_exprWasFound == 0) {
                messageList.add("Unable to find the jsp:expression element in the XML view of the JSP page.\n");
            }
            if (_exprWasFound > 1) {
            ...
            if (_jspRootWasFound == 0) {
                messageList.add("Unable to find the jsp:root element in the XML view of the JSP page.\n");
            }
            ...
            if (_textWasFound == 0) {
                messageList.add("Unable to find the jsp:text element in the XML view of the JSP page.\n");
            }
            if (_pageDirectiveFound == 0) {
                messageList.add("Unable to find the jsp:page.directive element in the XML view of the JSP page.\n");
            }
            if (_pageDirectiveFound > 1) {
                messageList.add(
                        "Found " + _pageDirectiveFound

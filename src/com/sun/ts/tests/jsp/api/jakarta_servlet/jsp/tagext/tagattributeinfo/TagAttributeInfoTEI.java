    ...
    public String getName() {
        ...
        if (info != null) {
            if (info.length == 3) {
                ...
                message = "Test FAILED.  Expected the TagAttributeInfo array length" + " to be 3, but was actually "
                        + info.length;
            }
        } else {
    ...
    public String getTypeName() {
        ...
        if (info != null) {
            if (info.length == 3) {
                ...
                if (!"jakarta.servlet.jsp.tagext.JspFragment".equals(typeName)) {
                    message = "Test FAILED.  Expected attribue type for attribute 'fragAttribute' "
                            + "to be 'jakarta.servlet.jsp.tagext.JspFragment'.  Received: "
                            + typeName;
                    return message;
                }
            } else {

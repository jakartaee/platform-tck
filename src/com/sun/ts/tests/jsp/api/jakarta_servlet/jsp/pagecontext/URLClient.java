...
public class URLClient extends AbstractUrlClient {
    ...
    public void pageContextGetExceptionTest() throws Fault {
        ...
        TEST_PROPS.setProperty(
                REQUEST, "GET /jsp_pagecontext_web/PageContextTest.jsp?testname=pageContextGetExceptionTest HTTP/1.1");
     ...
     * @test_Strategy: Validate PageContext.forward() passing in a resource identified by a context-relative path.
     */
     ...
     * @test_Strategy: Validate PageContext.forward() passing in a resource identified by a page-relative path.
     */
    ...
    /**
     * -- Removed due to the way we capture the exception. -- testName: pageContextForwardServletExceptionTest
     *
     * @assertion_ids: JSP:JAVADOC:26
     * @test_Strategy: Validate PageContext.forward() throws a ServletException if a ServletException occurs during the
     * forward process.
     *
     * public void pageContextForwardServletExceptionTest() throws Fault { TEST_PROPS.setProperty(APITEST,
     * "pageContextForwardServletExceptionTest"); TEST_PROPS.setProperty(UNEXPECTED_RESPONSE_MATCH, "Error page invoked");
     * invoke(); }
     */

    /**
     * -- Removed due to the way we capture the exception. -- testName: pageContextForwardIOExceptionTest
     *
     * @assertion_ids: JSP:JAVADOC:27
     * @test_Strategy: Validate PageContext.forward() throws an IOExcpetion if an IOException occurs during the forward
     * process.
     *
     * public void pageContextForwardIOExceptionTest() throws Fault { TEST_PROPS.setProperty(APITEST,
     * "pageContextForwardIOExceptionTest"); TEST_PROPS.setProperty(UNEXPECTED_RESPONSE_MATCH, "Error page invoked");
     * invoke(); }
     */
     ...
     * @test_Strategy: Valdiate PageContext.forward() throws an IllegalStateException if ServletResponse is not in the
     ...
     * @test_Strategy: Validate PageContext.include() where the inclusion resource is identified by a context-relative path.
     */
     ...
     * @test_Strategy: Validate PageContext.include() where the inclusion resource is identified by a page-relative path.
     */
     ...
     * @test_Strategy: Validate PageContext.include() with flush argument provided and set to true. Response should be
     * commited after the flush. Test validates this by perfoming an action against the response that would cause an
     * IllegalStateException if the response has been comitted. This also validated the inclusion of a resource identified
     * by a page-relative path.
     */
     ...
     * @test_Strategy: Validate PageContext.include() with flush argument provided and set to false. Response should not
     * have been flushed. Verify by preforming an action against the response that will throw an IllegalStateException if
     * the response has been flushed to the client. This also validated the inclusion of a resource identified by a
     ...
     * @test_Strategy: Validate PageContext.handlePageException(Exception) invokes the defined error page.
     */
     ...
     * @test_Strategy: Validate PageContext.handlePageException(Throwable) invokes the defined error page.
     */
     ...
     * @test_Strategy: Validate PageContext.handlePageException(Exception) throws a NullPointerException if an null argument
     * is provided.
     */
     ...
     * @test_Strategy: Validate PageContext.handlePageException(Throwable) throws a NullPointerException if an null argument
     * is provided.
     */
     ...
     * @assertion_ids: JSP:JAVADOC:60;JSP:JAVADOC:61;JSP:JAVADOC:380;JSP:JAVADOC: 381
     * @test_Strategy: Validate behavior of PageContext.pushBody() and PageContext.popBody().
     */
     ...
     * @test_Strategy: Validate PageContext.include() throws an IOException if included resource throws an IOException.
     */
     ...
     * @test_Strategy: Validate PageContext.include() throws a ServletException if target resource throws a
     * ServletException.
     */
     ...
     * @test_Strategy: Validate PageContext.include() with flush argument provided, throws an IOException if the target
     * resource cannot be accessed by the caller.
     */
     ...
     * @test_Strategy: Validate PageContext.include() with flush argument provided, throws a ServletException if the target
     * resource cannot be accessed by the caller.
     */
     ...
     * @test_Strategy: Validate PageContext.getAttribute(String), PageContext.setAttribute(String). Note: These are
     ...
     * @test_Strategy: Validate a NullPointerException is thrown if the attribute name provided is null, but not when the
     * provided value is null. Note: This is inherited from JspContext.
     */
     ...
     * @test_Strategy: Validate PageContext.getAttribute() and PageContext.setAttribute() when provided with scope
     ...
     * @test_Strategy: Validate an IllegalArgumentException is thrown if PageContext.setAttribute() is provided an invalid
     * scope. Note: This is inherited from JspContext.
     */
    public void pageContextSetAttributeInScopeIllegalArgumentExceptionTest() throws Fault {
     ...
     * @test_Strategy: Validate a NullPointerException is thrown if PageContext.getAttriubte() is provided a null argument.
     ...
     * @test_Strategy: Validate an IllegalArgumentException is thrown if PageContext.getAttribute() is provided an invalid
     * value for scope. Note: This is inherited from JspContext.
     */
    public void pageContextGetAttributeInScopeIllegalArgumentExceptionTest() throws Fault {
     ...
     * @test_Strategy: Validate behavior of PageContext.findAttribute(). Note: This is inherited from JspContext.
     */
     ...
     * @test_Strategy: Validate the behavior of PageContext.removeAttribute(). Note: This is inhertied from JspContext
     */
     ...
     * @test_Strategy: Validate the behavior of PageContext.remoteAttribute() when provided a scope. Note: This is inherited
     * from JspContext.
     */
     ...
     * @test_Strategy: Validate an IllegalArgumentException is thrown if the scope argument is provided an illegal scope.
     */
    public void pageContextRemoveAttributeFromScopeIllegalScopeTest() throws Fault {
     ...
     * @test_Strategy: Validate the behavior of PageContext.getAttributeScope(). Note: This is inherited from JspContext.
     */
     ...
     * @test_Strategy: Validate the behavior of PageContext.getAttributeNamesInScope(). Note: This is inherited from
     * JspContext
     */
     ...
     * @test_Strategy: Validate an IllegalArgumentException is thrown if the scope argument is provided an illegal scope.
     */
    public void pageContextGetAttributeNamesInScopeIllegalScopeTest() throws Fault {
     ...
     * @test_Strategy: Validate the behavior of PageContext.getOut. Note: This is inherited from JspContext.
     */
     ...
     * @test_Strategy: Validate the behavior of PageContext.getExpressionEvaluator. Note: This is inherited from JspContext.
     */
     ...
     * @test_Strategy: Validate the behavior of PageContext.getVariableResolver(). Note: This is inherited from JspContext.
     */
     ...
     * @test_Strategy: Validate a NullPointerException is thrown if a null value is provided for the name parameter.
     */
     ...
     * @test_Strategy: Validate a NullPointerException is thrown if a null value is provided to the name argument.
     */
     ...
     * @test_Strategy: Validate a NullPointerException is thrown if the name argument is provided a null value.
     */
     ...
     * @test_Strategy: Validate that if a null value is provided to either setAttribute(String, Object) or
     * setAttribute(String, Object, int) it has the same affect as calling removeAttribute(String) or

...
/**
 * Test client for TagLibraryInfo. Implementation note, all tests are performed within a TagExtraInfo class. If the test
...
public class URLClient extends AbstractUrlClient {
     ...
     *
     * @test_Strategy: Validate that TagLibaryInfo.getURI() returns the URI as defined by the taglib directive within a JSP
     * page.
     */
     ...
     *
     * @testStrategy: Validate that TagLibraryInfo.getPrefixString() returns the prefix as specified by the prefix attribute
     * of the taglib directive within a JSP page.
     */
     ...
     *
     * @testStrategy: Validate that TagLibraryInfo.getShortName() returns the short name of the tag library as specified by
     * the &lt;short-name&gt; element in a TLD.
     */
     ...
     *
     * @testStrategy: Validate that TagLibraryInfo.getShortName() returns the uri of the tag library as specified by the
     * &lt;uri&gt; element in a TLD.
     */
     ...
     *
     * @testStrategy: Validate that TagLibraryInfo.getInfoString() returns the description of the tag library as specified
     * by the &lt;description&gt; element in a TLD.
     */
     ...
     *
     * @testStrategy: Validate that TagLibraryInfo.getRequiredVersion() returns the require version of the tag library as
     * specified by the &lt;required-version&gt; element in a TLD.
     */
     ...
     *
     * @testStrategy: Validate that TagLibraryInfo.getTags() returns an array of TagInfo objects based off the tags defined
     * by the &lt;tag&gt; elements in a TLD.
     */
     ...
     *
     * @testStrategy: Validate that TagLibraryInfo.getTagFiles() returns an array of TagFileInfo objects based off the tags
     * files defined by the &lt;tag-file&gt; elements in a TLD.
     */
     ...
     *
     * @testStrategy: Validate that TagLibraryInfo.getTag() returns a TagInfo object based off the provided discriminate.
     */
     ...
     *
     * @testStrategy: Validate that TagLibraryInfo.getTagFile() returns a TagFileInfo object based off the provided
     * discriminate.
     */
     ...
     *
     * @testStrategy: Validate that TagLibraryInfo.getFunctions() returns an array of FunctionInfo objects based off the
     * functions defined by the &lt;function&gt; elements in a TLD.
     */
     ...
     *
     * @testStrategy: Validate that TagLibraryInfo.getFunction() returns a FunctionInfo object based off the provided
     * discriminate.
     */
     ...
     *
     * @testStrategy: Validate TagLibaryInfo.getTagLibraryInfos() returns an array of TagLibraryInfo objects for all
     * taglibraries declared in the JSP.
     */

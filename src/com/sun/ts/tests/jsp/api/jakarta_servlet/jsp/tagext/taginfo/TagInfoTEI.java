...
public class TagInfoTEI extends BaseTCKExtraInfo {
    ...
    public String getTagName() {
        ...
        if (info != null && info.length == 2) {
            ...
            if (!TEST_TAG.equals(tagName) && !TEST_TAG2.equals(tagName)) {
                message = "Test FAILED.  Expected a tag name of 'test' or 'test2'" + " to be returned.  Received: "
                        + tagName;
            }
        } else {
        ...
        if (info.length == 2) {
            ...
            for (int i = 0; i < info.length; i++) {
                ...
                if (TEST_TAG.equals(inf.getTagName())) {
                    ...
                    message = "Test FAILED.  Unexpected tag returned: " + info[i].getTagName();
                    break;
                }
            }
        } else {
            message = "Test FAILED.  Expected a TagInfo array length of 2, but was " + "actually " + info.length;
        }
    ...
    public String getTagExtraInfo() {
        ...
        if (info != null) {
            ...
            message = "Test FAILED.  The TagInfo array provided to test method" + " was null";
        }
        return message;
    }
    ...
    public String getTagClassName() {
        ...
        if (info != null && info.length == 2) {
            ...
            if (!className.equals(info[0].getTagClassName())) {
                message = "Test FAILED.  Expected a class name of '" + className + "' for tag '" + tagName + "'";
            }
        } else {
            message = "Test FAILED.  The TagInfo array provided to test method"
                    + " was null or did not have a length of 2.";
    ...
    public String getInfoString() {
        ...
        if (info != null && info.length == 2) {
            ...
            if (!"simple test tag".equals(description)) {
                message = "Test FAILED.  Expected TagInfo.getInfoString() to " + "return 'simple test tag'.  Received: "
                        + description;
            }
        } else {
            message = "Test FAILED.  The TagInfo array provided to test method"
    ...
    public String getTagLibrary() {
        ...
        if (info != null && info.length == 2) {
            if (info[0].getTagLibrary() == null) {
                message = "Test FAILED.  Expected TagInfo.getTagLibrary() to return " + "a non-null value.";
            }
        } else {
            message = "Test FAILED.  The TagInfo array provided to test method"
                    + " was null or did not have a length of 2.";
    ...
    public String getDisplayName() {
        ...
        if (info != null && info.length == 2) {
            ...
            if ("test tag".equals(displayName)) {
                ...
                message = "Test FAILED.  Expected TagInfo.getDisplayName() to return " + "'test tag'.  Received: "
                        + displayName;
            }
        } else {
            message = "Test FAILED.  The TagInfo array provided to test method"
    ...
    public String getSmallIcon() {
        ...
        if (info != null && info.length == 2) {
            ...
            if ("/16/icon.jpg".equals(icon)) {
                ...
                message = "Test FAILED.  Expected TagInfo.getSmallIcon() to return " + "'/16/icon.jpg'.  Received: "
                        + icon;
            }
        } else {
            message = "Test FAILED.  The TagInfo array provided to test method"
    ...
    public String getLargeIcon() {
        ...
        if (info != null && info.length == 2) {
            ...
            if ("/32/icon.jpg".equals(icon)) {
                ...
                message = "Test FAILED.  Expected TagInfo.getLargeIcon() to return " + "'/32/icon.jpg'.  Received: "
                        + icon;
            }
        } else {
            message = "Test FAILED.  The TagInfo array provided to test method"
            ...
            for (int i = 0; i < info.length; i++) {
                if (TEST_TAG.equals(info[i].getTagName())) {
                    if (!info[i].hasDynamicAttributes()) {
                        message = "Test FAILED.  TagInfo.hasDynamicAttributes() returned " + "false for tag 'test'.";
                    }
                } else if (TEST_TAG2.equals(info[i].getTagName())) {
                    if (info[i].hasDynamicAttributes()) {
                        message = "Test FAILED.  TagInfo.hasDynamicAttributes() returned " + "true for tag 'test2";
                    }
                } else {
                    message = "Test FAILED.  Unexpected tag returned from TagInfo array.  " + "Tag: "
                            + info[i].getTagName();
                }
            }
        } else {

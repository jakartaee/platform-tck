...
public class URLClient extends AbstractUrlClient {
    ...
    public void simpleTagSupportVariableSynchronizationTest() throws Fault {
        TEST_PROPS.setProperty(
                REQUEST, "GET /jsp_simtagsupport_web/SimpleTagSupportVariableSynchronizationTest.jsp HTTP/1.1");
        TEST_PROPS.setProperty(UNEXPECTED_RESPONSE_MATCH, "Test FAILED");
        invoke();
    }
    ...
    public void tagHandlerCacheTest() throws Fault {
        ...
        TEST_PROPS.setProperty(REQUEST, "GET /jsp_simtagsupport_web/" + testName + ".jsp HTTP/1.1");
        TEST_PROPS.setProperty(UNEXPECTED_RESPONSE_MATCH, "Test FAILED");
        invoke();
    }

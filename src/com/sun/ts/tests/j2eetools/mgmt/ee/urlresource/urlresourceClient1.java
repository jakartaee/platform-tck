...
/*
 * @version      "@(#)urlresourceClient1.java 1.6     06/02/11 SMI"
 */

package com.sun.ts.tests.j2eetools.mgmt.ee.urlresource;
...
public class urlresourceClient1 extends j2eeresourceClient1 {

  /**** MANAGED OBJECT LOOKUP SECTION ****/

  private static final String searchFor = "*:j2eeType=URLResource,*";
  ...
  private static final String J2EE_TYPE_VALUE = MOUtils.URL_RES;

  private static final String NAME_VALUE = "urlresourceClient1";
  ...
  public static void main(String[] args) {
    urlresourceClient1 theTests = new urlresourceClient1();
    Status s = theTests.run(args, System.out, System.err);
    s.exit();
  }

} // end class urlresourceClient1

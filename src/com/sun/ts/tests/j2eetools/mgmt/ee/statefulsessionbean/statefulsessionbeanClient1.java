...
/*
 * @version      "@(#)statefulsessionbeanClient1.java 1.6     06/02/11 SMI"
 */

package com.sun.ts.tests.j2eetools.mgmt.ee.statefulsessionbean;
...
public class statefulsessionbeanClient1 extends sessionbeanClient1 {

  /**** MANAGED OBJECT LOOKUP SECTION ****/

  private static final String searchFor = "*:j2eeType=StatefulSessionBean,*";
  ...
  private static final String J2EE_TYPE_VALUE = MOUtils.STATEFUL_SES_BEAN;

  private static final String NAME_VALUE = "statefulsessionbeanClient1";
  ...
  public static void main(String[] args) {
    statefulsessionbeanClient1 theTests = new statefulsessionbeanClient1();
    Status s = theTests.run(args, System.out, System.err);
    s.exit();
  }

} // end class statefulsessionbeanClient1

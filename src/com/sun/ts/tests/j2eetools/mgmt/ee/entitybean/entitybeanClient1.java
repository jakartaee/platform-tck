...
/*
 * @version      "@(#)entitybeanClient1.java 1.6     06/02/11 SMI"
 */

package com.sun.ts.tests.j2eetools.mgmt.ee.entitybean;
...
public class entitybeanClient1 extends ejbClient1 {

  /**** MANAGED OBJECT LOOKUP SECTION ****/

  private static final String searchFor = "*:j2eeType=EntityBean,*";
  ...
  private static final String J2EE_TYPE_VALUE = MOUtils.ENTITY_BEAN;

  private static final String NAME_VALUE = "entitybeanClient1";
   ...
   * J2EEMGMT:JAVADOC:15; J2EEMgmt:SPEC:1; J2EEMgmt:SPEC:2; J2EEMgmt:SPEC:54;
   * 
   * @test_Strategy:
   */
  ...
  public static void main(String[] args) {
    entitybeanClient1 theTests = new entitybeanClient1();
    Status s = theTests.run(args, System.out, System.err);
    s.exit();
  }

} // end class entitybeanClient1

...
/*
 * @version      "@(#)jndiresourceClient1.java 1.6     06/02/11 SMI"
 */

package com.sun.ts.tests.j2eetools.mgmt.ee.jndiresource;
...
public class jndiresourceClient1 extends j2eeresourceClient1 {

  /**** MANAGED OBJECT LOOKUP SECTION ****/

  private static final String searchFor = "*:j2eeType=JNDIResource,*";
  ...
  private static final String J2EE_TYPE_VALUE = MOUtils.JNDI_RES;

  private static final String NAME_VALUE = "jndiresourceClient1";
  ...
  public static void main(String[] args) {
    jndiresourceClient1 theTests = new jndiresourceClient1();
    Status s = theTests.run(args, System.out, System.err);
    s.exit();
  }

} // end class jndiresourceClient1

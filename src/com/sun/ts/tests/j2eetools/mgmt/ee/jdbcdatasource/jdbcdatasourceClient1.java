...
/*
 * @version      "@(#)jdbcdatasourceClient1.java 1.6     06/02/11 SMI"
 */

package com.sun.ts.tests.j2eetools.mgmt.ee.jdbcdatasource;
...
public class jdbcdatasourceClient1 extends BaseMO {

  /**** MANAGED OBJECT LOOKUP SECTION ****/

  private static final String searchFor = "*:j2eeType=JDBCDataSource,*";
  ...
  private static final String JDBC_DRIVER_ATR = "jdbcDriver";

  protected Map initAttributes() {
    Map result = super.initAttributes();
    result.put(JDBC_DRIVER_ATR, new String("driverName"));
    return result;
  }

  /**** MANAGED OBJECT NAME'S REQUIRED KEYS SECTION ***/

  private static final String J2EE_TYPE_VALUE = MOUtils.JDBC_DATA_SRC;

  private static final String NAME_VALUE = "jdbcdatasourceClient1";
  ...
  protected Object getJDBCResourceKeyValue() {
    return "jdbcResourceKeyValue";
  }

  public Map initParentKeys() {
    Map keys = super.initParentKeys();
    keys.put(MOUtils.JDBC_RES, getJDBCResourceKeyValue());
   ...
   * J2EEMGMT:JAVADOC:15; J2EEMgmt:SPEC:1; J2EEMgmt:SPEC:2;
   * 
   * @test_Strategy:
   */
  ...
  public static void main(String[] args) {
    jdbcdatasourceClient1 theTests = new jdbcdatasourceClient1();
    Status s = theTests.run(args, System.out, System.err);
    s.exit();
  }

} // end class jdbcdatasourceClient1

...
/*
 * @version      "@(#)servletClient1.java 1.6     06/02/11 SMI"
 */

package com.sun.ts.tests.j2eetools.mgmt.ee.servlet;
...
public class servletClient1 extends BaseMO {

  /**** MANAGED OBJECT LOOKUP SECTION ****/

  private static final String searchFor = "*:j2eeType=Servlet,*";
  ...
  private static final String J2EE_TYPE_VALUE = MOUtils.SERVLET;

  private static final String NAME_VALUE = "servletClient1";
  ...
  protected Object getWebModuleKeyValue() {
    return "webModuleKeyValue";
  }
  ...
  public Map initParentKeys() {
    ...
    keys.put(MOUtils.WEB_MOD, getWebModuleKeyValue());
   ...
   * J2EEMGMT:JAVADOC:15; J2EEMgmt:SPEC:1; J2EEMgmt:SPEC:2; J2EEMgmt:SPEC:60;
   * 
   * @test_Strategy:
   */
  ...
  public static void main(String[] args) {
    servletClient1 theTests = new servletClient1();
    Status s = theTests.run(args, System.out, System.err);
    s.exit();
  }

} // end class servletClient1

...
/*
 * @version      "@(#)rmiiiopresourceClient1.java 1.6     06/02/11 SMI"
 */

package com.sun.ts.tests.j2eetools.mgmt.ee.rmiiiopresource;
...
public class rmiiiopresourceClient1 extends j2eeresourceClient1 {

  /**** MANAGED OBJECT LOOKUP SECTION ****/

  private static final String searchFor = "*:j2eeType=RMI_IIOPResource,*";
  ...
  private static final String J2EE_TYPE_VALUE = MOUtils.RMI_IIOP_RES;

  private static final String NAME_VALUE = "rmiiiopresourceClient1";
  ...
  public static void main(String[] args) {
    rmiiiopresourceClient1 theTests = new rmiiiopresourceClient1();
    Status s = theTests.run(args, System.out, System.err);
    s.exit();
  }

} // end class rmiiiopresourceClient1

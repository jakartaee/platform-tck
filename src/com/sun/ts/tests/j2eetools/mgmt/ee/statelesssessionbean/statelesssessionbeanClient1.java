...
/*
 * @version      "@(#)statelesssessionbeanClient1.java 1.6     06/02/11 SMI"
 */

package com.sun.ts.tests.j2eetools.mgmt.ee.statelesssessionbean;
...
import com.sun.ts.tests.j2eetools.mgmt.ee.sessionbean.sessionbeanClient1;
...
public class statelesssessionbeanClient1 extends sessionbeanClient1 {

  /**** MANAGED OBJECT LOOKUP SECTION ****/

  private static final String searchFor = "*:j2eeType=StatelessSessionBean,*";
  ...
  private static final String J2EE_TYPE_VALUE = MOUtils.STATELESS_SES_BEAN;

  private static final String NAME_VALUE = "statelesssessionbeanClient1";
   ...
   * J2EEMGMT:JAVADOC:15; J2EEMgmt:SPEC:1; J2EEMgmt:SPEC:2; J2EEMgmt:SPEC:55;
   * J2EEMgmt:SPEC:57;
   * 
   * @test_Strategy:
   */
  ...
  public static void main(String[] args) {
    statelesssessionbeanClient1 theTests = new statelesssessionbeanClient1();
    Status s = theTests.run(args, System.out, System.err);
    s.exit();
  }

} // end class statelesssessionbeanClient1

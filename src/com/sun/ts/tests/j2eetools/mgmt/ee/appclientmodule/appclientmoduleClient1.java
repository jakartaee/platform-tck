...
/*
 * @version      "@(#)appclientmoduleClient1.java 1.6     06/02/11 SMI"
 */

package com.sun.ts.tests.j2eetools.mgmt.ee.appclientmodule;
...
public class appclientmoduleClient1 extends j2eemoduleClient1 {

  /**** MANAGED OBJECT LOOKUP SECTION ****/

  private static final String searchFor = "*:j2eeType=AppClientModule,*";
  ...
  private static final String J2EE_TYPE_VALUE = MOUtils.APP_CLIENT_MOD;

  private static final String NAME_VALUE = "appclientmoduleClient1";
  ...
  public static void main(String[] args) {
    appclientmoduleClient1 theTests = new appclientmoduleClient1();
    Status s = theTests.run(args, System.out, System.err);
    s.exit();
  }

} // end class appclientmoduleClient1

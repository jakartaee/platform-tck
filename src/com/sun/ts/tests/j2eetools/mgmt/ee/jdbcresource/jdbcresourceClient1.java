...
/*
 * @version      "@(#)jdbcresourceClient1.java 1.7     06/02/11 SMI"
 */

package com.sun.ts.tests.j2eetools.mgmt.ee.jdbcresource;
...
public class jdbcresourceClient1 extends j2eeresourceClient1 {

  /**** MANAGED OBJECT LOOKUP SECTION ****/

  private static final String searchFor = "*:j2eeType=JDBCResource,*";
  ...
  private static final String CON_FACT_ATR = "jdbcDataSources";

  protected Map initAttributes() {
    Map result = super.initAttributes();
    result.put(CON_FACT_ATR, new String[] { "ds2", "ds2" });
    return result;
  }

  /**** MANAGED OBJECT NAME'S REQUIRED KEYS SECTION ***/

  private static final String J2EE_TYPE_VALUE = MOUtils.JDBC_RES;

  private static final String NAME_VALUE = "jdbcresourceClient1";
   ...
   * J2EEMgmt:SPEC:72; J2EEMgmt:SPEC:73;
   * 
   * @test_Strategy:
   */
  ...
  public static void main(String[] args) {
    jdbcresourceClient1 theTests = new jdbcresourceClient1();
    Status s = theTests.run(args, System.out, System.err);
    s.exit();
  }

} // end class jdbcresourceClient1

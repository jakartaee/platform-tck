...
/*
 * @version      "@(#)jdbcdriverClient1.java 1.5     06/02/11 SMI"
 */

package com.sun.ts.tests.j2eetools.mgmt.ee.jdbcdriver;
...
public class jdbcdriverClient1 extends BaseMO {

  /**** MANAGED OBJECT LOOKUP SECTION ****/

  private static final String searchFor = "*:j2eeType=JDBCDriver,*";
  ...
  private static final String J2EE_TYPE_VALUE = MOUtils.JDBC_DRV;

  private static final String NAME_VALUE = "jdbcdriverClient1";
   ...
   * J2EEMGMT:JAVADOC:15; J2EEMgmt:SPEC:1; J2EEMgmt:SPEC:2; J2EEMgmt:SPEC:74;
   * 
   * @test_Strategy:
   */
  ...
  public static void main(String[] args) {
    jdbcdriverClient1 theTests = new jdbcdriverClient1();
    Status s = theTests.run(args, System.out, System.err);
    s.exit();
  }

} // end class jdbcdriverClient1

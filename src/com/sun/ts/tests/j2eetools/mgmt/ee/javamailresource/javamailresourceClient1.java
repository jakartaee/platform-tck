...
/*
 * @version      "@(#)javamailresourceClient1.java 1.7     06/02/11 SMI"
 */

package com.sun.ts.tests.j2eetools.mgmt.ee.javamailresource;
...
public class javamailresourceClient1 extends j2eeresourceClient1 {

  /**** MANAGED OBJECT LOOKUP SECTION ****/

  private static final String searchFor = "*:j2eeType=JavaMailResource,*";
  ...
  private static final String J2EE_TYPE_VALUE = MOUtils.JAVA_MAIL_RES;

  private static final String NAME_VALUE = "javamailresourceClient1";
  ...
  public static void main(String[] args) {
    javamailresourceClient1 theTests = new javamailresourceClient1();
    Status s = theTests.run(args, System.out, System.err);
    s.exit();
  }

} // end class javamailresourceClient1

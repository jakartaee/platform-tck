...
/*
 * @version      "@(#)jtaresourceClient1.java 1.6     06/02/11 SMI"
 */

package com.sun.ts.tests.j2eetools.mgmt.ee.jtaresource;
...
public class jtaresourceClient1 extends j2eeresourceClient1 {

  /**** MANAGED OBJECT LOOKUP SECTION ****/

  private static final String searchFor = "*:j2eeType=JTAResource,*";
  ...
  private static final String J2EE_TYPE_VALUE = MOUtils.JTA_RES;

  private static final String NAME_VALUE = "jtaresourceClient1";
  ...
  public static void main(String[] args) {
    jtaresourceClient1 theTests = new jtaresourceClient1();
    Status s = theTests.run(args, System.out, System.err);
    s.exit();
  }

} // end class jtaresourceClient1

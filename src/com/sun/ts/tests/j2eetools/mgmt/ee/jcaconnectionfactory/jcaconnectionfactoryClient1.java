...
/*
 * @version      "@(#)jcaconnectionfactoryClient1.java 1.6     06/02/11 SMI"
 */

package com.sun.ts.tests.j2eetools.mgmt.ee.jcaconnectionfactory;
...
public class jcaconnectionfactoryClient1 extends BaseMO {

  /**** MANAGED OBJECT LOOKUP SECTION ****/

  private static final String searchFor = "*:j2eeType=JCAConnectionFactory,*";
  ...
  private static final String JCA_CON_FACT_ATR = "managedConnectionFactory";

  protected Map initAttributes() {
    Map result = super.initAttributes();
    result.put(JCA_CON_FACT_ATR, new String(""));
    return result;
  }

  /**** MANAGED OBJECT NAME'S REQUIRED KEYS SECTION ***/

  private static final String J2EE_TYPE_VALUE = MOUtils.JCA_CONN_FACT;

  private static final String NAME_VALUE = "jcaconnectionfactoryClient1";
  ...
  protected Object getJCAConnectionKeyValue() {
    return "jcaConnectionKeyValue";
  }
  ...
  public Map initParentKeys() {
    ...
    keys.put(MOUtils.JCA_RES, getJCAConnectionKeyValue());
   ...
   * J2EEMGMT:JAVADOC:15; J2EEMgmt:SPEC:1; J2EEMgmt:SPEC:2; J2EEMgmt:SPEC:69;
   * J2EEMgmt:SPEC:70;
   * 
   * @test_Strategy:
   */
  ...
  public static void main(String[] args) {
    jcaconnectionfactoryClient1 theTests = new jcaconnectionfactoryClient1();
    Status s = theTests.run(args, System.out, System.err);
    s.exit();
  }

} // end class jcaconnectionfactoryClient1

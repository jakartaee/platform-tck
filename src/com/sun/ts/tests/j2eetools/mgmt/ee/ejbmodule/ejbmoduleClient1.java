...
/*
 * @version      "@(#)ejbmoduleClient1.java 1.6     06/02/11 SMI"
 */

package com.sun.ts.tests.j2eetools.mgmt.ee.ejbmodule;
...
public class ejbmoduleClient1 extends j2eemoduleClient1 {

  /**** MANAGED OBJECT LOOKUP SECTION ****/

  private static final String searchFor = "*:j2eeType=EJBModule,*";
  ...
  private static final String EJBS_ATR = "ejbs";

  protected Map initAttributes() {
    Map result = super.initAttributes();
    result.put(EJBS_ATR, new String[] { "ejb1", "ejb2" });
    return result;
  }

  /**** MANAGED OBJECT NAME'S REQUIRED KEYS SECTION ***/

  private static final String J2EE_TYPE_VALUE = MOUtils.EJB_MOD;

  private static final String NAME_VALUE = "ejbmoduleClient1";
   ...
   * J2EEMgmt:SPEC:51; J2EEMgmt:SPEC:52;
   * 
   * @test_Strategy:
   */
  ...
  public static void main(String[] args) {
    ejbmoduleClient1 theTests = new ejbmoduleClient1();
    Status s = theTests.run(args, System.out, System.err);
    s.exit();
  }

} // end class ejbmoduleClient1

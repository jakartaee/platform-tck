...
public class Client extends EETest {
     ...
     *
     * @assertion_ids: JMS:JAVADOC:502; JMS:JAVADOC:504; JMS:JAVADOC:510; JMS:JAVADOC:242; JMS:JAVADOC:244; JMS:JAVADOC:246;
     * JMS:JAVADOC:317; JMS:JAVADOC:334; JMS:JAVADOC:258; JMS:JAVADOC:260; JMS:JAVADOC:338; JMS:JAVADOC:221; JMS:SPEC:148;
     * JMS:SPEC:149; JMS:JAVADOC:278; JMS:JAVADOC:280; JMS:JAVADOC:282; JMS:JAVADOC:284; JMS:JAVADOC:288;
     *
     * @test_Strategy: 1. Create two TextMessages, send use a MessageProducer 2. Create a QueueBrowser to browse the Queue
     * so that all two messages can be seen. 3. Use the QueueBrowser to test getQueue 4. Create a QueueBrowser with selector
     * to browse the Queue so that only one message can be seen; 5. Use the above QueueBrowser to test getMessageSelector 6.
     * Create a MessageConsumer with a message selector so that only last message received. 7. Then create another
     * MessageConsumer to verify all messages except the last message can be received from the Queue.
     */

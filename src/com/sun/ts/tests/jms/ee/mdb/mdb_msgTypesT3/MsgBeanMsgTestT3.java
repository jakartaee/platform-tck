...
public class MsgBeanMsgTestT3 implements MessageDrivenBean, MessageListener {
    ...
    public void onMessage(Message msg) {
        ...
        try {
            ...
            if (msg.getStringProperty("TestCase").equals("msgClearBodyTopicTextTestCreate")) {
                TestUtil.logTrace("@onMessage - running msgClearBodyTopicTextTestCreate - create the message");
                msgClearBodyTopicTextTestCreate();
            } else if (msg.getStringProperty("TestCase").equals("msgClearBodyTopicTextTest")) {
                TestUtil.logTrace("@onMessage - running msgClearBodyTopicTextTest - read and verify the message");
                ...
                TestUtil.logTrace("@onMessage - running msgClearBodyTopicObjectTestCreate - create the message");
                msgClearBodyTopicObjectTestCreate();
            } else if (msg.getStringProperty("TestCase").equals("msgClearBodyTopicObjectTest")) {
                TestUtil.logTrace("@onMessage - running msgClearBodyTopicObjectTest - read and verify the message");
                ...
                TestUtil.logTrace("@onMessage - running msgClearBodyTopicMapTestCreate - create the message");
                msgClearBodyTopicMapTestCreate();
            } else if (msg.getStringProperty("TestCase").equals("msgClearBodyTopicMapTest")) {
                TestUtil.logTrace("@onMessage - running msgClearBodyTopicMapTest - read and verify the message");
                ...
                TestUtil.logTrace("@onMessage - running msgClearBodyTopicBytesTestCreate - create the message");
                msgClearBodyTopicBytesTestCreate();
            } else if (msg.getStringProperty("TestCase").equals("msgClearBodyTopicBytesTest")) {
                TestUtil.logTrace("@onMessage - running msgClearBodyTopicBytesTest - read and verify the message");
                ...
                TestUtil.logTrace("@onMessage - running msgClearBodyTopicStreamTestCreate - create the message");
                msgClearBodyTopicStreamTestCreate();
            } else if (msg.getStringProperty("TestCase").equals("msgClearBodyTopicStreamTest")) {
                TestUtil.logTrace("@onMessage - running msgClearBodyTopicStreamTest - read and verify the message");
                msgClearBodyTopicStreamTest((jakarta.jms.StreamMessage) msg);
            } else if (msg.getStringProperty("TestCase").equals("msgResetTopicTest")) {
                TestUtil.logTrace("@onMessage - running msgResetTopicTest - read and verify the message");
                msgResetTopicTest();
    ...
    public void setMessageDrivenContext(MessageDrivenContext mdc) {
        TestUtil.logTrace("jms.ee.mdb.mdb_msgTypesT3  In MsgBeanMsgTest3::setMessageDrivenContext()!!");
        this.mdc = mdc;
    }

    public void ejbRemove() {
        TestUtil.logTrace("jms.ee.mdb.mdb_msgTypesT3  In MsgBeanMsgTest3::remove()!!");
    }
}

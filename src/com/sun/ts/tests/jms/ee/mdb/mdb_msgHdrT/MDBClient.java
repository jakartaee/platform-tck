...
public class MDBClient extends EETest {
    ...
    public void mdbMsgHdrTimeStampTTest() throws Fault {
        ...
        try {
            ...
            TestUtil.logTrace("Call bean - have it tell mdb to run msgHdrTimeStampTTest");
    ...
    public void mdbMsgHdrCorlIdTTextTest() throws Fault {
        ...
        try {
            // Have the EJB invoke the MDB
            TestUtil.logTrace("Call bean - have it tell mdb to run msgHdrCorlIdTTextTestCreate");
    ...
    public void mdbMsgHdrCorlIdTBytesTest() throws Fault {
        ...
        try {
            // Have the EJB invoke the MDB
            TestUtil.logTrace("Call bean - have it tell mdb to run msgHdrCorlIdTBytesTestCreate");
            hr.askMDBToRunATest(testCase1);
            if (!hr.checkOnResponse(testCase2)) {
                TestUtil.logTrace("Error: didn't get expected response from mdb");
    ...
    public void mdbMsgHdrCorlIdTMapTest() throws Fault {
        ...
        try {
            // Have the EJB invoke the MDB
            TestUtil.logTrace("Call bean - have it tell mdb to run msgHdrCorlIdTMapTestCreate");
            hr.askMDBToRunATest(testCase1);
            if (!hr.checkOnResponse(testCase2)) {
                TestUtil.logTrace("Error: didn't get expected response from mdb");
    ...
    public void mdbMsgHdrCorlIdTStreamTest() throws Fault {
        ...
        try {
            // Have the EJB invoke the MDB
            TestUtil.logTrace("Call bean - have it tell mdb to run msgHdrCorlIdTStreamTestCreate");
            hr.askMDBToRunATest(testCase1);
            if (!hr.checkOnResponse(testCase2)) {
                TestUtil.logTrace("Error: didn't get expected response from mdb");
    ...
    public void mdbMsgHdrCorlIdTObjectTest() throws Fault {
        ...
        try {
            // Have the EJB invoke the MDB
            TestUtil.logTrace("Call bean - have it tell mdb to run msgHdrCorlIdTObjectTestCreate");
            hr.askMDBToRunATest(testCase1);
            if (!hr.checkOnResponse(testCase2)) {
                TestUtil.logTrace("Error: didn't get expected response from mdb");
    ...
    public void mdbMsgHdrReplyToTTest() throws Fault {
        ...
        try {
            // Have the EJB invoke the MDB
            TestUtil.logTrace("Call bean - have it tell mdb to run msgHdrReplyToTTestCreate");
            hr.askMDBToRunATest(testCase1);
            if (!hr.checkOnResponse(testCase2)) {
                TestUtil.logTrace("Error: didn't get expected response from mdb");
    ...
    public void mdbMsgHdrJMSTypeTTest() throws Fault {
        ...
        try {
            // Have the EJB invoke the MDB
            TestUtil.logTrace("Call bean - have it tell mdb to run msgHdrJMSTypeTTestCreate");
            hr.askMDBToRunATest(testCase1);
            if (!hr.checkOnResponse(testCase2)) {
                TestUtil.logTrace("Error: didn't get expected response from mdb");
    ...
    public void mdbMsgHdrJMSPriorityTTest() throws Fault {
        ...
        try {
            // Have the EJB invoke the MDB
            TestUtil.logTrace("Call bean - have it tell mdb to run mdbMsgHdrJMSTypeTTestCreate");
            hr.askMDBToRunATest(testCase1);
            if (!hr.checkOnResponse(testCase2)) {
                TestUtil.logTrace("Error: didn't get expected response from mdb");
    ...
    public void mdbMsgHdrJMSExpirationTopicTest() throws Fault {
        ...
        try {
            // Have the EJB invoke the MDB
            TestUtil.logTrace("Call bean - have it tell mdb to run msgHdrJMSExpirationTopicTestCreate");
            hr.askMDBToRunATest(testCase1);
            if (!hr.checkOnResponse(testCase2)) {
                TestUtil.logTrace("Error: didn't get expected response from mdb");
    ...
    public void mdbMsgHdrJMSDestinationTTest() throws Fault {
        ...
        try {
            // Have the EJB invoke the MDB
            TestUtil.logTrace("Call bean - have it tell mdb to run msgHdrJMSDestinationTTestCreate");
            hr.askMDBToRunATest(testCase1);
            if (!hr.checkOnResponse(testCase2)) {
                TestUtil.logTrace("Error: didn't get expected response from mdb");
    ...
    public void mdbMsgHdrJMSDeliveryModeTTest() throws Fault {
        ...
        try {
            // Have the EJB invoke the MDB
            TestUtil.logTrace("Call bean - have it tell mdb to run msgHdrJMSDeliveryModeTTestCreate");
            hr.askMDBToRunATest(testCase1);
            if (!hr.checkOnResponse(testCase2)) {
                TestUtil.logTrace("Error: didn't get expected response from mdb");
    ...
    public void mdbMsgHdrIDTTest() throws Fault {
        ...
        try {
            // Have the EJB invoke the MDB
            TestUtil.logTrace("Call bean - have it tell mdb to run msgHdrIDTTestCreate");
            hr.askMDBToRunATest(testCase1);
            if (!hr.checkOnResponse(testCase2)) {
                TestUtil.logTrace("Error: didn't get expected response from mdb");

...
public class MDB_SNDQ_TestEJB {
    ...
    private boolean recvMessageInternal(Session session, String prop) throws JMSException {
        ...
        if (msgRec != null) {
            if (msgRec.getStringProperty("MessageType").equals(prop)) {
                ...
                TestUtil.logErr("Msg from Q:  " + msgRec.getStringProperty("MessageType"));
            }
        } else {
            TestUtil.logErr("Fail: we didnt get the expected msg back! ");
        }
    ...
    public boolean isThereSomethingInTheQueue() {
        ...
        try {
            ...
            try {
                ...
                TestUtil.logErr("Error closing connection in isThereSomethingInTheQueue", e);
            }
        }
        return ret;
    }
        ...
        try {
            ...
            for (int n = 0; n < numMsgs; n++) {
                for (int i = 0; i < 10; ++i) {
                    ...
                    TestUtil.logTrace("Attempt no: " + i + " Trying to delete message: " + n);
    ...
    public void activate() {
        ...
        try {
            ...
            TestUtil.logErr("Error looking up Queue, Reply Queue, and ConnectionFactory objects", e);

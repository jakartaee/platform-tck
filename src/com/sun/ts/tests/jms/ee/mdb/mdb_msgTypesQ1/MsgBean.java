...
public class MsgBean implements MessageDrivenBean, MessageListener {
    ...
    public void onMessage(Message msg) {
        ...
        try {
            ...
            if (msg.getStringProperty("TestCase").equals("bytesMsgNullStreamQTest")) {
                ...
                TestUtil.logTrace("@onMessage - running bytesMessageQTestsFullMsg1 - create the message");
                bytesMessageQTestsFullMsgCreate();
            } else if (msg.getStringProperty("TestCase").equals("bytesMessageQTestsFullMsg")) {
                TestUtil.logTrace("@onMessage - running bytesMessageQTestsFullMsg - read and verify the message");
                ...
                TestUtil.logTrace("@onMessage - running mapMessageFullMsgQTestCreate - read and verify the message");
                mapMessageFullMsgQTestCreate();
            } else if (msg.getStringProperty("TestCase").equals("mapMessageFullMsgQTest")) {
                TestUtil.logTrace("@onMessage - running mapMessageFullMsgQTest - read and verify the message");
                ...
                TestUtil.logTrace("@onMessage - running  mapMessageConversionQTestsByte - read and verify the message");
                ...
                TestUtil.logTrace("@onMessage - running  mapMessageConversionQTestsChar - read and verify the message");
                ...
                TestUtil.logTrace("@onMessage - running  mapMessageConversionQTestsInt - read and verify the message");
                ...
                TestUtil.logTrace("@onMessage - running  mapMessageConversionQTestsLong - read and verify the message");
    ...
    private void bytesMsgNullStreamQTest() {
        ...
        try {
            ...
            TestUtil.logTrace("Writing a null stream to byte message should throw a NullPointerException");
            ...
            TestUtil.logTrace("Fail: message did not throw NullPointerException exception as expected");
    ...
    private void mapMessageFullMsgQTest(jakarta.jms.MapMessage messageReceivedMapMessage) {
        ...
        try {
            try {
                ...
                TestUtil.printStackTrace(e);
                TestUtil.logTrace("Fail: unexpected exception " + e.getClass().getName() + " was returned");
                pass = false;
            }
    ...
    private void mapMessageConversionQTestsByte(jakarta.jms.MapMessage messageReceived) {
        ...
        try {
            ...
            // -----------------------------------------------
            TestUtil.logTrace("--");
            TestUtil.logTrace("Use getBytes[] to read a byte - expect MessageFormatException");
            int nCount = 0;
            try {
    ...
    private void mapMessageConversionQTestsShort(jakarta.jms.MapMessage messageReceived) {
        ...
        try {
            ...
            // -----------------------------------------------
            TestUtil.logTrace("--");
            TestUtil.logTrace("Use getBytes[] to read a short - expect MessageFormatException");
            try {
    ...
    private void mapMessageConversionQTestsChar(jakarta.jms.MapMessage messageReceived) {
        ...
        try {
            ...
            // -----------------------------------------------
            TestUtil.logTrace("--");
            TestUtil.logTrace("Use getBytes[] to read a char - expect MessageFormatException");
            try {
    ...
    private void mapMessageConversionQTestsInt(jakarta.jms.MapMessage messageReceived) {
        ...
        try {
            ...
            // -----------------------------------------------
            TestUtil.logTrace("--");
            TestUtil.logTrace("Use getBytes[] to read an int - expect MessageFormatException");
            int nCount = 0;
            try {
    ...
    private void mapMessageConversionQTestsLong(jakarta.jms.MapMessage messageReceived) {
        ...
        try {
            ...
            // -----------------------------------------------
            TestUtil.logTrace("--");
            TestUtil.logTrace("Use getBytes[] to read  a long - expect MessageFormatException");
            try {
    ...
    private void mapMessageConversionQTestsBytes(jakarta.jms.MapMessage messageReceived) {
        ...
        try {
            ...
            // -----------------------------------------------
            TestUtil.logTrace("--");
            TestUtil.logTrace("Use getByte to read a byte[] - expect MessageFormatException");
            try {
            ...
            // -----------------------------------------------
            TestUtil.logTrace("--");
            TestUtil.logTrace("Use getShort to read a byte[] - expect MessageFormatException");
            try {
            ...
            // -----------------------------------------------
            TestUtil.logTrace("--");
            TestUtil.logTrace("Use getChar to read a byte[] - expect MessageFormatException");
            try {
            ...
            // -----------------------------------------------
            TestUtil.logTrace("--");
            TestUtil.logTrace("Use getInt to read a byte[] - expect MessageFormatException");
            try {
            ...
            // -----------------------------------------------
            TestUtil.logTrace("--");
            TestUtil.logTrace("Use getLong to read a byte[] - expect MessageFormatException");
            try {
            ...
            // -----------------------------------------------
            TestUtil.logTrace("--");
            TestUtil.logTrace("Use getFloat to read a byte[] - expect MessageFormatException");
            try {
            ...
            // -----------------------------------------------
            TestUtil.logTrace("--");
            TestUtil.logTrace("Use getDouble to read a byte[] - expect MessageFormatException");
            try {
    ...
    public void setMessageDrivenContext(MessageDrivenContext mdc) {
        TestUtil.logTrace("jms.ee.mdb.mdb_msgTypesQ1  In MsgBean::setMessageDrivenContext()!!");
        this.mdc = mdc;
    }

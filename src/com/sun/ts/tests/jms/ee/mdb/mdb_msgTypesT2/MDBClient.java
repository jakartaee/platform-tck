...
public class MDBClient extends EETest {
    ...
    public void mdbStreamMessageConversionTopicTestsBoolean() throws Fault {
        ...
        try {
            ...
            if (!hr.checkOnResponse(testCase2)) {
                TestUtil.logTrace("Error: didn't get expected response from mdb");
                throw new Fault("ERROR: streamMessageConversionTopicTestsBoolean failed");
            }
            TestUtil.logTrace("Test passed!");
        } catch (Exception e) {
            throw new Fault("Test Failed!", e);
    ...
    public void mdbStreamMessageConversionTopicTestsDouble() throws Fault {
        ...
        try {
            ...
            if (!hr.checkOnResponse(testCase2)) {
                TestUtil.logTrace("Error: didn't get expected response from mdb");
                throw new Fault("ERROR: streamMessageConversionTopicTestsDouble failed");
            }
            TestUtil.logTrace("Test passed!");
        } catch (Exception e) {
            throw new Fault("Test Failed!", e);
    ...
    public void mdbStreamMessageConversionTopicTestsString() throws Fault {
        ...
        try {
            ...
            if (!hr.checkOnResponse(testCase2)) {
                TestUtil.logTrace("Error: didn't get expected response from mdb");
                throw new Fault("ERROR: streamMessageConversionTopicTestsString failed");
            }
            TestUtil.logTrace("Test passed!");
        } catch (Exception e) {
            throw new Fault("Test Failed!", e);
     ...
     *
     */
    public void mdbStreamMessageConversionTopicTestsInvFormatString() throws Fault {
        ...
        try {
            ...
            if (!hr.checkOnResponse(testCase2)) {
                TestUtil.logTrace("Error: didn't get expected response from mdb");
                throw new Fault("ERROR: streamMessageConversionTopicTestsInvFormatString failed");
            }
            TestUtil.logTrace("Test passed!");
        } catch (Exception e) {
            throw new Fault("Test Failed!", e);

...
public class MDBClient extends EETest {
     ...
     * JMS:JAVADOC:720; JMS:JAVADOC:723; JMS:JAVADOC:726; JMS:JAVADOC:729; JMS:JAVADOC:738; JMS:JAVADOC:741;
     * JMS:JAVADOC:747;
     *
     * @test_Strategy: Invoke a session bean. Have it send a request to an mdb to create a StreamMessage -. use
     ...
     * JMS:JAVADOC:723; JMS:JAVADOC:726; JMS:JAVADOC:729; JMS:JAVADOC:732; JMS:JAVADOC:738; JMS:JAVADOC:741;
     * JMS:JAVADOC:747;
     *
     * @test_Strategy: Invoke a session bean. Have it send a request to an mdb to create a StreamMessage -. use
     ...
     * JMS:JAVADOC:723; JMS:JAVADOC:726; JMS:JAVADOC:729; JMS:JAVADOC:732; JMS:JAVADOC:735; JMS:JAVADOC:741;
     * JMS:JAVADOC:747;
     *
     * @test_Strategy: Invoke a session bean. Have it send a request to an mdb to create a StreamMessage -. use
    ...
    public void mdbStreamMessageConversionQTestsInvFormatString() throws Fault {
        ...
        try {
            ...
            if (!hr.checkOnResponse(testCase2)) {
                TestUtil.logTrace("Error: didn't get expected response from mdb");
                throw new Fault("ERROR: streamMessageConversionQTestsInvFormatString failed");
            }
            TestUtil.logTrace("Test passed!");
        } catch (Exception e) {
            throw new Fault("Test Failed!", e);

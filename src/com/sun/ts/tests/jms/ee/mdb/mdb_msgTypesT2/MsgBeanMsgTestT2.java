...
public class MsgBeanMsgTestT2 implements MessageDrivenBean, MessageListener {
    ...
    public void ejbCreate() {
        TestUtil.logTrace("jms.ee.mdb.mdb_msgTypesT2  - @MsgBeanMsgTest2-ejbCreate() !!");
        try {
    ...
    public void onMessage(Message msg) {
        ...
        try {
            ...
            if (msg.getStringProperty("TestCase").equals("messageObjectCopyTopicTestCreate")) {
                TestUtil.logTrace("@onMessage - running messageObjectCopyTopicTestCreate - create the message");
                messageObjectCopyTopicTestCreate();
            } else if (msg.getStringProperty("TestCase").equals("messageObjectCopyTopicTest")) {
                TestUtil.logTrace("@onMessage - running messageObjectCopyTopicTest - read and verify the message");
            ...
            if (msg.getStringProperty("TestCase").equals("streamMessageConversionTopicTestsBooleanCreate")) {
                ...
                TestUtil.logTrace("@onMessage - running streamMessageTopicTestsFullMsgCreate - create the message");
                streamMessageTopicTestsFullMsgCreate();
            } else if (msg.getStringProperty("TestCase").equals("streamMessageTopicTestsFullMsg")) {
                TestUtil.logTrace("@onMessage - running streamMessageTopicTestsFullMsg - read and verify the message");
                ...
                TestUtil.logTrace("@onMessage - running streamMessageTopicTestNullCreate - create the message");
                streamMessageTopicTestNullCreate();
            } else if (msg.getStringProperty("TestCase").equals("streamMessageTopicTestNull")) {
                TestUtil.logTrace("@onMessage - running streamMessageTopicTestNull - read and verify the message");
    ...
    /*
     * Description: Read ObjectMessage created by messageObjectCopyTopicTestCreate. verify that modifying the sBuff object
    ...
    public void setMessageDrivenContext(MessageDrivenContext mdc) {
        TestUtil.logTrace("jms.ee.mdb.mdb_msgTypesT2  In MsgBeanMsgTest2::setMessageDrivenContext()!!");
        this.mdc = mdc;
    }

    public void ejbRemove() {
        TestUtil.logTrace("jms.ee.mdb.mdb_msgTypesT2  In MsgBeanMsgTest2::remove()!!");
    }
}

...
public class MsgBeanMsgTestQ2 implements MessageDrivenBean, MessageListener {
    ...
    public void onMessage(Message msg) {
        ...
        try {
            ...
            if (msg.getStringProperty("TestCase").equals("messageObjectCopyQTestCreate")) {
                TestUtil.logTrace("@onMessage - running messageObjectCopyQTestCreate - create the message");
                messageObjectCopyQTestCreate();
            } else if (msg.getStringProperty("TestCase").equals("messageObjectCopyQTest")) {
                TestUtil.logTrace("@onMessage - running messageObjectCopyQTest - read and verify the message");
            ...
            if (msg.getStringProperty("TestCase").equals("streamMessageConversionQTestsBooleanCreate")) {
                ...
                TestUtil.logTrace("@onMessage - running streamMessageConversionQTestsByteCreate - create the message");
                ...
                TestUtil.logTrace("@onMessage - running streamMessageConversionQTestsShortCreate - create the message");
                ...
                TestUtil.logTrace("@onMessage - running streamMessageConversionQTestsIntCreate - create the message");
                ...
                TestUtil.logTrace("@onMessage - running streamMessageConversionQTestsLongCreate - create the message");
                ...
                TestUtil.logTrace("@onMessage - running streamMessageConversionQTestsFloatCreate - create the message");
                ...
                TestUtil.logTrace("@onMessage - running streamMessageConversionQTestsCharCreate - create the message");
                ...
                TestUtil.logTrace("@onMessage - running streamMessageConversionQTestsBytesCreate - create the message");
                ...
                TestUtil.logTrace("@onMessage - running streamMessageQTestsFullMsgCreate - create the message");
                streamMessageQTestsFullMsgCreate();
            } else if (msg.getStringProperty("TestCase").equals("streamMessageQTestsFullMsg")) {
                TestUtil.logTrace("@onMessage - running streamMessageQTestsFullMsg - read and verify the message");
                ...
                TestUtil.logTrace("@onMessage - running streamMessageQTestNullCreate - create the message");
                streamMessageQTestNullCreate();
            } else if (msg.getStringProperty("TestCase").equals("streamMessageQTestNull")) {
                TestUtil.logTrace("@onMessage - running streamMessageQTestNull - read and verify the message");
    ...
    public void messageObjectCopyQTest(jakarta.jms.ObjectMessage messageReceivedObjectMsg) {
        ...
        String initial = "This is";
        try {
            TestUtil.logMsg("Ensure that changing the object did not change the message");
    ...
    private void streamMessageConversionQTestsBoolean(jakarta.jms.StreamMessage messageReceived) {
        ...
        try {
            ...
            TestUtil.logTrace("--");
            TestUtil.logTrace("Use readBytes[] to read a boolean - expect MessageFormatException");
            int nCount = 0;
            try {
            ...
            // -----------------------------------------------
            TestUtil.logTrace("--");
            TestUtil.logTrace("Use readByte to read a boolean - expect MessageFormatException");
            try {
                // position to beginning of stream message.
                messageReceived.reset();
            ...
            // -----------------------------------------------
            TestUtil.logTrace("--");
            TestUtil.logTrace("Use readShort to read a boolean - expect MessageFormatException");
            try {
                // position to beginning of stream message.
                messageReceived.reset();
            ...
            // -----------------------------------------------
            TestUtil.logTrace("--");
            TestUtil.logTrace("Use readChar to read a boolean - expect MessageFormatException");
            try {
                // position to beginning of stream message.
                messageReceived.reset();
            ...
            // -----------------------------------------------
            TestUtil.logTrace("--");
            TestUtil.logTrace("Use readInt to read a boolean - expect MessageFormatException");
            try {
                // position to beginning of stream message.
                messageReceived.reset();
            ...
            // -----------------------------------------------
            TestUtil.logTrace("--");
            TestUtil.logTrace("Use readLong to read a boolean - expect MessageFormatException");
            try {
                // position to beginning of stream message.
                messageReceived.reset();
            ...
            TestUtil.logTrace("--");
            TestUtil.logTrace("Use readFloat to read a boolean - expect MessageFormatException");
            try {
                // position to beginning of stream message.
                messageReceived.reset();
            ...
            // -----------------------------------------------
            TestUtil.logTrace("--");
            TestUtil.logTrace("Use readDouble to read a boolean - expect MessageFormatException");
            try {
                // position to beginning of stream message.
                messageReceived.reset();
    ...
    private void streamMessageConversionQTestsByte(jakarta.jms.StreamMessage messageReceived) {
        ...
        try {
            ...
            // -----------------------------------------------
            TestUtil.logTrace("--");
            TestUtil.logTrace("Use readBytes[] to read a byte - expect MessageFormatException");
            int nCount = 0;
            try {
                // position to beginning of stream message.
                messageReceived.reset();
    ...
    private void streamMessageConversionQTestsShort(jakarta.jms.StreamMessage messageReceived) {
        ...
        try {
            ...
            // -----------------------------------------------
            TestUtil.logTrace("--");
            TestUtil.logTrace("Use readBytes[] to read a short - expect MessageFormatException");
            int nCount = 0;
            try {
                // position to beginning of stream message.
                messageReceived.reset();
    ...
    private void streamMessageConversionQTestsInt(jakarta.jms.StreamMessage messageReceived) {
        ...
        try {
            ...
            // -----------------------------------------------
            TestUtil.logTrace("--");
            TestUtil.logTrace("Use readBytes[] to read an int - expect MessageFormatException");
            int nCount = 0;
            try {
                // position to beginning of stream message.
                messageReceived.reset();
    ...
    private void streamMessageConversionQTestsLong(jakarta.jms.StreamMessage messageReceived) {
        ...
        try {
            ...
            // -----------------------------------------------
            TestUtil.logTrace("--");
            TestUtil.logTrace("Use readBytes[] to read  a long - expect MessageFormatException");
            int nCount = 0;
            try {
                // position to beginning of stream message.
                messageReceived.reset();
    ...
    private void streamMessageConversionQTestsChar(jakarta.jms.StreamMessage messageReceived) {
        ...
        try {
            ...
            // -----------------------------------------------
            TestUtil.logTrace("--");
            TestUtil.logTrace("Use readBytes[] to read a char - expect MessageFormatException");
            int nCount = 0;
            try {
                // position to beginning of stream message.
                messageReceived.reset();
    ...
    private void streamMessageConversionQTestsBytes(jakarta.jms.StreamMessage messageReceived) {
        ...
        try {
            ...
            try {
                boolean b = messageReceived.readBoolean();
                TestUtil.logTrace("Fail: byte[] to boolean conversion should have thrown MessageFormatException");
                pass = false;
            } catch (jakarta.jms.MessageFormatException e) {
                TestUtil.logTrace("Pass: MessageFormatException thrown as expected");
            } catch (Exception e) {
            ...
            // -----------------------------------------------
            TestUtil.logTrace("--");
            TestUtil.logTrace("Use readByte to read a byte[] - expect MessageFormatException");
            try {
                // position to beginning of stream message.
                messageReceived.reset();
                byte b = messageReceived.readByte();
            ...
            // -----------------------------------------------
            TestUtil.logTrace("--");
            TestUtil.logTrace("Use readShort to read a byte[] - expect MessageFormatException");
            try {
                // position to beginning of stream message.
                messageReceived.reset();
                short s = messageReceived.readShort();
            ...
            // -----------------------------------------------
            TestUtil.logTrace("--");
            TestUtil.logTrace("Use readChar to read a byte[] - expect MessageFormatException");
            try {
                // position to beginning of stream message.
                messageReceived.reset();
                char c = messageReceived.readChar();
            ...
            // -----------------------------------------------
            TestUtil.logTrace("--");
            TestUtil.logTrace("Use readInt to read a byte[] - expect MessageFormatException");
            try {
                // position to beginning of stream message.
                messageReceived.reset();
                int i = messageReceived.readInt();
            ...
            // -----------------------------------------------
            TestUtil.logTrace("--");
            TestUtil.logTrace("Use readLong to read a byte[] - expect MessageFormatException");
            try {
                // position to beginning of stream message.
                messageReceived.reset();
                long l = messageReceived.readLong();
            ...
            TestUtil.logTrace("--");
            TestUtil.logTrace("Use readFloat to read a byte[] - expect MessageFormatException");
            try {
                // position to beginning of stream message.
                messageReceived.reset();
                float f = messageReceived.readFloat();
            ...
            // -----------------------------------------------
            TestUtil.logTrace("--");
            TestUtil.logTrace("Use readDouble to read a byte[] - expect MessageFormatException");
            try {
                // position to beginning of stream message.
                messageReceived.reset();
                double d = messageReceived.readDouble();
    ...
    private void streamMessageConversionQTestsInvFormatString(jakarta.jms.StreamMessage messageReceived) {
        ...
        try {
            ...
            try {
                ...
                TestUtil.logTrace("Pass: java.lang.NumberFormatException thrown as expected");
            } catch (Exception e) {
                TestUtil.printStackTrace(e);
                TestUtil.logTrace("Error: Unexpected exception " + e.getClass().getName() + " was thrown");
                pass = false;
            ...
            TestUtil.logTrace("--");
            TestUtil.logTrace("Verify that the data can be read as a string and pointer did not move");
            try {
                String s = messageReceived.readString();
    ...
    public void setMessageDrivenContext(MessageDrivenContext mdc) {
        TestUtil.logTrace("jms.ee.mdb.mdb_msgTypesQ2  In MsgBeanMsgTestQ2::setMessageDrivenContext()!!");
        this.mdc = mdc;
    }

    public void ejbRemove() {
        TestUtil.logTrace("jms.ee.mdb.mdb_msgTypesQ2  In MsgBeanMsgTestQ2::remove()!!");
    }
}

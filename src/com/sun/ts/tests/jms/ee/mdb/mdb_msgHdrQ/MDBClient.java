...
public class MDBClient extends EETest {
    ...
    public void mdbMsgHdrTimeStampQTest() throws Fault {
        ...
        try {
            ...
            TestUtil.logTrace("Call bean - have it tell mdb to run msgHdrTimeStampQTest");
    ...
    public void mdbMsgHdrCorlIdQTextTest() throws Fault {
        ...
        try {
            // Have the EJB invoke the MDB
            TestUtil.logTrace("Call bean - have it tell mdb to run msgHdrCorlIdQTextTestCreate");
    ...
    public void mdbMsgHdrCorlIdQBytesTest() throws Fault {
        ...
        try {
            // Have the EJB invoke the MDB
            TestUtil.logTrace("Call bean - have it tell mdb to run msgHdrCorlIdQBytesTestCreate");
            hr.askMDBToRunATest(testCase1);
            if (!hr.checkOnResponse(testCase2)) {
                TestUtil.logTrace("Error: didn't get expected response from mdb");
    ...
    public void mdbMsgHdrCorlIdQMapTest() throws Fault {
        ...
        try {
            // Have the EJB invoke the MDB
            TestUtil.logTrace("Call bean - have it tell mdb to run msgHdrCorlIdQMapTestCreate");
            hr.askMDBToRunATest(testCase1);
            if (!hr.checkOnResponse(testCase2)) {
                TestUtil.logTrace("Error: didn't get expected response from mdb");
    ...
    public void mdbMsgHdrCorlIdQStreamTest() throws Fault {
        ...
        try {
            // Have the EJB invoke the MDB
            TestUtil.logTrace("Call bean - have it tell mdb to run msgHdrCorlIdQStreamTestCreate");
            hr.askMDBToRunATest(testCase1);
            if (!hr.checkOnResponse(testCase2)) {
                TestUtil.logTrace("Error: didn't get expected response from mdb");
    ...
    public void mdbMsgHdrCorlIdQObjectTest() throws Fault {
        ...
        try {
            // Have the EJB invoke the MDB
            TestUtil.logTrace("Call bean - have it tell mdb to run msgHdrCorlIdQObjectTestCreate");
            hr.askMDBToRunATest(testCase1);
            if (!hr.checkOnResponse(testCase2)) {
                TestUtil.logTrace("Error: didn't get expected response from mdb");
    ...
    public void mdbMsgHdrReplyToQTest() throws Fault {
        ...
        try {
            // Have the EJB invoke the MDB
            TestUtil.logTrace("Call bean - have it tell mdb to run msgHdrReplyToQTestCreate");
            hr.askMDBToRunATest(testCase1);
            if (!hr.checkOnResponse(testCase2)) {
                TestUtil.logTrace("Error: didn't get expected response from mdb");
    ...
    public void mdbMsgHdrJMSTypeQTest() throws Fault {
        ...
        try {
            // Have the EJB invoke the MDB
            TestUtil.logTrace("Call bean - have it tell mdb to run msgHdrJMSTypeQTestCreate");
            hr.askMDBToRunATest(testCase1);
            if (!hr.checkOnResponse(testCase2)) {
                TestUtil.logTrace("Error: didn't get expected response from mdb");
    ...
    public void mdbMsgHdrJMSPriorityQTest() throws Fault {
        ...
        try {
            // Have the EJB invoke the MDB
            TestUtil.logTrace("Call bean - have it tell mdb to run mdbMsgHdrJMSTypeQTestCreate");
            hr.askMDBToRunATest(testCase1);
            if (!hr.checkOnResponse(testCase2)) {
                TestUtil.logTrace("Error: didn't get expected response from mdb");
    ...
    public void mdbMsgHdrJMSExpirationQueueTest() throws Fault {
        ...
        try {
            // Have the EJB invoke the MDB
            TestUtil.logTrace("Call bean - have it tell mdb to run msgHdrJMSExpirationQueueTestCreate");
            hr.askMDBToRunATest(testCase1);
            if (!hr.checkOnResponse(testCase2)) {
                TestUtil.logTrace("Error: didn't get expected response from mdb");
    ...
    public void mdbMsgHdrJMSDestinationQTest() throws Fault {
        ...
        try {
            // Have the EJB invoke the MDB
            TestUtil.logTrace("Call bean - have it tell mdb to run msgHdrJMSDestinationQTestCreate");
            hr.askMDBToRunATest(testCase1);
            if (!hr.checkOnResponse(testCase2)) {
                TestUtil.logTrace("Error: didn't get expected response from mdb");
    ...
    public void mdbMsgHdrJMSDeliveryModeQTest() throws Fault {
        ...
        try {
            // Have the EJB invoke the MDB
            TestUtil.logTrace("Call bean - have it tell mdb to run msgHdrJMSDeliveryModeQTestCreate");
            hr.askMDBToRunATest(testCase1);
            if (!hr.checkOnResponse(testCase2)) {
                TestUtil.logTrace("Error: didn't get expected response from mdb");
    ...
    public void mdbMsgHdrIDQTest() throws Fault {
        ...
        try {
            ...
            TestUtil.logTrace("Call bean - have it tell mdb to run msgHdrIDQTestCreate");
            hr.askMDBToRunATest(testCase1);
            if (!hr.checkOnResponse(testCase2)) {
                TestUtil.logTrace("Error: didn't get expected response from mdb");

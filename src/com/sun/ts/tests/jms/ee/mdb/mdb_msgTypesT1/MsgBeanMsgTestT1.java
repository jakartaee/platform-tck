...
public class MsgBeanMsgTestT1 implements MessageDrivenBean, MessageListener {
    ...
    public void ejbCreate() {
        TestUtil.logTrace("jms.ee.mdb.mdb_msgTypesT1  - @MsgBeanMsgTestT1-ejbCreate() !!");
        try {
    ...
    public void onMessage(Message msg) {
        ...
        try {
            ...
            if (msg.getStringProperty("TestCase").equals("bytesMsgNullStreamTopicTest")) {
                ...
                TestUtil.logTrace("@onMessage - running bytesMessageTopicTestsFullMsg1 - create the message");
                bytesMessageTopicTestsFullMsgCreate();
            } else if (msg.getStringProperty("TestCase").equals("bytesMessageTopicTestsFullMsg")) {
                TestUtil.logTrace("@onMessage - running bytesMessageTopicTestsFullMsg - read and verify the message");
                ...
                TestUtil.logTrace("@onMessage - running mapMessageFullMsgTopicTest - read and verify the message");
    ...
    private void bytesMessageTopicTestsFullMsgCreate() {
        mSender = null;
        TestUtil.logTrace("MsgBeanMsgTestT1 - @bytesMessageTopicTestsFullMsgCreate");
        try {
    ...
    /*
     * Description: reads and verifies BytesMessage created by bytesMessageTopicTestsFullMsgCreate
     */
    ...
    private void mapMessageConversionTopicTestsInvFormatStringCreate() {
        try {
            ...
            messageSent = qSession.createMapMessage();
            JmsUtil.addPropsToMessage(messageSent, p);
            messageSent.setStringProperty(
                    "COM_SUN_JMS_TESTNAME", "mapMessageConversionTopicTestsInvFormatStringCreate");
    ...
    public void setMessageDrivenContext(MessageDrivenContext mdc) {
        TestUtil.logTrace("jms.ee.mdb.mdb_msgTypesT1  In MsgBeanMsgTestT1::setMessageDrivenContext()!!");
        this.mdc = mdc;
    }

    public void ejbRemove() {
        TestUtil.logTrace("jms.ee.mdb.mdb_msgTypesT1  In MsgBeanMsgTestT1::remove()!!");
    }
}

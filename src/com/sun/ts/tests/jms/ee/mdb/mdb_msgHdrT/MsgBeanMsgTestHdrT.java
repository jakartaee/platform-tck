...
public class MsgBeanMsgTestHdrT implements MessageDrivenBean, MessageListener {
    ...
    public void ejbCreate() {
        ...
        TestUtil.logTrace("jms.ee.mdb.mdb_msgHdrT  - @MsgBeanMsgTestHdrT-ejbCreate() !!");
        try {
    ...
    public void onMessage(Message msg) {
        ...
        try {
            ...
            if (msg.getStringProperty("TestCase").equals("msgHdrTimeStampTTest")) {
                TestUtil.logTrace("@onMessage - running msgHdrTimeStampTTest - create the message");
    ...
    public void setMessageDrivenContext(MessageDrivenContext mdc) {
        TestUtil.logTrace("jms.ee.mdb.mdb_msgHdrT  In MsgBeanMsgTestHdrT::setMessageDrivenContext()!!");
        this.mdc = mdc;
    }

    public void ejbRemove() {
        TestUtil.logTrace("jms.ee.mdb.mdb_msgHdrT  In MsgBeanMsgTestHdrT::remove()!!");
    }
}

...
public class MsgBeanMsgTestPropsT implements MessageDrivenBean, MessageListener {
    ...
    public void onMessage(Message msg) {
        ...
        TestUtil.logTrace("from jms.ee.mdb.mdb_msgPropsT @onMessage!" + msg);

        try {
            TestUtil.logTrace("onMessage will run TestCase: " + msg.getStringProperty("TestCase"));
            ...
            if (msg.getStringProperty("TestCase").equals("msgPropertiesTTestCreate")) {
                TestUtil.logTrace("@onMessage - running msgPropertiesTTestCreate - create the message");
                msgPropertiesTTestCreate();
            } else if (msg.getStringProperty("TestCase").equals("msgPropertiesTTest")) {
                TestUtil.logTrace("@onMessage - msgPropertiesTTest!");
                msgPropertiesTTest(msg);
            } else if (msg.getStringProperty("TestCase").equals("msgPropertiesConversionTTestCreate")) {
                TestUtil.logTrace("@onMessage - msgPropertiesConversionTTestCreate!");
                msgPropertiesConversionTTestCreate();
            } else if (msg.getStringProperty("TestCase").equals("msgPropertiesConversionTTest")) {
                TestUtil.logTrace("@onMessage - msgPropertiesConversionTTest!");
                msgPropertiesConversionTTest(msg);
            } else {
                TestUtil.logTrace("@onMessage - invalid message type found in StringProperty");
                TestUtil.logTrace("Do not have a method for this testcase: " + msg.getStringProperty("TestCase"));
            }
    ...
    private void msgPropertiesTTestCreate() {
        ...
        try {
            ...
            messageSent.setStringProperty("COM_SUN_JMS_TESTNAME", "msgPropertiesTTest");
            messageSent.setStringProperty("TestCase", "msgPropertiesTTest");
            ...
            try {
                ...
                TestUtil.logMsg("Error: unexpected error " + ee.getClass().getName() + " was thrown");
    ...
    private void msgPropertiesTTest(jakarta.jms.Message msg) {
        ...
        try {
            ...
            if (i == numPropertyNames) {
                ...
                TestUtil.logMsg("Error: expected " + numPropertyNames + "property names");
            ...
            if (b != false) {
                TestUtil.logTrace("Error: should havereceived false for getBooleanProperty");
                pass = false;
            }
            // try {
            // boolean value = messageReceived.getBooleanProperty("TESTDUMMY");
            // TestUtil.logMsg("Error: NullPointerException should have occurred for
            // getBooleanProperty");
            // pass = false;
            ...
            try {
                ...
                TestUtil.logMsg("Error: NullPointerException should have occurred for getShortProperty");
            ...
            try {
                ...
                TestUtil.logTrace("Verify that you can set a property after clearProperty");
                ...
                if (messageReceived.getStringProperty("TESTSTRING").equals(newEntry)) {
                    ...
                    TestUtil.logTrace("Error: was not able to new property setting after clearProperty");
                    pass = false;
                }
            } catch (Exception exp) {
                TestUtil.logTrace("Unexpected Exception caught while testing set after clearProperty");
                pass = false;
                TestUtil.printStackTrace(exp);
            }
            ...
            try {
                ...
                if (cmd == null) {
                    ...
                    TestUtil.logMsg("expected JMSXGroupID and JMSXGroupSeq at a miniumum");
                    pass = false;
                } else {
                    int iCount = 0;
                ...
                TestUtil.logMsg("Error: unexpected exception: " + ee.getClass().getName() + " was thrown");
                pass = false;
            }
    ...
    private void msgPropertiesConversionTTestCreate() {
        ...
        try {
            ...
            messageSent.setStringProperty("COM_SUN_JMS_TESTNAME", "msgPropertiesConversionTTest");
            messageSent.setStringProperty("TestCase", "msgPropertiesConversionTTest");
            TestUtil.logTrace("Sending message");
    ...
    private void msgPropertiesConversionTTest(jakarta.jms.Message messageReceived) {
        ...
        try {
            ...
            try {
                ...
                // + " was thrown");
                TestUtil.logMsg("Error: did not catch expected Exception -- boolean to byte");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logMsg(ee.getMessage());
                TestUtil.logMsg("Error: unexpected error " + ee.getClass().getName() + " was thrown");
                TestUtil.logMsg("Error: did not catch expected Exception -- boolean to short");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logMsg(ee.getMessage());
                TestUtil.logMsg("Error: unexpected error " + ee.getClass().getName() + " was thrown");
                TestUtil.logMsg("Error: did not catch expected Exception --boolean to int ");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logMsg(ee.getMessage());
                TestUtil.logMsg("Error: unexpected error " + ee.getClass().getName() + " was thrown");
                TestUtil.logMsg("Error: did not catch expected Exception -- boolean to long");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logMsg(ee.getMessage());
                TestUtil.logMsg("Error: unexpected error " + ee.getClass().getName() + " was thrown");
                TestUtil.logMsg("Error: did not catch expected Exception -- boolean to float");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logMsg(ee.getMessage());
                TestUtil.logMsg("Error: unexpected error " + ee.getClass().getName() + " was thrown");
                TestUtil.logMsg("Error: did not catch expected Exception -- boolean to double");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logMsg(ee.getMessage());
                TestUtil.logMsg("Error: unexpected error " + ee.getClass().getName() + " was thrown");
                TestUtil.logMsg("Error: did not catch expected Exception -- byte to boolean");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logMsg(ee.getMessage());
                TestUtil.logMsg("Error: unexpected error " + ee.getClass().getName() + " was thrown");
                TestUtil.logMsg("Error: did not catch expected Exception --byte to float ");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logMsg(ee.getMessage());
                TestUtil.logMsg("Error: unexpected error " + ee.getClass().getName() + " was thrown");
                TestUtil.logMsg("Error: did not catch expected Exception -- byte to double");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logMsg(ee.getMessage());
                TestUtil.logMsg("Error: unexpected error " + ee.getClass().getName() + " was thrown");
                TestUtil.logMsg("Error: did not catch expected Exception -- short to boolean");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logMsg(ee.getMessage());
                TestUtil.logMsg("Error: unexpected error " + ee.getClass().getName() + " was thrown");
                TestUtil.logMsg("Error: did not catch expected Exception -- short to byte");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logMsg(ee.getMessage());
                TestUtil.logMsg("Error: unexpected error " + ee.getClass().getName() + " was thrown");
                TestUtil.logMsg("Error: did not catch expected Exception -- short to float");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logMsg(ee.getMessage());
                TestUtil.logMsg("Error: unexpected error " + ee.getClass().getName() + " was thrown");
                TestUtil.logMsg("Error: did not catch expected Exception -- short to double");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logMsg(ee.getMessage());
                TestUtil.logMsg("Error: unexpected error " + ee.getClass().getName() + " was thrown");
                TestUtil.logMsg("Error: did not catch expected Exception -- int to boolean");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logMsg(ee.getMessage());
                TestUtil.logMsg("Error: unexpected error " + ee.getClass().getName() + " was thrown");
                TestUtil.logMsg("Error: did not catch expected Exception --  int to byte");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logMsg(ee.getMessage());
                TestUtil.logMsg("Error: unexpected error " + ee.getClass().getName() + " was thrown");
                TestUtil.logMsg("Error: did not catch expected Exception -- int to float");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logMsg(ee.getMessage());
                TestUtil.logMsg("Error: unexpected error " + ee.getClass().getName() + " was thrown");
                TestUtil.logMsg("Error: did not catch expected Exception -- int to double");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logMsg(ee.getMessage());
                TestUtil.logMsg("Error: unexpected error " + ee.getClass().getName() + " was thrown");
                TestUtil.logMsg("Error: did not catch expected Exception -- long to boolean");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logMsg(ee.getMessage());
                TestUtil.logMsg("Error: unexpected error " + ee.getClass().getName() + " was thrown");
                TestUtil.logMsg("Error: did not catch expected Exception -- long to byte");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logMsg(ee.getMessage());
                TestUtil.logMsg("Error: unexpected error " + ee.getClass().getName() + " was thrown");
                TestUtil.logMsg("Error: did not catch expected Exception -- long to short ");
                pass = false;
            }
            // invalid - long to int
            try {
                ...
                TestUtil.logMsg(ee.getMessage());
                TestUtil.logMsg("Error: unexpected error " + ee.getClass().getName() + " was thrown");
                TestUtil.logMsg("Error: did not catch expected Exception -- long to int");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logMsg(ee.getMessage());
                TestUtil.logMsg("Error: unexpected error " + ee.getClass().getName() + " was thrown");
                TestUtil.logMsg("Error: did not catch expected Exception -- long to float");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logMsg(ee.getMessage());
                TestUtil.logMsg("Error: unexpected error " + ee.getClass().getName() + " was thrown");
                TestUtil.logMsg("Error: did not catch expected Exception -- long to double");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logMsg(ee.getMessage());
                TestUtil.logMsg("Error: unexpected error " + ee.getClass().getName() + " was thrown");
                TestUtil.logMsg("Error: did not catch expected Exception -- float to boolean ");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logMsg(ee.getMessage());
                TestUtil.logMsg("Error: unexpected error " + ee.getClass().getName() + " was thrown");
                TestUtil.logMsg("Error: did not catch expected Exception -- float to byte");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logMsg(ee.getMessage());
                TestUtil.logMsg("Error: unexpected error " + ee.getClass().getName() + " was thrown");
                TestUtil.logMsg("Error: did not catch expected Exception - float to short ");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logMsg(ee.getMessage());
                TestUtil.logMsg("Error: unexpected error " + ee.getClass().getName() + " was thrown");
                TestUtil.logMsg("Error: did not catch expected Exception --- float to int");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logMsg(ee.getMessage());
                TestUtil.logMsg("Error: unexpected error " + ee.getClass().getName() + " was thrown");
                TestUtil.logMsg("Error: did not catch expected Exception --  float to long");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logMsg(ee.getMessage());
                TestUtil.logMsg("Error: unexpected error " + ee.getClass().getName() + " was thrown");
                TestUtil.logMsg("Error: did not catch expected Exception -- double to boolean ");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logMsg(ee.getMessage());
                TestUtil.logMsg("Error: unexpected error " + ee.getClass().getName() + " was thrown");
                TestUtil.logMsg("Error: did not catch expected Exception -- double to byte ");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logMsg(ee.getMessage());
                TestUtil.logMsg("Error: unexpected error " + ee.getClass().getName() + " was thrown");
                TestUtil.logMsg("Error: did not catch expected Exception -- double to short");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logMsg(ee.getMessage());
                TestUtil.logMsg("Error: unexpected error " + ee.getClass().getName() + " was thrown");
                TestUtil.logMsg("Error: did not catch expected Exception --- double to int ");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logMsg(ee.getMessage());
                TestUtil.logMsg("Error: unexpected error " + ee.getClass().getName() + " was thrown");
                TestUtil.logMsg("Error: did not catch expected Exception -- double to long");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logMsg(ee.getMessage());
                TestUtil.logMsg("Error: unexpected error " + ee.getClass().getName() + " was thrown");
                TestUtil.logMsg("Error: did not catch expected Exception -- double to float");
                pass = false;
            }
            // -------------------------------------------------------------------
            ...
            if ((messageReceived.getBooleanProperty("TESTSTRINGTRUE")) == true) {
                ...
                TestUtil.logMsg("Error: conversion from string to boolean - expect true  - failed");
                pass = false;
            }
            ...
            if ((messageReceived.getBooleanProperty("TESTSTRINGFALSE")) == false) {
                ...
                TestUtil.logMsg("Error: conversion from string to boolean expect false - failed");
                pass = false;
            }
    ...
    public void setMessageDrivenContext(MessageDrivenContext mdc) {
        TestUtil.logTrace("jms.ee.mdb.mdb_msgPropsT  In MsgBeanMsgTestPropsT::setMessageDrivenContext()!!");
        this.mdc = mdc;
    }

    public void ejbRemove() {
        TestUtil.logTrace("jms.ee.mdb.mdb_msgPropsT  In MsgBeanMsgTestPropsT::remove()!!");
    }
}

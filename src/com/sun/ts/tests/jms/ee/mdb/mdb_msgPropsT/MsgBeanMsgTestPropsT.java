...
public class MsgBeanMsgTestPropsT
  ...
  public void ejbCreate() {
    TestUtil.logTrace(
        "jms.ee.mdb.mdb_msgPropsT  - @MsgBeanMsgTestPropsT-ejbCreate() !!");
    try {
  ...
  public void ejbRemove() {
    TestUtil.logTrace(
        "jms.ee.mdb.mdb_msgPropsT  In MsgBeanMsgTestPropsT::remove()!!");
  }
}

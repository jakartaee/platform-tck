...
public class MsgBeanxa implements MessageDrivenBean, MessageListener {
    ...
    public void onMessage(Message msg) {
        ...
        try {
            TestUtil.logTrace("TestCase:=====================" + msg.getStringProperty("COM_SUN_JMS_TESTNAME"));
            //
            ...
            TestUtil.logTrace("will run TestCase: " + msg.getStringProperty("COM_SUN_JMS_TESTNAME"));
    ...
    private void runTest1(Message msg, QueueSession qSession) {
        try {
            ...
            if (!isJmsRedelivered(msg)) {
                ...
                TestUtil.logTrace("Message Number: " + msg.getIntProperty("TestCaseNum"));
                mdc.setRollbackOnly();
            } else {

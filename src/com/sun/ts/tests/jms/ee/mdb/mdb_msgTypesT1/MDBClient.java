...
public class MDBClient extends EETest {
     ...
     *
     * @test_Strategy: Invoke a session bean. Have it send a request to an mdb to create a byte message. Use writeObject to
     * write a null. verify a java.lang.NullPointerException is thrown.
     *
     *
     */
    public void mdbBytesMsgNullStreamTopicTest() throws Fault {
        ...
        try {
            ...
            TestUtil.logTrace("Call bean - have it tell mdb to run bytesMsgNullStreamTopicTest");
     ...
     * JMS:JAVADOC:550; JMS:JAVADOC:552; JMS:JAVADOC:554; JMS:JAVADOC:556; JMS:JAVADOC:558;
     *
     * @test_Strategy: Invoke a session bean. Have it send a request to an mdb to create a BytesMessage -. write to the
     * message using each type of method and as an object. Send the message. Verify the data received was as sent.
     *
     */
     ...
     * JMS:JAVADOC:453;
     *
     * @test_Strategy: Invoke a session bean. Have it send a request to an mdb to create a MapMessage -. write to the
     * message using each type of method and as an object. Send the message. Verify the data received was as sent.
     *
     */
     ...
     * JMS:JAVADOC:804;
     *
     * @test_Strategy: Invoke a session bean. Have it send a request to an mdb to create a MapMessage -. use MapMessage
     * method writeBoolean to write a boolean to the message. Verify the proper conversion support as in 3.11.3
     */
     ...
     *
     * @test_Strategy: Invoke a session bean. Have it send a request to an mdb to create a MapMessage -. use MapMessage
     * method setByte to write a byte. Verify the proper conversion support as in 3.11.3
     *
     */
     ...
     *
     * @test_Strategy: Invoke a session bean. Have it send a request to an mdb to create a MapMessage -. use MapMessage
     * method writeShort to write a short. Verify the proper conversion support as in 3.11.3
     *
     */
     ...
     *
     * @test_Strategy: Invoke a session bean. Have it send a request to an mdb to create a MapMessage -. use MapMessage
     * method writeChar to write a Char. Verify the proper conversion support as in 3.11.3
     *
     */
     ...
     *
     * @test_Strategy: Invoke a session bean. Have it send a request to an mdb to create a MapMessage -. use MapMessage
     * method writeInt to write a int. Verify the proper conversion support as in 3.11.3
     *
     */
     ...
     *
     * @test_Strategy: Invoke a session bean. Have it send a request to an mdb to create a MapMessage -. use MapMessage
     * method writeLong to write a long. Verify the proper conversion support as in 3.11.3
     *
     */
     ...
     *
     * @test_Strategy: Invoke a session bean. Have it send a request to an mdb to create a MapMessage -. use MapMessage
     * method writeFloat to write a float. Verify the proper conversion support as in 3.11.3
     *
     */
     ...
     *
     * @test_Strategy: Invoke a session bean. Have it send a request to an mdb to create a MapMessage -. use MapMessage
     * method writeDouble to write a double. Verify the proper conversion support as in 3.11.3
     *
     */
     ...
     *
     * @test_Strategy: Invoke a session bean. Have it send a request to an mdb to create a MapMessage -. use MapMessage
     * method writeString to write a String. Verify the proper conversion support as in 3.11.3
     *
     */
     ...
     *
     * @test_Strategy: Invoke a session bean. Have it send a request to an mdb to create a MapMessage -. use MapMessage
     * method writeBytes to write a Bytes. Verify the proper conversion support as in 3.11.3
     *
     */
     ...
     *
     * @test_Strategy: Invoke a session bean. Have it send a request to an mdb to create a MapMessage -. use MapMessage
     * method setString to write a text string of "mytest string". Verify NumberFormatException is thrown
     *
     */

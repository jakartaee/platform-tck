...
public class MsgBeanMsgTestQ3 implements MessageDrivenBean, MessageListener {
    ...
    public void ejbCreate() {
        TestUtil.logTrace("jms.ee.mdb.mdb_msgTypesQ3  - @MsgBeanMsgTest3-ejbCreate() !!");
        try {
    ...
    public void onMessage(Message msg) {
        ...
        try {
            ...
            if (msg.getStringProperty("TestCase").equals("msgClearBodyQueueTextTestCreate")) {
                TestUtil.logTrace("@onMessage - running msgClearBodyQueueTextTestCreate - create the message");
                msgClearBodyQueueTextTestCreate();
            } else if (msg.getStringProperty("TestCase").equals("msgClearBodyQueueTextTest")) {
                TestUtil.logTrace("@onMessage - running msgClearBodyQueueTextTest - read and verify the message");
                ...
                TestUtil.logTrace("@onMessage - running msgClearBodyQueueObjectTestCreate - create the message");
                msgClearBodyQueueObjectTestCreate();
            } else if (msg.getStringProperty("TestCase").equals("msgClearBodyQueueObjectTest")) {
                TestUtil.logTrace("@onMessage - running msgClearBodyQueueObjectTest - read and verify the message");
                ...
                TestUtil.logTrace("@onMessage - running msgClearBodyQueueMapTestCreate - create the message");
                msgClearBodyQueueMapTestCreate();
            } else if (msg.getStringProperty("TestCase").equals("msgClearBodyQueueMapTest")) {
                TestUtil.logTrace("@onMessage - running msgClearBodyQueueMapTest - read and verify the message");
                ...
                TestUtil.logTrace("@onMessage - running msgClearBodyQueueBytesTestCreate - create the message");
                msgClearBodyQueueBytesTestCreate();
            } else if (msg.getStringProperty("TestCase").equals("msgClearBodyQueueBytesTest")) {
                TestUtil.logTrace("@onMessage - running msgClearBodyQueueBytesTest - read and verify the message");
                ...
                TestUtil.logTrace("@onMessage - running msgClearBodyQueueStreamTestCreate - create the message");
                msgClearBodyQueueStreamTestCreate();
            } else if (msg.getStringProperty("TestCase").equals("msgClearBodyQueueStreamTest")) {
                TestUtil.logTrace("@onMessage - running msgClearBodyQueueStreamTest - read and verify the message");
                msgClearBodyQueueStreamTest((jakarta.jms.StreamMessage) msg);
            } else if (msg.getStringProperty("TestCase").equals("msgResetQueueTest")) {
                TestUtil.logTrace("@onMessage - running msgResetQueueTest - read and verify the message");
                msgResetQueueTest();
    ...
    public void msgClearBodyQueueTextTest(jakarta.jms.TextMessage messageReceived) {
        ...
        try {
            ...
            if (messageReceived.getStringProperty("TestCase").equals("msgClearBodyQueueTextTest")) {
                TestUtil.logTrace("Pass: Text properties read ok after clearBody called");
            } else {
                TestUtil.logTrace("Fail: Text properties cleared after clearBody called");
                pass = false;
            }
     ...
     * are not effected by clearBody. Write to the message again 3.11
     */
    public void msgClearBodyQueueObjectTest(jakarta.jms.ObjectMessage messageReceivedObjectMsg) {
        ...
        try {
            ...
            if (messageReceivedObjectMsg.getStringProperty("TestCase").equals("msgClearBodyQueueObjectTest")) {
                TestUtil.logTrace("Pass: Object properties read ok after clearBody called");
            } else {
                TestUtil.logTrace("Fail: Object properties cleared after clearBody called");
                pass = false;
            }
     ...
     */
    private void msgClearBodyQueueMapTest(jakarta.jms.MapMessage messageReceivedMapMessage) {
        ...
        try {
            ...
            if (messageReceivedMapMessage.getString("aString") == null) {
                ...
                TestUtil.logTrace("Contains: " + messageReceivedMapMessage.getString("aString"));
                pass = false;
            }

            // properties should not have been deleted by the clearBody method.
            if (messageReceivedMapMessage.getStringProperty("TestCase").equals("msgClearBodyQueueMapTest")) {
                TestUtil.logTrace("Pass: Map properties read ok after clearBody called");
            } else {
                TestUtil.logTrace("Fail: Map properties cleared after clearBody called");
                pass = false;
            }
            TestUtil.logTrace("write 2nd contents");
     ...
     * are not effected by clearBody. Write to the message again 3.11
     */
    public void msgClearBodyQueueBytesTest(jakarta.jms.BytesMessage messageReceivedBytesMessage) {
        ...
        try {
            ...
            TestUtil.logTrace("Bytes message body should now be empty and in writeonly mode");
            try {
                byte b = messageReceivedBytesMessage.readByte();
                TestUtil.logTrace("Fail: MessageNotReadableException not thrown as expected");
                pass = false;
            } catch (jakarta.jms.MessageNotReadableException e) {
                TestUtil.logTrace("Pass: MessageNotReadableException thrown as expected");
            } catch (Exception e) {
                TestUtil.printStackTrace(e);
                TestUtil.logTrace("Error: Unexpected exception " + e.getClass().getName() + " was thrown");
                pass = false;
            }
            // properties should not have been deleted by the clearBody method.
            if (messageReceivedBytesMessage.getStringProperty("TestCase").equals("msgClearBodyQueueBytesTest")) {
                TestUtil.logTrace("Pass: Bytes msg properties read ok after clearBody called");
            } else {
                TestUtil.logTrace("Fail: Bytes msg properties cleared after clearBody called");
                pass = false;
            }
     ...
     * are not effected by clearBody. Write to the message again 3.11
     */
    public void msgClearBodyQueueStreamTest(jakarta.jms.StreamMessage messageReceivedStreamMessage) {
        ...
        try {
            ...
            TestUtil.logTrace("Stream message body should now be empty and in writeonly mode");
            try {
                String s = messageReceivedStreamMessage.readString();
                TestUtil.logTrace("Fail: MessageNotReadableException should have been thrown");
                pass = false;
            ...
            if (messageReceivedStreamMessage.getStringProperty("TestCase").equals("msgClearBodyQueueStreamTest")) {
                TestUtil.logTrace("Pass: Stream msg properties read ok after clearBody called");
            } else {
                TestUtil.logTrace("Fail: Stream msg properties cleared after clearBody called");
                pass = false;
            }
            TestUtil.logTrace("write 2nd contents");
    ...
    private void msgResetQueueTest() {
        ...
        try {
            ...
            try {
                ...
                messageSentStreamMessage.writeString("Testing...");
                TestUtil.logTrace("reset stream message -  now  should be in readonly mode");
                messageSentStreamMessage.reset();
                messageSentStreamMessage.writeString("new data");
                TestUtil.logTrace("Fail: message did not throw MessageNotWriteable exception as expected");
                pass = false;
            ...
            try {
                ...
                TestUtil.logTrace("reset Byte message -  now  should be in readonly mode");
    ...
    public void readNullCharNotValidQueueMapTestCreate() {
        try {
            ...
            TestUtil.logTrace("Write a null string to the map message object with mapMessage.setString");
    ...
    public void readNullCharNotValidQueueStreamTestCreate() {
        try {
            ...
            TestUtil.logTrace("Write a null string to the map message object with streamMessage.setString");
    ...
    public void readNullCharNotValidQueueMapTest(jakarta.jms.MapMessage mapReceived) {
    ...
    public void readNullCharNotValidQueueStreamTest(jakarta.jms.StreamMessage messageReceived) {
    ...
    public void setMessageDrivenContext(MessageDrivenContext mdc) {
        TestUtil.logTrace("jms.ee.mdb.mdb_msgTypesQ3  In MsgBeanMsgTest3::setMessageDrivenContext()!!");
        this.mdc = mdc;
    }

    public void ejbRemove() {
        TestUtil.logTrace("jms.ee.mdb.mdb_msgTypesQ3  In MsgBeanMsgTest3::remove()!!");
    }
}

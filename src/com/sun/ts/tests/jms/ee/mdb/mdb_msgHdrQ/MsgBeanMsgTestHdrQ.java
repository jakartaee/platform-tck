...
public class MsgBeanMsgTestHdrQ implements MessageDrivenBean, MessageListener {
    ...
    public void onMessage(Message msg) {
        ...
        try {
            ...
            if (msg.getStringProperty("TestCase").equals("msgHdrTimeStampQTest")) {
                TestUtil.logTrace("@onMessage - running msgHdrTimeStampQTest - create the message");
    ...
    public void msgHdrCorlIdQTest(jakarta.jms.Message messageReceived) {
        ...
        String jmsCorrelationID = "test Correlation id";
        try {
            TestUtil.logTrace("jmsCorrelationID:  " + messageReceived.getJMSCorrelationID());
            if (messageReceived.getJMSCorrelationID() == null) {
                pass = false;
                TestUtil.logMsg("Text Message Error: JMSCorrelationID returned a  null");
    ...
    public void msgHdrJMSExpirationQueueTest(jakarta.jms.Message messageReceived) {
        ...
        try {
            ...
            TestUtil.logTrace("JMSExpiration is " + messageReceived.getJMSExpiration());
    ...
    public void msgHdrJMSDestinationQTest(jakarta.jms.Message messageReceived) {
        ...
        try {
            ...
            TestUtil.logErr("Unexpected Exception thrown in msgHdrJMSDestinationQTest:", e);
        } finally {
            sendTestResults(testCase, pass);
        }
    }
    ...
    public void msgHdrJMSDeliveryModeQTest(jakarta.jms.Message messageReceived) {
        ...
        try {
            ...
            TestUtil.logTrace("JMSDeliveryMode:  " + messageReceived.getJMSDeliveryMode());
            if (messageReceived.getJMSDeliveryMode() != DeliveryMode.PERSISTENT) {
                pass = false;
                TestUtil.logMsg("Error: JMSDeliveryMode should be set to persistent as default");
            } else {
    ...
    public void setMessageDrivenContext(MessageDrivenContext mdc) {
        TestUtil.logTrace("jms.ee.mdb.mdb_msgHdrQ  In MsgBeanMsgTestHdrQ::setMessageDrivenContext()!!");
        this.mdc = mdc;
    }

    public void ejbRemove() {
        TestUtil.logTrace("jms.ee.mdb.mdb_msgHdrQ  In MsgBeanMsgTestHdrQ::remove()!!");
    }
}

...
public class TransactionTests extends ServiceEETest {
    ...
    private void flushQueue(QueueSession qSession, QueueReceiver qReceiver, Queue queue) throws Exception {
        ...
        try {
            ...
            if (numMsgs == 0) {
                ...
                TestUtil.logTrace(numMsgs + " Messages left on Queue " + queue.getQueueName());
    ...
    private void testInitForQ(String TestCase, int TestNum) throws Exception {
        try {
            ...
            logMsg("Create QueueConnection, start user transaction, create QueueSession");
    ...
    private void testInitForT(String TestCase, int TestNum) throws Exception {
        try {
            ...
            logMsg("Create TopicConnection, start user transaction, create TopicSession");
            ...
            logMsg("Create subscriber and publisher with TestCase as subscription name");
    ...
    public void Test01() throws Fault {
        ...
        try {
            ...
            if (msgRec == null) {
                ...
                logMsg("msgRec.getIntProperty(\"TestCaseNum\")=" + msgRec.getIntProperty("TestCaseNum") + " expected "
                        + TestNum);
    ...
    public void Test03() throws Fault {
        ...
        try {
            ...
            ut.begin();
            logMsg("Begin TX: receiving test message again from Queue then: Commit TX");
            msgRec = (TextMessage) qReceiver.receive(timeout);
            ut.commit();
    ...
    public void Test07() throws Fault {
        ...
        try {
            ...
            ut.begin();
            logMsg("Begin TX: receiving test message again from Topic then: Commit TX");
            msgRec = (TextMessage) tSub.receive(timeout);
            ut.commit();
        ...
        try {
            ...
            for (int i = 0; i < 2; i++) {
                ...
                if (msgRec == null) {
                    ...
                    logMsg("Unknown Message was received in error");
                    logMsg("msgRec.getIntProperty(\"TestCaseNum\")=" + msgRec.getIntProperty("TestCaseNum")
                            + " expected " + TestNum);
                    throw new Exception("Unknown Message was received in error");
                }
            }

...
public class EjbClient implements EjbClientIF {
    ...
    public boolean sendRecvQueueTestUsingCDIFromEjb() {
        ...
        try {
            ...
            TestUtil.logMsg("Using CDI injected context1 specifying QueueConnectionFactory");
            ...
            if (messageReceived == null) {
                ...
                TestUtil.logMsg("Message Received: \"" + messageReceived.getText() + "\"");
    ...
    public boolean sendRecvTopicTestUsingCDIFromEjb() {
        ...
        try {
            ...
            TestUtil.logMsg("Using CDI injected context2 specifying TopicConnectionFactory");
    ...
    public boolean sendRecvUsingCDIDefaultFactoryFromEjb() {
        ...
        try {
            ...
            TestUtil.logMsg("Using CDI injected context4 using default system connection factory");
            ...
            if (messageReceived2 == null) {
                ...
                TestUtil.logMsg("Message Sent: \"" + messageSent.getText() + "\"");
                TestUtil.logMsg("Message Received: \"" + messageReceived2.getText() + "\"");
    ...
    public boolean verifySessionModeOnCDIJMSContextFromEjb() {
        ...
        try {
            ...
            if (context3.getSessionMode() != JMSContext.DUPS_OK_ACKNOWLEDGE) {
                ...
                TestUtil.logMsg("Returned correct session mode: " + printSessionMode(JMSContext.DUPS_OK_ACKNOWLEDGE));
            }
            ...
            if (context2.getSessionMode() != JMSContext.AUTO_ACKNOWLEDGE) {
                ...
                TestUtil.logMsg("Returned correct session mode: " + printSessionMode(JMSContext.AUTO_ACKNOWLEDGE));
            }
    ...
    public boolean testRestrictionsOnCDIJMSContextFromEjb() {
        ...
        try {
            TestUtil.logMsg("Calling JMSContext.acknowledge() MUST throw IllegalStateRuntimeException");
            try {
            ...
            TestUtil.logMsg("Calling JMSContext.setClientID(String) MUST throw IllegalStateRuntimeException");
            try {
            ...
            TestUtil.logMsg("Calling JMSContext.start() MUST throw IllegalStateRuntimeException");
            try {
                context1.start();
            } catch (IllegalStateRuntimeException e) {
                TestUtil.logMsg("Caught expected IllegalStateRuntimeException");
            ...
            TestUtil.logMsg("Calling JMSContext.stop() MUST throw IllegalStateRuntimeException");
            try {
                context1.stop();
            } catch (IllegalStateRuntimeException e) {
                TestUtil.logMsg("Caught expected IllegalStateRuntimeException");
            ...
            TestUtil.logMsg("Calling JMSContext.recover() MUST throw IllegalStateRuntimeException");
            try {
                context1.recover();
            } catch (IllegalStateRuntimeException e) {
                TestUtil.logMsg("Caught expected IllegalStateRuntimeException");
            ...
            TestUtil.logMsg("Calling JMSContext.setAutoStart(boolean) MUST throw IllegalStateRuntimeException");
            try {
    ...
    public boolean testActiveJTAUsingCDICallMethod1FromEjb() {
        ...
        try {
            ...
            context4.createProducer().send(queue, messageSent);
            TestUtil.logMsg("Exit method and let the next method call complete the JTA transaction");
        } catch (Exception e) {
            TestUtil.logErr("Caught exception: " + e);
            pass = false;
        }
    ...
    public boolean testActiveJTAUsingCDICallMethod2FromEjb() {
        ...
        try {
            ...
            // Create JMSConsumer from JMSContext
            TestUtil.logMsg("Create JMSConsumer to consume TextMessage sent in previous method");
            consumer = context4.createConsumer(queue);

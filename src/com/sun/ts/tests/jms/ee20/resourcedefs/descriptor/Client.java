...
public class Client extends ServiceEETest {
    ...
    public void setup(String[] args, Properties p) throws Fault {
        try {
            ...
            TestUtil.logMsg("Lookup JMS destinations defined in Deployment Descriptors");
    ...
    public void checkClientIDOnDurableConnFactoryTest() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Check the client id which is configured as MyClientID in the deployment descriptors");

...
public class Client extends ServiceEETest {
    ...
    public void qcfCreateJMSContextTest1() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Verify that JMSContext.getSessionMode() returns JMSContext.AUTO_ACKNOWLEDGE");
            ...
            if (actSessionMode != expSessionMode) {
                TestUtil.logErr("getSessionMode() returned " + printSessionMode(actSessionMode) + ", expected "
                        + printSessionMode(expSessionMode));
                pass = false;
            }
            context.close();
        } catch (Exception e) {
    ...
    public void qcfCreateJMSContextTest3() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Test QueueConnectionFactory.createContext(String, String)");
    ...
    public void qcfCreateConnectionTest() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Test QueueConnectionFactory.createQueueConnection(String, String) with valid credentials");
            ...
            TestUtil.logMsg("Test QueueConnectionFactory.createConnection(String, String) with valid credentials");
    ...
    public void tcfCreateJMSContextTest3() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Test TopicConnectionFactory.createContext(String, String)");
    ...
    public void tcfCreateConnectionTest() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Test TopicConnectionFactory.createTopicConnection(String, String) with valid credentials");
            ...
            TestUtil.logMsg("Test TopicConnectionFactory.createConnection(String, String) with valid credentials");
    ...
    public void createJMSContextExceptionTests() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Test QueueConnectionFactory.createContext(String, String) with bad credentials");
            ...
            TestUtil.logMsg("Test QueueConnectionFactory.createContext(int) with bad session mode");
            ...
            TestUtil.logMsg("Test TopicConnectionFactory.createContext(String, String) with bad credentials");
            ...
            TestUtil.logMsg("Test TopicConnectionFactory.createContext(int) with bad session mode");
            TestUtil.logMsg("Verify JMSRuntimeException is thrown");
            try {

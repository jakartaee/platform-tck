...
public class Client extends ServiceEETest {
        ...
        try {
            ...
            while (msgs.hasMoreElements()) {
                ...
                if (!tempMsg.getText().equals("Message " + numMessages)) {
                    TestUtil.logErr("Found [" + tempMsg.getText() + "] in browser expected only [Message 3]");
                    pass = false;
                } else {
            ...
            while (msgs.hasMoreElements()) {
                ...
                if (!tempMsg.getText().equals("Message " + msgIndex)) {
                    ...
                    TestUtil.logMsg("Found [Message " + msgIndex + "] in browser (correct)");
                }
                msgCount++;
                msgIndex++;
            }
    ...
    public void createConsumerTest() throws Fault {
        ...
        try {
            ...
            tempMsg = (TextMessage) consumerSelect.receive(timeout);
            if (tempMsg != null) {
                TestUtil.logErr("JMSConsumer.receive() returned a message [" + tempMsg.getText() + "]");
            ...
            tempMsg = (TextMessage) consumer.receive(timeout);
            if (tempMsg != null) {
                TestUtil.logErr("JMSConsumer returned message " + tempMsg.getText() + " (expected None)");
                pass = false;
            } else {
                TestUtil.logMsg("Received no message (CORRECT)");
            }
    ...
    public void invalidDestinationRuntimeExceptionTests() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Testing JMSContext.createBrowser(Queue, String) for InvalidDestinationRuntimeException");
            try {
                TestUtil.logMsg(
            ...
            TestUtil.logMsg("Testing JMSContext.createBrowser(Queue) for InvalidDestinationRuntimeException");
            try {
                TestUtil.logMsg("Calling JMSContext.createBrowser(Queue) -> expect InvalidDestinationRuntimeException");
    ...
    public void invalidSelectorRuntimeExceptionTests() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Testing JMSContext.createBrowser(Queue, String) for InvalidSelectorRuntimeException");
            try {
                TestUtil.logMsg(

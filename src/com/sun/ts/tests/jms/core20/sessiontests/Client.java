...
public class Client extends ServiceEETest {
    ...
    public void getAcknowledgeModeTopicTest() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Calling getAcknowledgeMode and expect " + expAcknowledgeMode + " to be returned");
    ...
    public void createConsumerProducerTopicTest() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Create normal consumer to consume all messages in Topic");
            ...
            if (tempMsg == null) {
                ...
                TestUtil.logErr("Received [" + tempMsg.getText() + "] expected [Message 3]");
                pass = false;
            } else {
            ...
            tempMsg = (TextMessage) consumer.receive(timeout);
            if (tempMsg != null) {
                TestUtil.logErr("Received [" + tempMsg.getText() + "] expected no message");
                TestUtil.logErr("MessageConsumer should have returned " + numMessages + " messages");
                pass = false;
            }
        } catch (Exception e) {
            TestUtil.logErr("Caught exception: " + e);
    ...
    public void createDurableSubscriberTopicTest1() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Create a Durable Subscription and a TopicSubscriber for it");
    ...
    public void createDurableSubscriberTopicTest2() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Create a Durable Subscription and a TopicSubscriber for it");
            tSub = session.createDurableSubscriber(
                    topic, "createDurableSubscriberTopicTest2", "lastMessage = TRUE", false);
        ...
        try {
            ...
            TestUtil.logMsg("Create a Durable Subscription and a TopicSubscriber for it");
            tSub = session.createDurableSubscriber(
                    topic, "createDurableSubscriberTopicTest2", "lastMessage = TRUE", true);
    ...
    public void createSharedConsumerTopicTest1() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Create a shared non-durable Subscription and a MessageConsumer for it");
            consumer.close();
    ...
    public void invalidDestinationExceptionTests() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Testing Session.createDurableSubscriber(Topic, String) for InvalidDestinationException");
            try {
                TestUtil.logMsg(
            ...
            try {
                ...
                session.createDurableSubscriber(
                        invalidTopic, "InvalidDestinationException", "lastMessage = TRUE", false);
            } catch (InvalidDestinationException e) {
                TestUtil.logMsg("Got InvalidDestinationException as expected.");
            } catch (Exception e) {
                TestUtil.logErr("Expected InvalidDestinationException, received " + e);
            ...
            TestUtil.logMsg("Testing Session.createDurableConsumer(Topic, String) for InvalidDestinationException");
            try {
                TestUtil.logMsg(
            ...
            TestUtil.logMsg("Testing Session.createSharedConsumer(Topic, String) for InvalidDestinationException");
            try {
                TestUtil.logMsg("Calling Session.createSharedConsumer(Topic, String) for InvalidDestinationException");
    ...
    public void invalidSelectorExceptionTopicTests() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Testing Session.createSharedConsumer(Topic, String, String) for InvalidSelectorException");
            try {
                TestUtil.logMsg(
    ...
    public void illegalStateExceptionTests() throws Fault {
        ...
        try {
            ...
            try {
                TestUtil.logMsg("Calling QueueSession.createDurableConsumer(Topic, String)");
            ...
            try {
                TestUtil.logMsg("Calling QueueSession.createDurableConsumer(Topic, String, String, boolean)");
                toolq.getDefaultQueueSession().createDurableConsumer(topic, "mySub1", "TEST = 'test'", false);
                pass = false;
                TestUtil.logErr("QueueSession.createDurableConsumer(Topic, String, String, boolean) "
                        + "didn't throw expected IllegalStateException.");
            } catch (jakarta.jms.IllegalStateException ex) {
                TestUtil.logMsg("Got expected IllegalStateException from "
                        + "QueueSession.createDurableConsumer(Topic, String, String, boolean)");
            ...
            try {
                TestUtil.logMsg("Calling QueueSession.createSharedConsumer(Topic, String)");
            ...
            try {
                TestUtil.logMsg("Calling QueueSession.createSharedConsumer(Topic, String, String)");
                toolq.getDefaultQueueSession().createSharedConsumer(topic, "mySub1", "TEST = 'test'");
                pass = false;
                TestUtil.logErr("QueueSession.createSharedConsumer(Topic, String, String) "
                        + "didn't throw expected IllegalStateException.");
            } catch (jakarta.jms.IllegalStateException ex) {
                TestUtil.logMsg("Got expected IllegalStateException from "
                        + "QueueSession.createSharedConsumer(Topic, String, String)");
            ...
            try {
                TestUtil.logMsg("Calling QueueSession.createSharedDurableConsumer(Topic, String)");
                toolq.getDefaultQueueSession().createSharedDurableConsumer(topic, "mySub1");
                pass = false;
                TestUtil.logErr("QueueSession.createSharedDurableConsumer(Topic, String) "
                        + "didn't throw expected IllegalStateException.");
            } catch (jakarta.jms.IllegalStateException ex) {
                TestUtil.logMsg("Got expected IllegalStateException from "
                        + "QueueSession.createSharedDurableConsumer(Topic, String)");
            ...
            try {
                TestUtil.logMsg("Calling QueueSession.createSharedDurableConsumer(Topic, String, String)");
                toolq.getDefaultQueueSession().createSharedDurableConsumer(topic, "mySub1", "TEST = 'test'");
                pass = false;
                TestUtil.logErr("QueueSession.createSharedDurableConsumer(Topic, String, String) "
                        + "didn't throw expected IllegalStateException.");
            } catch (jakarta.jms.IllegalStateException ex) {
                TestUtil.logMsg("Got expected IllegalStateException from "
                        + "QueueSession.createSharedDurableConsumer(Topic, String, String)");
            ...
            try {
                TestUtil.logMsg("Create a Durable Subscriber with clientid unset (expect IllegalStateException");
            ...
            try {
                ...
                TestUtil.logMsg("Calling Session.createDurableSubscriber(Topic, String, String, boolean)");
                subscriber = toolT.getDefaultSession().createDurableSubscriber(topic, "mySub1", "TEST = 'test'", true);
                pass = false;
                TestUtil.logErr("Session.createDurableSubscriber(Topic, String, String, boolean) "
                        + "didn't throw expected IllegalStateException.");
                try {
                    subscriber.close();
                    toolT.getDefaultSession().unsubscribe("mySub1");
            ...
            try {
                TestUtil.logMsg("Create a Durable Consumer with clientid unset (expect IllegalStateException");
            ...
            try {
                ...
                TestUtil.logMsg("Calling Session.createDurableConsumer(Topic, String, String, boolean)");
                consumer = toolT.getDefaultSession().createDurableConsumer(topic, "mySub1", "TEST = 'test'", true);
                pass = false;
                TestUtil.logErr("Session.createDurableConsumer(Topic, String, String, boolean) "
                        + "didn't throw expected IllegalStateException.");
                try {
                    consumer.close();
                    toolT.getDefaultSession().unsubscribe("mySub1");
    ...
    public void jMSExceptionTests() throws Fault {
        ...
        try {
            ...
            try {
                TestUtil.logMsg("Create a Durable Consumer with noLocal=true and clientid unset (expect JMSException");
                TestUtil.logMsg("Calling Session.createDurableConsumer(Topic, String, String, boolean)");
                consumer = null;
        ...
        try {
            ...
            TestUtil.logMsg("Create second durable subscriber with same name but different topic");
            TestUtil.logMsg("Calling Session.createDurableSubscriber(Topic, String)");
            ...
            TestUtil.logMsg("Got expected JMSException from " + "Session.createDurableSubscriber(Topic, String)");
        } catch (Exception e) {
            TestUtil.logErr("Caught unexpected exception: " + e);
            pass = false;
        } finally {
        ...
        try {
            ...
            TestUtil.logMsg("Got expected JMSException from " + "Session.createSharedConsumer(Topic, String)");
        } catch (Exception e) {
            TestUtil.logErr("Caught unexpected exception: " + e);
            pass = false;
        } finally {
        ...
        try {
            TestUtil.logMsg("Create shared consumer");
            TestUtil.logMsg("Calling Session.createSharedConsumer(Topic, String, String)");
            consumer = consumer2 = null;
            ...
            TestUtil.logMsg("Got expected JMSException from " + "Session.createSharedConsumer(Topic, String, String)");
        } catch (Exception e) {
            TestUtil.logErr("Caught unexpected exception: " + e);
            pass = false;
        } finally {
        ...
        try {
            ...
            TestUtil.logMsg("Calling Session.createSharedDurableConsumer(Topic, String, String)");
            consumer = consumer2 = null;
        ...
        try {
            ...
            TestUtil.logMsg("Got expected JMSException from " + "Session.createDurableConsumer(Topic, String)");
        } catch (Exception e) {
            TestUtil.logErr("Caught unexpected exception: " + e);
            pass = false;
        } finally {
        ...
        try {
            TestUtil.logMsg("Create shared durable subscription");
            TestUtil.logMsg("Calling Session.createSharedDurableConsumer(Topic, String)");
            consumer = consumer2 = null;
            ...
            TestUtil.logMsg("Got expected JMSException from " + "Session.createSharedDurableConsumer(Topic, String)");
        } catch (Exception e) {
            TestUtil.logErr("Caught unexpected exception: " + e);
            pass = false;
        } finally {
    ...
    public void createTemporayQueueTest() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Attempting to delete temporary queue with an open consumer should not be allowed");
            try {
                tempQueue.delete();
                pass = false;
                TestUtil.logErr("TemporaryQueue.delete() didn't throw expected Exception");
            } catch (JMSException em) {
                TestUtil.logMsg("Received expected JMSException: ");
            } catch (Exception e) {
            ...
            TestUtil.logMsg("Attempting to delete temporary queue with no open consumer should be allowed");
            try {
                tempQueue.delete();
            } catch (Exception e) {
                pass = false;
    ...
    public void createQueueBrowserTest() throws Fault {
        ...
        try {
            ...
            // selector
            TestUtil.logMsg("Create QueueBrowser to peek at last message in Queue using message selector");
            ...
            while (msgs.hasMoreElements()) {
                ...
                if (!tempMsg.getText().equals("Message " + numMessages)) {
                    TestUtil.logErr("Found [" + tempMsg.getText() + "] in browser expected [Message 3]");
                    pass = false;
                } else {
            ...
            if (msgCount != 1) {
                TestUtil.logErr("Found " + msgCount + " messages in browser expected 1");
                pass = false;
            } else {
            ...
            TestUtil.logMsg("Create QueueBrowser to browse all messages in the Queue");
            qBrowser = session.createBrowser(queue);

            // check for messages
            TestUtil.logMsg("Check that browser contains all " + numMessages + " messages");
            msgCount = 0;
            int msgIndex = 1;
            msgs = qBrowser.getEnumeration();
            while (msgs.hasMoreElements()) {
                ...
                if (!tempMsg.getText().equals("Message " + msgIndex)) {
                    TestUtil.logErr("Found [" + tempMsg.getText() + "] in browser expected [Message " + msgIndex + "]");
                    pass = false;
                }
                msgCount++;
                msgIndex++;
            ...
            if (msgCount != numMessages) {
                TestUtil.logErr("Found " + msgCount + " messages in browser expected " + numMessages);
                pass = false;
            } else {
                TestUtil.logMsg("Found " + numMessages + " messages in browser (correct)");
            }
        } catch (Exception e) {
            TestUtil.logErr("Caught exception: " + e);
            e.printStackTrace();
    ...
    public void createConsumerProducerQueueTest() throws Fault {
        ...
        try {
            ...
            tempMsg = (TextMessage) consumer.receive(timeout);
            if (tempMsg != null) {
                TestUtil.logErr("MessageConsumer should have returned " + (numMessages - 1) + " message");
                pass = false;
            }
        } catch (Exception e) {
            TestUtil.logErr("Caught exception: " + e);

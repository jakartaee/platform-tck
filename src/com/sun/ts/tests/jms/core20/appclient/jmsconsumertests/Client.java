...
public class Client extends ServiceEETest {
    ...
    public void queueSendRecvMessageListenerTest() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Send the TestMessage via JMSProducer.send(Destination, Message)");
            ...
            TestUtil.logMsg("Retreive MessageListener by calling consumer.getMessageListener()");

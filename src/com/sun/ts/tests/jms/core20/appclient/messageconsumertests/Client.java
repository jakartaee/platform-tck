...
public class Client extends ServiceEETest {
    ...
    public void queueSendRecvMessageListenerTest() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Set message listener MyMessageListener on this MessageConsumer");
            ...
            TestUtil.logMsg("Retreive MessageListener by calling MessageConsumer.getMessageListener()");

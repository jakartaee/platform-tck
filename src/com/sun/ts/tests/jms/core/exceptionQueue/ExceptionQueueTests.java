...
public class ExceptionQueueTests extends ServiceEETest {
    ...
    public void xInvalidDestinationExceptionQTest() throws Fault {
        ...
        try {
            ...
            if (!pass) {
                throw new Fault("Error: failures occurred during xInvalidDestinationExceptionQTest tests");
            }
        } catch (Exception e) {
    ...
    public void xMessageFormatExceptionQTestforStreamMessage() throws Fault {
        try {
            ...
            try {
                ...
                // Should not reach here !!
                TestUtil.logTrace("Failed:  expected MessageFormatException not thrown");
                throw new Fault("Fail: Did not throw expected error!!!");
            } catch (MessageFormatException fe) {
    ...
    public void xInvalidSelectorExceptionQueueTest() throws Fault {
        try {
            ...
            try {
                ...
                TestUtil.logErr("Error --- createBrowser didn't throw expected InvalidSelectorException!");
                pass = false;
            } catch (InvalidSelectorException es) {
                TestUtil.logTrace("createBrowser threw expected InvalidSelectorException!");
            } catch (Exception e) {
                pass = false;
                TestUtil.logErr("Error -- Incorrect Exception thrown by createBrowser.", e);
            } finally {
                if (qBrowser != null) {
                    try {
                        qBrowser.close();
            ...
            try {
                ...
                TestUtil.logMsg("createReceiver threw expected InvalidSelectorException!");
            } catch (Exception e) {
                pass = false;
                TestUtil.logErr("Error -- Incorrect Exception thrown by createReceiver.", e);
            } finally {
                if (qReceiver != null) {
                    try {
                        qReceiver.close();
    ...
    public void xUnsupportedOperationExceptionQTest1() throws Fault {
        try {
            ...
            try {
                ...
                pass = false;
                logErr("Error: QueueSender.send(Message) didn't throw expected UnsupportedOperationException.");
            } catch (UnsupportedOperationException ex) {
                logMsg("Got expected UnsupportedOperationException from QueueSender.send(Message)");
            } catch (Exception e) {
                logErr("Error: QueueSender.send(Message) throw incorrect Exception: ", e);
                pass = false;
            }
            ...
            try {
                ...
                logMsg("Got expected UnsupportedOperationException from QueueSender.send(Message, int, int, long)");
            } catch (Exception e) {
                logErr("Error: QueueSender.send(Message, int, int, long) throw incorrect Exception: ", e);
                pass = false;
            }
    ...
    public void xUnsupportedOperationExceptionQTest2() throws Fault {
        try {
            ...
            try {
                ...
                pass = false;
                logErr("Error: MessageProducer.send(Message) didn't throw expected UnsupportedOperationException.");
            } catch (UnsupportedOperationException ex) {
                logMsg("Got expected UnsupportedOperationException from MessageProducer.send(Message)");
            } catch (Exception e) {
                logErr("Error: MessageProducer.send(Message) throw incorrect Exception: ", e);
                pass = false;
            }
            ...
            try {
                ...
                logMsg("Got expected UnsupportedOperationException from MessageProducer.send(Message, int, int, long)");
            } catch (Exception e) {
                logErr("Error: MessageProducer.send(Message, int, int, long) throw incorrect Exception: ", e);
                pass = false;
            }
    ...
    public void xUnsupportedOperationExceptionQTest3() throws Fault {
        try {
            ...
            try {
                ...
                logMsg("Got expected UnsupportedOperationException from MessageProducer.send(Destination, Message)");
            } catch (Exception e) {
                logErr("Error: MessageProducer.send(Destination, Message) throw incorrect Exception: ", e);
                pass = false;
            }
    ...
    public void xInvalidDestinationExceptionQTests() throws Fault {
        ...
        try {
            ...
            try {
                ...
                logErr("Error: createConsumer(null) didn't throw expected InvalidDestinationException");
                pass = false;
            } catch (InvalidDestinationException ex) {
                logMsg("Got expected InvalidDestinationException from createConsumer(null)");
            } catch (Exception e) {
            ...
            try {
                ...
                logErr("Error: createConsumer(null, String) didn't throw expected InvalidDestinationException");
                pass = false;
            } catch (InvalidDestinationException ex) {
                logMsg("Got expected InvalidDestinationException from createConsumer(null, String)");
            } catch (Exception e) {
                logErr("Error: createConsumer(null, String) throw incorrect Exception: ", e);
                pass = false;
            }
            ...
            try {
                ...
                logMsg("Got expected InvalidDestinationException from createConsumer(null, String, true)");
            } catch (Exception e) {
                logErr("Error: createConsumer(null, String, true) throw incorrect Exception: ", e);
                pass = false;
            }

            try {
                tool.getDefaultSession().createBrowser(dummyQ);
                logErr("Error: createBrowser(null) didn't throw expected InvalidDestinationException");
                pass = false;
            } catch (InvalidDestinationException ex) {
                logMsg("Got expected InvalidDestinationException from createBrowser(null)");
            } catch (Exception e) {
            ...
            try {
                ...
                logErr("Error: createBrowser(null, String) didn't throw expected InvalidDestinationException");
                pass = false;
            } catch (InvalidDestinationException ex) {
                logMsg("Got expected InvalidDestinationException from createBrowser(null, String)");
            } catch (Exception e) {
                logErr("Error: createBrowser(null, String) throw incorrect Exception: ", e);
                pass = false;
            }
    ...
    public void xMessageNotReadableExceptionQBytesMsgTest() throws Fault {
        try {
            ...
            try {
                ...
                pass = false;
                TestUtil.logErr("Error: getBodyLength didn't throw Expected MessageNotReadableException!");
            } catch (MessageNotReadableException nr) {
                TestUtil.logTrace("getBodyLength threw Expected MessageNotReadableException!");
            } catch (Exception e) {
            ...
            try {
                ...
                pass = false;
                TestUtil.logErr("Error: readBoolean didn't throw Expected MessageNotReadableException!");
            } catch (MessageNotReadableException nr) {
                TestUtil.logTrace("readBoolean threw Expected MessageNotReadableException!");
            } catch (Exception e) {
            ...
            try {
                ...
                pass = false;
                TestUtil.logErr("Error: readByte didn't throw Expected MessageNotReadableException!");
            } catch (MessageNotReadableException nr) {
                TestUtil.logTrace("readByte threw Expected MessageNotReadableException!");
            } catch (Exception e) {
            ...
            try {
                ...
                pass = false;
                TestUtil.logErr("Error: readUnsignedByte didn't throw Expected MessageNotReadableException!");
            } catch (MessageNotReadableException nr) {
                TestUtil.logTrace("readUnsignedByte threw Expected MessageNotReadableException!");
            } catch (Exception e) {
            ...
            try {
                ...
                pass = false;
                TestUtil.logErr("Error: readShort didn't throw Expected MessageNotReadableException!");
            } catch (MessageNotReadableException nr) {
                TestUtil.logTrace("readShort threw Expected MessageNotReadableException!");
            } catch (Exception e) {
            ...
            try {
                ...
                pass = false;
                TestUtil.logErr("Error: readUnsignedShort didn't throw Expected MessageNotReadableException!");
            } catch (MessageNotReadableException nr) {
                TestUtil.logTrace("readUnsignedShort threw Expected MessageNotReadableException!");
            } catch (Exception e) {
            ...
            try {
                ...
                pass = false;
                TestUtil.logErr("Error: readChar didn't throw Expected MessageNotReadableException!");
            } catch (MessageNotReadableException nr) {
                TestUtil.logTrace("readChar threw Expected MessageNotReadableException!");
            } catch (Exception e) {
            ...
            try {
                messageSent.readInt();
                pass = false;
                TestUtil.logErr("Error: readInt didn't throw Expected MessageNotReadableException!");
            } catch (MessageNotReadableException nr) {
                TestUtil.logTrace("readInt threw Expected MessageNotReadableException!");
            } catch (Exception e) {
            ...
            try {
                ...
                pass = false;
                TestUtil.logErr("Error: readLong didn't throw Expected MessageNotReadableException!");
            } catch (MessageNotReadableException nr) {
                TestUtil.logTrace("readLong threw Expected MessageNotReadableException!");
            } catch (Exception e) {
            ...
            try {
                ...
                pass = false;
                TestUtil.logErr("Error: readFloat didn't throw Expected MessageNotReadableException!");
            } catch (MessageNotReadableException nr) {
                TestUtil.logTrace("readFloat threw Expected MessageNotReadableException!");
            } catch (Exception e) {
            ...
            try {
                ...
                pass = false;
                TestUtil.logErr("Error: readDouble didn't throw Expected MessageNotReadableException!");
            } catch (MessageNotReadableException nr) {
                TestUtil.logTrace("readDouble threw Expected MessageNotReadableException!");
            } catch (Exception e) {
            ...
            try {
                messageSent.readUTF();
                pass = false;
                TestUtil.logErr("Error: readUTF didn't throw Expected MessageNotReadableException!");
            } catch (MessageNotReadableException nr) {
                TestUtil.logTrace("readUTF threw Expected MessageNotReadableException!");
            } catch (Exception e) {
            ...
            try {
                ...
                pass = false;
                TestUtil.logErr("Error: readBytes(byte[]) didn't throw Expected MessageNotReadableException!");
            } catch (MessageNotReadableException nr) {
                TestUtil.logTrace("readBytes(byte[]) threw Expected MessageNotReadableException!");
            } catch (Exception e) {
            ...
            try {
                ...
                pass = false;
                TestUtil.logErr("Error: readBytes(byte[], int) didn't throw Expected MessageNotReadableException!");
            } catch (MessageNotReadableException nr) {
                TestUtil.logTrace("readBytes(byte[], int) threw Expected MessageNotReadableException!");
            } catch (Exception e) {
    ...
    public void xMessageNotReadableExceptionQStreamMsgTest() throws Fault {
        try {
            ...
            try {
                messageReceived.readString();
                pass = false;
                TestUtil.logErr("Error: readString didn't throw Expected MessageNotReadableException!");
            } catch (MessageNotReadableException nr) {
                TestUtil.logTrace("readString threw Expected MessageNotReadableException!");
            } catch (Exception e) {
            ...
            try {
                ...
                pass = false;
                TestUtil.logErr("Error: readObject didn't throw Expected MessageNotReadableException!");
            } catch (MessageNotReadableException nr) {
                TestUtil.logTrace("readObject threw Expected MessageNotReadableException!");
            } catch (Exception e) {
    ...
    public void xIllegalStateExceptionTestTopicMethodsQ() throws Fault {
        ...
        try {
            ...
            try {
                ...
                pass = false;
                TestUtil.logErr("Error: QueueSession.createDurableSubscriber(Topic, String) "
            ...
            try {
                ...
                pass = false;
                TestUtil.logErr("Error: QueueSession.createDurableSubscriber(Topic, String, String, boolean) "
                        + "didn't throw expected IllegalStateException.");
            } catch (jakarta.jms.IllegalStateException ex) {
            ...
            try {
                ...
                TestUtil.logMsg("Got expected IllegalStateException from QueueSession.createTemporayTopic()");
            } catch (Exception e) {
                TestUtil.logErr("Error: QueueSession.createTemporayTopic() throw incorrect Exception: ", e);
                pass = false;
            }
            ...
            try {
                ...
                pass = false;
                TestUtil.logErr("Error: QueueSession.createTopic(String) didn't throw expected IllegalStateException.");
            } catch (jakarta.jms.IllegalStateException ex) {
                TestUtil.logMsg("Got expected IllegalStateException from QueueSession.createTopic(String)");
            } catch (Exception e) {
                TestUtil.logErr("Error: QueueSession.createTopic(String) throw incorrect Exception: ", e);
                pass = false;
            }
            ...
            try {
                ...
                pass = false;
                TestUtil.logErr("Error: QueueSession.unsubscribe(String) didn't throw expected IllegalStateException.");
            } catch (jakarta.jms.IllegalStateException ex) {
                TestUtil.logMsg("Got expected IllegalStateException from QueueSession.unsubscribe(String)");
            } catch (Exception e) {
                TestUtil.logErr("Error: QueueSession.unsubscribe(String) throw incorrect Exception: ", e);
                pass = false;
            }
    ...
    public void xIllegalStateExceptionTestRollbackQ() throws Fault {
        ...
        try {
            ...
            try {
                logTrace("Rolling back a non-transacted session must throw IllegalStateException");
                tool.getDefaultSession().rollback();
                pass = false;
                TestUtil.logErr("Error: QueueSession.rollback() didn't throw expected IllegalStateException");

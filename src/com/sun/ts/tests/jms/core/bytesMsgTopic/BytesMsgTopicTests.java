...
public class BytesMsgTopicTests extends ServiceEETest {
    ...
    public void bytesMsgNullStreamTopicTest() throws Fault {
        ...
        try {
            ...
            // BytesMessage
            try {
                logMsg("Writing a null stream to byte message should throw a NullPointerException");
                ...
                logMsg("Fail: message did not throw NullPointerException exception as expected");
                pass = false;
     ...
     * JMS:JAVADOC:713;
     *
     * @test_Strategy: Create a BytesMessage - send it to a Topic. Write to the received message using each type of method

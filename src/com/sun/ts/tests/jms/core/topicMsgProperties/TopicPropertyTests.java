...
public class TopicPropertyTests extends ServiceEETest {
     ...
     * one default TopicConnection, as well as a default Topic. Tests that require multiple Destinations create the extras
     * within the test
     *
     *
     ...
     * JMS:SPEC:27; JMS:SPEC:28; JMS:SPEC:29; JMS:SPEC:31; JMS:SPEC:32; JMS:SPEC:19; JMS:SPEC:70; JMS:SPEC:71;
     ...
     *
     * Call ConnectionMetaData.getJMSXPropertyNames() and verify that the names of the required JMSX properties for
     * JMSXGroupID and JMSXGroupSeq are returned.
     */
    ...
    public void msgPropertiesTopicTest() throws Fault {
        ...
        try {
            ...
            try {
                ...
                TestUtil.logTrace("      MessageFormatException as expected from invalid setObjectProperty call");
            } catch (Exception ee) {
            ...
            try {
                ...
                TestUtil.logMsg("Error: exception should have occurred for setBooleanProperty");
                pass = false;
            } catch (MessageNotWriteableException aBool) {
                TestUtil.logTrace("Pass: exception as expected for setBooleanProperty ");
            }
            try {
                messageReceived.setByteProperty("TESTBYTE", bValue);
                TestUtil.logMsg("Error: exception should have occurred for setByteProperty");
                pass = false;
            } catch (MessageNotWriteableException aBool) {
            ...
            try {
                ...
                pass = false;
                TestUtil.logMsg("Error: exception should have occurred for setShortProperty");
            } catch (MessageNotWriteableException aBool) {
                TestUtil.logTrace("Pass: exception as expected for setShortProperty ");
            }
            try {
                messageReceived.setIntProperty("TESTINT", nInt);
                TestUtil.logMsg("Error: exception should have occurred for setIntProperty");
                pass = false;
            } catch (MessageNotWriteableException aBool) {
            ...
            try {
                ...
                TestUtil.logMsg("Error: exception should have occurred for setFloatProperty");
                pass = false;
            } catch (MessageNotWriteableException aBool) {
            ...
            try {
                ...
                TestUtil.logMsg("Error: exception should have occurred for setDoubleProperty");
                pass = false;
            } catch (MessageNotWriteableException aBool) {
            ...
            try {
                ...
                TestUtil.logMsg("Error: exception should have occurred for setStringProperty");
                pass = false;
            } catch (MessageNotWriteableException aBool) {
            ...
            try {
                ...
                TestUtil.logMsg("Error: exception should have occurred for setLongProperty");
                pass = false;
            } catch (MessageNotWriteableException aBool) {
            ...
            try {
                ...
                TestUtil.logMsg("Error: exception should have occurred for setObjectProperty");
                pass = false;
            } catch (MessageNotWriteableException aBool) {
            ...
            if (i == numPropertyNames) {
                TestUtil.logTrace("Pass: # of properties is " + numPropertyNames + " as expected");
            } else {
                TestUtil.logMsg("Error: expected " + numPropertyNames + " property names, but got " + i);
                pass = false;
            }
            ...
            if (messageReceived.getBooleanProperty("TESTBOOLEAN") == bool) {
                ...
                TestUtil.logMsg("Error: incorrect value returned from getBooleanProperty");
                pass = false;
            }
            ...
            if (messageReceived.getShortProperty("TESTSHORT") == nShort) {
                ...
                TestUtil.logMsg("Error: incorrect value returned from getShortProperty");
                pass = false;
            }
            ...
            try {
                ...
                if (b != false) {
                    TestUtil.logMsg("Error: should havereceived false for getBooleanProperty");
                    pass = false;
                }
            } catch (Exception e) {
            ...
            try {
                ...
                TestUtil.logMsg("Error: NumberFormatException should have occurred for getByteProperty");
                pass = false;
            ...
            try {
                ...
                TestUtil.logMsg("Error: NumberFormatException should have occurred for getShortProperty");
                pass = false;
            ...
            try {
                ...
                TestUtil.logMsg("Error: NumberFormatException should have occurred for getIntProperty");
                pass = false;
            } catch (java.lang.NumberFormatException np) {
                TestUtil.logTrace("Pass:NumberFormatException as expected ");
            }
            try {
                ...
                TestUtil.logMsg("Error: NumberFormatException should have occurred for getLongProperty");
                pass = false;
            } catch (java.lang.NumberFormatException np) {
                TestUtil.logTrace("Pass: NumberFormatException as expected ");
            }
            try {
                ...
                TestUtil.logMsg("Error: NullPointerException should have occurred for getFloatProperty");
                pass = false;
            ...
            try {
                ...
                TestUtil.logMsg("Error: NullPointerException should have occurred for getDoubleProperty");
                pass = false;
            } catch (java.lang.NullPointerException np) {
                TestUtil.logTrace("Pass: NullPointerException as expected ");
            }
            ...
            if (value == null) {
                ...
                TestUtil.logMsg("Error: expected a null return from getStringProperty for invalid property");
                pass = false;
            }
            Boolean aBool = (Boolean) messageReceived.getObjectProperty("TESTDUMMY");

            if (aBool == null) {
                TestUtil.logTrace("Pass: getObjectProperty returned correct value for Boolean");
            } else {
                TestUtil.logMsg("Error: expected a null return from getObjectProperty for invalid property");
                pass = false;
            }
            ...
            if (byteValue.byteValue() == bValue) {
                TestUtil.logTrace("Pass: getObjectProperty returned correct Byte value");
            } else {
            ...
            if (lValue.longValue() == nLong) {
                TestUtil.logTrace("Pass: getObjectProperty returned correct value for Long");
            } else {
                TestUtil.logMsg("Error: getObjectProperty returned incorrect value returned for Long");
                pass = false;
            }
            ...
            if (messageReceived.getObjectProperty("OBJTESTSTRING").equals(testString)) {
                TestUtil.logTrace("Pass: getObjectProperty returned correct value for String");
            } else {
                TestUtil.logMsg("Error: getObjectProperty returned incorrect value for String");
                pass = false;
            }
            Double dValue = (Double) messageReceived.getObjectProperty("OBJTESTDOUBLE");

            if (dValue.doubleValue() == nDouble) {
                TestUtil.logTrace("Pass: getObjectProperty returned correct value for Double");
            } else {
                TestUtil.logMsg("Error: getObjectProperty returned incorrect value for Double");
                pass = false;
            }
            Float fValue = (Float) messageReceived.getObjectProperty("OBJTESTFLOAT");

            if (fValue.floatValue() == nFloat) {
                TestUtil.logTrace("Pass: getObjectProperty returned correct value for Float");
            } else {
                TestUtil.logMsg("Error: getObjectProperty returned incorrect value for Float");
                pass = false;
            }
            Integer iValue = (Integer) messageReceived.getObjectProperty("OBJTESTINT");

            if (iValue.intValue() == nInt) {
                TestUtil.logTrace("Pass: getObjectProperty returned correct value for Integer");
            } else {
                TestUtil.logMsg("Error: getObjectProperty returned incorrect value for Integer");
                pass = false;
            }
            Short sValue = (Short) messageReceived.getObjectProperty("OBJTESTSHORT");

            if (sValue.shortValue() == nShort) {
                TestUtil.logTrace("Pass: getObjectProperty returned correct value for Short");
            } else {
                TestUtil.logMsg("Error: getObjectProperty returned incorrect value for Short");
                pass = false;
            }
            ...
            if (aLong == null) {
                ...
                TestUtil.logMsg("Error: getObjectProperty should have returned null for cleared property");
                pass = false;
            }
            try {
            ...
            if (messageReceived.getText().equals(testMessageBody)) {
                TestUtil.logTrace("Pass: able to read message body after clearProperties");
            } else {
                TestUtil.logMsg("Error: unable to read message body after clearProperties");
                pass = false;
            }
            ...
            try {
                ...
                if (cmd == null) {
                    ...
                    TestUtil.logMsg("expected JMSXGroupID, JMSXGroupSeq, JMSXDeliveryCount at a miniumum");
                    pass = false;
                } else {
                    int iCount = 0;
     ...
     * JMS:SPEC:22.14; JMS:SPEC:22.15; JMS:SPEC:22.16; JMS:JAVADOC:391; JMS:JAVADOC:393; JMS:JAVADOC:395; JMS:JAVADOC:397;
     * JMS:JAVADOC:399; JMS:JAVADOC:401; JMS:JAVADOC:403; JMS:JAVADOC:405; JMS:JAVADOC:407; JMS:JAVADOC:767;
     * JMS:JAVADOC:768; JMS:JAVADOC:769; JMS:JAVADOC:770; JMS:JAVADOC:771; JMS:JAVADOC:772; JMS:JAVADOC:773;
     * JMS:JAVADOC:774;
     *
     *
     *
    ...
    public void msgPropertiesConversionTopicTest() throws Fault {
        ...
        try {
            ...
            try {
                ...
                TestUtil.logMsg("Error: MessageFormatException should have occurred for type conversion error");
                ...
                TestUtil.logErr("Error: unexpected error ", ee);
                TestUtil.logErr("Error: did not catch expected MessageFormatException -- boolean to byte");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logErr("Error: unexpected error ", ee);
                TestUtil.logErr("Error: did not catch expected MessageFormatException -- boolean to short");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logErr("Error: unexpected error ", ee);
                TestUtil.logErr("Error: did not catch expected MessageFormatException --boolean to int ");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logErr("Error: unexpected error ", ee);
                TestUtil.logErr("Error: did not catch expected MessageFormatException -- boolean to long");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logErr("Error: unexpected error ", ee);
                TestUtil.logErr("Error: did not catch expected MessageFormatException -- boolean to float");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logErr("Error: unexpected error ", ee);
                TestUtil.logErr("Error: did not catch expected MessageFormatException -- boolean to double");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logErr("Error: unexpected error ", ee);
                TestUtil.logErr("Error: did not catch expected MessageFormatException -- byte to boolean");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logErr("Error: unexpected error ", ee);
                TestUtil.logErr("Error: did not catch expected MessageFormatException --byte to float ");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logErr("Error: unexpected error ", ee);
                TestUtil.logErr("Error: did not catch expected MessageFormatException -- byte to double");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logErr("Error: unexpected error ", ee);
                TestUtil.logErr("Error: did not catch expected MessageFormatException -- short to boolean");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logErr("Error: unexpected error ", ee);
                TestUtil.logErr("Error: did not catch expected MessageFormatException -- short to byte");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logErr("Error: unexpected error ", ee);
                TestUtil.logErr("Error: did not catch expected MessageFormatException -- short to float");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logErr("Error: unexpected error ", ee);
                TestUtil.logErr("Error: did not catch expected MessageFormatException -- short to double");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logErr("Error: unexpected error ", ee);
                TestUtil.logErr("Error: did not catch expected MessageFormatException -- int to boolean");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logErr("Error: unexpected error ", ee);
                TestUtil.logErr("Error: did not catch expected MessageFormatException --  int to byte");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logTrace("Pass: MessageFormatException as expected -- int to short ");
            } catch (Exception ee) {
                TestUtil.logErr("Error: unexpected error ", ee);
                TestUtil.logErr("Error: did not catch expected MessageFormatException ");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logErr("Error: unexpected error ", ee);
                TestUtil.logErr("Error: did not catch expected MessageFormatException -- int to float");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logErr("Error: unexpected error ", ee);
                TestUtil.logErr("Error: did not catch expected MessageFormatException -- int to double");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logErr("Error: unexpected error ", ee);
                TestUtil.logErr("Error: did not catch expected MessageFormatException -- long to boolean");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logErr("Error: unexpected error ", ee);
                TestUtil.logErr("Error: did not catch expected MessageFormatException -- long to byte");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logErr("Error: unexpected error ", ee);
                TestUtil.logErr("Error: did not catch expected MessageFormatException -- long to short ");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logErr("Error: unexpected error ", ee);
                TestUtil.logErr("Error: did not catch expected MessageFormatException -- long to int");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logErr("Error: unexpected error ", ee);
                TestUtil.logErr("Error: did not catch expected MessageFormatException -- long to float");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logErr("Error: unexpected error ", ee);
                TestUtil.logErr("Error: did not catch expected Exception -- long to double");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logErr("Error: unexpected error ", ee);
                TestUtil.logErr("Error: did not catch expected MessageFormatException -- float to boolean ");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logErr("Error: unexpected error ", ee);
                TestUtil.logErr("Error: did not catch expected MessageFormatException -- float to byte");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logErr("Error: unexpected error ", ee);
                TestUtil.logErr("Error: did not catch expected MessageFormatException - float to short ");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logErr("Error: unexpected error ", ee);
                TestUtil.logErr("Error: did not catch expected MessageFormatException --- float to int");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logErr("Error: unexpected error ", ee);
                TestUtil.logErr("Error: did not catch expected MessageFormatException --  float to long");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logErr("Error: unexpected error ", ee);
                TestUtil.logErr("Error: did not catch expected MessageFormatException -- double to boolean ");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logErr("Error: unexpected error ", ee);
                TestUtil.logErr("Error: did not catch expected MessageFormatException -- double to byte ");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logErr("Error: unexpected error ", ee);
                TestUtil.logErr("Error: did not catch expected MessageFormatException -- double to short");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logErr("Error: did not catch expected MessageFormatException --- double to int ");
                TestUtil.logErr("Error: unexpected error ", ee);
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logErr("Error: unexpected error ", ee);
                TestUtil.logErr("Error: did not catch expected MessageFormatException -- double to long");
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logErr("Error: unexpected error ", ee);
                TestUtil.logErr("Error: did not catch expected MessageFormatException -- double to float");
                pass = false;
            }
            ...
            if ((messageReceived.getBooleanProperty("TESTSTRINGTRUE")) == true) {
                TestUtil.logTrace("Pass: conversion from string to boolean - expect true - ok");
            } else {
                TestUtil.logErr("Error: conversion from string to boolean - expect true  - failed");
                pass = false;
            }
            if ((messageReceived.getBooleanProperty("TESTSTRINGFALSE")) == false) {
                TestUtil.logTrace("Pass: conversion from string to boolean expect false - ok");
            } else {
                TestUtil.logErr("Error: conversion from string to boolean expect false - failed");
                pass = false;
            }
            ...
            if (!pass) {
                throw new Fault("Error: failures occurred during property conversion tests");
            }
        } catch (Exception e) {
            TestUtil.printStackTrace(e);
     ...
     *
     * @test_Strategy: Set and read properties JMSXGroupID and JMSXGroupSeq. Verify the value of the properties JMSXGroupID
     * and JMSXGroupSeq are the same as set by client.
     */

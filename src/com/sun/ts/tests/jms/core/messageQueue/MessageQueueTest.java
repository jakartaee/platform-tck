...
public class MessageQueueTest extends ServiceEETest {
    ...
    public void msgClearBodyQueueTest() throws Fault {
        ...
        try {
            ...
            messageReceivedBytesMessage =
                    (BytesMessage) tool.getDefaultQueueReceiver().receive(timeout);
            try {
                ...
                logTrace("Bytes message body should now be empty and in writeonly mode");
                try {
                    ...
                    if (e instanceof jakarta.jms.MessageNotReadableException) {
                        ...
                        logMsg("Error: Unexpected exception " + e.getClass().getName() + " was thrown");
                        pass = false;
                    }
                }
            ...
            messageReceivedStreamMessage =
                    (StreamMessage) tool.getDefaultQueueReceiver().receive(timeout);
            try {
                ...
                logTrace("Stream message body should now be empty and in writeonly mode");
                try {
                ...
                if (messageReceivedStreamMessage
                        .getStringProperty("COM_SUN_JMS_TESTNAME")
                        .equals("msgClearBodyQueueTest")) {
                    logTrace("Pass: Stream msg properties read ok after clearBody called");
                } else {
    ...
    public void msgResetQueueTest() throws Fault {
        ...
        try {
            ...
            try {
                ...
                logMsg("Fail: message did not throw MessageNotWriteable exception as expected");
                pass = false;
    ...
    public void readNullCharNotValidQueueTest() throws Fault {
        try {
            ...
            // Stream Message
            // -----------------------------------------------------------------------------
            logTrace("Write a null string to the stream message object with StreamMessage.writeString");
            ...
            logTrace("Write a null string to the map message object with mapMessage.setString");

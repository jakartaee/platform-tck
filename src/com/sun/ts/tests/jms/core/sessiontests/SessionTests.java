...
public class SessionTests extends ServiceEETest {
    ...
    public void selectorAndBrowserTests() throws Fault {
        ...
        try {
            ...
            if (!browseAll
                ...
                logErr("QueueBrowser.getQueue=" + browseAll.getQueue().toString() + ".");
            ...
            if (tmp.indexOf("TEST") < 0 || tmp.indexOf("test") < 0) {
                ...
                logErr("selectiveBrowser.getMessageSelector()=" + selectiveBrowser.getMessageSelector());
            }
    ...
    public void SubscriberTests() throws Fault {
        ...
        try {
            ...
            try {
                ...
                logErr("Error closing subscribers and unsubscribing from subscriptions", ex);
            }
            try {
    ...
    public void IllegalStateTestQ() throws Fault {
        ...
        try {
            ...
            try {
                ...
                pass = false;
                logErr("Error: QueueSession.rollback() didn't throw expected IllegalStateException");
    ...
    public void InvalidDestinationTests() throws Fault {
        ...
        try {
            ...
            try {
                ...
                logErr("Error: unsubscribe(foo) didn't throw expected InvalidDestinationException");
                pass = false;
            } catch (InvalidDestinationException ex) {
                logMsg("Got expected InvalidDestinationException from unsubscribe(foo)");
            } catch (Exception e) {
            ...
            try {
                ...
                logMsg("Got expected InvalidDestinationException from createDurableSubscriber(null, String)");
            } catch (Exception e) {
                logErr("Error: createDurableSubscriber(null, String) throw incorrect Exception: ", e);
                pass = false;
            }
            ...
            try {
                ...
                logErr("Error: createDurableSubscriber(null, String, String, boolean) throw incorrect Exception: ", e);
                pass = false;
            }
    ...
    public void InvalidSelectorTests() throws Fault {
        ...
        try {
            ...
            try {
                tool.getDefaultSession().createConsumer(tool.getDefaultDestination(), "=TEST 'test'");
                logErr("Error: createConsumer(Destination, String) didn't throw expected InvalidSelectorException");
                pass = false;
            } catch (InvalidSelectorException ex) {
                logMsg("Got expected InvalidSelectorException from createConsumer(Destination, String)");
            } catch (Exception e) {
                logErr("Error: createConsumer(Destination, String) throw incorrect Exception: ", e);
                pass = false;
            }

            try {
                tool.getDefaultSession().createBrowser((Queue) tool.getDefaultDestination(), "=TEST 'test'");
                logErr("Error: createBrowser(Queue, String) didn't throw expected InvalidSelectorException");
                pass = false;
            } catch (InvalidSelectorException ex) {
                logMsg("Got expected InvalidSelectorException from createBrowser(Queue, String)");
            } catch (Exception e) {
                logErr("Error: createBrowser(Queue, String) throw incorrect Exception: ", e);
                pass = false;
            }
            ...
            try {
                TopicSubscriber tsub = newSess.createDurableSubscriber(
                        (Topic) tool.getDefaultDestination(), "mysubscription", "=TEST 'test'", true);
                ...
                logErr(
                        "Error: createDurableSubscriber(Topic, String, String, boolean) "
            ...
            try {
                ...
                logMsg("Got expected InvalidSelectorException from createConsumer(Destination, String, boolean)");
            } catch (Exception e) {
                logErr("Error: createConsumer(Destination, String, boolean) throw incorrect Exception: ", e);
                pass = false;
            }

    ...
    public void msgPropertiesQTest() throws Fault {
        ...
        try {
            ...
            try {
                ...
                logTrace("Pass: ");
                logTrace("      MessageFormatException as expected from invalid setObjectProperty call");
            } catch (Exception ee) {
            ...
            if (i == numPropertyNames) {
                logTrace("Pass: # of properties is " + numPropertyNames + " as expected");
            } else {
                logMsg("Error: expected " + numPropertyNames + " property names, but returned " + i);
                pass = false;
            }
            ...
            try {
                ...
                logMsg("Error: NumberFormatException should have occurred for getByteProperty");
                pass = false;
            ...
            try {
                ...
                logMsg("Error: NumberFormatException should have occurred for getShortProperty");
                pass = false;
            } catch (java.lang.NumberFormatException np) {
                logTrace("Pass: NumberFormatException as expected ");
            }
            try {
                ...
                logMsg("Error: NumberFormatException should have occurred for getIntProperty");
                pass = false;
            } catch (java.lang.NumberFormatException np) {
                logTrace("Pass: NumberFormatException as expected ");
            }
            try {
                ...
                logMsg("Error: NumberFormatException should have occurred for getLongProperty");
                pass = false;
            } catch (java.lang.NumberFormatException np) {
                logTrace("Pass: NumberFormatException as expected ");
            }
            ...
            if (value == null) {
                ...
                logMsg("Error: expected a null return from getStringProperty for invalid property");
                pass = false;
            }
            ...
            if (aBool == null) {
                ...
                logMsg("Error: expected a null return from getObjectProperty for invalid property");
                pass = false;
            }
            ...
            if (lValue.longValue() == nLong) {
                ...
                logMsg("Error: getObjectProperty returned incorrect value returned for Long");
                pass = false;
            }
            ...
            if (aLong == null) {
                ...
                logMsg("Error: getObjectProperty should have returned null for cleared property");
                pass = false;
            }
            try {
            ...
            try {
                ...
                logMsg("Error: unexpected exception: " + ee.getClass().getName() + " was thrown");
                pass = false;
            }
            if (!pass) {
    ...
    public void msgPropertiesConversionQTest() throws Fault {
        ...
        try {
            ...
            try {
                ...
                logMsg("Error: MessageFormatException should have occurred for type conversion error");
            ...
            if ((messageReceived.getBooleanProperty("TESTSTRINGTRUE")) == true) {
                ...
                logMsg("Error: conversion from string to boolean - expect true  - failed");
                pass = false;
            }
            if ((messageReceived.getBooleanProperty("TESTSTRINGFALSE")) == false) {
                ...
                logMsg("Error: conversion from string to boolean expect false - failed");
                pass = false;
            }

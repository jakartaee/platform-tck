...
public class TxTopicTests extends ServiceEETest {
    ...
    public void transactionRollbackOnRecTopicTest() throws Fault {
        ...
        try {
            ...
            logTrace("Since the receive was not committed, I expect the message to still be there");
            ...
            if (messageReceived.getText().equals(messageReceived2.getText())) {
                ...
                throw new Fault("Did not receive expected message after not doing the commit");
            }
        } catch (Exception e) {
            TestUtil.printStackTrace(e);

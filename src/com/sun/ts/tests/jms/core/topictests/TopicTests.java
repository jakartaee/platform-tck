...
public class TopicTests extends ServiceEETest {
    ...
    public void inactiveNonDurableSubscriberTopicRecTest() throws Fault {
        ...
        try {
            ...
            newTConn.start();
            TestUtil.logTrace("Try to receive second message (should not receive a message)");
            messageReceived = (TextMessage) tSub.receive(timeout);
    ...
    public void simpleDurableSubscriberTopicTest() throws Fault {
        ...
        try {
            ...
            durableTS = tool.getDefaultTopicSession()
                    .createDurableSubscriber(tool.getDefaultTopic(), "myDurableTopicSubscriber");
    ...
    public void inactiveDurableSubscriberTopicRecTest() throws Fault {
        ...
        try {
            ...
            tool.getDefaultTopicSubscriber().close();
            durableTS = tool.getDefaultTopicSession()
                    .createDurableSubscriber(tool.getDefaultTopic(), "inactiveDurableSubscriberTopicRecTest");
    ...
    public void durableSubscriberTopicNoLocalTest() throws Fault {
        ...
        try {
            ...
            tSubNoLocal = tool.getDefaultTopicSession()
                    .createDurableSubscriber(tool.getDefaultTopic(), subscriptionName, "", true);
            tool.getDefaultTopicConnection().start();
    ...
    public void durableSubscriberTopicNoLocalTest2() throws Fault {
        ...
        try {
            ...
            // messages)
            TestUtil.logMsg("Attempting to receive messages from (no_local=true) subscriber");
            messageReceived = tSubNoLocal.receive(timeout);
            if (messageReceived == null) {
            ...
            tSubNoLocal = tool.getDefaultTopicSession()
                    .createDurableSubscriber(tool.getDefaultTopic(), subscriptionName, "", false);
            ...
            messageReceived = tSubNoLocal.receive(timeout);
            if (messageReceived == null) {
                TestUtil.logMsg("No_local=false subscriber did not receive any message (expected)");
            } else {
                throw new Fault("No_local=false subscriber received message (unexpected)");
            }
            ...
            // messages)
            TestUtil.logMsg("Attempting to receive messages from (no_local=false) subscriber");
            for (int i = 0; i < num; i++) {
                messageReceived = tSubNoLocal.receive(timeout);
                if (messageReceived == null) {
                    throw new Fault("Should have received message");
    ...
    public void durableSubscriberNewTopicTest() throws Fault {
        ...
        try {
            ...
            tool.getDefaultTopicSubscriber().close();
            durableTS = tool.getDefaultTopicSession()
                    .createDurableSubscriber(tool.getDefaultTopic(), "durableSubscriberNewTopicTest");
            ...
            durableTS = tool.getDefaultTopicSession()
                    .createDurableSubscriber(newTestTopic, "durableSubscriberNewTopicTest");
        ...
        try {
            ...
            durableTS = tool.getDefaultTopicSession()
                    .createDurableSubscriber(
                            tool.getDefaultTopic(), "durableSubscriberChangeSelectorTest", "TEST = 'test'", false);
            ...
            durableTS = tool.getDefaultTopicSession()
                    .createDurableSubscriber(
                            tool.getDefaultTopic(), "durableSubscriberChangeSelectorTest", "TEST = 'new one'", false);
    ...
    public void durableSubscriberChangeSelectorTest2() throws Fault {
        ...
        try {
            ...
            TestUtil.logTrace("Create durable subscription with MessageSelector=\"TEST='test'\",");
            TestUtil.logTrace("TopicName=" + tool.getDefaultTopic().getTopicName() + " and SubscriptionName="
                    + "durableSubscriberChangeSelectorTest2");
            // Create a durable subscriber with a selector specified.
            durableTS = tool.getDefaultTopicSession()
                    .createDurableSubscriber(
                            tool.getDefaultTopic(), "durableSubscriberChangeSelectorTest2", "TEST = 'test'", false);

            // start Connection and send/receive message
            tool.getDefaultTopicConnection().start();

            TestUtil.logTrace("Create/Send first message with string property \"TEST = 'test'\"");
            messageSent = tool.getDefaultTopicSession().createTextMessage();
            messageSent.setStringProperty("TEST", "test");
            ...
            TestUtil.logTrace("Create/Send second message with string property \"TEST = 'test again'\"");
            messageSent2 = tool.getDefaultTopicSession().createTextMessage();
            ...
            TestUtil.logTrace("Try receiving second message (should not get message)");
            messageReceived = (TextMessage) durableTS.receive(timeout);
            if (messageReceived == null) {
            ...
            // change selector
            TestUtil.logTrace("Create new durable subscription with MessageSelector=\"TEST='test again'\",");
            TestUtil.logTrace("TopicName=" + tool.getDefaultTopic().getTopicName() + " and SubscriptionName="
                    + "durableSubscriberChangeSelectorTest2");
            durableTS = tool.getDefaultTopicSession()
                    .createDurableSubscriber(
    ...
    public void msgProducerNullDestinationTopicTest() throws Fault {
        ...
        try {
            ...
            if (!pass) {
                throw new Fault("Error: failures occurred during msgProducerNullDestinationTopicTest tests");
            }
        } catch (Exception e) {
    ...
    public void consumerTests() throws Fault {
        ...
        try {
            ...
            if (messageReceived != null) {
                pass = false;
                TestUtil.logErr("Error:  No_local MessageConsumer did receive local message");
            }

...
public class MapMsgQueueTests extends ServiceEETest {
     ...
     *
     * @assertion_ids: JMS:SPEC:74; JMS:SPEC:80; JMS:JAVADOC:211; JMS:JAVADOC:457; JMS:JAVADOC:459; JMS:JAVADOC:475;
     * JMS:JAVADOC:477; JMS:JAVADOC:479; JMS:JAVADOC:461; JMS:JAVADOC:463; JMS:JAVADOC:465; JMS:JAVADOC:467;
     * JMS:JAVADOC:469; JMS:JAVADOC:471; JMS:JAVADOC:473; JMS:JAVADOC:433; JMS:JAVADOC:435; JMS:JAVADOC:437;
     * JMS:JAVADOC:439; JMS:JAVADOC:441; JMS:JAVADOC:443; JMS:JAVADOC:445; JMS:JAVADOC:447; JMS:JAVADOC:449;
     * JMS:JAVADOC:451; JMS:JAVADOC:453; JMS:JAVADOC:455; JMS:JAVADOC:481;
     *
     * @test_Strategy: Create a MapMessage write to the message using each type of methods:
     * setBoolean/Byte/Bytes/Bytes/Char/Double/Float and setInt/Long/Object/Short/String/String. Send the message. Verify on
     * receive tha all data was received correctly using: 1. getMapNames that all fields are intact; 2. ItemExists that all
     * fields are intact; 3. getBoolean/Byte/Bytes/Bytes/Char/Double/Float and getInt/Long/Object/Short/String/String that
     * that all fields contain correct values; 4. an unset field is treated as null field.
     */
        ...
        try {
            ...
            while (list.hasMoreElements()) {
                ...
                if (name.equals("booleanValue"))
                    ...
                    TestUtil.logTrace("Object not created by the test with name: " + name);
            }

            if ((it < 13) || (j < 13))
                TestUtil.logErr("Incorrect number of of Objects." + " Total number = " + it
     ...
     * JMS:JAVADOC:804;
     *
     * @test_Strategy: Create a MapMessage -. use MapMessage method setBoolean to write a boolean to the message. Verify the
    ...
    public void MapMessageConversionQTestsBoolean() throws Fault {
        try {
            ...
            // -----------------------------------------------------------------------------
            TestUtil.logTrace("Verify conversion support for boolean primitive type section 3.11.3");
            ...
            TestUtil.logTrace("Msg recvd: " + messageReceived.getStringProperty("COM_SUN_JMS_TESTNAME"));
            ...
            // -----------------------------------------------
            TestUtil.logMsg("--");
            TestUtil.logMsg("Use readBytes[] to read a boolean - expect MessageFormatException");
            int nCount = 0;
            ...
            // -----------------------------------------------
            TestUtil.logMsg("--");
            TestUtil.logMsg("Use readByte to read a boolean - expect MessageFormatException");
            try {
            ...
            // -----------------------------------------------
            TestUtil.logMsg("--");
            TestUtil.logMsg("Use readShort to read a boolean - expect MessageFormatException");
            try {
            ...
            // -----------------------------------------------
            TestUtil.logMsg("--");
            TestUtil.logMsg("Use readChar to read a boolean - expect MessageFormatException");
            try {
            ...
            // -----------------------------------------------
            TestUtil.logMsg("--");
            TestUtil.logMsg("Use readInt to read a boolean - expect MessageFormatException");
            try {
            ...
            // -----------------------------------------------
            TestUtil.logMsg("--");
            TestUtil.logMsg("Use readLong to read a boolean - expect MessageFormatException");
            try {
            ...
            // -----------------------------------------------
            TestUtil.logMsg("--");
            TestUtil.logMsg("Use readFloat to read a boolean - expect MessageFormatException");
            try {
            ...
            // -----------------------------------------------
            TestUtil.logMsg("--");
            TestUtil.logMsg("Use readDouble to read a boolean - expect MessageFormatException");
            try {
    ...
    public void MapMessageConversionQTestsByte() throws Fault {
        ...
        try {
            ...
            // -----------------------------------------------------------------------------
            TestUtil.logTrace("Verify conversion support for byte primitive type section 3.11.3");
            ...
            // -----------------------------------------------
            TestUtil.logMsg("--");
            TestUtil.logMsg("Use getBytes[] to read a byte - expect MessageFormatException");
            int nCount = 0;
     ...
     * JMS:JAVADOC:804;
     *
     * @test_Strategy: Create a MapMessage -. use MapMessage method setShort to write a short. Verify the proper conversion
     * support as in 3.11.3
     *
     */
    ...
    public void MapMessageConversionQTestsShort() throws Fault {
        try {
            ...
            // -----------------------------------------------
            TestUtil.logMsg("--");
            TestUtil.logMsg("Use getBytes[] to read a short - expect MessageFormatException");
            try {
     ...
     * JMS:JAVADOC:804;
     *
     * @test_Strategy: Create a MapMessage -. use MapMessage method setChar to write a char. Verify the proper conversion
     * support as in 3.11.3
     *
     */
    ...
    public void MapMessageConversionQTestsChar() throws Fault {
        try {
            ...
            // -----------------------------------------------
            TestUtil.logMsg("--");
            TestUtil.logMsg("Use getBytes[] to read a char - expect MessageFormatException");
            try {
     ...
     * JMS:JAVADOC:804;
     *
     * @test_Strategy: Create a MapMessage -. use MapMessage method setInt to write an int. Verify the proper conversion
     * support as in 3.11.3
     *
     */
    ...
    public void MapMessageConversionQTestsInt() throws Fault {
        try {
            ...
            // -----------------------------------------------
            TestUtil.logMsg("--");
            TestUtil.logMsg("Use getBytes[] to read an int - expect MessageFormatException");
            int nCount = 0;
     ...
     * JMS:JAVADOC:804;
     *
     * @test_Strategy: Create a MapMessage -. use MapMessage method setLong to write a long. Verify the proper conversion
     * support as in 3.11.3
     *
     */
    ...
    public void MapMessageConversionQTestsLong() throws Fault {
        try {
            ...
            // -----------------------------------------------
            TestUtil.logMsg("--");
            TestUtil.logMsg("Use getBytes[] to read  a long - expect MessageFormatException");
            try {
     ...
     * JMS:JAVADOC:804;
     *
     * @test_Strategy: Create a MapMessage -. use MapMessage method setFloat to write a float. Verify the proper conversion
     * support as in 3.11.3
     *
     */
     ...
     * JMS:JAVADOC:804;
     *
     * @test_Strategy: Create a MapMessage -. use MapMessage method setDouble to write a double. Verify the proper
     ...
     * JMS:JAVADOC:804;
     *
     * @test_Strategy: Create a MapMessage -. use MapMessage method setString to write a string. Verify the proper
     * conversion support as in 3.11.3
     *
     */
     ...
     * JMS:JAVADOC:803;
     *
     * @test_Strategy: Create a MapMessage -. use MapMessage method setBytes to write a byte[] to the message. Verify the
     * proper conversion support as in 3.11.3
     */
    ...
    public void MapMessageConversionQTestsBytes() throws Fault {
        try {
            ...
            try {
                ...
                TestUtil.logMsg("Fail: byte[] to boolean conversion should have thrown MessageFormatException");
                pass = false;
            } catch (MessageFormatException mf) {
                TestUtil.logTrace("Pass: MessageFormatException thrown as expected");
            } catch (Exception e) {
            ...
            // -----------------------------------------------
            TestUtil.logMsg("--");
            TestUtil.logMsg("Use getByte to read a byte[] - expect MessageFormatException");
            try {
            ...
            // -----------------------------------------------
            TestUtil.logMsg("--");
            TestUtil.logMsg("Use getShort to read a byte[] - expect MessageFormatException");
            try {
            ...
            // -----------------------------------------------
            TestUtil.logMsg("--");
            TestUtil.logMsg("Use getChar to read a byte[] - expect MessageFormatException");
            try {
            ...
            // -----------------------------------------------
            TestUtil.logMsg("--");
            TestUtil.logMsg("Use getInt to read a byte[] - expect MessageFormatException");
            try {
            ...
            // -----------------------------------------------
            TestUtil.logMsg("--");
            TestUtil.logMsg("Use getLong to read a byte[] - expect MessageFormatException");
            try {
            ...
            // -----------------------------------------------
            TestUtil.logMsg("--");
            TestUtil.logMsg("Use getFloat to read a byte[] - expect MessageFormatException");
            try {
            ...
            // -----------------------------------------------
            TestUtil.logMsg("--");
            TestUtil.logMsg("Use getDouble to read a byte[] - expect MessageFormatException");
            try {
     ...
     * JMS:JAVADOC:829;
     *
     * @test_Strategy: Create a MapMessage, send it to a Queue. Receive it and try to write to the received Message's body,
    ...
    public void mapMessageQNotWritable() throws Fault {
        try {
            ...
            try {
                ...
                TestUtil.logMsg("Got Expected MessageNotWriteableException with setBoolean");
            }
            ...
            try {
                ...
                TestUtil.logMsg("Got Expected MessageNotWriteableException with setByte");
            }
            ...
            try {
                ...
                TestUtil.logMsg("Got Expected MessageNotWriteableException with setShort");
            }
            ...
            try {
                ...
                TestUtil.logMsg("Got Expected MessageNotWriteableException with setChar");
            }
            ...
            try {
                ...
                TestUtil.logMsg("Got Expected MessageNotWriteableException with setInt");
            }
            ...
            try {
                ...
                TestUtil.logMsg("Got Expected MessageNotWriteableException with setLong");
            }
            ...
            try {
                ...
                TestUtil.logMsg("Got Expected MessageNotWriteableException with setFloat");
            }
            ...
            try {
                ...
                TestUtil.logMsg("Got Expected MessageNotWriteableException with setDouble");
            }
            ...
            try {
                ...
                TestUtil.logMsg("Got Expected MessageNotWriteableException with setBytes");
            }
            ...
            try {
                ...
                TestUtil.logMsg("Got Expected MessageNotWriteableException with setString");
            }
            ...
            try {
                ...
                TestUtil.logMsg("Got Expected MessageNotWriteableException with setObject");
            }
    ...
    public void mapMessageQIllegalarg() throws Fault {
        try {
            ...
            try {
                ...
                TestUtil.logMsg("Got Expected IllegalArgumentException with setBoolean");
            }

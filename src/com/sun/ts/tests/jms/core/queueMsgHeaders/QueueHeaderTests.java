    ...
    public void msgHdrJMSExpirationQueueTest() throws Fault {
        ...
        try {
            ...
            if (messageReceived.getJMSExpiration() != exp) {
                TestUtil.logErr("TextMessage Failed: JMSExpiration didnot set correctly = "
    ...
    public void msgHdrJMSDeliveryModeQTest() throws Fault {
        ...
        try {
            ...
            if (messageReceived.getJMSDeliveryMode() != DeliveryMode.PERSISTENT) {
                pass = false;
                logErr("TextMessage Error: JMSDeliveryMode should be set to persistent as default");
            }
            ...
            if (messageReceived.getJMSDeliveryMode() != DeliveryMode.NON_PERSISTENT) {
                pass = false;
                logErr("TextMessage Error: JMSDeliveryMode not set correctly by setJMSDeliveryMode");
            }
            ...
            if (messageReceivedO.getJMSDeliveryMode() != DeliveryMode.PERSISTENT) {
                pass = false;
                logMsg("ObjectMessage Error: JMSDeliveryMode should be set to persistent as default");
            }
            ...
            if (messageReceivedO.getJMSDeliveryMode() != DeliveryMode.NON_PERSISTENT) {
                pass = false;
                logErr("ObjectMessage Error: JMSDeliveryMode not set correctly by setJMSDeliveryMode");
            }
            ...
            if (messageReceivedM.getJMSDeliveryMode() != DeliveryMode.PERSISTENT) {
                pass = false;
                logMsg("MapMessage Error: JMSDeliveryMode should be set to persistent as default");
            }
            ...
            if (messageReceivedM.getJMSDeliveryMode() != DeliveryMode.NON_PERSISTENT) {
                pass = false;
                logErr("MapMessage Error: JMSDeliveryMode not set correctly by setJMSDeliveryMode");
            }
            ...
            if (messageReceivedB.getJMSDeliveryMode() != DeliveryMode.PERSISTENT) {
                pass = false;
                logErr("BytesMessage Error: JMSDeliveryMode should be set to persistent as default");
            }
            ...
            if (messageReceivedB.getJMSDeliveryMode() != DeliveryMode.NON_PERSISTENT) {
                pass = false;
                logErr("BytesMessage Error: JMSDeliveryMode not set correctly by setJMSDeliveryMode");
            }
            ...
            if (messageReceivedS.getJMSDeliveryMode() != DeliveryMode.PERSISTENT) {
                pass = false;
                logErr("StreamMessage Error: JMSDeliveryMode should be set to persistent as default");
            }
            ...
            if (messageReceivedS.getJMSDeliveryMode() != DeliveryMode.NON_PERSISTENT) {
                pass = false;
                logErr("StreamMessage Error: JMSDeliveryMode not set correctly by setJMSDeliveryMode");
            }
            ...
            if (messageReceived.getJMSDeliveryMode() != DeliveryMode.NON_PERSISTENT) {
                pass = false;
                logErr("TextMessage Error: JMSDeliveryMode should be set to NON_PERSISTENT");
            }
            ...
            if (messageReceivedO.getJMSDeliveryMode() != DeliveryMode.NON_PERSISTENT) {
                pass = false;
                logErr("ObjectMessage Error: JMSDeliveryMode should be set to NON_PERSISTENT");
            }
            ...
            if (messageReceivedM.getJMSDeliveryMode() != DeliveryMode.NON_PERSISTENT) {
                pass = false;
                logErr("MapMessage Error: JMSDeliveryMode should be set to NON_PERSISTENT");
            }
            ...
            if (messageReceivedB.getJMSDeliveryMode() != DeliveryMode.NON_PERSISTENT) {
                pass = false;
                logErr("BytesMessage Error: JMSDeliveryMode should be set to NON_PERSISTENT");
            }
            ...
            if (messageReceivedS.getJMSDeliveryMode() != DeliveryMode.NON_PERSISTENT) {
                pass = false;
                logErr("StreamMessage Error: JMSDeliveryMode should be set to NON_PERSISTENT");
            }
    ...
    public void msgHdrJMSRedeliveredTest() throws Fault {
        ...
        try {
            ...
            if (messageReceived.getJMSRedelivered() != true) {
                pass = false;
                logErr("TextMessage Error: JMSRedelivered not set correctly by setJMSRedelivered");
            }
            ...
            if (messageReceivedO.getJMSRedelivered() != true) {
                pass = false;
                logErr("ObjectMessage Error: JMSRedelivered not set correctly by setJMSRedelivered");
            }
            ...
            if (messageReceivedM.getJMSRedelivered() != true) {
                pass = false;
                logErr("MapMessage Error: JMSRedelivered not set correctly by setJMSRedelivered");
            }
            ...
            if (messageReceivedB.getJMSRedelivered() != true) {
                pass = false;
                logErr("BytesMessage Error: JMSRedelivered not set correctly by setJMSRedelivered");
            }
            ...
            if (messageReceivedS.getJMSRedelivered() != true) {
                pass = false;
                logErr("StreamMessage Error: JMSRedelivered not set correctly by setJMSRedelivered");
            }

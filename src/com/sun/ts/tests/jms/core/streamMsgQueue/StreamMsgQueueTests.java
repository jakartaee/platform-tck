...
public class StreamMsgQueueTests extends ServiceEETest {
    ...
    public void streamMessageConversionQTestsBoolean() throws Fault {
        try {
            ...
            // -----------------------------------------------------------------------------
            logTrace("Verify conversion support for boolean primitive type section 3.11.3");
            ...
            // -----------------------------------------------
            logMsg("--");
            logMsg("Use readBytes[] to read a boolean - expect MessageFormatException");
            int nCount = 0;
            ...
            // -----------------------------------------------
            logMsg("--");
            logMsg("Use readDouble to read a boolean - expect MessageFormatException");
            try {
    ...
    public void streamMessageConversionQTestsByte() throws Fault {
        try {
            ...
            // -----------------------------------------------------------------------------
            logTrace("Verify conversion support for byte primitive type section 3.11.3");
    ...
    public void streamMessageConversionQTestsBytes() throws Fault {
        try {
            ...
            try {
                ...
                logMsg("Fail: byte[] to boolean conversion should have thrown MessageFormatException");
                pass = false;
            } catch (Exception e) {
                if (e instanceof jakarta.jms.MessageFormatException) {
                    logTrace("Pass: MessageFormatException thrown as expected");
    ...
    public void streamMessageConversionQTestsInvFormatString() throws Fault {
        try {
            ...
            // -----------------------------------------------
            logMsg("--");
            logMsg("Verify that the data can be read as a string and pointer did not move");
            try {
                String s = messageReceived.readString();
    ...
    public void streamMessageQTestNull() throws Fault {
        try {
            ...
            try {
                ...
                throw new Fault("Error: failed to write a null object with writeString", e);
            }
     ...
     *
     * @test_Strategy: Create a StreamMessage, send it to a Queue. Receive it and try to write to the received Message's

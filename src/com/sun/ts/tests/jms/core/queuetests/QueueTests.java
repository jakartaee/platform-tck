...
public class QueueTests extends ServiceEETest {
    ...
    public void queueBrowserMsgsRemainOnQueueTest() throws Fault {
        try {
            ...
            // check for messages
            TestUtil.logMsg("Checking for " + numMessages + " messages with QueueBrowser");
            int msgCount = 0;
            ...
            TestUtil.logMsg("Receive all remaining messages to verify still in queue");
    ...
    public void msgProducerNullDestinationQueueTest() throws Fault {
        ...
        try {
            ...
            if (!pass) {
                throw new Fault("Error: failures occurred during msgProducerNullDestinationQueueTest tests");
            }
        } catch (Exception e) {
            TestUtil.printStackTrace(e);
    ...
    public void tempQueueTests() throws Fault {
        ...
        try {
            ...
            try {
                tempQ.delete();
                pass = false;
                TestUtil.logErr("Didn't throw expected JMSException calling TemporaryQueue.delete()");
            ...
            try {
                tempQ.delete();
                TestUtil.logTrace("Succesfully calling TemporaryQueue.delete() after closing Receiver");
            } catch (Exception e) {
                pass = false;

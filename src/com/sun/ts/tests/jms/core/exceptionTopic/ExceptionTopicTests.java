...
public class ExceptionTopicTests extends ServiceEETest {
        ...
        try {
            ...
            try {
                ...
                if (ee instanceof jakarta.jms.InvalidDestinationException) {
                    TestUtil.logTrace("Pass: InvalidDestinationException thrown as expected");
                } else {
                    logMsg("Error: unexpected error " + ee.getClass().getName() + " was thrown");
                    pass = false;
                }
            }
            ...
            try {
                ...
                logErr("Error: unexpected error " + ee.getClass().getName() + " was thrown");
                pass = false;
            }
            if (!pass) {
    ...
    public void xMessageNotWriteableExceptionTTestforTextMessage() throws Fault {
        try {
            ...
            TestUtil.logErr("xMessageNotWriteableExceptionTTestforTextMessage failed:", e);
    ...
    public void xMessageNotWriteableExceptionTestforBytesMessage() throws Fault {
        try {
            ...
            TestUtil.logErr("xMessageNotWriteableExceptionTestforBytesMessage failed: ", e);
    ...
    public void xMessageNotWriteableExceptionTTestforStreamMessage() throws Fault {
        try {
            ...
            TestUtil.logErr("xMessageNotWriteableExceptionTTestforStreamMessage failed: ", e);
    ...
    public void xMessageNotWriteableExceptionTTestforMapMessage() throws Fault {
        try {
            ...
            try {
                ...
                TestUtil.logMsg("Passed with expected MessageNotWriteableException occurred.");
            }
        } catch (Exception e) {
            TestUtil.logErr("xMessageNotWriteableExceptionTTestforMapMessage failed: ", e);
    ...
    public void xIllegalStateExceptionTopicTest() throws Fault {
        ...
        try {
            ...
            try {
                ...
                logMsg("Received jakarta.jms.IllegalStateException -- GOOD");
                passed = true;
            }
    ...
    public void xUnsupportedOperationExceptionTTest1() throws Fault {
        try {
            ...
            try {
                ...
                pass = false;
                logErr("Error: TopicPublisher.publish(Message) didn't throw expected UnsupportedOperationException.");
            } catch (UnsupportedOperationException ex) {
                logMsg("Got expected UnsupportedOperationException from  TopicPublisher.publish(Message)");
            } catch (Exception e) {
                logErr("Error:  TopicPublisher.publish(Message) throw incorrect Exception: ", e);
                pass = false;
            }
            ...
            try {
                ...
                logErr("Error:  TopicPublisher.publish(Message, int, int, long) throw incorrect Exception: ", e);
                pass = false;
            }
    ...
    public void xIllegalStateExceptionTestQueueMethodsT() throws Fault {
        ...
        try {
            ...
            try {
                ...
                TestUtil.logMsg("Got expected IllegalStateException from TopicSession.createBrowser(Queue)");
            } catch (Exception e) {
                TestUtil.logErr("Error: TopicSession.createBrowser(Queue) throw incorrect Exception: ", e);
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logMsg("Got expected IllegalStateException from TopicSession.createBrowser(Queue, String)");
            } catch (Exception e) {
                TestUtil.logErr("Error: TopicSession.createBrowser(Queue, String) throw incorrect Exception: ", e);
                pass = false;
            }
            ...
            try {
                ...
                TestUtil.logMsg("Got expected IllegalStateException from TopicSession.createTemporayQueue()");
            } catch (Exception e) {
                TestUtil.logErr("Error: TopicSession.createTemporayQueue() throw incorrect Exception: ", e);
                pass = false;
            }
            ...
            try {
                ...
                pass = false;
                TestUtil.logErr("Error: TopicSession.createQueue(String) didn't throw expected IllegalStateException.");
            } catch (jakarta.jms.IllegalStateException ex) {
                TestUtil.logMsg("Got expected IllegalStateException from TopicSession.createQueue(String)");
            } catch (Exception e) {
                TestUtil.logErr("Error: TopicSession.createQueue(String) throw incorrect Exception: ", e);
                pass = false;
            }

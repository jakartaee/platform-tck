...
package com.sun.ts.tests.jaxrpc.wsi.w2j.document.literal.R2024;
...
/**
 * Tests R2024 in the WSI Basic Profile 1.0: The wsdl:documentation element MAY
 * occur as a first child of the wsdl:definitions element in a DESCRIPTION.
 * WSDL12
 */
public class Client extends ServiceEETest {
   ...
   */
  private static final String STRING = "R2024";

  /**
   * The client.
   */
  private W2JDLR2024Client client;
  ...
  public void setup(String[] args, Properties properties) throws Fault {
    client = (W2JDLR2024Client) ClientFactory.getClient(W2JDLR2024Client.class,
        properties);
    logMsg("setup ok");
  }
   ...
   *
   * @assertion_ids: JAXRPC:WSI:R2024
   *
   * @test_Strategy: The supplied WSDL, containg a wsdl:documentation element as
   *                 a child of the wsdl:definitions element, has been used by
  ...
  public void testDocumentLiteralDocumentationElement() throws Fault {
    ...
    try {
      ...
      throw new Fault("Unable to invoke echoString operation (BP-R2024)", e);
    }
    if (!STRING.equals(result)) {
      throw new Fault("echoString operation returns '" + result
          + "' in stead of '" + STRING + "' (BP-R2024)");
    }
  }
}

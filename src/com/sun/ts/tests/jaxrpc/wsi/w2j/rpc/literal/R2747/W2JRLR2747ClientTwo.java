...
public class W2JRLR2747ClientTwo extends SOAPClient {
  public W2JRLR2747ClientTwo(String webServerHost, int webServerPort, int mode)
      throws EETest.Fault {
    ...
    stubContext.setPortPrefix("W2JRLR2747TestTwo");
    stubContext.setServiceInterface(W2JRLR2747TestTwo.class);
  }

  protected String getEndpointURLProperty() {
    return CTSConstants.w2jrlr2747EndpointTwoProperty;
  }

  protected String getWSDLURLProperty() {
    return CTSConstants.w2jrlr2747WSDLTwoProperty;
  }

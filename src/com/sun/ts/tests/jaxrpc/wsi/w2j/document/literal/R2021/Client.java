...
/**
 * Tests R2021 in the WSI Basic Profile 1.0: The wsdl:documentation element MAY
 * occur as a child of the wsdl:part element in a DESCRIPTION. WSDL12
 */
public class Client extends ServiceEETest {
  /**
   * The string to be echoed.
   */
  private static final String STRING = "R2021";

  /**
   * The client.
   */
  private W2JDLR2021Client client;
  ...
  public void setup(String[] args, Properties properties) throws Fault {
    client = (W2JDLR2021Client) ClientFactory.getClient(W2JDLR2021Client.class,
        properties);
    logMsg("setup ok");
  }
   ...
   *
   * @assertion_ids: JAXRPC:WSI:R2021
   *
   * @test_Strategy: The supplied WSDL, containg a wsdl:documentation element as
   *                 a child of the wsdl:part element, has been used by the
  ...
  public void testDocumentLiteralDocumentationElement() throws Fault {
    ...
    try {
      ...
      throw new Fault("Unable to invoke echoString operation (BP-R2021)", e);
    }
    if (!STRING.equals(result)) {
      throw new Fault("echoString operation returns '" + result
          + "' in stead of '" + STRING + "' (BP-R2021)");
    }
  }
}

...
public class W2JDLR4003Client extends SOAPClient {
  public W2JDLR4003Client(String webServerHost, int webServerPort, int mode)
      throws EETest.Fault {
    super(webServerHost, webServerPort, mode);
    stubContext.setNamespace(
        "http://w2jdlr4003testservice.org/W2JDLR4003TestService.wsdl");
    stubContext.setService("W2JDLR4003TestService");
    stubContext.setPortPrefix("W2JDLR4003Test");
    stubContext.setServiceInterface(W2JDLR4003Test.class);
  }

  protected String getEndpointURLProperty() {
    return CTSConstants.w2jdlr4003EndpointProperty;
  }

  protected String getWSDLURLProperty() {
    return CTSConstants.w2jdlr4003WSDLProperty;
  }

...
public class W2JRLR1011ClientOne extends SOAPClient {
  public W2JRLR1011ClientOne(String webServerHost, int webServerPort, int mode)
      throws EETest.Fault {
    ...
    stubContext.setPortPrefix("W2JRLR1011TestOne");
    stubContext.setServiceInterface(W2JRLR1011TestOne.class);
  }

  protected String getEndpointURLProperty() {
    return CTSConstants.w2jrlr1011EndpointOneProperty;
  }

  protected String getWSDLURLProperty() {
    return CTSConstants.w2jrlr1011WSDLOneProperty;
  }

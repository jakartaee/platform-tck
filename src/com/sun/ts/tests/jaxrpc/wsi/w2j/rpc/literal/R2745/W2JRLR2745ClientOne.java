...
public class W2JRLR2745ClientOne extends SOAPClient {
  public W2JRLR2745ClientOne(String webServerHost, int webServerPort, int mode)
    ...
    stubContext.setPortPrefix("W2JRLR2745TestOne");
    stubContext.setServiceInterface(W2JRLR2745TestOne.class);
  }

  protected String getEndpointURLProperty() {
    return CTSConstants.w2jrlr2745EndpointOneProperty;
  }

  protected String getWSDLURLProperty() {
    return CTSConstants.w2jrlr2745WSDLOneProperty;
  }

...
package com.sun.ts.tests.jaxrpc.wsi.w2j.rpc.literal.R2707;
...
public class W2JRLR2707Client extends SOAPClient {
  public W2JRLR2707Client(String webServerHost, int webServerPort, int mode)
    ...
    stubContext.setPortPrefix("W2JRLR2707Test");
    stubContext.setServiceInterface(W2JRLR2707Test.class);
  }

  protected String getEndpointURLProperty() {
    return CTSConstants.w2jrlr2707EndpointProperty;
  }

  protected String getWSDLURLProperty() {
    return CTSConstants.w2jrlr2707WSDLProperty;
  }

  public String echoString(String str) throws Exception {
    NonNullString nns = new NonNullString(str);
    nns = ((W2JRLR2707Test) stubContext.getStub()).echoString(nns);
    return nns.getP1();
  }
}

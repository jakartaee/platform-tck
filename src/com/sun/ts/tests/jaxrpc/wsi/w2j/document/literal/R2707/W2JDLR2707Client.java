...
public class W2JDLR2707Client extends SOAPClient {
  public W2JDLR2707Client(String webServerHost, int webServerPort, int mode)
    ...
    stubContext.setPortPrefix("W2JDLR2707Test");
    stubContext.setServiceInterface(W2JDLR2707Test.class);
  }

  protected String getEndpointURLProperty() {
    return CTSConstants.w2jdlr2707EndpointProperty;
  }

  protected String getWSDLURLProperty() {
    return CTSConstants.w2jdlr2707WSDLProperty;
  }

  public String echoString(String str) throws Exception {
    return ((W2JDLR2707Test) stubContext.getStub()).echoString(str);
  }
}

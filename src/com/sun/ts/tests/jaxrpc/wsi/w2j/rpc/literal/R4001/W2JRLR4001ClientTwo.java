...
public class W2JRLR4001ClientTwo extends SOAPClient {
  public W2JRLR4001ClientTwo(String webServerHost, int webServerPort, int mode)
      throws EETest.Fault {
    ...
    stubContext.setPortPrefix("W2JRLR4001TestTwo");
    stubContext.setServiceInterface(W2JRLR4001TestTwo.class);
  }

  protected String getEndpointURLProperty() {
    return CTSConstants.w2jrlr4001EndpointTwoProperty;
  }

  protected String getWSDLURLProperty() {
    return CTSConstants.w2jrlr4001WSDLTwoProperty;
  }

  public String echoString(String str) throws Exception {
    NonNullString nns = new NonNullString(str);
    nns = ((W2JRLR4001TestTwo) stubContext.getStub()).echoString(nns);
    return nns.getP1();
  }
}

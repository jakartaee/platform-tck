...
public class W2JRLR2753Client extends SOAPClient {
  ...
  public W2JRLR2753Client(String webServerHost, int port, int mode)
      throws EETest.Fault {
  ...
  protected String getEndpointURLProperty() {
    return CTSConstants.w2jrlr2753EndpointProperty;
  }

  protected String getWSDLURLProperty() {
    return CTSConstants.w2jrlr2753WSDLProperty;
  }

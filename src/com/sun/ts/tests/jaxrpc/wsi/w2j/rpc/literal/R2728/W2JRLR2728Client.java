...
public class W2JRLR2728Client extends SOAPClient {
  public W2JRLR2728Client(String webServerHost, int webServerPort, int mode)
    ...
    stubContext.setPortPrefix("W2JRLR2728Test");
    stubContext.setServiceInterface(W2JRLR2728Test.class);
  }

  protected String getEndpointURLProperty() {
    return CTSConstants.w2jrlr2728EndpointProperty;
  }

  protected String getWSDLURLProperty() {
    return CTSConstants.w2jrlr2728WSDLProperty;
  }

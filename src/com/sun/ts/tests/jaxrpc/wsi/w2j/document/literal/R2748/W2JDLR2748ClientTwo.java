...
public class W2JDLR2748ClientTwo extends SOAPClient {
  public W2JDLR2748ClientTwo(String webServerHost, int webServerPort, int mode)
    ...
    stubContext.setPortPrefix("W2JDLR2748TestTwo");
    stubContext.setServiceInterface(W2JDLR2748TestTwo.class);
  }

  protected String getEndpointURLProperty() {
    return CTSConstants.w2jdlr2748EndpointTwoProperty;
  }

  protected String getWSDLURLProperty() {
    return CTSConstants.w2jdlr2748WSDLTwoProperty;
  }

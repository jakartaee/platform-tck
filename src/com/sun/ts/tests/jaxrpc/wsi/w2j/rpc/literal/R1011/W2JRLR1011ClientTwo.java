...
public class W2JRLR1011ClientTwo extends SOAPClient {
  public W2JRLR1011ClientTwo(String webServerHost, int webServerPort, int mode)
    ...
    stubContext.setPortPrefix("W2JRLR1011TestTwo");
    stubContext.setServiceInterface(W2JRLR1011TestTwo.class);
  }

  protected String getEndpointURLProperty() {
    return CTSConstants.w2jrlr1011EndpointTwoProperty;
  }

  protected String getWSDLURLProperty() {
    return CTSConstants.w2jrlr1011WSDLTwoProperty;
  }

...
public class W2JRLR1109ClientOne extends SOAPClient {

  public W2JRLR1109ClientOne(String webServerHost, int port, int mode)
      throws EETest.Fault {
    ...
    stubContext.setPortPrefix("W2JRLR1109TestOne");
    stubContext.setServiceInterface(W2JRLR1109Test.class);
  }

  protected String getEndpointURLProperty() {
    return CTSConstants.w2jrlr1109EndpointOneProperty;
  }

  protected String getWSDLURLProperty() {
    return CTSConstants.w2jrlr1109WSDLOneProperty;
  }

...
public class W2JDLR2747ClientTwo extends SOAPClient {
  public W2JDLR2747ClientTwo(String webServerHost, int webServerPort, int mode)
      throws EETest.Fault {
    ...
    stubContext.setPortPrefix("W2JDLR2747TestTwo");
    stubContext.setServiceInterface(W2JDLR2747TestTwo.class);
  }

  protected String getEndpointURLProperty() {
    return CTSConstants.w2jdlr2747EndpointTwoProperty;
  }

  protected String getWSDLURLProperty() {
    return CTSConstants.w2jdlr2747WSDLTwoProperty;
  }

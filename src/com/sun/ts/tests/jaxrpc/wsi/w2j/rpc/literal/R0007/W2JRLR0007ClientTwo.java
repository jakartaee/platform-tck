...
public class W2JRLR0007ClientTwo extends SOAPClient {
  public W2JRLR0007ClientTwo(String webServerHost, int webServerPort, int mode)
      throws EETest.Fault {
    ...
    stubContext.setPortPrefix("W2JRLR0007TestTwo");
    stubContext.setServiceInterface(W2JRLR0007TestTwo.class);
  }

  protected String getEndpointURLProperty() {
    return CTSConstants.w2jrlr0007EndpointTwoProperty;
  }

  protected String getWSDLURLProperty() {
    return CTSConstants.w2jrlr0007WSDLTwoProperty;
  }

  public String echoString(String str) throws Exception {
    NonNullString nns = new NonNullString(str);
    nns = ((W2JRLR0007TestTwo) stubContext.getStub()).echoString(nns);
    return nns.getP1();
  }
}

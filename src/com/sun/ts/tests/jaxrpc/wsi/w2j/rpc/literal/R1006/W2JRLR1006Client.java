...
public class W2JRLR1006Client extends SOAPClient {
  ...
  public W2JRLR1006Client(String webServerHost, int port, int mode)
      throws EETest.Fault {
  ...
  protected String getEndpointURLProperty() {
    return CTSConstants.w2jrlr1006EndpointProperty;
  }

  protected String getWSDLURLProperty() {
    return CTSConstants.w2jrlr1006WSDLProperty;
  }

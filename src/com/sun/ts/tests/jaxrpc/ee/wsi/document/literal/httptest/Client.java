...
public class Client extends ServiceEETest {
  ...
  private void getStubJaxrpc() throws Exception {
    ...
    port = (Hello) JAXRPC_Util.getStub("com.sun.ts.tests.jaxrpc.ee."
        + "wsi.document.literal.httptest.HttpTestService", "getHelloPort");
  ...
  private void getStub() throws Exception {
    ...
    TestUtil.logMsg("Lookup java:comp/env/service/wsidlhttptest");
    javax.xml.rpc.Service svc = (javax.xml.rpc.Service) ctx
        .lookup("java:comp/env/service/wsidlhttptest");

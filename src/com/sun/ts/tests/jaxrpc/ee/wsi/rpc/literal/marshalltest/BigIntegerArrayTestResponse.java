...
public class BigIntegerArrayTestResponse {
  protected java.math.BigInteger[] bigIntegerArray;

  public BigIntegerArrayTestResponse() {
  }

  public BigIntegerArrayTestResponse(java.math.BigInteger[] bigIntegerArray) {

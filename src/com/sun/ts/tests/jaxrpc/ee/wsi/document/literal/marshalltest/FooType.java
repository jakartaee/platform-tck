...
public class FooType {
  ...
  protected com.sun.ts.tests.jaxrpc.ee.wsi.document.literal.marshalltest.FooVariousSchemaTypes fooJ;

  protected java.math.BigInteger fooK;

  protected java.lang.String fooM;

  protected com.sun.ts.tests.jaxrpc.ee.wsi.document.literal.marshalltest.FooAnonymousType fooN;
  ...
  public FooType(boolean fooA, byte fooB, short fooC, int fooD, long fooE,
      ...
      com.sun.ts.tests.jaxrpc.ee.wsi.document.literal.marshalltest.FooVariousSchemaTypes fooJ,
      java.math.BigInteger fooK, java.lang.String fooM,
      com.sun.ts.tests.jaxrpc.ee.wsi.document.literal.marshalltest.FooAnonymousType fooN) {
    this.fooA = fooA;
    this.fooB = fooB;
    this.fooC = fooC;
    this.fooD = fooD;
  ...
  public com.sun.ts.tests.jaxrpc.ee.wsi.document.literal.marshalltest.FooVariousSchemaTypes getFooJ() {
    return fooJ;
  }
  ...
  public com.sun.ts.tests.jaxrpc.ee.wsi.document.literal.marshalltest.FooAnonymousType getFooN() {
    return fooN;
  }

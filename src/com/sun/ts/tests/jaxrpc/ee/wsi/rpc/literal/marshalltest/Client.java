...
import com.sun.ts.tests.jaxrpc.ee.wsi.rpc.literal.marshalltest.*;
...
public class Client extends ServiceEETest {
  ...
  private static final String PKG_NAME = "com.sun.ts.tests.jaxrpc.ee.wsi.rpc.literal.marshalltest.";
  ...
  private static final String ENDPOINT_URL = "wsirlmarshalltest.endpoint.1";

  private static final String ENDPOINT2_URL = "wsirlmarshalltest.endpoint.2";

  private static final String ENDPOINT3_URL = "wsirlmarshalltest.endpoint.3";

  private static final String ENDPOINT4_URL = "wsirlmarshalltest.endpoint.4";

  private static final String WSDLLOC_URL = "wsirlmarshalltest.wsdlloc.1";
  ...
  private void getStub() throws Exception {
    ...
    TestUtil.logMsg("Lookup java:comp/env/service/wsirlmarshalltest");
    Service svc = (javax.xml.rpc.Service) ctx
        .lookup("java:comp/env/service/wsirlmarshalltest");
    TestUtil.logMsg("Get port1 from Service1");
    port = (MarshallTest) svc.getPort(
        com.sun.ts.tests.jaxrpc.ee.wsi.rpc.literal.marshalltest.MarshallTest.class);
    TestUtil.logMsg("Get port2 from Service1");
    port2 = (NewSchemaTest) svc.getPort(
        com.sun.ts.tests.jaxrpc.ee.wsi.rpc.literal.marshalltest.NewSchemaTest.class);

    port3 = (CompoundTest) svc.getPort(
        com.sun.ts.tests.jaxrpc.ee.wsi.rpc.literal.marshalltest.CompoundTest.class);

    port4 = (OneWayTest) svc.getPort(
        com.sun.ts.tests.jaxrpc.ee.wsi.rpc.literal.marshalltest.OneWayTest.class);
  ...
  public void setup(String[] args, Properties p) throws Fault {
    ...
    try {
      ...
      if (modeProperty.equals("standalone")) {
        ...
        JAXRPC_Util.setSOAPLogging(stub3, System.out);
        JAXRPC_Util.setSOAPLogging(stub4, System.out);
   ...
   *
   * @assertion_ids: JAXRPC:SPEC:52; JAXRPC:SPEC:295; JAXRPC:SPEC:269;
   * JAXRPC:SPEC:502;
   *
   ...
   * JAXRPC:SPEC:295; JAXRPC:SPEC:269;
   *
   * @test_Strategy: Create a stub instance to our service definition interface,
   ...
   *
   * @assertion_ids: JAXRPC:SPEC:70; JAXRPC:SPEC:295; JAXRPC:SPEC:269;
   * JAXRPC:SPEC:64; JAXRPC:SPEC:502;
   *
   * @test_Strategy: Create a stub instance to our service definition interface,
   ...
   * JAXRPC:SPEC:269; JAXRPC:SPEC:503;
   *
   * @test_Strategy: Create a stub instance to our service definition interface,
   * set the target endpoint to the servlet, and invoke the RPC method. Verify
   * normal invocation and return.
   ...
   *
   * @assertion_ids: JAXRPC:SPEC:65; JAXRPC:SPEC:295; JAXRPC:SPEC:269;
   *
   * @test_Strategy: Create a stub instance to our service definition interface,
   * set the target endpoint to the servlet, and invoke the RPC method. Verify
   * normal invocation and return.
   ...
   * JAXRPC:SPEC:269; JAXRPC:SPEC:502;
   *
   * @test_Strategy: Create a stub instance to our service definition interface,
   * set the target endpoint to the servlet, and invoke the RPC method. Verify
   * normal invocation and return.
   ...
   * JAXRPC:SPEC:295; JAXRPC:SPEC:269; JAXRPC:SPEC:502;
   *
   * @test_Strategy: Create a stub instance to our service definition interface,
   * set the target endpoint to the servlet, and invoke the RPC method. Verify
   * normal invocation and return.
  ...
  public void MarshallAnySimpleTypeTest() throws Fault {
    ...
    try {
      ...
      String res = response.getFooAnySimpleType();
   ...
   *
   * @assertion_ids: JAXRPC:SPEC:52; JAXRPC:SPEC:63; JAXRPC:SPEC:64;
   * JAXRPC:SPEC:502; JAXRPC:SPEC:295; JAXRPC:SPEC:269;
   *
   * @test_Strategy: Create a stub instance to our service definition interface,
   * set the target endpoint to the servlet, and invoke the RPC method voidTest.
   * Verify normal invocation and return.
   ...
   *
   * @assertion_ids: JAXRPC:SPEC:13; JAXRPC:SPEC:269; JAXRPC:SPEC:442;
   * JAXRPC:SPEC:295;
   *
   * @test_Strategy: Create a stub instance to our service definition interface,
  ...
  public void MarshallComplexTypesTest() throws Fault {
    ...
    try {
      ...
      // comment out for now .... working on fix
   ...
   *
   * @assertion_ids: JAXRPC:SPEC:33; JAXRPC:SPEC:295; JAXRPC:SPEC:269;
   *
   * @test_Strategy: Create a stub instance to our service definition interface,
   * set the target endpoint to the servlet, and invoke the RPC method voidTest.
   * Verify normal invocation and return.
   ...
   *
   * @assertion_ids: JAXRPC:SPEC:13; JAXRPC:SPEC:269; JAXRPC:SPEC:295;
   * JAXRPC:SPEC:52; JAXRPC:SPEC:442; JAXRPC:SPEC:284;
   *
   * @test_Strategy: Create a stub instance to our service definition interface,
   * set the target endpoint to the servlet, and invoke the RPC methods for each
   ...
   *
   * @assertion_ids: JAXRPC:SPEC:71; JAXRPC:SPEC:295; JAXRPC:SPEC:269;
   *
   * @test_Strategy: Create a stub instance to our service definition interface,
   * set the target endpoint to the servlet, and invoke the RPC methods for each
   * standard java class type. For each supported unsigned simple type pass its
   ...
   *
   * @assertion_ids: JAXRPC:SPEC:TODO; JAXRPC:SPEC:295; JAXRPC:SPEC:269;
   *
  ...
  public void MarshallIncludedStringTypeTest() throws Fault {
    ...
    boolean pass = true;
    com.sun.ts.tests.jaxrpc.ee.wsi.rpc.literal.marshalltest.IncludedStringRequest request = null;
    String myString = "Please echo this back to me ";
    com.sun.ts.tests.jaxrpc.ee.wsi.rpc.literal.marshalltest.IncludedStringResponse response = null;
    try {
  ...
  private boolean sendFoo1Test() {
    ...
    boolean pass = true;
    TestUtil.logMsg(
        "Passing/Returning OtherXMLSchemaDataTypes to/from JAXRPC Service");
    try {
  ...
  private boolean TimeTest() {
    ...
    boolean pass = true;
    Calendar request = JAXRPC_Data.GregorianCalendar_data[0];
    Calendar response;
    TestUtil.logMsg("Passing/Returning Time class to/from JAXRPC Service");
    try {
      response = port2.echoTimeTest(request);
      if (!JAXRPC_Data.compareValues(request, response, "calendar"))
        pass = false;
    } catch (Exception e) {
      TestUtil.logErr("Caught exception: " + e.getMessage());
      TestUtil.printStackTrace(e);
  ...
  private boolean DateTest() {
    ...
    TestUtil.logMsg("Passing/Returning Date class to/from JAXRPC Service");
    try {

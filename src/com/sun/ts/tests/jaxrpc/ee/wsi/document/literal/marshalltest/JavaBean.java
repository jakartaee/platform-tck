...
public class JavaBean {
  ...
  protected com.sun.ts.tests.jaxrpc.ee.wsi.document.literal.marshalltest.JavaBean2 myJavaBean;
  ...
  public JavaBean(java.math.BigDecimal myBigDecimal, double myDouble,
      long myLong,
      com.sun.ts.tests.jaxrpc.ee.wsi.document.literal.marshalltest.JavaBean2 myJavaBean,
      short myShort, int myInt, java.util.Calendar myCalendar, byte myByte,
      boolean myBoolean, java.lang.String myString,
  ...
  public com.sun.ts.tests.jaxrpc.ee.wsi.document.literal.marshalltest.JavaBean2 getMyJavaBean() {
    return myJavaBean;
  }

  public void setMyJavaBean(
      com.sun.ts.tests.jaxrpc.ee.wsi.document.literal.marshalltest.JavaBean2 myJavaBean) {
    this.myJavaBean = myJavaBean;
  }

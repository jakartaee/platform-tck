...
/*
 * @(#)NewSchemaTestImpl.java	1.5 03/06/16
 */

/*
 * @(#)NewSchemaTestImpl.java	1.17	03/03/05
 */
...
public class NewSchemaTestImpl implements NewSchemaTest {
  ...
  public IncludedStringResponse echoIncludedStringTest(
      IncludedStringRequest request) throws RemoteException {
  ...
  public TokenElem echoTokenTypeTest(TokenElem v) throws RemoteException {
    return v;
  }

  public NameElem echoNameTypeTest(NameElem v) throws RemoteException {
    return v;
  }

  public NCNameElem echoNCNameTypeTest(NCNameElem v) throws RemoteException {
    return v;
  }

  public IDElem echoIDTypeTest(IDElem v) throws RemoteException {
    return v;
  }
  ...
  private void init_SOAPElement_Data() {
    try {
      ...
      SOAPElement_data = sf.createElement("MyNameM", "MyPrefixM",
          "http://example.com/MyURIM");
    } catch (Exception e) {

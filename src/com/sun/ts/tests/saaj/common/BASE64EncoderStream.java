...
/**
 * This class implements a BASE64 Encoder. It is implemented as a FilterOutputStream, so one can just wrap this class
 * around any output stream and write bytes into this filter. The Encoding is done as the bytes are written out.
 *
 * @author John Mani
 * @author Bill Shannon
 */
public class BASE64EncoderStream extends FilterOutputStream {
    ...
    /**
     * Encodes <code>len</code> bytes from the specified <code>byte</code> array starting at offset <code>off</code> to this
     * output stream.
     *
     * @param b the data.
    ...
    /**
     * Base64 encode a byte array. No line breaks are inserted. This method is suitable for short strings, such as those in
     * the IMAP AUTHENTICATE protocol, but not to encode the entire content of a MIME part.
     */
     ...
     * FileInputStream(argv[0]); BASE64EncoderStream encoder = new BASE64EncoderStream(System.out); int c;
     *

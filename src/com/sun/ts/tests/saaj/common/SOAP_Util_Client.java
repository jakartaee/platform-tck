...
public final class SOAP_Util_Client {
    ...
    public static String getSOAPVersion() {
        ...
        if (soapVersion == null || soapVersion.equals(SOAP_Util_Client.SOAP11)) return SOAP_Util_Client.SOAP11;
        else return SOAP_Util_Client.SOAP12;
    }
    ...
    public static void dumpSOAPMessageWOA(SOAPMessage msg) {
        ...
        try {
            ByteArrayOutputStream baos = new ByteArrayOutputStream();
            msg.writeTo(baos);
            SOAPMessage tmpMsg = getMessageFactory()
                    .createMessage(msg.getMimeHeaders(), new ByteArrayInputStream(baos.toByteArray()));

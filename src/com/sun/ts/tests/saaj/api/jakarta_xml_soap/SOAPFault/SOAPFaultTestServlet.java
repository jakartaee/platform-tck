...
public class SOAPFaultTestServlet extends HttpServlet {
        ...
        try {
            ...
            if (result != null) {
                if (!result.equals(expected)) {
                    ...
                    TestUtil.logErr("setFaultActor=" + expected + ", getFaultActor=" + result);
                    pass = false;
                } else TestUtil.logMsg("setFaultActor()/getFaultActor() behaved correctly");
            } else {
                TestUtil.logErr("getFaultActor() returned a null result, eventhough an actor was set");
                pass = false;
            }
        } catch (Exception e) {
            TestUtil.logErr("Exception: " + e);
    ...
    private void addFaultReasonText1Test(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            TestUtil.logMsg("Calling addFaultReasonText() must" + " throw UnsupportedOperationException");
        ...
        try {
            ...
            while (i.hasNext()) {
                ...
                if (o instanceof String) {
                    ...
                    TestUtil.logErr("An object that is not an instance of String was returned");
            ...
            if (!found1) {
                TestUtil.logErr("The following Reason text was not received: '" + expected1 + "'");
                pass = false;
            }
        } catch (Exception e) {
            TestUtil.logErr("Exception: " + e);
    ...
    private void addFaultReasonText3Test(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            if (!found2) {
                TestUtil.logErr("The following Reason text was not received: '" + expected2 + "'");
                pass = false;
            }
        } catch (Exception e) {
            TestUtil.logErr("Exception: " + e);
    ...
    private void addFaultReasonText4Test(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            if (!found) {
                TestUtil.logErr("The following Reason text was not received: '" + expected + "'");
                pass = false;
            }
        } catch (Exception e) {
            TestUtil.logErr("Exception: " + e);
    ...
    private void getFaultReasonLocales1Test(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            setup();
            TestUtil.logMsg("Calling getFaultReasonLocales() must" + " throw UnsupportedOperationException");
    ...
    private void getFaultReasonLocales2Test(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            while (i.hasNext()) {
                ...
                if (o instanceof Locale) {
                    ...
                    if (actual.equals(expected1)) {
                        ...
                        TestUtil.logErr("Did not receive expected reason text:");
                        TestUtil.logErr("expected= '" + expected1 + "' or '" + expected2 + "' or '" + expected3 + "'");
                        TestUtil.logErr("actual= '" + actual + "'");
                        pass = false;
                    }
                } else {
                    TestUtil.logErr("An object that is not an instance of Locale was returned");
                    TestUtil.logErr("The object is:" + o);
                    pass = false;
                }
                j++;
            ...
            if (!found1) {
                TestUtil.logErr("The following Locale was not received: '" + expected1 + "'");
                pass = false;
            }
            if (!found2) {
                TestUtil.logErr("The following Locale was not received: '" + expected2 + "'");
                pass = false;
            }
            if (!found3) {
                TestUtil.logErr("The following Locale was not received: '" + expected3 + "'");
                pass = false;
            }
        } catch (Exception e) {
            TestUtil.logErr("Exception: " + e);
    ...
    private void getFaultReasonText1Test(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            setup();
            TestUtil.logMsg("Calling getFaultReasonText(Locale) must" + " throw UnsupportedOperationException");
    ...
    private void getFaultReasonTexts1Test(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            TestUtil.logMsg("Calling getFaultReasonTexts() must" + " throw UnsupportedOperationException");
    ...
    private void setFaultNode1Test(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            TestUtil.logMsg("Calling setFaultNode() must" + " throw UnsupportedOperationException");
    ...
    private void getFaultNode1Test(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            TestUtil.logMsg("Calling getFaultNode() must" + " throw UnsupportedOperationException");
            sf.getFaultNode();
            TestUtil.logErr("Did not throw UnsupportedOperationException");
            pass = false;
        } catch (UnsupportedOperationException e) {
    ...
    private void setFaultRole1Test(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            TestUtil.logMsg("Calling setFaultRole() must" + " throw UnsupportedOperationException");
        ...
        try {
            ...
            if (result != null) {
                if (!result.equals(expected)) {
                    ...
                    pass = false;
                } else TestUtil.logMsg("setFaultRole()/getFaultRole() behaved correctly");
            } else {
    ...
    private void getFaultRole1Test(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            TestUtil.logMsg("Calling getFaultRole() must" + " throw UnsupportedOperationException");
            sf.getFaultRole();
            TestUtil.logErr("Did not throw UnsupportedOperationException");
            pass = false;
        } catch (UnsupportedOperationException e) {
    ...
    private void SetGetFaultCodeAsName1Test(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            if (SOAP_Util.getSOAPVersion().equals(SOAP_Util.SOAP11)) {
                ...
                TestUtil.logMsg("Calling setFaultCode() with " + name.getQualifiedName());
                sf.setFaultCode(name);
                TestUtil.logMsg("Calling getFaultCodeAsName() to retrieve Fault Code");
                Name name2 = sf.getFaultCodeAsName();
                if (name2 != null) TestUtil.logMsg("Qualified name=" + name2.getQualifiedName());
                if (name2 == null) {
                    TestUtil.logErr("Calling getFaultCodeAsName " + "returned null (unexpected)");
                    pass = false;
                } else if (!name2.getLocalName().equals(name.getLocalName())
                        || !name2.getPrefix().equals(name.getPrefix())
                        || !name2.getURI().equals(name.getURI())) {
                    TestUtil.logErr("Calling getFaultCodeAsName returned <" + name2.getLocalName()
                ...
                Name name = SOAP_Util.getSOAPFactory()
                        .createName(qname.getLocalPart(), qname.getPrefix(), qname.getNamespaceURI());
                TestUtil.logMsg("Calling setFaultCode() with " + name.getQualifiedName());
                sf.setFaultCode(name);
                TestUtil.logMsg("Calling getFaultCodeAsName() to retrieve Fault Code");
                Name name2 = sf.getFaultCodeAsName();
    ...
    private void SetGetFaultCodeAsQName1Test(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            if (SOAP_Util.getSOAPVersion().equals(SOAP_Util.SOAP11)) {
                TestUtil.logMsg("Creating QName of: <myfault, flt, http://example.com>");
                ...
                if (name2 != null) TestUtil.logMsg("Qualified name=" + name2.toString());
                if (name2 == null) {
                    TestUtil.logErr("Calling getFaultCodeAsQName " + "returned null (unexpected)");
                    pass = false;
                } else if (!name2.getLocalPart().equals(name.getLocalPart())
                        || !name2.getPrefix().equals(name.getPrefix())
                        || !name2.getNamespaceURI().equals(name.getNamespaceURI())) {
                    TestUtil.logErr("Calling getFaultCodeAsQName returned <" + name2.getLocalPart()
    ...
    private void SetGetFaultStringLocale1Test(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            if (result != null) {
                if (!result.equals(expected)) {
                    TestUtil.logErr("setFaultString(string,Locale)/getFaultStringLocale behaved incorrectly");
                    TestUtil.logErr("expected=" + expected);
                    pass = false;
                }
                TestUtil.logMsg("result=" + result);
    ...
    private void getFaultStringLocale1SOAP12Test(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            if (result == null) {
                ...
                TestUtil.logMsg("getFaultStringLocale() returned a non-null result (expected)");
                TestUtil.logMsg("result=" + result);
        ...
        try {
            ...
            while (i.hasNext()) {
                ...
                if (o instanceof QName) {
                    ...
                    TestUtil.logErr("An object that is not an instance of QName was returned");
                    TestUtil.logErr("The object is:" + o);
                    pass = false;
                }
                j++;
            ...
            if (!found1) {
                TestUtil.logErr("The following Subcode was not received: '" + expected1 + "'");
                pass = false;
            }
            if (!found2) {
                TestUtil.logErr("The following Subcode was not received: '" + expected2 + "'");
                pass = false;
            }
    ...
    private void getFaultSubcodes2Test(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            TestUtil.logMsg("Appending a second fault Subcode");
            sf.appendFaultSubcode(expected2);
            TestUtil.logMsg("Getting FaultSubCodes from SOAPFault for the first time");
            Iterator i = sf.getFaultSubcodes();
            int j = 0;
            while (i.hasNext()) {
                Object o = i.next();
            ...
            TestUtil.logMsg("Getting FaultSubCodes from SOAPFault for the second time");
    ...
    private void AppendFaultSubcodeSOAPExceptionTest(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            setup();
            TestUtil.logMsg("Calling appendFaultSubcode() with unqualified QName object" + " must throw SOAPException");

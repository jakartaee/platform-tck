...
public class URLClient extends EETest {
     ...
     *
     * @test_Strategy: Call AttachmentPart.addMimeHeader(String,String) method and verify creation of a new MIMEHeader
     * object. Add a single header.
     *
     ...
     *
     * @test_Strategy: Call AttachmentPart.addMimeHeader(String,String) method and verify creation of a new MimeHeader
     * object. Add two headers that have different values.
     *
     * Description: Construct a MimeHeader object.
     */
     ...
     *
     * @test_Strategy: Call AttachmentPart.addMimeHeader(String,String) method and verify creation of a new MimeHeader
     * object. Attempt to add an empty header and value.
     *
     * Description: Construct a MimeHeader object.
     */
     ...
     *
     * @test_Strategy: Call AttachmentPart.addMimeHeader(String,String) method and verify creation of a new MimeHeader
     * object. Attempt to add an empty header and non-empty value.
     *
     * Description: Construct a MimeHeader object.
     */
     ...
     *
     * @test_Strategy: Call AttachmentPart.addMimeHeader(String,String) method and verify creation of a new MimeHeader
     * object. Attempt to add a non-empty header and empty value.
     *
     * Description: Construct a MimeHeader object.
     */
     ...
     *
     * @test_Strategy: Call AttachmentPart.addMimeHeader(String,String) method and verify creation of a new MimeHeader
     * object. Attempt to add a null header and null value.
     *
     * Description: Construct a MimeHeader object.
     */
     ...
     *
     * @test_Strategy: Call AttachmentPart.getMimeHeader(String) method and verify return of a the MimeHeader object. Get a
     * single header.
     *
     ...
     * @assertion_ids: SAAJ:JAVADOC:145;
     *
     * @test_Strategy: Call AttachmentPart.getMimeHeader(String) method and verify return of the MimeHeader object. Get
     * single header from multiple headers.
     *
     * Description: Retrieve a MimeHeader object.
     */
     ...
     *
     * @test_Strategy: Call AttachmentPart.getMimeHeader(String) method and verify return of the MimeHeader object. Get
     * header that contains two entries.
     *
     * Description: Retrieve a MimeHeader object.
     */
     ...
     * @assertion_ids: SAAJ:JAVADOC:145;
     *
     * @test_Strategy: Call AttachmentPart.getMimeHeader(String) method and verify return of the MimeHeader object. Attempt
     * to get a header that doesn't exist
     *
     * Description: Retrieve a MimeHeader object.
     */
     ...
     *
     * @test_Strategy: Call AttachmentPart.getAllMimeHeaders() method and verify return of all MimeHeader objects.
     *
     ...
     * @assertion_ids: SAAJ:JAVADOC:148;
     *
     * @test_Strategy: Call AttachmentPart.getAllMimeHeaders() method and verify return of all MimeHeader objects. Get
     * multiple.
     *
     * Description: Retrieve a MimeHeader object.
     */
     ...
     *
     * @test_Strategy: Call AttachmentPart.getAllMimeHeaders() method and verify return of all MimeHeader objects. Get
     * single header that contains mulitple entries.
     *
     * Description: Retrieve a MimeHeader object.
     */
     ...
     * @assertion_ids: SAAJ:JAVADOC:148;
     *
     * @test_Strategy: Call AttachmentPart.getAllMimeHeaders() method and verify return of all MimeHeader objects. Attempt
     * to get all headers when none exist.
     *
     * Description: Retrieve a MimeHeader object.
     */
     ...
     *
     * @test_Strategy: Call AttachmentPart.removeAllMimeHeaders() method and verify removal of all MimeHeader objects.
     ...
     *
     * @test_Strategy: Call AttachmentPart.removeAllMimeHeaders() method and verify removal of all MimeHeader objects.
     * Remove header that contains multiple entries.
     *
     * Description: Remove a MimeHeader object.
     */
     ...
     *
     * @test_Strategy: Call AttachmentPart.removeAllMimeHeaders() method and verify removal of all MimeHeader objects.
     * Remove headers when none exist.
     *
     * Description: Remove a MimeHeader object.
     */
     ...
     *
     * @test_Strategy: Call AttachmentPart.setMimeHeader(String,String) method and verify return of a the MimeHeader object.
     * Set exist header.
     *
     ...
     * @assertion_ids: SAAJ:JAVADOC:146;
     *
     * @test_Strategy: Call AttachmentPart.setMimeHeader(String,String) method and verify return of the MimeHeader object.
     * Set existing header from list of two headers.
     *
     * Description: Replace a MimeHeader object.
     */
     ...
     *
     * @test_Strategy: Call AttachmentPart.setMimeHeader(String,String) method and verify return of the MimeHeader object.
     * Set existing header that contains multiple values.
     *
     ...
     *
     * @test_Strategy: Call AttachmentPart.removeMimeHeader(String) method and verify return of a the MimeHeader object.
     * Remove single header.
     *
     * Description: Remove a MimeHeader object.
     */
     ...
     * @assertion_ids: SAAJ:JAVADOC:143;
     *
     * @test_Strategy: Call AttachmentPart.removeMimeHeader(String) method and verify return of the MimeHeader object.
     * Remove single header from list of two.
     *
     * Description: Replace a MimeHeader object.
     */
     ...
     *
     * @test_Strategy: Call AttachmentPart.removeMimeHeader(String) method and verify return of the MimeHeader object.
     * Remove single header that contains multiple values.
     *
     * Description: Remove a MimeHeader object.
     */
     ...
     *
     * @test_Strategy: Call AttachmentPart.removeMimeHeader(String) method and verify return of the MimeHeader object.
     * Remove header that doesn't exist
     *
     * Description: Remove a MimeHeader object.
     */
     ...
     *
     * @test_Strategy: Call AttachmentPart.getMatchingMimeHeaders(String[]) method and verify return of a the MimeHeader
     * object.
     *
     ...
     * @assertion_ids: SAAJ:JAVADOC:149;
     *
     * @test_Strategy: Call AttachmentPart.getMatchingMimeHeaders(String[]) method and verify return of the MimeHeader
     * object. Get single header from list of two.
     *
     * Description: Retrieve a MimeHeader object.
     */
     ...
     *
     * @test_Strategy: Call AttachmentPart.getMatchingMimeHeaders(String[]) method and verify return of the MimeHeader
     * object. Get single header that contains multiple values.
     *
     * Description: Retrieve a MimeHeader object.
     */
     ...
     *
     * @test_Strategy: Call AttachmentPart.getMatchingMimeHeaders(String[]) method and verify return of the MimeHeader
     * object. Attempt to get a header that doesn't exist
     *
     * Description: Retrieve a MimeHeader object.
     */
     ...
     *
     * @test_Strategy: Call AttachmentPart.getMatchingMimeHeaders(String[]) method and verify return of the MimeHeader
     * object. Attempt to get a headers and a non-existent header
     *
     * Description: Retrieve a MimeHeader object.
     */
     ...
     *
     * @test_Strategy: Call AttachmentPart.getNonMatchingMimeHeaders(String[]) method and verify return of a the MimeHeader
     * object. Get single header.
     *
     * Description: Retrieve a MimeHeader object.
     */
     ...
     * @assertion_ids: SAAJ:JAVADOC:150;
     *
     * @test_Strategy: Call AttachmentPart.getNonMatchingMimeHeaders(String[]) method and verify return of the MimeHeader
     * object. Get single header from list of two.
     *
     * Description: Retrieve a MimeHeader object.
     */
     ...
     *
     * @test_Strategy: Call AttachmentPart.getNonMatchingMimeHeaders(String[]) method and verify return of the MimeHeader
     * object. Attempt to get header that results in no headers being returned.
     *
     * Description: Retrieve a MimeHeader object.
     */
     ...
     *
     * @test_Strategy: Call AttachmentPart.getNonMatchingMimeHeaders(String[]) method and verify return of the MimeHeader
     * object. Attempt to get a header and a non-existent header
     *
     * Description: Retrieve a MimeHeader object.
     */
     ...
     *
     * @test_Strategy: Call AttachmentPart.setContentId(String) method and verify no errors occur. Attempt to set id to a
     * valid value.
     *
     ...
     * @assertion_ids: SAAJ:JAVADOC:140;
     *
     * @test_Strategy: Call AttachmentPart.setContentId(String) method and verify no errors occur.
     *
     ...
     *
     * @test_Strategy: Call AttachmentPart.setContentId(String) method and verify no errors occur. Attempt to set id to a
     * valid value then to another string.
     *
     * Description: Set the Mime Header named Content-Id
     */
     ...
     *
     * @test_Strategy: Call AttachmentPart.getContentId() method and verify correct content id is returned. Get Id.
     *
     ...
     * @assertion_ids: SAAJ:JAVADOC:139;
     *
     * @test_Strategy: Call AttachmentPart.getContentId() method and verify correct content id is returned. Get id after it
     * has been set twice in a row.
     *
     * Description: Get the Mime Header named Content-Id
     */
     ...
     *
     * @test_Strategy: Call AttachmentPart.setContentLocation(String) method and verify no errors occur. Set URL location
     *
     * Description: Set the Mime Header named Content-Id
     */
     ...
     * @assertion_ids: SAAJ:JAVADOC:141;
     *
     * @test_Strategy: Call AttachmentPart.setContentLocation(String) method and verify no errors occur. Set empty string
     * location.
     *
     * Description: Set the Mime Header named Content-Id
     */
     ...
     * @assertion_ids: SAAJ:JAVADOC:141;
     *
     * @test_Strategy: Call AttachmentPart.setContentLocation(String) method and verify no errors occur. Set URI location
     *
     * Description: Set the Mime Header named Content-Id
     */
     ...
     * @assertion_ids: SAAJ:JAVADOC:141;
     *
     * @test_Strategy: Call AttachmentPart.setContentLocation(String) method and verify no errors occur. Set location twice.
     *
     * Description: Set the Mime Header named Content-Id
     */
     ...
     * @assertion_ids: SAAJ:JAVADOC:141;
     *
     * @test_Strategy: Call AttachmentPart.setContentLocation(String) method and verify no errors occur. Set location to
     * null.
     *
     * Description: Set the Mime Header named Content-Id
     */
     ...
     *
     * @test_Strategy: Call AttachmentPart.getContentLocation() method and verify correct content location is returned. Get
     * URL location.
     *
     * Description: Get the Mime Header named Content-Id
     */
     ...
     * @assertion_ids: SAAJ:JAVADOC:138;
     *
     * @test_Strategy: Call AttachmentPart.getContentLocation(String) method and verify correct content location is
     * returned. Get location after it has been set twice.
     *
     * Description: Set the Mime Header named Content-Id
     */
     ...
     *
     * @test_Strategy: Call AttachmentPart.setContent(Object, String) method passing a null and verify exception is thrown.
     *
     ...
     * @assertion_ids: SAAJ:JAVADOC:129;
     *
     * @test_Strategy: Call AttachmentPart.setContent(Object, String) method passing an invalid object type verify exception
     * is thrown.
     *
     * Description: Set the Content
     */
     ...
     * @assertion_ids: SAAJ:JAVADOC:129;
     *
     * @test_Strategy: Call AttachmentPart.setContent(Object, String) method passing invalid object types and verify
     * exception is thrown.
     *
     * Description: Set the Content
     */
     ...
     *
     * @test_Strategy: Call AttachmentPart.getContent() method and verify that a StreamSource object is returned properly
     * for the text/xml mime type.
     *
     ...
     * @assertion_ids: SAAJ:JAVADOC:123; SAAJ:JAVADOC:124;
     *
     * @test_Strategy: Call AttachmentPart.getContent() method and verify that an InputStream object or String object is
     * returned properly for the text/html mime type.
     *
     * Description: Get the Content
     */
     ...
     * @assertion_ids: SAAJ:JAVADOC:123; SAAJ:JAVADOC:124;
     *
     * @test_Strategy: Call AttachmentPart.getContent() method and verify that an Image object is returned properly for the
     * image/gif mime type.
     *
     * Description: Get the Content
     */
     ...
     * @assertion_ids: SAAJ:JAVADOC:123; SAAJ:JAVADOC:124;
     *
     * @test_Strategy: Call AttachmentPart.getContent() method and verify that a String object is returned properly for the
     ...
     *
     * @test_Strategy: Call AttachmentPart.setDataHandler(DataHandler) with valid object
     *
     ...
     * @assertion_ids: SAAJ:JAVADOC:136;
     *
     * @test_Strategy: Call AttachmentPart.setDataHandler(DataHandler) with a null object.
     *
     * Description: Set the DataHandler object
     */
     ...
     * @assertion_ids: SAAJ:JAVADOC:136;
     *
     * @test_Strategy: Call AttachmentPart.setDataHandler(DataHandler) twice and verify no errors occur.
     *
     * Description: Set the DataHandler object
     */
     ...
     *
     * @test_Strategy: Call AttachmentPart.getDataHandler() and verify the contents of the data.
     *
     ...
     * @assertion_ids: SAAJ:JAVADOC:134; SAAJ:JAVADOC:135;
     *
     * @test_Strategy: Call AttachmentPart.getDataHandler() when no DataHandler has been set, should result in an exception.
     *
     * Description: Get the DataHandler object
     */
     ...
     * @assertion_ids: SAAJ:JAVADOC:134; SAAJ:JAVADOC:135;
     *
     * @test_Strategy: Call AttachmentPart.getDataHandler() twice and verify the contents of the data.
     *
     * Description: Get the DataHandler object
     */
     ...
     * @assertion_ids: SAAJ:JAVADOC:120; SAAJ:JAVADOC:121;
     *
     * @test_Strategy: Call AttachmentPart.getSize() after AttachmentPart. setContent is done. A SOAPException should be
     * thrown.
     *
     * Description: Get the size of the AttachmentPart Object
     */
     ...
     * @assertion_ids: SAAJ:JAVADOC:120; SAAJ:JAVADOC:121;
     *
     * @test_Strategy: Call AttachmentPart.getSize() after AttachmentPart. setDataHandler is done.
     *
     * Description: Get the size of the AttachmentPart Object
     */
     ...
     * @assertion_ids: SAAJ:JAVADOC:122;
     *
     * @test_Strategy: Call AttachmentPart.clearContent() after setting content twice.
     *
     * Description: Clear content of AttachmentPart object
     */
     ...
     * @assertion_ids: SAAJ:JAVADOC:122;
     *
     * @test_Strategy: Call AttachmentPart.clearContent() after setting content and mime headers. Mime Headers should remain
     * untouched.
     *
     * Description: Clear content of AttachmentPart object
     */
     ...
     * @assertion_ids: SAAJ:JAVADOC:122;
     *
     * @test_Strategy: Call AttachmentPart.clearContent() when no content has been set.
     *
     * Description: Clear content of AttachmentPart object
     */
     ...
     *
     * @test_Strategy: Call AttachmentPart.setBase64Content/getBase64Content and verify correct behavior.
     */
     ...
     *
     * @test_Strategy: Call AttachmentPart.setBase64Content and test for IOException.
     */
     ...
     * @assertion_ids: SAAJ:JAVADOC:133;
     *
     * @test_Strategy: Call AttachmentPart.setBase64Content and test for NullPointerException.
     */
     ...
     * @assertion_ids: SAAJ:JAVADOC:133;
     *
     * @test_Strategy: Call AttachmentPart.setBase64Content and test for SOAPException.
     */
     ...
     *
     * @test_Strategy: Call AttachmentPart.getBase64Content and test for SOAPException.
     */
     ...
     *
     * @test_Strategy: Call AttachmentPart.setRawContent/getRawContent and verify correct behavior.
     */
     ...
     *
     * @test_Strategy: Call AttachmentPart.setRawContentBytes/getRawContentBytes and verify correct behavior.
     */
     ...
     *
     * @test_Strategy: Call AttachmentPart.setRawContentBytes with a null byte[] array and verify correct behavior.
     */
    public void SetRawContentBytesSOAPOrNullPointerExceptionTest1() throws Fault {
        try {
            ...
            if (!pass)
                throw new Fault("SetRawContentBytesSOAPOrNullPointerExceptionTest1 failed");

        } catch (Exception e) {
            TestUtil.logErr("Caught exception: " + e.getMessage());
            e.printStackTrace();
            throw new Fault("SetRawContentBytesSOAPOrNullPointerExceptionTest1 failed", e);
        }
    }
     ...
     *
     * @test_Strategy: Call AttachmentPart.getRawContentBytes on an empty Attachment object and verify correct behavior.
     */
    public void GetRawContentBytesSOAPOrNullPointerExceptionTest1() throws Fault {
        try {
            ...
            if (!pass)
                throw new Fault("GetRawContentBytesSOAPOrNullPointerExceptionTest1 failed");

        } catch (Exception e) {
            TestUtil.logErr("Caught exception: " + e.getMessage());
            e.printStackTrace();
            throw new Fault("GetRawContentBytesSOAPOrNullPointerExceptionTest1 failed", e);
        }
    }
     ...
     * @assertion_ids: SAAJ:JAVADOC:131;
     *
     * @test_Strategy: Call AttachmentPart.setRawContent and test for NullPointerException.
     */

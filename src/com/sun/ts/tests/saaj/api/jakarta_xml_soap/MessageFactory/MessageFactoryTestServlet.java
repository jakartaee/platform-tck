...
public class MessageFactoryTestServlet extends HttpServlet {
    ...
    private void createMessageTest2(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            TestUtil.logMsg("Create SOAPMessage msg2 using createMessage(" + "MimeHeaders, InputStream)");
    ...
    private void newInstanceTest1(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            TestUtil.logMsg("Create MessageFactory object for default implementation");
    ...
    private void newInstanceTest2(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            if (mf == null) {
                TestUtil.logErr("MessageFactory.newInstance(SOAPConstants." + "SOAP_1_1_PROTOCOL) returned null");
                pass = false;
            } else {
                TestUtil.logMsg("Create SOAPMessage from MessageFactory object");
                SOAPMessage msg = mf.createMessage();
    ...
    private void newInstanceTest3(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            if (mf == null) {
                TestUtil.logErr("MessageFactory.newInstance(SOAPConstants." + "SOAP_1_2_PROTOCOL) returned null");
                pass = false;
            } else {
                TestUtil.logMsg("Create SOAPMessage from MessageFactory object");
                SOAPMessage msg = mf.createMessage();
    ...
    private void newInstanceTest4(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            if (mf == null) {
                TestUtil.logErr("MessageFactory.newInstance(" + "DYNAMIC_SOAP_PROTOCOL) returned null");
                pass = false;
            } else {
    ...
    private void newInstanceTest4b(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            if (mf == null) {
                ...
                TestUtil.logMsg("Create SOAPMessage from Dynamic MessageFactory object");
                TestUtil.logMsg("Call MessageFactory.createMessage() and expect UnsupportedOperationException");
                mf.createMessage();
    ...
    private void newInstanceTest6(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            if (mf == null) {
                TestUtil.logErr("MessageFactory.newInstance(" + "DEFAULT_SOAP_PROTOCOL) returned null");
                pass = false;
            } else {
                TestUtil.logMsg("Create SOAPMessage from MessageFactory object");
                SOAPMessage msg = mf.createMessage();

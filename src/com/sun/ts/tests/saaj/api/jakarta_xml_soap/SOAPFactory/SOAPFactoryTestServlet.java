...
public class SOAPFactoryTestServlet extends HttpServlet {
    ...
    private void createElementTest1(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            if (sf == null) {
                ...
                if (se == null) {
                    TestUtil.logErr("createElementTest1() could not create SOAPElement object");
                    pass = false;
                } else {
    ...
    private void createElementTest2(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            if (sf == null) {
                ...
                if (se == null) {
                    TestUtil.logErr("createElementTest2() could not create SOAPElement object");
                    pass = false;
                } else {
    ...
    private void createElementTest3(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            if (sf == null) {
                ...
                TestUtil.logMsg("Create SOAPElement object with localName=MyName1" + ", prefix=MyPrefix1, uri=MyUri1");
                SOAPElement se = sf.createElement("MyName1", "MyPrefix1", "MyUri1");
                if (se == null) {
                    TestUtil.logErr("createElementTest3() could not create SOAPElement object");
                    pass = false;
                } else {
                    Name name = se.getElementName();
                    String localName = name.getLocalName();
    ...
    private void createElementTest4(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            if (sf == null) {
                ...
                TestUtil.logMsg("Create QName object with localName=MyName1, " + "prefix=MyPrefix1, uri=MyUri1");
                QName name = new QName("MyUri1", "MyName1", "MyPrefix1");
                TestUtil.logMsg("Create SOAPElement object with above QName object");
                SOAPElement se = sf.createElement(name);
                if (se == null) {
                    TestUtil.logErr("createElementTest4() could not create SOAPElement object");
                    pass = false;
                } else {
    ...
    private void createElementTest5(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            if (sf == null) {
                ...
                TestUtil.logMsg("Calling SOAPFactory.createElement(org.w3c.dom.Element)");
                SOAPElement se = sf.createElement(de);
                XMLUtils.XmlDumpDOMNodes(se);
                TestUtil.logMsg("Check that DOMElement and SOAPElement names are equal");
                ...
                if (!de.getNodeName().equals(se.getNodeName())
                    ...
                    TestUtil.logErr("Got: <URI=" + se.getNamespaceURI() + ", PREFIX=" + se.getPrefix() + ", NAME="
                            + se.getNodeName() + ">");
                    TestUtil.logErr("Expected: <URI=" + de.getNamespaceURI() + ", PREFIX=" + de.getPrefix() + ", NAME="
                            + de.getNodeName() + ">");
                    pass = false;
                }
            }
    ...
    private void createElementTest6(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            if (sf == null) {
                ...
                TestUtil.logMsg("Check the two SOAPElement's for equality and sameness");
                ...
                if (!se1.getNodeName().equals(se2.getNodeName())
                    ...
                    TestUtil.logErr("Node names are not equal");
                    TestUtil.logErr("Got: <URI=" + se1.getNamespaceURI() + ", PREFIX=" + se1.getPrefix() + ", NAME="
                            + se1.getNodeName() + ">");
    ...
    private void createNameTest2(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            if (sf == null) {
                ...
                TestUtil.logMsg("Create Name object localName=MyName1, " + "prefix=MyPrefix1, uri=MyUri1");
            ...
            if (factory == null) {
                ...
                if (SOAP_Util.getSOAPVersion().equals(SOAP_Util.SOAP11)) {
                    ...
                    if (sf == null) {
                        ...
                        TestUtil.logMsg("Expected FaultCode=" + SOAPConstants.SOAP_RECEIVER_FAULT);
                        ...
                        if (i == null) {
                            TestUtil.logErr("Call to getFaultReasonTexts() returned null iterator");
                            pass = false;
                        } else {
                            String reason = "";
    ...
    private void createFaultSOAPExceptionTest1(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            SOAPFactory factory = SOAP_Util.getSOAPFactory();
            if (factory == null) {
                TestUtil.logErr("createFaultSOAPExceptionTest1() could not create SOAPFactory object");
                pass = false;
            } else {
                if (SOAP_Util.getSOAPVersion().equals(SOAP_Util.SOAP11)) {
                    SOAPFault sf = factory.createFault(
                            "This is the fault reason.", new QName("http://MyNamespaceURI.org/", "My Fault Code"));
                } else {
                    SOAPFault sf = factory.createFault(
                            "This is the fault reason.", new QName("http://MyNamespaceURI.org/", "My Fault Code"));
                    TestUtil.logErr("Did not throw expected SOAPException");

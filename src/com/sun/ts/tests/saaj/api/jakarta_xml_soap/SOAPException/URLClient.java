...
public class URLClient extends EETest {
    ...
    public void SOAPExceptionConstructor1Test() throws Fault {
        boolean pass = true;
        try {
            TestUtil.logMsg("SOAPExceptionConstructor1Test: call SOAPException() constructor");
    ...
    public void SOAPExceptionConstructor2Test() throws Fault {
        boolean pass = true;
        try {
            TestUtil.logMsg("SOAPExceptionConstructor2Test: call SOAPException(String) constructor");
            TestUtil.logMsg("Creating url to test servlet.....");
            url = tsurl.getURL(PROTOCOL, hostname, portnum, SOAPEXCEPTION_TESTSERVLET);
            TestUtil.logMsg(url.toString());
            for (int i = 0; i < 2; i++) {
    ...
    public void SOAPExceptionConstructor3Test() throws Fault {
        boolean pass = true;
        try {
            TestUtil.logMsg("SOAPExceptionConstructor3Test: call SOAPException(String, Throwable) constructor");
            TestUtil.logMsg("Creating url to test servlet.....");
            url = tsurl.getURL(PROTOCOL, hostname, portnum, SOAPEXCEPTION_TESTSERVLET);
            TestUtil.logMsg(url.toString());
            for (int i = 0; i < 2; i++) {
    ...
    public void SOAPExceptionConstructor4Test() throws Fault {
        boolean pass = true;
        try {
            TestUtil.logMsg("SOAPExceptionConstructor4Test: call SOAPException(String, Throwable) constructor");
            TestUtil.logMsg("Creating url to test servlet.....");
            url = tsurl.getURL(PROTOCOL, hostname, portnum, SOAPEXCEPTION_TESTSERVLET);
            TestUtil.logMsg(url.toString());
            for (int i = 0; i < 2; i++) {
    ...
    public void InitGetCauseTest() throws Fault {
        boolean pass = true;
        try {
            TestUtil.logMsg("InitGetCauseTest: call SOAPException.initCause(Throwable)");

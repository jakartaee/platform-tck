...
public class SOAPMessageTestServlet extends HttpServlet {
    ...
    private void setup() throws Exception {
        ...
        TestUtil.logMsg("Create SOAP Attachment 3 (PLAIN/TEXT document) and add it");
    ...
    private void createAttachmentPartTest2(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            TestUtil.logMsg("Create SOAP Attachment (XML document) using DataHandler");
            msg.removeAllAttachments();
            ...
            if (ap != null) {
                TestUtil.logMsg("Verify attachment part is not empty and contents are correct");
                try {
                    Object o = ap.getContent();
                    InputStream is = null;
                    if (o == null) {
    ...
    private void createAttachmentPartTest3(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            TestUtil.logMsg("Create SOAP Attachment (XML document) with specified data and content type");
    ...
    private void getAttachmentsTest2(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            TestUtil.logMsg("get all attachments of MimeHeader Content-Type: text/xml");
    ...
    private void getAttachmentBySwaRefTest1(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            url1 = tsurl.getURL(
                    PROTOCOL, SOAP_Util.getHostname(), SOAP_Util.getPortnum(), cntxroot + XML_RESOURCE_FILE);
            url2 = tsurl.getURL(
                    PROTOCOL, SOAP_Util.getHostname(), SOAP_Util.getPortnum(), cntxroot + GIF_RESOURCE_FILE);
            url3 = tsurl.getURL(
                    PROTOCOL, SOAP_Util.getHostname(), SOAP_Util.getPortnum(), cntxroot + TXT_RESOURCE_FILE);
            url4 = tsurl.getURL(
                    PROTOCOL, SOAP_Util.getHostname(), SOAP_Util.getPortnum(), cntxroot + HTML_RESOURCE_FILE);
            url5 = tsurl.getURL(
                    PROTOCOL, SOAP_Util.getHostname(), SOAP_Util.getPortnum(), cntxroot + JPEG_RESOURCE_FILE);

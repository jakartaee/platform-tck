...
public class URLClient extends EETest {
    ...
    public void addAttachmentPartTest() throws Fault {
        boolean pass = true;
        try {
            TestUtil.logMsg("addAttachmentPartTest: add an attachmentpart to a SOAPMessage");
    ...
    public void countAttachmentsTest() throws Fault {
        boolean pass = true;
        try {
            TestUtil.logMsg("countAttachmentsTest: count number of attachments in SOAPMessage");
            TestUtil.logMsg("Creating url to test servlet.....");
            url = tsurl.getURL(PROTOCOL, hostname, portnum, TESTSERVLET);
            TestUtil.logMsg(url.toString());
            for (int i = 0; i < 2; i++) {
    ...
    public void getAttachmentsTest1() throws Fault {
        boolean pass = true;
        try {
            TestUtil.logMsg("getAttachmentsTest1: get number of attachments in SOAPMessage");
            TestUtil.logMsg("Creating url to test servlet.....");
            url = tsurl.getURL(PROTOCOL, hostname, portnum, TESTSERVLET);
            TestUtil.logMsg(url.toString());
            for (int i = 0; i < 2; i++) {
    ...
    public void getAttachmentsTest2() throws Fault {
        boolean pass = true;
        try {
            TestUtil.logMsg("getAttachmentsTest2: get number of attachments in SOAPMessage");
            TestUtil.logMsg("Creating url to test servlet.....");
            url = tsurl.getURL(PROTOCOL, hostname, portnum, TESTSERVLET);
            TestUtil.logMsg(url.toString());
            for (int i = 0; i < 2; i++) {
    ...
    public void removeAllAttachmentsTest() throws Fault {
        boolean pass = true;
        try {
            TestUtil.logMsg("removeAllAttachmentsTest: remove attachments in SOAPMessage");
            TestUtil.logMsg("Creating url to test servlet.....");
            url = tsurl.getURL(PROTOCOL, hostname, portnum, TESTSERVLET);
            TestUtil.logMsg(url.toString());
            for (int i = 0; i < 2; i++) {
    ...
    public void removeAttachmentsTest() throws Fault {
        boolean pass = true;
        try {
            TestUtil.logMsg("removeAttachmentsTest: remove attachments in SOAPMessage");
            TestUtil.logMsg("Creating url to test servlet.....");
            url = tsurl.getURL(PROTOCOL, hostname, portnum, TESTSERVLET);
            TestUtil.logMsg(url.toString());
            for (int i = 0; i < 2; i++) {
    ...
    public void setContentDescriptionTest() throws Fault {
        boolean pass = true;
        try {
            TestUtil.logMsg("setContentDescriptionTest: set content description of SOAPMessage");
            TestUtil.logMsg("Creating url to test servlet.....");
            url = tsurl.getURL(PROTOCOL, hostname, portnum, TESTSERVLET);
            TestUtil.logMsg(url.toString());
            for (int i = 0; i < 2; i++) {
    ...
    public void getContentDescriptionTest() throws Fault {
        boolean pass = true;
        try {
            TestUtil.logMsg("getContentDescriptionTest: get content description of SOAPMessage");
            TestUtil.logMsg("Creating url to test servlet.....");
            url = tsurl.getURL(PROTOCOL, hostname, portnum, TESTSERVLET);
            TestUtil.logMsg(url.toString());
            for (int i = 0; i < 2; i++) {
    ...
    public void createAttachmentPartTest1() throws Fault {
        boolean pass = true;
        try {
            TestUtil.logMsg("createAttachmentPartTest1: create empty attachment part");
            TestUtil.logMsg("Creating url to test servlet.....");
            url = tsurl.getURL(PROTOCOL, hostname, portnum, TESTSERVLET);
            TestUtil.logMsg(url.toString());
            for (int i = 0; i < 2; i++) {
    ...
    public void createAttachmentPartTest2() throws Fault {
        boolean pass = true;
        try {
            TestUtil.logMsg("createAttachmentPartTest2: create attachment part and populate with given DataHandler");
            TestUtil.logMsg("Creating url to test servlet.....");
            url = tsurl.getURL(PROTOCOL, hostname, portnum, TESTSERVLET);
            TestUtil.logMsg(url.toString());
            for (int i = 0; i < 2; i++) {
    ...
    public void writeToTest1() throws Fault {
        boolean pass = true;
        try {
            TestUtil.logMsg("writeToTest1: write a SOAPMessage without attachments to OutputStream");
            TestUtil.logMsg("Creating url to test servlet.....");
            url = tsurl.getURL(PROTOCOL, hostname, portnum, TESTSERVLET);
            TestUtil.logMsg(url.toString());
            for (int i = 0; i < 2; i++) {
    ...
    public void writeToTest2() throws Fault {
        boolean pass = true;
        try {
            TestUtil.logMsg("writeToTest2: write SOAPMessage with attachments to OutputStream");
            TestUtil.logMsg("Creating url to test servlet.....");
            url = tsurl.getURL(PROTOCOL, hostname, portnum, TESTSERVLET);
            TestUtil.logMsg(url.toString());
            for (int i = 0; i < 2; i++) {
    ...
    public void saveRequiredTest1() throws Fault {
        boolean pass = true;
        try {
            TestUtil.logMsg("saveRequiredTest1: verify SOAPMessage.saveRequired() is false");
            TestUtil.logMsg("Creating url to test servlet.....");
            url = tsurl.getURL(PROTOCOL, hostname, portnum, TESTSERVLET);
            TestUtil.logMsg(url.toString());
            for (int i = 0; i < 2; i++) {
    ...
    public void saveRequiredTest2() throws Fault {
        boolean pass = true;
        try {
            TestUtil.logMsg("saveRequiredTest2: verify SOAPMessage.saveRequired() is true");
            TestUtil.logMsg("Creating url to test servlet.....");
            url = tsurl.getURL(PROTOCOL, hostname, portnum, TESTSERVLET);
            TestUtil.logMsg(url.toString());
            for (int i = 0; i < 2; i++) {
    ...
    public void getMimeHeadersTest() throws Fault {
        boolean pass = true;
        try {
            TestUtil.logMsg("getMimeHeadersTest: verify SOAPMessage.saveRequired() is true");
            TestUtil.logMsg("Creating url to test servlet.....");
            url = tsurl.getURL(PROTOCOL, hostname, portnum, TESTSERVLET);
            TestUtil.logMsg(url.toString());
            for (int i = 0; i < 2; i++) {

...
public class SOAPHeaderTestServlet extends HttpServlet {
    ...
    private void addNotUnderstoodHeaderElementSOAP11Test(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            TestUtil.logMsg("Calling addNotUnderstoodHeaderElement() should" + " throw UnsupportedOperationException");
    ...
    private void addNotUnderstoodHeaderElementSOAP12Test(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            if (pass) {
                ...
                TestUtil.logMsg("Validate the URI which must be " + SOAPConstants.URI_NS_SOAP_1_2_ENVELOPE);
                ...
                if (!localName.equals("NotUnderstood")) {
                    TestUtil.logErr("Got LocalName: " + localName + ", Expected LocalName: NotUnderstood");
                    pass = false;
                }
            }
        } catch (Exception e) {
        ...
        try {
            ...
            if (pass) {
                ...
                if (SOAP_Util.getSOAPVersion().equals("soap11")) {
                    TestUtil.logMsg("Validate the URI which must be " + SOAPConstants.URI_NS_SOAP_ENVELOPE);
                ...
                if (!localName.equals("Upgrade")) {
                    TestUtil.logErr("Got LocalName: " + localName + ", Expected LocalName: Upgrade");
                    pass = false;
                }
            }
        } catch (Exception e) {
    ...
    private void examineHeaderElementsTest1(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            if (SOAP_Util.getSOAPVersion().equals(SOAP_Util.SOAP11)) {
                ...
                TestUtil.logMsg("Examing SOAPHeaderElements with role role-URI again ...");
                iterator = hdr.examineHeaderElements("role-URI");
            }
            if (!iterator.hasNext()) {
                TestUtil.logErr("no elements in iterator - unexpected");
    ...
    private void examineHeaderElementsTest4(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            if (cnt != 4) {
                TestUtil.logErr("SOAPHeaderElement count mismatch: expected 4, received " + cnt);
                pass = false;
            }
    ...
    private void examineMustUnderstandHeaderElementsTest2(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            if (iterator.hasNext()) {
                ...
                TestUtil.logMsg("Good no SOAPHeaderElements - MustUnderstand is false.");
            }
    ...
    private void extractHeaderElementsTest1(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            if (SOAP_Util.getSOAPVersion().equals(SOAP_Util.SOAP11)) {
                ...
                TestUtil.logMsg("Extract SOAPHeaderElements with role role-URI again ...");
                iterator = hdr.extractHeaderElements("role-URI");
            }
            if (iterator.hasNext()) {
                TestUtil.logErr("elements in iterator - unexpected");

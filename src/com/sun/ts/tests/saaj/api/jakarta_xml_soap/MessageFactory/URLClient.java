...
public class URLClient extends EETest {
    ...
    public void newInstanceTest2() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Call MessageFactory.newInstance(SOAPConstants." + "SOAP11_PROTOCOL)");
            TestUtil.logMsg("Creating url to test servlet.....");
            url = tsurl.getURL(PROTOCOL, hostname, portnum, SOAPMESSAGEFACTORY_TESTSERVLET);
            TestUtil.logMsg(url.toString());
            TestUtil.logMsg("Sending post request to test servlet.....");
    ...
    public void newInstanceTest3() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Call MessageFactory.newInstance(SOAPConstants." + "SOAP12_PROTOCOL)");
            TestUtil.logMsg("Creating url to test servlet.....");
            url = tsurl.getURL(PROTOCOL, hostname, portnum, SOAPMESSAGEFACTORY_TESTSERVLET);
            TestUtil.logMsg(url.toString());
            TestUtil.logMsg("Sending post request to test servlet.....");
    ...
    public void newInstanceTest4() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Call MessageFactory.newInstance(SOAPConstants." + "DYNAMIC_PROTOCOL)");
            TestUtil.logMsg("Creating url to test servlet.....");
            url = tsurl.getURL(PROTOCOL, hostname, portnum, SOAPMESSAGEFACTORY_TESTSERVLET);
            TestUtil.logMsg(url.toString());
            TestUtil.logMsg("Sending post request to test servlet.....");
    ...
    public void newInstanceTest4b() throws Fault {
        boolean pass = true;
        try {
            TestUtil.logMsg("newInstanceTest4b: create Dynamic MessageFactory object");
            TestUtil.logMsg("Call MessageFactory.newInstance(SOAPConstants." + "DYNAMIC_PROTOCOL)");
            TestUtil.logMsg("Creating url to test servlet.....");
            url = tsurl.getURL(PROTOCOL, hostname, portnum, SOAPMESSAGEFACTORY_TESTSERVLET);
            TestUtil.logMsg(url.toString());
    ...
    public void newInstanceTest6() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Call MessageFactory.newInstance(SOAPConstants." + "DEFAULT_PROTOCOL)");
            TestUtil.logMsg("Creating url to test servlet.....");
            url = tsurl.getURL(PROTOCOL, hostname, portnum, SOAPMESSAGEFACTORY_TESTSERVLET);
            TestUtil.logMsg(url.toString());
            TestUtil.logMsg("Sending post request to test servlet.....");

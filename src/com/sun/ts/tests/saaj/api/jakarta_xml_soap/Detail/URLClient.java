...
public class URLClient extends EETest {
    ...
    public void addDetailEntryTest1() throws Fault {
        boolean pass = true;
        try {
            TestUtil.logMsg("addDetailEntryTest1: add DetailEntry Name " + "object to this Detail object");
            TestUtil.logMsg("protocol=" + PROTOCOL + ", hostname=" + hostname + ", portnum=" + portnum + ", servlet="
                    + DETAIL_TESTSERVLET);
    ...
    public void addDetailEntryTest2() throws Fault {
        boolean pass = true;
        try {
            TestUtil.logMsg("addDetailEntryTest2: add DetailEntry Name " + "object to this Detail object");
            TestUtil.logMsg("protocol=" + PROTOCOL + ", hostname=" + hostname + ", portnum=" + portnum + ", servlet="
                    + DETAIL_TESTSERVLET);
            TestUtil.logMsg("Creating url to test servlet.....");
            url = tsurl.getURL(PROTOCOL, hostname, portnum, DETAIL_TESTSERVLET);
    ...
    public void getDetailEntriesTest() throws Fault {
        boolean pass = true;
        try {
            TestUtil.logMsg("getDetailEntriesTest: get a list of the " + "DetailEntry objects in this Detail object");
            TestUtil.logMsg("Creating url to test servlet.....");
            url = tsurl.getURL(PROTOCOL, hostname, portnum, DETAIL_TESTSERVLET);
            TestUtil.logMsg(url.toString());
            for (int i = 0; i < 2; i++) {

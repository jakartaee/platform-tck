...
public class URLClient extends EETest {
    ...
    public void createElementTest1() throws Fault {
        boolean pass = true;
        try {
            TestUtil.logMsg("createElementTest1: create a SOAPElement object constructor1");
            TestUtil.logMsg("Creating url to test servlet.....");
            url = tsurl.getURL(PROTOCOL, hostname, portnum, SOAPFACTORY_TESTSERVLET);
            TestUtil.logMsg(url.toString());
            for (int i = 0; i < 2; i++) {
    ...
    public void createElementTest2() throws Fault {
        boolean pass = true;
        try {
            TestUtil.logMsg("createElementTest2: create a SOAPElement object constructor2");
            TestUtil.logMsg("Creating url to test servlet.....");
            url = tsurl.getURL(PROTOCOL, hostname, portnum, SOAPFACTORY_TESTSERVLET);
            TestUtil.logMsg(url.toString());
            for (int i = 0; i < 2; i++) {
    ...
    public void createElementTest3() throws Fault {
        boolean pass = true;
        try {
            TestUtil.logMsg("createElementTest3: create a SOAPElement object constructor3");
            TestUtil.logMsg("Creating url to test servlet.....");
            url = tsurl.getURL(PROTOCOL, hostname, portnum, SOAPFACTORY_TESTSERVLET);
            TestUtil.logMsg(url.toString());
            for (int i = 0; i < 2; i++) {
    ...
    public void createElementTest4() throws Fault {
        boolean pass = true;
        try {
            TestUtil.logMsg("createElementTest4: create a SOAPElement object constructor4");
            TestUtil.logMsg("Creating url to test servlet.....");
            url = tsurl.getURL(PROTOCOL, hostname, portnum, SOAPFACTORY_TESTSERVLET);
            TestUtil.logMsg(url.toString());
            for (int i = 0; i < 2; i++) {
    ...
    public void createElementTest5() throws Fault {
        boolean pass = true;
        try {
            TestUtil.logMsg("createElementTest5: create a SOAPElement object constructor5");
            TestUtil.logMsg("Creating url to test servlet.....");
            url = tsurl.getURL(PROTOCOL, hostname, portnum, SOAPFACTORY_TESTSERVLET);
            TestUtil.logMsg(url.toString());
            for (int i = 0; i < 2; i++) {
    ...
    public void createElementTest6() throws Fault {
        boolean pass = true;
        try {
            TestUtil.logMsg("createElementTest6: create a SOAPElement object constructor5");
            TestUtil.logMsg("Creating url to test servlet.....");
            url = tsurl.getURL(PROTOCOL, hostname, portnum, SOAPFACTORY_TESTSERVLET);
            TestUtil.logMsg(url.toString());
            for (int i = 0; i < 2; i++) {
    ...
    public void createFaultSOAPExceptionTest1() throws Fault {
        boolean pass = true;
        try {
            TestUtil.logMsg("createFaultSOAPExceptionTest1: test for a SOAPException");
            TestUtil.logMsg("Creating url to test servlet.....");
            url = tsurl.getURL(PROTOCOL, hostname, portnum, SOAPFACTORY_TESTSERVLET);
            TestUtil.logMsg(url.toString());
            for (int i = 0; i < 2; i++) {

...
public class NodeTestServlet extends HttpServlet {
    ...
    private void setParentElementTest2(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            TestUtil.logMsg("Attempt to set parent element of SOAPHeaderElement to a body parent ...");
            try {
                ...
                TestUtil.logErr("no IllegalArgumentException or SOAPException, received exception " + e);
                pass = false;
            }
    ...
    private void setParentElementTest3(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            TestUtil.logMsg("Attempt to set parent element of SOAPHeaderElement to a null parent ...");
            try {
    ...
    private void getValueTest1(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            TestUtil.logMsg("get value of non-existant child Text Node should return null ...");
    ...
    private void getValueTest2(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            TestUtil.logMsg("get value of existant child Text Node should return the text nodes value (foo-bar) ...");
            String value = she.getValue();
            if (value == null) {
    ...
    private void setValueTest1(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            TestUtil.logMsg("Add a Text Node to SOAPHeaderElement initialized to \"foo-bar\"");
            she.addTextNode("foo-bar");
            TestUtil.logMsg("Getting value of SOAPHeaderElement should return \"foo-bar\"");
            String value = she.getValue();
            if (value == null) {
                TestUtil.logErr("value is null - unexpected");
                pass = false;
    ...
    private void setValueTest2(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            TestUtil.logMsg("Add a Text Node to child element \"child1\"" + " initialized to \"foo-bar\"");
    ...
    private void setValueTest3(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            TestUtil.logMsg("Try setting a value on SOAPHeaderElement which is not a Text Node");
        ...
        try {
            ...
            SOAPElement se = she.addChildElement("child1");
            TestUtil.logMsg("Try setting a value on a Node that is not a Text Node");
            TestUtil.logMsg("Try setting a value on child element which is not a Text Node");
            TestUtil.logMsg("This should throw an IllegalStateException");
            se.setValue("foo-bar");
            TestUtil.logErr("Did not throw expected IllegalStateException");
        } catch (IllegalStateException e) {

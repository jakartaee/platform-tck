...
public class SOAPElementTestServlet extends HttpServlet {
    ...
    private void addAttributeTest1(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            TestUtil.logMsg("Add attribute name = " + name.getLocalName() + ", value = " + value);
            ...
            if (se == null) {
                ...
                TestUtil.logErr("getAttribute() return wrong value, expected " + value + ", got "
    ...
    private void addAttributeTest2(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            String value = "MyValue1";
            TestUtil.logMsg("Add attribute qname = " + name.getLocalPart() + ", value = " + value);
            SOAPElement se = body.addAttribute(name, value);
            if (se == null) {
                TestUtil.logErr("addAttribute() did not return SOAPElement");
                pass = false;
    ...
    private void getAttributeValueTest1(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            TestUtil.logMsg("Add attribute name = " + name1.getLocalName() + ", value = " + value1);
            body.addAttribute(name1, value1);
            TestUtil.logMsg("Add attribute name = " + name2.getLocalName() + ", value = " + value2);
            ...
            if (!s1.equals(value1) && !s2.equals(value2)) {
                TestUtil.logErr("getAttribute() return wrong value, expected " + value1 + ", got " + s1);
                TestUtil.logErr("getAttribute() return wrong value, expected " + value2 + ", got " + s2);
                pass = false;
            }
        } catch (Exception e) {
            TestUtil.logErr("Exception: " + e);
    ...
    private void getAttributeValueTest2(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            String value2 = "MyValue2";
            TestUtil.logMsg("Add attribute qname = " + name1.getLocalPart() + ", value = " + value1);
            body.addAttribute(name1, value1);
            TestUtil.logMsg("Add attribute qname = " + name2.getLocalPart() + ", value = " + value2);
            body.addAttribute(name2, value2);
            String s1 = body.getAttributeValue(name1);
            String s2 = body.getAttributeValue(name2);
            if (s1.equals(value1) && s2.equals(value2)) TestUtil.logMsg("getAttribute() test PASSED");
            else {
    ...
    private void getAllAttributesTest(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            TestUtil.logMsg("Add attribute name1 = " + name1.getLocalName() + ", value1 = " + value1);
            body.addAttribute(name1, value1);
            TestUtil.logMsg("Add attribute name2 = " + name2.getLocalName() + ", value2 = " + value2);
            body.addAttribute(name2, value2);
            TestUtil.logMsg("Add attribute name3 = " + name3.getLocalName() + ", value3 = " + value3);
            ...
            if (count != 3) {
                TestUtil.logErr("Wrong iterator count returned of " + count + ", expected 3");
                pass = false;
            } else {
                ...
                while (i.hasNext()) {
                    ...
                    if (name.equals(name1)) foundName1 = true;
                    else if (name.equals(name2)) foundName2 = true;
                    else if (name.equals(name3)) foundName3 = true;
                    else {
                ...
                if (!foundName1 || !foundName2 || !foundName3) {
                    TestUtil.logErr("Did not find all names of MyAttr1, " + "MyAttr2, MyAttr3");
                    pass = false;
                }
            }
        } catch (Exception e) {
    ...
    private void removeAttributeTest1(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            TestUtil.logMsg("Remove attribute name = " + name.getLocalName() + ", value = " + value);
            ...
            if (pass) {
                ...
                if (s != null) {
                    TestUtil.logErr("getAttributeValue() returned wrong value," + " expected null, got \"" + s + "\"");
                    pass = false;
                }
            }
        } catch (Exception e) {
    ...
    private void removeAttributeTest2(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            TestUtil.logMsg("Add attribute qname = " + name.getLocalPart() + ", value = " + value);
            body.addAttribute(name, value);
            TestUtil.logMsg("Remove attribute qname = " + name.getLocalPart() + ", value = " + value);
            boolean b = body.removeAttribute(name);
            if (!b) {
                TestUtil.logErr("removeAttribute() did not return true");
    ...
    private void getElementNameTest(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            setup();
            TestUtil.logMsg(
                    "Get element name of SOAPBody = " + body.getElementName().getLocalName());
            TestUtil.logMsg("Get element name of SOAPEnvelope = "
                    + envelope.getElementName().getLocalName());
            TestUtil.logMsg(
                    "Get element name of SOAPHeader = " + hdr.getElementName().getLocalName());
        } catch (Exception e) {
            TestUtil.logErr("Exception: " + e);
            TestUtil.printStackTrace(e);
            pass = false;
    ...
    private void getElementQNameTest(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            setup();
            TestUtil.logMsg(
                    "Get element qname of SOAPBody = " + body.getElementQName().getLocalPart());
            TestUtil.logMsg("Get element qname of SOAPEnvelope = "
                    + envelope.getElementQName().getLocalPart());
            TestUtil.logMsg(
                    "Get element qname of SOAPHeader = " + hdr.getElementQName().getLocalPart());
        } catch (Exception e) {
            TestUtil.logErr("Exception: " + e);
            TestUtil.printStackTrace(e);
            pass = false;
    ...
    private void addNamespaceDeclarationTest(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            String uri = "myURI";
            TestUtil.logMsg("Add namespace declaration: prefix=" + prefix + ", uri=" + uri);
    ...
    private void removeNamespaceDeclarationTest(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            TestUtil.logMsg("Remove namespace declaration: prefix=" + prefix + ", uri=" + uri);
            ...
            if (pass) {
                ...
                if (body.getNamespaceURI(prefix) != null) {
                    TestUtil.logErr("getNamespaceURI() returned wrong value, expected" + " null, got "
    ...
    private void getNamespacePrefixesTest(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            if (count != 1) {
                TestUtil.logErr("Wrong iterator count returned of " + count + ", expected 1");
                pass = false;
            } else {
    ...
    private void getNamespaceURITest(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            if (s.equals(uri)) TestUtil.logMsg("The namespace URI is correct");
            else {
                TestUtil.logErr("The namespace URI is wrong, expected " + uri + ", got " + s);
                pass = false;
            }
        } catch (Exception e) {
            TestUtil.logErr("Exception: " + e);
    ...
    private void addTextNodeTest1(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            setup();
            TestUtil.logMsg("Add text node to SOAPBody " + "with text <txt>This is text</txt>");
            ...
            if (se == null) {
                ...
                TestUtil.logErr("Returned " + s + ", Expected <txt>" + "This is text</txt>");
                pass = false;
            }
            if (pass) {
                ...
                if (count != ++countStart) {
                    TestUtil.logErr("Wrong iterator count returned of " + count + ", expected " + countStart);
                    pass = false;
                } else {
                    Object obj = null;
                    while (i.hasNext()) {
                        obj = i.next();
                        if (obj instanceof Text) break;
                    }
    ...
    private void addTextNodeSOAP11Test2(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            setup();
            TestUtil.logMsg("Add text node to SOAPHeader " + "with text <txt>This is text</txt>");
    ...
    private void addTextNodeSOAP12Test2(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            TestUtil.logMsg("This is illegal for a SOAP1.2 message (expect SOAPException)");
    ...
    private void setEncodingStyleSOAP12Test1(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            TestUtil.logMsg("For SOAP1.2 this is not allowed and must throw a SOAPException");
    ...
    private void getEncodingStyleSOAP11Test1(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            TestUtil.logMsg("Set encoding style on body to URI_NS_SOAP_ENCODING");
            body.setEncodingStyle(SOAPConstants.URI_NS_SOAP_ENCODING);
            TestUtil.logMsg("Get encoding style from body (should return " + "URI_NS_SOAP_ENCODING) value");
    ...
    private void getEncodingStyleSOAP12Test1(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            setup();
            TestUtil.logMsg("Get encoding style from body (should return null) value");
            String s = body.getEncodingStyle();
            if (s != null) {
                TestUtil.logErr("getEncodingStyle() returned wrong value, " + "expected: null, got: " + s);
                pass = false;
            }
        } catch (Exception e) {
            TestUtil.logErr("Exception: " + e);
            ...
            if (se == null) {
                ...
                if (count != 1) {
                    ...
                    if (!se.equals(se2)) {
                        ...
                        pass = false;
                    } else TestUtil.logMsg("SOAPElement se = se2 (expected)");
                }
                if (pass) {
                    ...
                    if (!n.equals(name)) {
                        ...
                        pass = false;
                    } else TestUtil.logMsg("Name objects are equal (expected)");
                }
            }
        } catch (Exception e) {
            TestUtil.logErr("Exception: " + e);
    ...
    private void addChildElementTest3(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            TestUtil.logMsg("SOAPElementName = " + myse.getElementName().getLocalName());
            TestUtil.logMsg("Add child element with localName=" + s + ", prefix=" + p);
            TestUtil.logMsg("Calling addChildElement(String localName, String prefix)");
            SOAPElement se = body.addChildElement(s, p);
            if (se == null) {
                TestUtil.logErr("addChildElement() did not return SOAPElement");
                pass = false;
            } else {
                TestUtil.logMsg("SOAPElementName = " + se.getElementName().getLocalName());
                Iterator i = body.getChildElements();
                int count = SOAP_Util.getIteratorCount(i);
                i = body.getChildElements();
                if (count != 1) {
                ...
                if (pass) {
                    ...
                    if (!name.equals(s) || !prefix.equals(p)) {
                        TestUtil.logMsg("Name objects are not equal (unexpected)");
                        TestUtil.logErr("addChildElement() did not return" + " correct localName and prefix");
                        TestUtil.logErr("Expected localName=" + s + " prefix=" + p + ", got localName=" + name
                                + " prefix=" + prefix);
                        pass = false;
                    } else TestUtil.logMsg("Name objects are equal (expected)");
                }
    ...
    private void addChildElementTest4(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            String p = "MyPrefix1";
            String u = "MyURI1";
            TestUtil.logMsg("Add child element localName=" + s + ", prefix=" + p + ", URI=" + u);
            TestUtil.logMsg("Calling addChildElement(String localName, " + "String prefix, String URI)");
            ...
            if (se == null) {
                ...
                if (pass) {
                    ...
                    if (!name.equals(s) || !prefix.equals(p) || !uri.equals(u)) {
                        TestUtil.logMsg("Name objects are not equal (unexpected)");
                        TestUtil.logErr("addChildElement() did not return" + " correct localName, prefix, and uri");
                        TestUtil.logErr("Expected localName=" + s + " prefix=" + p + ", got localName=" + name
    ...
    private void addChildElementTest5(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            String p = "MyPrefix1";
            String u = "MyUri1";
            TestUtil.logMsg("Create Name object with localName=MyName1, " + "prefix=MyPrefix1, uri=MyUri1");
            ...
            if (se == null) {
                ...
                if (pass) {
                    ...
                    if (!n.equals(name)) {
                        ...
                        TestUtil.logErr("addChildElementTest6() test FAILED");
                        pass = false;
                    } else TestUtil.logMsg("addChildElementTest6() test PASSED");
                }
            }
        } catch (Exception e) {
            TestUtil.logErr("Exception: " + e);
    ...
    private void getChildElementsTest3(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            String p2 = "MyPrefix2";
            String u2 = "MyURI2";
            TestUtil.logMsg("Add child element name = " + s + ", prefix = " + p + ", URI = " + u);
            SOAPElement se = body.addChildElement(s, p, u);
            TestUtil.logMsg("Add child element name = " + s + ", prefix = " + p2 + ", URI = " + u2);
            SOAPElement se2 = body.addChildElement(s, p2, u2);
            Iterator i = body.getChildElements();
            int count = SOAP_Util.getIteratorCount(i);
            i = body.getChildElements();
            if (count != 2) {
                TestUtil.logErr("Wrong iterator count returned of " + count + ", expected 2");
                pass = false;
            }
            if (pass) {
                ...
                if (!se.equals(sei)) {
                    ...
                    pass = false;
                } else TestUtil.logMsg("SOAPElement se = sei (expected)");
                if (!se2.equals(sei2)) {
                    ...
                    if (pass) {
                        ...
                        if (!name.equals(s) || !prefix.equals(p) || !uri.equals(u)) {
                            TestUtil.logMsg("Name objects are not equal (unexpected)");
                            TestUtil.logErr("getChildElement() did not return" + " correct localName, prefix, and uri");
        ...
        try {
            ...
            if (pass) {
                ...
                if (!n.equals(name)) {
                    ...
                    TestUtil.logErr("getChildElementsTest4() test FAILED");
                    pass = false;
                } else TestUtil.logMsg("getChildElementsTest4() test PASSED");
            }
        } catch (Exception e) {
            TestUtil.logErr("Exception: " + e);
            TestUtil.printStackTrace(e);
    ...
    private void removeContentsTest(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            if (se == null) {
                ...
                TestUtil.logMsg("Child addition verified, now call removeContents to delete it");
                se.removeContents();
    ...
    private void getVisibleNamespacePrefixesTest(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            while (i.hasNext()) {
                String s = (String) i.next();
                TestUtil.logMsg("Got Prefix = " + s);
                if (s.equals(prefix)) foundPrefix = true;
            }
            if (!foundPrefix) TestUtil.logMsg("Did not find prefix " + prefix);
        } catch (Exception e) {
            TestUtil.logErr("Exception: " + e);
            TestUtil.printStackTrace(e);
            pass = false;
    ...
    private void setElementQNameTest2(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            TestUtil.logMsg("Try and change element name of SOAPEnvelope (expect SOAPException)");
            try {
            ...
            TestUtil.logMsg("Try and change element name of SOAPHeader (expect SOAPException)");
            try {
            ...
            TestUtil.logMsg("Try and change element name of SOAPBody (expect SOAPException)");
            try {
    ...
    private void createQNameTest2(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            setup();
            TestUtil.logMsg("Create QName from SOAPBody with bogus prefix (expect SOAPException)");

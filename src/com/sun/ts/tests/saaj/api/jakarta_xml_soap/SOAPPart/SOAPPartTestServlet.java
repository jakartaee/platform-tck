            ...
            while (iterator.hasNext()) {
                ...
                if (name.equals("Content-Type") && value.equals("text/xml")) {
                    if (!foundDefaultHeader) {
                        ...
                        TestUtil.logErr("Error: Received the same the default MimeHeader again (unexpected)");
                        TestUtil.logErr("received: name=" + name + ", value=" + value);
                        pass = false;
                    }
                }
            ...
            while (iterator.hasNext()) {
                ...
                if (name.equals("Content-Description") && value.equals("some text")) {
                    ...
                    if (!foundHeader3) {
                        ...
                        TestUtil.logErr("Error: Received the same header3 MimeHeader again (unexpected)");
                        TestUtil.logErr("received: name=" + name + ", value=" + value);
                        pass = false;
                    }
                } else {

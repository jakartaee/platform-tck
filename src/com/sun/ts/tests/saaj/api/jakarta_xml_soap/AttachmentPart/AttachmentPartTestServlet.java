...
public class AttachmentPartTestServlet extends HttpServlet {
    ...
    private static final String XML_RESOURCE_FILE2 = "/attach2.xml";
    ...
    private static final String XML_FILE = "attach.xml";

    private static final String HTML_FILE = "attach.html";

    private static final String GIF_FILE = "attach.gif";

    private static final String NULL_FILE = "attach.null";

    private static final String JPEG_FILE = "attach.jpeg";

    private static final String NOEXISTS_FILE = "attach.noexist";
    ...
    private void dispatch(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        if (testname.equals("addMimeHeader1Test")) {
            ...
            TestUtil.logTrace("Starting SetRawContentBytesSOAPOrNullPointerExceptionTest1");
            ...
            TestUtil.logTrace("Starting GetRawContentBytesSOAPOrNullPointerExceptionTest1");
    ...
    private void addMimeHeader4Test(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            TestUtil.logErr("Error: expected java.lang.IllegalArgumentException to be thrown");
            pass = false;
    ...
    private void getAllMimeHeaders1Test(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            while (iterator.hasNext()) {
                ...
                if ((name.equalsIgnoreCase("Content-Description") && value.equals("some text"))) {
                    if (!foundHeader1) {
                        ...
                        TestUtil.logErr("Error: Received the header1 MimeHeader again (unexpected)");
                        TestUtil.logErr("received: name=" + name + ", value=" + value);
                        pass = false;
                    }
                } else {
            ...
            if (cnt != 1) {
                TestUtil.logErr("Error: expected one item to be returned, got a total of:" + cnt);
                pass = false;
            }
        } catch (Exception e) {
            TestUtil.logErr("Exception: " + e);
    ...
    private void getAllMimeHeaders2Test(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            while (iterator.hasNext()) {
                ...
                if (name.equalsIgnoreCase("Content-Description") && value.equals("some text")) {
                    ...
                    if (!foundHeader2) {
                        ...
                        TestUtil.logErr("Error: Received the header2 MimeHeader again (unxpected)");
                        TestUtil.logErr("received: name=" + name + ", value=" + value);
                        pass = false;
                    }
                } else {
            ...
            if (cnt != 2) {
                TestUtil.logErr("Error: expected 2 items to be returned, got a total of:" + cnt);
                pass = false;
            }
        } catch (Exception e) {
            TestUtil.logErr("Exception: " + e);
            ...
            while (iterator.hasNext()) {
                ...
                if (name.equalsIgnoreCase("Content-Description") && value.equals("some text")) {
                    ...
                    if (!foundHeader2) {
                        ...
                        TestUtil.logErr("Error: Received the same header2 MimeHeader again (unexpected)");
                        TestUtil.logErr("received: name=" + name + ", value=" + value);
                        pass = false;
                    }
                } else {
    ...
    private void getAllMimeHeaders4Test(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            if (cnt != 0) {
                TestUtil.logErr("Error: expected no items to be returned, got a total of:" + cnt);
                pass = false;
            }
    ...
    private void getContentLocation1Test(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            if (!result.equals("http://localhost/someapp")) {
                TestUtil.logErr("Error: received invalid Location value from getContentLocation()");
    ...
    private void getContent1Test(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            TestUtil.logMsg("Setting Content for text/xml mime type using StreamSource");
    ...
    private void getContent2Test(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            TestUtil.logMsg("Setting Content for text/html mime type using InputStream");
            ap.setContent(dh.getInputStream(), "text/html");

            TestUtil.logMsg("Getting Content should return String or InputStream object");
            Object o = ap.getContent();
            TestUtil.logMsg("object returned=" + o);
            if (o != null) {
    ...
    private void getMatchingMimeHeaders2Test(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            if (cnt != 1) {
                TestUtil.logErr("Error: expected one items to be returned, got a total of:" + cnt);
                pass = false;
            }
    ...
    private void getMatchingMimeHeaders3Test(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            while (iterator.hasNext()) {
                ...
                if (name.equalsIgnoreCase("Content-Description") && value.equals("some text")) {
                    ...
                    if (!foundHeader2) {
                        ...
                        TestUtil.logErr("Error: Received the header2 MimeHeader again (unexpected)");
                        TestUtil.logErr("received: name=" + name + ", value=" + value);
                        pass = false;
                    }
                } else {
            ...
            if (cnt != 2) {
                TestUtil.logErr("Error: expected two items to be returned, got a total of:" + cnt);
                pass = false;
            }
    ...
    private void getMatchingMimeHeaders5Test(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            while (iterator.hasNext()) {
                ...
                if (name.equalsIgnoreCase("Content-Description") && value.equals("some text")) {
                    ...
                    if (!foundHeader3) {
                        ...
                        TestUtil.logErr("Error: Received the header3 MimeHeader again (unexpected)");
                        TestUtil.logErr("received: name=" + name + ", value=" + value);
                        pass = false;
                    }
                } else {
            ...
            if (cnt != 3) {
                TestUtil.logErr("Error: expected three items to be returned, got a total of:" + cnt);
                pass = false;
            }
        } catch (Exception e) {
            TestUtil.logErr("Exception: " + e);
    ...
    private void getMimeHeader1Test(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            if (len != 1) {
                TestUtil.logErr("Error: expected only one item to be returned, got a total of:" + len);
                pass = false;
            }
            ...
            for (int i = 0; i < len; i++) {
                ...
                if (!temp.equals("some text")) {
                    TestUtil.logErr("Error: received invalid value from getMimeHeader(Content-Description)");
        ...
        try {
            ...
            for (int i = 0; i < len; i++) {
                ...
                if (!temp.equals("id@abc.com")) {
                    TestUtil.logErr("Error: received invalid value from getMimeHeader(Content-Id)");
                    TestUtil.logErr("expected result: id@abc.com");
                    TestUtil.logErr("actual result:" + temp);
                    pass = false;
                }
            ...
            while (iterator.hasNext()) {
                ...
                if (name.equalsIgnoreCase("Content-Description") && value.equals("some text")) {
                    if (!foundHeader1) {
                        ...
                        TestUtil.logErr("Error: Received the same header1 MimeHeader again (unexpected)");
                        TestUtil.logErr("received: name=" + name + ", value=" + value);
                        pass = false;
                    }
                } else if (name.equalsIgnoreCase("Content-Description") && value.equals("some text2")) {
    ...
    private void getSize3Test(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            TestUtil.logMsg("Setting Content for attachment via setContent() and mimetype=text/xml");
            ap.setContent(new StreamSource(in1), "text/xml");
            TestUtil.logMsg("Getting Size");
            int size2 = ap.getSize();
            TestUtil.logMsg("The returned size2 = " + size2);
    ...
    private void getSize4Test(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            TestUtil.logMsg("Setting DataHandler for attachment using setDataHandler()");
    ...
    private void removeMimeHeader1Test(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            if (cnt != 0) {
                TestUtil.logErr("Error: expected no items to be returned, got atotal of:" + cnt);
                pass = false;
            }
    ...
    private void removeMimeHeader2Test(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            if (cnt != 1) {
                TestUtil.logErr("Error: expected only one item to be returned, got a total of:" + cnt);
                pass = false;
            }
    ...
    private void setContent1Test(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            TestUtil.logMsg("Setting Content using StreamSource for text/xml mime type");
            ap.setContent(new StreamSource(in1), "text/xml");
            ...
            if (o == null) {
                ...
                TestUtil.logErr("Getting the content did not return a StreamSource for text/xml content");
                pass = false;
            }
        } catch (Exception e) {
            TestUtil.logErr("Exception: " + e);
    ...
    private void setContent3Test(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            setup();
            try {
                TestUtil.logMsg("Setting Content with invalid param (a null) may throw IllegalArgumentException");
        ...
        try {
            ...
            for (int i = 0; i < len; i++) {
                ...
                if (!temp.equals("some text2")) {
                    TestUtil.logErr("Error: received invalid value from setMimeHeader(Content-Description)");
    ...
    private void SetGetBase64ContentTest1(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            TestUtil.logMsg("Setting Content via InputStream for image/jpeg mime type");
    ...
    private void SetGetBase64ContentTest2(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            TestUtil.logMsg("Setting Content via InputStream for image/xml mime type");
            ByteArrayOutputStream bos = new ByteArrayOutputStream();
            OutputStream ret = new BASE64EncoderStream(bos);
            int count;
            byte buf[] = new byte[8192];
            ...
            if (r != null) {
                ...
                if (length1 != length2) {
                    ...
                    for (int i = 0; i < length1; i++) {
                        if (buf1[i] != buf2[i]) {
                            TestUtil.logErr("Data is different: buf1[" + i + "]=" + buf1 + ", buf2[" + i + "]=" + buf2);
                            pass = false;
                            break;
                        }
                    }
    ...
    private void SetGetBase64ContentTest3(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            int size = ap.getSize();
            if (size != 0) {
                TestUtil.logErr("setBase64Content() with null content should return size=0, got size=" + size);
                pass = false;
            }
        } catch (Exception e) {
            TestUtil.logErr("Exception: " + e);
    ...
    private void SetGetRawContentTest1(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            TestUtil.logMsg("Setting Content via InputStream for image/gif mime type");
    ...
    private void SetGetRawContentTest2(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            TestUtil.logMsg("Get DataHandler to gif attachment: " + XML_RESOURCE_FILE);
            TestUtil.logMsg("URL = " + url);
            dh = new DataHandler(url);
            TestUtil.logMsg("Get InputStream from DataHandler");
            InputStream is1 = dh.getInputStream();
    ...
    private void SetGetRawContentTest4(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            int size = ap.getSize();
            if (size != 0) {
                TestUtil.logErr("setRawContent() with null content should return size=0, got size=" + size);
                pass = false;
            }
        } catch (Exception e) {
            TestUtil.logErr("Exception: " + e);
    ...
    private void SetGetRawContentBytesTest1(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            TestUtil.logMsg("Setting Content via byte[] array for image/jpeg mime type");
    ...
    private void SetRawContentBytesSOAPOrNullPointerExceptionTest1(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            TestUtil.logErr("Did not throw expected SOAPException or NullPointerException");
            pass = false;
        } catch (SOAPException e) {
    ...
    private void setBase64ContentNullPointerExceptionTest1(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            TestUtil.logMsg("Call setBase64Content() passing in an InputStream that is null");
            InputStream is = null;
    ...
    private void setBase64ContentSOAPExceptionTest1(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            TestUtil.logMsg("Create InputStream from DataHandler's InputStream");
            InputStream is = dh.getInputStream();
            TestUtil.logMsg("Call setBase64Content() with an InputStream that is not Base64 encoded");
            ap.setBase64Content(is, "image/jpeg");
    ...
    private void setRawContentIOExceptionTest1(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            url = tsurl.getURL("http", host, port, cntxroot + "/" + NOEXISTS_FILE);
            TestUtil.logMsg("Get DataHandler to attachment that doesn't exist: " + NOEXISTS_FILE);
            TestUtil.logMsg("URL = " + url);
            dh = new DataHandler(url);
    ...
    private void setRawContentNullPointerExceptionTest1(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            TestUtil.logMsg("Call setRawContent() passing in an InputStream that is null");
            InputStream is = null;
            ap.setRawContent(is, "image/gif");
            TestUtil.logErr("Did not throw expected NullPointerException");
            pass = false;

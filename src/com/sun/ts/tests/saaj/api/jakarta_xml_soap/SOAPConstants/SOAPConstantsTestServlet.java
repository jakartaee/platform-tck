...
public class SOAPConstantsTestServlet extends HttpServlet {
    ...
    private void SOAPConstantsTest(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            TestUtil.logMsg("DEFAULT_SOAP_PROTOCOL=" + SOAPConstants.DEFAULT_SOAP_PROTOCOL);
            TestUtil.logMsg("DYNAMIC_SOAP_PROTOCOL=" + SOAPConstants.DYNAMIC_SOAP_PROTOCOL);
            TestUtil.logMsg("SOAP_1_1_CONTENT_TYPE=" + SOAPConstants.SOAP_1_1_CONTENT_TYPE);
            TestUtil.logMsg("SOAP_1_2_CONTENT_TYPE=" + SOAPConstants.SOAP_1_2_CONTENT_TYPE);
            TestUtil.logMsg("URI_NS_SOAP_ENCODING=" + SOAPConstants.URI_NS_SOAP_ENCODING);
            TestUtil.logMsg("URI_NS_SOAP_ENVELOPE=" + SOAPConstants.URI_NS_SOAP_ENVELOPE);
            TestUtil.logMsg("URI_SOAP_ACTOR_NEXT=" + SOAPConstants.URI_SOAP_ACTOR_NEXT);
            TestUtil.logMsg("URI_NS_SOAP_1_1_ENVELOPE=" + SOAPConstants.URI_NS_SOAP_1_1_ENVELOPE);
            TestUtil.logMsg("URI_NS_SOAP_1_2_ENCODING=" + SOAPConstants.URI_NS_SOAP_1_2_ENCODING);
            TestUtil.logMsg("URI_NS_SOAP_1_2_ENVELOPE=" + SOAPConstants.URI_NS_SOAP_1_2_ENVELOPE);
            TestUtil.logMsg("URI_SOAP_1_2_ROLE_NEXT=" + SOAPConstants.URI_SOAP_1_2_ROLE_NEXT);
            TestUtil.logMsg("URI_SOAP_1_2_ROLE_NONE=" + SOAPConstants.URI_SOAP_1_2_ROLE_NONE);
            TestUtil.logMsg("URI_SOAP_1_2_ROLE_ULTIMATE_RECEIVER=" + SOAPConstants.URI_SOAP_1_2_ROLE_ULTIMATE_RECEIVER);
            TestUtil.logMsg("SOAP_ENV_PREFIX=" + SOAPConstants.SOAP_ENV_PREFIX);
            TestUtil.logMsg("SOAP_DATAENCODINGUNKNOWN_FAULT=" + SOAPConstants.SOAP_DATAENCODINGUNKNOWN_FAULT);
            TestUtil.logMsg("SOAP_MUSTUNDERSTAND_FAULT=" + SOAPConstants.SOAP_MUSTUNDERSTAND_FAULT);
            TestUtil.logMsg("SOAP_RECEIVER_FAULT=" + SOAPConstants.SOAP_RECEIVER_FAULT);
            TestUtil.logMsg("SOAP_SENDER_FAULT=" + SOAPConstants.SOAP_SENDER_FAULT);
            TestUtil.logMsg("SOAP_VERSIONMISMATCH_FAULT=" + SOAPConstants.SOAP_VERSIONMISMATCH_FAULT);
            ...
            if (!SOAPConstants.URI_SOAP_1_2_ROLE_ULTIMATE_RECEIVER.equals(EXP_URI_SOAP_1_2_ROLE_ULTIMATE_RECEIVER)) {
                ...
                TestUtil.logErr("Received: " + SOAPConstants.URI_SOAP_1_2_ROLE_ULTIMATE_RECEIVER);
                pass = false;
            }
            if (!SOAPConstants.SOAP_DATAENCODINGUNKNOWN_FAULT.equals(EXP_DATAENCODINGUNKNOWN_FAULT)) {
                ...
                TestUtil.logErr("Received: " + SOAPConstants.SOAP_DATAENCODINGUNKNOWN_FAULT);
                pass = false;
            }

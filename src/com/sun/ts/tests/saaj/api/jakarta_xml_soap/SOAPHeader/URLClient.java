...
public class URLClient extends EETest {
    ...
    public void examineAllHeaderElementsTest1() throws Fault {
        boolean pass = true;
        try {
            TestUtil.logMsg("examineAllHeaderElementsTest1: examine SOAPHeaderElements");
            TestUtil.logMsg("Creating url to test servlet.....");
            url = tsurl.getURL(PROTOCOL, hostname, portnum, SOAPHEADER_TESTSERVLET);
            TestUtil.logMsg(url.toString());
            TestUtil.logMsg("Sending post request to test servlet.....");
    ...
    public void examineAllHeaderElementsTest2() throws Fault {
        boolean pass = true;
        try {
            TestUtil.logMsg("examineAllHeaderElementsTest2: examine SOAPHeaderElements");
            TestUtil.logMsg("Creating url to test servlet.....");
            url = tsurl.getURL(PROTOCOL, hostname, portnum, SOAPHEADER_TESTSERVLET);
            TestUtil.logMsg(url.toString());
            TestUtil.logMsg("Sending post request to test servlet.....");
    ...
    public void examineAllHeaderElementsTest3() throws Fault {
        boolean pass = true;
        try {
            TestUtil.logMsg("examineAllHeaderElementsTest3: examine SOAPHeaderElements");
            TestUtil.logMsg("Creating url to test servlet.....");
            url = tsurl.getURL(PROTOCOL, hostname, portnum, SOAPHEADER_TESTSERVLET);
            TestUtil.logMsg(url.toString());
            TestUtil.logMsg("Sending post request to test servlet.....");
    ...
    public void examineMustUnderstandHeaderElementsTest1() throws Fault {
        boolean pass = true;
        try {
            TestUtil.logMsg("examineMustUnderstandHeaderElementsTest1: examine MustUnderstand");
            TestUtil.logMsg("Creating url to test servlet.....");
            url = tsurl.getURL(PROTOCOL, hostname, portnum, SOAPHEADER_TESTSERVLET);
            TestUtil.logMsg(url.toString());
            TestUtil.logMsg("Sending post request to test servlet.....");
    ...
    public void examineMustUnderstandHeaderElementsTest2() throws Fault {
        boolean pass = true;
        try {
            TestUtil.logMsg("examineMustUnderstandHeaderElementsTest2: examine MustUnderstand");
            TestUtil.logMsg("Creating url to test servlet.....");
            url = tsurl.getURL(PROTOCOL, hostname, portnum, SOAPHEADER_TESTSERVLET);
            TestUtil.logMsg(url.toString());
            TestUtil.logMsg("Sending post request to test servlet.....");
    ...
    public void examineMustUnderstandHeaderElementsTest3() throws Fault {
        boolean pass = true;
        try {
            TestUtil.logMsg("examineMustUnderstandHeaderElementsTest3: examine MustUnderstand");
            TestUtil.logMsg("Creating url to test servlet.....");
            url = tsurl.getURL(PROTOCOL, hostname, portnum, SOAPHEADER_TESTSERVLET);
            TestUtil.logMsg(url.toString());
            TestUtil.logMsg("Sending post request to test servlet.....");
    ...
    public void extractAllHeaderElementsTest1() throws Fault {
        boolean pass = true;
        try {
            TestUtil.logMsg("extractAllHeaderElementsTest1: extract SOAPHeaderElements");
            TestUtil.logMsg("Creating url to test servlet.....");
            url = tsurl.getURL(PROTOCOL, hostname, portnum, SOAPHEADER_TESTSERVLET);
            TestUtil.logMsg(url.toString());
            TestUtil.logMsg("Sending post request to test servlet.....");
    ...
    public void extractAllHeaderElementsTest2() throws Fault {
        boolean pass = true;
        try {
            TestUtil.logMsg("extractAllHeaderElementsTest2: extract SOAPHeaderElements");
            TestUtil.logMsg("Creating url to test servlet.....");
            url = tsurl.getURL(PROTOCOL, hostname, portnum, SOAPHEADER_TESTSERVLET);
            TestUtil.logMsg(url.toString());
            TestUtil.logMsg("Sending post request to test servlet.....");
    ...
    public void extractAllHeaderElementsTest3() throws Fault {
        boolean pass = true;
        try {
            TestUtil.logMsg("extractAllHeaderElementsTest3: extract SOAPHeaderElements");
            TestUtil.logMsg("Creating url to test servlet.....");
            url = tsurl.getURL(PROTOCOL, hostname, portnum, SOAPHEADER_TESTSERVLET);
            TestUtil.logMsg(url.toString());
            TestUtil.logMsg("Sending post request to test servlet.....");

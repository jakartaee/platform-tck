...
public class SendingServlet extends HttpServlet {
    ...
    private void SendSyncReqRespMsgTest1(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            if (!SOAP_Util.isSOAPConnectionFactorySupported()) {
                TestUtil.logMsg("SOAPConnectionFactory.newInstance() is " + "unsupported (skipping test)");
            ...
            se = hdr.addHeaderElement(envelope.createName("Header2", NS_PREFIX, NS_URI))
            ...
            se = hdr.addHeaderElement(envelope.createName("Header3", NS_PREFIX, NS_URI))
                    .addTextNode("This is Header3");
            she = (SOAPHeaderElement) se;
            she.setMustUnderstand(true);

            TestUtil.logMsg("Add SOAP HeaderElement Header4");
            se = hdr.addHeaderElement(envelope.createName("Header4", NS_PREFIX, NS_URI))
    ...
    private void SendSyncReqRespMsgTest2(HttpServletRequest req, HttpServletResponse res)
            throws ServletException, IOException {
        Properties resultProps = new Properties();
        boolean pass = true;
        ...
        try {
            ...
            URL url = tsurl.getURL(PROTOCOL, hostname, portnum, cntxroot + "/attach.xml");
    ...
    private void SendSyncReqRespMsgTest3(HttpServletRequest req, HttpServletResponse res)
            throws ServletException, IOException {
        Properties resultProps = new Properties();
        boolean pass = true;
        ...
        try {
            ...
            URL url2 = tsurl.getURL(PROTOCOL, hostname, portnum, cntxroot + "/attach.jpeg");

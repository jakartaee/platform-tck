...
public class VerifyInformationItemsTestServlet extends HttpServlet {
        ...
        try {
            ...
            if (pass) {
                ...
                if (!localName.equals("encodingStyle")) {
                    TestUtil.logErr("Got LocalName: " + localName + ", Expected LocalName: encodingStyle");
                    pass = false;
                }
            }
        } catch (Exception e) {
        ...
        try {
            ...
            if (pass) {
                ...
                if (!localName.equals("role")) {
                    TestUtil.logErr("Got LocalName: " + localName + ", Expected LocalName: role");
                    pass = false;
                }
            }
        } catch (Exception e) {
        ...
        try {
            ...
            if (pass) {
                ...
                if (!localName.equals("relay")) {
                    TestUtil.logErr("Got LocalName: " + localName + ", Expected LocalName: relay");
                    pass = false;
                }
            }
        } catch (Exception e) {
        ...
        try {
            ...
            if (pass) {
                ...
                if (!localName.equals("mustUnderstand")) {
                    TestUtil.logErr("Got LocalName: " + localName + ", Expected LocalName: mustUnderstand");
                    pass = false;
                }
            }
        } catch (Exception e) {
        ...
        try {
            ...
            if (pass) {
                ...
                if (!localName.equals("Envelope")) {
                    TestUtil.logErr("Got LocalName: " + localName + ", Expected LocalName: Envelope");
                    pass = false;
                }
            }
        } catch (Exception e) {
        ...
        try {
            ...
            if (pass) {
                ...
                if (!localName.equals("Header")) {
                    TestUtil.logErr("Got LocalName: " + localName + ", Expected LocalName: Header");
                    pass = false;
                }
            }
        } catch (Exception e) {
        ...
        try {
            ...
            if (pass) {
                ...
                if (!localName.equals("Body")) {
                    TestUtil.logErr("Got LocalName: " + localName + ", Expected LocalName: Body");
                    pass = false;
                }
            }
        } catch (Exception e) {
        ...
        try {
            ...
            if (pass) {
                ...
                if (!localName.equals("MyName")) {
                    TestUtil.logErr("Got LocalName: " + localName + ", Expected LocalName: MyName");
                    pass = false;
                }
            }
        } catch (Exception e) {
        ...
        try {
            ...
            if (pass) {
                ...
                if (!localName.equals("Fault")) {
                    TestUtil.logErr("Got LocalName: " + localName + ", Expected LocalName: Fault");
                    pass = false;
                }
            }
        } catch (Exception e) {
    ...
    private void VerifyCodeElementInfoItem(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            SOAPFault sf = body.addFault(SOAPConstants.SOAP_VERSIONMISMATCH_FAULT, "This is the fault string (boo hoo hoo)");
    ...
    private void VerifySubcodeElementInfoItem(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            if (pass) {
                ...
                String uri = name.getNamespaceURI();
                String localName = name.getLocalPart();
                TestUtil.logMsg("Validate the URI which must be " + "http://www.w3.org/2003/05/soap-rpc");
                ...
                if (!localName.equals("BadArguments")) {
                    TestUtil.logErr("Got LocalName: " + localName + ", Expected LocalName: BadArguments");
                    pass = false;
                }
            }
        } catch (Exception e) {
        ...
        try {
            ...
            if (pass) {
                ...
                if (!localName.equals("Detail")) {
                    TestUtil.logErr("Got LocalName: " + localName + ", Expected LocalName: Detail");
                    pass = false;
                }
            }
        } catch (Exception e) {

...
public final class JSONP_Data {
    ...
    public static final String asciiCharacters =
            "!@#$%^&*()_+|~1234567890-=;',./<>? " + "qwertyuiopasdfghjklzxcvbnmQWERTYUIOPASDFGHJKLZXCVBNM";

    public static final String jsonArrayTestData =
    ...
    public static final String jsonArrayWithMultipleArraysData =
            "[ \"string\", 100, true, false, null, { \"object\" : \"object\" }, [ \"one\","

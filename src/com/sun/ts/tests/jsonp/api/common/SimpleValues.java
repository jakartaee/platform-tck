...
public class SimpleValues {
    ...
    public static JsonObject createCompoundObjectCopyValue() {
        return Json.createObjectBuilder()
                .add(DEF_NAME, DEF_VALUE)
                .add(DEF_OBJ_NAME, DEF_OBJ_VALUE2)
                .build();
    }
    ...
    public static JsonObject createCompoundObjectWithObjectReplaced() {
        return Json.createObjectBuilder()
                .add(DEF_NAME, DEF_VALUE)
                .add(DEF_OBJ_NAME, createSimpleStringArray5())
                .build();
    }
    ...
    public static JsonObject createSimpleObject(final String[] names, final Object[] values) {
    ...
    public static String jsonData(final JsonValue value) {
        ...
        try (final JsonWriter writer = Json.createWriter(strWriter)) {
            ...
            TestUtil.logMsg("Could not initialize JSON data: " + ex.getLocalizedMessage());
            throw ex;
        }

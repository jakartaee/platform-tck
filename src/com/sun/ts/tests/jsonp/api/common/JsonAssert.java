...
public class JsonAssert {
    ...
    private static boolean assertEquals(final JsonObject expected, final JsonObject actual, final String message) {
    ...
    private static boolean assertEquals(final JsonArray expected, final JsonArray actual, final String message) {
        if (actual.equals(expected)) {
            return true;
        } else {
            TestUtil.logMsg("   " + message);
    ...
    private static boolean assertEquals(final JsonString expected, final JsonString actual, final String message) {
        if (actual.equals(expected)) {
            return true;
        } else {
            TestUtil.logMsg("   " + message);
    ...
    private static boolean assertEquals(final JsonNumber expected, final JsonNumber actual, final String message) {
        if (actual.equals(expected)) {
            return true;
        } else {
            TestUtil.logMsg("   " + message);
    ...
    public static boolean assertEquals(final JsonValue expected, final JsonValue actual) {

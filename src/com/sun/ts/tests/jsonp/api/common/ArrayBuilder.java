...
public class ArrayBuilder {
     ...
     *
     * @param builder Target JSON array builder.
     * @param value Value to be added at the end of the array.
     * @return JSON array builder containing new {@code value}.
     */
    @SuppressWarnings("UnnecessaryUnboxing")
    public static JsonArrayBuilder add(final JsonArrayBuilder builder, final Object value) {
     ...
     *
     * @param builder Target JSON array builder.
     * @param index Array index of value to be added.
     * @param value Value to be added at the end of the array.
     * @return JSON array builder containing new {@code value}.
     */
    @SuppressWarnings("UnnecessaryUnboxing")
    public static JsonArrayBuilder add(final JsonArrayBuilder builder, final int index, final Object value) {
        switch (JsonValueType.getType(value)) {
        case String:
    ...
    /**
     * Add {@code null} to provided JSON array builder. Every call shall throw an exception which depends on selected type.
     *
     * @param builder Target JSON array builder.
     * @param type Type of method argument to use..
     * @return JSON array builder containing new {@code value}.
     */
    @SuppressWarnings("UnnecessaryUnboxing")
    public static JsonArrayBuilder add(final JsonArrayBuilder builder, final JsonValueType type) {
        switch (type) {
        case String:
     ...
     */
    @SuppressWarnings("UnnecessaryUnboxing")
    public static JsonArrayBuilder add(final JsonArrayBuilder builder, final int index, final JsonValueType type) {
        switch (type) {
        case String:
     ...
     * @param builder Target JSON array builder.
     * @param index Array index of value to be added.
     * @param value Value to be set at the end of the array.
     * @return JSON array builder containing new {@code value}.
     */
    @SuppressWarnings("UnnecessaryUnboxing")
    public static JsonArrayBuilder set(final JsonArrayBuilder builder, final int index, final Object value) {
        switch (JsonValueType.getType(value)) {
        case String:
    ...
    /**
     * Set {@code null} to provided JSON array builder. Every call shall throw an exception which depends on selected type.
     *
     * @param builder Target JSON array builder.
     * @param index Array index of value to be added.
     * @param type Type of method argument to use..
     ...
     */
    @SuppressWarnings("UnnecessaryUnboxing")
    public static JsonArrayBuilder set(final JsonArrayBuilder builder, final int index, final JsonValueType type) {
        switch (type) {
        case String:
     ...
     */
    @SuppressWarnings("UnnecessaryUnboxing")
    public static JsonArrayBuilder remove(final JsonArrayBuilder builder, final int index) {

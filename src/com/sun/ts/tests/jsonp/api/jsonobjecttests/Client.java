...
public class Client extends ServiceEETest {
  ...
  public void jsonObjectTest1() throws Fault {
    ...
    try {
      ...
      logMsg("Create JsonObject using all JsonObjectBuilder API's");
  ...
  public void jsonObjectTest2() throws Fault {
    ...
    try {
      ...
      try (JsonReader reader = Json.createReader(new StringReader(contents))) {
        ...
        logMsg("Save contents of the JsonReader as a String");
        contents = reader.toString();
      }
      logMsg("Dump contents of JsonReader as a String");
      logMsg("JsonReaderContents=" + contents);
  ...
  public void jsonObjectTest3() throws Fault {
    ...
    try {
      ...
      logMsg("Create myObject JsonObject with 22 name/value pairs");
  ...
  public void jsonObjectTest4() throws Fault {
    ...
    try {
      ...
      logMsg("Dump contents of JsonWriter as a String");
      logMsg("JsonWriterContents=" + contents);
      logMsg("Remove whitespace from contents.");
  ...
  public void jsonObjectExceptionTests() throws Fault {
    ...
    try {
      ...
      pass = false;
      logErr("Failed to throw ClassCastException");
    } catch (ClassCastException e) {
      logMsg("Got expected ClassCastException");
    } catch (Exception e) {
      pass = false;
      logErr("Caught unexpected exception: " + e);
    }
    ...
    try {
      logMsg("Trip NumberFormatException calling add(String, Double.NaN)");
      JsonObject object = Json.createObjectBuilder().add("double", Double.NaN)
          .build();
      pass = false;
      logErr("Failed to throw NumberFormatException");
    } catch (NumberFormatException e) {
      logMsg("Got expected NumberFormatException");
    } catch (Exception e) {
      pass = false;
      logErr("Caught unexpected exception: " + e);
    }
    ...
    try {
      ...
      JsonObject object = Json.createObjectBuilder().add("number", 12345.12345)
          .build();
      logMsg("Call JsonObject.getJsonNumber(\"number\").intValueExact()");
      int value = object.getJsonNumber("number").intValueExact();
      pass = false;
      logErr("Failed to throw ArithmeticException");
    } catch (ArithmeticException e) {
      logMsg("Got expected ArithmeticException");
    } catch (Exception e) {
      pass = false;
      logErr("Caught unexpected exception: " + e);
    }
    ...
    try {
      ...
      JsonObject object = Json.createObjectBuilder().add("number", 12345.12345)
          .build();
      logMsg("Call JsonObject.getJsonNumber(\"number\").longValueExact()");
    ...
    try {
      ...
      pass = false;
      logErr("Failed to throw UnsupportedOperationException");
    } catch (UnsupportedOperationException e) {
      logMsg("Got expected UnsupportedOperationException");
    } catch (Exception e) {
      pass = false;
      logErr("Caught unexpected exception: " + e);
    }
    ...
    try {
      ...
      pass = false;
      logErr("Failed to throw NullPointerException");

...
public class Client extends EETest {
  ...
  public void testCommitTransactionWithManagedScheduledExecutorService()
    ...
    if (!Message.SUCCESSMESSAGE.equals(resp)) {
      throw new Fault(
          "testTransactionWithManagedScheduledExecutorService fail to get successful result.");
    }
  }
  ...
  public void testRollbackTransactionWithManagedScheduledExecutorService()
    ...
    if (!Message.SUCCESSMESSAGE.equals(resp)) {
      throw new Fault(
          "testRollbackTransactionWithManagedScheduledExecutorService fail to get successful result.");
    }
  }
  ...
  public void testCancelTransactionWithManagedScheduledExecutorService()
    ...
    if (!Message.SUCCESSMESSAGE.equals(resp)) {
      throw new Fault(
          "testCancelTransactionWithManagedScheduledExecutorService fail to get successful result.");
    }
  }

...
public class Client extends EETest {
   ...
   * "javajoe(in role manager)", then submit a task by
   * ManagedScheduledExecutorService in which call a ejb that requires role
   * manager.
   */
  public void managedScheduledExecutorServiceAPISecurityTest() throws Fault {

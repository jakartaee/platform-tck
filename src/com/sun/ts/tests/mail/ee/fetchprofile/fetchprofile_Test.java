...
package com.sun.ts.tests.mail.ee.fetchprofile;
...
public class fetchprofile_Test extends ServiceEETest implements Serializable {
  ...
  public void setup(String[] args, Properties props) throws Fault {
    try {
      ...
      rootPath = TestUtil.getProperty("mail.root.path");
   ...
   */
  // derived from mail suite fetchProfile_Test class
   ...
   */
  // derived from mail suite fetchProfile getItems_test

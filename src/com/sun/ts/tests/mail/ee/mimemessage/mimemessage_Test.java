 ...
 */
package com.sun.ts.tests.mail.ee.mimemessage;

import java.util.*;

import com.sun.ts.lib.util.*;
import com.sun.ts.lib.harness.*;
import com.sun.ts.tests.mail.ee.common.MailTestUtil;
...
public class mimemessage_Test extends ServiceEETest implements Serializable {
  ...
  private String[] addrlist = { "ksnijjar@eng", "ksnijjar@eng.sun.com",
      ...
      "xx.zzz12@fea.net", "mail-api-eng@icdev",
  ...
  /* Test setup: */
  /*
   * @class.setup_props: mail.protocol; mail.server; mail.username;
   * mail.password ; mail.mailbox; mail.root.path; smtp.port;
   * imap.port;
   */
  public void setup(String[] args, Properties props) throws Fault {
    try {

      String protocol = TestUtil.getProperty("mail.protocol");
      String host = TestUtil.getProperty("mail.server");
      user = TestUtil.getProperty("mail.username");
      String password = TestUtil.getProperty("mail.password");
      String mailbox = TestUtil.getProperty("mail.mailbox");
   ...
   */
  // derived from mail suite setContent_Test class
   ...
   */
  // derived from mail suite sendMessage_Test class
   ...
   */
  // derived from mail suite getSession_Test class
   ...
   */
  // derived from mail suite createMimeMessage_Test
   ...
   * 
   * derived from mail suite reply_Test
   */
   ...
   * 
   * derived from mail suite setContent_Test
   */

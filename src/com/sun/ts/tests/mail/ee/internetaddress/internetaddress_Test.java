 ...
 */
package com.sun.ts.tests.mail.ee.internetaddress;
...
public class internetaddress_Test extends ServiceEETest
   ...
   * mail.password ;mailuser1; smtp.port; imap.port;
   */
  public void setup(String[] args, Properties props) throws Fault {
    try {
      ...
      String user = TestUtil.getProperty("mail.username");
   ...
   */
  // derived from mail suite utilmethods_Test class
   ...
   */
  // derived from mail suite getAddress_Test class
   ...
   */
  // derived from mail suite getPersonal_Test.java class
   ...
   * 
   * 
   * derived from mail suite next_Test
   */
   ...
   * 
   * derived from mail suite combineSegments_Test
   */

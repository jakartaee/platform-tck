...
package com.sun.ts.tests.mail.ee.internetMimeMultipart;
...
public class internetMimeMultipart_Test extends ServiceEETest {
   ...
   * mail.password ; mail.mailbox; mail.root.path; work.dir; iofile;
   * smtp.port; imap.port;
   */
   ...
   */
  // derived from mail suite getMessageContent_Test
   ...
   * @test_Strategy: getMessageContent test
   */
  // derived from mail suite properties_Test
   ...
   * @test_Strategy: getMessageContent test
   */
  // derived from mail suite MimeMultipart test

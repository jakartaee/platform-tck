 ...
 */
package com.sun.ts.tests.mail.ee.transport;
...
public class send_Test extends ServiceEETest implements Serializable {
  ...
  public static final String MAILER = "Mail";
   ...
   * mail.password ; mail.mailbox; transport_protocol; mailuser1;
   * smtp.port; imap.port;
   */
  public void setup(String[] args, Properties props) throws Fault {
    try {
      ...
      password = TestUtil.getProperty("mail.password");
   ...
   * error.
   */
  // derived from mail suite send_Test class
   ...
   * returns rfc822
   */
  // derived from mail suite getType class
   ...
   * error.
   */
  // derived from mail suite connect_Test class
   ...
   * it fails. <p>
   * 
   * derived from mail suite send_Test
   */
  public void test4() throws Fault {
    ...
    try {
      ...
      msg.setFrom(addr);
      msg.setRecipients(Message.RecipientType.TO, addrs);
      msg.setSubject("Mail send() API Test");
      msg.setContent(msgText, "text/plain");

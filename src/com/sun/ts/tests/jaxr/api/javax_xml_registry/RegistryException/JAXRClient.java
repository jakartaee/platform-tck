...
public class JAXRClient extends JAXRCommonClient {
   ...
   *
   * @assertion: RegistryException - Constructs a JAXRException object with no
  ...
  public void registryException_ConstructorTest1() throws Fault {
    ...
    try {
      ...
      if (!(e instanceof RegistryException))
        throw new Fault(
            testName + "failed to create RegistryException instance");
      else
        debug.add("RegistryException created successfully\n");
    } catch (Exception ue) {
   ...
   *
   * @assertion: RegistryException(reason) - Constructs a JAXRException object
  ...
  public void registryException_ConstructorTest2() throws Fault {
    ...
    try {
      ...
      if (!(e.getMessage().equals(reason))) {
        ...
        debug.add("RegistryException returned reason successfully\n");
   ...
   *
   * @assertion: RegistryException(reason, cause) - Constructs a JAXRException
   ...
   *
   * @test_Strategy: Create and verify RegistryException, verify reason and
   * cause.
   *
   */
   ...
   *
   * @assertion: RegistryException(cause) - Constructs a JAXRException object

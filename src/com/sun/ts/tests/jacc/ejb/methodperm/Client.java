...
public class Client extends EETest {
    ...
    public void setup(String[] args, Properties p) throws Fault {
        ...
        if (!initialized) {
            ...
            logProcessor.fetchLogs("getAppSpecificRecordCollection|appId", "jacc_ejb_methodperm");
    ...
    public void EJBMethodPermissionTest() throws Fault {
        ...
        String[] params = {};
        expectedAddToRolePermissions.add(new EJBMethodPermission(
                "jacc_ejb_methodperm_MethodPermBean", "protectedByRoleManager", "Remote", params));
        expectedAddToRolePermissions.add(new EJBMethodPermission(
                "jacc_ejb_methodperm_MethodPermBean", "protectedByRoleAdminAndManager", "Remote", params));
        expectedAddToRolePermissions.add(new EJBMethodPermission(
                "jacc_ejb_methodperm_MethodPermBean", "protectedByAnyAuthUser", "Remote", params));

        // step 3: verify expected policy statements with generated policy
        // statements
        TestUtil.logMsg("verifying unchecked policy statments:");
        verified = logProcessor.verifyLogImplies(expectedAddToRolePermissions, addToRoleEJBMethodPermissions);

        if (!verified) {
            throw new Fault("EJBMethodPermissionTest failed: " + "addToRole policy statements verification failed");
        } else {
    ...
    public void EJBMethodPermissionAddToRole() throws Fault {
        ...
        Collection<LogRecordEntry> records = logProcessor.getMsgTagRecordCollection();
        ...
        while (iterator.hasNext()) {
            ...
            try {
                ...
                if (message.indexOf(" :: ") > 0) {
                    ...
                    TestUtil.logTrace("EJBMethodPermissionAddToRole:  permType = " + permType);
                    ...
                    if ((permType != null) && (permType.equals("EJBMethodPermission"))) {
                        ...
                        if ((permName != null) && (permName.equals("jacc_ejb_methodperm_MethodPermBean"))) {
        ...
        if (bAdminFound && bManagerFound) {
            ...
            throw new Fault(
                    "EJBMethodPermissionAddToRole failed: " + "addToRole policy statements verification failed");
        }
    }
    ...
    public void EJBRoleRefPermission() throws Fault {
        ...
        expectedAddToRolePermissions.add(new EJBRoleRefPermission("jacc_ejb_methodperm_MethodPermBean", "ADMIN"));
        expectedAddToRolePermissions.add(
                new EJBRoleRefPermission("jacc_ejb_methodperm_MethodPermBean", "Administrator"));
        expectedAddToRolePermissions.add(new EJBRoleRefPermission("jacc_ejb_methodperm_MethodPermBean", "MGR"));
        expectedAddToRolePermissions.add(new EJBRoleRefPermission("jacc_ejb_methodperm_MethodPermBean", "Manager"));
        expectedAddToRolePermissions.add(new EJBRoleRefPermission("jacc_ejb_methodperm_MethodPermBean", "EMP"));
        expectedAddToRolePermissions.add(new EJBRoleRefPermission("jacc_ejb_methodperm_MethodPermBean", "Employee"));
        expectedAddToRolePermissions.add(new EJBRoleRefPermission("jacc_ejb_methodperm_MethodPermBean", "**"));

        TestUtil.logMsg("verifying addToRole policy statments:");

        verified = logProcessor.verifyLogImplies(expectedAddToRolePermissions, addToRoleEJBRoleRefPermissions);

        if (!verified) {
            throw new Fault("EJBRoleRefPermission failed: " + "addToRole policy statements verification failed");
        } else {
            TestUtil.logMsg("addToRole policy statements verification successful");
        }
    }

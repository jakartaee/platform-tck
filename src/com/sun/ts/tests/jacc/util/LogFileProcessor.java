...
public class LogFileProcessor {
    ...
    public Permissions getAppSpecificPermissions(String permCat, String permType, String appContext) {
        ...
        while (iterator.hasNext()) {
            ...
            p = getPermissionFromRecordEntry(recordEntry, permCat, permType, appContext);
            if (p != null) {
                permsToReturn.add(p);
            }
        }
    ...
    public Permission getPermissionFromRecordEntry(
            LogRecordEntry recordEntry, String permCat, String permType, String appContext) {
        String permissionCategory = null;
        String applicationContext = null;
        String temp = null;
        String message = null;
    ...
    public Collection<LogRecordEntry> getMsgTagRecordCollection() {
        ...
        TestUtil.logTrace("getMsgTagRecordCollection():  Record collection size : " + recordCollection.size());
        if (recordCollection == null) {
        ...
        TestUtil.logTrace(
                "getMsgTagRecordCollection():  returning collection size of: " + msgTagRecordCollection.size());

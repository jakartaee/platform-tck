...
public class FetchLogClient extends EETest {
    ...
    public void setup(String[] args, Properties p) throws Fault {
        ...
        try {
            ...
            if (!pass) {
                TestUtil.logErr("Please specify web server host & port" + "in ts.jte file");
    ...
    public void fetchLogClientTest() throws Fault {
        ...
        try {
            ...
            FileHandler tsFileHandler = new FileHandler(logFileLocation + "/jacc_log.txt");
            ...
            conn.setRequestProperty(
                    "Content-Type", "java-internal/" + props.getClass().getName());
            ...
            if (header.equals("RecordCollection header")) {
                ...
                TestUtil.logErr(
                        "Log file does not exists in the server" + " or you don't have read permission for log file");

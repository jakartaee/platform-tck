...
public class Client extends ServiceEETest {
    ...
    public void WildCardAuthConstraint() throws Fault {
        ...
        String url = ctsurl.getURLString("http", hostname, portnum, pageBase + accessToAllPage);
        try {
            ...
            if (output.indexOf(stringToSearch) == -1) {
                throw new Fault(
                        "AccessToAll.jsp: getRemoteUser(): " + "- did not find \"" + stringToSearch + "\" in log.");
            } else {
            ...
            if (output.indexOf(stringToSearch) == -1) {
                throw new Fault("AccessToAll.jsp: getRemoteUser(): " + "- not mapped to role ADM");
            } else {
            ...
            if (output.indexOf(stringToSearch) == -1) {
                throw new Fault("AccessToAll.jsp: getRemoteUser(): " + "- not mapped to role MGR");
            } else {
            ...
            if (output.indexOf(stringToSearch) == -1) {
                throw new Fault("AccessToAll.jsp: getRemoteUser(): " + "- not mapped to role EMP");
            } else {
            ...
            if (output.indexOf(stringToSearch) == -1) {
                throw new Fault("AccessToAll.jsp: getRemoteUser(): " + "- mapped to role VP");
            } else {
            ...
            if (output.indexOf(stringToSearch) == -1) {
                ...
                throw new Fault("anyauthuser.jsp: getRemoteUser() - incorrectly mapped to role named '**'");
            }
    ...
    public void PermissionsToRole() throws Fault {
        ...
        String url = ctsurl.getURLString("http", hostname, portnum, pageBase + securedPage);
        try {
            URL newURL = new URL(url);
            ...
            if (output.indexOf(stringToSearch) == -1) {
                throw new Fault(
                        "PermissionToRole: getRemoteUser(): " + "- did not find \"" + stringToSearch + "\" in log.");
            } else {
    ...
    public void anyAuthUserWebResPermAddedToRole() throws Fault {
        ...
        try {
            ...
            while (iterator.hasNext()) {
                ...
                if ((msg != null) && msg.startsWith(searchStr) && (msg.indexOf("anyauthuser") > 0)) {

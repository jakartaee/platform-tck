...
public class Client extends ServiceEETest {
    ...
    public void WebUserDataPermission() throws Fault {
        ...
        String url = ctsurl.getURLString("https", hostname, securedPortNum, pageBase + sslProtectedPage);
        try {
            URL newURL = new URL(url);
            ...
            if (httpsURLConn != null) {
                ...
                TestUtil.logMsg("WebUserDataPermission():  securedPortNum = " + securedPortNum);
                TestUtil.logMsg("WebUserDataPermission():  pageBase = " + pageBase);
                TestUtil.logMsg("WebUserDataPermission():  sslProtectedPage = " + sslProtectedPage);
                TestUtil.logMsg("WebUserDataPermission():  url.toString() = " + url.toString());
                TestUtil.logMsg("WebUserDataPermission():  newURL.toString() = " + newURL.toString());
    ...
    public void WebResourcePermission() throws Fault {
        ...
        try {
            ...
            throw new Fault("WebResourcePermission test failed :" + "User j2ee allowed to access secured.jsp");

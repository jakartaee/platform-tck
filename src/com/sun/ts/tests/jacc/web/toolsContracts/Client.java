...
public class Client extends ServiceEETest {
    ...
    public void setup(String[] args, Properties p) throws Fault {
        ...
        if (!initialized) {
            ...
            logProcessor.fetchLogs("getAppSpecificRecordCollection|appId", "toolsContracts");
    ...
    public void WebResourcePermission() throws Fault {
        ...
        expectedUnCheckedPermissions.add(new WebResourcePermission(
                "/:/secured.jsp:/unchecked.jsp:/excluded.jsp:/sslprotected.jsp:/anyauthuser.jsp", (String) null));
        ...
        verified = logProcessor.verifyLogImplies(expectedUnCheckedPermissions, uncheckedWebResourcePermissions);

        if (!verified) {
            throw new Fault("WebResourcePermission failed: " + "unchecked policy statements verification failed");
        } else {
        ...
        verified = logProcessor.verifyLogImplies(expectedExcludedPermissions, excludedWebResourcePermissions);

        if (!verified) {
            throw new Fault("WebResourcePermission failed: " + "excluded policy statements verification failed");
        } else {
        ...
        verified = logProcessor.verifyLogImplies(expectedAddToRolePermissions, addToRoleWebResourcePermissions);

        if (!verified) {
            throw new Fault("WebResourcePermission failed: " + "addToRole policy statements verification failed");
        } else {
    ...
    public void WebRoleRefPermission() throws Fault {
        ...
        expectedAddToRolePermissions.add(new WebRoleRefPermission("secured", "ADM"));
        ...
        verified = logProcessor.verifyLogImplies(expectedAddToRolePermissions, addToRoleWebRoleRefPermissions);

        if (!verified) {
            throw new Fault("WebRoleRefPermission failed: " + "addToRole policy statements verification failed");
        } else {
            TestUtil.logMsg("addToRole policy statements verification successful");
        }
    }
    ...
    public void AnyAuthUserWebRoleRef() throws Fault {
        ...
        verified = logProcessor.verifyLogImplies(expectedAddToRolePerms, addToRoleWebRoleRefPermissions);
    ...
    public void WebResourcePermissionUnCheckedPolicy() throws Fault {
        ...
        verified = logProcessor.verifyLogImplies(expectedPermissions, uncheckedWebResourcePermissions);
    ...
    public void WebUserDataPermission() throws Fault {
        ...
        expectedUnCheckedPermissions.add(new WebUserDataPermission(
                "/:/unchecked.jsp:/secured.jsp:/sslprotected.jsp:/excluded.jsp:/anyauthuser.jsp", (String) null));
        expectedUnCheckedPermissions.add(new WebUserDataPermission("/unchecked.jsp", (String) null));

        TestUtil.logMsg("verifying unchecked policy statments:");

        verified = logProcessor.verifyLogImplies(expectedUnCheckedPermissions, uncheckedWebUserDataPermissions);

        if (!verified) {
            throw new Fault("WebUserDataPermission failed: " + "unchecked policy statements verification failed");
        } else {
            TestUtil.logMsg("unchecked policy statements verification successful");
        }
        ...
        verified = logProcessor.verifyLogImplies(expectedExcludedPermissions, excludedWebUserDataPermissions);

        if (!verified) {
            throw new Fault("WebUserDataPermission failed: " + "excluded policy statements verification failed");
        } else {
            TestUtil.logMsg("excluded policy statements verification successful");
        }
    }
    ...
    public void PolicyConfigurationFactory() throws Fault {
        ...
        if (!verified) {
            throw new Fault("PolicyConfigurationFactory failed : " + "PolicyconfigurationFactory not instantiated");
        } else {
    ...
    public void GetPolicyConfiguration() throws Fault {
        ...
        verified = logProcessor.verifyLogContains(args);
        if (!verified) {
            throw new Fault("GetPolicyConfiguration failed : " + "getPolicyconfiguration() was not invoked");
        } else {
    ...
    public void validateNoInvalidStates() throws Fault {
        ...
        if (verified) {
            ...
            throw new Fault("validateNoInvalidStates failed : detected error message of: " + args1[0]);
        } else {
        ...
        if (verified) {
            ...
            throw new Fault("validateNoInvalidStates failed : detected error message of: " + args2[0]);
        } else {
            TestUtil.logMsg("validateNoInvalidStates() passed.");
        }
    }
    ...
    public void Policy() throws Fault {
        ...
        if (!verified) {
            throw new Fault("TestName: Policy failed : " + "Policy replacement algorithm not used");
        } else {

...
public class Client extends ServiceEETest {
    ...
    public void PrincipalToRoleMapping() throws Fault {
        ...
        String secondURLstr = ctsurl.getURLString("http", hostname, portnum, pageSec1);
        ...
        try {
            ...
            TestUtil.logMsg("Unauthorized user " + unauthusername + " invoking " + firstURL);
            ...
            TestUtil.logMsg("Unauthorized user " + unauthusername + " invoking " + secondURL);

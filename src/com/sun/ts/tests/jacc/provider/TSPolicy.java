...
public final class TSPolicy extends java.security.Policy {
    ...
    private void policyContextKey3() {
        try {
            // Get Subject
            javax.security.auth.Subject subject = PolicyContext.getContext("javax.security.auth.Subject.container");
            logger.log(
                    Level.INFO,
                    "PolicyContext.getContext() " + "test passed for" + "javax.security.auth.Subject.container");
    ...
    private void jaccPermissionsHashCode() {
        try {
            ...
            if (hashCode1 == hashCode2) {
                ...
                logger.log(
                        Level.INFO,
                        "EJBMethodPermission.hashCode()" + " returned different values within the same application.");
            }
        ...
        try {
            ...
            if (hashCode3 == hashCode4) {
                ...
                logger.log(
                        Level.INFO,
                        "EJBRoleRefPermission.hashCode()" + " returned different values within the same application.");
            }
        ...
        try {
            ...
            if (hashCode5 == hashCode6) {
                ...
                logger.log(
                        Level.INFO,
                        "WebResourcePermission.hashCode()" + " returned different values within the same application.");
            }
        ...
        try {
            ...
            if (hashCode7 == hashCode8) {
                ...
                logger.log(
                        Level.INFO,
                        "WebRoleRefPermission.hashCode()" + " returned different values within the same application.");
            }
        ...
        try {
            ...
            if (hashCode9 == hashCode10) {
                ...
                logger.log(
                        Level.INFO,
                        "WebUserDataPermission.hashCode()" + " returned different values within the same application.");
            }
        } catch (Exception e) {

...
public class Client extends ServiceEETest implements DescriptionConstants, SOAPConstants, SchemaConstants {
    ...
    private static final String DEFAULT_STRING_OPERATION_REQUEST =
            "com.sun.ts.tests.jaxws.mapping.j2wmapping.document.literal.wrapped.jaxws.StringOperation";

    private static final String DEFAULT_STRING_OPERATION_RESPONSE =
            "com.sun.ts.tests.jaxws.mapping.j2wmapping.document.literal.wrapped.jaxws.StringOperationResponse";
    ...
    private static final String CUSTOMIZED_STRING_OPERATION_REQUEST =
            "com.sun.ts.tests.jaxws.mapping.j2wmapping.document.literal.wrapped.MyStringOperation";

    private static final String CUSTOMIZED_STRING_OPERATION_RESPONSE =
            "com.sun.ts.tests.jaxws.mapping.j2wmapping.document.literal.wrapped.MyStringOperationResponse";

    private static final String JAXB_ANNOTATIONS_TEST1 =
            "com.sun.ts.tests.jaxws.mapping.j2wmapping.document.literal.wrapped.jaxws.JaxbAnnotationsTest1";

    private static final String JAXB_ANNOTATIONS_TEST2 =
            "com.sun.ts.tests.jaxws.mapping.j2wmapping.document.literal.wrapped.jaxws.JaxbAnnotationsTest2";

    private static final String JAXB_ANNOTATIONS_TEST3 =
            "com.sun.ts.tests.jaxws.mapping.j2wmapping.document.literal.wrapped.jaxws.JaxbAnnotationsTest3";

    private static final String JAXB_ANNOTATIONS_TEST4 =
            "com.sun.ts.tests.jaxws.mapping.j2wmapping.document.literal.wrapped.jaxws.JaxbAnnotationsTest4";

    private static final String JAXB_ANNOTATIONS_FAULTBEAN =
            "com.sun.ts.tests.jaxws.mapping.j2wmapping.document.literal.wrapped.jaxws.MyFaultBean";
    ...
    private boolean CompareTypesElementsOk(String[] expectedtypes, String[] types, String opname) {
        ...
        if (expectedtypes == null && types == null) {
            ...
            if (types != null) {
                ...
                got.append("]");
                exp.append("]");
                if (!ok) TestUtil.logErr("Incorrect types: got " + got.toString() + ", expected " + exp.toString());
                else TestUtil.logMsg("Types are correct: " + got.toString());
            }
        }
        return ok;
    }
    ...
    public void VerifyParameterAndResultNaming() throws Fault {
        ...
        if (element != null) {
            ...
            if (type.indexOf(":") != -1) type = type.substring(type.indexOf(":") + 1, type.length());
        ...
        for (int i = 0; i < messages.length; i++) {
            ...
            if (Arrays.binarySearch(imessages, messageName) >= 0 || Arrays.binarySearch(omessages, messageName) >= 0) {
                ...
                if (parts.length == 0) {
                    ...
                    pass = false;
                    continue;
                } else TestUtil.logMsg("    check that element attribute exists for all its message parts ...");
                int partCnt = 0;
    ...
    public void VerifyWsdlPartNamesAndMessageNamesForMessages() throws Fault {
        ...
        for (int i = 0; i < fmessages.length; i++) TestUtil.logMsg("fault message: " + fmessages[i]);
        ...
        for (int i = 0; i < messages.length; i++) {
            ...
            if (Arrays.binarySearch(imessages, messageName) >= 0 || Arrays.binarySearch(omessages, messageName) >= 0) {
                ...
                if (messageName.contains("Response")) {
                    ...
                    if (messageName.equals("methodWithNoReturn2Response")) expectedPartname = "response";
                    ...
                    if (messageName.equals("methodWithNoReturn2")) expectedPartname = "request";
                    if (!partname.equals(expectedPartname)) {
                        TestUtil.logErr("    partname is <" + partname + "> expected: <" + expectedPartname + ">");
                        pass = false;
                    } else {
        ...
        if (!pass) throw new Fault("VerifyWsdlPartNamesAndMessageNamesForMessages failed");
        else TestUtil.logMsg("Verification passed");
    }
    ...
    public void VerifySchemaNamespacesImportsElementsAndTypes() throws Fault {
        ...
        if (!pass) throw new Fault("VerifySchemaNamespacesImportsElementsAndTypes failed");
        else TestUtil.logMsg("Verification passed");
    }
    ...
    public void VerifyDocumentWrapped() throws Fault {
        ...
        if (!pass) throw new Fault("VerifyDocumentWrapped failed");
        else TestUtil.logMsg("Verification passed");
    }
    ...
    public void VerifyJAXBMappingsTest() throws Fault {
        ...
        try {
            ...
            else TestUtil.logErr("XmlJavaTypeAdapter value is of unexpected type: " + type);
            ...
            if (!AnnotationUtils.verifyXmlElement(x, "xmljavatypeadapter", "foo", true, true)) pass = false;
        ...
        try {
            ...
            else TestUtil.logErr("XmlMimeType value is of unexpected type: " + type);

            XmlElement x = (XmlElement) AnnotationUtils.getAnnotationOnField(
                    c, "xmlmimetype", jakarta.xml.bind.annotation.XmlElement.class);
            if (!AnnotationUtils.verifyXmlElement(x, "xmlmimetype", "foo", false, false)) pass = false;
        } catch (Exception e) {
            TestUtil.logErr("Exception loading class: " + e);
            pass = false;
        }
        try {
            ...
            if (!AnnotationUtils.verifyXmlElement(x, "xmlattachmentref", "foo", false, false)) pass = false;
        } catch (Exception e) {
            TestUtil.logErr("Exception loading class: " + e);
            pass = false;
        }
        try {
            ...
            XmlElement x = (XmlElement)
                    AnnotationUtils.getAnnotationOnField(c, "xmllist", jakarta.xml.bind.annotation.XmlElement.class);
            if (!AnnotationUtils.verifyXmlElement(x, "xmllist", "foo", false, true)) pass = false;
        } catch (Exception e) {
            TestUtil.logErr("Exception loading class: " + e);
            pass = false;
        }
        if (!pass) throw new Fault("VerifyJAXBMappingsTest failed");
        else TestUtil.logMsg("Verification passed");
    }
    ...
    public void VerifyXmlTypeAnnotationOnFaultBean() throws Fault {
        ...
        try {
            ...
            if (!AnnotationUtils.verifyXmlType(x, "Bozo", "http://bozo.org/wsdl")) pass = false;
        } catch (Exception e) {
            TestUtil.logErr("Exception loading class: " + e);
            pass = false;
        }
        if (!pass) throw new Fault("VerifyXmlTypeAnnotationOnFaultBean failed");
        else TestUtil.logMsg("Verification passed");
    }
}

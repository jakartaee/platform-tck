...
public class Client extends ServiceEETest {
     ...
     * JAXWS:SPEC:2017; JAXWS:SPEC:2040;
     *
    ...
    public void FaultTest() throws Fault {
        ...
        boolean found = AnnotationUtils.verifyWebFaultAnnotation(
                faultWrapper, "MyFaultReason", "http://w2jrlnoncustomization/types", EXPECTED_FAULT_BEAN);
        if (!found) {
            TestUtil.logErr(
     ...
     *
     * @assertion_ids: JAXWS:SPEC:2001; JAXWS:SPEC:2002; JAXWS:SPEC:2003; JAXWS:SPEC:2004; JAXWS:SPEC:2055; JAXWS:SPEC:2056;
     * JAXWS:SPEC:2040; JAXWS:SPEC:2070; JAXWS:SPEC:2071;
     *
     ...
     * @testName: HeaderTest
     *
     * @assertion_ids: JAXWS:SPEC:2001; JAXWS:SPEC:2002; JAXWS:SPEC:2003; JAXWS:SPEC:2004; JAXWS:SPEC:2040;
     *
    ...
    public void HeaderTest() throws Fault {
        ...
        try {
            Method helloOp = endpointClass.getMethod(
                    "helloOperation", new Class[] { w2jrlnoncustomization.types.StringElement.class });

...
public class Client extends ServiceEETest {
     ...
     *
     * @assertion_ids: JAXWS:SPEC:2001; JAXWS:SPEC:2002; JAXWS:SPEC:2003; JAXWS:SPEC:2004; JAXWS:SPEC:2005; JAXWS:SPEC:2010;
     * JAXWS:SPEC:2041;
     *
     ...
     * JAXWS:SPEC:2018; JAXWS:SPEC:2017; JAXWS:SPEC:2041;
     *
     ...
     * JAXWS:SPEC:2041; JAXWS:SPEC:2061;
     *
    ...
    public void FaultTest() throws Fault {
        ...
        boolean found = AnnotationUtils.verifyWebFaultAnnotation(
                faultWrapper, "MyFaultReason", "http://w2jrlcustomization/types", EXPECTED_FAULT_BEAN);
        if (!found) {
            TestUtil.logErr(
     ...
     * JAXWS:SPEC:2056; JAXWS:SPEC:2041; JAXWS:SPEC:2045;
     *
     ...
     * @testName: HeaderTest
     *
     * @assertion_ids: JAXWS:SPEC:2001; JAXWS:SPEC:2002; JAXWS:SPEC:2003; JAXWS:SPEC:2004; JAXWS:SPEC:2041;
     *
        ...
        try {
            ...
            if (theMethod != null) {
                ...
                if (!found) {
                    ...
                    TestUtil.logMsg("operationWithHeaderAndFaults does declare a header as parameter for type "
                            + EXPECTED_HEADER2_TYPE);
                }

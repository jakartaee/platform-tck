...
public class Client extends ServiceEETest {
    ...
    public void HelloOperationAnnotationsTest() throws Fault {
        ...
        try {
            ...
            result = AnnotationUtils.verifyWebResultAnnotation(
                    c, "helloOperation", "result", "http://w2jrlannotations.org/wsdl");
            if (result == false) {
                pass = false;
            }

            result = AnnotationUtils.verifyWebParamAnnotation(
                    c, 0, "helloOperation", "parameter", "http://w2jrlannotations.org/wsdl", "IN", false);
            if (result == false) {
                pass = false;
            }
    ...
    public void OnewayAnnotationsTest() throws Fault {
        ...
        try {
            ...
            result = AnnotationUtils.verifyWebParamAnnotation(
                    c, 0, "onewayOperation", "varString", "http://w2jrlannotations.org/wsdl", "IN", false);
            if (result == false) {
                pass = false;
            }
        } catch (Exception e) {
    ...
    public void WebParamModesAnnotationsTest() throws Fault {
        ...
        try {
            ...
            result = AnnotationUtils.verifyWebParamAnnotation(
                    c, 0, "mode1Operation", "varString", "http://w2jrlannotations.org/wsdl", "IN", false);
            if (result == false) {
                pass = false;
            }
            ...
            result = AnnotationUtils.verifyWebParamAnnotation(
                    c, 0, "mode3Operation", "varString", "http://w2jrlannotations.org/wsdl", "OUT", false);
            if (result == false) {
                pass = false;
            }
    ...
    public void WebServiceClientAnnotationsTest() throws Fault {
        ...
        try {
            ...
            boolean result = AnnotationUtils.verifyWebServiceClientAnnotation(
                    c, "W2JRLAnnotations", "http://w2jrlannotations.org/wsdl", "W2JRLAnnotations.wsdl");
            if (result == false) {
                pass = false;
            }
        } catch (Exception e) {

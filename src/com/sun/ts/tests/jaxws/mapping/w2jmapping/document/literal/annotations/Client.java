...
public class Client extends ServiceEETest {
     ...
     *
     * @assertion_ids: JAXWS:SPEC:7004; JAXWS:SPEC:7013; JAXWS:JAVADOC:39; JAXWS:JAVADOC:40; JAXWS:JAVADOC:41;
     *
    ...
    public void RequestWrapperAnnotationTest() throws Fault {
        ...
        try {
            ...
            TestUtil.logTrace("------------------------");
            boolean result = AnnotationUtils.verifyRequestWrapperAnnotation(
                    c,
                    "wrapperElement1",
                    "WrapperElement1",
     ...
     *
     * @assertion_ids: JAXWS:SPEC:7005; JAXWS:SPEC:7013; JAXWS:JAVADOC:43; JAXWS:JAVADOC:44; JAXWS:JAVADOC:45;
     *
     * @test_Strategy: Generate classes from a wsdl and verify existence of annotations
     */
    public void ResponseWrapperAnnotationTest() throws Fault {
        ...
        try {
            ...
            TestUtil.logTrace("testing WebService for the class");
            TestUtil.logTrace("------------------------");
            boolean result = AnnotationUtils.verifyResponseWrapperAnnotation(
                    c,
                    "wrapperElement1",
                    "WrapperElement11",
                    "http://w2jdlannotations.org/types",
    ...
    public void WebServiceAnnotationTest() throws Fault {
        ...
        try {
            ...
            TestUtil.logTrace("testing WebService for the class");
            TestUtil.logTrace("------------------------");
            boolean result = AnnotationUtils.verifyWebServiceAnnotation(
                    c,
    ...
    public void SOAPBindingAnnotationTest() throws Fault {
        ...
        try {
            ...
            boolean result = AnnotationUtils.verifySOAPBindingAnnotationPerMethod(
                    c, "wrapperElement1", "DOCUMENT", "LITERAL", "WRAPPED");
            if (result == false) {
                pass = false;
            }

            result = AnnotationUtils.verifySOAPBindingAnnotationPerMethod(
                    c, "helloOperation", "DOCUMENT", "LITERAL", "BARE");
            if (result == false) {
                pass = false;
            }

            result = AnnotationUtils.verifySOAPBindingAnnotationPerMethod(
                    c, "onewayOperation", "DOCUMENT", "LITERAL", "BARE");
            if (result == false) {
                pass = false;
            }

            result = AnnotationUtils.verifySOAPBindingAnnotationPerMethod(
                    c, "mode1Operation", "DOCUMENT", "LITERAL", "BARE");
            if (result == false) {
                pass = false;
            }

            result = AnnotationUtils.verifySOAPBindingAnnotationPerMethod(
                    c, "mode2Operation", "DOCUMENT", "LITERAL", "BARE");
            if (result == false) {
                pass = false;
            }

            result = AnnotationUtils.verifySOAPBindingAnnotationPerMethod(
                    c, "mode3Operation", "DOCUMENT", "LITERAL", "BARE");
            if (result == false) {
                pass = false;
            }
    ...
    public void HelloOperationAnnotationsTest() throws Fault {
        ...
        try {
            ...
            result = AnnotationUtils.verifyWebResultAnnotation(
                    c, "helloOperation", "HelloStringElement", "http://w2jdlannotations.org/types");
            if (result == false) {
                pass = false;
            }

            result = AnnotationUtils.verifyWebParamAnnotation(
                    c, 0, "helloOperation", "HelloStringElement", "http://w2jdlannotations.org/types", "IN", false);
            if (result == false) {
                pass = false;
            }
    ...
    public void OnewayAnnotationsTest() throws Fault {
        ...
        try {
            ...
            result = AnnotationUtils.verifyWebParamAnnotation(
                    c, 0, "onewayOperation", "OneWayStringElement", "http://w2jdlannotations.org/types", "IN", false);
            if (result == false) {
                pass = false;
            }
        } catch (Exception e) {
    ...
    public void WebParamModesAnnotationsTest() throws Fault {
        ...
        try {
            ...
            result = AnnotationUtils.verifyWebParamAnnotation(
                    c, 0, "mode1Operation", "Mode1StringElement", "http://w2jdlannotations.org/types", "IN", false);
            if (result == false) {
                pass = false;
            }
            ...
            result = AnnotationUtils.verifyWebParamAnnotation(
                    c, 0, "mode3Operation", "Mode3StringElement", "http://w2jdlannotations.org/types", "OUT", false);
            if (result == false) {
                pass = false;
            }
    ...
    public void WebFaultAnnotationsTest() throws Fault {
        ...
        try {
            Class c = Class.forName(
                    ...
                    false,
                    this.getClass().getClassLoader());
            boolean result = AnnotationUtils.verifyWebFaultAnnotation(
                    c,
                    "MyFault",
                    "http://w2jdlannotations.org/types",
    ...
    public void WebServiceClientAnnotationsTest() throws Fault {
        ...
        try {
            ...
            TestUtil.logTrace("------------------------");
            boolean result = AnnotationUtils.verifyWebServiceClientAnnotation(
                    c, "W2JDLAnnotations", "http://w2jdlannotations.org/wsdl", "W2JDLAnnotations.wsdl");
            if (result == false) {
                pass = false;
            }
        } catch (Exception e) {
     ...
     *
     * @assertion_ids: JAXWS:JAVADOC:62; JAXWS:SPEC:7007; JAXWS:SPEC:2065; JAXWS:SPEC:7013;
     *
     * @test_Strategy: Generate classes from a wsdl and verify existence of annotations
     */
    public void WebEndpointAnnotationsTest() throws Fault {
        ...
        try {
            ...
            TestUtil.logTrace("------------------------");
            boolean result = AnnotationUtils.verifyWebEndpointAnnotation(
                    c, "getW2JDLAnnotationsEndpointPort", "W2JDLAnnotationsEndpointPort");
            if (result == false) {
                pass = false;
            }
        } catch (Exception e) {
    ...
    public void ActionFaultActionAndAddressingAnnotationsTest() throws Fault {
        ...
        try {
            ...
            result = AnnotationUtils.verifyActionFaultActionAnnotation(c, "address2", true, null, "output2", faults);
            if (result == false) {
                pass = false;
            }
            String faults3[][] = {
                    { "com.sun.ts.tests.jaxws.mapping.w2jmapping.document.literal.annotations.Myfault3AException", "fault3a"
                    },
                    { "com.sun.ts.tests.jaxws.mapping.w2jmapping.document.literal.annotations.Myfault3BException", "fault3b" }
            };
            ...
            c = Class.forName(
                    ...
                    this.getClass().getClassLoader());
            String faults4[][] = {
                    { "com.sun.ts.tests.jaxws.mapping.w2jmapping.document.literal.annotations.Myfault4Exception", "fault4" }
            };
            ...
            String faults5[][] = {
                    { "com.sun.ts.tests.jaxws.mapping.w2jmapping.document.literal.annotations.Myfault5Exception", "fault5" }
            };
            ...
            c = Class.forName(
                    ...
                    this.getClass().getClassLoader());
            String faults6[][] = {};
            result = AnnotationUtils.verifyActionFaultActionAnnotation(c, "address6", false, "", "", faults6);
            if (result == false) {
                pass = false;
            }
            String faults7[][] = {};
            result = AnnotationUtils.verifyActionFaultActionAnnotation(c, "address7", false, "", "", faults7);
            if (result == false) {
                pass = false;
            }
            c = Class.forName(
                    ...
                    this.getClass().getClassLoader());
            String faults8[][] = {};
            result = AnnotationUtils.verifyActionFaultActionAnnotation(c, "address8", true, "input8", null, faults8);
            if (result == false) {
                pass = false;
            }
            String faults9[][] = {};
            result = AnnotationUtils.verifyActionFaultActionAnnotation(c, "address9", true, null, "output9", faults9);
            if (result == false) {
                pass = false;
            }
            c = Class.forName(
                    ...
                    this.getClass().getClassLoader());
            String faults10[][] = {};
            result = AnnotationUtils.verifyActionFaultActionAnnotation(c, "address10", true, "input10", null, faults10);
            if (result == false) {
                pass = false;
            }
            String faults11[][] = {};
            result = AnnotationUtils.verifyActionFaultActionAnnotation(c, "address11", true, null, "output11", faults11);
            if (result == false) {
                pass = false;
            }
        } catch (Exception e) {

...
public class Client extends ServiceEETest {
    ...
    private boolean compare_inoutarray_data() {
        ...
        if (!JAXWS_Data.compareArrayValues(
                JAXWS_Data.XMLGregorianCalendar_nonull_data, dateTimeArray, "XMLGregorianCalendar")) {
    ...
    public void InOutSimpleTypesTest() throws Fault {
        ...
        try {
            ...
            port.echoInOutSimpleTypes(
                    inout1, inout2, inout3, inout4, inout5, inout6, inout7, inout8, inout9, inout10, inout11, inout12);
    ...
    public void InOutUserDefinedTypeTest() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Data Out: [" + v.getAuthor() + "|" + v.getTitle() + "|" + v.getIsbn() + "]");
            ...
            if (blist.size() != 2) {
                ...
                for (int i = 0; i < r.length; i++) {
                    if (!r[i].getAuthor().equals(s[i].getAuthor())
                        ...
                        TestUtil.logMsg("Expected: [" + s[i].getAuthor() + "|" + s[i].getTitle()

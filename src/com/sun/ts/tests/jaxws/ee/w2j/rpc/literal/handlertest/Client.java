    ...
    public void ClientHandlerDoesNotGetCalledTest() throws Fault {
        ...
        try {
            if (!setupPorts()) {
                ...
                TestUtil.logMsg("Programmatically registering the following handlers which should never be called: \n"
                        + "ClientSNBCLogicalHandler, ClientSNBCSOAPHandler");
                List<Handler> handlerList = new ArrayList<Handler>();
                TestUtil.logMsg("Construct HandleInfo for ClientSNBCLogicalHandler and add to HandlerChain");
                handler = new com.sun.ts.tests.jaxws.sharedclients.rlhandlerclient.ClientSNBCLogicalHandler();
                handlerList.add(handler);
                TestUtil.logMsg("Construct HandleInfo for ClientSNBCSOAPHandler and add to HandlerChain");

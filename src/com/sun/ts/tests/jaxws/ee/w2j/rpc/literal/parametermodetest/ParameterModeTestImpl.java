...
public class ParameterModeTestImpl implements ParameterModeTest {
    ...
    public void echoInSimpleTypes(
            ...
            XMLGregorianCalendar varDateTime,
    ...
    public void echoOutSimpleTypes(
            Holder<String> varString,
            Holder<BigInteger> varInteger,
            Holder<Integer> varInt,
            Holder<Long> varLong,
            Holder<Short> varShort,
            Holder<BigDecimal> varDecimal,
            Holder<Float> varFloat,
            Holder<Double> varDouble,
            Holder<Boolean> varBoolean,
            Holder<Byte> varByte,
            Holder<QName> varQName,
            Holder<XMLGregorianCalendar> varDateTime,
            Holder<byte[]> varBase64Binary,
    ...
    public void echoInEnum(
            EnumString varEnumString,
            BigInteger varEnumInteger,
            int varEnumInt,
            long varEnumLong,
            short varEnumShort,
            java.math.BigDecimal varEnumDecimal,
            float varEnumFloat,
            double varEnumDouble,
            byte varEnumByte) {
    ...
    public void echoOutEnum(
            Holder<EnumString> varEnumString,
            Holder<BigInteger> varEnumInteger,
            Holder<Integer> varEnumInt,
            Holder<Long> varEnumLong,
            Holder<Short> varEnumShort,
            Holder<BigDecimal> varEnumDecimal,
            Holder<Float> varEnumFloat,
            Holder<Double> varEnumDouble,

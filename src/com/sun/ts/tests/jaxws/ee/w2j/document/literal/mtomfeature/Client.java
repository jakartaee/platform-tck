...
public class Client extends ServiceEETest {
    ...
    private void getPortStandalone() throws Exception {
        port1 = (MTOMFeatureTest1) JAXWS_Util.getPort(
                wsdlurl, SERVICE_QNAME, MTOMFeatureTestService.class, PORT_QNAME1, MTOMFeatureTest1.class, mtomenabled);
        JAXWS_Util.setTargetEndpointAddress(port1, url1);
        port2 = (MTOMFeatureTest2) JAXWS_Util.getPort(
                wsdlurl, SERVICE_QNAME, MTOMFeatureTestService.class, PORT_QNAME2, MTOMFeatureTest2.class, mtomenabled);
        JAXWS_Util.setTargetEndpointAddress(port2, url2);
        port3_1 = (MTOMFeatureTest3) JAXWS_Util.getPort(
                wsdlurl,
                SERVICE_QNAME,
                MTOMFeatureTestService.class,
                PORT_QNAME3,
                MTOMFeatureTest3.class,
                mtomenabledtheshold2000);
        JAXWS_Util.setTargetEndpointAddress(port3_1, url3);
        port3_2 = (MTOMFeatureTest3) JAXWS_Util.getPort(
                wsdlurl,
                SERVICE_QNAME,
                MTOMFeatureTestService.class,
                PORT_QNAME3,
        ...
        port4_1 = (MTOMFeatureTest4) JAXWS_Util.getPort(
                wsdlurl,
                SERVICE_QNAME,
                MTOMFeatureTestService.class,
                PORT_QNAME4,
                MTOMFeatureTest4.class,
                mtomenabledtheshold2000);
        JAXWS_Util.setTargetEndpointAddress(port4_1, url4);
        port4_2 = (MTOMFeatureTest4) JAXWS_Util.getPort(
                wsdlurl,
                SERVICE_QNAME,
                MTOMFeatureTestService.class,
                PORT_QNAME4,
    ...
    public void ClientEnabledServerEnabledLT2000Test() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Sending a jpg document that is below the threshold [" + SDOCSmallJpeg + "]");
    ...
    public void ClientEnabledServerEnabledGT2000Test() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Sending a jpg document that is above the threshold [" + SDOCBigJpeg + "]");
            port3_1.threshold2000(d);

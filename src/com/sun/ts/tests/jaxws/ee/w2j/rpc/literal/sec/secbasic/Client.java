...
public class Client extends ServiceEETest {
    ...
    private void getUnprotectedServiceStubStandalone() throws Exception {
        port1 = (HelloUnprotected) JAXWS_Util.getPort(
                wsdlurl1, SERVICE_QNAME, BasicAuthServiceTestService.class, PORT_QNAME1, HelloUnprotected.class);
        JAXWS_Util.setTargetEndpointAddress(port1, url1);
    }

    private void getProtectedNoIdServiceStubStandalone() throws Exception {
        port2noid = (HelloProtected) JAXWS_Util.getPort(
                wsdlurl2, SERVICE_QNAME, BasicAuthServiceTestService.class, PORT_QNAME2, HelloProtected.class);
        JAXWS_Util.setTargetEndpointAddress(port2noid, url2);
    }

    private void getProtectedValidIdServiceStubStandalone() throws Exception {
        port2validid = (HelloProtected1) JAXWS_Util.getPort(
                wsdlurl4, SERVICE_QNAME, BasicAuthServiceTestService.class, PORT_QNAME4, HelloProtected1.class);
    ...
    private void getProtectedInvalidIdServiceStubStandalone() throws Exception {
        port2invalidid = (HelloProtected2) JAXWS_Util.getPort(
                wsdlurl5, SERVICE_QNAME, BasicAuthServiceTestService.class, PORT_QNAME5, HelloProtected2.class);
    ...
    private void getProtectedUnauthIdServiceStubStandalone() throws Exception {
        port2unauthid = (HelloProtected3) JAXWS_Util.getPort(
                wsdlurl6, SERVICE_QNAME, BasicAuthServiceTestService.class, PORT_QNAME6, HelloProtected3.class);
        JAXWS_Util.setTargetEndpointAddress(port2unauthid, url6);
    }

    private void getGuestServiceStubStandalone() throws Exception {
        port3 = (HelloGuest) JAXWS_Util.getPort(
                wsdlurl3, SERVICE_QNAME, BasicAuthServiceTestService.class, PORT_QNAME3, HelloGuest.class);

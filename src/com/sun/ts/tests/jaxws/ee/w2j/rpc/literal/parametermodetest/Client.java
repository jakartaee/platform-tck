...
public class Client extends ServiceEETest {
    ...
    private void getPortStandalone() throws Exception {
        port = (ParameterModeTest) JAXWS_Util.getPort(
                wsdlurl, SERVICE_QNAME, ParameterModeTestService.class, PORT_QNAME, ParameterModeTest.class);
    ...
    private boolean compare_out_inoutarray_data() {
        ...
        if (!JAXWS_Data.compareArrayValues(
                out_inoutarray1_tmp.value.getArrayOfstring(), out_inoutarray1.value.getArrayOfstring(), "String")) {
        ...
        if (!JAXWS_Data.compareArrayValues(
                out_inoutarray3_tmp.value.getArrayOfint(), out_inoutarray3.value.getArrayOfint(), "int")) {
            TestUtil.logMsg("int array data miscompare");
            pass = false;
        }
        if (!JAXWS_Data.compareArrayValues(
                out_inoutarray4_tmp.value.getArrayOflong(), out_inoutarray4.value.getArrayOflong(), "long")) {
            TestUtil.logMsg("long array data miscompare");
            pass = false;
        }
        if (!JAXWS_Data.compareArrayValues(
                out_inoutarray5_tmp.value.getArrayOfshort(), out_inoutarray5.value.getArrayOfshort(), "short")) {
        ...
        if (!JAXWS_Data.compareArrayValues(
                out_inoutarray7_tmp.value.getArrayOffloat(), out_inoutarray7.value.getArrayOffloat(), "float")) {
            TestUtil.logMsg("float array data miscompare");
            pass = false;
        }
        if (!JAXWS_Data.compareArrayValues(
                out_inoutarray8_tmp.value.getArrayOfdouble(), out_inoutarray8.value.getArrayOfdouble(), "double")) {
            TestUtil.logMsg("double array data miscompare");
            pass = false;
        }
        if (!JAXWS_Data.compareArrayValues(
                out_inoutarray9_tmp.value.getArrayOfboolean(), out_inoutarray9.value.getArrayOfboolean(), "boolean")) {
            TestUtil.logMsg("boolean array data miscompare");
            pass = false;
        }
        if (!JAXWS_Data.compareArrayValues(
                out_inoutarray10_tmp.value.getArrayOfbyte(), out_inoutarray10.value.getArrayOfbyte(), "byte")) {
            TestUtil.logMsg("byte array data miscompare");
            pass = false;
        }
        if (!JAXWS_Data.compareArrayValues(
                out_inoutarray11_tmp.value.getArrayOfQName(), out_inoutarray11.value.getArrayOfQName(), "QName")) {
    ...
    public void InOutSimpleTypesArrayTest() throws Fault {
        ...
        try {
            TestUtil.logMsg("Marshalling input/output data");
            port.echoInOutSimpleTypesArray(
                    out_inoutarray1,
                    out_inoutarray2,
                    out_inoutarray3,
                    out_inoutarray4,
    ...
    public void InOutUserDefinedTypeTest() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Data Out: [" + b.getAuthor() + "|" + b.getTitle() + "|" + b.getIsbn() + "]");

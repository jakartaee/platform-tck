...
public class Client extends ServiceEETest {
    ...
    private static final Class SERVICE_CLASS =
            com.sun.ts.tests.jaxws.ee.w2j.document.literal.onewayhandlertest.client.DLOWHandlerTestService.class;
    ...
    public void setup(String[] args, Properties p) throws Fault {
        ...
        try {
            ...
            try {
                ...
                TestUtil.logMsg("An ERROR occurred for the property " + CLIENTDELAY + ", using default value of "
                        + clientDelay + " second");
                TestUtil.printStackTrace(e);
            }
            ...
            if (modeProperty.equals("standalone")) {
                ...
                getTestURLs();
                service = (DLOWHandlerTestService) JAXWS_Util.getService(wsdlurl, SERVICE_QNAME, SERVICE_CLASS);
            } else {
                getTestURLs();
            ...
            service.setHandlerResolver(
                    new HandlerResolver() {
                        public List<Handler> getHandlerChain(PortInfo info) {
                            ...
                            handler =
                                    new com.sun.ts.tests.jaxws.ee.w2j.document.literal.onewayhandlertest.client
                                            .ClientSOAPHandler1();
                            handlerList.add(handler);
                            TestUtil.logMsg("Construct HandleInfo for ClientLogicalHandler1 and add to HandlerChain");
                            handler = new com.sun.ts.tests.jaxws.ee.w2j.document.literal.onewayhandlertest.client
    ...
    public void ClientLogicalOutboundHandleMessageThrowsSOAPFaultTest() throws Fault {
        ...
        try {
            ...
            if (pass) {
                ...
                if (!Handler_Util.VerifyOneWaySOAPFaultCallbacks(
                        "Client", Constants.OUTBOUND, LOGICAL, clientSideMsgs)) {
                    TestUtil.logErr("Client-Side Callbacks are (incorrect)");
                    pass = false;
                } else {
                    TestUtil.logMsg("Client-Side Callbacks are (correct)");
    ...
    public void ClientLogicalOutboundHandleMessageReturnsFalseTest() throws Fault {
        ...
        try {
            ...
            if (pass) {
                ...
                if (!Handler_Util.VerifyOneWayHandleMessageFalseCallbacks(
                        "Client", Constants.OUTBOUND, LOGICAL, clientSideMsgs)) {
                    TestUtil.logErr("Client-Side Callbacks are (incorrect)");
                    pass = false;
                } else {
    ...
    public void ClientSOAPOutboundHandleMessageReturnsFalseTest() throws Fault {
        ...
        try {
            ...
            if (pass) {
                ...
                if (!Handler_Util.VerifyOneWayHandleMessageFalseCallbacks(
                        "Client", Constants.OUTBOUND, SOAP, clientSideMsgs)) {
                    TestUtil.logErr("Client-Side Callbacks are (incorrect)");
                    pass = false;
                } else {
                    TestUtil.logMsg("Client-Side Callbacks are (correct)");
    ...
    public void ServerLogicalInboundHandleMessageThrowsSOAPFaultTest() throws Fault {
        ...
        if (pass) {
            ...
            try {
                ...
                if (!Handler_Util.VerifyOneWaySOAPFaultCallbacks(
                        "Server", Constants.INBOUND, LOGICAL, serverSideMsgs)) {
                    TestUtil.logErr("Server-Side Callbacks are (incorrect)");
                    pass = false;
                } else {
                    TestUtil.logMsg("Server-Side Callbacks are (correct)");
    ...
    public void ServerSOAPInboundHandleMessageReturnsFalseTest() throws Fault {
        ...
        if (pass) {
            ...
            try {
                ...
                if (!Handler_Util.VerifyOneWayHandleMessageFalseCallbacks(
                        "Server", Constants.INBOUND, SOAP, serverSideMsgs)) {
                    TestUtil.logErr("Server-Side Callbacks are (incorrect)");
                    pass = false;
                } else {
                    TestUtil.logMsg("Server-Side Callbacks are (correct)");

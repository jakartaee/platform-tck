...
public class Client extends ServiceEETest {
    ...
    private void getPortStandalone() throws Exception {
        port = (HandlerChainTest) JAXWS_Util.getPort(
                wsdlurl, SERVICE_QNAME, HandlerChainTestService.class, PORT_QNAME, HandlerChainTest.class);
     ...
     *
     * @test_Strategy: Use a handler that is specified on the Impl and see that it transforms the body
     */

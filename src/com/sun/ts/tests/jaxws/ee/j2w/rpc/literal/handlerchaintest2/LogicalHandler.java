...
public class LogicalHandler implements jakarta.xml.ws.handler.LogicalHandler<LogicalMessageContext> {
    ...
    public boolean handleMessage(LogicalMessageContext context) {
        ...
        if (Handler_Util.checkForMsg(this, context, "HandlerChainOnSEITest")) {
            ...
            System.out.println("didn't find HandlerChainOnSEITest message, handler will ignore");
        }
        System.out.println("exiting " + HANDLER_NAME + ":handleMessage");
        return true;
    }

    public void HandlerChainOnSEITest(LogicalMessageContext context, String direction) {
        ...
        String newTmp = tmp.replaceAll("HandlerChainOnSEITest", "HandlerChainOnSEITest" + direction + HANDLER_NAME);

...
public class LogicalHandler implements jakarta.xml.ws.handler.LogicalHandler<LogicalMessageContext> {
    ...
    public boolean handleMessage(LogicalMessageContext context) {
        ...
        if (Handler_Util.checkForMsg(this, context, "HandlerChainOnImplTest")) {
            ...
            System.out.println("didn't find HandlerChainOnImplTest message, handler will ignore");
        }
        System.out.println("exiting " + HANDLER_NAME + ":handleMessage");
        return true;
    }

    public void HandlerChainOnImplTest(LogicalMessageContext context, String direction) {
        ...
        String newTmp = tmp.replaceAll("HandlerChainOnImplTest", "HandlerChainOnImplTest" + direction + HANDLER_NAME);

        ...
        if (!Handler_Util.checkForMsg(this, context, "GetTrackerData")) {
            ...
            if (direction.equals(Constants.INBOUND)) {
                if (Handler_Util.checkForMsg(
                        this, context, "ServerLogicalInboundHandleMessageThrowsRuntimeExceptionTest")) {
                    ...
                    try {
                        ...
                        HandlerTracker.reportThrowable(
                                this, new Exception("Unexpected error in handleMessage for an inbound message" + e));
                    }
                ...
                if (Handler_Util.checkForMsg(
                    ...
                    try {
                        ...
                        HandlerTracker.reportThrowable(
                                this, new Exception("Unexpected error in handleMessage for an outbound message" + e));
                    }
                    throw new SOAPFaultException(sf);
                }
            }

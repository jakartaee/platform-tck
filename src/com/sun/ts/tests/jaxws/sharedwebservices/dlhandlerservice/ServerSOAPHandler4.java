        ...
        if (!Handler_Util.checkForMsg(this, context, "GetTrackerData")) {
            ...
            if (direction.equals(Constants.INBOUND)) {
                if (Handler_Util.checkForMsg(
                        this, context, "ServerSOAPInboundHandleMessageThrowsRuntimeExceptionTest")) {
                    ...
                    return false;
                        ...
                        this, context, "ServerSOAPInboundHandleMessageThrowsSOAPFaultExceptionTest")) {
                ...
                if (Handler_Util.checkForMsg(
                        this, context, "ServerSOAPOutboundHandleMessageThrowsRuntimeExceptionTest")) {
                    ...
                    return false;
                        ...
                        this, context, "ServerSOAPOutboundHandleMessageThrowsSOAPFaultExceptionTest")) {

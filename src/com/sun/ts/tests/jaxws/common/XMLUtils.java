    ...
    public static String getAttrValue_(Node n, String name, String value) {
        ...
        if (attribs != null) {
            for (int i = 0; i < attribs.getLength(); i++) {
                ...
                System.out.println("<Attribute>" + attName + "=" + attValue + "</Attribute>");
                ...
                if (index != -1) {
                    value = value.substring(0, index) + value.substring(index).toUpperCase();
                }
                if ((attName.equals(name) || attName.indexOf(name) != -1) && attValue.indexOf(value) != -1) {
                    retAttr = attValue;
                    break;
                }
            }

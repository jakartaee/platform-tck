...
public class Constants {
    ...
    public static final String NSURI_SOAP12HTTP_MTOM_BINDING =
    ...
    public static final String EXPECTED_SOAP11HTTP_MTOM_BINDING = NSURI_SOAP11HTTP_MTOM_BINDING;

    public static final String EXPECTED_SOAP12HTTP_MTOM_BINDING = NSURI_SOAP12HTTP_MTOM_BINDING;
}

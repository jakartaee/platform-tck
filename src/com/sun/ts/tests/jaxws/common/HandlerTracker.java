...
public final class HandlerTracker {
    ...
    public static void reportGetHeaders(Handler handler) {
        TestUtil.logTrace("HandlerTracker: " + getIdNameOnly(handler) + ".getHeaders()");
        messages1.add(getIdNameOnly(handler) + ".getHeaders()");
    }

    public static void reportHandleFault(Handler handler) {
        TestUtil.logTrace("HandlerTracker: " + getIdNameOnly(handler) + ".handleFault()");
    ...
    public static void reportComment(Handler handler, String comment) {
        TestUtil.logTrace("HandlerTracker: " + getIdNameOnly(handler) + " " + comment);
        messages1.add(getIdNameOnly(handler) + " " + comment);
    }

    public static void reportHandleMessage(Handler handler, String direction) {
        TestUtil.logTrace("HandlerTracker: " + getIdNameOnly(handler) + ".handleMessage().do" + direction + "()");
        messages1.add(getIdNameOnly(handler) + ".handleMessage().do" + direction + "()");
    }

    public static void reportPut(Handler h, String p, String v) {
        TestUtil.logTrace(
                "HandlerTracker: reportPut()=" + getIdNameOnly(h) + ".MessageContext.put(" + p + "," + v + ")");
        messages2.add(getIdNameOnly(h) + ".MessageContext.put(" + p + "," + v + ")");
    }

    public static void reportSetScope(Handler h, String p, String s) {
        TestUtil.logTrace("HandlerTracker: reportSetScope()=" + getIdNameOnly(h) + ".MessageContext.setPropertyScope("
                + p + "," + s + ")");
        messages2.add(getIdNameOnly(h) + ".MessageContext.setPropertyScope(" + p + "," + s + ")");
    }

    public static void reportProperties(Handler h, String d, String p, String v) {
        TestUtil.logTrace("HandlerTracker: reportProperties()=" + d + getIdNameOnly(h) + ".MessageContext.getProperty("
                + p + ")=" + v);
        messages2.add(d + getIdNameOnly(h) + ".MessageContext.getProperty(" + p + ")=" + v);
    }

    public static void reportGet(Handler h, String p, String v) {
        TestUtil.logTrace(
                "HandlerTracker: reportGet()=" + getIdNameOnly(h) + ".MessageContext.getProperty(" + p + ")=" + v);
        messages2.add(getIdNameOnly(h) + ".MessageContext.getProperty(" + p + ")=" + v);
    }

    public static void reportGetScope(Handler h, String p, String v) {
        TestUtil.logTrace("HandlerTracker: reportGetScope()=" + getIdNameOnly(h) + ".MessageContext.getPropertyScope("
                + p + ")=" + v);
        messages2.add(getIdNameOnly(h) + ".MessageContext.getPropertyScope(" + p + ")=" + v);
    }

    public static void reportSMCGetMessage(Handler h, String direction, String s) {
        TestUtil.logTrace("HandlerTracker: reportSMCGetMessage()=" + direction + getIdNameOnly(h)
                + ".SOAPMessageContext.getMessage()=" + s);
        messages3.add(direction + getIdNameOnly(h) + ".SOAPMessageContext.getMessage()=" + s);
    }

    public static void reportSMCSetMessage(Handler h, String direction) {
        messages3.add(direction + getIdNameOnly(h) + ".SOAPMessageContext.setMessage() was called");
    }

    public static void reportSMCGetRoles(Handler h, String direction, java.util.Set<String> set) {
        ...
        s.append("|");
        messages3.add(direction + getIdNameOnly(h) + ".SOAPMessageContext.getRoles()=" + s);
    }
    ...
    public static void reportSMCGetHeaders(Handler h, String direction, Object[] o) {
        ...
        s.append("|");
        messages3.add(direction + getIdNameOnly(h) + ".SOAPMessageContext.getHeaders()=" + s);
    }

    public static void reportLMCGetMessage(Handler h, String direction, String s) {
        TestUtil.logTrace("HandlerTracker: reportLMCGetMessage()=" + direction + getIdNameOnly(h)
                + ".LogicalMessageContext.getMessage()=" + s);
        messages4.add(direction + getIdNameOnly(h) + ".LogicalMessageContext.getMessage()=" + s);
    }

    public static void reportThrowable(Handler handler, Throwable t) {
        TestUtil.logTrace("HandlerTracker: reportThrowable(): " + getIdNameOnly(handler) + " " + t);

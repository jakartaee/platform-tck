...
public final class Handler_Util {
    ...
    public static String getDirection(MessageContext context) {
        ...
        if (context instanceof LogicalMessageContext) {
            TestUtil.logTrace(
                    "MESSAGE_OUTBOUND_PROPERTY=" + context.get(LogicalMessageContext.MESSAGE_OUTBOUND_PROPERTY));
            result = ((Boolean) context.get(LogicalMessageContext.MESSAGE_OUTBOUND_PROPERTY)).booleanValue();
        } else {
            TestUtil.logTrace("MESSAGE_OUTBOUND_PROPERTY=" + context.get(SOAPMessageContext.MESSAGE_OUTBOUND_PROPERTY));
            result = ((Boolean) context.get(SOAPMessageContext.MESSAGE_OUTBOUND_PROPERTY)).booleanValue();
        }
    ...
    public static boolean checkForMsg(Handler handler, MessageContext context, String whichMsg) {
            ...
            if (context instanceof LogicalMessageContext) {
                ...
                if (lm != null) {
                    ...
                    if (source != null) {
                        ...
                        TestUtil.logTrace("LogicalHandlerBase(checkForMsg): No message payload was present");
                    }
                } else {
                    TestUtil.logTrace("LogicalHandlerBase(checkForMsg): No message was present");
                }
            } else {
    ...
    public static void initTestUtil(Handler handler, String host, String port, String flag) {
        /*
    ...
    public static void initTestUtil(String impl, String host, String port, String flag) {
        /*
        ...
        if ((host != null) && (!host.equals(""))) {
            if ((port != null) && (!port.equals(""))) {
                if ((flag != null) && (!flag.equals(""))) {
                    ...
                    System.out.println("Can't init TestUtil, harnesslogtraceflag was either null or empty");
                }
            } else {
                System.out.println("Can't init TestUtil, harnesslogport was either null or empty");
            }
        } else {
            System.out.println("Can't init TestUtil, harnessloghost was either null or empty");
        }
    }

    public static String getValueFromMsg(Handler handler, MessageContext context, String name) {
        String value = "";
        TestUtil.logTrace("Getting the value for item '" + name + "' from the message");
        try {
            if (context instanceof LogicalMessageContext) {
                LogicalMessage lm = ((LogicalMessageContext) context).getMessage();
                if (lm != null) {
                    ...
                    if (source != null) {
                        ...
                        TestUtil.logErr("LogicalHandlerBase(getValueFromMsg): No message payload was present");
                    }
                } else {
                    TestUtil.logTrace("LogicalHandlerBase(getValueFromMsg): No message was present");
                }
            } else {
                SOAPMessage soapmsg = ((SOAPMessageContext) context).getMessage();
        ...
        if (context instanceof LogicalMessageContext) {
            ...
            if (lm != null) {
                try {
                    Source source = lm.getPayload();
                    if (source != null) {
                        msg = JAXWS_Util.getDOMResultAsString(JAXWS_Util.getSourceAsDOMResult(source));
                    } else {
                        TestUtil.logTrace("LogicalHandlerBase(getMessageAsString): No message payload was present");
                    }
                } catch (Exception e) {
                    TestUtil.printStackTrace(e);
                }
            } else {
                TestUtil.logTrace("LogicalHandlerBase(getMessageAsString): No message was present");
            }
        } else {
            try {
                SOAPMessage soapmsg = ((SOAPMessageContext) context).getMessage();
    ...
    public static boolean VerifyCloseCallBacks(
            String who, List<String> calls, String contextType, boolean exception, String direction) {
        boolean pass = true;
        ...
        TestUtil.logMsg("Testing that close() was called and the order in which it was called");
        if (exception) {
            ...
            if (who.equals("Client")) {
                ...
                if (close6 > -1) {
                    if (close4 > -1) {
                        if (close6 > close4) {
                            TestUtil.logErr(
                                    "The close method for handler " + who + contextType + "Handler4 was not called");
                            TestUtil.logErr("after the close method for handler " + who + contextType + "Handler6");
                            pass = false;
                        }
                        if (close5 > -1) {
                            if (close4 > close5) {
                                ...
                                TestUtil.logErr("after the close method for handler " + who + contextType + "Handler4");
                                pass = false;
                            }
                        }
                    }
                    if (close5 > -1) {
                        if (close6 > close5) {
                            TestUtil.logErr(
                                    "The close method for handler " + who + contextType + "Handler5 was not called");
                            TestUtil.logErr("after the close method for handler " + who + contextType + "Handler6");
                            pass = false;
                        }
                    }
                    ...
                    TestUtil.logErr("The close method for handler " + who + contextType + "Handler4 was not found");
                    pass = false;
                }
            } else {
                // server
            ...
            if (who.equals("Client")) {
                if (close1 > close5) {
                    TestUtil.logErr("The close method for handler " + who + contextType + "Handler5 was not called");
                    TestUtil.logErr("after the close method for handler " + who + contextType + "Handler1");
                    pass = false;
                }
                if (close2 > close1) {
                    TestUtil.logErr("The close method for handler " + who + contextType + "Handler1 was not called");
                    TestUtil.logErr("after the close method for handler " + who + contextType + "Handler2");
                    pass = false;
                }
                if (close3 > close2) {
                    TestUtil.logErr("The close method for handler " + who + contextType + "Handler2 was not called");
                    TestUtil.logErr("after the close method for handler " + who + contextType + "Handler3");
                    pass = false;
                }
                if (close6 > close3) {
                    TestUtil.logErr("The close method for handler " + who + contextType + "Handler3 was not called");
                    TestUtil.logErr("after the close method for handler " + who + contextType + "Handler6");
                    pass = false;
                }
            } else {
                if (close6 < close3) {
                    TestUtil.logErr("The close method for handler " + who + contextType + "Handler6 was not called");
                    TestUtil.logErr("after the close method for handler " + who + contextType + "Handler3");
                    pass = false;
                }
                if (close3 < close2) {
                ...
                if (close1 < close5) {
                    TestUtil.logErr("The close method for handler " + who + contextType + "Handler1 was not called");
                    TestUtil.logErr("after the close method for handler " + who + contextType + "Handler5");
                    pass = false;
                }
            }
        }
    ...
    public static boolean VerifyHandlerExceptionCallBacks(
            String who, String contextType, boolean remoteException, String direction, List<String> calls) {
        boolean pass = true;
        ...
        if (who.equals("Client")) {
            if (direction.equals(Constants.OUTBOUND)) {
                if (calls.indexOf(who + contextType + "Handler5.handleMessage().doOutbound()") == -1) {
                    TestUtil.logErr(who + contextType + "Handler5.handleMessage().doOutbound() was not called");
                    pass = false;
                }
                if (calls.indexOf(who + contextType + "Handler4.handleMessage().doOutbound()") == -1) {
                    TestUtil.logErr(who + contextType + "Handler4.handleMessage().doOutbound() was not called");
                    pass = false;
                }
            } else {
                if (calls.indexOf(who + contextType + "Handler5.handleMessage().doOutbound()") == -1) {
                ...
                if (calls.indexOf(who + contextType + "Handler6.handleMessage().doOutbound()") == -1) {
                    TestUtil.logErr(who + contextType + "Handler6.handleMessage().doOutbound() was not called");
                    pass = false;
                }
                if (calls.indexOf(who + contextType + "Handler6.handleMessage().doInbound()") == -1) {
                    TestUtil.logErr(who + contextType + "Handler6.handleMessage().doInbound() was not called");
                    pass = false;
                }
                if (calls.indexOf(who + contextType + "Handler4.handleMessage().doInbound()") == -1) {
                    TestUtil.logErr(who + contextType + "Handler4.handleMessage().doInbound() was not called");
                    pass = false;
                }
            }
        } else {
            ...
            if (remoteException) {
                ...
                if (calls.indexOf(who + contextType + "Handler5.handleMessage().doInbound()") == -1) {
                    TestUtil.logErr(who + contextType + "Handler5.handleMessage().doInbound() was not called");
                    pass = false;
                }
                if (calls.indexOf(who + contextType + "Handler6.handleFault()") == -1) {
                    TestUtil.logErr(who + contextType + "Handler6.handleFault() was not called");
                    pass = false;
                }
                if (calls.indexOf(who + contextType + "Handler4.handleFault()") == -1) {
                    TestUtil.logErr(who + contextType + "Handler4.handleFault() was not called");
                    pass = false;
                }
                if (calls.indexOf(who + contextType + "Handler5.handleFault()") == -1) {
                    TestUtil.logErr(who + contextType + "Handler5.handleFault() was not called");
                    pass = false;
                }
                if (calls.indexOf(who + contextType + "Handler5.handleMessage().doOutbound()") > -1) {
                    TestUtil.logErr(who + contextType + "Handler5.handleMessage().doOutbound() was called");
                    pass = false;
                }
                if (calls.indexOf(who + contextType + "Handler4.handleMessage().doOutbound()") > -1) {
                    TestUtil.logErr(who + contextType + "Handler4.handleMessage().doOutbound() was called");
                    pass = false;
                }
                if (calls.indexOf(who + contextType + "Handler6.handleMessage().doOutbound()") > -1) {
                    TestUtil.logErr(who + contextType + "Handler6.handleMessage().doOutbound() was called");
                    pass = false;
                }
            } else {
                if (direction.equals(Constants.OUTBOUND)) {
                    ...
                    if (calls.indexOf(who + contextType + "Handler5.handleMessage().doInbound()") > -1) {
                        TestUtil.logErr(who + contextType + "Handler5.handleMessage().doInbound() was called");
                        pass = false;
                    }
                }
            }
    ...
    public static boolean VerifyHandlerInitCallBacks(String who, String contextType, List<String> calls) {
        boolean pass = true;
    ...
    public static boolean VerifyHandlerInitCallBacks2(String who, String contextType, List<String> calls) {
        boolean pass = true;
    ...
    public static boolean VerifyHandlerInitCallBacks3(String who, String contextType, List<String> calls) {
        boolean pass = true;
    ...
    public static boolean VerifyHandlerCallBacks(String who, String contextType, List<String> calls) {
        boolean pass = true;
    ...
    public static boolean VerifyHandlerCallBacks2(String who, String contextType, List<String> calls) {
        boolean pass = true;
    ...
    public static boolean VerifyHandlerCallBacks3(String who, String contextType, List<String> calls) {
        boolean pass = true;
    ...
    public static boolean VerifyOutboundInboundCallBacks(String who, String contextType, List<String> calls) {
        boolean pass = true;
        ...
        int outhandler4 = calls.indexOf(who + contextType + "Handler4.handleMessage().doInbound()");
        if (outhandler4 > -1) {
            TestUtil.logErr(who + contextType + "Handler4.handleMessage().doOutbound() was called and should not have");
            pass = false;
        }
        int outhandler5 = calls.indexOf(who + contextType + "Handler5.handleMessage().doOutbound()");
        if (outhandler5 == -1) {
            TestUtil.logErr(who + contextType + "Handler5.handleMessage().doOutbound() was not called");
            pass = false;
        }
        int outhandler1 = calls.indexOf(who + contextType + "Handler1.handleMessage().doOutbound()");
        if (outhandler1 == -1) {
            TestUtil.logErr(who + contextType + "Handler1.handleMessage().doOutbound() was not called");
            pass = false;
        }
        int outhandler2 = calls.indexOf(who + contextType + "Handler2.handleMessage().doOutbound()");
        if (outhandler2 == -1) {
            TestUtil.logErr(who + contextType + "Handler2.handleMessage().doOutbound() was not called");
            pass = false;
        }
        int outhandler3 = calls.indexOf(who + contextType + "Handler3.handleMessage().doOutbound()");
        if (outhandler3 == -1) {
            TestUtil.logErr(who + contextType + "Handler3.handleMessage().doOutbound() was not called");
            pass = false;
        }
        int outhandler6 = calls.indexOf(who + contextType + "Handler6.handleMessage().doOutbound()");
        if (outhandler6 == -1) {
            TestUtil.logErr(who + contextType + "Handler6.handleMessage().doOutbound() was not called");
            pass = false;
        }
        ...
        int inhandler4 = calls.indexOf(who + contextType + "Handler4.handleMessage().doInbound()");
        if (inhandler4 > -1) {
            TestUtil.logErr(who + contextType + "Handler4.handleMessage().doInbound() was called and should not have");
            pass = false;
        }
        int inhandler6 = calls.indexOf(who + contextType + "Handler6.handleMessage().doInbound()");
        if (inhandler6 == -1) {
            TestUtil.logErr(who + contextType + "Handler6.handleMessage().doInbound() was not called");
            pass = false;
        }
        int inhandler3 = calls.indexOf(who + contextType + "Handler3.handleMessage().doInbound()");
        if (inhandler3 == -1) {
            TestUtil.logErr(who + contextType + "Handler3.handleMessage().doInbound() was not called");
            pass = false;
        }
        int inhandler2 = calls.indexOf(who + contextType + "Handler2.handleMessage().doInbound()");
        if (inhandler2 == -1) {
            TestUtil.logErr(who + contextType + "Handler2.handleMessage().doInbound() was not called");
            pass = false;
        }
        int inhandler1 = calls.indexOf(who + contextType + "Handler1.handleMessage().doInbound()");
        if (inhandler1 == -1) {
            TestUtil.logErr(who + contextType + "Handler1.handleMessage().doInbound() was not called");
            pass = false;
        }
        int inhandler5 = calls.indexOf(who + contextType + "Handler5.handleMessage().doInbound()");
        if (inhandler5 == -1) {
            TestUtil.logErr(who + contextType + "Handler5.handleMessage().doInbound() was not called");
            pass = false;
        }
        ...
        TestUtil.logMsg("Testing the order of the inbound verses outbound messages");
        if (who.equals("Client")) {
    ...
    public static boolean VerifyHandleMessageFalseCallBacks(
            String who, String contextType, List<String> calls, String direction) {
        boolean pass = true;
        ...
        if (who.equals("Client")) {
            if (direction.equals(Constants.OUTBOUND)) {
                int i = calls.indexOf(who + contextType + "Handler5.handleMessage().doOutbound()");
                if (i == -1) {
                    TestUtil.logErr(who + contextType + "Handler5.handleMessage().doOutbound() was not called");
                    pass = false;
                }
                ...
                int j = calls.lastIndexOf(who + contextType + "Handler5.handleMessage().doInbound()");
                if (i == j) {
                    TestUtil.logErr(
                            "The call to " + who + contextType + "Handler5.handleMessage().doInbound() was not called");
                    pass = false;
                }
    ...
    public static boolean VerifyMessageContextCallBacks(String who, String contextType, List<String> calls) {
        boolean pass = true;
    ...
    public static boolean VerifyLogicalOrSOAPMessageContextCallBacks(
        ...
        if (calls.indexOf(
                        "Inbound" + who + contextType + "Handler2." + contextType + "MessageContext.getMessage()=null")
                != -1) {
        ...
        if (calls.indexOf(
                        "Outbound" + who + contextType + "Handler2." + contextType + "MessageContext.getMessage()=null")
                != -1) {
        ...
        if (contextType.equals("SOAP")) {
            if (calls.indexOf("Inbound" + who + contextType + "Handler2." + contextType
                            + "MessageContext.setMessage() was called")
                    == -1) {
                TestUtil.logErr("Inbound" + who + contextType + "Handler2." + contextType
                        + "MessageContext.setMessage() was not called");
                pass = false;
            }
            if (calls.indexOf("Inbound" + who + contextType + "Handler2." + contextType
                            + "MessageContext.getRoles()=null")
                    != -1) {
                TestUtil.logErr("Inbound" + who + contextType + "Handler2." + contextType
                        + "MessageContext.getRoles()=null was called");
                pass = false;
            }
            if (calls.indexOf("Inbound" + who + contextType + "Handler2." + contextType
                            + "MessageContext.getHeaders()=||")
                    == -1) {
                TestUtil.logErr("Inbound" + who + contextType + "Handler2." + contextType
                        + "MessageContext.getHeaders()=|| was not returned");
                pass = false;
            }
    ...
    public static boolean VerifyStandardMessageContextPropertiesCallBacks(
        ...
        if (who.equals("Client")) {
            ...
            if (JAXWS_Util.looseIndexOf(
                            ...
                            "OutboundClient" + contextType
                                    + "Handler2.MessageContext.getProperty(" + contextType
                                    + "MessageContext.OUTBOUND_MESSAGE_ATTACHMENTS)=key[1]")
                    != -1) {
                TestUtil.logErr("OutboundClient" + contextType
                        + "Handler2.MessageContext.getProperty(" + contextType
            ...
            if (JAXWS_Util.looseIndexOf(
                            calls,
                            "OutboundClient" + contextType
                                    + "Handler2.MessageContext.getProperty(MessageContext.OUTBOUND_MESSAGE_ATTACHMENTS)=key[0]")
                    == -1) {
                TestUtil.logErr(
                        "OutboundClient" + contextType
            ...
            if (JAXWS_Util.looseIndexOf(
                            calls,
                            "OutboundClient" + contextType
                                    + "Handler2.MessageContext.getProperty(MessageContext.OUTBOUND_MESSAGE_ATTACHMENTS)=key[1]")
                    != -1) {
                TestUtil.logErr(
                        "OutboundClient" + contextType
            ...
            if (JAXWS_Util.looseIndexOf(
                            ...
                            "InboundClient" + contextType + "Handler2.MessageContext.getProperty("
                                    + contextType
                                    + "MessageContext.INBOUND_MESSAGE_ATTACHMENTS)=key[0]")
                    == -1) {
            ...
            if (JAXWS_Util.looseIndexOf(
                            ...
                            "InboundClient" + contextType + "Handler2.MessageContext.getProperty("
                                    + contextType
                                    + "MessageContext.INBOUND_MESSAGE_ATTACHMENTS)=key[1]")
                    != -1) {
                TestUtil.logErr("InboundClient" + contextType
                        + "Handler2.MessageContext.getProperty(" + contextType
            ...
            if (JAXWS_Util.looseIndexOf(
                            calls,
                            "InboundClient" + contextType
                                    + "Handler2.MessageContext.getProperty(MessageContext.INBOUND_MESSAGE_ATTACHMENTS)=key[0]")
                    == -1) {
                TestUtil.logErr(
                        "InboundClient" + contextType
            ...
            if (JAXWS_Util.looseIndexOf(
                            calls,
                            "InboundClient" + contextType
                                    + "Handler2.MessageContext.getProperty(MessageContext.INBOUND_MESSAGE_ATTACHMENTS)=key[1]")
                    != -1) {
                TestUtil.logErr(
                        "InboundClient" + contextType
            ...
            if (calls.indexOf("InboundClient" + contextType + "Handler2.MessageContext.getProperty(" + contextType
            ...
            if (calls.indexOf("InboundServer" + contextType + "Handler2.MessageContext.getProperty(" + contextType
                            + "MessageContext.SERVLET_REQUEST)=null")
                    != -1) {
                TestUtil.logErr("InboundServer" + contextType
                        + "Handler2.MessageContext.getProperty(" + contextType
            ...
            if (JAXWS_Util.looseIndexOf(
                            ...
                            "OutboundServer" + contextType
                                    + "Handler2.MessageContext.getProperty(" + contextType
                                    + "MessageContext.OUTBOUND_MESSAGE_ATTACHMENTS)=key[0]")
                    == -1) {
    ...
    public static boolean VerifyHandleFaultFalseCallBacks(
            String who, String contextType, List<String> calls, String direction) {
        boolean pass = true;
        String packageName = null;
        ...
        if (who.equals("Client")) {
            if (direction.equals(Constants.OUTBOUND)) {
                ...
                if (calls.indexOf(who + contextType + "Handler6 Throwing an outbound SOAPFaultException") == -1) {
                    TestUtil.logErr(
                            who + contextType + "Handler6 Throwing an outbound SOAPFaultException was not found");
                    pass = false;
                }
                if (calls.indexOf(who + contextType + "Handler4.handleFault()") == -1) {
                    TestUtil.logErr(who + contextType + "Handler4.handleFault() was not called");
                ...
                if (calls.indexOf(who + contextType + "Handler5.handleFault()") > -1) {
                    TestUtil.logErr(who + contextType + "Handler5.handleFault() was called");
                    pass = false;
                }
                if (calls.indexOf(who + contextType + "Handler6.close()") == -1) {
                    TestUtil.logErr(who + contextType + "Handler6.close() was not called");
            ...
            if (direction.equals(Constants.INBOUND)) {
                ...
                if (calls.indexOf(who + contextType + "Handler5 Throwing an inbound SOAPFaultException") == -1) {
                    TestUtil.logErr(
                            who + contextType + "Handler5 Throwing an inbound SOAPFaultException was not found");
                    pass = false;
                }
                if (calls.indexOf(who + contextType + "Handler4.handleFault()") == -1) {
                    TestUtil.logErr(who + contextType + "Handler4.handleFault() was not called");
                ...
                if (calls.indexOf(who + contextType + "Handler6.handleFault()") > -1) {
                    TestUtil.logErr(who + contextType + "Handler4.handleFault() was called");
                    pass = false;
                }
                if (calls.indexOf(who + contextType + "Handler6.close()") == -1) {
                    TestUtil.logErr(who + contextType + "Handler6.close() was not called");
    ...
    public static boolean VerifyHandleMessageExceptionCallBacks(
            String who, String contextType, List<String> calls, String direction) {
        boolean pass = true;
        String packageName = null;
        ...
        if (who.equals("Client")) {
            if (direction.equals(Constants.OUTBOUND)) {
                ...
                if (calls.indexOf(who + contextType + "Handler4 Throwing an outbound SOAPFaultException") == -1) {
                    TestUtil.logErr(
                            who + contextType + "Handler4 Throwing an outinbound SOAPFaultException was not found");
                    pass = false;
                }
                if (calls.indexOf(who + contextType + "Handler4.close()") == -1) {
                    TestUtil.logErr(who + contextType + "Handler4.close() was not called");
                ...
                if (calls.indexOf(who + contextType + "Handler4 Throwing an inbound SOAPFaultException") == -1) {
                    TestUtil.logErr(
                            who + contextType + "Handler4 Throwing an inbound SOAPFaultException was not found");
                    pass = false;
                }
                if (calls.indexOf(who + contextType + "Handler5.handleMessage().doInbound()") > -1) {
                    TestUtil.logErr(who + contextType + "Handler5.handleMessage().doInbound() was called");
            ...
            if (direction.equals(Constants.INBOUND)) {
                ...
                if (calls.indexOf(who + contextType + "Handler4 Throwing an outbound SOAPFaultException") == -1) {
                    TestUtil.logErr(
                            who + contextType + "Handler4 Throwing an outbound SOAPFaultException was not found");
                    pass = false;
                }
                if (calls.indexOf(who + contextType + "Handler6.close()") == -1) {
                    TestUtil.logErr(who + contextType + "Handler6.close() was not called");
    ...
    public static boolean VerifyHandleFaultRuntimeExceptionCallBacks(
            String who, String contextType, List<String> calls, String direction) {
        boolean pass = true;
        String packageName = null;
        ...
        if (who.equals("Client")) {
            if (direction.equals(Constants.OUTBOUND)) {
                ...
                if (calls.indexOf(who + contextType + "Handler4 Throwing an inbound RuntimeException") == -1) {
                    TestUtil.logErr(who + contextType + "Handler4 Throwing an inbound RuntimeException was not found");
                    pass = false;
                }
                if (calls.indexOf(who + contextType + "Handler6.close()") == -1) {
                    TestUtil.logErr(who + contextType + "Handler6.close() was not called");
            ...
            if (direction.equals(Constants.INBOUND)) {
                ...
                if (calls.indexOf(who + contextType + "Handler4 Throwing an outbound RuntimeException") == -1) {
                    TestUtil.logErr(who + contextType + "Handler4 Throwing an outbound RuntimeException was not found");
                    pass = false;
                }
                if (calls.indexOf(who + contextType + "Handler6.close()") == -1) {
                    TestUtil.logErr(who + contextType + "Handler6.close() was not called");
    ...
    public static boolean VerifyHandleFaultSOAPFaultExceptionCallBacks(
            String who, String contextType, List<String> calls, String direction) {
        boolean pass = true;
        String packageName = null;
    ...
    public static boolean VerifyLogicalVerseSOAPHandlerOrder(List<String> calls) {
        ...
        TestUtil.logTrace("Getting just the handleMessage().doOutbound/doInbound messages");
        List<String> inHandlers = new Vector<String>();
        List<String> outHandlers = new Vector<String>();
        TestUtil.logTrace("\n");
        TestUtil.logTrace("The list of doOutbound/doInbound callbacks are as follows:");
        if (!calls.isEmpty()) {
            ...
            while (i.hasNext()) {
                ...
                if (o != null) {
                    if (o instanceof String) {
                        ...
                        TestUtil.logErr("An unexpected object was returned while iterating through");
        ...
        if (outHandlers.size() > 0) {
            ...
            int lastLogical = JAXWS_Util.looseLastIndexOf(outHandlers, "LogicalHandler");
            ...
            if ((lastLogical == -1) || (firstSOAP == -1)) {
                TestUtil.logErr("Both Logical and SOAP request handlers were not in the Callback string");
                pass = false;
            }

            if (lastLogical > firstSOAP) {
                TestUtil.logErr("The first SOAPHandler (" + outHandlers.get(firstSOAP) + ")");
                TestUtil.logErr("for an outbound message did not occur after the");
                TestUtil.logErr("last LogicalHandler (" + outHandlers.get(lastLogical) + ")");
                pass = false;
            }
        } else {
        ...
        if (inHandlers.size() > 0) {
            ...
            if ((lastSOAP == -1) || (firstLogical == -1)) {
                TestUtil.logErr("Both Logical and SOAP response handlers were not in the Callback string");
                pass = false;
            }
            if (lastSOAP > firstLogical) {
                TestUtil.logErr("The first LogicalHandler (" + inHandlers.get(firstLogical) + ")");
    ...
    public static boolean VerifyServerToClientHandlerExceptionCallBacks(
        ...
        if (who.equals("Client")) {
            ...
            if (!VerifyCloseCallBacks(who, calls, contextType, true, Constants.INBOUND)) {
                pass = false;
            }
        } else {
            // server
            if (direction.equals(Constants.INBOUND)) {
                ...
                if (calls.indexOf(who + contextType + "Handler6 Throwing an inbound SOAPFaultException") == -1) {
                    TestUtil.logErr(
                            who + contextType + "Handler6 Throwing an inbound SOAPFaultException was not called");
                    pass = false;
                }
                if (calls.indexOf(who + contextType + "Handler6.close()") == -1) {
                    TestUtil.logErr(who + contextType + "Handler6.close() was not called");
                ...
                if (calls.indexOf(who + contextType + "Handler6 Throwing an outbound SOAPFaultException") == -1) {
                    TestUtil.logErr(
                            who + contextType + "Handler6 Throwing an outbound SOAPFaultException was not called");
                    pass = false;
                }
                if (!VerifyCloseCallBacks(who, calls, contextType, true, Constants.OUTBOUND)) {
                    pass = false;
                }
            }
        }
    ...
    public static boolean VerifyOneWayCallbacks(String who, String direction, List<String> calls) {
        boolean pass = true;
        ...
        if (who.equals("Client")) {
            if (direction.equals(Constants.OUTBOUND)) {
                if (calls.indexOf(who + "LogicalHandler1.handleMessage().doOutbound()") == -1) {
                    TestUtil.logErr(who + "LogicalHandler1.handleMessage().doOutbound() was not called");
                    pass = false;
                }
                if (calls.indexOf(who + "LogicalHandler2.handleMessage().doOutbound()") == -1) {
                    TestUtil.logErr(who + "LogicalHandler2.handleMessage().doOutbound() was not called");
                    pass = false;
                }
                if (calls.indexOf(who + "LogicalHandler3.handleMessage().doOutbound()") == -1) {
                    TestUtil.logErr(who + "LogicalHandler3.handleMessage().doOutbound() was not called");
                    pass = false;
                }
                if (calls.indexOf(who + "SOAPHandler1.handleMessage().doOutbound()") == -1) {
                    TestUtil.logErr(who + "SOAPHandler1.handleMessage().doOutbound() was not called");
                    pass = false;
                }
                if (calls.indexOf(who + "SOAPHandler2.handleMessage().doOutbound()") == -1) {
                    TestUtil.logErr(who + "SOAPHandler2.handleMessage().doOutbound() was not called");
                    pass = false;
                }
                if (calls.indexOf(who + "SOAPHandler3.handleMessage().doOutbound()") == -1) {
                    TestUtil.logErr(who + "SOAPHandler3.handleMessage().doOutbound() was not called");
                    pass = false;
                }
            ...
            // server
            if (direction.equals(Constants.INBOUND)) {
                if (calls.indexOf(who + "SOAPHandler3.handleMessage().doInbound()") == -1) {
                    TestUtil.logErr(who + "SOAPHandler3.handleMessage().doInbound() was not called");
                    pass = false;
                }
                if (calls.indexOf(who + "SOAPHandler2.handleMessage().doInbound()") == -1) {
                    TestUtil.logErr(who + "SOAPHandler2.handleMessage().doInbound() was not called");
                    pass = false;
                }
                if (calls.indexOf(who + "SOAPHandler1.handleMessage().doInbound()") == -1) {
                    TestUtil.logErr(who + "SOAPHandler1.handleMessage().doInbound() was not called");
                    pass = false;
                }
                if (calls.indexOf(who + "LogicalHandler3.handleMessage().doInbound()") == -1) {
                    TestUtil.logErr(who + "LogicalHandler3.handleMessage().doInbound() was not called");
                    pass = false;
                }
                if (calls.indexOf(who + "LogicalHandler2.handleMessage().doInbound()") == -1) {
                    TestUtil.logErr(who + "LogicalHandler2.handleMessage().doInbound() was not called");
                    pass = false;
                }
                if (calls.indexOf(who + "LogicalHandler1.handleMessage().doInbound()") == -1) {
                    TestUtil.logErr(who + "LogicalHandler1.handleMessage().doInbound() was not called");
                    pass = false;
                }
                if (calls.indexOf(who + "LogicalHandler1.close()") == -1) {
                    TestUtil.logErr(who + "LogicalHandler1.close() was not called");
    ...
    public static boolean VerifyOneWaySOAPFaultCallbacks(
            String who, String direction, String contextType, List<String> calls) {
        boolean pass = true;
        ...
        if (who.equals("Client")) {
            if (direction.equals(Constants.OUTBOUND)) {
                ...
                if (contextType.equals("SOAP")) {
                    ...
                    if (calls.indexOf(who + "SOAPHandler2 Throwing an outbound SOAPFaultException") == -1) {
                        TestUtil.logErr(who + "SOAPHandler2 Throwing an outbound SOAPFaultException was not called");
                        pass = false;
                    }
                    if (calls.indexOf(who + "SOAPHandler2.close()") == -1) {
                        TestUtil.logErr(who + "SOAPHandler2.close() was not called");
                    ...
                    if (calls.indexOf(who + "LogicalHandler2 Throwing an outbound SOAPFaultException") == -1) {
                        TestUtil.logErr(who + "LogicalHandler2 Throwing an outbound SOAPFaultException was not called");
                        pass = false;
                    }
                }
                if (calls.indexOf(who + "LogicalHandler2.close()") == -1) {
            ...
            if (direction.equals(Constants.INBOUND)) {
                ...
                if (!contextType.equals("SOAP")) {
                    ...
                    if (calls.indexOf(who + "LogicalHandler2 Throwing an inbound SOAPFaultException") == -1) {
                        TestUtil.logErr(who + "LogicalHandler2 Throwing an inbound SOAPFaultException was not called");
                        pass = false;
                    }
                    if (calls.indexOf(who + "LogicalHandler2.close()") == -1) {
                        TestUtil.logErr(who + "LogicalHandler2.close() was not called");
                    ...
                    if (calls.indexOf(who + "SOAPHandler2 Throwing an inbound SOAPFaultException") == -1) {
                        TestUtil.logErr(who + "SOAPHandler2 Throwing an inbound SOAPFaultException was not called");
                        pass = false;
                    }
                }
                if (calls.indexOf(who + "SOAPHandler2.close()") == -1) {
    ...
    public static boolean VerifyOneWayHandleMessageFalseCallbacks(
            String who, String direction, String contextType, List<String> calls) {
        boolean pass = true;
        ...
        if (who.equals("Client")) {
            if (direction.equals(Constants.OUTBOUND)) {
                ...
                if (contextType.equals("SOAP")) {
                    ...
                    if (calls.indexOf(who + "SOAPHandler2 HandleMessage returns false") == -1) {
                        TestUtil.logErr(who + "SOAPHandler2 HandleMessage returns false was not called");
                        pass = false;
                    }
                    if (calls.indexOf(who + "SOAPHandler2.close()") == -1) {
                        TestUtil.logErr(who + "SOAPHandler2.close() was not called");
                    ...
                    if (calls.indexOf(who + "LogicalHandler2 HandleMessage returns false") == -1) {
                        TestUtil.logErr(who + "LogicalHandler2 HandleMessage returns false was not called");
                        pass = false;
                    }
                }
                if (calls.indexOf(who + "LogicalHandler2.close()") == -1) {
    ...
    public static boolean VerifyHandlerDoesNotGetCalled(String who, List<String> calls) {
        boolean pass = true;
        ...
        if (calls.indexOf(who + "LogicalHandler5.handleMessage().doOutbound()") == -1) {
            TestUtil.logErr(who + "LogicalHandler5.handleMessage().doOutbound() was not called");
            pass = false;
        }
        if (calls.indexOf(who + "LogicalHandler1.handleMessage().doOutbound()") == -1) {
            TestUtil.logErr(who + "LogicalHandler1.handleMessage().doOutbound() was not called");
        ...
        if (calls.indexOf(who + "LogicalHandler6.handleMessage().doOutbound()") == -1) {
            TestUtil.logErr(who + "LogicalHandler6.handleMessage().doOutbound() was not called");
            pass = false;
        }
        if (calls.indexOf(who + "SOAPHandler5.handleMessage().doOutbound()") == -1) {
            TestUtil.logErr(who + "SOAPHandler5.handleMessage().doOutbound() was not called");
            pass = false;
        }
        if (calls.indexOf(who + "SOAPHandler1.handleMessage().doOutbound()") == -1) {
            TestUtil.logErr(who + "SOAPHandler1.handleMessage().doOutbound() was not called");
        ...
        if (calls.indexOf(who + "SOAPHandler6.handleMessage().doOutbound()") == -1) {
            TestUtil.logErr(who + "SOAPHandler6.handleMessage().doOutbound() was not called");
            pass = false;
        }
        if (calls.indexOf(who + "SOAPHandler6.handleMessage().doInbound()") == -1) {
            TestUtil.logErr(who + "SOAPHandler6.handleMessage().doInbound() was not called");
            pass = false;
        }
        if (who.equals("Server")) {
            if (calls.indexOf(who + "SOAPHandler3.handleMessage().doInbound()") == -1) {
        ...
        if (calls.indexOf(who + "SOAPHandler5.handleMessage().doInbound()") == -1) {
            TestUtil.logErr(who + "SOAPHandler5.handleMessage().doInbound() was not called");
            pass = false;
        }
        if (calls.indexOf(who + "LogicalHandler6.handleMessage().doInbound()") == -1) {
            TestUtil.logErr(who + "LogicalHandler6.handleMessage().doInbound() was not called");
            pass = false;
        }
        if (who.equals("Server")) {
            if (calls.indexOf(who + "LogicalHandler3.handleMessage().doInbound()") == -1) {
        ...
        if (calls.indexOf(who + "LogicalHandler5.handleMessage().doInbound()") == -1) {
            TestUtil.logErr(who + "LogicalHandler5.handleMessage().doInbound() was not called");
            pass = false;
        }
        ...
        if (calls.indexOf(who + "SNPSNBCLogicalHandler.handleMessage().doOutbound()") > -1) {
            TestUtil.logErr(who + "SNPSNBCLogicalHandler.handleMessage().doOutbound() was called");
            pass = false;
        }
        if (calls.indexOf(who + "SNPSNBCSOAPHandler.handleMessage().doOutbound()") > -1) {
            TestUtil.logErr(who + "SNPSNBCSOAPHandler.handleMessage().doOutbound() was called");
            pass = false;
        }
        if (calls.indexOf(who + "SNPSNBCLogicalHandler.handleMessage().doInbound()") > -1) {
            TestUtil.logErr(who + "SNPSNBCLogicalHandler.handleMessage().doInbound() was called");
            pass = false;
        }
        if (calls.indexOf(who + "SNPSNBCSOAPHandler.handleMessage().doInbound()") > -1) {
            TestUtil.logErr(who + "SNPSNBCSOAPHandler.handleMessage().doInbound() was called");
            pass = false;
        }
        ...
        if (calls.indexOf(who + "PNPSNBCLogicalHandler.handleMessage().doOutbound()") > -1) {
            TestUtil.logErr(who + "PNPSNBCLogicalHandler.handleMessage().doOutbound() was called");
            pass = false;
        }
        if (calls.indexOf(who + "PNPSNBCSOAPHandler.handleMessage().doOutbound()") > -1) {
            TestUtil.logErr(who + "PNPSNBCSOAPHandler.handleMessage().doOutbound() was called");
            pass = false;
        }
        if (calls.indexOf(who + "PNPSNBCLogicalHandler.handleMessage().doInbound()") > -1) {
            TestUtil.logErr(who + "PNPSNBCLogicalHandler.handleMessage().doInbound() was called");
            pass = false;
        }
        if (calls.indexOf(who + "PNPSNBCSOAPHandler.handleMessage().doInbound()") > -1) {
            TestUtil.logErr(who + "PNPSNBCSOAPHandler.handleMessage().doInbound() was called");
            pass = false;
        }

...
public class LogicalHandlerBase implements jakarta.xml.ws.handler.LogicalHandler<LogicalMessageContext> {
    ...
    private void doContextProperties(LogicalMessageContext context, String direction) {
        ...
        if (handlerName.equals("ClientLogicalHandler2") || handlerName.equals("ServerLogicalHandler2")) {
            Map<String, DataHandler> m1 = null;
            String attachmentProp = "";
            if (direction.equals(Constants.OUTBOUND)) {
                m1 = (Map<String, DataHandler>) context.get(LogicalMessageContext.OUTBOUND_MESSAGE_ATTACHMENTS);
                attachmentProp = "LogicalMessageContext.OUTBOUND_MESSAGE_ATTACHMENTS";
            } else {
                m1 = (Map<String, DataHandler>) context.get(LogicalMessageContext.INBOUND_MESSAGE_ATTACHMENTS);
            ...
            String ss = (String) context.get(LogicalMessageContext.HTTP_REQUEST_METHOD);
            if (ss != null) {
                HandlerTracker.reportProperties(this, direction, "LogicalMessageContext.HTTP_REQUEST_METHOD", ss);
            } else {
                HandlerTracker.reportProperties(this, direction, "LogicalMessageContext.HTTP_REQUEST_METHOD", "null");
            }
            ...
            Integer ii = (Integer) context.get(LogicalMessageContext.HTTP_RESPONSE_CODE);
            if (ii != null) {
                HandlerTracker.reportProperties(
                        this, direction, "LogicalMessageContext.HTTP_RESPONSE_CODE", ii.toString());
            } else {
                HandlerTracker.reportProperties(this, direction, "LogicalMessageContext.HTTP_RESPONSE_CODE", "null");
            }
            ...
            HandlerTracker.reportProperties(
                    this, direction, "LogicalMessageContext.HTTP_REQUEST_HEADERS", sb.toString());
            ...
            m2 = (Map<String, List<String>>) context.get(LogicalMessageContext.HTTP_RESPONSE_HEADERS);
            sb = new StringBuffer();
            cnt = 0;
            iterator = null;
            try {
            ...
            HandlerTracker.reportProperties(
                    this, direction, "LogicalMessageContext.HTTP_RESPONSE_HEADERS", sb.toString());
            ...
            if (oo != null) {
                HandlerTracker.reportProperties(
                        this, direction, "LogicalMessageContext.SERVLET_REQUEST", oo.toString());
            } else {
                HandlerTracker.reportProperties(this, direction, "LogicalMessageContext.SERVLET_REQUEST", "null");
            }
            ...
            if (oo != null) {
                HandlerTracker.reportProperties(
                        this, direction, "LogicalMessageContext.SERVLET_RESPONSE", oo.toString());
            } else {
                HandlerTracker.reportProperties(this, direction, "LogicalMessageContext.SERVLET_RESPONSE", "null");
            }
            ...
            if (oo != null) {
                HandlerTracker.reportProperties(
                        this, direction, "LogicalMessageContext.SERVLET_CONTEXT", oo.toString());
            } else {
                HandlerTracker.reportProperties(this, direction, "LogicalMessageContext.SERVLET_CONTEXT", "null");
            }
    ...
    private void doMessageContext(LogicalMessageContext context, String direction) {
        ...
        TestUtil.logTrace("handlerName=" + handlerName);
        if (handlerName.equals("ClientLogicalHandler2") || handlerName.equals("ServerLogicalHandler2")) {
            HandlerTracker.reportComment(this, "BeginMessageContextCallbackInvocations");
        ...
        } else if (handlerName.equals("ClientLogicalHandler1") || handlerName.equals("ServerLogicalHandler1")) {
            HandlerTracker.reportComment(this, "BeginMessageContextCallbackInvocations");
            if (direction.equals(Constants.OUTBOUND)) {
                ...
                // handler
                context.put(
                        whichDirection + whichHandlerType + "LogicalCrossHandlerPropSetByHandler1", "SetByHandler1");
                ...
                // a different handler
                context.put(
                        whichDirection + whichHandlerType + "LogicalMessageScopeAppPropSetByHandler1", "SetByHandler1");
                HandlerTracker.reportPut(
                        this,
                ...
                HandlerTracker.reportGetScope(
                        this,
                        whichDirection + whichHandlerType + "LogicalMessageScopeAppPropSetByHandler3",
                        context.getScope(whichDirection + whichHandlerType + "LogicalMessageScopeAppPropSetByHandler3")
                                .toString());
                HandlerTracker.reportGetScope(
                        this,
                        whichDirection + whichHandlerType + "LogicalMessageScopeHandlerPropSetByHandler3",
        ...
        } else if (handlerName.equals("ClientLogicalHandler3") || handlerName.equals("ServerLogicalHandler3")) {
            HandlerTracker.reportComment(this, "BeginMessageContextCallbackInvocations");
            if (direction.equals(Constants.OUTBOUND)) {
                TestUtil.logTrace("whichHandlerType=" + whichHandlerType);
                ...
                HandlerTracker.reportGetScope(
                        this,
                        whichDirection + whichHandlerType + "LogicalCrossHandlerPropSetByHandler1",
                        context.getScope(whichDirection + whichHandlerType + "LogicalCrossHandlerPropSetByHandler1")
                                .toString());
                HandlerTracker.reportGetScope(
                        this,
                        whichDirection + whichHandlerType + "LogicalMessageScopeAppPropSetByHandler1",
                        context.getScope(whichDirection + whichHandlerType + "LogicalMessageScopeAppPropSetByHandler1")
                                .toString());
                HandlerTracker.reportGetScope(
                        this,
                        whichDirection + whichHandlerType + "LogicalMessageScopeHandlerPropSetByHandler1",
                ...
                // handler
                context.put(
                        whichDirection + whichHandlerType + "LogicalCrossHandlerPropSetByHandler3", "SetByHandler3");
                HandlerTracker.reportPut(
                        this,
                        whichDirection + whichHandlerType + "LogicalCrossHandlerPropSetByHandler3",
                        "SetByHandler3");
                ...
                // a different handler
                context.put(
                        whichDirection + whichHandlerType + "LogicalMessageScopeAppPropSetByHandler3", "SetByHandler3");
                HandlerTracker.reportPut(
                        this,
                        whichDirection + whichHandlerType + "LogicalMessageScopeAppPropSetByHandler3",
                        "SetByHandler3");

...
public final class JAXWS_Data {
    ...
    public static final List<Double> list_Double_nonull_data = (List<Double>) Arrays.asList(Double_nonull_data);
    ...
    public static void dumpMultiArrayValues(Object o, String t) {
        ...
        System.out.println("Dumping " + t + " multiarray, size=" + getMultiArraySize(o, t));
        if (t.equals("boolean")) {
            boolean[][] v = (boolean[][]) o;
            for (int i = 0; i < v.length; i++) {
    ...
    public static boolean compareArrayValues(Object e, Object r, String t) {
        ...
        if (t.equals("boolean")) {
            ...
            for (int i = 0; i < rec.length; i++) {
                if (rec[i] != exp[i]) {
                    System.out.println("Array Mismatch: expected " + exp[i] + ", received " + rec[i]);
                    pass = false;
                }
            }
        } else if (t.equals("Boolean")) {
    ...
    public static boolean compareDate(Object e, Object r, String t) {
        ...
        if (rec == null || exp == null) {
            ...
            System.out.println("Date Mismatch: expected " + exp + ", received " + rec);
            return false;
        } else if (t.equals("YM")) {
            ...
            if (rec.getYear() != exp.getYear()) {
                System.out.println(
                        "Date Mismatch: expected Year " + exp.getYear() + ", received Year " + rec.getYear());
                pass = false;
            }
        } else if (t.equals("MD")) {
            ...
            if (rec.getMonth() != exp.getMonth() || rec.getDay() != exp.getDay()) {
                System.out.println("Date Mismatch: expected MonthDay " + exp.getMonth() + exp.getDay()
            ...
            if (rec.getDay() != exp.getDay()) {
                System.out.println("Date Mismatch: expected Day " + exp.getDay() + ", received Day " + rec.getDay());
                pass = false;
            }
        } else if (t.equals("M")) {
            ...
            if (rec.getMonth() != exp.getMonth()) {
                System.out.println(
                        "Date Mismatch: expected Month " + exp.getMonth() + ", received Month " + rec.getMonth());
                pass = false;
            }
        }
        return pass;
        ...
        if (t.equals("boolean")) {
            ...
            for (int i = 0; i < rec.length; i++) {
                if (rec[i].length != exp[i].length) {
                    System.out.println(
                            "Multi Array Size MisMatch: expected " + exp[i].length + ", received " + rec[i].length);
                    pass = false;
                } else {
                    for (int k = 0; k < rec[i].length; k++) {
                        if (rec[i][k] != exp[i][k]) {
                            System.out.println("Array Mismatch: expected " + exp[i][k] + ", received " + rec[i][k]);
                            pass = false;
                        }
                    }
                }

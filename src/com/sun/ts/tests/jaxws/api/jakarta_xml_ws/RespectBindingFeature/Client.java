        ...
        try {
            ...
            if (n != null) {
                if (!(RespectBindingFeature.ID.equals(n.getID()))) {
                    ...
                    TestUtil.logMsg("RespectBindingFeature object created successfully with correct ID, expected ["
                            + RespectBindingFeature.ID + "], received [" + n.getID()
                            + "]");
                }
            } else {
        ...
        try {
            ...
            if (n != null) {
                ...
                if (isEnabled == true) {
                    ...
                    TestUtil.logMsg("Returned incorrect isEnabled value, expected [" + new Boolean(true)
                ...
                if (n1 != null) {
                    ...
                    if (isEnabled == false) {
                        ...
                        TestUtil.logMsg("Returned incorrect isEnabled value, expected [" + new Boolean(false)

...
public class Client extends ServiceEETest {
    ...
    public void getRequestContextForDispatchObjTest() throws Fault {
        ...
        boolean pass = true;
        TestUtil.logMsg("Calling BindingProvider.getRequestContext() for Dispatch object");
        ...
        if (requestContext == null) {
            ...
            TestUtil.logMsg("getRequestContext() returned java.util.Map<String,Object> object");
    ...
    public void getResponseContextForDispatchObjTest() throws Fault {
        ...
        boolean pass = true;
        TestUtil.logMsg("Calling BindingProvider.getResponseContext() for Dispatch object");
        ...
        if (responseContext == null) {
            ...
            TestUtil.logMsg("getResponseContext() returned java.util.Map<String,Object> object");

...
public class Client extends ServiceEETest {
    ...
    public void createWithWSFTest1() throws Fault {
        ...
        boolean pass = true;
        jakarta.xml.ws.Service service = null;
        TestUtil.logMsg("Call jakarta.xml.ws.Service.create(QName, WebServiceFeature[]) ...");
    ...
    public void createWithWSFTest2() throws Fault {
        ...
        boolean pass = true;
        jakarta.xml.ws.Service service = null;
        TestUtil.logMsg("Call jakarta.xml.ws.Service.create(URL, QName, WebServiceFeature[]) ...");
        TestUtil.logMsg("Pass in AddressingFeature(true) as WebServiceFeature ...");
        try {
            if (modeProperty.equals("standalone")) {
    ...
    public void createWithWSFNegativeTest1() throws Fault {
        ...
        TestUtil.logMsg("API must throw WebServiceException as endpoint does not know TCKFeature(true) ...");
        try {
            if (modeProperty.equals("standalone")) {
    ...
    public void GetPort1PosTest1WithWsdl() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Test getPort (valid port name/WSDL access) - positive test 1");
    ...
    public void GetPortTest1WithFeatures() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Test getPort (valid port name/WSDL access) AddressingFeature(true)");
            ...
            TestUtil.logMsg("Test getPort (valid port name/WSDL access) AddressingFeature(false)");
            TestUtil.logMsg("Call Service.getPort(QName, Class, WebServiceFeature ...)");
            TestUtil.logMsg("Should find port");
    ...
    public void GetPortTest3WithFeatures() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Test getPort (valid port name/WSDL access) AddressingFeature(true)");
            TestUtil.logMsg("Call Service.getPort(EndpointReference, Class, WebServiceFeature ...)");
            TestUtil.logMsg("Should find port");
    ...
    public void GetPort1NegTest1WithWsdl() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Test getPort (invalid port name/WSDL access) - negative test 1");
    ...
    public void GetPort2PosTest1WithWsdl() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Test getPort (valid SEI class/WSDL access) - positive test 1");
    ...
    public void GetPort2NegTest1WithWsdl() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Test getPort (invalid SEI class/WSDL access) - negative test 1");
            TestUtil.logMsg("Call Service.getPort(Class)");
    ...
    public void GetServiceNameTest1() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("ServiceName = " + SERVICE_QNAME + "\ngetServiceName() = " + sname);
    ...
    public void CreateDispatchTest1WithWsdl() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Create Dispatch object via Service.createDispatch(QName, Source, Mode)");
    ...
    public void CreateDispatchTest2WithWsdl() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Create Dispatch object via Service.createDispatch(QName, JAXBContext, Mode)");
    ...
    public void CreateDispatchExceptionTest1WithWsdl() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Call Service.createDispatch(QName, Object, Mode) with invalid QName");
            TestUtil.logMsg("INVALID_PORT_QNAME=" + NONEXISTANT_PORT_QNAME);
            String bindingID = new String(SOAPBinding.SOAP11HTTP_BINDING);
    ...
    private jakarta.xml.ws.Service getService(QName sname, WebServiceFeature[] wsfeatures) throws Exception {
        ...
        TestUtil.logMsg("Creating Service via jakarta.xml.ws.Service.create(QName, WebServiceFeature[])");

...
public class Client extends ServiceEETest {
    ...
    public void setup(String[] args, Properties p) throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("unauthUsername=" + unauthUsername + ", unauthPassword=" + unauthPassword);
    ...
    public void getMessageContextTest() throws Fault {
        boolean pass = true;
        try {
            TestUtil.logMsg("getMessageContextTest: test access to MessageContext information");
    ...
    public void getEndpointReferenceTest() throws Fault {
        boolean pass = true;
        try {
            TestUtil.logMsg("getEndpointReferenceTest: test access to EndpointReference information");
    ...
    public void getEndpointReference2Test() throws Fault {
        boolean pass = true;
        try {
            TestUtil.logMsg("getEndpointReference2Test: test access to MessageContext information");
    ...
    public void getUserPrincipalTest() throws Fault {
        boolean pass = true;
        try {
            TestUtil.logMsg("getUserPrincipalTest: test access to UserPrincipal information");
    ...
    public void isUserInRoleTest() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Invoking RPC method isUserInRoleTest() and " + "expect false for Manager role ...");

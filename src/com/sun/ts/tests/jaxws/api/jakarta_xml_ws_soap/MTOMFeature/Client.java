...
public class Client extends ServiceEETest {
    ...
    public void MTOMFeatureConstructorTest2() throws Fault {
        ...
        try {
            ...
            if (n != null) {
                if (!(n.isEnabled())) {
                    TestUtil.logMsg("MTOMFeature object created successfully, MTOM is correctly not enabled");
                } else {
        ...
        try {
            ...
            if (n != null) {
                if (!(n.isEnabled())) {
                    ...
                    TestUtil.logMsg("MTOMFeature object created successfully with correct threshold, expected ["
                            + Integer.valueOf(100) + "] received [" + n.getThreshold()
                            + "]");
                }
            } else {
        ...
        try {
            ...
            if (n != null) {
                if (!(MTOMFeature.ID.equals(n.getID()))) {
                    ...
                    TestUtil.logMsg("MTOMFeature object created successfully with correct ID, expected ["
        ...
        try {
            ...
            if (n != null) {
                ...
                if (threshold == 100) {
                    ...
                    TestUtil.logMsg("MTOMFeature object created with correct threshold, received ["
                    ...
                    if (threshold == 1000) {
                        ...
                        TestUtil.logMsg("MTOMFeature object set and retrieved correct threshold, expected ["
                                + Integer.valueOf(1000) + "], received [" + n.getThreshold()
                                + "]");
                    } else {
                        TestUtil.logMsg("MTOMFeature object created with incorrect threshold, expected ["
                                + Integer.valueOf(1000) + "], received [" + n.getThreshold()
                                + "]");
                        pass = false;
                    }

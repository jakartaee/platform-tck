        ...
        if (!Handler_Util.checkForMsg(this, context, "GetTrackerData")) {
            ...
            if (direction.equals(Constants.OUTBOUND)) {
                if (Handler_Util.checkForMsg(
                        this, context, "ClientSOAPOutboundHandleMessageThrowsRuntimeExceptionTest")) {
                    ...
                    throw new SOAPFaultException(sf);
                        ...
                        this, context, "ClientSOAPOutboundHandleMessageThrowsWebServiceExceptionTest")) {
                    ...
                    throw new WebServiceException(
                        ...
                        this, context, "ClientSOAPOutboundHandleMessageThrowsProtocolExceptionTest")) {
                ...
                // inbound
                if (Handler_Util.checkForMsg(
                        this, context, "ClientSOAPInboundHandleMessageThrowsRuntimeExceptionTest")) {
                    HandlerTracker.reportComment(this, "Throwing an inbound RuntimeException");
                    ...
                    throw new SOAPFaultException(sf);
                        ...
                        this, context, "ClientSOAPInboundHandleMessageThrowsWebServiceExceptionTest")) {
        ...
        if (direction.equals(Constants.INBOUND)) {
            if (Handler_Util.checkForMsg(
                ...
                return false;
                    ...
                    this, context, "ClientSOAPOutboundHandleFaultThrowsRuntimeExceptionTest")) {
                HandlerTracker.reportComment(this, "Throwing an inbound RuntimeException");
                ...
                try {
                    ...
                    HandlerTracker.reportThrowable(
                            this, new Exception("Unexpected error occurred in handleFault for an inbound message" + e));
                }
                throw new SOAPFaultException(sf);
            }
        }

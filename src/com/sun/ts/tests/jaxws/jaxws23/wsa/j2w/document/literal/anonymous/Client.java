...
public class Client extends ServiceEETest {
    ...
    private Dispatch<SOAPMessage> createAnonymousResponsesDispatch() {
        return service23001.createDispatch(
                PORT_QNAME23001, SOAPMessage.class, Service.Mode.MESSAGE, ENABLED_ADDRESSING_FEATURE);
    }

    private Dispatch<SOAPMessage> createNonAnonymousResponsesDispatch() {
        return service23002.createDispatch(
                PORT_QNAME23002, SOAPMessage.class, Service.Mode.MESSAGE, ENABLED_ADDRESSING_FEATURE);
    }

    private Dispatch<SOAPMessage> createAnonymousResponsesDispatchWithoutAddressing() {
        return service23001.createDispatch(
                PORT_QNAME23001, SOAPMessage.class, Service.Mode.MESSAGE, DISABLED_ADDRESSING_FEATURE);
    }

    private Dispatch<SOAPMessage> createNonAnonymousResponsesDispatchWithoutAddressing() {
        return service23002.createDispatch(
                PORT_QNAME23002, SOAPMessage.class, Service.Mode.MESSAGE, DISABLED_ADDRESSING_FEATURE);
    }

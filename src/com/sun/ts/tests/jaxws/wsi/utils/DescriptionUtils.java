...
public class DescriptionUtils implements DescriptionConstants, SOAPConstants, SchemaConstants, WSIConstants {
     ...
     * @return Element
     */
    public static Element getPortTypeOperationNameElement(
            Document document, String portTypeName, String operationName) {
        Element portType = getPortType(document, portTypeName);
        if (portType != null) {
    ...
    public static String[] getFaultMessageNames(Document document, String portTypeName) {
        ...
        if (portType != null) {
            Element[] operations = getChildElements(portType, WSDL_NAMESPACE_URI, WSDL_OPERATION_LOCAL_NAME);
            for (int i = 0; i < operations.length; i++) {
                Element[] faults = DescriptionUtils.getChildElements(operations[i], WSDL_NAMESPACE_URI, WSDL_FAULT_LOCAL_NAME);
                // Operation always has an input, may not have a fault so let's check
                if (faults.length > 0) {
     ...
     * @throws EETest.Fault
     */
    public static boolean findGlobalElementByName(Document document, String name) throws EETest.Fault {
     ...
     * @throws EETest.Fault
     */
    public static boolean findGlobalElementByName(Element element, String name) throws EETest.Fault {
     ...
     * @throws EETest.Fault
     */
    public static Document[] getSchemaDocuments(Document document, String base) throws EETest.Fault {
        Element[] imports = getSchemaImportElements(document);
        ArrayList alist = new ArrayList();
        for (int i = 0; i < imports.length; i++) {
     ...
     * @throws EETest.Fault
     */
    public static Document getSchemaDocument(Document document, String prefix, String base) throws EETest.Fault {
     ...
     * @throws EETest.Fault
     */
    public static Document[] getWsdlDocuments(Document document, String base) throws EETest.Fault {
        Element[] imports = getImports(document);
        ArrayList alist = new ArrayList();
        for (int i = 0; i < imports.length; i++) {
            String location = imports[i].getAttribute(WSDL_LOCATION_ATTR);
     ...
     * @throws EETest.Fault
     */
    public static Document[] getSchemaDocuments(Document document, URL url) throws EETest.Fault {
        Element[] imports = getSchemaImportElements(document);
        ArrayList alist = new ArrayList();
        for (int i = 0; i < imports.length; i++) {
            String schemaLocation = imports[i].getAttribute(XSD_SCHEMALOCATION_ATTR);
     ...
     * @throws EETest.Fault
     */
    public static Document getSchemaDocument(Document document, String prefix, URL url) throws EETest.Fault {
        String ns = getNamespaceOfPrefix(document, prefix);
        Element[] imports = getSchemaImportElements(document);
        for (int i = 0; i < imports.length; i++) {
            String namespace = imports[i].getAttribute(XSD_NAMESPACE_ATTR);
     ...
     * @throws EETest.Fault
     */
    public static Document[] getWsdlDocuments(Document document, URL url) throws EETest.Fault {
        Element[] imports = getImports(document);
        ArrayList alist = new ArrayList();
        for (int i = 0; i < imports.length; i++) {
            String location = imports[i].getAttribute(WSDL_LOCATION_ATTR);
     ...
     * @throws EETest.Fault
     */
    public static Document getDocumentFromLocation(String location, URL context) throws EETest.Fault {
        try {
            URL url;

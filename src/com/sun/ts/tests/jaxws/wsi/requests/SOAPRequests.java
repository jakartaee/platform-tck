...
public interface SOAPRequests {
    ...
    public static final String HELLOWORLD_WITH_HANDLER =
    ...
    public static final String HELLOWORLD_WITH_CONFORMANCE_WITH_MU1 =
    ...
    public static final String HELLOWORLD_WITH_CONFORMANCE_WITH_MU0 =
    ...
    public static final String HELLOWORLD_WITH_CONFORMANCE =
    ...
    public static final String HELLOWORLD_WITH_MULTIPLE_CONFORMANCE =
    ...
    public static final String ALWAYS_THROWS_EXCEPTION =
    ...
    public static final String ALWAYS_THROWS_SERVER_EXCEPTION =
    ...
    public static final String BAD_SOAP_ENVELOPE =
    ...
    public static final String MUST_UNDERSTAND_HEADER =
    ...
    public static final String NON_EXISTANT_OPERATION =
    ...
    public static final String BAD_SOAP_ENVELOPE_WITH_HEADER =
    ...
    public static final String BAD_SOAP_ENVELOPE_NON_EXISTANT_OPERATION =
            "<?xml version='1.0' encoding='UTF-8'?><!-- Copyright (c) 2003 Oracle Corporation.  All rights reserved. --><env:Envelope xmlns:env='http://not.soap/envelope/' xmlns:xsd='http://www.w3.org/2001/XMLSchema' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' xmlns:enc='http://schemas.xmlsoap.org/soap/encoding/' xmlns:ns0='http://simpletestservice.org/wsdl' xmlns:ns1='http://simpletestservice.org/wsdl'><env:Body><ns0:nonExistantOperation/></env:Body></env:Envelope>";

    public static final String MUST_UNDERSTAND_HEADER_NON_EXISTANT_OPERATION =
            "<?xml version='1.0' encoding='UTF-8'?><!-- Copyright (c) 2003 Oracle Corporation.  All rights reserved. --><env:Envelope xmlns:env='http://schemas.xmlsoap.org/soap/envelope/' xmlns:xsd='http://www.w3.org/2001/XMLSchema' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' xmlns:enc='http://schemas.xmlsoap.org/soap/encoding/' xmlns:ns0='http://simpletestservice.org/wsdl' xmlns:ns1='http://simpletestservice.org/wsdl'><env:Header><foo:Bar xmlns:foo='http://foo.org/bar/' env:actor='http://schemas.xmlsoap.org/soap/actor/next' env:mustUnderstand='1'>BAZ</foo:Bar></env:Header><env:Body><ns0:nonExistantOperation/></env:Body></env:Envelope>";

    public static final String SOAP_ACTION_HELLO_WORLD =
    ...
    public static final String SOAP_ACTION_ECHO_STRING =
    ...
    public static final String ARRAY_OPERATION =
    ...
    public static final String ECHO_STRING =
            "<?xml version='1.0' encoding='UTF-8'?><!-- Copyright (c) 2003 Oracle Corporation.  All rights reserved. --><env:Envelope xmlns:env='http://schemas.xmlsoap.org/soap/envelope/' xmlns:xsd='http://www.w3.org/2001/XMLSchema' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' xmlns:enc='http://schemas.xmlsoap.org/soap/encoding/' xmlns:ns0='http://soapactionservice.org/wsdl/' xmlns:ns1='http://soapactionservice.org/types/'><env:Header><cts:test env:actor='http://conformance-checker.org' xmlns:cts='http://cts.org'>response</cts:test></env:Header><env:Body><ns0:echoString><str><ans1:p1 xmlns:ans1=\"http://soapactionservice.org/xsd\">echo</ans1:p1></str></ns0:echoString></env:Body></env:Envelope>";

    public static final String R0007_REQUEST =
    ...
    public static final String R0007_RESPONSE =
    ...
    public static final String R1011_REQUEST =
    ...
    public static final String R1011_RESPONSE =
    ...
    public static final String R1012_REQUEST =
    ...
    public static final String R1012_RESPONSE =
    ...
    public static final String R97XX_REQUEST =
    ...
    public static final String R97XX_RESPONSE =
    ...
    public static final String R2301_REQUEST =
    ...
    public static final String R2729_REQUEST =
    ...
    public static final String R2744_RESPONSE =
    ...
    public static final String R2745_RESPONSE =
    ...
    public static final String R273X_RESPONSE =
    ...
    public static final String R2712_REQUEST =
    ...
    public static final String R2712_RESPONSE =
    ...
    public static final String R11XX_RESPONSE =
    ...
    public final String R2915_UTF8_REQUEST_NO_ATTACHMENTS =
    ...
    public final String R2915_UTF16_REQUEST_NO_ATTACHMENTS =
    ...
    public final String R2915_UTF8_REQUEST_NO_ATTACHMENTS_DOCLIT =
    ...
    public final String R2915_UTF16_REQUEST_NO_ATTACHMENTS_DOCLIT =
            "<?xml version=\"1.0\" encoding=\"UTF-16\"?><env:Envelope xmlns:env=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:enc=\"http://schemas.xmlsoap.org/soap/encoding/\" xmlns:ns0=\"http://SwaTestService.org/xsd\"><env:Body><ns0:InputRequestString><ns0:myString>Hello</ns0:myString></ns0:InputRequestString></env:Body></env:Envelope>";

    public final String R2917_REQUEST =
            "<?xml version=\"1.0\" encoding=\"UTF-8\"?><env:Envelope xmlns:env=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:enc=\"http://schemas.xmlsoap.org/soap/encoding/\" xmlns:ns0=\"http://SwaTestService.org/xsd\" xmlns:ns1=\"http://SwaTestService.org/wsdl\"><env:Body><ns1:echoNoAttachments><request><ns0:myString>Hello</ns0:myString></request></ns1:echoNoAttachments></env:Body></env:Envelope>";

    public final String R2925_REQUEST =
    ...
    public final String R2917_REQUEST_DOCLIT =
            "<?xml version=\"1.0\" encoding=\"UTF-8\"?><env:Envelope xmlns:env=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:enc=\"http://schemas.xmlsoap.org/soap/encoding/\" xmlns:ns0=\"http://SwaTestService.org/xsd\"><env:Body><ns0:InputRequestString><ns0:myString>Hello</ns0:myString></ns0:InputRequestString></env:Body></env:Envelope>";

    public final String R2925_REQUEST_DOCLIT =
    ...
    public final String R2917_RESPONSE1 =
    ...
    public final String R2917_RESPONSE2 =
    ...
    public final String R2917_RESPONSE_DOCLIT =
    ...
    public final String MTOM_RESPONSE_DOCLIT =
            "<?xml version=\"1.0\" encoding=\"UTF-8\"?><soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\"><soapenv:Body><MTOMIn2Response xmlns=\"http://mtomtestservice.org/xsd\">{0}</MTOMIn2Response></soapenv:Body></soapenv:Envelope>";
}

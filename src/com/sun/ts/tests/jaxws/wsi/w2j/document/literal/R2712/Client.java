...
public class Client extends ServiceEETest implements SOAPRequests {
    ...
    public void setup(String[] args, Properties properties) throws EETest.Fault {
        client1 = (W2JDLR2712ClientOne) ClientFactory.getClient(W2JDLR2712ClientOne.class, properties, this, service);
        client2 = (W2JDLR2712ClientTwo) ClientFactory.getClient(W2JDLR2712ClientTwo.class, properties, this, service);
        logMsg("setup ok");
    }
     ...
     * @throws com.sun.ts.lib.harness.EETest.Fault
     */
    public void ChildElementInstanceOfGlobalElementInRequest() throws EETest.Fault {
     ...
     * @throws com.sun.ts.lib.harness.EETest.Fault
     */
    public void ChildElementInstanceOfGlobalElementInResponse() throws EETest.Fault {

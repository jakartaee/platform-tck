...
public class Client extends ServiceEETest implements SOAPRequests {
    ...
    public void setup(String[] args, Properties properties) throws Fault {
        client1 = (W2JRLR1011ClientOne) ClientFactory.getClient(W2JRLR1011ClientOne.class, properties, this, service);
        client2 = (W2JRLR1011ClientTwo) ClientFactory.getClient(W2JRLR1011ClientTwo.class, properties, this, service);
        logMsg("setup ok");
    }
    ...
    public void testResponseChildren() throws Fault {
        ...
        if (!isElement(envelope, "http://schemas.xmlsoap.org/soap/envelope/", "Envelope")) {
            throw new Fault("Expected 'env:Envelope' element not received (BP-R1011)");
        }
        ...
        for (int i = 0; i < list.getLength(); i++) {
            ...
            if (hasBody) {
                throw new Fault("Child of 'env:Envelope' following 'env:Body' (BP-R1011)");
            } else {
    ...
    public void testRequestChildren() throws Fault {
        ...
        if (!result.equals(STRING_2)) {
            if (result.equals("EXCEPTION")) {
                ...
                throw new Fault("Request contains invalid 'soap:Envelope' children (BP-R1011)");
            }
        }
    }
}

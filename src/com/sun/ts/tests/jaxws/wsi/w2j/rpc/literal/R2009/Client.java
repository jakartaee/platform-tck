...
public class Client extends ServiceEETest {
    ...
    public void setup(String[] args, Properties properties) throws Fault {
        client = (W2JRLR2009Client) ClientFactory.getClient(W2JRLR2009Client.class, properties, this, service);
        logMsg("setup ok");
    }
    ...
    public void testBOMUTF16Schema() throws Fault {
        ...
        try {
            ...
            throw new Fault("Unable to invoke echoIncludedUTF16IntegerTest operation (BP-R2009)", e);
        }
        if (!BIGINTEGER.equals(result)) {
            throw new Fault("echoIncludedUTF16IntegerTest operation returns '" + result + "' in stead of '" + BIGINTEGER
                    + "' (BP-R2009)");
        }
    }
}

...
public class Client extends ServiceEETest {
    ...
    public void setup(String[] args, Properties properties) throws Fault {
        client = (W2JDLR4002Client) ClientFactory.getClient(W2JDLR4002Client.class, properties, this, service);
        logMsg("setup ok");
    }
     ...
     *
     * @test_Strategy: The supplied WSDL, encoded as UTF-16 and containing a BOM, has been used by the WSDL-to-Java tool to
     * generate an end point. If the tool works correctly, the end-point has been built and deployed so it should simply be
     * reachable.
     *
     * @throws Fault
     */
    public void testDescriptionWithBOM() throws Fault {
        ...
        if (!STRING.equals(result)) {
            throw new Fault("echoString operation returns '" + result + "' in stead of '" + STRING + "' (BP-R4002)");
        }
    }
}

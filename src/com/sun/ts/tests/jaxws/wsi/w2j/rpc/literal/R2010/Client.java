...
public class Client extends ServiceEETest {
    ...
    public void setup(String[] args, Properties properties) throws Fault {
        client = (W2JRLR2010Client) ClientFactory.getClient(W2JRLR2010Client.class, properties, this, service);
        logMsg("setup ok");
    }
    ...
    public void testImportDirectlyUTF8Schema() throws Fault {
        ...
        try {
            ...
            throw new Fault("Unable to invoke echoImportDirectlyUTF8Test operation (BP-R2010)", e);
        }
        if (!STRING.equals(result)) {
            throw new Fault("echoImportDirectlyUTF8Test operation returns '" + result + "' in stead of '" + STRING
                    + "' (BP-R2010)");
        }
    }
    ...
    public void testImportDirectlyUTF16Schema() throws Fault {
        ...
        try {
            ...
            throw new Fault("Unable to invoke echoImportDirectlyUTF16Test operation (BP-R2010)", e);
        }
        if (!BIGINTEGER.equals(result)) {
            throw new Fault("echoImportDirectlyUTF16Test operation returns '" + result + "' in stead of '" + BIGINTEGER
                    + "' (BP-R2010)");
        }
    }
    ...
    public void testImportIndirectlyUTF8Schema() throws Fault {
        ...
        try {
            ...
            throw new Fault("Unable to invoke echoImportIndirectlyUTF8Test operation (BP-R2010)", e);
        }
        if (!STRING.equals(result)) {
            throw new Fault("echoImportIndirectlyUTF8Test operation returns '" + result + "' in stead of '" + STRING
                    + "' (BP-R2010)");
        }
    }
    ...
    public void testImportIndirectlyUTF16Schema() throws Fault {
        ...
        try {
            ...
            throw new Fault("Unable to invoke echoImportIndirectlyUTF16Test operation (BP-R2010)", e);
        }
        if (!BIGINTEGER.equals(result)) {
            throw new Fault("echoImportIndirectlyUTF16Test operation returns '" + result + "' in stead of '"
                    + BIGINTEGER + "' (BP-R2010)");
        }
    }
}

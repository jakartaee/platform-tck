...
public class Client extends ServiceEETest implements SOAPRequests {
    ...
    public void setup(String[] args, Properties properties) throws EETest.Fault {
        client = (W2JRLR1007Client) ClientFactory.getClient(W2JRLR1007Client.class, properties, this, service);
        logMsg("setup ok");
    }
     ...
     * @throws com.sun.ts.lib.harness.EETest.Fault
     */
    public void testNoEncodingStyleOnResponseBodyGrandchildren() throws EETest.Fault {
     ...
     * @throws com.sun.ts.lib.harness.EETest.Fault
     */
    public void testNoEncodingStyleOnRequestBodyGrandchildren() throws EETest.Fault {
        String response = "";
        try {
    ...
    private void validateNoEncodingStyleOnBodyGrandchildren(SOAPMessage response) throws EETest.Fault, SOAPException {
    ...
    private void validateNoEncodingStyleOnChildren(SOAPElement element, SOAPMessage response) throws EETest.Fault {
        ...
        while (children.hasNext()) {
            ...
            if (!(encodingStyle == null || encodingStyle.equals(""))) {
                client.logMessageInHarness(response);
                throw new EETest.Fault("Invalid element: grandchild elements of soap:Body"

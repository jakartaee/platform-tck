...
public class Client extends ServiceEETest implements SOAPRequests {
    ...
    public void setup(String[] args, Properties properties) throws EETest.Fault {
        client1 = (W2JRLR11XXClientOne) ClientFactory.getClient(W2JRLR11XXClientOne.class, properties, this, service);
        client2 = (W2JRLR11XXClientTwo) ClientFactory.getClient(W2JRLR11XXClientTwo.class, properties, this, service);
        logMsg("setup ok");
    }

...
public class Client extends ServiceEETest {
    ...
    public void setup(String[] args, Properties properties) throws Fault {
        client = (W2JRLR2706Client) ClientFactory.getClient(W2JRLR2706Client.class, properties, this, service);
        logMsg("setup ok");
    }
     ...
     * element with the use="literal" attribute has been used by the WSDL-to-Java tool to generate an end point. If the tool
     * works correctly, the end-point has been built and deployed so it should simply be reachable.
     *
     * @throws Fault
     */
    public void testUseAttribute() throws Fault {
        ...
        if (!result.equals(HEADER)) {
            throw new Fault("echoString operation returned '" + result + "' instead of '" + HEADER + "' (BP-R2706)");
        }
    }
}

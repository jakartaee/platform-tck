...
public class Client extends ServiceEETest implements SOAPRequests {
    ...
    public void setup(String[] args, Properties properties) throws Fault {
        client1 = (W2JRLR273XClient1) ClientFactory.getClient(W2JRLR273XClient1.class, properties, this, service);
        client2 = (W2JRLR273XClient2) ClientFactory.getClient(W2JRLR273XClient2.class, properties, this, service);
        logMsg("setup ok");
    }
    ...
    public void testNamespacesForChildrenOfPartAccessorsOnRequest() throws Fault {
        ...
        try {
            ...
            if (!fb2.getFoo().equals(expected)) {
                ...
                throw new Fault("testNamespacesForChildrenOfPartAccessorsOnRequest failed (BP-R273X)");
            }
        } catch (Exception e) {
     ...
     * @throws Fault
     */
    public void testNamespacesForChildrenOfPartAccessorsOnResponse() throws Fault {
        ...
        try {
            ...
            if (!result.equals("OK")) {
                ...
                throw new Fault("testNamespacesForChildrenOfPartAccessorsOnResponse failed (BP-R273X)");
            }
        } catch (Exception e) {
            throw new Fault("Unable to invoke echoFooBar operation (BP-R273X)", e);
        }

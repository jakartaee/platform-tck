...
public class Client extends ServiceEETest implements SOAPRequests {
    ...
    public void setup(String[] args, Properties properties) throws Fault {
        client = (W2JRLR2729Client) ClientFactory.getClient(W2JRLR2729Client.class, properties, this, service);
        logMsg("setup ok");
    }
    ...
    public void testResponseWrapperElement() throws Fault {
        ...
        NodeList list = envelope.getElementsByTagNameNS(
                "http://w2jrlr2729testservice.org/W2JRLR2729TestService.wsdl", "echoStringResponse");
        if (list.getLength() == 0) {
            throw new Fault("Required 'echoStringResponse' element not present in message (BP-R2729)");
        }
    }
}

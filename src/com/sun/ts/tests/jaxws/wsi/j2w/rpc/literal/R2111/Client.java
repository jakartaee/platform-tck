...
public class Client extends ServiceEETest implements DescriptionConstants, SchemaConstants {
     ...
     *
     * @test_Strategy: Retrieve the WSDL, generated by the Java-to-WSDL tool, and examine the complex types, making sure
     * they do not use the wsdl:ArrayType.
     *
     * @throws Fault
     */
    ...
    protected void verifyAttribute(Element element) throws Fault {
        ...
        if (attribute != null) {
            throw new Fault("Encountered comple type that uses attribute with 'wsdl:arrayType' (BP-R2111)");
        }
    }
}

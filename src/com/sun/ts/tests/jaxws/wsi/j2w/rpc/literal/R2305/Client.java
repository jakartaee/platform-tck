...
public class Client extends ServiceEETest implements DescriptionConstants {
    ...
    public void setup(String[] args, Properties properties) throws Fault {
        client = ClientFactory.getClient(SimpleTestClient.class, properties, this, service);
        logMsg("setup ok");
    }
     ...
     * have correct parameterOrder attributes - if present.
     *
     * @throws Fault
     */
    ...
    protected void verifyOperation(Element element) throws Fault {
        ...
        while (tokenizer.hasMoreTokens()) {
            ...
            if ((!inputNames.contains(name)) && (!outputNames.contains(name))) {
                throw new Fault("Parameter '" + name + "' of operation '" + operationName
    ...
    protected Element getMessage(Element element) throws Fault {
        ...
        if (index == -1) {
            throw new Fault("In- or output element refers to unqualified message name '" + message + "' (BP-R2305)");
        }
    ...
    protected ArrayList getPartNames(Element element) throws Fault {
        ...
        for (int i = 0; i < children.length; i++) {
            ...
            if (names.contains(name)) {
                throw new Fault("Duplicate part name '" + name + "' encountered on message (BP-R2305)");
            }
            names.add(name);
        }
        return names;

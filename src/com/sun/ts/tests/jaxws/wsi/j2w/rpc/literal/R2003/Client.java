...
public class Client extends ServiceEETest implements DescriptionConstants, SchemaConstants {
     ...
     *
     * @test_Strategy: Retrieve the WSDL, generated by the Java-to-WSDL tool, and examine all elements, ensuring that
     * xsd:import elements are contained within xsd:schema elements.
     *
     * @throws Fault
     */
    ...
    protected void verifyImportParent(Element element) throws Fault {
        ...
        if (!DescriptionUtils.isElement(parent, XSD_NAMESPACE_URI, XSD_SCHEMA_LOCAL_NAME)) {
            throw new Fault("Encountered xsd:import element that is not child of xsd:schema element (BP-R2003)");
        }
    }
}

...
public class Client extends ServiceEETest implements DescriptionConstants, SOAPConstants {
     ...
     *
     * @test_Strategy: Retrieve the WSDL, generated by the Java-to-WSDL tool, and examine all binding elements that are
     * document style and verify all literal use soap:body elements, ensuring that the part(s) the reference - if any - are

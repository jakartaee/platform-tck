...
public class Client extends ServiceEETest implements DescriptionConstants, SchemaConstants {
     ...
     *
     * @test_Strategy: Retrieve the WSDL, generated by the Java-to-WSDL tool, and examine all xsd:complexType elements,
     * making sure that they are not named ArrayOf[XXX].
     *
     * @throws Fault
     */
    ...
    protected void verifyComplexType(Element complexType) throws Fault {
        ...
        if (name.startsWith("ArrayOf")) {
            throw new Fault("xsd:complexType element encountered named '" + name + "' (BP-R2112)");
        }
    }
}

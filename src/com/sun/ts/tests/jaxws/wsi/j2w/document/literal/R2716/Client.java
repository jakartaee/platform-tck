...
public class Client extends ServiceEETest {
     ...
     *
     * @test_Strategy: Retrieve the WSDL, generated by the Java-to-WSDL tool, and examine the document-literal wsdl:binding
     * elements to ensure that their input- and output elements' soap:body, soap:header, soap:headerfault and soap:fault
     * elements do not have a namespace attribute defined.
     *
     * @throws Fault
     */

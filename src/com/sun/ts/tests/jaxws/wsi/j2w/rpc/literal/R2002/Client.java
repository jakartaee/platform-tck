...
public class Client extends ServiceEETest implements DescriptionConstants {
     ...
     *
     * @test_Strategy: Retrieve the WSDL, generated by the Java-to-WSDL tool, and examine all wsdl:import statements,
     * ensuring that the resource at the specified location is not a schema.
     *
     * @throws Fault
     */
    ...
    protected void verifyImport(Element element) throws Fault {
        ...
        if (!DescriptionUtils.isDescription(document)) {
            throw new Fault("Document imported from '" + location + "' is not a description (BP-R2002)");
        }
    }
}

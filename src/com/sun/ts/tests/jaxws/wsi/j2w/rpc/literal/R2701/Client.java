...
public class Client extends ServiceEETest implements DescriptionConstants, SOAPConstants {
     ...
     * ensure that their soap:binding element has a transport attribute specified.
     *
     * @throws Fault
     */
    ...
    protected void verifySOAPBinding(Element element) throws Fault {
        ...
        if (transport.length() == 0) {
            throw new Fault("The required soap:binding transport attribute not present (BP-R2701)");
        }
    }
}

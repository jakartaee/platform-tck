...
public class NamespaceAttributeVerifier implements DescriptionConstants, SOAPConstants {
    ...
    protected void verifyBinding(Element binding) throws EETest.Fault {
        ...
        if (!style.equals(this.style)) {
            throw new EETest.Fault("The literal style attribute does not match, expected " + this.style
    ...
    protected void verifySOAPElement(Element element) throws EETest.Fault {
        ...
        if (attr != null) {
            ...
            if (!forbidden) {
                throw new EETest.Fault("The " + style + "-literal element 'soap:" + element.getLocalName()

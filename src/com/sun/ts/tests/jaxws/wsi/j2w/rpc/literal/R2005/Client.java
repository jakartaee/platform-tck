...
public class Client extends ServiceEETest implements DescriptionConstants {
     ...
     * that the target namespace of the imported WSDL matches the namespace of the wsdl:import.
     *
     * @throws Fault
     */
    ...
    protected void verifyImport(Element element) throws Fault {
        ...
        if (!namespace.equals(targetNamespace)) {
            throw new Fault("Target namespace '" + targetNamespace + "' of description at '"

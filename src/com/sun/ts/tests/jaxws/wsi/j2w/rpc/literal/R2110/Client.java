...
public class Client extends ServiceEETest implements DescriptionConstants, SchemaConstants {
     ...
     *
     * @test_Strategy: Retrieve the WSDL, generated by the Java-to-WSDL tool, and examine the array types, making sure they
     * do not extend the soap-enc:Array type.
     *
     * @throws Fault
     */
    ...
    protected void verifyRestriction(Element element) throws Fault {
        ...
        if (value.endsWith(":Array")) {
            throw new Fault("Encountered complex type that extends 'soap-enc:Array' (BP-R2110)");
        }
    }
}

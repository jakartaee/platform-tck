...
public class Client extends ServiceEETest implements DescriptionConstants, SchemaConstants {
     ...
     *
     * @test_Strategy: Retrieve the WSDL, generated by the Java-to-WSDL tool, and examine all schema element attributes, and
     * verify the namespace declaration for each QName.
     *
     * @throws Fault
     */
            ...
            if (index > 0) {
                if (value.indexOf('/') == -1) {
                    ...
                    if (!DescriptionUtils.isNamespacePrefixDeclared(element, prefix)) {
                        throw new Fault("The prefix '" + prefix + "' in QName attribute '" + name

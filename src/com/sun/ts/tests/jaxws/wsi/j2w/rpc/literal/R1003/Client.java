...
public class Client extends ServiceEETest {
     ...
     *
     * @test_Strategy: Make a request that generates a soap:Fault with a detail element with no attributes.
     *
     * @throws com.sun.ts.lib.harness.EETest.Fault
     */
    public void testSOAPFaultExceptionDetailNoAttributes() throws EETest.Fault {
        try {
            ...
            throw new EETest.Fault("Error processing received fault: should have accepted a soap:Fault"
     ...
     *
     * @test_Strategy: Make a request that generates a soap:Fault with a detail element with qualified attributes.
     *
     * @throws com.sun.ts.lib.harness.EETest.Fault
     */
    public void testSOAPFaultExceptionDetailQualifiedAttributes() throws EETest.Fault {
        try {

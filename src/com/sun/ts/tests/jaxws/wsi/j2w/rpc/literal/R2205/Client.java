...
public class Client extends ServiceEETest implements DescriptionConstants {
     ...
     *
     * @test_Strategy: Retrieve the WSDL, generated by the Java-to-WSDL tool, and examine all binding elements and verify
     * allsoap:header, soap:headerfault and soap:fault elements and ensure that their part(s) - if any - are defined using

...
public class Client extends ServiceEETest implements DescriptionConstants, SOAPConstants {
     ...
     * ensuring that the contained soap:fault elements have the name attribute specified.
     *
     * @throws Fault
     */
    ...
    protected void verifySOAPFault(Element fault) throws Fault {
        ...
        if (attr == null) {
            throw new Fault("Required 'name' attribute not present on soap:fault element (BP-R2721)");
        } else {
            foundOne = true;
        }
    }

...
public class Client extends ServiceEETest {
     ...
     *
     * @test_Strategy: Retrieve the WSDL, generated by the Java-to-WSDL tool, and examine its encoding.
     *
     * @throws Fault
     */
    public void testDescriptionEncoding() throws Fault {
        ...
        try {
            ...
            throw new Fault("The description URL '" + descriptionURL + "' is invalid (BP-R4003)", e);
        }
    }
    ...
    protected void verifyEncoding(URL url) throws Fault {
        ...
        if (description.startsWith("<?xml")) {
            ...
            if (index == -1) {
                throw new Fault("Description at '" + url + "' has open '<?xml ...' declaration (BP-R4003)");
            }
            ...
            if (index != -1) {
                ...
                throw new Fault("Description at '" + url + "' is not 'UTF-8','utf-8','utf-16' or 'UTF-16' (BP-R4003)");
            }
        }
    }
    ...
    protected byte[] getDescriptionBytes(URL url) throws Fault {
        try {
            ...
            throw new Fault("Unable to read description from '" + url + "' (BP-R4003)", e);
        }
    }
}

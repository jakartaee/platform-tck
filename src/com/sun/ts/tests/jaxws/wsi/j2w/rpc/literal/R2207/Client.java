...
public class Client extends ServiceEETest implements DescriptionConstants, SOAPConstants {
     ...
     *
     * @test_Strategy: Retrieve the WSDL, generated by the Java-to-WSDL tool, and examine all message elements and verify
     * all part elements, defined by the element attribute, ensuring that they're not referenced by a body in an rpc-literal
     * binding.
     *
     * @throws Fault
     */

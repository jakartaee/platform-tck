...
public class Client extends ServiceEETest implements SOAPRequests {
     ...
     * @throws com.sun.ts.lib.harness.EETest.Fault
     */
    public void testSoapFaultUnqualifiedChildrenDummyException() throws EETest.Fault {
     ...
     * @throws com.sun.ts.lib.harness.EETest.Fault
     */
    public void testSoapFaultUnqualifiedChildrenServerException() throws EETest.Fault {
        SOAPMessage response = null;
        try {
    ...
    private void validateUnqualifiedFaultChildrenNames(SOAPMessage response) throws EETest.Fault, SOAPException {
        ...
        while (children.hasNext()) {
            ...
            if (!(prefix == null || prefix.equals(""))) {
                client.logMessageInHarness(response);
                throw new EETest.Fault("Invalid soap:Fault child : must be unqualified (BP-R1001):  "

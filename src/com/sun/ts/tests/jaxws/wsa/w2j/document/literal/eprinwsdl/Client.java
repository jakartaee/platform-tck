...
public class Client extends ServiceEETest {
    ...
    private void getPortStandalone() throws Exception {
        ...
        port1 = (Test1) JAXWS_Util.getPort(
                wsdlurl, SERVICE_QNAME, EPRInWsdlTestService.class, PORT_QNAME1, Test1.class, addressingenabled);
    ...
    public void GetPortAndVerifyRefParamsAreSentTest1() throws Fault {
        ...
        try {
            ...
            data.value = datatype;
            TestUtil.logMsg("Get port via Service.getPort(Class, AddressingFeature(true))");
    ...
    public void GetPortAndVerifyRefParamsAreSentTest2() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Retrieve EPR via BindingProvider.getEndpointReference()");
            W3CEndpointReference epr = (W3CEndpointReference) bp.getEndpointReference();
            TestUtil.logMsg("Get port via Service.getPort(EPR, Class, AddressingFeature(true))");

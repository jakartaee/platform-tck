...
public class Client extends ServiceEETest {
    ...
    private void getPortStandalone() throws Exception {
        ...
        port1a = (AddressingFeatureTest1) JAXWS_Util.getPort(
                wsdlurl,
                SERVICE_QNAME,
                AddressingFeatureTestService.class,
                PORT_QNAME1,
                AddressingFeatureTest1.class,
                enabledNotRequiredwsf);
        ...
        // Addressing/NotRequired
        port1b = (AddressingFeatureTest1) JAXWS_Util.getPort(
                wsdlurl,
                SERVICE_QNAME,
                AddressingFeatureTestService.class,
                PORT_QNAME1,
        ...
        port1c = (AddressingFeatureTest1) JAXWS_Util.getPort(
                wsdlurl,
                SERVICE_QNAME,
                AddressingFeatureTestService.class,
                PORT_QNAME1,
        ...
        // client side Addressing enabled/NotRequired; server side
        // Addressing/Required
        port2a = (AddressingFeatureTest2) JAXWS_Util.getPort(
                wsdlurl,
                SERVICE_QNAME,
                AddressingFeatureTestService.class,
                PORT_QNAME2,
                AddressingFeatureTest2.class,
                enabledNotRequiredwsf);
        JAXWS_Util.setTargetEndpointAddress(port2a, url2);

        TestUtil.logMsg("******************************Retrieving Port 5************************\n");
        // client side Addressing enabled/Required; server side Addressing/Required
        port2b = (AddressingFeatureTest2) JAXWS_Util.getPort(
                wsdlurl,
                SERVICE_QNAME,
                AddressingFeatureTestService.class,
                PORT_QNAME2,
        ...
        TestUtil.logMsg("******************************Retrieving Port 6************************\n");
        // client side Addressing off; server side Addressing/Required
        port2c = (AddressingFeatureTest2) JAXWS_Util.getPort(
                wsdlurl,
                SERVICE_QNAME,
                AddressingFeatureTestService.class,
                PORT_QNAME2,
        ...
        port3a = (AddressingFeatureTest3) JAXWS_Util.getPort(
                wsdlurl,
                SERVICE_QNAME,
                AddressingFeatureTestService.class,
                PORT_QNAME3,
                AddressingFeatureTest3.class,
                enabledNotRequiredwsf);
        JAXWS_Util.setTargetEndpointAddress(port3a, url3);

        TestUtil.logMsg("******************************Retrieving Port 8************************\n");
        // client side Addressing enabled/Required; server side off (in WSDL
        // enabled, but overridden to false in IMPL to turn it off)
        port3b = (AddressingFeatureTest3) JAXWS_Util.getPort(
                wsdlurl,
                SERVICE_QNAME,
                AddressingFeatureTestService.class,
                PORT_QNAME3,
    ...
    public void afClientEnabledNotREQServerEnabledNotREQTest() throws Fault {
        ...
        TestUtil.logMsg("Verify Addressing headers may be present on SOAPRequest and SOAPResponse");
        boolean pass = true;
        try {
    ...
    public void afClientNotEnabledServerEnabledNotREQTest() throws Fault {
        ...
        TestUtil.logMsg("Verify Addressing headers are not present on SOAPRequest and SOAPResponse");
        boolean pass = true;
        try {
    ...
    public void afClientEnabledNotREQServerEnabledREQTest() throws Fault {
        ...
        TestUtil.logMsg("Verify Addressing headers may be present on SOAPRequest and SOAPResponse");
        TestUtil.logMsg("or a MessageAddressingHeaderRequired soap fault is thrown by endpoint");
        boolean pass = true;
        try {

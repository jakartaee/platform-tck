        ...
        try {
            ...
            try {
                ...
                if (WsaSOAPUtils.isInvalidCARDINALITYFaultCode(s))
                    TestUtil.logMsg("SOAPFault contains expected faultcode InvalidCardinality");
                else {
        ...
        try {
            ...
            try {
                ...
                if (WsaSOAPUtils.isActionMismatchFaultCode(s) || WsaSOAPUtils.isActionNotSupportedFaultCode(s))
                    TestUtil.logMsg("SOAPFault contains expected faultcode ActionMismatch or ActionNotSupported");
                else {
                    String faultcode = WsaSOAPUtils.getFaultCode(s);
                    TestUtil.logErr("SOAPFault contains unexpected faultcode got: " + faultcode
                ...
                TestUtil.logErr("Caught unexpected exception: " + e2.getMessage());
                throw new Fault("testActionMismatchOrActionNotSupportedFaultCase1 failed", e2);
            }
        } catch (Exception e) {
            TestUtil.logErr("Caught unexpected exception: " + e.getMessage());
    ...
    public void testActionMismatchOrActionNotSupportedFaultCase2() throws Fault {
        ...
        try {
            ...
            try {
                ...
                TestUtil.logErr("Caught unexpected exception: " + e2.getMessage());
                throw new Fault("testActionMismatchOrActionNotSupportedFaultCase2 failed", e2);
            }
        } catch (Exception e) {
            TestUtil.logErr("Caught unexpected exception: " + e.getMessage());
    ...
    public void testActionMismatchOrActionNotSupportedFaultCase3() throws Fault {
        ...
        try {
            ...
            try {
                ...
                TestUtil.logErr("Caught unexpected exception: " + e2.getMessage());
                throw new Fault("testActionMismatchOrActionNotSupportedFaultCase3 failed", e2);
            }
        } catch (Exception e) {
            TestUtil.logErr("Caught unexpected exception: " + e.getMessage());

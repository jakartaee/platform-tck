...
public class Client extends ServiceEETest {
    ...
    private void getPortStandalone() throws Exception {
        ...
        port = (AddNumbers) JAXWS_Util.getPort(
                wsdlurl, SERVICE_QNAME, AddNumbersService.class, PORT_QNAME, AddNumbers.class, wsftrue);
    ...
    public void EPRGetEPRViaWSCTest2() throws Fault {
        ...
        boolean pass = true;
        try {
            TestUtil.logMsg("Retrieve EPR via WebServiceContext.getEndpointReference(java.lang.Class)");
    ...
    public void EPRGetEPRViaBPWithUnsupportedEPRClassTest() throws Fault {
        ...
        try {
            TestUtil.logMsg("Retrieve EPR via BindingProvider.getEndpointReference(" + "java.lang.Class)");
            TestUtil.logMsg("Pass in unsupported EPR Class and expect WebServiceException");
    ...
    public void EPRGetPortViaWSCAndWSFTrueTest() throws Fault {
        ...
        try {
            ...
            epr.writeTo(new StreamResult(baos));
            TestUtil.logMsg(baos.toString());
            TestUtil.logMsg("Retrieve the port from the EPR via EndpointReference.getPort()");
            TestUtil.logMsg("Pass WebServiceFeature with Addressing=true");

...
public class Client extends ServiceEETest {
    ...
    private Dispatch<SOAPMessage> createAnonymousResponsesDispatch() {
        return service3.createDispatch(
                PORT_QNAME3, SOAPMessage.class, Service.Mode.MESSAGE, ENABLED_ADDRESSING_FEATURE);
    }

    private Dispatch<SOAPMessage> createNonAnonymousResponsesDispatch() {
        return service4.createDispatch(
                PORT_QNAME4, SOAPMessage.class, Service.Mode.MESSAGE, ENABLED_ADDRESSING_FEATURE);
    }

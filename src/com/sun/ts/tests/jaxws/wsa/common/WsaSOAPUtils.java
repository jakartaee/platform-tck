...
public class WsaSOAPUtils
        implements jakarta.xml.soap.SOAPConstants, com.sun.ts.tests.jaxws.wsa.common.W3CAddressingConstants {
    ...
    public static boolean isMustUnderstandFaultCode(SOAPFaultException se) throws SOAPException {
        return isFaultCode(se, W3CAddressingConstants.SOAP11_MUSTUNDERSTAND_FAULT.getLocalPart());
    }

    public static boolean isVersionMismatchFaultCode(SOAPFaultException se) throws SOAPException {
        return isFaultCode(se, W3CAddressingConstants.SOAP11_VERSIONMISMATCH_FAULT.getLocalPart());
    }

    public static boolean isClientFaultCode(SOAPFaultException se) throws SOAPException {
        return isFaultCode(se, W3CAddressingConstants.SOAP11_CLIENT_FAULT.getLocalPart());
    }

    public static boolean isServerFaultCode(SOAPFaultException se) throws SOAPException {
        return isFaultCode(se, W3CAddressingConstants.SOAP11_SERVER_FAULT.getLocalPart());
    }

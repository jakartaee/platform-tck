...
public class Client extends EETest {
    ...
    public void SOAPIOExceptionTest() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Call SOAPIOException.printStackTrace(PrintStream) method");
            ex.printStackTrace(new PrintStream(baos));
            TestUtil.logMsg("Call SOAPIOException.printStackTrace(PrintWriter) method");
    ...
    public void SOAPVersionMismatchExceptionTest() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Call SOAPVersionMismatchException(String, Throwable) constructor");
            ex = new SOAPVersionMismatchException(s, foo);
            TestUtil.logMsg("Call SOAPVersionMismatchException(Throwable) constructor");
            ex = new SOAPVersionMismatchException(foo);
            TestUtil.logMsg("Call SOAPVersionMismatchException.initCause(Throwable) method");
            ex = new SOAPVersionMismatchException();
            ex.initCause(foo);
            ...
            ex.getMessage();
            TestUtil.logMsg("Call SOAPVersionMismatchException.printStackTrace() method");
            PrintStream saveErrStream = System.err;
            System.setErr(new PrintStream(baos));
            ex.printStackTrace();
            System.setErr(saveErrStream);
            TestUtil.logMsg("Call SOAPVersionMismatchException.printStackTrace(PrintStream) method");
            ex.printStackTrace(new PrintStream(baos));
            TestUtil.logMsg("Call SOAPVersionMismatchException.printStackTrace(PrintWriter) method");
            ex.printStackTrace(new PrintWriter(new PrintStream(baos)));
    ...
    public void MessageFactoryImplTest() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Call MessageFactoryImpl.createMessage(MimeHeaders, InputStream) method");
            SOAPMessage msg2 = mfi.createMessage(
                    headers, new ByteArrayInputStream(baos1.toString().getBytes()));
            msg2.writeTo(baos2);
            if (msg2 == null) {
                TestUtil.logErr("createMessage(MimeHeaders, InputStream) returned null");
                pass = false;
            } else if (!(msg2 instanceof SOAPMessage)) {
                TestUtil.logErr("createMessage(MimeHeaders, InputStream) " + "did not return SOAPMessage object");
                pass = false;
            }
    ...
    public void SOAPDocumentImplTest() throws Fault {
        ...
        try {
            ...
            SOAPDocumentImpl sdi2 = new SOAPDocumentImpl((SOAPPartImpl) msg2.getSOAPPart());
            ...
            TestUtil.logMsg("Call SOAPDocumentImpl.createCDATASection(String) method");
            ...
            TestUtil.logMsg("Call SOAPDocumentImpl.createProcessingInstruction(String, String) method");
            try {
                ProcessingInstruction pi = sdi.createProcessingInstruction("piinst", "pidata");
            } catch (Exception e) {
            }
            ...
            TestUtil.logMsg("Call SOAPDocumentImpl.createEntityReference(String) method");
            try {
                EntityReference entityRef = sdi.createEntityReference("entity1");
            } catch (Exception e) {
            }
            TestUtil.logMsg("Call SOAPDocumentImpl.getElementsByTagName(String) method");
            ...
            TestUtil.logMsg("Call SOAPDocumentImpl.createElementNS(String, String) method");
            try {
                element = sdi.createElementNS("http://MyNameSpace.org/", "element2");
            } catch (Exception e) {
            }
            TestUtil.logMsg("Call SOAPDocumentImpl.createAttributeNS(String, String) method");
            try {
                Attr attr = sdi.createAttributeNS("http://MyNameSpace.org/", "attribute2");
            } catch (Exception e) {
            }
            TestUtil.logMsg("Call SOAPDocumentImpl.getElementsByTagName(String, String) method");
            ...
            TestUtil.logMsg("Call SOAPDocumentImpl.cloneNode(SOAPDocumentImpl, boolean) method");
    ...
    public void SOAPPartImplTest() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Call SOAPPartImpl.createProcessingInstruction(String, String) method");
            try {
                ProcessingInstruction pi = partImpl.createProcessingInstruction("piinst", "pidata");
            } catch (Exception e) {
            }
            ...
            TestUtil.logMsg("Call SOAPPartImpl.createElementNS(String, String) method");
            try {
                element = partImpl.createElementNS("http://MyNameSpace.org/", "element2");
            } catch (Exception e) {
            }
            TestUtil.logMsg("Call SOAPPartImpl.createAttributeNS(String, String) method");
            try {
                Attr attr = partImpl.createAttributeNS("http://MyNameSpace.org/", "attribute2");
            } catch (Exception e) {
            }
            TestUtil.logMsg("Call SOAPPartImpl.getElementsByTagName(String, String) method");
            nl = partImpl.getElementsByTagNameNS("http://MyNameSpace.org/", "element2");
            ...
            TestUtil.logMsg("Call SOAPPartImpl.replaceChild(org.w3c.dom.Node, org.w3c.dom.Node) method");
            Element element1 = partImpl.createElement("element3");
            Element element2 = partImpl.createElement("element4");
            try {
                node = partImpl.replaceChild((org.w3c.dom.Node) element1, (org.w3c.dom.Node) element2);
            } catch (Exception e) {
            }
    ...
    public void GifDataContentHandlerTest() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Call GifDataContentHandler.getTransferDataFlavors() method");
            ...
            TestUtil.logMsg("Call GifDataContentHandler.writeTo(Object, String, OutputStream) method");
            TestUtil.logMsg("GIF encoding is not supported so this should throw IOException");
            try {
    ...
    public void JpegDataContentHandlerTest() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Call JpegDataContentHandler.getTransferDataFlavors() method");
            ...
            TestUtil.logMsg("Call JpegDataContentHandler.writeTo(Object, String, OutputStream) method");
    ...
    public void XmlDataContentHandlerTest() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Call XmlDataContentHandler.getTransferDataFlavors() method");
            ...
            TestUtil.logMsg("Call XmlDataContentHandler.writeTo(Object, String, OutputStream) method");
    ...
    public void StringDataContentHandlerTest() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Call StringDataContentHandler.getTransferDataFlavors() method");
            ...
            TestUtil.logMsg("Call StringDataContentHandler.writeTo(Object, String, OutputStream) method");

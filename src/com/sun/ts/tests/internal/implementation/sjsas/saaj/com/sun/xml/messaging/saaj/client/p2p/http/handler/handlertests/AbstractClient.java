...
public class AbstractClient extends EETest {
    ...
    public void BasicAuthenticationTest() throws Fault {
        ...
        try {
            ...
            BasicAuthentication ba = new BasicAuthentication(false, hostname, portnum, "realm", pa);
            TestUtil.logMsg("Call BasicAuthentication(boolean, String, int, String, String) constructor");
            ba = new BasicAuthentication(false, hostname, portnum, "realm", "auth");
            TestUtil.logMsg("Call BasicAuthentication(boolean, URL, String, PasswordAuthentication) constructor");
            ba = new BasicAuthentication(false, url, "realm", pa);
            TestUtil.logMsg("Call BasicAuthentication(boolean, URL, String, String) constructor");
            ...
            TestUtil.logMsg("Call BasicAuthentication.supportsPreemptiveAuthorization() method");
            boolean isPreemptive = ba.supportsPreemptiveAuthorization();
            TestUtil.logMsg(
                    "HeaderName=" + headerName + ", HeaderValue=" + headerValue + ", IsPreemtive=" + isPreemptive);
            TestUtil.logMsg("Call BasicAuthentication.getServerAuth(URL) method");
            AuthenticationInfo ai = ba.getServerAuth(url);
            TestUtil.logMsg("Call BasicAuthentication.getServerAuth(URL, String) method");
            ai = ba.getServerAuth(url, "realm");
            TestUtil.logMsg("Call BasicAuthentication.getProxyAuth(String, int) method");
            ai = ba.getProxyAuth(hostname, portnum);
            TestUtil.logMsg("Call BasicAuthentication.getProxyAuth(String, int, String) method");
    ...
    public void DigestAuthenticationTest() throws Fault {
        ...
        boolean pass = true;
        try {
            TestUtil.logMsg("Call DigestAuthentication(URL, String, String, PasswordAuthentication) constructor");

            PasswordAuthentication pa = new PasswordAuthentication(username, password.toCharArray());
            DigestAuthentication ba = new DigestAuthentication(url, "realm", "basic", pa);
            ...
            String headerValue = ba.getHeaderValue();
            TestUtil.logMsg("Call DigestAuthentication.supportsPreemptiveAuthorization() method");
            boolean isPreemptive = ba.supportsPreemptiveAuthorization();
            TestUtil.logMsg(
                    "HeaderName=" + headerName + ", HeaderValue=" + headerValue + ", IsPreemtive=" + isPreemptive);
            TestUtil.logMsg("Call DigestAuthentication.getServerAuth(URL) method");
            AuthenticationInfo ai = ba.getServerAuth(url);
            TestUtil.logMsg("Call DigestAuthentication.getServerAuth(URL, String) method");
            ai = ba.getServerAuth(url, "realm");
            TestUtil.logMsg("Call DigestAuthentication.getProxyAuth(String, int) method");
            ai = ba.getProxyAuth(hostname, portnum);
            TestUtil.logMsg("Call DigestAuthentication.getProxyAuth(String, int, String) method");
            ai = ba.getProxyAuth(hostname, portnum, "realm");
    ...
    public void HttpURLConnectionTest() throws Fault {
        ...
        boolean pass = true;
        try {
            TestUtil.logMsg("Call HttpURLConnection(URL, hostname, portnum) constructor");
            ...
            TestUtil.logMsg("Call HttpURLConnection.setDoInput(boolean) method");
            b = conn.getDoInput();
            TestUtil.logMsg("Call HttpURLConnection.setRequestMethod(boolean) method");
            conn.setRequestMethod("POST");
            TestUtil.logMsg("Call HttpURLConnection.setRequestProperty(String, String) method");
            conn.setRequestProperty("HTTP-Version", "HTTP/1.1");
            conn.setRequestProperty("Content-Type", "text/xml");
            conn.setRequestProperty("SOAPAction", "\"\"");
            TestUtil.logMsg("Call HttpURLConnection.setAuthenticationProperty(String, String) method");
            conn.setAuthenticationProperty("USER", username);
            conn.setAuthenticationProperty("PASSWORD", password);
            TestUtil.logMsg("Call HttpURLConnection.getRequestProperty(String) method");
            ...
            TestUtil.logMsg("Call HttpURLConnection.getProxiedClient(URL, String, int) method");
            hc = conn.getProxiedClient(url, hostname, portnum);
            TestUtil.logMsg("Call HttpURLConnection.openConnectionCheckRedirects(URLConnection) method");
            try {
                InputStream is = conn.openConnectionCheckRedirects(url.openConnection());
                is.close();
            } catch (Exception e) {
            }
        } catch (Exception e) {
    ...
    private int _sendRequest(HttpURLConnection conn, byte[] data) throws IOException {
        ...
        InputStream istream = !isFailure ? conn.getInputStream() : conn.getErrorStream();
        if (istream != null) {

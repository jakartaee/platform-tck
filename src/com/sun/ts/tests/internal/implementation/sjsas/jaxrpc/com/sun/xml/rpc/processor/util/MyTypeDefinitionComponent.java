...
public class MyTypeDefinitionComponent extends TypeDefinitionComponent {
  public MyTypeDefinitionComponent() {
    super();
  }

  public void accept(ComponentVisitor vistor) throws Exception {
  }
}

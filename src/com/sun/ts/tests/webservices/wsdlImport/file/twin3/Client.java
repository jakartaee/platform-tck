...
package com.sun.ts.tests.webservices.wsdlImport.file.twin3;
...
public class Client extends EETest {
  ...
  /*
   * @testName: invokeTwin3Svcs
   *
   * @assertion_ids: WS4EE:SPEC:214;WS4EE:SPEC:65
   *
   * @test_Strategy:
   */
  public void invokeTwin3Svcs() throws Fault {
    TestUtil.logMsg("invokeTwin3Svcs");
    try {
      port1.hello();
      port2.bye();
      TestUtil.logMsg("invokeTwin3Svcs passed");
    } catch (Throwable t) {
      TestUtil
          .logMsg("test invokeTwin3Svcs failed: got exception " + t.toString());
      throw new Fault("invokeTwin3Svcs failed");
    }
    return;
  }
}

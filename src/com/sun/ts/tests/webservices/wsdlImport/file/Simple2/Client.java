...
package com.sun.ts.tests.webservices.wsdlImport.file.Simple2;
...
public class Client extends ServiceEETest {
  private String SERVICE_NAME_WITH_WSDL = "Simple2File";

  private String SERVICE_NAME_WITH_WSDL_NO_PCREF = "Simple2File_no_pcref";
  ...
  public void setup(String[] args, Properties p) throws Fault {
    try {
      ...
      TestUtil.logMsg("JNDI lookup for Simple2 Service");

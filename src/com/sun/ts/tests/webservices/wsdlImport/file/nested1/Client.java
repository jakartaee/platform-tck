...
package com.sun.ts.tests.webservices.wsdlImport.file.nested1;
...
public class Client extends ServiceEETest {
  ...
  private void getStub() throws Exception {
    ...
    Service svc = (javax.xml.rpc.Service) ctx
        .lookup("java:comp/env/service/nested1");
    TestUtil.logMsg("Get port from Service1");
    port = (StockQuotePortType) svc.getPort(
        com.sun.ts.tests.webservices.wsdlImport.file.nested1.StockQuotePortType.class);

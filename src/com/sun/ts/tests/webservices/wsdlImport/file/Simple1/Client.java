...
package com.sun.ts.tests.webservices.wsdlImport.file.Simple1;
...
public class Client extends ServiceEETest {
  private String SERVICE_NAME_WITH_WSDL = "Simple1File";

  private String SERVICE_NAME_WITH_WSDL_NO_PCREF = "Simple1File_no_pcref";
  ...
  public void setup(String[] args, Properties p) throws Fault {
    try {
      ...
      TestUtil.logMsg("JNDI lookup for Simple1 Service");

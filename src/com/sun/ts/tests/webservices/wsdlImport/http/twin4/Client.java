...
package com.sun.ts.tests.webservices.wsdlImport.http.twin4;
...
public class Client extends EETest {
  ...
  /*
   * @testName: invokeTwin4Svcs
   *
   * @assertion_ids: WS4EE:SPEC:214;WS4EE:SPEC:65
   *
   * @test_Strategy:
   */
  public void invokeTwin4Svcs() throws Fault {
    TestUtil.logMsg("invokeTwin4Svcs");
    try {
      port1.hello();
      port2.bye();
      TestUtil.logMsg("invokeTwin4Svcs passed");
    } catch (Throwable t) {
      TestUtil
          .logMsg("test invokeTwin4Svcs failed: got exception " + t.toString());
      throw new Fault("invokeTwin4Svcs failed");
    }
    return;
  }
}

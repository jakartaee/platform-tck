...
package com.sun.ts.tests.webservices.wsdlImport.http.twin1;
...
public class Client extends EETest {
  ...
  /*
   * @testName: invokeTwin1Svcs
   *
   * @assertion_ids: WS4EE:SPEC:214;WS4EE:SPEC:66
   *
   * @test_Strategy:
   */
  public void invokeTwin1Svcs() throws Fault {
    TestUtil.logMsg("invokeTwin1Svcs");
    try {
      port1.hello();
      port2.bye();
      TestUtil.logMsg("invokeTwin1Svcs passed");
    } catch (Throwable t) {
      TestUtil
          .logMsg("test invokeTwin1Svcs failed: got exception " + t.toString());
      throw new Fault("invokeTwin1Svcs failed");
    }
    return;
  }
}

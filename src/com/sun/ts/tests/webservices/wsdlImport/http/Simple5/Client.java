...
package com.sun.ts.tests.webservices.wsdlImport.http.Simple5;
...
public class Client extends ServiceEETest {
  private String SERVICE_NAME_WITH_WSDL = "Simple5Http";

  private String SERVICE_NAME_WITH_WSDL_NO_PCREF = "Simple5Http_no_pcref";
  ...
  public void setup(String[] args, Properties p) throws Fault {
    try {
      ...
      TestUtil.logMsg("JNDI lookup for Simple5 Service");

...
package com.sun.ts.tests.webservices.wsdlImport.http.Simple4;
...
public class Client extends ServiceEETest {
  private String SERVICE_NAME_WITH_WSDL = "Simple4Http";

  private String SERVICE_NAME_WITH_WSDL_NO_PCREF = "Simple4Http_no_pcref";
  ...
  public void setup(String[] args, Properties p) throws Fault {
    try {
      ...
      TestUtil.logMsg("JNDI lookup for Simple4 Service");

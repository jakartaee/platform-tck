...
public class Client extends ServiceEETest {
   ...
   * WS4EE:SPEC:91; WS4EE:SPEC:174; JavaEE:SPEC:247;
   *
   ...
   * WS4EE:SPEC:90; WS4EE:SPEC:91; JavaEE:SPEC:247;
   *
   ...
   * WS4EE:SPEC:162; WS4EE:SPEC:90; WS4EE:SPEC:91; JavaEE:SPEC:247;
   *
  ...
  private Vector removeServerSideHandlers(Vector v) {
    Vector v2 = new Vector();
    Object[] elements = v.toArray();
    for (int i = 0; i < elements.length; i++) {
      if (elements[i].toString().indexOf("ClientHandler") >= 0)
        v2.add(elements[i]);
    }
    return v2;
  }

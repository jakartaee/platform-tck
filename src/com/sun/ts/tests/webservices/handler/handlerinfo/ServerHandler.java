...
package com.sun.ts.tests.webservices.handler.handlerinfo;
...
public class ServerHandler extends HandlerBase {
  ...
  public void init(HandlerInfo hi) {
    ...
    String s1 = (String) cfg.get("ServerParam1");
    String s2 = (String) cfg.get("ServerParam2");
  ...
  public boolean handleRequest(MessageContext context) {
    ...
    String buf = "";
    if (qns[0].getNamespaceURI().equals("http://HandlerInfo.org/Server1")
        && qns[0].getLocalPart().equals("header1")) {
      if (!qns[1].getNamespaceURI().equals("http://HandlerInfo.org/Server2")
    ...
    } else if (qns[0].getNamespaceURI().equals("http://HandlerInfo.org/Server2")
        && qns[0].getLocalPart().equals("header2")) {
      if (!qns[1].getNamespaceURI().equals("http://HandlerInfo.org/Server1")

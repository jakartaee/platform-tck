...
/* inter-module port-component-link SEI */
public class InterModuleSeiImpl implements InterModuleSei {

  public String interModCall(String param) throws java.rmi.RemoteException {

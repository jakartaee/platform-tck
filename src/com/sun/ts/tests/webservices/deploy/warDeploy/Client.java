...
public class Client extends EETest {
  ...
  private void getStub() throws Exception {
    ...
    svc = (javax.xml.rpc.Service) ctx.lookup("java:comp/env/service/warDeploy");
  ...
  public void warDeployCall() throws Fault {
    ...
    try {
      String ret = port.sayHello("warDeploy");
      if (!ret.equals("'warDeploy' to you too!")) {
        TestUtil.logMsg(
            "test WarDeployCall failed: return value from server is: " + ret);
        throw new Fault("WarDeployCall failed");
      }
    } catch (Throwable t) {
      TestUtil

...
public class EchoHexBinary {
  protected byte[] inputHexBinary;

  public EchoHexBinary() {
  }

  public EchoHexBinary(byte[] inputHexBinary) {
    this.inputHexBinary = inputHexBinary;
  }

  public byte[] getInputHexBinary() {
    return inputHexBinary;
  }

  public void setInputHexBinary(byte[] inputHexBinary) {
    this.inputHexBinary = inputHexBinary;
  }
}

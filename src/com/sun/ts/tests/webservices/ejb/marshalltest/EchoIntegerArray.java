...
public class EchoIntegerArray {
  protected java.math.BigInteger[] aVal;

  public EchoIntegerArray() {
  }

  public EchoIntegerArray(java.math.BigInteger[] aVal) {
    this.aVal = aVal;
  }

  public java.math.BigInteger[] getAVal() {
    return aVal;
  }

  public void setAVal(java.math.BigInteger[] aVal) {
    this.aVal = aVal;
  }
}

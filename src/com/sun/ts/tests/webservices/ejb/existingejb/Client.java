...
package com.sun.ts.tests.webservices.ejb.existingejb;
...
public class Client extends EETest {
  ...
  private void getStub() throws Exception {
    TestUtil.logMsg("JNDI lookup for existingejb Service");
    InitialContext ctx = new InitialContext();
    Service svc = (javax.xml.rpc.Service) ctx
        .lookup("java:comp/env/service/existingejb");
   ...
   * @testName: call_hello
   *
   * @assertion_ids: WS4EE:SPEC:51; WS4EE:SPEC:145; WS4EE:SPEC:155;
   * WS4EE:SPEC:39; WS4EE:SPEC:109; WS4EE:SPEC:184; WS4EE:SPEC:43;
   * WS4EE:SPEC:37; WS4EE:SPEC:41; WS4EE:SPEC:42; WS4EE:SPEC:44; WS4EE:SPEC:148;
   * WS4EE:SPEC:149; WS4EE:SPEC:171;
   *
   * @test_Strategy: Call web service whose implementation is an existing EJB.
   */
   ...
   * @testName: call_bye
   *
   * @assertion_ids: WS4EE:SPEC:51; WS4EE:SPEC:145; WS4EE:SPEC:171;
   * WS4EE:SPEC:155; WS4EE:SPEC:39; WS4EE:SPEC:109; WS4EE:SPEC:184;
   * WS4EE:SPEC:43; WS4EE:SPEC:37; WS4EE:SPEC:41; WS4EE:SPEC:42; WS4EE:SPEC:44;
   *
   * @test_Strategy: Call web service whose implementation is an existing EJB.
   */

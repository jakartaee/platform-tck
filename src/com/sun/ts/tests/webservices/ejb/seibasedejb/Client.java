...
public class Client extends EETest {
  ...
  private void getStub() throws Exception {
    TestUtil.logMsg("JNDI lookup for seibasedejb Service");
    InitialContext ctx = new InitialContext();
    Service svc = (javax.xml.rpc.Service) ctx
        .lookup("java:comp/env/service/seibasedejb");
   ...
   * @testName: call_hello
   *
   * @assertion_ids: WS4EE:SPEC:51; WS4EE:SPEC:145; WS4EE:SPEC:43;
   * WS4EE:SPEC:39; WS4EE:SPEC:109; WS4EE:SPEC:184; WS4EE:SPEC:148;
   * WS4EE:SPEC:149;
   *
   * @test_Strategy: Call web service whose implementation is an EJB whose
   * remote interface implements the SEI directly.
   */

...
package com.sun.ts.tests.webservices.handlerEjb.localtx;
...
public class Client extends EETest {
  ...
  private void getStub() throws Exception {
    TestUtil.logMsg("JNDI lookup for LocalTxEjbHandler Service");
    InitialContext ctx = new InitialContext();
    Service svc = (javax.xml.rpc.Service) ctx
        .lookup("java:comp/env/service/LocalTxEjbHandler");

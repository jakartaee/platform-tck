...
public class Client extends BaseUrlClient {
  ...
  private String pageServletBase = "/securityapi_securitycontext_ejb_web";
  ...
  /*
   * @testName: testSecurityContextAvailableInEJB
   *
   * @assertion_ids: Security:JAVADOC:5; Security:JAVADOC:6; Security:JAVADOC:9;
   * Security:JAVADOC:20; Security:SPEC:4.2-1; Security:SPEC:4.4-1
   *
   * @test_Strategy: 1. Use the SecurityContext in EJB container to test 2. Send
   * request without authentication 3. The application will programmatically
   * trigger the authentication process 4. Ensure SecurityContext
   * getCallerPrincipal returns the correct name 5. Ensure SecurityContext
   * isCallerInRole returns the correct value
   *
   */
  public void testSecurityContextAvailableInEJB() throws Fault {
    ...
    TEST_PROPS.setProperty(TEST_NAME,
        "SecurityContext/EJB/testSecurityContextAvailableInEJB");

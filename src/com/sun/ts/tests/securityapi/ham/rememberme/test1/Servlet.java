...
public class Servlet extends HttpServlet {
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    String HAMValidateRequestCalled = (String) request
        .getAttribute("ham-validateRequest-called");
    boolean called = false;
    if (HAMValidateRequestCalled != null
        && HAMValidateRequestCalled.equalsIgnoreCase("true")) {
      called = true;
    }

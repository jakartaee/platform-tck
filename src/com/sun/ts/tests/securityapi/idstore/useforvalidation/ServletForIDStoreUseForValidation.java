...
@WebServlet("/ServletForIDStoreUseForValidation")
public class ServletForIDStoreUseForValidation extends HttpServlet {
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    System.out.println(
        "Inside ServletForIDStoreUseForValidation:doGet() ....." + "<BR>");

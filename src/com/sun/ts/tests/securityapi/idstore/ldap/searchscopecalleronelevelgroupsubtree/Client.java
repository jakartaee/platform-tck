...
package com.sun.ts.tests.securityapi.idstore.ldap.searchscopecalleronelevelgroupsubtree;
...
public class Client extends BaseIDStoreClient {
  ...
  private String pageServletBase = "/securityapi_idstore_ldap_searchscopecalleronelevelgroupsubtree_web";
  ...
  /*
   * @testName: testAnnotationLdapIDStore_searchScopeCallerOneLevelGroupSubTree
   *
   ...
   * 
   * if value of callerSearchScope is ONE_LEVEL && value of groupSearchScope is
   * SUB_TREE request with subtom/secret1, the response returns INVALID with
   * null group request with tom/secret1, the response returns group
   * [Administrator, Manager, SubAdministrator, SubManager]
   * 
   */
  public void testAnnotationLdapIDStore_searchScopeCallerOneLevelGroupSubTree()
      throws Fault {
    String testName = "idstore/ldap/testAnnotationLdapIDStore_searchScopeCallerOneLevelGroupSubTree";

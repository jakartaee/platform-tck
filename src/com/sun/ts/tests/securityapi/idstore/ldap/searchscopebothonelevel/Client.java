...
package com.sun.ts.tests.securityapi.idstore.ldap.searchscopebothonelevel;
...
public class Client extends BaseIDStoreClient {
  ...
  private String pageServletBase = "/securityapi_idstore_ldap_searchscopebothonelevel_web";
  ...
  /*
   * @testName: testAnnotationLdapIDStore_searchScopeBothOneLevel
   *
   ...
   * ONE_LEVEL request with subtom/secret1, the response returns INVALID with
   * null group request with tom/secret1, the response returns group
   * [Administrator, Manager]
   */
  public void testAnnotationLdapIDStore_searchScopeBothOneLevel() throws Fault {
    String testName = "idstore/ldap/testAnnotationLdapIDStore_searchScopeBothOneLevel";

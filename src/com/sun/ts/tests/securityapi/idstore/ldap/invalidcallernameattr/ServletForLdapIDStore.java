...
@LdapIdentityStoreDefinition(url = "ldap://localhost:11389/", callerBaseDn = "ou=caller,dc=securityapi,dc=net", callerNameAttribute = "invalid", groupNameAttribute = "cn", groupMemberAttribute = "member", priority = 100)

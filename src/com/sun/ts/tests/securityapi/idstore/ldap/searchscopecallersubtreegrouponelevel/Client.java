...
package com.sun.ts.tests.securityapi.idstore.ldap.searchscopecallersubtreegrouponelevel;
...
public class Client extends BaseIDStoreClient {
  ...
  private String pageServletBase = "/securityapi_idstore_ldap_searchscopecallersubtreegrouponelevel_web";
  ...
  /*
   * @testName: testAnnotationLdapIDStore_searchScopeCallerSubTreeGroupOneLevel
   *
   ...
   * ONE_LEVEL request with subtom/secret1, the response returns VALID with null
   * group request with tom/secret1, the response returns group [Administrator,
   * Manager]
   * 
   */
  public void testAnnotationLdapIDStore_searchScopeCallerSubTreeGroupOneLevel()
      throws Fault {
    String testName = "idstore/ldap/testAnnotationLdapIDStore_searchScopeCallerSubTreeGroupOneLevel";

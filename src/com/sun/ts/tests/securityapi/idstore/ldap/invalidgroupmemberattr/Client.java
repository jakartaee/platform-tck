...
public class Client extends BaseIDStoreClient {
  ...
  private String pageServletBase = "/securityapi_idstore_ldap_invalidgroupmemberattr_web";
  ...
  /*
   * @testName: testAnnotationLdapIDStore_invalidGroupMemberAttribute
   *
   * @assertion_ids: Security:JAVADOC:123
   *
   * @test_Strategy: LdapIdenttiyStore (priority=100) exists, but
   * groupMemberAttribute property is not correct Then validation is VALID but
   * no group returned
   * 
   */
  public void testAnnotationLdapIDStore_invalidGroupMemberAttribute()
      throws Fault {
    String testName = "idstore/ldap/testAnnotationLdapIDStore_invalidGroupMemberAttribute";

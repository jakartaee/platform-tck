...
package com.sun.ts.tests.securityapi.idstore.ldap.groupmemberofnotexist;
...
public class Client extends BaseIDStoreClient {
  ...
  private String pageServletBase = "/securityapi_idstore_ldap_groupmemberofnotexist_web";
  ...
  /*
   * @testName: testAnnotationLdapIDStore_groupMemberOfNotExist
   *
   * @assertion_ids: Security:JAVADOC:180
   *
   * @test_Strategy:
   * 
   * The groupMemberOfAttribute="notexisting" Then the groups returns will be
   * empty [] when request with valid user/pwd
   *
   */
  public void testAnnotationLdapIDStore_groupMemberOfNotExist() throws Fault {
    String testName = "idstore/ldap/testAnnotationLdapIDStore_groupMemberOfNotExist";
    String pageSecBase = pageServletBase + "/ServletForLdapIDStore";
    String username = "bobx";

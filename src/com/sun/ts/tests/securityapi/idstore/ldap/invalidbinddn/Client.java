...
public class Client extends BaseIDStoreClient {
  ...
  private String pageServletBase = "/securityapi_idstore_ldap_invalidbinddn_web";
  ...
  /*
   * @testName: testAnnotationLdapIDStore_invalidBinddn
   *
   * @assertion_ids: Security:JAVADOC:119;
   *
   * @test_Strategy: LdapIdenttiyStore (priority=100) exists, but bindDn
   * property is not correct Except receive a exception.
   * 
   */
  public void testAnnotationLdapIDStore_invalidBinddn() throws Fault {
    String testName = "idstore/ldap/testAnnotationLdapIDStore_invalidBinddn";

...
package com.sun.ts.tests.securityapi.idstore.ldap.invalidcallersearchfilter;
...
public class Client extends BaseIDStoreClient {
  ...
  private String pageServletBase = "/securityapi_idstore_ldap_invalidcallersearchfilter_web";
  ...
  /*
   * @testName: testAnnotationLdapIDStore_invalidCallerSearchFilter
   *
   * @assertion_ids: Security:JAVADOC:128
   *
   * **
   * 
   * @test_Strategy: LdapIdenttiyStore (priority=100) exists, but
   * callerSearchExpression property is not correct Then validation is INVALID
   *
   */
  public void testAnnotationLdapIDStore_invalidCallerSearchFilter()
      throws Fault {
    String testName = "idstore/ldap/testAnnotationLdapIDStore_invalidCallerSearchFilter";

...
package com.sun.ts.tests.securityapi.idstore.ldap.invalidcallernameattr;
...
public class Client extends BaseIDStoreClient {
  ...
  private String pageServletBase = "/securityapi_idstore_ldap_invalidcallernameattr_web";
  ...
  /*
   * @testName: testAnnotationLdapIDStore_invalidCallerNameAttribute
   *
   * @assertion_ids: Security:JAVADOC:121;
   *
   * @test_Strategy: LdapIdenttiyStore (priority=100) exists, but
   * callerNameAttribute property is not correct Then validation is INVALID
   * 
   */
  public void testAnnotationLdapIDStore_invalidCallerNameAttribute()
      throws Fault {
    String testName = "idstore/ldap/testAnnotationLdapIDStore_invalidCallerNameAttribute";

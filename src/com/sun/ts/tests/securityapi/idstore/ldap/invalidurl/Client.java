...
package com.sun.ts.tests.securityapi.idstore.ldap.invalidurl;
...
public class Client extends BaseIDStoreClient {
  ...
  private String pageServletBase = "/securityapi_idstore_ldap_invalidurl_web";
  ...
  /*
   * @testName: testAnnotationLdapIDStore_invalidURL
   *
   * @assertion_ids: Security:JAVADOC:129;
   *
   * @test_Strategy: LdapIdenttiyStore (priority=100) exists, but url property
   * is not correct Then validation is INVALID
   * 
   */
  public void testAnnotationLdapIDStore_invalidURL() throws Fault {
    String testName = "idstore/ldap/testAnnotationLdapIDStore_invalidURL";

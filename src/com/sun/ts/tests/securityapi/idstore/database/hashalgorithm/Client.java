...
public class Client extends BaseIDStoreClient {
  ...
  private String pageServletBase = "/securityapi_idstore_database_hashalgorithm_web";
  ...
  /*
   * @testName: testAnnotationDBIDStore_HashAlgorithmDefault
   *
   * @assertion_ids: Security:JAVADOC:189; Security:JAVADOC:190;
   * Security:JAVADOC:191
   * 
   * @test_Strategy:
   * 
   ...
   * 
   * 
   * In this test case, DatabaseIdentityStore use default hashAlgorithm and
   * without specifying hashAlgorithmParameters 1) request with
   * tom_hash256_saltsize32/secret1, return VALID with related groups 2) request
   * with tom_hash512_saltsize16/secret1, return VALID with related groups 3)
   * request with tom_hash512_saltsize32/secret1, return VALID with related
   * groups
   */
  public void testAnnotationDBIDStore_HashAlgorithmDefault() throws Fault {
    String testName = "idstore/database/testAnnotationDBIDStore_HashAlgorithmDefault";

...
public class Client extends BaseIDStoreClient {
  ...
  private String pageServletBase = "/securityapi_idstore_database_useforgroup_web";
  ...
  /*
   * @testName: testAnnotationDBIDStore_useforgroup
   *
   ...
   * @test_Strategy:
   *
   * Two IdentityStore exist: DBIdentityStore: (useFor getGroup only),
   ...
   * getgroup); priority=1000 use/pwd/group: tom/secret1/Administrator1,
   * Manager1 use/pwd/group: emma/secret12/Administrator1, Employee1
   * use/pwd/group: bob/secret13/Administrator1 IdentityStore2: (useFor getgroup
   * only); priority=200 use/pwd/group: tom/secret1/Administrator2, Manager2
   ...
   * IdentityStore1 & DBIdentityStore & IdentityStore2 Step2. request with valid
   * emma/secret12. return VALID with groups in IdentityStore1 & DBIdentityStore
   * & IdentityStore2
   * 
   * 
   */
  public void testAnnotationDBIDStore_useforgroup() throws Fault {
    String testName = "idstore/database/testIdentityStore_validationType_database";
    String pageSec = pageServletBase + "/ServletForDatabaseIDStore";
    String username = "tom";
    String password = "secret1";

    // Step1. request with valid tom/secret1. return VALID with groups in
    // IdentityStore1 & DBIdentityStore & IdentityStore2
    ...
    checkGroupsSet("ValidateResultGroups",
        "Administrator1, Manager1, Administrator, Manager, IDStore2:getCallerGroups, Administrator2, Manager2");
    dumpResponse();
    ...
    invoke();
    checkGroupsSet("ValidateResultGroups",
        "Administrator1, Employee1, Administrator, Employee, IDStore2:getCallerGroups, Administrator2, Employee2");
    dumpResponse();
  }

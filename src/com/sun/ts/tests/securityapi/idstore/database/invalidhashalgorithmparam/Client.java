...
public class Client extends BaseIDStoreClient {
  ...
  private String pageServletBase = "/securityapi_idstore_database_invalidhashalgorithmparam_web";
  ...
  /*
   * @testName: testAnnotationDBIDStore_InvalidHashAlgorithmParam
   *
   ...
   * with related groups
   */
  public void testAnnotationDBIDStore_InvalidHashAlgorithmParam() throws Fault {
    String testName = "idstore/database/testAnnotationDBIDStore_InvalidHashAlgorithmParam";

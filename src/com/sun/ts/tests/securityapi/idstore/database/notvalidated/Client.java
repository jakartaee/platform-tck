...
package com.sun.ts.tests.securityapi.idstore.database.notvalidated;
...
public class Client extends BaseIDStoreClient {
  ...
  private String pageServletBase = "/securityapi_idstore_database_notvalidated_web";
  ...
  /*
   * @testName: testAnnotationDBIDStore_notValidated
   *
   * @assertion_ids: Security:SPEC:3.2.1-4
   *
   * @test_Strategy:
   * 
   * NOT_VALIDATED returned if the credential is not supported by
   * LDAPIdentityStore annoatation
   * 
   */
  public void testAnnotationDBIDStore_notValidated() throws Fault {
    String testName = "idstore/database/testAnnotationDBIDStore_notValidated";

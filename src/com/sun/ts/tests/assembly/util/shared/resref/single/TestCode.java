...
public class TestCode {
    ...
    protected static final String queueLookup = prefix + "jms/myQueueConnectionFactory";

    protected static final String topicLookup = prefix + "jms/myTopicConnectionFactory";
    ...
    protected static String getRecipient() {
        ...
        try {
            ...
            if ("" == recipient || null == recipient) {
                TestUtil.logErr("[TestCode] 'mailuser1' property is " + ((null == recipient) ? "null" : "empty"));
                return null;
            }
    ...
    protected static void collect(String subject, String htmlContents, Message msg)

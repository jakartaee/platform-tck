...
public class TestCode {
    ...
    protected static final String statelessInternalName = prefix + "StatelessBean_SameJAR";

    protected static final String statelessExternalName = prefix + "StatelessBean_ExternalJAR";

    protected static final String statefulInternalName = prefix + "StatefulBean_SameJAR";

    protected static final String statefulExternalName = prefix + "StatefulBean_ExternalJAR";

    protected static final String BMPInternalName = prefix + "BMPBean_SameJAR";

    protected static final String BMPExternalName = prefix + "BMPBean_ExternalJAR";

    protected static final String CMP11InternalName = prefix + "CMP11Bean_SameJAR";

    protected static final String CMP11ExternalName = prefix + "CMP11Bean_ExternalJAR";

    protected static final String CMP20InternalName = prefix + "CMP20Bean_SameJAR";
    ...
    public static boolean testStatelessInternal(TSNamingContext nctx, Properties props) {
        ...
        try {
            home = (StatelessInternalHome) nctx.lookup(statelessInternalName, StatelessInternalHome.class);
            bean = home.create();
    ...
    public static boolean testStatelessExternal(TSNamingContext nctx, Properties props) {
        ...
        try {
            home = (StatelessExternalHome) nctx.lookup(statelessExternalName, StatelessExternalHome.class);
            bean = home.create();
            bean.initLogging(props);
    ...
    public static boolean testStatefulInternal(TSNamingContext nctx, Properties props) {

        StatefulInternalHome home = null;
        boolean pass;

        try {
            home = (StatefulInternalHome) nctx.lookup(statefulInternalName, StatefulInternalHome.class);
    ...
    public static boolean testStatefulExternal(TSNamingContext nctx, Properties props) {

        StatefulExternalHome home = null;
        boolean pass;

        try {
            home = (StatefulExternalHome) nctx.lookup(statefulExternalName, StatefulExternalHome.class);
    ...
    public static boolean testBMPInternal(TSNamingContext nctx, Properties props) {
        ...
        try {
            home = (BMPInternalHome) nctx.lookup(BMPInternalName, BMPInternalHome.class);
    ...
    public static boolean testBMPExternal(TSNamingContext nctx, Properties props) {
        ...
        try {
            home = (BMPExternalHome) nctx.lookup(BMPExternalName, BMPExternalHome.class);
            bean = home.create(props, safePK, "coffee-1", 1);
    ...
    public static boolean testCMP11Internal(TSNamingContext nctx, Properties props) {
        ...
        try {
            ...
            home = (CMP11InternalHome) nctx.lookup(CMP11InternalName, CMP11InternalHome.class);
    ...
    public static boolean testCMP11External(TSNamingContext nctx, Properties props) {
        ...
        try {
            ...
            home = (CMP11ExternalHome) nctx.lookup(CMP11ExternalName, CMP11ExternalHome.class);
    ...
    public static boolean testCMP20Internal(TSNamingContext nctx, Properties props) {
        ...
        try {
            ...
            home = (CMP20InternalHome) nctx.lookup(CMP20InternalName, CMP20InternalHome.class);
    ...
    public static boolean testCMP20External(TSNamingContext nctx, Properties props) {
        ...
        try {
            ...
            home = (CMP20ExternalHome) nctx.lookup(CMP20ExternalName, CMP20ExternalHome.class);

...
public class Client extends EETest {
     ...
     *
     * @test_Strategy: Package an ejb-jar file using a J2EE 1.2 DD (assembly_standalone_jar_compat12_13_component_ejb.jar).
     *
     * Package a .ear file (J2EE 1.3 DD's) containing an application client accessing a bean in the stand-alone ejb-jar

...
package com.sun.ts.tests.assembly.compat.standalone.jar.compat12_50;
...
public class Client extends EETest {
     ...
     *
     * @test_Strategy: Package an ejb-jar file using a J2EE 1.2 DD (assembly_standalone_jar_compat12_50_component_ejb.jar).
     *
     * Package a .ear file (JavaEE 5.0 DD's) containing an application client accessing a bean in the stand-alone ejb-jar
     * module (JNDI names match in runtime information).
     *

...
public class Client extends EETest {
   ...
   *                 ejb-jar file using a J2EE 1.4 DD - 1 ejb-jar file using a
   *                 JavaEE 5.0 DD - 1 application client jar file using a J2EE
   *                 1.4 DD - 1 application client jar file using a JavEE 5.0 DD
   *
   *                 Deploy the .ear file.
   *
   *                 Run the 1.4 client and check that it can call a bean in

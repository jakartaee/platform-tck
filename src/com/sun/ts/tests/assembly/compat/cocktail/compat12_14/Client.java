...
public class Client extends EETest {
     ...
     * @test_Strategy:
     *
     * Package an .ear file (J2EE 1.4 application DD) with: - 1 ejb-jar file using a J2EE 1.2 DD - 1 ejb-jar file using a
     * J2EE 1.4 DD - 1 application client jar file using a J2EE 1.2 DD - 1 application client jar file using a J2EE 1.4 DD
     *
     * Deploy the .ear file.
     *

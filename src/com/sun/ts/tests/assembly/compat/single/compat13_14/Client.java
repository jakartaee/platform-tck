...
package com.sun.ts.tests.assembly.compat.single.compat13_14;
...
public class Client extends EETest {
     ...
     *
     * @test_Strategy: Package an application with an application client and an EJB jar file. Use J2EE 1.3 DD for the 2
     * modules, and a J2EE 1.2 DD for the application DD.
     *

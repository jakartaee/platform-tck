...
public class Client extends PMClientBase {
  ...
  public void getJtaDataSource() throws Fault {
    ...
    boolean pass1 = false;
    String expected[] = { LOGMESSAGE_PREFIX
        + "Called PersistenceUnitInfoImpl.getJtaDataSource()" };
    getClassObjects();
  ...
  public void getClassObjects() {
    emImpl = getEntityManager(false).unwrap(
        com.sun.ts.tests.jpa.common.pluggability.altprovider.implementation.EntityManagerImpl.class);

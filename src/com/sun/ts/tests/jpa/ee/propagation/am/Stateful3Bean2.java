    ...
    public boolean test5() {
        ...
        try {
            ...
            if (!entityManager.contains(mRef2[0])) {
                TestUtil.logTrace("PU " + EMF_LOOKUP_NAME + " does not contain Member2:" + mRef2[0].getMemberId()
                        + " as expected");
                pass3 = true;
            } else {
                TestUtil.logErr(
            ...
            if (!entityManager2.contains(mRef[0])) {
                TestUtil.logTrace("PU " + EMF_LOOKUP_NAME2 + " does not contain Member:" + mRef[0].getMemberId()
                        + " as expected");
                pass4 = true;
            } else {
                TestUtil.logErr("PU " + EMF_LOOKUP_NAME2 + " does incorrectly contain Member:" + mRef[0].getMemberId());
            }

...
public class Client extends PMClientBase {
    ...
    public void setup(String[] args, Properties p) throws Fault {
        ...
        try {
            ...
            throw new Fault(" ! JPA 2.2 Java 8 date and time types test setup failed", e);
        }
        verifySchema();
    }
    ...
    public void dateTimeTest() throws Fault {
        ...
        boolean localDateRangeResult = queryEntitiesRange(
                ...
                "min",
                LOCAL_DATE.minus(10, ChronoUnit.DAYS),
                "max",
                LOCAL_DATE.plus(10, ChronoUnit.DAYS),
                entities[0]);
        boolean localTimeRangeResult = queryEntitiesRange(
                "DateTimeEntity.findLocalTimeRange",
                "min",
                LOCAL_TIME.minus(10, ChronoUnit.MINUTES),
                "max",
                LOCAL_TIME.plus(10, ChronoUnit.MINUTES),
                entities[1]);
        boolean localDateTimeRangeResult = queryEntitiesRange(
                "DateTimeEntity.findLocalDateTimeRange",
                "min",
                LOCAL_DATE_TIME.minus(10, ChronoUnit.DAYS),
                "max",
                LOCAL_DATE_TIME.plus(10, ChronoUnit.DAYS),
                entities[2]);
        boolean offsetTimeRangeResult = queryEntitiesRange(
                "DateTimeEntity.findOffsetTimeRange",
                "min",
                OFFSET_TIME.minus(10, ChronoUnit.MINUTES),
                "max",
                OFFSET_TIME.plus(10, ChronoUnit.MINUTES),
                entities[3]);
        boolean offsetDateTimeRangeResult = queryEntitiesRange(
                "DateTimeEntity.findOffsetDateTimeRange",
                "min",
                OFFSET_DATE_TIME.minus(10, ChronoUnit.DAYS).minus(10, ChronoUnit.MINUTES),
                "max",
        ...
        if (!(createResult
            ...
            throw new Fault("dateTimeTest (JPA 2.2 Java 8 date and time types test) failed");
        }
    }

...
public class Client extends PMClientBase {
     ...
     * @test_Strategy:
     */
    public void createEntityManagerSynchronizationTypeMapIllegalStateExceptionTest() throws Fault {
        boolean pass1 = false;
        boolean pass2 = false;
        ...
        if (!pass1 || !pass2) {
            throw new Fault("createEntityManagerSynchronizationTypeMapIllegalStateExceptionTest failed");
        }
    }
    ...
    public void createEntityManagerSynchronizationTypeIllegalStateExceptionTest() throws Fault {
        boolean pass1 = false;
        boolean pass2 = false;
        Properties p = getPersistenceUnitProperties();
        TestUtil.logMsg("Testing for resource-local entity managers");
        ...
        if (!pass1 || !pass2) {
            throw new Fault("createEntityManagerSynchronizationTypeIllegalStateExceptionTest failed");
        }
    }
    ...
    private void removeTestData() {
        ...
        if (getEntityManager().isOpen()) {
            ...
            try {
                ...
                getEntityManager()
                        .createNativeQuery("DELETE FROM AEJB_1X1_BI_BTOB")
                        .executeUpdate();
                getEntityManager()
                        .createNativeQuery("DELETE FROM BEJB_1X1_BI_BTOB")
                        .executeUpdate();

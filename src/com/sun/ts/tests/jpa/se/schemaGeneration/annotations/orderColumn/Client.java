...
public class Client extends PMClientBase {
    ...
    public void orderColumnTest() throws Fault {
        ...
        pass1c = findDataInFile(
                f1,
                "ALTER TABLE SCHEMAGENEMP ADD CONSTRAINT MYCONSTRANT FOREIGN KEY (FK_DEPT) REFERENCES SCHEMAGENDEPT (DEPTID)");

        /*
         * CREATE TABLE SCHEMAGENDEPT (DEPTID INTEGER NOT NULL, PRIMARY KEY (DEPTID)) CREATE TABLE SCHEMAGENEMP (EMPID INTEGER
         * NOT NULL, FK_DEPT INTEGER, THEORDERCOLUMN INTEGER, PRIMARY KEY (EMPID)) ALTER TABLE SCHEMAGENEMP ADD CONSTRAINT
         * MYCONSTRANT FOREIGN KEY (FK_DEPT) REFERENCES SCHEMAGENDEPT (DEPTID)
         */

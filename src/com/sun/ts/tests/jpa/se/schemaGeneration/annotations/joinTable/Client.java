...
public class Client extends PMClientBase {
    ...
    public void joinTableTest() throws Fault {
        ...
        /*
         * CREATE TABLE SCHEMAGENCOURSE (COURSEID INTEGER NOT NULL, COURSENAME VARCHAR(255), PRIMARY KEY (COURSEID)) CREATE
         * TABLE SCHEMAGENSTUDENT (STUDENTID INTEGER NOT NULL, STUDENTNAME VARCHAR(255), PRIMARY KEY (STUDENTID)) CREATE TABLE
         * COURSE_STUDENT (COURSE_ID INTEGER NOT NULL, STUDENT_ID INTEGER NOT NULL, PRIMARY KEY (COURSE_ID, STUDENT_ID)) ALTER
         * TABLE COURSE_STUDENT ADD CONSTRAINT STUDENTIDCONSTRAINT FOREIGN KEY (STUDENT_ID) REFERENCES SCHEMAGENSTUDENT
         * (STUDENTID) ALTER TABLE COURSE_STUDENT ADD CONSTRAINT COURSEIDCONSTRAINT FOREIGN KEY (COURSE_ID) REFERENCES

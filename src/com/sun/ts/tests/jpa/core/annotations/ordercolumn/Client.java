...
public class Client extends PMClientBase {
     ...
     * PERSISTENCE:SPEC:1204; PERSISTENCE:JAVADOC:378; PERSISTENCE:JAVADOC:379; PERSISTENCE:JAVADOC:377;
     * PERSISTENCE:JAVADOC:380;
     *
            ...
            if (numStudents == expectedListSize) {
                ...
                if (students.get(0).equals(expectedResults.get(0))
                    ...
                    Query q = getEntityManager()
                            .createQuery("SELECT s.studentName "
     ...
     *
     * @assertion_ids: PERSISTENCE:SPEC:2097; PERSISTENCE:SPEC:2104; PERSISTENCE:SPEC:2102;
     *
     ...
     *
     * @assertion_ids: PERSISTENCE:SPEC:2097; PERSISTENCE:SPEC:2104; PERSISTENCE:SPEC:2102; PERSISTENCE:SPEC:2101;
     *
     * @test_Strategy: name is specified while using property access.
     */
    @SetupMethod(name = "setupEmployee")
    ...
    public void fieldAccessWithNameTest() throws Fault {
        ...
        try {
            ...
            TypedQuery<Employee2> q = getEntityManager()
                    .createQuery(

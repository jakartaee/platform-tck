...
public class Client extends PMClientBase {
     ...
     * PERSISTENCE:SPEC:1204; PERSISTENCE:JAVADOC:364; PERSISTENCE:JAVADOC:365; PERSISTENCE:JAVADOC:368;
     * PERSISTENCE:JAVADOC:369;
     *
     * @test_Strategy: With basic entity requirements, persist/remove an entity.
     */
    public void mapKeyJoinColumn() throws Fault {
        boolean pass = false;

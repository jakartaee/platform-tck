...
public class Client extends PMClientBase {
    ...
    public void DoubleOperandResultTypeTests() throws Fault {
        ...
        try {
            ...
            p = getEntityManager()
                    .createQuery("Select (a.basicBigDouble + 1) From A a where (a.basicBigDouble = ?1)")
                    .setParameter(1, whereValue)
                    .getSingleResult();
    ...
    public void FloatOperandResultTypeTests() throws Fault {
        ...
        try {
            ...
            getEntityTransaction().begin();
            p = getEntityManager()
                    .createQuery("Select (a.basicBigFloat + 1) From A a where (a.id = '9')")
                    .getSingleResult();
    ...
    public void BigDecimalOperandResultTypeTests() throws Fault {
        ...
        try {
            ...
            getEntityTransaction().begin();
            p = getEntityManager()
                    .createQuery("Select (a.basicBigDecimal + 1) From A a where (a.id = '9')")
                    .getSingleResult();
    ...
    public void BigIntegerOperandResultTypeTests() throws Fault {
        ...
        try {
            ...
            getEntityTransaction().begin();
            p = getEntityManager()
                    .createQuery("Select (a.basicBigInteger + 1) From A a where (a.id = '9')")
                    .getSingleResult();
    ...
    public void LongOperandResultTypeTests() throws Fault {
        ...
        try {
            ...
            getEntityTransaction().begin();
            p = getEntityManager()
                    .createQuery("Select (a.basicBigLong + 1) From A a where (a.id = '9')")
                    .getSingleResult();
    ...
    public void ShortOperandResultTypeTests() throws Fault {
        ...
        try {
            ...
            getEntityTransaction().begin();
            p = getEntityManager()
                    .createQuery("Select (a.basicBigShort + 1) From A a where (a.id = '9')")
                    .getSingleResult();

...
public class Client extends PMClientBase {
    ...
    /**
     * @testName: DIDTest
     * @assertion_ids: PERSISTENCE:SPEC:1182; PERSISTENCE:SPEC:1183; PERSISTENCE:SPEC:1184; PERSISTENCE:SPEC:1185;
    ...
    public void DIDTest() throws Fault {
        ...
        try {
            ...
            final List depList = getEntityManager()
                    .createQuery("Select m from DID5MedicalHistory m where m.patient.firstName='Java'")
                    .getResultList();
            newMHistory = null;
            if (depList.size() > 0) {
    ...
    private void removeTestData() {
        ...
        try {
            getEntityTransaction().begin();
            getEntityManager()
                    .createNativeQuery("DELETE FROM DID5MEDICALHISTORY")
                    .executeUpdate();

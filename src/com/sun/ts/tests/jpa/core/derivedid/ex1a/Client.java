...
public class Client extends PMClientBase {
     ...
     * @testName: DIDTest
     *
     * @assertion_ids: PERSISTENCE:SPEC:1183; PERSISTENCE:SPEC:1184;PERSISTENCE:SPEC:1185;
     *
     * @test_Strategy: Derived Identifier The parent entity ( DID1Employee ) has a simple primary key Case (a): The
     * dependent entity (DID1Dependent ) uses IdClass to represent a composite key:
     */

...
public class Client extends PMClientBase {
    ...
    public void setFirstResultTest() throws Fault {
        ...
        try {
            ...
            Query query = getEntityManager()
                    .createQuery("select d.id, e.id from Department d join d.employees e where d.id <= 5 "
                            + " order by d.id, e.id");
            ...
            if (gfr != 13) {
                TestUtil.logErr("getFirstResult() - Expecting result=11, actual=" + gfr);
            } else {
                pass2 = true;
            }
            ...
            if (q.size() == 8) {
                ...
                TestUtil.logErr("Did not get expected results.  Expected: 10, " + "got: " + q.size());
    ...
    public void getParameterIntIllegalArgumentExceptionTest() throws Fault {
        ...
        boolean pass2 = false;
        try {
            TestUtil.logTrace("Creating query for getParameterIntIllegalArgumentExceptionTest");
            TestUtil.logMsg("Testing Query version");
            Query query = getEntityManager()
                    .createQuery("select e from Employee e where e.firstName = ?1")
                    .setParameter(1, "foo");
    ...
    public void setParameterParameterCalendarTemporalTypeIllegalArgumentExceptionTest() throws Fault {
        ...
        if (!pass1 || !pass2 || !pass3 || !pass4) {
            throw new Fault("setParameterParameterCalendarTemporalTypeIllegalArgumentExceptionTest failed");
        }
    }
    ...
    public void getParameterValueStringIllegalArgumentExceptionTest() throws Fault {
        ...
        if (!pass1 || !pass2) {
            throw new Fault("getParameterValueStringIllegalArgumentExceptionTest failed");
        }
    }
    ...
    public void getParameterValueStringIllegalStateExceptionTest() throws Fault {
        ...
        if (!pass1 || !pass2) {
            throw new Fault("getParameterValueStringIllegalStateExceptionTest failed");
        }
    }
    ...
    public void setParameterStringObject1IllegalArgumentExceptionTest() throws Fault {
        ...
        if (!pass1 || !pass2) {
            throw new Fault("setParameterStringObject1IllegalArgumentExceptionTest failed");
        }
    }
    ...
    public void setParameterStringObject2IllegalArgumentExceptionTest() throws Fault {
        ...
        if (!pass1 || !pass2) {
            throw new Fault("setParameterStringObject2IllegalArgumentExceptionTest failed");
        }
    }
    ...
    public void setParameterStringDateTemporalTypeIllegalArgumentExceptionTest() throws Fault {
        ...
        if (!pass1 || !pass2) {
            throw new Fault("setParameterStringDateTemporalTypeIllegalArgumentExceptionTest failed");
        }
    }
    ...
    public void setParameterStringCalendarTemporalTypeTest() throws Fault {
        ...
        try {
            ...
            TypedQuery<Employee> tquery = getEntityManager()
                    .createQuery("select e from Employee e where e.hireDate = :hDate", Employee.class);
            Collection<Employee> q = tquery.setParameter("hDate", getCalDate(), TemporalType.DATE)
                    .getResultList();
    ...
    public void setParameterStringCalendarTemporalTypeTestIllegalArgumentExceptionTest() throws Fault {
        ...
        try {
            getEntityManager()
                    .createQuery("select d from Department d where :param > 1", Department.class)
                    .setParameter("badName", c, TemporalType.TIMESTAMP);
            TestUtil.logErr("IllegalArgumentException not thrown");
        } catch (IllegalArgumentException iae) {
            TestUtil.logTrace("IllegalArgumentException Caught as Expected");
        ...
        if (!pass1 || !pass2) {
            throw new Fault("setParameterStringCalendarTemporalTypeTestIllegalArgumentExceptionTest failed");
        }
    }
    ...
    public void setParameterIntDateTemporalTypeTest() throws Fault {
        ...
        try {
            ...
            Collection<Employee> q = getEntityManager()
                    ...
                    .setParameter(1, d1, TemporalType.DATE)
                    .getResultList();
    ...
    public void setParameterIntDateTemporalTypeIllegalArgumentException1Test() throws Fault {
        ...
        try {
            getEntityManager()
                    .createQuery("select d from Department d where :hDate > 1", Department.class)
                    .setParameter(5, d1, TemporalType.DATE);
            TestUtil.logErr("IllegalArgumentException not thrown");
        } catch (IllegalArgumentException iae) {
            TestUtil.logTrace("IllegalArgumentException Caught as Expected");
        ...
        if (!pass1 || !pass2) {
            throw new Fault("setParameterIntDateTemporalTypeIllegalArgumentException1Test failed");
        }
    }
    ...
    public void setParameterIntCalendarTemporalTypeTest() throws Fault {
        ...
        try {
            ...
            Collection<Employee> q = getEntityManager()
                    .createQuery("select e from Employee e where e.hireDate = ?1")
                    .setParameter(1, getCalDate(), TemporalType.DATE)
                    .getResultList();
    ...
    public void setParameterIntCalendarTemporalTypeIllegalArgumentExceptionTest() throws Fault {
        ...
        try {
            getEntityManager()
                    .createQuery("select d from Department d where ?1 > 1")
        ...
        try {
            getEntityManager()
                    .createQuery("select d from Department d where ?1 > 1", Department.class)
                    .setParameter(5, c, TemporalType.TIMESTAMP);
            TestUtil.logErr("IllegalArgumentException not thrown");
        } catch (IllegalArgumentException iae) {
            TestUtil.logTrace("IllegalArgumentException Caught as Expected");
    ...
    public void getSingleResultNoResultExceptionTest() throws Fault {
        ...
        try {
            getEntityTransaction().begin();
            getEntityManager()
                    .createQuery("select d.name from Department d where d.id = 99", String.class)
                    .getSingleResult();
            TestUtil.logErr("NoResultException was not thrown");
            getEntityTransaction().commit();
        } catch (NoResultException nre) {
    ...
    public void getSingleResultNonUniqueResultExceptionTest() throws Fault {
        ...
        try {
            getEntityTransaction().begin();
            getEntityManager()
                    .createQuery("select d.name from Department d where d.id > 1", String.class)
                    .getSingleResult();
            TestUtil.logErr("NoResultException was not thrown");
            getEntityTransaction().commit();
        } catch (NonUniqueResultException nure) {
    ...
    public void isBoundTest() throws Fault {
        ...
        try {
            ...
            if (p != null) {
                if (!query.isBound(p)) {
                    TestUtil.logErr("isbound returned false even though a value is bound to the parameter "
    ...
    public void setGetMaxResultsTest() throws Fault {
        ...
        try {
            ...
            if (gmr != Integer.MAX_VALUE) {
                TestUtil.logErr("getMaxResults() called when setMaxResults() not called - Expected:" + Integer.MAX_VALUE
                        + ", actual:" + gmr);
                pass1 = false;
            } else {
                ...
                if (gmr != 15) {
                    ...
                    if (!checkEntityPK(q, expected)) {
                        TestUtil.logErr("Did not get expected results. Expected " + expected.length
    ...
    public void executeUpdateTransactionRequiredExceptionTest() throws Fault {
        ...
        try {
            getEntityManager()
                    .createQuery("update Department d  set d.name = NULLIF(d.name, 'Engineering')")
                    .executeUpdate();
            TestUtil.logErr("TransactionRequiredException was not thrown");
        } catch (TransactionRequiredException ise) {
    ...
    public void queryAPITest21() throws Fault {
        ...
        try {
            ...
            getEntityManager()
                    .createQuery("SELECT d FROM Department d WHERE d.name = 'Research and Development'")
            ...
            if (newDepartment.getName().equals("Research and Development")) {
                ...
                TestUtil.logErr("Expected result:Research and Development, actual:" + newDepartment.getName());
            }
        ...
        try {
            ...
            if (dept != null) {
                if (dept.getId() == 1) {
                    ...
                    TestUtil.logErr("Received incorrect Department, expected id=1 and name=IT, actual id="
    ...
    public void queryAPITest23() throws Fault {
        ...
        try {
            ...
            if (emp == null) {
                ...
                TestUtil.logErr("Expected null Employee, instead got:" + emp.toString());
            }
            ...
            if (result_size == 2) {
                ...
                for (Date d : result) {
                    ...
                    if (d.equals(expectedHireDate)) {
                        ...
                        TestUtil.logErr("Received unexpected Employee HireDate = " + d.toString());
                        pass2 = false;
                    }
                }
    ...
    public void queryAPITest28() throws Fault {
        ...
        try {
            ...
            result = getEntityManager()
                    .createQuery("select d.timeData from DataTypes2 d where d.timeData = :time")
                    .setParameter("time", timeValue)
                    .getResultList();
    ...
    private static void logErrorEmp(Collection c) {
        for (Object o : c) {
            Employee e = (Employee) o;
            TestUtil.logErr("id=" + e.getId() + ", " + "first=" + e.getFirstName() + ", last=" + e.getLastName()
    ...
    private static void logTraceEmp(Collection c) {
        for (Object o : c) {
            Employee e = (Employee) o;
            TestUtil.logTrace("id=" + e.getId() + ", " + "first=" + e.getFirstName() + ", last=" + e.getLastName()
                    + ", hireDate=" + e.getHireDate());
        }
    }

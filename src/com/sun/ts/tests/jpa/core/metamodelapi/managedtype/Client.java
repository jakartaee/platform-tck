...
public class Client extends PMClientBase {
                    ...
                    if (attribSet != null) {
                        ...
                        for (Attribute attrib : attribSet) {
                            ...
                            if (expected.contains(attrib.getName())) {
                                ...
                                TestUtil.logErr("Received unexpected result" + attrib.getName());
                                pass = false;
                            }
                        }
                    } else {
    ...
    public void getSingularAttributeStringClassTest() throws Fault {
        ...
        try {
            ...
            if (metaModel != null) {
                ...
                if (mTypeB != null) {
                    TestUtil.logTrace("Obtained Non-null ManagedType");
                    SingularAttribute<? super B, Address> singAttrib = mTypeB.getSingularAttribute(
                            "address", com.sun.ts.tests.jpa.core.metamodelapi.managedtype.Address.class);
                    Class addrClass = singAttrib.getType().getJavaType();
                    if (addrClass.getName().equals("com.sun.ts.tests.jpa.core.metamodelapi.managedtype.Address")) {
                        TestUtil.logTrace("address class getName =" + addrClass.getName());
                        pass = true;
                    } else {
                        TestUtil.logErr("Expected: com.sun.ts.tests.jpa.core.metamodelapi.managedtype.Address, actual:"
                                + addrClass.getName());
                    }
                } else {
                    TestUtil.logErr("managedType() returned null");
     ...
     *
     */
    public void getSingularAttributeStringClassIllegalArgumentExceptionTest() throws Fault {
        boolean pass = true;
        ...
        try {
            ...
            if (metaModel != null) {
                ...
                if (mTypeB != null) {
                    ...
                    try {
                        mTypeB.getSingularAttribute(
                                "doesnotexist", com.sun.ts.tests.jpa.core.metamodelapi.managedtype.Address.class);
                        pass = false;
                    ...
                    try {
                        mTypeB.getSingularAttribute(
                                "addreess", com.sun.ts.tests.jpa.core.metamodelapi.managedtype.ZipCode.class);
                        pass = false;
                        TestUtil.logTrace("Did not receive IllegalArgumentException");
                    } catch (IllegalArgumentException iae) {
                        TestUtil.logTrace("Received expected IllegalArgumentException");
        ...
        if (!pass) {
            throw new Fault("getSingularAttributeStringClassIllegalArgumentExceptionTest failed");
        }
    }
        ...
        try {
            ...
            if (metaModel != null) {
                ...
                if (mTypeB != null) {
                    ...
                    TestUtil.logTrace("singAttrib Java Type = " + singAttrib.getJavaType());
                    if (singAttrib
                            .getJavaType()
                            .getName()
                            .equals("com.sun.ts.tests.jpa.core.metamodelapi.managedtype.Address")) {
                        pass = true;
                    } else {
    ...
    public void getSingularAttributeStringIllegalArgumentExceptionTest() throws Fault {
        boolean pass = false;
        ...
        if (!pass) {
            throw new Fault("getSingularAttributeStringIllegalArgumentExceptionTest failed");
        }
    }
     ...
     *
     */
    public void getDeclaredSingularAttributeStringClassIllegalArgumentExceptionTest() throws Fault {
        boolean pass = true;
        ...
        try {
            ...
            if (metaModel != null) {
                ...
                if (mTypeB != null) {
                    TestUtil.logMsg("Testing invalid name");
                    try {
                        mTypeB.getDeclaredSingularAttribute(
                                "doesnotexist", com.sun.ts.tests.jpa.core.metamodelapi.managedtype.Address.class);
                        pass = false;
                        TestUtil.logTrace("Did not receive IllegalArgumentException");
                    } catch (IllegalArgumentException iae) {
                    ...
                    try {
                        mTypeB.getDeclaredSingularAttribute(
                                "address", com.sun.ts.tests.jpa.core.metamodelapi.managedtype.ZipCode.class);
                        pass = false;
                        TestUtil.logTrace("Did not receive IllegalArgumentException");
                    } catch (IllegalArgumentException iae) {
                        TestUtil.logTrace("Received expected IllegalArgumentException");
        ...
        if (!pass) {
            throw new Fault("getDeclaredSingularAttributeStringClassIllegalArgumentExceptionTest failed");
        }
    }
     ...
     *
     */
    public void getDeclaredSingularAttributeStringIllegalArgumentExceptionTest() throws Fault {
        boolean pass = false;
        ...
        if (!pass) {
            throw new Fault("getDeclaredSingularAttributeStringIllegalArgumentExceptionTest failed");
        }
    }
            ...
            if (metaModel != null) {
                ...
                if (mType != null) {
                    ...
                    if (t != null) {
                        ...
                        if (t.getJavaType()
                                .getName()
                                .equals("com.sun.ts.tests.jpa.core.metamodelapi.managedtype.Uni1XMProject")) {
                            TestUtil.logTrace(
    ...
    public void getCollectionStringClassTest() throws Fault {
        ...
        try {
            ...
            if (metaModel != null) {
                ...
                if (mType != null) {
                    TestUtil.logTrace("Obtained Non-null ManagedType");
                    CollectionAttribute<? super Uni1XMPerson, Uni1XMProject> colAttrib = mType.getCollection(
                            "projects", com.sun.ts.tests.jpa.core.metamodelapi.managedtype.Uni1XMProject.class);
                    Type t = colAttrib.getElementType();
                    if (t != null) {
                        if (t.getJavaType()
                                .getName()
     ...
     *
     */
    public void getCollectionStringClassIllegalArgumentExceptionTest() throws Fault {
        boolean pass = true;
        ...
        try {
            ...
            if (metaModel != null) {
                ...
                if (mType != null) {
                    ...
                    try {
                        mType.getCollection(
                                "doesnotexist", com.sun.ts.tests.jpa.core.metamodelapi.managedtype.Uni1XMProject.class);
                        pass = false;
                        TestUtil.logTrace("Did not receive IllegalArgumentException");
                    } catch (IllegalArgumentException iae) {
                        TestUtil.logTrace("Received expected IllegalArgumentException");
                    ...
                    try {
                        mType.getCollection(
                                "projects", com.sun.ts.tests.jpa.core.metamodelapi.managedtype.ZipCode.class);
                        pass = false;
                        TestUtil.logTrace("Did not receive IllegalArgumentException");
                    } catch (IllegalArgumentException iae) {
                        TestUtil.logTrace("Received expected IllegalArgumentException");
        ...
        if (!pass) {
            throw new Fault("getCollectionStringClassIllegalArgumentExceptionTest failed");
        }
    }
        ...
        try {
            ...
            if (metaModel != null) {
                ...
                if (mType != null) {
                    TestUtil.logMsg("Testing invalid name");
                    try {
                        mType.getSet("doesnotexist", com.sun.ts.tests.jpa.core.metamodelapi.managedtype.Address.class);
                        pass = false;
                        TestUtil.logTrace("Did not receive IllegalArgumentException");
                    } catch (IllegalArgumentException iae) {
                        TestUtil.logTrace("Received expected IllegalArgumentException");
    ...
    public void getListStringClassTest() throws Fault {
        ...
        try {
            ...
            if (metaModel != null) {
                ...
                if (mType != null) {
                    TestUtil.logTrace("Obtained Non-null ManagedType");
                    ListAttribute<? super BiDirMX1Project, BiDirMX1Person> listAttrib = mType.getList(
                            "biDirMX1Persons", com.sun.ts.tests.jpa.core.metamodelapi.managedtype.BiDirMX1Person.class);
                    Type t = listAttrib.getElementType();
                    if (t != null) {
                        TestUtil.logTrace("element Type  = " + t.getJavaType());
                        if (t.getJavaType()
                                .getName()
                                .equals("com.sun.ts.tests.jpa.core.metamodelapi.managedtype.BiDirMX1Person")) {
                            pass = true;
                        } else {
                            TestUtil.logErr(
        ...
        try {
            ...
            if (metaModel != null) {
                ...
                if (mType != null) {
                    ...
                    try {
                        mType.getCollection(
                                "biDirMX1Persons", com.sun.ts.tests.jpa.core.metamodelapi.managedtype.ZipCode.class);
                        pass = false;
                        TestUtil.logTrace("Did not receive IllegalArgumentException");
                    } catch (IllegalArgumentException iae) {
                        TestUtil.logTrace("Received expected IllegalArgumentException");
            ...
            if (metaModel != null) {
                ...
                if (mType != null) {
                    ...
                    if (t != null) {
                        ...
                        if (t.getJavaType()
                                .getName()
                                .equals("com.sun.ts.tests.jpa.core.metamodelapi.managedtype.Employee")) {
                            pass = true;
                        } else {
                            TestUtil.logErr(
    ...
    public void getDeclaredCollectionStringClassTest() throws Fault {
        ...
        try {
            ...
            if (metaModel != null) {
                ...
                if (mType != null) {
                    TestUtil.logTrace("Obtained Non-null ManagedType");
                    CollectionAttribute<Uni1XMPerson, Uni1XMProject> colAttrib = mType.getDeclaredCollection(
                            "projects", com.sun.ts.tests.jpa.core.metamodelapi.managedtype.Uni1XMProject.class);
                    Type t = colAttrib.getElementType();
                    if (t != null) {
                        String type = t.getJavaType().getName();
                        TestUtil.logTrace("element Type  = " + type);
                        if (type.equals("com.sun.ts.tests.jpa.core.metamodelapi.managedtype.Uni1XMProject")) {
                            pass = true;
                        } else {
                            TestUtil.logErr(
                                    "Expected: com.sun.ts.tests.jpa.core.metamodelapi.managedtype.Uni1XMProject, actual:"
     ...
     *
     */
    public void getDeclaredCollectionStringClassIllegalArgumentExceptionTest() throws Fault {
        boolean pass = true;
        ...
        if (!pass) {
            throw new Fault("getDeclaredCollectionStringClassIllegalArgumentExceptionTest failed");
        }
    }
     ...
     *
     */
    public void getDeclaredCollectionStringIllegalArgumentExceptionTest() throws Fault {
        boolean pass = false;
        ...
        if (!pass) {
            throw new Fault("getDeclaredCollectionStringIllegalArgumentExceptionTest failed");
        }
    }
    ...
    public void getDeclaredSetStringClassTest() throws Fault {
        ...
        try {
            ...
            if (metaModel != null) {
                ...
                if (mType != null) {
                    TestUtil.logTrace("Obtained Non-null ManagedType");
                    SetAttribute<A, Address> setAttrib = mType.getDeclaredSet(
                            "address", com.sun.ts.tests.jpa.core.metamodelapi.managedtype.Address.class);
                    Type t = setAttrib.getElementType();
                    if (t != null) {
                        TestUtil.logTrace("element Type  = " + t.getJavaType());
     ...
     *
     */
    public void getDeclaredSetStringClassIllegalArgumentExceptionTest() throws Fault {
        boolean pass = true;
        ...
        if (!pass) {
            throw new Fault("getDeclaredSetStringClassIllegalArgumentExceptionTest failed");
        }
    }
    ...
    public void getDeclaredSetStringIllegalArgumentExceptionTest() throws Fault {
        ...
        if (!pass) {
            throw new Fault("getDeclaredSetStringIllegalArgumentExceptionTest failed");
        }
    }
    ...
    public void getDeclaredListStringClassTest() throws Fault {
        ...
        try {
            ...
            if (metaModel != null) {
                ...
                if (mType != null) {
                    TestUtil.logTrace("Obtained Non-null ManagedType");
                    ListAttribute<BiDirMX1Project, BiDirMX1Person> listAttrib = mType.getDeclaredList(
                            "biDirMX1Persons", com.sun.ts.tests.jpa.core.metamodelapi.managedtype.BiDirMX1Person.class);
                    Type t = listAttrib.getElementType();
                    if (t != null) {
                        TestUtil.logTrace("element Type  = " + t.getJavaType());
     ...
     *
     */
    public void getDeclaredListStringClassIllegalArgumentExceptionTest() throws Fault {
        boolean pass = true;
        ...
        if (!pass) {
            throw new Fault("getDeclaredListStringClassIllegalArgumentExceptionTest failed");
        }
    }
    ...
    public void getDeclaredListStringIllegalArgumentExceptionTest() throws Fault {
        ...
        if (!pass) {
            throw new Fault("getDeclaredListStringIllegalArgumentExceptionTest failed");
        }
    }
     ...
     *
     */
    public void getDeclaredMapStringClassClassIllegalArgumentExceptionTest() throws Fault {
        boolean pass = true;
        ...
        if (!pass) {
            throw new Fault("getDeclaredMapStringClassClassIllegalArgumentExceptionTest failed");
        }
    }
    ...
    public void getDeclaredMapStringIllegalArgumentExceptionTest() throws Fault {
        ...
        if (!pass) {
            throw new Fault("getDeclaredMapStringIllegalArgumentExceptionTest failed");
        }
    }
                ...
                if (mType != null) {
                    ...
                    if (pluralAttribSet != null) {
                        if (pluralAttribSet.size() != 1) {
                            pass = false;
                            TestUtil.logErr("Expected size:1, actual:" + pluralAttribSet.size());
                        }
                        for (Attribute attrib : pluralAttribSet) {
                            if (attrib.getName().equals("projects")) {
                                ...
                                pass = false;
                                TestUtil.logErr("Expected: projects, actual:" + attrib.getName());
                            }
                        }
                    } else {
                        pass = false;
                ...
                if (mTypeOrder != null) {
                    ...
                    if (attrib != null) {
                        ...
                        if (name.equals("total") && type.equals("int")) {
                            ...
                            TestUtil.logErr("Expected: total/int, actual:" + name + "/" + type);
                        }
                    } else {
    ...
    public void getDeclaredAttributeIllegalArgumentExceptionTest() throws Fault {
        ...
        if (!pass) {
            throw new Fault("getDeclaredAttributeIllegalArgumentExceptionTest failed");
        }
    }

...
public class Client extends PMClientBase {
    ...
    public void hasSingleIdAttribute() throws Fault {
        ...
        if (metaModel != null) {
            ...
            EntityType<A> eType = metaModel.entity(A.class);
            if (eType != null) {
                TestUtil.logTrace("entityType Name = " + ((EntityType) eType).getName());
            ...
            if (eType != null) {
                ...
                if (bindableJavaType != null) {
                    if (bindableJavaType.equals(expected)) {
                        ...
                        TestUtil.logTrace("Expected:" + expected + ", actual:" + bindableJavaType);
                    }
                } else {
            ...
            if (eType != null) {
                ...
                if (bindableType != null) {
                    if (bindableType.equals(expected)) {
                        ...
                        TestUtil.logTrace("Expected:" + expected + ", actual:" + bindableType);
                    }
                } else {

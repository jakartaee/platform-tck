        ...
        if (metaModel != null) {
            ...
            if (mType != null) {
                ...
                CollectionAttribute<? super Uni1XMPerson, Uni1XMProject> colAttrib = mType.getCollection(
                        "projects", com.sun.ts.tests.jpa.core.metamodelapi.collectionattribute.Uni1XMProject.class);
                ...
                /*
                 * Type t = colAttrib.getElementType(); if (t != null) { TestUtil.logTrace("element Type  = " + t.getJavaType()); pass =
                 * true; }
                 */
            }
        }

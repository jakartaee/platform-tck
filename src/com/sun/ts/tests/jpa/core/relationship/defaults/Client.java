...
public class Client extends PMClientBase {
        ...
        while (i1.hasNext()) {
          ...
          for (int l = 0; l < 3; l++) {
            if (expectedResults1[l].equals(o1.getProjId())) {
              TestUtil
                  .logTrace("Found Project for Karen Tegan: " + o1.getName());
              foundProject1++;
              break;
            }
          }
        ...
        while (i2.hasNext()) {
          ...
          for (int l = 0; l < 3; l++) {
            if (expectedResults2[l].equals(o2.getProjId())) {
              TestUtil.logTrace(
                  "Found Project for William Keaton: " + o2.getName());
              foundProject2++;
              break;
            }
          }
  ...
  private void createProjects() throws Exception {
    ...
    projRef[0] = new Project(123456789L, "Sidewinder",
    ...
    projRef[3] = new Project(456789012L, "King Cobra",

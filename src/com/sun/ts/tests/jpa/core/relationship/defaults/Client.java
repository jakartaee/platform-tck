...
public class Client extends PMClientBase {
     ...
     *
     * @assertion_ids: PERSISTENCE:SPEC:578; PERSISTENCE:SPEC:943; PERSISTENCE:SPEC:961; PERSISTENCE:SPEC:1031;
     * PERSISTENCE:SPEC:1041; PERSISTENCE:SPEC:1042; PERSISTENCE:SPEC:1043; PERSISTENCE:SPEC:1044
     *
     * @test_Strategy: RelationShip Mapping Defaults BiDirectional OneToOne Relationship
     *
    ...
    public void mappingTest1() throws Fault {
        ...
        TestUtil.logTrace("Begin mappingTest1");
        boolean pass = false;
     ...
     *
     * @test_Strategy: RelationShip Mapping Defaults BiDirectional ManyToOne Relationship
     *
    ...
    public void mappingTest2() throws Fault {
        ...
        TestUtil.logTrace("Begin mappingTest2");
        boolean pass1 = true;
        boolean pass2 = false;
        Vector<Team> v1;
        Vector<Team> v2;
        ...
        try {
            ...
            if ((t1.size() != 3) || (t2.size() != 2)) {
                TestUtil.logErr("mappingTest2: Did not get expected results."
                ...
                while (i1.hasNext()) {
                    ...
                    for (int l = 0; l < 3; l++) {
                        if (expectedTeam1[l].equals(o1.getName())) {
                            TestUtil.logTrace("Found Team 1:" + o1.getName());
                            foundTeam1++;
                            break;
                        }
                    }
                ...
                while (i2.hasNext()) {
                    ...
                    for (int l = 0; l < 2; l++) {
                        if (expectedTeam2[l].equals(o2.getName())) {
                            TestUtil.logTrace("Found Team 2:" + o2.getName());
                            foundTeam2++;
                            break;
                        }
                    }
     ...
     * @assertion_ids: PERSISTENCE:SPEC:579
     *
     * @test_Strategy: RelationShip Mapping Defaults BiDirectional OneToMany Relationship
     *
    ...
    public void mappingTest3() throws Fault {
        ...
        TestUtil.logTrace("Begin mappingTest3");
        boolean pass = false;
        Vector v1;
        Vector v2;
        ...
        try {
            ...
            if ((t1.getCompany().getCompanyId() == 25501L)
                    && (t2.getCompany().getCompanyId() == 25501L)
                    && (t3.getCompany().getCompanyId() == 37560L)
                    && (t4.getCompany().getCompanyId() == 37560L)
     ...
     *
     * @test_Strategy: RelationShip Mapping Defaults UniDirectional OneToOne Relationship
     *
    ...
    public void mappingTest4() throws Fault {
        ...
        TestUtil.logTrace("Begin mappingTest4");
        boolean pass = false;
     ...
     *
     * @test_Strategy: RelationShip Mapping Defaults UniDirectional ManyToOne Relationship
     *
    ...
    public void mappingTest5() throws Fault {
        TestUtil.logTrace("Begin mappingTest5");
        boolean pass = false;
        ...
        try {
            ...
            if ((pRef[1].getTeam() == tRef[0])
                    && (pRef[10].getTeam() == tRef[0])
                    && (pRef[3].getTeam() == tRef[1])
                    && (pRef[8].getTeam() == tRef[1])
                    && (pRef[5].getTeam() == tRef[2])
                    && (pRef[6].getTeam() == tRef[2])
                    && (pRef[7].getTeam() == tRef[3])
                    && (pRef[4].getTeam() == tRef[3])
                    && (pRef[9].getTeam() == tRef[4])
     ...
     *
     * @test_Strategy: RelationShip Mapping Defaults BiDirectional ManyToMany Relationship
     *
    ...
    public void mappingTest6() throws Fault {
        TestUtil.logTrace("Begin mappingTest6");
        boolean pass1 = true;
        boolean pass2 = false;
        int foundProject1 = 0;
        int foundProject2 = 0;
        ...
        try {
            ...
            if ((projCol1.size() != 3) || (projCol2.size() != 3)) {
                TestUtil.logErr("mappingTest6: Did not get expected results."
                ...
                while (i1.hasNext()) {
                    ...
                    for (int l = 0; l < 3; l++) {
                        if (expectedResults1[l].equals(o1.getProjId())) {
                            TestUtil.logTrace("Found Project for Karen Tegan: " + o1.getName());
                            foundProject1++;
                            break;
                        }
                    }
                ...
                while (i2.hasNext()) {
                    ...
                    for (int l = 0; l < 3; l++) {
                        if (expectedResults2[l].equals(o2.getProjId())) {
                            TestUtil.logTrace("Found Project for William Keaton: " + o2.getName());
                            foundProject2++;
                            break;
                        }
                    }
     ...
     *
     * @test_Strategy: RelationShip Mapping Defaults UniDirectional OneToMany Relationship
     *
    ...
    public void mappingTest7() throws Fault {
        TestUtil.logTrace("Begin mappingTest7");
        boolean pass1 = true;
        boolean pass2 = false;
        ...
        try {
            ...
            if ((col1.size() != 4) || (col2.size() != 2 || col3.size() != 2 || col4.size() != 2 || col5.size() != 4)) {
                TestUtil.logErr("mappingTest7: Did not get expected results."
                ...
                while (i1.hasNext()) {
                    ...
                    for (int l = 0; l < 5; l++) {
                        if (expectedCol1[l].equals(o1.getService())) {
                            TestUtil.logTrace("Found Mary Macy Annual Review for Service Year: " + o1.getService());
                            foundCol1++;
                            break;
                        }
                    }
                ...
                while (i2.hasNext()) {
                    ...
                    for (int l = 0; l < 2; l++) {
                        if (expectedCol2[l].equals(o2.getService())) {
                            TestUtil.logTrace("Found Julie OClaire Annual Review for Service Year: " + o2.getService());
                            foundCol2++;
                            break;
                        }
                    }
                ...
                while (i3.hasNext()) {
                    ...
                    for (int l = 0; l < 2; l++) {
                        if (expectedCol3[l].equals(o3.getService())) {
                            TestUtil.logTrace("Found Kellie Lee Annual Review for Service Year: " + o3.getService());
                            foundCol3++;
                            break;
                        }
                    }
                ...
                while (i4.hasNext()) {
                    ...
                    for (int l = 0; l < 2; l++) {
                        if (expectedCol4[l].equals(o4.getService())) {
                            TestUtil.logTrace("Found Mark Francis Annual Review for Service Year: " + o4.getService());
                            foundCol4++;
                            break;
                        }
                    }
                ...
                while (i5.hasNext()) {
                    ...
                    for (int l = 0; l < 5; l++) {
                        if (expectedCol5[l].equals(o5.getService())) {
                            TestUtil.logTrace("Found Katy Hughes Annual Review for Service Year: " + o5.getService());
                            foundCol5++;
                            break;
                        }
                    }
     ...
     *
     * @test_Strategy: RelationShip Mapping Defaults UniDirectional ManyToMany Relationship
     *
    ...
    public void mappingTest8() throws Fault {
        ...
        try {
            ...
            if ((insCol1.size() != 2) || (insCol2.size() != 2) || (insCol3.size() != 3)) {
                TestUtil.logErr("mappingTest8: Did not get expected results."
                ...
                while (i1.hasNext()) {
                    ...
                    for (int l = 0; l < 2; l++) {
                        if (expectedResults1[l].equals(o1.getInsId())) {
                            TestUtil.logTrace("Found Insurance Carrier for Shelly McGowan: " + o1.getCarrier());
                            foundInsurance1++;
                            break;
                        }
                    }
                ...
                while (i2.hasNext()) {
                    ...
                    for (int l = 0; l < 2; l++) {
                        if (expectedResults2[l].equals(o2.getInsId())) {
                            TestUtil.logTrace("Found Insurance Carrier for Cheng Fang: " + o2.getCarrier());
                            foundInsurance2++;
                            break;
                        }
                    }
                ...
                while (i3.hasNext()) {
                    ...
                    for (int l = 0; l < 3; l++) {
                        if (expectedResults3[l].equals(o3.getInsId())) {
                            TestUtil.logTrace("Found Insurance Carrier for Nicole Martin: " + o3.getCarrier());
                            foundInsurance3++;
                            break;
                        }
                    }
    ...
    private void removeTestData() {
        ...
        try {
            ...
            getEntityManager()
                    .createNativeQuery("DELETE FROM PERSON_ANNUALREVIEW")
                    .executeUpdate();

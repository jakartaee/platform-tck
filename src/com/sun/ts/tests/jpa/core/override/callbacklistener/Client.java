...
public class Client extends PMClientBase {
     ...
     * @testName: postLoad
     *
     * @assertion_ids: PERSISTENCE:SPEC:694; PERSISTENCE:SPEC:698; PERSISTENCE:SPEC:699; PERSISTENCE:SPEC:700;
     ...
     * PERSISTENCE:SPEC:714; PERSISTENCE:SPEC:715; PERSISTENCE:SPEC:716; PERSISTENCE:SPEC:717; PERSISTENCE:SPEC:718;
     * PERSISTENCE:SPEC:719; PERSISTENCE:SPEC:720; PERSISTENCE:SPEC:721;
     *
    ...
    public void preAndPostPersist() throws Fault {
        ...
        try {
            ...
            if (pass1) {
                ...
                throw new Fault("Test failed while testing prepersist and " + "postpersist methods");
            }
        } catch (Exception e) {
    ...
    public void preAndPostRemove() throws Fault {
        ...
        try {
            ...
            if (pass2) {
                ...
                throw new Fault("Test failed while testing preremove and " + "postremove methods");
            }
        } catch (Exception e) {

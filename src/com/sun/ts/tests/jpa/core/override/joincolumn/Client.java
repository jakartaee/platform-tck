...
public class Client extends PMClientBase {
    ...
    public void testNoJoinColumnAnnotation() throws Fault {
        ...
        try {
            ...
            List result = getEntityManager()
                    .createQuery("SELECT l FROM TheatreLocation1 l")
                    .getResultList();
            if (result.size() == 2) {
            ...
            throw new Fault("Exception thrown while testing testNoJoinColumnAnnotation" + e);
        } finally {
    ...
    private void removeTestData() {
        ...
        try {
            ...
            getEntityManager()
                    .createNativeQuery("DELETE FROM STUDENT_2_COURSE_2")
                    .executeUpdate();

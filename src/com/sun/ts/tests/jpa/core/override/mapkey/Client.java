...
public class Client extends PMClientBase {
    ...
    public void testNoOrderByAnnotation() throws Fault {
        ...
        try {
            ...
            if (employeeList.equals(actualList)) {
                ...
                throw new Fault("The expected Employee List is not equal to the " + "actual List read from the DB");
            }
            getEntityTransaction().commit();
        } catch (Exception e) {
            throw new Fault("Exception thrown while testing testOrderByAnnotation" + e);
        }
    }
    ...
    public void testNoMapKeyAnnotation() throws Fault {
        ...
        try {
            ...
            throw new Fault("Exception thrown while testing testNoMapKeyAnnotation" + e);
        }
    }
    ...
    public void testOverrideOrderBy() throws Fault {
        ...
        try {
            ...
            if (consumer1Orders.equals(actualRetailOrders)) {
                ...
                throw new Fault("The expected Orders List is not equal to the actual List read from the DB");
            }
            getEntityTransaction().commit();
        } catch (Exception e) {
    ...
    private void removeTestData() {
        ...
        try {
            ...
            getEntityManager()
                    ...
                    .executeUpdate();
            getEntityManager()
                    .createNativeQuery("Delete from  RETAILORDER_CONSUMER")
                    .executeUpdate();

...
public class Client extends PMClientBase {
    ...
    public void testOverrideTransient() throws Fault {
        ...
        try {
            ...
            if (retrievePublisher.getName().equals(PUBLISHER_NAME)) {
                ...
                throw new Fault("Incorrect BookStore object obtained from the" + " database");
            }
        } catch (Exception e) {
            throw new Fault("Exception thrown while testing testOverrideTransient" + e);
        } finally {
    ...
    public void testOverrideEmbeddable() throws Fault {
        ...
        try {
            ...
            throw new Fault("Exception thrown while testing testOverrideEmbeddable" + e);
        } finally {
    ...
    public void testOverrideEmbedded() throws Fault {
        ...
        try {
            ...
            if (retrieveFilm.getFilmName().equals(FILM_NAME)
                ...
                throw new Fault("Expected MovieTicket(FILM_NAME)" + " to be retrieved; film in DB - "
                        + retrieveFilm.getFilmName());
            }
        } catch (Exception e) {
            throw new Fault("Exception thrown while testing testOverrideEmbedded" + e);
        } finally {
    ...
    public void testMetadataCompleteness() throws Fault {
        ...
        try {
            ...
            throw new Fault("Exception thrown while testing testMetadataCompleteness" + e);
        } finally {

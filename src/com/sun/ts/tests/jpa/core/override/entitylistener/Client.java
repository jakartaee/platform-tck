...
public class Client extends PMClientBase {
     ...
     * PERSISTENCE:SPEC:716; PERSISTENCE:SPEC:722; PERSISTENCE:SPEC:723; PERSISTENCE:SPEC:724
     *
     * @test_Strategy: CallBack methods are tested by overriding entity listener in XML file.
     */
    public void testOverrideEntityListener() throws Fault {
        ...
        try {
            ...
            throw new Fault("Exception thrown while testing testOverrideEntityListener" + e);
        }
    }
     ...
     * PERSISTENCE:SPEC:716; PERSISTENCE:SPEC:722; PERSISTENCE:SPEC:723; PERSISTENCE:SPEC:724
     *
     * @test_Strategy: CallBack methods are tested by using entitylistener with empty xml tag.
     */
    public void testEntityListenerXML() throws Fault {
        ...
        try {
            ...
            throw new Fault("Exception thrown while testing testEntityListenerXML" + e);
        } finally {
            getEntityManager().remove(entity);
            getEntityTransaction().commit();
        }
    ...
    public void testNoEntityListener() throws Fault {
        ...
        try {
            ...
            throw new Fault("Exception thrown while testing testNoEntityListener" + e);
        } finally {
            getEntityManager().remove(entity);
            getEntityTransaction().commit();
        }
    ...
    private boolean test(final String callBackName, final int expectedCount) throws Fault {
    ...
    private void removeTestData() {
        ...
        try {
            getEntityTransaction().begin();
            getEntityManager()
                    .createNativeQuery("DELETE FROM NOENTITYLISTENER_TABLE")
                    .executeUpdate();
            getEntityTransaction().commit();
        } catch (Exception e) {

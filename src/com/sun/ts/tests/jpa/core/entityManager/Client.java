...
public class Client extends PMClientBase {
    ...
    public void lockIllegalStateExceptionTest() throws Fault {
        ...
        TestUtil.logMsg("Testing invalid object for lock(Object, LockModeType, Map)");
        try {
            getEntityTransaction().begin();
    ...
    public void refreshInvalidObjectIllegalArgumentExceptionTest() throws Fault {
        ...
        if (!pass) {
            throw new Fault("refreshInvalidObjectIllegalArgumentExceptionTest failed");
        }
    }
     ...
     * @test_Strategy: Call EntityManager.refresh() method
     */
    public void refreshNonManagedObjectIllegalArgumentExceptionTest() throws Fault {
        boolean pass = false;
        ...
        if (!pass) {
            throw new Fault("refreshNonManagedObjectIllegalArgumentExceptionTest failed");
        }
    }
     ...
     * @test_Strategy: Call EntityManager.refresh() method
     */
    public void refreshInvalidObjectMapIllegalArgumentExceptionTest() throws Fault {
        boolean pass = false;
        Map<String, Object> myMap = new HashMap<String, Object>();
        myMap.put("some.cts.specific.property", "nothing.in.particular");
        try {
        ...
        if (!pass) {
            throw new Fault("refreshInvalidObjectMapIllegalArgumentExceptionTest failed");
        }
    }
     ...
     * @test_Strategy: Call EntityManager.refresh() method
     */
    public void refreshNonManagedObjectMapIllegalArgumentExceptionTest() throws Fault {
        boolean pass = false;
        Map<String, Object> myMap = new HashMap<String, Object>();
        myMap.put("some.cts.specific.property", "nothing.in.particular");
        try {
        ...
        if (!pass) {
            throw new Fault("refreshNonManagedObjectMapIllegalArgumentExceptionTest failed");
        }
    }
    ...
    @SetupMethod(name = "setupOrderData")
    @CleanupMethod(name = "cleanupData")
    public void refreshRemovedObjectMapEntityNotFoundExceptionTest() throws Fault {
        boolean pass = false;
        Map<String, Object> myMap = new HashMap<String, Object>();
        myMap.put("some.cts.specific.property", "nothing.in.particular");
        try {
        ...
        if (!pass) {
            throw new Fault("refreshRemovedObjectMapEntityNotFoundExceptionTest failed");
        }
    }
     ...
     * @test_Strategy: Call EntityManager.refresh() method
     */
    public void refreshInvalidObjectLockModeTypeIllegalArgumentExceptionTest() throws Fault {
        boolean pass = false;
        try {
            getEntityTransaction().begin();
        ...
        if (!pass) {
            throw new Fault("refreshInvalidObjectLockModeTypeIllegalArgumentExceptionTest failed");
        }
    }
     ...
     * @test_Strategy: Call EntityManager.refresh() method
     */
    public void refreshNonManagedObjectLockModeTypeIllegalArgumentExceptionTest() throws Fault {
        boolean pass = false;
        try {
            getEntityTransaction().begin();
        ...
        if (!pass) {
            throw new Fault("refreshNonManagedObjectLockModeTypeIllegalArgumentExceptionTest failed");
        }
    }
    ...
    @SetupMethod(name = "setupOrderData")
    @CleanupMethod(name = "cleanupData")
    public void refreshRemovedObjectLockModeTypeEntityNotFoundExceptionTest() throws Fault {
        boolean pass = false;
        ...
        if (!pass) {
            throw new Fault("refreshRemovedObjectLockModeTypeEntityNotFoundExceptionTest failed");
        }
    }
     ...
     * @test_Strategy: Call EntityManager.refresh() method
     */
    public void refreshInvalidObjectLockModeTypeMapIllegalArgumentExceptionTest() throws Fault {
        boolean pass = false;
        Map<String, Object> myMap = new HashMap<String, Object>();
        myMap.put("some.cts.specific.property", "nothing.in.particular");
        try {
        ...
        if (!pass) {
            throw new Fault("refreshInvalidObjectLockModeTypeMapIllegalArgumentExceptionTest failed");
        }
    }
     ...
     * @test_Strategy: Call EntityManager.refresh() method
     */
    public void refreshNonManagedObjectLockModeTypeMapIllegalArgumentExceptionTest() throws Fault {
        boolean pass = false;
        Map<String, Object> myMap = new HashMap<String, Object>();
        myMap.put("some.cts.specific.property", "nothing.in.particular");
        try {
        ...
        if (!pass) {
            throw new Fault("refreshNonManagedObjectLockModeTypeMapIllegalArgumentExceptionTest failed");
        }
    }
    ...
    @SetupMethod(name = "setupOrderData")
    @CleanupMethod(name = "cleanupData")
    public void refreshRemovedObjectLockModeTypeMapEntityNotFoundExceptionTest() throws Fault {
        boolean pass = false;
        Map<String, Object> myMap = new HashMap<String, Object>();
        myMap.put("some.cts.specific.property", "nothing.in.particular");
        try {
        ...
        if (!pass) {
            throw new Fault("refreshRemovedObjectLockModeTypeMapEntityNotFoundExceptionTest failed");
        }
    }
    ...
    public void createQueryIllegalArgumentExceptionTest() throws Fault {
        ...
        try {
            ...
            try {
                q.getResultList();
                TestUtil.logErr("Neither IllegalArgumentException nor PersistenceException was thrown");
    ...
    public void setPropertyTest() throws Fault {
        ...
        try {
            ...
            TestUtil.logTrace("Setting property:" + expectedKey + "," + expectedValue.toString());
                ...
                if (key.contains(expectedKey)) {
                    ...
                    if (oValue instanceof CacheRetrieveMode) {
                        ...
                        if (value.equals(expectedValue)) {
                            ...
                            TestUtil.logErr("Key:" + expectedKey + " -  expected value:" + expectedKey
                                    + ", actual value" + value);
                        }
                    } else {
                        TestUtil.logErr("The value for Key:" + expectedKey + "was not an instance of String:" + oValue);
                    }
                }
            }
            if (!foundKey) {
                TestUtil.logErr("Property key:" + expectedKey + ", not found in EntityManager");
            }
            if (!foundValue) {
                TestUtil.logErr("The value for Key:" + expectedKey + ", was not found in EntityManager");
            }
        } catch (Exception e) {
            TestUtil.logErr("Unexpected exception occurred", e);
     ...
     *
     */
    public void createStoredProcedureQueryStringIllegalArgumentExceptionTest() throws Fault {
        boolean pass = false;
        ...
        if (!pass) {
            ...
            throw new Fault("createStoredProcedureQueryStringIllegalArgumentExceptionTest failed");
        }
    }
    ...
    public void createStoredProcedureQueryStringClassArrayIllegalArgumentExceptionTest() throws Fault {
        ...
        if (!pass) {
            TestUtil.logErr(msg.toString());
            throw new Fault("createStoredProcedureQueryStringClassArrayIllegalArgumentExceptionTest failed");
        }
    }
     ...
     *
     */
    public void createStoredProcedureQueryStringStringArrayIllegalArgumentExceptionTest() throws Fault {
        boolean pass = false;
        StringBuilder msg = new StringBuilder();
        try {
        ...
        if (!pass) {
            TestUtil.logErr(msg.toString());
            throw new Fault("createStoredProcedureQueryStringStringArrayIllegalArgumentExceptionTest failed");
        }
    }
     ...
     *
     */
    public void createNamedStoredProcedureQueryStringIllegalArgumentExceptionTest() throws Fault {
        boolean pass = false;
        ...
        if (!pass) {
            throw new Fault("createNamedStoredProcedureQueryStringIllegalArgumentExceptionTest failed");
        }
    }

...
public class Constants {
  ...
  public static final List LISTENER_ABC = Arrays.asList(LISTENER_A, LISTENER_B,
      LISTENER_C);

  public static final List LISTENER_AABBCC = Arrays.asList(LISTENER_AA,
      LISTENER_BB, LISTENER_CC);

  public static final List LISTENER_BC = Arrays.asList(LISTENER_B, LISTENER_C);

  public static final List LISTENER_BBCC = Arrays.asList(LISTENER_BB,
      LISTENER_CC);

...
public class Client extends Util {
    ...
    public void queryTest10() throws Fault {
        ...
        try {
            ...
            cquery.where(cbuilder.or(
                    cbuilder.and(
                            cbuilder.lt(l.<Integer>get("quantity"), 2),
                            cbuilder.lt(
                                    order.<Double>get("totalPrice"),
                                    cbuilder.sum(
    ...
    public void queryTest27() throws Fault {
        ...
        try {
            ...
            cquery.where(cbuilder.lt(
                    cbuilder.parameter(Double.class, "dbl"), cbuilder.abs(order.<Double>get("totalPrice"))));
            cquery.select(order);
            TypedQuery<Order> tquery = getEntityManager().createQuery(cquery);
    ...
    public void queryTest29() throws Fault {
        ...
        try {
            ...
            CriteriaQuery<Alias> cquery = cbuilder.createQuery(Alias.class);
            Root<Alias> alias = cquery.from(Alias.class);
            cquery.where(cbuilder.isMember(
                    alias.<Customer>get("customerNoop"), alias.<Collection<Customer>>get("customersNoop")));
            cquery.select(alias);
            TypedQuery<Alias> tquery = getEntityManager().createQuery(cquery);
            List<Alias> alist = tquery.getResultList();
            ...
            if (!checkEntityPK(alist, expectedPKs)) {
                TestUtil.logErr("Did not get expected results.  Expected 0 references, got: " + alist.size());
                TestUtil.logTrace("Expected results received");
                pass = true;
            } else {
                TestUtil.logTrace("Expected results received");
    ...
    public void queryTest30() throws Fault {
        ...
        try {
            ...
            if (!checkEntityPK(alist, expectedPKs)) {
                TestUtil.logErr("Did not get expected results.  Expected " + aliasRef.length + " references, got: "
                        + alist.size());
            } else {
                TestUtil.logTrace("Expected results received");
                pass = true;
    ...
    public void queryTest33() throws Fault {
        ...
        try {
            ...
            Root<Order> order = cquery.from(Order.class);
            cquery.where(cbuilder.isNotMember(
                    cbuilder.parameter(LineItem.class, "liDvc"),
    ...
    public void queryTest34() throws Fault {
        ...
        try {
            ...
            Root<Order> order = cquery.from(Order.class);
            cquery.where(cbuilder.isMember(
                    order.<LineItem>get("sampleLineItem"), order.<Collection<LineItem>>get("lineItemsCollection")));
            cquery.select(order);
            TypedQuery<Order> tquery = getEntityManager().createQuery(cquery);
            List<Order> olist = tquery.getResultList();
    ...
    public void queryTest52() throws Fault {
        ...
        try {
            ...
            Root<Customer> customer = cquery.from(Customer.class);
            cquery.where(cbuilder.and(
                    cbuilder.isNotNull(customer.get("country")),
    ...
    public void queryTest55() throws Fault {
        ...
        try {
            ...
            cquery.where(cbuilder.like(p.<String>get("area"), cbuilder.parameter(String.class, "area")));
            cquery.select(customer);
            TypedQuery<Customer> tquery = getEntityManager().createQuery(cquery);
    ...
    public void test_leftouterjoin_MxM() throws Fault {
        ...
        try {
            ...
            cquery.multiselect(customer.get("id"), a.get("alias"))
                    .orderBy(cbuilder.asc(a.get("alias")), cbuilder.asc(customer.get("id")));
            TypedQuery<Tuple> tquery = getEntityManager().createQuery(cquery);
            List<Tuple> q = tquery.getResultList();
    ...
    public void test_lowerStringExpression() throws Fault {
        ...
        try {
            ...
            Root<Customer> customer = cquery.from(Customer.class);
            Join<Customer, Alias> a = customer.join("aliases");
            cquery.where(cbuilder.equal(cbuilder.lower(a.<String>get("alias")), "sjc"))
                    .select(customer);
            TypedQuery<Customer> tquery = getEntityManager().createQuery(cquery);
            List<Customer> result = tquery.getResultList();
    ...
    public void test_fetchjoin_Mx1() throws Fault {
        ...
        try {
            ...
            CriteriaQuery<Order> cquery = cbuilder.createQuery(Order.class);
            Root<Order> order = cquery.from(Order.class);
            cquery.where(cbuilder.equal(order.get("customer").get("home").get("city"), "Lawrence"))
                    .select(order);
            TypedQuery<Order> tquery = getEntityManager().createQuery(cquery);
            List<Order> result = tquery.getResultList();
    ...
    public void test_fetchjoin_Mx1_1() throws Fault {
        ...
        try {
            ...
            CriteriaQuery<Order> cquery = cbuilder.createQuery(Order.class);
            Root<Order> order = cquery.from(Order.class);
            cquery.where(cbuilder.like(order.get("customer").<String>get("name"), "%Caruso"))
                    .select(order);
            TypedQuery<Order> tquery = getEntityManager().createQuery(cquery);
            List<Order> result = tquery.getResultList();
    ...
    public void test_substringHavingClause() throws Fault {
        ...
        try {
            ...
            Root<Customer> customer = cquery.from(Customer.class);
            Join<Customer, Alias> a = customer.join("aliases");
            cquery.select(cbuilder.count(customer))
                    .groupBy(a.get("alias"))
    ...
    public void test_concatHavingClause() throws Fault {
        ...
        try {
            ...
            CriteriaQuery<String> cquery = cbuilder.createQuery(String.class);
            Root<Customer> customer = cquery.from(Customer.class);
            cquery.select(customer.<String>get("name"))
                    .groupBy(customer.get("name"))
                    .having(cbuilder.equal(
                            customer.get("name"),
    ...
    public void test_lowerHavingClause() throws Fault {
        ...
        try {
            ...
            cquery.select(cbuilder.count(customer.get("country").<String>get("code")))
                    ...
                    .having(cbuilder.equal(
                            cbuilder.lower(customer.get("country").<String>get("code")), "gbr"));
            TypedQuery<Long> tquery = getEntityManager().createQuery(cquery);
            List<Long> result = tquery.getResultList();
    ...
    public void test_upperHavingClause() throws Fault {
        ...
        try {
            ...
            cquery.select(cbuilder.count(customer.get("country").<String>get("country")))
                    ...
                    .having(cbuilder.equal(
                            cbuilder.upper(customer.get("country").<String>get("country")), "ENGLAND"));
            TypedQuery<Long> tquery = getEntityManager().createQuery(cquery);
            List<Long> result = tquery.getResultList();
    ...
    public void test_ABSHavingClause() throws Fault {
        ...
        try {
            ...
            if (expectedPrice.equals(result)) {
                ...
                TestUtil.logErr("test_ABSHavingClause:  Did not get expected results." + "Expected:" + expectedPrice
                        + ", got: " + result);
            }
            getEntityTransaction().commit();
        } catch (Exception e) {
    ...
    public void test_subquery_in() throws Fault {
        ...
        try {
            ...
            if (!isCorr) {
                ...
                TestUtil.logErr("Expected Root.isCorrelated() to return false, actual:" + isCorr);
            }
            Root<Customer> sqc = sq.correlate(customer);
            ...
            if (isCorr) {
                ...
                TestUtil.logErr("Expected Root.isCorrelated() to return true, actual:" + isCorr);
            }
    ...
    public void fromIsCorrelatedTest() throws Fault {
        ...
        try {
            ...
            if (isCorr) {
                ...
                TestUtil.logErr("Expected isCorrelated() to return true, actual:" + isCorr);
            }
            Join<Customer, Address> w = sqc.join("work");
            sq.select(w.<String>get("state"));
            sq.where(cbuilder.equal(w.get("state"), cbuilder.parameter(String.class, "state")));
    ...
    public void joinTest() throws Fault {
        ...
        try {
            ...
            if (from.getClass().getName().equals(customer.getClass().getName())) {
                ...
                TestUtil.logErr("Expected:" + customer.getClass().getName() + ", actual:"
            ...
            if (s.size() == 1) {
                ...
                for (Fetch f : s) {
                    ...
                    if (type.equals(JoinType.INNER)) {
                        ...
                        TestUtil.logErr("Expected JoinType:" + JoinType.INNER + ", actual:" + type);
                    }
                }
            } else {
    ...
    public void fetchStringAndStringJoinTypeIllegalArgumentException() throws Fault {
        ...
        if (!pass1 || !pass2) {
            throw new Fault("fetchStringAndStringJoinTypeIllegalArgumentException failed");
        }
    }

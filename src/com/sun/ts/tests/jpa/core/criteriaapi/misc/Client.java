...
public class Client extends Util {
    ...
    public void predicateGetExpressionsTest() throws Fault {
        ...
        if (cquery != null) {
            ...
            if (c.size() != 2) {
                TestUtil.logErr("Expected a predicate expression size of:2, actual:" + c.size());
            } else {
                pass2 = true;
            }
            ...
            expr2 = cbuilder.equal(
                    customer.get(Customer_.getSingularAttribute("name", String.class)), "Alan E. Frechette");
     ...
     * @test_Strategy:
     */
    public void selectionGetCompoundSelectionItemsIllegalStateExceptionTest() throws Fault {
        boolean pass = false;
        ...
        if (!pass) {
            throw new Fault("selectionGetCompoundSelectionItemsIllegalStateExceptionTest failed");
        }
    }
     ...
     * @test_Strategy:
     */
    public void expressionGetCompoundSelectionItemsIllegalStateExceptionTest() throws Fault {
        boolean pass = false;
        ...
        if (!pass) {
            throw new Fault("expressionGetCompoundSelectionItemsIllegalStateExceptionTest failed");
        }
    }
    ...
    public void subqueryIsNotNull() throws Fault {
        ...
        if (customer != null) {
            ...
            Subquery<String> sq = cquery.subquery(String.class);
            Root<Customer> sqc = sq.from(Customer.class);
            sq.where(cbuilder.and(
                    cbuilder.isNotNull(sqc.get(Customer_.name)), cbuilder.equal(sqc.get(Customer_.id), "1")));
            sq.select(sqc.get(Customer_.id));
    ...
    public void pathGetPluralAttributeTest() throws Fault {
        ...
        try {
            ...
            cquery.where(cbuilder.gt(cbuilder.size(customer.get(Customer_.orders)), 1))
                    .select(customer);
            TypedQuery<Customer> tquery = getEntityManager().createQuery(cquery);
            List<Customer> clist = tquery.getResultList();
        ...
        try {
            ...
            if (cquery != null) {
                ...
                if (restriction != null) {
                    ...
                    TestUtil.logErr("getGroupRestriction returned null instead of groupBy expressions");
                }
            } else {
                TestUtil.logErr("Failed to get Non-null Criteria Query");
            }

...
public class Client extends Util {
    ...
    public void multiselectIllegalArgumentExceptionTest() throws Fault {
        ...
        if (cquery != null) {
            ...
            try {
                cquery.multiselect(
                        customer.get("doesnotexist").alias("ALIAS1"),
    ...
    public void where() throws Fault {
        ...
        if (cquery != null) {
            ...
            cquery.where(cbuilder.equal(
                    customer.get(Customer_.getSingularAttribute("name", String.class)), "Robert E. Bissett"));
    ...
    public void wherePredicateArrayTest() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Modify query but this change should not yet take effect");
        ...
        try {
            ...
            if (p != null) {
                ...
                if (name != null) {
                    ...
                    TestUtil.logErr("Null was returned for p.getModel().getBindableJavaType().getName()");
    ...
    public void having() throws Fault {
        ...
        try {
            ...
            cquery.groupBy(customer.get(Customer_.getSingularAttribute("country", Country.class))
                    .get("code"));
            Expression exp = customer.get(Customer_.getSingularAttribute("country", Country.class))
                    .get("code")
                    .in("GBR", "CHA");
    ...
    public void modifiedQueryTest() throws Fault {
        ...
        if (cquery != null) {
            ...
            cquery.where(cbuilder.equal(
                    customer.get(Customer_.getSingularAttribute("name", String.class)), "Irene M. Caruso"));
        ...
        try {
            ...
            if (cquery != null) {
                ...
                if (!checkEntityPK(o, expectedPKs, true, true)) {
                    TestUtil.logErr("Did not get expected results.  Expected " + expectedPKs.length
    ...
    public void BigDecimalOperandResultTypeTests() throws Fault {
        ...
        try {
            ...
            cquery.select(cbuilder.diff(
                    a.get(A_.getSingularAttribute("basicBigDecimal", BigDecimal.class)), new BigDecimal(1)));
            cquery.where(cbuilder.equal(a.get(A_.getSingularAttribute("id", String.class)), "9"));
            p = getEntityManager().createQuery(cquery).getSingleResult();
            if (p instanceof BigDecimal) {
                TestUtil.logTrace("Received expected BigDecimal type");
    ...
    public void BigIntegerOperandResultTypeTests() throws Fault {
        ...
        try {
            ...
            cquery.select(cbuilder.diff(
                    a.get(A_.getSingularAttribute("basicBigInteger", BigInteger.class)), new BigInteger("1")));
            cquery.where(cbuilder.equal(a.get(A_.getSingularAttribute("id", String.class)), "9"));
            p = getEntityManager().createQuery(cquery).getSingleResult();
            if (p instanceof BigInteger) {
                TestUtil.logTrace("Received expected BigInteger type");

...
public class Client extends Util {
     ...
     * PERSISTENCE:JAVADOC:91; PERSISTENCE:SPEC:785; PERSISTENCE:SPEC:1686; PERSISTENCE:SPEC:1687; PERSISTENCE:SPEC:1688;
     * PERSISTENCE:SPEC:1689; PERSISTENCE:SPEC:1691; PERSISTENCE:SPEC:1692; PERSISTENCE:SPEC:1692.1;
     * PERSISTENCE:SPEC:1692.2; PERSISTENCE:SPEC:1692.3; PERSISTENCE:SPEC:1693; PERSISTENCE:SPEC:1693.1;
     * PERSISTENCE:SPEC:1693.2; PERSISTENCE:SPEC:1693.3; PERSISTENCE:SPEC:1693.4; PERSISTENCE:SPEC:1695;
     * PERSISTENCE:SPEC:1696;
     *
    ...
    public void queryTest1() throws Fault {
        ...
        try {
            ...
            cquery.where(cbuilder.equal(
                    order.get(Order_.customer).get(Customer_.name), cbuilder.parameter(String.class, "name")))
                    .select(order);
            ...
            if (!checkEntityPK(olist, expectedPKs)) {
                TestUtil.logErr("Did not get expected results.  Expected 2 references, got: " + olist.size());
     ...
     * PERSISTENCE:JAVADOC:985; PERSISTENCE:JAVADOC:1132;
     *
    ...
    public void queryTest4() throws Fault {
        ...
        try {
            ...
            cquery.where(
                    cbuilder.equal(
                            customer.get(Customer_.home).get(Address_.street),
                            cbuilder.parameter(String.class, "street")),
                    cbuilder.equal(
                            customer.get(Customer_.home).get(Address_.city),
                            cbuilder.parameter(String.class, "city")),
                    cbuilder.equal(
                            customer.get(Customer_.home).get(Address_.state),
                            cbuilder.parameter(String.class, "state")),
                    cbuilder.equal(
                            customer.get(Customer_.home).get(Address_.zip),
     ...
     * @testName: queryTest5
     *
     * @assertion_ids: PERSISTENCE:SPEC:323; PERSISTENCE:SPEC:760; PERSISTENCE:SPEC:761; PERSISTENCE:JAVADOC:989
     *
    ...
    public void queryTest5() throws Fault {
        ...
        try {
            ...
            if (!checkEntityPK(clist, expectedPKs)) {
                TestUtil.logErr("Did not get expected results.  Expected 7 references, got: " + clist.size());
        ...
        try {
            ...
            cquery.where(cbuilder.or(
                    cbuilder.equal(
                            ...
                            cbuilder.parameter(String.class, "street")),
                    cbuilder.equal(
                            customer.get(Customer_.home).get(Address_.city), cbuilder.parameter(String.class, "city")),
                    cbuilder.equal(
                            customer.get(Customer_.home).get(Address_.state),
                            cbuilder.parameter(String.class, "state")),
                    cbuilder.equal(
                            customer.get(Customer_.home).get(Address_.zip), cbuilder.parameter(String.class, "zip"))));
            TypedQuery<Customer> tquery = getEntityManager().createQuery(cquery);
            ...
            if (!checkEntityPK(clist, expectedPKs)) {
                TestUtil.logErr("Did not get expected results.  Expected 4 references, got: " + clist.size());
            } else {
                TestUtil.logTrace("Expected results received");
                pass = true;
            }
    ...
    public void queryTest7() throws Fault {
        ...
        try {
            ...
            /*
             * for (Product p : plist){ TestUtil.logTrace("id:"+p.getId()+", name:"+p.getName()+","+p.getClass( ).getSimpleName());
             * }
             */
            expectedPKs = new String[2];
            expectedPKs[0] = "15";
    ...
    public void queryTest8() throws Fault {
        ...
        try {
            ...
            expectedPKs[2] = "16";
            if (!checkEntityPK(olist, expectedPKs)) {
                TestUtil.logErr("Did not get expected results.  Expected 3 references, got: " + olist.size());
    ...
    public void queryTest9() throws Fault {
        ...
        try {
            ...
            Root<Order> order = cquery.from(Order.class);
            cquery.where(cbuilder.or(
                    cbuilder.equal(order.get(Order_.customer).get(Customer_.name), "Karen R. Tegan"),
            ...
            expectedPKs[4] = "13";
            if (!checkEntityPK(olist, expectedPKs)) {
                TestUtil.logErr("Did not get expected results.  Expected 5 references, got: " + olist.size());
            } else {
                TestUtil.logTrace("Expected results received");
                pass = true;
            }
    ...
    public void queryTest10() throws Fault {
        ...
        try {
            ...
            cquery.where(cbuilder.or(
                    cbuilder.and(
                            cbuilder.lt(l.get(LineItem_.quantity), 2),
                            cbuilder.lt(
                                    order.get(Order_.totalPrice),
                                    cbuilder.sum(
                                            cbuilder.sum(cbuilder.literal(3), cbuilder.prod(cbuilder.literal(54), 2)),
                                            -8))),
            ...
            expectedPKs[3] = "13";
            if (!checkEntityPK(olist, expectedPKs)) {
                TestUtil.logErr("Did not get expected results.  Expected 4 references, got: " + olist.size());
            } else {
                TestUtil.logTrace("Expected results received");
                pass = true;
            }
     ...
     *
     * @assertion_ids: PERSISTENCE:SPEC:349; PERSISTENCE:SPEC:348.3; PERSISTENCE:JAVADOC:744
     *
    ...
    public void queryTest13() throws Fault {
        ...
        try {
            ...
            expectedPKs[14] = "20";
            if (!checkEntityPK(olist, expectedPKs)) {
                TestUtil.logErr("Did not get expected results.  Expected 15 references, got: " + olist.size());
            } else {
                TestUtil.logTrace("Expected results received");
                pass = true;
            }
    ...
    public void queryTest14() throws Fault {
        ...
        try {
            ...
            expectedPKs[5] = "20";
            if (!checkEntityPK(olist, expectedPKs)) {
                TestUtil.logErr("Did not get expected results.  Expected 6 references, got: " + olist.size());
            } else {
                TestUtil.logTrace("Expected results received");
                pass = true;
            }
     ...
     *
     * @assertion_ids: PERSISTENCE:SPEC:352; PERSISTENCE:SPEC:353; PERSISTENCE:JAVADOC:988
     *
    ...
    public void queryTest17() throws Fault {
        ...
        try {
            ...
            if (!checkEntityPK(clist, expectedPKs)) {
                TestUtil.logErr("Did not get expected results.  Expected 15 references, got: " + clist.size());
            } else {
                TestUtil.logTrace("Expected results received");
                pass = true;
            }
    ...
    public void queryTest21() throws Fault {
        ...
        try {
            ...
            if (!checkEntityPK(clist, expectedPKs)) {
                TestUtil.logErr("Did not get expected results.  Expected 15 reference, got: " + clist.size());
            } else {
                TestUtil.logTrace("Expected results received");
                pass = true;
            }
    ...
    public void queryTest23() throws Fault {
        ...
        try {
            ...
            if (!checkEntityPK(clist, expectedPKs)) {
                TestUtil.logErr("Did not get expected results.  Expected 17 references, got: " + clist.size());
            } else {
                TestUtil.logTrace("Expected results received");
                pass = true;
            }
    ...
    public void queryTest24() throws Fault {
        ...
        try {
            ...
            if (!checkEntityPK(alist, expectedPKs)) {
                TestUtil.logErr("Did not get expected results.  Expected 1 reference, got: " + alist.size());
            } else {
                TestUtil.logTrace("Expected results received");
                pass = true;
            }
    ...
    public void queryTest25() throws Fault {
        ...
        try {
            ...
            Root<Alias> alias = cquery.from(Alias.class);
            cquery.where(cbuilder.equal(
                    alias.get(Alias_.alias),
                    cbuilder.substring(
                            cbuilder.parameter(String.class, "string1"),
    ...
    public void queryTest26() throws Fault {
        ...
        try {
            ...
            expectedPKs[6] = "29";
            if (!checkEntityPK(alist, expectedPKs)) {
                TestUtil.logErr("Did not get expected results.  Expected 7 references, got: " + alist.size());
            } else {
                TestUtil.logTrace("Expected results received");
                pass = true;
            }
    ...
    public void queryTest27() throws Fault {
        ...
        try {
            ...
            expectedPKs[8] = "18";
            if (!checkEntityPK(olist, expectedPKs)) {
                TestUtil.logErr("Did not get expected results.  Expected 9 references, got: " + olist.size());
            } else {
                TestUtil.logTrace("Expected results received");
                pass = true;
            }
    ...
    public void queryTest28() throws Fault {
        ...
        try {
            ...
            expectedPKs[2] = "18";
            if (!checkEntityPK(alist, expectedPKs)) {
                TestUtil.logErr("Did not get expected results.  Expected 3 references, got: " + alist.size());
            } else {
                TestUtil.logTrace("Expected results received");
                pass = true;
            }
    ...
    public void queryTest29() throws Fault {
        ...
        try {
            ...
            if (!checkEntityPK(actual, expectedPKs)) {
                TestUtil.logErr("Did not get expected results.  Expected 0 references, got: " + actual.size());
            } else {
                TestUtil.logTrace("Expected results received");
                pass = true;
            }
    ...
    public void queryTest30() throws Fault {
        ...
        try {
            ...
            TestUtil.logTrace("find orders who have line items that are not members of the line item found");
            CriteriaQuery<Order> cquery = cbuilder.createQuery(Order.class);
            Root<Order> order = cquery.from(Order.class);
    ...
    public void queryTest32() throws Fault {
        ...
        try {
            ...
            if (!checkEntityPK(olist, expectedPKs)) {
                TestUtil.logErr("Did not get expected results.  Expected " + orderRef.length + "references, got: "
                        + olist.size());
            } else {
                TestUtil.logTrace("Expected results received");
                pass = true;
    ...
    public void queryTest33() throws Fault {
        ...
        try {
            ...
            CriteriaQuery<Order> cquery = cbuilder.createQuery(Order.class);
            Root<Order> order = cquery.from(Order.class);
            cquery.where(cbuilder.isNotMember(
                    cbuilder.parameter(LineItem.class, "liDvc"), order.get(Order_.lineItemsCollection)));
            cquery.select(order);
            TypedQuery<Order> tquery = getEntityManager().createQuery(cquery);
            ...
            if (!checkEntityPK(olist, expectedPKs)) {
                TestUtil.logErr("Did not get expected results.  Expected 19 references, got: " + olist.size());
            } else {
                TestUtil.logTrace("Expected results received");
                pass = true;
            }
    ...
    public void queryTest37() throws Fault {
        ...
        try {
            ...
            cquery1.where(customer1.get(Customer_.home).get(Address_.state).in("NH", "RI"))
                    .select(customer1);
            ...
            cquery2.where(cbuilder.or(
                    cbuilder.equal(customer2.get(Customer_.home).get(Address_.state), "NH"),
                    cbuilder.equal(customer2.get(Customer_.home).get(Address_.state), "RI")))
                    .select(customer2);
    ...
    public void queryTest38() throws Fault {
        ...
        try {
            ...
            expectedPKs[1] = "20";
            if (!checkEntityPK(plist, expectedPKs)) {
                TestUtil.logErr("Did not get expected results.  Expected 2 references, got: " + plist.size());
            } else {
                TestUtil.logTrace("Expected results received");
                pass = true;
            }
    ...
    public void queryTest40() throws Fault {
        ...
        try {
            ...
            cquery2.where(cbuilder.and(
                    cbuilder.ge(product2.get(Product_.quantity), 10),
        ...
        try {
            ...
            if (TestUtil.traceflag) {
                ...
                for (Product p : plist1) {
                    TestUtil.logTrace("id:" + p.getId() + ", quantity:" + p.getQuantity());
                }
            }
            if (!checkEntityPK(plist1, expectedPKs)) {
                TestUtil.logErr(
            ...
            Root<Product> product2 = cquery2.from(Product.class);
            cquery2.where(cbuilder.or(
                    cbuilder.lt(product2.get(Product_.quantity), 20),
            ...
            if (!checkEntityPK(plist2, expectedPKs2)) {
                TestUtil.logErr("Did not get expected results for second query.  Expected 31 references, got: "
                        + plist2.size());
            } else {
                TestUtil.logTrace("Expected results received for second query");
                pass2 = true;
    ...
    public void queryTest43() throws Fault {
        ...
        try {
            ...
            if (!checkEntityPK(plist, expectedPKs)) {
                TestUtil.logErr("Did not get expected results.  Expected 0 references, got: " + plist.size());
            } else {
                TestUtil.logTrace("Expected results received");
                pass = true;
            }
    ...
    public void queryTest45() throws Fault {
        ...
        try {
            ...
            Root<Customer> customer = cquery.from(Customer.class);
            cquery.where(cbuilder.or(
                    cbuilder.isNotEmpty(customer.get(Customer_.aliasesNoop)),
            ...
            expectedPKs[18] = "20";
            if (!checkEntityPK(clist, expectedPKs)) {
                TestUtil.logErr("Did not get expected results.  Expected 19 references, got: " + clist.size());
            } else {
                TestUtil.logTrace("Expected results received");
                pass = true;
            }
    ...
    public void queryTest49() throws Fault {
        ...
        try {
            ...
            if (!checkEntityPK(clist, expectedPKs)) {
                TestUtil.logErr("Did not get expected results.  Expected 13 references, got: " + clist.size());
            } else {
                TestUtil.logTrace("Expected results received");
                pass = true;
            }
    ...
    public void queryTest51() throws Fault {
        ...
        try {
            ...
            if (clist.size() != 0) {
                TestUtil.logErr("Did not get expected results.  Expected 0 references, got: " + clist.size());
            } else {
                TestUtil.logTrace("Expected results received");
                pass = true;
            }
    ...
    public void queryTest52() throws Fault {
        ...
        try {
            ...
            Root<Customer> customer = cquery.from(Customer.class);
            cquery.where(cbuilder.and(
                    cbuilder.isNotNull(customer.get(Customer_.country)),
     ...
     * relationship is NOT NULL. Verify the results were accurately returned.
     */
    @SetupMethod(name = "setupAliasData")
     ...
     *
     * @assertion_ids: PERSISTENCE:SPEC:358; PERSISTENCE:SPEC:1712; PERSISTENCE:SPEC:1713
     *
    ...
    public void queryTest55() throws Fault {
        ...
        try {
            ...
            if (!checkEntityPK(clist, expectedPKs)) {
                TestUtil.logErr("Did not get expected results.  Expected 3 references, got: " + clist.size());
            } else {
                TestUtil.logTrace("Expected results received");
                pass = true;
            }
    ...
    public void queryTest56() throws Fault {
        ...
        try {
            ...
            if (clist.size() != 18) {
                TestUtil.logErr("Did not get expected results.  Expected 18 references, got: " + clist.size());
            } else {
                pass1 = true;
                int numOfNull = 0;
                int foundZip = 0;
    ...
    public void queryTest62() throws Fault {
        ...
        try {
            ...
            if (!checkEntityPK(clist, expectedPKs)) {
                TestUtil.logErr("Did not get expected results.  Expected 2 references, got: " + clist.size());
            } else {
                TestUtil.logTrace("Expected results received");
                pass = true;
            }
    ...
    public void queryTest64() throws Fault {
        ...
        try {
            ...
            Root<Customer> customer = cquery.from(Customer.class);
            cquery.where(cbuilder.equal(
                    customer.get(Customer_.work).get(Address_.city), cbuilder.parameter(String.class, "workcity")));
     ...
     * PERSISTENCE:SPEC:811; PERSISTENCE:JAVADOC:993
     *
    ...
    public void test_groupBy() throws Fault {
        ...
        try {
            ...
            if (!pass) {
                TestUtil.logErr("Did not get expected results.  Expected 4 Country Codes: "
    ...
    public void test_groupBy_1() throws Fault {
        ...
        try {
            ...
            if (!pass) {
                TestUtil.logErr("Did not get expected results.  Expected 3 Credit Card Types: "
     ...
     *
     * @assertion_ids: PERSISTENCE:SPEC:779; PERSISTENCE:SPEC:372; PERSISTENCE:SPEC:372.2; PERSISTENCE:JAVADOC:987
     *
    ...
    public void fetchFetchSingularAttributeTest() throws Fault {
        ...
        try {
            ...
            if (attr.getName().equals(Customer_.spouse.getName())) {
                ...
                TestUtil.logErr("Expected attribute:" + Customer_.spouse.getName() + ", actual:" + attr.getName());
            }
            ...
            if (jt.equals(JoinType.INNER)) {
                ...
                TestUtil.logErr("Expected JoinType:" + JoinType.INNER.name() + ", actual:" + jt.name());
            }
            getEntityTransaction().commit();
        } catch (Exception e) {
    ...
    public void fetchFetchPluralAttributeTest() throws Fault {
        ...
        try {
            ...
            if (attr.getName().equals(Customer_.orders2.getName())) {
                ...
                TestUtil.logErr("Expected attribute:" + Customer_.orders2.getName() + ", actual:" + attr.getName());
            }
            JoinType jt = f1.getJoinType();
            if (jt.equals(JoinType.INNER)) {
                TestUtil.logTrace("Received expected JoinType:" + jt.name());
    ...
    public void fetchFetchStringTest() throws Fault {
        ...
        try {
            ...
            if (attr.getName().equals("creditCard")) {
                ...
                TestUtil.logErr("Expected attribute:creditCard, actual:" + attr.getName());
            }
            JoinType jt = f1.getJoinType();
            if (jt.equals(JoinType.INNER)) {
                TestUtil.logTrace("Received expected JoinType:" + jt.name());
     ...
     *
     * @assertion_ids: PERSISTENCE:JAVADOC:971; PERSISTENCE:SPEC:1698; PERSISTENCE:SPEC:1786; PERSISTENCE:SPEC:1786.2;
     *
     * @test_Strategy:
     */
    @SetupMethod(name = "setupOrderData")
    public void fetchFetchStringJoinTypeTest() throws Fault {
        ...
        try {
            ...
            if (attr.getName().equals("creditCard")) {
                ...
                TestUtil.logErr("Expected attribute:" + Customer_.orders.getName() + ", actual:" + attr.getName());
            }
            JoinType jt = f1.getJoinType();
            if (jt.equals(JoinType.INNER)) {
                TestUtil.logTrace("Received expected JoinType:" + jt.name());
     ...
     */
    @SetupMethod(name = "setupOrderData")
    public void fetchFetchStringJoinTypeIllegalArgumentExceptionTest() throws Fault {
        boolean pass = false;
        ...
        if (!pass) {
            throw new Fault("fetchFetchStringJoinTypeIllegalArgumentExceptionTest failed");
        }
    }
    ...
    public void fetchTest() throws Fault {
        ...
        try {
            ...
            if (jt.equals(JoinType.LEFT)) {
                ...
                TestUtil.logErr("Expected JoinType:" + JoinType.LEFT.name() + ", actual:" + jt.name());
            }

            /*
             * JoinType.RIGHT Not Required in JPA 2.0 jt = customer.fetch(Customer_.spouse,JoinType.RIGHT).getJoinType(); if
             * (jt.equals(JoinType.RIGHT)) { TestUtil.logTrace("Received expected JoinType"); pass=true; } else {
             * TestUtil.logErr("Expected JoinType:" + JoinType.RIGHT.name() + ", actual:" + jt.name()); }
             */
     ...
     *
     * @test_Strategy: Get FetchParent then get the fetches that it contains and verify we got the correct one.
     */
    @SetupMethod(name = "setupCustomerData")
    public void fetchGetParentTest() throws Fault {
        ...
        try {
            ...
            if (f.size() == 1) {
                ...
                TestUtil.logErr("Expected 1 fetch to be returned from FetchParent.getFetches(), got:" + f.size());
                for (Fetch tmpFetch : f) {
                    String name = tmpFetch.getAttribute().getName();
     ...
     *
     * @assertion_ids: PERSISTENCE:SPEC:781; PERSISTENCE:SPEC:774; PERSISTENCE:SPEC:776; PERSISTENCE:JAVADOC:974;
     * PERSISTENCE:JAVADOC:982; PERSISTENCE:JAVADOC:974; PERSISTENCE:JAVADOC:1017;
     *
    ...
    public void test_fetchjoin_1x1() throws Fault {
        ...
        try {
            ...
            if (cFetches.size() != 0) {
                TestUtil.logErr("Did not get correct number of fetches, expected:0, actual:" + cFetches.size());
            ...
            if (cFetches.size() == 1) {
                TestUtil.logTrace("Received expected number of fetches" + cFetches.size());
            } else {
                TestUtil.logErr("Did not get correct number of fetches, expected:1, actual:" + cFetches.size());
                for (Object o : cFetches) {
                    TestUtil.logErr("Fetch:" + o.toString());
                }
            }
     ...
     * PERSISTENCE:JAVADOC:977; PERSISTENCE:SPEC:1715;
     *
    ...
    public void test_fetchjoin_Mx1() throws Fault {
        ...
        try {
            ...
            cquery.where(cbuilder.equal(
                    order.get(Order_.customer).get(Customer_.home).get(Address_.city), "Lawrence"))
                    .select(order);
            TypedQuery<Order> tquery = getEntityManager().createQuery(cquery);
            tquery.setMaxResults(orderRef.length);
            List<Order> result = tquery.getResultList();
    ...
    public void test_fetchjoin_Mx1_1() throws Fault {
        ...
        try {
            ...
            Root<Order> order = cquery.from(Order.class);
            order.fetch(Order_.customer, JoinType.LEFT);
            cquery.where(cbuilder.like(order.get(Order_.customer).get(Customer_.name), "%Caruso"))
                    .select(order);
            TypedQuery<Order> tquery = getEntityManager().createQuery(cquery);
            tquery.setMaxResults(orderRef.length);
            List<Order> result = tquery.getResultList();
     ...
     * PERSISTENCE:JAVADOC:189; PERSISTENCE:SPEC:1049; PERSISTENCE:SPEC:1059; PERSISTENCE:SPEC:1060
     *
    ...
    public void test_ANDconditionFT() throws Fault {
        ...
        try {
            ...
            cquery.where(
                    ...
                    cbuilder.lt(order.get(Order_.totalPrice), 1000))
                    .select(order);
            TypedQuery<Order> tquery = getEntityManager().createQuery(cquery);
            tquery.setMaxResults(orderRef.length);
            List<Order> result = tquery.getResultList();
    ...
    public void test_ORconditionTT() throws Fault {
        ...
        try {
            ...
            cquery.where(cbuilder.or(
                    cbuilder.equal(order.get(Order_.customer).get(Customer_.name), "Karen R. Tegan"),
                    cbuilder.gt(order.get(Order_.totalPrice), 5000)))
                    .select(order);
            TypedQuery<Order> tquery = getEntityManager().createQuery(cquery);
            tquery.setMaxResults(orderRef.length);
            List<Order> result = tquery.getResultList();
    ...
    public void test_lowerHavingClause() throws Fault {
        ...
        try {
            ...
            cquery.select(cbuilder.count(customer.get(Customer_.country).get(Country_.code)))
                    ...
                    .having(cbuilder.equal(
                            cbuilder.lower(customer.get(Customer_.country).get(Country_.code)), "gbr"));
            TypedQuery<Long> tquery = getEntityManager().createQuery(cquery);
            List<Long> result = tquery.getResultList();
            ...
            if (result.size() == 1) {
                ...
                TestUtil.logErr("Did not get expected results. Expected 1, got: " + result.size());
            }
    ...
    public void test_upperHavingClause() throws Fault {
        ...
        try {
            ...
            cquery.select(cbuilder.count(customer.get(Customer_.country).get(Country_.country)))
                    ...
                    .having(cbuilder.equal(
                            cbuilder.upper(customer.get(Customer_.country).get(Country_.country)), "ENGLAND"));
            TypedQuery<Long> tquery = getEntityManager().createQuery(cquery);
            List<Long> result = tquery.getResultList();
    ...
    public void test_lengthHavingClause() throws Fault {
        ...
        try {
            ...
            if (!pass) {
                TestUtil.logErr("Did not get expected results.  Expected 2 Cities, got: " + result.size());
            }
    ...
    public void test_locateHavingClause() throws Fault {
        ...
        try {
            ...
            if (!pass) {
                TestUtil.logErr("Did not get expected results.  Expected 2 Customers, got: " + result.size());
            }
     ...
     * cbuilder.equal(cbuilder.trim(CriteriaBuilder.Trimspec.BOTH, trim.get(Trim_.name)), expected2)); TypedQuery<String>
     * tquery = getEntityManager().createQuery(cquery); result = tquery.getSingleResult();
     *
     ...
     *
     *
     * try { getEntityTransaction().begin(); Trim tTrim = getEntityManager().find(Trim.class, "19");
     * TestUtil.logTrace("Trim(19):" + tTrim.toString()); if (!tTrim.getName().equals(expected)) {
     * TestUtil.logErr("Name returned by find does not match expected"); TestUtil.logErr("Expected:|" + expected +
     * "|, actual:|" + tTrim.getName() + "|"); }
     *
     * CriteriaQuery<String> cquery = cbuilder.createQuery(String.class); Root<Trim> trim = cquery.from(Trim.class);
     * cquery.select(trim.get(Trim_.name)).groupBy(trim.get(Trim_.name)).having(
     * cbuilder.equal(cbuilder.trim(CriteriaBuilder.Trimspec.LEADING, trim.get(Trim_.name)), expected2)); TypedQuery<String>
     * tquery = getEntityManager().createQuery(cquery); result = tquery.getSingleResult();
     *
     * if (expected.equals(result)) { pass = true; TestUtil.logTrace("Expected results received"); } else {
     * TestUtil.logErr("Did not get expected results," + "Expected:|" + expected + "|, got: |" + result + "|"); }
     ...
     * CriteriaQuery<String> cquery = cbuilder.createQuery(String.class); Root<Trim> trim = cquery.from(Trim.class);
     * cquery.select(trim.get(Trim_.name)).groupBy(trim.get(Trim_.name)).having(
     * cbuilder.equal(cbuilder.trim(CriteriaBuilder.Trimspec.TRAILING, trim.get(Trim_.name)), expected2));
    ...
    public void test_SQRTWhereClause() throws Fault {
        ...
        try {
            ...
            cquery.where(cbuilder.gt(
                    cbuilder.sqrt(order.get(Order_.totalPrice)),
                    cbuilder.parameter(Double.class, "doubleValue")))
                    .select(order);
            TypedQuery<Order> tquery = getEntityManager().createQuery(cquery);
        ...
        try {
            ...
            if (parent != null) {
                ...
                if (parent instanceof CriteriaQuery || parent instanceof Subquery) {
                    ...
                    TestUtil.logErr("getParent() did not return a query of type CriteriaQuery or Subquery:" + parent);
                }
            } else {
            ...
            if (selExpression1.getJavaType().equals(selExpression2.getJavaType())) {
                TestUtil.logTrace("Received expected selection expression" + selExpression1.getJavaType());
                pass2 = true;
            } else {
     ...
     *
     * @assertion_ids: PERSISTENCE:JAVADOC:1184; PERSISTENCE:JAVADOC:1180; PERSISTENCE:JAVADOC:1200;
     * PERSISTENCE:JAVADOC:1193;
     *
     * @test_Strategy: Test SubQuery with a Having statement.
     */
    @SetupMethod(name = "setupOrderData")
    public void subQueryHavingExpressionTest() throws Fault {
        ...
        try {
             ...
             * ).getResultList(); for (Object obj : q) { String o = (String) obj; TestUtil.logTrace("id:" + o); }
             */
            ...
            if (pred == null) {
                ...
                TestUtil.logErr("Expected null result from subquery.getGroupRestriction() when no restrictions exist:"
                        + pred.toString());
            }
            getEntityTransaction().commit();
        } catch (Exception e) {
    ...
    public void subQueryHavingPredicateArrayTest() throws Fault {
        ...
        try {
            ...
            Predicate[] predArray1 = {
                    cbuilder.greaterThan(order2.get(Order_.id), "3"), cbuilder.lessThan(order2.get(Order_.id), "4")
            };
            sq.having(predArray1);

            // this having overrides the previous
            Predicate[] predArray2 = {
                    cbuilder.greaterThan(order2.get(Order_.id), "1"), cbuilder.lessThan(order2.get(Order_.id), "2")
            };
    ...
    public void subQuerySelectExpressionTest() throws Fault {
        ...
        try {
             ...
             * ).getResultList(); for (Order o : result) { TestUtil.logTrace("id:"+o.getId()+", totalprice:"+o.getTotalPrice()); }
             */
     ...
     *
     * @test_Strategy: Test SubQuery with a Where Expression statement. SELECT o FROM ORDER_TABLE o WHERE o.ID IN (SELECT
     * o2.ID FROM ORDER_TABLE o2 WHERE (o2.ID <= 1 )
     */
    @SetupMethod(name = "setupOrderData")
    public void subQueryWhereExpressionTest() throws Fault {
        ...
        try {
            ...
            TestUtil.logTrace("Received null from subquery.getRestriction() when no restrictions exist");
     ...
     *
     * @assertion_ids: PERSISTENCE:JAVADOC:1178; PERSISTENCE:JAVADOC:1195; PERSISTENCE:JAVADOC:1196;
     * PERSISTENCE:JAVADOC:1202;
     *
     * @test_Strategy: Test SubQuery with a Where Predicate[] statement.
     */
    @SetupMethod(name = "setupOrderData")
    public void subQueryDistinctTest() throws Fault {
        ...
        try {
             ...
             * ).getResultList(); for (Object[] o : q) { TestUtil.logTrace("lineitem id:" + o[0] + ", prod id:" + o[1]+
             * ", prod price:" + o[2]); }
             */
            ...
            if (s.size() == 1) {
                ...
                for (Root r : s) {
                    ...
                    if (name.equals("com.sun.ts.tests.jpa.common.schema30.LineItem")) {
                        ...
                        TestUtil.logErr("Expected Root: com.sun.ts.tests.jpa.common.schema30.LineItem, actual:" + name);
                        pass5 = false;
                    }
                }
            } else {
        ...
        try {
            ...
            if (cJoins != null) {
                if (cJoins.size() == 0) {
                    ...
                    if (cJoins != null) {
                        if (cJoins.size() == 1) {
                            TestUtil.logTrace("Received expected 1 correlated join from subquery.getCorrelatedJoins()");
                            pass = true;
                        } else {
                ...
                TestUtil.logErr("Received null from subquery.getCorrelatedJoins() instead of empty set when non exist");
            }
            getEntityTransaction().commit();
        } catch (Exception e) {
            TestUtil.logErr("Caught unexpected exception:", e);
     ...
     * PERSISTENCE:JAVADOC:1173; PERSISTENCE:JAVADOC:1038;
     *
    ...
    public void getCorrelationParentIllegalStateExceptionTest() throws Fault {
        ...
        try {
            ...
            if (!b) {
                TestUtil.logTrace("Received expected result from isCorrelated(): false");
                pass1 = true;
            } else {
     ...
     *
     * @assertion_ids: PERSISTENCE:JAVADOC:1170; PERSISTENCE:JAVADOC:1175; PERSISTENCE:JAVADOC:1137;
     * PERSISTENCE:JAVADOC:1171;
     *
    ...
    public void test_subquery_ALL_NOTEQ() throws Fault {
        ...
        try {
            ...
            Root<Order> sqo = sq.from(Order.class);
            sq.select(cbuilder.min(sqo.get(Order_.totalPrice)));
            cquery.where(cbuilder.notEqual(o.get(Order_.totalPrice), cbuilder.all(sq)))
                    .select(customer)
                    .distinct(true);
            TypedQuery<Customer> tquery = getEntityManager().createQuery(cquery);
            tquery.setMaxResults(customerRef.length);

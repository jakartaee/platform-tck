...
public class Client extends PMClientBase {
     ...
     *
     * @assertion_ids: PERSISTENCE:SPEC:618; PERSISTENCE:SPEC:622; PERSISTENCE:SPEC:1091; PERSISTENCE:SPEC:1098;
     ...
     * it. The semantics of the persist operation as applied to entity X is as follows: The persist operation is cascaded to
     * entities referenced by X, if the relationship from X to these other entities is annotated with cascade=PERSIST
     * annotation member.
     *
     * Invoke persist on a ManyToMany relationship from X annotated with cascade=PERSIST and ensure the persist operation is
     * cascaded.
     *
     */
     ...
     *
     * Test the remove semantics of a ManyToMany relationship when the related entity has NOT been annotated with REMOVE.
     *
     */
     ...
     * true: If the entity has been retrieved from the database and has not been removed or detached.
     *
     */
    public void persistMXMTest6() throws Fault {
        ...
        try {
            ...
            TestUtil.logErr("Unexpected exception caught trying to remove " + "entity instance :", e);
            pass = false;
        } finally {
            try {
                if (getEntityTransaction().isActive()) {
     ...
     *
     * @assertion_ids: PERSISTENCE:SPEC:618; PERSISTENCE:SPEC:622; PERSISTENCE:SPEC:2037;
     *
     * @test_Strategy: The new entity bean instance becomes both managed and persistent by invoking the persist method on
    ...
    private void removeTestData() {
        ...
        try {
            getEntityTransaction().begin();
            getEntityManager()
                    .createNativeQuery("DELETE FROM FKEYS_MXM_BI_BTOB")
                    .executeUpdate();

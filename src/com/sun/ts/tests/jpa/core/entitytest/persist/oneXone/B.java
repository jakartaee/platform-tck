...
public class B implements java.io.Serializable {
  ...
  @OneToOne(targetEntity = com.sun.ts.tests.jpa.core.entitytest.persist.oneXone.A.class, cascade = CascadeType.PERSIST, fetch = FetchType.EAGER, orphanRemoval = true)

    ...
    public void abstractEntityTest3() throws Fault {
        ...
        try {
            ...
            result = getEntityManager()
                    .createQuery("Select e from Employee e where e.id between :param1 and :param2")
                    .setParameter("param1", 4)
                    .setParameter("param2", 7)
                    .setMaxResults(10)
                    .getResultList();
            ...
            if (result.size() != 4) {
                ...
                while (i.hasNext()) {
                    ...
                    if (e.getLastName().equals("Lee")
                            || e.getLastName().equals("Martin")

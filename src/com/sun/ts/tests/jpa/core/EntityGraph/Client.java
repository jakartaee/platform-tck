...
public class Client extends PMClientBase {
     ...
     */
    public void addAttributeNodesStringArrayIllegalArgumentExceptionTest() throws Fault {
        boolean pass = false;
    ...
    public void createEntityGraphStringTest() throws Fault {
        ...
        try {
            ...
            if (eg == null) {
                ...
                TestUtil.logErr("Non-null EntityGraph was returned instead of a null:" + eg.getName());
            }
        } catch (Exception ex) {
    ...
    public void entityGraphGetNameTest() throws Fault {
        ...
        if (eg != null) {
            if (eg.getName().equals(expected)) {
                ...
                TestUtil.logErr("Expected name: " + expected + ", actual:" + eg.getName());
            }
        } else {
            TestUtil.logErr("Null was returned for EntityGraph that does exist");
        }
    ...
    public void getEntityGraphStringIllegalArgumentExceptionTest() throws Fault {
        ...
        if (!pass) {
            throw new Fault("getEntityGraphStringIllegalArgumentExceptionTest failed");
        }
    }
        ...
        if (eg2 != null) {
            if (eg2.getName() != null) {
                if (eg2.getName().equals(sExpected)) {
                    ...
                    TestUtil.logErr("Expected: named_entity_graph, actual:" + eg2.getName());
                }
            } else {
                TestUtil.logErr("getName() returned null for a named entity graph added via addNamedEntityGraph");
            }
        } else {
    ...
    public void getEntityGraphsClassIllegalArgumentExceptionTest() throws Fault {
        ...
        if (!pass) {
            throw new Fault("getEntityGraphsClassIllegalArgumentExceptionTest failed");
        }
    }

...
public class Util extends PMClientBase {
    ...
    public void setupCustAliasProductData(String[] args, Properties p) throws Fault {
    ...
    public void setupDepartmentEmployeeData(String[] args, Properties p) throws Fault {
    ...
    public void createOrderData() throws Exception {
        ...
        try {
            ...
            totalPrice = hardwareRef[2].getPrice()
                    + hardwareRef[3].getPrice()
                    + softwareRef[1].getPrice()
    ...
    public void removeTestData() {
        ...
        try {
            ...
            getEntityManager()
                    .createNativeQuery("DELETE FROM FKS_ALIAS_CUSTOMER")
                    .executeUpdate();
            ...
            getEntityManager()
                    .createNativeQuery("UPDATE ORDER_TABLE SET FK4_FOR_CUSTOMER_TABLE= NULL")
                    .executeUpdate();
            getEntityManager()

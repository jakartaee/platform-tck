...
public abstract class BusinessTimerBeanBase extends TimerBeanBase {
    @SuppressWarnings("unused")
    @AroundInvoke
    private Object aroundInvoke(InvocationContext inv) throws Exception {
        TimerUtil.createMillisecondLaterTimer(timerService, "BusinessTimerBeanBase.aroundInvoke", false);
        return inv.proceed();
    }
}

...
public class ScheduleBean extends TimerBeanBase {
  ...
  public String isCalendarTimerAndGetSchedule() {
    ...
    // false, sb);
    isCalendarTimerAndGetSchedule0(timerService.createSingleActionTimer(initial,
        new TimerConfig(info, false)), false, sb);
    // isCalendarTimerAndGetSchedule0(timerService.createTimer(initial.getTime(),
    // info), false, sb);
    isCalendarTimerAndGetSchedule0(timerService.createSingleActionTimer(
        initial.getTime(), new TimerConfig(info, false)), false, sb);
    // isCalendarTimerAndGetSchedule0(timerService.createTimer(initial,
    // interval, info), false, sb);
    isCalendarTimerAndGetSchedule0(timerService.createIntervalTimer(initial,
        interval, new TimerConfig(info, false)), false, sb);
    // isCalendarTimerAndGetSchedule0(timerService.createTimer(initial.getTime(),
    // interval, info), false, sb);
    isCalendarTimerAndGetSchedule0(timerService.createIntervalTimer(
        initial.getTime(), interval, new TimerConfig(info, false)), false, sb);

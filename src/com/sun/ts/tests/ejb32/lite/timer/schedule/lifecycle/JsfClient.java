...
public class JsfClient extends JsfClientBase {
    ...
    public static final File TIMER_STORE = new File(TIMER_STORE_DIR, TIMER_STORE_NAME);
    ...
    public void timerHandle() throws IOException, ClassNotFoundException {
        ...
        assertEquals("Confirm the timer no long exists", null, scheduleBean.findTimer(ScheduleBean.YEAR_5000));
    ...
    public void timerEquals() {
        ...
        Timer t2 = scheduleBean.createFarFutureTimer(new TimerConfig(new TimerInfo(getTestName()), false));
        // Timer t3 = scheduleBean.createTimer(exp, getTestName());
        Timer t3 = scheduleBean.createTimer(exp, new TimerConfig(new TimerInfo(getTestName()), false));
        // Timer t4 = scheduleBean.createTimer(exp, getTestName());
        Timer t4 = scheduleBean.createTimer(exp, new TimerConfig(new TimerInfo(getTestName()), false));
        String t1Name = getTestName() + "t1";
        Timer t1 = scheduleBean.createSecondLaterTimer(new TimerConfig(new TimerInfo(t1Name), false));
    ...
    public void createAndComplete() {
        ...
        scheduleBean.createSecondLaterTimer(new TimerConfig(new TimerInfo(getTestName()), false));
    ...
    public void completeAndNoSuchObjectLocalException() {
        ...
        Timer t = scheduleBean.createSecondLaterTimer(new TimerConfig(new TimerInfo(getTestName()), false));
        passIfTimeoutOnce();
    ...
    public void cancelAndNoSuchObjectLocalException() {
        ...
        Timer t = scheduleBean.createFarFutureTimer(new TimerConfig(new TimerInfo(getTestName()), false));

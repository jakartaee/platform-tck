...
import static com.sun.ts.tests.ejb30.timer.common.ScheduleAttributeType.*;
...
import com.sun.ts.tests.ejb30.timer.common.*;
...
public class ScheduleBean extends TimerBeanBaseWithoutTimeOutMethod {
  ...
  public void validStartEnd(StringBuilder sb) {
    ...
    Timer timer = timerService.createCalendarTimer(exp,
        new TimerConfig(null, false));
    sb.append(" Created a timer with schedule ").append(TimerUtil.toString(exp))
  ...
  public void validTimeZone(StringBuilder sb) {
    ...
    Timer timer = timerService.createCalendarTimer(exp,
        new TimerConfig(null, false));
    sb.append(" Created a timer with timezone ").append(TimerUtil.toString(exp))
        .append(TestUtil.NEW_LINE);
  }

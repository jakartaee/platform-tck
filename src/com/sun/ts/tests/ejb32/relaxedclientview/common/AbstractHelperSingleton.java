...
public class AbstractHelperSingleton implements HelperSingleton, TestConstants {
    ...
    public String oneRemoteAnnotationOnInterfaceTest() throws TestFailedException {
        ...
        if (obj != null) {
            try {
                ...
                return String.format(SUCCESSFULLY_RUN_RESULT, "oneRemoteAnnotationOnInterfaceTest");
            }
    ...
    public String oneRemoteAnnotationOnEjbTest() throws TestFailedException {
        ...
        if (obj != null) {
            try {
                ...
                return String.format(SUCCESSFULLY_RUN_RESULT, "oneRemoteAnnotationOnEjbTest");
            }

            throw new TestFailedException(
                    String.format(JNDI_SHOULD_NOT_BE_FOUND, ONE_REMOTE_ANNOTATION_ON_EJB_TEST_JNDI));
        }
        return String.format(SUCCESSFULLY_RUN_RESULT, "oneRemoteAnnotationOnEjbTest");
    }
    ...
    public String noInterfaceViewTest() throws TestFailedException {
        ...
        NormalInterface1 beanIf1 = (NormalInterface1) findEjbByJndi(NO_INTERFACE_VIEW_TEST_BEAN_JNDI);
        if (beanIf1 == null) {
            throw new TestFailedException(String.format(JNDI_NOT_FOUNT, NO_INTERFACE_VIEW_TEST_BEAN_JNDI));
        }
        ...
        if (obj != null) {
            ...
            throw new TestFailedException(String.format(JNDI_SHOULD_NOT_BE_FOUND, NO_INTERFACE_VIEW_TEST_IF2_JNDI));
        }
    ...
    public String localDDTest() throws TestFailedException {
        ...
        if (obj != null) {
            ...
            throw new TestFailedException(String.format(JNDI_SHOULD_NOT_BE_FOUND, LOCAL_DD_TEST_JNDI));
        }

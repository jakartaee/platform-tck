...
public class WSCClient extends WebSocketCommonClient {
    ...
    public void linkedListHashSetTextHandlerTest() throws Fault {
        invoke(
                TypeEnum.LINKEDLIST_HASHSET_TEXT.name().toLowerCase(),
                ECHO,
                LinkedListHashSetMessageHandler.HANDLER_SAYS,
                ECHO);
        logMsg(
    ...
    public void byteBufferMessageHandlerTest() throws Fault {
        invoke(
                TypeEnum.BYTEBUFFER_WHOLE.name().toLowerCase(),
                ByteBuffer.wrap(ECHO.getBytes()),
                ByteBufferMessageHandler.HANDLER_SAYS,
                ECHO);
    ...
    public void byteArrayMessageHandlerTest() throws Fault {
        invoke(
                TypeEnum.BYTEARRAY_WHOLE.name().toLowerCase(),
                ByteBuffer.wrap(ECHO.getBytes()),
                ByteArrayMessageHandler.HANDLER_SAYS,
                ECHO);
    ...
    public void inputStreamMessageHandlerTest() throws Fault {
        invoke(
                TypeEnum.INPUTSTREAM.name().toLowerCase(),
                ByteBuffer.wrap(ECHO.getBytes()),
    ...
    public void binaryStringBeanMessageHandlerTest() throws Fault {
        invoke(
                TypeEnum.STRINGBEANBINARY.name().toLowerCase(),
                ByteBuffer.wrap(ECHO.getBytes()),
                StringBeanMessageHandler.HANDLER_SAYS,
                ECHO);
        logMsg("addMessageHandler(StringBean.class, Whole<StringBean>) works as expected.");
    }
    ...
    public void binaryStreamStringBeanMessageHandlerTest() throws Fault {
        invoke(
                TypeEnum.STRINGBEANBINARYSTREAM.name().toLowerCase(),
                ByteBuffer.wrap(ECHO.getBytes()),
                StringBeanMessageHandler.HANDLER_SAYS,
                ECHO);
        logMsg("addMessageHandler(StringBean.class, Whole<StringBean>) works as expected.");
    ...
    public void stringPartialHandlerTest() throws Fault {
        ...
        setProperty(
                Property.REQUEST, buildRequest(TypeEnum.STRING_PARTIAL.name().toLowerCase()));
    ...
    public void byteArrayPartialMessageHandlerTest() throws Fault {
        ...
        setProperty(Property.SEARCH_STRING, ECHO_PARTIAL);
        setProperty(
                Property.REQUEST, buildRequest(TypeEnum.BYTEARRAY_PARTIAL.name().toLowerCase()));

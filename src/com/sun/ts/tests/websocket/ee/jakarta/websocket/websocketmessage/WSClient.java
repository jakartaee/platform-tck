...
public class WSClient extends WebSocketCommonClient {
    ...
    public void stringToAllNumbersTest() throws Fault {
        ...
        invokeSequence(
                0, String.valueOf(entity) + param, "primitive", "sessionpathparam/" + param, TEXT_PRIMITIVE_SEQUENCE);
    ...
    private void invokeTextSequencesWithPathParam(int startIndex, String content, String pathParam) throws Fault {

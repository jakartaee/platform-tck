    ...
    public void test1() throws Fault {
        ...
        try {
            ...
            final Session session = clientContainer.connectToServer(
                    com.sun.ts.tests.websocket.ee.jakarta.websocket.sessionexception.WSClient.TCKBasicEndpoint.class,
                    config,
            ...
            if (tmp != session) {
                ...
                receivedMessageString.append(
                        "========Incorrect session returned,  expecting " + session + ", got " + tmp);
            }
            ...
            if (!message_expected.equals(msg)) {
                passed = false;
                receivedMessageString.append(
                        "========Incorrect message returned,  expecting " + message_expected + ", got " + msg);
            }
            ...
            if (cause_expected != cause) {
                passed = false;
                receivedMessageString.append(
                        "========Incorrect cause returned,  expecting " + cause_expected + ", got " + cause);
            }

...
public class WSClient extends WebSocketCommonClient {
     ...
     * WebSocket:SPEC:WSC-2.2.2-1; WebSocket:SPEC:WSC-2.2.3-1; WebSocket:SPEC:WSC-4.4-1; WebSocket:SPEC:WSC-4.4-2;
     *
     * @test_Strategy:
     */
     ...
     * WebSocket:JAVADOC:122; WebSocket:SPEC:WSC-2.2.2-1; WebSocket:SPEC:WSC-2.2.3-1;
     *
     * @test_Strategy:
     */
     ...
     * WebSocket:JAVADOC:122; WebSocket:SPEC:WSC-2.1.3-1; WebSocket:SPEC:WSC-2.1.3-2; WebSocket:SPEC:WSC-2.2.2-1;
     ...
     * WebSocket:JAVADOC:121; WebSocket:JAVADOC:122; WebSocket:JAVADOC:134; WebSocket:JAVADOC:147;
        ...
        try {
            ...
            for (MessageHandler msgHander : msgHanders) {
                ...
                receivedMessageString.append(
                        "MessageHandler=" + session.getMessageHandlers().size());
            }

            passed = MessageValidator.checkSearchStrings(
                    "TCKBasicEndpoint OnOpen|"
     ...
     * WebSocket:JAVADOC:145; WebSocket:SPEC:WSC-4.5-1;
     *
     * @test_Strategy:
     */
     ...
     * @assertion_ids: WebSocket:JAVADOC:28; WebSocket:JAVADOC:8; WebSocket:JAVADOC:10; WebSocket:JAVADOC:159;
     * WebSocket:JAVADOC:69; WebSocket:JAVADOC:79; WebSocket:JAVADOC:128; WebSocket:JAVADOC:112; WebSocket:JAVADOC:123;
     * WebSocket:JAVADOC:145; WebSocket:SPEC:WSC-2.2.2-1; WebSocket:SPEC:WSC-2.2.3-1; WebSocket:SPEC:WSC-2.1.5-1;
     ...
     * WebSocket:JAVADOC:145; WebSocket:JAVADOC:19; WebSocket:JAVADOC:20; WebSocket:SPEC:WSC-2.2.2-1;
     ...
     * @assertion_ids: WebSocket:JAVADOC:28; WebSocket:JAVADOC:8; WebSocket:JAVADOC:10; WebSocket:JAVADOC:159;
     * WebSocket:JAVADOC:69; WebSocket:JAVADOC:79; WebSocket:JAVADOC:128; WebSocket:JAVADOC:112; WebSocket:JAVADOC:125;
     * WebSocket:JAVADOC:145; WebSocket:JAVADOC:19; WebSocket:JAVADOC:20; WebSocket:SPEC:WSC-2.1.5-1;
    ...
    public void close12Test() throws Fault {
        ...
        try {
            ...
            passed = MessageValidator.checkSearchStrings(
                    "TCKCloseEndpoint OnOpen|" + "TCKTestServer opened|" + "TCKCloseEndpoint OnClose|"
                            + "TCKCloseEndpoint OnError",
                    receivedMessageString.toString());
    ...
    public void setMaxTextMessageBufferSizeTest() throws Fault {
        ...
        try {
            ...
            System.out.println(
                    "getMaxTextMessageBufferSize returned default value =" + session.getMaxTextMessageBufferSize());
            session.setMaxTextMessageBufferSize(size);
            int tmp = session.getMaxTextMessageBufferSize();
            if (tmp == size) {
                System.out.println("getMaxTextMessageBufferSize returned expected value =" + tmp);
            } else {
                System.out.println("getMaxTextMessageBufferSize returned unexpected value =" + tmp);
    ...
    public void setTimeoutTest() throws Fault {
        ...
        try {
            ...
            System.out.println(
                    "getMaxIdleTimeout returned default value on client side =" + session.getMaxIdleTimeout());
            ...
            if (tmp == tt) {
                ...
                System.out.println("getMaxIdleTimeout returned unexpected value =" + tmp);
    ...
    public void setTimeout1Test() throws Fault {
        ...
        try {
            ...
            if (receivedMessageString.indexOf("AnyString=") > -1
                ...
                passed = false;
                System.err.println("Test failed due to message sent and/or received after timeout from client side");
            }
            if (!passed) {
                throw new Fault("Test failed with incorrect response");
            }
    ...
    public void setTimeout2Test() throws Fault {
        ...
        try {
            ...
            if (receivedMessageString.indexOf("AnyString=") > -1
                    || receivedMessageString.indexOf("TCKTestServer second message after sleep") > -1) {
                passed = false;
                System.err.println("Test failed due to message sent and/or received after timeout from server side");
            }
     ...
     *
     * @assertion_ids: WebSocket:JAVADOC:28; WebSocket:JAVADOC:8; WebSocket:JAVADOC:10; WebSocket:JAVADOC:159;
     * WebSocket:JAVADOC:69; WebSocket:JAVADOC:79; WebSocket:JAVADOC:128; WebSocket:JAVADOC:112; WebSocket:SPEC:WSC-2.2.2-1;
     * WebSocket:JAVADOC:138; WebSocket:SPEC:WSC-4.4-1; WebSocket:SPEC:WSC-4.4-2;
     *
     * @test_Strategy:
     */
    public void getPathParametersTest() throws Fault {
        ...
        try {
            ...
            Session session = clientContainer.connectToServer(
                    TCKBasicEndpoint.class,
                    config,
                    new URI("ws://" + _hostname + ":" + _port + CONTEXT_ROOT + "/TCKTestServerPathParam/" + param1 + "/"
                            + param2));
            messageLatch.await(_ws_wait, TimeUnit.SECONDS);
     ...
     *
     * @assertion_ids: WebSocket:JAVADOC:28; WebSocket:JAVADOC:8; WebSocket:JAVADOC:10; WebSocket:JAVADOC:159;
     * WebSocket:JAVADOC:69; WebSocket:JAVADOC:79; WebSocket:JAVADOC:128; WebSocket:JAVADOC:112; WebSocket:JAVADOC:139;
     * WebSocket:SPEC:WSC-2.2.2-1; WebSocket:SPEC:WSC-4.4-1;
     *
     * @test_Strategy:
     */
    public void getProtocolVersionTest() throws Fault {
        ...
        assertEquals(
                ...
                getSession().getProtocolVersion(),
                "getProtocolVersion() is not",
                expectedProtocolVersion,
                "as expected");
    ...
    public void getOpenSessionsTest() throws Fault {
        ...
        try {
            ...
            messageLatch = new CountDownLatch(2);
            Session session1 = clientContainer.connectToServer(
                    TCKOpenSessionEndpoint.class,
                    config,
                    new URI("ws://" + _hostname + ":" + _port + CONTEXT_ROOT + "/TCKTestServer"));
            messageLatch.await(_ws_wait, TimeUnit.SECONDS);
            ...
            messageLatch = new CountDownLatch(2);
            Session session2 = clientContainer.connectToServer(
                    TCKOpenSessionEndpoint.class,
                    config,
                    new URI("ws://" + _hostname + ":" + _port + CONTEXT_ROOT + "/TCKTestServer"));
            messageLatch.await(_ws_wait, TimeUnit.SECONDS);
    ...
    public static final class TCKBasicEndpoint extends Endpoint {
        ...
        public void onOpen(Session session, EndpointConfig config) {
            ...
            session.addMessageHandler(new MessageHandler.Whole<ByteBuffer>() {
                ...
                public void onMessage(ByteBuffer data) {
                    ...
                    data.get(data1);
                    receivedMessageString.append(
                            "========Basic ByteBuffer MessageHander received=" + new String(data1));
                    messageLatch.countDown();
                }
            });
        }
    ...
    public static final class TCKGetIdEndpoint extends EndpointCallback {

        @Override
        public void onOpen(Session session, EndpointConfig config) {
            ClientEndpoint.getMessageBuilder()
                    .append("======Another SessionID=")
                    .append(session.getId());
            System.out.println(session.getId());
        }
    }

    public static final class TCKBasicStringEndpoint extends ClientEndpoint<String> {
    ...
    public static final class TCKBasicByteEndpoint extends ClientEndpoint<ByteBuffer> {
            ...
            try {
                session.addMessageHandler(new MessageHandler.Whole<ByteBuffer>() {
                    ...
                    public void onMessage(ByteBuffer data) {
                        ...
                        getMessageBuilder()
                                .append("========Second Basic ByteBuffer MessageHander received=")
                                .append(message_string);
                        getCountDownLatch().countDown();
                    }
                });
    ...
    public static final class TCKOpenSessionEndpoint extends Endpoint {
    ...
    public static final class TCKCloseEndpoint extends Endpoint {

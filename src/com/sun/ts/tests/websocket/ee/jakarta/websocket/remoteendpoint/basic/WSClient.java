...
public class WSClient extends WebSocketCommonClient {
    ...
    private void sendOnServer(OPS ops, Object search, Class<? extends ClientEndpoint<?>> endpoint) throws Fault {
    ...
    private void sendOnClientThrowsException(final OPS op, final String exception) throws Fault {
        EndpointCallback callback = new BasicEndpointCallback() {
            @Override
            void doBasic(Basic basicRemote) throws Fault {
                String ret = null;

...
public class WSClient extends WebSocketCommonClient {
    ...
    public void dataTypesTest() throws Fault {
        ...
        invokeSequence(
                String.valueOf(Short.MIN_VALUE), new WSCPrimitiveIntClientEndpoint(), new WSCFullIntClientEndpoint());
        invokeSequence(
                String.valueOf(Short.MIN_VALUE), new WSCPrimitiveLongClientEndpoint(), new WSCFullLongClientEndpoint());
        invokeSequence(
                String.valueOf(123.456f), new WSCPrimitiveFloatClientEndpoint(), new WSCFullFloatClientEndpoint());
        invokeSequence(
                String.valueOf(789.012), new WSCPrimitiveDoubleClientEndpoint(), new WSCFullDoubleClientEndpoint());
    ...
    // Private -----------------------------------------
    private void invokeSequence(String search, AnnotatedClientEndpoint<?>... endpoints) throws Fault {

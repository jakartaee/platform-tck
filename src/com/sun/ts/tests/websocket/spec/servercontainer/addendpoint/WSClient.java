...
public class WSClient extends WebSocketCommonClient {
    ...
    public static final class TCKBasicStringEndpoint extends Endpoint {
    ...
    public static final class TCKBasicByteEndpoint extends Endpoint {

...
public class NegativeDeploymentClient extends WebSocketCommonClient {
    ...
    public void setup(String[] args, Properties p) throws Fault {
        ...
        assertFalse(isNullOrEmpty(tslib_name), "'tslib.name' was not set in the build.properties.");
    }
    ...
    protected void throwDeploymentDidNotFail() throws Fault {
        throw new Fault("Test Failed - expected deployment to fail, but it succeeded!");
    }
}

 ...
 */
/**
 * @OnMessage can contain any java class the decoder for it exists. This test checks the StringHolder argument.
 * @since 1.11
 */
public class WSCClient extends NegativeDeploymentClient {
     ...
     *
     * To check the test fails when deployment pass, switch the StringHolder argument to String in @OnMessage of

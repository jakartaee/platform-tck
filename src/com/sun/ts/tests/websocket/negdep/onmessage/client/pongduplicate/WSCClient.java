 ...
 */
/**
 * @OnMessage can contain one pong message handling method. This test checks two such methods fail the deployment.
 * @since 1.11
 */
public class WSCClient extends NegativeDeploymentClient {
     ...
     *
     * @assertion_ids: WebSocket:SPEC:WSC-5.2.1-3;WebSocket:SPEC:WSC-4.7-4; WebSocket:SPEC:WSC-5.2.1-4;
     *

 ...
 */
/**
 * @OnMessage can contain PongMessage. This test checks that PongMessage and boolean pair is out of this scope for
 * partial messages.
 * @since 1.11
 */
public class WSCClient extends NegativeDeploymentClient {
     ...
     *
     * To check the test fails when deployment pass, comment out the boolean parameter in @OnMessage of
     * OnMessageClientEndpoint
     */
    public void pongBooleanOnMessageTest() throws Fault {

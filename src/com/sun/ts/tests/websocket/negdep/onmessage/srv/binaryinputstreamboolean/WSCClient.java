 ...
 */
/**
 * @OnMessage can contain ByteBuffer and boolean pair. This test checks that InputStream and boolean pair is out of this
 * scope for partial messages.
 * @since 1.11
 */
public class WSCClient extends NegativeDeploymentClient {
     ...
     *
     * To check the test fails when deployment pass, comment out the int parameter in @OnMessage of OnMessageServerEndpoint
     */
    public void inputStreamBooleanOnMessageUndeployOtherEndpointTest() throws Fault {
     ...
     * To check the test fails when deployment pass, comment out the int parameter in @OnMessage of OnMessageServerEndpoint
     */
    public void inputStreamBooleanOnMessageTest() throws Fault {
        setEntity(ByteBuffer.wrap("anything".getBytes()));

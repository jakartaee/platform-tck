 ...
 */
/**
 * @OnMessage can contain String and boolean. This test checks that String and int pair is out of this scope for partial
 * messages.
 * @since 1.11
 */
public class WSCClient extends NegativeDeploymentClient {
     ...
     *
     * To check the test fails when deployment pass, comment out int argument in @OnMessage of OnMessageClientEndpoint
     */

 ...
 */
/**
 * @OnMessage can contain Reader. This test checks that Reader and boolean pair is out of this scope for partial
 * messages.
 * @since 1.11
 */
public class WSCClient extends NegativeDeploymentClient {
     ...
     *
     * To check the test fails when deployment pass, comment out boolean argument in @OnMessage of OnMessageClientEndpoint
     */
    public void readerBooleanOnMessageTest() throws Fault {
        setEntity("anything");

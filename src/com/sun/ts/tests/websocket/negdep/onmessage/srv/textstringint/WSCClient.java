 ...
 */
/**
 * @OnMessage can contain String and boolean pair. This test checks that String and int pair is out of this scope.
 * @since 1.11
 */
public class WSCClient extends NegativeDeploymentClient {
     ...
     */
    public void tooManyArgumentsOnMessageUndeployOtherEndpointTest() throws Fault {
     ...
     * To check the test fails when deployment pass, comment out the int parameter in @OnMessage of OnMessageServerEndpoint
     */
    public void tooManyArgumentsOnMessageTest() throws Fault {
        setProperty(Property.CONTENT, "anything");

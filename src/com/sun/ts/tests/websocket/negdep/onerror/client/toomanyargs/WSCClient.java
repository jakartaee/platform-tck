...
public class WSCClient extends NegativeDeploymentClient {
     ...
     *
     * @assertion_ids: WebSocket:SPEC:WSC-5.2.1-3;WebSocket:SPEC:WSC-4.6-3; WebSocket:SPEC:WSC-5.2.1-4;
     *
     ...
     * more than one method may not be deployed by the implementation and the error reported to the deployer. [WSC-4.6-3]
     *
     ...
     *
     * To verify the test fails when the deployment was successful, comment out the CloseReason argument of @OnError in
     * OnErrorServerEndpoint
     */
    public void duplicateOnCloseTest() throws Fault {

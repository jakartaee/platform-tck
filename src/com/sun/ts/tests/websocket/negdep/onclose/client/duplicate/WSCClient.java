...
public class WSCClient extends NegativeDeploymentClient {
     ...
     *
     * @assertion_ids: WebSocket:SPEC:WSC-5.2.1-3;WebSocket:SPEC:WSC-4.5-4; WebSocket:SPEC:WSC-5.2.1-4;
     *
     ...
     *
     * To verify the test fails when the deployment was successful, comment out one of @OnClose in
     * AnnotatedOnCloseClientEndpoint
     */

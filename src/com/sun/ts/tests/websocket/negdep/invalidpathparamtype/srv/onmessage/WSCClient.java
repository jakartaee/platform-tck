...
public class WSCClient extends NegativeDeploymentClient {
     ...
     *
     * To verify the test fails when the deployment was successful, switch StringHolder to String as argument of @OnMessage
     * in OnMessageStringHolderServerEndpoint
     */

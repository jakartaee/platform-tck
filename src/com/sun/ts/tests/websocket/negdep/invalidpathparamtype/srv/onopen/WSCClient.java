...
public class WSCClient extends NegativeDeploymentClient {
     ...
     *
     * To verify the test fails when the deployment was successful, switch StringHolder to String as argument of @OnOpen in
     * OnOpenStringHolderServerEndpoint
     */
    public void invalidTypeOnOpenUndeployOtherEndpointTest() throws Fault {
     ...
     * OnOpenStringHolderServerEndpoint
     */
    public void invalidTypeOnOpenTest() throws Fault {
        setProperty(Property.CONTENT, "anything");

...
public class WSCClient extends WebSocketCommonClient {
     ...
     *
     * @assertion_ids: WebSocket:JAVADOC:175; WebSocket:JAVADOC:15; WebSocket:JAVADOC:210; WebSocket:SPEC:WSC-7.2-1;
     *
     * @test_Strategy: HandshakeRequest.getHttpSession ClientEndpointConfig.Configurator.afterResponse
     * ServerEndpointConfig.Configurator.modifyHandshake
     *
     * the http session or null if either the websocket implementation is not part of a Java EE web container, or there is
     * no HttpSession associated with the opening handshake request.
     *
     * The API allows access in the opening handshake to the unique HttpSession corresponding to that same client.
     *
     * This test is only run as part of CTS, i.e. in full java EE environment, i.e. in servlet container
     */

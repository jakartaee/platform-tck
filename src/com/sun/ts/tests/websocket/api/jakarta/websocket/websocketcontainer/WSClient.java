...
public class WSClient extends ServiceEETest {
    ...
    public void setMaxSessionIdleTimeoutTest() throws Fault {
        ...
        if (client.getDefaultMaxSessionIdleTimeout() != timeout) {
            throw new Fault("Test failed. getMaxSessionIdleTimeout didn't return set value."
    ...
    public void setMaxTextMessageBufferSizeTest() throws Fault {
        ...
        if (expected_msgsize != actual_msgsize) {
            throw new Fault("DefaultMaxTextMessageBufferSize does not match. " + "Expecting " + expected_msgsize
                    + ", got " + actual_msgsize);
        }
    }
    ...
    public void setMaxBinaryMessageBufferSizeTest() throws Fault {
        ...
        if (expected_msgsize != actual_msgsize) {
            throw new Fault("DefaultMaxBinaryMessageBufferSize does not match. " + "Expecting " + expected_msgsize
                    + ", got " + actual_msgsize);
        }
    }
    ...
    public void setAsyncSendTimeoutTest() throws Fault {
        ...
        if (actual_timeout != expected_timeout) {
            throw new Fault("Test failed. getDefaultAsyncSendTimeout didn't return set value." + "Expecting "

...
package com.sun.ts.tests.interop.security.appclient.stateful;
...
public class Client extends EETest {
   ...
   * @assertion_ids: EJB:SPEC:827
   *
   * @test_Strategy: 1. Create a stateful session bean with an unchecked remote
   ...
   *
   * @test_Strategy: 1. Create a stateful session bean with a method on

...
package com.sun.ts.tests.interop.security.ejbclient.bmp;
...
public class Client extends EETest {
   ...
   * @assertion_ids: EJB:SPEC:827
   *
   * @test_Strategy: 1. Create a bmp entity bean accessing an unchecked method
   * of the second entity bean. 2. Deploy the first bmp bean on one J2EE server
   * 3. Deploy the second bmp bean on another J2EE server 4. Verify that access
   * is allowed from the first ejb to the unchecked method.
   */
   ...
   *
   * @test_Strategy: 1. Create a bmp entity bean accessing another bmp entity
   * bean with a method on exclude-list. 2. Deploy the first ejb on one J2EE
   * server 3. Deploy the second bmp bean on another J2EE server 4. Verify
   * java.rmi.RemoteException is generated when the first ejb accessing the
   * method.
   */

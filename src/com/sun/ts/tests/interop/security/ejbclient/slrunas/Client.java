...
package com.sun.ts.tests.interop.security.ejbclient.slrunas;
...
public class Client extends EETest {
   ...
   * @assertion_ids: EJB:SPEC:827
   *
   * @test_Strategy: 1. Create a stateless session bean using runas identity 2.
   * Create another stateless bean with an unchecked method 3. Deploy the first
   ...
   *
   * @test_Strategy: 1. Create a stateless session bean using runas identity 2.
   * Create another stateless bean with a method on exclude-list. 3. Deploy the

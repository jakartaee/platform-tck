...
package com.sun.ts.tests.interop.security.ejbclient.cmprunas;
...
public class Client extends EETest {
   ...
   * 
   * @test_Strategy: 1. Create a cmp entity bean accessing a method from another
   ...
   * 
   * @test_Strategy: 1. Create a cmp entity bean accessing two cmp entity beans
   ...
   * 
   * @test_Strategy: 1. Create a cmp entity bean accessing another bean deployed
   * on another J2EE server with overloaded methods. 2. Call method1 passing
   ...
   *
   * @test_Strategy: 1. Create a cmp entity bean accessing a method from another
   * bean deployed on another J2EE server. 2. Protect the bean method with
   ...
   * @assertion_ids: EJB:SPEC:61.7; EJB:SPEC:81.4
   *
   * @test_Strategy: 1. Create a cmp entity bean using runas identity 2. Create
   * another cmp entity bean with an unchecked method 3. Deploy the first cmp
   * bean on one J2EE server 4. Deploy the second cmp bean on another J2EE
   ...
   *
   * @test_Strategy: 1. Create a cmp entity bean using runas identity 2. Create
   * another cmp entity bean with a method on exclude-list. 3. Deploy the first
   * ejb on one J2EE server 4. Deploy the second cmp bean on another J2EE server

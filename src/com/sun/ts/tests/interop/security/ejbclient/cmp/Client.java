...
package com.sun.ts.tests.interop.security.ejbclient.cmp;
...
public class Client extends EETest {
   ...
   * @assertion_ids: EJB:SPEC:827
   *
   * @test_Strategy: 1. Create a cmp entity bean accessing an unchecked method
   * of the second entity bean. 2. Deploy the first cmp bean on one J2EE server
   * 3. Deploy the second cmp bean on another J2EE server 4. Verify that access
   ...
   *
   * @test_Strategy: 1. Create a cmp entity bean accessing another cmp entity
   * bean with a method on exclude-list. 2. Deploy the first ejb on one J2EE
   * server 3. Deploy the second cmp bean on another J2EE server 4. Verify

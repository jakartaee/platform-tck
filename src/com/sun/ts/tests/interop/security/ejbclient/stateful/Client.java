...
package com.sun.ts.tests.interop.security.ejbclient.stateful;
...
public class Client extends EETest {
   ...
   * @assertion_ids: EJB:SPEC:827
   *
   * @test_Strategy: 1. Create a stateful session bean accessing an unchecked
   ...
   *
   * @test_Strategy: 1. Create a stateful session bean accessing another
   * stateful session bean with a method on exclude-list. 2. Deploy the first

...
public class Client extends EETest {
   ...
   * @assertion_ids: EJB:SPEC:665; EJB:SPEC:666; EJB:SPEC:667; EJB:SPEC:668
   * 
   * @test_Strategy: Create an Entity EJBean via the EJBHome interface. Deploy
   ...
   * @assertion_ids: EJB:SPEC:665; EJB:SPEC:666; EJB:SPEC:667; EJB:SPEC:668
   * 
   * @test_Strategy: Create an Entity EJBean. Deploy it on the J2EE server.
   ...
   * @assertion_ids: EJB:SPEC:665; EJB:SPEC:666; EJB:SPEC:667; EJB:SPEC:668
   * 
   * @test_Strategy: Create an Entity Bean. Deploy it on the J2EE server. Try to
   * Obtain primary.
   *
   */
   ...
   * 
   * @test_Strategy: Create an Entity EJBean. Deploy it on the J2EE server.
   * Obtain the EJBHome Interface. Varify the EJBHome Interface was created.
   */
   ...
   * 
   * @test_Strategy: Create an Entity EJBean. Deploy it on the J2EE server.
   * Remove the Object via the EJBObject. Varify the object no longer exists.
   */
   ...
   * @assertion_ids: EJB:SPEC:665; EJB:SPEC:666; EJB:SPEC:667; EJB:SPEC:668
   * 
   * @test_Strategy: Create a Entity EJBean. Deploy it on the J2EE server. Call
   * the isIdentical(SameObject). verify that the result is true.
   */
   ...
   * @assertion_ids: EJB:SPEC:665; EJB:SPEC:666; EJB:SPEC:667; EJB:SPEC:668
   * 
   * @test_Strategy: Create an Entity EJBean. Deploy it on the J2EE server. Call
   * the isIdentical(newObject). verify that the result is false.
   */
   ...
   * 
   * @test_Strategy: Create an Entity EJBean. Deploy it on the J2EE server. Call
   * objects Business Method. verify that a exception isn't raised
   */
   ...
   * 
   * @test_Strategy: Create an Entity EJBean. Deploy it on the J2EE server. Call
   * the objects business method with and instance of itself as the parameter.
   * 
   */
   ...
   * @assertion_ids: EJB:SPEC:665; EJB:SPEC:666; EJB:SPEC:667; EJB:SPEC:668
   * 
   * @test_Strategy: Obtain EJBMetaData Obtain EJBHome interface Varify EJBHome
   ...
   * Varify that EJB home Interface was obtained
   */
   ...
   * @assertion_ids: EJB:SPEC:665; EJB:SPEC:666; EJB:SPEC:667; EJB:SPEC:668
   * 
   * @test_Strategy: Obtain EJBMetaData Call isSession on the Entity Bean Varify

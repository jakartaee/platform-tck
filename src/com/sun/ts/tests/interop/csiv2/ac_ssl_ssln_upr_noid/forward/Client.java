...
package com.sun.ts.tests.interop.csiv2.ac_ssl_ssln_upr_noid.forward;
...
public class Client extends EETest {
   ...
   * CSIv2:SPEC:43; EJB:SPEC:745
   * 
   * @test_Strategy: Required by EJB2.0 Spec Section 19.8.2.3 item 2:
   *
   ...
   * 
   * 4) Verify the following a) SAS identity token = NONE b) transport client
   * principal = NONE c) SAS client authentication principal = P2 (GSSUP)
   *
   */
  public void ac_ssl_ssln_upr_noid_sb_testid2() throws Fault {

    boolean pass = true;
    String testName = "ac_ssl_ssln_upr_noid_sb_testid2";
    ...
    pass = CSIv2LogValidator.validate(testName, logContents, null, // no IOR
        ...
        new RequestValidationStrategy(false, // expecting transport client
            ...
            true, // expecting SAS Client authentication principal?

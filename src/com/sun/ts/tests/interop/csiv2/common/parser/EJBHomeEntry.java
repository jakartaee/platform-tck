...
public class EJBHomeEntry extends Entry {
  public EJBHomeEntry(Element element) throws ParseException {
    if (!element.getTagName().equals("ejb-home")) {

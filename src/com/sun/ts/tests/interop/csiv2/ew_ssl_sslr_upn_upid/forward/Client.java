...
package com.sun.ts.tests.interop.csiv2.ew_ssl_sslr_upn_upid.forward;
...
public class Client extends EETest {
  ...
  private String SERVLET = "/interop_csiv2_ew_ssl_sslr_upn_upid_f_web/CSIv2ServletTest";
  ...
  public void ew_ssl_sslr_upn_upid_wb_sb_testid7_setup(String[] args,
  ...
  /*
   * @testName: ew_ssl_sslr_upn_upid_sb_sb_testid7
   *
   ...
   *
   * Test ew_ssl_sslr_upn_upid_sb_sb_testid7 tests session bean access remote
   * session bean with client authentication over SSL transport using identity
   ...
   * and WebClient(WC) 2) EJBs SessionBean(SB)
   *
   ...
   * 
   * 4) Verify the following a) SAS identity token = P1 (GSSUP) b) SAS client
   * authentication principal = none c) transport client principal = P2
   * 
   */
  public void ew_ssl_sslr_upn_upid_sb_sb_testid7() throws Fault {

    boolean pass = true;
    String testName = "ew_ssl_sslr_upn_upid_sb_sb_testid7";
  ...
  /*
   * @testName: ew_ssl_sslr_upn_upid_wb_sb_testid7
   *
   * @assertion_ids: EJB:SPEC:740; EJB:SPEC:742; EJB:SPEC:750; EJB:SPEC:751;
   * CSIv2:SPEC:43; EJB:SPEC:746
   *
   ...
   * support the stateful mode.
   *
   * Test ew_ssl_sslr_upn_upid_wb_sb_testid7 tests servlet access remote session
   * bean with client authentication over SSL transport using identity token
   ...
   * 
   */
  public void ew_ssl_sslr_upn_upid_wb_sb_testid7() throws Fault {

    boolean pass = true;
    String testName = "ew_ssl_sslr_upn_upid_wb_sb_testid7";

...
package com.sun.ts.tests.interop.csiv2.ew_ssl_ssln_upn_ccid.reverse;
...
public class Client extends EETest {
  ...
  private String SERVLET = "/interop_csiv2_ew_ssl_ssln_upn_ccid_r_web/CSIv2ServletTest";
   ...
   * session bean using certificates or disdinguished name identity token with
   * SSL.
   *
  ...
  public void ew_ssl_ssln_upn_ccid_sb_sb_testid3b() throws Fault {
    ...
    boolean pass = true;
    String testName = "ew_ssl_ssln_upn_ccid_sb_sb_testid3b_reverse";
  ...
  public void ew_ssl_ssln_upn_ccid_wb_sb_testid3b() throws Fault {
    ...
    boolean pass = true;
    String testName = "ew_ssl_ssln_upn_ccid_wb_sb_testid3b_reverse";

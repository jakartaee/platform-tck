...
package com.sun.ts.tests.interop.csiv2.ew_ssl_ssln_upn_ccid.forward;
...
public class Client extends EETest {
  ...
  private String SERVLET = "/interop_csiv2_ew_ssl_ssln_upn_ccid_f_web/CSIv2ServletTest";
   ...
   * generateSQL; webServerHost; webServerPort; securedWebServicePort;
   * certLoginUserAlias;
   */
  ...
  /*
   * @testName: ew_ssl_ssln_upn_ccid_sb_sb_testid3b
   *
   ...
   *
   * Test ew_ssl_ssln_upn_ccid_sb_sb_testid3b tests session bean access remote
   * session bean using certificates or distinguished name identity token with
   * SSL.
   *
   ...
   * 
   * 4) Verify the following a) SAS identity token = certificates or
   * distinguished name b) SAS client authentication principal = none c)
   * transport client principal = none
   */
  public void ew_ssl_ssln_upn_ccid_sb_sb_testid3b() throws Fault {

    boolean pass = true;
    String testName = "ew_ssl_ssln_upn_ccid_sb_sb_testid3b";
  ...
  /*
   * @testName: ew_ssl_ssln_upn_ccid_wb_sb_testid3b
   *
   * @assertion_ids: EJB:SPEC:740; EJB:SPEC:742; EJB:SPEC:750; EJB:SPEC:751;
   * CSIv2:SPEC:43; EJB:SPEC:746
   *
   ...
   * support the stateful mode.
   *
   * Test ew_ssl_ssln_upn_ccid_wb_sb_testid3b tests servlet access remote
   * session bean using certificates or distinguished name identity token with
   * SSL.
   *
   ...
   * transport client principal = none
   */
  public void ew_ssl_ssln_upn_ccid_wb_sb_testid3b() throws Fault {

    boolean pass = true;
    String testName = "ew_ssl_ssln_upn_ccid_wb_sb_testid3b";

    TestUtil.logMsg(testName);

    /*
     * // Certificate based login try {
     * 
     * TSLoginContext clc = new TSLoginContext();
     * clc.login(props.getProperty("certLoginUserAlias"),
     * System.getProperty("javax.net.ssl.keyStore"),
     * System.getProperty("javax.net.ssl.keyStorePassword"));
     * 
     * }catch(Exception e){ TestUtil.logMsg( e.getMessage());
     * TestUtil.printStackTrace(e); throw new Fault(testName +
     * " TSCertLogin failed"); }
     */

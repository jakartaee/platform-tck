...
package com.sun.ts.tests.interop.csiv2.ew_ssl_sslr_upn_ccid.forward;
...
public class Client extends EETest {
  ...
  private String SERVLET = "/interop_csiv2_ew_ssl_sslr_upn_ccid_f_web/CSIv2ServletTest";
   ...
   * distinguished name b) SAS client authentication principal=none c) transport
   * client principal=P2
   */
  public void ew_ssl_sslr_upn_ccid_sb_sb_testid7a() throws Fault {

    boolean pass = true;
    String testName = "ew_ssl_sslr_upn_ccid_sb_sb_testid7a";
   ...
   * support the stateful mode.
   *
   * Test ew_ssl_sslr_upn_ccid_wb_sb_testid7a tests servlet access remote
   * session bean with client authentication over SSL transport using identity
   * token format certificate chain or distinguished name.
   *
  ...
  public void ew_ssl_sslr_upn_ccid_wb_sb_testid7a() throws Fault {
    ...
    boolean pass = true;
    String testName = "ew_ssl_sslr_upn_ccid_wb_sb_testid7a";

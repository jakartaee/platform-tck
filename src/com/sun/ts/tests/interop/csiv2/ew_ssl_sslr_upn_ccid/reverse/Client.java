...
package com.sun.ts.tests.interop.csiv2.ew_ssl_sslr_upn_ccid.reverse;
...
public class Client extends EETest {
  ...
  private String SERVLET = "/interop_csiv2_ew_ssl_sslr_upn_ccid_r_web/CSIv2ServletTest";
  ...
  /*
   * @testName: ew_ssl_sslr_upn_ccid_sb_sb_testid7a
   *
   ...
   *
   * Test ew_ssl_sslr_upn_ccid_sb_sb_testid7a tests session bean access remote
   * session bean with client authentication over SSL transport using identity
   * token format certificate chain or distinguished name.
   *
   ...
   * 
   * 4) Verify the following a) port=0 b) IOR.7
   */
  public void ew_ssl_sslr_upn_ccid_sb_sb_testid7a() throws Fault {

    boolean pass = true;
    String testName = "ew_ssl_sslr_upn_ccid_sb_sb_testid7a_reverse";
  ...
  /*
   * @testName: ew_ssl_sslr_upn_ccid_wb_sb_testid7a
   *
   * @assertion_ids: EJB:SPEC:740; EJB:SPEC:742; EJB:SPEC:750; EJB:SPEC:751;
   * CSIv2:SPEC:43; EJB:SPEC:746; EJB:SPEC:741
   *
   ...
   * support the stateful mode.
   *
   * Test ew_ssl_sslr_upn_ccid_wb_sb_testid7a tests servlet access remote entity
   * bean with client authentication over SSL transport using identity token
   * format certificate chain or distinguished name.
   *
   ...
   * 
   */
  public void ew_ssl_sslr_upn_ccid_wb_sb_testid7a() throws Fault {

    boolean pass = true;
    String testName = "ew_ssl_sslr_upn_ccid_wb_sb_testid7a_reverse";

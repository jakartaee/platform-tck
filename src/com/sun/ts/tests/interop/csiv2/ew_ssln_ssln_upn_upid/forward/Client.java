...
package com.sun.ts.tests.interop.csiv2.ew_ssln_ssln_upn_upid.forward;
...
public class Client extends EETest {
  ...
  private String SERVLET = "/interop_csiv2_ew_ssln_ssln_upn_upid_f_web/CSIv2ServletTest";
  ...
  /*
   * @testName: ew_ssln_ssln_upn_upid_sb_sb_testid6
   *
   ...
   *
   * Test ew_ssln_ssln_upn_upid_sb_sb_testid6 tests session bean access remote
   * session bean using identity token of user-password without SSL.
   *
   ...
   *
   */
  public void ew_ssln_ssln_upn_upid_sb_sb_testid6() throws Fault {

    boolean pass = true;
    String testName = "ew_ssln_ssln_upn_upid_sb_sb_testid6";
  ...
  /*
   * @testName: ew_ssln_ssln_upn_upid_wb_sb_testid6
   *
   * @assertion_ids: EJB:SPEC:740; EJB:SPEC:742; EJB:SPEC:750; EJB:SPEC:751;
   * CSIv2:SPEC:43; EJB:SPEC:746
   *
   ...
   * support the stateful mode.
   *
   * Test ew_ssln_ssln_upn_upid_wb_sb_testid6 tests servlet access remote
   * session bean using identity token of user-password without SSL.
   *
   ...
   * authentication principal=none c) transport client principal=none
   */
  public void ew_ssln_ssln_upn_upid_wb_sb_testid6() throws Fault {

    boolean pass = true;
    String testName = "ew_ssln_ssln_upn_upid_wb_sb_testid6";

...
package com.sun.ts.tests.interop.csiv2.ew_ssl_ssln_upn_anonid.reverse;
...
public class Client extends EETest {
  ...
  private String SERVLET = "/interop_csiv2_ew_ssl_ssln_upn_anonid_r_web/CSIv2ServletTest";
  ...
  /*
   * @testName: ew_ssl_ssln_upn_anonid_sb_sb_testid3
   *
   ...
   *
   * Test ew_ssl_ssln_upn_anonid_sb_sb_testid3 tests session bean access remote
   * session bean without authentication with SSL.
   *
   ...
   * 
   * 4) Verify the following IOR.3 and port=0
   *
   */
  public void ew_ssl_ssln_upn_anonid_sb_sb_testid3() throws Fault {

    boolean pass = true;
    String testName = "ew_ssl_ssln_upn_anonid_sb_sb_testid3_reverse";
    ...
    pass = CSIv2LogValidator.validate(testName, logContents,
        new IOR3ValidationStrategy(false, IORValidationStrategy.ITTAnonymous),
  ...
  /*
   * @testName: ew_ssl_ssln_upn_anonid_wb_sb_testid3
   *
   * @assertion_ids: EJB:SPEC:740; EJB:SPEC:742; EJB:SPEC:750; EJB:SPEC:751;
   * CSIv2:SPEC:43; EJB:SPEC:746; EJB:SPEC:741
   *
   ...
   * support the stateful mode.
   *
   * Test ew_ssl_ssln_upn_anonid_wb_sb_testid3 tests servlet access remote
   * session bean without authentication with SSL.
   *
   ...
   *
   */
  public void ew_ssl_ssln_upn_anonid_wb_sb_testid3() throws Fault {

    boolean pass = true;
    String testName = "ew_ssl_ssln_upn_anonid_wb_sb_testid3_reverse";

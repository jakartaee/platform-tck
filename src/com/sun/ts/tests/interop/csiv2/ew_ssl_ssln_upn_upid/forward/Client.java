...
package com.sun.ts.tests.interop.csiv2.ew_ssl_ssln_upn_upid.forward;
...
public class Client extends EETest {
  ...
  private String SERVLET = "/interop_csiv2_ew_ssl_ssln_upn_upid_f_web/CSIv2ServletTest";
  ...
  public void ew_ssl_ssln_upn_upid_wb_sb_testid3a_setup(String[] args,
   ...
   * 
   * 4) Verify the following a) SAS identity token = user-password b) SAS client
   * authentication principal = none c) transport client principal = none
   */
  public void ew_ssl_ssln_upn_upid_sb_sb_testid3a() throws Fault {

    boolean pass = true;
    String testName = "ew_ssl_ssln_upn_upid_sb_sb_testid3a";
    ...
    pass = CSIv2LogValidator.validate(testName, logContents, null, // no IOR
                                                                   // validation
        new RequestValidationStrategy(false, // expecting transport client
                                             // principals?
  ...
  public void ew_ssl_ssln_upn_upid_wb_sb_testid3a() throws Fault {
    ...
    boolean pass = true;
    String testName = "ew_ssl_ssln_upn_upid_wb_sb_testid3a";

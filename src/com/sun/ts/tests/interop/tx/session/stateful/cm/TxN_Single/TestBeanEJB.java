...
package com.sun.ts.tests.interop.tx.session.stateful.cm.TxN_Single;
...
public class TestBeanEJB implements SessionBean {
  ...
  public void ejbCreate() throws CreateException {
    ...
    try {
      ...
      TestUtil.logMsg("Looking up the TxBean Home interface of " + txNever);
      beanHome = (TxBeanHome) jctx.lookup(txNever, TxBeanHome.class);
  ...
  public boolean test1() {
    ...
    try {
      TestUtil.logTrace("Creating EJB instance of " + txNever);

...
package com.sun.ts.tests.interop.tx.session.stateful.cm.TxNS_Single;
...
public class Client extends EETest {
  ...
  private static final String testName = "TxNS_Single";
   ...
   * Create an instance of a stateful session TxBean (NotSupported) bean.
   * Perform Insert/Delete operations to a single table and ensure that these
   * operations are commited automatically after each method completes.
   *

...
public class JSTLClient extends AbstractUrlClient {
    ...
    public void functionsContainsStringSubstringEqualTest() throws Fault {
        TEST_PROPS.setProperty(
                REQUEST, "GET /jstl_etu_func_web/functionsContainsStringSubstringEqualTest.jsp HTTP/1.1");
        TEST_PROPS.setProperty(SEARCH_STRING, "Test PASSED");
        TEST_PROPS.setProperty(UNEXPECTED_RESPONSE_MATCH, "Test FAILED");
        invoke();
    }
    ...
    public void functionsContainsIgnoreCaseStringSubstringEqualTest() throws Fault {
        TEST_PROPS.setProperty(
                REQUEST, "GET /jstl_etu_func_web/functionsContainsIgnoreCaseStringSubstringEqualTest.jsp HTTP/1.1");
        TEST_PROPS.setProperty(SEARCH_STRING, "Test PASSED");
        TEST_PROPS.setProperty(UNEXPECTED_RESPONSE_MATCH, "Test FAILED");
        invoke();
    }
    ...
    public void functionsContainsIgnoreCaseNullStringTest() throws Fault {
        TEST_PROPS.setProperty(
                REQUEST, "GET /jstl_etu_func_web/functionsContainsIgnoreCaseNullStringTest.jsp HTTP/1.1");
        TEST_PROPS.setProperty(UNEXPECTED_RESPONSE_MATCH, "Test FAILED");
        invoke();
    }
    ...
    public void functionsContainsIgnoreCaseNullSubstringTest() throws Fault {
        TEST_PROPS.setProperty(
                REQUEST, "GET /jstl_etu_func_web/functionsContainsIgnoreCaseNullSubstringTest.jsp HTTP/1.1");
        TEST_PROPS.setProperty(UNEXPECTED_RESPONSE_MATCH, "Test FAILED");
        invoke();
    }
    ...
    public void functionsLengthTest() throws Fault {
        ...
        TEST_PROPS.setProperty(UNEXPECTED_RESPONSE_MATCH, "Test FAILED");
        TEST_PROPS.setProperty(
                SEARCH_STRING, "Test PASSED|Test PASSED|Test PASSED|Test PASSED|Test PASSED|Test PASSED|Test PASSED");
        invoke();
    }
    ...
    public void functionsStartsWithEmptyPrefixTest() throws Fault {
        TEST_PROPS.setProperty(
                REQUEST, "GET /jstl_etu_func_web//functionsStartsWithEmptyPrefixStringTest.jsp HTTP/1.1");
        TEST_PROPS.setProperty(UNEXPECTED_RESPONSE_MATCH, "Test FAILED");
        TEST_PROPS.setProperty(SEARCH_STRING, "Test PASSED");
        invoke();
    }
    ...
    public void functionsStartsWithPrefixStringEqualTest() throws Fault {
        TEST_PROPS.setProperty(
                REQUEST, "GET /jstl_etu_func_web//functionsStartsWithPrefixStringEqualTest.jsp HTTP/1.1");
        TEST_PROPS.setProperty(UNEXPECTED_RESPONSE_MATCH, "Test FAILED");
        TEST_PROPS.setProperty(SEARCH_STRING, "Test PASSED");
        invoke();
    }
    ...
    public void functionsSubstringNegativeBeginIndexTest() throws Fault {
        TEST_PROPS.setProperty(
                REQUEST, "GET /jstl_etu_func_web//functionsSubstringNegativeBeginIndexTest.jsp HTTP/1.1");
        TEST_PROPS.setProperty(UNEXPECTED_RESPONSE_MATCH, "Test FAILED");
        TEST_PROPS.setProperty(SEARCH_STRING, "Test PASSED");
        invoke();
    }
    ...
    public void functionsSubstringEndIndexGTStringLengthTest() throws Fault {
        TEST_PROPS.setProperty(
                REQUEST, "GET /jstl_etu_func_web//functionsSubstringEndIndexGTStringLengthTest.jsp HTTP/1.1");
        TEST_PROPS.setProperty(UNEXPECTED_RESPONSE_MATCH, "Test FAILED");
        TEST_PROPS.setProperty(SEARCH_STRING, "Test PASSED");
        invoke();
    }
    ...
    public void functionsSubstringBeginIndexGTLastIndexTest() throws Fault {
        TEST_PROPS.setProperty(
                REQUEST, "GET /jstl_etu_func_web//functionsSubstringBeginIndexGTLastIndexTest.jsp HTTP/1.1");
        TEST_PROPS.setProperty(UNEXPECTED_RESPONSE_MATCH, "Test FAILED");
        TEST_PROPS.setProperty(SEARCH_STRING, "Test PASSED");
        invoke();
    }
    ...
    public void functionsSubstringEndIndexLTBeginIndexTest() throws Fault {
        TEST_PROPS.setProperty(
                REQUEST, "GET /jstl_etu_func_web//functionsSubstringEndIndexLTBeginIndexTest.jsp HTTP/1.1");
        TEST_PROPS.setProperty(UNEXPECTED_RESPONSE_MATCH, "Test FAILED");
        TEST_PROPS.setProperty(SEARCH_STRING, "Test PASSED");
        invoke();
    }
    ...
    public void functionsSubstringAfterNullSubstringTest() throws Fault {
        TEST_PROPS.setProperty(
                REQUEST, "GET /jstl_etu_func_web//functionsSubstringAfterNullSubstringTest.jsp HTTP/1.1");
        TEST_PROPS.setProperty(UNEXPECTED_RESPONSE_MATCH, "Test FAILED");
        TEST_PROPS.setProperty(SEARCH_STRING, "Test PASSED");
        invoke();
    }
    ...
    public void functionsSubstringAfterEmptySubstringTest() throws Fault {
        TEST_PROPS.setProperty(
                REQUEST, "GET /jstl_etu_func_web//functionsSubstringAfterEmptySubstringTest.jsp HTTP/1.1");
        TEST_PROPS.setProperty(UNEXPECTED_RESPONSE_MATCH, "Test FAILED");
        TEST_PROPS.setProperty(SEARCH_STRING, "Test PASSED");
        invoke();
    }
    ...
    public void functionsSubstringBeforeNullSubstringTest() throws Fault {
        TEST_PROPS.setProperty(
                REQUEST, "GET /jstl_etu_func_web//functionsSubstringBeforeNullSubstringTest.jsp HTTP/1.1");
        TEST_PROPS.setProperty(UNEXPECTED_RESPONSE_MATCH, "Test FAILED");
        TEST_PROPS.setProperty(SEARCH_STRING, "Test PASSED");
        invoke();
    }
    ...
    public void functionsSubstringBeforeEmptySubstringTest() throws Fault {
        TEST_PROPS.setProperty(
                REQUEST, "GET /jstl_etu_func_web//functionsSubstringBeforeEmptySubstringTest.jsp HTTP/1.1");
        TEST_PROPS.setProperty(UNEXPECTED_RESPONSE_MATCH, "Test FAILED");
        TEST_PROPS.setProperty(SEARCH_STRING, "Test PASSED");
        invoke();
    }

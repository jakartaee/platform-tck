...
public class TckConnectionWrapper implements java.sql.Connection {
     ...
     * @see java.sql.Connection
     */
    public java.sql.CallableStatement prepareCall(java.lang.String str, int param, int param2)
     ...
     * @see java.sql.Connection
     */
    public java.sql.PreparedStatement prepareStatement(java.lang.String str, int param, int param2)
            throws java.sql.SQLException {

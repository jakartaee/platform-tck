...
public class URLClient extends AbstractUrlClient {
    ...
    String CONTEXT_ROOT = "/servlet_ee_platform_cdi_filter_web";
    ...
    public void simpleInjectTest() throws EETest.Fault {
        TEST_PROPS.setProperty(REQUEST, "GET " + CONTEXT_ROOT + "/TCKTestServletURL HTTP/1.1");
        TEST_PROPS.setProperty(SEARCH_STRING, "Test PASSED from TestFilter");
        invoke();
    }
}

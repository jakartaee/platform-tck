...
public final class PermDDLibrary {
    ...
    public static String ValidateLocalGrantForCustomPermInLib() {
        ...
        try {
            ...
            debug("CTSPermission2_name permission property threw AccessControlException.");
    ...
    public static String ValidateRequiredPermSetInLib() {
        ...
        try {
            ...
            debug("ValidateRequiredPermSetInLib():  valid perm for: " + rtperm.toString());

            RuntimePermission rtperm2 = new RuntimePermission("queuePrintJob");
            doCheckPermission(rtperm2);
            debug("ValidateRequiredPermSetInLib():  valid perm for: " + rtperm2.toString());

            SocketPermission socperm = new SocketPermission("*", "connect");
            doCheckPermission(socperm);
            debug("ValidateRequiredPermSetInLib():  valid perm for: " + socperm.toString());

            FilePermission fperm = new FilePermission("*", "read");
            doCheckPermission(fperm);
            debug("ValidateRequiredPermSetInLib():  valid perm for: " + fperm.toString());

            PropertyPermission pperm = new PropertyPermission("*", "read");
            doCheckPermission(pperm);
            debug("ValidateRequiredPermSetInLib():  valid perm for: " + pperm.toString());
    ...
    public static String ValidateLocalPermsInvalidNameInLib() {
        ...
        try {
            ...
            try {
                ...
                // should get here.
                debug("SUCCESS:  ValidateLocalPermsInvalidNameInLib() threw expected AccessControlException");
            }
    ...
    public static String ValidateRestrictedLocalPermInLib() {
        ...
        try {
            ...
            try {
                ...
                // should get here
                debug("SUCCESS:  ValidateRestrictedLocalPermInLib() has grant for read of TestPropertyPerm");
            } catch (AccessControlException ex) {
                // should not get here.
                ex.printStackTrace();
                rval =

...
public class TestServlet extends HttpServlet {
    ...
    private void doTests(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (testMethod.equals("ValidateCustomPerm")) {
            ...
            debug("TestServlet.doTests(): testMethod == ValidateCustomPermFromAppServer");
            validateCustomPermFromAppServer(request, response);

        } else if (testMethod.equals("ValidateLocalGrantForCustomPerm")) {
            // test permission.xml from within a servlet
            debug("TestServlet.doTests(): testMethod == validateLocalGrantForCustomPerm");
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    // should get here
                    send_output(out, "SUCCESS:  validateRestrictedLocalPerm() has grant for read of TestPropertyPerm");
                ...
                send_output(out, "FAILURE:  validateRestrictedLocalPerm had unexpected exception.");
                ex.printStackTrace();
            }
    ...
    public void validateLocalPermsInvalidName(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            try {
                ...
                // should get here.
                send_output(out, "SUCCESS:  validateLocalPermsInvalidName() threw expected AccessControlException");
            }
            ...
            try {
                ...
                // should get here
                send_output(out, "CTSPermission_second_name permission property granted AccessControlException.");
            } catch (AccessControlException ex) {
                // should NOT get here
                send_output(out, "FAILURE:  validateLocalPermsInvalidName() threw unexpected exception.");
                return;
            } catch (Exception ex) {
                // should NOT get here
                send_output(out, "FAILURE:  validateLocalPermsInvalidName had unexpeted exception.");
                ex.printStackTrace();
                return;
            }
            ...
            send_output(out, "FAILURE:  validateLocalPermsInvalidName had unexpected exception.");
            ex.printStackTrace();
        }
    }
    ...
    public void validateLocalGrantForCustomPerm(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            try {
                ...
                // we have locally defined grant/perms (thru permissions.xml) so we
                // should get here
                send_output(out, "CTSPermission2_name permission property granted AccessControlException.");
                send_output(out, "SUCCESS:  validateLocalGrantForCustomPerm passed.");
            } catch (AccessControlException ex) {
                send_output(
                        out, "FAILURE:  validateLocalGrantForCustomPerm() threw unexpected AccessControlException.");
                ex.printStackTrace();
            } catch (Exception ex) {
                send_output(out, "FAILURE:  validateLocalGrantForCustomPerm had unexpeted exception.");
                ex.printStackTrace();
            }

        } catch (Exception ex) {
            System.out.println("TestServlet->validateLocalGrantForCustomPerm() failed");
            ex.printStackTrace();
        }
    }
    ...
    public void validateCustomPerm(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            try {
                ...
                send_output(out, "FAILURE:  CTSPermission1_name perm missing, throwing AccessControlException.");
                ex.printStackTrace();
            } catch (Exception ex) {
                send_output(out, "FAILURE:  validateCustomPerm(), throwing unexpected Exception.");
                ex.printStackTrace();
            }
    ...
    public void validateCustomPermFromAppServer(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            try {
                ...
                send_output(out, "FAILURE:  validateCustomPermFromAppServer(), throwing unexpected Exception.");
                ex.printStackTrace();
            }

        } catch (Exception ex) {
            System.out.println("TestServlet->validateCustomPermFromAppServer() failed");
            ex.printStackTrace();
        }
    }
    ...
    public void validateMissingPermFails(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            try {
                ...
                send_output(out, "SUCCESS:  CTSPermission3_name doesnt exist and was caught.");
                send_output(out, "SUCCESS:  validateMissingPermFails passed.");
            } catch (Exception ex) {
                send_output(out, "FAILURE:  validateMissingPermFails threw unexpected exception.");
                ex.printStackTrace();
            }
    ...
    public void validateRequiredPermSet(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            try {
                ...
                send_output(
                        out, "FAILURE:  validateRequiredPermSet had perm missing, throwing AccessControlException.");
                ex.printStackTrace();
            } catch (Exception ex) {
                send_output(out, "FAILURE:  validateRequiredPermSet had unexpected Exception.");
                ex.printStackTrace();
            }
    ...
    public void validateRestrictedLocalPermInLib(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            System.out.println("TestServlet->validateRestrictedLocalPermInLib() failed");
            ex.printStackTrace();
        }
    }
    ...
    public void validateLocalGrantForCustomPermInLib(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            System.out.println("TestServlet->validateLocalGrantForCustomPermInLib() failed");
            ex.printStackTrace();
        }
    }
    ...
    public void validateLocalPermsInvalidNameInLib(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            System.out.println("TestServlet->validateLocalPermsInvalidNameInLib() failed");
            ex.printStackTrace();
        }
    }
     ...
     *
     */
    public void validateCustomPermFromAppServerInLib(HttpServletRequest request, HttpServletResponse response) {
        try {
            PrintWriter out = response.getWriter();
            ...
            System.out.println("TestServlet->validateCustomPermFromAppServerInLib() failed");
            ex.printStackTrace();
        }
    }

...
public class URLClient extends AbstractUrlClient {
    ...
    private static final String CONTEXT_ROOT = "/servlet_plu_servletrequest30_web";
    ...
    public void getDispatcherTypeTestAsync() throws Fault {
        TEST_PROPS.setProperty(
                REQUEST, "GET " + getContextRoot() + "/AsyncTestServlet?testname=getDispatcherTypeTestAsync  HTTP/1.1");
    ...
    public void asyncStartedTest1() throws Fault {
        TEST_PROPS.setProperty(
                REQUEST, "GET " + getContextRoot() + "/AsyncTestServlet?testname=asyncStartedTest1  HTTP/1.1");
    ...
    public void asyncStartedTest2() throws Fault {
        TEST_PROPS.setProperty(
                REQUEST, "GET " + getContextRoot() + "/AsyncTestServlet?testname=asyncStartedTest2  HTTP/1.1");
    ...
    public void asyncStartedTest3() throws Fault {
        TEST_PROPS.setProperty(
                REQUEST, "GET " + getContextRoot() + "/AsyncTestServlet?testname=asyncStartedTest3  HTTP/1.1");
        TEST_PROPS.setProperty(SEARCH_STRING, "IsAsyncStarted=true");
        invoke();
    }
    ...
    public void asyncStartedTest4() throws Fault {
        TEST_PROPS.setProperty(
                REQUEST, "GET " + getContextRoot() + "/AsyncTestServlet?testname=asyncStartedTest4  HTTP/1.1");
        TEST_PROPS.setProperty(SEARCH_STRING, "IsAsyncStarted=false");
        invoke();
    }
    ...
    public void isAsyncSupportedTest1() throws Fault {
        TEST_PROPS.setProperty(
                REQUEST, "GET " + getContextRoot() + "/AsyncTestServlet?testname=isAsyncSupportedTest  HTTP/1.1");
    ...
    public void isAsyncSupportedTest2() throws Fault {
        TEST_PROPS.setProperty(
                REQUEST, "GET " + getContextRoot() + "/TestServlet?testname=isAsyncSupportedTest  HTTP/1.1");
    ...
    public void startAsyncTest2() throws Fault {
        TEST_PROPS.setProperty(
                REQUEST, "GET " + getContextRoot() + "/AsyncTestServlet?testname=startAsyncTest  HTTP/1.1");
    ...
    public void getAsyncContextTest() throws Fault {
        TEST_PROPS.setProperty(
                REQUEST, "GET " + getContextRoot() + "/AsyncTestServlet?testname=getAsyncContextTest  HTTP/1.1");
        TEST_PROPS.setProperty(SEARCH_STRING, "Test PASSED");
        invoke();
    }
}

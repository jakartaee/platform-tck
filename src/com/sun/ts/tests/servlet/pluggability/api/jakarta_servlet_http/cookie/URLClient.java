...
public class URLClient extends AbstractUrlClient {
    ...
    public void getDomainTest() throws Fault {
        ...
        TEST_PROPS.setProperty(
                REQUEST_HEADERS,
                "Cookie: $Version=1; name1=value1; $Domain=" + _hostname + "; $Path=/servlet_pluh_cookie_web");
    ...
    public void getNameTest() throws Fault {
        // version 0 Cookie
        TEST_PROPS.setProperty(
                REQUEST_HEADERS, "Cookie: name1=value1; Domain=" + _hostname + "; Path=/servlet_pluh_cookie_web");
    ...
    public void setMaxAgePositiveTest() throws Fault {
        ...
        HttpRequest request = new HttpRequest(
                "GET " + getContextRoot() + "/" + getServletName() + "?testname=" + testName + " HTTP/1.1",
                _hostname,
                _port);
        ...
        try {
            ...
            TestUtil.logTrace("Found " + response.getResponseHeaders("Set-Cookie").length + " set-cookie entry");
            ...
            while (i < CookiesHeader.length) {
                ...
                Cookie[] cookies = spec.parse(".eng.com", _port, getServletName(), false, CookiesHeader[i]);

 ...
 * $Id$
 */
package com.sun.ts.tests.servlet.api.javax_servlet.scinitializer.addlistener1;
...
public class TestListener implements ServletContextListener {
  ...
  public void contextInitialized(ServletContextEvent sce) {
    ...
    try {
      context.addListener(
          "com.sun.ts.tests.servlet.api.javax_servlet.scinitializer.addlistener.SCListener");
      log.append(
    ...
    try {
      context.addListener(
          "com.sun.ts.tests.servlet.api.javax_servlet.scinitializer.addlistener.SCAttributeListener");
      log.append(
    ...
    try {
      context.addListener(
          "com.sun.ts.tests.servlet.api.javax_servlet.scinitializer.addlistener.SRListener");
      log.append(
    ...
    try {
      context.addListener(
          "com.sun.ts.tests.servlet.api.javax_servlet.scinitializer.addlistener.SRAttributeListener");
      log.append(

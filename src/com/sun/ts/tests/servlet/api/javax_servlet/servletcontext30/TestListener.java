...
public class TestListener implements ServletContextListener {
  ...
  public void contextInitialized(ServletContextEvent sce) {
    ...
    try {
      context.addListener(
          com.sun.ts.tests.servlet.api.javax_servlet.servletcontext30.AddSCListenerClass.class);
    ...
    try {
      context.addListener(
          "com.sun.ts.tests.servlet.api.javax_servlet.servletcontext30.AddSCListenerString");
    } catch (IllegalArgumentException ilex) {
    ...
    try {
      EventListener csclistener = context.createListener(
          com.sun.ts.tests.servlet.api.javax_servlet.servletcontext30.CreateSCListener.class);
    ...
    ServletRegistration srdClass = context.addServlet(addServletName5,
        com.sun.ts.tests.servlet.api.javax_servlet.servletcontext30.DuplicateServletClass.class);
    if (srdClass == null) {
    ...
    ServletRegistration srdString = context.addServlet(addServletName6,
        "com.sun.ts.tests.servlet.api.javax_servlet.servletcontext30.DuplicateServletString");
    if (srdString == null) {
    ...
    FilterRegistration frdClass = context.addFilter(addFilterName6,
        com.sun.ts.tests.servlet.api.javax_servlet.servletcontext30.DuplicateFilterClass.class);
    if (frdClass == null) {
    ...
    FilterRegistration frdString = context.addFilter(addFilterName6,
        "com.sun.ts.tests.servlet.api.javax_servlet.servletcontext30.DuplicateFilterString");
    if (frdString == null) {

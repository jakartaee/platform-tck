...
public class TestListener implements ServletContextListener {
  ...
  public void contextInitialized(ServletContextEvent sce) {
     ...
     */
    context.addListener(
        com.sun.ts.tests.servlet.api.javax_servlet_http.servletcontext305.AddHttpSessionAttributeListenerClass.class);
    context.addListener(
        "com.sun.ts.tests.servlet.api.javax_servlet_http.servletcontext305.AddHttpSessionAttributeListenerString");
    try {
      EventListener hslistener = context.createListener(
          com.sun.ts.tests.servlet.api.javax_servlet_http.servletcontext305.CreateHttpSessionAttributeListener.class);

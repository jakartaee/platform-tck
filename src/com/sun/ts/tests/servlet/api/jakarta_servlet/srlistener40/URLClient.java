...
public class URLClient extends AbstractUrlClient {
    ...
    public Status run(String args[], PrintWriter out, PrintWriter err) {
        ...
        setContextRoot("/servlet_js_srlistener40_web");
     ...
     * @assertion_ids: NA;
     *
     * @test_Strategy: Client successfully calls a servlet with an empty ServletRequest listener implementation class.
     *
     */

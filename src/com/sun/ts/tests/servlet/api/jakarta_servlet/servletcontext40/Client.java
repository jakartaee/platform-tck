...
public class Client extends EETest {
    ...
    public void addJspContextInitialized() throws Fault {
        try {
            ...
            if (response.content.indexOf("IllegalStateException_when_addJsp__ContextInitialized") < 0) {
                TestUtil.logErr(
    ...
    public void setSessionTimeoutContextInitialized() throws Fault {
        try {
            ...
            if (response.content.indexOf("IllegalStateException_when_setSessionTimeout_ContextInitialized") < 0) {
                TestUtil.logErr(
                        "IllegalStateException should be thrown if this ServletContext has already been initialized");
                throw new Fault("setSessionTimeoutContextInitialized failed.");
            }
    ...
    public void addJspContextListenerInTLD() throws Fault {
        try {
            ...
            if (response.content.indexOf("UnsupportedOperationException_when_addJsp_addedListener") < 0) {
    ...
    public void setSessionTimeoutContextListenerInTLD() throws Fault {
        try {
            ...
            if (response.content.indexOf("UnsupportedOperationException_when_setSessionTimeout_addedListener") < 0) {
                TestUtil.logErr("UnsupportedOperationException should be thrown.");
                throw new Fault("setSessionTimeoutContextListenerInTLD failed.");
            }
    ...
    public void addJspEmptyAndNullName() throws Fault {
        try {
            ...
            if (response.content.indexOf("IllegalArgumentException_when_empty_name") < 0) {
                TestUtil.logErr("IllegalArgumentException should be thrown if servletName is an empty String");
                throw new Fault("addJspEmptyAndNullName failed.");
            }

            if (response.content.indexOf("IllegalArgumentException_when_null_name") < 0) {
                TestUtil.logErr("IllegalArgumentException should be thrown if servletName is null");
                throw new Fault("addJspEmptyAndNullName failed.");
            }
    ...
    public void getAttributeWithNullName() throws Fault {
        try {
            ...
            if (response.content.indexOf("NullPointerException_when_getAttribute_with_null") < 0) {
                TestUtil.logErr("NullPointerException should be thrown if getAttribute with a null name.");
                throw new Fault("getAttributeWithNullName failed.");
            }
    ...
    public void getInitParameterWithNullName() throws Fault {
        try {
            ...
            if (response.content.indexOf("NullPointerException_when_getInitParameter_with_null") < 0) {
                TestUtil.logErr("NullPointerException should be thrown if getInitParameter with a null name.");
                throw new Fault("getAttributeWithNullName failed.");
            }
    ...
    public void setAttributeWithNullName() throws Fault {
        try {
            ...
            if (response.content.indexOf("NullPointerException_when_setAttribute_with_null") < 0) {
                TestUtil.logErr("NullPointerException should be thrown if setAttribute with a null name.");
                throw new Fault("setAttributeWithNullName failed.");
            }
    ...
    public void setInitParameterWithNullName() throws Fault {
        try {
            ...
            if (response.content.indexOf("NullPointerException_when_setInitParameter_with_null") < 0) {
                TestUtil.logErr("NullPointerException should be thrown if setInitParameter with a null name.");
                throw new Fault("setAttributeWithNullName failed.");
            }
    ...
    public void getEffectiveSessionTrackingModes() throws Fault {
        try {
            ...
            if (response.content.indexOf("getEffectiveSessionTrackingModes_test_passed") < 0) {

...
public class URLClient extends AbstractUrlClient {
     ...
     *
     * @assertion_ids: Servlet:SPEC:48; Servlet:SPEC:50; Servlet:SPEC:52; Servlet:JAVADOC:287; Servlet:JAVADOC:293;
     *
     * @test_Strategy: Client attempts to access a servlet and both filters configured for that servlet should be invoked.
     */

...
public class TestListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
         ...
         */
        ServletRegistration srString = context.addServlet(
                addServletName1, "com.sun.ts.tests.servlet.api.jakarta_servlet.servletcontext30.AddServletString");
        ...
        FilterRegistration frString = context.addFilter(
                addFilterName1, "com.sun.ts.tests.servlet.api.jakarta_servlet.servletcontext30.AddFilterString");
        frString.addMappingForServletNames(EnumSet.of(DispatcherType.FORWARD), true, addServletName1);
         ...
         */
        ServletRegistration srClass = context.addServlet(
                addServletName2, com.sun.ts.tests.servlet.api.jakarta_servlet.servletcontext30.AddServletClass.class);
        ...
        FilterRegistration frClass = context.addFilter(
                addFilterName2, com.sun.ts.tests.servlet.api.jakarta_servlet.servletcontext30.AddFilterClass.class);
        frClass.addMappingForServletNames(EnumSet.of(DispatcherType.REQUEST), true, addServletName2);
        ...
        try {
            ...
            frFilter.addMappingForServletNames(EnumSet.of(DispatcherType.REQUEST), true, addServletName3);
         ...
         */
        ServletRegistration srNotFound = context.addServlet(
                addServletName4,
        ...
        FilterRegistration frNotFound = context.addFilter(
                addFilterName4, com.sun.ts.tests.servlet.api.jakarta_servlet.servletcontext30.AddFilterNotFound.class);
        ...
        while (it.hasNext()) {
            ...
            Value_OF_Servlet_Registrations.append(pairs.getKey() + "=" + pairs.getValue() + "|");
        }
        context.setInitParameter(SERVLET_REGISTRATIONS, Value_OF_Servlet_Registrations.toString());
        ...
        context.setInitParameter(SERVLET_REGISTRATION, Value_OF_Registration.toString());
        ...
        Map<String, ? extends FilterRegistration> filter_registrations = context.getFilterRegistrations();
        it = filter_registrations.entrySet().iterator();
        while (it.hasNext()) {
            Map.Entry pairs = (Map.Entry) it.next();
            Value_OF_Filter_Registrations.append(pairs.getKey() + "=" + pairs.getValue() + "|");
        }
        context.setInitParameter(FILTER_REGISTRATIONS, Value_OF_Filter_Registrations.toString());
        ...
        context.setInitParameter(FILTER_REGISTRATION, Value_OF_Filter_Registration.toString());
        ...
        for (Registration registration : registrations) {
            ...
            Value_OF_Registration_Class_Name.append(registration.getClassName() + "|");

            Value_OF_Registration_InitParameter.append(registration.getInitParameter("FILTER") + "|");
            Value_OF_Registration_InitParameter.append(registration.getInitParameter("SERVLET") + "|");

            params = registration.getInitParameters();
            for (int i = 0; i < 5; i++) {
                Value_OF_Registration_InitParameters.append(param_names[i] + "=" + params.get(param_names[i]) + "|");
            }
        }

        context.setInitParameter(REGISTRATION_NAME, Value_OF_Registration_Name.toString());
        context.setInitParameter(REGISTRATION_CLASS_NAME, Value_OF_Registration_Class_Name.toString());
        context.setInitParameter(REGISTRATION_INIT_PARAMETER, Value_OF_Registration_InitParameter.toString());
        context.setInitParameter(REGISTRATION_INIT_PARAMETERS, Value_OF_Registration_InitParameters.toString());
    }

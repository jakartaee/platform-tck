...
public class TestListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        try {
            ...
            passed = false;
            log.append("Expected UnsupportedOperationException not thrown by getServletRegistration(String).");
        } catch (UnsupportedOperationException ex) {
            log.append("Expected UnsupportedOperationException thrown by getServletRegistration(String).");
        }

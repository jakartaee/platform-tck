...
public class TestListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        try {
            ...
            log.append("Expected UnsupportedOperationException not thrown by getFilterRegistrations().");
            passed = false;
        } catch (UnsupportedOperationException ex) {
            log.append("Expected UnsupportedOperationException thrown by getFilterRegistrations().");
        }

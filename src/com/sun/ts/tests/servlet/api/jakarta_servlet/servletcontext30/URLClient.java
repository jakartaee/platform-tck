...
public class URLClient extends AbstractUrlClient {
    ...
    /* Run test */
    /*
     * Test setup; In Deployment Descriptor, a Servlet TestServlet and Listener TestListener; TestListener extends
     * ServletContextListener;
     *
     * In TestListener, three Servlets are added using the following methods: - ServletContext.addServlet(String, String); -
     * ServletContext.addServlet(String, Class); - ServletContext.createServlet(Class);
     *
     * In TestListener, three Filters are added using the following methods: - ServletContext.addFilter(String, String); -
     * ServletContext.addFilter(String, Class); - ServletContext.createServlet(Class);
     *
     * In TestListener, three Listeners are added using the following methods: - ServletContext.addListener(Listener Class)
     * - ServletContext.addListener(Listener name) - EventListener listener = ServletContext.createListener(class);
     * ServletContext.addListener(listener); for all three following Listeners: - ServletContextAttributeListener -
     * ServletRequestListener - ServletRequestAttributesListener
     */
    /*
     * @testName: getContextPathTest
     *
     * @assertion_ids: Servlet:JAVADOC:124; Servlet:JAVADOC:258; Servlet:JAVADOC:637; Servlet:JAVADOC:671.1;
     * Servlet:JAVADOC:671.2; Servlet:JAVADOC:671.3; Servlet:JAVADOC:672.1; Servlet:JAVADOC:672.2; Servlet:JAVADOC:672.3;
     * Servlet:JAVADOC:673.1; Servlet:JAVADOC:673.2; Servlet:JAVADOC:673.3; Servlet:JAVADOC:679;
     *
     * @test_Strategy: In TestServlet verify that the result from the ServletContext.getServletContextPath call returns the
     * context path.
     *
     * In client verify that all Listeners are added correctly and invoked in the order added.
     */
     ...
     *
     * @assertion_ids: Servlet:JAVADOC:655; Servlet:JAVADOC:668; Servlet:JAVADOC:671.1; Servlet:JAVADOC:671.2;
     * Servlet:JAVADOC:671.3; Servlet:JAVADOC:672.1; Servlet:JAVADOC:672.2; Servlet:JAVADOC:672.3; Servlet:JAVADOC:673.1;
     * Servlet:JAVADOC:673.2; Servlet:JAVADOC:673.3; Servlet:JAVADOC:674; Servlet:JAVADOC:679; Servlet:JAVADOC:696;
     *
     * @test_Strategy: Create a ServletContextListener, in which, 1. create a Servlet by calling
     ...
     *
     * @assertion_ids: Servlet:JAVADOC:655; Servlet:JAVADOC:670; Servlet:JAVADOC:671.1; Servlet:JAVADOC:671.2;
     * Servlet:JAVADOC:671.3; Servlet:JAVADOC:672.1; Servlet:JAVADOC:672.2; Servlet:JAVADOC:672.3; Servlet:JAVADOC:676;
     * Servlet:JAVADOC:679; Servlet:JAVADOC:696;
     *
     * @test_Strategy: Create a ServletContextListener, in which, 1. create a Servlet by calling
     ...
     *
     * @assertion_ids: Servlet:JAVADOC:655; Servlet:JAVADOC:669; Servlet:JAVADOC:670; Servlet:JAVADOC:671.1;
     * Servlet:JAVADOC:671.2; Servlet:JAVADOC:671.3; Servlet:JAVADOC:672.1; Servlet:JAVADOC:672.2; Servlet:JAVADOC:672.3;
     * Servlet:JAVADOC:673.1; Servlet:JAVADOC:673.2; Servlet:JAVADOC:673.3; Servlet:JAVADOC:675; Servlet:JAVADOC:677;
     * Servlet:JAVADOC:679; Servlet:JAVADOC:681; Servlet:JAVADOC:696;
     *
     * @test_Strategy: Create a ServletContextListener, in which, 1. Create a Servlet instance using
     ...
     * @assertion_ids: Servlet:JAVADOC:655; Servlet:JAVADOC:670; Servlet:JAVADOC:671.1; Servlet:JAVADOC:671.2;
     * Servlet:JAVADOC:671.3; Servlet:JAVADOC:672.1; Servlet:JAVADOC:672.2; Servlet:JAVADOC:672.3; Servlet:JAVADOC:673.1;
     * Servlet:JAVADOC:673.2; Servlet:JAVADOC:673.3; Servlet:JAVADOC:676; Servlet:JAVADOC:679; Servlet:JAVADOC:696;
     *
     * @test_Strategy: Create a ServletContextListener, in which, 1. create a Servlet by calling
     ...
     * Servlet:JAVADOC:679; Servlet:JAVADOC:681; Servlet:JAVADOC:696;
     *
     * @test_Strategy: Create a ServletContextListener, in which, one ServletContextAttributeListener, one
     ...
     *
     * @assertion_ids: Servlet:JAVADOC:243; Servlet:JAVADOC:678; Servlet:JAVADOC:680; Servlet:JAVADOC:682;
     * Servlet:JAVADOC:694; Servlet:JAVADOC:671.10; Servlet:JAVADOC:672.10; Servlet:JAVADOC:673.10;
     *
     ...
     * ServletContextListener
     *
     * Create another ServletContextListener, in which: 5. Call ServletContext.createFilter(Filter) which should fail; 6.
     * Call ServletContext.createServlet(Servlet) which fails 7. Call ServletContext.createListener(EventListener) which
     * fails 8. Call ServletContext.addListener(ServletContextListener.class) which fails 9. Call
     * ServletContext.addListener(ServletContextListenerClassName) which fails 10. Call
     * ServletContext.createListener(ServletContextListener.class) which fails 11. Call ServletContext.setInitParameter to
     * pass information about status on 4-6 12. In another Servlet, get all information stored in ServletContext
     * InitParameter 13. Send a request to the new Servlet Verify that - createServlet failed accordingly; - createFilter
     * failed accordingly; - createListener failed accordingly; - addListener failed accordingly; - setInitParameter works
     * properly
     */
     ...
     *
     * @test_Strategy: 1. Create a Servlet Servlet, define it in web.xml; 2. Create a ServletContextListener, in which: 3.
     * try to add the Servlet again by calling ServletContext.addServlet(servletName, Servlet.class) 6. Verify that the
     * Servlet can be invoked as defined in web.xml1.
     */
    public void duplicateServletTest1() throws Fault {
        TEST_PROPS.setProperty(REQUEST, "GET " + getContextRoot() + "/DuplicateServletClass HTTP/1.0");
     ...
     *
     * @test_Strategy: 1. Create a Servlet Servlet, define it in web.xml; 2. Create a ServletContextListener, in which: 3.
     * try to add the Servlet again by calling ServletContext.addServlet(servletName, "Servlet.class") 4. Verify that the
     * Servlet can be invoked as defined in web.xm1.
     */
    public void duplicateServletTest2() throws Fault {
        TEST_PROPS.setProperty(REQUEST, "GET " + getContextRoot() + "/DuplicateServletString HTTP/1.0");
     ...
     *
     * @assertion_ids: Servlet:JAVADOC:674.5; Servlet:JAVADOC:675.5; Servlet:JAVADOC:676.5;
     *
     * @test_Strategy: 1. Create a Servlet Servlet1, define it in web.xml; 2. Create a Servlet Servlet2, define it in
     * web.xml; 3. Create a ServletContextListener, in which: 4. try to add the Servlet1 again by calling
     * ServletContext.addServlet(servletName, Servlet.class) 4. try to add the Servlet2 again by calling
     * ServletContext.addServlet(servletName, "Servlet.class") 4. Verify null is returned in both cases.
     */
    public void duplicateServletTest3() throws Fault {
        TEST_PROPS.setProperty(APITEST, "duplicateServletTest3");
        TEST_PROPS.setProperty(SEARCH_STRING, "DUPLICATEC_SERVLET_TEST=TRUE" + "|DUPLICATES_SERVLET_TEST=TRUE");
        invoke();
    }
     ...
     *
     * @test_Strategy: 1. Create a Filter Filter1, define it in web.xml; 2. Create a Filter Filter2, define it in web.xml;
     * 3. Create a ServletContextListener, in which: 4. try to add Filter1 again by calling
     * ServletContext.addFilter(FilterName, Filter.class) 5. try to add Filter2 again by calling
     * ServletContext.addFilter(FilterName,,"Filter.class") 6. Verify that both Filter can be invoked as defined in web.xml
     */
    public void duplicateFilterTest() throws Fault {
        TEST_PROPS.setProperty(REQUEST, "GET " + getContextRoot() + "/FilterTestServlet HTTP/1.0");
     ...
     * 3. Create a ServletContextListener, in which: 4. try to add Filter1 again by calling
     * ServletContext.addFilter(FilterName, Filter.class) 5. try to add Filter2 again by calling
     * ServletContext.addFilter(FilterName,,"Filter.class") 6. Verify that null is returned in both cases
     */
    public void duplicateFilterTest1() throws Fault {
        TEST_PROPS.setProperty(APITEST, "duplicateFilterTest1");
        TEST_PROPS.setProperty(SEARCH_STRING, "DUPLICATEC_FILTER_TEST=TRUE" + "|DUPLICATES_FILTER_TEST=TRUE");
        invoke();
    }
     ...
     *
     * @test_Strategy: Create a Servlet, in which call ServletContext.getEffectiveMajorVersion() Verify that 5 is returned.
     */
     ...
     *
     * @test_Strategy: Create a Servlet, in which call ServletContext.getEffectiveMinorVersion() Verify that 0 is returned.
     */
     ...
     *
     * @test_Strategy: Create a Servlet, verify SessionTrackingModes.valueOf() works
     */
     ...
     *
     * @test_Strategy: Create a Servlet, verify SessionTrackingModes.values() works
     */

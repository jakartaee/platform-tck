...
public class AsyncTestServlet extends GenericTCKServlet {
    ...
    public void dispatchZeroArgTest2(ServletRequest request, ServletResponse response) throws IOException {
        ...
        if ("ASYNC".equals(where)) {
            ...
            response.getWriter().println("IsAsyncStarted=" + request.isAsyncStarted());
            response.getWriter().println("DispatcherType=" + request.getDispatcherType());
            AsyncContext ac = request.startAsync(new RequestWrapper(request), new ResponseWrapper(response));
            request.setAttribute("WHERE", "ASYNC");
            ac.dispatch();
        }
    }
        ...
        asyncTimer.schedule(
                new TimerTask() {
                    ...
                    public void run() {
                        try {
                            if (ac.getRequest() == request) {
                                ac.getResponse().getWriter().println("getRequest() worked.  Test PASSED.");
                            } else {
                                ac.getResponse()
                                        .getWriter()
            ...
            public void run() {
                try {
                    if (ac.getRequest() == request) {
                        ...
                        ac.getResponse().getWriter().println("getRequest() didnot work as expected.  Test FAILED.");
                    }
                    ac.complete();
                } catch (java.io.IOException ioe) {
                    ioe.printStackTrace();
    ...
    public void asyncListenerTest(ServletRequest request, ServletResponse response)
    ...
    public void asyncListenerTest1(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
    ...
    public void asyncListenerTest2(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
    ...
    // Test for AsyncContext.createListener and
    // AsyncContext.addListener(AsyncListener)
    public void asyncListenerTest5(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
    ...
    // Negative test for AsyncContext.createListener
    public void asyncListenerTest6(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
        long timeout_set = 5015L;
    ...
    // Test for AsyncContext.createListener and
    // AsyncContext.addListener(AsyncListener, ServletRequest, ServletResponse)
    public void asyncListenerTest7(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
    ...
    public void originalRequestTest(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
    ...
    // Test for AsyncContext.hasOriginalRequestAndResponse()
    public void originalRequestTest1(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
    ...
    public void originalRequestTest2(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
    ...
    // Negative test for AsyncContext.hasOriginalRequestAndResponse()
    public void originalRequestTest3(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
    ...
    // Negative test for AsyncContext.hasOriginalRequestAndResponse()
    public void originalRequestTest4(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {

        AsyncContext ac = request.startAsync(request, new ResponseWrapper(response));
        if (ac.hasOriginalRequestAndResponse()) {
            response.getWriter().println("Test FAILED. AsyncContext.hasOriginalRequestAndRespons()=true");
        } else {
            response.getWriter().println("Test PASSED. AsyncContext.hasOriginalRequestAndRespons()=false");

...
public class URLClient extends AbstractUrlClient {
    ...
    public Status run(String args[], PrintWriter out, PrintWriter err) {
        ...
        setContextRoot("/servlet_sci_getfilterregistrations_web");
     ...
     * ServletContext.addListener; in the ServletContextListener call ServletContext.getFilterRegistrations() Verify that

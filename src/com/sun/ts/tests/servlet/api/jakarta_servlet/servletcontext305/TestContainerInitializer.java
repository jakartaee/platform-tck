...
public class TestContainerInitializer implements ServletContainerInitializer {
    ...
    public void onStartup(Set<Class<?>> arg0, ServletContext context) throws ServletException {
         ...
         */
        context.addListener(com.sun.ts.tests.servlet.api.jakarta_servlet.servletcontext305.AddSCListenerClass.class);

        context.addListener("com.sun.ts.tests.servlet.api.jakarta_servlet.servletcontext305.AddSCListenerString");
        try {
            ...
            System.out.println("Error creating Listener CreateSCListener: " + ex.getMessage());
            ex.printStackTrace();
        }
        ...
        try {
            ...
            System.out.println("Error adding Listener addListener: " + ex.getMessage());
        }

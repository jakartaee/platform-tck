...
public class URLClient extends AbstractUrlClient {
    ...
    public Status run(String args[], PrintWriter out, PrintWriter err) {
        ...
        setContextRoot("/servlet_sci_geteffectivesessiontrackingmode_web");
     ...
     * ServletContext.addListener; in the ServletContextListener call ServletContext.getEffectiveSessionTrackingModes()

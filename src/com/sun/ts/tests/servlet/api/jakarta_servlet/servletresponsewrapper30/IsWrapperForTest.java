...
public class IsWrapperForTest extends GenericServlet {
    ...
    public void service(ServletRequest req, ServletResponse response) throws ServletException, IOException {
        ...
        ServletResponseWrapper resWrapper2 = new TCKServletResponseWrapper(resWrapper1);
        ServletResponseWrapper resWrapper3 = new TCKServletResponseWrapper(resWrapper2);
        TCKServletResponsesubWrapper myresWrapper = new TCKServletResponsesubWrapper(response);

...
public class TestServlet extends GenericTCKServlet {
    ...
    public void getRealPath(ServletRequest request, ServletResponse response) throws ServletException, IOException {
        ...
        String win32Path = new StringBuffer(45)
                .append(File.separatorChar)
                .append("servlet_js_ServletContext")
                .append(File.separatorChar)
                .append("Test")
                .toString();
        ...
        if (realPath == null && realPathNoSolidus == null || realPath != null && realPath.equals(realPathNoSolidus)) {
     ...
     */
    public void getResourceAsStream(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
        boolean passed = false;
        PrintWriter pw = response.getWriter();
        ServletConfig config = this.getServletConfig();
     ...
     */
    public void getResourceAsStream_1(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
        boolean passed = false;
        PrintWriter pw = response.getWriter();
     ...
     */
    public void servletContextGetAttribute(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
     ...
     */
    public void servletContextGetContext(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
     ...
     */
    public void servletContextGetInitParameterNames(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
        boolean passed = true;
        PrintWriter pw = response.getWriter();
        ServletConfig config = this.getServletConfig();
     ...
     */
    public void servletContextGetInitParameter(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
        boolean passed = false;
        PrintWriter pw = response.getWriter();
        ServletConfig config = this.getServletConfig();
     ...
     */
    public void servletContextGetInitParameterNull(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
        boolean passed = false;
        PrintWriter pw = response.getWriter();
     ...
     */
    public void servletContextRemoveAttribute(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
        boolean passed = false;
        PrintWriter pw = response.getWriter();
        ServletConfig config = this.getServletConfig();
     ...
     */
    public void servletContextSetAttribute(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
        boolean passed = false;
        PrintWriter pw = response.getWriter();
        ServletConfig config = this.getServletConfig();
        ...
        if (attr != null) {
            if (attr.getClass().getName().equals("java.lang.String")) {
                ...
                passed = false;
                pw.println(
                        "setAttribute(" + param1 + "," + param2 + ") did not set an attribute of type String properly");
            }
        }
        ServletTestUtil.printResult(pw, passed);
    }

    public void servletContextSetAttribute_1(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
        boolean passed = false;
        PrintWriter pw = response.getWriter();
    ...
    public void servletContextSetAttribute_2(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
        boolean passed = false;
        PrintWriter pw = response.getWriter();
    ...
    public void servletContextGetAttributeNames(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
        boolean passed = false;
        PrintWriter pw = response.getWriter();
        ServletConfig config = this.getServletConfig();
     ...
     */
    public void servletContextGetRequestDispatcher(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
        /**
     ...
     */
    public void getNamedDispatcher_1(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
        boolean passed = false;
        PrintWriter pw = response.getWriter();
     ...
     */
    public void getServletNameTest(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
        boolean passed = false;
        PrintWriter pw = response.getWriter();
        ServletConfig config = this.getServletConfig();
    ...
    public void getServletTempDir(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
        boolean passed = false;
        PrintWriter pw = response.getWriter();
        ServletConfig config = this.getServletConfig();
        ...
        try {
            java.io.File tmp = (java.io.File) context.getAttribute("jakarta.servlet.context.tempdir");
            if (tmp != null) {
                ...
                if (tmp.exists()) {
                    ...
                    passed = false;
                    pw.println("jakarta.servlet.context.tempdir points to a non-existing dir");
                }
            } else {
                passed = false;
            ...
            passed = false;
            pw.println("Got Exception when retrieving jakarta.servlet.temp.dir attribute:" + ex.toString());
        }
        ServletTestUtil.printResult(pw, passed);
    }
}

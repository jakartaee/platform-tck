...
public class TestListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        srString.setInitParameter(addFilterName1, DispatcherType.FORWARD.toString());
        ...
        frString.setInitParameter(addServletName1, DispatcherType.FORWARD.toString());
        ...
        frClass.setInitParameter(addServletName2, DispatcherType.REQUEST.toString());
        ...
        try {
            ...
            srServlet.setInitParameter(addFilterName3, DispatcherType.REQUEST.toString());
            ...
            frFilter.setInitParameter(addServletName3, DispatcherType.REQUEST.toString());
         ...
         */
        context.addListener(com.sun.ts.tests.servlet.api.jakarta_servlet.servletcontext30.AddSRListenerClass.class);
        context.addListener("com.sun.ts.tests.servlet.api.jakarta_servlet.servletcontext30.AddSRListenerString");
        try {
        ...
        try {
            context.createListener(com.sun.ts.tests.servlet.api.jakarta_servlet.servletcontext30.BadListener.class);
        } catch (ServletException ex) {
            listener_test = true;
        }
        ...
        try {
            context.addListener(com.sun.ts.tests.servlet.api.jakarta_servlet.servletcontext30.AddSCListenerClass.class);
        ...
        try {
            context.addListener("com.sun.ts.tests.servlet.api.jakarta_servlet.servletcontext30.AddSCListenerString");
        } catch (IllegalArgumentException ilex) {
         ...
         */
        ServletRegistration srdClass = context.addServlet(
                addServletName5,
        ...
        ServletRegistration srdString = context.addServlet(
                addServletName6,
        ...
        FilterRegistration frdClass = context.addFilter(
                addFilterName6,
        ...
        FilterRegistration frdString = context.addFilter(
                addFilterName6, "com.sun.ts.tests.servlet.api.jakarta_servlet.servletcontext30.DuplicateFilterString");
        if (frdString == null) {

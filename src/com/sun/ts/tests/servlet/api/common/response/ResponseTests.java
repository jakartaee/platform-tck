...
public class ResponseTests {
    ...
    public static void responseWrapperConstructorTest(ServletRequest request, ServletResponse response)
    ...
    public static void responseWrapperGetResponseTest(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
    ...
    public static void responseWrapperSetResponseTest(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
    ...
    public static void flushBufferTest(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
    ...
    public static void getBufferSizeTest(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
    ...
    public static void getOutputStreamFlushTest(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
    ...
    public static void getOutputStreamTest(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
    ...
    public static void getOutputStreamIllegalStateExceptionTest(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
    ...
    public static void setCharacterEncodingTest(ServletRequest request, ServletResponse response) throws IOException {
        boolean pass = true;
    ...
    public static void getWriterTest(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
        boolean pass = false;
    ...
    public static void getWriterFlushTest(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
        boolean passed = false;
        PrintWriter pw = response.getWriter();
        response.setContentType("text/html;charset=ISO-8859-7");
    ...
    public static void getWriterAfterTest(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
        boolean pass = false;
    ...
    public static void getWriterIllegalStateExceptionTest(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
    ...
    public static void isCommittedTest(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
    ...
    public static void resetTest1(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
        ServletOutputStream sos = null;
    ...
    public static void resetIllegalStateExceptionTest(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
    ...
    public static void getCharacterEncodingDefaultTest(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
    ...
    public static void getCharacterEncodingTest(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
    ...
    public static void setBufferSizeTest(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
        boolean passed = false;
        PrintWriter pw = response.getWriter();
    ...
    public static void setBufferSizeIllegalStateExceptionTest(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
    ...
    public static void setContentLengthTest(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
    ...
    public static void setContentTypeTest(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
        response.setContentType("text/html");
    }

    public static void setContentType1Test(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
        boolean passed = false;
        String expected = "text/html";
        response.setContentType(expected);
    ...
    public static void setContentType2Test(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
        String expected = "text/html";
    ...
    public static void getContentTypeTest(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
    ...
    public static void getContentType1Test(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
    ...
    public static void getContentTypeNullTest(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
        PrintWriter pw = response.getWriter();
        String actual = response.getContentType();
    ...
    public static void getContentTypeNull1Test(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
    ...
    public static void getContentTypeNull2Test(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
    ...
    public static void setLocaleTest(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
    ...
    public static void setLocale1Test(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
        boolean passed = false;
        ...
        if (actual == null) {
            ...
            pw.println("The value returned by getContentType() did not contain the expected result=" + expected1 + ";"
                    + expected2);
            pw.println("actual=" + actual);
        }
        ServletTestUtil.printResult(pw, passed);
    ...
    public static void getLocaleDefaultTest(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
    ...
    public static void getLocaleTest(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
        boolean passed = false;
        PrintWriter pw = response.getWriter();
    ...
    public static void resetBufferTest(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
    ...
    public static void httpResponseWrapperConstructorTest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        PrintWriter pw = response.getWriter();
    ...
    public static void addCookieTest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
    ...
    public static void addDateHeaderTest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
    ...
    public static void addHeaderTest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
    ...
    public static void addIntHeaderTest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
    ...
    public static void containsHeaderTest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
    ...
    public static void sendError_StringTest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
    ...
    public static void setDateHeaderTest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
    ...
    public static void setHeaderTest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
    ...
    public static void setMultiHeaderTest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        response.setHeader("header", "value1");
    ...
    public static void setIntHeaderTest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
    ...
    public static void setStatusTest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {

        response.setStatus(HttpServletResponse.SC_OK);
    }

    public static void setStatusTest1(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {

        response.setStatus(HttpServletResponse.SC_NOT_FOUND);
    }

    public static void getHeadersTest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        PrintWriter pw = response.getWriter();
        Boolean passed = true;
    ...
    public static void getHeaderTest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        PrintWriter pw = response.getWriter();
        Boolean passed = false;
        String name = "TestheadersUnique";
    ...
    public static void getHeaderNamesTest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        PrintWriter pw = response.getWriter();
        Boolean passed = true;
    ...
    public static void getStatusTest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        Boolean passed = true;
        PrintWriter pw = response.getWriter();

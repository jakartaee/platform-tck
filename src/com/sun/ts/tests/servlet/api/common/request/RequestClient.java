...
public class RequestClient extends AbstractUrlClient {
    ...
    public void getContentLengthTest() throws Fault {
        ...
        TEST_PROPS.setProperty(
                REQUEST, "POST " + getContextRoot() + "/" + getServletName() + "?testname=" + testName + " HTTP/1.1");
    ...
    public void getParameterMapTest() throws Fault {
        ...
        TEST_PROPS.setProperty(
                ...
                "GET " + getContextRoot() + "/" + getServletName() + "?testname=" + testName
                        + "&parameter1=value1&parameter2=value2 HTTP/1.1");
        TEST_PROPS.setProperty(SEARCH_STRING, Data.PASSED);
        invoke();
    }
    ...
    public void getParameterValuesTest() throws Fault {
        ...
        TEST_PROPS.setProperty(
                REQUEST,
                "GET " + getContextRoot() + "/" + getServletName() + "?testname=" + testName
                        + "&Names=value1&Names=value2 HTTP/1.1");
        TEST_PROPS.setProperty(SEARCH_STRING, Data.PASSED);
        invoke();
    }
    ...
    public void getRemoteAddrTest() throws Fault {
        ...
        TEST_PROPS.setProperty(
                REQUEST,
                "GET " + getContextRoot() + "/" + getServletName() + "?testname=" + testName + "&Address=" + localIps
                        + " HTTP/1.1");
        TEST_PROPS.setProperty(SEARCH_STRING, Data.PASSED);
        invoke();
    }
    ...
    public void getServerNameTest() throws Fault {
        ...
        TEST_PROPS.setProperty(
                REQUEST,
                "GET " + getContextRoot() + "/" + getServletName() + "?testname=" + testName + "&hostname=" + _hostname
                        + " HTTP/1.1");
        TEST_PROPS.setProperty(SEARCH_STRING, Data.PASSED);
        invoke();
    }
    ...
    public void getServerPortTest() throws Fault {
        ...
        TEST_PROPS.setProperty(
                REQUEST,
                "GET " + getContextRoot() + "/" + getServletName() + "?testname=" + testName + "&port=" + _port
                        + " HTTP/1.1");
        TEST_PROPS.setProperty(SEARCH_STRING, Data.PASSED);
        invoke();
    }
    ...
    public void setCharacterEncodingUnsupportedEncodingExceptionTest() throws Fault {
    ...
    public void getLocalPortTest() throws Fault {
        ...
        TEST_PROPS.setProperty(
                REQUEST,
                "GET " + getContextRoot() + "/" + getServletName() + "?testname=" + testName + "&hostport=" + _port
                        + " HTTP/1.1");
        TEST_PROPS.setProperty(SEARCH_STRING, Data.PASSED);
        invoke();
    }

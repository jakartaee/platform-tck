...
public class URLClient extends HttpResponseClient {
     ...
     * @test_Strategy: Servlet sets wrapped response object
     */
    public void httpResponseWrapperSetResponseIllegalArgumentExceptionTest() throws Fault {
    ...
    public void sendRedirectTest() throws Fault {
        ...
        TEST_PROPS.setProperty(
                EXPECTED_HEADERS,
                "Location: http://" + _hostname + ":" + _port + "" + getContextRoot() + "/RedirectedTest");
        TEST_PROPS.setProperty(STATUS_CODE, MOVED_TEMPORARY);
        invoke();
    }
     ...
     *
     * @test_Strategy: Testing Servlet API HttpServletResponseWrapper.setStatus(SC_OK)
     */
     ...
     * @assertion_ids: Servlet:JAVADOC:332
     *
     * @test_Strategy: Testing Servlet API HttpServletResponseWrapper.setStatus(SC_NOT_FOUND)
     */

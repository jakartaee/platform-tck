...
public class URLClient extends AbstractUrlClient {
    ...
    public Status run(String args[], PrintWriter out, PrintWriter err) {
        ...
        setContextRoot("/servlet_jsh_httpsessionactivationlistener40_web");
     ...
     * @assertion_ids: NA;
     *
     * @test_Strategy: Client successfully calls a servlet with an empty HttpSessionActivation listener implementation
     * class.
     *
     */

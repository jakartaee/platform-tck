...
public class URLClient extends AbstractUrlClient {
     ...
     *
     * @assertion_ids: Servlet:JAVADOC:754; Servlet:JAVADOC:757; Servlet:JAVADOC:787; Servlet:JAVADOC:789;
     * Servlet:JAVADOC:793; Servlet:JAVADOC:794; Servlet:JAVADOC:955;
     *
     * @test_Strategy: Create a Servlet TestServlet; From client, send multi-part form without file Verify that the data is
    ...
    public void getPartTest() throws Fault {
        ...
        String requestUrl = getContextRoot() + "/" + getServletName() + "?testname=" + testname + " HTTP/1.1";
        URL url = null;
        ...
        try {
            ...
            passed = false;
            throw new Fault(
                    "EXception getting URL " + requestUrl + " with host " + _hostname + " at port " + _port, ex);
        }
        ...
        try {
            ...
            passed = false;
            throw new Fault("EXception getting Socket " + " with host " + _hostname + " at port " + _port, ex);
        }
     ...
     *
     * @test_Strategy: Create a Servlet TestServlet; From client, send a non-multi-part form data request with a form data
     * Verify HttpServletRequest.getPart(String name) throw ServletException
     */
     ...
     *
     * @test_Strategy: Create a Servlet TestServlet; From client, send a non-multi-part form data request with a few form
     * data Verify HttpServletRequest.getParts() throw ServletException
     */
     ...
     * Servlet:JAVADOC:793; Servlet:JAVADOC:794; Servlet:JAVADOC:955;
     *
     * @test_Strategy: Create a Servlet TestServlet; From client, send multi-part form with several parts, with and without
     ...
     *
     * @test_Strategy: Create a Servlet TestServlet; From client, send multi-part form with several parts, with and without
     * file Verify that Part.getHeader(String) works correctly
     */
     ...
     *
     * @test_Strategy: Create a Servlet TestServlet; From client, send multi-part form with several parts, with and without
     * file Verify that Part.getHeaders(String) works correctly
     */
     ...
     *
     * @test_Strategy: Create a Servlet TestServlet; From client, send multi-part form with several parts, with and without
     * file Verify that Part.getInputStream() works correctly
     */

...
public class URLClient extends AbstractUrlClient {
    ...
    public Status run(String args[], PrintWriter out, PrintWriter err) {
        ...
        setContextRoot("/servlet_jsh_servletcontext305_web");
     ...
     *
     * @assertion_ids: Servlet:JAVADOC:671.5; Servlet:JAVADOC:672.5; Servlet:JAVADOC:673.5;
     *
     * @test_Strategy: In a ServletContextListener, call: - ServletContext.addListener(TCKTestListener.class) -
     * ervletContext.addListener("TCKTestListener") - ServletContext.createListener(TCKTestListener.class) TCKTestListener
     * implements the following Listener interfaces on the list: - HttpSessionAttributeListener Verify it works
     */

...
public class Client extends EETest {
    ...
    public void httpServletMappingTest() throws Fault {
        simpleTest(
                "httpServletMappingTest",
                CONTEXT_ROOT + "/TestServlet",
                "GET",
    ...
    public void httpServletMappingForwardTest() throws Fault {
        simpleTest(
                "httpServletMappingForwardTest",
                CONTEXT_ROOT + "/ForwardServlet",
                "GET",
                "matchValue=a, pattern=*.ts, servletName=TestServlet, mappingMatch=EXTENSION");
    }
    ...
    public void httpServletMappingNamedForwardTest() throws Fault {
        simpleTest(
                "httpServletMappingNamedForwardTest",
                CONTEXT_ROOT + "/NamedForwardServlet",
                "GET",
    ...
    public void httpServletMappingNamedIncludeTest() throws Fault {
        simpleTest(
                "httpServletMappingNamedIncludeTest",
                CONTEXT_ROOT + "/NamedIncludeServlet",
                "GET",
    ...
    public void httpServletMappingIncludeTest() throws Fault {
        simpleTest(
                "httpServletMappingIncludeTest",
                CONTEXT_ROOT + "/IncludeServlet",
                "POST",
    ...
    public void httpServletMappingFilterTest() throws Fault {
        simpleTest(
                "httpServletMappingFilterTest",
                CONTEXT_ROOT + "/ForwardFilter",
                "GET",
                "matchValue=, pattern=/, servletName=defaultServlet, mappingMatch=DEFAULT");
    }
    ...
    public void httpServletMappingDispatchTest() throws Fault {
        simpleTest(
                "httpServletMappingDispatchTest",
                CONTEXT_ROOT + "/DispatchServlet",
                "GET",
                "matchValue=TestServlet, pattern=/TestServlet, servletName=TestServlet, mappingMatch=EXACT");
    }

    private void simpleTest(String testName, String request, String method, String expected) throws Fault {
        try {
            TestUtil.logMsg("Sending request \"" + request + "\"");

            response = WebUtil.sendRequest(
                    method, InetAddress.getByName(hostname), portnum, tsurl.getRequest(request), null, null);
    ...
    public void TrailerTest() throws Fault {
        ...
        try {
            url = new URL("http://" + hostname + ":" + portnum + CONTEXT_ROOT + "/TrailerTestServlet");
    ...
    public void TrailerTest2() throws Fault {
        simpleTest("TrailerTest2", CONTEXT_ROOT + "/TrailerTestServlet", "POST", "isTrailerFieldsReady: true");
        simpleTest("TrailerTest2", CONTEXT_ROOT + "/TrailerTestServlet", "POST", "Trailer: {}");
    }
}

...
public class URLClient extends AbstractUrlClient {
    ...
    public void getDomainTest() throws Fault {
        ...
        TEST_PROPS.setProperty(
                REQUEST_HEADERS,
                "Cookie: $Version=1; name1=value1; $Domain=" + _hostname + "; $Path=/servlet_jsh_cookie_web");
    ...
    public void getNameTest() throws Fault {
        // version 0
        TEST_PROPS.setProperty(
                REQUEST_HEADERS, "Cookie: name1=value1; Domain=" + _hostname + "; Path=/servlet_jsh_cookie_web");

...
public class TestServlet extends HttpTCKServlet {
    ...
    public void constructortest1(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if (results.indexOf("-FAILED-") > -1) {
            ServletTestUtil.printResult(response.getWriter(), "At least on test failed.  " + results);
        }
    }
    ...
    public void setCommentTest(HttpServletRequest request, HttpServletResponse response) throws IOException {
    ...
    public void setMaxAgeTest(HttpServletRequest request, HttpServletResponse response) throws IOException {
        int maxage = 12345;
        boolean pass = true;
        PrintWriter pw = response.getWriter();
        HttpSession session = request.getSession();

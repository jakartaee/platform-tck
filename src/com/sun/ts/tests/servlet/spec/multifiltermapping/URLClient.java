...
public class URLClient extends AbstractUrlClient {
     ...
     *
     * @test_Strategy: 1. Create a web page - /dummy.html. 2. Create servlets TestServlet1 with URL /foo/bar/*, TestServlet2
     * with URL /foo/baR/*, TestServlet3 with URL /TestServlet3, TestServlet4 with URL *.bop, TestServlet5 with URL
     * /foo/bar/TestServlet5, TestServlet6 with servlet-name TestServlet6, 2. Map a filter Test_RequestFilter on all above
     * one web page and 6 servlets with dispatcher value set to REQUEST using url-pattern and servlet name respectively. 3.
     * Client try to access all of them directly. 4. Verify that Test_RequestFilter is properly invoked.
     */
     ...
     * @test_Strategy: 1. Create a web page - /dummy.html. 2. Create servlets TestServlet1 with URL /foo/bar/*, TestServlet2
     * with URL /foo/baR/*, TestServlet3 with URL /TestServlet3, TestServlet4 with URL *.bop, TestServlet5 with URL
     * /foo/bar/TestServlet5, TestServlet6 with servlet-name TestServlet6; 3. Map a filter Test_ForwardFilter on all above
     * one web page and 6 servlets with dispatcher value set to FORWARD using url-pattern and servlet name respectively. 4.
     * Create a servlet TestServlet. 5. Client send request to TestServlet, which access all resources list in 1 and 2 using
    ...
    public void forwardTest() throws Fault {
        ...
        TEST_PROPS.setProperty(
                REQUEST,
                "GET " + getContextRoot() + "/" + getServletName() + "?testname=" + testName
                        + "&parameter1=/foo/bar/index.html HTTP/1.1");
        invoke();

        TEST_PROPS.setProperty(
                REQUEST,
                "GET " + getContextRoot() + "/" + getServletName() + "?testname=" + testName
                        + "&parameter1=/foo/bar HTTP/1.1");
        TEST_PROPS.setProperty(SEARCH_STRING, "Test_ForwardFilter|TestServlet1");
        invoke();
        ...
        TEST_PROPS.setProperty(
                REQUEST,
                "GET " + getContextRoot() + "/" + getServletName() + "?testname=" + testName
                        + "&parameter1=/foo/baR/TestServlet5 HTTP/1.1");
        ...
        TEST_PROPS.setProperty(
                REQUEST,
                "GET " + getContextRoot() + "/" + getServletName() + "?testname=" + testName
                        + "&parameter1=/TestServlet3 HTTP/1.1");
        ...
        TEST_PROPS.setProperty(
                REQUEST,
                "GET " + getContextRoot() + "/" + getServletName() + "?testname=" + testName
                        + "&parameter1=/test/servletbyname HTTP/1.1");
        ...
        TEST_PROPS.setProperty(
                REQUEST,
                "GET " + getContextRoot() + "/" + getServletName() + "?testname=" + testName
                        + "&parameter1=/dummy.html HTTP/1.1");
        ...
        TEST_PROPS.setProperty(
                REQUEST,
                "GET " + getContextRoot() + "/" + getServletName() + "?testname=" + testName
                        + "&parameter1=/TestServlet3/racecar.bop HTTP/1.1");
        TEST_PROPS.setProperty(SEARCH_STRING, "Test_ForwardFilter|TestServlet4");
        invoke();
    }
     ...
     * @test_Strategy: 1. Create a web page - /dummy.html. 2. Create servlets TestServlet1 with URL /foo/bar/*, TestServlet2
     * with URL /foo/baR/*, TestServlet3 with URL /TestServlet3, TestServlet4 with URL *.bop, TestServlet5 with URL
     * /foo/bar/TestServlet5, TestServlet6 with servlet-name TestServlet6; 3. Map a filter Test_IncludeFilter on all above
     * one web page and 6 servlets with dispatcher value set to INCLUDE using url-pattern and servlet name respectively. 4.
     * Create a servlet TestServlet. 5. Client send request to TestServlet, which access all resources list in 1 and 2 using
    ...
    public void includeTest() throws Fault {
        ...
        TEST_PROPS.setProperty(
                ...
                "GET " + getContextRoot() + "/" + getServletName() + "?testname=" + testName
                        + "&parameter1=/dummy.html HTTP/1.1");
        TEST_PROPS.setProperty(SEARCH_STRING, filterString + "|Test FAILED from dummy html page");
        invoke();
     ...
     * @test_Strategy: 1. Create a web page - /dummy.html. 2. Create servlets TestServlet1 with URL /foo/bar/*, TestServlet2
     * with URL /foo/baR/*, TestServlet3 with URL /TestServlet3, TestServlet4 with URL *.bop, TestServlet5 with URL
     * /foo/bar/TestServlet5, TestServlet6 with servlet-name TestServlet6, 3. Map a filter Test_RequestFilter on all above
     * one web page and six servlets with dispatcher value set to REQUEST, using url-pattern and servlet name respectively.
     * 4. Map a filter Test_ForwardFilter on all above one web page and six servlets with dispatcher value set to FORWARD
     * using url-pattern and servlet name respectively. 5. Map a filter Test_ErrorFilter to an servlet ErrorPage with
     * dispatcher value set to ERROR 6. access a resource that dose not match any resource listed in 1 and 2, 7. verify that
     * Test_ErrorFilter is properly invoked 8. Create a servlet TestServlet. 9. Client send request to TestServlet, which
     * access a resource that dose not match any resource listed in 1 and 2 using include and forward respectively. 10.
     * Verify that Test_ErrorFilter is properly invoked.
     */

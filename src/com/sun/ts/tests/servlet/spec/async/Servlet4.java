...
public class Servlet4 extends GenericServlet {
    ...
    public void startA(ServletRequest request, ServletResponse response) throws ServletException, IOException {
        try {
            response.getWriter().println(filter_name + "=" + request.getAttribute(filter_name));
    ...
    public void testdirect(ServletRequest request, ServletResponse response) throws ServletException, IOException {
        PrintWriter pw = response.getWriter();
        pw.println(filter_name + "=" + request.getAttribute(filter_name));
        pw.println("Servlet4_Async=" + request.isAsyncSupported());
    ...
    public void teststartA(ServletRequest request, ServletResponse response) throws ServletException, IOException {
        PrintWriter pw = response.getWriter();
        pw.println(filter_name + "=" + request.getAttribute(filter_name));
        pw.println("Servlet4_Async=" + request.isAsyncSupported());

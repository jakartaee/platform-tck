...
public class URLClient extends EETest {
    ...
    public void testFlushBufferHttp() throws Fault {
        ...
        try {
            URL u = new URL("http://" + host + ":" + port + contextPath + "/HttpTestServlet");
            TestUtil.logTrace("URL: http://" + host + ":" + port + contextPath + "/HttpTestServlet");
            ...
            while ((line = bis.readLine()) != null) {
                ...
                if (line.contains("flushBufferTest for compatibility") && (time1 == 0L)) {
            ...
            if (((time2 - time1) > 5000) && (time1 != 0L) && (time2 != 0L)) {
                TestUtil.logTrace("Test passed.  There is decent time difference between two clocked time.");
            } else {
                throw new Fault("Test failed: there is not enough time between two clocked time");
            }
    ...
    public void testFlushBuffer() throws Fault {
        ...
        try {
            URL u = new URL("http://" + host + ":" + port + contextPath + "/TestServlet");
            TestUtil.logTrace("URL: http://" + host + ":" + port + contextPath + "/TestServlet");

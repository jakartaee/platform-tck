...
public class TestServlet extends GenericTCKServlet {
    ...
    public void ContextListenerTest(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
        response.getWriter().println(getServletContext().getAttribute("ContextListener"));
    ...
    public void ContextAttributeListenerTest(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
    ...
    public void RequsetListenerTest(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
    ...
    public void RepeatRequsetListenerTest(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
        response.getWriter().println(getServletContext().getAttribute("SRList"));
        getServletContext().removeAttribute("SRAList");
        getServletContext().removeAttribute("SCAList");
    ...
    public void RequsetAttributeListenerTest(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {
    ...
    public void HttpSessionAttributeListenerPreLude(ServletRequest request, ServletResponse response)
        ...
        httpServletReq.getSession().setAttribute("Test", "HttpSessionAttributeListenerPreludeB");

        // replace session attribute to trigger attributeReplaced() notification
        httpServletReq.getSession().setAttribute("Test", "HttpSessionAttributeListenerPrelude");

        // remove session attribute to trigger attributeRemoved notification
        httpServletReq.getSession().removeAttribute("Test");
    }

    public void HttpSessionAttributeListenerTest(ServletRequest request, ServletResponse response)
            throws ServletException, IOException {

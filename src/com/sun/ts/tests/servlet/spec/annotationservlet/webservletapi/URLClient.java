...
public class URLClient extends AbstractUrlClient {
    ...
    public void test1() throws Fault {
        ...
        TEST_PROPS.setProperty(REQUEST, "GET " + getContextRoot() + "/Servlet1APIURL HTTP/1.1");
        TEST_PROPS.setProperty(SEARCH_STRING, "Servlet1_INVOKED" + "|servletname=Servlet1API|isAsyncSupported=false");
        invoke();
    }
    ...
    public void test2() throws Fault {
        ...
        TEST_PROPS.setProperty(REQUEST, "GET " + getContextRoot() + "/Servlet2APIURL HTTP/1.1");
        TEST_PROPS.setProperty(SEARCH_STRING, "Servlet2_INVOKED" + "|servletname=Servlet2API|isAsyncSupported=false");
        invoke();

        TEST_PROPS.setProperty(REQUEST, "GET " + getContextRoot() + "/Servlet2APIURL2 HTTP/1.1");
        TEST_PROPS.setProperty(SEARCH_STRING, "Servlet2_INVOKED" + "|servletname=Servlet2API|isAsyncSupported=false");
        invoke();

        TEST_PROPS.setProperty(REQUEST, "GET " + getContextRoot() + "/test2/indext.xml HTTP/1.1");
        TEST_PROPS.setProperty(SEARCH_STRING, "Servlet2_INVOKED" + "|servletname=Servlet2API|isAsyncSupported=false");
        invoke();

        TEST_PROPS.setProperty(REQUEST, "GET " + getContextRoot() + "/ServletAPIURL2/xyz HTTP/1.1");
        TEST_PROPS.setProperty(
                SEARCH_STRING, "Servlet2_INVOKED" + "|servletname=Servlet2API" + "|isAsyncSupported=false");
        invoke();
    }
    ...
    public void test3() throws Fault {
        ...
        TEST_PROPS.setProperty(
                ...
                "Servlet3_INVOKED|initParams:" + "|name1=value1|name2=value2" + "|servletname=Servlet3"
                        + "|isAsyncSupported=false");
        invoke();

        TEST_PROPS.setProperty(REQUEST, "GET " + getContextRoot() + "/Servlet3APIURL HTTP/1.1");
        TEST_PROPS.setProperty(
                UNORDERED_SEARCH_STRING,
                "Servlet3_INVOKED|initParams:" + "|name1=servlet3|name2=servlet3again" + "|servletname=Servlet3API"
                        + "|isAsyncSupported=false");
        invoke();
    }
}

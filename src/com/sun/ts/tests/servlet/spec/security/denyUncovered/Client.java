...
public class Client extends ServiceEETest implements Serializable {
    ...
    private String ctxtAllMethodsAllowedAnno = contextPath + "/AllMethodsAllowedAnno";

    private String ctxtExcludeAuthConstraint = contextPath + "/ExcludeAuthConstraint";
    ...
    public void testAllMethodsAllowedAnno() throws Fault {
        ...
        if (httpStatusCode != 200) {
            TestUtil.logMsg("Accessing " + ctxtAllMethodsAllowedAnno + "  (POST) returns = " + httpStatusCode);
            throw new Fault("testAllMethodsAllowedAnno : FAILED");
        }

        httpStatusCode = invokeServlet(ctxtAllMethodsAllowedAnno, "GET");
        if (httpStatusCode != 200) {
            TestUtil.logMsg("Accessing " + ctxtAllMethodsAllowedAnno + "  (GET) returns = " + httpStatusCode);
            throw new Fault("testAllMethodsAllowedAnno : FAILED");
        }

        httpStatusCode = invokeServlet(ctxtAllMethodsAllowedAnno, "PUT");
        if (httpStatusCode != 200) {
            TestUtil.logMsg("Accessing " + ctxtAllMethodsAllowedAnno + "  (PUT) returns = " + httpStatusCode);
            throw new Fault("testAllMethodsAllowedAnno : FAILED");
        }

        httpStatusCode = invokeServlet(ctxtAllMethodsAllowedAnno, "DELETE");
        if (httpStatusCode != 200) {
            TestUtil.logMsg("Accessing " + ctxtAllMethodsAllowedAnno + "  (DELETE) returns = " + httpStatusCode);
            throw new Fault("testAllMethodsAllowedAnno : FAILED");
        }
    ...
    public void testAccessToMethodAllowed() throws Fault {
        ...
        if (httpStatusCode != 200) {
            TestUtil.logMsg("Accessing " + ctxtTestServlet + "  (POST) returns = " + httpStatusCode);
            throw new Fault("testAccessToMethodAllowed : FAILED");
        }

        httpStatusCode = invokeServlet(ctxtTestServlet, "GET");
        if (httpStatusCode != 200) {
            TestUtil.logMsg("Accessing " + ctxtTestServlet + "  (GET) returns = " + httpStatusCode);
            throw new Fault("testAccessToMethodAllowed : FAILED");
        }
    ...
    public void testDenySomeUncovered() throws Fault {
        ...
        if (httpStatusCode != 403) {
            TestUtil.logMsg("Accessing " + ctxtTestServlet + "  (DELETE) returns = " + httpStatusCode);
            throw new Fault("testDenySomeUncovered : FAILED");
        }

        httpStatusCode = invokeServlet(ctxtTestServlet, "PUT");
        if (httpStatusCode != 403) {
            TestUtil.logMsg("Accessing " + ctxtTestServlet + "  (PUT) returns = " + httpStatusCode);
            throw new Fault("testDenySomeUncovered : FAILED");
        }
    ...
    public void testExcludeAuthConstraint() throws Fault {
        ...
        if (httpStatusCode != 403) {
            TestUtil.logMsg("Accessing " + ctxtExcludeAuthConstraint + "  (GET) returns = " + httpStatusCode);
            throw new Fault("testExcludeAuthConstraint : FAILED");
        }

        httpStatusCode = invokeServlet(ctxtExcludeAuthConstraint, "POST");
        if (httpStatusCode != 403) {
            TestUtil.logMsg("Accessing " + ctxtExcludeAuthConstraint + "  (POST) returns = " + httpStatusCode);
            throw new Fault("testExcludeAuthConstraint : FAILED");
        }
    ...
    public void testPartialDDServlet() throws Fault {
        ...
        if (httpStatusCode != 200) {
            TestUtil.logMsg("Accessing " + ctxtPartialDDServlet + "  (GET) returns = " + httpStatusCode);
        ...
        if (httpStatusCode != 200) {
            TestUtil.logMsg("Accessing " + ctxtPartialDDServlet + "  (POST) returns = " + httpStatusCode);
            throw new Fault("testPartialDDServlet : FAILED");
        }
        ...
        if (httpStatusCode != 403) {
            TestUtil.logMsg("Accessing " + ctxtPartialDDServlet + "  (PUT) returns = " + httpStatusCode);
            throw new Fault("testPartialDDServlet : FAILED");
        }
        ...
        if (httpStatusCode != 403) {
            TestUtil.logMsg("Accessing " + ctxtPartialDDServlet + "  (DELETE) returns = " + httpStatusCode);
            throw new Fault("testPartialDDServlet : FAILED");
        }

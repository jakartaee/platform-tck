...
public class Client extends BaseUrlClient {
    ...
    public void test1() throws Fault {
        ...
        trace("test1 passed:  we were not allowed to perform GET on servlet: " + pageDeny);
    }
    ...
    public void test2() throws Fault {
        ...
        trace("POST w/ user=" + unauthUsername + " should be allowed due to DD declaration");
        ...
        // check
        trace("GET w/ user=" + unauthUsername + " should be allowed due to DD declaration");
        ...
        trace("success - DD's role access was honored while the conflicting annotation was ignored.");
        trace("test2 passed.");
    }
    ...
    public void test3() throws Fault {
        ...
        trace("Attempting to POST as user= " + username + " should be denied due to DD security.");
        ...
        trace("Attempting to GET as user=" + username + " should be allowed due to DD security.");
    ...
    public void test5() throws Fault {
        ...
        trace("GET w/ user=" + unauthUsername + " should be allowed access as DD leaves this servlet unprotected.");
    ...
    public void test6() throws Fault {
        ...
        trace("GET w/ user=" + username + " should NOT be allowed due to DD declaration");
        TEST_PROPS.setProperty(TEST_NAME, "SecAnnotations/Test6");
        TEST_PROPS.setProperty(REQUEST, getRequestLine("GET", pageGuest));
        ...
        try {
            ...
            trace("retrying: GET w/ user=" + username + " should still NOT be allowed due to DD declaration");
            TEST_PROPS.setProperty(TEST_NAME, "SecAnnotations/Test6");
            TEST_PROPS.setProperty(REQUEST, getRequestLine("GET", pageGuest));
            TEST_PROPS.setProperty(BASIC_AUTH_USER, username); // "j2ee"
            TEST_PROPS.setProperty(BASIC_AUTH_PASSWD, password); // "j2ee"
        ...
        trace("POST w/ user=" + username + " should NOT be allowed due to DD declaration");
        TEST_PROPS.setProperty(TEST_NAME, "SecAnnotations/Test6");
        TEST_PROPS.setProperty(REQUEST, getRequestLine("POST", pageGuest));
        TEST_PROPS.setProperty(BASIC_AUTH_USER, username); // "j2ee"
        TEST_PROPS.setProperty(BASIC_AUTH_PASSWD, password); // "j2ee"
        ...
        try {
            ...
            // its possible we were denied access with a FORBIDDEN code
            // so retry with that code - if it still fails then we have an issue.
            trace("retrying: POST w/ user=" + username + " should still NOT be allowed due to DD declaration");
            TEST_PROPS.setProperty(TEST_NAME, "SecAnnotations/Test6");
            TEST_PROPS.setProperty(REQUEST, getRequestLine("POST", pageGuest));
            TEST_PROPS.setProperty(BASIC_AUTH_USER, username); // "j2ee"
            TEST_PROPS.setProperty(BASIC_AUTH_PASSWD, password); // "j2ee"
        ...
        trace("Success - we were not allowed to POST or GET as role=Administrator (user=j2ee).");
        trace("Test6 passed.");
    }

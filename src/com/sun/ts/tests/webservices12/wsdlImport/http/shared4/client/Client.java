...
package com.sun.ts.tests.webservices12.wsdlImport.http.shared4.client;
...
public class Client extends ServiceEETest {
    private String SERVICE_NAME_WITH_WSDL_1 = "WSShared4Http1";

    private String SERVICE_NAME_WITH_WSDL_2 = "WSShared4Http2";

...
package com.sun.ts.tests.webservices12.wsdlImport.http.shared1.client;
...
public class Client extends ServiceEETest {
    private String SERVICE_NAME_WITH_WSDL_1 = "WSShared1Http1";

    private String SERVICE_NAME_WITH_WSDL_2 = "WSShared1Http2";
    ...
    public void setup(String[] args, Properties p) throws Fault {
        try {
            ...
            TestUtil.logMsg("JNDI lookup for shared1 Service: " + SERVICE_NAME_WITH_WSDL_1);
            ...
            TestUtil.logMsg("JNDI lookup for shared1 Service: " + SERVICE_NAME_WITH_WSDL_2);

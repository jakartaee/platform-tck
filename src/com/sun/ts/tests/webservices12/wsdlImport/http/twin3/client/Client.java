...
package com.sun.ts.tests.webservices12.wsdlImport.http.twin3.client;
...
public class Client extends EETest {
  private String SERVICE_NAME_WITH_WSDL_1 = "WSTwin3Http1";

  private String SERVICE_NAME_WITH_WSDL_2 = "WSTwin3Http2";

  private Tests1 port1;

  private Tests2 port2;

  @WebServiceRef(name = "service/WSTwin3Http1")
  static Twin3HttpSvc1 svc1;

  @WebServiceRef(name = "service/WSTwin3Http2")
  static Twin3HttpSvc2 svc2;

...
package com.sun.ts.tests.webservices12.wsdlImport.http.twin2.client;
...
public class Client extends EETest {
  private String SERVICE_NAME_WITH_WSDL_1 = "WSTwin2Http1";

  private String SERVICE_NAME_WITH_WSDL_2 = "WSTwin2Http2";

  private Tests1 port1;

  private Tests2 port2;

  @WebServiceRef(name = "service/WSTwin2Http1")
  static Twin2HttpSvc1 svc1;

  @WebServiceRef(name = "service/WSTwin2Http2")
  static Twin2HttpSvc2 svc2;

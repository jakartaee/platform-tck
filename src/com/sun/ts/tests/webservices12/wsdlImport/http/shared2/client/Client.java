...
package com.sun.ts.tests.webservices12.wsdlImport.http.shared2.client;
...
public class Client extends ServiceEETest {
    private String SERVICE_NAME_WITH_WSDL_1 = "WSShared2Http1";

    private String SERVICE_NAME_WITH_WSDL_2 = "WSShared2Http2";
    ...
    public void setup(String[] args, Properties p) throws Fault {
        try {
            ...
            TestUtil.logMsg("JNDI lookup for shared2 Service: " + SERVICE_NAME_WITH_WSDL_1);
            ...
            TestUtil.logMsg("JNDI lookup for shared2 Service: " + SERVICE_NAME_WITH_WSDL_2);

...
package com.sun.ts.tests.webservices12.wsdlImport.file.twin1.client;
...
public class Client extends EETest {
  private String SERVICE_NAME_WITH_WSDL_1 = "WSTwin1File1";

  private String SERVICE_NAME_WITH_WSDL_2 = "WSTwin1File2";

  private Tests1 port1;

  private Tests2 port2;

  @WebServiceRef(name = "service/WSTwin1File1")
  static Twin1FileSvc1 svc1;

  @WebServiceRef(name = "service/WSTwin1File2")
  static Twin1FileSvc2 svc2;

...
package com.sun.ts.tests.webservices12.wsdlImport.file.shared4.client;
...
public class Client extends ServiceEETest {
    private String SERVICE_NAME_WITH_WSDL_1 = "WSShared4File1";

    private String SERVICE_NAME_WITH_WSDL_2 = "WSShared4File2";
    ...
    public void setup(String[] args, Properties p) throws Fault {
        try {
            ...
            TestUtil.logMsg("JNDI lookup for shared4 Service: " + SERVICE_NAME_WITH_WSDL_1);
            ...
            TestUtil.logMsg("JNDI lookup for shared4 Service: " + SERVICE_NAME_WITH_WSDL_2);

...
package com.sun.ts.tests.webservices12.wsdlImport.file.twin3.client;
...
public class Client extends EETest {
  private String SERVICE_NAME_WITH_WSDL_1 = "WSTwin3File1";

  private String SERVICE_NAME_WITH_WSDL_2 = "WSTwin3File2";

  private Tests1 port1;

  private Tests2 port2;

  @WebServiceRef(name = "service/WSTwin3File1")
  static Twin3FileSvc1 svc1;

  @WebServiceRef(name = "service/WSTwin3File2")
  static Twin3FileSvc2 svc2;

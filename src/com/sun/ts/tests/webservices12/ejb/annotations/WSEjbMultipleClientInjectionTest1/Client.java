...
public class Client extends EETest {
    ...
    private String SERVLET = "/WSEjbMultipleClientInjectionTest1Clnt_web/ServletTest";

    private Hello port;

    @WebServiceRef(name = "service/wsejbmultipleclientinjectiontest1")
    static HelloService service = null;

    private void getPort() throws Exception {
        TestUtil.logMsg("Get wsejbmultipleclientinjectiontest1 Service via @WebServiceRef annotation");
        TestUtil.logMsg("Uses name attribute @WebServiceRef(name=\"service/wsejbmultipleclientinjectiontest1\")");
    ...
    /*
     * @testName: MultipleClientInjectionSingleClntEarTest
     *
     ...
     * a single client ear file. An appclient and servletclient is packaged in a
     * single client ear file. Injection should happen in both clients.
     */
    public void MultipleClientInjectionSingleClntEarTest() throws Fault {
        boolean pass = true;

        TestUtil.logMsg("MultipleClientInjectionSingleClntEarTest");
        ...
        try {
            ...
            throw new Fault("MultipleClientInjectionSingleClntEarTest failed");
        }
        if (!pass) throw new Fault("MultipleClientInjectionSingleClntEarTest failed");
    }

    /*
     * @testName: MultipleClientInjectionSingleClntEarInvokeHelloBye
     *
     * @assertion_ids: WS4EE:SPEC:37; WS4EE:SPEC:39; WS4EE:SPEC:41; WS4EE:SPEC:42;
     * WS4EE:SPEC:43; WS4EE:SPEC:44; WS4EE:SPEC:51; WS4EE:SPEC:109;
     * WS4EE:SPEC:145; WS4EE:SPEC:148; WS4EE:SPEC:149; WS4EE:SPEC:155;
     ...
     */
    public void MultipleClientInjectionSingleClntEarInvokeHelloBye() throws Fault {
        boolean pass = true;

        TestUtil.logMsg("MultipleClientInjectionSingleClntEarInvokeHelloBye");
        TestUtil.logMsg("Test injection in both appclient and servletclient");
        try {
            ...
            throw new Fault("MultipleClientInjectionSingleClntEarInvokeHelloBye failed");
        }
        if (!pass) throw new Fault("MultipleClientInjectionSingleClntEarInvokeHelloBye failed");
    }
}

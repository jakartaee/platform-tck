...
public class Client extends EETest {
    ...
    private void getPort() throws Exception {
        TestUtil.logMsg("Get wsejbwebservicerefwithnoddstest Service via @WebServiceRef annotation");
        TestUtil.logMsg("Uses no attribute @WebServiceRef");
        TestUtil.logMsg("service=" + service);
        TestUtil.logMsg("Get port from service");
        port = (WSEjbWSRefWithNoDDsTestHelloEJB) service.getWSEjbWSRefWithNoDDsTestHelloEJBPort();
        TestUtil.logMsg("port=" + port);
        TestUtil.logMsg("Port obtained");
        TestUtil.logMsg("Set the target endpoint address for this webservice since there are no DD's");

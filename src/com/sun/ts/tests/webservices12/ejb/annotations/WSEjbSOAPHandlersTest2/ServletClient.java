...
public class ServletClient extends HttpServlet {
    ...
    private void getPort() throws Exception {
        System.out.println("Get wsejbsoaphandlerstest2 Service via @WebServiceRef annotation");
        System.out.println("Uses name attribute @WebServiceRef(name=\"service/wsejbsoaphandlerstest2\")");

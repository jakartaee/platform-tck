...
public class ServletClient extends HttpServlet {
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        try {
            ...
            targetEndpointAddress = (String) context.get(BindingProvider.ENDPOINT_ADDRESS_PROPERTY);
            System.out.println("DEBUG init: target endpoint address=" + targetEndpointAddress);
        } catch (Exception e) {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        System.out.println("doPost: target endpoint address=" + targetEndpointAddress);

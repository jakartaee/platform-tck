...
public class Client extends EETest {
    ...
    private void getPort() throws Exception {
        ...
        TestUtil.logMsg("JNDI lookup java:comp/env/service/wsejbnowebservicerefinclienttest");
        HelloService service = (HelloService) ctx.lookup("java:comp/env/service/wsejbnowebservicerefinclienttest");
    ...
    public void WSEjbNoWebServiceRefInClientTestVerifyJNDILookupOfService() throws Fault {
        ...
        try {
            TestUtil.logMsg("Verify JNDI lookup of \"java:comp/env/service/wsejbnowebservicerefinclienttest\"");
            InitialContext ctx = new InitialContext();
            TestUtil.logMsg("JNDI lookup java:comp/env/service/wsejbnowebservicerefinclienttest");
            HelloService service = (HelloService) ctx.lookup("java:comp/env/service/wsejbnowebservicerefinclienttest");
            TestUtil.logMsg("service=" + service);
            TestUtil.logMsg("WSEjbNoWebServiceRefInClientTestVerifyJNDILookupOfService passed");
        } catch (Throwable t) {
            throw new Fault("WSEjbNoWebServiceRefInClientTestVerifyJNDILookupOfService failed");
        }
        return;
    }
     ...
     */
    public void WSEjbNoWebServiceRefInClientTestInvokeHelloBye() throws Fault {
        boolean pass = true;

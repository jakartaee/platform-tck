...
public class Client extends EETest {
    ...
    private void getPort() throws Exception {
        TestUtil.logMsg("Get wsejbsoaphandlerstest Service via @WebServiceRef annotation");
        TestUtil.logMsg("Uses name attribute @WebServiceRef(name=\"service/wsejbsoaphandlerstest\")");

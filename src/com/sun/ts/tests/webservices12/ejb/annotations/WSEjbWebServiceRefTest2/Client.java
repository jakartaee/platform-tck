...
public class Client extends EETest {
    ...
    private void getPort() throws Exception {
        TestUtil.logMsg("Get wsejbwebservicereftest2 Service via @WebServiceRef annotation");
        TestUtil.logMsg("Uses name attribute @WebServiceRef(name=\"service/wsejbwebservicereftest2\")");
    ...
    public void WSEjbWebServiceRefTest2VerifyJNDILookupOfService() throws Fault {
        ...
        try {
            ...
            HelloService service = (HelloService) ctx.lookup("java:comp/env/service/wsejbwebservicereftest2");
            TestUtil.logMsg("service=" + service);
            TestUtil.logMsg("WSEjbWebServiceRefTest2VerifyJNDILookupOfService passed");
        } catch (Throwable t) {
            TestUtil.printStackTrace(t);
            throw new Fault("WSEjbWebServiceRefTest2VerifyJNDILookupOfService failed");
        }
        return;
    }
}

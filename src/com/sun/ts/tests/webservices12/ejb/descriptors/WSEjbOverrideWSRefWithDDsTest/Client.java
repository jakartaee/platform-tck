...
public class Client extends EETest {
    ...
    private void getStub() throws Exception {
        TestUtil.logMsg("Get wsejboverridewsrefwithddstest Service via DDs (ignore @WebServiceRef annotation)");
    ...
    public void call_txRequired() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("test call_txRequired failed: got exception " + t.toString());
    ...
    public void call_txSupports() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("test call_txSupports failed: got exception " + t.toString());
    ...
    public void call_txRequiresNew() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("test call_txRequiresNew failed: got exception " + t.toString());
    ...
    public void call_txNotSupported() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("test call_txNotSupported failed: got exception " + t.toString());
    ...
    public void call_txNever() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("test call_txNever failed: got exception " + t.toString());

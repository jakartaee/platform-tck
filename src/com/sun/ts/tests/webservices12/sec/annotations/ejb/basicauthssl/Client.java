...
public class Client extends EETest {
    ...
    /*
     * @class.setup_props: webServerHost; securedWebServicePort; user; password; authuser; authpassword;
     */
    public void setup(String[] args, Properties p) throws Fault {
        ...
        try {
            ...
            urlString = ctsurl.getURLString(PROTOCOL, hostname, portnum, "/WSEjbBasicAuthSSL/HelloService/Hello");
    ...
    public void sayHelloProtected() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Invoking sayHelloProtected with authorized user on Hello port");
    ...
    public void sayHelloProtectedUnauthorizedUser() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Setting username and password in WS port");
            TestUtil.logMsg("username=" + unauthorizedUser + " password=" + unauthorizedUserPassword);
            ...
            TestUtil.logMsg("Invoking sayHelloProtected with unauthorized user on Hello port");
            TestUtil.logMsg("Invocation must not be allowed (throw exception)");
            String text = port.sayHelloProtected("Raja");
            TestUtil.logErr("Test sayHelloProtectedUnauthorizedUser did not throw expected exception");
            TestUtil.logMsg("Got Output : " + text);

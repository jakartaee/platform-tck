...
public class Client extends EETest {
    ...
    public void setup(String[] args, Properties p) throws Fault {
        ...
        try {
            ...
            urlString = ctsurl.getURLString(PROTOCOL, hostname, portnum, "/WSEjbClientCert/HelloService/Hello");
    ...
    public void sayHelloDenyAll() throws Fault {
        ...
        try {
            ...
            TestUtil.logErr("Test sayHelloDenyAll failed, didn't get the expected exception");

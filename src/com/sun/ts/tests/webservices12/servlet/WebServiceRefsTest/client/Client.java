...
public class Client extends ServiceEETest {
    ...
    private void getPort() throws Exception {
        ...
        TestUtil.logMsg("Do JNDI lookup of service1 java:comp/env/service/wshello1service");
        WSHello1Service service1 = (WSHello1Service) ic.lookup("java:comp/env/service/wshello1service");
        TestUtil.logMsg("service1=" + service1);
        TestUtil.logMsg("Do JNDI lookup of service2 java:comp/env/service/wshello2service");
        WSHello2Service service2 = (WSHello2Service) ic.lookup("java:comp/env/service/wshello2service");
    ...
    public void VerifyTargetEndpointAddressForBothWebServices() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Verify that target endpoint address for WebService1 ends with [jaxws/WSHello1]");
            TestUtil.logMsg("Verify that target endpoint address for WebService2 ends with [jaxws/WSHello2]");
            if (endpointaddr1.endsWith("jaxws/WSHello1") && endpointaddr2.endsWith("jaxws/WSHello2"))
                ...
                TestUtil.logErr("Target Endpoint Address for WebService1: " + endpointaddr1);
                TestUtil.logErr("Target Endpoint Address for WebService2: " + endpointaddr2);

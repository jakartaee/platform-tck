...
@WebService(
        ...
        endpointInterface = "com.sun.ts.tests.webservices12.servlet.WSMTOMSBAnnotationsTest.MTOMTest")
@BindingType(SOAPBinding.SOAP11HTTP_MTOM_BINDING)
public class MTOMTestImpl implements MTOMTest {

    public String mtomIn(com.sun.ts.tests.webservices12.servlet.WSMTOMSBAnnotationsTest.DataType data) {
        System.out.println("--------------------------");
    ...
    public com.sun.ts.tests.webservices12.servlet.WSMTOMSBAnnotationsTest.DataType mtomOut(String urls) {
        System.out.println("--------------------------");
    ...
    public com.sun.ts.tests.webservices12.servlet.WSMTOMSBAnnotationsTest.DataType3 mtomOut2(String urls) {
        System.out.println("--------------------------");

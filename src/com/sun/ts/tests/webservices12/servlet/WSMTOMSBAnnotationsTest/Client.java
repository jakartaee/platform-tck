...
public class Client extends ServiceEETest {
    ...
    public void setup(String[] args, Properties p) throws Fault {
        props = p;
        boolean pass = true;
        client2 = (MTOMClientTwo) ClientFactory.getClient(MTOMClientTwo.class, p, this, service);
        ...
        try {
            ...
            SOAPBinding binding = (SOAPBinding) ((BindingProvider) port2).getBinding();
            binding.setMTOMEnabled(true);
    ...
    public void MTOMInTest() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Documents to send: [" + SDOC1 + "," + SDOC2 + "," + SDOC3 + "," + SDOC4 + "]");
    ...
    public void MTOMInOutTest() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Send and receieve 4 documents using MTOM via webservice method mtomInOut()");
            TestUtil.logMsg("Documents to send: [" + SDOC1 + "," + SDOC2 + "," + SDOC3 + "," + SDOC4 + "]");
            TestUtil.logMsg("Documents to receive: [" + SDOC11 + "," + SDOC12 + "," + SDOC13 + "," + SDOC14 + "]");
            port.mtomInOut(
                    hDocName1, hDocName2, hDocName3, hDocName4, hDocUrl1, hDocUrl2, hDocUrl3, hDocUrl4, hDocUrl11,
                    hDocUrl12, hDocUrl13, hDocUrl14, hDoc1, hDoc2, hDoc3, hDoc4, hResult);
    ...
    public void MTOMIn2CheckHttpHeadersTest() throws Fault {
        ...
        try {
            ...
            String result = "";
            try {
                TestUtil.logMsg("Check Content-Type Request HTTP Request header for correctness");
    ...
    public void MTOMOut2Test() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Receive 1 document using MTOM via webservice method mtomOut2()");
    ...
    public void VerifySOAPProtocolBindingOnPorts() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Binding for first port is " + bindingprovider1.getBinding());
            TestUtil.logMsg("Binding for second port is " + bindingprovider2.getBinding());
            ...
            if (pass) {
                ...
                try {
                    ...
                    TestUtil.logErr("SOAPFactory for first port is a based on SOAP1.2 protocol (Unexpected)");
                    pass = false;
                } catch (UnsupportedOperationException e) {
                    TestUtil.logMsg("SOAPFactory for first port is a based on SOAP1.1 protocol (Expected)");
                }
                soapfault = factory2.createFault();
                try {
                    soapfault.setFaultRole("http://myfault.org");
                    TestUtil.logErr("SOAPFactory for second port is a based on SOAP1.2 protocol (Unexpected)");
                    pass = false;
                } catch (UnsupportedOperationException e) {
                    TestUtil.logMsg("SOAPFactory for second port is a based on SOAP1.1 protocol (Expected)");
                }
            }
        } catch (Exception e) {
            TestUtil.logErr("Exception occurred");

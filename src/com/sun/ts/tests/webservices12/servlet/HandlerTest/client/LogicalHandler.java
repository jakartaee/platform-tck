...
package com.sun.ts.tests.webservices12.servlet.HandlerTest.client;
...
public class LogicalHandler implements jakarta.xml.ws.handler.LogicalHandler<LogicalMessageContext> {
    ...
    public boolean handleMessage(LogicalMessageContext context) {
        ...
        if (Handler_Util.checkForMsg(this, context, "transformBodyTest")) {
            ...
            System.out.println("didn't find a transformBodyTest message, handler will ignore");
        }
        System.out.println("exiting " + HANDLER_NAME + ":handleMessage");
        return true;
    }

    public void transformBodyTest(LogicalMessageContext context, String direction) {
        ...
        String newTmp = tmp.replaceAll("transformBodyTest", "transformBodyTest" + direction + HANDLER_NAME);

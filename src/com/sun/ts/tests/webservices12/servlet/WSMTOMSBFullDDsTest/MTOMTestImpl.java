...
public class MTOMTestImpl implements MTOMTest {
    ...
    public com.sun.ts.tests.webservices12.servlet.WSMTOMSBFullDDsTest.DataType mtomOut(String urls) {
        System.out.println("--------------------------");
    ...
    public com.sun.ts.tests.webservices12.servlet.WSMTOMSBFullDDsTest.DataType3 mtomOut2(String urls) {
        System.out.println("--------------------------");

...
public class MTOMTestImpl implements MTOMTest {
  ...
  public String mtomIn(
      com.sun.ts.tests.webservices12.servlet.WSMTOMSBFullDDsTest.DataType data) {
    System.out.println("--------------------------");
  ...
  public com.sun.ts.tests.webservices12.servlet.WSMTOMSBFullDDsTest.DataType mtomOut(
      String urls) {
    System.out.println("--------------------------");
  ...
  public com.sun.ts.tests.webservices12.servlet.WSMTOMSBFullDDsTest.DataType3 mtomOut2(
      String urls) {
    System.out.println("--------------------------");

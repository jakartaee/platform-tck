...
public class connectionClient1 extends ServiceEETest implements Serializable {
    ...
    public void setup(String[] args, Properties p) throws Fault {
        ...
        try {
            ...
            TestUtil.logErr("###", e);
            throw new Fault("Exception constructing DBSupport object: " + e.getMessage());
        }
    ...
    public void testAPILocalTransactionException() throws Fault {
        ...
        if (b1 && b2 && b3 && b4 && b5) {
            ...
            throw new Fault("LocalTransactionException API assertions failed: " + err);
        }
    }
    ...
    public void testAPIResourceAllocationException() throws Fault {
        ...
        if (b1 && b2 && b3 && b4 && b5) {
            ...
            throw new Fault("ResourceAllocationException API assertions failed: " + err);
        }
    }
    ...
    public void testAPIResourceAdapterInternalException() throws Fault {
        ...
        if (b1 && b2 && b3 && b4 && b5) {
            ...
            throw new Fault("ResourceAdapterInternalException API assertions failed: " + err);
        }
    }
    ...
    public void testAPISharingViolationException() throws Fault {
        ...
        if (b1 && b2 && b3 && b4 && b5) {
            ...
            throw new Fault("SharingViolationException API assertions failed: " + err);
        }
    }
    ...
    public void testAPIApplicationServerInternalException() throws Fault {
        ...
        if (b1 && b2 && b3 && b4 && b5) {
            TestUtil.logMsg("ApplicationServerInternalException API assertions passed");
        } else {
            String err = "";
            if (!b1) {
                err = "b1 failed, ";
            ...
            throw new Fault("ApplicationServerInternalException API assertions failed: " + err);
        }
    }
    ...
    public void testAPIRetryableWorkRejectedException() throws Fault {
        ...
        if (b1 && b2 && b3 && b4 && b5) {
            ...
            throw new Fault("RetryableWorkRejectedException API assertions failed: " + err);
        }
    }
    ...
    public void testAPIRetryableUnavailableException() throws Fault {
        ...
        if (b1 && b2 && b3 && b4 && b5) {
            ...
            throw new Fault("RetryableUnavailableException API assertions failed: " + err);
        }
    }

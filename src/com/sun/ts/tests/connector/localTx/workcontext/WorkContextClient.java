...
public class WorkContextClient extends ServiceEETest implements Serializable {
    ...
    public void testNestedWorkContexts() throws Fault {
        ...
        if (b1 && b2 && b3) {
            ...
            if (!b1) {
                TestUtil.logMsg("testNestedWorkContexts() - could not find string: " + toCheck1);
            }
            if (!b2) {
                TestUtil.logMsg("testNestedWorkContexts() - could not find string: " + toCheck2);
            }
            if (!b3) {
                TestUtil.logMsg("testNestedWorkContexts() - could not find string: " + toCheck3);
            }
    ...
    public void testNestedWorkContexts2() throws Fault {
        ...
        if (b2) {
            ...
            TestUtil.logMsg("testNestedWorkContexts2() failed - could not find string: " + toCheck2);
    ...
    public void testNestedWorkContexts3() throws Fault {
        ...
        if (b2) {
            ...
            TestUtil.logMsg("testNestedWorkContexts3() failed - could not find string: " + toCheck2);
    ...
    public void testWorkContextProvider() throws Fault {
        ...
        if (b2) {
            ...
            TestUtil.logMsg("testWorkContextProvider() failed - could not find string: " + toCheck);
    ...
    public void testWorkContextNotifications() throws Fault {
        ...
        if ((iWorkAcceptedCount == -1)
                || (iWorkStartedCount == -1)
                || (iWorkCompletedCount == -1)
                || (iContextSetupCompleteCount == -1)) {
        ...
        if (iWorkCompletedCount < iContextSetupCompleteCount) {
            ...
            throw new Fault("FAILURE:  contextSetupCompleted must be called befor workCompleted - but was not!");
        } else {
            // good so far as contextSetupCompleted called befor workCompleted
            TestUtil.logMsg("contextSetupCompleted correctly called befor workCompleted");
        }
    ...
    public void testHICNotifications() throws Fault {
        ...
        if (iContextSetupFailedCount != -1) {
            ...
            // notifications
            throw new Fault("FAILURE:  testWorkContextNotifications() detected contextSetupFailed notification.");
        }
    }

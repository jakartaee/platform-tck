    ...
    public void validateGlobalAdminObj(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            if (testAdminObjStatelessEjb == null) {
                send_output(out, "ERROR:  test will fail since testAdminObjStatelessEjb == null");
            }

            boolean bval = testAdminObjStatelessEjb.validateConnectorResource(RARJndiScope);
            if (bval == true) {
                send_output(out, "SUCCESS:  validateGlobalAdminObj passed.");
            } else {
                send_output(out, "FAILURE:  validateGlobalAdminObj had unexpected exception.");
            }
        } catch (Exception ex) {
    ...
    public void validateAppAdminObj(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            if (bval == true) {
                ...
                send_output(out, "FAILURE:  validateAppAdminObj had unexpected exception.");
            }
        } catch (Exception ex) {
    ...
    public void validateCompAdminObj(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            if (bval == true) {
                ...
                send_output(out, "FAILURE:  validateCompAdminObj had unexpected exception.");
            }
        } catch (Exception ex) {
    ...
    public void validateModuleAdminObj(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            if (bval == true) {
                ...
                send_output(out, "FAILURE:  validateModuleAdminObj had unexpected exception.");
            }
        } catch (Exception ex) {

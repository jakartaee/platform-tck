...
public class Client extends ServiceEETest implements Serializable {
    ...
    public void ValidateGlobalResourceDef() throws Fault {
        ...
        String str = invokeServletAndGetResponse(
                crdServletPath, "POST", "ValidateGlobalResourceDef", RARGlobalScopedJndiName);
    ...
    public void ValidateModuleResourceDef() throws Fault {
        ...
        String str = invokeServletAndGetResponse(
                crdServletPath, "POST", "ValidateModuleResourceDef", RARModuleScopedJndiName);
    ...
    public void ValidateAppAdminObj() throws Fault {
        ...
        String str = invokeServletAndGetResponse(aodServletPath, "POST", "ValidateAppAdminObj", AODAppScopedJndiName);
    ...
    public void ValidateCompAdminObj() throws Fault {
        ...
        String str = invokeServletAndGetResponse(aodServletPath, "POST", "ValidateCompAdminObj", AODCompScopedJndiName);
    ...
    private String invokeServletAndGetResponse(
            String sContext, String requestMethod, String testMethod, String rarJndiScope) {
        ...
        if (testMethod != null) {
            sContext = sContext + "?" + "method.under.test=" + testMethod + "&" + "rar.jndi.scope=" + rarJndiScope;
        }

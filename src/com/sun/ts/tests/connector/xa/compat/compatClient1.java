...
public class compatClient1 extends ServiceEETest implements Serializable {
  ...
  /*
   * @class.setup_props: oldwhitebox-xa, JNDI name of TS WhiteBox;
   * oldwhitebox-xa-param, conn w/ params; rauser1, user name; rapassword1,
  ...
  public void setup(String[] args, Properties p) throws Fault {
    ...
    // here.
    oldwhitebox_xa = p.getProperty("oldwhitebox-xa");
    oldwhitebox_xa_param = p.getProperty("oldwhitebox-xa-param");
    ...
    logMsg("Using: " + oldwhitebox_xa);
    logMsg("Using: " + oldwhitebox_xa_param);
    ...
    try {
      ...
      ds1 = (TSDataSource) nc.lookup(oldwhitebox_xa);
      ds2 = (TSDataSource) nc.lookup(oldwhitebox_xa_param);

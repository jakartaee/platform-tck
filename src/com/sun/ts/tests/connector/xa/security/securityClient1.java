...
public class securityClient1 extends ServiceEETest implements Serializable {
     ...
     * Connector:JAVADOC:334; Connector:JAVADOC:335; Connector:JAVADOC:337; Connector:JAVADOC:338;
     *
     ...
     *
     * @test_Strategy: Call the DataSource.getConnection(uname, password). Providing there are no unused existing

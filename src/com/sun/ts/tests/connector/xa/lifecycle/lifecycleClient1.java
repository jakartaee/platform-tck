...
public class lifecycleClient1 extends ServiceEETest implements Serializable {
    ...
    public void testAssociationMCFandRA2() throws Fault {
        ...
        if (!b1) {
            ...
            TestUtil.logMsg("testAssociationMCFandRA2 passed:  setResourceAdapter not called twice.");
        } else {
            // this is bad, it means setResourceAdapter was called more than once
            throw new Fault("XAManagedConnectionFactory.setResourceAdapter called more than once.");
        }
    }
    ...
    public void testMCFcalledOnce() throws Fault {
        ...
        if (b1) {
            ...
            throw new Fault("XAManagedConnectionFactory.setResourceAdapter not called .");
        }

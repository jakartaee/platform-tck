...
public class workmgtClient1 extends ServiceEETest implements Serializable {
     ...
     *
     * @assertion_ids: Connector:SPEC:70; Connector:JAVADOC:131; Connector:JAVADOC:396; Connector:JAVADOC:404;
     *
     ...
     *
     * @assertion_ids: Connector:SPEC:73; Connector:JAVADOC:397; Connector:JAVADOC:405; Connector:JAVADOC:407;
     *
     ...
     * then the tests passes. If UnavailableException is thrown then test passes. If UnsupportedOperationException then
     * tests passes.
     *

...
public class lifecycleClient1 extends ServiceEETest implements Serializable {
     ...
     *
     * @test_Strategy: Check to see if NoTxManagedConnectionFacotry.setResourceAdapter and ResourceAdatper.start was called
     ...
     *
     * @test_Strategy: Check to see if NoTxManagedConnectionFacotry.setResourceAdapter was called twice. If it was, then we
     * fail assertion Connector:SPEC:227
     *
     */
    public void testAssociationMCFandRA2() throws Fault {
        ...
        if (!b1) {
            ...
            throw new Fault("ManagedConnectionFactory.setResourceAdapter called twice and should not have been.");
        }
     ...
     *
     * @test_Strategy: Check to see if NoTxManagedConnectionFacotry constructor was called atleast once. If it was then
     ...
     *
     * @test_Strategy: Check to see if NoTxResourceAdapter.start was called more than once. If it has then it is not being
     * shared or reused.
     *
     ...
     *
     * @test_Strategy: Check to see if NoTxManagedConnectionFactory.setResourceAdapter was called exactly once. If it has
    ...
    public void testMCFcalledOnce() throws Fault {
        ...
        if (b1) {
            ...
            throw new Fault("NoTxManagedConnectionFactory.setResourceAdapter not called .");
        }
     ...
     *
     * @test_Strategy: Check to see if NoTxResourceAdapter.setRAName is called. If it has then the test passes. We are

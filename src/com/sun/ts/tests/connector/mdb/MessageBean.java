...
public class MessageBean implements MessageDrivenBean, TSMessageListenerInterface {
    ...
    private void checkSecurityContext(String roleName) throws AppException {
        System.out.println(" MessageBean.checkSecurityContext:  roleName is " + roleName);
        ...
        System.out.println(" MessageBean.checkSecurityContext:  principal name is " + principalName);
        System.out.println(" MessageBean.checkSecurityContext:  roleName is " + roleName);

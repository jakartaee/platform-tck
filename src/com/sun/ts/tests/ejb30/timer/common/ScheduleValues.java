...
public class ScheduleValues {
    ...
    public static String[] validSecondValuesString() {
        return combineIntAndStringValues(validSecondValuesInt(), SECOND_LIST_RANGE_INCREMENT, WILD_CARD);
    }

    public static String[] invalidSecondValuesString() {
        return combineIntAndStringValues(invalidSecondValuesInt(), INVALID_SECOND_STRING, INVALID_COMMON_STRING);
    }
    ...
    public static String[] validMinuteValuesString() {
        return combineIntAndStringValues(validMinuteValuesInt(), MINUTE_LIST_RANGE, WILD_CARD);
    }

    public static String[] invalidMinuteValuesString() {
        return combineIntAndStringValues(invalidMinuteValuesInt(), INVALID_MINUTE_STRING, INVALID_COMMON_STRING);
    }
    ...
    public static String[] validHourValuesString() {
        return combineIntAndStringValues(validHourValuesInt(), HOUR_LIST_RANGE_INCREMENT, WILD_CARD);
    }

    public static String[] invalidHourValuesString() {
        return combineIntAndStringValues(invalidHourValuesInt(), INVALID_HOUR_STRING, INVALID_COMMON_STRING);
    }
    ...
    public static int[] validDayOfMonthValuesInt() {
        ...
        System.arraycopy(daysRange, 0, allValid, daysBefore.length, daysRange.length);
        return allValid;
    }
    ...
    public static String[] validDayOfMonthValuesString() {
        ...
        String[] valid1 = combineIntAndStringValues(validDayOfMonthValuesInt(), DAY_OF_MONTH_LIST_RANGE, WILD_CARD);
    ...
    public static String[] invalidDayOfMonthValuesString() {
        return combineIntAndStringValues(
                invalidDayOfMonthValuesInt(), INVALID_DAY_OF_MONTH_STRING, INVALID_COMMON_STRING);
    }
    ...
    public static String[] validMonthValuesString() {
        return combineIntAndStringValues(validMonthValuesInt(), MONTH_VALUE_LIST_RANGE, WILD_CARD);
    }

    public static String[] invalidMonthValuesString() {
        return combineIntAndStringValues(invalidMonthValuesInt(), INVALID_MONTH_STRING, INVALID_COMMON_STRING);
    }
    ...
    public static String[] validDayOfWeekValuesString() {
        return combineIntAndStringValues(validDayOfWeekValuesInt(), DAY_OF_WEEK_VALUE_LIST_RANGE, WILD_CARD);
    }

    public static String[] invalidDayOfWeekValuesString() {
        return combineIntAndStringValues(
                invalidDayOfWeekValuesInt(), INVALID_DAY_OF_WEEK_STRING, INVALID_COMMON_STRING);
    }
    ...
    public static String[] validYearValuesString() {
        return combineIntAndStringValues(validYearValuesInt(), YEAR_LIST_RANGE, WILD_CARD);
    }

    public static String[] invalidYearValuesString() {
        return combineIntAndStringValues(invalidYearValuesInt(), INVALID_YEAR_STRING, INVALID_COMMON_STRING);
    }

    /////////////////////////////////////////////////////////////////////
    // utility methods
    /////////////////////////////////////////////////////////////////////
    public static String[] combineIntAndStringValues(final int[] a1, final String[] a2, String... additional) {
        ...
        if (additional.length > 0) {
            System.arraycopy(additional, 0, values, a1.length + a2.length, additional.length);
        }
        return values;
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("DAY_OF_MONTH=" + TimerUtil.getForSchedule(Calendar.DAY_OF_MONTH));
        System.out.println("DAY_OF_WEEK=" + TimerUtil.getForSchedule(Calendar.DAY_OF_WEEK));
        System.out.println("HOUR_OF_DAY=" + TimerUtil.getForSchedule(Calendar.HOUR_OF_DAY));

        Calendar calNextHour = Calendar.getInstance();
        calNextHour.add(Calendar.HOUR_OF_DAY, 1);
        System.out.println("Next hour=" + TimerUtil.getForSchedule(Calendar.HOUR_OF_DAY, calNextHour));

        Calendar calNextMonth = Calendar.getInstance();
        calNextMonth.add(Calendar.MONTH, 1);
        System.out.println("Next month=" + TimerUtil.getForSchedule(Calendar.MONTH, calNextMonth));
    }
}

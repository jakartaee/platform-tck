...
public class JsfClientBase extends com.sun.ts.tests.ejb30.timer.common.JsfClientBase {
    ...
    private void aroundTimeoutTest(AroundTimeoutIF b, String[] expectedAroundTimeout, boolean timeoutInvoked) {
        ...
        checkAndClearAroundTimeoutRecords(expectedAroundTimeout, getAroundTimeoutRecordKey(), timeoutInvoked);
    }

    private void checkAndClearAroundTimeoutRecords(
            String[] expected, String aroundTimeoutRecordKey, boolean timeoutInvoked) {
        if (timeoutInvoked) {
            passIfTimeout();
        } else {
            passIfNoTimeout();

...
public class ScheduleBean extends TimerBeanBase {
    ...
    public String isCalendarTimerAndGetSchedule() {
        ...
        isCalendarTimerAndGetSchedule0(timerService.createCalendarTimer(exp), true, sb);
        ...
        isCalendarTimerAndGetSchedule0(timerService.createTimer(initial, info), false, sb);
        isCalendarTimerAndGetSchedule0(timerService.createTimer(initial.getTime(), info), false, sb);
        isCalendarTimerAndGetSchedule0(timerService.createTimer(initial, interval, info), false, sb);
        isCalendarTimerAndGetSchedule0(timerService.createTimer(initial.getTime(), interval, info), false, sb);

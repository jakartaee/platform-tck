...
public class BasicBeanHelper {
    ...
    public static void globalJNDI(
        ...
        Helper.assertEquals(
                "BasicBean from lookup with global jndi name " + lookupName, expected, b0.add(x, y), reason);
        b0 = null;
        ...
        Helper.assertEquals(
                "BasicBean from lookup with global jndi name " + lookupName, expected, b00.add(x, y), reason);
        b00 = null;
        ...
        Helper.assertEquals(
                "TwoInterfacesBasicBean from lookup with global jndi name " + lookupName,
                expected,
                b21.add(x, y),
                reason);
        b21 = null;
    ...
    public static void appJNDI(String modName, Class<?> businessInterface, StringBuilder reason, EJBContext... ec) {
        ...
        Helper.assertEquals(
                "OneInterfaceBasicBean from lookup with app jndi name " + lookupName, expected, b1.add(x, y), reason);
        b1 = null;
        ...
        Helper.assertEquals(
                "OneInterfaceBasicBean from lookup with app jndi name " + lookupName, expected, b11.add(x, y), reason);
        b11 = null;
        ...
        Helper.assertEquals(
                "TwoInterfacesBasicBean from lookup with app jndi name " + lookupName, expected, b21.add(x, y), reason);
        b21 = null;
        ...
        Helper.assertEquals(
                "TwoInterfacesBasicBean from lookup with app jndi name " + lookupName, expected, b22.add(x, y), reason);
        b22 = null;
    }
    ...
    public static void moduleJNDI(Class<?> businessInterface, StringBuilder reason, EJBContext... ec) {
        ...
        Basic1IF b0 = (Basic1IF) lookupWithEJBContext(lookupName, ec);
        Helper.assertEquals(
                "BasicBean from lookup with module jndi name " + lookupName, expected, b0.add(x, y), reason);
        b0 = null;
        ...
        Helper.assertEquals(
                "BasicBean from lookup with module jndi name " + lookupName, expected, b00.add(x, y), reason);
        b00 = null;
        ...
        Helper.assertEquals(
                "TwoInterfacesBasicBean from lookup with module jndi name " + lookupName,
                expected,
                b21.add(x, y),
                reason);
        b21 = null;

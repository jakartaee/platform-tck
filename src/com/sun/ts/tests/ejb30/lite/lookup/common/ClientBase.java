...
public abstract class ClientBase extends EJBLiteClientBase {
    ...
    private void nonPostConstruct() {
        ...
        Helper.assertEquals(
                "Verify lookupBeanAgain injection", LOOKUP_BEAN, lookupBeanAgain.getName(), postConstructRecords);
        Helper.assertEquals(
                "Verify lookup2BeanAgain injection", LOOKUP2_BEAN, lookup2BeanAgain.getName(), postConstructRecords);
        ...
        Helper.assertEquals("Check " + lookup, expected, actual, postConstructRecords);

...
public abstract class EnvEntryBeanBase {
    ...
    private void verifyAnnotatedInjections() {
        ...
        assertEquals(s, EnvEntryBeanBase.class, envEntryBeanBaseClass, postConstructRecords);
        assertEquals(s, TestUtil.class, testUtilClass, postConstructRecords);

        s = "Verify injected fields with SessionContext lookup:";
        assertEquals(s, "myString", sctx.lookup(getLookupName("myString")), postConstructRecords);
        assertEquals(s, "compSameName2", sctx.lookup("java:comp/env/sameName2"), postConstructRecords);
        assertEquals(s, "moduleSameName", sctx.lookup("java:module/env/sameName"), postConstructRecords);
        assertEquals(s, "appSameName", sctx.lookup("java:app/env/sameName"), postConstructRecords);
        assertEquals(s, true, sctx.lookup(getLookupName("myBoolean")), postConstructRecords);
        assertEquals(s, (byte) 1, sctx.lookup(getLookupName("myByte")), postConstructRecords);
        assertEquals(s, (short) 1, sctx.lookup(getLookupName("myShort")), postConstructRecords);
        assertEquals(s, 1, sctx.lookup(getLookupName("myInt")), postConstructRecords);
        assertEquals(s, (long) 1, sctx.lookup(getLookupName("myLong")), postConstructRecords);
        assertEquals(s, (float) 1, sctx.lookup(getLookupName("myFloat")), postConstructRecords);
        assertEquals(s, (double) 1, sctx.lookup(getLookupName("myDouble")), postConstructRecords);
        assertEquals(s, '1', sctx.lookup(getLookupName("myChar")), postConstructRecords);

        assertEquals(s, TimeUnit.NANOSECONDS, sctx.lookup(getLookupName("timeUnit")), postConstructRecords);
        assertEquals(s, NumberEnum.ONE, sctx.lookup(getLookupName("numberEnum")), postConstructRecords);
        assertEquals(s, Helper.class, sctx.lookup(getLookupName("helperClass")), postConstructRecords);
        assertEquals(s, NumberEnum.class, sctx.lookup(getLookupName("numberEnumClass")), postConstructRecords);
        assertEquals(
                s, EnvEntryBeanBase.class, sctx.lookup(getLookupName("envEntryBeanBaseClass")), postConstructRecords);
        assertEquals(s, TestUtil.class, sctx.lookup(getLookupName("testUtilClass")), postConstructRecords);

        s = "Verify injected fields with naming context lookup:";
        assertEquals(s, "myString", lookupNoTry(getLookupName("myString")), postConstructRecords);
        assertEquals(s, "compSameName2", lookupNoTry("java:comp/env/sameName2"), postConstructRecords);
        assertEquals(s, "moduleSameName", lookupNoTry("java:module/env/sameName"), postConstructRecords);
        assertEquals(s, "appSameName", lookupNoTry("java:app/env/sameName"), postConstructRecords);
        assertEquals(s, true, lookupNoTry(getLookupName("myBoolean")), postConstructRecords);
        assertEquals(s, (byte) 1, lookupNoTry(getLookupName("myByte")), postConstructRecords);
        assertEquals(s, (short) 1, lookupNoTry(getLookupName("myShort")), postConstructRecords);
        assertEquals(s, 1, lookupNoTry(getLookupName("myInt")), postConstructRecords);
        assertEquals(s, (long) 1, lookupNoTry(getLookupName("myLong")), postConstructRecords);
        assertEquals(s, (float) 1, lookupNoTry(getLookupName("myFloat")), postConstructRecords);
        assertEquals(s, (double) 1, lookupNoTry(getLookupName("myDouble")), postConstructRecords);
        assertEquals(s, '1', lookupNoTry(getLookupName("myChar")), postConstructRecords);

        assertEquals(s, TimeUnit.NANOSECONDS, lookupNoTry(getLookupName("timeUnit")), postConstructRecords);
        assertEquals(s, NumberEnum.ONE, lookupNoTry(getLookupName("numberEnum")), postConstructRecords);
        assertEquals(s, Helper.class, lookupNoTry(getLookupName("helperClass")), postConstructRecords);
        assertEquals(s, NumberEnum.class, lookupNoTry(getLookupName("numberEnumClass")), postConstructRecords);
        assertEquals(
                s, EnvEntryBeanBase.class, lookupNoTry(getLookupName("envEntryBeanBaseClass")), postConstructRecords);
        assertEquals(s, TestUtil.class, lookupNoTry(getLookupName("testUtilClass")), postConstructRecords);
    }
    ...
    private void verifyDescriptorInjections() {
        ...
        s = "Verify injected fields with SessionContext lookup:";
        assertEquals(s, "xmlString", sctx.lookup(getLookupName("xmlString")), postConstructRecords);
        assertEquals(s, true, sctx.lookup(getLookupName("xmlBoolean")), postConstructRecords);
        assertEquals(s, (byte) 1, sctx.lookup(getLookupName("xmlByte")), postConstructRecords);
        assertEquals(s, (short) 1, sctx.lookup(getLookupName("xmlShort")), postConstructRecords);
        assertEquals(s, 1, sctx.lookup(getLookupName("xmlInt")), postConstructRecords);
        assertEquals(s, (long) 1, sctx.lookup(getLookupName("xmlLong")), postConstructRecords);
        assertEquals(s, (float) 1, sctx.lookup(getLookupName("xmlFloat")), postConstructRecords);
        assertEquals(s, (double) 1, sctx.lookup(getLookupName("xmlDouble")), postConstructRecords);
        assertEquals(s, '1', sctx.lookup(getLookupName("xmlChar")), postConstructRecords);

        assertEquals(s, NumberEnum.ONE, sctx.lookup(getLookupName("xmlNumberEnum")), postConstructRecords);
        assertEquals(s, Helper.class, sctx.lookup(getLookupName("xmlHelperClass")), postConstructRecords);

        s = "Verify injected fields with naming context lookup:";
        assertEquals(s, "xmlString", lookupNoTry(getLookupName("xmlString")), postConstructRecords);
        assertEquals(s, true, lookupNoTry(getLookupName("xmlBoolean")), postConstructRecords);
        assertEquals(s, (byte) 1, lookupNoTry(getLookupName("xmlByte")), postConstructRecords);
        assertEquals(s, (short) 1, lookupNoTry(getLookupName("xmlShort")), postConstructRecords);
        assertEquals(s, 1, lookupNoTry(getLookupName("xmlInt")), postConstructRecords);
        assertEquals(s, (long) 1, lookupNoTry(getLookupName("xmlLong")), postConstructRecords);
        assertEquals(s, (float) 1, lookupNoTry(getLookupName("xmlFloat")), postConstructRecords);
        assertEquals(s, (double) 1, lookupNoTry(getLookupName("xmlDouble")), postConstructRecords);
        assertEquals(s, '1', lookupNoTry(getLookupName("xmlChar")), postConstructRecords);

        assertEquals(s, NumberEnum.ONE, lookupNoTry(getLookupName("xmlNumberEnum")), postConstructRecords);
        assertEquals(s, Helper.class, lookupNoTry(getLookupName("xmlHelperClass")), postConstructRecords);
    }

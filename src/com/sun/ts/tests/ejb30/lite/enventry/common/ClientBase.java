...
public abstract class ClientBase extends EJBLiteClientBase {
    ...
    private void postConstruct() {
        ...
        numberEnum = (NumberEnum) lookupNoTry(envEntryBean.getLookupName("numberEnum"));
        helperClass = (Class<Helper>) lookupNoTry(envEntryBean.getLookupName("helperClass"));
        numberEnumClass = (Class<NumberEnum>) lookupNoTry(envEntryBean.getLookupName("numberEnumClass"));
        envEntryBeanBaseClass = (Class<?>) lookupNoTry(envEntryBean.getLookupName("envEntryBeanBaseClass"));
        testUtilClass = (Class) lookupNoTry(envEntryBean.getLookupName("testUtilClass"));

        xmlString = (String) lookupNoTry(envEntryBean.getLookupName("xmlString"));
        xmlBoolean = (Boolean) lookupNoTry(envEntryBean.getLookupName("xmlBoolean"));
        ...
        xmlNumberEnum = (NumberEnum) lookupNoTry(envEntryBean.getLookupName("xmlNumberEnum"));
        xmlHelperClass = (Class) lookupNoTry(envEntryBean.getLookupName("xmlHelperClass"));
    ...
    private void verifyAnnotatedInjections() {
        ...
        Helper.assertEquals(null, TimeUnit.NANOSECONDS, timeUnit, postConstructRecords);
        ...
        Helper.assertEquals(null, NumberEnum.class, numberEnumClass, postConstructRecords);
        Helper.assertEquals(null, EnvEntryBeanBase.class, envEntryBeanBaseClass, postConstructRecords);
        Helper.assertEquals(null, TestUtil.class, testUtilClass, postConstructRecords);
    }
    ...
    private void verifyDescriptorInjections() {
        ...
        Helper.assertEquals(null, NumberEnum.ONE, xmlNumberEnum, postConstructRecords);
        Helper.assertEquals(null, Helper.class, xmlHelperClass, postConstructRecords);
    }
}

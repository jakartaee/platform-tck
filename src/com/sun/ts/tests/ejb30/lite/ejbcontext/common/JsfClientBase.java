...
public abstract class JsfClientBase extends EJBLiteJsfClientBase {
    ...
    protected abstract void setNoInterface(EJBContextBeanBase b);

    // classes in common directories should not directly reference classes in
    // specific subdirectories.
    protected abstract Class<? extends EJBContextBeanBase> getInvokedBusinessInterfaceForNoInterfaceView();
    ...
    public void getBusinessObject() {
        ...
        EJBContextBeanBase bob3 = noInterface.getBusinessObject(getInvokedBusinessInterfaceForNoInterfaceView());

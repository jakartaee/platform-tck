...
public class ClientBase extends EJBLiteClientBase {
    ...
    public void multipleInterfacesLocal() {
        assertEquals("Multi local interfaces:", resultReset[0], businessBean1.businessMethodLocal1(args)[0]);
        assertEquals("Multi local interfaces:", resultReset[0], businessBean2.businessMethodLocal2(args)[0]);
    }
    ...
    public void singleInterfaceLocal() {
        ...
        assertEquals(
                "local interface & Externalizable:",
                resultReset[0],
                externalizableLocalBean.businessMethodLocal1(args)[0]);
        assertEquals(
                "local interface & SessionBean:",
                resultReset[0],
    ...
    public void localAndNoInterfaceView() {
        appendReason(
                ...
                "localAndNoInterfaceBeanNoInterfaceView: " + localAndNoInterfaceBeanNoInterfaceView);
        assertEquals(
                "Local and no-interface view:",
                resultReset[0],

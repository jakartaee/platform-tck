...
public class JsfClientBase extends EJBLiteJsfClientBase {
    ...
    private void interceptorTest(InterceptorIF b, String[] expectedPostConstruct, String[] expectedAroundInvoke) {
        try {
            ...
            List<String> actualAroundInvoke = historySingletonBean.getAroundInvokeRecords();
            appendReason(Helper.compareResultList(expectedAroundInvoke, actualAroundInvoke));
        } finally {

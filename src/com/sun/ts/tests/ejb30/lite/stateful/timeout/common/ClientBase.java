...
public abstract class ClientBase extends EJBLiteClientBase {
    ...
    protected StatefulTimeoutIF getDefaultUnitBeanNoInterface() {
        return (StatefulTimeoutIF) lookup(defaultUnitBeanNoInterfaceName, null, null);
    }
    ...
    protected StatefulTimeoutIF getSecondUnitBeanNoInterface() {
        return (StatefulTimeoutIF) lookup(secondUnitBeanNoInterfaceName, null, null);
    }
    ...
    private void defaultUnit(StatefulTimeoutIF b) {
        ...
        assertBeanActive(b);
        sleepSec((int) (StatefulTimeoutIF.TIMEOUT_MINUTES * 60 + StatefulTimeoutIF.EXTRA_WAIT_SECONDS));
        assertBeanRemoved(b);
    }
    ...
    private void secondUnit(StatefulTimeoutIF b) {
        ...
        assertBeanActive(b);
        sleepSec((int) (StatefulTimeoutIF.TIMEOUT_SECONDS + StatefulTimeoutIF.EXTRA_WAIT_SECONDS));
        assertBeanRemoved(b);
    }
    ...
    public void zeroTimeout() {
        ...
        try {
            ...
            appendReason("Got the expected ", e, TestUtil.NEW_LINE, b, " was removed immediately after lookup.");
            passed = true;
        }

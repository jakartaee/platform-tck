...
public abstract class BeanBase extends ComponentBase {

    @Resource
    private EJBContext ejbContext;

    @Resource(
            lookup = "java:comp/env/com.sun.ts.tests.ejb30.lite.packaging.war.enventry.Client/myBooleanTrue",
    ...
    @Resource(
            lookup = "java:comp/env/com.sun.ts.tests.ejb30.lite.packaging.war.enventry.OneBean/myBooleanTrue",
    ...
    @Resource(
            lookup = "java:comp/env/com.sun.ts.tests.ejb30.lite.packaging.war.enventry.TwoBean/myBooleanTrue",
    ...
    @Resource(
            lookup = "java:comp/env/com.sun.ts.tests.ejb30.lite.packaging.war.enventry.ThreeBean/myBooleanTrue",
    ...
    private void postConstruct() {
        ...
        try {
            ...
            assertEquals("Check myBooleanTrue web.xml: ", true, myBooleanTrueFromWebXml, sb);
            assertEquals("Check myBooleanTrue from OneBean", true, myBooleanTrue, sb);
            assertEquals("Check myBooleanTrue from TwoBean", true, myBooleanTrueFromTwo, sb);
            assertEquals("Check myBooleanTrue from ThreeBean", true, myBooleanTrueFromThree, sb);

            assertEquals("Check myBooleanFalse from web.xml", false, myBooleanFalseFromWebXml, sb);
            assertEquals("Check myBooleanFalse from OneBean", false, myBooleanFalse, sb);
            assertEquals("Check myBooleanFalse from TwoBean", false, myBooleanFalseFromTwo, sb);
            assertEquals("Check myBooleanFalse from ThreeBean", false, myBooleanFalseFromThree, sb);

 ...
 */
public class Client extends com.sun.ts.tests.ejb30.lite.packaging.war.webinflib.Client {
    /*
     * @testName: clientToBeanClassLookup
     *
     * @test_Strategy: client looking up ejb-ref injections in bean class. It must succeed since client and ejb packaged
     ...
     *
     * @test_Strategy: bean looking up resource injected into client. It must succeed since client and ejb packaged together

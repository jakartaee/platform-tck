...
public class Client extends EJBLiteClientBase {
    ...
    private URLClassLoader createClassLoader() {
        ...
        appendReason("Creating a classloader with additionalModule URLs: ", Arrays.toString(urls));
    ...
    protected void additionalModule(String moduleName1, String moduleName2, String moduleName3) throws Exception {
        appendReason("Created EJBContainer provider ", getContainer(), " with init properties: ");
        appendReason(
                EJBContainer.APP_NAME + " = " + getContainerInitProperties().get(EJBContainer.APP_NAME));
        appendReason(EJBContainer.MODULES + " = " + getContainerInitProperties().get(EJBContainer.MODULES));
        File[] modPaths = (File[]) getContainerInitProperties().get(EJBContainer.MODULES);
        ...
        final List<String> expected = Arrays.asList("OneBean", "TwoBean", "ThreeBean");
        ...
        appendReason(oneBean.lookupJNDINames(APP_NAME, moduleName1, moduleName2, moduleName3));
        appendReason(twoBean.lookupJNDINames(APP_NAME, moduleName1, moduleName2, moduleName3));
        appendReason(threeBean.lookupJNDINames(APP_NAME, moduleName1, moduleName2, moduleName3));
    }
    ...
    public void autoCloseTest() throws Exception {
        ...
        TSDbUtil tsDbUtil = new TSDbUtil(databaseURL, databaseUser, databasePassword, driverName);
    ...
    public void autoCloseTestWithArrayList() throws Exception {
        ...
        final List<String> expectedOutput = Arrays.asList("setupOneBeanWithArrayList called");
        assertEquals(null, expectedOutput, oneBean.setupOneBeanWithArrayList(arrayList));

...
public class OneBean extends BeanBase {
    ...
    @Resource(
            lookup = "java:comp/env/com.sun.ts.tests.ejb30.lite.packaging.war.enventry.Client/myByte",
    ...
    @Resource(
            lookup = "java:comp/env/com.sun.ts.tests.ejb30.lite.packaging.war.enventry.TwoBean/myByte",
    ...
    @Resource(
            lookup = "java:comp/env/com.sun.ts.tests.ejb30.lite.packaging.war.enventry.ThreeBean/myByte",

...
public class Client extends com.sun.ts.tests.ejb30.lite.interceptor.common.lifecycle.ClientBase {
    ...
    public void identityHashCode() {
        ...
        for (int i = 0; i < 50; i++) {
            AManagedBean b = (AManagedBean) ServiceLocator.lookupNoTry("java:module/AManagedBean");
            int c = b.identityHashCode();
            assertEquals("Existing instance: " + b + "?", false, instances.contains(c));
            instances.add(c);
        }

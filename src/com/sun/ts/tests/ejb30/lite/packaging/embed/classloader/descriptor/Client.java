...
public final class Client extends com.sun.ts.tests.ejb30.lite.packaging.embed.classloader.annotated.Client {
    ...
    public void additionalModuleJar() throws Exception {
        additionalModule(getModuleName(), "ejbembed_two_ejb-renamed", "ejbembed_three_ejb-renamed");
    }
    ...
    public void additionalModuleJarDir() throws Exception {
        additionalModule(getModuleName(), "2-renamed", "ejbembed_three_ejb-renamed");
    }
}

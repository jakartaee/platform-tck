...
public class Client extends EJBLiteClientBase {
    ...
    private void verify() {
        assertEquals("Check myString from web.xml: ", " web.xml ${java.home} ", myString);
        assertEquals("Check myString from OneBean: ", " OneBean ${java.home} ", myStringFromOne);
        assertEquals("Check myString from TwoBean: ", " TwoBean ${java.home} ", myStringFromTwo);
        assertEquals("Check myString from  ThreeBean: ", " ThreeBean ${java.home} ", myStringFromThree);

...
public class ThreeBean extends BeanBase {
    ...
    @Resource(
            lookup = "java:comp/env/com.sun.ts.tests.ejb30.lite.packaging.war.jsfenventry.JsfClient/myFloat",
    ...
    @Resource(lookup = "java:comp/env/com.sun.ts.tests.ejb30.lite.packaging.war.jsfenventry.OneBean/myDouble")
    ...
    @Resource(lookup = "java:comp/env/com.sun.ts.tests.ejb30.lite.packaging.war.jsfenventry.TwoBean/myDouble")
    ...
    protected void verify(StringBuilder sb) throws RuntimeException {
        assertEquals("Check myFloatFromOneBean web.xml: ", (float) 8, myFloatFromWebXml, sb);
        assertEquals("Check myFloatFromOneBean from OneBean", (float) 1, myFloatFromOneBean, sb);
        assertEquals("Check myFloatFromOneBean from TwoBean", (float) 2, myFloatFromTwoBean, sb);
        assertEquals("Check myFloatFromOneBean from ThreeBean", (float) 3, myFloat, sb);

        assertEquals("Check myDoubleFromOneBean from web.xml", (double) 8, myDoubleFromWebXml, sb);
        assertEquals("Check myDoubleFromOneBean from OneBean", (double) 1, myDoubleFromOneBean, sb);
        assertEquals("Check myDoubleFromOneBean from TwoBean", (double) 2, myDoubleFromTwoBean, sb);
        assertEquals("Check myDoubleFromOneBean from ThreeBean", (double) 3, myDouble, sb);
    }
}

...
public class TestBean extends RWTestBeanBase {
    ...
    public String mandatory(boolean flush) {
        ...
        result += CoffeeUtil.verifyCoffee(AFTER_BEGIN_COFFEE_ID, AFTER_BEGIN, em, false);
        result += TestUtil.NEW_LINE;
        result += CoffeeUtil.verifyCoffee(BEFORE_COMPLETION_COFFEE_ID, BEFORE_COMPLETION, em, false);
    ...
    public String requiredNoExistingTransaction(boolean flush) {
        ...
        result += CoffeeUtil.verifyCoffee(AFTER_BEGIN_COFFEE_ID, AFTER_BEGIN, em, true);
        result += TestUtil.NEW_LINE;
        result += CoffeeUtil.verifyCoffee(BEFORE_COMPLETION_COFFEE_ID, BEFORE_COMPLETION, em, true);
    ...
    public String invokeAsBusinessMethod() {
        ...
        String result = CoffeeUtil.verifyCoffee(AFTER_BEGIN_COFFEE_ID, AFTER_BEGIN, em, true);
        result += TestUtil.NEW_LINE;
    ...
    private void deleteTestCoffees() {
        ...
        CoffeeUtil.deleteCoffeeInNewUserTransaction(BEFORE_COMPLETION_COFFEE_ID, em, ut);
    }

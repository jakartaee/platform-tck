...
public class RWTestBeanBase0 {
    ...
    public String mandatory(boolean flush) {
        ...
        try {
            ...
            result += Helper.assertEquals("Check coffee price ", targetPrice, coffee.getPrice());
            ut.rollback();
            CoffeeEJBLite coffeeFound = em.find(CoffeeEJBLite.class, id);
            result += Helper.assertEquals("Check coffee from em.find()", null, coffeeFound);
    ...
    public String requiredNoExistingTransaction(boolean flush) {
        ...
        coffee = em.find(CoffeeEJBLite.class, id);
        return Helper.assertEquals("Check coffee price ", targetPrice, coffee.getPrice());
    }
    ...
    public String requiresNew(boolean flush) {
        ...
        try {
            ...
            ut.rollback();
            CoffeeEJBLite coffeeFound = em.find(CoffeeEJBLite.class, id);
            result += Helper.assertEquals("Check coffee id from em.find()", id, coffeeFound.getId());
        } catch (RuntimeException e) {
            throw e;
        } catch (Exception e) {
            throw new RuntimeException(e);

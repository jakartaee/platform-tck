...
/**
 * The purpose of this class is to verify method-level @AccessTimeout. This class has no class-level @AccessTimeout
 * metadata. Its superclass, PlainAccessTimeoutBeanBase, contains no AccessTimeout metadata.
 */
@Singleton
@Startup
@Lock(LockType.READ)

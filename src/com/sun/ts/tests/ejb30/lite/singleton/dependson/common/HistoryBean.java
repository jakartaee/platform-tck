...
public class HistoryBean {
    ...
    public void addInstanceIdForBeanName(String beanName, int i, Object beanInstance) {
        ...
        Helper.getLogger()
                .info(String.format(
                        "Adding instanceId %d for beanName %s by beanInstance %s", i, beanName, beanInstance));
    }
    ...
    public void addCreationTimeMillisForBeanName(String beanName, long t, Object beanInstance) {
        if (creationTimeMillisMap.containsKey(beanName)) {
            throw new IllegalStateException("creationTimeMillis for beanName " + beanName
                    + " already exists, which was added by another instance.");
        }
        creationTimeMillisMap.put(beanName, t);
        Helper.getLogger()
                .info(String.format(
                        "Adding creationTimeMillis %d for beanName %s by beanInstance %s", t, beanName, beanInstance));
    }
}

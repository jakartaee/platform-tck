    ...
    public void uncheckedSystemException4() {
        try {
            ...
            if (cause instanceof Exception4) {
                ...
                throw new RuntimeException("Expecting EJBException with Exception4, but got " + cause);
            }
        }
    }
    ...
    public void uncheckedSystemException5() {
        try {
            ...
            if (cause instanceof Exception5) {
                ...
                throw new RuntimeException("Expecting EJBException with Exception5, but got " + cause);
            }
        }
    }

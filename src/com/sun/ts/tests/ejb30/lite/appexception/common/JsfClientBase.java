...
public abstract class JsfClientBase extends EJBLiteJsfClientBase {
    ...
    protected abstract void setNoInterfaceBean(AppExceptionIF noInterfaceBean);
     ...
     *
     */
    public void atCheckedRollbackAppExceptionTestLocal() throws TestFailedException {
        try {
     ...
     *
     */
    public void atUncheckedRollbackAppExceptionTestLocal() throws TestFailedException {
        try {
    ...
    public void checkedAppExceptionTest() throws TestFailedException {
        for (CommonIF b : appExceptionBeans) {
            try {
                ...
                throw new TestFailedException("Did not get expected exception: CheckedAppException");
     ...
     *
     */
    public void checkedRollbackAppExceptionTestLocal() throws TestFailedException {
        try {
    ...
    public void atCheckedAppExceptionTest() throws TestFailedException {
        for (CommonIF b : appExceptionBeans) {
            try {
                ...
                throw new TestFailedException("Did not get expected exception: AtCheckedAppException");
    ...
    public void atUncheckedAppExceptionTest() throws TestFailedException {
        for (CommonIF b : appExceptionBeans) {
            try {
                ...
                throw new TestFailedException("Did not get expected exception: AtUncheckedAppException");
    ...
    public void uncheckedAppExceptionTest() throws TestFailedException {
        try {
            ...
            throw new TestFailedException("Did not get expected exception: UncheckedAppException");
     ...
     *
     */
    public void uncheckedRollbackAppExceptionTestLocal() throws TestFailedException {
        try {

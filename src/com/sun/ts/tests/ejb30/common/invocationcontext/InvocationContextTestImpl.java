...
public class InvocationContextTestImpl {
    ...
    private void getSetParameters(InvocationContext inv, String methodName) throws TestFailedException {
        ...
        if (!Arrays.equals(params, paramsOld)) {
            throw new TestFailedException(
                    "Expecting " + Arrays.asList(paramsOld) + ", actual " + Arrays.asList(params));
        }
    ...
    private void getTarget(InvocationContext inv, String methodName) throws TestFailedException {
        ...
        try {
            ...
            if (id1 == id2) {
                ...
                throw new TestFailedException(
                        "target1: " + id1 + ", and target2" + id2 + " are not the same bean instance.");
            }
        }
    }
    ...
    private void setParametersIllegalArgumentExceptionForNumber(InvocationContext inv, String methodName)
    ...
    private void setParametersIllegalArgumentExceptionForChar(InvocationContext inv, String methodName)
            throws TestFailedException {
        String reason = "";
        Object[] objects = null;
        // try to reset it in various ways, and may result in
    ...
    private void setParametersIllegalArgumentExceptionForString(InvocationContext inv, String methodName)
            throws TestFailedException {
        String reason = "";
        Object[] objects = null;
    ...
    private void setParametersIllegalArgumentExceptionForStringArray(InvocationContext inv, String methodName)
            throws TestFailedException {
        String reason = "";
        Object[] objects = null;
    ...
    private void setParametersIllegalArgumentExceptionForShortLong(InvocationContext inv, String methodName)
            throws TestFailedException {
        String reason = "";
        Object[] objects = null;
    ...
    public static void getSetParameters(InvocationContextIF[] beans) throws TestFailedException {
        for (InvocationContextIF b : beans) {
            ...
            if (result.equals(paramsCombined)) {
                Helper.getLogger()
                        .info("Got expected result after InvocationContext.setParameters: " + result + ", from bean "
                                + b);
            } else {
                throw new TestFailedException(
                        "Expecting " + paramsCombined + ", actual, " + result + ", from bean " + b);
            }
        }
    }
    ...
    private static void setParametersIllegalArgumentExceptionForNumber0(InvocationContextIF bean)
            throws TestFailedException {
        Number m = 8;
        Number n = 9;
        Number[] result = null;
        ...
        if (Arrays.equals(expected, result)) {
            ...
            throw new RuntimeException("Expecting " + Arrays.asList(expected) + ", but the actual result is "
                    + Arrays.asList(result) + " from bean " + bean);
        }
    }

    private static void setParametersIllegalArgumentExceptionForChar0(InvocationContextIF bean)
            throws TestFailedException {
        char m = '8';
        char n = '9';
        char[] result = null;
        ...
        if (Arrays.equals(expected, result)) {
            ...
            throw new TestFailedException("Expecting " + Arrays.asList(expected) + ", but the actual result is "
                    + Arrays.asList(result) + " from bean " + bean);
        }
    }

    private static void setParametersIllegalArgumentExceptionForString0(InvocationContextIF bean)
            throws TestFailedException {
        String m = "8";
        String n = "9";
        String[] result = null;
    ...
    private static void setParametersIllegalArgumentExceptionForShortLong0(InvocationContextIF bean)
            throws TestFailedException {
        short m = 0;
        long n = 1;
        Number[] result = null;
        ...
        if (result != null
                ...
                && result[0] != null
                && result[1] != null
                && (result[0].intValue() == expected[0].intValue())

...
public abstract class ClientBase extends EETest {
    ...
    protected abstract EnvEntryIF getEnvEntrySetterBean();

    protected abstract EnvEntryIF getEnvEntryFieldBean();

    protected abstract EnvEntryIF getEnvEntryTypeBean();

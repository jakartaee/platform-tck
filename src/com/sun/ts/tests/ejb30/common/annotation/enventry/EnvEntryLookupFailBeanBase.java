...
public abstract class EnvEntryLookupFailBeanBase extends EnvEntryBeanBase implements EnvEntryIF {
    ...
    protected void failEJBContextLookup(String name) throws TestFailedException {
        ...
        if (actual != null) {
            throw new TestFailedException("EJBContext lookup of env-entry unexpectedly succedded " + name + "=" + actual
                    + " in class " + this);
        }
    }
    ...
    protected void failJndiLookup(String name) throws TestFailedException {
        ...
        if (actual != null) {
            throw new TestFailedException("Naming Context lookup of env-entry unexpectedly succedded " + name + "="

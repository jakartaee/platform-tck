...
public abstract class ResourceBeanBase implements ResourceIF {
    ...
    protected abstract jakarta.mail.Session getMailSession();
    ...
    public void testConnectionFactoryT() throws TestFailedException {
        ...
        ConnectionFactory topic2 = (ConnectionFactory) getEJBContext().lookup(getConnectionFactoryTName());
        verify(topic2, "EJBContext.lookup" + getConnectionFactoryTName());

        try {
            ConnectionFactory topic3 = (ConnectionFactory) ServiceLocator.lookup(PREFIX + getConnectionFactoryTName());
            verify(topic3, "Naming Context lookup");
        } catch (NamingException e) {
            throw new TestFailedException(e);
        }
    ...
    public void testConnectionFactoryQ() throws TestFailedException {
        ...
        ConnectionFactory queue2 = (ConnectionFactory) getEJBContext().lookup(getConnectionFactoryQName());
        verify(queue2, "EJBContext.lookup" + getConnectionFactoryQName());

        try {
            ConnectionFactory queue3 = (ConnectionFactory) ServiceLocator.lookup(PREFIX + getConnectionFactoryQName());
            verify(queue3, "Naming Context lookup");
        } catch (NamingException e) {
            throw new TestFailedException(e);
        }
    ...
    public void testDestinationQ() throws TestFailedException {
        ...
        Destination dest2 = (Destination) getEJBContext().lookup(getDestinationQName());
        verify(dest2, "EJBContext.lookup" + getDestinationQName());

        try {
            Destination dest3 = (Destination) ServiceLocator.lookup(PREFIX + getDestinationQName());
    ...
    public void testDestinationT() throws TestFailedException {
        ...
        Destination dest2 = (Destination) getEJBContext().lookup(getDestinationTName());
        verify(dest2, "EJBContext.lookup" + getDestinationTName());

        try {
            Destination dest3 = (Destination) ServiceLocator.lookup(PREFIX + getDestinationTName());
            verify(dest3, "Naming Context lookup");
        } catch (NamingException e) {
            throw new TestFailedException(e);
        }
    ...
    public void testDataSource2() throws TestFailedException {
        ...
        try {
            DataSource ds3 = (DataSource) ServiceLocator.lookup(PREFIX + getDataSource2Name());
    ...
    public void testDataSource() throws TestFailedException {
        ...
        try {
            DataSource ds3 = (DataSource) ServiceLocator.lookup(PREFIX + getDataSourceName());
            verify(ds3, "Naming Context lookup");
        } catch (NamingException e) {
            throw new TestFailedException(e);
        }
    ...
    public void testUserTransaction() throws TestFailedException {
        ...
        try {
            UserTransaction ut3 = (UserTransaction) ServiceLocator.lookup(USER_TRANSACTION_JNDI_NAME);
    ...
    public void testCustomResourceLookup() throws TestFailedException {
        ...
        if (Dog.getInstance().equals(dog)) {
            ...
            throw new TestFailedException("Failed to lookup the expected value.  Expected result: "
    ...
    public void testCustomResourceInjected() throws TestFailedException {
        ...
        if (Dog.getInstance().equals(obj)) {
            ...
            throw new TestFailedException("The expected value has not been injected.  Expected result: "

...
public abstract class TestBeanBase implements TestIF {
    protected abstract BusinessLocalIF1 getLocalBean1();

    protected abstract BusinessLocalIF2 getLocalBean2();
    ...
    protected abstract BusinessLocalIF1 getSerializableLocalBean();

    protected abstract BusinessLocalIF1 getExternalizableLocalBean();

    protected abstract BusinessLocalIF1 getTimedObjectLocalBean();

    protected abstract BusinessLocalIF1 getSessionSynchronizationLocalBean();

    protected abstract BusinessLocalIF1 getSessionBeanLocalBean();

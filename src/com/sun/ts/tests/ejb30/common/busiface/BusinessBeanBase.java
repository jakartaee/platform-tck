 ...
 */
public abstract class BusinessBeanBase extends BusinessLocal1Base
...
// AnnotatedBusinessInterface1, AnnotatedBusinessInterface2
{
    ...
    public void afterCompletion(boolean b) throws EJBException {
        throw new EJBException(
                "This method should not be called since this bean" + " does not implement SessionSynchronization.");
    }

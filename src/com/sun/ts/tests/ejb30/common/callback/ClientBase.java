...
public abstract class ClientBase extends EETest {
    ...
    protected abstract CallbackIF getBean();

    protected abstract Callback2IF getBean2();
    ...
    public void isPostConstructCalledTest() throws Fault {
        ...
        if (expected != actual) {
            throw new Fault("PostConstruct method has not been called when business method is called");
        }
    }
    ...
    public void isInjectionDoneTest() throws Fault {
        ...
        if (expected != actual) {
            throw new Fault("Dependency injection has not occurred when callback method is called");
        }
    }
    ...
    public void isPostConstructOrPreDestroyCalledTest() throws Fault {
        ...
        if (expected != actual) {
            throw new Fault("PostConstruct or PreDestroy method has not been called when business method is called");
        }
    }
    ...
    public void inheritanceInterceptorsForCallbackBean3() throws Fault {
        List actual = getBean3().getPostConstructCalls();
        Helper.compareResultList(INTERCEPTORS_ABCEFCG_SUPERSUPER_SUPER_BEAN, actual);
    }

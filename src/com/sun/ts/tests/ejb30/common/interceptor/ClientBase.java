...
public abstract class ClientBase extends EETest implements Constants {
    ...
    public void suppressExceptionTest() throws Fault {
        try {
            ...
            throw new Fault("This exception should have been supressed by interceptor.", e);
        } catch (Exception e) {
            throw new Fault("Unexpected exception", e);
        }
    }
    ...
    public void runtimeExceptionTest() throws Fault {
        try {
            ...
            throw new Fault("Should not get here. RuntimeException should've been thrown from AroundInvoke method.");
        } catch (CalculatorException e) {
            throw new Fault("tx not rolled back properly.", e);
        } catch (Exception e) {
            if (e instanceof RemoteException) {
                ...
                throw new Fault("Got RuntimeException. It should not be thrown to the client.");
            } else {
    ...
    public void methodLevelInterceptorMixedTest() throws CalculatorException {
        ...
        ArrayList<String> result = getBean().methodLevelInterceptorMixedTest(new ArrayList<String>());
        if (expected.equals(result)) {
            TLogger.log("Method-level interceptors are invoked in the correct order: " + result);
        } else {
            throw new CalculatorException("Method-level interceptors are not invoked in the correct order. "
    ...
    public void methodLevelClassLevelInterceptorMixedTest() throws CalculatorException {
        ...
        ArrayList<String> result = getBean().methodLevelClassLevelInterceptorMixedTest(new ArrayList<String>());
        if (expected.equals(result)) {
            TLogger.log("Method-level interceptors are invoked in the correct order: " + result);
        } else {
            throw new CalculatorException("Method-level interceptors are not invoked in the correct order. "
    ...
    public void repeatedInterceptors() throws CalculatorException {
        ...
        ArrayList<String> result = getBean().repeatedInterceptors(new ArrayList<String>());
        if (expected.equals(result)) {
            TLogger.log("Method-level interceptors are invoked in the correct order: " + result);
        } else {
            throw new CalculatorException("Method-level interceptors are not invoked in the correct order. "
    ...
    public void interceptorOrderingOverride() throws CalculatorException {
        ...
        ArrayList<String> result = getBean().interceptorOrderingOverride(new ArrayList<String>());
        if (expected.equals(result)) {
            TLogger.log("Method-level interceptors are invoked in the correct order: " + result);
        } else {
            throw new CalculatorException("Method-level interceptors are not invoked in the correct order. "

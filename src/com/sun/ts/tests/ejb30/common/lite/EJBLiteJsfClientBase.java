...
public class EJBLiteJsfClientBase extends ServiceEETest implements EJBLiteClientIF {
        ...
        if (container == null) {
            ...
            if (!lookupName.startsWith(JAVA_GLOBAL_PREFIX)) {
                if (beanName == null) {
                    ...
                    nameNormalized = s;
                    Helper.getLogger()
                            .info("Retrieved the global jndi name from jndiMapping: " + lookupName + " : "
                                    + nameNormalized);
                } else {
    ...
    protected void assertEquals(final String messagePrefix, final Object expected, final Object actual)
            throws RuntimeException {
        Helper.assertEquals(messagePrefix, expected, actual, getReasonBuffer());
    }

    protected void assertNotEquals(final String messagePrefix, final Object expected, final Object actual)
            throws RuntimeException {

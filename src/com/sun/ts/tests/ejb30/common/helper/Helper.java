...
public final class Helper {
    ...
    public static void assertEquals(
            final String messagePrefix, final Object expected, final Object actual, final StringBuilder sb)
            throws RuntimeException {
    ...
    public static void assertCloseEnough(
            final String messagePrefix, long expected, long actual, long ignoreableDiff, StringBuilder sb) {
        sb.append(TestUtil.NEW_LINE);
        if (messagePrefix != null) {
            sb.append(messagePrefix).append(" ");
        }

...
public class Module2Bean extends AppResBeanBase implements AppResRemoteIF {
    ...
    private void nonPostConstruct() {
        ...
        lookupShouldFail("java:app/two_standalone_component_ejb/ModuleMBean", postConstructRecords);

        lookupShouldFail("java:app/two_standalone_component_ejb/Module2Bean", postConstructRecords);
        ...
        Helper.assertEquals("Check " + lookup, expected, value, postConstructRecords);
        ...
        Helper.assertEquals(
                "Compare to ModuleName from ModuleMBean", expected, moduleMBean.getModuleName(), postConstructRecords);
        Helper.assertEquals(
                "Compare to AppName from ModuleMBean", expected, moduleMBean.getAppName(), postConstructRecords);
    }

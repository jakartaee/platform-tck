...
public class TestServlet extends HttpTCKServlet {
    ...
    public void globalJNDI(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        PrintWriter pw = response.getWriter();
        StringBuilder reason = new StringBuilder();
        try {
            BasicBeanHelper.globalJNDI(
                    getAppName(request),
                    getModuleName(request),
                    basicBean.getBusinessInterface(),
                    reason,
                    (jakarta.ejb.EJBContext) null,
    ...
    public void globalJNDI2(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        PrintWriter pw = response.getWriter();
        StringBuilder reason = new StringBuilder();
        try {
            reason.append(basicBean.globalJNDI(getAppName(request), getModuleName(request)));
            pw.println(Data.PASSED);
        } catch (Exception e) {
            pw.println(Data.FAILED);
            reason.append(TestUtil.printStackTraceToString(e));
    ...
    public void appJNDI(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        StringBuilder reason = new StringBuilder();
        try {
            BasicBeanHelper.appJNDI(getModuleName(request), basicBean.getBusinessInterface(), reason);
            pw.println(Data.PASSED);
        } catch (Exception e) {
            pw.println(Data.FAILED);
            reason.append(TestUtil.printStackTraceToString(e));
    ...
    public void moduleJNDI(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        PrintWriter pw = response.getWriter();
        StringBuilder reason = new StringBuilder();
        try {
    ...
    public void moduleJNDI2(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        PrintWriter pw = response.getWriter();
        StringBuilder reason = new StringBuilder();
        try {
    ...
    public void appNameModuleName(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        PrintWriter pw = response.getWriter();

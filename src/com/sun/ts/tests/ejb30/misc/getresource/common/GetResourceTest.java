...
public class GetResourceTest {
    ...
    public void getResourceWithClassLoader(Class cls, String name, String expected) throws TestFailedException {
        ...
        if (url == null) {
            throw new TestFailedException("ClassLoader.getResource(" + name + ") returned a null URL"
    ...
    public void getResourceAsStreamWithClass(Class cls, String name, String expected) throws TestFailedException {
        ...
        if (is == null) {
            throw new TestFailedException(
                    "Class.getResourceAsStream(" + name + ") returned a null InputStream" + ".  The class is " + cls);
        }
    ...
    public void getResourceAsStreamNonexisting(Class cls) throws TestFailedException {
        ...
        getResourceAsStreamNonexisting0(getContextClassLoader(cls), NON_EXISTING_RESOURCE);
        getResourceAsStreamNonexisting0(getContextClassLoader(cls), NON_EXISTING_RESOURCE);
        getResourceAsStreamNonexisting0(getContextClassLoader(cls), "/" + NON_EXISTING_RESOURCE);
        getResourceAsStreamNonexisting0(getContextClassLoader(cls), "//////" + NON_EXISTING_RESOURCE);
    }
    ...
    public static void verify(String content, String expected) throws TestFailedException {
        ...
        if (expected.equals(content)) {
            TLogger.log("Resource retrieved correctly and the content is: " + expected);
        } else {
            throw new TestFailedException(
                    "Failed to retrieve the resource. " + "Expecting " + expected + ", actual: " + content);
        }
    }
}

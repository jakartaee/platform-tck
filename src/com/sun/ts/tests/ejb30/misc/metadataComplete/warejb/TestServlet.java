...
public class TestServlet extends HttpTCKServlet {
    ...
    private void operation(RemoteCalculator bean, HttpServletRequest request, HttpServletResponse response)
    ...
    public void annotationNotProcessedForStateless(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        operation(statelessBean, request, response);
    }

    public void annotationNotProcessedForStateful(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        operation(statefulBean, request, response);
    }

    public void annotationNotProcessedForWar(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        PrintWriter pw = response.getWriter();
        if (statelessBeanNotInjected == null && statefulBeanNotInjected == null) {
    ...
    public void typeLevelAnnotationNotProcessedForWar(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        PrintWriter pw = response.getWriter();
        ...
        try {
            ...
            pw.println(Data.PASSED + "Got expected javax.naming.NamingException when looking up " + lookupName);
        }
    ...
    public void excludeDefaultIncludeClassInterceptor(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        PrintWriter pw = response.getWriter();
        int param1 = 0;
        int param2 = 0;
        ...
        if (actual == expected) {
            ...
            pw.println(Data.FAILED + " Expecting result: " + expected + ", but actual is " + actual);
        }
    ...
    public void excludeDefaulAndClassReinstateDefault(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        PrintWriter pw = response.getWriter();
        int param1 = 0;
        int param2 = 0;
        ...
        int postConstructCallsCount = 1;
        int expected = param1 + param2 + additionByInterceptor + postConstructCallsCount;
        int actual = excludeDefaultAndClassReinstateDefault.remoteAdd(param1, param2);
        if (actual == expected) {
            pw.println(Data.PASSED + " Got expected result : " + actual);
        } else {
            pw.println(Data.FAILED + " Expecting result: " + expected + ", but actual is " + actual);
    ...
    public void defaultAndMethodInterceptor(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        PrintWriter pw = response.getWriter();
        int param1 = 0;
        int param2 = 0;
        ...
        int postConstructCallsCount = 1;
        int expected = param1 + param2 + additionByInterceptor + postConstructCallsCount;
        int actual = excludeDefaultAndClassReinstateDefault.remoteSubtract(param1, param2);
        if (actual == expected) {
            pw.println(Data.PASSED + " Got expected result : " + actual);
        } else {
            pw.println(Data.FAILED + " Expecting result: " + expected + ", but actual is " + actual);
    ...
    public void sameInterceptor3Times(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        PrintWriter pw = response.getWriter();
        int param1 = 0;
        int param2 = 0;
    ...
    public void sameInterceptorTwice(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        PrintWriter pw = response.getWriter();
        int param1 = 0;
        int param2 = 0;

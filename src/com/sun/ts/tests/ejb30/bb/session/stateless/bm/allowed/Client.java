...
public class Client extends ClientBase implements Constants {
     ...
     * EJB:SPEC:108.15; EJB:SPEC:106; EJB:SPEC:107; EJB:JAVADOC:36; EJB:JAVADOC:40; EJB:JAVADOC:44; EJB:JAVADOC:48;
     * EJB:JAVADOC:51; EJB:JAVADOC:86; EJB:JAVADOC:102; EJB:JAVADOC:72
     *
     * @test_Strategy: Operations allowed and not allowed in the ejbCreate method of a stateless session bean with
     * container-managed transaction demarcation are: Deploy it on the J2EE server. Verify correct operations.
     *
     */
    ...
    public void postConstructTest() throws Fault {
        ...
        // bug 6497583 spec does not mandate IllegalStateException when accessing
        // UserTransaction methods in PostConstruct methods
        //
     ...
     * EJB:SPEC: 109.15; EJB:JAVADOC:72; EJB:JAVADOC:73; EJB:JAVADOC:36; EJB:JAVADOC:40; EJB:JAVADOC:44; EJB:JAVADOC:48;
     * EJB:JAVADOC:51; EJB:JAVADOC:86; EJB:JAVADOC:102
     *
     * @test_Strategy: Operations allowed and not allowed in the setSessionContext method of a stateless session bean with
     * container-managed transaction demarcation are: Create a stateless Session Bean. Deploy it on the J2EE server. Verify
     * correct operations.
     */
     ...
     * EJB:SPEC:110.15; EJB:JAVADOC:72
     *
     * @test_Strategy: Operations allowed and not allowed in the business method method from a component interface of a
     * stateless session bean with container- managed transaction demarcation are: Create a stateless Session Bean. Deploy
     * it on the J2EE server. Verify correct operations.
     *
     */
    public void businessTest() throws Fault {
        ...
        // since Test3 (commit) is allowed and the current tx is already committed.
        // Test4 (rollback) should produce IllegalStateException.
        expected.setProperty(UserTransaction_Methods_Test4, disallowed);

        // since Test3 (commit) is allowed and the current tx is already committed.
        // Test5 (setRollbackOnly) should produce IllegalStateException.
        expected.setProperty(UserTransaction_Methods_Test5, disallowed);
     ...
     * EJB:SPEC:110.15; EJB:JAVADOC:72
     *
     * @test_Strategy: Operations allowed and not allowed in the preInvokeTest method method from a component interface of a
     * stateless session bean with container- managed transaction demarcation are: Create a stateless Session Bean. Deploy
     * it on the J2EE server. Verify correct operations.
     *
     */
     ...
     * EJB:SPEC:110.15; EJB:JAVADOC:72
     *
     * @test_Strategy: Operations allowed and not allowed in the postInvokeTest method method from a component interface of
     * a stateless session bean with container- managed transaction demarcation are: Create a stateless Session Bean. Deploy
     * it on the J2EE server. Verify correct operations.
     *
     */

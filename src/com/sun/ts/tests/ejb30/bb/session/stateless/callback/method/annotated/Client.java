...
public class Client extends ClientBase3 {
    ...
    public void ejbCreateTreatedAsPostConstruct() throws Fault {
        ...
        if (b) {
            TLogger.log("Got expected result.  ejbCreate method is called as a PostConstruct method.");
        } else {
            throw new Fault("ejbCreate method is not called as a PostConstruct method in " + ejbCreateCallbackBean);
        }
    }
    ...
    public void injectionDoneInEjbCreate() throws Fault {
        ...
        if (b) {
            ...
            throw new Fault("injection has not completed when ejbCreate is called in " + ejbCreateCallbackBean);
        }
    }
}

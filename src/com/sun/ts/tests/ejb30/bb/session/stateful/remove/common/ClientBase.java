...
public abstract class ClientBase extends EETest {
    ...
    public void removeBean2() throws Fault {
        ...
        try {
            removeBean2.remove();
            throw new Fault("Expecting java.rmi.NoSuchObjectException, but got none.");
    ...
    public void retainBean() throws Fault {
        ...
        try {
            ...
            throw new Fault("Failed to remove bean, which should be there when this" + "method was called");
        } finally {
            removeBean = null;
        }
    }
    ...
    public void retainBeanOverloaded() throws Fault {
        ...
        try {
            ...
            throw new Fault(
                    "Failed to remove bean, which should be there when this" + "method was called. But got " + e);
        } finally {
            removeBean = null;
        }
    }
    ...
    public void removeNotRetainBean() throws Fault {
        try {
            ...
            TLogger.log("Got expected exception, and bean should have been removed" + "despite the exception");
        }
        try {
            removeNotRetainBean.remove();
            throw new Fault("Expecting jakarta.ejb.NoSuchEJBException, but got none.");
    ...
    public void alwaysRemoveAfterSystemException() throws Fault {
        try {
            ...
            TLogger.log(
                    "Got expected exception, and bean should have been removed" + " after the system exception: " + e);
        }
        try {
            removeNotRetainBean.alwaysRemoveAfterSystemException();
            throw new Fault("Expecting jakarta.ejb.NoSuchEJBException, but got none.");

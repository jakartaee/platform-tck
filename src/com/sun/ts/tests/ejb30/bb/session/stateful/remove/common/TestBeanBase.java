...
public abstract class TestBeanBase implements TestIF {
    ...
    protected abstract RemoveLocalIF getRemoveLocalBean();

    protected abstract RemoveLocal2IF getRemoveLocalBean2();

    protected abstract RemoveIF getRemoveRemoteBean();

    protected abstract Remove2IF getRemoveRemoteBean2();

    protected abstract TwoLocalHome getTwoLocalHome();

    protected abstract void setRemoveLocalBean(RemoveLocalIF b);

    protected abstract void setRemoveLocalBean2(RemoveLocal2IF b);

    protected abstract void setRemoveRemoteBean(RemoveIF b);

    protected abstract void setRemoveRemoteBean2(Remove2IF b);
    ...
    public void removeBean() throws TestFailedException {
        ...
        try {
            removeBean.remove2();
            throw new TestFailedException("Expecting jakarta.ejb.NoSuchEJBException, " + "but got none");
    ...
    public void removeBean2Remote() throws TestFailedException {
        ...
        try {
            removeBean2.remove2();
            throw new TestFailedException("Expecting java.rmi.NoSuchObjectException, " + "but got none");
    ...
    public void retainBean() throws TestFailedException {
        ...
        try {
            ...
            throw new TestFailedException(
                    "Failed to remove the bean. " + "The bean should be there when this method was called.");
        } finally {
            setRemoveLocalBean(null);
        }
    }
    ...
    public void removeTwoLocal() throws TestFailedException {
        ...
        try {
            ...
            throw new TestFailedException("Expecting jakarta.ejb.RemoveException, but got none");
        } catch (RemoveException e) {
            // TLogger.log("Got expected exception " + e.toString());
        } catch (CreateException e) {
            throw new TestFailedException("Expecting jakarta.ejb.RemoveException, but got", e);
        }
        try {
            bean.remove();
        } catch (RemoveException e) {
        ...
        try {
            bean.remove();
            throw new TestFailedException("Expecting jakarta.ejb.NoSuchObjectLocalException, " + "but got none.");
        } catch (NoSuchObjectLocalException e) {
            // TLogger.log("Got expected exception: " + e.toString());
        } catch (RemoveException e) {
            throw new TestFailedException("Expecting jakarta.ejb.NoSuchObjectLocalException, but got", e);
        }
    }
}

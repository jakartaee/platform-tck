...
public class Client extends ClientBase {
    ...
    public void removeNotRetainBeanOverloadedRemoveMethod() throws Fault {
        try {
            ...
            TLogger.log("Got expected exception, and bean should not be removed" + " despite the exception" + e);
        }
        try {
            removeNotRetainBean.hi();
            TLogger.log("Ok, the bean is still there as expected.");
        } catch (NoSuchEJBException e) {
            throw new Fault("The bean was unexpectedly removed, and hi() results " + "in this exception: ", e);
        } finally {
            try {

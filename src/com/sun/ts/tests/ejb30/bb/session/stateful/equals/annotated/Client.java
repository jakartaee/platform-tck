...
public class Client extends ClientBase {
    ...
    public void otherNotEquals() throws Fault {
        try {
            ...
            Comparator.compare(shoppingCart, shoppingCartOther, false, CLIENT_LOG_IF_OK);
        } catch (TestFailedException e) {
            throw new Fault(e);
        }
    }
    ...
    public void otherNotEqualsLookup() throws Fault {
        try {
            ...
            Comparator.compare(shoppingCart, shoppingCartOther, shoppingCart, false, CLIENT_LOG_IF_OK);
        } catch (TestFailedException e) {
            throw new Fault(e);
        } catch (NamingException e) {
            throw new Fault(e);

...
public class Client extends ClientBase {
    ...
    public void otherEquals() throws Fault {
        try {
            ...
            Comparator.compare(shoppingCart, shoppingCartOther, true, CLIENT_LOG_IF_OK);
        } catch (TestFailedException e) {
            throw new Fault(e);
        }
    }
    ...
    public void otherEqualsLookup() throws Fault {
        try {
            ...
            Comparator.compare(shoppingCart, shoppingCartOther, shoppingCart, true, CLIENT_LOG_IF_OK);
        } catch (TestFailedException e) {
            throw new Fault(e);
        } catch (NamingException e) {
            throw new Fault(e);
     ...
     * @assertion_ids:
     *
     * @test_Strategy: cart1.equals(shoppingCart) should return false for stateless beans.
     */

...
public class Client extends ClientBase {
    ...
    public void beanClassLevel() throws InterruptedException {
        List<Exception> exceptionList = concurrentPing(getBeanClassLevelAccessTimeoutBeanRemote(), getTestName());
    ...
    public void beanSuperClassLevel() throws InterruptedException {
        List<Exception> exceptionList = concurrentPing(getAnnotatedSuperClassAccessTimeoutBeanRemote(), getTestName());
        checkConcurrentAccessTimeoutResult(exceptionList, 1, 1);
    }
    ...
    public void beanClassMethodLevel() throws InterruptedException {
        List<Exception> exceptionList = concurrentPing(getBeanClassMethodLevelAccessTimeoutBeanRemote(), getTestName());
        checkConcurrentAccessTimeoutResult(exceptionList, 1, 1);
    }

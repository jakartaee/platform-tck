...
public class Client extends ClientBase {
    ...
    private static InterceptorInstanceIF bean2;
    ...
    public void interceptorInstance2() throws CalculatorException {
        ...
        for (int i = 0; i < calls; i++) {
            beans[i] = (InterceptorInstanceIF) ServiceLocator.lookupByShortNameNoTry(shortLookupName);
    ...
    private void verifyPostConstructAndAroundInvokeCalls(final int[] expected, final int[] actual)
            throws CalculatorException {
        if (Arrays.equals(expected, actual)) {
            TLogger.log("Verified interceptor lifecycle: PostConstruct and AroundInvoke methods are called "

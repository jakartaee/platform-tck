...
public abstract class TestBeanBase implements TestBeanIF {
    ...
    public void passByReferenceTest(String[] args, String refName, Class klass) throws TestFailedException {
        ...
        if (expected.equals(actual)) {
            ...
            throw new TestFailedException("Expect '" + expected + "', but actual '" + actual + "'");
        }
    }
    ...
    protected CommonIF lookup(String refName, Class klass) throws TestFailedException {
        CommonIF bean = null;
        if (refName != null) {
        ...
        try {
            ...
            throw new TestFailedException(
                    "Testbean Failed to look up bean with name '" + refName + " and type '" + klass + "'", e);
        }
        return bean;
    }

...
public abstract class ClientBase extends EETest implements Constants {
    ...
    protected abstract TestBeanIF getBean();
    ...
    public void runtimeExceptionTest1() throws Fault {
        try {
            getBean().runtimeExceptionTest(localStatelessRefName, localStatelessClass);
        } catch (Exception e) {
            throw new Fault("Test Failed!", e);
        }
    }
    ...
    public void exceptionTest2() throws Fault {
        try {
            getBean().exceptionTest(defaultLocalStatelessRefName, defaultLocalStatelessClass);
        } catch (Exception e) {
            throw new Fault("Test Failed!", e);
        }
    }
    ...
    public void runtimeExceptionTest2() throws Fault {
        try {
            getBean().runtimeExceptionTest(defaultLocalStatelessRefName, defaultLocalStatelessClass);
        } catch (Exception e) {
            throw new Fault("Test Failed!", e);
        }
    }
    ...
    public void exceptionTest4() throws Fault {
        try {
            getBean().exceptionTest(defaultLocalStatefulRefName, defaultLocalStatefulClass);
        } catch (Exception e) {
            throw new Fault("Test Failed!", e);
        }
    }
    ...
    public void runtimeExceptionTest4() throws Fault {
        try {
            getBean().runtimeExceptionTest(defaultLocalStatefulRefName, defaultLocalStatefulClass);
        } catch (Exception e) {
            throw new Fault("Test Failed!", e);
        }
    }
    ...
    public void runtimeExceptionTest5() throws Fault {
        try {
            getBean().runtimeExceptionTest(localStateless2RefName, localStateless2Class);
        } catch (Exception e) {
            throw new Fault("Test Failed!", e);
        }
    }

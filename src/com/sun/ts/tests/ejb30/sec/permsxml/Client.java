...
public class Client extends EETest {
    ...
    public void ValidateCustomPermInACC() throws Fault {
        ...
        try {
            ...
            throw new Fault("FAILURE:  CTSPermission1_name perm missing, throwing AccessControlException.", ex);
        } catch (Exception ex) {
            throw new Fault("FAILURE:  ValidateCustomPermInACC(), throwing unexpected Exception.", ex);
        }
    ...
    public void ValidateLocalGrantForCustomPermInACC() throws Fault {
        ...
        try {
            ...
            logMsg("CTSPermission2_name permission property threw unexpected AccessControlException.");
            throw new Fault(
                    "FAILURE:  validateLocalGrantForCustomPerm() did threw unexpected AccessControlException.", ex);
        } catch (Exception ex) {
            throw new Fault("FAILURE:  ValidateLocalGrantForCustomPermInACC threw unexpected exception.", ex);
        }
    ...
    public void ValidateRestrictedLocalPermInACC() throws Fault {
        ...
        try {
            ...
            try {
                ...
                // should get here
                logMsg("ValidateRestrictedLocalPermInACC() has grant for read of TestPropertyPerm");
            } catch (AccessControlException ex) {
                // should not get here.
                throw new Fault(
    ...
    public void ValidateMissingPermFailsInACC() throws Fault {
        ...
        try {
            ...
            throw new Fault("FAILURE:  ValidateMissingPermFailsInACC threw unexpected exception.", ex);
        }
    ...
    public void ValidateRequiredPermSetInACC() throws Fault {
        ...
        try {
            ...
            logTrace("ValidateRequiredPermSetInACC():  valid perm for: " + rtperm.toString());

            RuntimePermission rtperm2 = new RuntimePermission("queuePrintJob");
            doCheckPermission(rtperm2);
            logTrace("ValidateRequiredPermSetInACC():  valid perm for: " + rtperm2.toString());

            SocketPermission socperm = new SocketPermission("*", "connect");
            doCheckPermission(socperm);
            logTrace("ValidateRequiredPermSetInACC():  valid perm for: " + socperm.toString());

            FilePermission fperm = new FilePermission("*", "read");
            doCheckPermission(fperm);
            logTrace("ValidateRequiredPermSetInACC():  valid perm for: " + fperm.toString());

            PropertyPermission pperm = new PropertyPermission("*", "read");
            doCheckPermission(pperm);
            logTrace("ValidateRequiredPermSetInACC():  valid perm for: " + pperm.toString());

        } catch (AccessControlException ex) {
            throw new Fault("FAILURE:  validateRequiredPermSet had perm missing, throwing AccessControlException.", ex);

        } catch (Exception ex) {
            throw new Fault("FAILURE:  validateRequiredPermSet had unexpected Exception.", ex);
        }
    ...
    public void ValidateLocalPermsInvalidNameInACC() throws Fault {
        ...
        try {
            ...
            try {
                ...
                // should get here.
                logMsg("SUCCESS:  ValidateLocalPermsInvalidNameInACC() threw expected AccessControlException");
            } catch (NullPointerException ex) {
                throw new Fault("FAILURE:  ValidateLocalPermsInvalidNameInACC() threw NullPointerException");
            }
            ...
            try {
                ...
                // should get here
                logMsg("CTSPermission_second_name permission property granted AccessControlException.");
            } catch (AccessControlException ex) {
                // should NOT get here
                throw new Fault("FAILURE:  ValidateLocalPermsInvalidNameInACC() threw unexpected exception.");
            } catch (Exception ex) {
                // should NOT get here
                ex.printStackTrace();
                throw new Fault("FAILURE:  ValidateLocalPermsInvalidNameInACC had unexpeted exception.");
            }

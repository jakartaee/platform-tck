...
public class Client extends com.sun.ts.tests.ejb30.bb.mdb.dest.common.ClientBase {
     ...
     *
     * @test_Strategy: use transaction attribute REQUIRED annotation at type level The transaction is rolled back in bean's
     * onMessage, so the client should not get any response from the bean. Note that after the test run, this message should
     * still be in the queue, because message receipt is part of the transaction that has been rolled back.
     */

...
public abstract class TxBeanBase0 {
    @Resource
    ...
    protected String illegalGetSetRollbackOnly(TransactionAttributeType attr) throws TestFailedException {
        String result = "";
        try {
            getSessionContext().getRollbackOnly();
            result += "Calling EJBContext.getRollbackOnly inside a method of tx attr " + attr
        ...
        try {
            ...
            result += "Calling EJBContext.setRollbackOnly inside a method of tx attr " + attr
                    + " should have caused IllegalStateException";
            throw new TestFailedException(result);
        } catch (IllegalStateException expected) {
    ...
    public String systemExceptionTest() throws TestFailedException {
        throw new AssertionError("This AssertionError must cause the tx to be marked for rollback.");
    }
}

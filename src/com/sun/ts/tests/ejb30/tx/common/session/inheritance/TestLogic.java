...
public class TestLogic {
    ...
    public static void aBeanRemote(StringBuilder reason) throws TestFailedException {
        boolean pass1 = false;
        boolean pass2 = false;
        TxRemoteIF beanRemote = (TxRemoteIF) ServiceLocator.lookupByShortNameNoTry("abeanRemote");
        ...
        try {
            ...
            pass2 = true;
            reason.append(" Got expected ").append(e.toString()).append(" when invoking ");
    ...
    public static void aBeanLocal(StringBuilder reason, TxLocalIF... b) throws TestFailedException {
        boolean pass1 = false;
        boolean pass2 = false;
        ...
        if (beanLocal == null) {
            beanLocal = (TxLocalIF) ServiceLocator.lookupByShortNameNoTry("abeanLocal");
        }
    ...
    public static void bBeanRemote(StringBuilder reason) throws TestFailedException {
        boolean pass1 = false;
        boolean pass2 = false;
        TxRemoteIF beanRemote = (TxRemoteIF) ServiceLocator.lookupByShortNameNoTry("bbeanRemote");
        UserTransaction ut = (UserTransaction) ServiceLocator.lookupNoTry("java:comp/UserTransaction");
    ...
    public static void bBeanLocal(StringBuilder reason) throws TestFailedException {
        boolean pass1 = false;
        boolean pass2 = false;
        TxLocalIF beanlocal = (TxLocalIF) ServiceLocator.lookupByShortNameNoTry("bbeanLocal");
        UserTransaction ut = (UserTransaction) ServiceLocator.lookupNoTry("java:comp/UserTransaction");
    ...
    public static void cBeanRemote(StringBuilder reason) throws TestFailedException {
        boolean pass1 = false;
        boolean pass2 = false;
        TxRemoteIF beanRemote = (TxRemoteIF) ServiceLocator.lookupByShortNameNoTry("cbeanRemote");
        UserTransaction ut = (UserTransaction) ServiceLocator.lookupNoTry("java:comp/UserTransaction");
    ...
    public static void cBeanLocal(StringBuilder reason) throws TestFailedException {
        boolean pass1 = false;
        boolean pass2 = false;
        TxLocalIF beanlocal = (TxLocalIF) ServiceLocator.lookupByShortNameNoTry("cbeanLocal");
        UserTransaction ut = (UserTransaction) ServiceLocator.lookupNoTry("java:comp/UserTransaction");
    ...
    public static void dBeanRemote(StringBuilder reason) throws TestFailedException {
        boolean pass1 = false;
        boolean pass2 = false;
        TxRemoteIF beanRemote = (TxRemoteIF) ServiceLocator.lookupByShortNameNoTry("dbeanRemote");
        UserTransaction ut = (UserTransaction) ServiceLocator.lookupNoTry("java:comp/UserTransaction");
    ...
    public static void dBeanLocal(StringBuilder reason) throws TestFailedException {
        boolean pass1 = false;
        boolean pass2 = false;
        TxLocalIF beanLocal = (TxLocalIF) ServiceLocator.lookupByShortNameNoTry("dbeanLocal");
        UserTransaction ut = (UserTransaction) ServiceLocator.lookupNoTry("java:comp/UserTransaction");
    ...
    public static void eBeanRemote(StringBuilder reason) throws TestFailedException {
        boolean pass1 = false;
        boolean pass2 = false;
        TxRemoteIF beanRemote = (TxRemoteIF) ServiceLocator.lookupByShortNameNoTry("ebeanRemote");
        UserTransaction ut = (UserTransaction) ServiceLocator.lookupNoTry("java:comp/UserTransaction");
    ...
    public static void eBeanLocal(StringBuilder reason) throws TestFailedException {
        boolean pass1 = false;
        boolean pass2 = false;
        TxLocalIF beanLocal = (TxLocalIF) ServiceLocator.lookupByShortNameNoTry("ebeanLocal");
        UserTransaction ut = (UserTransaction) ServiceLocator.lookupNoTry("java:comp/UserTransaction");
    ...
    public static void overloadedMethodsTxLocal(StringBuilder reason, TxLocalIF... b) throws TestFailedException {
        boolean pass1 = false;
        boolean pass2 = false;
        boolean pass3 = false;
        ...
        if (beanLocal == null) {
            beanLocal = (TxLocalIF) ServiceLocator.lookupByShortNameNoTry("fbeanLocal");
        }

        Helper.getLogger().info("About to invoke fbeanLocal.foo(), which has tx attribute Mandatory.");
        try {
            String result = beanLocal.foo();
            reason.append("Expecting jakarta.ejb.EJBTransactionRequiredException");
            reason.append(", but got no exception.");
        ...
        Helper.getLogger().info("About to invoke fbeanLocal.foo(String), which has tx attribute Required.");
        try {
            ...
            reason.append(" Got unexpected ").append(e.toString()).append(" when invoking ");
            reason.append(beanLocal).append(" foo(String)");
        }

        Helper.getLogger().info("About to invoke fbeanLocal.foo(String, String), which has tx attribute Required.");
        try {
    ...
    public static void overloadedMethodsTxRemote(StringBuilder reason) throws TestFailedException {
        boolean pass1 = false;
        boolean pass2 = false;
        boolean pass3 = false;
        TxRemoteIF beanRemote = (TxRemoteIF) ServiceLocator.lookupByShortNameNoTry("fbeanRemote");
        Helper.getLogger().info("About to invoke fbeanRemote.foo(), which has tx attribute Mandatory.");
        try {
            String result = beanRemote.foo();
            reason.append("Expecting jakarta.ejb.EJBTransactionRequiredException");
            reason.append(", but got no exception.");
        ...
        Helper.getLogger().info("About to invoke fbeanRemote.foo(String), which has tx attribute Required.");
        try {
        ...
        Helper.getLogger().info("About to invoke fbeanRemote.foo(String, String), which has tx attribute Required.");
        try {

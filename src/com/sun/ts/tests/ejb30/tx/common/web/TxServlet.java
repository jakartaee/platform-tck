...
public class TxServlet extends HttpServlet {
    ...
    private void servletRemoteCmtNever(HttpServletRequest req, HttpServletResponse resp)
    ...
    private void servletLocalCmtNever(HttpServletRequest req, HttpServletResponse resp)
            throws ServletException, IOException {
        PrintWriter pw = resp.getWriter();
        try {
            localBean.never();
    ...
    private void interServletTxPropagation(HttpServletRequest req, HttpServletResponse resp)
            throws ServletException, IOException {
        ...
        try {
            ...
            if (status == Status.STATUS_ACTIVE) {
                ...
                pw.println(Data.FAILED + ", tx is not active in the called servlet. " + "tx status is " + status);
            }
    ...
    private void interServletTxPropagation2(HttpServletRequest req, HttpServletResponse resp)
            throws ServletException, IOException {
        interServletTxPropagation(req, resp);
        try {
            ut.rollback();

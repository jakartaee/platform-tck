...
public class TestServlet extends HttpTCKServlet {
    ...
    public void formatLocal(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        format0(varargsLocalBean, request, response);
    }

    public void formatRemote(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
    ...
    public void addRemote(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        add0(varargsRemoteBean, request, response);
    }

    public void listDogsLocal(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        listDogs0(varargsLocalBean, request, response);
    }

    public void listDogsRemote(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        listDogs0(varargsRemoteBean, request, response);
    }

    private void format0(VarargsCommonIF varargsBean, HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
    ...
    private void listDogs0(VarargsCommonIF varargsBean, HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        PrintWriter pw = response.getWriter();
    ...
    private void add0(VarargsCommonIF varargsBean, HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        PrintWriter pw = response.getWriter();
        int a = 1, b = 2, c = 3;
        int expected = a + b + c;
    ...
    private boolean verify(Object expected, Object result, PrintWriter pw, boolean printPass) throws IOException {
        ...
        pw.println(Data.FAILED + " Expecting " + expected + ", but actual " + result);
        return false;
    }
}

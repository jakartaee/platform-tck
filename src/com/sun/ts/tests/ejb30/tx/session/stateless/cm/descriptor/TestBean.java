...
public class TestBean extends TestBeanBase implements TestIF {
    ...
    public void sameMethodDifferentTxAttr() throws TestFailedException {
        ...
        try {
            ...
            throw new TestFailedException("Expecting jakarta.ejb.EJBTransactionRequiredException, but got none");
        } catch (EJBTransactionRequiredException e) {
            Helper.getLogger().info("Got expected jakarta.ejb.EJBTransactionRequiredException");
        }
    }
    ...
    protected void mandatoryTestOverloaded(TxIF b) throws TestFailedException {
        ...
        try {
            ...
            reason += this + " Expecting jakarta.ejb.EJBTransactionRequiredException, but got none";
            throw new TestFailedException(reason);
        } catch (EJBTransactionRequiredException e) {
            reason += this + " Got expected jakarta.ejb.EJBTransactionRequiredException";
    ...
    protected void neverTestOverloaded(TxIF b) throws TestFailedException {
        ...
        try {
            ...
            throw new TestFailedException("Expecting jakarta.ejb.EJBException, but got " + ex);

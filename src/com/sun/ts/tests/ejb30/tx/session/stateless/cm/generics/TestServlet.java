...
public class TestServlet extends HttpTCKServlet {
    ...
    public void genericsTxMandatoryRemote(HttpServletRequest request, HttpServletResponse response)
    ...
    public void rolesAllowedRemoteIntGreet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        PrintWriter pw = response.getWriter();
        boolean pass = false;
        StringBuilder reason = new StringBuilder();
        try {
            ...
            reason.append(remoteIntGreetingBean).append(" rolesAllowed() method.  Actually Got " + result);
    ...
    public void rolesAllowedLocalIntGreet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        PrintWriter pw = response.getWriter();
        boolean pass = false;
        StringBuilder reason = new StringBuilder();
        try {
            ...
            reason.append("Failed to get expected EJBException when invoking ");
            reason.append(localIntGreetingBean).append(" rolesAllowed() method.  Actually Got " + result);
        } catch (EJBException e) {
            Helper.getLogger().info("TestServlet got expected " + e);
            pass = true;
            reason.append(" Got expected EJBException when invoking ");
    ...
    public void rolesAllowedNoArgRemoteIntGreet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        PrintWriter pw = response.getWriter();
        boolean pass = false;
        StringBuilder reason = new StringBuilder();
        try {
            ...
            reason.append("Failed to get expected EJBException when invoking ");
            reason.append(remoteIntGreetingBean).append(" rolesAllowedNoArg() method.  Actually Got " + result);
        } catch (EJBException e) {
            Helper.getLogger().info("TestServlet got expected " + e);
            pass = true;
            reason.append(" Got expected EJBException when invoking ");
            reason.append(remoteIntGreetingBean).append(" rolesAllowedNoArg() method");
        }
    ...
    public void rolesAllowedNoArgLocalIntGreet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        PrintWriter pw = response.getWriter();
        boolean pass = false;
        StringBuilder reason = new StringBuilder();
        try {
            ...
            reason.append("Failed to get expected EJBException when invoking ");
            reason.append(localIntGreetingBean).append(" rolesAllowedNoArg() method.  Actually Got " + result);
        } catch (EJBException e) {
            Helper.getLogger().info("TestServlet got expected " + e);
            pass = true;
            reason.append(" Got expected EJBException when invoking ");
    ...
    public void genericsTxMandatoryLocal(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        PrintWriter pw = response.getWriter();
        boolean pass1 = false;
        boolean pass2 = false;
    ...
    public void genericLocalBusinessInterfaceTxMandatory(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        PrintWriter pw = response.getWriter();
        boolean pass1 = false;
        StringBuilder reason = new StringBuilder();
        ...
        try {
            ...
            Helper.getLogger()
                    .info("TestServlet about to invoke localDateGreetingBean.greeting(date): " + date.toString());
    ...
    public void rolesAllowedLocalDateGreeting(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        PrintWriter pw = response.getWriter();
        boolean pass1 = false;
        StringBuilder reason = new StringBuilder();
        try {
            java.util.Date date = new java.util.Date();
            Helper.getLogger()
                    .info("TestServlet about to invoke localDateGreetingBean.rolesAllowed(date): " + date.toString());
            java.util.Date rolesAllowedResult = localDateGreetingBean.rolesAllowed(date);
            ...
            pass1 = true;
            reason.append(" Got expected EJBException when invoking .");
            reason.append(localDateGreetingBean).append(" rolesAllowedResult() method");
        }
        pw.println(pass1 ? Data.PASSED : Data.FAILED);
        pw.println(reason.toString());
    }

    public void rolesAllowedNoArgLocalDateGreeting(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        PrintWriter pw = response.getWriter();
        boolean pass1 = false;
        StringBuilder reason = new StringBuilder();
        try {
            ...
            java.util.Date rolesAllowedNoArgResult = localDateGreetingBean.rolesAllowedNoArg();
            reason.append("Failed to get expected jakarta.ejb.EJBException when invoking .");
            reason.append(localDateGreetingBean).append(" rolesAllowedNoArg() method");
            reason.append(" It incorrectly returned ").append(rolesAllowedNoArgResult.toString());
        } catch (EJBException e) {
            Helper.getLogger().info("TestServlet got expected " + e);
            pass1 = true;
            reason.append(" Got expected EJBException when invoking .");
            reason.append(localDateGreetingBean).append(" rolesAllowedNoArgResult() method");
        }
        pw.println(pass1 ? Data.PASSED : Data.FAILED);
        pw.println(reason.toString());
    }

    public void parameterizedParamLocalTxMandatory(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        PrintWriter pw = response.getWriter();
        boolean pass1 = false;
        StringBuilder reason = new StringBuilder();
        ...
        try {
            ...
            Helper.getLogger()
                    .info("TestServlet about to invoke localParameterizedBean.parameterizedParam(List<String>): " + ls);
            localParameterizedBean.parameterizedParam(ls);
            reason.append("Failed to get expected EJBTransactionRequiredException when invoking .");
            reason.append(localParameterizedBean).append(" parameterizedParam(List<String>) method");
    ...
    public void parameterizedReturnLocalTxMandatory(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        PrintWriter pw = response.getWriter();
        boolean pass1 = false;
        StringBuilder reason = new StringBuilder();
        ...
        try {
            int i = 2;
            Helper.getLogger()
                    .info("TestServlet about to invoke localParameterizedBean.parameterizedReturn(int): " + i);
            List<String> result = localParameterizedBean.parameterizedReturn(i);
            reason.append("Failed to get expected EJBTransactionRequiredException when invoking .");
            reason.append(localParameterizedBean).append(" parameterizedReturn(i) method");
            reason.append(" It incorrectly returned: " + result);
        } catch (EJBTransactionRequiredException e) {
            Helper.getLogger().info("TestServlet got expected " + e);
            pass1 = true;
            reason.append(" Got expected EJBTransactionRequiredException when invoking .");
            reason.append(localParameterizedBean).append(" parameterizedReturn(int) method");
        } catch (jakarta.ejb.TransactionRequiredLocalException e) {
            Helper.getLogger().info("TestServlet got unexpected " + e);
            reason.append(" Got unexpected exception: ");
            reason.append(e.toString());
    ...
    public void parameterizedParamRemoteTxMandatory(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        PrintWriter pw = response.getWriter();
        boolean pass1 = false;
        StringBuilder reason = new StringBuilder();
        ...
        try {
            ...
            Helper.getLogger()
                    .info("TestServlet about to invoke localParameterizedRemoteBean.parameterizedParam(List<String>): "
                            + ls);
            remoteParameterizedBean.parameterizedParam(ls);
            reason.append("Failed to get expected EJBTransactionRequiredException when invoking .");
            reason.append(remoteParameterizedBean).append(" parameterizedParam(List<String>) method");
            reason.append(" It incorrectly returned void.");
        } catch (EJBTransactionRequiredException e) {
            Helper.getLogger().info("TestServlet got expected " + e);
            pass1 = true;
    ...
    public void parameterizedReturnRemoteTxMandatory(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        PrintWriter pw = response.getWriter();
        boolean pass1 = false;
        StringBuilder reason = new StringBuilder();
        ...
        try {
            int i = 2;
            Helper.getLogger()
                    .info("TestServlet about to invoke localParameterizedRemoteBean.parameterizedReturn(int): " + i);
            List<String> result = remoteParameterizedBean.parameterizedReturn(i);
            reason.append("Failed to get expected EJBTransactionRequiredException when invoking .");
            reason.append(remoteParameterizedBean).append(" parameterizedReturn(i) method");
            reason.append(" It incorrectly returned: " + result);
        } catch (EJBTransactionRequiredException e) {
            Helper.getLogger().info("TestServlet got expected " + e);
            pass1 = true;
            reason.append(" Got expected EJBTransactionRequiredException when invoking .");
            reason.append(remoteParameterizedBean).append(" parameterizedReturn(int) method");
        }
        pw.println(pass1 ? Data.PASSED : Data.FAILED);
        pw.println(reason.toString());
    }

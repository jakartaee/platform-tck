...
public class AppResTest {
    ...
    public static final void verifyPersistenceContext(StringBuilder sb) {
        EntityManager em = (EntityManager) lookupNoTry("java:app/env/entityManager");
        assertNotEquals(null, null, em, sb);
    }

    public static final void verifyPersistenceUnit(StringBuilder sb) {
        EntityManagerFactory pu = (EntityManagerFactory) lookupNoTry("java:app/env/persistenceUnit");
    ...
    public static final void verifyValidatorAndFactory(StringBuilder sb) {
        ...
        ValidatorFactory vf = (ValidatorFactory) lookupNoTry("java:comp/ValidatorFactory");
        ...
        assertNotEquals("Check ValidatorFactory java:comp/ValidatorFactory", null, vf, sb);
        ...
        assertNotEquals("Check Validator from factory", null, v2, sb);
        assertNotEquals("Check ValidatorFactory java:app/env/validatorFactory", null, vf, sb);
    }
    ...
    public static void beanPostConstruct(
            String myString,
            StringBuilder postConstructRecords,
            boolean namingContextLookup,
        ...
        try {
            ...
            if (namingContextLookup) {
                ...
                if (ejbContextLookup) {
                    SessionContext sctx = (SessionContext) lookupNoTry("java:app/env/sctx");

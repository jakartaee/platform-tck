...
public class Client extends ClientBase {
    ...
    public void secondLevelJar() throws TestFailedException {
        (new GetResourceTest())
                .getResourceWithClass(getClass(), SECOND_LEVEL_JAR_RESOURCE_NAME, SECOND_LEVEL_JAR_RESOURCE_CONTENT);
    }
    ...
    public void secondLevelJarEJB() throws TestFailedException {
        String result = remoteAssemblyBean.getResourceContent(SECOND_LEVEL_JAR_RESOURCE_NAME);
    ...
    public void secondLevelDir() throws TestFailedException {
        (new GetResourceTest())
                .getResourceWithClass(getClass(), SECOND_LEVEL_DIR_RESOURCE_NAME, SECOND_LEVEL_DIR_RESOURCE_CONTENT);
    }
    ...
    public void secondLevelDirEJB() throws TestFailedException {
        String result = remoteAssemblyBean.getResourceContent(SECOND_LEVEL_DIR_RESOURCE_NAME);

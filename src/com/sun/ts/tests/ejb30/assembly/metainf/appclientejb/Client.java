...
public class Client extends ClientBase {
    ...
    public void dirUsedInClassPath() {
        ...
        TLogger.log("CalculatorException.class is available in classpath.  Instance:" + e);
    }
    ...
    public void dirUsedInClassPathEJB() {
        ...
        TLogger.log("CalculatorException.class is available in EJB classpath.  Instance:" + e);
    }
    ...
    public void concurrentLookupHelloBean() throws TestFailedException {
        for (int i = 0; i < 2; i++) {
            String result = (new ConcurrentLookup()).concurrentLookup("helloBean2", null);
            TLogger.log(result);
        }
    }
    ...
    public void concurrentLookupDataSource() throws TestFailedException {
        for (int i = 0; i < 2; i++) {
            String result = (new ConcurrentLookup()).concurrentLookup("dataSource", null);
            TLogger.log(result);
        }
    }

...
public class UserCommitClient extends ServiceEETest implements Serializable {
    ...
    public static void main(String args[]) {
        ...
        com.sun.javatest.Status s = userCommitClientInst.run(args, System.out, System.err);
        s.exit();
    } // End of main
    ...
    public void testUserCommit001() throws Fault {
        ...
        try {
            ...
            if (userTransaction.getStatus() == Status.STATUS_NO_TRANSACTION) {
                ...
                throw new Fault("Failed to return the status" + " STATUS_NO_TRANSACTION");
            }
            ...
            throw new Fault("IllegalStateException was not" + " thrown as Expected", system);
        } catch (Exception exception) {
            logErr("Exception " + exception.toString() + " was caught");
            throw new Fault("IllegalStateException was not" + " thrown as Expected", exception);
        }
    ...
    public void testUserCommit002() throws Fault {
        ...
        try {
            ...
            throw new Fault("UnExpected Exception was caught:" + " Failed", heuristicMixed);
        } catch (HeuristicRollbackException heuristicRollback) {
            logErr("Exception " + heuristicRollback.toString() + " was caught");
            throw new Fault("UnExpected Exception was caught:" + " Failed", heuristicRollback);
            ...
            throw new Fault("UnExpected Exception was caught:" + " Failed", illegalState);
        } catch (SystemException system) {
            logErr("Exception " + system.toString() + " was caught");
            throw new Fault("UnExpected Exception was caught:" + " Failed", system);
        } catch (Exception exception) {
            logErr("Exception " + exception.toString() + " was caught");
            throw new Fault("UnExpected Exception was caught:" + " Failed", exception);
        }
    ...
    public void testUserCommit005() throws Fault {
        ...
        } catch (IllegalStateException state) // if rolled back
        {
            ...
            logErr("Exception " + system.toString() + " was caught");
            throw new Fault("RollbackException was not" + " thrown as Expected", system);
        } catch (Exception exception) {
            logErr("Exception " + exception.toString() + " was caught");
            throw new Fault("RollbackException was not" + " thrown as Expected", exception);
        }

...
public class UserBeginClient extends ServiceEETest implements Serializable {
    ...
    public static void main(String args[]) {
        ...
        com.sun.javatest.Status s = userBeginClientInst.run(args, System.out, System.err);
        s.exit();
    } // End of main
    ...
    public void testUserBegin002() throws Fault {
        ...
        try {
            ...
            logErr("Exception " + system.toString() + " was caught");
            throw new Fault("NotSupportedException was not thrown" + " as Expected", system);
        } catch (Exception exception) {
            logErr("Exception " + exception.toString() + " was caught");
            throw new Fault("NotSupportedException was not thrown" + " as Expected", exception);
        }

...
public class UserSetRollbackOnlyClient extends ServiceEETest implements Serializable {
    ...
    public static void main(String args[]) {
        ...
        com.sun.javatest.Status s = userSetRollbackOnlyClientInst.run(args, System.out, System.err);
        s.exit();
    } // End of main
    ...
    public void testUserSetRollbackOnly001() throws Fault {
        ...
        try {
            ...
            throw new Fault("IllegalStateException not thrown as" + " Expected", system);
        } catch (Exception exception) {
            logErr("Exception " + exception.toString() + " was caught");
            throw new Fault("IllegalStateException not thrown as" + " Expected", exception);
        }
    ...
    public void testUserSetRollbackOnly002() throws Fault {
        ...
        try {
            ...
            // other acceptable status conditions
                ...
                throw new Fault("Failed to return the status" + " STATUS_MARKED_ROLLBACK");
            }
        } catch (IllegalStateException illegalState) {

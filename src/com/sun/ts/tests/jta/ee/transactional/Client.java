...
public class Client extends EJBLiteClientBase {
    ...
    public void txTypeMandatory_withoutTransaction() throws Fault {
        ...
        try {
            ...
            if (te.getCause() instanceof TransactionRequiredException) {
                ...
                throw new Fault("Received TransactionalException without nested TransactionRequiredExecption");
            }
    ...
    public void txTypeSupports_withoutTransaction() throws Fault {
        ...
        Helper.assertEquals(
                null,
                "txTypeSupports run without active transaction",
                one.txTypeSupportsWithoutTransaction(),
                callRecords);
        // Helper.getLogger().info(callRecords.toString());
        appendReason(Helper.compareResult(
                "txTypeSupports run without active transaction", one.txTypeSupportsWithoutTransaction()));
    }
    ...
    public void txTypeNotSupported_withoutTransaction() throws Fault {
        ...
        Helper.assertEquals(
                null, "txTypeNotSupported run without active transaction", one.txTypeNotSupported(), callRecords);
        // Helper.getLogger().info(callRecords.toString());
        appendReason(
    ...
    public void txTypeNotSupported_withTransaction() throws Fault {
        try {
            ...
            // Helper.getLogger().info(callRecords.toString());
            appendReason(Helper.compareResult(
                    "txTypeNotSupported run without active transaction", one.txTypeNotSupported()));
            ut.commit();
        } catch (Exception e) {
            Helper.getLogger().log(Level.INFO, null, e);
            throw new Fault("txTypeSupports failed");
    ...
    public void txTypeNever_withTransaction() throws Fault {
        ...
        try {
            ...
            if (te.getCause() instanceof InvalidTransactionException) {
                ...
                throw new Fault("Received expected TransactionalException without nested InvalidTransactionException");
            }
    ...
    public void rollbackOnException() throws Fault {
        ...
        try {
            ...
            if (ut.getStatus() == Status.STATUS_ACTIVE) {
                ...
                Helper.getLogger()
                        .info("Transaction Status value for Status.STATUS_MARKED_ROLLBACK = "
    ...
    private void verifyInterceptorPriority(List<Integer> priorityList, String txType) throws Fault {
        String result = null;
        if (priorityList.contains(Interceptor.Priority.PLATFORM_BEFORE + 200)) {
            Helper.getLogger()
                    .log(Level.INFO, "Transactional Interceptor for " + txType + " has right interceptor priority");

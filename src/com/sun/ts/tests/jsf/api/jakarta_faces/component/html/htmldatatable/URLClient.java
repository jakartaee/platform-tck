 ...
 * $Id$
 */
package com.sun.ts.tests.jsf.api.jakarta_faces.component.html.htmldatatable;
...
public class URLClient
    extends com.sun.ts.tests.jsf.api.jakarta_faces.component.uidata.URLClient {

  private static final String CONTEXT_ROOT = "/jsf_chtml_datatab_web";
   ...
   *                 JSF:JAVADOC:643; JSF:JAVADOC:617; JSF:JAVADOC:643
   ...
   * @assertion_ids: JSF:JAVADOC:554; JSF:JAVADOC:649
   ...
   * @assertion_ids: JSF:JAVADOC:539; JSF:JAVADOC:649
   ...
   * @assertion_ids: JSF:JAVADOC:540; JSF:JAVADOC:649
   * @test_Strategy: Assert that a call to popComponentToEL removes "this"
   *                 component as being the current component and that the
   *                 previous UIComponent is set to the current component being
   *                 processed.
   ...
   */
  public void uiDataGetRowCountTest() throws EETest.Fault {
    super.uiDataGetRowCountTest();
  }

  /**
   * @testName: uiDataGetRowDataIAETest
   * @assertion_ids: JSF:JAVADOC:668
   ...
   */
  public void uiDataGetRowDataIAETest() throws EETest.Fault {
    super.uiDataGetRowDataIAETest();
  }

  /**
   * @testName: uiDataGetRowDataTest
   * @assertion_ids: JSF:JAVADOC:666
   * @test_Strategy: Verify the following: - getRowData() returns the expected
   *                 object when specifying various row index values
   */
  public void uiDataGetRowDataTest() throws EETest.Fault {
    super.uiDataGetRowDataTest();
  }

  /**
   * @testName: uiDataGetSetFirstTest
   * @assertion_ids: JSF:JAVADOC:661; JSF:JAVADOC:688
   ...
   */
  public void uiDataGetSetFirstTest() throws EETest.Fault {
    super.uiDataGetSetFirstTest();
  }

  /**
   * @testName: uiDataGetSetRowIndexTest
   * @assertion_ids: JSF:JAVADOC:694
   ...
   *                 setRowIndex()
   */
  public void uiDataGetSetRowIndexTest() throws EETest.Fault {
    super.uiDataGetSetRowIndexTest();
  }

  /**
   * @testName: uiDataGetSetRowsTest
   * @assertion_ids: JSF:JAVADOC:697; JSF:JAVADOC:671
   * @test_Strategy: Verify the following: - getRows() returns the value as
   *                 specified by setRows()
   */
  public void uiDataGetSetRowsTest() throws EETest.Fault {
    super.uiDataGetSetRowsTest();
  }

  /**
   * @testName: uiDataGetSetVarTest
   * @assertion_ids: JSF:JAVADOC:673; JSF:JAVADOC:706
   * @test_Strategy: Verify the following: - getVar() returns the value as
   *                 specified by setVar()
   */
  public void uiDataGetSetVarTest() throws EETest.Fault {
    super.uiDataGetSetVarTest();
  }

  /**
   * @testName: uiDataIsRowAvailableTest
   * @assertion_ids: JSF:JAVADOC:677
   ...
   */
  public void uiDataIsRowAvailableTest() throws EETest.Fault {
    super.uiDataIsRowAvailableTest();
  }
   ...
   */
  public void uiDataSetFirstIAETest() throws EETest.Fault {
    super.uiDataSetFirstIAETest();
  }

  /**
   * @testName: uiDataSetRowIndexIAETest
   * @assertion_ids: JSF:JAVADOC:696
   * @test_Strategy: Verify the following: - setRowIndex() throws IAE if the
   *                 integer value specified is less than -1
   */
  public void uiDataSetRowIndexIAETest() throws EETest.Fault {
    super.uiDataSetRowIndexIAETest();
  }

  /**
   * @testName: uiDataSetRowsIAETest
   * @assertion_ids: JSF:JAVADOC:689
   * @test_Strategy: Verify the following: - setRows() throws IAE if the integer
   *                 value specified is negative
   */
  public void uiDataSetRowsIAETest() throws EETest.Fault {
    super.uiDataSetRowsIAETest();
  }
   ...
   *                 getValue().
   */
  public void uiDataGetSetValueTest() throws EETest.Fault {
    super.uiDataGetSetValueTest();
  }

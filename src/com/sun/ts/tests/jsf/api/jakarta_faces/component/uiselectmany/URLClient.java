...
public class URLClient
    extends com.sun.ts.tests.jsf.api.jakarta_faces.component.uiinput.URLClient {

  private static final String CONTEXT_ROOT = "/jsf_comp_selmany_web";
   ...
   * @assertion_ids: JSF:JAVADOC:517; JSF:JAVADOC:875
   ...
   * @assertion_ids: JSF:JAVADOC:567; JSF:JAVADOC:528; JSF:JAVADOC:879;
   *                 JSF:JAVADOC:884
   ...
   * @assertion_ids: JSF:JAVADOC:529; JSF:JAVADOC:880; JSF:JAVADOC:885
   ...
   * @assertion_ids: JSF:JAVADOC:418; JSF:JAVADOC:427
   ...
   * @assertion_ids: JSF:JAVADOC:417; JSF:JAVADOC:425
   ...
   * @assertion_ids: JSF:JAVADOC:407; JSF:JAVADOC:886
   ...
   * @assertion_ids: JSF:JAVADOC:409; JSF:JAVADOC:886
   ...
   * @assertion_ids: JSF:JAVADOC:421; JSF:JAVADOC:886
   * @test_Strategy: Validate that addValueChangeListener throws a
   *                 NullPointerException when ValueChangeListener is null
   */
   ...
   * @assertion_ids: JSF:JAVADOC:478; JSF:JAVADOC:741
   ...
   */
  public void uiInputBroadcastTest() throws EETest.Fault {
    super.uiInputBroadcastTest();
  }
   ...
   *                 ref are invoked when broadcast() is invoked().
   */
  public void uiInputBroadcastValueChangeListenerTest() throws EETest.Fault {
    super.uiInputBroadcastValueChangeListenerTest();
  }
   ...
   */
  public void uiInputUpdateModelFailsTest() throws EETest.Fault {
    super.uiInputUpdateModelFailsTest();
  }
  ...
  public void uiInputUpdateModelNoActionTest() throws EETest.Fault {
    super.uiInputUpdateModelNoActionTest();
  }
   ...
   */
  public void uiInputUpdateModelSucceedsTest() throws EETest.Fault {
    super.uiInputUpdateModelSucceedsTest();
  }
   ...
   *                 validations.
   */
  public void uiInputValidate1Test() throws EETest.Fault {
    super.uiInputValidate1Test(); // To change body of overridden methods
   ...
   */
  public void uiInputValidate2Test() throws EETest.Fault {
    super.uiInputValidate2Test(); // To change body of overridden methods
    // use Options | File Templates.
  }
  ...
  // NOT TESTABLE IN THIS CASE AS VALUE WON'T BE A STRING
  /*
   ...
   * called to convert the submitted value. Additionally verify if an exception
   * is thrown during the conversion process, a message is queued to the
   * FacesContext and the component is marked invalid.
   */
  // public void uiInputValidate4Test() throws EETest.Fault {
  // super.uiInputValidate4Test(); //To change body of overridden methods use
   ...
   * and 'value' is a ValueBinding, get the use the type to create a Converter
   * for that type and use it to convert the submitted value. Additionally
   * verify if an exception is thrown during the conversion process, a message
   * is queued to the FacesContext and the component is marked invalid.
   */
  // public void uiInputValidate5Test() throws EETest.Fault {
  // super.uiInputValidate5Test(); //To change body of overridden methods use
  // Options | File Templates.
  // }

  /**
   * @testName: uiInputValidate6Test
   * @assertion_ids: JSF:JAVADOC:787
   * @test_Strategy: If the selected item is not one of the available sections,
   *                 ensure a message is queued to the FacesContext and the
   *                 component is marked invalid.
   */
  public void uiInputValidate6Test() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiInputValidate6Test");
    invoke();
  }

  /**
   * @testName: uiInputResetValueTest
   * @assertion_ids: JSF:JAVADOC:770
  ...
  public void uiInputResetValueTest() throws Fault {
    super.uiInputResetValueTest();
  }

  // -------------------------------- selectMany Tests

  /**
   * @testName: uiSelectManyGetSetSelectedValuesTest
   * @assertion_ids: JSF:JAVADOC:876; JSF:JAVADOC:881
   * @test_Strategy: Validate that we are able to {set, get}SelectedValues().
   * 
   * @since 2.2
   */
  public void uiSelectManyGetSetSelectedValuesTest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiSelectManyGetSetSelectedValuesTest");
    invoke();
  }
}

...
package com.sun.ts.tests.jsf.api.jakarta_faces.convert.offsetdatetimeconverter;
...
public final class URLClient extends AbstractUrlClient {
  ...
  private static final String CONTEXT_ROOT = "/jsf_convert_offsetdatetime_web";

  private static final String TYPE = "offsetdatetime";
  ...
  /**
   * @testName: LocalDateTimeConverterGetAsObjectTest
   ...
   */
  public void LocalDateTimeConverterGetAsObjectTest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "converterGetAsObjectTest&type=" + TYPE);
    invoke();
  }

  /**
   * @testName: LocalDateTimeConverterGetAsObjectNPETest
   ...
   *                 parameters are null.
   */
  public void LocalDateTimeConverterGetAsObjectNPETest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "converterGetAsObjectNPETest&type=" + TYPE);
    invoke();
  }

  /**
   * @testName: LocalDateTimeConverterGetAsStringTest
   * @assertion_ids: JSF:JAVADOC:1579; JSF:JAVADOC:1539; JSF:JAVADOC:1543
   * @test_Strategy: Ensure the proper result is returned when passing in a
   *                 valid value, null, or a zero-length String.
   */
  public void LocalDateTimeConverterGetAsStringTest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "converterGetAsStringTest&type=" + TYPE);
    invoke();
  }

  /**
   * @testName: LocalDateTimeConverterGetAsStringNPETest
   * @assertion_ids: JSF:JAVADOC:1539; JSF:JAVADOC:1545
   * @test_Strategy: Ensure an NPE is thrown if either the context or component
   *                 parameters are null.
   */
  public void LocalDateTimeConverterGetAsStringNPETest() throws Fault {

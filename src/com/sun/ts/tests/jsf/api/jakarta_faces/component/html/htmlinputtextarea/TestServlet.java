...
public final class TestServlet
  ...
  private static final String[] attrNames = { "accesskey", "cols", "dir",
      "lang", "onblur", "onchange", "onclick", "ondblclick", "onfocus",
      "onkeydown", "onkeypress", "onkeyup", "onmousedown", "onmousemove",
      "onmouseout", "onmouseover", "onmouseup", "onselect", "rows", "style",
      "styleClass", "tabindex", "title", "disabled", "readonly" };

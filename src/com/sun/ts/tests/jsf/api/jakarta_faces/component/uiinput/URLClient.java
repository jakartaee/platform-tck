...
public class URLClient extends BaseUIComponentClient {
  ...
  private static final String CONTEXT_ROOT = "/jsf_comp_input_web";
   ...
   * @assertion_ids: JSF:JAVADOC:583; JSF:JAVADOC:484; JSF:JAVADOC:745
   * @test_Strategy: Verify that when decode() is called passing null as the
   *                 context, a NullPointException is thrown.
   */
  public void uiComponentDecodeNPETest() throws EETest.Fault {
    super.uiComponentDecodeNPETest();
  }
   ...
   * @assertion_ids: JSF:JAVADOC:517; JSF:JAVADOC:747
   ...
   * @assertion_ids: JSF:JAVADOC:542; JSF:JAVADOC:621; JSF:JAVADOC:762
   ...
   * @assertion_ids: JSF:JAVADOC:550; JSF:JAVADOC:627; JSF:JAVADOC:764
   * @test_Strategy: Validate a NullPointerException is thrown if context is
   *                 null.
   * 
   * @since 2.0
   ...
   * @assertion_ids: JSF:JAVADOC:628; JSF:JAVADOC:765
   ...
   * @assertion_ids: JSF:JAVADOC:552; JSF:JAVADOC:629; JSF:JAVADOC:766
   ...
   * @assertion_ids: JSF:JAVADOC:443; JSF:JAVADOC:771; JSF:JAVADOC:772
   ...
   *                 JSF:JAVADOC:432; JSF:JAVADOC:433; JSF:JAVADOC:743;
   *                 JSF:JAVADOC:760
   ...
   * @assertion_ids: JSF:JAVADOC:966; JSF:JAVADOC:968; JSF:JAVADOC:782
   ...
   * @assertion_ids: JSF:JAVADOC:418; JSF:JAVADOC:427; JSF:JAVADOC:759;
   *                 JSF:JAVADOC:779
   * @test_Strategy: Verify {is,set}Valid() - if a value is set, the same value
   *                 is returned.
   */
  public void editableValueHolderIsSetValidTest() throws EETest.Fault {
    super.editableValueHolderIsSetValidTest();
  }

  /**
   * @testName: editableValueHolderAddGetRemoveValidatorTest
   * @assertion_ids: JSF:JAVADOC:412; JSF:JAVADOC:406; JSF:JAVADOC:411;
   *                 JSF:JAVADOC:419; JSF:JAVADOC:739; JSF:JAVADOC:752;
   *                 JSF:JAVADOC:767
  ...
  public void editableValueHolderAddGetRemoveValidatorTest()
      throws EETest.Fault {
    super.editableValueHolderAddGetRemoveValidatorTest();
  }

  /**
   * @testName: editableValueHolderGetSetSubmittedValueTest
   * @assertion_ids: JSF:JAVADOC:410; JSF:JAVADOC:426; JSF:JAVADOC:778;
   *                 JSF:JAVADOC:749
  ...
  public void editableValueHolderGetSetSubmittedValueTest()
      throws EETest.Fault {
    super.editableValueHolderGetSetSubmittedValueTest();
  }

  /**
   * @testName: editableValueHolderIsSetRequiredTest
   * @assertion_ids: JSF:JAVADOC:417; JSF:JAVADOC:425; JSF:JAVADOC:758;
   *                 JSF:JAVADOC:776
   * @test_Strategy: Verify {is,set}Required - if a value is set, the expected
   *                 value is returned.
   */
  public void editableValueHolderIsSetRequiredTest() throws EETest.Fault {
    super.editableValueHolderIsSetRequiredTest();
  }

  /**
   * @testName: editableValueHolderAddGetRemoveValueChangeListenerTest
   * @assertion_ids: JSF:JAVADOC:414; JSF:JAVADOC:408; JSF:JAVADOC:413;
   *                 JSF:JAVADOC:420; JSF:JAVADOC:768
  ...
  public void editableValueHolderAddGetRemoveValueChangeListenerTest()
      throws EETest.Fault {
    super.editableValueHolderAddGetRemoveValueChangeListenerTest();
  }
  ...
  public void editableValueHolderGetSetValueChangeListenerTest()
      throws EETest.Fault {
    super.editableValueHolderGetSetValueChangeListenerTest();
  }

  /**
   * @testName: editableValueHolderAddValidatorNPETest
   * @assertion_ids: JSF:JAVADOC:407; JSF:JAVADOC:740
   * @test_Strategy: Validate that addValidator throws a NullPointerException
   *                 when Validator is null
   */
  public void editableValueHolderAddValidatorNPETest() throws EETest.Fault {
    super.editableValueHolderAddValidatorNPETest();
  }

  /**
   * @testName: editableValueHolderAddValueChangeListenerNPETest
   * @assertion_ids: JSF:JAVADOC:409; JSF:JAVADOC:742
  ...
  public void editableValueHolderAddValueChangeListenerNPETest() throws Fault {
    super.editableValueHolderAddValueChangeListenerNPETest();
  }

  /**
   * @testName: editableValueHolderRemoveValueChangeListenerNPETest
   * @assertion_ids: JSF:JAVADOC:421; JSF:JAVADOC:769
   * @test_Strategy: Validate that addValueChangeListener throws a
   *                 NullPointerException when ValueChangeListener is null
   */
  public void editableValueHolderRemoveValueChangeListenerNPETest()
      throws Fault {
    super.editableValueHolderRemoveValueChangeListenerNPETest();
  }

  /**
   * @testName: editableValueHolderIsSetImmediateTest
   * @assertion_ids: JSF:JAVADOC:415; JSF:JAVADOC:423; JSF:JAVADOC:756;
   *                 JSF:JAVADOC:774
  ...
  public void editableValueHolderIsSetImmediateTest() throws EETest.Fault {
    super.editableValueHolderIsSetImmediateTest();
  }

  /**
   * @testName: editableValueHolderIsSetLocalValueSetTest
   * @assertion_ids: JSF:JAVADOC:416; JSF:JAVADOC:424; JSF:JAVADOC:757;
   *                 JSF:JAVADOC:775
   ...
   *                 this component.
   */
  public void editableValueHolderIsSetLocalValueSetTest() throws EETest.Fault {
    super.editableValueHolderIsSetLocalValueSetTest();
  }

  // ----------------------------------------------------------------- UIInput

  /**
   * @testName: uiInputBroadcastTest
   * @assertion_ids: JSF:JAVADOC:784; JSF:JAVADOC:478; JSF:JAVADOC:741
   * @test_Strategy: Verify that the ValueChangeListeners are invoked in order
   *                 or registration and that they are only invoked during the
   *                 PROCESS_VALIDATIONS phase.
   */
  public void uiInputBroadcastTest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiInputBroadcastTest");
    invoke();
  }

  /**
   * @testName: uiInputBroadcastValueChangeListenerTest
   * @assertion_ids: JSF:JAVADOC:784; JSF:JAVADOC:478; JSF:JAVADOC:741
   * @test_Strategy: Verify any listeners referenced via a value change listener
   *                 are invoked when broadcast() is invoked().
   */
  public void uiInputBroadcastValueChangeListenerTest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiInputBroadcastValueChangeListenerTest");
    invoke();
  }

  /**
   * @testName: uiInputUpdateModelNoActionTest
   * @assertion_ids: JSF:JAVADOC:784; JSF:JAVADOC:785
   ...
   */
  public void uiInputUpdateModelNoActionTest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiInputUpdateModelNoActionTest");
    invoke();
  }

  /**
   * @testName: uiInputUpdateModelSucceedsTest
   * @assertion_ids: JSF:JAVADOC:784; JSF:JAVADOC:785
   * @test_Strategy: Verify when the updateModel() call is successful, the
   *                 underlying bean is indeed updated and the local value of
   *                 the component is set to null.
   */
  public void uiInputUpdateModelSucceedsTest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiInputUpdateModelSucceedsTest");
    invoke();
  }

  /**
   * @testName: uiInputUpdateModelFailsTest
   * @assertion_ids: JSF:JAVADOC:784; JSF:JAVADOC:785
   * @test_Strategy: Verify when the updateModel() call is unsuccessful, the
   *                 underlying bean is not updated, the local value is not
   *                 modified, the valid property of the component is false, and
   *                 a message is queued into the FacesContext.
   */
  public void uiInputUpdateModelFailsTest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiInputUpdateModelFailsTest");
    invoke();
  }

  /**
   * @testName: uiInputUpdateModelNPETest
   * @assertion_ids: JSF:JAVADOC:784; JSF:JAVADOC:786
   * @test_Strategy: Validate that a NullPointerException is thrown if
   *                 FacesContext is null.
   * 
   */
  public void uiInputUpdateModelNPETest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiInputUpdateModelNPETest");
    invoke();
  }

  /**
   * @testName: uiInputValidateNPETest
   * @assertion_ids: JSF:JAVADOC:784; JSF:JAVADOC:788
   * @test_Strategy: Validate that a NullPointerException is thrown if
   *                 FacesContext is null.
   * 
   */
  public void uiInputValidateNPETest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiInputValidateNPETest");
    invoke();
  }

  /**
   * @testName: uiInputValidate1Test
   * @assertion_ids: JSF:JAVADOC:784; JSF:JAVADOC:787
   * @test_Strategy: Verify a message is queued to the FacesContext and the
   *                 UIInput object is marked invalid if it has a null or a
   *                 zero-length String as its value when processing
   *                 validations.
   */
  public void uiInputValidate1Test() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiInputValidate1Test");
    invoke();
  }

  /**
   * @testName: uiInputValidate2Test
   * @assertion_ids: JSF:JAVADOC:784; JSF:JAVADOC:787
   * @test_Strategy: Verify that getConvertedValue() is called on the Renderer
   *                 that is associated with the component under test when the
   *                 validate() method is called.
   */
  public void uiInputValidate2Test() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiInputValidate2Test");
    invoke();
  }

  /**
   * @testName: uiInputValidate3aTest
   * @assertion_ids: JSF:JAVADOC:784; JSF:JAVADOC:787
   * @test_Strategy: - If the component is valid, call the validate() method on
   *                 all registered validators, and THEN the validate() method
   *                 on the validator referenced by validatorRef - If a
   *                 validator marked a component as invalid, the associated
   *                 ValueChangeListener must not be invoked.
   */
  public void uiInputValidate3aTest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiInputValidate3aTest");
    invoke();
  }

  /**
   * @testName: uiInputValidate3bTest
   * @assertion_ids: JSF:JAVADOC:784; JSF:JAVADOC:787
   * @test_Strategy: - If the component is valid, call the validate() method on
   *                 all registered validators, and THEN the validate() method
   *                 on the validator referenced by validatorRef - If the
   *                 validators pass the component, and the new value is
   *                 different from the previous value, invoke the
   *                 ValueChangeListener.
   */
  public void uiInputValidate3bTest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiInputValidate3bTest");
    invoke();
  }

  /**
   * @testName: uiInputValidate3cTest
   * @assertion_ids: JSF:JAVADOC:784; JSF:JAVADOC:787
   * @test_Strategy: - If the component is valid, call the validate() method on
   *                 all registered validators, and THEN the validate() method
   *                 on the validator referenced by validatorRef - If the
   *                 validators pass the component, and the new value is the
   *                 same as the old, do not invoke the ValueChangeListener
   */
  public void uiInputValidate3cTest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiInputValidate3cTest");
    invoke();
  }

  /**
   * @testName: uiInputValidate4Test
   * @assertion_ids: JSF:JAVADOC:784; JSF:JAVADOC:787
   * @test_Strategy: Verify that a converter available via getConverter() is
   *                 called to convert the submitted value. Additionally verify
   *                 if an exception is thrown during the conversion process, a
   *                 message is queued to the FacesContext and the component is
   *                 marked invalid.
   */
  public void uiInputValidate4Test() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiInputValidate4Test");
    invoke();
  }
   ...
   *                 and 'value' is a ValueExpression, use the type of the
   *                 expression to create a Converter for that type and use it
   *                 to convert the submitted value. Additionally verify if an
   *                 exception is thrown during the conversion process, a
   *                 message is queued to the FacesContext and the component is
   *                 marked invalid.
   */
  public void uiInputValidate5Test() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiInputValidate5Test");
    invoke();
  }

  /**
   * @testName: uiInputResetValueTest
   * @assertion_ids: JSF:JAVADOC:784; JSF:JAVADOC:770
   * @test_Strategy: Verify that calling resetValue() will cause the following:
   *                 - value set to null - submitted value set to null -
   *                 component is marked as valid - flag denoting that a local
   *                 value is set is false
   * @since 1.2
   */
  public void uiInputResetValueTest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiInputResetValueTest");
    invoke();
  }

  /**
   * @testName: uiInputSetGetConverterMessTest
   * @assertion_ids: JSF:JAVADOC:746; JSF:JAVADOC:773
   * @test_Strategy: Validate that {set,get}ConverterMessage() methods work
   *                 properly.
   * 
   * @since 2.2
   */
  public void uiInputSetGetConverterMessTest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiInputSetGetConverterMessTest");
    invoke();
  }

  /**
   * @testName: uiInputSetGetValidatorMessTest
   * @assertion_ids: JSF:JAVADOC:751; JSF:JAVADOC:777
   * @test_Strategy: Validate that {set,get}ValidatorMessage() methods work
   *                 properly.
   * 
   * @since 2.2
   */
  public void uiInputSetGetValidatorMessTest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiInputSetGetValidatorMessTest");
    invoke();
  }

  /**
   * @testName: uiInputSetGetRequiredMessTest
   * @assertion_ids: JSF:JAVADOC:748; JSF:JAVADOC:781
   * @test_Strategy: Validate that {set,get}RequiredMessage() methods work
   *                 properly.
   * 
   * @since 2.2
   */
  public void uiInputSetGetRequiredMessTest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiInputSetGetRequiredMessTest");
    invoke();
  }

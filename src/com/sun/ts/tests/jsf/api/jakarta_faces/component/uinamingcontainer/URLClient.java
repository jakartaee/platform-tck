...
package com.sun.ts.tests.jsf.api.jakarta_faces.component.uinamingcontainer;
...
public class URLClient extends BaseUIComponentClient {
  ...
  private static final String CONTEXT_ROOT = "/jsf_comp_naming_web";
   ...
   * @assertion_ids: JSF:JAVADOC:814; JSF:JAVADOC:488; JSF:JAVADOC:584
   ...
   * @assertion_ids: JSF:JAVADOC:517; JSF:JAVADOC:812
  ...
  /**
   * @testName: uiNamingContainerGetSeparatorCharTest
   * @assertion_ids: JSF:JAVADOC:814; JSF:JAVADOC:813
   * @test_Strategy: Verify that we are able to set a value for this webapp and
   *                 retrieve it using get.SeparatorChar().
   * 
   * @since 2.0
   */
  public void uiNamingContainerGetSeparatorCharTest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiNamingContainerGetSeparatorCharTest");
    invoke();
  }
}

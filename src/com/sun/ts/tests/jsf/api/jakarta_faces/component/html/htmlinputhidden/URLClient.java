 ...
 * $Id$
 */
package com.sun.ts.tests.jsf.api.jakarta_faces.component.html.htmlinputhidden;
...
public class URLClient
  ...
  private static final String CONTEXT_ROOT = "/jsf_chtml_inhidden_web";
   ...
   * @test_Strategy: Assert that a call to popComponentToEL removes "this"
   *                 component as being the cureent component and that the
   *                 previous UIComponent is set to the current component being
   *                 processed.
   */

...
public final class URLClient extends BaseEventClient {
  ...
  private static final String CONTEXT_ROOT = "/jsf_event_postconstructcustomscopeevent_web";
  ...
  // Tests
  /**
   * @testName: postConstructCustomScopeEventGetContextTest
   * @assertion_ids: JSF:JAVADOC:1857; JSF:JAVADOC:1858
   * @test_Strategy: Validate that we get the correct value returned from
   *                 PostConstructCustomScopeEvent.getContext().
   * 
   * @since 2.2
   */
  public void postConstructCustomScopeEventGetContextTest() throws Fault {
    TEST_PROPS.setProperty(APITEST,
        "postConstructCustomScopeEventGetContextTest");
    invoke();
  }

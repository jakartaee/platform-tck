...
public class URLClient
    extends com.sun.ts.tests.jsf.api.jakarta_faces.component.uiform.URLClient {

  private static final String CONTEXT_ROOT = "/jsf_chtml_form_web";
   ...
   * @assertion_ids: JSF:JAVADOC:714; JSF:JAVADOC:722
   ...
   */
  public void uiFormIsSetSubmittedTest() throws EETest.Fault {
    super.uiFormIsSetSubmittedTest();
  }

  /**
   * @testName: uiFormProcessUpdatesIsSubmittedTest
   * @assertion_ids: JSF:JAVADOC:718; JSF:JAVADOC:714; JSF:JAVADOC:722
   * @test_Strategy: Verify that the children of the UIForm component will be
   *                 processed if the UIForm's submitted is true; ensure the
   *                 inverse occurs when the submitted property is false.
   */
  public void uiFormProcessUpdatesIsSubmittedTest() throws EETest.Fault {
    super.uiFormProcessUpdatesIsSubmittedTest();
  }

  /**
   * @testName: uiFormProcessValidationsIsSubmittedTest
   * @assertion_ids: JSF:JAVADOC:714; JSF:JAVADOC:722; JSF:JAVADOC:719
   * @test_Strategy: Verify that the children of the UIForm component will be
   *                 processed if the UIForm's submitted is true; ensure the
   *                 inverse occurs when the submitted property is false.
   */
  public void uiFormProcessValidationsIsSubmittedTest() throws EETest.Fault {
    super.uiFormProcessValidationsIsSubmittedTest();
  }

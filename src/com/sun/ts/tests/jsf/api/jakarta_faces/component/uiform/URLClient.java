...
package com.sun.ts.tests.jsf.api.jakarta_faces.component.uiform;
...
public class URLClient extends BaseUIComponentClient {
  ...
  private static final String CONTEXT_ROOT = "/jsf_comp_form_web";
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:488
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:491
   * @test_Strategy: Verify that the component doesn't delegate the
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:494
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:487
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:490; JSF:JAVADOC:586
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:493; JSF:JAVADOC:589
   * @test_Strategy: Verify an NPE is thrown if the <code>context</code>
   *                 argument is null.
   */
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:496; JSF:JAVADOC:592
   * @test_Strategy: Verify an NPE is thrown if the <code>context</code>
   *                 argument is null.
   */
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:498; JSF:JAVADOC:594
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:499; JSF:JAVADOC:595
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:497; JSF:JAVADOC:593
   ...
   * @assertion_ids: JSF:JAVADOC:596; JSF:JAVADOC:723; JSF:JAVADOC:500
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:508
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:507
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:501
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:502
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:505; JSF:JAVADOC:601
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:503
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:504
   * @test_Strategy: Verify getClientId() returns a non-null value.
   */
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:509
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:510
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:512
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:511
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:535
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:534
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:516
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:515
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:513
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:517; JSF:JAVADOC:712
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:524
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:518;JSF:JAVADOC:558
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:561; JSF:JAVADOC:632;
   *                 JSF:JAVADOC:557
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:550; JSF:JAVADOC:635
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:550; JSF:JAVADOC:638
   * @test_Strategy: Validate a NullPointerException is thrown if context is
   *                 null.
   * 
   */
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:523;JSF:JAVADOC:563
   * @test_Strategy: Verify {get,set}Parent() - if a value is set, the same
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:531; JSF:JAVADOC:614
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:531; JSF:JAVADOC:532;
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:537; JSF:JAVADOC:562
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:536
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:541
   ...
   * @assertion_ids: JSF:JAVADOC:582; JSF:JAVADOC:723; JSF:JAVADOC:541
   * @test_Strategy: Assert the following when processDecodes is called: #
   *                 Ensure the UIForm's decode() method is called prior to
   *                 processing its children # Call the processDecodes() method
   *                 of all facets and children of this UIComponent. # Call the
   *                 decode() method of this component, if this component's
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:542; JSF:JAVADOC:621;
   *                 JSF:JAVADOC:716
   * @test_Strategy: Validate a NullPointerException is thrown when arg is null.
   */
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:545;JSF:JAVADOC:547
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:548; JSF:JAVADOC:625
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:546; JSF:JAVADOC:623
   * @test_Strategy: Validate that a NullPointerException is thrown when context
   *                 is null.
   */
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:549
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:549; JSF:JAVADOC:763
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:550; JSF:JAVADOC:627
   * @test_Strategy: Validate a NullPointerException is thrown if context is
   *                 null.
   * 
   * @since 2.0
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:628
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:552; JSF:JAVADOC:629;
   *                 JSF:JAVADOC:720
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:553
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:554
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:539
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:540
   * @test_Strategy: Assert that a call to popComponentToEL removes "this"
   *                 component as being the current component and that the
   *                 previous UIComponent is set to the current component being
   *                 processed.
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:640; JSF:JAVADOC:559
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:567;JSF:JAVADOC:528
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:529
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:569
   * @test_Strategy: Verify an NPE is thrown if a null value for the 'name'
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:568
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:570
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:2547
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:575
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:442;JSF:JAVADOC:447
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:443
   ...
   *                 restoreState() method. Enforce that extra requirement that
   *                 when saveState is called, the submitted property is set to
   *                 false. Finally verify that no state about the forms
   *                 submission state (i.e. the submitted property is true), the
   *                 value isn't saved in the state by restoring the state
   *                 object and ensuring that return value of isSubmitted() is
   *                 false.
   */
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:444; JSF:JAVADOC:445
   ...
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:446
  ...
  /**
   * @testName: uiFormIsSetSubmittedTest
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:714; JSF:JAVADOC:722
   * @test_Strategy: Verify the following: - The default return value of
   *                 isSubmitted() is false (on a newly created component) -
   *                 isSubmitted() returns the value as set by setSubmitted()
   */
  public void uiFormIsSetSubmittedTest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiFormIsSetSubmittedTest");
    invoke();
  }

  /*
   * @testName: uiFormProcessUpdatesIsSubmittedTest
   * 
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:714; JSF:JAVADOC:717
   * 
   * @test_Strategy: Verify that the children of the UIForm component will be
   * processed if the UIForm's submitted is true; ensure the inverse occurs when
   * the submitted property is false.
   */
  public void uiFormProcessUpdatesIsSubmittedTest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiFormProcessUpdatesIsSubmittedTest");
    invoke();
  }

  /*
   * @testName: uiFormProcessValidationsIsSubmittedTest
   * 
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:714; JSF:JAVADOC:719
   * 
   * @test_Strategy: Verify that the children of the UIForm component will be
   * processed if the UIForm's submitted is true; ensure the inverse occurs when
   * the submitted property is false.
   */
  public void uiFormProcessValidationsIsSubmittedTest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiFormProcessUpdatesIsSubmittedTest");
    invoke();
  }

  /*
   * @testName: uiFormCreateUniqueIdTest
   * 
   * @assertion_ids: JSF:JAVADOC:723; JSF:JAVADOC:710
   * 
   * @test_Strategy: Validate that we receive a uniqueId with a specific 'seed'
   * value contained within.
   */
  public void uiFormCreateUniqueIdTest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiFormCreateUniqueIdTest");
    invoke();
  }

  /*
   * @testName: uiFormIsSetPrependIdTest
   * 
   * @assertion_ids: JSF:JAVADOC:713; JSF:JAVADOC:721
   * 
   * @test_Strategy: Validate that we are able to set and get the Prepend flag.
   * 
   * @since 2.2
   */
  public void uiFormIsSetPrependIdTest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiFormIsSetPrependIdTest");
    invoke();
  }

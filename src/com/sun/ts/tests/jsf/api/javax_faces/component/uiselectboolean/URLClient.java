 ...
 * $Id$
 */
package com.sun.ts.tests.jsf.api.javax_faces.component.uiselectboolean;
...
public class URLClient
  ...
  private static final String CONTEXT_ROOT = "/jsf_comp_selboolean_web";
   ...
   * @assertion_ids: JSF:JAVADOC:517; JSF:JAVADOC:843
   ...
   * @assertion_ids: JSF:JAVADOC:567; JSF:JAVADOC:528; JSF:JAVADOC:846;
   *                 JSF:JAVADOC:852
   ...
   * @assertion_ids: JSF:JAVADOC:529; JSF:JAVADOC:847; JSF:JAVADOC:853
   ...
   * @assertion_ids: JSF:JAVADOC:407; JSF:JAVADOC:854
   ...
   * @assertion_ids: JSF:JAVADOC:409; JSF:JAVADOC:854
   ...
   * @assertion_ids: JSF:JAVADOC:421; JSF:JAVADOC:854
   * @test_Strategy: Validate that addValueChangeListener throws a
   *                 NullPointerException when ValueChangeListener is null
   */
  ...
  public void uiInputValidate4Test() throws EETest.Fault {
    super.uiInputValidate4Test(); // To change body of overridden methods
    // use Options | File Templates.
  }
   ...
   *                 to the FacesContext and the component is marked invalid.
   */
  public void uiInputValidate5Test() throws EETest.Fault {
    super.uiInputValidate5Test(); // To change body of overridden methods
    // use Options | File Templates.
  }
  ...
  /**
   * @testName: uiSelectBooleanIsSetSelectedTest
   * @assertion_ids: JSF:JAVADOC:848; JSF:JAVADOC:849
   * @test_Strategy: Validate that we can set and get if the component is
   *                 selected.
   */
  public void uiSelectBooleanIsSetSelectedTest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiSelectBooleanIsSetSelectedTest");
    invoke();
  }

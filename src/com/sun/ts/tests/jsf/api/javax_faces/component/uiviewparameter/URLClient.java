...
public class URLClient extends BaseUIComponentClient {
  ...
  private static final String CONTEXT_ROOT = "/jsf_comp_viewparameter_web";
   ...
   * 
   * @assertion_ids: JSF:JAVADOC:517; JSF:JAVADOC:892
   * 
   ...
   * 
   * @assertion_ids: JSF:JAVADOC:541; JSF:JAVADOC:889
   * 
   ...
   * 
   * @assertion_ids: JSF:JAVADOC:552; JSF:JAVADOC:629; JSF:JAVADOC:899
   * 
  ...
  /**
   * @testName: uiViewParameterIsImmediateTest
   * 
   * @assertion_ids: JSF:JAVADOC:415; JSF:JAVADOC:898; JSF:JAVADOC:902
   * 
   * @test_Strategy: Validate that a NullPointerException is thrown when arg is
   *                 null.
   */
  public void uiViewParameterIsImmediateTest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiViewParameterIsImmediateTest");
    invoke();
  }

  /**
   * @testName: uiViewParameterGetSetNameTest
   * 
   * @assertion_ids: JSF:JAVADOC:893; JSF:JAVADOC:900
   * 
   * @test_Strategy: Validate the following: we can set the name
   *                 value(setname()) we can get the name value(getname())
   */
  public void uiViewParameterGetSetNameTest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiViewParameterGetSetNameTest");
    invoke();
  }

  /**
   * @testName: uiViewParameterGetStringValueTest
   * 
   * @assertion_ids: JSF:JAVADOC:410; JSF:JAVADOC:426; JSF:JAVADOC:894
   * 
   * @test_Strategy: Verify getStringValue() - if a value is set, the expected
   *                 value is returned.
   */
  public void uiViewParameterGetStringValueTest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiViewParameterGetStringValueTest");
    invoke();
  }

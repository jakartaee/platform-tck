...
public class URLClient extends BaseUIComponentClient {
  ...
  private static final String CONTEXT_ROOT = "/jsf_comp_selitems_web";
   ...
   * @assertion_ids: JSF:JAVADOC:517; JSF:JAVADOC:871
  ...
  // UISelectItems
  /**
   * @testName: uiSelectItemsGetSetValueTest
   * @assertion_ids: JSF:JAVADOC:874; JSF:JAVADOC:872; JSF:JAVADOC:873
   * @test_Strategy: Verify {get,set}Value() - if a value is set, the same value
   *                 is returned.
   */
  public void uiSelectItemsGetSetValueTest() throws EETest.Fault {
    TEST_PROPS.setProperty(APITEST, "uiSelectItemsGetSetValueTest");
    invoke();
  }

  /**
   * @testName: uiSelectItemsGetArrayValueTest
   * @assertion_ids: JSF:JAVADOC:874; JSF:JAVADOC:872; JSF:JAVADOC:873
   * @test_Strategy: Verify {get,set}Value() - if a value is set using Arrays,
   *                 the same value is returned.
   */
  public void uiSelectItemsGetArrayValueTest() throws EETest.Fault {
    TEST_PROPS.setProperty(APITEST, "uiSelectItemsGetArrayValueTest");
    invoke();
  }

  /**
   * @testName: uiSelectItemsGetCollectionValueTest
   * @assertion_ids: JSF:JAVADOC:874; JSF:JAVADOC:872; JSF:JAVADOC:873
   * @test_Strategy: Verify {get,set}Value() - if a value is set using a Vector,
   *                 the same value is returned.
   */
  public void uiSelectItemsGetCollectionValueTest() throws EETest.Fault {
    TEST_PROPS.setProperty(APITEST, "uiSelectItemsGetCollectionValueTest");
    invoke();
  }

  /**
   * @testName: uiSelectItemsMapGetValueTest
   * @assertion_ids: JSF:JAVADOC:874; JSF:JAVADOC:872; JSF:JAVADOC:873
   * @test_Strategy: Verify {get,set}Value() - if a value is set using a Vector,
   *                 the same value is returned.
   */
  public void uiSelectItemsMapGetValueTest() throws EETest.Fault {
    TEST_PROPS.setProperty(APITEST, "uiSelectItemsMapGetValueTest");
    invoke();
  }
}

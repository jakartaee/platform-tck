...
public class URLClient extends BaseUIComponentClient {
  ...
  private static final String CONTEXT_ROOT = "/jsf_comp_data_web";
   ...
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:488
   ...
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:490; JSF:JAVADOC:586;
   *                 JSF:JAVADOC:657
   ...
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:488; JSF:JAVADOC:656
   ...
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:491
   * @test_Strategy: Verify that the component doesn't delegate the
   ...
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:493; JSF:JAVADOC:589
   * @test_Strategy: Verify an NPE is thrown if the <code>context</code>
   *                 argument is null.
   */
   ...
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:494
   ...
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:496; JSF:JAVADOC:592
   * @test_Strategy: Verify an NPE is thrown if the <code>context</code>
   *                 argument is null.
   */
   ...
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:487
   ...
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:498; JSF:JAVADOC:594
   ...
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:499; JSF:JAVADOC:595
   ...
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:497; JSF:JAVADOC:593
   ...
   * @assertion_ids: JSF:JAVADOC:596; JSF:JAVADOC:707; JSF:JAVADOC:500
   ...
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:508
   * @test_Strategy: Validate a NullPointerException is thrown when arg is null.
   */
  public void uiComponentGetContainerClientIdNPETest() throws EETest.Fault {
    super.uiComponentGetContainerClientIdNPETest();
  }

  /**
   * @testName: uiComponentGetContainerClientIdTest
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:507
   * @test_Strategy: Validate a that we get a non null value return.
   */
  public void uiComponentGetContainerClientIdTest() throws EETest.Fault {
    super.uiComponentGetContainerClientIdTest();
  }

  /**
   * @testName: uiComponentGetChildCountTest
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:501
   ...
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:502
   ...
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:505; JSF:JAVADOC:601;
   *                 JSF:JAVADOC:659
   ...
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:503
   ...
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:504
   * @test_Strategy: Verify getClientId() returns a non-null value.
   */
   ...
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:509
   ...
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:510
   ...
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:535
   ...
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:534
   ...
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:512
   ...
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:511
   ...
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:516
   ...
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:515
   ...
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:513
   ...
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:517; JSF:JAVADOC:466;
   *                 JSF:JAVADOC:660
   ...
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:524
   ...
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:518;JSF:JAVADOC:558;
   *                 JSF:JAVADOC:658
   ...
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:523;JSF:JAVADOC:563
   * @test_Strategy: Verify {get,set}Parent() - if a value is set, the same
   ...
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:531; JSF:JAVADOC:614
   * @test_Strategy: Validate the behavior of InvokeOnComponent():
   */
  public void uiComponentInvokeOnComponentTest() throws EETest.Fault {
    TEST_PROPS.setProperty(APITEST, "uiDataPositiveInvokeOnComponentTest");
    invoke();
  }

  /**
   * @testName: uiComponentInvokeOnComponentNPETest
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:676
   * @test_Strategy: Validate that InvokeOnComponent() throws a
   *                 NullPointerException if any of its parameters are null.
   */
  public void uiComponentInvokeOnComponentNPETest() throws EETest.Fault {
    TEST_PROPS.setProperty(APITEST, "uiDataNPEInvokeOnComponentTest");
    invoke();
  }

  /**
   * @testName: uiComponentInvokeOnComponentFETest
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:675
   * @test_Strategy: Validate that InvokeOnComponent() throws FacesException.
   */
  public void uiComponentInvokeOnComponentFETest() throws EETest.Fault {
    TEST_PROPS.setProperty(APITEST, "uiDataFEInvokeOnComponentTest");
    invoke();
  }

  /**
   * @testName: uiComponentIsSetRenderedTest
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:537; JSF:JAVADOC:562
   ...
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:536
   ...
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:545;JSF:JAVADOC:547
   ...
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:548; JSF:JAVADOC:625
   ...
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:546; JSF:JAVADOC:623
   * @test_Strategy: Validate that a NullPointerException is thrown when context
   *                 is null.
   */
   ...
   * @assertion_ids: JSF:JAVADOC:550; JSF:JAVADOC:627; JSF:JAVADOC:682
   ...
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:552; JSF:JAVADOC:629;
   *                 JSF:JAVADOC:684
   ...
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:553
   ...
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:554
   ...
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:539
   ...
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:540
   * @test_Strategy: Assert that a call to popComponentToEL removes "this"
   *                 component as being the current component and that the
   *                 previous UIComponent is set to the current component being
   *                 processed.
   ...
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:640; JSF:JAVADOC:559
   ...
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:567;JSF:JAVADOC:528
   ...
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:529
   ...
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:569; JSF:JAVADOC:709
   * @test_Strategy: Verify an NPE is thrown if a null value for the 'name'
   ...
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:568
   ...
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:570
   ...
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:2547
   ...
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:575
   ...
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:442;JSF:JAVADOC:447
   ...
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:443
   ...
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:444; JSF:JAVADOC:445
   ...
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:446
  ...
  /**
   * @testName: uiDataGetSetFirstTest
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:661; JSF:JAVADOC:688
   * @test_Strategy: Verify that getFirst() returns 0 on a newly created
   *                 component. Additionally verify that getFirst() will return
   *                 the value as set by setFirst().
   */
  public void uiDataGetSetFirstTest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiDataGetSetFirstTest");
    invoke();
  }

  /**
   * @testName: uiDataGetSetFooterTest
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:662; JSF:JAVADOC:690
   * @test_Strategy: Validate that we can set/get Footer Facet.
   */
  public void uiDataGetSetFooterTest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiDataGetSetFooterTest");
    invoke();
  }

  /**
   * @testName: uiDataGetSetHeaderTest
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:663; JSF:JAVADOC:693;
   *                 JSF:JAVADOC:692
   * @test_Strategy: Validate that we can set/get Header Facet.
   */
  public void uiDataGetSetHeaderTest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiDataGetSetHeaderTest");
    invoke();
  }

  /**
   * @testName: uiDataSetFooterNPETest
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:691
   * @test_Strategy: Validate that a NullPointerException is thrown when arg is
   *                 null.
   */
  public void uiDataSetFooterNPETest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiDataSetFooterNPETest");
    invoke();
  }

  /**
   * @testName: uiDataSetFirstIAETest
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:689
   * @test_Strategy: Verify setFirst() throws an IAE if the integer argument
   *                 provided is negative.
   */
  public void uiDataSetFirstIAETest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiDataSetFirstIAETest");
    invoke();
  }

  /**
   * @testName: uiDataIsRowAvailableTest
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:677
   * @test_Strategy: Verify the following: - No backing data; isRowAvailable()
   *                 returns false - Current row index is out of range;
   *                 isRowAvailable() returns false - Current row index points
   *                 to valid row, isRowAvailable() returns true
   */
  public void uiDataIsRowAvailableTest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiDataIsRowAvailableTest");
    invoke();
  }

  /**
   * @testName: uiDataBroadcastNPETest
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:481; JSF:JAVADOC:580;
   *                 JSF:JAVADOC:653
   * @testStrategy: Verify that if the FacesContext is passed in a
   *                NullPointerException is thrown.
   */
  public void uiDataBroadcastNPETest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiDataBroadcastNPETest");
    invoke();
  }

  /**
   * @testName: uiDataGetRowCountTest
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:664
   * @test_Strategy: Verify the following: - No backing data; getRowCount()
   *                 returns -1 - Valid backing data, getRowCount() returns the
   *                 value as returned from DataModel.getRowCount();
   */
  public void uiDataGetRowCountTest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiDataGetRowCountTest");
    invoke();
  }

  /**
   * @testName: uiDataGetRowDataTest
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:666
   * @test_Strategy: Verify the following: - getRowData() returns the expected
   *                 object when specifying various row index values
   */
  public void uiDataGetRowDataTest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiDataGetRowDataTest");
    invoke();
  }

  /**
   * @testName: uiDataGetRowDataIAETest
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:668
   * @test_Strategy: Verify the following: - getRowData() throws IAE if the no
   *                 data is available at the specified index. In this case, the
   *                 index is out of range
   */
  public void uiDataGetRowDataIAETest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiDataGetRowDataIAETest");
    invoke();
  }

  /**
   * @testName: uiDataGetSetRowIndexTest
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:694; JSF:JAVADOC:695
   * @test_Strategy: Verify the following: - getRowIndex returns -1 when called
   *                 against a newly created component. - if the var property
   *                 has been specified, and setRowIndex() is set to a valid
   *                 index, ensure the request scoped attribute name as
   *                 specified by var has the value as returned by
   *                 getDataValue(); - getRowIndex() returns the value as set by
   *                 setRowIndex()
   */
  public void uiDataGetSetRowIndexTest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiDataGetSetRowIndexTest");
    invoke();
  }

  /**
   * @testName: uiDataSetRowIndexIAETest
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:696
   * @test_Strategy: Verify the following: - setRowIndex() throws IAE if the
   *                 integer value specified is less than -1
   */
  public void uiDataSetRowIndexIAETest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiDataSetRowIndexIAETest");
    invoke();
  }

  /**
   * @testName: uiDataGetSetRowsTest
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:697; JSF:JAVADOC:671;
   *                 JSF:JAVADOC:698
   * @test_Strategy: Verify the following: - getRows() returns the value as
   *                 specified by setRows()
   */
  public void uiDataGetSetRowsTest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiDataGetSetRowsTest");
    invoke();
  }

  /**
   * @testName: uiDataSetRowsIAETest
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:689
   * @test_Strategy: Verify the following: - setRows() throws IAE if the integer
   *                 value specified is negative
   */
  public void uiDataSetRowsIAETest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiDataSetRowsIAETest");
    invoke();
  }

  /**
   * @testName: uiDataGetSetVarTest
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:673; JSF:JAVADOC:706
   * @test_Strategy: Verify the following: - getVar() returns the value as
   *                 specified by setVar()
   */
  public void uiDataGetSetVarTest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiDataGetSetVarTest");
    invoke();
  }

  /**
   * @testName: uiDataQueueEventNPETest
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:561; JSF:JAVADOC:687
   * @test_Strategy: Validate that a NullPointerException is thrown when arg is
   *                 null.
   */
  public void uiDataQueueEventNPETest() throws EETest.Fault {
    TEST_PROPS.setProperty(APITEST, "uiDataQueueEventNPETest");
    invoke();
  }

  /**
   * @testName: uiDataQueueEventISETest
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:561; JSF:JAVADOC:686;
   * @test_Strategy: Validate that a NullPointerException is thrown when arg is
   *                 null.
   */
  public void uiDataQueueEventISETest() throws EETest.Fault {
    TEST_PROPS.setProperty(APITEST, "uiDataQueueEventISETest");
    invoke();
  }

  /**
   * @testName: uiDataGetSetValueTest
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:661; JSF:JAVADOC:672;
   *                 JSF:JAVADOC:688; JSF:JAVADOC:699
   * @test_Strategy: Validate the value set vis setValue() is returned by
   *                 getValue().
   */
  public void uiDataGetSetValueTest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiDataGetSetValueTest");
    invoke();
  }

  /**
   * @testName: uiDataProcessDecodesNPETest
   * @assertion_ids: JSF:JAVADOC:542; JSF:JAVADOC:621; JSF:JAVADOC:680
   * @test_Strategy: Validate a NullPointerException is thrown when arg is null.
   */
  public void uiDataProcessDecodesNPETest() throws EETest.Fault {
    TEST_PROPS.setProperty(APITEST, "uiDataProcessDecodesNPETest");
    invoke();
  }

  /**
   * @testName: uiDataSetValueExpressionNPETest
   * @assertion_ids: JSF:JAVADOC:542; JSF:JAVADOC:621; JSF:JAVADOC:705
   * @test_Strategy: Validate a NullPointerException is thrown when String arg
   *                 is null.
   */
  public void uiDataSetValueExpressionNPETest() throws EETest.Fault {
    TEST_PROPS.setProperty(APITEST, "uiDataSetValueExpressionNPETest");
    invoke();
  }

  /**
   * @testName: uiDatatVisitTreeNPETest
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:709
   * @test_Strategy: Validate that a NullPointerException is thrown when any arg
   *                 is null.
   */
  public void uiDatatVisitTreeNPETest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiDatatVisitTreeNPETest");
    invoke();
  }

  /**
   * @testName: uiDataCreateUniqueIdTest
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:654
   * @test_Strategy: Validate that we are able to supplu a 'seed' to be included
   *                 into the generated Unique ID.
   */
  public void uiDataCreateUniqueIdTest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiDataCreateUniqueIdTest");
    invoke();
  }

  /**
   * @testName: uiDataIsSetRowStatePreservedTest
   * @assertion_ids: JSF:JAVADOC:707; JSF:JAVADOC:2550; JSF:JAVADOC:2554
   * @test_Strategy: Validate that we are able to set and that we get returned
   *                 the same value.
   */
  public void uiDataIsSetRowStatePreservedTest() throws Fault {
    TEST_PROPS.setProperty(APITEST, "uiDataIsSetRowStatePreservedTest");
    invoke();
  }

 ...
 * $Id$
 */
package com.sun.ts.tests.jsf.api.javax_faces.factoryfinder.altfacesconfig;
...
public class URLClient extends AbstractUrlClient {
  ...
  private static final String CONTEXT_ROOT = "/jsf_altfacesconfig_web";
   ...
   */
  /*
   * @testName: getFactoryAltfacesConfigTest
   * 
   ...
   * 
   */
  public void getFactoryAltfacesConfigTest() throws Fault {
    String factoryStyle = "AltfacesConfig";

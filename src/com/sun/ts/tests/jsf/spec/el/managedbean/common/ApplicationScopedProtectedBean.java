...
@jakarta.inject.Named("applicationScopedProtected") @jakarta.enterprise.context.ApplicationScoped
public class ApplicationScopedProtectedBean extends ScopedBean
    implements Serializable {

  protected @PostConstruct void onPostConstruct() {
    setPostConstructProperty(
        "application protected PostConstruct method invoked");
  }

  protected @PreDestroy void onPreDestroy() {
    PreDestroyProp.setPreDestroyProperty(
        "application protected PreDestroy method invoked");
  }

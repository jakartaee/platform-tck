...
public class internetaddress_Test extends ServiceEETest implements Serializable {
    ...
    public void contentType_Test() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("UNIT TEST 3:  ContentType(" + primaryType + "," + subType + ")");
            ...
            TestUtil.logMsg("UNIT TEST 4:  ContentType(" + primaryType + "," + subType + "," + pl + ")");
            ...
            if (errors > 0) {
                throw new Fault("contentType_Test Failed: No of unit test failed = " + errors);
            }
        } catch (Exception e) {
            logErr("Unexpected Exception " + e.getMessage());
            TestUtil.printStackTrace(e);

...
public class internetMimeMultipart_Test extends ServiceEETest {
    ...
    public void properties_Test() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("UNIT TEST 1:  test for parse(InputStream) with " + "no System properties set");
            clearAll();
            ...
            TestUtil.logMsg("UNIT TEST 3:  test for parse(InputStream) with " + "no boundary parameter");
            clearAll();
            ...
            TestUtil.logMsg("UNIT TEST 5:  test for parse(InputStream) with " + "no end boundary");
            clearAll();
            ...
            TestUtil.logMsg("UNIT TEST 6:  test for parse(InputStream) with " + "no end boundary"
            ...
            TestUtil.logMsg("UNIT TEST 7:  test for parse(InputStream) with " + "mail.mime.multipart.allowempty=true");
            clearAll();
            System.setProperty("mail.mime.multipart.allowempty", "true");

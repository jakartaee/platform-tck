...
public class Client extends EETest {
     ...
     * 5. bean calls isCallerInRole(emp_secrole_ref) and returns returnvalue. 6. Verify return value is true.
     *
     ...
     *
     * @test_Strategy: 1. Create two entity beans (say ejb1 and ejb2). 2. Link security role reference (roleref) to role1 in
     ...
     * @assertion_ids: EJB:SPEC:827
     *
     * @test_Strategy: 1. Create a bmp entity bean with a remote interface method permission unchecked 2. Verify that access
     * is allowed.
     *
     ...
     *
     * @test_Strategy: 1. Create a bmp entity bean with a remote method on exclude-list. 2. Verify java.rmi.RemoteException
     * is generated when the method is invoked. Note: "The exclude-list element defines a set of methods which the assembler
     * marks to be uncallable. It contains one or more methods. If the method permission relation contains methods that are
     * in the exclude list, the deployer should consider those methods to be uncallable."
     *

...
public class TestEJB implements EntityBean {
    ...
    public boolean IsCallerB2(String caller, java.util.Properties props) {
        try {
            ...
            TestUtil.logMsg("verifying caller principal " + caller + "in SecTest EJB");
    ...
    public boolean EjbSecRoleRefScope(String role, java.util.Properties props) {
        ...
        try {
            ...
            TestUtil.logErr("ERROR: Exception caught in method EjbSecRoleRefScope", e);
            return false;
        } finally {
            try {
                if (ejb1ref != null) {
    ...
    public boolean EjbOverloadedSecRoleRefs(String role1, String role2, java.util.Properties props) {
        ...
        try {
            ...
            TestUtil.logErr("EjbOverloadedSecRoleRefs(" + role1 + "," + role2 + ") failed with Exception: ", e);
            return false;
        } finally {
            try {
                if (ejb1ref != null) {
    ...
    public boolean excludetest1(java.util.Properties props) {
        try {
            ...
            TestUtil.logErr("ERROR: Unexpected exception caught during excludeTest1", e);
            cleanup(ejb1ref);
            return false;
        }
    }

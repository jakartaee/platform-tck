...
/*
 * @(#)Client.java	1.9 03/05/16
 */

package com.sun.ts.tests.ejb.ee.sec.cmp20.secrunaspropagation;

import com.sun.javatest.Status;
import com.sun.ts.lib.harness.EETest;
import com.sun.ts.lib.porting.TSLoginContext;
import com.sun.ts.lib.util.TSNamingContext;
import com.sun.ts.tests.ejb.ee.sec.cmp20.common.Test;
import com.sun.ts.tests.ejb.ee.sec.cmp20.common.TestHome;
...
public class Client extends EETest {
    ...
    /*
     * @class.setup_props: user; password; authuser; generateSQL;
     */
     ...
     *
     * @test_Strategy: 1. Create an entity cmp20 bean TestEJB with runas identity set to <Manager> 2. Create another entity
     * cmp20 bean SecTestEJB with method EjbIsAuthz 3. Protect the method with multiple security roles including <Manager>
     * 4. Call the bean TestEJB as a principal <username,password>. Which then invokes the method of the bean SecTestEJB. 5.
    ...
    public void test1() throws Fault {
        ...
        try {
            ejbref = ejbhome.create(1, "coffee-1", 1);
     ...
     *
     * @test_Strategy: 1. Create an entity cmp20 bean TestEJB with runas identity set to <Manager> 2. Create another entity
     * cmp20 bean SecTestEJB with method EjbNotAuthz 3. Protect the method with security role <Administrator> 4. Call the
     * bean TestEJB as a principal <username,password>. Which then invokes the method of the bean SecTestEJB. 5. Since then
     ...
     *
     * @test_Strategy: 1. Create an entity cmp20 bean TestEJB with runas identity set to <Manager> 2. Create another entity
     * cmp20 bean SecTestEJB with method EjbSecRoleRef. 3. Protect the method with security role <Employee>, Link a security
     ...
     *
     * @test_Strategy: 1. Create an entity cmp20 bean TestEJB with runas identity set to <Manager> 2. Create two more entity
     * cmp20 beans SecTestEJB and SecTestRoleRefEJB 3. Link security role reference (emp_secrole_ref) to role1 in ejb1 and
     ...
     *
     * @test_Strategy: 1. Create an entity cmp20 bean TestEJB with runas identity set to <Manager> 2. Create another entity
     * cmp20 beans SecTestEJB with overloaded methods. 3. Call method1 passing emp_secrole_ref. 4. Method1 returns
     ...
     *
     * @test_Strategy: 1. Create an entity cmp20 bean TestEJB with runas identity set to <Manager> 2. Create another entity
     * cmp20 beans SecTestEJB. 3. SecTestEJB returns isCallerInRole(mgr_secrole_ref) which must be true.
     */
     ...
     *
     * @test_Strategy: 1. Create an entity cmp20 bean TestEJB with runas identity set to <Manager> 2. Create another entity
     * cmp20 beans SecTestEJB. 3. SecTestEJB returns isCallerInRole(admin_secrole_ref) which must be false.
     */
     ...
     *
     * @test_Strategy: 1. Create an entity cmp20 bean TestEJB with runas identity set to <Manager> 2. Verify that TestEJB
     * returns the correct GetCallerPrincipal() which should not be affected by the bean's using runas identity.
     */
     ...
     *
     * @test_Strategy: 1. Create an entity cmp20 bean TestEJB with runas identity set to <Manager> 2. Create another entity
     * cmp20 bean SecTestEJB. 3. Verify that SecTestEJB returns the correct GetCallerPrincipal() which is the principal
     * using runas identity, but not the principal invoked TestEJB.
     */
     ...
     * @assertion_ids: EJB:SPEC:827
     *
     * @test_Strategy: 1. Create a cmp20 entity bean with runas identity invokes a remote method of the second bean. 2. Have
     ...
     *
     * @test_Strategy: 1. Create a cmp20 entity bean invokes a remote method of the second bean. 2. Set the first bean to
     * use runas identity. 3. Put the method of the second bean on exclude-list. 4. Verify java.rmi.RemoteException is
     * generated.
     */

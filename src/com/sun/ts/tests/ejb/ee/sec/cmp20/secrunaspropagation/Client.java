...
public class Client extends EETest {
     ...
     *
     * @test_Strategy: 1. Create an entity cmp20 bean TestEJB with runas identity
     * set to <Manager> 2. Create another entity cmp20 bean SecTestEJB with method
     ...
     *
     * @test_Strategy: 1. Create an entity cmp20 bean TestEJB with runas identity
     * set to <Manager> 2. Create two more entity cmp20 beans SecTestEJB and
     ...
     *
     * @test_Strategy: 1. Create an entity cmp20 bean TestEJB with runas identity
     * set to <Manager> 2. Create another entity cmp20 beans SecTestEJB with
     ...
     *
     * @test_Strategy: 1. Create an entity cmp20 bean TestEJB with runas identity
     * set to <Manager> 2. Create another entity cmp20 beans SecTestEJB. 3.
    ...
    public void test7() throws Fault {
        ...
        try {
            ...
            if (!ejbref.InRole(mgr_secrole_ref, props)) throw new Fault("caller in role positive test failed");
    ...
    public void test8() throws Fault {
        ...
        try {
            ...
            if (ejbref.InRole(admin_secrole_ref, props)) throw new Fault("caller in role negative test failed");
     ...
     *
     * @test_Strategy: 1. Create an entity cmp20 bean TestEJB with runas identity
     * set to <Manager> 2. Create another entity cmp20 bean SecTestEJB. 3. Verify
    ...
    public void test10() throws Fault {
        ...
        try {
            ...
            if (ejbref.IsCallerB2(username, props)) throw new Fault("second bean's getCallerPrincipal test failed");

            if (!ejbref.IsCallerB2(authuser, props)) throw new Fault("second bean's getCallerPrincipal test failed");
     ...
     * @assertion_ids: EJB:SPEC:827
     *
     * @test_Strategy: 1. Create a cmp20 entity bean with runas identity invokes a
     ...
     *
     * @test_Strategy: 1. Create a cmp20 entity bean invokes a remote method of
     * the second bean. 2. Set the first bean to use runas identity. 3. Put the

...
package com.sun.ts.tests.ejb.ee.sec.stateful.lsecr;
...
public class Client extends EETest {
     ...
     *
     * @test_Strategy: 1. Create a stateful session bean using run-as identity accessing a method of a second bean. 2.
     ...
     *
     * @test_Strategy: 1. Create a stateful session bean using run-as identity accessing a method of a second bean. 2.
     * Protect the method using a security role (role1). while run-as identity is in. 3. Link a security role name -
     * emp_secrole - to role1 in the bean. 4. Invoke the method with emp_secrole as parameter. 5. bean calls
     ...
     *
     * @test_Strategy: 1. Create a stateful session bean using run-as identity accessing a method of a second bean. 2. Link
     * security role name (roleref) to role1 in ejb1 and role2 in ejb2. 3. Ensure run-as identity is in role1 but not in
     ...
     *
     * @test_Strategy: 1. Create a stateful session bean using run-as identity accessing a second bean with overloaded
     * methods: method1 and method2. 2. Call method1 passing emp_secrole, which run-as identity is in. 3. Method1 returns
     * isCallerInRole(emp_secrole) which must be true. 4. Call method2 passing two role references as parameters. 5. Method
     * must return false. (Make sure run-as identity not in both security roles)
     */
     ...
     *
     * @test_Strategy: 1. Create a stateful session bean using run-as identity accessing a method of a second bean. 2.
     * Protect the second bean's method with multiple security roles. 3. Call the method as run-as identity which is not in
     * any of the security roles that protects the method. 4. Verify jakarta.ejb.EJBException is generated.
     */
     ...
     *
     * @test_Strategy: 1. Create a stateful session bean using runas identity invokes a local method of the second bean. 2.
     * Put this local method on exclude-list. 3. Verify jakarta.ejb.EJBException is generated.
     */

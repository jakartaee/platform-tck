...
public class Client extends EETest {
    ...
    public void test1() throws Fault {
        ...
        try {
            ...
            try {
                ...
                logErr("ERROR:  Unexpected exception occurred removing ejb1ref in test1: ", ex1);
            }
        } catch (Exception en) {
            try {
                if (ejb1ref != null) {
     ...
     * @assertion_ids: EJB:SPEC:827
     *
     * @test_Strategy: 1. Create a cmp entity bean with a remote interface method permission unchecked 2. Verify that access
     * is allowed.
     */
     ...
     *
     * @test_Strategy: 1. Create a cmp entity bean with a remote method on exclude-list. 2. Verify java.rmi.RemoteException
     * is generated when the method is invoked.
     */
    ...
    public void test8() throws Fault {
        try {
            ...
            try {
                if (ejb1ref != null) {
                    TestUtil.logTrace("removing ejb1ref from test8 in expected catch block");
                    ejb1ref.remove();
                    TestUtil.logTrace("ejb1ref removed from test8 in expected catch block");
                }
            } catch (Exception ex1) {
                logErr("ERROR:  Unexpected exception occurred removing ejb1ref in test8: ", ex1);
            }
        } catch (Exception en) {
            try {
                if (ejb1ref != null) {
                    TestUtil.logTrace("removing ejb1ref from test8 in unexpected catch block");
                    ejb1ref.remove();
                    TestUtil.logTrace("ejb1ref removed from test8 in unexpected catch block");
                }
            } catch (Exception ex1) {

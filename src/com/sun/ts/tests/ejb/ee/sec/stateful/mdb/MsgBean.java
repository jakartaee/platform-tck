...
public class MsgBean implements MessageDrivenBean, MessageListener {
    ...
    public void onMessage(Message msg) {
        ...
        try {
            ...
            context = new TSNamingContext();
            TestUtil.logTrace("@MsgBean() onMessage! Looking up the ejb home " + context);
            ejbhome = (TestHome) context.lookup("java:comp/env/ejb/Test", TestHome.class);
            ...
            if (msg.getStringProperty("MessageType").equals("TextMessage")) {
                ...
                try {
                    ...
                    TestUtil.logMsg("@OnMessage!  Got expected exception: " + ex.getMessage());
                    sendATextMessage();
                }

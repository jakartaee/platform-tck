...
public class Client extends EETest {
   ...
   *
   * @test_Strategy: 1. Create a cmp20 entity bean which invokes a local method
   * of a second cmp20 bean. 2. Protect the method within the bean with multiple
   ...
   *
   * @test_Strategy: 1. Create a cmp20 entity bean which invokes a local method
   * of a second cmp20 bean. 2. Protect the method in the bean using a security
   * role (role1). 3. Link a security role name - emp_secrole - to role1 in the
   * bean. 4. Invoke the method with emp_secrole as parameter. 5. bean calls
   ...
   *
   * @test_Strategy: 1. Create a cmp20 entity bean which invokes a local method
   * of a second cmp20 bean. 2. Link a security role name - mgr_secrole - to
   * role1 in the bean. 3. Invoke the method with mgr_secrole as a parameter. 4.
   ...
   * 
   * @test_Strategy: 1. Create a cmp20 entity bean which invokes a local method
   * of two cmp20 entity beans (ejb1 and ejb2). 2. Link security role reference
   ...
   * 
   * @test_Strategy: 1. Create a cmp20 entity bean which invokes a second cmp20
   * bean with overloaded methods: method1 and method2. 2. Call method1 passing
   ...
   * must return false ( caller not in both security roles).
   */
   ...
   *
   * @test_Strategy: 1. Create a cmp20 entity bean which invokes a local method
   * of a second cmp20 bean. 2. Protect the bean method with multiple security
   * roles. 3. Call bean method as a principal who is not in any of the security
   * roles that protects the method. 4. Verify jakarta.ejb.EJBException is
   * generated.
   */

...
package com.sun.ts.tests.ejb.ee.sec.stateless.lsecp;

import com.sun.javatest.Status;
import com.sun.ts.lib.harness.EETest;
import com.sun.ts.lib.porting.TSLoginContext;
import com.sun.ts.lib.util.TSNamingContext;
import com.sun.ts.tests.ejb.ee.sec.stateless.common.lTest;
import com.sun.ts.tests.ejb.ee.sec.stateless.common.lTestHome;
...
public class Client extends EETest {
     ...
     *
     * @test_Strategy: 1. Create a stateless session bean accessing a local method of a second bean 2. Protect the method
     * within the bean with multiple security roles. 3. Call bean method as a principal who is in one or some of the
     ...
     *
     * @test_Strategy: 1. Create a stateless session bean accessing a local method of a second bean 2. Protect the method in
     ...
     *
     * @test_Strategy: 1. Create a stateless session bean accessing a local method of a second bean 2. Authenticate caller
     ...
     *
     * @test_Strategy: 1. Create a stateless session bean accessing two other beans (ejb1 and ejb2)'s local methods. 2. Link
     ...
     *
     * @test_Strategy: 1. Create a stateless session bean accessing another bean's local methods which is overloaded:
     * method1 and method2. 2. Call method1 passing emp_secrole. 3. Method1 returns isCallerInRole(emp_secrole) which must
     * be true. 4. Call method2 passing two role references as parameters. 5. Method must return false ( caller not in both
     * security role refs).
     */
     ...
     *
     * @test_Strategy: 1. Create a stateless session bean accessing a local method of a second bean 2. Protect the bean
     ...
     *
     * @test_Strategy: 1. Create a stateless session bean invokes a local method of the second bean. 2. Put this local
     * method on exclude-list. 3. Verify jakarta.ejb.EJBException is generated.
     */

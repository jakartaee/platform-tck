...
public class Client extends EETest {
     ...
     *
     * @test_Strategy: 1. Create a cmp entity bean which invokes a method of a
     * second cmp bean. 2. Protect the method within the bean with multiple
     * security roles. 3. Call bean method as a principal who is in one some of
     ...
     *
     * @test_Strategy: 1. Create a cmp entity bean which access a method of a
     * second cmp bean. 2. Protect the method in the bean using a security role
     ...
     *
     * @test_Strategy: 1. Create a cmp entity bean invoking a method of a second
     * cmp bean. 2. Protect the method in the bean using a security role (role1).
     * 3. Link a security role ref - emp_secrole_ref - to role1 in the bean. 4.
     ...
     *
     * @test_Strategy: 1. Create a cmp bean accessing two cmp entity beans (ejb1
     * and ejb2). 2. Link security role reference (roleref) to role1 in ejb1 and
     * role2 in ejb2. 3. Ensure caller principal is in role1 but not in role2. 4.
     * Invoke method in ejb1 that returns value of isCallerInRole(roleref). Verify
     * return value is true. 5. Invoke method in ejb2 that returns value of
     ...
     *
     * @test_Strategy: 1. Create a cmp entity bean accessing a second cmp bean
     ...
     * @assertion_ids: EJB:SPEC:827
     *
     * @test_Strategy: 1. Create a cmp entity bean accessing a method of a second
     * cmp bean. 2. Protect the bean method with multiple security roles. 3. Call
     ...
     * @assertion_ids: EJB:SPEC:827
     *
     * @test_Strategy: 1. Create a cmp entity bean invokes a remote method of the

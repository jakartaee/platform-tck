...
package com.sun.ts.tests.ejb.ee.sec.cmp20.secpropagation;
...
public class Client extends EETest {
     ...
     *
     * @test_Strategy: 1. Create a cmp entity bean which invokes a method of a second cmp bean. 2. Protect the method within
     * the bean with multiple security roles. 3. Call bean method as a principal who is in one some of the security roles
     * but not in others. 4. Verify call returns successfully.
     */
     ...
     *
     * @test_Strategy: 1. Create a cmp entity bean which access a method of a second cmp bean. 2. Protect the method in the
     ...
     *
     * @test_Strategy: 1. Create a cmp entity bean invoking a method of a second cmp bean. 2. Protect the method in the bean
     ...
     *
     * @test_Strategy: 1. Create a cmp bean accessing two cmp entity beans (ejb1 and ejb2). 2. Link security role reference
     * (roleref) to role1 in ejb1 and role2 in ejb2. 3. Ensure caller principal is in role1 but not in role2. 4. Invoke
     * method in ejb1 that returns value of isCallerInRole(roleref). Verify return value is true. 5. Invoke method in ejb2
     ...
     *
     * @test_Strategy: 1. Create a cmp entity bean accessing a second cmp bean with overloaded methods: method1 and method2.
     * 2. Call method1 passing emp_secrole_ref. 3. Method1 returns isCallerInRole(emp_secrole_ref) which must be true. 4.
     * Call method2 passing two role references as parameters. 5. Method must return false ( caller not in both security
     * role refs).
     */
    ...
    public void test2() throws Fault {
        ...
        try {
            ...
            if (!ejbref.EjbOverloadedSecRoleRefs(emp_secrole_ref, mgr_secrole_ref, props))
     ...
     * @assertion_ids: EJB:SPEC:827
     *
     * @test_Strategy: 1. Create a cmp entity bean accessing a method of a second cmp bean. 2. Protect the bean method with
     * multiple security roles. 3. Call bean method as a principal who is not in any of the security roles that protects the
     * method. 4. Verify java.rmi.RemoteException is generated.
     */
     ...
     * @assertion_ids: EJB:SPEC:827
     *
     * @test_Strategy: 1. Create a cmp entity bean invokes a remote method of the second bean. 2. Have this method with
     ...
     *
     * @test_Strategy: 1. Create a cmp entity bean invokes a remote method of the second bean. 2. Put this method on
     * exclude-list. 3. Verify java.rmi.RemoteException is generated.
     */
    ...
    public void test8() throws Fault {
        ...
        try {
            ...
            if (!ejbref.excludetest1(props)) {
                ...
                throw new Fault("exclude-list test1 failed");
            }

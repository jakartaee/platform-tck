...
public class Client extends EETest {
     ...
     *
     * @test_Strategy: 1. Create an entity cmp bean TestEJB with runas identity set to <Manager> 2. Create another entity
     * cmp bean SecTestEJB with method EjbIsAuthz 3. Protect the method with multiple security roles including <Manager> 4.
     ...
     *
     * @test_Strategy: 1. Create an entity cmp bean TestEJB with runas identity set to <Manager> 2. Create another entity
     * cmp bean SecTestEJB with method EjbNotAuthz 3. Protect the method with security role <Administrator> 4. Call the bean
     ...
     *
     * @test_Strategy: 1. Create an entity cmp bean TestEJB with runas identity set to <Manager> 2. Create another entity
     * cmp bean SecTestEJB with method EjbSecRoleRef. 3. Protect the method with security role <Employee>, Link a security
     * role ref - emp_secrole_ref to role <Employee>. 4. Call the bean TestEJB as a principal <username,password>. Which
     * then invokes the method of the bean SecTestEJB. 5. Since then TestEJB uses runas identity, <Manager>, whose
     ...
     *
     * @test_Strategy: 1. Create an entity cmp bean TestEJB with runas identity set to <Manager> 2. Create two more entity
     * cmp beans SecTestEJB and SecTestRoleRefEJB 3. Link security role reference (emp_secrole_ref) to role1 in ejb1 and
     ...
     *
     * @test_Strategy: 1. Create an entity cmp bean TestEJB with runas identity set to <Manager> 2. Create another entity
     * cmp beans SecTestEJB with overloaded methods. 3. Call method1 passing emp_secrole_ref. 4. Method1 returns
     ...
     *
     * @test_Strategy: 1. Create an entity cmp bean TestEJB with runas identity set to <Manager> 2. Create another entity
     * cmp beans SecTestEJB. 3. SecTestEJB returns isCallerInRole(mgr_secrole_ref) which must be true.
     */
     ...
     *
     * @test_Strategy: 1. Create an entity cmp bean TestEJB with runas identity set to <Manager> 2. Create another entity
     * cmp beans SecTestEJB. 3. SecTestEJB returns isCallerInRole(admin_secrole_ref) which must be false.
     */
     ...
     *
     * @test_Strategy: 1. Create an entity cmp bean TestEJB with runas identity set to <Manager> 2. Verify that TestEJB
     ...
     *
     * @test_Strategy: 1. Create an entity cmp bean TestEJB with runas identity set to <Manager> 2. Create another entity
     * cmp bean SecTestEJB. 3. Verify that SecTestEJB returns the correct GetCallerPrincipal() which is the principal using
    ...
    public void test10() throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("verify caller principal for caller" + username);
            if (ejbref.IsCallerB2(username, props))
                throw new Fault("second bean's getCallerPrincipal test failed");

            TestUtil.logMsg("verify caller principal for caller" + authuser);
     ...
     * @assertion_ids: EJB:SPEC:827
     *
     * @test_Strategy: 1. Create a cmp entity bean with runas identity invokes a remote method of the second bean. 2. Have
     ...
     *
     * @test_Strategy: 1. Create a cmp entity bean invokes a remote method of the second bean. 2. Set the first bean to use

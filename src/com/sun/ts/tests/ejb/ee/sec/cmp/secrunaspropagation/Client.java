...
public class Client extends EETest {
     ...
     *
     * @test_Strategy: 1. Create an entity cmp bean TestEJB with runas identity
     * set to <Manager> 2. Create another entity cmp bean SecTestEJB with method
     ...
     * <Manager>, whose principals also in role <Employee> so access to the method
     ...
     *
     * @test_Strategy: 1. Create an entity cmp bean TestEJB with runas identity
     * set to <Manager> 2. Create two more entity cmp beans SecTestEJB and
     ...
     *
     * @test_Strategy: 1. Create an entity cmp bean TestEJB with runas identity
     * set to <Manager> 2. Create another entity cmp beans SecTestEJB with
     ...
     *
     * @test_Strategy: 1. Create an entity cmp bean TestEJB with runas identity
     * set to <Manager> 2. Create another entity cmp beans SecTestEJB. 3.
     ...
     *
     * @test_Strategy: 1. Create an entity cmp bean TestEJB with runas identity
     * set to <Manager> 2. Create another entity cmp bean SecTestEJB. 3. Verify
     ...
     * @assertion_ids: EJB:SPEC:827
     *
     * @test_Strategy: 1. Create a cmp entity bean with runas identity invokes a

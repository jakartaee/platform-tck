...
/*
 * @(#)TestBeanEJB.java	1.23 03/05/16
 */

package com.sun.ts.tests.ejb.ee.tx.session.stateful.bm.TxRN_GlobalSingle;
...
public class TestBeanEJB implements SessionBean {
    ...
    public boolean test1() {
        ...
        try {
            ...
            /*
             * try { dbResults = beanRef.getResults(tName); } catch (java.rmi.RemoteException re) { // Table or view should not
             * exist TestUtil.logTrace("Caught expected RemoteException"); b3 = true; }
             *
             */
            if (b1 && b2 && b3)
                testResult = true;

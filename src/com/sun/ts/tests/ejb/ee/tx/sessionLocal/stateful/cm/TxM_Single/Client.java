...
public class Client extends EETest {
     ...
     * this operation executes successfully and that the jakarta.transaction.TransactionRequiredLocalException exception is
     * not thrown. Call a method with the same name but a different parameter list that has no Style 3 declaration (hence
     * the Style 2 declaration applies). Ensure that this operation throws the jakarta.ejb.TransactionRequiredLocalException
     * exception.
     *
     */

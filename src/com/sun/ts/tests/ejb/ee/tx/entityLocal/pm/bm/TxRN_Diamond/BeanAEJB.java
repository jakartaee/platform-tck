...
public class BeanAEJB implements SessionBean {
    ...
    public void ejbCreate(Properties p) throws CreateException {
        ...
        try {
            ...
            // TxEPMBean - BeanD
            TestUtil.logMsg("Getting the EJB Home interface for " + txEPMBeanRequiresNew);
            ...
            RefTxEPMBean = (TxEPMBean) beanHome.create(tName1, new Integer(1), tName1 + "-1", (float) 1, testProps);
    ...
    public boolean test1() {
        ...
        TestUtil.logTrace("Commit a transaction involving a Tx Diamond - RequiresNew");
        ...
        try {
            ...
            if (RefTxEPMBean != null)
                try {
                    ...
                    TestUtil.logErr("Exception removing Bean TxEPMBean: " + e.getMessage(), e);
                }
            ;
        }
    }
    ...
    public boolean test2() {
        ...
        TestUtil.logTrace("Rollback a transaction involving a Tx Diamond - RequiresNew");
    ...
    private void initLogging(Properties p) {
        ...
        try {
            ...
            // Get the table names
            this.tName1 = TestUtil.getTableName(TestUtil.getProperty("TxEPMBean_Delete"));

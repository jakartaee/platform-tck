...
public class Client extends EETest {
    ...
    private static final String testName = "TxBM_GlobalSingle";
     ...
     * @testName: test1
     *
     * @assertion_ids: EJB:SPEC:543.1; EJB:SPEC:543.2
     *
     * @test_Strategy: Create a stateful session TX_BEAN_MANAGED bean. Obtain the UserTransaction interface. Perform a
     * global transaction using the TxBean (deployed as TX_BEAN_MANAGED) to a single RDBMS table.
     *

...
public class Client extends EETest {
     ...
     *
     * @test_Strategy: Container managed Tx commit - Required Entity EJBs. Create a few instances of an Entity EJB
     * (TxEPMBean) bean. Perform updates to the Entity EJB's instance data. Ensure that the instance data is updated on
     * method return. Ensure that the database fields are updated on method return.
     *
     */
     ...
     * (TxEPMBean) bean, without a transaction context. Ensure that javax.transacton.TransactionRequiredException exception
     * is thrown.
     *
     */

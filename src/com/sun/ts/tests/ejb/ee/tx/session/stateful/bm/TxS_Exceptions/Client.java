...
package com.sun.ts.tests.ejb.ee.tx.session.stateful.bm.TxS_Exceptions;
...
public class Client extends EETest {
     ...
     * of a stateful session TxBean (Supports) bean. Initiate a bean managed transaction and perform a delete row operation
     ...
     * stateful session TxBean (Supports) bean. Initiate a bean managed transaction and perform a delete row operation to a

...
package com.sun.ts.tests.ejb.ee.tx.session.stateless.bm.TxR_Exceptions;
...
public class Client extends EETest {
     ...
     * of a stateless session TxBean (Required) bean. Initiate a bean managed transaction and perform a delete row operation
     ...
     * stateless session TxBean (Required) bean. Initiate a bean managed transaction and perform a delete row operation to a

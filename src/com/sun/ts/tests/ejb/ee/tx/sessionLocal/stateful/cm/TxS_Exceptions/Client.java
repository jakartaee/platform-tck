...
package com.sun.ts.tests.ejb.ee.tx.sessionLocal.stateful.cm.TxS_Exceptions;
...
public class Client extends EETest {
     ...
     * operation to a table and throw SystemException. Ensure that the instance gets discarded. Ensure that the local client
     ...
     * a table and throw Error. Ensure that the instance gets discarded. Ensure that the client receives EJBException.
     */

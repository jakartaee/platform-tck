...
package com.sun.ts.tests.ejb.ee.tx.entityLocal.pm.bm.TxR_Exceptions;

import com.sun.ts.lib.util.RemoteLoggingInitException;
import com.sun.ts.lib.util.TSNamingContext;
import com.sun.ts.lib.util.TestUtil;
import com.sun.ts.tests.ejb.ee.tx.txEPMbeanLocal.AppException;
...
public class TestBeanEJB implements SessionBean {
    ...
    public boolean test1() {
        ...
        try {
            TestUtil.logTrace("Looking up the TxEPMBean Home interface of " + txEPMBeanRequired);
    ...
    public boolean test3() {
        ...
        try {
            ...
            TestUtil.logTrace("Creating EJB instances of " + txEPMBeanRequired);
            beanref1 = (TxEPMBean) beanHome.create(tName1, key1, brand1, (float) 1, testProps);
            ...
            ut.begin();
            try {
                beanref2 = (TxEPMBean) beanHome.create(tName1, key1, brand2, (float) 1, testProps);
            } catch (Exception e1) {
                TestUtil.logMsg("Expected exception caught trying to " + "create bean with same PK");
                testResult = true;
            }
            ...
            try {
                ...
                if (!brand1.equals(result)) {
                    TestUtil.logErr("Wrong brand name:  Expected: " + brand1 + " Received: " + result);
                    testResult = false;
                } else {
                    testResult = true;
                }
            ...
            try {
                ...
                TestUtil.logErr("Expected exception removing beanref2" + "  - should not exist");
            }
        }
        return (testResult);
    }
    ...
    public boolean test6() {
        ...
        try {
            ...
            beanHome = (TxEPMBeanHome) jctx.lookup(txEPMBeanRequired);
            TestUtil.logTrace("Creating EJB instances of " + txEPMBeanRequired);
            beanref = (TxEPMBean) beanHome.create(tName1, key1, brand1, (float) 1, testProps);

...
package com.sun.ts.tests.ejb.ee.tx.sessionLocal.stateful.bm.TxRN_GlobalSingle;
...
public class Client extends EETest {
     ...
     * global transactions using the TxBean (deployed as TX_REQUIRESNEW) to a single RDBMS table.
     *

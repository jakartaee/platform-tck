...
/*
 * @(#)BeanBEJB.java	1.18 03/05/16
 */

/*
 * @(#)BeanBEJB.java	1.16 03/03/05
 */
...
public class BeanBEJB implements SessionBean {
    ...
    public boolean helloB() throws RemoveException {
        ...
        try {
            TestUtil.logMsg("Looking up the TxEBean Home interface of " + txEBeanRequiresNew);
            beanHome = (TxEBeanHome) jctx.lookup(txEBeanRequiresNew, TxEBeanHome.class);
            beanRef = (TxEBean) beanHome.findtxEbean(tName1, new Integer(1), testProps);

...
package com.sun.ts.tests.ejb.ee.tx.session.stateless.cm.TxN_Exceptions;
...
public class Client extends EETest {
     ...
     * a stateless session TxBean (Never) bean. Perform a delete row operation to a table and throw AppException. Ensure
     ...
     * of a stateless session TxBean (Never) bean. Initiate a container managed transaction and perform delete row operation
     ...
     * a stateless session TxBean (Never) bean. Initiate a container managed transaction and perform delete row operation to
     ...
     * stateless session TxBean (Never) bean. Initiate a container managed transaction and perform delete row operation to a

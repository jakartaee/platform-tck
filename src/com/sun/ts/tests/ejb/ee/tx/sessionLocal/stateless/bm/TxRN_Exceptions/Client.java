...
package com.sun.ts.tests.ejb.ee.tx.sessionLocal.stateless.bm.TxRN_Exceptions;
...
public class Client extends EETest {
     ...
     * a stateless session TxBean (RequiresNew) bean. Initiate a bean managed transaction and perform a delete row operation
     ...
     * of a stateless session TxBean (RequiresNew) bean. Initiate a bean managed transaction and perform a delete row
     ...
     * stateless session TxBean (RequiresNew) bean. Initiate a bean managed transaction and perform a delete row operation

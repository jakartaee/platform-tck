...
public class TestBeanEJB implements SessionBean {
    ...
    public boolean test1() {
        ...
        try {
            ...
            beanRef = (TxEPMBean) beanHome.create(tName1, new Integer(1), origName, (float) 1, testProps);
    ...
    public boolean test2() {
        ...
        try {
            ...
            try {
                beanRef.updateBrandName(expName, TxEPMBeanEJB.FLAGAPPEXCEPTIONWITHROLLBACK);
    ...
    public boolean test3() {
        ...
        try {
            TestUtil.logTrace("Looking up the TxEPMBean Home interface of " + txEPMBeanMandatory);
            beanHome = (TxEPMBeanHome) jctx.lookup(txEPMBeanMandatory, TxEPMBeanHome.class);
    ...
    public boolean test4() {
        ...
        try {
            TestUtil.logTrace("Looking up the TxEPMBean Home interface of " + txEPMBeanTxRequiresNew);
            beanHome = (TxEPMBeanHome) jctx.lookup(txEPMBeanTxRequiresNew, TxEPMBeanHome.class);

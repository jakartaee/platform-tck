...
package com.sun.ts.tests.ejb.ee.tx.session.stateful.cm.Tx_SetRollbackOnly;
...
public class Client extends EETest {
     ...
     * instance of a stateful session TxBean (Required) bean. Perform a delete row operation to a table and force a rollback
     * via EJBContext.setRollbackOnly(). Ensure the EJBContext.getRollbackOnly() status returns true. Ensure the transaction
     * is rolledback.
     */
     ...
     * an instance of a stateful session TxBean (Required) bean. Perform a delete row operation to a table and force a
     ...
     * Testbean bean. Create an instance of a stateful session TxBean (Required) bean. Perform a delete row operation to a

...
package com.sun.ts.tests.ejb.ee.tx.sessionLocal.stateful.bm.TxBM_GlobalSingle;
...
public class TestBeanEJB implements SessionBean {
    ...
    private static final String TxBeanBeanManaged = "java:comp/env/ejb/TxBeanManaged";
    ...
    public void ejbCreate() throws CreateException {
        ...
        try {
            ...
            TestUtil.logMsg("Looking up the TxBean Home interface of " + TxBeanBeanManaged);
            beanHome = (TxBeanHome) jctx.lookup(TxBeanBeanManaged);
    ...
    public boolean test1() {
        ...
        try {
            TestUtil.logTrace("Creating EJB instance of " + TxBeanBeanManaged);
    ...
    public boolean test2() {
        ...
        try {
            ...
            for (int i = 1; i <= size; i++) {
                if (i >= tRngFrom && i <= tRngTo) continue;
                else {
                    if (dbResults.contains(new Integer(i))) {
                        b2 = true;
                    } else {
    ...
    public void initLogging(Properties p) {
        ...
        this.testProps = p;
        // Get the table name
        this.tName = TestUtil.getTableName(testProps.getProperty("TxBean_Tab1_Delete"));

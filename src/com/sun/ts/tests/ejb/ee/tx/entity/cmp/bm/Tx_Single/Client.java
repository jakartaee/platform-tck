...
public class Client extends EETest {
     ...
     * Entity EJB (TxECMPBean) bean. Update some Data in the bean. Commit the transaction. Create an instance of the
     ...
     * Entity EJB (TxECMPBean) bean. Commit the creation of the bean. Start another transaction Update some Data in the
     ...
     *
     * @test_Strategy: Bean managed Tx commit - Required Entity EJBs. Start a user Transaction Create an instance of an
     * Entity EJB (TxECMPBean) bean. Commit the transaction. Start a user Transaction Create an instance of the previously
     ...
     * Entity EJB (TxEBean) bean. Perform an update to the Entity EJB's instance data. Commit the transaction. Create an
     * instance of the previously created bean, by doing a findByPrimaryKey(). Ensure that the instance data reflects the

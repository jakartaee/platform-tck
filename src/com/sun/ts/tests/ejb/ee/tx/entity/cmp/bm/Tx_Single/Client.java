...
public class Client extends EETest {
   ...
   * Transaction Create an instance of an Entity EJB (TxECMPBean) bean. Update
   ...
   * user Transaction Create an instance of an Entity EJB (TxECMPBean) bean.
   ...
   *
   * @test_Strategy: Bean managed Tx commit - Required Entity EJBs. Start a user
   * Transaction Create an instance of an Entity EJB (TxECMPBean) bean. Commit

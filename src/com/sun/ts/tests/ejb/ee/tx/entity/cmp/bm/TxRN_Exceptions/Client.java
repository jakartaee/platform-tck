...
public class Client extends EETest {
     ...
     * instance of an Entity TxEBean(RequiresNew) bean. - Cause an AppException in the Entity bean. - Ensure that the client
     ...
     * instance of an Entity TxEBean(RequiresNew) bean. - Cause a SysException in the Entity bean. - Ensure that the client
     * receives RemoteException. - Check that the client transaction(t1) is still active or marked for rollback. - Verify
     ...
     * instance of an Entity TxEBean(RequiresNew) bean. - Cause a EJBException in the Entity bean. - Ensure that the client
     * receives RemoteException. - Check that the client transaction(t1) is still active or marked for rollback. - Verify
     * the transaction did not commit.
     *
     */
     ...
     * of an Entity TxEBean(RequiresNew) bean. - Cause a Error in the Entity bean. - Ensure that the client receives
     * RemoteException. - Check that the client transaction(t1) is still active or marked for rollback. - Verify the

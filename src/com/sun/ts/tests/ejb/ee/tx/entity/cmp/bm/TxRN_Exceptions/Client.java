...
public class Client extends EETest {
   ...
   * Ensure that the client receives RemoteException. - Check that the client
   * transaction(t1) is still active or marked for rollback. - Verify the
   ...
   * that the client receives RemoteException. - Check that the client
   * transaction(t1) is still active or marked for rollback. - Verify the
   * transaction did not commit.
   *
   */

...
/*
 * @(#)TxEPMBeanEJB.java	1.13 03/05/16
 */
...
public abstract class TxEPMBeanEJB implements EntityBean {
    ...
    public Integer ejbCreate(String tName, Integer key, String brand, float price, Properties p)
    ...
    public void ejbPostCreate(String tName, Integer key, String brand, float price, Properties p)

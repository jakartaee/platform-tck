...
package com.sun.ts.tests.ejb.ee.tx.session.stateless.bm.TxRN_Single;
...
public class TestBeanEJB implements SessionBean {
    ...
    private static final String txBeanRequiresNewStateless = "java:comp/env/ejb/TxRequiresNew.STATELESS";
    ...
    public void ejbCreate() throws CreateException {
        ...
        try {
            ...
            TestUtil.logMsg("Looking up the TxBean Home interface of " + txBeanRequiresNewStateless);
            beanHome = (TxBeanHome) jctx.lookup(txBeanRequiresNewStateless, TxBeanHome.class);
    ...
    public boolean test1() {
        ...
        try {
            TestUtil.logTrace("Creating EJB instance of " + txBeanRequiresNewStateless);

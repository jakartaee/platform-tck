...
public class Client extends EETest {
     ...
     * a stateless session TxBean (NotSupported) bean. Initiate a bean managed transaction and perform a delete row
     * operation to a table and throw AppException. Ensure that the exception does not cause an automatic rolledback. Ensure
     * that the client receives AppException.
     */
     ...
     * of a stateless session TxBean (NotSupported) bean. Initiate a bean managed transaction and perform a delete row
     ...
     * stateless session TxBean (NotSupported) bean. Initiate a bean managed transaction and perform a delete row operation
     * to a table and throw Error. Ensure that the instance gets discarded. Ensure that the client receives EJBException.
     */

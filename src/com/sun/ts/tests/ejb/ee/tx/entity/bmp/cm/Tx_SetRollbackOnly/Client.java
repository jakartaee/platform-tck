...
public class Client extends EETest {
   ...
   * stateful session Testbean bean. Create an instance of a Entity TxEBean
   ...
   * Entity TxEBean (Required) bean. Perform a update operation to a table and
   * force a rollback via EJBContext.setRollbackOnly() as well as forcing the
   * method to throw an AppException. Ensure the getTXRollbackOnly() status
   ...
   * of a stateful session Testbean bean. Create an instance of a Entity TxEBean
   * (RequiresNew) bean. Perform a update operation to a table and force a
   * rollback via EJBContext.setRollbackOnly(). Ensure the
   ...
   * Create an instance of a stateful session Testbean bean. Create an instance
   * of a Entity TxEBean (RequiresNew) bean. Perform a update operation to a

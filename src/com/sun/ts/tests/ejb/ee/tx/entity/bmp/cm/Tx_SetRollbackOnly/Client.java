...
public class Client extends EETest {
     ...
     * instance of a Entity TxEBean (Required) bean. Perform a update operation to a table and force a rollback via
     ...
     * Testbean bean. Create an instance of a Entity TxEBean (Required) bean. Perform a update operation to a table and
     ...
     * an instance of a Entity TxEBean (RequiresNew) bean. Perform a update operation to a table and force a rollback via
     * EJBContext.setRollbackOnly(). Ensure the EJBContext.getRollbackOnly() status returns true. Ensure the transaction is
     * rolledback.
     */
     ...
     * Testbean bean. Create an instance of a Entity TxEBean (RequiresNew) bean. Perform a update operation to a table and
     * force a rollback via EJBContext.setRollbackOnly() as well as forcing the method to throw an AppException. Ensure the
     * getTXRollbackOnly() status returns true. Ensure the transaction is rolledback.
     */

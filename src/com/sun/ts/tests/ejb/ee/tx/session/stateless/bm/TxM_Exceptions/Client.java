...
package com.sun.ts.tests.ejb.ee.tx.session.stateless.bm.TxM_Exceptions;
...
public class Client extends EETest {
     ...
     * of a stateless session TxBean (Mandatory) bean. Initiate a bean managed transaction and perform a delete row
     * operation to a table and throw SystemException. Ensure that the Container marks the transaction for rollback. Ensure
     * that the instance gets discarded. Ensure that the client receives TransactionRolledbackException.
     */
     ...
     * stateless session TxBean (Mandatory) bean. Initiate a bean managed transaction and perform a delete row operation to

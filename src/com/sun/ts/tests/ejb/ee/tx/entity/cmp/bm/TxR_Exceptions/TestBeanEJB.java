...
public class TestBeanEJB implements SessionBean {
  ...
  public boolean test3() {
    ...
    try {
      ...
      TestUtil.logTrace("Creating EJB instances of " + txECMPBeanRequired);
      beanref1 = (TxECMPBean) beanHome.create(tName1, key1, brand1, (float) 1,
          testProps);
      ...
      ut.begin();
      try {
        beanref2 = (TxECMPBean) beanHome.create(tName1, key1, brand2, (float) 1,
            testProps);
      } catch (Exception e1) {
      ...
      try {
        ...
        if (!brand1.equals(result)) {
          TestUtil.logMsg(
              "Wrong brand name: Expected: " + brand1 + " Received: " + result);
          testResult = false;
        } else {
          testResult = true;
        }
      ...
      try {
        ...
        TestUtil
            .logErr("Exception removing beanref2 - beanref2 should not exist");
      }
    }
  ...
  public boolean test7() {
    ...
    try {
      ...
      beanHome = (TxECMPBeanHome) jctx.lookup(txECMPBeanRequired,
          TxECMPBeanHome.class);
      TestUtil.logTrace("Creating EJB instances of " + txECMPBeanRequired);
      beanref = (TxECMPBean) beanHome.create(tName1, key1, brand1, (float) 1,
          testProps);

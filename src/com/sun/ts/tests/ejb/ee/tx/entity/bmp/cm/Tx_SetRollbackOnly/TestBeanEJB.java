...
public class TestBeanEJB implements SessionBean {
    ...
    public boolean test1() {
        ...
        try {
            ...
            beanRef = (TxEBean) beanHome.create(tName1, 1, origName, (float) 1, testProps);
    ...
    public boolean test2() {
        ...
        try {
            ...
            try {
                beanRef.updateBrandName(expName, TxEBeanEJB.FLAGAPPEXCEPTIONWITHROLLBACK);
    ...
    public boolean test8() {
        ...
        try {
            TestUtil.logTrace("Looking up the TxEBean Home interface of " + txEBeanTxRequiresNew);
            beanHome = (TxEBeanHome) jctx.lookup(txEBeanTxRequiresNew, TxEBeanHome.class);

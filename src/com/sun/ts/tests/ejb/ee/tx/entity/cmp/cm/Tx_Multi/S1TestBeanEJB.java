...
public class S1TestBeanEJB implements SessionBean {
    ...
    public boolean doTest1(Integer pkey, String tName, int i) {
        ...
        TestUtil.logMsg("Commit a transaction - synchronized multi-clients - Required Tx");
    ...
    public boolean doTest3(Integer pkey, String tName, int i) {
        ...
        try {
            ...
            TestUtil.logMsg("Looking up home interface for EJB: " + txECMPBeanMandatory);
            ...
            beanRef = (TxECMPBean) beanHome.create(tName, pkey, tName + "-" + pkey.intValue(), (float) 1.00, testProps);

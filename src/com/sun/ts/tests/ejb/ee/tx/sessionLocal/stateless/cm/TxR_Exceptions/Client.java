...
public class Client extends EETest {
   ...
   * (Required) bean. Perform a delete row operation to a table and throw
   ...
   * session Testbean bean. Create an instance of a stateless session TxBean
   * (Required) bean. Initiate a container managed transaction and perform a
   ...
   * bean. Initiate a container managed transaction and perform a delete row
   * operation to a table and throw SystemException. Ensure that the Container
   * does a rollback on the transaction. Ensure that the instance gets
   * discarded. Ensure that the client receives EJBException.
   */

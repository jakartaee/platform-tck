...
public class Client extends EETest {
    ...
    public void setup(String[] args, Properties p) throws Fault {
        ...
        try {
            ...
            beanRefER = (TxEBean) eHomeR.create(tName, pkeyR.intValue(), tName + "-" + pkeyR.intValue(), (float) 1.00, props);
            ...
            beanRefERN = (TxEBean) eHomeRN.create(tName, pkeyRN.intValue(), tName + "-" + pkeyRN.intValue(), (float) 2.00, props);

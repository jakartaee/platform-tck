...
public class Client extends EETest {
    ...
    private TxEBeanHome eHomeR = null;

    private TxEBeanHome eHomeRN = null;

    private TestBean beanRefS1 = null;

    private TestBean beanRefS2 = null;

    private TxEBean beanRefER = null;

    private TxEBean beanRefERN = null;
    ...
    class TestThread implements Runnable {
        ...
        public void run() {
            ...
            else if (testNum == 5) testResult = runTest5();
            else if (testNum == 6) testResult = runTest6();
    ...
    public void setup(String[] args, Properties p) throws Fault {
        ...
        try {
            ...
            eHomeR = (TxEBeanHome) nctx.lookup(tLookupER, TxEBeanHome.class);
            pkeyR = new Integer(1);
            logMsg("Creating entity EJB = " + pkeyR.toString());
            beanRefER = (TxEBean)
                    eHomeR.create(tName, pkeyR.intValue(), tName + "-" + pkeyR.intValue(), (float) 1.00, props);

            eHomeRN = (TxEBeanHome) nctx.lookup(tLookupERN, TxEBeanHome.class);
            pkeyRN = new Integer(2);
            logMsg("Creating entity EJB = " + pkeyRN.toString());
            beanRefERN = (TxEBean)
                    eHomeRN.create(tName, pkeyRN.intValue(), tName + "-" + pkeyRN.intValue(), (float) 2.00, props);

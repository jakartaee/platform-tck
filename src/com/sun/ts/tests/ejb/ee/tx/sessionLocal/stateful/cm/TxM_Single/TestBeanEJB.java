...
public class TestBeanEJB implements SessionBean {
    ...
    public boolean test1() {
        ...
        TestUtil.logTrace("Access a method with the Mandatory attribute  and ensure that "
                + "TransactionRequiredLocalException exception is thrown");
    ...
    public boolean test2() {
        ...
        TestUtil.logTrace("Access a business method with a Style 3 attribute "
                ...
                + "the TransactionRequiredLocalException exception is NOT thrown.");
        ...
        try {
            ...
            if (!t1) {
                TestUtil.logErr("Caught unexpected TransactionRequiredLocalException: " + et.getMessage());

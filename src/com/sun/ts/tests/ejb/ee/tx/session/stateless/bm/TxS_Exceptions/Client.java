...
public class Client extends EETest {
     ...
     * of a stateless session TxBean (Supports) bean. Initiate a bean managed transaction and perform a delete row operation
     ...
     * stateless session TxBean (Supports) bean. Initiate a bean managed transaction and perform a delete row operation to a

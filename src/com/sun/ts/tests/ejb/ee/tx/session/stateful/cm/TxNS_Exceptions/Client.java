...
package com.sun.ts.tests.ejb.ee.tx.session.stateful.cm.TxNS_Exceptions;
...
public class Client extends EETest {
     ...
     * a stateful session TxBean (NotSupported) bean. Perform a delete row operation to a table and throw AppException.
     ...
     * of a stateful session TxBean (NotSupported) bean. Initiate a container managed transaction and perform delete row
     ...
     * a stateful session TxBean (NotSupported) bean. Initiate a container managed transaction and perform delete row
     ...
     * stateful session TxBean (NotSupported) bean. Initiate a container managed transaction and perform delete row

...
public class Client extends EETest {
    ...
    public void setup(String[] args, Properties p) throws Fault {
        ...
        try {
            ...
            beanRefER = (TxEBean) ERHome.create(tName1, pkeyR.intValue(), tName1 + "-" + pkeyR.intValue(), (float) 2.00, testProps);
     ...
     * object. Attempt to create an instances of an Entity EJB (TxEBean) bean, without a transaction context. Ensure that

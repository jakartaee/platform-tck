...
package com.sun.ts.tests.ejb.ee.tx.entityLocal.bmp.bm.TxR_Exceptions;
...
import com.sun.ts.tests.ejb.ee.tx.txEbeanLocal.TxEBeanEJB;
...
public class TestBeanEJB implements SessionBean {
    ...
    public boolean test1() {
        ...
        try {
            TestUtil.logTrace("Looking up the TxEBean Home interface of " + txEBeanRequired);
            beanHome = (TxEBeanHome) jctx.lookup(txEBeanRequired);

            TestUtil.logTrace("Creating EJB instances of " + txEBeanRequired);
            beanref = (TxEBean) beanHome.create(tName1, 1, brand1, (float) 1, testProps);
    ...
    public boolean test2() {
        ...
        try {
            ...
            TestUtil.logTrace("Update brand name and catch TransactionRolledbackLocalException");
            ut.begin();
            try {
                beanref.updateBrandName(brand2, TxEBeanEJB.FLAGSYSEXCEPTION);
                TestUtil.logTrace("Did not receive TransactionRolledbackLocalException as expected");
            } catch (TransactionRolledbackLocalException ee) {
                TestUtil.logTrace("TransactionRolledbackLocalException received as expected.");
                t1 = true;
            }
    ...
    public boolean test3() {
        ...
        try {
            ...
            TestUtil.logTrace("Creating EJB instances of " + txEBeanRequired);
            beanref1 = (TxEBean) beanHome.create(tName1, key1, brand1, (float) 1, testProps);

            beanref2 = (TxEBean) beanHome.create(tName1, key2, brand2, (float) 1, testProps);
            ...
            ut.begin();
            try {
                beanref3 = (TxEBean) beanHome.create(tName1, key2, brand2, (float) 1, testProps);
    ...
    public boolean test5() {
        ...
        try {
            ...
            beanref2 = (TxEBean) beanHome.create(tName1, key2, brand1, (float) 1, testProps);
            try {
                beanref2.remove();
                TestUtil.logTrace("beanRef2 sucessfully removed");
            } catch (RemoveException re) {
                TestUtil.printStackTrace(re);
                TestUtil.logTrace("Could not remove beanref2");
            }
            beanref2 = null;
            ...
            try {
                ...
                TestUtil.logTrace("Caught expected FinderException");
                testResult = true;
            }
    ...
    public boolean test6() {
        ...
        try {
            ...
            beanref = (TxEBean) beanHome.create(tName1, key1, brand1, (float) 1, testProps);
    ...
    public boolean test7() {
        ...
        try {
            ...
            TestUtil.logErr("Exception caught while trying to rollback" + er.getMessage(), er);
        } finally {
            // cleanup the bean (will remove the DB row entry!)
            try {
                if (beanref != null) {

...
/*
 * @(#)TestBeanEJB.java	1.24 03/05/16
 */
...
public class TestBeanEJB implements SessionBean {
    ...
    public void ejbCreate(Properties p) throws CreateException {
        ...
        try {
            ...
            TestUtil.logMsg("Looking up the TxEBean Home interface of " + txEBeanRequired);
    ...
    public boolean test1() {
        ...
        try {
            ...
            beanRef1 = (TxEBean) beanHome.create(tName1, 1, tName1 + "-1", (float) 1, testProps);
            beanRef2 = (TxEBean) beanHome.create(tName1, 2, tName1 + "-2", (float) 2, testProps);
    ...
    public boolean test2() {
        ...
        try {
            ...
            try {
                ut.begin();
                beanRef2 = (TxEBean) beanHome.findtxEbean(tName1, new Integer(1), testProps);
                ut.commit();
    ...
    public boolean test3() {
        ...
        TestUtil.logMsg(
                "Commit a transaction involving entity EJBs, located via " + "ejbFind<Method>() - Required case");
    ...
    public boolean test4() {
        ...
        TestUtil.logMsg(
                "rollback a transaction involving entity EJBs, located via " + "ejbFind<Method>() - Required case");
        ...
        try {
            ...
            if (b1) {
                ...
                TestUtil.logMsg("Brand Name DB value did not match expected value");
                TestUtil.logMsg("Expected: " + tName1 + "-1" + ", Actual: " + tempName1);
                TestUtil.logMsg("The transaction rollback failed");
            }
    ...
    public boolean test7() {
        ...
        try {
            ...
            TestUtil.logTrace("Looking up the TxEBean Home interface of " + txEBeanRequiresNew);
            beanHome = (TxEBeanHome) jctx.lookup(txEBeanRequiresNew, TxEBeanHome.class);
            ...
            if (!b2) {
                TestUtil.logMsg("Price DB value did not match expected value");
                TestUtil.logMsg("Expected: " + (float) 100.00 + ", Actual: " + tempPrice1);
            }

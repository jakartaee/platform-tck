...
public class TestBeanEJB implements SessionBean {
    ...
    public boolean test1() {
        ...
        TestUtil.logTrace("Access a method with the Mandatory attribute  and ensure that "
    ...
    public boolean test2() {
        ...
        try {
            ...
            beanRef.initLogging(testProps);
            TestUtil.logTrace("As expected, TransactionRequiredException was not thrown");
            t1 = true;
            ...
            if (!t1) {
                TestUtil.logErr("Caught unexpected TransactionRequiredException: " + et.getMessage());

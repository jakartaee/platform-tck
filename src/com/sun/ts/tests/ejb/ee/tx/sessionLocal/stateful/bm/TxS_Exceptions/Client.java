...
public class Client extends EETest {
     ...
     * a stateful session TxBean (Supports) bean. Initiate a bean managed transaction and perform a delete row operation to
     ...
     * of a stateful session TxBean (Supports) bean. Initiate a container managed transaction and perform delete row

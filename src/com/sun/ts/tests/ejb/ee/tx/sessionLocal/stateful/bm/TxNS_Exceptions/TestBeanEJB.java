...
package com.sun.ts.tests.ejb.ee.tx.sessionLocal.stateful.bm.TxNS_Exceptions;
...
public class TestBeanEJB implements SessionBean {
    ...
    private static final String txBeanNotSupported = "java:comp/env/ejb/TxNotSupported";
    ...
    public void ejbCreate() throws CreateException {
        ...
        try {
            ...
            TestUtil.logMsg("Looking up the TxBean Home interface of " + txBeanNotSupported);

            beanHome = (TxBeanHome) jctx.lookup(txBeanNotSupported);
    ...
    public boolean test2() {
        ...
        try {
            ...
            if (!dbResults.contains(new Integer(tRng))) b4 = true;

            for (int i = 1; i <= size; i++) {
                if (i == tRng) continue;
                else {
                    if (dbResults.contains(new Integer(i))) b5 = true;
                    else {
                        b5 = false;
                        break;
                    }
            ...
            if (b1 && b3 && b4 && b5) testResult = true;

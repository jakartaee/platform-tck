...
public class Client extends EETest {
     ...
     * a stateful session TxBean (Required) bean. Perform a delete row operation to a table and throw AppException. Ensure
     ...
     * of a stateful session TxBean (Required) bean. Initiate a container managed transaction and perform a delete row
     ...
     * a stateful session TxBean (Required) bean. Initiate a container managed transaction and perform a delete row
     * operation to a table and throw SystemException. Ensure that the Container does a rollback on the transaction. Ensure
     * that the instance gets discarded. Ensure that the client receives RemoteException.
     */
     ...
     * stateful session TxBean (Required) bean. Initiate a container managed transaction and perform a delete row operation

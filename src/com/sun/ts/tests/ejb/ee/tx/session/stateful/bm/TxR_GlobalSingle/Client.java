...
public class Client extends EETest {
     ...
     * global transactions using the TxBean (deployed as TX_REQUIRED) to a single RDBMS table.
     *
     ...
     *
     * @test_Strategy: Create a stateful session TX_BEAN_MANAGED bean. Obtain the UserTransaction interface. Perform a
     * global transaction using the TxBean (deployed as TX_REQUIRED) to a single RDBMS table.
     *

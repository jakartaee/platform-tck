...
public class Client extends EETest {
     ...
     * a stateless session TxBean (Supports) bean. Perform a delete row operation to a table and throw AppException. Ensure
     ...
     * a stateless session TxBean (Supports) bean. Initiate a container managed transaction and perform delete row operation
     ...
     * stateless session TxBean (Supports) bean. Initiate a container managed transaction and perform delete row operation

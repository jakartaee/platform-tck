...
import com.sun.ts.tests.ejb.ee.tx.txEPMbean.TxEPMBeanEJB;
...
public class TestBeanEJB implements SessionBean {
    ...
    public boolean test1() {
        ...
        try {
            ...
            beanHome = (TxEPMBeanHome) jctx.lookup(txEPMBeanRequired, TxEPMBeanHome.class);
    ...
    public boolean test3() {
        ...
        try {
            ...
            try {
                ...
                TestUtil.logErr("Expected exception removing beanref2" + " beanref2 should not exist");
            }
        }
        return (testResult);
    }

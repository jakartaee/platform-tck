...
package com.sun.ts.tests.ejb.ee.tx.session.stateless.cm.TxR_Exceptions;
...
public class Client extends EETest {
     ...
     * a stateless session TxBean (Required) bean. Perform a delete row operation to a table and throw AppException. Ensure
     ...
     * of a stateless session TxBean (Required) bean. Initiate a container managed transaction and perform a delete row
     * operation to a table and throw SystemException. Ensure that the Container does a rollback on the transaction. Ensure
     * that the instance gets discarded. Ensure that the client receives RemoteException.
     */
     ...
     * a stateless session TxBean (Required) bean. Initiate a container managed transaction and perform a delete row
     * operation to a table and throw SystemException. Ensure that the Container does a rollback on the transaction. Ensure
     * that the instance gets discarded. Ensure that the client receives RemoteException.
     */
     ...
     * stateless session TxBean (Required) bean. Initiate a container managed transaction and perform a delete row operation
     * to a table and throw SystemException. Ensure that the Container does a rollback on the transaction. Ensure that the

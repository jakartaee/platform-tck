...
public class BeanBEJB implements SessionBean {
    ...
    public boolean helloB() throws RemoveException {
        ...
        String txEPMBeanRequiresNew = "java:comp/env/ejb/TxRequiresNew";
        ...
        try {
            TestUtil.logMsg("Looking up the TxEPMBean Home interface of " + txEPMBeanRequiresNew);

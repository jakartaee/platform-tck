...
public class TestBeanEJB implements SessionBean {
    ...
    public void ejbCreate(Properties p) throws CreateException {
        ...
        try {
            ...
            TestUtil.logMsg("Looking up the TxEPMBean Home interface of " + txEPMBeanRequired);
    ...
    public boolean test1() {
        ...
        try {
            ...
            beanRef1 = (TxEPMBean) beanHome.create(tName1, origKey1, origName1, origPrice1, testProps);
    ...
    public boolean test5() {
        ...
        try {
            ...
            beanHome = (TxEPMBeanHome) jctx.lookup(txEPMBeanRequiresNew, TxEPMBeanHome.class);

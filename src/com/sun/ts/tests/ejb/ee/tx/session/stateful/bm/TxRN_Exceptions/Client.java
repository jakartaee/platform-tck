...
package com.sun.ts.tests.ejb.ee.tx.session.stateful.bm.TxRN_Exceptions;
...
public class Client extends EETest {
     ...
     * a stateful session TxBean (RequiresNew) bean. Initiate a bean managed transaction and perform a delete row operation
     ...
     * @testName: test2
     *
     * @assertion_ids: EJB:SPEC:631.4
     *
     * @test_Strategy: SystemException from EJB. Create an instance of a stateful session Testbean bean. Create an instance
     * of a stateful session TxBean (RequiresNew) bean. Initiate a bean managed transaction and perform a delete row
     ...
     * stateful session TxBean (RequiresNew) bean. Initiate a bean managed transaction and perform a delete row operation to
     * a table and throw Error. Ensure that the instance gets discarded. Ensure that the client receives RemoteException.
     */

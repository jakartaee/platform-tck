...
public class Client extends EETest {
     ...
     *
     * (Section 18.3.1 Container provider responsibilities)
     *
     * @test_Strategy: AppException from Entity EJB. - Create an instance of a stateful session Testbean bean. - Create an
     * instance of an Entity TxEPMBean(RequiresNew) bean. - Cause an AppException in the Entity bean. - Ensure that the
     ...
     * instance of an Entity TxEPMBean(RequiresNew) bean. - Cause a SysException in the Entity bean. - Ensure that the
     * client receives RemoteException. - Verify the transaction did not commit.
     */
     ...
     * instance of an Entity TxEPMBean(RequiresNew) bean. - Cause a EJBException in the Entity bean. - Ensure that the
     * client receives RemoteException. - Verify the transaction did not commit.
     *
     */
     ...
     * of an Entity TxEPMBean(RequiresNew) bean. - Cause a Error in the Entity bean. - Ensure that the client receives
     * RemoteException. - Verify the transaction did not commit.
     *
     */

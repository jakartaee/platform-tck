...
public class Client extends EETest {
   ...
   * TxEPMBean(RequiresNew) bean. - Cause an AppException in the Entity bean. -
   ...
   * stateful session Testbean bean. - Create an instance of an Entity
   * TxEPMBean(RequiresNew) bean. - Cause a SysException in the Entity bean. -
   * Ensure that the client receives RemoteException. - Verify the transaction
   * did not commit.
   */
   ...
   * stateful session Testbean bean. - Create an instance of an Entity
   * TxEPMBean(RequiresNew) bean. - Cause a EJBException in the Entity bean. -
   * Ensure that the client receives RemoteException. - Verify the transaction
   * did not commit.
   *
   */
   ...
   * TxEPMBean(RequiresNew) bean. - Cause a Error in the Entity bean. - Ensure
   * that the client receives RemoteException. - Verify the transaction did not
   * commit.
   *
   */

...
public class Client extends EETest {
    ...
    private static final String testName = "TxN_Single";
     ...
     * global transaction using the TxBean (deployed as TX_NEVER) to a single RDBMS table. jakarta.ejb.EJBException

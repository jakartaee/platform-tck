...
public class Client extends EETest {
    ...
    private static final String testName = "TxS_Exceptions";
     ...
     * a stateless session TxBean (Supports) bean. Initiate a bean managed transaction and perform a delete row operation to
     ...
     * of a stateless session TxBean (Supports) bean. Initiate a container managed transaction and perform delete row
     ...
     * a stateful session TxBean (Supports) bean. Initiate a container managed transaction and perform delete row operation
     ...
     * stateful session TxBean (Supports) bean. Initiate a container managed transaction and perform delete row operation to

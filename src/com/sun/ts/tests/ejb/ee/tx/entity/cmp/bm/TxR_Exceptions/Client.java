...
public class Client extends EETest {
     ...
     * TxECMPBean(Required) bean. Ensure an Exception is thrown when attempting to create an entity bean with a duplicate
     * primary key.
     */
     ...
     * Create 1 instance of an Entity TxECMPBean(Required) bean, creating a fresh database table. - Use
     * findByPrimaryKey(...) to find a record with a key that does not exist. Note that the programmer knows all the keys
     * that exist (only "1") since it is a newly created table. - Catch ObjectNotFoundException
     */
     ...
     *
     * @test_Strategy: RemoveException from Entity EJB. - Create 1 instance of an Entity TxECMPBean(Required) bean. - Force
     * a RemoveException. - Catch RemoveException
     */

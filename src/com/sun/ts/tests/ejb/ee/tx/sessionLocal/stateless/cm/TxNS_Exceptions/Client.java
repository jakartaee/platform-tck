...
public class Client extends EETest {
     ...
     * operation to a table and throw EJBException. Ensure that the instance gets discarded. Ensure that the client receives
     * EJBException.
     */
     ...
     * operation to a table and throw Error. Ensure that the instance gets discarded. Ensure that the client receives
     * EJBException.
     */

...
public class TestBeanEJB implements SessionBean {
    ...
    public void ejbCreate(Properties p) throws CreateException {
        ...
        try {
            ...
            TestUtil.logMsg("Looking up the TxECMPBean Home interface of " + txECMPBeanRequired);
    ...
    public boolean test1() {
        ...
        try {
            ...
            beanRef1 = (TxECMPBean) beanHome.create(tName1, origKey1, origName1, origPrice1, testProps);

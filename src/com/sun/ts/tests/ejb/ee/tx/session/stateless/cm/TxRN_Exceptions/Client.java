...
public class Client extends EETest {
     ...
     * a stateless session TxBean (RequiresNew) bean. Perform a delete row operation to a table and throw AppException.
     ...
     * of a stateless session TxBean (RequiresNew) bean. Initiate a container managed transaction and perform a delete row
     ...
     * a stateless session TxBean (RequiresNew) bean. Initiate a container managed transaction and perform a delete row
     * operation to a table and throw SystemException. Ensure that the Container does a rollback on the transaction. Ensure
     * that the instance gets discarded. Ensure that the client receives RemoteException.
     */
     ...
     * stateless session TxBean (RequiresNew) bean. Initiate a container managed transaction and perform a delete row
     * operation to a table and throw SystemException. Ensure that the Container does a rollback on the transaction. Ensure
     * that the instance gets discarded. Ensure that the client receives RemoteException.
     */

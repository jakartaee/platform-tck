...
package com.sun.ts.tests.ejb.ee.tx.sessionLocal.stateless.bm.TxR_Exceptions;
...
public class Client extends EETest {
     ...
     * a stateless session TxBean (Required) bean. Initiate a bean managed transaction and perform a delete row operation to
     ...
     * of a stateful session TxBean (Required) bean. Initiate a container managed transaction and perform delete row
     ...
     * a stateful session TxBean (Required) bean. Initiate a container managed transaction and perform delete row operation
     ...
     * stateful session TxBean (Required) bean. Initiate a container managed transaction and perform delete row operation to
     * a table and throw Error. Ensure that the Container marks the transaction for rollback. Ensure that the instance gets

...
public class Client extends EETest {
     ...
     * a stateful session TxBean (Supports) bean. Perform a delete row operation to a table and throw AppException. Ensure
     * that the exception does not cause an automatic rolledback. Ensure that the client receives AppException.
     *
     *
     */

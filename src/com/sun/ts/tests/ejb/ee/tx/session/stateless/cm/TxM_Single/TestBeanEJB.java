...
package com.sun.ts.tests.ejb.ee.tx.session.stateless.cm.TxM_Single;
...
public class TestBeanEJB implements SessionBean {
    ...
    public void ejbCreate() throws CreateException {
        ...
        try {
            ...
            TestUtil.logMsg("Looking up the TxBean Home interface of " + txBeanMandatoryStateless);
            beanHome = (TxBeanHome) jctx.lookup(txBeanMandatoryStateless, TxBeanHome.class);
    ...
    public boolean test1() {
        ...
        TestUtil.logTrace(
                "Access a Mandatory Bean and ensure that " + "TransactionRequiredException exception is thrown");
        ...
        try {
            ...
            TestUtil.logTrace("Error: TransactionRequiredException not thrown as expected");

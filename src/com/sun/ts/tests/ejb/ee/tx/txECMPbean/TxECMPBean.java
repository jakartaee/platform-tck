...
/**
 * The TxECMPBean is an entity EJB. Most of the business methods of the TxECMPBean class do not access the database.
...
public interface TxECMPBean extends EJBObject {
     ...
     * @exception RemoteException if an error occurs while retrieving the brand name
     */
     ...
     * @exception RemoteException if an error occurs while retrieving the price
     */
     ...
     * @return void
     * @exception RemoteException if the brand name could not be obtained
     */
     ...
     * @return void
     * @exception RemoteException if the price could not be updated
     */

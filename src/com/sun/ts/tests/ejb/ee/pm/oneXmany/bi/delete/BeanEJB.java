...
public abstract class BeanEJB implements EntityBean {
    ...
    public boolean test2() {
        ...
        try {
            ...
            if (c.size() == 1) {
                ...
                TestUtil.logErr("Collection size returned is " + c.size() + ", expected 1");
    ...
    public boolean test4() {
        ...
        try {
            ...
            bTwo.remove();
            TestUtil.logMsg("Assigning B1 to collection " + "must throw IllegalArgumentException");
    ...
    public void ejbPostCreate(String id, String name, int value, ADVC aOne, BDVC bOne, BDVC bTwo)
            throws CreateException {
        TestUtil.logTrace("ejbPostCreate");
        try {
            ALocal a1 = createALocal(aOne.getId(), aOne.getName(), aOne.getValue());

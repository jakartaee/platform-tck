...
public abstract class CustomerEJB implements EntityBean {
    ...
    private AddressLocal createAddressLocal(String id, String street, String city, String state, String zip)
            throws Exception {
    ...
    private AddressLocal createAddressLocal(
            String id, String street, String city, String state, String zip, Collection phones) throws Exception {
        TestUtil.logTrace("createAddressLocal");
        TSNamingContext nctx = new TSNamingContext();
        AddressLocalHome addressLocalHome = (AddressLocalHome) nctx.lookup(AddressLocal);
    ...
    private SpouseLocal createSpouseLocal(
            String id, String first, String maiden, String last, String sNumber, InfoDVC infoDVC) throws Exception {
        ...
        InfoLocal infoLocal = infoLocalHome.create(
                infoDVC.getId(), infoDVC.getStreet(), infoDVC.getCity(), infoDVC.getState(), infoDVC.getZip());
    ...
    private CreditCardLocal createCreditCardLocal(
            String id,
            String number,
            String type,
            String expires,
    ...
    public abstract CreditCardLocal ejbSelectCreditCard(String pkey) throws FinderException;

    public abstract Set ejbSelectHomeZipCodesByCity(String city) throws FinderException;

    public abstract Collection ejbSelectAllHomeZipCodesByCity(String city) throws FinderException;

    public abstract Collection ejbSelectCustomersByAlias(String s) throws FinderException;

    public abstract Collection ejbSelectCustomersByAlias(String s, String t) throws FinderException;

    public abstract Collection ejbSelectPhonesByArea(String area) throws FinderException;

    public abstract Set ejbSelectCustomerAddressBySet(String addr) throws FinderException;

    public abstract Collection ejbSelectCustomerAddressByCollection(String addr) throws FinderException;
    ...
    public String ejbCreate(String id, String name, AddressDVC home, AddressDVC work, Country country)
    ...
    public void ejbPostCreate(String id, String name, AddressDVC home, AddressDVC work, Country country)
            throws CreateException {
        TestUtil.logTrace("ejbPostCreate");
        try {
            AddressLocal homeAddr = createAddressLocal(
                    home.getId(), home.getStreet(), home.getCity(), home.getState(), home.getZip(), home.getPhones());
            AddressLocal workAddr = createAddressLocal(
                    work.getId(), work.getStreet(), work.getCity(), work.getState(), work.getZip(), work.getPhones());
            setHome(homeAddr);
            setWork(workAddr);
        } catch (Exception e) {
            TestUtil.printStackTrace(e);
    ...
    public Collection ejbHomeSelectAllWorkAddresses() throws AddressException {
        ...
        try {
            ...
            while (iterator.hasNext()) {
                ...
                AddressDVC aDvc = new AddressDVC(
                        aLeb.getId(), aLeb.getStreet(), aLeb.getCity(), aLeb.getState(), aLeb.getZip(), v2);
                v1.add(aDvc);
            }
            return v1;
        } catch (Exception e) {
    ...
    public Customer ejbHomeGetCustomerByHomePhoneNumber(String phone) {
        ...
        try {
            CustomerLocalHome customerLocalHome = (CustomerLocalHome) ectx.getEJBLocalHome();
    ...
    public void ejbHomeAddSpouseEntry(SpouseDVC s) throws SpouseException {
        try {
            SpouseLocal sLeb = createSpouseLocal(
                    s.getId(),
                    s.getFirstName(),
                    s.getMaidenName(),
                    s.getLastName(),
    ...
    public void addCreditCard(CreditCardDVC p) throws CreditCardException {
        try {
            ...
            CreditCardLocal cc = createCreditCardLocal(
                    p.getId(),
                    p.getNumber(),
                    p.getType(),
                    p.getExpires(),
    ...
    public AddressDVC getClientHomeAddress() throws AddressException {
        try {
            ...
            AddressDVC homeAddr = new AddressDVC(
                    getHome().getId(),
                    getHome().getStreet(),
                    getHome().getCity(),
                    getHome().getState(),
    ...
    public AddressDVC getClientWorkAddress() throws AddressException {
        try {
            ...
            AddressDVC workAddr = new AddressDVC(
                    getWork().getId(),
                    getWork().getStreet(),
                    getWork().getCity(),
                    getWork().getState(),

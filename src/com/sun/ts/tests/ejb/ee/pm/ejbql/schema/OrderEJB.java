...
public abstract class OrderEJB implements EntityBean {
    ...
    public abstract LineItemLocal ejbSelectLineItem(String pkey) throws FinderException;
    ...
    public abstract Collection ejbSelectSampleLineItems(LineItemLocal l) throws FinderException;
    ...
    public void addLineItem(LineItemDVC p) throws LineItemException {
        try {
            LineItemLocal li = createLineItemLocal(p.getId(), p.getQuantity(), p.getOrder(), p.getProduct());
    ...
    public void addSampleLineItem(LineItemDVC p) throws LineItemException {
        LineItemLocal liLeb = null;
        try {
            liLeb = createLineItemLocal(p.getId(), p.getQuantity(), p.getOrder(), p.getProduct());

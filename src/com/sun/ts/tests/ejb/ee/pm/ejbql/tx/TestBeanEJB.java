...
public class TestBeanEJB implements SessionBean {
    ...
    public void ejbCreate(Properties p) throws CreateException {
        ...
        try {
            ...
            TestUtil.logMsg("Looking up the TxCommonBean Home interface of " + txCommonRequired);
            beanHome = (TxCommonBeanHome) jctx.lookup(txCommonRequired, TxCommonBeanHome.class);

            TestUtil.logMsg("Looking up the TxCommonBean Home interface of " + txCommonRequiresNew);
            beanHome1 = (TxCommonBeanHome) jctx.lookup(txCommonRequiresNew, TxCommonBeanHome.class);

            TestUtil.logMsg("Looking up the TxCommonBean Home interface of " + txCommonMandatory);
            beanHome2 = (TxCommonBeanHome) jctx.lookup(txCommonMandatory, TxCommonBeanHome.class);
    ...
    public boolean txTest1() {
        ...
        try {
            ...
            TestUtil.logTrace("Creating the entity bean instance for txTest1:" + txCommonRequired);
            beanRef1 = (TxCommonBean) beanHome.create(origKey1, origName1, origPrice1, testProps);
            ...
            try {
                ...
                TestUtil.logErr("Caught unexpected FinderException from findByPrimaryKey:" + origKey1, fe);
                // Close the transaction on an exception
                ut.commit();
            } catch (Exception ie) {
                TestUtil.logErr("Caught unexpected Exception from findByPrimaryKey:" + origKey1, ie);
            }
            ...
            try {
                ...
                TestUtil.logErr("Exception caught while removing beanRef1 in txTest1", e);
            }
        }
    ...
    public boolean txTest2() {
        ...
        try {
            ...
            TestUtil.logMsg("Creating the entity bean instance for txTest2" + txCommonRequired);

            ut.begin();
            beanRef1 = (TxCommonBean) beanHome.create(origKey2, origName1, origPrice1, testProps);
            ...
            try {
                ...
                TestUtil.logErr("Caught unexpected exception from findByPrimaryKey:" + origKey2, ie);
            }
            ...
            try {
                ...
                TestUtil.logErr("Exception caught while removing beanRef1 in txTest2", e);
            }
        }
    ...
    public boolean txTest3() {
        ...
        try {
            ...
            TestUtil.logTrace("Creating entity bean instance for txTest3" + txCommonRequiresNew);
            beanRef1 = (TxCommonBean) beanHome1.create(origKey3, origName1, origPrice1, testProps);
            TestUtil.logTrace("Entity EJB object created!");
            ...
            try {
                ...
                TestUtil.logErr("Caught unexpected FinderException from findByPrimaryKey:" + origKey3, fe);
                // Close the transaction on an exception
                ut.commit();
            } catch (Exception ie) {
                TestUtil.logErr("Caught unexpected Exception from findByPrimaryKey:" + origKey3, ie);
            }
            ...
            try {
                ...
                TestUtil.logErr("Exception caught while removing beanRef1 in txTest3", e);
            }
        }
    ...
    public boolean txTest4() {
        ...
        try {
            ...
            TestUtil.logMsg("Creating entity bean instance for txTest4 " + txCommonRequiresNew);

            ut.begin();
            beanRef1 = (TxCommonBean) beanHome1.create(origKey4, origName1, origPrice1, testProps);
            TestUtil.logMsg("Entity EJB object created!");
            ut.commit();
            ...
            try {
                ...
                TestUtil.logErr("Caught an unexpected Exception from findByPrimaryKey" + origKey4, ie);
            }
            ...
            try {
                ...
                TestUtil.logErr("Exception caught while removing beanRef1 in txTest4", e);
            }
        }
    ...
    public boolean txTest5() {
        ...
        try {
            ...
            TestUtil.logTrace("Creating the Entity Bean Instance for txTest5" + txCommonMandatory);
            beanRef1 = (TxCommonBean) beanHome2.create(origKey5, origName1, origPrice1, testProps);
            ...
            try {
                ...
                TestUtil.logErr("Caught unexpected FinderException from findByPrimaryKey:" + origKey5, fe);
                // Close the transaction on an exception
            } catch (Exception ie) {
                TestUtil.logErr("Caught unexpected Exception from findByPrimaryKey:" + origKey5, ie);
            }
            ...
            try {
                ...
                TestUtil.logErr("Unexpected exception caught while removing beanRef1 in txTest5", e);
            }
        }
    ...
    public boolean txTest6() {
        ...
        try {
            ...
            TestUtil.logMsg("Creating entity bean instance for txTest6 " + txCommonMandatory);

            ut.begin();
            beanRef1 = (TxCommonBean) beanHome2.create(origKey6, origName1, origPrice1, testProps);
            ...
            try {
                ...
                TestUtil.logErr("Caught unexpected exception from findByPrimaryKey:" + origKey6, ie);
            }
            ...
            try {
                ...
                TestUtil.logErr("Unexpected exception caught while removing beanRef1 in txTest6" + e);
            }
        }

...
public class Client extends EETest {
    ...
    public void nullTest2() throws Fault {
        ...
        try {
            ...
            if (c.size() != 0) {
                TestUtil.logErr("findCustomersByQuery15 returned " + c.size() + " references, expected 0 references");
                pass = false;
            } else {
    ...
    public void nullTest5() throws Fault {
        ...
        try {
            ...
            if (c.size() != 0) {
                TestUtil.logErr("findCustomersByQuery24 returned " + c.size() + " references, expected 0 references");
                pass = false;
            } else {
    ...
    public void nullTest7() throws Fault {
        ...
        try {
            ...
            if (c.size() != 14) {
                TestUtil.logErr(
                        "selectCustomersByWorkZipCode returned " + c.size() + " references, expected 14 references");
                pass1 = false;
            } else if (pass1) {
    ...
    public void nullTest8() throws Fault {
        ...
        try {
            ...
            if (c != null) {
                TestUtil.logErr("findCustomerByQuery40 returned " + c + " expected: null");
                pass = false;
            } else {
                TestUtil.logMsg("Successfully returned expected results");
            }
    ...
    public void nullTest9() throws Fault {
        ...
        try {
            ...
            if (s != null) {
                TestUtil.logErr("selectCustomerByHomeAddress returned " + s + " expected: null");
                pass = false;
            } else {
                TestUtil.logMsg("Successfully returned expected results");
            }
    ...
    public void nullTest14() throws Fault {
        ...
        try {
            ...
            if (c1 != expectedResult1) {
                TestUtil.logErr("ERROR: selectAllHomeCities returned:" + c1 + " expected: " + expectedResult1);
                pass1 = false;
            } else {
            ...
            if (c2 != expectedResult2) {
                TestUtil.logErr("ERROR: selectNotNullHomeCities returned:" + c2 + " expected: " + expectedResult2);
                pass2 = false;
            } else {
    ...
    public void nullTest16() throws Fault {
        ...
        try {
            ...
            if (s.size() == 1) {
                TestUtil.logMsg("Checking results for alias names with size of " + s.size());
    ...
    public void nullTest17() throws Fault {
        ...
        try {
            ...
            if (a.size() == 29) {
                TestUtil.logMsg("Checking results for expectedPKs with size of " + a.size());
                pass = Util.checkEJBs(a, Schema.ALIASREF, expectedPKs);
            } else {
                if (a.size() == 27) {
                    TestUtil.logMsg("Checking results for expectedPK1s with size of " + a.size());
    ...
    public void nullTest23() throws Fault {
        ...
        try {
            ...
            if (c.size() != 6) {
                TestUtil.logErr("findCustomersByQuery41 returned " + c.size() + " references, expected 6 references");
                pass1 = false;
            } else if (pass1) {
                Iterator i = c.iterator();
                int numOfNull = 0;
    ...
    public void nullTest26() throws Fault {
        ...
        try {
            ...
            if (a.size() != 0) {
                TestUtil.logErr("findAliasesByQuery12 returned " + a.size() + " references, expected 0 references");
                pass = false;
            } else {
                TestUtil.logMsg("Successfully returned expected results");
            }
    ...
    public void nullTest27() throws Fault {
        ...
        try {
            ...
            if (o.size() != 15) {
                TestUtil.logErr(
                        "selectAllCreditCardBalances returned " + o.size() + " references, expected 15 references");
                pass1 = false;
            } else if (pass1) {

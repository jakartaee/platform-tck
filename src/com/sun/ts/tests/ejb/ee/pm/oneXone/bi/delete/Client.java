...
public class Client extends EETest {
  ...
  public void delete_1x1_bi_test1() throws Fault {
    ...
    try {
      ...
      throw new Fault("delete_1x1_bi_test1 failed", e);
    } finally {
      try {
        if (b != null) {
          b.remove();
  ...
  public void delete_1x1_bi_test2() throws Fault {
    boolean pass = true;
    Bean b = null;
    try {
      // Create entity bean with two entitybean objects in a 1x1
      ...
      throw new Fault("delete_1x1_bi_test2 failed", e);
    } finally {
      try {
        if (b != null) {
          b.remove();
  ...
  public void delete_1x1_bi_test3() throws Fault {
    boolean pass = true;
    Bean b = null;
    try {
      // Create entity bean with two entitybean objects in a 1x1
      ...
      throw new Fault("delete_1x1_bi_test3 failed", e);
    } finally {
      try {
        if (b != null) {
          b.remove();
  ...
  public void delete_1x1_bi_test4() throws Fault {
    boolean pass = true;
    Bean b = null;
    try {
      // Create entity bean with two entitybean objects in a 1x1
      ...
      throw new Fault("delete_1x1_bi_test4 failed", e);
    } finally {
      try {
        if (b != null) {
          b.remove();

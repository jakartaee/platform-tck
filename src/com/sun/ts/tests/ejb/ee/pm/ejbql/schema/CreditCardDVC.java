...
public class CreditCardDVC implements java.io.Serializable {
    ...
    public CreditCardDVC(String v1, String v2, String v3, String v4, boolean v5, double v6, Order v7, Customer v8) {
        id = v1;
        number = v2;
        type = v3;
        expires = v4;
    ...
    public CreditCardDVC(String v1, String v2, String v3, String v4, boolean v5, double v6) {
        id = v1;
        number = v2;
        type = v3;
        expires = v4;

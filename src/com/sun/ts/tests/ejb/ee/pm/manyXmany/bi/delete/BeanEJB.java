...
public abstract class BeanEJB implements EntityBean {
    ...
    public boolean test1() {
        ...
        try {
            ...
            TestUtil.logErr("Entitybean object A2 was not " + "deleted, expected EJBException");
    ...
    public boolean test3() {
        ...
        try {
            TestUtil.logMsg("Assigning aTwo to BeanEJB must throw IllegalArgumentException");
            setA2(aTwo);
            TestUtil.logErr("Did not get expected IllegalArgumentException");
            return false;
        } catch (IllegalArgumentException e) {
    ...
    public void ejbPostCreate(
        ...
        try {
            ...
            setA2(a2);
            ALocal a3 = createALocal(aThree.getId(), aThree.getName(), aThree.getValue());
            setA3(a3);
            ALocal a4 = createALocal(aFour.getId(), aFour.getName(), aFour.getValue());
            setA4(a4);

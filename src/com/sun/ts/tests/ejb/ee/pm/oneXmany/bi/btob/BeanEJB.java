...
public abstract class BeanEJB implements EntityBean {
    ...
    private boolean nullTest() {
        ...
        if (a1 == null && b1.isEmpty()) return true;
        else return false;
    }
    ...
    private boolean checkReassignment(Collection c, ALocal theA) {
        ...
        while (iterator.hasNext()) {
            ...
            if (theA == null) {
                ...
                if (!a.isIdentical(theA)) return false;
            }
        }
        return true;
    }
    ...
    private void dumpCollectionData(Collection c) {
        ...
        while (i.hasNext()) {
            ...
            TestUtil.logMsg("  id=" + v.getId() + ", name=" + v.getName() + ", value=" + v.getValue());
        }
    }
    ...
    public boolean doAssignmentTest2() {
        ...
        try {
            ...
            if (b1.contains(b11)
                    ...
                    && b1.contains(b22)
                    && b2.contains(b21)
                    && aOne.isIdentical(b11.getA())
                    && aOne.isIdentical(b12.getA())
                    && aOne.isIdentical(b22.getA())
    ...
    public void ejbPostCreate(String id, String name, int value, ADVC aOne, BDVC bOne, int flag)
    ...
    public String ejbCreate(
            String id, String name, int value, ADVC aOne, BDVC bOne, BDVC bTwo, ADVC aTwo, BDVC bThree, BDVC bFour)
            throws CreateException {
        TestUtil.logTrace("ejbCreate");
        try {
            setId(id);
    ...
    public void ejbPostCreate(
        ...
        try {
            ...
            BLocal b3 = createBLocal(bThree.getId(), bThree.getName(), bThree.getValue());
            setB3(b3);
            bcol2.add(b3);

            BLocal b4 = createBLocal(bFour.getId(), bFour.getName(), bFour.getValue());
            setB4(b4);
            bcol2.add(b4);

...
public abstract class EmployeeEJB implements EntityBean {
    ...
    public Integer ejbCreate(Integer id, String firstName, String lastName, java.util.Date hireDate, float salary)
    ...
    public void ejbPostCreate(Integer id, String firstName, String lastName, java.util.Date hireDate, float salary)
            throws CreateException {
    ...
    public void addManager(Employee e) {
        ...
        try {
            ...
            EmployeeLocalHome empLocalHome = (EmployeeLocalHome) ectx.getEJBLocalHome();
    ...
    public boolean test4() {
        try {
            ...
            EmployeeLocal eOne = (EmployeeLocal) empLocalHome.findByPrimaryKey(new Integer(1));
            EmployeeLocal eTwo = (EmployeeLocal) empLocalHome.findByPrimaryKey(new Integer(2));
            EmployeeLocal mOne = (EmployeeLocal) empLocalHome.findByPrimaryKey(new Integer(3));
            EmployeeLocal mTwo = (EmployeeLocal) empLocalHome.findByPrimaryKey(new Integer(4));

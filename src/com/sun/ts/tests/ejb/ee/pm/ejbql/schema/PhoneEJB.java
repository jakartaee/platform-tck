...
public abstract class PhoneEJB implements EntityBean {
    ...
    public String ejbCreate(String id, String area, String number) throws CreateException {
    ...
    public void ejbPostCreate(String id, String area, String number) throws CreateException {
        TestUtil.logTrace("ejbPostCreatePhone");
    }

    public String ejbCreate(String id, String area, String number, AddressLocal a) throws CreateException {
    ...
    public void ejbPostCreate(String id, String area, String number, AddressLocal a) throws CreateException {
        TestUtil.logTrace("ejbPostCreatePhone");
        try {
            setAddress(a);
        } catch (Exception e) {

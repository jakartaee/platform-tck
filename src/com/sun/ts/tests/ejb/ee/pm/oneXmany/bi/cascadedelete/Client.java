...
public class Client extends EETest {
    ...
    /*
     * @testName: cascadedelete_1xM_bi_test1
     *
    ...
    public void cascadedelete_1xM_bi_test1() throws Fault {
        boolean pass = true;
        Bean b = null;
        try {
            ...
            b = bHome.create("1", "bean1", 1, a1, b11, b12);
            b.init(props);
            ...
            throw new Fault("cascadedelete_1xM_bi_test1 failed", e);
        } finally {
            try {
                if (b != null) {
                    b.remove();
        ...
        if (!pass)
            throw new Fault("cascadedelete_1xM_bi_test1 failed");
    }

    /*
     * @testName: cascadedelete_1xM_bi_test2a
     *
    ...
    public void cascadedelete_1xM_bi_test2a() throws Fault {
        boolean pass = true;
        Bean b = null;
        try {
            // Create entity bean with two entitybean objects in a 1xmany
            ...
            throw new Fault("cascadedelete_1xM_bi_test2a failed", e);
        } finally {
            try {
                if (b != null) {
                    b.remove();
        ...
        if (!pass)
            throw new Fault("cascadedelete_1xM_bi_test2a failed");
    }

    /*
     * @testName: cascadedelete_1xM_bi_test2b
     *
     * @assertion_ids: EJB:SPEC:187
     *
     * @test_Strategy: A 1xmany bi-directional relationship between entitybean objects. Create a 1xmany bi-directional
    ...
    public void cascadedelete_1xM_bi_test2b() throws Fault {
        boolean pass = true;
        Bean b = null;
        try {
            // Create entity bean with two entitybean objects in a 1xmany
            ...
            // Check if accessor methods for the relationships returns the
            // correct collection
            if (b.test2b())
            ...
            throw new Fault("cascadedelete_1xM_bi_test2b failed", e);
        } finally {
            try {
                if (b != null) {
                    b.remove();
        ...
        if (!pass)
            throw new Fault("cascadedelete_1xM_bi_test2b failed");
    }

    /*
     * @testName: cascadedelete_1xM_bi_test3
     *
     * @assertion_ids: EJB:SPEC:178
     *
     * @test_Strategy: A 1xmany bi-directional relationship between entitybean objects. Perform cascade delete of entitybean
     * object. Deploy it on the J2EE server. Ensure that the Persistence Manager throws jakarta.ejb.EJBException when trying
     * to invoke an accessor methods on a deleted entitybean objects.
     *
     */

    public void cascadedelete_1xM_bi_test3() throws Fault {
        boolean pass = true;
        Bean b = null;
        try {
            // Create entity bean with two entitybean objects in a 1xmany
            ...
            throw new Fault("cascadedelete_1xM_bi_test3 failed", e);
        } finally {
            try {
                if (b != null) {
                    b.remove();
        ...
        if (!pass)
            throw new Fault("cascadedelete_1xM_bi_test3 failed");
    }

    /*
     * @testName: cascadedelete_1xM_bi_test4
     *
    ...
    public void cascadedelete_1xM_bi_test4() throws Fault {
        boolean pass = true;
        Bean b = null;
        try {
            // Create entity bean with two entitybean objects in a 1xmany
            ...
            throw new Fault("cascadedelete_1xM_bi_test4 failed", e);
        } finally {
            try {
                if (b != null) {
                    b.remove();
        ...
        if (!pass)
            throw new Fault("cascadedelete_1xM_bi_test4 failed");
    }
}

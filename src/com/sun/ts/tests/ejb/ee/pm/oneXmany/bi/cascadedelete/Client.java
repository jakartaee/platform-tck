...
public class Client extends EETest {
  ...
  public void cascadedelete_1xM_bi_test2a() throws Fault {
    ...
    try {
      ...
      if (b.test2a())
        TestUtil.logMsg(
            "accessor methods for relationships " + "returns null passed");
      else {
        TestUtil.logErr(
            "accessor methods for relationships " + "returns non null failed");
        pass = false;
      }
    } catch (Exception e) {
  ...
  public void cascadedelete_1xM_bi_test2b() throws Fault {
    ...
    try {
      ...
      // correct collection
      if (b.test2b())
        TestUtil.logMsg("accessor methods for relationships "
            + "returns correct collection passed");
      else {
        TestUtil.logErr("accessor methods for relationships "
            + "returns incorrect collection failed");
        pass = false;
      }
    } catch (Exception e) {

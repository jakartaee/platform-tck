...
public class Schema {
    ...
    private static void RemoveSchemaEJBs() {
        ...
        try {
            ...
            while (i.hasNext()) {
                Customer cref = (Customer) PortableRemoteObject.narrow(i.next(), Customer.class);
                try {
                    cref.remove();
                } catch (Exception e) {
                    TestUtil.printStackTrace(e);
            ...
            i = col.iterator();
            while (i.hasNext()) {
                Product pref = (Product) PortableRemoteObject.narrow(i.next(), Product.class);
                try {
                    pref.remove();
                } catch (Exception e) {
                    TestUtil.printStackTrace(e);
    ...
    private static void createSchemaDVCs(boolean printMsgs) throws Exception {
        ...
        v1.add(phoneDVC[0]);
        v2.add(phoneDVC[1]);
        addressDVC[0] = new AddressDVC("1", "1 Oak Road", "Bedford", "MA", "02155", v1);
        addressDVC[1] = new AddressDVC("2", "1 Network Drive", "Burlington", "MA", "00252", v2);

        v1 = new Vector();
        v2 = new Vector();
        v1.add(phoneDVC[2]);
        v2.add(phoneDVC[3]);
        addressDVC[2] = new AddressDVC("3", "10 Griffin Road", "Lexington", "MA", "02277", v1);
        addressDVC[3] = new AddressDVC("4", "1 Network Drive", "Burlington", "MA", "00252", v2);

        v1 = new Vector();
        v2 = new Vector();
        v1.add(phoneDVC[4]);
        v2.add(phoneDVC[5]);
        addressDVC[4] = new AddressDVC("5", "125 Moxy Lane", "Swansea", "MA", "11345", v1);
        addressDVC[5] = new AddressDVC("6", "1 Network Drive", "Burlington", "MA", "11345", v2);

        v1 = new Vector();
        v2 = new Vector();
        v1.add(phoneDVC[6]);
        v2.add(phoneDVC[7]);
        addressDVC[6] = new AddressDVC("7", "2654 Brookline Avenue", "Brookline", "MA", "11678", v1);
        addressDVC[7] = new AddressDVC("8", "1 Network Drive", "Burlington", "MA", "00252", v2);

        v1 = new Vector();
        v2 = new Vector();
        v1.add(phoneDVC[8]);
        v2.add(phoneDVC[9]);
        addressDVC[8] = new AddressDVC("9", "100 Forrest Drive", "Hudson", "NH", "78654", v1);
        addressDVC[9] = new AddressDVC("10", "1 Network Drive", "Burlington", "MA", "00252", v2);

        v1 = new Vector();
        v2 = new Vector();
        v1.add(phoneDVC[10]);
        v2.add(phoneDVC[11]);
        addressDVC[10] = new AddressDVC("11", "200 Elliot Road", "Nashua", "NH", "65447", v1);
        addressDVC[11] = new AddressDVC("12", "1 Network Drive", "Burlington", "MA", "00252", v2);

        v1 = new Vector();
        v2 = new Vector();
        v1.add(phoneDVC[12]);
        v2.add(phoneDVC[13]);
        addressDVC[12] = new AddressDVC("13", "634 Goldstar Road", "Peabody", "MA", "88444", v1);
        addressDVC[13] = new AddressDVC("14", "1 Network Drive", "Burlington", "MA", "00252", v2);

        v1 = new Vector();
        v2 = new Vector();
        v1.add(phoneDVC[14]);
        v2.add(phoneDVC[15]);
        addressDVC[14] = new AddressDVC("15", "100 Forrest Drive", "Peabody", "MA", "88444", v1);
        addressDVC[15] = new AddressDVC("16", "1 Network Drive", "Burlington", "MA", "00252", v2);

        v1 = new Vector();
        v2 = new Vector();
        v1.add(phoneDVC[16]);
        v2.add(phoneDVC[17]);
        addressDVC[16] = new AddressDVC("17", "18 Rosewood Avenue", null, "MA", "87653", v1);
        addressDVC[17] = new AddressDVC("18", "1 Network Drive", "Burlington", "MA", "00252", v2);
        ...
        addressDVC[19] = new AddressDVC("20", "1 Network Drive", "Burlington", "MA", "00252", v2);

        v1 = new Vector();
        v2 = new Vector();
        v1.add(phoneDVC[20]);
        v2.add(phoneDVC[21]);
        addressDVC[20] = new AddressDVC("21", "3212 Boston Road", "Chelmsford", "MA", "01824", v1);
        addressDVC[21] = new AddressDVC("22", "1 Network Drive", "Burlington", "MA", "00252", v2);

        v1 = new Vector();
        v2 = new Vector();
        v1.add(phoneDVC[22]);
        v2.add(phoneDVC[23]);
        addressDVC[22] = new AddressDVC("23", "212 Edgewood Drive", "Claremont", "NH", "58976", v1);
        addressDVC[23] = new AddressDVC("24", "1 Network Drive", "Burlington", null, "00252", v2);

        v1 = new Vector();
        v2 = new Vector();
        v1.add(phoneDVC[24]);
        v2.add(phoneDVC[25]);
        addressDVC[24] = new AddressDVC("25", "47 Skyline Drive", "Attleboro", "MA", "76656", v1);
        addressDVC[25] = new AddressDVC("26", "1 Network Drive", "Burlington", "MA", null, v2);
        ...
        creditCardDVC[3] = new CreditCardDVC("4", "0002-1221-0078-0890", "VISA", "05/03", true, (double) 8000);
        creditCardDVC[4] = new CreditCardDVC("5", "1987-5555-8733-0011", "VISA", "05/03", true, (double) 2500);
        creditCardDVC[5] = new CreditCardDVC("6", "0000-0011-2200-3087", "MCARD", "11/02", true, (double) 23000);
        creditCardDVC[6] = new CreditCardDVC("7", "3341-7610-8880-9910", "AXP", "10/04", true, (double) 13000);
        creditCardDVC[7] = new CreditCardDVC("8", "2222-3333-4444-5555", "MCARD", "12/03", true, (double) 2000);
        creditCardDVC[8] = new CreditCardDVC("9", "8888-2222-0090-1348", "AXP", "01/02", true, (double) 4500);
        creditCardDVC[9] = new CreditCardDVC("10", "1762-5094-8769-3117", "VISA", "06/01", true, (double) 14000);
        creditCardDVC[10] = new CreditCardDVC("11", "1234-1234-1234-9999", "MCARD", "09/03", true, (double) 7000);
        creditCardDVC[11] = new CreditCardDVC("12", "9876-9876-1234-5678", "VISA", "04/04", false, (double) 1000);
        creditCardDVC[12] = new CreditCardDVC("13", "7777-8888-9999-0012", "MCARD", "01/02", true, (double) 3500);
        creditCardDVC[13] = new CreditCardDVC("14", "9099-8808-7718-4455", "AXP", "03/05", true, (double) 4400);
        creditCardDVC[14] = new CreditCardDVC("15", "7653-7901-2397-1768", "AXP", "02/04", true, (double) 5000);
        creditCardDVC[15] = new CreditCardDVC("16", "8760-8618-9263-3322", "VISA", "04/05", false, (double) 750);
        creditCardDVC[16] = new CreditCardDVC("17", "9870-2309-6754-3210", "MCARD", "03/03", true, (double) 500);
        creditCardDVC[17] = new CreditCardDVC("18", "8746-8754-9090-1234", "AXP", "08/04", false, (double) 1500);
        ...
        spouseDVC[3] = new SpouseDVC("4", "Thomas", null, "Mullen", "210-23-3456", infoDVC[3]);
        spouseDVC[4] = new SpouseDVC("5", "Mitchell", null, "Jackson", "476-44-3349", infoDVC[4]);
        spouseDVC[5] = new SpouseDVC("6", "Cynthia", "White", "Allen", "508-908-7765", infoDVC[5]);
    }
    ...
    private static void createSchemaEJBs(Properties p) throws Exception {
        ...
        customerRef[0] = customerHome.create("1", "Alan E. Frechette", addressDVC[0], addressDVC[1], countryDVC[0]);
        customerRef[0].initLogging(props);

        customerRef[1] = customerHome.create("2", "Arthur D. Frechette", addressDVC[2], addressDVC[3], countryDVC[1]);
        customerRef[1].initLogging(props);

        customerRef[2] = customerHome.create("3", "Shelly D. Mcgowan", addressDVC[4], addressDVC[5], countryDVC[2]);
        customerRef[2].initLogging(props);

        customerRef[3] = customerHome.create("4", "Robert E. Bissett", addressDVC[6], addressDVC[7], countryDVC[3]);
        customerRef[3].initLogging(props);

        customerRef[4] = customerHome.create("5", "Stephen S. D'Milla", addressDVC[8], addressDVC[9], countryDVC[4]);
        customerRef[4].initLogging(props);

        customerRef[5] = customerHome.create("6", "Karen R. Tegan", addressDVC[10], addressDVC[11], countryDVC[5]);
        customerRef[5].initLogging(props);

        customerRef[6] = customerHome.create("7", "Stephen J. Caruso", addressDVC[12], addressDVC[13], countryDVC[6]);
        customerRef[6].initLogging(props);

        customerRef[7] = customerHome.create("8", "Irene M. Caruso", addressDVC[14], addressDVC[15], countryDVC[7]);
        customerRef[7].initLogging(props);

        customerRef[8] = customerHome.create("9", "William P. Keaton", addressDVC[16], addressDVC[17], countryDVC[8]);
        ...
        productRef[0] = productHome.create("1", "Java 2 Unleashed Programming", (double) 54.95, 100, (long) 987654321);
        productRef[0].initLogging(props);

        productRef[1] = productHome.create("2", "Java 2 Network Programming", (double) 37.95, 100, (long) 876543219);
        ...
        productRef[5] = productHome.create("6", "Compaq Laptop PC", (double) 995.95, 33, (long) 432198765);
        productRef[5].initLogging(props);

        productRef[6] = productHome.create("7", "Toshiba Laptop PC", (double) 1210.95, 22, (long) 321987654);
        productRef[6].initLogging(props);

        productRef[7] = productHome.create("8", "Gateway Laptop PC", (double) 1100.95, 11, (long) 219876543);
        ...
        productRef[11] = productHome.create("12", "Programming for Dummies", (double) 24.95, 45, (long) 345678912);
        productRef[11].initLogging(props);

        productRef[12] = productHome.create("13", "Introduction to Java", (double) 60.95, 95, (long) 456789123);
        productRef[12].initLogging(props);

        productRef[13] = productHome.create("14", "Ultra System", (double) 5095.95, 250, (long) 567891234);
        ...
        productRef[17] = productHome.create("18", "Trial Software", (double) 10.00, 75, (long) 912345678);
        ...
        totalPrice = productRef[0].getPrice()
                + productRef[1].getPrice()
                + productRef[2].getPrice()
                + productRef[3].getPrice()
        ...
        totalPrice = productRef[0].getPrice()
                ...
                + productRef[3].getPrice()
                + productRef[4].getPrice()
                + productRef[5].getPrice()
                + productRef[6].getPrice()
                + productRef[7].getPrice();
        ...
        totalPrice = productRef[1].getPrice()
                + productRef[2].getPrice()
                + productRef[12].getPrice()

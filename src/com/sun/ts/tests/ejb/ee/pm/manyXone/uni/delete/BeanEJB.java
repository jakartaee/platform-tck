...
public abstract class BeanEJB implements EntityBean {
    ...
    public boolean test2() {
        ...
        try {
            ...
            TestUtil.logMsg("Delete entitybean object A1");
            aOne.remove();
            TestUtil.logMsg("Check relationship accessor method of " + "entitybean object bOne and bTwo");
    ...
    public boolean test3() {
        ...
        try {
            ...
            TestUtil.logMsg("Delete entitybean object A1");
            aOne.remove();
            TestUtil.logMsg("Assigning aOne to BeanEJB must throw IllegalArgumentException");
            setA1(aOne);

...
public abstract class BeanEJB implements EntityBean {
    ...
    public boolean test4() {
        ...
        /*
         * A TransactionRolledbackLocalException (an EJBException) should occur when calling the business method of another bean
         * with the client's tx context. This follows the behavior of 18.3.1. We expect an EJBException here.
         */
        try {
    ...
    public String ejbCreate(String id, String name, int value, ADVC aOne, BDVC bOne, ADVC aTwo, BDVC bTwo)
    ...
    public void ejbPostCreate(String id, String name, int value, ADVC aOne, BDVC bOne, ADVC aTwo, BDVC bTwo)
            throws CreateException {
        TestUtil.logTrace("ejbPostCreate");
        ALocal a1, a2;
        BLocal b1, b2;

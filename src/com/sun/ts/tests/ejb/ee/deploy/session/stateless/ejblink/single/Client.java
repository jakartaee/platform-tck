...
public class Client extends EETest {
     ...
     * (StatelessInternal) which is part of the same JAR file.
     *
     ...
     * @assertion_ids: EJB:SPEC:765
     *
     * @test_Strategy: Deploy a Stateless Session bean (TestBean) referencing a Statelful Session bean (StatefulInternal)
     ...
     * @assertion_ids: EJB:SPEC:765
     *
     * @test_Strategy: Deploy a Stateless Session bean (TestBean) referencing a CMP 1.1 Entity bean (CMP11External) which is

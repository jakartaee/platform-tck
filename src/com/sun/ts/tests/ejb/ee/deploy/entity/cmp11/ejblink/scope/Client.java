...
public class Client extends EETest {
     ...
     *
     * @test_Strategy: A CMP 1.1. Entity bean references two other beans. One in the same JAR file, the other in a distinct
     * JAR file. Both referenced bean use the same ejb-name in their respective JAR file, and they are identified by a
     ...
     * referenced bean identities (as reported by the String env. entry) match the ones specified in the DD.
     */

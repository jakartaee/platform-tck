...
public class Client extends EETest {
     ...
     *
     * @test_Strategy: A BMP Entity bean references two other beans. One in the same JAR file, the other in a distinct JAR
     * file. Both referenced bean use the same ejb-name in their respective JAR file, and their are identified by a String

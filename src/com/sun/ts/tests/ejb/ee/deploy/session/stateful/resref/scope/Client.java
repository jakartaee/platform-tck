...
public class Client extends EETest {
     ...
     *
     * - Two Stateful Session beans using the same res-ref-name ('jms/myFactory') to reference two distinct resource manager

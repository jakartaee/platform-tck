...
package com.sun.ts.tests.ejb.ee.deploy.entity.bmp.compat13_14;
...
public class Client extends EETest {
  ...
  public void setup(String[] args, Properties props) throws Fault {
    ...
    try {
      ...
      logMsg("[Client] initializing BMP table...");
   ...
   *                 client references a BMP bean in this ejb-jar module.
   *
   *                 Deploy the ear file.
   *
  ...
  public void test13DD() throws Fault {
    ...
    try {
      ...
      pass = bean.ping();
      if (!pass) {
        throw new Fault("BMP compat13_14 test failed");
      }
    } catch (Exception e) {
      throw new Fault("BMP compat13_14 test failed: " + e, e);
    }
  }

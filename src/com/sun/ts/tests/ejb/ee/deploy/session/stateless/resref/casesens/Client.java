...
public class Client extends EETest {
     ...
     *
     * @test_Strategy: Deploy a Stateless Session bean (TestBean) with two resource references whose name differ only by
     * case and are assigned to two distinct factory types: a jakarta.jms.QueueConnectionFactory and a

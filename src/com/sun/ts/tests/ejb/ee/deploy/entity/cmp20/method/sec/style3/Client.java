...
public class Client extends EETest {
     ...
     *
     * @test_Strategy: Package a CMP 2.0 Entity bean using a Style 3 declaration to grant permission to role 'Employee' for
     ...
     * @assertion_ids: EJB:SPEC:805; EJB:SPEC:811
     *
     * @test_Strategy: Package a CMP 2.0 Entity bean using a Style 3 declaration to grant permissions to role 'Manager' only

...
package com.sun.ts.tests.ejb.ee.deploy.session.stateless.compat12_13;
...
public class Client extends EETest {
   ...
   *
   *                 Package an .ear file (J2EE 1.3 DD's) including the ejb-jar
  ...
  public void test12DD() throws Fault {
    ...
    try {
      ...
      pass = bean.ping();
      if (!pass) {
        throw new Fault("Stateless compat12_13 test failed");
      }
    } catch (Exception e) {
      throw new Fault("Stateless compat12_13 test failed: " + e, e);
    }
  }

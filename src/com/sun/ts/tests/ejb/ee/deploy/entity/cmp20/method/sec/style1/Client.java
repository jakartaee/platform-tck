...
public class Client extends EETest {
     ...
     *
     * @test_Strategy: Package a CMP 2.0 Entity bean using a Style1 declaration to grant permission to role 'Employee'.
     ...
     * @assertion_ids: EJB:SPEC:805; EJB:SPEC:811
     *
     * @test_Strategy: Package a CMP 2.0 Entity bean using a Style1 declaration to grant permissions to role 'Manager' only.
     ...
     *
     * @test_Strategy: Package a CMP 2.0 Entity bean using: - a Style1 declaration to grant permissions to role Employee

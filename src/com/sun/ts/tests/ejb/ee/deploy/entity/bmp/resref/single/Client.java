...
public class Client extends EETest {
     ...
     *
     * @test_Strategy: Create a BMP Entity Bean declaring a resource reference for a javax.sql.Datasource.
     *
     ...
     * @assertion_ids: EJB:SPEC:10766
     *
     * @test_Strategy: Create a BMP Entity Bean declaring a resource reference for a jakarta.mail.Session.
     *
     ...
     * @assertion_ids: EJB:SPEC:10766
     *
     * @test_Strategy: Create a BMP Entity Bean declaring a resource reference for a java.net.URL.
     *
     ...
     * @assertion_ids: EJB:SPEC:10766
     *
     * @test_Strategy: Create a BMP Entity Bean declaring a resource reference for a jakarta.jms.QueueConnectionFactory.
     *
     ...
     * @assertion_ids: EJB:SPEC:10766
     *
     * @test_Strategy: Create a BMP Entity Bean declaring a resource reference for a jakarta.jms.TopicConnectionFactory.
     *
     ...
     * @assertion_ids: EJB:SPEC:10766
     *
     * @test_Strategy: Create a BMP Entity Bean declaring a resource reference for all the standard resource manager

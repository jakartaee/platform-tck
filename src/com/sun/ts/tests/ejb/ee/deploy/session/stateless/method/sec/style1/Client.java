...
public class Client extends EETest {
     ...
     *
     * @test_Strategy: Package a Stateless Session bean using a Style1 declaration to grant permission to role 'Employee'.
     ...
     * @assertion_ids: EJB:SPEC:805; EJB:SPEC:811
     *
     * @test_Strategy: Package a Stateless Session bean using a Style1 declaration to grant permissions to role 'Manager'
     * only. Login as a user that is not associated to this security role and check that we get a java.rmi.RemoteException
     * when calling a business method on that bean.
     */
     ...
     *
     * @test_Strategy: Package a Stateless Session bean using: - a Style1 declaration to grant permissions to role Employee

...
public class Client extends EETest {
     ...
     *
     * @test_Strategy: Deploy a Stateless Session bean with two String environment entries whose name differ only by case
     * and are assigned to two distinct values. Check that we can lookup the two environment entries. Check that their
     * runtime values are distinct and match the ones specified in the DD.
     */

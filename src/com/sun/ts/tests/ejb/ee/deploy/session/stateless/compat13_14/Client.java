...
package com.sun.ts.tests.ejb.ee.deploy.session.stateless.compat13_14;
...
public class Client extends EETest {
   ...
   *
   *                 Package an .ear file (J2EE 1.4 DD's) including the ejb-jar
   *                 and an application client (J2EE 1.4 DD's). This application
   *                 client references a Stateless Session bean in this ejb-jar
   *                 module.
   *
   *                 Deploy the .ear file.
   *
  ...
  public void test13DD() throws Fault {
    ...
    try {
      ...
      pass = bean.ping();
      if (!pass) {
        throw new Fault("Stateless compat13_14 test failed");
      }
    } catch (Exception e) {
      throw new Fault("Stateless compat13_14 test failed: " + e, e);
    }
  }

...
public class Client extends EETest {
     ...
     *
     * @test_Strategy: A Stateful Session bean references two other beans. One in the same JAR file, the other in a distinct
     * JAR file. Both referenced beans use the same ejb-name in their respective JAR file, and are identified by a String

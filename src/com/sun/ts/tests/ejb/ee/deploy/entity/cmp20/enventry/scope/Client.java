...
public class Client extends EETest {
     ...
     *
     * @test_Strategy: Deploy two CMP 2.0 Entity beans (part of a same JAR file) using the same env-entry-name but declaring
     ...
     * @assertion_ids: EJB:SPEC:757.1
     *
     * @test_Strategy: Deploy two CMP 2.0 Entity beans (in 2 distinct JAR files) using the same env-entry-name but declaring

...
package com.sun.ts.tests.ejb.ee.deploy.entity.bmp.method.sec.style1;
...
public class Client extends EETest {
     ...
     *
     * @test_Strategy: Package a BMP Entity bean using a Style1 declaration to grant permission to role 'Employee'. Login as
     * a user associated to this security role and check that we can call a business method on that bean.
     */
     ...
     * @assertion_ids: EJB:SPEC:805; EJB:SPEC:811
     *
     * @test_Strategy: Package a BMP Entity bean using a Style1 declaration to grant permissions to role 'Manager' only.
    ...
    public void testStyle1Negative() throws Fault {
        ...
        try {
            ...
            throw new Fault("Style1 negative test failed: " + "We were allowed to can test1 method!");
     ...
     *
     * @test_Strategy: Package a BMP Entity bean using: - a Style1 declaration to grant permissions to role Employee only. -
     * a Style2 declaration to grant permissions to role Manager only for business method test2.
     *
     ...
     *
     * @test_Strategy: Package a BMP Entity bean using: - a Style1 declaration to grant permissions to role Employee only. -
     * a Style3 declaration to grant permissions to role Manager only for business method test3(int).
     *
     * Login as a user that is associated with the Employee security role, but not the Manager's one. Check that we can call

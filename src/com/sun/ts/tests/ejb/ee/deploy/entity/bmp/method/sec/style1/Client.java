...
public class Client extends EETest {
     ...
     *
     * @test_Strategy: Package a BMP Entity bean using a Style1 declaration to
     ...
     *
     * @test_Strategy: Package a BMP Entity bean using: - a Style1 declaration to
     *                 grant permissions to role Employee only. - a Style2
     ...
     *
     * @test_Strategy: Package a BMP Entity bean using: - a Style1 declaration to
     *                 grant permissions to role Employee only. - a Style3
     *                 declaration to grant permissions to role Manager only for

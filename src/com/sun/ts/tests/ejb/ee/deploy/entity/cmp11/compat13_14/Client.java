...
package com.sun.ts.tests.ejb.ee.deploy.entity.cmp11.compat13_14;
...
public class Client extends EETest {
  ...
  public void test13DD() throws Fault {
    ...
    try {
      ...
      pass = bean.ping();
      if (!pass) {
        throw new Fault("CMP 1.1 compat13_14 test failed");
      }
    } catch (Exception e) {
      throw new Fault("CMP 1.1 compat13_14 test failed: " + e, e);
    } finally {
      try {

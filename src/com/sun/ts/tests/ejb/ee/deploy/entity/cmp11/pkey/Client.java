...
public class Client extends EETest {
     ...
     *
     * @test_Strategy: Package a CMP 1.1 Entity bean with a String primary key
     *
     ...
     * @assertion_ids: EJB:SPEC:10147
     *
     * @test_Strategy: Package a CMP 1.1 Entity bean with a Long primary key
     *
     *                 Check that you can: - Create bean instances - Discover
     *                 these instances with findByPrimaryKey() - Compare the bean
     *                 instances (EJBObject.isIdentical()) - Get the primary keys
     ...
     * @assertion_ids: EJB:SPEC:10147
     *
     * @test_Strategy: Package a CMP 1.1 Entity bean with a Float primary key
     *
     *                 Check that you can: - Create bean instances - Discover
     *                 these instances with findByPrimaryKey() - Compare the bean
     *                 instances (EJBObject.isIdentical()) - Get the primary keys
     ...
     * @assertion_ids: EJB:SPEC:10147
     *
     * @test_Strategy: Package a CMP 1.1 Entity bean with a compound primary key
     *
     *                 Check that you can: - Create bean instances - Discover
     *                 these instances with findByPrimaryKey() - Compare the bean
     *                 instances (EJBObject.isIdentical()) - Get the primary keys

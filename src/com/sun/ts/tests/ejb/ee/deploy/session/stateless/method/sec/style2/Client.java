...
package com.sun.ts.tests.ejb.ee.deploy.session.stateless.method.sec.style2;
...
public class Client extends EETest {
     ...
     *
     * @test_Strategy: Package a Stateless Session bean using a Style 2 declaration to grant permission to role 'Employee'
     * for test1 methods. Login as a user associated to this security role and check that we can call a business method on
     * that bean.
     */
     ...
     * @assertion_ids: EJB:SPEC:805; EJB:SPEC:811
     *
     * @test_Strategy: Package a Stateless Session bean using a Style 2 declaration to grant permissions to role 'Manager'
     * only for test2 methods. Login as a user that is not associated to this security role and check that we get a
    ...
    public void testStyle2Negative() throws Fault {
        ...
        try {
            ...
            throw new Fault("Style2 negative test failed: " + "We were allowed to call method!");
     ...
     *
     * @test_Strategy: Package a Stateless Session bean using: - a Style 2 declaration to grant permissions to role Employee
     * only for test1 business methods. - a Style3 declaration to grant permissions to role Manager only for business method
     * test1(int).
     *
    ...
    public void testStyle3Style2() throws Fault {
        ...
        try {
            ...
            if (!pass) {
                throw new Fault("Style 2 union test failed.");
            }
        } catch (Exception e) {
            TestUtil.logErr("[Client] Unexpected exception: " + e);

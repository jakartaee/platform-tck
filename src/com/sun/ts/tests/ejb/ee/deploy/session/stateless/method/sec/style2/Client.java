...
public class Client extends EETest {
     ...
     *
     * @test_Strategy: Package a Stateless Session bean using a Style 2
     *                 declaration to grant permission to role 'Employee' for
     *                 test1 methods. Login as a user associated to this security
     *                 role and check that we can call a business method on that
     *                 bean.
     */
     ...
     *                 test2 methods. Login as a user that is not associated to
     *                 this security role and check that we get a

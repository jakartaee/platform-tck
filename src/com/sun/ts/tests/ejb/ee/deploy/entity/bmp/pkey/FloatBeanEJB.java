...
public class FloatBeanEJB implements EntityBean {
    ...
    public Float ejbCreate(Properties props, float cofID, String cofName, float cofPrice) throws CreateException {
    ...
    public void ejbPostCreate(Properties props, float cofID, String cofName, float cofPrice) {
    ...
    public void ejbLoad() throws EJBException {
        ...
        try {
            ...
            this.cofPrice = dao.loadPrice(((Float) ectx.getPrimaryKey()).floatValue());

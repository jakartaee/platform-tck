...
public class Client extends EETest {
    ...
    private static final String testName = "com.sun.ts.tests.ejb.ee.deploy.session.stateful" + ".enventry.scope.Bean";
    ...
    public void testScopeInternal() throws Fault {
        ...
        try {
            ...
            throw new Fault("Client: Env entry scope test failed [same JAR]: " + e, e);
        }
    }

...
public class Client extends EETest {
     ...
     *
     * @test_Strategy: Deploy and create a CMP 1.1 Entity bean whose DD declares a Character environment entry. Lookup this
     ...
     * @assertion_ids: EJB:SPEC:762
     *
     * @test_Strategy: Deploy and create a CMP 1.1 Entity bean whose DD declares a String environment entry. Lookup this
     * entry and check that its runtime value match the DD value.
     *
     */
     ...
     * @assertion_ids: EJB:SPEC:762
     *
     * @test_Strategy: Deploy and create a CMP 1.1 Entity bean whose DD declares a Boolean environment entry. Lookup this
     * entry and check that its runtime value match the DD value.
     *
     */
     ...
     * @assertion_ids: EJB:SPEC:762
     *
     * @test_Strategy: Deploy and create a CMP 1.1 Entity bean whose DD declares a Byte environment entry. Lookup this entry
     ...
     * @assertion_ids: EJB:SPEC:762
     *
     * @test_Strategy: Deploy and create a CMP 1.1 Entity bean whose DD declares a Short environment entry. Lookup this
     * entry and check that its runtime value match the DD value.
     *
     */
     ...
     * @assertion_ids: EJB:SPEC:762
     *
     * @test_Strategy: Deploy and create a CMP 1.1 Entity bean whose DD declares a Integer environment entry. Lookup this
     * entry and check that its runtime value match the DD value.
     *
     */
     ...
     * @assertion_ids: EJB:SPEC:762
     *
     * @test_Strategy: Deploy and create a CMP 1.1 Entity bean whose DD declares a Long environment entry. Lookup this entry
     * and check that its runtime value match the DD value.
     *
     */
     ...
     * @assertion_ids: EJB:SPEC:762
     *
     * @test_Strategy: Deploy and create a CMP 1.1 Entity bean whose DD declares a Float environment entry. Lookup this
     * entry and check that its runtime value match the DD value.
     *
     */
     ...
     * @assertion_ids: EJB:SPEC:762
     *
     * @test_Strategy: Deploy and create a CMP 1.1 Entity bean whose DD declares a Double environment entry. Lookup this
     * entry and check that its runtime value match the DD value.
     *
     */
     ...
     * @assertion_ids: EJB:SPEC:762
     *
     * @test_Strategy: Deploy and create a CMP 1.1 Entity bean whose DD declares an environment entry of each type. Lookup

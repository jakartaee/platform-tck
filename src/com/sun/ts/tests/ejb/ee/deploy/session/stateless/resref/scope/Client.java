...
public class Client extends EETest {
     ...
     *
     * - Two Stateless Session beans using the same res-ref-name ('jms/myFactory') to reference two distinct resource
     * manager connection factories (a QueueConnectionFactory and a TopicConnectionFactory).
     *
     * We check that:
     *

...
package com.sun.ts.tests.ejb.ee.deploy.entity.bmp.compat12_14;
...
public class Client extends EETest {
  ...
  public void test12DD() throws Fault {
    ...
    try {
      ...
      pass = bean.ping();
      if (!pass) {
        throw new Fault("BMP compat12_14 test failed");
      }
    } catch (Exception e) {
      throw new Fault("BMP compat12_14 test failed: " + e, e);
    }
  }

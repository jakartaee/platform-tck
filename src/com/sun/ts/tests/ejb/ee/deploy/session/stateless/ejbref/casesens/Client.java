...
public class Client extends EETest {
     ...
     *
     * @test_Strategy: Deploy a Stateless Session bean (TestBean) with two EJB references whose name differ only by case and
     ...
     *
     * Check that TestBean can lookup the two beans. Check that their runtime value for the 'myName' env. entry are distinct
     * and match the ones specified in the DD (to check that the EJB reference were resolved correctly).
     */

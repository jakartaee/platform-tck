...
public class Client extends com.sun.ts.tests.jms.commonee.Client {
     ...
     *
     * @test_Strategy: Deploy a message-driven queue bean with two EJB references whose name differ only by case and are
     ...
     * the 'myName' env entry are distinct and correspond the ones specified in the DD (in an attempt to verify that the EJB

...
public class Client extends EETest {
     ...
     *
     * - Two CMP 1.1 Entity beans using the same res-ref-name ('jms/myFactory') to reference two distinct resource manager

...
package com.sun.ts.tests.ejb.ee.deploy.session.stateful.compat12_13;
...
public class Client extends EETest {
  ...
  public void test12DD() throws Fault {
    ...
    try {
      ...
      pass = bean.ping();
      if (!pass) {
        throw new Fault("Stateful compat12_13 test failed");
      }
    } catch (Exception e) {
      throw new Fault("Stateful compat12_13 test failed: " + e, e);
    }
  }

...
package com.sun.ts.tests.ejb.ee.deploy.session.stateful.compat12_14;
...
public class Client extends EETest {
  ...
  public void test13DD() throws Fault {
    ...
    try {
      ...
      pass = bean.ping();
      if (!pass) {
        throw new Fault("Stateful compat12_14 test failed");
      }
    } catch (Exception e) {
      throw new Fault("Stateful compat12_14 test failed: " + e, e);
    }
  }

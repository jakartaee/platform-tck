...
public class Client extends EETest {
     ...
     *
     * Another Stateless Session bean (TestBean) references these two beans using ejb-link elements. Check that TestBean can
     * lookup the two beans and check each bean identity based on their value for the 'myName' environment entry. Check that
     * this identity correspond to the references specified in the DD (validates that the EJB references were resolved
     * correctly).
     */

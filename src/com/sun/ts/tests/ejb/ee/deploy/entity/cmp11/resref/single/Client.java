...
package com.sun.ts.tests.ejb.ee.deploy.entity.cmp11.resref.single;
...
public class Client extends EETest {
     ...
     *
     * @test_Strategy: Create a CMP 1.1 Entity bean declaring a resource reference for a javax.sql.Datasource.
     *
     ...
     *
     *
     * @test_Strategy: Create a CMP 1.1 Entity bean declaring a resource reference for a jakarta.mail.Session.
     *
     ...
     * @assertion_ids: EJB:SPEC:10766
     *
     * @test_Strategy: Create a CMP 1.1 Entity bean declaring a resource reference for a java.net.URL.
     *
     ...
     * @assertion_ids: EJB:SPEC:10766
     *
     * @test_Strategy: Create a CMP 1.1 Entity bean declaring a resource reference for a jakarta.jms.QueueConnectionFactory.
     *
    ...
    public void testQueue() throws Fault {
        ...
        try {
            ...
            logErr("[Client] JMS Queue Factory test failed: " + e);
     ...
     *
     *
     * @test_Strategy: Create a CMP 1.1 Entity bean declaring a resource reference for a jakarta.jms.TopicConnectionFactory.
     *
    ...
    public void testTopic() throws Fault {
        ...
        try {
            ...
            logErr("[Client] JMS Topic Factory test failed: " + e);
     ...
     * @assertion_ids: EJB:SPEC:10766
     *
     * @test_Strategy: Create a CMP 1.1 Entity bean declaring a resource reference for all the standard resource manager

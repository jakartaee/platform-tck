...
public class Client extends com.sun.ts.tests.jms.commonee.Client {
     ...
     *
     * @test_Strategy: Deploy a message-driven queue bean referencing a stateless session bean (StatelessInternal) part of
     * the same JAR file.
     *
     ...
     * @assertion_ids: EJB:SPEC:765
     *
     * @test_Strategy: Deploy a message-driven bean referencing a stateful session bean (StatefulInternal) part of the same
     * JAR file.
     *
     * Check at runtime that the MDB can do a lookup for the ejb reference and use it to create a bean. Then invoke on that
     ...
     * file.
     *
     * Check at runtime that message-driven queue bean can do a lookup for the ejb reference and use it to create a bean.
     * Then invoke on that instance a business method to be found only in BMPInternal beans in an attempt to check that the
     ...
     * @assertion_ids: EJB:SPEC:765
     *
     * @test_Strategy: Deploy a message-driven queue bean referencing a BMP emtity bean (BMPExternal) part of the another
     * JAR file.
     *
     * Check at runtime that a MDB can do a lookup for the ejb reference and use it to create a bean. Then invoke on that

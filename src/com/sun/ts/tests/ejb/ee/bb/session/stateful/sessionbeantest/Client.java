...
public class Client extends EETest {
    ...
    public void test6() throws Fault {
        try {
            cRef.reset();
            logMsg("Required: Testing transaction notification synchronization - commit");
            // create EJB instance
            logMsg("Create EJB instance");
            beanRef = (TestBean) beanHome.create(cRef);
            logMsg("initialize remote logging");
    ...
    public void test7() throws Fault {
        try {
            cRef.reset();
            logMsg("Required: Testing transaction notification synchronization - rollback");
            logMsg("Create EJB instance");
            beanRef = (TestBean) beanHome.create(cRef);
            logMsg("initialize remote logging");
            beanRef.initLogging(props);
    ...
    public void test8() throws Fault {
        try {
            cRef.reset();
            logMsg("RequiresNew: Testing transaction notification synchronization - commit");
            // create EJB instance
            logMsg("Create EJB instance");
            beanRef = (TestBean) beanHome.create(cRef);
            logMsg("initialize remote logging");
    ...
    public void test9() throws Fault {
        try {
            cRef.reset();
            logMsg("RequiresNew: Testing transaction notification synchronization - rollback");
            // create EJB instance
            logMsg("Create EJB instance");
            beanRef = (TestBean) beanHome.create(cRef);
            logMsg("initialize remote logging");
    ...
    public void test14() throws Fault {
        try {
            cRef.reset();
            logMsg("Mandatory: Testing transaction notification synchronization - commit");
            // create EJB instance
            logMsg("Create EJB instance");
            beanRef = (TestBean) beanHome.create(cRef);
            logMsg("initialize remote logging");
    ...
    public void test15() throws Fault {
        try {
            cRef.reset();
            logMsg("Mandatory: Testing transaction notification synchronization - rollback");
            // create EJB instance
            logMsg("Create EJB instance");
            beanRef = (TestBean) beanHome.create(cRef);
            logMsg("initialize remote logging");

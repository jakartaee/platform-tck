...
public abstract class TestBeanEJB implements EntityBean {
    ...
    public boolean loopBackAnotherBean(Properties p) {
        ...
        try {
            ...
            LoopBackHome beanHome = (LoopBackHome) nctx.lookup(beanName, LoopBackHome.class);
            // create EJB instance
    ...
    public boolean loopBackAnotherBeanLocal() {
        ...
        try {
            ...
            LoopBackLocalHome beanHomeLocal = (LoopBackLocalHome) nctx.lookup(beanNameLocal, LoopBackLocalHome.class);
            // create EJB instance
            TestUtil.logMsg("Create EJB instance");
            LoopBackLocal beanRef = (LoopBackLocal) beanHomeLocal.create();
            TestUtil.logMsg("Set bean reference");
            beanRef.setBeanRefLocal((TestBeanLocal) ectx.getEJBLocalObject());
            TestUtil.logMsg("Performing loopback call test");

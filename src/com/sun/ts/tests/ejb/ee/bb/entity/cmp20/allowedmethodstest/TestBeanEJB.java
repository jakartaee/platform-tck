...
public abstract class TestBeanEJB implements EntityBean, TimedObject {
    ...
    public Integer ejbCreate(Properties p, Helper ref, int id, String brandName, float price, int flag)
    ...
    public void ejbPostCreate(Properties p, int id, String brandName, float price) throws CreateException {
        TestUtil.logTrace("ejbPostCreate");
    }
    ...
    private void doOperationTests(String s) {
        ...
        try {
            ...
            TestUtil.logMsg("Operations test: getPrimaryKey() - not allowed (Unexpected Exception) - " + e);
        }

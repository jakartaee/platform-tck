...
public class CEJB implements EntityBean {
    ...
    public Integer ejbCreateC(Properties p, int cofID, String cofName, float cofPrice) throws CreateException {
    ...
    public void ejbPostCreateC(Properties p, int cofID, String cofName, float cofPrice) {
    ...
    // ===========================================================
    // C interface (our business methods)

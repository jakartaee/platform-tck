...
public abstract class AEJB implements EntityBean {
    ...
    public String ejbCreateA(String id, String name, int value) throws CreateException {
    ...
    public void ejbPostCreateA(String id, String name, int value) throws CreateException {

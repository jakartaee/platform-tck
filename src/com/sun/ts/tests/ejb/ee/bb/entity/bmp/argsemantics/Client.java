...
public class Client extends EETest {
     ...
     * view). - a BMP Caller bean, Calling this Session Bean home or remote interface.
     *
     ...
     *
     * - a BMP Caller bean, Calling this Session Bean local home or local interface.
     *
     ...
     *
     * - a BMP Caller bean, Calling this Session Bean home, local home, remote, or local interface.
     *
     ...
     * @test_Strategy:
     *
     * This is applicable to : - a CMP 2.0 Callee bean defining a remote client view only (No local view). - a BMP Caller
     * bean, Calling this CMP 2.0 Bean home or remote interface.
     *
     * We package in the same ejb-jar: - a CMP 2.0 Callee bean defining a remote client view only (No local view). - a BMP
     * Caller bean
     *
     * Remote Home arg semantics verification:
     *
     ...
     *
     * - a BMP Caller bean, Calling this CMP 2.0 Bean local home or local interface.
     *
     ...
     *
     * - a BMP Caller bean, Calling the CMP 2.0 Bean home, local home, remote, or local interface.
     *

...
public class Client extends EETest {
     ...
     * @test_Strategy:
     *
     * This is applicable to : - a Session Stateful Callee bean defining a remote client view only (No local view). - a
     * Stateless Caller bean, Calling this Callee Bean home or remote interface.
     *
     ...
     * view).
     *
     * - a Stateless Caller bean, Calling this Callee Bean local home or local interface.
     *
     ...
     *
     * - a Stateless Caller bean, Calling this Callee Bean home, local home, remote, or local interface.
     *
     ...
     * @test_Strategy:
     *
     * This is applicable to : - a CMP 2.0 Callee bean defining a remote client view only (No local view). - a Stateless
     ...
     *
     * - a Stateless Caller bean, Calling this CMP 2.0 Bean local home or local interface.
     *
     ...
     *
     * - a Stateless Caller bean, Calling the CMP 2.0 Bean home, local home, remote, or local interface.
     *

...
public class TestBeanEJB implements SessionBean {
    ...
    private void doOperationTests(String s) {
        ...
        try {
            ...
            TestUtil.logMsg("Operations test: Timer_Methods() - not allowed (Unexpected Exception) - " + e);
        }
    ...
    public void stopTestTimer() {
        try {
            ...
            TestUtil.logMsg("Looking up home interface for " + "stateless bean creating timer: " + timerLookup);
    ...
    public boolean testUTBegin() {
        ...
        try {
            ...
            TestUtil.logTrace("Attempt to call begin again before commit() or rollback()");
            sctx.getUserTransaction().begin();
            TestUtil.logMsg("UserTransaction.begin - allowed");
            ...
            try {
                if (sctx.getUserTransaction().getStatus() != Status.STATUS_NO_TRANSACTION) {

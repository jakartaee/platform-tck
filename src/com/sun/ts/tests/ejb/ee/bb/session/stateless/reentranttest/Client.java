...
public class Client extends EETest implements Runnable {
    ...
    public void setup(String[] args, Properties p) throws Fault {
        ...
        try {
            ...
            TestUtil.logMsg("Looking up home interface for ClientBean EJB: " + clientLookup);
            beanHome2 = (ClientBeanHome) nctx.lookup(clientLookup, ClientBeanHome.class);
    ...
    public void test1() throws Fault {
        ...
        try {
            ...
            if (successes != 2) {
                pass = false;
                logMsg("ERROR: test1 - did not get the expected results, " + "Expected successes = 2, got: "
                        + successes);
            } else {
                pass = true;
                logMsg("test1 - Expected results received, " + "Expected successes = 2, got: " + successes);
            }

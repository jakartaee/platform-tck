    ...
    public void webLocalAccessTest1() throws Fault {
        try {
            ...
            if (!expectedResult1.equals(s)) {
                TestUtil.logErr("Incorrect Results: Expected: " + expectedResult1 + " Received: " + s);
                pass = false;
            }
    ...
    public void webLocalAccessTest2() throws Fault {
        try {
            ...
            if (!expectedResult2.equals(s)) {
                TestUtil.logErr("Incorrect Results: Expected: " + expectedResult2 + " Received: " + s);
                pass = false;
            }
    ...
    public void webLocalAccessTest3() throws Fault {
        try {
            ...
            if (!expectedResult3.equals(s)) {
                TestUtil.logErr("Incorrect Results: Expected: " + expectedResult3 + " Received: " + s);
                pass = false;
            }
    ...
    public void webLocalAccessTest4() throws Fault {
        try {
            ...
            if (!expectedResult4.equals(s)) {
                TestUtil.logErr("Incorrect Results: Expected: " + expectedResult4 + " Received: " + s);
                pass = false;
            }

...
public class Client extends EETest {
   ...
   *
   *
   * @test_Strategy: This is applicable to : - a CMP 2.0 Callee bean defining a
   *                 remote client view only (No local view). - a Stateful
   ...
   *
   *                 - a Stateful Caller bean, Calling this CMP 2.0 Bean local
   *                 home or local interface.
   * 
   * 
   *                 We package in the same ejb-jar:
   *
   *                 - a Stateful Callee bean defining a local client view only
   *                 (No remote view).
   *
   *                 - a Stateful Caller bean
   *
   ...
   *                 client view.
   *
   *                 - a Stateful Caller bean, Calling the CMP 2.0 Bean home,
   *                 local home, remote, or local interface.
   * 
   *                 The test strategy is a cumulated version of the two

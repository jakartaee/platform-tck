...
public class Client extends EETest {
     ...
     * view). - a Stateful Caller bean, Calling this Callee Bean home or remote interface.
     *
     ...
     * @test_Strategy:
     *
     * This is applicable to : - a Session Stateful Callee bean defining a local client view only (No remote view).
     *
     * - a Stateful Caller bean, Calling this Callee Bean local home or local interface.
     *
     ...
     *
     * - a Stateful Caller bean, Calling this Callee Bean home, local home, remote, or local interface.
     *
     ...
     *
     *
     * @test_Strategy: This is applicable to : - a CMP 2.0 Callee bean defining a remote client view only (No local view). -
     * a Stateful Caller bean, Calling this CMP 2.0 Bean home or remote interface.
     *
     * We package in the same ejb-jar: - a CMP 2.0 Callee bean defining a remote client view only (No local view). - a
     * Stateful Caller bean
     *
     * Remote Home arg semantics verification:
     *
     * - We set a non-remote object 'arg' (of type SimpleArgument) to an initial value. This SimpleArgument class is just a
     ...
     *
     *
     * @test_Strategy: This is applicable to : - a CMP 2.0 Callee bean defining a local client view only (No remote view).
     *
     * - a Stateful Caller bean, Calling this CMP 2.0 Bean local home or local interface.
     *
     *
     * We package in the same ejb-jar:
     *
     * - a Stateful Callee bean defining a local client view only (No remote view).
     *
     * - a Stateful Caller bean
     *
     * Local Home arg semantics verification:
     ...
     *
     * - a Stateful Caller bean, Calling the CMP 2.0 Bean home, local home, remote, or local interface.
     *

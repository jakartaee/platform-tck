...
public class Client extends EETest {
   ...
   * 
   * @test_Strategy: A client of an session bean can be another EJB. This test
   * demonstrates bean to bean calls in different application EARs. Satisfy
   * inter-ear calls of application components. Create 2 stateful Session Beans.

...
public class Client extends EETest {
    ...
    private static final String testProps = "bean2beanmultijartest.properties";
     ...
     * @testName: test1
     *
     * @assertion_ids: EJB:SPEC:14; EJB:SPEC:16
     *
     * @test_Strategy: A client of an session bean can be another EJB. This test demonstrates bean to bean calls in
     * different application EARs. Satisfy inter-ear calls of application components. Create 2 stateful Session Beans.
     * Deploy them on the J2EE server. Client call bean1, bean1 call bean2.
     *
     */

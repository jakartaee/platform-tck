...
//****************************************************
//EntityBean Lifecyle Test for CMP20 entity beans
//****************************************************
...
public class Client extends EETest {
  ...
  public void test1() throws Fault {
    ...
    try {
      ...
      beanRef = (TestBean) beanHome.create(1, "coffee-1", 2, helperRef);
  ...
  public void test2() throws Fault {
    ...
    try {
      // create EJB instance
      logMsg("Create EJB instance");
      beanRef = (TestBean) beanHome.create(1, helperRef);
      beanRef.initLogging(props);
      logMsg("check if proper lifecycle creation order was called in the bean");
  ...
  public void test4() throws Fault {
    ...
    try {
      // create EJB instance
      logMsg("Create EJB instance");
      beanRef = (TestBean) beanHome.create(2, helperRef);
      beanRef.initLogging(props);

...
public abstract class TestBeanEJB implements EntityBean {
    ...
    public abstract void setB(byte[] b);

    // ===========================================================

    public Integer ejbCreate(int id, String brandName, float price, byte[] b) throws CreateException {
    ...
    public void ejbPostCreate(int id, String brandName, float price, byte[] b) {

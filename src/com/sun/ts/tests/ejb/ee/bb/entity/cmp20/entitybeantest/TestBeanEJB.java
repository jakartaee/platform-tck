...
public abstract class TestBeanEJB implements EntityBean {
    ...
    public void ejbPostCreate(int id, String brandName, float price, Helper r) throws CreateException {
    ...
    public Integer ejbCreate(int id, Helper r) throws CreateException, DuplicateKeyException {
        ref = r;
        TestUtil.logTrace("ejbCreate");
        TestUtil.logTrace("ejbNewInstanceFlag=" + ejbNewInstanceFlag
                + "\nejbEntityContextFlag=" + ejbEntityContextFlag + "\nejbCreateFlag="

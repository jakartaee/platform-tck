...
public abstract class TestBeanEJB implements EntityBean {
    ...
    public Object ejbCreate(String first, String middle, String last, String accountNumber) throws CreateException {
    ...
    public void ejbPostCreate(String first, String middle, String last, String accountNumber) throws CreateException {
        TestUtil.logTrace("ejbPostCreate");
    }

    public Object ejbCreateHomeAddress(String street, String city, String state, int zip) throws CreateException {
    ...
    public void ejbPostCreateHomeAddress(String street, String city, String state, int zip) throws CreateException {

...
public class Client extends EETest {
    ...
    class TestThread implements Runnable {
        ...
        public boolean runTest1() {
            ...
            try {
                ...
                TestBean beanRef = (TestBean) beanHome.findTheBean(props, pkey);
                ...
                for (int i = 0; i < NUMLOOPS; i++) {
                    synchronized (workLock) {
                        ...
                        beanRef.updatePrice((float) (currentPrice + threadNum + 1));
                        float updatePrice = beanRef.getPrice();
                        logMsg("Entity EJB currentPrice = " + currentPrice + ", updatePrice = " + updatePrice
                                + ", threadNum = " + threadNum);
    ...
    public void test1() throws Fault {
        try {
            ...
            beanRef = (TestBean) beanHome.create(props, newTable, pkey.intValue(), "coffee-1", 1);
            ...
            logMsg("Entity EJB initialPrice = " + initialPrice + ", Entity EJB finalPrice = " + finalPrice + " ...");
     ...
     * instances depends upon the Container Implementation. Unsynchronize calling of entity EJB methods. (Chapter 12.1.10)
     *
     */
    ...
    public void test3() throws Fault {
        ...
        try {
            ...
            logMsg("Entity EJB #1 initialPrice = " + initialPrice1 + ", Entity EJB #1 finalPrice = " + finalPrice1
                    + " ...");
            logMsg("Entity EJB #2 initialPrice = " + initialPrice2 + ", Entity EJB #2 finalPrice = " + finalPrice2
                    + " ...");

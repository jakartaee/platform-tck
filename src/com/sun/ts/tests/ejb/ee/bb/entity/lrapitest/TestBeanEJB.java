...
public class TestBeanEJB implements SessionBean {
    ...
    private CLocal createCLocal(String id, String name, int value) throws Exception {
    ...
    private DLocal createDLocal(int id, String name, float price) throws Exception {

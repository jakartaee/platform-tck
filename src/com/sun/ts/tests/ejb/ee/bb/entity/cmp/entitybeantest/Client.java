...
public class Client extends EETest {
     ...
     *
     * @test_Strategy: Create an CMP 1.1 entity bean. Deploy it on the J2EE server. Check creation life cycle call flow
     * occurs. Verifies proper ejbCreate/ejbPostCreate method called and correct lifecycle creation call flow.
     *
     */
     ...
     *
     * @test_Strategy: Create an CMP 1.1 entity bean. Deploy it on the J2EE server. Check creation life cycle call flow
     * occurs. Verifies proper ejbCreate/ejbPostCreate method called and correct lifecycle creation call flow. This test
     * uses a different create method than above.
     *
     */
     ...
     *
     * @test_Strategy: Create an entity CMP 1.1 bean. Deploy it on the J2EE server. Call ejbRemove() and check a Helper
     * object was notified to ensure ejbRemove was called. Invoke remove via EJBObject interface twice. A subsequent call to
     ...
     * @assertion_ids: EJB:SPEC:144.6; EJB:SPEC:145
     *
     * @test_Strategy: Create a CMP 1.1 entity bean. Deploy it on the J2EE server. Call ejbRemove() and check a Helper
     * object was notified to ensure ejbRemove was called. Invoke remove through EJBHome via handle twice. A subsequent call
     ...
     *
     * @test_Strategy: Create a CMP 1.1 entity bean. Deploy it on the J2EE server. Call ejbRemove() and check a Helper
     * object was notified to ensure ejbRemove was called. Invoke remove through EJBHome via PKEY twice. A subsequent call
     * to remove should return NoSuchObjectException or RemoteException.
     *
     */
     ...
     * EJBObject interface and attempt to call a business method afterwards. Create a CMP 1.1 entity bean. Deploy it on the
     * J2EE server. Call ejbRemove() and check a Helper object was notified to ensure ejbRemove was called.
     *
     */
     ...
     *
     * @test_Strategy: Container provides notification to bean of removal via callback ejbRemove(). Invoke remove through
     * EJBObject interface via handle and attempt to call a business method afterwards. Create a CMP 1.1 entity bean. Deploy
     * it on the J2EE server. Call ejbRemove() and check a Helper object was notified to ensure ejbRemove was called.
     *
     */
     ...
     *
     * @test_Strategy: Container provides notification to bean of removal via callback ejbRemove(). Invoke remove through
     * EJBObject via PKEY twice. Create a CMP 1.1 entity bean. Deploy it on the J2EE server. Call ejbRemove() and check a
     * Helper object was notified to ensure ejbRemove was called.
     *
     */

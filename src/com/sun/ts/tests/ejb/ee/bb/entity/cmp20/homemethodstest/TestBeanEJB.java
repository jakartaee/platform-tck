...
public abstract class TestBeanEJB implements EntityBean {
    ...
    public Integer ejbCreate(int id, String first, String middle, String last, String accountNumber)
    ...
    public void ejbPostCreate(int id, String first, String middle, String last, String accountNumber)
            throws CreateException {
    ...
    public Integer ejbCreateHomeAddress(int id, String street, String city, String state, int zip)
            throws CreateException {
    ...
    public void ejbPostCreateHomeAddress(int id, String street, String city, String state, int zip)
            throws CreateException {
        TestUtil.logTrace("ejbPostCreateHomeAddress");
    }

    public Integer ejbCreateCountry(int id, String name, String code) throws CreateException {
    ...
    public void ejbPostCreateCountry(int id, String name, String code) throws CreateException {
        TestUtil.logTrace("ejbPostCreateCountry");
    }

    public Integer ejbCreatePhone(int id, String homePhone, String workPhone) throws CreateException {
    ...
    public void ejbPostCreatePhone(int id, String homePhone, String workPhone) throws CreateException {
    ...
    public void ejbHomeAddCardFee(Integer key, double fee) {
        try {
            ...
            TestUtil.logTrace("Card balance before fee for pk: " + key + " is: " + currentBal);
            ref.setCardBalance(currentBal + fee);
            TestUtil.logTrace("Card balance after fee for pk: " + key + " is: " + ref.getCardBalance());
        } catch (Exception e) {
            TestUtil.printStackTrace(e);

...
public class TestBeanEJB implements SessionBean {
    ...
    public boolean loopBackAnotherBean(Properties p) {
        ...
        try {
            ...
            LoopBackHome beanHome = (LoopBackHome) lookup(beanName, LoopBackHome.class);
            // create EJB instance
            TestUtil.logMsg("Create EJB instance");
            LoopBack beanRef = (LoopBack) beanHome.create((TestBean) sctx.getEJBObject());
    ...
    public boolean loopBackAnotherBeanLocal() {
        ...
        try {
            // lookup EJB home
            TestUtil.logMsg("lookup home interface for EJB: " + beanName);
            LoopBackLocalHome beanLocalHome = (LoopBackLocalHome) lookup(beanName2, LoopBackLocalHome.class);
            // create EJB instance
            TestUtil.logMsg("Create EJB instance");
            LoopBackLocal beanLocalRef = (LoopBackLocal) beanLocalHome.create((TestBeanLocal) sctx.getEJBLocalObject());
            TestUtil.logMsg("Performing loopback call test");

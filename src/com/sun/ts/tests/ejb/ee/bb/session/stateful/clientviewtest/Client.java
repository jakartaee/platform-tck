...
public class Client extends EETest {
        ...
        try {
            ...
            if (handle == null) {
                ...
                try {
                    ...
                    TestUtil.logErr("Caught inner NoSuchObjectException in test3 as expected: " + e);
                    pass = true;
                } catch (Exception e) {
    ...
    public void test9() throws Fault {
        ...
        try {
            ...
            TestUtil.logErr("Caught inner NoSuchObjectException in test9 as expected: " + e);
            pass = true;
        } catch (Exception e) {

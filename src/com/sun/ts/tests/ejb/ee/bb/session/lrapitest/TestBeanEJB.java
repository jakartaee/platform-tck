...
public class TestBeanEJB implements SessionBean {
    ...
    public boolean test8() {
        ...
        try {
            ...
            TestUtil.logErr("Caught Unexpected Exception in test8: " + e.getMessage());
        } finally {
            try {
    ...
    public boolean test9() {
        ...
        try {
            ...
            TestUtil.logErr("Caught Unexpected Exception in test9: " + e.getMessage());
        } finally {
            try {
                TestUtil.logMsg("Attempt Removal of bean while participating in TX");
                aRef.remove();
    ...
    public boolean test10() {
        ...
        try {
            ...
            TestUtil.logErr("Caught Unexpected Exception in test10: " + e.getMessage());
        } finally {
            try {
                TestUtil.logMsg("Attempt Removal of bean while participating in TX");
    ...
    public boolean test11() {
        ...
        try {
            ...
            TestUtil.logErr("Caught Unexpected Exception in test11: " + e.getMessage());
        } finally {
            try {
                TestUtil.logMsg("Attempt Removal of bean while participating in TX");
                aHome.remove(aRef);

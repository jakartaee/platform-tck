...
public class Client extends EETest {
     ...
     *
     * @test_Strategy: Create an entity BMP bean. Deploy it on the J2EE server. Check creation life cycle call flow occurs.
     *
     */
     ...
     *
     * @test_Strategy: Create an entity BMP bean. Deploy it on the J2EE server. Call ejbRemove() and check a Helper object
     * was notified to ensure ejbRemove was called. Invoke remove via EJBObject interface twice. A subsequent call to remove
     ...
     * @assertion_ids: EJB:SPEC:144.6; EJB:SPEC:145
     *
     * @test_Strategy: Create a BMP entity bean. Deploy it on the J2EE server. Call ejbRemove() and check a Helper object
     * was notified to ensure ejbRemove was called. Invoke remove through EJBHome via handle twice. A subsequent call to
     ...
     *
     * @test_Strategy: Create a BMP entity bean. Deploy it on the J2EE server. Call ejbRemove() and check a Helper object
     * was notified to ensure ejbRemove was called. Invoke remove through EJBHome via PKEY twice. A subsequent call to
     * remove should return NoSuchObjectException or RemoteException.
     *
     */
     ...
     * EJBObject interface and attempt to call a business method afterwards. Create a BMP entity bean. Deploy it on the J2EE
     * server. Call ejbRemove() and check a Helper object was notified to ensure ejbRemove was called.
     *
     */
     ...
     *
     * @test_Strategy: Container provides notification to bean of removal via callback ejbRemove(). Invoke remove through
     * EJBObject interface via Handle and attempt to call a business method afterwards. Create a BMP entity bean. Deploy it
     * on the J2EE server. Call ejbRemove() and check a Helper object was notified to ensure ejbRemove was called.
     *
     */
     ...
     *
     * @test_Strategy: Container provides notification to bean of removal via callback ejbRemove(). Invoke remove through
     * EJBObject via PKEY twice. Create a BMP entity bean. Deploy it on the J2EE server. Call ejbRemove() and check a Helper
     ...
     *
     * @test_Strategy: Create an entity BMP bean. Deploy it on the J2EE server. Perform a direct insert following by a
     * create and ensure an exception is obtained - DuplicateKeyException.
     *
     */
     ...
     *
     * @test_Strategy: Create an entity bean. Deploy it on the J2EE server. Perform a direct delete followed by an
     * invocation of a business method and ensure RemoteException is obtained.
     *
     */
     ...
     *
     * @test_Strategy: Create an entity BMP bean. Deploy it on the J2EE server. Throw a EJBException instance will be
     * discarded.
     *
     */
     ...
     * @assertion_ids: EJB:SPEC:633.2; EJB:SPEC:633.3
     *
     * @test_Strategy: Create an entity BMP bean. Deploy it on the J2EE server. Throw a Error instance will be discarded.
     *
     */
     ...
     *
     * @test_Strategy: Create an entity BMP bean. Deploy it on the J2EE server. Check that ejbStore was called after

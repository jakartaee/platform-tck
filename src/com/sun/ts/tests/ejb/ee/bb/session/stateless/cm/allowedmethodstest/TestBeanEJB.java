...
public class TestBeanEJB implements SessionBean, TimedObject {
    ...
    private void doOperationTests(String s) {
        ...
        try {
            ...
            TestUtil.logMsg("Operations test: UserTransaction.begin - not allowed (Unexpected Exception) - " + e);
        }
        ...
        try {
            ...
            TestUtil.logMsg("Operations test: UserTransaction.commit - not allowed (Unexpected Exception) - " + e);
        }
        ...
        try {
            ...
            TestUtil.logMsg("Operations test: UserTransaction.getStatus - not allowed (Unexpected Exception) - " + e);
        }
        ...
        try {
            ...
            TestUtil.logMsg("Operations test: UserTransaction.rollback - not allowed (Unexpected Exception) - " + e);
        }
        ...
        try {
            ...
            TestUtil.logMsg(
                    "Operations test: UserTransaction.setRollbackOnly - not allowed (Unexpected Exception) - " + e);
        }
        ...
        try {
            ...
            TestUtil.logMsg("Operations test: getEJBLocalHome() - not allowed (Unexpected Exception) - " + e);
        }
        ...
        try {
            ...
            TestUtil.logMsg("Operations test: getEJBLocalObject() - not allowed (Unexpected Exception) - " + e);
        }
        ...
        try {
            ...
            TestUtil.logMsg("Operations test: getTimerService() - not allowed (Unexpected Exception) - " + e);
        }
        ...
        try {
            ...
            TestUtil.logMsg(
                    "Operations test: TimerService_Methods_Test1() - not allowed (Unexpected Exception) - " + e);
        }

        // TimerService_Methods_Test2
        try {
            jakarta.ejb.TimerService timesrv2 = sctx.getTimerService();
            jakarta.ejb.Timer t2 = timesrv2.createTimer((long) 10000, (long) 10000, "test2");
            t2.cancel();
            ...
            TestUtil.logMsg(
                    "Operations test: TimerService_Methods_Test2() - not allowed (Unexpected Exception) - " + e);
        }
        ...
        try {
            ...
            TestUtil.logMsg(
                    "Operations test: TimerService_Methods_Test3() - not allowed (Unexpected Exception) - " + e);
        }
        ...
        try {
            ...
            TestUtil.logMsg(
                    "Operations test: TimerService_Methods_Test4() - not allowed (Unexpected Exception) - " + e);
        }
        ...
        try {
            ...
            TestUtil.logMsg(
                    "Operations test: TimerService_Methods_Test5() - not allowed (Unexpected Exception) - " + e);
        }
        ...
        try {
            ...
            TestUtil.logMsg(
                    "Operations test: TimerService_Methods_Test6() - not allowed (Unexpected Exception) - " + e);
        }
        ...
        try {
            ...
            TestUtil.logMsg(
                    "Operations test: TimerService_Methods_Test7() - not allowed (Unexpected Exception) - " + e);
        }
    ...
    public boolean getCallerPrincipalTest(String s) {
        ...
        try {
            ...
            if (principal != null) {
                TestUtil.logMsg("getCallerPrincipal() returned Principal: " + principal);

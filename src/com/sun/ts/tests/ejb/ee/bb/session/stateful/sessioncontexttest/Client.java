...
public class Client extends EETest {
    ...
    public void test6b() throws Fault {
        ...
        try {
            ...
            TestBean2Home beanHome2 = (TestBean2Home) nctx.lookup(txRequired, TestBean2Home.class);
            // create EJB instance
            logMsg("Create EJB instance");
    ...
    public void test9() throws Fault {
        ...
        try {
            ...
            bean2Home = (TestBean2Home) nctx.lookup(txNotSupported, TestBean2Home.class);
            // create EJB instance
            logMsg("Create EJB instance");
    ...
    public void test12() throws Fault {
        ...
        try {
            ...
            bean2Home = (TestBean2Home) nctx.lookup(txRequiresNew, TestBean2Home.class);
            // create EJB instance
            logMsg("Create EJB instance");
            bean2Ref = (TestBean2) bean2Home.create(props);

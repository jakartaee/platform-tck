...
<%
    ...
    BLocal bLocalRef = null;
    String s;
    try {
            TSNamingContext nctx = new TSNamingContext();
            TestUtil.logMsg("Lookup local home of Session Stateful EJB and do create");
            BLocalHome  bLocalHome =
		(BLocalHome)nctx.lookup("java:comp/env/ejb/BEJB");
            bLocalRef = (BLocal) bLocalHome.createB();
        try {

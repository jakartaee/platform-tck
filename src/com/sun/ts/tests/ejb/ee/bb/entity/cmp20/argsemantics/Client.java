...
public class Client extends EETest {
    ...
    public void setup(String[] args, Properties props) throws Fault {
        try {
            ...
            bean = (CallerBean) beanHome.create(props, 1, "coffee-1", 2);
        } catch (Exception e) {
     ...
     *
     * - a CMP 2.0 Caller bean, Calling this Session Bean local home or local interface.
     *
     ...
     *
     * - a CMP 2.0 Caller bean, Calling this Session Bean home, local home, remote, or local interface.
     *
     ...
     * @test_Strategy:
     *
     * This is applicable to : - a CMP 2.0 Callee bean defining a remote client view only (No local view). - a CMP 2.0
     * Caller bean, Calling the CMP 2.0 Callee Bean home or remote interface.
     *
     * We package in the same ejb-jar: - a CMP 2.0 Callee bean defining a remote client view only (No local view). - a CMP
     * 2.0 Entity Caller bean
     *
     * Remote Home arg semantics verification:
     *
     * - We set a non-remote object 'arg' (of type SimpleArgument) to an initial value. This SimpleArgument class is just a
     ...
     *
     * - a CMP 2.0 Caller bean, Calling the CMP 2.0 Callee Bean local home or local interface.
     *
     ...
     *
     * - a CMP 2.0 Caller bean, Calling the CMP 2.0 Callee Bean home, local home, remote, or local interface.
     *

...
public class Client extends EETest {
   ...
   *                 2.0 Caller bean, Calling this Session Bean home or remote
   *                 interface.
   * 
   ...
   *
   *                 - a CMP 2.0 Caller bean, Calling this Session Bean local
   ...
   *                 local client view.
   *
   *                 - a CMP 2.0 Caller bean, Calling this Session Bean home,
   ...
   *                 remote client view only (No local view). - a CMP 2.0 Caller
   *                 bean, Calling the CMP 2.0 Callee Bean home or remote
   *                 interface.
   * 
   ...
   *
   *                 - a CMP 2.0 Caller bean, Calling the CMP 2.0 Callee Bean
   ...
   *
   *                 - a CMP 2.0 Caller bean, Calling the CMP 2.0 Callee Bean
   *                 home, local home, remote, or local interface.
   * 
   *                 The test strategy is a cumulated version of the two

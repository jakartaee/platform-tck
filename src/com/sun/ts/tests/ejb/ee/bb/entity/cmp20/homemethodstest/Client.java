...
public class Client extends EETest {
    ...
    public void test1() throws Fault {
        ...
        try {
            ...
            beanRef = (TestBean) beanHome.create(1, "John", "Edward", "Brown", "100-200-300");
    ...
    public void test2() throws Fault {
        ...
        try {
            logMsg("Create EJB instance");
            beanRef = (TestBean) beanHome.create(2, "100-200-300", "VISA", 1000.00, "3450678912348090", "1102");
            beanRef.initLogging(props);
    ...
    public void test3() throws Fault {
        ...
        try {
            logMsg("Create EJB instance");
            beanRef = (TestBean) beanHome.createHomeAddress(3, "10 Spring Street", "Boston", "MA", 02115);
            beanRef.initLogging(props);
    ...
    public void test5() throws Fault {
        ...
        try {
            logMsg("Create EJB instance");
            beanRef = (TestBean) beanHome.createPhone(5, "617-225-9086", "781-288-9843");
            beanRef.initLogging(props);
    ...
    public void test6() throws Fault {
        ...
        try {
            logMsg("Create EJB instance");
            beanRef = (TestBean) beanHome.create(3, "103-203-303", "MASTERCARD", 459.00, "4569543201237989", "0801");
            beanRef.initLogging(props);

            beanRef2 = (TestBean) beanHome.create(4, "104-204-304", "AMEX", 2025.00, "8365901745363321", "0502");
            logMsg("Initialize logging");
            beanRef2.initLogging(props);

            beanRef3 = (TestBean) beanHome.create(5, "105-205-305", "VISA", 300.00, "763839306103976", "0703");
            logMsg("Initialize logging");

 ...
 * @author Raja Perumal
 */
public class TSAuthExceptionClientAuthModule
  ...
  public AuthStatus secureRequest(MessageInfo messageInfo,
    ...
    String msg = "TSAuthExceptionClientAuthModule.secureRequest called";
    logMsg(msg);
    throw new AuthException(
        "TSAuthExceptionClientAuthModule.secureRequest throws AuthException");
  ...
  public AuthStatus validateResponse(MessageInfo messageInfo,
    ...
    String msg = "TSAuthExceptionClientAuthModule.validateResponse called";
    logMsg(msg);

    throw new AuthException(
        "TSAuthExceptionClientAuthModule.validateResponse throws AuthException");
  ...
  /*
   * 
   * SOAPPart soap = smsg.getSOAPPart(); if (soap != null) { try { SOAPEnvelope
   * envelope = soap.getEnvelope(); if (envelope != null) { SOAPBody body =
   * envelope.getBody(); if (body != null) { QName qname = new QName("Client");
   * body.addFault(qname, "Error in Client"); } } } catch (SOAPException se) {

...
package com.sun.ts.tests.jakartamail.ee.internetMimeMultipart;
...
public class internetMimeMultipart_Test extends ServiceEETest {
   ...
   * jakartamail.password ; jakartamail.mailbox; jakartamail.root.path; work.dir; iofile;
   * smtp.port; imap.port;
   */
   ...
   */
  // derived from jakartamail suite getMessageContent_Test
   ...
   * @test_Strategy: getMessageContent test
   */
  // derived from jakartamail suite properties_Test
   ...
   * @test_Strategy: getMessageContent test
   */
  // derived from jakartamail suite MimeMultipart test

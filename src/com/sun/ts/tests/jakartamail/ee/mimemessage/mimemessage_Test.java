 ...
 */
package com.sun.ts.tests.jakartamail.ee.mimemessage;
...
import com.sun.ts.tests.jakartamail.ee.common.MailTestUtil;
...
public class mimemessage_Test extends ServiceEETest implements Serializable {
  ...
  private String[] addrlist = { "ksnijjar@eng", "ksnijjar@eng.sun.com",
      ...
      "xx.zzz12@fea.net", "jakartamail-api-eng@icdev",
  ...
  /* Test setup: */
  /*
   * @class.setup_props: jakartamail.protocol; jakartamail.server; jakartamail.username;
   * jakartamail.password ; jakartamail.mailbox; jakartamail.root.path; smtp.port;
   * imap.port;
   */
  public void setup(String[] args, Properties props) throws Fault {
    try {

      String protocol = TestUtil.getProperty("jakartamail.protocol");
      String host = TestUtil.getProperty("jakartamail.server");
      user = TestUtil.getProperty("jakartamail.username");
      String password = TestUtil.getProperty("jakartamail.password");
      String mailbox = TestUtil.getProperty("jakartamail.mailbox");
   ...
   */
  // derived from jakartamail suite setContent_Test class
   ...
   */
  // derived from jakartamail suite sendMessage_Test class
   ...
   */
  // derived from jakartamail suite getSession_Test class
   ...
   */
  // derived from jakartamail suite createMimeMessage_Test
   ...
   * 
   * derived from jakartamail suite reply_Test
   */
   ...
   * 
   * derived from jakartamail suite setContent_Test
   */

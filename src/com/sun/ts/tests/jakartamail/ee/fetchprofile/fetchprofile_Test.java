...
package com.sun.ts.tests.jakartamail.ee.fetchprofile;
...
public class fetchprofile_Test extends ServiceEETest implements Serializable {
  ...
  public void setup(String[] args, Properties props) throws Fault {
    try {
      ...
      rootPath = TestUtil.getProperty("jakartamail.root.path");
   ...
   */
  // derived from jakartamail suite fetchProfile_Test class
   ...
   */
  // derived from jakartamail suite fetchProfile getItems_test

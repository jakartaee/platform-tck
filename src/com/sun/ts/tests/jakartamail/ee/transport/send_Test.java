 ...
 */
package com.sun.ts.tests.jakartamail.ee.transport;
...
public class send_Test extends ServiceEETest implements Serializable {
  ...
  public static final String MAILER = "JakartaMail";
   ...
   * jakartamail.password ; jakartamail.mailbox; transport_protocol; mailuser1;
   * smtp.port; imap.port;
   */
  public void setup(String[] args, Properties props) throws Fault {
    try {
      ...
      password = TestUtil.getProperty("jakartamail.password");
   ...
   * error.
   */
  // derived from jakartamail suite send_Test class
   ...
   * returns rfc822
   */
  // derived from jakartamail suite getType class
   ...
   * error.
   */
  // derived from jakartamail suite connect_Test class
   ...
   * it fails. <p>
   * 
   * derived from jakartamail suite send_Test
   */
  public void test4() throws Fault {
    ...
    try {
      ...
      msg.setFrom(addr);
      msg.setRecipients(Message.RecipientType.TO, addrs);
      msg.setSubject("JakartaMail send() API Test");
      msg.setContent(msgText, "text/plain");

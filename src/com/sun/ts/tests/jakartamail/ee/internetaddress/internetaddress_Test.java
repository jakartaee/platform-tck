 ...
 */
package com.sun.ts.tests.jakartamail.ee.internetaddress;
...
public class internetaddress_Test extends ServiceEETest
   ...
   * jakartamail.password ;mailuser1; smtp.port; imap.port;
   */
  public void setup(String[] args, Properties props) throws Fault {
    try {
      ...
      String user = TestUtil.getProperty("jakartamail.username");
   ...
   */
  // derived from jakartamail suite utilmethods_Test class
   ...
   */
  // derived from jakartamail suite getAddress_Test class
   ...
   */
  // derived from jakartamail suite getPersonal_Test.java class
   ...
   * 
   * 
   * derived from jakartamail suite next_Test
   */
   ...
   * 
   * derived from jakartamail suite combineSegments_Test
   */

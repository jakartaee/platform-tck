 ...
 * @author Kyle Grucci
 */
public class AutoDeploymentServer extends UnicastRemoteObject implements AutoDeploymentServerInterface {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            TestUtil.logHarness("AutoDeploymentServer:  Registry has been created on port:  " + iPort);
            registry.rebind("AutoDeploymentServer", deploymentServer);
            TestUtil.logHarness("AutoDeploymentServer:  deploymentServer has been bound to the Registry");
        } catch (Exception e) {
     ...
     * Sun's implementation of this method (below) for an example.
     *
    ...
    public void init(Properties jteProps, Map extraParameters) throws RemoteException {
        try {
            ...
            TestUtil.logHarness("AutoDeploymentServer:  iPortingSet = " + portingSetInteger.intValue());
    ...
    /**
     * This method is called by the test harness to deploy an .ear file into Sun 's J2EE reference implementation. We

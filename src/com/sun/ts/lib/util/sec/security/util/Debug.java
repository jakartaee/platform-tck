...
public class Debug {
    ...
    static {
        args = java.security.AccessController.doPrivileged(
                new com.sun.ts.lib.util.sec.security.action.GetPropertyAction("java.security.debug"));

        String args2 = java.security.AccessController.doPrivileged(
                new com.sun.ts.lib.util.sec.security.action.GetPropertyAction("java.security.auth.debug"));

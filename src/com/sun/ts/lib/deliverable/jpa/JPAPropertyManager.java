...
public class JPAPropertyManager extends AbstractPropertyManager {
    ...
    /**
     * This method returns the singleton instance of JPAPropertyManager which provides access to all ts.jte properties. This
     ...
     */
    public static final JPAPropertyManager getJPAPropertyManager(TestEnvironment env) throws Exception {
     ...
     * @return JPAPropertyManager - singleton property manager object
     */
    public static final JPAPropertyManager getJPAPropertyManager(Properties p) throws Exception {
        jteMgr.setJteProperties(p);
        return jteMgr;
    }

    public static final JPAPropertyManager getJPAPropertyManager() throws Exception {
        return jteMgr;
    }
    ...
    public Properties getTestSpecificProperties(String[] sPropKeys) throws PropertyNotSetException {
        ...
        String secondPUName = getProperty(PMClientBase.SECOND_PERSISTENCE_UNIT_NAME_PROP);
        ...
        String provider_specific = getProperty(PMClientBase.JPA_PROVIDER_IMPLEMENTATION_SPECIFIC_PROPERTIES);
        String errorMsg = "";
        if (mode == null) {
            errorMsg += PMClientBase.MODE_PROP + " is not set in ts.jte. ";
        }
        if (puName == null) {
            errorMsg += PMClientBase.PERSISTENCE_UNIT_NAME_PROP + " is not set in ts.jte. ";
        }
        if (secondPUName == null) {
            errorMsg += PMClientBase.SECOND_PERSISTENCE_UNIT_NAME_PROP + " is not set in ts.jte. ";
        }
        if (provider == null) {
            errorMsg += PMClientBase.JAVAX_PERSISTENCE_PROVIDER + " is not set in ts.jte. ";
        }
        if (driver == null) {
            errorMsg += PMClientBase.JAVAX_PERSISTENCE_JDBC_DRIVER + " is not set in ts.jte. ";
        }
        if (url == null) {
            errorMsg += PMClientBase.JAVAX_PERSISTENCE_JDBC_URL + " is not set in ts.jte. ";
        }
        if (user == null) {
            errorMsg += PMClientBase.JAVAX_PERSISTENCE_JDBC_USER + " is not set in ts.jte. ";
        }
        if (password == null) {
            errorMsg += PMClientBase.JAVAX_PERSISTENCE_JDBC_PASSWORD + " is not set in ts.jte. ";
        }
        if (provider_specific == null) {
            errorMsg += PMClientBase.JPA_PROVIDER_IMPLEMENTATION_SPECIFIC_PROPERTIES + " is not set in ts.jte. ";
        }
        if (errorMsg.length() > 0) {
            ...
            pTestProps.put(PMClientBase.SECOND_PERSISTENCE_UNIT_NAME_PROP, secondPUName);
            ...
            pTestProps.put(PMClientBase.JPA_PROVIDER_IMPLEMENTATION_SPECIFIC_PROPERTIES, provider_specific);
        }
        pTestProps.put(

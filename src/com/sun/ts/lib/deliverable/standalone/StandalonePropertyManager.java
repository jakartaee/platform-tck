...
public class StandalonePropertyManager extends AbstractPropertyManager {
    ...
    /**
     * This method returns the singleton instance of StandalonePropertyManager which provides access to all ts.jte
     ...
     */
    public static final StandalonePropertyManager getStandalonePropertyManager(TestEnvironment env) throws Exception {
     ...
     * @return StandalonePropertyManager - singleton property manager object
     */
    public static final StandalonePropertyManager getStandalonePropertyManager(Properties p) throws Exception {
        jteMgr.setJteProperties(p);
        return jteMgr;
    }

    public static final StandalonePropertyManager getStandalonePropertyManager() throws Exception {
        return jteMgr;
    }

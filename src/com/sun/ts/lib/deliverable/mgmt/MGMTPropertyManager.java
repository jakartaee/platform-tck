...
public class MGMTPropertyManager extends AbstractPropertyManager {
    ...
    /**
     * This method returns the singleton instance of MGMTPropertyManager which provides access to all ts.jte properties.
     ...
     */
    public static final MGMTPropertyManager getMGMTPropertyManager(TestEnvironment env) throws Exception {
     ...
     * @return MGMTPropertyManager - singleton property manager object
     */
    public static final MGMTPropertyManager getMGMTPropertyManager(Properties p) throws Exception {
        jteMgr.setJteProperties(p);
        return jteMgr;
    }

    public static final MGMTPropertyManager getMGMTPropertyManager() throws Exception {
        return jteMgr;
    }

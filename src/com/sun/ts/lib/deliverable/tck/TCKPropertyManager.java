...
public class TCKPropertyManager extends AbstractPropertyManager {
     ...
     */
    public static final TCKPropertyManager getTCKPropertyManager(TestEnvironment env) throws Exception {
     ...
     * @return TCKPropertyManager - singleton property manager object
     */
    public static final TCKPropertyManager getTCKPropertyManager(Properties p) throws Exception {
        jteMgr.setJteProperties(p);
        return jteMgr;
    }

    public static final TCKPropertyManager getTCKPropertyManager() throws Exception {
        return jteMgr;
    }

...
public class ELPropertyManager extends AbstractPropertyManager {
     ...
     */
    public static final ELPropertyManager getTCKPropertyManager(TestEnvironment env) throws Exception {
     ...
     * @return TCKPropertyManager - singleton property manager object
     */
    public static final ELPropertyManager getTCKPropertyManager(Properties p) throws Exception {
        jteMgr.setJteProperties(p);
        return jteMgr;
    }

    public static final ELPropertyManager getTCKPropertyManager() throws Exception {
        return jteMgr;
    }

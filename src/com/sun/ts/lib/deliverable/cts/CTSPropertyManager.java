...
public class CTSPropertyManager extends AbstractPropertyManager {
    ...
    /**
     * This method returns the singleton instance of TSPropertyManager which provides access to all ts.jte properties. This
     * is only called once by the test harness.
     *
     * @param env - TestEnvironment object from JavaTest
     * @return TSPropertyManager - singleton property manager object
     */
    public static final CTSPropertyManager getCTSPropertyManager(TestEnvironment env) throws PropertyNotSetException {
    ...
    /**
     * This method returns the singleton instance of CTSPropertyManager which provides access to all ts.jte properties. This
     * is only called by the init() method in ManualDeployment.java
     *
     * @param p - Properties object from JavaTest
     * @return CTSPropertyManager - singleton property manager object
     */
    public static final CTSPropertyManager getCTSPropertyManager(Properties p) throws PropertyNotSetException {
        jteMgr.setJteProperties(p);
        return jteMgr;
    }

    public static final CTSPropertyManager getCTSPropertyManager() throws PropertyNotSetException {
        return jteMgr;
    }
    ...
    private void initInteropProperties() {
        ...
        httpSupportsEndpointPublish = getProperty("http.server.supports.endpoint.publish", null);
        httpSupportsEndpointPublish2 = getProperty("http.server.supports.endpoint.publish.2", null);
    ...
    public void forwardValues() {
        ...
        setProperty("http.server.supports.endpoint.publish", httpSupportsEndpointPublish);
    ...
    public void reverseValues() {
        ...
        setProperty("http.server.supports.endpoint.publish", httpSupportsEndpointPublish2);
        setProperty("http.server.supports.endpoint.publish.2", httpSupportsEndpointPublish);
    ...
    public Properties getTestSpecificProperties(String[] sPropKeys) throws PropertyNotSetException {
        ...
        pTestProps.put(
                ...
                getProperty("porting.ts.deploy2.class.1", "com.sun.ts.lib.implementation.sun.javaee.SunRIDeployment2"));
        pTestProps.put(
                "porting.ts.deploy2.class.2",
                getProperty("porting.ts.deploy2.class.2", "com.sun.ts.lib.implementation.sun.javaee.SunRIDeployment2"));
        ...
        pTestProps.put("vi.admin.passwd", getProperty("vi.admin.passwd", "adminadmin"));
        pTestProps.put("orb.host", getProperty("orb.host"));
        pTestProps.put("orb.port", getProperty("orb.port"));
        pTestProps.put("securedWebServicePort", getProperty("securedWebServicePort"));
        ...
        pTestProps.put("persistence.unit.name", getProperty("persistence.unit.name"));
        pTestProps.put("persistence.unit.name.2", getProperty("persistence.unit.name.2"));
        pTestProps.put("jakarta.persistence.provider", getProperty("jakarta.persistence.provider"));
        pTestProps.put("jakarta.persistence.jdbc.driver", getProperty("jakarta.persistence.jdbc.driver"));
        pTestProps.put("jakarta.persistence.jdbc.url", getProperty("jakarta.persistence.jdbc.url"));
        pTestProps.put("jakarta.persistence.jdbc.user", getProperty("jakarta.persistence.jdbc.user"));
        pTestProps.put("jakarta.persistence.jdbc.password", getProperty("jakarta.persistence.jdbc.password"));
        pTestProps.put(

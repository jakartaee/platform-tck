...
public class PointbaseProcedures {
     ...
     *******************/
    public void Numeric_Proc(
            jdbcInOutBigDecimalWrapper max_param,
            jdbcInOutBigDecimalWrapper min_param,
            jdbcInOutBigDecimalWrapper null_param)
            throws SQLException {

        // System.out.println("Inside Numeric_Proc");
        Statement stmt = con.createStatement();
        ResultSet rs = stmt.executeQuery("select max_val, min_val, null_val from numeric_tab");
    ...
    public void Decimal_Proc(
        ...
        Statement stmt = con.createStatement();
        ResultSet rs = stmt.executeQuery("select max_val,min_val,null_val from Decimal_Tab");
    ...
    public void Double_Proc(
            jdbcInOutDoubleWrapper max_param, jdbcInOutDoubleWrapper min_param, jdbcInOutDoubleWrapper null_param)
            throws SQLException {

        Statement stmt = con.createStatement();
        ResultSet rs = stmt.executeQuery("select max_val, min_val, null_val from double_tab");
    ...
    public void Float_Proc(
            jdbcInOutDoubleWrapper max_param, jdbcInOutDoubleWrapper min_param, jdbcInOutDoubleWrapper null_param)
            throws SQLException {

        Statement stmt = con.createStatement();
        ResultSet rs = stmt.executeQuery("select max_val, min_val, null_val from float_tab");
    ...
    public void Real_Proc(
            jdbcInOutFloatWrapper max_param, jdbcInOutFloatWrapper min_param, jdbcInOutFloatWrapper null_param)
            throws SQLException {

        Statement stmt = con.createStatement();
        ResultSet rs = stmt.executeQuery("select max_val,min_val,null_val from Real_Tab");
    ...
    public void Bit_Proc(
            jdbcInOutBooleanWrapper max_param, jdbcInOutBooleanWrapper min_param, jdbcInOutBooleanWrapper null_param)
            throws SQLException {

        Statement stmt = con.createStatement();
        ResultSet rs = stmt.executeQuery("select max_val, min_val, null_val from bit_tab");
    ...
    public void Smallint_Proc(
            jdbcInOutShortWrapper max_param, jdbcInOutShortWrapper min_param, jdbcInOutShortWrapper null_param)
            throws SQLException {

        Statement stmt = con.createStatement();
        ResultSet rs = stmt.executeQuery("select max_val, min_val, null_val from smallint_tab");
    ...
    public void Tinyint_Proc(
            jdbcInOutShortWrapper max_param, jdbcInOutShortWrapper min_param, jdbcInOutShortWrapper null_param)
            throws SQLException {

        Statement stmt = con.createStatement();
        ResultSet rs = stmt.executeQuery("select max_val, min_val, null_val from tinyint_tab");
    ...
    public void Integer_Proc(
            jdbcInOutIntWrapper max_param, jdbcInOutIntWrapper min_param, jdbcInOutIntWrapper null_param)
            throws SQLException {

        Statement stmt = con.createStatement();
        ResultSet rs = stmt.executeQuery("select max_val, min_val, null_val from integer_tab");
    ...
    public void Bigint_Proc(
            jdbcInOutLongWrapper max_param, jdbcInOutLongWrapper min_param, jdbcInOutLongWrapper null_param)
            throws SQLException {

        Statement stmt = con.createStatement();
        ResultSet rs = stmt.executeQuery("select max_val, min_val, null_val from bigint_tab");
    ...
    public void Char_Proc(jdbcInOutStringWrapper coffee_param, jdbcInOutStringWrapper null_param) throws SQLException {

        Statement stmt = con.createStatement();
        ResultSet rs = stmt.executeQuery("select coffee_name, null_val from char_tab");
    ...
    public void Varchar_Proc(jdbcInOutStringWrapper coffee_param, jdbcInOutStringWrapper null_param)
            throws SQLException {

        Statement stmt = con.createStatement();
        ResultSet rs = stmt.executeQuery("select coffee_name, null_val from varchar_tab");
    ...
    public void Longvarchar_Proc(jdbcInOutStringWrapper coffee_param) throws SQLException {
    ...
    public void Longvarcharnull_Proc(jdbcInOutStringWrapper null_param) throws SQLException {

        Statement stmt = con.createStatement();
        ResultSet rs = stmt.executeQuery("select null_val from longvarcharnull_tab");
    ...
    public void Date_Proc(jdbcInOutDateWrapper mfg_param, jdbcInOutDateWrapper null_param) throws SQLException {
    ...
    public void Time_Proc(jdbcInOutTimeWrapper brk_param, jdbcInOutTimeWrapper null_param) throws SQLException {
    ...
    public void Timestamp_Proc(jdbcInOutTimestampWrapper in_param, jdbcInOutTimestampWrapper null_param)
            throws SQLException {

        Statement stmt = con.createStatement();
        ResultSet rs = stmt.executeQuery("select in_time, null_val from timestamp_tab");
    ...
    public void Binary_Proc(jdbcInOutByteArrayWrapper binary_param) throws SQLException {
        ...
        if (rs.next()) {
            ...
            if (x == null) {
                ...
                System.out.println("The Length of byte[] in Binary_Proc: " + binary_param.size());
            }
    ...
    public void Varbinary_Proc(jdbcInOutByteArrayWrapper varbinary_param) throws SQLException {
    ...
    public void Longvarbinary_Proc(jdbcInOutByteArrayWrapper longvarbinary_param) throws SQLException {

        Statement stmt = con.createStatement();
        ResultSet rs = stmt.executeQuery("select longvarbinary_val from longvarbinary_tab");
    ...
    public void Integer_In_Proc(Integer in_param) throws SQLException {
        ...
        PreparedStatement ps = con.prepareStatement("update Integer_Tab set MAX_VAL=?");
    ...
    public void Integer_InOut_Proc(jdbcInOutIntWrapper inout_param) throws SQLException {

        PreparedStatement ps = con.prepareStatement("select max_val from integer_Tab where min_val=?");
    ...
    public void UpdCoffee_Proc(BigDecimal type_param) throws SQLException {
        ...
        PreparedStatement ps = con.prepareStatement("update ctstable2 set PRICE=PRICE*20 where TYPE_ID=?");
    ...
    public void SelCoffee_Proc(jdbcInOutStringWrapper keyid_param) throws SQLException {

        Statement stmt = con.createStatement();
        ResultSet rs = stmt.executeQuery("select KEY_ID from CTSTABLE2 where TYPE_ID=1");
    ...
    public void IOCoffee_Proc(jdbcInOutDoubleWrapper price_param) throws SQLException {
    ...
    public void Coffee_Proc(BigDecimal bigdecimal) throws SQLException {
        ...
        preparedstatement.close();
        preparedstatement = null;
        PreparedStatement preparedstatement1 = con.prepareStatement("delete from CTSTABLE2 where TYPE_ID=?-1");
    ...
    public void Coffee_Proc(int type_param) throws SQLException {
        ...
        ps1 = con.prepareStatement("update CTSTABLE2 set PRICE=Price*2 where TYPE_ID=?");
     ...
     ******************/
    public void Numeric_Io_Max(jdbcInOutBigDecimalWrapper inout_param) throws SQLException {

        PreparedStatement ps = con.prepareStatement("update Numeric_Tab set max_val =?");
    ...
    public void Numeric_Io_Min(jdbcInOutBigDecimalWrapper inout_param) throws SQLException {

        PreparedStatement ps = con.prepareStatement("update Numeric_Tab set min_val =?");
        ps.setBigDecimal(1, inout_param.get());
        ps.executeUpdate();
    ...
    public void Numeric_Io_Null(jdbcInOutBigDecimalWrapper inout_param) throws SQLException {

        PreparedStatement ps = con.prepareStatement("update Numeric_Tab set null_val =?");
        ps.setBigDecimal(1, inout_param.get());
        ps.executeUpdate();
    ...
    public void Decimal_Io_Max(jdbcInOutBigDecimalWrapper inout_param) throws SQLException {

        PreparedStatement ps = con.prepareStatement("update Decimal_Tab set max_val =?");
        ps.setBigDecimal(1, inout_param.get());
        ps.executeUpdate();
    ...
    public void Decimal_Io_Min(jdbcInOutBigDecimalWrapper inout_param) throws SQLException {

        PreparedStatement ps = con.prepareStatement("update Decimal_Tab set min_val =?");
        ps.setBigDecimal(1, inout_param.get());
        ps.executeUpdate();
    ...
    public void Decimal_Io_Null(jdbcInOutBigDecimalWrapper inout_param) throws SQLException {

        PreparedStatement ps = con.prepareStatement("update Decimal_Tab set null_val =?");
        ps.setBigDecimal(1, inout_param.get());
        ps.executeUpdate();
    ...
    public void Double_Io_Max(jdbcInOutDoubleWrapper inout_param) throws SQLException {

        PreparedStatement ps = con.prepareStatement("update Double_Tab set max_val =?");
    ...
    public void Double_Io_Min(jdbcInOutDoubleWrapper inout_param) throws SQLException {

        PreparedStatement ps = con.prepareStatement("update Double_Tab set min_val =?");
        ps.setDouble(1, inout_param.get());
        ps.executeUpdate();
    ...
    public void Double_Io_Null(jdbcInOutDoubleWrapper inout_param) throws SQLException {

        PreparedStatement ps = con.prepareStatement("update Double_Tab set null_val =?");
        ps.setDouble(1, inout_param.get());
        ps.executeUpdate();
    ...
    public void Float_Io_Max(jdbcInOutDoubleWrapper inout_param) throws SQLException {

        PreparedStatement ps = con.prepareStatement("update Float_Tab set max_val =?");
        ps.setDouble(1, inout_param.get());
        ps.executeUpdate();
    ...
    public void Float_Io_Min(jdbcInOutDoubleWrapper inout_param) throws SQLException {

        PreparedStatement ps = con.prepareStatement("update Float_Tab set min_val =?");
        ps.setDouble(1, inout_param.get());
        ps.executeUpdate();
    ...
    public void Float_Io_Null(jdbcInOutDoubleWrapper inout_param) throws SQLException {

        PreparedStatement ps = con.prepareStatement("update Float_Tab set null_val =?");
        ps.setDouble(1, inout_param.get());
        ps.executeUpdate();
    ...
    public void Real_Io_Max(jdbcInOutFloatWrapper inout_param) throws SQLException {

        PreparedStatement ps = con.prepareStatement("update Real_Tab set max_val =?");
    ...
    public void Real_Io_Max(jdbcInOutDoubleWrapper inout_param) throws SQLException {
    ...
    public void Real_Io_Min(jdbcInOutFloatWrapper inout_param) throws SQLException {

        PreparedStatement ps = con.prepareStatement("update Real_Tab set min_val =?");
        ps.setFloat(1, inout_param.get());
        ps.executeUpdate();
    ...
    public void Real_Io_Min(jdbcInOutDoubleWrapper inout_param) throws SQLException {
    ...
    public void Real_Io_Null(jdbcInOutFloatWrapper inout_param) throws SQLException {

        PreparedStatement ps = con.prepareStatement("update Real_Tab set null_val =?");
        ps.setFloat(1, inout_param.get());
        ps.executeUpdate();
    ...
    public void Real_Io_Null(jdbcInOutDoubleWrapper inout_param) throws SQLException {
    ...
    public void Bit_Io_Max(jdbcInOutBooleanWrapper inout_param) throws SQLException {
    ...
    public void Bit_Io_Min(jdbcInOutBooleanWrapper inout_param) throws SQLException {
    ...
    public void Bit_Io_Null(jdbcInOutBooleanWrapper inout_param) throws SQLException {

        PreparedStatement ps = con.prepareStatement("update Bit_Tab set null_val =?");
        ps.setBoolean(1, inout_param.get());
        ps.executeUpdate();
    ...
    public void Smallint_Io_Max(jdbcInOutShortWrapper inout_param) throws SQLException {

        PreparedStatement ps = con.prepareStatement("update Smallint_Tab set max_val =?");
    ...
    public void Smallint_Io_Min(jdbcInOutShortWrapper inout_param) throws SQLException {

        PreparedStatement ps = con.prepareStatement("update Smallint_Tab set min_val =?");
        ps.setShort(1, inout_param.get());
        ps.executeUpdate();
    ...
    public void Smallint_Io_Null(jdbcInOutShortWrapper inout_param) throws SQLException {

        PreparedStatement ps = con.prepareStatement("update Smallint_Tab set null_val =?");
        ps.setShort(1, inout_param.get());
        ps.executeUpdate();
    ...
    public void Tinyint_Io_Max(jdbcInOutShortWrapper inout_param) throws SQLException {

        PreparedStatement ps = con.prepareStatement("update Tinyint_Tab set max_val =?");
    ...
    public void Tinyint_Io_Min(jdbcInOutShortWrapper inout_param) throws SQLException {

        PreparedStatement ps = con.prepareStatement("update Tinyint_Tab set min_val =?");
        ps.setByte(1, (byte) inout_param.get());
        ps.executeUpdate();
    ...
    public void Tinyint_Io_Null(jdbcInOutShortWrapper inout_param) throws SQLException {

        PreparedStatement ps = con.prepareStatement("update Tinyint_Tab set null_val =?");
        ps.setByte(1, (byte) inout_param.get());
        ps.executeUpdate();
    ...
    public void Integer_Io_Max(jdbcInOutIntWrapper max_param) throws SQLException {
    ...
    public void Integer_Io_Min(jdbcInOutIntWrapper min_param) throws SQLException {

        PreparedStatement ps = con.prepareStatement("update Integer_Tab set MIN_VAL=?");
    ...
    public void Integer_Io_Null(jdbcInOutIntWrapper null_param) throws SQLException {

        PreparedStatement ps = con.prepareStatement("update Integer_Tab set NULL_VAL=?");
    ...
    public void Bigint_Io_Max(jdbcInOutLongWrapper max_param) throws SQLException {

        PreparedStatement ps = con.prepareStatement("update Bigint_Tab set MAX_VAL=?");
    ...
    public void Bigint_Io_Min(jdbcInOutLongWrapper min_param) throws SQLException {
    ...
    public void Bigint_Io_Null(jdbcInOutLongWrapper null_param) throws SQLException {
    ...
    public void Bigint_Io_Mull(jdbcInOutLongWrapper null_param) throws SQLException {
    ...
    public void Char_Io_Name(jdbcInOutStringWrapper name_param) throws SQLException {

        PreparedStatement ps = con.prepareStatement("update char_Tab set coffee_name=?");
    ...
    public void Char_Io_Null(jdbcInOutStringWrapper null_param) throws SQLException {

        PreparedStatement ps = con.prepareStatement("update char_Tab set null_val=?");
    ...
    public void Varchar_Io_Name(jdbcInOutStringWrapper name_param) throws SQLException {

        PreparedStatement ps = con.prepareStatement("update varchar_Tab set coffee_name=?");
        ps.setString(1, name_param.get());
        ps.executeUpdate();
    ...
    public void Varchar_Io_Null(jdbcInOutStringWrapper null_param) throws SQLException {

        PreparedStatement ps = con.prepareStatement("update varchar_Tab set null_val=?");
        ps.setString(1, null_param.get());
        ps.executeUpdate();
    ...
    public void Longvarchar_Io_Name(jdbcInOutStringWrapper name_param) throws SQLException {

        PreparedStatement ps = con.prepareStatement("update Longvarchar_Tab set coffee_name=?");
        ps.setString(1, name_param.get());
        ps.executeUpdate();
    ...
    public void Longvarchar_Io_Null(jdbcInOutStringWrapper name_param) throws SQLException {

        PreparedStatement ps = con.prepareStatement("update Longvarcharnull_Tab set null_val=?");
        ps.setString(1, name_param.get());
        ps.executeUpdate();
    ...
    public void Date_Io_Mfg(jdbcInOutDateWrapper mfg_param) throws SQLException {
        ...
        PreparedStatement ps = con.prepareStatement("update Date_Tab set mfg_date=?");
    ...
    public void Date_Io_Null(jdbcInOutDateWrapper null_param) throws SQLException {

        PreparedStatement ps = con.prepareStatement("update Date_Tab set null_val=?");
    ...
    public void Time_Io_Brk(jdbcInOutTimeWrapper brk_param) throws SQLException {
        ...
        PreparedStatement ps = con.prepareStatement("update Time_Tab set brk_time=?");
    ...
    public void Time_Io_Null(jdbcInOutTimeWrapper null_param) throws SQLException {

        PreparedStatement ps = con.prepareStatement("update Time_Tab set null_val=?");
    ...
    public void Timestamp_Io_Intime(jdbcInOutTimestampWrapper intime_param) throws SQLException {

        PreparedStatement ps = con.prepareStatement("update Timestamp_Tab set in_time=?");
    ...
    public void Timestamp_Io_Null(jdbcInOutTimestampWrapper null_param) throws SQLException {

        PreparedStatement ps = con.prepareStatement("update Timestamp_Tab set null_val=?");
    ...
    public void Binary_Proc_Io(jdbcInOutByteArrayWrapper binary_param) throws SQLException {

        System.out.println("The Length of byte[] in Binary_Proc_Io: " + binary_param.size());

        PreparedStatement ps = con.prepareStatement("update Binary_Tab set binary_val=?");
    ...
    public void Varbinary_Proc_Io(jdbcInOutByteArrayWrapper varbinary_param) throws SQLException {

        PreparedStatement ps = con.prepareStatement("update Varbinary_Tab set varbinary_val=?");
    ...
    public void Longvarbinary_Io(jdbcInOutByteArrayWrapper longvarbinary_param) throws SQLException {

        PreparedStatement ps = con.prepareStatement("update Longvarbinary_Tab set Longvarbinary_val=?");
    ...
    public void Binary_Proc_In(byte[] in_param) throws SQLException {
        ...
        System.out.println("The Length of byte[] in Binary_Proc_In: " + in_param.length);

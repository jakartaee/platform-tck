...
public class CS_Procs {
     ...
     *******************/
    public static void Numeric_Proc(BigDecimal[] max_param, BigDecimal[] min_param, BigDecimal[] null_param)
            throws SQLException {
    ...
    public static void Decimal_Proc(BigDecimal[] max_param, BigDecimal[] min_param, BigDecimal[] null_param)
            throws SQLException {
    ...
    public static void Double_Proc(double[] max_param, double[] min_param, BigDecimal[] null_param)
            throws SQLException {
    ...
    public static void Float_Proc(double[] max_param, double[] min_param, BigDecimal[] null_param) throws SQLException {
    ...
    public static void Real_Proc(float[] max_param, float[] min_param, BigDecimal[] null_param) throws SQLException {
    ...
    public static void Bit_Proc(boolean[] max_param, boolean[] min_param, BigDecimal[] null_param) throws SQLException {
    ...
    public static void Smallint_Proc(short[] max_param, short[] min_param, BigDecimal[] null_param)
            throws SQLException {
    ...
    public static void Tinyint_Proc(int[] max_param, int[] min_param, BigDecimal[] null_param) throws SQLException {
    ...
    public static void Integer_Proc(int[] max_param, int[] min_param, BigDecimal[] null_param) throws SQLException {
    ...
    public static void Bigint_Proc(long[] max_param, long[] min_param, BigDecimal[] null_param) throws SQLException {
    ...
    public static void Char_Proc(String[] coffee_param, String[] null_param) throws SQLException {
    ...
    public static void Varchar_Proc(String[] coffee_param, String[] null_param) throws SQLException {
    ...
    public static void Longvarchar_Proc(String[] coffee_param) throws SQLException {
    ...
    public static void Longvarcharnull_Proc(String[] null_param) throws SQLException {
    ...
    public static void Date_Proc(Date[] mfg_param, Date[] null_param) throws SQLException {
    ...
    public static void Time_Proc(Time[] brk_param, Time[] null_param) throws SQLException {
    ...
    public static void Timestamp_Proc(Timestamp[] in_param, Timestamp[] null_param) throws SQLException {
    ...
    public static void Varbinary_Proc(byte[][] varbinary_param) throws SQLException {
    ...
    public static void Longvarbinary_Proc(byte[][] longvarbinary_param) throws SQLException {
     ...
     ******************/
    public static void Numeric_Io_Max(BigDecimal[] inout_param) throws SQLException {
    ...
    public static void Numeric_Io_Min(BigDecimal[] inout_param) throws SQLException {
    ...
    public static void Numeric_Io_Null(BigDecimal[] inout_param) throws SQLException {
    ...
    public static void Decimal_Io_Max(BigDecimal[] inout_param) throws SQLException {
    ...
    public static void Decimal_Io_Min(BigDecimal[] inout_param) throws SQLException {
    ...
    public static void Decimal_Io_Null(BigDecimal[] inout_param) throws SQLException {
    ...
    public static void Longvarchar_Io_Name(String[] name_param) throws SQLException {
    ...
    public static void Longvarchar_Io_Null(String[] name_param) throws SQLException {
    ...
    public static void Timestamp_Io_Intime(Timestamp[] intime_param) throws SQLException {
    ...
    public static void Timestamp_Io_Null(Timestamp[] null_param) throws SQLException {
    ...
    public static void Varbinary_Proc_Io(byte[][] varbinary_param) throws SQLException {
    ...
    public static void Longvarbinary_Io(byte[][] longvarbinary_param) throws SQLException {
    ...
    public static void Numeric_In_Null(BigDecimal null_param) throws SQLException {
    ...
    public static void Decimal_In_Null(BigDecimal null_param) throws SQLException {
    ...
    public static void Timestamp_In_Intime(Timestamp in_param) throws SQLException {

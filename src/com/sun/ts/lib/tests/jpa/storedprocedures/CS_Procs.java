...
package com.sun.ts.lib.tests.jpa.storedprocedures;

import java.sql.*;

public class CS_Procs {

    public static void GetEmpOneFirstNameFromOut(String[] out_param) throws SQLException {
    ...
    public static void GetEmpFirstNameFromOut(int in_param, String[] out_param) throws SQLException {
    ...
    public static void GetEmpLastNameFromInOut(String[] inout_param) throws SQLException {
        // inout_param - (in - is the ID to look up, out is the last name returned
        // by the select)

        String query = "SELECT LASTNAME FROM EMPLOYEE WHERE ID=" + Integer.parseInt(inout_param[0]);
        Connection con = DriverManager.getConnection("jdbc:default:connection");
        Statement stmt = con.createStatement();
        ResultSet rs = stmt.executeQuery(query);
    ...
    public static void GetEmpIdFNameLNameFromRS(int in_param, ResultSet[] rs) throws SQLException {
        // in_param - IN parameter containing the id value
        // rs - resultSet of one ID returned by the select

        String query = "SELECT ID, FIRSTNAME, LASTNAME FROM EMPLOYEE WHERE ID=" + in_param;
    ...
    public static void GetEmpIdUsingHireDateFromOut(Date in_param, int[] out_param) throws SQLException {

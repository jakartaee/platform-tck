    ...
    private Method getSetupMethod(Class testClass, Method runMethod) {
        ...
        if (annotation != null) {
            try {
                ...
                setTestStatus(
                        Status.failed("Could not find annotation defined setup method for testcase: " + sTestCase), e);
            }
        } else {
            ...
            try {
                // get setup method
                TestUtil.logTrace(
                        "getSetupMethod - checking for testcase specific setup method:  " + sTestCase + "_setup");
    ...
    private Method getCleanupMethod(Class testClass, Method runMethod) {
        ...
        if (annotation != null) {
            try {
                ...
                setTestStatus(
                        Status.failed("Could not find annotation defined cleanup method for testcase: " + sTestCase),
                        e);
            }
        } else {
            ...
            try {
                // get cleanup method
                TestUtil.logTrace(
                        "getCleanupMethod - checking for testcase specific cleanup method:  " + sTestCase + "_cleanup");

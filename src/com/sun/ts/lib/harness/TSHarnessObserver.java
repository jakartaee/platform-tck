...
public class TSHarnessObserver implements Harness.Observer, TestResult.Observer {
            ...
            if (executionMode == ExecutionMode.LIST) {
                ...
                while (it.hasNext()) {
                    ...
                    if (iValue.intValue() > 1) {
                        ...
                        msg.append(iValue + " occurrences of " + sKey.substring(sKey.indexOf("com" + File.separator)))
                                .append('\n');
                    }
                }
                msg.append('\n');
            } else {
                msg.append("Completed running ")
                        .append(iFinishedTests)
                        .append(" tests.")
                        .append('\n');
                msg.append("Number of Tests Passed      = ")
                        .append(iPassedCount)
                        .append('\n');
    ...
    public synchronized void finishedTest(TestResult tr) {
        ...
        if (executionMode == ExecutionMode.DEPLOY_RUN_UNDEPLOY
            ...
            if (executionMode == ExecutionMode.DEPLOY || executionMode == ExecutionMode.UNDEPLOY) {

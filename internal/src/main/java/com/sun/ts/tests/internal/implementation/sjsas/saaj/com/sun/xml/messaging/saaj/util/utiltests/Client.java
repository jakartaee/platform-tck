...
public class Client extends EETest {
  ...
  public void Base64Test() throws Exception {
    ...
    try {
      ...
      throw new Exception("Base64Test failed", e);
    }

    if (!pass)
      throw new Exception("Base64Test failed");
  }
   ...
   * @test_Strategy:
   */
  public void ByteInputStreamTest() throws Exception {
    ...
    try {
      ...
      TestUtil.logErr("Caught unexpected exception: " + e.getMessage());
      TestUtil.printStackTrace(e);
      throw new Exception("ByteInputStreamTest failed", e);
    }

    if (!pass)
      throw new Exception("ByteInputStreamTest failed");
  }
   ...
   * @test_Strategy:
   */
  public void ByteOutputStreamTest() throws Exception {
    ...
    try {
      ...
      TestUtil.logErr("Caught unexpected exception: " + e.getMessage());
      TestUtil.printStackTrace(e);
      throw new Exception("ByteOutputStreamTest failed", e);
    }

    if (!pass)
      throw new Exception("ByteOutputStreamTest failed");
  }
   ...
   * @test_Strategy:
   */
  public void CharReaderTest() throws Exception {
    ...
    try {
      ...
      TestUtil.logErr("Caught unexpected exception: " + e.getMessage());
      TestUtil.printStackTrace(e);
      throw new Exception("CharReaderTest failed", e);
    }

    if (!pass)
      throw new Exception("CharReaderTest failed");
  }
   ...
   * @test_Strategy:
   */
  public void CharWriterTest() throws Exception {
    ...
    try {
      ...
      TestUtil.logErr("Caught unexpected exception: " + e.getMessage());
      TestUtil.printStackTrace(e);
      throw new Exception("CharWriterTest failed", e);
    }

    if (!pass)
      throw new Exception("CharWriterTest failed");
  }
   ...
   * @test_Strategy:
   */
  public void ParseUtilTest() throws Exception {
    ...
    try {
      ...
      TestUtil.logErr("Caught unexpected exception: " + e.getMessage());
      TestUtil.printStackTrace(e);
      throw new Exception("ParseUtilTest failed", e);
    }

    if (!pass)
      throw new Exception("ParseUtilTest failed");
  }
   ...
   * @test_Strategy:
   */
  public void MimeHeadersUtilTest() throws Exception {
    ...
    try {
      ...
      TestUtil.logErr("Caught unexpected exception: " + e.getMessage());
      TestUtil.printStackTrace(e);
      throw new Exception("MimeHeadersUtilTest failed", e);
    }

    if (!pass)
      throw new Exception("MimeHeadersUtilTest failed");
  }
   ...
   * @test_Strategy:
   */
  public void TeeInputStreamTest() throws Exception {
    ...
    try {
      ...
      TestUtil.logErr("Caught unexpected exception: " + e.getMessage());
      TestUtil.printStackTrace(e);
      throw new Exception("TeeInputStreamTest failed", e);
    }

    if (!pass)
      throw new Exception("TeeInputStreamTest failed");
  }
   ...
   * @test_Strategy:
   */
  public void XMLDeclarationParserTest() throws Exception {
    ...
    for (int i = 0; i < docs.length; i++) {
      try {
        ...
        TestUtil.logErr("Caught unexpected exception: " + e.getMessage());
        TestUtil.printStackTrace(e);
        throw new Exception("XMLDeclarationParserTest failed", e);
      }
    }

    if (!pass)
      throw new Exception("XMLDeclarationParserTest failed");
  }
}

...
public class Client extends EETest {
   ...
   * @test_Strategy:
   */
  public void CDATAImplTest() throws Exception {
    ...
    try {
      ...
      throw new Exception("CDATAImplTest failed", e);
    }

    if (!pass)
      throw new Exception("CDATAImplTest failed");
  }
   ...
   * @test_Strategy:
   */
  public void TreeExceptionTest() throws Exception {
    ...
    try {
      ...
      TestUtil.logErr("Caught unexpected exception: " + e.getMessage());
      TestUtil.printStackTrace(e);
      throw new Exception("TreeExceptionTest failed", e);
    }

    if (!pass)
      throw new Exception("TreeExceptionTest failed");
  }
}

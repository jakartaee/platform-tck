...
public class AbstractClient extends EETest {
  ...
  public void BasicAuthenticationTest() throws Exception {
    ...
    try {
      ...
      throw new Exception("BasicAuthenticationTest failed", e);
    }

    if (!pass)
      throw new Exception("BasicAuthenticationTest failed");
  }

  public void DigestAuthenticationTest() throws Exception {
    ...
    try {
      ...
      TestUtil.logErr("Caught unexpected exception: " + e.getMessage());
      TestUtil.printStackTrace(e);
      throw new Exception("DigestAuthenticationTest failed", e);
    }

    if (!pass)
      throw new Exception("DigestAuthenticationTest failed");
  }
  ...
  public void HttpURLConnectionTest() throws Exception {
    ...
    try {
      ...
      TestUtil.logErr("Caught unexpected exception: " + e.getMessage());
      TestUtil.printStackTrace(e);
      throw new Exception("HttpURLConnectionTest failed", e);
    }

    if (!pass)
      throw new Exception("HttpURLConnectionTest failed");
  }
  ...
  public void HandlerTest() throws Exception {
    ...
    try {
      ...
      TestUtil.logErr("Caught unexpected exception: " + e.getMessage());
      TestUtil.printStackTrace(e);
      throw new Exception("HandlerTest failed", e);
    }

    if (!pass)
      throw new Exception("HandlerTest failed");
  }

  public void EmptyInputStreamTest() throws Exception {
    ...
    try {
      ...
      TestUtil.logErr("Caught unexpected exception: " + e.getMessage());
      TestUtil.printStackTrace(e);
      throw new Exception("EmptyInputStreamTest failed", e);
    }

    if (!pass)
      throw new Exception("EmptyInputStreamTest failed");
  }

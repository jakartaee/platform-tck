...
public class Client extends EETest {
   ...
   * @test_Strategy:
   */
  public void HttpSOAPConnectionTest() throws Exception {
    ...
    try {
      ...
      throw new Exception("HttpSOAPConnectionTest failed", e);
    }

    if (!pass)
      throw new Exception("HttpSOAPConnectionTest failed");
  }

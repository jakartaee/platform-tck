...
public class Client extends EETest {
   ...
   * @test_Strategy:
   */
  public void SOAPIOExceptionTest() throws Exception {
    ...
    try {
      ...
      throw new Exception("SOAPIOExceptionTest failed", e);
    }

    if (!pass)
      throw new Exception("SOAPIOExceptionTest failed");
  }
   ...
   * @test_Strategy:
   */
  public void SOAPVersionMismatchExceptionTest() throws Exception {
    ...
    try {
      ...
      TestUtil.logErr("Caught unexpected exception: " + e.getMessage());
      TestUtil.printStackTrace(e);
      throw new Exception("SOAPVersionMismatchExceptionTest failed", e);
    }

    if (!pass)
      throw new Exception("SOAPVersionMismatchExceptionTest failed");
  }
   ...
   * @test_Strategy:
   */
  public void MessageFactoryImplTest() throws Exception {
    ...
    try {
      ...
      TestUtil.logErr("Caught unexpected exception: " + e.getMessage());
      TestUtil.printStackTrace(e);
      throw new Exception("MessageFactoryImplTest failed", e);
    }

    if (!pass)
      throw new Exception("MessageFactoryImplTest failed");
  }
   ...
   * @test_Strategy:
   */
  public void SOAPDocumentFragmentTest() throws Exception {
    ...
    try {
      ...
      TestUtil.logErr("Caught unexpected exception: " + e.getMessage());
      TestUtil.printStackTrace(e);
      throw new Exception("SOAPDocumentFragmentTest failed", e);
    }

    if (!pass)
      throw new Exception("SOAPDocumentFragmentTest failed");
  }
   ...
   * @test_Strategy:
   */
  public void SOAPDocumentImplTest() throws Exception {
    ...
    try {
      ...
      TestUtil.logErr("Caught unexpected exception: " + e.getMessage());
      TestUtil.printStackTrace(e);
      throw new Exception("SOAPDocumentImplTest failed", e);
    }

    if (!pass)
      throw new Exception("SOAPDocumentImplTest failed");
  }
   ...
   * @test_Strategy:
   */
  public void EnvelopeFactoryTest() throws Exception {
    ...
    try {
      ...
      TestUtil.logErr("Caught unexpected exception: " + e.getMessage());
      TestUtil.printStackTrace(e);
      throw new Exception("EnvelopeFactoryTest failed", e);
    }

    if (!pass)
      throw new Exception("EnvelopeFactoryTest failed");
  }
   ...
   * @test_Strategy:
   */
  public void SOAPPartImplTest() throws Exception {
    ...
    try {
      ...
      TestUtil.logErr("Caught unexpected exception: " + e.getMessage());
      TestUtil.printStackTrace(e);
      throw new Exception("SOAPPartImplTest failed", e);
    }

    if (!pass)
      throw new Exception("SOAPPartImplTest failed");
  }
   ...
   * @test_Strategy:
   */
  public void GifDataContentHandlerTest() throws Exception {
    ...
    try {
      ...
      TestUtil.logErr("Caught unexpected exception: " + e.getMessage());
      TestUtil.printStackTrace(e);
      throw new Exception("GifDataContentHandlerTest failed", e);
    }

    if (!pass)
      throw new Exception("GifDataContentHandlerTest failed");
  }
   ...
   * @test_Strategy:
   */
  public void JpegDataContentHandlerTest() throws Exception {
    ...
    try {
      ...
      TestUtil.logErr("Caught unexpected exception: " + e.getMessage());
      TestUtil.printStackTrace(e);
      throw new Exception("JpegDataContentHandlerTest failed", e);
    }

    if (!pass)
      throw new Exception("JpegDataContentHandlerTest failed");
  }
   ...
   * @test_Strategy:
   */
  public void XmlDataContentHandlerTest() throws Exception {
    ...
    try {
      ...
      TestUtil.logErr("Caught unexpected exception: " + e.getMessage());
      TestUtil.printStackTrace(e);
      throw new Exception("XmlDataContentHandlerTest failed", e);
    }

    if (!pass)
      throw new Exception("XmlDataContentHandlerTest failed");
  }
   ...
   * @test_Strategy:
   */
  public void StringDataContentHandlerTest() throws Exception {
    ...
    try {
      ...
      TestUtil.logErr("Caught unexpected exception: " + e.getMessage());
      TestUtil.printStackTrace(e);
      throw new Exception("StringDataContentHandlerTest failed", e);
    }

    if (!pass)
      throw new Exception("StringDataContentHandlerTest failed");
  }
}

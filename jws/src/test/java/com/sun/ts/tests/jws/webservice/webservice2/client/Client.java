...
public class Client extends ServiceEETest {
  ...
  private void getPortJavaEE() throws Exception {
    ...
    port = (EndpointInterfaceWebServiceEI) service
        .getPort(EndpointInterfaceWebServiceEI.class);
    TestUtil.logMsg("port=" + port);
    TestUtil.logMsg("Obtained port");
  }

  private void getPortStandalone() throws Exception {
    port = (EndpointInterfaceWebServiceEI) JWS_Util.getPort(wsdlurl,
        SERVICE_QNAME, EndpointInterfaceWebServiceService.class, PORT_QNAME,
        ...
        if (att != null && att.getValue().equals(PORT_NAME)) {
          ...
          if (bindingAttr != null && bindingAttr.getValue() != null) {
            ...
            if (bindingQName != null) {
              ...
              Element bindingElement = WsdlUtils.findSoapBindingElement(doc,
                  bindingQName);

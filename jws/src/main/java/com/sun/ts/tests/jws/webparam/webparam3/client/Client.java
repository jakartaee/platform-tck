...
public class Client extends ServiceEETest
  ...
  public void testHello3() throws Exception {
    ...
    try {
      ...
      throw new Exception("testHello3 failed", e);
    }

    if (!pass)
      throw new Exception("testHello3 failed, returned value : " + output);
  ...
  public void testWSDL7() throws Exception {
    ...
    if (pass) {
      ...
      throw new Exception("Output Parameter Order is set to " + outputParameterOrder

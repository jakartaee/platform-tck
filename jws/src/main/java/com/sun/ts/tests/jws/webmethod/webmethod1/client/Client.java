...
public class Client extends ServiceEETest {
  ...
  public void testHello2() throws Exception {
    ...
    try {
      ...
      TestUtil.logErr("Exception occurred: " + e.getMessage());
      throw new Exception("testHello2 failed", e);
    }

    if (!pass)
      throw new Exception("testHello2 failed invoking hello2 returned " + result);
  ...
  public void testHello3() throws Exception {
    ...
    if (!pass)
      throw new Exception("testHello3 failed invoking hello2 returned " + result);

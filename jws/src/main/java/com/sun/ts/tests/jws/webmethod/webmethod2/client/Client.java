...
package com.sun.ts.tests.jws.webmethod.webmethod2.client;
...
/**
 * @test
 * @executeClass com.sun.ts.tests.jws.webmethod.webmethod2.client.Client
 * @sources Client.java
 * @keywords webservice
 */
...
public class Client extends ServiceEETest {
  ...
  static DefaultWebMethod2WebServiceService service = null;

  // URL properties used by the test
  private static final String ENDPOINT_URL = "jwstest.defaultwebmethod2webservice.endpoint.1";
  ...
  private static final String NAMESPACEURI = "http://server.webmethod2.webmethod.jws.tests.ts.sun.com/";

  private static final String PKG_NAME = "com.sun.ts.tests.jws.webmethod.webmethod2.client.";

  private static final String PORT_NAME = "defaultWebMethod2WebServicePort";
  ...
  private static final String SERVICE_NAME = "defaultWebMethod2WebServiceService";
  ...
  private static final String WSDLLOC_URL = "jwstest.defaultwebmethod2webservice.wsdlloc.1";
  ...
  private DefaultWebMethod2WebService port;
  ...
  private void getPortJavaEE() throws Exception {
    ...
    port = (DefaultWebMethod2WebService) service
        .getPort(DefaultWebMethod2WebService.class);
    TestUtil.logMsg("port=" + port);
    TestUtil.logMsg("Obtained port");
  }

  private void getPortStandalone() throws Exception {
    port = (DefaultWebMethod2WebService) JWS_Util.getPort(wsdlurl,
        SERVICE_QNAME, DefaultWebMethod2WebServiceService.class, PORT_QNAME,
        DefaultWebMethod2WebService.class);
  ...
  public void setup(String[] args, Properties p) throws Exception {
    ...
    try {
      ...
      if (modeProperty.equals("standalone")) {
        ...
        service = (DefaultWebMethod2WebServiceService) getSharedObject();
        getPortJavaEE();
      }
  ...
  public void testHello() throws Exception {
    ...
    try {
      TestUtil
          .logMsg("Invoke the hello() method of DefaultWebMethod2WebService");
    ...
    if (!pass)
      throw new Exception("testHello failed invoking hello returned " + result);
  ...
  public void testPingWSDL() throws Exception {
    ...
    boolean pass = true;
    try {
      TestUtil.logMsg("Get the WSDL of defaultWebMethod2WebService");
  ...
  public void testWSDL1() throws Exception {
    ...
    try {
      ...
      if (operationElement != null) {
        ...
        soapOperationElement = com.sun.ts.tests.jws.common.WsdlUtils
            .findSoapOperationElement(doc, EXPECTED_SOAP_ACTION,
                operationElement);

...
public class Client extends ServiceEETest {
  ...
  public void testHelloString2() throws Exception {
    ...
    if (!pass)
      throw new Exception("testHelloString2 failed");
  ...
  public void testHelloString3() throws Exception {
    ...
    if (!pass)
      throw new Exception("testHelloString3 failed");
  ...
  public void testHelloString4() throws Exception {
    ...
    if (!pass)
      throw new Exception("testHelloString4 failed");
   ...
   * @test_Strategy:
   */
  public void testHelloString5() throws Exception {
    ...
    try {
      ...
      TestUtil.logErr("Exception occurred: " + e.getMessage());
      throw new Exception("testHelloString5 failed", e);
    }

    if (!pass)
      throw new Exception("testHelloString5 failed, returned value : " + result);
   ...
   * @test_Strategy:
   */
  public void testHelloString6() throws Exception {
    ...
    try {
      ...
      TestUtil.logErr("Exception occurred: " + e.getMessage());
      throw new Exception("testHelloString6 failed", e);
    }

    if (!pass)
      throw new Exception("testHelloString6 failed, returned value : " + result);
   ...
   * @test_Strategy:
   */
  public void testHelloString7() throws Exception {
   ...
   * @test_Strategy:
   */
  public void testHelloString8() throws Exception {
    ...
    try {
      ...
      TestUtil.logErr("Exception occurred: " + e.getMessage());
      throw new Exception("testHelloString8 failed", e);
    }

    if (!pass)
      throw new Exception("testHelloString8 failed, returned value : " + result);
  ...
  public void testWSDL4() throws Exception {
    ...
    if (pass) {
      ...
      throw new Exception("testWSDL4 failed : could not find soap header element : "
  ...
  public void testWSDL6() throws Exception {
    boolean pass = false;
    Element messageElement = null;
    Element partElement = null;
    ...
    try {
      ...
      TestUtil.logErr("Exception occurred: " + ex.getMessage());
      throw new Exception("testWSDL6 failed", ex);
    }

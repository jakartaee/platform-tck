...
public class Client extends ServiceEETest
  ...
  public void testHelloString2() throws Exception {
    ...
    if (!pass)
      throw new Exception("testHelloString failed, got result : " + result);
  ...
  public void testHelloString5() throws Exception {
    ...
    if (!pass)
      throw new Exception("testHelloString5 failed");
  }
  ...
  public void testHelloString6() throws Exception {
    ...
    if (!pass)
      throw new Exception("testHelloString6 failed");
  }
      ...
      if (partElement != null) {
        ...
        if (wrapperElement != null) {
          ...
          if (!NAMESPACEURI.equals(targetNameSpace))
            throw new Exception(" Name space of schema with wrapper element "
          ...
          if (complexType != null) {
            ...
            throw new Exception("Cannot Find Complex Type "
  ...
  public void testWSDL7() throws Exception {
    ...
    try {
      ...
      TestUtil.logErr("Exception occurred: " + ex.getMessage());
      throw new Exception("testWSDL7 failed", ex);
    }
    ...
    if (pass) {
      ...
      throw new Exception("testWSDL7 failed : could not find soap header element : "

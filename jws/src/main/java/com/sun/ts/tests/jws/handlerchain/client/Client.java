...
public class Client extends ServiceEETest {
   ...
   * @test_Strategy:
   */
  public void testHelloRPC_WithHandler() throws Exception {
    ...
    try {
      ...
      throw new Exception("testHelloRPC_WithHandler failed", e);
    }

    if (!pass)
      throw new Exception("testHelloRPC_WithHandler failed");
  }
   ...
   * @test_Strategy:
   */
  public void testHelloRPC_WithoutHandler() throws Exception {
    ...
    try {
      ...
      TestUtil.logErr("Exception occurred: " + e.getMessage());
      throw new Exception("testHelloRPC_WithoutHandler failed", e);
    }

    if (!pass)
      throw new Exception("testHelloRPC_WithoutHandler failed");
  }
}

...
public class XAManagedConnectionFactory
    ...
    public String getUserName() {
        System.out.println("XAManagedConnectionFactory.getUserName() returning:  " + userName);
        return userName;
    }
    ...
    public String getPassword() {
        System.out.println("XAManagedConnectionFactory.getPassword() returning:  " + password);
        return password;
    }

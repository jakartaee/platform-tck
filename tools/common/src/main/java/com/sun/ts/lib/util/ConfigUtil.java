...
public class ConfigUtil {
    public final static File PROPS_DIR = new File(System.getProperty("TS_HOME", System.getProperty("ts.home")) + File.separator + "src"
            + File.separator + "com" + File.separator + "sun" + File.separator + "ts" + File.separator + "lib", "harness");

    public final static File SRC_DIR = new File(System.getProperty("TS_HOME", System.getProperty("ts.home")), "src");

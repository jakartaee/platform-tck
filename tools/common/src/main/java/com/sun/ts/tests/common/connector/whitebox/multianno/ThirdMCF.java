 ...
 *
 */
public class ThirdMCF implements ManagedConnectionFactory, ResourceAdapterAssociation, Serializable, jakarta.resource.Referenceable {
    ...
    public Object createConnectionFactory(ConnectionManager cxManager) throws ResourceException {
        ConnectorStatus.getConnectorStatus().logAPI("ThirdMCF.createConnectionFactory", "cxManager", "TSEISDataSource");
    ...
    public Object createConnectionFactory() throws ResourceException {
        ConnectorStatus.getConnectorStatus().logAPI("ThirdMCF.createConnectionFactory", "", "TSEISDataSource");
    ...
    public ManagedConnection createManagedConnection(Subject subject, ConnectionRequestInfo info) throws ResourceException {
        ...
        try {
            ...
            ConnectorStatus.getConnectorStatus().logAPI("ThirdMCF.createManagedConnection", "subject|info", "TSManagedConnection");
    ...
    public ManagedConnection matchManagedConnections(Set connectionSet, Subject subject, ConnectionRequestInfo info)
        ...
        ConnectorStatus.getConnectorStatus().logAPI("ThirdMCF.matchManagedConnection", "connectionSet|subject|info", "TSEISDataSource");
        PasswordCredential pc = Util.getPasswordCredential(this, subject, info);

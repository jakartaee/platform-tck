...
public class LocalTxMessageWork1 implements Work {
    ...
    public void run() {
        ...
        while (!stop) {
            try {
                ...
                ((TSMessageListenerInterface) xaep).onMessage("LocalTx MDB2 Transacted Message To MDB");
                xaep.afterDelivery();
    ...
    public void callSysExp() {
        ...
        try {
            ...
            ((TSMessageListenerInterface) ep2).onMessage("Throw EJBException from Required");
    ...
    public void callAppExp() {
        ...
        try {
            Method onMessage = getOnMessageMethod();
            ep2.beforeDelivery(onMessage);
            ((TSMessageListenerInterface) ep2).onMessage("Throw AppException from Required");
            // this has been moved to finally clause to ensure that before and
            // after delivery calls are properly matched.
            // ep2.afterDelivery();

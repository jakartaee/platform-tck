...
public class MAManagedConnectionFactory
    ...
    public void setResourceAdapter(ResourceAdapter ra) throws ResourceException {
        count++;
        String newStr1 = new String("MAManagedConnectionFactory setResourceAdapter " + count);
        debug(newStr1);
    ...
    public ManagedConnection createManagedConnection(Subject subject, ConnectionRequestInfo info) throws ResourceException {
        ...
        try {
            ...
            ConnectorStatus.getConnectorStatus().logAPI("MAManagedConnectionFactory.createManagedConnection", "subject|info",
                    "TSManagedConnection");
    ...
    public ManagedConnection matchManagedConnections(Set connectionSet, Subject subject, ConnectionRequestInfo info)
        ...
        ConnectorStatus.getConnectorStatus().logAPI("MAManagedConnectionFactory.matchManagedConnection", "connectionSet|subject|info",
                "TSEISDataSource");
        PasswordCredential pc = Util.getPasswordCredential(this, subject, info);

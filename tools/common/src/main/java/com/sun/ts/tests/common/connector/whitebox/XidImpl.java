...
public class XidImpl implements Xid {
    ...
    public boolean equals(Object o) {
        ...
        if (this.formatID == other.formatID && this.branchQualifier == other.branchQualifier && this.globalTxID == other.globalTxID) {
            return true;
        }
    ...
    public String toString() {
        ...
        String s = new String("{XidImpl: " + "formatID(" + formatID + "), " + "branchQualifier (" + branchQualifier + "), " + "globalTxID("
                + globalTxID + ")}");

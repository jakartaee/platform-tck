...
public class ResolverTest {
    ...
    public static boolean testELResolver(ELContext elContext, ELResolver resolver, Object base, Object property, Object value,
            StringBuffer buf, boolean readOnly) {
     ...
     * @return
     */
    public static boolean testELResolverInvoke(ELContext elContext, ELResolver resolver, Object beanName, Object methodName,
            Class<?>[] types, Object[] values, Boolean negTest, StringBuffer buf) {
        ...
        elContext.setPropertyResolved(false);
        try {
            Boolean nameMatch = (Boolean) resolver.invoke(elContext, beanName, methodName, types, values);
    ...
    public static boolean testELResolverNPE(ELResolver resolver, Object base, Object property, Object value, StringBuffer buf) {
        ...
        try {
            ...
            pass = false;
            buf.append("getType test failed with: " + NL + "EXPECTED: NullPointerException to be thrown " + NL
                    + "RECEIVED: NO EXCEPTION THROWN AT ALL! " + NL);
        } catch (Exception e) {
            if (!(e instanceof NullPointerException)) {
                buf.append("getType test failed with: " + NL + "EXPECTED: " + "NullPointerException to be thrown " + NL + "RECEIVED: "
                        + e.toString() + NL);
                pass = false;
        ...
        try {
            ...
            if (!(e instanceof NullPointerException)) {
                buf.append("Test Failed  getValue() threw the wrong exception " + NL + "Expected: NullPointerException " + NL + "Received: "
                        + e.toString());
        ...
        try {
            ...
            if (!(e instanceof NullPointerException)) {
                buf.append("Test Failed  setValue() threw the wrong exception " + NL + "Expected: NullPointerException " + NL + "Received: "
                        + e.toString());
        ...
        try {
            ...
            if (!(e instanceof NullPointerException)) {
                buf.append("Test Failed  isReadOnly() threw the wrong exception " + NL + "Expected: NullPointerException " + NL
                        + "Received: " + e.toString());
    ...
    public static boolean testELResolverPNFE(ELContext elcontext, ELResolver resolver, Object base, Object property, StringBuffer buf) {
        ...
        try {
            ...
            if (!(e instanceof PropertyNotFoundException)) {
                buf.append("Test Failed  getType() threw the wrong exception " + NL + "Expected: PropertyNotFoundException " + NL
                        + "Received: " + e.toString());
        ...
        try {
            ...
            if (!(e instanceof PropertyNotFoundException)) {
                buf.append("Test Failed  isReadOnly() threw the wrong exception " + NL + "Expected: PropertyNotFoundException " + NL
                        + "Received: " + e.toString());
        ...
        try {
            ...
            if (!(e instanceof PropertyNotFoundException)) {
                buf.append("Test Failed  setValue() threw the wrong exception " + NL + "Expected: PropertyNotFoundException " + NL
                        + "Received: " + e.toString());
        ...
        try {
            ...
            if (!(e instanceof PropertyNotFoundException)) {
                buf.append("Test Failed  getValue() threw the wrong exception " + NL + "Expected: PropertyNotFoundException " + NL
                        + "Received: " + e.toString());
    ...
    public static boolean testELResolverIAE(ELContext elcontext, ELResolver resolver, Object base, Object property, Object value,
            StringBuffer buf) {
        ...
        try {
            ...
            if (!(e instanceof IllegalArgumentException)) {
                buf.append("Test Failed  getValue() threw the wrong exception " + NL + "Expected: IllegalArgumentException " + NL
                        + "Received: " + e.toString());
        ...
        try {
            ...
            if (!(e instanceof IllegalArgumentException)) {
                buf.append("Test Failed  setValue() threw the wrong exception " + "Expected: IllegalArgumentException " + NL + "Received: "
                        + e.toString());
    ...
    public static boolean testELResolverPNWE(ELContext elcontext, ELResolver resolver, Object base, Object property, Object value,
            StringBuffer buf) {
        ...
        try {
            ...
            if (!(e instanceof PropertyNotWritableException)) {
                buf.append("Test Failed  setValue() threw the wrong exception " + NL + "Expected: PropertyNotWritableException " + NL
                        + "Received: " + e.toString());
                pass = false;

...
public class MDCompleteMCF
        implements ManagedConnectionFactory, ResourceAdapterAssociation, TransactionSupport, Serializable, jakarta.resource.Referenceable {
    ...
    public ManagedConnection matchManagedConnections(Set connectionSet, Subject subject, ConnectionRequestInfo info)
        ...
        ConnectorStatus.getConnectorStatus().logAPI("MDCompleteMCF.matchManagedConnection", "connectionSet|subject|info",
                "TSEISDataSource");

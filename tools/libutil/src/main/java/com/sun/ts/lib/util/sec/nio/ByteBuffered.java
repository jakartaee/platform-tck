 ...
 * <p>
 *
 * For example, the Zip/Jar code supports {@link java.io.InputStream <tt>InputStreams</tt>}. To make the Zip code use
 * {@link java.nio.MappedByteBuffer <tt>MappedByteBuffers</tt>} as the underlying data structure, it can create a class
...
public interface ByteBuffered {
    ...
    /**
     * Returns the <tt>ByteBuffer</tt> behind this object, if this particular instance has one. An implementation of
     * <tt>getByteBuffer()</tt> is allowed to return <tt>null</tt> for any reason.
     *
     * @return The <tt>ByteBuffer</tt>, if this particular instance has one, or <tt>null</tt> otherwise.
     *

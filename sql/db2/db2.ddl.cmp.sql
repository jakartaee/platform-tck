...
CREATE TABLE COMMON_TABLE(ID INT NOT NULL, BRANDNAME  VARCHAR(25), PRICE  REAL, CONSTRAINT COMMON_TABLE1 PRIMARY KEY(ID))!
...
CREATE TABLE LOCALACCESSTEST_TABLE1 ( ID INT  NOT NULL, NAME VARCHAR(25) , VALUE REAL , CONSTRAINT LOCALACCTEST_TAB PRIMARY KEY (ID))!
...
CREATE TABLE CUSTOMEREJB_TABLE ( ID VARCHAR(255)   PRIMARY KEY NOT NULL, NAME VARCHAR(255) , COUNTRY BLOB(2G)   NOT LOGGED)!
...
CREATE TABLE COMPLEXPK_TABLE1 ( ID INT  NOT NULL, BRANDNAME VARCHAR(25) NOT NULL, PRICE REAL , PRODUCT BLOB(2G)   NOT LOGGED, FK_FOR_LINEITEMS varchar(25), CONSTRAINT COMPLEXPK_TABLE1  PRIMARY KEY (ID, BRANDNAME))!
...
CREATE TABLE CMP20_ENTITYCMP_TABLE1 ( KEY_ID INT  NOT NULL, BRAND_NAME VARCHAR(25) , PRICE REAL , B BLOB(2G) NOT LOGGED, CONSTRAINT CMP20_ENTITYCMP_TA  PRIMARY KEY (KEY_ID))!
...
CREATE TABLE CMP_COMPLEXPK_TABLE1 ( ID INT  NOT NULL, BRAND_NAME VARCHAR(25) NOT NULL, PRICE REAL , PRODUCT BLOB(2G) NOT LOGGED, CONSTRAINT CMP_COMPLEXPK_TABL  PRIMARY KEY (ID, BRAND_NAME))!
...
CREATE TABLE EMPLOYEEEJB (HIREDATE TIMESTAMP, ID INTEGER NOT NULL, FIRSTNAME VARCHAR(256) , SALARY REAL NOT NULL, LASTNAME VARCHAR(256) , EMPLOYEEEJB_ID INTEGER , DEPARTMENTEJB_ID INTEGER , CONSTRAINT PK_EMPLOYEEEJB PRIMARY KEY (ID)) !

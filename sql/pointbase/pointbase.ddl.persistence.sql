...
CREATE TABLE DATATYPES ( BOOLEANDATA SMALLINT, CHARDATA CHAR, SHORTDATA SMALLINT, INTDATA INTEGER, INTDATA2 INTEGER, LONGDATA BIGINT, DBLDATA DOUBLE, FLOATDATA FLOAT, ID INTEGER PRIMARY KEY NOT NULL, ENUMODATA INTEGER, ENUMSDATA VARCHAR(25), BYTEDATA SMALLINT, TRANS SMALLINT);
...
CREATE TABLE ORDER1 (ID INTEGER PRIMARY KEY NOT NULL, TOTALPRICE DOUBLE , FK1_FOR_ITEM INTEGER);
 
DROP TABLE ORDER2 cascade;
CREATE TABLE ORDER2 (ID INTEGER PRIMARY KEY NOT NULL, TOTALPRICE DOUBLE , FK2_FOR_ITEM INTEGER);

DROP TABLE ORDER3 cascade;
CREATE TABLE ORDER3 (ID INTEGER PRIMARY KEY NOT NULL, TOTALPRICE DOUBLE , FK3_FOR_ITEM INTEGER);

DROP TABLE ITEM ;
CREATE TABLE ITEM (ID INTEGER PRIMARY KEY NOT NULL, ITEMNAME VARCHAR2(255)) ;
...
CREATE TABLE A_BASIC ( ID VARCHAR(255)   PRIMARY KEY NOT NULL, NAME VARCHAR(255) , VALUE INT, BASICINTEGER INT, BASICSHORT SMALLINT, BASICBIGSHORT SMALLINT, BASICFLOAT REAL, BASICBIGFLOAT REAL, BASICLONG BIGINT, BASICBIGLONG BIGINT, BASICDOUBLE DOUBLE PRECISION, BASICBIGDOUBLE DOUBLE PRECISION, BASICCHAR CHAR, BASICCHARARRAY VARCHAR(448), BASICBIGCHARARRAY VARCHAR(448), BASICBYTEARRAY   LONGVARBINARY(48000), BASICBIGBYTEARRAY  LONGVARBINARY(48000), BASICBIGINTEGER DECIMAL(18,0), BASICBIGDECIMAL DECIMAL(18,0), BASICDATE DATE, BASICTIME TIME, BASICCALENDAR DATE, BASICTIMESTAMP TIMESTAMP ) ;

DROP TABLE A_BIGINTEGER  cascade ;
CREATE TABLE A_BIGINTEGER ( ID VARCHAR(255), NAME VARCHAR(255) , VALUE INT, BASICINTEGER INT, BASICSHORT SMALLINT, BASICBIGSHORT SMALLINT, BASICFLOAT REAL, BASICBIGFLOAT REAL, BASICLONG BIGINT, BASICBIGLONG BIGINT, BASICDOUBLE DOUBLE PRECISION, BASICBIGDOUBLE DOUBLE PRECISION, BASICCHAR CHAR, BASICCHARARRAY VARCHAR(448), BASICBIGCHARARRAY VARCHAR(448), BASICBYTEARRAY   LONGVARBINARY(48000), BASICBIGBYTEARRAY  LONGVARBINARY(48000), BASICBIGINTEGER DECIMAL(18,0) PRIMARY KEY NOT NULL, BASICBIGDECIMAL DECIMAL(18,0), BASICDATE DATE, BASICTIME TIME, BASICCALENDAR DATE, BASICTIMESTAMP TIMESTAMP ) ;

DROP TABLE A_BIGDECIMAL  cascade ;
CREATE TABLE A_BIGDECIMAL ( ID VARCHAR(255), NAME VARCHAR(255) , VALUE INT, BASICINTEGER INT, BASICSHORT SMALLINT, BASICBIGSHORT SMALLINT, BASICFLOAT REAL, BASICBIGFLOAT REAL, BASICLONG BIGINT, BASICBIGLONG BIGINT, BASICDOUBLE DOUBLE PRECISION, BASICBIGDOUBLE DOUBLE PRECISION, BASICCHAR CHAR, BASICCHARARRAY VARCHAR(448), BASICBIGCHARARRAY VARCHAR(448), BASICBYTEARRAY   LONGVARBINARY(48000), BASICBIGBYTEARRAY  LONGVARBINARY(48000), BASICBIGINTEGER DECIMAL(18,0), BASICBIGDECIMAL DECIMAL(18,0) PRIMARY KEY NOT NULL, BASICDATE DATE, BASICTIME TIME, BASICCALENDAR DATE, BASICTIMESTAMP TIMESTAMP );

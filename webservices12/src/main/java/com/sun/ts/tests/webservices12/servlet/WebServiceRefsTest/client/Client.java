...
public class Client extends ServiceEETest {
   ...
   */
  public void DoInvokeWebService1Test() throws Exception {
    ...
    try {
      ...
      if (!ret.equals("WSHello1Servlet: Hello Hello!!!"))
        throw new Exception("DoInvokeWebService1Test failed");
    } catch (Exception e) {
      throw new Exception("DoInvokeWebService1Test failed", e);
    }
  }
   ...
   */
  public void DoInvokeWebService2Test() throws Exception {
    ...
    try {
      ...
      if (!ret.equals("WSHello2Servlet: Hello Hello!!!"))
        throw new Exception("DoInvokeWebService2Test failed");
    } catch (Exception e) {
      throw new Exception("DoInvokeWebService2Test failed", e);
    }
  }
   ...
   *
   */
  public void VerifyTargetEndpointAddressForBothWebServices() throws Exception {
    ...
    try {
      ...
      if (endpointaddr1.endsWith("jaxws/WSHello1")
        ...
        throw new Exception("VerifyTargetEndpointAddressForBothWebServices failed");
      }
    } catch (Throwable t) {

...
public class Client extends EETest {
   ...
   */
  public void WSEjbWebServiceRefTest2CallHello() throws Exception {
    ...
    try {
      ...
      throw new Exception("WSEjbWebServiceRefTest2CallHello failed");
    }
    return;
  }
   ...
   * field to access the service ref.
   */
  public void WSEjbWebServiceRefTest2CallBye() throws Exception {
    ...
    try {
      ...
      TestUtil.printStackTrace(t);
      throw new Exception("WSEjbWebServiceRefTest2CallBye failed");
    }
    return;
  }
   ...
   * 
   */
  public void WSEjbWebServiceRefTest2VerifyJNDILookupOfService() throws Exception {

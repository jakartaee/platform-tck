...
import com.sun.ts.tests.webservices12.sec.annotations.ejb.basicauthssl.HelloService;
import com.sun.ts.tests.webservices12.sec.annotations.ejb.basicauthssl.Hello;
...
public class Client extends EETest {
  ...
  /*
   * @class.setup_props: webServerHost; securedWebServicePort; user; password;
  ...
  public void setup(String[] args, Properties p) throws Exception {
    ...
    try {
      ...
      urlString = ctsurl.getURLString(PROTOCOL, hostname, portnum,
          "/WSEjbBasicAuthSSL/HelloService/Hello");
   ...
   * @test_Strategy:
   */
  public void sayHelloProtected() throws Exception {
    ...
    try {
      ...
      e.printStackTrace();
      throw new Exception("Test sayHelloProtected failed");
    }
    return;
  }
   ...
   * @test_Strategy:
   */
  public void sayHelloPermitAll() throws Exception {
    ...
    try {
      ...
      e.printStackTrace();
      throw new Exception("Test sayHelloPermitAll failed");
    }
    return;
  }
   ...
   * @test_Strategy:
   */
  public void sayHelloDenyAll() throws Exception {
   ...
   */
  public void sayHelloProtectedUnauthorizedUser() throws Exception {
    ...
    try {
      ...
      TestUtil.logMsg("Got Output : " + text);
      throw new Exception("Test sayHelloProtectedUnauthorizedUser failed");
    } catch (WebServiceException e) {
      TestUtil.logMsg("Got expected WebServiceException");
      TestUtil.logMsg("Test sayHelloDenyAll Passed");
    } catch (Exception e) {

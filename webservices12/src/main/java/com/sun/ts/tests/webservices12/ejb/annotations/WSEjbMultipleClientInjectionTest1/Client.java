...
public class Client extends EETest {
  ...
  private void getPort() throws Exception {
    TestUtil.logMsg(
        "Get wsejbmultipleclientinjectiontest1 Service via @WebServiceRef annotation");
    TestUtil.logMsg(
        "Uses name attribute @WebServiceRef(name=\"service/wsejbmultipleclientinjectiontest1\")");
   ...
   */
  public void MultipleClientInjectionSingleClntEarTest() throws Exception {
    boolean pass = true;
    ...
    try {
      ...
      throw new Exception("MultipleClientInjectionSingleClntEarTest failed");
    }
    if (!pass)
      throw new Exception("MultipleClientInjectionSingleClntEarTest failed");
  }
   ...
   */
  public void MultipleClientInjectionSingleClntEarInvokeHelloBye()
      throws Exception {
    boolean pass = true;
    ...
    try {
      ...
      throw new Exception(
          "MultipleClientInjectionSingleClntEarInvokeHelloBye failed");
    }
    if (!pass)
      throw new Exception(
          "MultipleClientInjectionSingleClntEarInvokeHelloBye failed");

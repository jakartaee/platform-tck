...
public class Client extends EETest {
  ...
  private void getPort() throws Exception {
    TestUtil.logMsg(
        "Get wsejbsoaphandlerstest2 Service via @WebServiceRef annotation");
    TestUtil.logMsg(
        "Uses name attribute @WebServiceRef(name=\"service/wsejbsoaphandlerstest2\")");
   ...
   * container.
   */
  public void WSEjbSOAPHandlersApplicationClientTest() throws Exception {
    ...
    try {
      ...
      if (!pass)
        throw new Exception("WSEjbSOAPHandlersApplicationClientTest failed");
    } catch (Throwable t) {
      throw new Exception("WSEjbSOAPHandlersApplicationClientTest failed");
    }
  }
   ...
   * container.
   */
  public void WSEjbSOAPHandlersServletClientTest() throws Exception {
    ...
    try {
      ...
      if (passStr.equals("fail"))
        throw new Exception("WSEjbSOAPHandlersServletClientTest failed");
    } catch (Throwable t) {
      throw new Exception("WSEjbSOAPHandlersServletClientTest failed");
    }
  }

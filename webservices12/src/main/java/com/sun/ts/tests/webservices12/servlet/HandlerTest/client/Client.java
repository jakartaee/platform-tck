...
public class Client extends ServiceEETest {
   ...
   */
  public void transformBodyTest() throws Exception {
    ...
    if (!pass)
      throw new Exception("transformBodyTest failed");
  }
   ...
   */
  public void transformHeaderTest() throws Exception {
    ...
    if (!pass)
      throw new Exception("transformHeaderTest failed");
  }

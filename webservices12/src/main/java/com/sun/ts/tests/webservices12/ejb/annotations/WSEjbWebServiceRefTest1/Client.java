...
public class Client extends EETest {
   ...
   * ref name.
   */
  public void WSEjbWebServiceRefTest1CallHello() throws Exception {
    ...
    try {
      ...
      throw new Exception("WSEjbWebServiceRefTest1CallHello failed");
    }
    return;
  }
   ...
   * ref name.
   */
  public void WSEjbWebServiceRefTest1CallBye() throws Exception {
    ...
    try {
      ...
      TestUtil.printStackTrace(t);
      throw new Exception("WSEjbWebServiceRefTest1CallBye failed");
    }
    return;
  }
   ...
   */
  public void WSEjbWebServiceRefTest1VerifyJNDILookupOfService() throws Exception {

...
public class Client extends ServiceEETest {
   ...
   * WebServiceException.
   */
  public void secEjbBasicNoId() throws Exception {
    ...
    try {
      ...
      throw new Exception("SecEjbBasicNoId failed");
   ...
   */
  public void secEjbBasicUnauthorizedId() throws Exception {
    ...
    try {
      ...
      throw new Exception("SecEjbBasicUnauthorizedId failed");
    } catch (WebServiceException ex) {
      TestUtil.logMsg(
   ...
   * WebServiceException.
   */
  public void secEjbBasicInvalidId() throws Exception {
    ...
    try {
      ...
      throw new Exception("SecEjbBasicInvalidId failed");
    } catch (WebServiceException ex) {
   ...
   */
  public void secEjbBasicAuthorizedId() throws Exception {

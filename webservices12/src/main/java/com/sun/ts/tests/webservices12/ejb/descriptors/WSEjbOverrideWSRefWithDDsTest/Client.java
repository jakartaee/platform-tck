...
public class Client extends EETest {
   ...
   */
  public void call_txRequired() throws Exception {
    ...
    try {
      ...
      throw new Exception("call_txRequired failed");
    }
    return;
  }
   ...
   * deployment descriptors.
   */
  public void call_txSupports() throws Exception {
    ...
    try {
      ...
      throw new Exception("call_txSupports failed");
    }
    return;
  }
   ...
   * deployment descriptors.
   */
  public void call_txRequiresNew() throws Exception {
    ...
    try {
      ...
      throw new Exception("call_txRequiresNew failed");
    }
    return;
  }
   ...
   * deployment descriptors.
   */
  public void call_txNotSupported() throws Exception {
    ...
    try {
      ...
      throw new Exception("call_txNotSupported failed");
    }
    return;
  }
   ...
   * deployment descriptors.
   */
  public void call_txNever() throws Exception {
    ...
    try {
      ...
      throw new Exception("call_txNever failed");
    }
    return;
  }
}

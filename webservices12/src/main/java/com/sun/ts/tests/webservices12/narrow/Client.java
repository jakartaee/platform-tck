...
public class Client extends ServiceEETest {
   ...
   *
   */
  public void narrowTest() throws Exception {
    ...
    if (!pass)
      throw new Exception("narrowTest failed");
  }

  private boolean interface1Test() throws Exception {
  ...
  private boolean interface2Test() throws Exception {

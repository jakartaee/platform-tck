...
public class Client extends EETest {
   ...
   */
  public void WSEjbWebServiceRefWithNoDDsTestCallHello() throws Exception {
    ...
    try {
      ...
      throw new Exception("WSEjbWebServiceRefWithNoDDsTestCallHello failed");
    }
    return;
  }
   ...
   * no field attributes. No deployment descriptors are uses in the packaging.
   */
  public void WSEjbWebServiceRefWithNoDDsTestCallBye() throws Exception {
    ...
    try {
      ...
      throw new Exception("WSEjbWebServiceRefWithNoDDsTestCallBye failed");
    }
    return;
  }
}

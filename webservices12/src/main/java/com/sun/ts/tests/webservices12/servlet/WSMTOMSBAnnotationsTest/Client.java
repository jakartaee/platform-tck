...
public class Client extends ServiceEETest {
  ...
  public void setup(String[] args, Properties p) throws Exception {
    ...
    try {
      ...
      SOAPBinding binding = (SOAPBinding) ((BindingProvider) port2)
          .getBinding();
      binding.setMTOMEnabled(true);
   ...
   */
  public void MTOMIn2CheckHttpHeadersTest() throws Exception {
    ...
    if (!pass)
      throw new Exception("MTOMIn2CheckHttpHeadersTest failed");
  }
   ...
   */
  public void VerifySOAPProtocolBindingOnPorts() throws Exception {
    ...
    if (!pass)
      throw new Exception("VerifySOAPProtocolBindingOnPorts failed");
  }
   ...
   */
  public void VerifyMTOMEnabledOnPorts() throws Exception {
    ...
    if (!pass)
      throw new Exception("VerifyMTOMEnabledOnPorts failed");
  }
}

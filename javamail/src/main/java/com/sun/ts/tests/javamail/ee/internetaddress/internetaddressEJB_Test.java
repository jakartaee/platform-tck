...
public class internetaddressEJB_Test extends internetaddress_Test
	...
	public static EnterpriseArchive createDeploymentEjb(@ArquillianResource TestArchiveProcessor archiveProcessor) throws IOException {
		...
		URL resURL = internetaddressEJB_Test.class.getResource("com/sun/ts/tests/common/vehicle/ejb/ejb_vehicle_client.xml");
		if (resURL != null) {
		...
		ejb.addAsManifestResource(internetaddressEJB_Test.class.getPackage(), "ejb_vehicle_ejb.xml");

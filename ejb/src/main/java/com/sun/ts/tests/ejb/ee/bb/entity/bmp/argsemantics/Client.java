...
public class Client extends EETest {
   ...
   *                 defining a remote client view only (No local view). - a BMP
   *                 Caller bean, Calling this Session Bean home or remote
   *                 interface.
   * 
   ...
   *
   *                 - a BMP Caller bean, Calling this Session Bean local home
   *                 or local interface.
   * 
   *                 We package in the same ejb-jar: - a Session Stateful Callee
   ...
   *                 local client view.
   *
   *                 - a BMP Caller bean, Calling this Session Bean home, local
   *                 home, remote, or local interface.
   * 
   ...
   *                 remote client view only (No local view). - a BMP Caller
   ...
   *
   *                 - a BMP Caller bean, Calling this CMP 2.0 Bean local home
   *                 or local interface.
   * 
   ...
   *                 client view.
   *
   *                 - a BMP Caller bean, Calling the CMP 2.0 Bean home, local
   *                 home, remote, or local interface.
   * 
   *                 The test strategy is a cumulated version of the two

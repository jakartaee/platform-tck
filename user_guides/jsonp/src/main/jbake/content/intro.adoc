...
for JSON Processing TCK (JSON-P TCK 1.1). It also includes a high level
listing of what is needed to get up and running with the JSON-P TCK.

This chapter contains the following sections:

* link:#GBFTK[Section 1.1, "Compatibility Testing"]
* link:#GBFQR[Section 1.2, "About the JSON-P TCK 1.1"]
* link:#GBFQW[Section 1.3, "Getting Started With the JSON-P TCK"]
...
[[GBFQR]][[TCCOA00028]][[about-the-json-p-tck-1.1]]

1.2 About the JSON-P TCK 1.1
~~~~~~~~~~~~~~~~~~~~~~~~~~~~

The JSON-P TCK 1.1 is designed as a portable, configurable, automated
test suite for verifying the compatibility of a licensee's
implementation of the JSON-P 1.1 Specification.

[[GBFQV]][[TCCOA00059]][[json-p-tck-specifications-and-requirements]]
...
* Specification Requirements: Software requirements for a JSON-P
implementation are described in detail in the JSON-P 1.1 Specification.
Links to the JSON-P specification and other product information can be
found at `http://jcp.org/en/jsr/detail?id=374`.
* JSON-P Version: The JSON-P TCK 1.1 is based on the JSON-P
Specification, Version 1.1.
* Reference Runtime: The designated Reference Runtime for conformance
testing of implementations based upon the JSON-P Specification 1.1 is
the Oracle Corporation JSON-P 1.1 Reference Implementation (RI).

[[GBFSQ]][[TCCOA00060]][[json-p-tck-components]]
...
information.
* JSON-P TCK signature tests: Check that all public APIs are supported
and/or defined as specified in the JSON-P Version 1.1 implementation
under test.
...
collection of tests used by the JSON-P TCK 1.1 to test a JSON-P 1.1
...
The Exclude List file, `<TS_HOME>/bin/ts.jtx`, is included in the JSON-P
TCK.
...
Exclude List before running the JSON-P TCK to verify your
implementation.
...
link:rules.html#BABBDABB[Java API for JSON Processing Version 1.1 Test
Appeals Process].

=======================================================================


[[GBFRR]][[TCCOA00064]][[json-p-tck-configuration]]
...
harness to configure and run the JSON-P tests, as described in
link:config.html#GBFVV[Chapter 4, "Setup and Configuration"].

[[GBFQW]][[TCCOA00029]][[getting-started-with-the-json-p-tck]]

1.3 Getting Started With the JSON-P TCK
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

This section provides an general overview of what needs to be done to
install, set up, test, and use the JSON-P TCK. These steps are explained
...
* JSON-P software: The implementation of the JSON-P 1.1 specification
under test +
...
Test the JSON-P implementation installation by running the test suite.

...
.  Install the {TechnologyShortName} TCK {TechnologyVersion} software.
  a.  Copy or download the {TechnologyShortName} TCK software to your
      ...
      Eclipse EE4J specification project
      site {JSRURL}.  The {TechnologyShortName} TCK software is located in the
...
A CI for {TechnologyShortName} may be obtained from Eclipse EE4J Project site for {TechnologyRI}, at {TechnologyRIURL}.

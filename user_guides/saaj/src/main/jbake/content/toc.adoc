...
** link:config.html#GHGDH[4.1 Configuring Your Environment to Run the TCK With a Compatible Implementation]
** link:config.html#GHGDH[4.2 Configuring Your Environment to Run the TCK With Your Concurreny Implementation]
** link:config.html#GHGDH[4.3 Publishing the Test Applications]

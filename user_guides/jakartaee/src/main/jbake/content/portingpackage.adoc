...
The following sections describe the API in the Jakarta EE 9.1 CTS porting
...
In addition to the Java-based deployment porting interfaces, Jakarta EE 9.1
...
The Ant-based deployment implementation for the Jakarta EE 9.1 CI is under
...
targets are implemented for the Jakarta EE 9.1 CI.
...
This implementation, which leverages the Jakarta EE 9.1 CI implementation of

...
8, the context root mapping for web archives in a Jakarta EE 9 CI becomes
...
are used for the Jakarta EE 9 CI.

The following algorithm describes the context root mapping rules that
are used by the Jakarta EE 9 Compatible Implementation.

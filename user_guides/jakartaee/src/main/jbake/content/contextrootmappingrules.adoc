...
8, the context root mapping for web archives in a Jakarta EE 9.1 CI becomes
...
clients under the Jakarta EE 9.1 Platform TCK test trees 
...
are used for the Jakarta EE 9.1 CI.

The following algorithm describes the context root mapping rules that
are used by the Jakarta EE 9.1 Compatible Implementation.

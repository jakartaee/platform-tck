type=page
status=published
title=Procedure for Jakarta Platform, Enterprise Edition 10 Web Profile Certification
next=install.html
prev=rules.html
~~~~~~
...
[[GJJPZ]][[procedure-for-jakarta-platform-enterprise-edition-10-web-profile-certification]]

3 Procedure for Jakarta Platform, Enterprise Edition 10 Web Profile Certification
---------------------------------------------------------------------------------

This chapter describes the compatibility testing procedure and
compatibility requirements for Jakarta Platform, Enterprise Edition Version 10
Web Profile.
...
* link:#CEGHFFED[Jakarta Platform, Enterprise Edition Version 10 Test
Appeals Process]
* link:#CEGEHIBD[Specifications for Jakarta Platform, Enterprise Edition
Version 10, Web Profile]
...
The certification process for Jakarta EE 10, Web Profile consists of the following activities:
...
The compatibility requirements for Jakarta EE 10, Web Profile consist of meeting the requirements set forth by the rules and
...
Enterprise Edition Version 10, Web Profile.
...
for Jakarta Platform, Enterprise Edition Version 10, Web Profile.
...
[[CEGCFBHB]][[rules-for-jakarta-platform-enterprise-edition-version-10-products]]

3.2.2 Rules for Jakarta Platform, Enterprise Edition Version 10 Products
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
EE-WP1.1 Each implementation must have at least one configuration that can be used to pass
...
EE-WP20 Compatibility testing for the Jakarta EE 10 Web Profile consists of
running the tests for the technologies defined in
link:intro.html#BHCGFHDI[Section 1.2.2, "Jakarta EE 10 Web Profile
Technologies Tested With Jakarta EE 10 Platform TCK."] If optional technologies
defined in the Jakarta EE 10 Web Profile platform are implemented in
addition to the required Jakarta EE 10 Web Profile technologies,
corresponding tests within this TCK for those additional technologies
must also be run.

EE-WP21 Compliance testing for Jakarta EE 10 Web Profile consists of running
the Jakarta EE 10 Web Profile TCK tests and the following Technology
Compatibility Kits (TCKs). Version details are defined in the Platform EE Specification document (https://jakarta.ee/specifications/webprofile/10/), see heading 'Web Profile Definition', sub-heading 'Required Components':
...
[[CEGEHIBD]][[specifications-for-jakarta-platform-enterprise-edition-version-10-web-profile]]

3.4 Specifications for Jakarta Platform, Enterprise Edition Version 10, Web Profile
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

The Specifications for Jakarta Platform, Enterprise Edition 10, Web Profile are found on the Eclipse Foundation, Jakarta EE Specification web
site at `https://jakarta.ee/specifications/webprofile/10/`. You may also find information available from the EE4J Jakarta EE Platform project page, at `https://projects.eclipse.org/projects/ee4j.jakartaee-platform`.

[[CEGFDIEG]][[3libraries-for-jakarta-platform-enterprise-edition-version-10-web-profile]]

3.5 Libraries for Jakarta Platform, Enterprise Edition Version 10, Web Profile
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

The following location provides a list of packages that constitute the
required class libraries for the full Java EE 10 platform:

``https://projects.eclipse.org/projects/ee4j.jakartaee-platform`

The following list constitutes the subset of Jakarta EE 10 packages that are
required for the Jakarta EE 10 Web Profile:

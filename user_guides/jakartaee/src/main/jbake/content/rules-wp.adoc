...
as required by the Eclipse Foundation TCK Licenses.												   
...
The compatibility requirements for Jakarta Platform, Enterprise Edition
Version 8 Web Profile consist of meeting the requirements set forth by the rules and
...
Technology Under Test, as distributed by the Eclipse Foundation, excluding
...
The Specifications for Jakarta EE 8 Web Profile are found on the Jakarta EE Platform Specification web

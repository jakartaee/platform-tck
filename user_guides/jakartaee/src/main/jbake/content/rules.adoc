type=page
status=published
title=Procedure for Jakarta Platform, Enterprise Edition 9.1 Certification
next=rules-wp.html
prev=intro.html
~~~~~~
Procedure for Jakarta Platform, Enterprise Edition 9.1 Certification
====================================================================

[[GBFSN]][[procedure-for-jakarta-platform-enterprise-edition-9.1-certification]]

2 Procedure for Jakarta Platform, Enterprise Edition 9.1 Certification
----------------------------------------------------------------------
...
The certification process for Jakarta EE 9.1 consists of the
...
The compatibility requirements for Jakarta EE 9.1 consist of meeting the
...
[[CJAFEGEH]][[rules-for-jakarta-platform-enterprise-edition-version-9.1-products]]
...
EE21 Compliance testing for Jakarta EE 9.1 consists of running Jakarta EE 9.1
...
[[CJAHFAJE]][[specifications-for-jakarta-platform-enterprise-edition-version-9.1]]

2.4 Specifications for Jakarta Platform, Enterprise Edition Version 9.1
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

The Specifications for Jakarta Platform, Enterprise Edition 9.1 are found on
the Eclipse Foundation, Jakarta EE Specifications web site at `https://jakarta.ee/specifications/platform/9.1/`. You may also find information available from the EE4J Jakarta EE Platform project page, at `https://projects.eclipse.org/projects/ee4j.jakartaee-platform`.

[[CJAHIGAB]][[libraries-for-jakarta-platform-enterprise-edition-version-9.1]]

2.5 Libraries for Jakarta Platform, Enterprise Edition Version 9.1
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

The following list constitutes the complete list of packages that are
required for Jakarta EE 9.1:

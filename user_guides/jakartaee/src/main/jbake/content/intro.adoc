...
* The following needs to be reviewed and possibly further refined to provide details consistent with
the JESP and describe the Eclipse Jakarta EE process
...
[NOTE]
====
Jakarta EE intends to support multiple compatible implementations. 
These instructions explain how to get started with the {TechnologyRI} CI.
As more CIs become available, these instructions will be extended.

...
The full list with specification version requirements is defined in the Platform EE Specification document (https://jakarta.ee/specifications/platform/10/), see the heading 'Full Jakarta™ EE Product Requirements,'
...
The following optional technologies may also br tested via the Jakarta EE Platform TCK:
...
Jakarta EE 10 Platform TCK provides certification verification of implementations contained in the Platform for the following component specifications:
...
The full list with specification version requirements is defined in the Web Profile specification document (https://jakarta.ee/specifications/webprofile/10/), see heading 'Web Profile Definition', sub-heading 'Required Components'.
...
Jakarta EE 10 Platform TCK provides certification verification of implementations contained in the platform, Web Profile for the following component specifications:

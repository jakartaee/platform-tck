...
The Jakarta EE 9.1 Platform TCK uses the JavaTest harness to execute the tests in the
...
* link:#GFADX[Jakarta EE 9.1 Platform TCK Operating Assumptions]
...
7.1 Jakarta EE 9.1 Platform TCK Operating Assumptions
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

The following are assumed in this chapter:

* Jakarta EE 9.1 CI is installed and configured as described in this guide.
...
machine.
* Jakarta EE 9.1 Platform TCK is installed and configured as described in this guide.
...
There are two general ways to run Jakarta EE 9.1 Platform TCK using the JavaTest
harness software:
...
targets for the Jakarta EE 9.1 Platform TCK test suite
...
Jakarta EE 9.1 Platform TCK is installed.
...
Jakarta EE 9.1 Platform TCK was installed.
...
===== Example 7-1 Running the Jakarta EE 9.1 Platform TCK Signature Tests

To run the Jakarta EE 9.1 Platform TCK signature tests, enter the following commands:
...
For example, you could run all Jakarta EE 9.1 tests with a status of failed
...
required by the Jakarta EE 9.1 platform specification. link:#BAGGCEJC[Table
...
|EJB CMP, BMP, entity beans |`entitybeans_optional` or `javaee_optional`
...
are not required by the Jakarta EE 9.1 Web Profile specification. For
example, if your server implements the Jakarta EE 9.1 Web Profile and the
...
optional test areas for the Jakarta EE 9.1 Web Profile.
...
|All CMP/BMP Entity Beans * |`entitybeans_optional`
...
against the Jakarta EE 9.1 CI, you must start the standalone deployment

...
===== Example 7-11 Running the Optional JAXR Tests With the Required Full Profile Tests

[source,oac_no_warn]
----
cd <TS_HOME>/src/com/sun/ts/tests
ant -Dkeywords="javaee | jaxr" runclient
----

The optional JAXR tests and the tests that are required by

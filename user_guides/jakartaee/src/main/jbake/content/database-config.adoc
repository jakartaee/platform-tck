...
link:config.html#GEWTQ[Configuring a Jakarta EE 8 Server]. The final step,
...
For each supported database type, the Jakarta EE 8 CTS includes a set of
...
In addition to the database-specific DML files, the Jakarta EE 8 CTS

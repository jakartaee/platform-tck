...
To build the Jakarta EE 8 CTS tests using Ant, complete the following
steps:
...
To run the Jakarta EE 8 CTS tests using Ant, use one of the following
procedures.
...
The Jakarta EE 8 CTS service tests test the compatibility of the Jakarta
...
Note that you must remove these properties before you run the Jakarta EE 8

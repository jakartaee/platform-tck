...
5.4.12 Jakarta Enterprise Beans 4.0 Test Setup
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
5.4.12.1 To Configure the Test Environment to Run the Jakarta Enterprise Beans 4.0 DataSource Tests
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
5.4.12.2 To Configure the Test Environment to Run the Jakarta Enterprise Beans 4.0 Stateful Timeout Tests
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
5.4.19 Jakarta Authorization Test Setup
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
5.4.20 Jakarta Batch Test Setup
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
5.4.21 WSDL: Webservice Test and Runtime Notes
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
5.4.21.1 WSDL ts.jte Properties
+++++++++++++++++++++++++++++++
...
5.4.21.2 Webservice Endpoint WSDL Elements
++++++++++++++++++++++++++++++++++++++++++
...
5.4.21.2.1 Setting Endpoint Address
...
5.4.21.2.2 Jakarta Enterprise Beans Endpoint Security
...
5.4.21.2.3 Transport Guarantee
...
5.4.21.2.4 Publishing Final WSDL During Deployment
...
5.4.21.3 Webservice Client WSDL Elements
++++++++++++++++++++++++++++++++++++++++
...
5.4.21.3.1 Resolving Container-Managed Ports
...
5.4.21.3.2 Setting Stub Properties
...
5.4.22 Jakarta Security API Test Setup
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
5.4.23.1 sigTestClasspath Property
++++++++++++++++++++++++++++++++++
...
5.4.23.2 Additional Signature Test Information
++++++++++++++++++++++++++++++++++++++++++++++
...
5.4.24.1 Setup Considerations for MySQL
+++++++++++++++++++++++++++++++++++++++
...
5.4.24.2 Setup Considerations for MS SQL Server
+++++++++++++++++++++++++++++++++++++++++++++++

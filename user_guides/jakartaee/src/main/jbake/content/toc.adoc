...
*** link:config.html#sthref24[5.4.18 Jakarta Batch Test Setup]
*** link:config.html#GEYAM[5.4.19 WSDL: Webservice Test and Runtime Notes]
*** link:config.html#CEGCHDEA[5.4.20 Jakarta Security API Test Setup]
*** link:config.html#GEYNX[5.4.21 Signature Test Setup]
*** link:config.html#GJLGQ[5.4.22 Backend Database Setup]

...
* link:rules.html#GCLJC[2.4 Reference Runtime for {TechnologyFullName}]
...
* link:config.html#GBFWG[4.4 Using the JavaTest Harness Configuration GUI]

** link:config.html#GBFVA[4.4.1 Configuration GUI Overview]

** link:config.html#GBFVD[4.4.2 Starting the Configuration GUI]

** link:config.html#GBFVX[4.4.3 To Configure the JavaTest Harness to Run the TCK Tests]

** link:config.html#GBFUU[4.4.4 Modifying the Default Test Configuration]

* link:config.html#GHGDG[4.5 The Configuration Interview]

* link:config.html#GCLJG[4.6 Special Set-Up Instructions]

** link:config.html#GCLJK[4.6.1 Running the {TechnologyShortName} on a Vendor's Implementation]

** link:config.html#GCLII[4.6.2 Instructions for Interoperability Test Scenarios]

type=page
status=published
title=Java API for XML Registries-Technology Compatibility Kit User's Guide
next=title.html
~~~~~~
...
* link:rules.html#GCLJK[2.4 Reference Implementation for {TechnologyFullName} {TechnologyVersion}]

* link:rules.html#CJAJECIE[2.5 Specifications for {TechnologyFullName}]

* link:rules.html#CJABAHGI[2.6 Libraries for {TechnologyFullName}]
...
* link:config.html#GBFVU[4.1 Modifying the ts_env and ts_env.bat Files]

* link:config.html#GCLHU[4.2 Modifying the ts.jte File]

* link:config.html#GBFWG[4.3 Using the JavaTest Harness Configuration GUI]

** link:config.html#GBFVA[4.3.1 Configuration GUI Overview]

** link:config.html#GBFVD[4.3.2 Starting the Configuration GUI]

** link:config.html#GBFVX[4.3.3 To Configure the JavaTest Harness to Run
the TCK Tests]

** link:config.html#GBFUU[4.3.4 Modifying the Default Test Configuration]

** link:config.html#GCLJG[4.3.5 Configuration Interview]

* link:config.html#GBFUY[4.4 Special Set-Up Instructions]

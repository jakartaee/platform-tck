type=page
status=published
title=Procedure for Jakarta Platform, Enterprise Edition 11.0 Certification
next=rules-wp.html
prev=intro.html
~~~~~~
...
[[GBFSN]][[procedure-for-jakarta-platform-enterprise-edition-11.0-certification]]

2 Procedure for Jakarta Platform, Enterprise Edition 11.0 Certification
-----------------------------------------------------------------------
...
* link:#CJACBJIB[Jakarta Platform, Enterprise Edition Version 11 Test
Appeals Process]
...
The certification process for Jakarta EE 11.0 consists of the
...
The compatibility requirements for Jakarta EE 11.0 consist of meeting the
...
[[CJAFEGEH]][[rules-for-jakarta-platform-enterprise-edition-version-11.0-products]]

2.2.2 Rules for Jakarta Platform, Enterprise Edition Version 11 Products
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
EE21 Compliance testing for Jakarta EE 11.0 consists of running Jakarta EE 11.0
...
Guide, Jakarta EE 11.0 implementations must also adhere to all of the
compatibility rules defined in the User's Guides of the aforementioned
TCKs.

EE21.1 If the Jakarta EE 11 implementation uses a runtime which has
already been validated by the Technology Compatibility Kit,
the Jakarta EE 11 implementation may use result of such validation
...
[[CJAHFAJE]][[specifications-for-jakarta-platform-enterprise-edition-version-11.0]]

2.4 Specifications for Jakarta Platform, Enterprise Edition Version 11.0
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
[[CJAHIGAB]][[libraries-for-jakarta-platform-enterprise-edition-version-11.0]]

2.5 Libraries for Jakarta Platform, Enterprise Edition Version 11.0
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

The following list constitutes the complete list of packages that are
required for Jakarta EE 11.0:

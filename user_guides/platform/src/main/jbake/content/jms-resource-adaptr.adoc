...
This appendix explains how to set up and configure a Jakarta EE 11 CI and
Jakarta EE 11 Platform TCK so a standalone Jakarta Messaging resource adapter can be tested.

This appendix covers the following topics:

* link:#CJGGIEEJ[Setting Up Your Environment]
* link:#CJGDJCEC[Configuring Jakarta EE 11 Platform TCK]
* link:#CJGFCJBA[Configuring a Jakarta EE 11 CI for the Standalone Jakarta Messaging
Resource Adapter]
...
Jakarta Messaging MDB and Resource Adapter Tests]
* link:#CJGCDGIG[Reconfiguring Jakarta EE 11 CI for Jakarta EE 11 Platform TCK After
...
Adapter using a Jakarta EE 11 CI, you must install the following
components:

* Java SE 8 or 11 software
* Jakarta EE 11 CI software such as Eclipse GlassFish 6.1
...
installed
* JAVAEE_HOME to the directory where the Jakarta EE 11 CI (Eclipse GlassFish 6.1) software has been
installed
* TS_HOME to the directory where the Jakarta EE 11 Platform TCK software has been
installed
...
standalone Jakarta Messaging Resource Adapter using the Jakarta EE 11 CI. The Jakarta Messaging Resource
...
your Jakarta EE 11 environment when the `config.vi` Ant task, which is
described in the next section, is invoked. For the Jakarta EE 11 CI Eclipse GlassFish 6.1, the
...
F.3 Configuring a Jakarta EE 11 CI for the Standalone Jakarta Messaging Resource Adapter
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

Invoke the config.vi Ant task to configure the Jakarta EE 11 CI, Eclipse GlassFish 6.1 for TCK 11
...
The config.vi Ant task executes scripts, which configure your Jakarta EE 11
...
Adapter (GenericJMSRA) for the Jakarta EE 11 CI. If you are using a
different Jakarta EE 11 environment, you will need to rewrite these scripts
...
(GenericJMSRA). If you are using a different Jakarta EE 11 environment, your
...
Jakarta EE 11 Platform TCK provides an Ant task that handles the restoration. Invoke
...
If you are using another Jakarta EE 11 environment, these runtime deployment
...
F.7 Reconfiguring Jakarta EE 11 CI for Jakarta EE 11 Platform TCK After Testing the Standalone Jakarta Messaging Resource Adapter
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

After you finish testing the standalone Jakarta Messaging Resource Adapter, you need
to reconfigure the Jakarta EE 11 CI before you can continue testing with
...
Resource Adapter for the Jakarta EE 11 CI
.  From the TS_HOME/bin directory, invoke the config.vi Ant task to
reconfigure the Jakarta EE 11 CI for Jakarta EE 11 Platform TCK: +
`ant config.vi`

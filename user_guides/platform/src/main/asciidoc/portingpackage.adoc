...
In addition to the Java-based deployment porting interfaces, Jakarta EE {tck_version}
...
The Ant-based deployment implementation for the Jakarta EE {tck_version} compatible implementation (CI) is under
...
targets are implemented for the Jakarta EE {tck_version} CI.
...
This implementation, which leverages the Jakarta EE {tck_version} CI implementation of

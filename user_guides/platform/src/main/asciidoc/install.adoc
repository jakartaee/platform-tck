...
This procedure is optional and requires an implementation that supports the full Jakarta EE Platform. See <<setup-and-configuration>> for complete configuration instructions.

...
* link:#GEUYK[About Jakarta EE {tck_version} Platform TCK]
* link:#GEVAD[Hardware Requirements]
* link:#GEVBB[Software Requirements]
* link:#GEVCL[Additional Jakarta EE {tck_version} Platform TCK Requirements]
* link:#GBFQW[Getting Started With the Jakarta EE {tck_version} Platform TCK Test Suite]
...
Enterprise Edition 11 Web Profile Certification,"] for Jakarta EE {tck_version} Web
Profile.
...
List for the Jakarta EE {tck_version} Platform TCK. The definition of required tests will change
...
1.2 About Jakarta EE {tck_version} Platform TCK
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
1.2.1 Jakarta EE {tck_version} Technologies Required for Jakarta EE {tck_version} Platform Compatibility
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
1.2.2 Jakarta EE {tck_version} Web Profile Technologies Tested With Jakarta EE {tck_version} Platform TCK
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
provides a definitive list of certification rules for Jakarta EE {tck_version} and Jakarta
EE {tck_version} Web Profile implementations.
...
1.5 Additional Jakarta EE {tck_version} Platform TCK Requirements
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
1.6 Getting Started With the Jakarta EE {tck_version} Platform TCK Test Suite
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

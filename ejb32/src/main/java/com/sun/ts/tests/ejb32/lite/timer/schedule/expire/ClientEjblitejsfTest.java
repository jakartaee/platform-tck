    ...
    static final String VEHICLE_ARCHIVE = "ejb32_lite_timer_schedule_expire_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb32/lite/timer/schedule/expire/beans.xml");
            if(warResURL != null) {
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb32/lite/timer/schedule/expire/faces-config.xml");
            if(warResURL != null) {

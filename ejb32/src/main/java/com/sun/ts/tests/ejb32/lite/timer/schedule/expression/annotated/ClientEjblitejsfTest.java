    ...
    static final String VEHICLE_ARCHIVE = "ejb32_lite_timer_schedule_expression_annotated_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb32/lite/timer/schedule/expression/annotated/beans.xml");
            if(warResURL != null) {
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb32/lite/timer/schedule/expression/annotated/faces-config.xml");
            if(warResURL != null) {

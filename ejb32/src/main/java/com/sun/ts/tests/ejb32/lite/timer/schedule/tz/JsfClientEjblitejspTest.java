    ...
    static final String VEHICLE_ARCHIVE = "ejb32_lite_timer_schedule_tz_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            if(warResURL != null) {
              ejb32_lite_timer_schedule_tz_ejblitejsp_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/ejb-jar.xml");
            }
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb32/lite/timer/schedule/tz/ejblitejsp.tld");
            if(warResURL != null) {

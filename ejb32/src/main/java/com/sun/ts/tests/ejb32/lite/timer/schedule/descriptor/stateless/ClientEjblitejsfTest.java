    ...
    static final String VEHICLE_ARCHIVE = "ejb32_lite_timer_schedule_descriptor_stateless_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb32/lite/timer/schedule/descriptor/stateless/beans.xml");
            if(warResURL != null) {
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb32/lite/timer/schedule/descriptor/stateless/ejb-jar.xml");
            if(warResURL != null) {
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb32/lite/timer/schedule/descriptor/stateless/faces-config.xml");
            if(warResURL != null) {

    ...
    static final String VEHICLE_ARCHIVE = "ejb32_lite_timer_timerconfig_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb32/lite/timer/timerconfig/beans.xml");
            if(warResURL != null) {
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb32/lite/timer/timerconfig/faces-config.xml");
            if(warResURL != null) {

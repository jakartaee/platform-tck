    ...
    static final String VEHICLE_ARCHIVE = "ejb32_lite_timer_schedule_auto_attr_singleton_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb32/lite/timer/schedule/auto/attr/singleton/beans.xml");
            if(warResURL != null) {
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb32/lite/timer/schedule/auto/attr/singleton/faces-config.xml");
            if(warResURL != null) {

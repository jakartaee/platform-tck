    ...
    static final String VEHICLE_ARCHIVE = "ejb32_lite_timer_interceptor_business_stateless_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb32/lite/timer/interceptor/business/stateless/beans.xml");
            if(warResURL != null) {
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb32/lite/timer/interceptor/business/stateless/faces-config.xml");
            if(warResURL != null) {

    ...
    static final String VEHICLE_ARCHIVE = "ejb32_lite_timer_basic_concurrency_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb32/lite/timer/basic/concurrency/beans.xml");
            if(warResURL != null) {
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb32/lite/timer/basic/concurrency/faces-config.xml");
            if(warResURL != null) {

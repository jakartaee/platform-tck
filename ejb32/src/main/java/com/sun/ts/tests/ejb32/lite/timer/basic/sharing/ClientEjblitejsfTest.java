    ...
    static final String VEHICLE_ARCHIVE = "ejb32_lite_timer_basic_sharing_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb32/lite/timer/basic/sharing/beans.xml");
            if(warResURL != null) {
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb32/lite/timer/basic/sharing/faces-config.xml");
            if(warResURL != null) {

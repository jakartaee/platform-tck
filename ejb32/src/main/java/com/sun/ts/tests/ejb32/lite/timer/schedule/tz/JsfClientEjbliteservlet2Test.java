    ...
    static final String VEHICLE_ARCHIVE = "ejb32_lite_timer_schedule_tz_ejbliteservlet2_vehicle";
        ...
        */
        ...
        // War
            ...
            if(warResURL != null) {
              ejb32_lite_timer_schedule_tz_ejbliteservlet2_vehicle_web.addAsWebResource(warResURL, "/EJBLiteServlet2Filter.java.txt");
            }
            ...
            if(warResURL != null) {
              ejb32_lite_timer_schedule_tz_ejbliteservlet2_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/ejbliteservlet2_vehicle_web.xml");
            }

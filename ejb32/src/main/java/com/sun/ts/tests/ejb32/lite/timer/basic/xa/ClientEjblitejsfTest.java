...
public class ClientEjblitejsfTest extends com.sun.ts.tests.ejb32.lite.timer.basic.xa.Client {
    static final String VEHICLE_ARCHIVE = "ejb32_lite_timer_basic_xa_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb32/lite/timer/basic/xa/beans.xml");
            if(warResURL != null) {
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb32/lite/timer/basic/xa/faces-config.xml");
            if(warResURL != null) {

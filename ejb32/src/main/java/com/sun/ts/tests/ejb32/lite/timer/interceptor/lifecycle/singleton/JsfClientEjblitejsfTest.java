    ...
    static final String VEHICLE_ARCHIVE = "ejb32_lite_timer_interceptor_lifecycle_singleton_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb32/lite/timer/interceptor/lifecycle/singleton/beans.xml");
            if(warResURL != null) {
              ejb32_lite_timer_interceptor_lifecycle_singleton_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/beans.xml");
            }
            ...
            if(warResURL != null) {
              ejb32_lite_timer_interceptor_lifecycle_singleton_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/ejb-jar.xml");
            }
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/common/vehicle/ejblitejsf/ejblitejsf_vehicle_web.xml");
            if(warResURL != null) {
              ejb32_lite_timer_interceptor_lifecycle_singleton_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/ejblitejsf_vehicle_web.xml");
            }
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb32/lite/timer/interceptor/lifecycle/singleton/faces-config.xml");
            if(warResURL != null) {
              ejb32_lite_timer_interceptor_lifecycle_singleton_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/faces-config.xml");
            }
            ...
            if(warResURL != null) {
              ejb32_lite_timer_interceptor_lifecycle_singleton_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/lib/ejb.jar");
            }

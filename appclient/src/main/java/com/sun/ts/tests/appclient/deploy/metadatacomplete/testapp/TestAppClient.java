...
public class TestAppClient extends EETest {
  ...
  public void testResourceLookup() throws Exception {
    try {
      Object mybean = nctx.lookup("java:module/mybean");
      logMsg("mybean" + mybean);
      if (null == mybean) {
        throw new Exception("lookup failed!");
      }
    } catch (Exception e) {
      throw new Exception("lookup failed: " + e, e);
    }
  }
   ...
   *
   */
  public void testResourceAnnotation() throws Exception {
    try {
      logMsg("bean" + bean);
      if (null != bean) {
        throw new Exception("ResourceAnnotation test failed!");
      }
    } catch (Exception e) {
      throw new Exception("ResourceAnnotation test failed: " + e, e);
    }
  }
  ...
  public void testMailSession() throws Exception {
    try {
      ...
      throw new Exception("MailSession test failed: " + e, e);
    }
  }
   ...
   *
   */
  public void testMailSessionDefinition() throws Exception {
    try {
      logMsg("session" + session);
      logMsg("mail.debug:" + session.getProperty("mail.debug"));
      if (null != session) {
        throw new Exception("MailSessionDefinition test failed!");
      }
    } catch (Exception e) {
      throw new Exception("MailSessionDefinition test failed: " + e, e);
    }
  }
   ...
   *
   */
  public void testEJBAnnotation() throws Exception {
    try {
      logMsg("datastore" + dataStore);
      if (null != dataStore) {
        throw new Exception("EJBAnnotation test failed!");
      }
    } catch (Exception e) {
   ...
   *
   */
  public void testDataSourceDefinitionAnnotation() throws Exception {
    try {
      Object dataSource = nctx.lookup("java:global/MyApp/MyDataSource");
      if (dataSource != null) {
        throw new Exception("DataSourceDefinition test failed!");
      }
    } catch (Exception e) {
      throw new Exception("DataSourceDefinition test failed: " + e, e);
    }
  }
   ...
   *
   */
  public void testJMSConnectionFactoryDefinitionAnnotation() throws Exception {
    try {
      Object connFactory = nctx
          .lookup("java:global/JSPMyTestConnectionFactory");
      logMsg("connFactory" + connFactory);
      if (connFactory != null) {
        throw new Exception("JMSConnectionFactoryDefinition test failed!");
      }
    } catch (Exception e) {
      throw new Exception("JMSConnectionFactoryDefinition test failed: " + e, e);
    }
  }
   ...
   *
   */
  public void testJMSDestinationDefinitionAnnotation() throws Exception {
    try {
      Object destination = nctx.lookup("java:app/jms/myappTopic");
      logMsg("destination" + destination);
      if (destination != null) {
        throw new Exception("JMSDestinationDefinition test failed!");
      }
    } catch (Exception e) {
      throw new Exception("JMSDestinationDefinition test failed: " + e, e);
    }
  }
   ...
   *
   */
  public void testConnectionFactoryDefinitionAnnotation() throws Exception {
    try {
      logMsg("testFac" + testFac);
      if (testFac != null) {
        throw new Exception("ConnectionFactoryDefinition test failed!");
      }
    } catch (Exception e) {
      throw new Exception("ConnectionFactoryDefinition test failed: " + e, e);
    }
  }
   ...
   *
   */
  public void testAdministeredObjectDefinitionAnnotation() throws Exception {
    try {
      logMsg("testQueue" + testQueue);
      if (testFac != null) {
        throw new Exception("AdministeredObjectDefinition test failed!");
      }
    } catch (Exception e) {
      throw new Exception("AdministeredObjectDefinition test failed: " + e, e);
    }
  }
   ...
   *
   */
  public void testPersistenceUnitDefinitionAnnotation() throws Exception {
    try {
      logMsg("emf" + emf);
      if (emf != null) {
        throw new Exception("PersistenceUnitDefinition test failed!");
      }
    } catch (Exception e) {
      throw new Exception("PersistenceUnitDefinition test failed: " + e, e);
    }
  }

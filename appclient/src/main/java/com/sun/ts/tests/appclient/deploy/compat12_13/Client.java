...
package com.sun.ts.tests.appclient.deploy.compat12_13;
...
public class Client extends EETest {
   ...
   */
  public void test12DD() throws Exception {
    ...
    try {
      ...
      if (!pass) {
        throw new Exception("appclient compat12_13 test failed!");
      }
    } catch (Exception e) {
      TestUtil.logErr("appclient compat12_13 test failed: " + e);
      throw new Exception("appclient compat12_13 test failed: ", e);
    } finally {
      try {
        if (null != bean) {

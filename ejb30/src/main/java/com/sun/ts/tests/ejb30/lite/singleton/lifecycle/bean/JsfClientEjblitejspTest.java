...
public class JsfClientEjblitejspTest extends com.sun.ts.tests.ejb30.lite.singleton.lifecycle.bean.JsfClient {
    static final String VEHICLE_ARCHIVE = "ejblite_singleton_lifecycle_bean_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/lite/singleton/lifecycle/bean/ejblitejsp.tld");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_singleton_lifecycle_bean_ejblitejsp_vehicle_web, JsfClient.class, warResURL);

...
import com.sun.ts.tests.ejb30.misc.datasource.twowars.Client;
import java.net.URL;
...
public class ClientTest extends com.sun.ts.tests.ejb30.misc.datasource.twowars.Client {
    /**
        ...
        ejb3_misc_datasource_twowars: 
        ejb3_misc_datasource_twowars_ejb: jar.sun-ejb-jar.xml
        ejb3_misc_datasource_twowars_web: 

        Found Descriptors:
        Ejb:

        /com/sun/ts/tests/ejb30/misc/datasource/twowars/ejb3_misc_datasource_twowars_ejb.jar.sun-ejb-jar.xml
        War:

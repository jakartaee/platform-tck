...
public class JsfClientEjbliteservletTest extends com.sun.ts.tests.ejb30.lite.singleton.lifecycle.bean.JsfClient {
    static final String VEHICLE_ARCHIVE = "ejblite_singleton_lifecycle_bean_ejbliteservlet_vehicle";
        ...
        */
        ...
        // War
           ...
           archiveProcessor.processWebArchive(ejblite_singleton_lifecycle_bean_ejbliteservlet_vehicle_web, JsfClient.class, warResURL);

...
public class ClientEjblitejspTest extends com.sun.ts.tests.ejb30.bb.async.stateless.metadata.Client {
    static final String VEHICLE_ARCHIVE = "ejbbb_async_stateless_metadata_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/bb/async/stateless/metadata/ejblitejsp.tld");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejbbb_async_stateless_metadata_ejblitejsp_vehicle_web, Client.class, warResURL);

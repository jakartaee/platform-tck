...
import com.sun.ts.tests.ejb30.lite.packaging.war.webinflib.JsfClient;
import java.net.URL;
...
public class JsfClientEjblitejsfTest extends com.sun.ts.tests.ejb30.lite.packaging.war.webinflib.JsfClient {
    static final String VEHICLE_ARCHIVE = "ejblite_packaging_war_webinflib_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            WebArchive ejblite_packaging_war_webinflib_ejblitejsf_vehicle_web = ShrinkWrap.create(WebArchive.class, "ejblite_packaging_war_webinflib_ejblitejsf_vehicle_web.war");
            // The class files
            ejblite_packaging_war_webinflib_ejblitejsf_vehicle_web.addClasses(
            ...
            if(warResURL != null) {
              ejblite_packaging_war_webinflib_ejblitejsf_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            ...
            if(warResURL != null) {
              ejblite_packaging_war_webinflib_ejblitejsf_vehicle_web.addAsWebInfResource(warResURL, "sun-web.xml");
            }
            ...
            // Any libraries added to the war
                ...
                ejblite_packaging_war_webinflib_ejblitejsf_vehicle_web.addAsLibrary(x1_lib);
                JavaArchive x2_lib = ShrinkWrap.create(JavaArchive.class, "2.jar");

                ejblite_packaging_war_webinflib_ejblitejsf_vehicle_web.addAsLibrary(x2_lib);


            // Web content
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/lite/packaging/war/webinflib/beans.xml");
            if(warResURL != null) {
              ejblite_packaging_war_webinflib_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/beans.xml");
            }
            ...
            if(warResURL != null) {
              ejblite_packaging_war_webinflib_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/ejblitejsf_vehicle_web.xml");
            }
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/lite/packaging/war/webinflib/faces-config.xml");
            if(warResURL != null) {
              ejblite_packaging_war_webinflib_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/faces-config.xml");
            }
            ...
            if(warResURL != null) {
              ejblite_packaging_war_webinflib_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/ejblitejsf_vehicle.xhtml");
            }

           // Call the archive processor
           archiveProcessor.processWebArchive(ejblite_packaging_war_webinflib_ejblitejsf_vehicle_web, JsfClient.class, warResURL);

        return ejblite_packaging_war_webinflib_ejblitejsf_vehicle_web;
        }

...
public class JsfClientEjbliteservletTest extends com.sun.ts.tests.ejb30.lite.async.stateful.metadata.JsfClient {
    static final String VEHICLE_ARCHIVE = "ejblite_async_stateful_metadata_ejbliteservlet_vehicle";
        ...
        */
        ...
        // War
           ...
           archiveProcessor.processWebArchive(ejblite_async_stateful_metadata_ejbliteservlet_vehicle_web, JsfClient.class, warResURL);

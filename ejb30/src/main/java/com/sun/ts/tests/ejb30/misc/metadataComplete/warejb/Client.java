...
public class Client extends AbstractUrlClient {
   ...
   * @test_Strategy:
   */
  public void annotationNotProcessedForWar() throws Exception {
   ...
   * @test_Strategy:
   */
  public void typeLevelAnnotationNotProcessedForWar() throws Exception {
   ...
   * @test_Strategy:
   */
  public void excludeDefaultIncludeClassInterceptor() throws Exception {
   ...
   * @test_Strategy:
   */
  public void excludeDefaulAndClassReinstateDefault() throws Exception {
   ...
   * @test_Strategy:
   */
  public void defaultAndMethodInterceptor() throws Exception {
   ...
   * @test_Strategy:
   */
  public void sameInterceptor3Times() throws Exception {
   ...
   * @test_Strategy:
   */
  public void sameInterceptorTwice() throws Exception {

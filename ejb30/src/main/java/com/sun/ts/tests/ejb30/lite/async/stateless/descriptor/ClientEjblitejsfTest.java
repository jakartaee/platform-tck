...
import com.sun.ts.tests.ejb30.lite.async.stateless.descriptor.Client;
import java.net.URL;
...
public class ClientEjblitejsfTest extends com.sun.ts.tests.ejb30.lite.async.stateless.descriptor.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_async_stateless_descriptor_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            WebArchive ejblite_async_stateless_descriptor_ejblitejsf_vehicle_web = ShrinkWrap.create(WebArchive.class, "ejblite_async_stateless_descriptor_ejblitejsf_vehicle_web.war");
            // The class files
            ejblite_async_stateless_descriptor_ejblitejsf_vehicle_web.addClasses(
            ...
            if(warResURL != null) {
              ejblite_async_stateless_descriptor_ejblitejsf_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            ...
            if(warResURL != null) {
              ejblite_async_stateless_descriptor_ejblitejsf_vehicle_web.addAsWebInfResource(warResURL, "sun-web.xml");
            }

            // Any libraries added to the war

            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/async/stateless/descriptor/beans.xml");
            if(warResURL != null) {
              ejblite_async_stateless_descriptor_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/beans.xml");
            }
            warResURL = Client.class.getResource("/com/sun/ts/tests/common/vehicle/ejblitejsf/beans.xml");
            if(warResURL != null) {
              ejblite_async_stateless_descriptor_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/beans.xml");
            }
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/async/stateless/descriptor/ejb-jar.xml");
            if(warResURL != null) {
              ejblite_async_stateless_descriptor_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/ejb-jar.xml");
            }
            warResURL = Client.class.getResource("/com/sun/ts/tests/common/vehicle/ejblitejsf/ejblitejsf_vehicle_web.xml");
            if(warResURL != null) {
              ejblite_async_stateless_descriptor_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/ejblitejsf_vehicle_web.xml");
            }
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/async/stateless/descriptor/faces-config.xml");
            if(warResURL != null) {
              ejblite_async_stateless_descriptor_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/faces-config.xml");
            }
            ...
            if(warResURL != null) {
              ejblite_async_stateless_descriptor_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/ejblitejsf_vehicle.xhtml");
            }

           // Call the archive processor
           archiveProcessor.processWebArchive(ejblite_async_stateless_descriptor_ejblitejsf_vehicle_web, Client.class, warResURL);

        return ejblite_async_stateless_descriptor_ejblitejsf_vehicle_web;
        }

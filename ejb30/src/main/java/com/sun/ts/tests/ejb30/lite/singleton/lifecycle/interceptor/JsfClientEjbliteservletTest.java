...
import com.sun.ts.tests.ejb30.lite.singleton.lifecycle.interceptor.JsfClient;
import java.net.URL;
...
public class JsfClientEjbliteservletTest extends com.sun.ts.tests.ejb30.lite.singleton.lifecycle.interceptor.JsfClient {
    static final String VEHICLE_ARCHIVE = "ejblite_singleton_lifecycle_interceptor_ejbliteservlet_vehicle";
        ...
        */
        ...
        // War
            ...
            WebArchive ejblite_singleton_lifecycle_interceptor_ejbliteservlet_vehicle_web = ShrinkWrap.create(WebArchive.class, "ejblite_singleton_lifecycle_interceptor_ejbliteservlet_vehicle_web.war");
            // The class files
            ejblite_singleton_lifecycle_interceptor_ejbliteservlet_vehicle_web.addClasses(
            ...
            com.sun.ts.tests.ejb30.lite.singleton.lifecycle.interceptor.EJBLiteServletVehicle.class,
            ...
            ejblite_singleton_lifecycle_interceptor_ejbliteservlet_vehicle_web.addClass("com.sun.ts.tests.ejb30.lite.singleton.lifecycle.interceptor.Client$1.class");
            ejblite_singleton_lifecycle_interceptor_ejbliteservlet_vehicle_web.addClass("com.sun.ts.tests.ejb30.lite.singleton.lifecycle.interceptor.JsfClient$1.class");

            // The web.xml descriptor
            URL warResURL = JsfClient.class.getResource("ejbliteservlet_vehicle_web.xml");
            if(warResURL != null) {
              ejblite_singleton_lifecycle_interceptor_ejbliteservlet_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = JsfClient.class.getResource("/ejbliteservlet_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
              ejblite_singleton_lifecycle_interceptor_ejbliteservlet_vehicle_web.addAsWebInfResource(warResURL, "sun-web.xml");
            }
            ...
            if(warResURL != null) {
              ejblite_singleton_lifecycle_interceptor_ejbliteservlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/ejb-jar.xml");
            }
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/common/vehicle/ejbliteservlet/ejbliteservlet_vehicle_web.xml");
            if(warResURL != null) {
              ejblite_singleton_lifecycle_interceptor_ejbliteservlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/ejbliteservlet_vehicle_web.xml");
            }

           // Call the archive processor
           archiveProcessor.processWebArchive(ejblite_singleton_lifecycle_interceptor_ejbliteservlet_vehicle_web, JsfClient.class, warResURL);

        return ejblite_singleton_lifecycle_interceptor_ejbliteservlet_vehicle_web;
        }

...
public class ClientEjbliteservletTest extends com.sun.ts.tests.ejb30.lite.ejbcontext.stateless.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_ejbcontext_ejbliteservlet_vehicle";
        ...
        */
        ...
        // War
           ...
           archiveProcessor.processWebArchive(ejblite_ejbcontext_ejbliteservlet_vehicle_web, Client.class, warResURL);

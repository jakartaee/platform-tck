...
public class JsfClientEjbliteservlet2Test extends com.sun.ts.tests.ejb30.lite.singleton.concurrency.bean.JsfClient {
    static final String VEHICLE_ARCHIVE = "ejblite_singleton_concurrency_bean_ejbliteservlet2_vehicle";
        ...
        */
        ...
        // War
            ...
            WebArchive ejblite_singleton_concurrency_bean_ejbliteservlet2_vehicle_web = ShrinkWrap.create(WebArchive.class, "ejblite_singleton_concurrency_bean_ejbliteservlet2_vehicle_web.war");
            // The class files
            ejblite_singleton_concurrency_bean_ejbliteservlet2_vehicle_web.addClasses(
            ...
            com.sun.ts.tests.ejb30.lite.singleton.concurrency.bean.EJBLiteServlet2Filter.class,
            ...
            ejblite_singleton_concurrency_bean_ejbliteservlet2_vehicle_web.addClass("com.sun.ts.tests.ejb30.lite.singleton.concurrency.common.ClientBase$1.class");
            ejblite_singleton_concurrency_bean_ejbliteservlet2_vehicle_web.addClass("com.sun.ts.tests.ejb30.lite.singleton.concurrency.common.JsfClientBase$1.class");

            // The web.xml descriptor
            URL warResURL = JsfClient.class.getResource("ejbliteservlet2_vehicle_web.xml");
            if(warResURL != null) {
              ejblite_singleton_concurrency_bean_ejbliteservlet2_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = JsfClient.class.getResource("/ejbliteservlet2_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
              ejblite_singleton_concurrency_bean_ejbliteservlet2_vehicle_web.addAsWebInfResource(warResURL, "sun-web.xml");
            }
            ...
            if(warResURL != null) {
              ejblite_singleton_concurrency_bean_ejbliteservlet2_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/ejbliteservlet2_vehicle_web.xml");
            }
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/common/vehicle/ejbliteservlet2/ejbliteservlet2_vehicle.jsp");
            if(warResURL != null) {
              ejblite_singleton_concurrency_bean_ejbliteservlet2_vehicle_web.addAsWebResource(warResURL, "/ejbliteservlet2_vehicle.jsp");
            }

           // Call the archive processor
           archiveProcessor.processWebArchive(ejblite_singleton_concurrency_bean_ejbliteservlet2_vehicle_web, JsfClient.class, warResURL);

        return ejblite_singleton_concurrency_bean_ejbliteservlet2_vehicle_web;
        }

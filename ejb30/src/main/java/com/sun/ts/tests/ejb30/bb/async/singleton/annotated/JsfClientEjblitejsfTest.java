...
public class JsfClientEjblitejsfTest extends com.sun.ts.tests.ejb30.bb.async.singleton.annotated.JsfClient {
    static final String VEHICLE_ARCHIVE = "ejbbb_async_singleton_annotated_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            WebArchive ejbbb_async_singleton_annotated_ejblitejsf_vehicle_web = ShrinkWrap.create(WebArchive.class, "ejbbb_async_singleton_annotated_ejblitejsf_vehicle_web.war");
            // The class files
            ...
            ejbbb_async_singleton_annotated_ejblitejsf_vehicle_web.addClass("com.sun.ts.tests.ejb30.bb.async.common.annotated.AsyncAnnotatedMethodsBeanBase$1.class");

            // The web.xml descriptor
            URL warResURL = JsfClient.class.getResource("/com/sun/ts/tests/common/vehicle/ejblitejsf/ejblitejsf_vehicle_web.xml");
            if(warResURL != null) {
              ejbbb_async_singleton_annotated_ejblitejsf_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            ...
            if(warResURL != null) {
              ejbbb_async_singleton_annotated_ejblitejsf_vehicle_web.addAsWebInfResource(warResURL, "sun-web.xml");
            }

            // Any libraries added to the war

            // Web content
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/bb/async/singleton/annotated/beans.xml");
            if(warResURL != null) {
              ejbbb_async_singleton_annotated_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/beans.xml");
            }
            ...
            if(warResURL != null) {
              ejbbb_async_singleton_annotated_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/ejblitejsf_vehicle_web.xml");
            }
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/bb/async/singleton/annotated/faces-config.xml");
            if(warResURL != null) {
              ejbbb_async_singleton_annotated_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/faces-config.xml");
            }
            ...
            if(warResURL != null) {
              ejbbb_async_singleton_annotated_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/ejblitejsf_vehicle.xhtml");
            }

           // Call the archive processor
           archiveProcessor.processWebArchive(ejbbb_async_singleton_annotated_ejblitejsf_vehicle_web, JsfClient.class, warResURL);

        return ejbbb_async_singleton_annotated_ejblitejsf_vehicle_web;
        }

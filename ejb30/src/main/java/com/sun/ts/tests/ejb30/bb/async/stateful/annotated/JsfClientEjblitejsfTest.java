...
import com.sun.ts.tests.ejb30.bb.async.stateful.annotated.JsfClient;
import java.net.URL;
...
public class JsfClientEjblitejsfTest extends com.sun.ts.tests.ejb30.bb.async.stateful.annotated.JsfClient {
    static final String VEHICLE_ARCHIVE = "ejbbb_async_stateful_annotated_ejblitejsf_vehicle";

        /**
        EE10 Deployment Descriptors:
        ejbbb_async_stateful_annotated_ejblitejsf_vehicle_web: WEB-INF/beans.xml,WEB-INF/faces-config.xml,WEB-INF/web.xml,war.sun-ejb-jar.xml
        ejbbb_async_stateful_annotated_ejblitejsp_vehicle_web: war.sun-ejb-jar.xml
        ejbbb_async_stateful_annotated_ejbliteservlet_vehicle_web: WEB-INF/web.xml,war.sun-ejb-jar.xml
        ejbbb_async_stateful_annotated_ejbliteservlet2_vehicle_web: WEB-INF/web.xml,war.sun-ejb-jar.xml
        ...
        */
        ...
        // War
            ...
            WebArchive ejbbb_async_stateful_annotated_ejblitejsf_vehicle_web = ShrinkWrap.create(WebArchive.class, "ejbbb_async_stateful_annotated_ejblitejsf_vehicle_web.war");
            // The class files
            ejbbb_async_stateful_annotated_ejblitejsf_vehicle_web.addClasses(
            com.sun.ts.tests.ejb30.common.helper.TestFailedException.class,
            com.sun.ts.tests.ejb30.bb.async.stateful.annotated.JsfClient.class,
            com.sun.ts.lib.harness.EETest.Fault.class,
            com.sun.ts.tests.ejb30.bb.async.common.annotated.AsyncIF.class,
            com.sun.ts.tests.ejb30.bb.async.stateful.annotated.StatefulAsyncIF.class,
            ...
            com.sun.ts.tests.ejb30.bb.async.stateful.annotated.StatefulAsyncRemoteIF.class,
            com.sun.ts.tests.ejb30.common.helper.Helper.class,
            com.sun.ts.tests.ejb30.common.lite.EJBLiteClientBase.class,
            com.sun.ts.tests.ejb30.bb.async.common.annotated.Async2RemoteIF.class,
            com.sun.ts.lib.harness.EETest.class,
            com.sun.ts.tests.ejb30.bb.async.stateful.annotated.StatefulAsync2RemoteIF.class,
            ...
            com.sun.ts.tests.ejb30.bb.async.stateful.annotated.StatefulAsync2IF.class,
            com.sun.ts.tests.ejb30.bb.async.common.annotated.AsyncBeanBase.class,
            com.sun.ts.tests.ejb30.bb.async.stateful.annotated.AsyncBean.class,
            com.sun.ts.tests.ejb30.common.lite.NumberIF.class,
            com.sun.ts.tests.common.vehicle.ejbliteshare.EJBLiteClientIF.class,
            com.sun.ts.tests.common.vehicle.VehicleRunnerFactory.class,
            com.sun.ts.tests.ejb30.bb.async.common.AsyncJsfClientBase.class,
            com.sun.ts.tests.ejb30.bb.async.stateful.annotated.AsyncAnnotatedMethodsBean.class,
            ...
            com.sun.ts.tests.ejb30.bb.async.stateful.annotated.Async2Bean.class,
            com.sun.ts.tests.ejb30.bb.async.stateful.annotated.HttpServletDelegate.class,
            com.sun.ts.tests.ejb30.bb.async.stateful.annotated.Client.class,
            ...
            ejbbb_async_stateful_annotated_ejblitejsf_vehicle_web.addClass("com.sun.ts.tests.ejb30.bb.async.common.annotated.AsyncAnnotatedMethodsBeanBase$1.class");

            // The web.xml descriptor
            URL warResURL = JsfClient.class.getResource("/com/sun/ts/tests/common/vehicle/ejblitejsf/ejblitejsf_vehicle_web.xml");
            if(warResURL != null) {
              ejbbb_async_stateful_annotated_ejblitejsf_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            ...
            if(warResURL != null) {
              ejbbb_async_stateful_annotated_ejblitejsf_vehicle_web.addAsWebInfResource(warResURL, "sun-web.xml");
            }

            // Any libraries added to the war

            // Web content
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/bb/async/stateful/annotated/beans.xml");
            if(warResURL != null) {
              ejbbb_async_stateful_annotated_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/beans.xml");
            }
            ...
            if(warResURL != null) {
              ejbbb_async_stateful_annotated_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/ejblitejsf_vehicle_web.xml");
            }
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/bb/async/stateful/annotated/faces-config.xml");
            if(warResURL != null) {
              ejbbb_async_stateful_annotated_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/faces-config.xml");
            }
            ...
            if(warResURL != null) {
              ejbbb_async_stateful_annotated_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/ejblitejsf_vehicle.xhtml");
            }

           // Call the archive processor
           archiveProcessor.processWebArchive(ejbbb_async_stateful_annotated_ejblitejsf_vehicle_web, JsfClient.class, warResURL);

        return ejbbb_async_stateful_annotated_ejblitejsf_vehicle_web;
        }
        ...
        @Override
        @TargetVehicle("ejblitejsf")
        public void addReturnConcurrent() throws java.lang.InterruptedException, java.util.concurrent.ExecutionException {
            super.addReturnConcurrent();
        }

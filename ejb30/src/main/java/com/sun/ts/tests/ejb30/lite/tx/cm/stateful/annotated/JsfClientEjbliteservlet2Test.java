...
public class JsfClientEjbliteservlet2Test extends com.sun.ts.tests.ejb30.lite.tx.cm.stateful.annotated.JsfClient {
    static final String VEHICLE_ARCHIVE = "ejblite_tx_cm_stateful_annotated_ejbliteservlet2_vehicle";
        ...
        */
        ...
        // War
            ...
            WebArchive ejblite_tx_cm_stateful_annotated_ejbliteservlet2_vehicle_web = ShrinkWrap.create(WebArchive.class, "ejblite_tx_cm_stateful_annotated_ejbliteservlet2_vehicle_web.war");
            // The class files
            ejblite_tx_cm_stateful_annotated_ejbliteservlet2_vehicle_web.addClasses(
            ...
            com.sun.ts.tests.ejb30.lite.tx.cm.stateful.annotated.EJBLiteServlet2Filter.class,
            com.sun.ts.lib.harness.EETest.SetupException.class
            );
            // The web.xml descriptor
            URL warResURL = JsfClient.class.getResource("ejbliteservlet2_vehicle_web.xml");
            if(warResURL != null) {
              ejblite_tx_cm_stateful_annotated_ejbliteservlet2_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = JsfClient.class.getResource("/ejbliteservlet2_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
              ejblite_tx_cm_stateful_annotated_ejbliteservlet2_vehicle_web.addAsWebInfResource(warResURL, "sun-web.xml");
            }
            ...
            if(warResURL != null) {
              ejblite_tx_cm_stateful_annotated_ejbliteservlet2_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/ejbliteservlet2_vehicle_web.xml");
            }
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/common/vehicle/ejbliteservlet2/ejbliteservlet2_vehicle.jsp");
            if(warResURL != null) {
              ejblite_tx_cm_stateful_annotated_ejbliteservlet2_vehicle_web.addAsWebResource(warResURL, "/ejbliteservlet2_vehicle.jsp");
            }

           // Call the archive processor
           archiveProcessor.processWebArchive(ejblite_tx_cm_stateful_annotated_ejbliteservlet2_vehicle_web, JsfClient.class, warResURL);

        return ejblite_tx_cm_stateful_annotated_ejbliteservlet2_vehicle_web;
        }

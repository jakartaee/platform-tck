...
public class JsfClientEjblitejsfTest extends com.sun.ts.tests.ejb30.bb.async.stateless.metadata.JsfClient {
    static final String VEHICLE_ARCHIVE = "ejbbb_async_stateless_metadata_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            ejbbb_async_stateless_metadata_ejblitejsf_vehicle_web.addClass("com.sun.ts.tests.ejb30.bb.async.common.metadata.BeanClassLevel2BeanBase$1.class");
            ...
            // Web content
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/bb/async/stateless/metadata/beans.xml");
            if(warResURL != null) {
            ...
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/bb/async/stateless/metadata/faces-config.xml");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejbbb_async_stateless_metadata_ejblitejsf_vehicle_web, JsfClient.class, warResURL);

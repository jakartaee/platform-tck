...
public class Client extends AbstractUrlClient {
   ...
   * servlet
   */
  public void globalJNDI() throws Exception {
   ...
   */
  public void globalJNDI2() throws Exception {
   ...
   * servlet
   */
  public void appJNDI() throws Exception {
   ...
   */
  public void appJNDI2() throws Exception {
   ...
   * servlet
   */
  public void moduleJNDI() throws Exception {
   ...
   */
  public void moduleJNDI2() throws Exception {
   ...
   * @test_Strategy:
   */
  public void appNameModuleName() throws Exception {
    TEST_PROPS.setProperty(APITEST, "appNameModuleName");
    TEST_PROPS.setProperty(REQUEST_HEADERS, APP_MODULE_NAME_HEADER);
    invoke();
  }
}

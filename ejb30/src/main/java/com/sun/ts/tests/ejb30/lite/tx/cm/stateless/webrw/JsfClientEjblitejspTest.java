...
import com.sun.ts.tests.ejb30.lite.tx.cm.stateless.webrw.JsfClient;
import java.net.URL;
...
public class JsfClientEjblitejspTest extends com.sun.ts.tests.ejb30.lite.tx.cm.stateless.webrw.JsfClient {
    static final String VEHICLE_ARCHIVE = "ejblite_tx_cm_stateless_webrw_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/lite/tx/cm/stateless/webrw/ejblitejsp.tld");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_tx_cm_stateless_webrw_ejblitejsp_vehicle_web, JsfClient.class, warResURL);

...
import com.sun.ts.tests.ejb30.lite.tx.cm.stateful.sessionsync.Client;
import java.net.URL;
...
public class ClientEjblitejspTest extends com.sun.ts.tests.ejb30.lite.tx.cm.stateful.sessionsync.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_tx_cm_stateful_sessionsync_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/tx/cm/stateful/sessionsync/ejblitejsp.tld");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_tx_cm_stateful_sessionsync_ejblitejsp_vehicle_web, Client.class, warResURL);

...
import com.sun.ts.tests.ejb30.misc.getresource.warejb.Client;
import java.net.URL;
...
public class ClientTest extends com.sun.ts.tests.ejb30.misc.getresource.warejb.Client {
    /**
        ...
        misc_getresource_warejb: 
        misc_getresource_warejb_ejb: jar.sun-ejb-jar.xml
        misc_getresource_warejb_web: 

        Found Descriptors:
        Ejb:

        /com/sun/ts/tests/ejb30/misc/getresource/warejb/misc_getresource_warejb_ejb.jar.sun-ejb-jar.xml
        War:

...
public class ClientTest extends com.sun.ts.tests.ejb30.misc.nomethodbean.Client {
    /**
        ...
        ejb3_misc_nomethodbean: 
        ejb3_misc_nomethodbean_ejb: jar.sun-ejb-jar.xml
        ejb3_misc_nomethodbean_web: 

        Found Descriptors:
        Ejb:

        /com/sun/ts/tests/ejb30/misc/nomethodbean/ejb3_misc_nomethodbean_ejb.jar.sun-ejb-jar.xml
        War:
        ...
        */
        ...
        // War
            ...
            URL warResURL = Client.class.getResource("com/sun/ts/tests/ejb30/misc/nomethodbean/ejb3_misc_nomethodbean_web.xml");
            if(warResURL != null) {
              ejb3_misc_nomethodbean_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/misc/nomethodbean/ejb3_misc_nomethodbean_web.war.sun-web.xml");
            if(warResURL != null) {
              ejb3_misc_nomethodbean_web.addAsWebInfResource(warResURL, "sun-web.xml");
            }
           ...
           archiveProcessor.processWebArchive(ejb3_misc_nomethodbean_web, Client.class, warResURL);
        ...
        // Ejb
            ...
            URL ejbResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/misc/nomethodbean/ejb3_misc_nomethodbean_ejb.xml");
            if(ejbResURL != null) {
              ejb3_misc_nomethodbean_ejb.addAsManifestResource(ejbResURL, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/misc/nomethodbean/ejb3_misc_nomethodbean_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL != null) {
        ...
        // Ear
            ...
            URL earResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/misc/nomethodbean/");
            if(earResURL != null) {
              ejb3_misc_nomethodbean_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/misc/nomethodbean/.ear.sun-application.xml");
            if(earResURL != null) {
              ejb3_misc_nomethodbean_ear.addAsManifestResource(earResURL, "sun-application.xml");
            }
            // Call the archive processor

...
import com.sun.ts.tests.ejb30.lite.async.singleton.metadata.Client;
import java.net.URL;
...
public class ClientEjblitejsfTest extends com.sun.ts.tests.ejb30.lite.async.singleton.metadata.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_async_singleton_metadata_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            WebArchive ejblite_async_singleton_metadata_ejblitejsf_vehicle_web = ShrinkWrap.create(WebArchive.class, "ejblite_async_singleton_metadata_ejblitejsf_vehicle_web.war");
            // The class files
            ejblite_async_singleton_metadata_ejblitejsf_vehicle_web.addClasses(
            ...
            if(warResURL != null) {
              ejblite_async_singleton_metadata_ejblitejsf_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            ...
            if(warResURL != null) {
              ejblite_async_singleton_metadata_ejblitejsf_vehicle_web.addAsWebInfResource(warResURL, "sun-web.xml");
            }

            // Any libraries added to the war

            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/async/singleton/metadata/beans.xml");
            if(warResURL != null) {
              ejblite_async_singleton_metadata_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/beans.xml");
            }
            ...
            if(warResURL != null) {
              ejblite_async_singleton_metadata_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/ejblitejsf_vehicle_web.xml");
            }
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/async/singleton/metadata/faces-config.xml");
            if(warResURL != null) {
              ejblite_async_singleton_metadata_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/faces-config.xml");
            }
            ...
            if(warResURL != null) {
              ejblite_async_singleton_metadata_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/ejblitejsf_vehicle.xhtml");
            }

           // Call the archive processor
           archiveProcessor.processWebArchive(ejblite_async_singleton_metadata_ejblitejsf_vehicle_web, Client.class, warResURL);

        return ejblite_async_singleton_metadata_ejblitejsf_vehicle_web;
        }

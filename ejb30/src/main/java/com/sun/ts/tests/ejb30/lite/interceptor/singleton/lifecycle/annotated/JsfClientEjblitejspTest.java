...
public class JsfClientEjblitejspTest extends com.sun.ts.tests.ejb30.lite.interceptor.singleton.lifecycle.annotated.JsfClient {
    static final String VEHICLE_ARCHIVE = "ejblite_interceptor_singleton_lifecycle_annotated_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            if(warResURL != null) {
              ejblite_interceptor_singleton_lifecycle_annotated_ejblitejsp_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = JsfClient.class.getResource("//vehicle/ejblitejsp/ejblitejsp_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
              ejblite_interceptor_singleton_lifecycle_annotated_ejblitejsp_vehicle_web.addAsWebInfResource(warResURL, "sun-web.xml");
            }
            ...
            if(warResURL != null) {
              ejblite_interceptor_singleton_lifecycle_annotated_ejblitejsp_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/ejb-jar.xml");
            }
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/lite/interceptor/singleton/lifecycle/annotated/ejblitejsp.tld");
            if(warResURL != null) {
              ejblite_interceptor_singleton_lifecycle_annotated_ejblitejsp_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/tlds/ejblitejsp.tld");
            }
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/common/vehicle/ejblitejsp/ejblitejsp.tld");
            if(warResURL != null) {
              ejblite_interceptor_singleton_lifecycle_annotated_ejblitejsp_vehicle_web.addAsWebResource(warResURL, "/ejblitejsp.tld");
            }
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/common/vehicle/ejblitejsp/ejblitejsp_vehicle.jsp");
            if(warResURL != null) {
              ejblite_interceptor_singleton_lifecycle_annotated_ejblitejsp_vehicle_web.addAsWebResource(warResURL, "/ejblitejsp_vehicle.jsp");
            }

           // Call the archive processor
           archiveProcessor.processWebArchive(ejblite_interceptor_singleton_lifecycle_annotated_ejblitejsp_vehicle_web, JsfClient.class, warResURL);

        return ejblite_interceptor_singleton_lifecycle_annotated_ejblitejsp_vehicle_web;
        }

...
import com.sun.ts.tests.ejb30.bb.session.stateful.concurrency.metadata.annotated.Client;
import java.net.URL;
...
public class ClientEjblitejspTest extends com.sun.ts.tests.ejb30.bb.session.stateful.concurrency.metadata.annotated.Client {
    static final String VEHICLE_ARCHIVE = "bb_stateful_concurrency_metadata_annotated_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            WebArchive bb_stateful_concurrency_metadata_annotated_ejblitejsp_vehicle_web = ShrinkWrap.create(WebArchive.class, "bb_stateful_concurrency_metadata_annotated_ejblitejsp_vehicle_web.war");
            // The class files
            bb_stateful_concurrency_metadata_annotated_ejblitejsp_vehicle_web.addClasses(
            ...
            com.sun.ts.tests.ejb30.bb.session.stateful.concurrency.metadata.annotated.EJBLiteJSPTag.class
            );
            // The web.xml descriptor
            URL warResURL = Client.class.getResource("/vehicle/ejblitejsp/ejblitejsp_vehicle_web.xml");
            if(warResURL != null) {
              bb_stateful_concurrency_metadata_annotated_ejblitejsp_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = Client.class.getResource("//vehicle/ejblitejsp/ejblitejsp_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
              bb_stateful_concurrency_metadata_annotated_ejblitejsp_vehicle_web.addAsWebInfResource(warResURL, "sun-web.xml");
            }

            // Any libraries added to the war

            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/bb/session/stateful/concurrency/metadata/annotated/ejblitejsp.tld");
            if(warResURL != null) {
              bb_stateful_concurrency_metadata_annotated_ejblitejsp_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/tlds/ejblitejsp.tld");
            }
            warResURL = Client.class.getResource("/com/sun/ts/tests/common/vehicle/ejblitejsp/ejblitejsp.tld");
            if(warResURL != null) {
              bb_stateful_concurrency_metadata_annotated_ejblitejsp_vehicle_web.addAsWebResource(warResURL, "/ejblitejsp.tld");
            }
            warResURL = Client.class.getResource("/com/sun/ts/tests/common/vehicle/ejblitejsp/ejblitejsp_vehicle.jsp");
            if(warResURL != null) {
              bb_stateful_concurrency_metadata_annotated_ejblitejsp_vehicle_web.addAsWebResource(warResURL, "/ejblitejsp_vehicle.jsp");
            }

           // Call the archive processor
           archiveProcessor.processWebArchive(bb_stateful_concurrency_metadata_annotated_ejblitejsp_vehicle_web, Client.class, warResURL);

        return bb_stateful_concurrency_metadata_annotated_ejblitejsp_vehicle_web;
        }

...
import com.sun.ts.tests.ejb30.bb.async.stateful.metadata.Client;
import java.net.URL;
...
public class ClientEjblitejsfTest extends com.sun.ts.tests.ejb30.bb.async.stateful.metadata.Client {
    static final String VEHICLE_ARCHIVE = "ejbbb_async_stateful_metadata_ejblitejsf_vehicle";

        /**
        EE10 Deployment Descriptors:
        ejbbb_async_stateful_metadata_ejblitejsf_vehicle_web: WEB-INF/beans.xml,WEB-INF/faces-config.xml,WEB-INF/web.xml,war.sun-ejb-jar.xml
        ejbbb_async_stateful_metadata_ejblitejsp_vehicle_web: war.sun-ejb-jar.xml
        ejbbb_async_stateful_metadata_ejbliteservlet_vehicle_web: WEB-INF/web.xml,war.sun-ejb-jar.xml
        ejbbb_async_stateful_metadata_ejbliteservlet2_vehicle_web: WEB-INF/web.xml,war.sun-ejb-jar.xml
        ...
        */
        ...
        // War
            ...
            WebArchive ejbbb_async_stateful_metadata_ejblitejsf_vehicle_web = ShrinkWrap.create(WebArchive.class, "ejbbb_async_stateful_metadata_ejblitejsf_vehicle_web.war");
            // The class files
            ejbbb_async_stateful_metadata_ejblitejsf_vehicle_web.addClasses(
            ...
            com.sun.ts.tests.ejb30.bb.async.stateful.metadata.HttpServletDelegate.class,
            ...
            com.sun.ts.tests.ejb30.bb.async.stateful.metadata.JsfClient.class,
            com.sun.ts.tests.common.vehicle.VehicleRunnerFactory.class,
            com.sun.ts.tests.ejb30.bb.async.stateful.metadata.BeanClassLevelBean.class,
            ...
            com.sun.ts.tests.ejb30.bb.async.stateful.metadata.Client.class,
            ...
            ejbbb_async_stateful_metadata_ejblitejsf_vehicle_web.addClass("com.sun.ts.tests.ejb30.bb.async.common.metadata.BeanClassLevel2BeanBase$1.class");

            // The web.xml descriptor
            URL warResURL = Client.class.getResource("/com/sun/ts/tests/common/vehicle/ejblitejsf/ejblitejsf_vehicle_web.xml");
            if(warResURL != null) {
              ejbbb_async_stateful_metadata_ejblitejsf_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            ...
            if(warResURL != null) {
              ejbbb_async_stateful_metadata_ejblitejsf_vehicle_web.addAsWebInfResource(warResURL, "sun-web.xml");
            }

            // Any libraries added to the war

            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/bb/async/stateful/metadata/beans.xml");
            if(warResURL != null) {
              ejbbb_async_stateful_metadata_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/beans.xml");
            }
            ...
            if(warResURL != null) {
              ejbbb_async_stateful_metadata_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/ejblitejsf_vehicle_web.xml");
            }
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/bb/async/stateful/metadata/faces-config.xml");
            if(warResURL != null) {
              ejbbb_async_stateful_metadata_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/faces-config.xml");
            }
            ...
            if(warResURL != null) {
              ejbbb_async_stateful_metadata_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/ejblitejsf_vehicle.xhtml");
            }

           // Call the archive processor
           archiveProcessor.processWebArchive(ejbbb_async_stateful_metadata_ejblitejsf_vehicle_web, Client.class, warResURL);

        return ejbbb_async_stateful_metadata_ejblitejsf_vehicle_web;
        }

...
import com.sun.ts.tests.ejb30.lite.stateful.concurrency.metadata.annotated.Client;
import java.net.URL;
...
public class ClientEjblitejspTest extends com.sun.ts.tests.ejb30.lite.stateful.concurrency.metadata.annotated.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_stateful_concurrency_metadata_annotated_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            WebArchive ejblite_stateful_concurrency_metadata_annotated_ejblitejsp_vehicle_web = ShrinkWrap.create(WebArchive.class, "ejblite_stateful_concurrency_metadata_annotated_ejblitejsp_vehicle_web.war");
            // The class files
            ejblite_stateful_concurrency_metadata_annotated_ejblitejsp_vehicle_web.addClasses(
            ...
            com.sun.ts.tests.ejb30.lite.stateful.concurrency.metadata.annotated.EJBLiteJSPTag.class,
            ...
            if(warResURL != null) {
              ejblite_stateful_concurrency_metadata_annotated_ejblitejsp_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = Client.class.getResource("//vehicle/ejblitejsp/ejblitejsp_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
              ejblite_stateful_concurrency_metadata_annotated_ejblitejsp_vehicle_web.addAsWebInfResource(warResURL, "sun-web.xml");
            }

            // Any libraries added to the war

            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/stateful/concurrency/metadata/annotated/ejblitejsp.tld");
            if(warResURL != null) {
              ejblite_stateful_concurrency_metadata_annotated_ejblitejsp_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/tlds/ejblitejsp.tld");
            }
            warResURL = Client.class.getResource("/com/sun/ts/tests/common/vehicle/ejblitejsp/ejblitejsp.tld");
            if(warResURL != null) {
              ejblite_stateful_concurrency_metadata_annotated_ejblitejsp_vehicle_web.addAsWebResource(warResURL, "/ejblitejsp.tld");
            }
            warResURL = Client.class.getResource("/com/sun/ts/tests/common/vehicle/ejblitejsp/ejblitejsp_vehicle.jsp");
            if(warResURL != null) {
              ejblite_stateful_concurrency_metadata_annotated_ejblitejsp_vehicle_web.addAsWebResource(warResURL, "/ejblitejsp_vehicle.jsp");
            }

           // Call the archive processor
           archiveProcessor.processWebArchive(ejblite_stateful_concurrency_metadata_annotated_ejblitejsp_vehicle_web, Client.class, warResURL);

        return ejblite_stateful_concurrency_metadata_annotated_ejblitejsp_vehicle_web;
        }

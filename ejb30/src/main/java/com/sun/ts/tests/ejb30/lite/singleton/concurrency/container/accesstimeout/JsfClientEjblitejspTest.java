...
import com.sun.ts.tests.ejb30.lite.singleton.concurrency.container.accesstimeout.JsfClient;
import java.net.URL;
...
public class JsfClientEjblitejspTest extends com.sun.ts.tests.ejb30.lite.singleton.concurrency.container.accesstimeout.JsfClient {
    static final String VEHICLE_ARCHIVE = "ejblite_singleton_concurrency_container_accesstimeout_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            WebArchive ejblite_singleton_concurrency_container_accesstimeout_ejblitejsp_vehicle_web = ShrinkWrap.create(WebArchive.class, "ejblite_singleton_concurrency_container_accesstimeout_ejblitejsp_vehicle_web.war");
            // The class files
            ejblite_singleton_concurrency_container_accesstimeout_ejblitejsp_vehicle_web.addClasses(
            ...
            com.sun.ts.tests.ejb30.lite.singleton.concurrency.container.accesstimeout.EJBLiteJSPTag.class
            );
            // The web.xml descriptor
            URL warResURL = JsfClient.class.getResource("/vehicle/ejblitejsp/ejblitejsp_vehicle_web.xml");
            if(warResURL != null) {
              ejblite_singleton_concurrency_container_accesstimeout_ejblitejsp_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = JsfClient.class.getResource("//vehicle/ejblitejsp/ejblitejsp_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
              ejblite_singleton_concurrency_container_accesstimeout_ejblitejsp_vehicle_web.addAsWebInfResource(warResURL, "sun-web.xml");
            }

            // Any libraries added to the war

            // Web content
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/lite/singleton/concurrency/container/accesstimeout/ejblitejsp.tld");
            if(warResURL != null) {
              ejblite_singleton_concurrency_container_accesstimeout_ejblitejsp_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/tlds/ejblitejsp.tld");
            }
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/common/vehicle/ejblitejsp/ejblitejsp.tld");
            if(warResURL != null) {
              ejblite_singleton_concurrency_container_accesstimeout_ejblitejsp_vehicle_web.addAsWebResource(warResURL, "/ejblitejsp.tld");
            }
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/common/vehicle/ejblitejsp/ejblitejsp_vehicle.jsp");
            if(warResURL != null) {
              ejblite_singleton_concurrency_container_accesstimeout_ejblitejsp_vehicle_web.addAsWebResource(warResURL, "/ejblitejsp_vehicle.jsp");
            }

           // Call the archive processor
           archiveProcessor.processWebArchive(ejblite_singleton_concurrency_container_accesstimeout_ejblitejsp_vehicle_web, JsfClient.class, warResURL);

        return ejblite_singleton_concurrency_container_accesstimeout_ejblitejsp_vehicle_web;
        }

...
public class ClientEjbliteservletTest extends com.sun.ts.tests.ejb30.lite.basic.singleton.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_basic_singleton_ejbliteservlet_vehicle";
        ...
        */
        ...
        // War
           ...
           archiveProcessor.processWebArchive(ejblite_basic_singleton_ejbliteservlet_vehicle_web, Client.class, warResURL);

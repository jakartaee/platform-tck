...
import com.sun.ts.tests.ejb30.timer.basic.xa.Client;
import java.net.URL;
...
public class ClientEjbliteservletTest extends com.sun.ts.tests.ejb30.timer.basic.xa.Client {
    static final String VEHICLE_ARCHIVE = "ejb30_timer_basic_xa_ejbliteservlet_vehicle";

        /**
        EE10 Deployment Descriptors:
        ejb30_timer_basic_xa_ejbliteservlet_vehicle_web: WEB-INF/classes/META-INF/persistence.xml,WEB-INF/web.xml
        ...
        */
        ...
        // War
            ...
            WebArchive ejb30_timer_basic_xa_ejbliteservlet_vehicle_web = ShrinkWrap.create(WebArchive.class, "ejb30_timer_basic_xa_ejbliteservlet_vehicle_web.war");
            // The class files
            ejb30_timer_basic_xa_ejbliteservlet_vehicle_web.addClasses(
            com.sun.ts.lib.harness.EETest.Fault.class,
            com.sun.ts.tests.ejb30.timer.basic.xa.XATimerBeanBase.class,
            ...
            com.sun.ts.tests.ejb30.timer.basic.xa.HttpServletDelegate.class,
            com.sun.ts.lib.harness.ServiceEETest.class,
            com.sun.ts.tests.ejb30.lite.tx.cm.common.CoffeeUtil.class,
            com.sun.ts.tests.common.vehicle.VehicleClient.class,
            com.sun.ts.tests.ejb30.common.lite.NumberIF.class,
            com.sun.ts.tests.ejb30.timer.basic.xa.EJBLiteServletVehicle.class,
            com.sun.ts.tests.common.vehicle.ejbliteshare.EJBLiteClientIF.class,
            com.sun.ts.tests.common.vehicle.VehicleRunnerFactory.class,
            com.sun.ts.tests.ejb30.timer.basic.xa.SingletonXATimerBean.class,
            ...
            com.sun.ts.tests.ejb30.timer.basic.xa.StatelessXATimerBean.class,
            com.sun.ts.tests.ejb30.common.lite.NumberEnum.class,
            com.sun.ts.tests.ejb30.common.lite.EJBLiteJsfClientBase.class,
            com.sun.ts.tests.ejb30.timer.common.TimerUtil.class,
            com.sun.ts.lib.harness.EETest.SetupException.class,
            com.sun.ts.tests.ejb30.timer.basic.xa.Client.class
            );
            // The web.xml descriptor
            URL warResURL = Client.class.getResource("ejbliteservlet_vehicle_web.xml");
            if(warResURL != null) {
              ejb30_timer_basic_xa_ejbliteservlet_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = Client.class.getResource("/ejbliteservlet_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
              ejb30_timer_basic_xa_ejbliteservlet_vehicle_web.addAsWebInfResource(warResURL, "sun-web.xml");
            }
        ...
        return ejb30_timer_basic_xa_ejbliteservlet_vehicle_web;
        }

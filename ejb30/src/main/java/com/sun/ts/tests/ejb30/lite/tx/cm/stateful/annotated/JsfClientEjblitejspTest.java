...
public class JsfClientEjblitejspTest extends com.sun.ts.tests.ejb30.lite.tx.cm.stateful.annotated.JsfClient {
    static final String VEHICLE_ARCHIVE = "ejblite_tx_cm_stateful_annotated_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/lite/tx/cm/stateful/annotated/ejblitejsp.tld");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_tx_cm_stateful_annotated_ejblitejsp_vehicle_web, JsfClient.class, warResURL);

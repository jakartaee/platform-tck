...
public class ClientEjblitejsfTest extends com.sun.ts.tests.ejb30.bb.async.singleton.metadata.Client {
    static final String VEHICLE_ARCHIVE = "ejbbb_async_singleton_metadata_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            ejbbb_async_singleton_metadata_ejblitejsf_vehicle_web.addClass("com.sun.ts.tests.ejb30.bb.async.common.metadata.BeanClassLevel2BeanBase$1.class");
            ...
            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/bb/async/singleton/metadata/beans.xml");
            if(warResURL != null) {
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/bb/async/singleton/metadata/faces-config.xml");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejbbb_async_singleton_metadata_ejblitejsf_vehicle_web, Client.class, warResURL);

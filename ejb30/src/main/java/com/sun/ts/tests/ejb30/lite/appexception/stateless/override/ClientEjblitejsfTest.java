...
public class ClientEjblitejsfTest extends com.sun.ts.tests.ejb30.lite.appexception.stateless.override.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_appexception_stateless_override_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/appexception/stateless/override/beans.xml");
            if(warResURL != null) {
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/appexception/stateless/override/faces-config.xml");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_appexception_stateless_override_ejblitejsf_vehicle_web, Client.class, warResURL);

...
import com.sun.ts.tests.ejb30.lite.packaging.war.datasource.stateful.Client;
import java.net.URL;
...
public class ClientEjbliteservlet2Test extends com.sun.ts.tests.ejb30.lite.packaging.war.datasource.stateful.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_packaging_war_datasource_stateful_ejbliteservlet2_vehicle";
        ...
        */
        ...
        // War
           ...
           archiveProcessor.processWebArchive(ejblite_packaging_war_datasource_stateful_ejbliteservlet2_vehicle_web, Client.class, warResURL);

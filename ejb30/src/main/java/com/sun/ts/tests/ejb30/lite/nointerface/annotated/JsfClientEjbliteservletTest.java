...
public class JsfClientEjbliteservletTest extends com.sun.ts.tests.ejb30.lite.nointerface.annotated.JsfClient {
    static final String VEHICLE_ARCHIVE = "ejblite_nointerface_annotated_ejbliteservlet_vehicle";
        ...
        */
        ...
        // War
           ...
           archiveProcessor.processWebArchive(ejblite_nointerface_annotated_ejbliteservlet_vehicle_web, JsfClient.class, warResURL);

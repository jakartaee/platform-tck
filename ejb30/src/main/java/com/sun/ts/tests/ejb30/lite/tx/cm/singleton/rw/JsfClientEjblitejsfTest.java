...
import com.sun.ts.tests.ejb30.lite.tx.cm.singleton.rw.JsfClient;
import java.net.URL;
...
public class JsfClientEjblitejsfTest extends com.sun.ts.tests.ejb30.lite.tx.cm.singleton.rw.JsfClient {
    static final String VEHICLE_ARCHIVE = "ejblite_tx_cm_singleton_rw_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            WebArchive ejblite_tx_cm_singleton_rw_ejblitejsf_vehicle_web = ShrinkWrap.create(WebArchive.class, "ejblite_tx_cm_singleton_rw_ejblitejsf_vehicle_web.war");
            // The class files
            ejblite_tx_cm_singleton_rw_ejblitejsf_vehicle_web.addClasses(
            ...
            if(warResURL != null) {
              ejblite_tx_cm_singleton_rw_ejblitejsf_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            ...
            if(warResURL != null) {
              ejblite_tx_cm_singleton_rw_ejblitejsf_vehicle_web.addAsWebInfResource(warResURL, "sun-web.xml");
            }

            // Any libraries added to the war

            // Web content
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/lite/tx/cm/singleton/rw/beans.xml");
            if(warResURL != null) {
              ejblite_tx_cm_singleton_rw_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/beans.xml");
            }
            ...
            if(warResURL != null) {
              ejblite_tx_cm_singleton_rw_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/ejblitejsf_vehicle_web.xml");
            }
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/lite/tx/cm/singleton/rw/faces-config.xml");
            if(warResURL != null) {
              ejblite_tx_cm_singleton_rw_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/faces-config.xml");
            }
            ...
            if(warResURL != null) {
              ejblite_tx_cm_singleton_rw_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/ejblitejsf_vehicle.xhtml");
            }
            // ejblite-pu persistence unit
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/tx/cm/common/persistence.xml");
            ejblite_tx_cm_singleton_rw_ejblitejsf_vehicle_web.addAsWebInfResource(warResURL, "classes/META-INF/persistence.xml");

           // Call the archive processor
           archiveProcessor.processWebArchive(ejblite_tx_cm_singleton_rw_ejblitejsf_vehicle_web, JsfClient.class, warResURL);

        return ejblite_tx_cm_singleton_rw_ejblitejsf_vehicle_web;
        }

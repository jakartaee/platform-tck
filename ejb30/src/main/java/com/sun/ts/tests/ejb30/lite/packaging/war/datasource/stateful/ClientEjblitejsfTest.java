...
public class ClientEjblitejsfTest extends com.sun.ts.tests.ejb30.lite.packaging.war.datasource.stateful.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_packaging_war_datasource_stateful_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            WebArchive ejblite_packaging_war_datasource_stateful_ejblitejsf_vehicle_web = ShrinkWrap.create(WebArchive.class, "ejblite_packaging_war_datasource_stateful_ejblitejsf_vehicle_web.war");
            // The class files
            ejblite_packaging_war_datasource_stateful_ejblitejsf_vehicle_web.addClasses(
            ...
            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/packaging/war/datasource/stateful/beans.xml");
            if(warResURL != null) {
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/packaging/war/datasource/stateful/faces-config.xml");
            if(warResURL != null) {
            ...
            if(warResURL != null) {
              ejblite_packaging_war_datasource_stateful_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/ejblitejsf_vehicle.xhtml");
            }

           // Call the archive processor
           archiveProcessor.processWebArchive(ejblite_packaging_war_datasource_stateful_ejblitejsf_vehicle_web, Client.class, warResURL);

        return ejblite_packaging_war_datasource_stateful_ejblitejsf_vehicle_web;
        }

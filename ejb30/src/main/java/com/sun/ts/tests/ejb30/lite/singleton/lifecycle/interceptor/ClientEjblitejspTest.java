...
public class ClientEjblitejspTest extends com.sun.ts.tests.ejb30.lite.singleton.lifecycle.interceptor.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_singleton_lifecycle_interceptor_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/singleton/lifecycle/interceptor/ejblitejsp.tld");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_singleton_lifecycle_interceptor_ejblitejsp_vehicle_web, Client.class, warResURL);

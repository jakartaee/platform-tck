...
import com.sun.ts.tests.ejb30.timer.schedule.auto.attr.stateless.Client;
import java.net.URL;
...
public class ClientEjbliteservletTest extends com.sun.ts.tests.ejb30.timer.schedule.auto.attr.stateless.Client {
    static final String VEHICLE_ARCHIVE = "ejb30_timer_schedule_auto_attr_stateless_ejbliteservlet_vehicle";

        /**
        EE10 Deployment Descriptors:
        ejb30_timer_schedule_auto_attr_stateless_ejbliteservlet_vehicle_web: WEB-INF/web.xml
        ...
        */
        ...
        // War
            ...
            WebArchive ejb30_timer_schedule_auto_attr_stateless_ejbliteservlet_vehicle_web = ShrinkWrap.create(WebArchive.class, "ejb30_timer_schedule_auto_attr_stateless_ejbliteservlet_vehicle_web.war");
            // The class files
            ejb30_timer_schedule_auto_attr_stateless_ejbliteservlet_vehicle_web.addClasses(
            ...
            com.sun.ts.tests.ejb30.timer.schedule.auto.attr.stateless.ScheduleBean.class,
            com.sun.ts.tests.common.vehicle.VehicleClient.class,
            com.sun.ts.tests.ejb30.common.lite.NumberIF.class,
            com.sun.ts.tests.common.vehicle.ejbliteshare.EJBLiteClientIF.class,
            com.sun.ts.tests.common.vehicle.VehicleRunnerFactory.class,
            com.sun.ts.tests.ejb30.timer.common.TimerInfo.class,
            com.sun.ts.tests.ejb30.timer.schedule.auto.attr.stateless.HttpServletDelegate.class,
            com.sun.ts.tests.ejb30.timer.schedule.auto.attr.stateless.Client.class,
            com.sun.ts.tests.ejb30.timer.schedule.auto.attr.stateless.EJBLiteServletVehicle.class,
            ...
            if(warResURL != null) {
              ejb30_timer_schedule_auto_attr_stateless_ejbliteservlet_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = Client.class.getResource("/ejbliteservlet_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
              ejb30_timer_schedule_auto_attr_stateless_ejbliteservlet_vehicle_web.addAsWebInfResource(warResURL, "sun-web.xml");
            }
            ...
            if(warResURL != null) {
              ejb30_timer_schedule_auto_attr_stateless_ejbliteservlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/ejbliteservlet_vehicle_web.xml");
            }

           // Call the archive processor
           archiveProcessor.processWebArchive(ejb30_timer_schedule_auto_attr_stateless_ejbliteservlet_vehicle_web, Client.class, warResURL);

        return ejb30_timer_schedule_auto_attr_stateless_ejbliteservlet_vehicle_web;
        }

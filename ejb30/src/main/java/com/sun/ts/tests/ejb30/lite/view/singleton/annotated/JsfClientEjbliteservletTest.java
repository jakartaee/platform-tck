...
public class JsfClientEjbliteservletTest extends com.sun.ts.tests.ejb30.lite.view.singleton.annotated.JsfClient {
    static final String VEHICLE_ARCHIVE = "ejblite_view_singleton_annotated_ejbliteservlet_vehicle";
        ...
        */
        ...
        // War
           ...
           archiveProcessor.processWebArchive(ejblite_view_singleton_annotated_ejbliteservlet_vehicle_web, JsfClient.class, warResURL);

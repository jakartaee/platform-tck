...
public class JsfClientEjblitejspTest extends com.sun.ts.tests.ejb30.lite.enventry.stateless.JsfClient {
    static final String VEHICLE_ARCHIVE = "ejblite_enventry_stateless_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/lite/enventry/stateless/ejblitejsp.tld");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_enventry_stateless_ejblitejsp_vehicle_web, JsfClient.class, warResURL);

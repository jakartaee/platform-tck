...
public class ClientEjblitejsfTest extends com.sun.ts.tests.ejb30.lite.view.equals.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_view_equals_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/view/equals/beans.xml");
            if(warResURL != null) {
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/view/equals/faces-config.xml");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_view_equals_ejblitejsf_vehicle_web, Client.class, warResURL);

...
public class ClientEjbliteservletTest extends com.sun.ts.tests.ejb30.lite.async.stateless.descriptor.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_async_stateless_descriptor_ejbliteservlet_vehicle";
        ...
        */
        ...
        // War
           ...
           archiveProcessor.processWebArchive(ejblite_async_stateless_descriptor_ejbliteservlet_vehicle_web, Client.class, warResURL);

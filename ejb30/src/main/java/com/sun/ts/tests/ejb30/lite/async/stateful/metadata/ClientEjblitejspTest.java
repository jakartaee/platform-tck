...
public class ClientEjblitejspTest extends com.sun.ts.tests.ejb30.lite.async.stateful.metadata.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_async_stateful_metadata_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/async/stateful/metadata/ejblitejsp.tld");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_async_stateful_metadata_ejblitejsp_vehicle_web, Client.class, warResURL);

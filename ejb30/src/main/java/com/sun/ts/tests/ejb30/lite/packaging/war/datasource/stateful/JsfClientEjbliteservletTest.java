...
public class JsfClientEjbliteservletTest extends com.sun.ts.tests.ejb30.lite.packaging.war.datasource.stateful.JsfClient {
    static final String VEHICLE_ARCHIVE = "ejblite_packaging_war_datasource_stateful_ejbliteservlet_vehicle";
        ...
        */
        ...
        // War
            ...
            if(warResURL != null) {
              ejblite_packaging_war_datasource_stateful_ejbliteservlet_vehicle_web.addAsWebInfResource(warResURL, "sun-web.xml");
            }
            ...
            if(warResURL != null) {
              ejblite_packaging_war_datasource_stateful_ejbliteservlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/ejbliteservlet_vehicle_web.xml");
            }

           // Call the archive processor
           archiveProcessor.processWebArchive(ejblite_packaging_war_datasource_stateful_ejbliteservlet_vehicle_web, JsfClient.class, warResURL);

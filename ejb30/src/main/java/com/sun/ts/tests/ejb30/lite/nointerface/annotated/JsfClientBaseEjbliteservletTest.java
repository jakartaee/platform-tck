...
public class JsfClientBaseEjbliteservletTest extends com.sun.ts.tests.ejb30.lite.nointerface.annotated.JsfClientBase {
    static final String VEHICLE_ARCHIVE = "ejblite_nointerface_annotated_ejbliteservlet_vehicle";
        ...
        */
        ...
        // War
            ...
            URL warResURL = JsfClientBase.class.getResource("ejbliteservlet_vehicle_web.xml");
            if(warResURL != null) {
              ejblite_nointerface_annotated_ejbliteservlet_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = JsfClientBase.class.getResource("/ejbliteservlet_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
            ...
            // Web content
            warResURL = JsfClientBase.class.getResource("/com/sun/ts/tests/common/vehicle/ejbliteservlet/ejbliteservlet_vehicle_web.xml");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_nointerface_annotated_ejbliteservlet_vehicle_web, JsfClientBase.class, warResURL);

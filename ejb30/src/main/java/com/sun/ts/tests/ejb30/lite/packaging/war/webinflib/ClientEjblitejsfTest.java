...
import com.sun.ts.tests.ejb30.lite.packaging.war.webinflib.Client;
import java.net.URL;
...
public class ClientEjblitejsfTest extends com.sun.ts.tests.ejb30.lite.packaging.war.webinflib.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_packaging_war_webinflib_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/packaging/war/webinflib/beans.xml");
            if(warResURL != null) {
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/packaging/war/webinflib/faces-config.xml");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_packaging_war_webinflib_ejblitejsf_vehicle_web, Client.class, warResURL);

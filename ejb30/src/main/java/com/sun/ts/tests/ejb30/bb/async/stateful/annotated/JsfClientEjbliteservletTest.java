...
public class JsfClientEjbliteservletTest extends com.sun.ts.tests.ejb30.bb.async.stateful.annotated.JsfClient {
    static final String VEHICLE_ARCHIVE = "ejbbb_async_stateful_annotated_ejbliteservlet_vehicle";
        ...
        */
        ...
        // War
            ...
            WebArchive ejbbb_async_stateful_annotated_ejbliteservlet_vehicle_web = ShrinkWrap.create(WebArchive.class, "ejbbb_async_stateful_annotated_ejbliteservlet_vehicle_web.war");
            // The class files
            ejbbb_async_stateful_annotated_ejbliteservlet_vehicle_web.addClasses(
            ...
            com.sun.ts.tests.ejb30.bb.async.stateful.annotated.EJBLiteServletVehicle.class,
            ...
            ejbbb_async_stateful_annotated_ejbliteservlet_vehicle_web.addClass("com.sun.ts.tests.ejb30.bb.async.common.annotated.AsyncAnnotatedMethodsBeanBase$1.class");

            // The web.xml descriptor
            URL warResURL = JsfClient.class.getResource("ejbliteservlet_vehicle_web.xml");
            if(warResURL != null) {
              ejbbb_async_stateful_annotated_ejbliteservlet_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = JsfClient.class.getResource("/ejbliteservlet_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
              ejbbb_async_stateful_annotated_ejbliteservlet_vehicle_web.addAsWebInfResource(warResURL, "sun-web.xml");
            }
            ...
            if(warResURL != null) {
              ejbbb_async_stateful_annotated_ejbliteservlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/ejbliteservlet_vehicle_web.xml");
            }

           // Call the archive processor
           archiveProcessor.processWebArchive(ejbbb_async_stateful_annotated_ejbliteservlet_vehicle_web, JsfClient.class, warResURL);

        return ejbbb_async_stateful_annotated_ejbliteservlet_vehicle_web;
        }

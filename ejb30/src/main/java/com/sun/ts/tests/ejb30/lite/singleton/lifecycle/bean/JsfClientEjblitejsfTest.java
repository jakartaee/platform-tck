...
public class JsfClientEjblitejsfTest extends com.sun.ts.tests.ejb30.lite.singleton.lifecycle.bean.JsfClient {
    static final String VEHICLE_ARCHIVE = "ejblite_singleton_lifecycle_bean_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/lite/singleton/lifecycle/bean/beans.xml");
            if(warResURL != null) {
            ...
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/lite/singleton/lifecycle/bean/faces-config.xml");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_singleton_lifecycle_bean_ejblitejsf_vehicle_web, JsfClient.class, warResURL);

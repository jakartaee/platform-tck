...
public class JsfClientEjbliteservletTest extends com.sun.ts.tests.ejb30.lite.enventry.stateful.JsfClient {
    static final String VEHICLE_ARCHIVE = "ejblite_enventry_stateful_ejbliteservlet_vehicle";
        ...
        */
        ...
        // War
           ...
           archiveProcessor.processWebArchive(ejblite_enventry_stateful_ejbliteservlet_vehicle_web, JsfClient.class, warResURL);

...
public class JsfClientEjbliteservletTest extends com.sun.ts.tests.ejb30.lite.tx.cm.stateful.sessionsync.JsfClient {
    static final String VEHICLE_ARCHIVE = "ejblite_tx_cm_stateful_sessionsync_ejbliteservlet_vehicle";
        ...
        */
        ...
        // War
            ...
            WebArchive ejblite_tx_cm_stateful_sessionsync_ejbliteservlet_vehicle_web = ShrinkWrap.create(WebArchive.class, "ejblite_tx_cm_stateful_sessionsync_ejbliteservlet_vehicle_web.war");
            // The class files
            ejblite_tx_cm_stateful_sessionsync_ejbliteservlet_vehicle_web.addClasses(
            com.sun.ts.tests.ejb30.lite.tx.cm.stateful.sessionsync.EJBLiteServletVehicle.class,
            ...
            if(warResURL != null) {
              ejblite_tx_cm_stateful_sessionsync_ejbliteservlet_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = JsfClient.class.getResource("/ejbliteservlet_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
              ejblite_tx_cm_stateful_sessionsync_ejbliteservlet_vehicle_web.addAsWebInfResource(warResURL, "sun-web.xml");
            }
            ...
            if(warResURL != null) {
              ejblite_tx_cm_stateful_sessionsync_ejbliteservlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/ejb-jar.xml");
            }
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/common/vehicle/ejbliteservlet/ejbliteservlet_vehicle_web.xml");
            if(warResURL != null) {
              ejblite_tx_cm_stateful_sessionsync_ejbliteservlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/ejbliteservlet_vehicle_web.xml");
            }

           // Call the archive processor
           archiveProcessor.processWebArchive(ejblite_tx_cm_stateful_sessionsync_ejbliteservlet_vehicle_web, JsfClient.class, warResURL);

        return ejblite_tx_cm_stateful_sessionsync_ejbliteservlet_vehicle_web;
        }

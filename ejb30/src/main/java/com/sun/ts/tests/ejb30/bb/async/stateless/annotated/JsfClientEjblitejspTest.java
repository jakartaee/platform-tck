...
public class JsfClientEjblitejspTest extends com.sun.ts.tests.ejb30.bb.async.stateless.annotated.JsfClient {
    static final String VEHICLE_ARCHIVE = "ejbbb_async_stateless_annotated_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            ejbbb_async_stateless_annotated_ejblitejsp_vehicle_web.addClass("com.sun.ts.tests.ejb30.bb.async.common.annotated.AsyncAnnotatedMethodsBeanBase$1.class");
            ...
            // Web content
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/bb/async/stateless/annotated/ejblitejsp.tld");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejbbb_async_stateless_annotated_ejblitejsp_vehicle_web, JsfClient.class, warResURL);

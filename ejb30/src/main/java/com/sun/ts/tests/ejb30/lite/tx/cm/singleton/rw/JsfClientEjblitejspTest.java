...
public class JsfClientEjblitejspTest extends com.sun.ts.tests.ejb30.lite.tx.cm.singleton.rw.JsfClient {
    static final String VEHICLE_ARCHIVE = "ejblite_tx_cm_singleton_rw_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/lite/tx/cm/singleton/rw/ejblitejsp.tld");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_tx_cm_singleton_rw_ejblitejsp_vehicle_web, JsfClient.class, warResURL);

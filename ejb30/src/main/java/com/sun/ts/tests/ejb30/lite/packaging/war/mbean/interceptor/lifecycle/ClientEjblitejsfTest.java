...
public class ClientEjblitejsfTest extends com.sun.ts.tests.ejb30.lite.packaging.war.mbean.interceptor.lifecycle.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_packaging_war_mbean_interceptor_lifecycle_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/packaging/war/mbean/interceptor/lifecycle/beans.xml");
            if(warResURL != null) {
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/packaging/war/mbean/interceptor/lifecycle/faces-config.xml");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_packaging_war_mbean_interceptor_lifecycle_ejblitejsf_vehicle_web, Client.class, warResURL);

...
public class JsfClientEjblitejspTest extends com.sun.ts.tests.ejb30.lite.basic.stateful.JsfClient {
    static final String VEHICLE_ARCHIVE = "ejblite_basic_stateful_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/lite/basic/stateful/ejblitejsp.tld");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_basic_stateful_ejblitejsp_vehicle_web, JsfClient.class, warResURL);

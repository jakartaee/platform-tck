...
import com.sun.ts.tests.ejb30.lite.tx.bm.singleton.rw.Client;
import java.net.URL;
...
public class ClientEjblitejsfTest extends com.sun.ts.tests.ejb30.lite.tx.bm.singleton.rw.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_tx_bm_singleton_rw_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/tx/bm/singleton/rw/beans.xml");
            if(warResURL != null) {
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/tx/bm/singleton/rw/faces-config.xml");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_tx_bm_singleton_rw_ejblitejsf_vehicle_web, Client.class, warResURL);

...
public class ClientEjblitejspTest extends com.sun.ts.tests.ejb30.bb.async.stateful.annotated.Client {
    static final String VEHICLE_ARCHIVE = "ejbbb_async_stateful_annotated_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/bb/async/stateful/annotated/ejblitejsp.tld");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejbbb_async_stateful_annotated_ejblitejsp_vehicle_web, Client.class, warResURL);

...
public class ClientEjbliteservletTest extends com.sun.ts.tests.ejb30.lite.async.stateless.annotated.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_async_stateless_annotated_ejbliteservlet_vehicle";
        ...
        */
        ...
        // War
           ...
           archiveProcessor.processWebArchive(ejblite_async_stateless_annotated_ejbliteservlet_vehicle_web, Client.class, warResURL);

...
public class ClientEjblitejspTest extends com.sun.ts.tests.ejb30.lite.appexception.stateful.annotated.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_appexception_stateful_annotated_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/appexception/stateful/annotated/ejblitejsp.tld");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_appexception_stateful_annotated_ejblitejsp_vehicle_web, Client.class, warResURL);

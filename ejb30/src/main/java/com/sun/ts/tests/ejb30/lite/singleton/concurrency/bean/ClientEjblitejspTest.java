...
import com.sun.ts.tests.ejb30.lite.singleton.concurrency.bean.Client;
import java.net.URL;
...
public class ClientEjblitejspTest extends com.sun.ts.tests.ejb30.lite.singleton.concurrency.bean.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_singleton_concurrency_bean_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/singleton/concurrency/bean/ejblitejsp.tld");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_singleton_concurrency_bean_ejblitejsp_vehicle_web, Client.class, warResURL);

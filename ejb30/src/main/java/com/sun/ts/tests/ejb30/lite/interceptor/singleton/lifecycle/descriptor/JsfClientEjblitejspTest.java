...
public class JsfClientEjblitejspTest extends com.sun.ts.tests.ejb30.lite.interceptor.singleton.lifecycle.descriptor.JsfClient {
    static final String VEHICLE_ARCHIVE = "ejblite_interceptor_singleton_lifecycle_descriptor_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/lite/interceptor/singleton/lifecycle/descriptor/ejblitejsp.tld");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_interceptor_singleton_lifecycle_descriptor_ejblitejsp_vehicle_web, JsfClient.class, warResURL);

...
public class ClientEjblitejspTest extends com.sun.ts.tests.ejb30.lite.packaging.war.servletcontextlistener.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_packaging_war_servletcontextlistener_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/packaging/war/servletcontextlistener/ejblitejsp.tld");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_packaging_war_servletcontextlistener_ejblitejsp_vehicle_web, Client.class, warResURL);

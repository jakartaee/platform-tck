...
public class ClientEjbliteservletTest extends com.sun.ts.tests.ejb30.lite.stateful.concurrency.metadata.annotated.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_stateful_concurrency_metadata_annotated_ejbliteservlet_vehicle";
        ...
        */
        ...
        // War
            ...
            WebArchive ejblite_stateful_concurrency_metadata_annotated_ejbliteservlet_vehicle_web = ShrinkWrap.create(WebArchive.class, "ejblite_stateful_concurrency_metadata_annotated_ejbliteservlet_vehicle_web.war");
            // The class files
            ejblite_stateful_concurrency_metadata_annotated_ejbliteservlet_vehicle_web.addClasses(
            ...
            com.sun.ts.tests.ejb30.lite.stateful.concurrency.metadata.annotated.EJBLiteServletVehicle.class,
            ...
            if(warResURL != null) {
              ejblite_stateful_concurrency_metadata_annotated_ejbliteservlet_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = Client.class.getResource("/ejbliteservlet_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
              ejblite_stateful_concurrency_metadata_annotated_ejbliteservlet_vehicle_web.addAsWebInfResource(warResURL, "sun-web.xml");
            }
            ...
            if(warResURL != null) {
              ejblite_stateful_concurrency_metadata_annotated_ejbliteservlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/ejbliteservlet_vehicle_web.xml");
            }

           // Call the archive processor
           archiveProcessor.processWebArchive(ejblite_stateful_concurrency_metadata_annotated_ejbliteservlet_vehicle_web, Client.class, warResURL);

        return ejblite_stateful_concurrency_metadata_annotated_ejbliteservlet_vehicle_web;
        }

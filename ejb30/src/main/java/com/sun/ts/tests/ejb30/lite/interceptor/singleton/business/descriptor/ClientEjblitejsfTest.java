...
public class ClientEjblitejsfTest extends com.sun.ts.tests.ejb30.lite.interceptor.singleton.business.descriptor.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_interceptor_singleton_business_descriptor_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/interceptor/singleton/business/descriptor/beans.xml");
            if(warResURL != null) {
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/interceptor/singleton/business/descriptor/faces-config.xml");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_interceptor_singleton_business_descriptor_ejblitejsf_vehicle_web, Client.class, warResURL);

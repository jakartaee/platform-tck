...
public class ClientEjblitejsfTest extends com.sun.ts.tests.ejb30.lite.singleton.lifecycle.interceptor.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_singleton_lifecycle_interceptor_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            ejblite_singleton_lifecycle_interceptor_ejblitejsf_vehicle_web.addClass("com.sun.ts.tests.ejb30.lite.singleton.lifecycle.interceptor.Client$1.class");
            ejblite_singleton_lifecycle_interceptor_ejblitejsf_vehicle_web.addClass("com.sun.ts.tests.ejb30.lite.singleton.lifecycle.interceptor.JsfClient$1.class");
            ...
            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/singleton/lifecycle/interceptor/beans.xml");
            if(warResURL != null) {
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/singleton/lifecycle/interceptor/faces-config.xml");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_singleton_lifecycle_interceptor_ejblitejsf_vehicle_web, Client.class, warResURL);

...
import com.sun.ts.tests.ejb30.timer.schedule.tx.Client;
import java.net.URL;
...
public class ClientEjbliteservletTest extends com.sun.ts.tests.ejb30.timer.schedule.tx.Client {
    static final String VEHICLE_ARCHIVE = "ejb30_timer_schedule_tx_ejbliteservlet_vehicle";

        /**
        EE10 Deployment Descriptors:
        ejb30_timer_schedule_tx_ejbliteservlet_vehicle_web: WEB-INF/ejb-jar.xml,WEB-INF/web.xml
        ...
        */
        ...
        // War
            ...
            WebArchive ejb30_timer_schedule_tx_ejbliteservlet_vehicle_web = ShrinkWrap.create(WebArchive.class, "ejb30_timer_schedule_tx_ejbliteservlet_vehicle_web.war");
            // The class files
            ejb30_timer_schedule_tx_ejbliteservlet_vehicle_web.addClasses(
            ...
            com.sun.ts.tests.ejb30.timer.schedule.tx.HttpServletDelegate.class,
            ...
            com.sun.ts.tests.ejb30.timer.schedule.tx.EJBLiteServletVehicle.class,
            com.sun.ts.lib.harness.EETest.SetupException.class,
            com.sun.ts.tests.ejb30.timer.schedule.tx.Client.class
            );
            // The web.xml descriptor
            URL warResURL = Client.class.getResource("ejbliteservlet_vehicle_web.xml");
            if(warResURL != null) {
              ejb30_timer_schedule_tx_ejbliteservlet_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = Client.class.getResource("/ejbliteservlet_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
              ejb30_timer_schedule_tx_ejbliteservlet_vehicle_web.addAsWebInfResource(warResURL, "sun-web.xml");
            }

            // Any libraries added to the war

            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/timer/schedule/tx/ejb-jar.xml");
            if(warResURL != null) {
              ejb30_timer_schedule_tx_ejbliteservlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/ejb-jar.xml");
            }
            warResURL = Client.class.getResource("/com/sun/ts/tests/common/vehicle/ejbliteservlet/ejbliteservlet_vehicle_web.xml");
            if(warResURL != null) {
              ejb30_timer_schedule_tx_ejbliteservlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/ejbliteservlet_vehicle_web.xml");
            }

           // Call the archive processor
           archiveProcessor.processWebArchive(ejb30_timer_schedule_tx_ejbliteservlet_vehicle_web, Client.class, warResURL);

        return ejb30_timer_schedule_tx_ejbliteservlet_vehicle_web;
        }

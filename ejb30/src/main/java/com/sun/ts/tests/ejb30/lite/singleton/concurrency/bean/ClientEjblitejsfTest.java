...
public class ClientEjblitejsfTest extends com.sun.ts.tests.ejb30.lite.singleton.concurrency.bean.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_singleton_concurrency_bean_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/singleton/concurrency/bean/beans.xml");
            if(warResURL != null) {
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/singleton/concurrency/bean/faces-config.xml");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_singleton_concurrency_bean_ejblitejsf_vehicle_web, Client.class, warResURL);

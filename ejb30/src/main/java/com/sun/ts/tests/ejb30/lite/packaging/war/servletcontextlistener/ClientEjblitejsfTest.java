...
import com.sun.ts.tests.ejb30.lite.packaging.war.servletcontextlistener.Client;
import java.net.URL;
...
public class ClientEjblitejsfTest extends com.sun.ts.tests.ejb30.lite.packaging.war.servletcontextlistener.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_packaging_war_servletcontextlistener_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/packaging/war/servletcontextlistener/beans.xml");
            if(warResURL != null) {
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/packaging/war/servletcontextlistener/faces-config.xml");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_packaging_war_servletcontextlistener_ejblitejsf_vehicle_web, Client.class, warResURL);

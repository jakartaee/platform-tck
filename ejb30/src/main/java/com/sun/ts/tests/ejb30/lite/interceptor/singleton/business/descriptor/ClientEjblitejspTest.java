...
import com.sun.ts.tests.ejb30.lite.interceptor.singleton.business.descriptor.Client;
import java.net.URL;
...
public class ClientEjblitejspTest extends com.sun.ts.tests.ejb30.lite.interceptor.singleton.business.descriptor.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_interceptor_singleton_business_descriptor_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/interceptor/singleton/business/descriptor/ejblitejsp.tld");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_interceptor_singleton_business_descriptor_ejblitejsp_vehicle_web, Client.class, warResURL);

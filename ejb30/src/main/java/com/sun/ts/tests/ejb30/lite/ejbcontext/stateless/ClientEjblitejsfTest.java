...
public class ClientEjblitejsfTest extends com.sun.ts.tests.ejb30.lite.ejbcontext.stateless.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_ejbcontext_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/ejbcontext/stateless/beans.xml");
            if(warResURL != null) {
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/ejbcontext/stateless/faces-config.xml");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_ejbcontext_ejblitejsf_vehicle_web, Client.class, warResURL);

...
public class ClientEjblitejspTest extends com.sun.ts.tests.ejb30.lite.tx.bm.singleton.rw.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_tx_bm_singleton_rw_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            WebArchive ejblite_tx_bm_singleton_rw_ejblitejsp_vehicle_web = ShrinkWrap.create(WebArchive.class, "ejblite_tx_bm_singleton_rw_ejblitejsp_vehicle_web.war");
            // The class files
            ejblite_tx_bm_singleton_rw_ejblitejsp_vehicle_web.addClasses(
            ...
            com.sun.ts.tests.ejb30.lite.tx.bm.singleton.rw.EJBLiteJSPTag.class,
            ...
            if(warResURL != null) {
              ejblite_tx_bm_singleton_rw_ejblitejsp_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            ...
            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/tx/bm/singleton/rw/ejblitejsp.tld");
            if(warResURL != null) {
              ejblite_tx_bm_singleton_rw_ejblitejsp_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/tlds/ejblitejsp.tld");
            }
            warResURL = Client.class.getResource("/com/sun/ts/tests/common/vehicle/ejblitejsp/ejblitejsp.tld");
            if(warResURL != null) {
              ejblite_tx_bm_singleton_rw_ejblitejsp_vehicle_web.addAsWebResource(warResURL, "/ejblitejsp.tld");
            }
            warResURL = Client.class.getResource("/com/sun/ts/tests/common/vehicle/ejblitejsp/ejblitejsp_vehicle.jsp");
            if(warResURL != null) {
              ejblite_tx_bm_singleton_rw_ejblitejsp_vehicle_web.addAsWebResource(warResURL, "/ejblitejsp_vehicle.jsp");
            }

           // Call the archive processor
           archiveProcessor.processWebArchive(ejblite_tx_bm_singleton_rw_ejblitejsp_vehicle_web, Client.class, warResURL);

        return ejblite_tx_bm_singleton_rw_ejblitejsp_vehicle_web;
        }

...
import com.sun.ts.tests.ejb30.lite.async.stateful.annotated.Client;
import java.net.URL;
...
public class ClientEjblitejsfTest extends com.sun.ts.tests.ejb30.lite.async.stateful.annotated.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_async_stateful_annotated_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/async/stateful/annotated/beans.xml");
            if(warResURL != null) {
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/async/stateful/annotated/faces-config.xml");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_async_stateful_annotated_ejblitejsf_vehicle_web, Client.class, warResURL);

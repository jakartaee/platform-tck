...
public class JsfClientEjblitejspTest extends com.sun.ts.tests.ejb30.lite.async.singleton.descriptor.JsfClient {
    static final String VEHICLE_ARCHIVE = "ejblite_async_singleton_descriptor_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/lite/async/singleton/descriptor/ejblitejsp.tld");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_async_singleton_descriptor_ejblitejsp_vehicle_web, JsfClient.class, warResURL);

...
public class Client extends AbstractUrlClient {
     ...
     */
    public void injectedIntoTestServletSuperEvenNoAnnotationInTestServlet() throws Exception {
        TEST_PROPS.setProperty(APITEST, "injectedIntoTestServletSuperEvenNoAnnotationInTestServlet");
        invoke();
    }

    /*
     * @testName: postConstructCalledInTestServletSuperEvenNoAnnotationInTestServlet
     * 
     * @assertion_ids:
     * 
     * @test_Strategy:client -> TestServlet
     */
    public void postConstructCalledInTestServletSuperEvenNoAnnotationInTestServlet() throws Exception {
        TEST_PROPS.setProperty(APITEST, "postConstructCalledInTestServletSuperEvenNoAnnotationInTestServlet");
        invoke();
    }

...
import com.sun.ts.tests.ejb30.lite.xmloverride.ejbref.JsfClient;
import java.net.URL;
...
public class JsfClientEjblitejspTest extends com.sun.ts.tests.ejb30.lite.xmloverride.ejbref.JsfClient {
    static final String VEHICLE_ARCHIVE = "ejblite_xmloverride_ejbref_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            WebArchive ejblite_xmloverride_ejbref_ejblitejsp_vehicle_web = ShrinkWrap.create(WebArchive.class, "ejblite_xmloverride_ejbref_ejblitejsp_vehicle_web.war");
            // The class files
            ejblite_xmloverride_ejbref_ejblitejsp_vehicle_web.addClasses(
            ...
            com.sun.ts.tests.ejb30.lite.xmloverride.ejbref.EJBLiteJSPTag.class,
            ...
            // Web content
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/lite/xmloverride/ejbref/ejb-jar.xml");
            if(warResURL != null) {
              ejblite_xmloverride_ejbref_ejblitejsp_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/ejb-jar.xml");
            }
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/lite/xmloverride/ejbref/ejblitejsp.tld");
            if(warResURL != null) {
              ejblite_xmloverride_ejbref_ejblitejsp_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/tlds/ejblitejsp.tld");
            }
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/common/vehicle/ejblitejsp/ejblitejsp.tld");
            if(warResURL != null) {
              ejblite_xmloverride_ejbref_ejblitejsp_vehicle_web.addAsWebResource(warResURL, "/ejblitejsp.tld");
            }
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/common/vehicle/ejblitejsp/ejblitejsp_vehicle.jsp");
            if(warResURL != null) {
              ejblite_xmloverride_ejbref_ejblitejsp_vehicle_web.addAsWebResource(warResURL, "/ejblitejsp_vehicle.jsp");
            }

           // Call the archive processor
           archiveProcessor.processWebArchive(ejblite_xmloverride_ejbref_ejblitejsp_vehicle_web, JsfClient.class, warResURL);

        return ejblite_xmloverride_ejbref_ejblitejsp_vehicle_web;
        }

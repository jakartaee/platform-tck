...
public class ClientEjblitejsfTest extends com.sun.ts.tests.ejb30.lite.interceptor.singleton.lifecycle.descriptor.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_interceptor_singleton_lifecycle_descriptor_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/interceptor/singleton/lifecycle/descriptor/beans.xml");
            if(warResURL != null) {
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/interceptor/singleton/lifecycle/descriptor/faces-config.xml");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_interceptor_singleton_lifecycle_descriptor_ejblitejsf_vehicle_web, Client.class, warResURL);

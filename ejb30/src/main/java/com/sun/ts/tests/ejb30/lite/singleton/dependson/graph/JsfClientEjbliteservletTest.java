...
public class JsfClientEjbliteservletTest extends com.sun.ts.tests.ejb30.lite.singleton.dependson.graph.JsfClient {
    static final String VEHICLE_ARCHIVE = "ejblite_singleton_dependson_graph_ejbliteservlet_vehicle";
        ...
        */
        ...
        // War
           ...
           archiveProcessor.processWebArchive(ejblite_singleton_dependson_graph_ejbliteservlet_vehicle_web, JsfClient.class, warResURL);

...
public class JsfClientEjblitejspTest extends com.sun.ts.tests.ejb30.lite.tx.cm.singleton.inheritance.JsfClient {
    static final String VEHICLE_ARCHIVE = "ejblite_tx_cm_singleton_inheritance_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/lite/tx/cm/singleton/inheritance/ejblitejsp.tld");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_tx_cm_singleton_inheritance_ejblitejsp_vehicle_web, JsfClient.class, warResURL);

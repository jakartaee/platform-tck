...
import com.sun.ts.tests.ejb30.tx.session.stateless.cm.covariant.Client;
import java.net.URL;
...
public class ClientTest extends com.sun.ts.tests.ejb30.tx.session.stateless.cm.covariant.Client {
    /**
        ...
        /com/sun/ts/tests/ejb30/tx/session/stateless/cm/covariant/tx_stateless_covariant_ejb.jar.sun-ejb-jar.xml
        War:

        /com/sun/ts/tests/ejb30/tx/session/stateless/cm/covariant/tx_stateless_covariant_web.xml
        Ear:
        ...
        */
        ...
        // War
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/tx/session/stateless/cm/covariant/tx_stateless_covariant_web.war.sun-web.xml");
            if(warResURL != null) {
              tx_stateless_covariant_web.addAsWebInfResource(warResURL, "sun-web.xml");
            }
        ...
        // Ejb
            ...
            URL ejbResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/tx/session/stateless/cm/covariant/tx_stateless_covariant_ejb.xml");
            if(ejbResURL != null) {
              tx_stateless_covariant_ejb.addAsManifestResource(ejbResURL, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/tx/session/stateless/cm/covariant/tx_stateless_covariant_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL != null) {
        ...
        // Ear
            ...
            if(earResURL != null) {
              tx_stateless_covariant_ear.addAsManifestResource(earResURL, "sun-application.xml");
            }
            // Call the archive processor

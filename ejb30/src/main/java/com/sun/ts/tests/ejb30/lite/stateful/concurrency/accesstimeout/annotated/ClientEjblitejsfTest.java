...
public class ClientEjblitejsfTest extends com.sun.ts.tests.ejb30.lite.stateful.concurrency.accesstimeout.annotated.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_stateful_concurrency_accesstimeout_annotated_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/stateful/concurrency/accesstimeout/annotated/beans.xml");
            if(warResURL != null) {
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/stateful/concurrency/accesstimeout/annotated/faces-config.xml");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_stateful_concurrency_accesstimeout_annotated_ejblitejsf_vehicle_web, Client.class, warResURL);

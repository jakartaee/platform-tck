...
public class JsfClientEjblitejspTest extends com.sun.ts.tests.ejb30.bb.session.stateful.concurrency.accesstimeout.annotated.JsfClient {
    static final String VEHICLE_ARCHIVE = "bb_stateful_concurrency_accesstimeout_annotated_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            WebArchive bb_stateful_concurrency_accesstimeout_annotated_ejblitejsp_vehicle_web = ShrinkWrap.create(WebArchive.class, "bb_stateful_concurrency_accesstimeout_annotated_ejblitejsp_vehicle_web.war");
            // The class files
            bb_stateful_concurrency_accesstimeout_annotated_ejblitejsp_vehicle_web.addClasses(
            ...
            com.sun.ts.tests.ejb30.bb.session.stateful.concurrency.accesstimeout.annotated.EJBLiteJSPTag.class,
            ...
            bb_stateful_concurrency_accesstimeout_annotated_ejblitejsp_vehicle_web.addClass("com.sun.ts.tests.ejb30.lite.stateful.concurrency.accesstimeout.common.ClientBase$1.class");
            bb_stateful_concurrency_accesstimeout_annotated_ejblitejsp_vehicle_web.addClass("com.sun.ts.tests.ejb30.lite.stateful.concurrency.accesstimeout.common.ClientBase$2.class");
            bb_stateful_concurrency_accesstimeout_annotated_ejblitejsp_vehicle_web.addClass("com.sun.ts.tests.ejb30.lite.stateful.concurrency.accesstimeout.common.ClientBase$3.class");
            bb_stateful_concurrency_accesstimeout_annotated_ejblitejsp_vehicle_web.addClass("com.sun.ts.tests.ejb30.lite.stateful.concurrency.accesstimeout.common.ClientBase$4.class");
            bb_stateful_concurrency_accesstimeout_annotated_ejblitejsp_vehicle_web.addClass("com.sun.ts.tests.ejb30.lite.stateful.concurrency.accesstimeout.common.ClientBase$5.class");
            bb_stateful_concurrency_accesstimeout_annotated_ejblitejsp_vehicle_web.addClass("com.sun.ts.tests.ejb30.lite.stateful.concurrency.accesstimeout.common.ClientBase$6.class");
            bb_stateful_concurrency_accesstimeout_annotated_ejblitejsp_vehicle_web.addClass("com.sun.ts.tests.ejb30.lite.stateful.concurrency.accesstimeout.common.ClientBase$7.class");

            // The web.xml descriptor
            URL warResURL = JsfClient.class.getResource("/vehicle/ejblitejsp/ejblitejsp_vehicle_web.xml");
            if(warResURL != null) {
              bb_stateful_concurrency_accesstimeout_annotated_ejblitejsp_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = JsfClient.class.getResource("//vehicle/ejblitejsp/ejblitejsp_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
              bb_stateful_concurrency_accesstimeout_annotated_ejblitejsp_vehicle_web.addAsWebInfResource(warResURL, "sun-web.xml");
            }
            ...
            if(warResURL != null) {
              bb_stateful_concurrency_accesstimeout_annotated_ejblitejsp_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/ejb-jar.xml");
            }
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/bb/session/stateful/concurrency/accesstimeout/annotated/ejblitejsp.tld");
            if(warResURL != null) {
              bb_stateful_concurrency_accesstimeout_annotated_ejblitejsp_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/tlds/ejblitejsp.tld");
            }
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/common/vehicle/ejblitejsp/ejblitejsp.tld");
            if(warResURL != null) {
              bb_stateful_concurrency_accesstimeout_annotated_ejblitejsp_vehicle_web.addAsWebResource(warResURL, "/ejblitejsp.tld");
            }
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/common/vehicle/ejblitejsp/ejblitejsp_vehicle.jsp");
            if(warResURL != null) {
              bb_stateful_concurrency_accesstimeout_annotated_ejblitejsp_vehicle_web.addAsWebResource(warResURL, "/ejblitejsp_vehicle.jsp");
            }

           // Call the archive processor
           archiveProcessor.processWebArchive(bb_stateful_concurrency_accesstimeout_annotated_ejblitejsp_vehicle_web, JsfClient.class, warResURL);

        return bb_stateful_concurrency_accesstimeout_annotated_ejblitejsp_vehicle_web;
        }

...
public class ClientEjblitejspTest extends com.sun.ts.tests.ejb30.lite.async.singleton.metadata.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_async_singleton_metadata_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            ejblite_async_singleton_metadata_ejblitejsp_vehicle_web.addClass("com.sun.ts.tests.ejb30.lite.async.common.metadata.BeanClassLevel2BeanBase$1.class");
            ...
            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/async/singleton/metadata/ejblitejsp.tld");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_async_singleton_metadata_ejblitejsp_vehicle_web, Client.class, warResURL);

  ...
  public void test7() throws Exception {
    ...
    try {
      ...
      if (!ejbref.InRole(mgr_secrole_ref, props))
        throw new Exception("caller in role positive test failed");
      logMsg("caller in role positive test passed");
    } catch (Exception e) {
      throw new Exception(" tesn role positive failed:", e);
    }
  }
  ...
  public void test8() throws Exception {
    ...
    try {
      ...
      if (ejbref.InRole(admin_secrole_ref, props))
        throw new Exception("caller in role negative test failed");
      logMsg("caller in role negative test passed");
    } catch (Exception e) {
      throw new Exception("caller in role negative test failed:", e);
    }
  }
  ...
  public void test9() throws Exception {
    ...
    try {
      ...
      if (!ejbref.IsCallerB1(username))
        throw new Exception("first bean's getCallerPrincipal test failed");
      logMsg("first bean's getCallerPrincipal test passed");
    } catch (Exception e) {
      throw new Exception("first bean's getCallerPrincipal test failed:", e);
    }
  }
  ...
  public void test10() throws Exception {
    ...
    try {
      ...
      if (ejbref.IsCallerB2(username, props))
        throw new Exception("second bean's getCallerPrincipal test failed");
      ...
      throw new Exception("second bean's getCallerPrincipal test failed:", e);
    }
  }

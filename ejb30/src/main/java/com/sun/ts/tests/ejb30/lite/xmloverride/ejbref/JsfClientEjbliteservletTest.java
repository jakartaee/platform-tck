...
public class JsfClientEjbliteservletTest extends com.sun.ts.tests.ejb30.lite.xmloverride.ejbref.JsfClient {
    static final String VEHICLE_ARCHIVE = "ejblite_xmloverride_ejbref_ejbliteservlet_vehicle";
        ...
        */
        ...
        // War
            ...
            WebArchive ejblite_xmloverride_ejbref_ejbliteservlet_vehicle_web = ShrinkWrap.create(WebArchive.class, "ejblite_xmloverride_ejbref_ejbliteservlet_vehicle_web.war");
            // The class files
            ejblite_xmloverride_ejbref_ejbliteservlet_vehicle_web.addClasses(
            ...
            com.sun.ts.tests.ejb30.lite.xmloverride.ejbref.EJBLiteServletVehicle.class,
            ...
            if(warResURL != null) {
              ejblite_xmloverride_ejbref_ejbliteservlet_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = JsfClient.class.getResource("/ejbliteservlet_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
              ejblite_xmloverride_ejbref_ejbliteservlet_vehicle_web.addAsWebInfResource(warResURL, "sun-web.xml");
            }
           ...
           archiveProcessor.processWebArchive(ejblite_xmloverride_ejbref_ejbliteservlet_vehicle_web, JsfClient.class, warResURL);

        return ejblite_xmloverride_ejbref_ejbliteservlet_vehicle_web;
        }

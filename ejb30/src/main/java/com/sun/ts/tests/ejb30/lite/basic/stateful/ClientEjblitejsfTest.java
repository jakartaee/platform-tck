...
import com.sun.ts.tests.ejb30.lite.basic.stateful.Client;
import java.net.URL;
...
public class ClientEjblitejsfTest extends com.sun.ts.tests.ejb30.lite.basic.stateful.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_basic_stateful_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/basic/stateful/beans.xml");
            if(warResURL != null) {
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/basic/stateful/faces-config.xml");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_basic_stateful_ejblitejsf_vehicle_web, Client.class, warResURL);

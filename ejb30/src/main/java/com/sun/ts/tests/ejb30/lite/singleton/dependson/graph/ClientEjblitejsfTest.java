...
public class ClientEjblitejsfTest extends com.sun.ts.tests.ejb30.lite.singleton.dependson.graph.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_singleton_dependson_graph_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/singleton/dependson/graph/beans.xml");
            if(warResURL != null) {
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/singleton/dependson/graph/faces-config.xml");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_singleton_dependson_graph_ejblitejsf_vehicle_web, Client.class, warResURL);

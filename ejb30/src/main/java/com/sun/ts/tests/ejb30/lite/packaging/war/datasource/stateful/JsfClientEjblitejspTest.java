...
public class JsfClientEjblitejspTest extends com.sun.ts.tests.ejb30.lite.packaging.war.datasource.stateful.JsfClient {
    static final String VEHICLE_ARCHIVE = "ejblite_packaging_war_datasource_stateful_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            WebArchive ejblite_packaging_war_datasource_stateful_ejblitejsp_vehicle_web = ShrinkWrap.create(WebArchive.class, "ejblite_packaging_war_datasource_stateful_ejblitejsp_vehicle_web.war");
            // The class files
            ejblite_packaging_war_datasource_stateful_ejblitejsp_vehicle_web.addClasses(
            ...
            com.sun.ts.tests.ejb30.lite.packaging.war.datasource.stateful.EJBLiteJSPTag.class,
            ...
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/lite/packaging/war/datasource/stateful/ejblitejsp.tld");
            if(warResURL != null) {
            ...
            if(warResURL != null) {
              ejblite_packaging_war_datasource_stateful_ejblitejsp_vehicle_web.addAsWebResource(warResURL, "/ejblitejsp_vehicle.jsp");
            }

           // Call the archive processor
           archiveProcessor.processWebArchive(ejblite_packaging_war_datasource_stateful_ejblitejsp_vehicle_web, JsfClient.class, warResURL);

        return ejblite_packaging_war_datasource_stateful_ejblitejsp_vehicle_web;
        }

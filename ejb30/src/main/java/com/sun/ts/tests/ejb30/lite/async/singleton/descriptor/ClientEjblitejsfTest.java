...
public class ClientEjblitejsfTest extends com.sun.ts.tests.ejb30.lite.async.singleton.descriptor.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_async_singleton_descriptor_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/async/singleton/descriptor/beans.xml");
            if(warResURL != null) {
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/async/singleton/descriptor/faces-config.xml");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_async_singleton_descriptor_ejblitejsf_vehicle_web, Client.class, warResURL);

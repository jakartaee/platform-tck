    ...
    /**
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/tx/session/stateless/cm/inheritance/annotated/tx_stateless_inheritance_annotated_web.xml");
            if(warResURL != null) {
              tx_stateless_inheritance_annotated_web.addAsWebResource(warResURL, "//tx_stateless_inheritance_annotated_web.xml");
            }
        ...
        // Ejb
            ...
            URL ejbResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/tx/session/stateless/cm/inheritance/annotated/tx_stateless_inheritance_annotated_ejb.xml");
            if(ejbResURL != null) {
              tx_stateless_inheritance_annotated_ejb.addAsManifestResource(ejbResURL, "ejb-jar.xml");
            }
            // The sun-ejb-jar.xml file
            ejbResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/tx/session/stateless/cm/inheritance/annotated/tx_stateless_inheritance_annotated_ejb.jar.sun-ejb-jar.xml");
            if(ejbResURL != null) {
        ...
        // Ear
            ...
            URL earResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/tx/session/stateless/cm/inheritance/annotated/");
            if(earResURL != null) {
              tx_stateless_inheritance_annotated_ear.addAsManifestResource(earResURL, "application.xml");
            }
            // The sun-application.xml descriptor
            earResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/tx/session/stateless/cm/inheritance/annotated/.ear.sun-application.xml");
            if(earResURL != null) {

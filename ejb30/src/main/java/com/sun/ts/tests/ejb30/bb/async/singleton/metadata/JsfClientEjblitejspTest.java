...
public class JsfClientEjblitejspTest extends com.sun.ts.tests.ejb30.bb.async.singleton.metadata.JsfClient {
    static final String VEHICLE_ARCHIVE = "ejbbb_async_singleton_metadata_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/bb/async/singleton/metadata/ejblitejsp.tld");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejbbb_async_singleton_metadata_ejblitejsp_vehicle_web, JsfClient.class, warResURL);

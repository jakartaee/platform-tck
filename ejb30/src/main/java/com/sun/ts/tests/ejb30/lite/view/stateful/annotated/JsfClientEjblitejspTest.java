...
public class JsfClientEjblitejspTest extends com.sun.ts.tests.ejb30.lite.view.stateful.annotated.JsfClient {
    static final String VEHICLE_ARCHIVE = "ejblite_view_stateful_annotated_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            WebArchive ejblite_view_stateful_annotated_ejblitejsp_vehicle_web = ShrinkWrap.create(WebArchive.class, "ejblite_view_stateful_annotated_ejblitejsp_vehicle_web.war");
            // The class files
            ejblite_view_stateful_annotated_ejblitejsp_vehicle_web.addClasses(
            ...
            com.sun.ts.tests.ejb30.lite.view.stateful.annotated.EJBLiteJSPTag.class,
            ...
            if(warResURL != null) {
              ejblite_view_stateful_annotated_ejblitejsp_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = JsfClient.class.getResource("//vehicle/ejblitejsp/ejblitejsp_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
              ejblite_view_stateful_annotated_ejblitejsp_vehicle_web.addAsWebInfResource(warResURL, "sun-web.xml");
            }

            // Any libraries added to the war

            // Web content
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/lite/view/stateful/annotated/ejblitejsp.tld");
            if(warResURL != null) {
              ejblite_view_stateful_annotated_ejblitejsp_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/tlds/ejblitejsp.tld");
            }
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/common/vehicle/ejblitejsp/ejblitejsp.tld");
            if(warResURL != null) {
              ejblite_view_stateful_annotated_ejblitejsp_vehicle_web.addAsWebResource(warResURL, "/ejblitejsp.tld");
            }
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/common/vehicle/ejblitejsp/ejblitejsp_vehicle.jsp");
            if(warResURL != null) {
              ejblite_view_stateful_annotated_ejblitejsp_vehicle_web.addAsWebResource(warResURL, "/ejblitejsp_vehicle.jsp");
            }

           // Call the archive processor
           archiveProcessor.processWebArchive(ejblite_view_stateful_annotated_ejblitejsp_vehicle_web, JsfClient.class, warResURL);

        return ejblite_view_stateful_annotated_ejblitejsp_vehicle_web;
        }

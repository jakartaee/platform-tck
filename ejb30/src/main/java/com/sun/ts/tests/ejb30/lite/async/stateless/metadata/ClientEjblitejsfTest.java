...
public class ClientEjblitejsfTest extends com.sun.ts.tests.ejb30.lite.async.stateless.metadata.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_async_stateless_metadata_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            ejblite_async_stateless_metadata_ejblitejsf_vehicle_web.addClass("com.sun.ts.tests.ejb30.lite.async.common.metadata.BeanClassLevel2BeanBase$1.class");
            ...
            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/async/stateless/metadata/beans.xml");
            if(warResURL != null) {
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/async/stateless/metadata/faces-config.xml");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_async_stateless_metadata_ejblitejsf_vehicle_web, Client.class, warResURL);

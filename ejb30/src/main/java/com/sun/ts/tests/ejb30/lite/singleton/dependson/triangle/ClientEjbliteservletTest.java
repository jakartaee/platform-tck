...
public class ClientEjbliteservletTest extends com.sun.ts.tests.ejb30.lite.singleton.dependson.triangle.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_singleton_dependson_triangle_ejbliteservlet_vehicle";
        ...
        */
        ...
        // War
           ...
           archiveProcessor.processWebArchive(ejblite_singleton_dependson_triangle_ejbliteservlet_vehicle_web, Client.class, warResURL);

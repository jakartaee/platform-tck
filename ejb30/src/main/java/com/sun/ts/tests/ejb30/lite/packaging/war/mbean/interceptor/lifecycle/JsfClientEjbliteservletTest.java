...
public class JsfClientEjbliteservletTest extends com.sun.ts.tests.ejb30.lite.packaging.war.mbean.interceptor.lifecycle.JsfClient {
    static final String VEHICLE_ARCHIVE = "ejblite_packaging_war_mbean_interceptor_lifecycle_ejbliteservlet_vehicle";
        ...
        */
        ...
        // War
           ...
           archiveProcessor.processWebArchive(ejblite_packaging_war_mbean_interceptor_lifecycle_ejbliteservlet_vehicle_web, JsfClient.class, warResURL);

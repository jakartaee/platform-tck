...
public class ClientEjblitejspTest extends com.sun.ts.tests.ejb30.bb.session.stateful.concurrency.accesstimeout.annotated.Client {
    static final String VEHICLE_ARCHIVE = "bb_stateful_concurrency_accesstimeout_annotated_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/bb/session/stateful/concurrency/accesstimeout/annotated/ejblitejsp.tld");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(bb_stateful_concurrency_accesstimeout_annotated_ejblitejsp_vehicle_web, Client.class, warResURL);

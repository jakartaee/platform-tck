...
import com.sun.ts.tests.ejb30.lite.appexception.singleton.annotated.Client;
import java.net.URL;
...
public class ClientEjblitejsfTest extends com.sun.ts.tests.ejb30.lite.appexception.singleton.annotated.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_appexception_singleton_annotated_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/appexception/singleton/annotated/beans.xml");
            if(warResURL != null) {
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/appexception/singleton/annotated/faces-config.xml");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_appexception_singleton_annotated_ejblitejsf_vehicle_web, Client.class, warResURL);

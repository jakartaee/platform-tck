...
public class ClientEjblitejsfTest extends com.sun.ts.tests.ejb30.lite.basic.singleton.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_basic_singleton_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/basic/singleton/beans.xml");
            if(warResURL != null) {
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/basic/singleton/faces-config.xml");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_basic_singleton_ejblitejsf_vehicle_web, Client.class, warResURL);

...
public class JsfClientEjblitejsfTest extends com.sun.ts.tests.ejb30.lite.xmloverride.ejbref.JsfClient {
    static final String VEHICLE_ARCHIVE = "ejblite_xmloverride_ejbref_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/lite/xmloverride/ejbref/beans.xml");
            if(warResURL != null) {
            ...
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/lite/xmloverride/ejbref/faces-config.xml");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_xmloverride_ejbref_ejblitejsf_vehicle_web, JsfClient.class, warResURL);

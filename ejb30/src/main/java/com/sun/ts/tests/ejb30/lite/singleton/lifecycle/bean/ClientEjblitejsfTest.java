...
import com.sun.ts.tests.ejb30.lite.singleton.lifecycle.bean.Client;
import java.net.URL;
...
public class ClientEjblitejsfTest extends com.sun.ts.tests.ejb30.lite.singleton.lifecycle.bean.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_singleton_lifecycle_bean_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            WebArchive ejblite_singleton_lifecycle_bean_ejblitejsf_vehicle_web = ShrinkWrap.create(WebArchive.class, "ejblite_singleton_lifecycle_bean_ejblitejsf_vehicle_web.war");
            // The class files
            ejblite_singleton_lifecycle_bean_ejblitejsf_vehicle_web.addClasses(
            ...
            ejblite_singleton_lifecycle_bean_ejblitejsf_vehicle_web.addClass("com.sun.ts.tests.ejb30.lite.singleton.lifecycle.bean.Client$1.class");
            ejblite_singleton_lifecycle_bean_ejblitejsf_vehicle_web.addClass("com.sun.ts.tests.ejb30.lite.singleton.lifecycle.bean.JsfClient$1.class");

            // The web.xml descriptor
            URL warResURL = Client.class.getResource("/com/sun/ts/tests/common/vehicle/ejblitejsf/ejblitejsf_vehicle_web.xml");
            if(warResURL != null) {
              ejblite_singleton_lifecycle_bean_ejblitejsf_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            ...
            if(warResURL != null) {
              ejblite_singleton_lifecycle_bean_ejblitejsf_vehicle_web.addAsWebInfResource(warResURL, "sun-web.xml");
            }

            // Any libraries added to the war

            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/singleton/lifecycle/bean/beans.xml");
            if(warResURL != null) {
              ejblite_singleton_lifecycle_bean_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/beans.xml");
            }
            ...
            if(warResURL != null) {
              ejblite_singleton_lifecycle_bean_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/ejblitejsf_vehicle_web.xml");
            }
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/singleton/lifecycle/bean/faces-config.xml");
            if(warResURL != null) {
              ejblite_singleton_lifecycle_bean_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/faces-config.xml");
            }
            ...
            if(warResURL != null) {
              ejblite_singleton_lifecycle_bean_ejblitejsf_vehicle_web.addAsWebResource(warResURL, "/ejblitejsf_vehicle.xhtml");
            }

           // Call the archive processor
           archiveProcessor.processWebArchive(ejblite_singleton_lifecycle_bean_ejblitejsf_vehicle_web, Client.class, warResURL);

        return ejblite_singleton_lifecycle_bean_ejblitejsf_vehicle_web;
        }

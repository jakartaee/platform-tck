...
public class ClientEjblitejsfTest extends com.sun.ts.tests.ejb30.lite.tx.cm.stateful.sessionsync.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_tx_cm_stateful_sessionsync_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/tx/cm/stateful/sessionsync/beans.xml");
            if(warResURL != null) {
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/tx/cm/stateful/sessionsync/faces-config.xml");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_tx_cm_stateful_sessionsync_ejblitejsf_vehicle_web, Client.class, warResURL);

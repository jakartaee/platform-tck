...
public class JsfClientEjblitejspTest extends com.sun.ts.tests.ejb30.lite.view.equals.JsfClient {
    static final String VEHICLE_ARCHIVE = "ejblite_view_equals_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/lite/view/equals/ejblitejsp.tld");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_view_equals_ejblitejsp_vehicle_web, JsfClient.class, warResURL);

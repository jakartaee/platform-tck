...
import com.sun.ts.tests.ejb30.bb.async.stateless.metadata.JsfClient;
import java.net.URL;
...
public class JsfClientEjblitejspTest extends com.sun.ts.tests.ejb30.bb.async.stateless.metadata.JsfClient {
    static final String VEHICLE_ARCHIVE = "ejbbb_async_stateless_metadata_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            WebArchive ejbbb_async_stateless_metadata_ejblitejsp_vehicle_web = ShrinkWrap.create(WebArchive.class, "ejbbb_async_stateless_metadata_ejblitejsp_vehicle_web.war");
            // The class files
            ejbbb_async_stateless_metadata_ejblitejsp_vehicle_web.addClasses(
            ...
            com.sun.ts.tests.ejb30.bb.async.stateless.metadata.EJBLiteJSPTag.class,
            ...
            ejbbb_async_stateless_metadata_ejblitejsp_vehicle_web.addClass("com.sun.ts.tests.ejb30.bb.async.common.metadata.BeanClassLevel2BeanBase$1.class");

            // The web.xml descriptor
            URL warResURL = JsfClient.class.getResource("/vehicle/ejblitejsp/ejblitejsp_vehicle_web.xml");
            if(warResURL != null) {
              ejbbb_async_stateless_metadata_ejblitejsp_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = JsfClient.class.getResource("//vehicle/ejblitejsp/ejblitejsp_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
              ejbbb_async_stateless_metadata_ejblitejsp_vehicle_web.addAsWebInfResource(warResURL, "sun-web.xml");
            }

            // Any libraries added to the war

            // Web content
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/bb/async/stateless/metadata/ejblitejsp.tld");
            if(warResURL != null) {
              ejbbb_async_stateless_metadata_ejblitejsp_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/tlds/ejblitejsp.tld");
            }
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/common/vehicle/ejblitejsp/ejblitejsp.tld");
            if(warResURL != null) {
              ejbbb_async_stateless_metadata_ejblitejsp_vehicle_web.addAsWebResource(warResURL, "/ejblitejsp.tld");
            }
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/common/vehicle/ejblitejsp/ejblitejsp_vehicle.jsp");
            if(warResURL != null) {
              ejbbb_async_stateless_metadata_ejblitejsp_vehicle_web.addAsWebResource(warResURL, "/ejblitejsp_vehicle.jsp");
            }

           // Call the archive processor
           archiveProcessor.processWebArchive(ejbbb_async_stateless_metadata_ejblitejsp_vehicle_web, JsfClient.class, warResURL);

        return ejbbb_async_stateless_metadata_ejblitejsp_vehicle_web;
        }

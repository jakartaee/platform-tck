...
public class ClientEjblitejspTest extends com.sun.ts.tests.ejb30.lite.singleton.lifecycle.bean.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_singleton_lifecycle_bean_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            WebArchive ejblite_singleton_lifecycle_bean_ejblitejsp_vehicle_web = ShrinkWrap.create(WebArchive.class, "ejblite_singleton_lifecycle_bean_ejblitejsp_vehicle_web.war");
            // The class files
            ejblite_singleton_lifecycle_bean_ejblitejsp_vehicle_web.addClasses(
            ...
            com.sun.ts.tests.ejb30.lite.singleton.lifecycle.bean.EJBLiteJSPTag.class,
            com.sun.ts.tests.ejb30.common.lite.EJBLiteJsfClientBase.class,
            com.sun.ts.tests.ejb30.common.helper.ServiceLocator.class,
            com.sun.ts.tests.ejb30.lite.singleton.lifecycle.bean.C2SingletonIF.class,
            com.sun.ts.lib.harness.EETest.SetupException.class
            );
            ejblite_singleton_lifecycle_bean_ejblitejsp_vehicle_web.addClass("com.sun.ts.tests.ejb30.lite.singleton.lifecycle.bean.Client$1.class");
            ejblite_singleton_lifecycle_bean_ejblitejsp_vehicle_web.addClass("com.sun.ts.tests.ejb30.lite.singleton.lifecycle.bean.JsfClient$1.class");

            // The web.xml descriptor
            URL warResURL = Client.class.getResource("/vehicle/ejblitejsp/ejblitejsp_vehicle_web.xml");
            if(warResURL != null) {
              ejblite_singleton_lifecycle_bean_ejblitejsp_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = Client.class.getResource("//vehicle/ejblitejsp/ejblitejsp_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
              ejblite_singleton_lifecycle_bean_ejblitejsp_vehicle_web.addAsWebInfResource(warResURL, "sun-web.xml");
            }

            // Any libraries added to the war

            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/singleton/lifecycle/bean/ejblitejsp.tld");
            if(warResURL != null) {
              ejblite_singleton_lifecycle_bean_ejblitejsp_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/tlds/ejblitejsp.tld");
            }
            warResURL = Client.class.getResource("/com/sun/ts/tests/common/vehicle/ejblitejsp/ejblitejsp.tld");
            if(warResURL != null) {
              ejblite_singleton_lifecycle_bean_ejblitejsp_vehicle_web.addAsWebResource(warResURL, "/ejblitejsp.tld");
            }
            warResURL = Client.class.getResource("/com/sun/ts/tests/common/vehicle/ejblitejsp/ejblitejsp_vehicle.jsp");
            if(warResURL != null) {
              ejblite_singleton_lifecycle_bean_ejblitejsp_vehicle_web.addAsWebResource(warResURL, "/ejblitejsp_vehicle.jsp");
            }

           // Call the archive processor
           archiveProcessor.processWebArchive(ejblite_singleton_lifecycle_bean_ejblitejsp_vehicle_web, Client.class, warResURL);

        return ejblite_singleton_lifecycle_bean_ejblitejsp_vehicle_web;
        }

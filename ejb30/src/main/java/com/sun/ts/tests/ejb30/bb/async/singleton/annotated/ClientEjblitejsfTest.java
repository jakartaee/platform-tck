...
public class ClientEjblitejsfTest extends com.sun.ts.tests.ejb30.bb.async.singleton.annotated.Client {
    static final String VEHICLE_ARCHIVE = "ejbbb_async_singleton_annotated_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/bb/async/singleton/annotated/beans.xml");
            if(warResURL != null) {
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/bb/async/singleton/annotated/faces-config.xml");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejbbb_async_singleton_annotated_ejblitejsf_vehicle_web, Client.class, warResURL);

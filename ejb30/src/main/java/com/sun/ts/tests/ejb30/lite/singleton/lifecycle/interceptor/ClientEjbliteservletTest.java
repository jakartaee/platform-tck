...
import com.sun.ts.tests.ejb30.lite.singleton.lifecycle.interceptor.Client;
import java.net.URL;
...
public class ClientEjbliteservletTest extends com.sun.ts.tests.ejb30.lite.singleton.lifecycle.interceptor.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_singleton_lifecycle_interceptor_ejbliteservlet_vehicle";
        ...
        */
        ...
        // War
           ...
           archiveProcessor.processWebArchive(ejblite_singleton_lifecycle_interceptor_ejbliteservlet_vehicle_web, Client.class, warResURL);

...
public class JsfClientEjblitejspTest extends com.sun.ts.tests.ejb30.lite.async.stateless.metadata.JsfClient {
    static final String VEHICLE_ARCHIVE = "ejblite_async_stateless_metadata_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/lite/async/stateless/metadata/ejblitejsp.tld");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_async_stateless_metadata_ejblitejsp_vehicle_web, JsfClient.class, warResURL);

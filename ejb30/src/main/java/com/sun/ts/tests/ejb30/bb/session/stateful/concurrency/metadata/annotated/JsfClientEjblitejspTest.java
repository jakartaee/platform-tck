...
public class JsfClientEjblitejspTest extends com.sun.ts.tests.ejb30.bb.session.stateful.concurrency.metadata.annotated.JsfClient {
    static final String VEHICLE_ARCHIVE = "bb_stateful_concurrency_metadata_annotated_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/bb/session/stateful/concurrency/metadata/annotated/ejblitejsp.tld");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(bb_stateful_concurrency_metadata_annotated_ejblitejsp_vehicle_web, JsfClient.class, warResURL);

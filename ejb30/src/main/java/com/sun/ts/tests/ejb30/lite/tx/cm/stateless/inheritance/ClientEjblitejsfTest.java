...
import com.sun.ts.tests.ejb30.lite.tx.cm.stateless.inheritance.Client;
import java.net.URL;
...
public class ClientEjblitejsfTest extends com.sun.ts.tests.ejb30.lite.tx.cm.stateless.inheritance.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_tx_cm_stateless_inheritance_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/tx/cm/stateless/inheritance/beans.xml");
            if(warResURL != null) {
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/tx/cm/stateless/inheritance/faces-config.xml");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_tx_cm_stateless_inheritance_ejblitejsf_vehicle_web, Client.class, warResURL);

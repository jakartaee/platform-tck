...
public class ClientEjblitejsfTest extends com.sun.ts.tests.ejb30.bb.async.stateful.descriptor.Client {
    static final String VEHICLE_ARCHIVE = "ejbbb_async_stateful_descriptor_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/bb/async/stateful/descriptor/beans.xml");
            if(warResURL != null) {
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/bb/async/stateful/descriptor/faces-config.xml");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejbbb_async_stateful_descriptor_ejblitejsf_vehicle_web, Client.class, warResURL);

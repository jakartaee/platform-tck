...
public class JsfClientEjblitejspTest extends com.sun.ts.tests.ejb30.lite.stateful.concurrency.metadata.annotated.JsfClient {
    static final String VEHICLE_ARCHIVE = "ejblite_stateful_concurrency_metadata_annotated_ejblitejsp_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = JsfClient.class.getResource("/com/sun/ts/tests/ejb30/lite/stateful/concurrency/metadata/annotated/ejblitejsp.tld");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_stateful_concurrency_metadata_annotated_ejblitejsp_vehicle_web, JsfClient.class, warResURL);

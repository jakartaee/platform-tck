...
public class JsfClientEjbliteservletTest extends com.sun.ts.tests.ejb30.lite.async.stateless.annotated.JsfClient {
    static final String VEHICLE_ARCHIVE = "ejblite_async_stateless_annotated_ejbliteservlet_vehicle";
        ...
        */
        ...
        // War
            ...
            WebArchive ejblite_async_stateless_annotated_ejbliteservlet_vehicle_web = ShrinkWrap.create(WebArchive.class, "ejblite_async_stateless_annotated_ejbliteservlet_vehicle_web.war");
            // The class files
            ejblite_async_stateless_annotated_ejbliteservlet_vehicle_web.addClasses(
            com.sun.ts.tests.ejb30.common.helper.TestFailedException.class,
            com.sun.ts.tests.ejb30.lite.async.stateless.annotated.AsyncAnnotatedMethodsBean.class,
            com.sun.ts.lib.harness.EETest.Fault.class,
            com.sun.ts.tests.ejb30.lite.async.stateless.annotated.EJBLiteServletVehicle.class,
            ...
            ejblite_async_stateless_annotated_ejbliteservlet_vehicle_web.addClass("com.sun.ts.tests.ejb30.lite.async.common.annotated.AsyncAnnotatedMethodsBeanBase$1.class");

            // The web.xml descriptor
            URL warResURL = JsfClient.class.getResource("ejbliteservlet_vehicle_web.xml");
            if(warResURL != null) {
              ejblite_async_stateless_annotated_ejbliteservlet_vehicle_web.addAsWebInfResource(warResURL, "web.xml");
            }
            // The sun-web.xml descriptor
            warResURL = JsfClient.class.getResource("/ejbliteservlet_vehicle_web.war.sun-web.xml");
            if(warResURL != null) {
              ejblite_async_stateless_annotated_ejbliteservlet_vehicle_web.addAsWebInfResource(warResURL, "sun-web.xml");
            }
            ...
            if(warResURL != null) {
              ejblite_async_stateless_annotated_ejbliteservlet_vehicle_web.addAsWebResource(warResURL, "/WEB-INF/ejbliteservlet_vehicle_web.xml");
            }

           // Call the archive processor
           archiveProcessor.processWebArchive(ejblite_async_stateless_annotated_ejbliteservlet_vehicle_web, JsfClient.class, warResURL);

        return ejblite_async_stateless_annotated_ejbliteservlet_vehicle_web;
        }

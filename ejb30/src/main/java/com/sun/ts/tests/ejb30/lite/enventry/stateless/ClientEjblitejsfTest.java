...
public class ClientEjblitejsfTest extends com.sun.ts.tests.ejb30.lite.enventry.stateless.Client {
    static final String VEHICLE_ARCHIVE = "ejblite_enventry_stateless_ejblitejsf_vehicle";
        ...
        */
        ...
        // War
            ...
            // Web content
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/enventry/stateless/beans.xml");
            if(warResURL != null) {
            ...
            warResURL = Client.class.getResource("/com/sun/ts/tests/ejb30/lite/enventry/stateless/faces-config.xml");
            if(warResURL != null) {
           ...
           archiveProcessor.processWebArchive(ejblite_enventry_stateless_ejblitejsf_vehicle_web, Client.class, warResURL);

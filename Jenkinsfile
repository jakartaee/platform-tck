...
default_tcks=["caj", "concurrency", "connector", "el", "jacc", "jaspic", "jaxws", "jms", "jpa", "jsp", "jstl", "jta", "saaj", "securityapi", "servlet",  "websocket"]
...
"""
  ...
  parameters {
    ...
    string(name: 'standalone_tcks', defaultValue: 'caj concurrency connector el jacc jaspic jaxws jms jpa jsp jstl jta saaj securityapi servlet websocket', 

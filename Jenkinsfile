...
default_tcks=["caj", "connector", "el", "jacc", "jaspic", "jaxws", "jms", "jpa", "jsp", "jstl", "jta", "saaj", "securityapi", "servlet",  "websocket"]
...
"""
  ...
  parameters {
    ...
    string(name: 'standalone_tcks', defaultValue: 'caj connector el jacc jaspic jaxws jms jpa jsp jstl jta saaj securityapi servlet websocket', 

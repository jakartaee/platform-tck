...
public class JAXRSClientIT extends JAXRSCommonClient {
  ...
  public static WebArchive createDeployment() throws IOException {
    ...
    archive.addAsWebInfResource(JAXRSClientIT.class.getPackage(), "jaxrs_platform_servletapp2_web.xml", "web.xml"); //can use if the web.xml.template doesn't need to be modified.    
    return archive;

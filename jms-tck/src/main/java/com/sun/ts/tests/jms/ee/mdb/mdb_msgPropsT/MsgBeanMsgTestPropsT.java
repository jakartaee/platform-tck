...
public class MsgBeanMsgTestPropsT implements MessageDrivenBean, MessageListener {
	...
	private static final Logger logger = (Logger) System.getLogger(MsgBeanMsgTestPropsT.class.getName());

	public MsgBeanMsgTestPropsT() {
		logger.log(Logger.Level.TRACE, "@MsgBeanMsgTestPropsT()!");
	};

	public void ejbCreate() {
		logger.log(Logger.Level.TRACE, "jms.ee.mdb.mdb_msgPropsT  - @MsgBeanMsgTestPropsT-ejbCreate() !!");
		try {
	...
	public void onMessage(Message msg) {
		...
		logger.log(Logger.Level.TRACE, "from jms.ee.mdb.mdb_msgPropsT @onMessage!" + msg);
	...
	private void msgPropertiesTTest(jakarta.jms.Message msg) {
		...
		try {
			...
			if (b != false) {
				logger.log(Logger.Level.TRACE, "Error: should havereceived false for getBooleanProperty");
				pass = false;
			}
			// try {
			// boolean value = messageReceived.getBooleanProperty("TESTDUMMY");
			// logger.log(Logger.Level.INFO,"Error: NullPointerException should have
			// occurred for
			// getBooleanProperty");
			// pass = false;
	...
	public void setMessageDrivenContext(MessageDrivenContext mdc) {
		logger.log(Logger.Level.TRACE,
				"jms.ee.mdb.mdb_msgPropsT  In MsgBeanMsgTestPropsT::setMessageDrivenContext()!!");
		this.mdc = mdc;
	}

	public void ejbRemove() {
		logger.log(Logger.Level.TRACE, "jms.ee.mdb.mdb_msgPropsT  In MsgBeanMsgTestPropsT::remove()!!");
	}
}

...
public class MsgBeanForTopic implements MessageDrivenBean, MessageListener {
	...
	private static final Logger logger = (Logger) System.getLogger(MsgBeanForTopic.class.getName());

	public MsgBeanForTopic() {
		logger.log(Logger.Level.TRACE, "In MsgBeanForTopic::MsgBeanForTopic()!");
	};

	public void ejbCreate() {
		logger.log(Logger.Level.TRACE, "In MsgBeanForTopic::ejbCreate() !!");
		p = new Properties();
	}
	...
	public void setMessageDrivenContext(MessageDrivenContext mdc) {
		logger.log(Logger.Level.TRACE, "In MsgBeanForTopicForQueue::setMessageDrivenContext()!!");
		this.mdc = mdc;
	}

	public void ejbRemove() {
		logger.log(Logger.Level.TRACE, "In MsgBeanForTopicForQueue::remove()!!");
	}
}

...
public class Client extends EETest {
  ...
  public void testDatasource() throws Exception {
    try {
      ...
      if (!pass) {
        throw new Exception("testDatasource failed");
      }
    } catch (Exception e) {
      logErr("Caught unexpected exception: " + e.getMessage());
      throw new Exception("testDatasource failed", e);
    }
  }
  ...
  public void testSession() throws Exception {
    try {
      ...
      if (!pass) {
        throw new Exception("testSession failed");
      }
    } catch (Exception e) {
      logErr("Caught unexpected exception: " + e.getMessage());
      throw new Exception("testSession failed", e);
    }
  }
  ...
  public void testURL() throws Exception {
    try {
      ...
      if (!pass) {
        throw new Exception("testURL failed");
      }
    } catch (Exception e) {
      logErr("Caught unexpected exception: " + e.getMessage());
      throw new Exception("testURL failed", e);
    }
  }
  ...
  public void testQueue() throws Exception {
    try {
      ...
      logErr("Caught unexpected exception: " + e.getMessage());
      throw new Exception("testQueue failed", e);
    }
  }
  ...
  public void testTopic() throws Exception {
    try {
      ...
      if (!pass) {
        throw new Exception("testTopic failed");
      }
    } catch (Exception e) {
      logErr("Caught unexpected exception: " + e.getMessage());
      throw new Exception("testTopic failed", e);
    }
  }

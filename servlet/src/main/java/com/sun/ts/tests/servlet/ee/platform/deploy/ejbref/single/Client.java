...
package com.sun.ts.tests.servlet.ee.platform.deploy.ejbref.single;
...
public class Client extends EETest {
  ...
  private static final String webAlias = "/servlet_ee_platform_deploy_ejbref_single_web/testDriver";
   ...
   *
   * @assertion_ids: Servlet:SPEC:116.2; JavaEE:SPEC:10117
   *
  ...
  public void testStateless() throws Exception {
    try {
      ...
      if (!pass) {
        throw new Exception("testStateless failed");
      }
    } catch (Exception e) {
      logErr("Caught unexpected exception: " + e.getMessage());
      throw new Exception("testStateless failed", e);
    }
  }
  ...
  public void testStateful() throws Exception {
    try {
      ...
      if (!pass) {
        throw new Exception("testStateful failed");
      }
    } catch (Exception e) {
      logErr("Caught unexpected exception: " + e.getMessage());
      throw new Exception("testStateful failed", e);
    }
  }
  ...
  public void testBMP() throws Exception {
    ...
    try {
      ...
      if (!pass) {
        throw new Exception("testBMP failed");
      }
    } catch (Exception e) {
      logErr("Caught unexpected exception: " + e.getMessage());
      throw new Exception("testBMP failed", e);
    }
  }
  ...
  public void testCMP11() throws Exception {
    try {
      ...
      if (!pass) {
        throw new Exception("testCMP11 failed");
      }
    } catch (Exception e) {
      logErr("Caught unexpected exception: " + e.getMessage());
      throw new Exception("testCMP11 failed", e);
    }
  }
  ...
  public void testCMP20() throws Exception {
    try {
      ...
      if (!pass) {
        throw new Exception("testCMP20 failed");
      }
    } catch (Exception e) {
      logErr("Caught unexpected exception: " + e.getMessage());
      throw new Exception("testCMP20 failed", e);
    }
  }

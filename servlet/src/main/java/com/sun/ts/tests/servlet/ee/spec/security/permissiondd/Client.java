...
public class Client extends ServiceEETest implements Serializable {
  ...
  public void ValidateCustomPerm() throws Exception {
    ...
    if (ii < 0) {
      throw new Exception("ValidateCustomPerm : FAILED");
    }
   ...
   *
   */
  public void ValidateCustomPermInLib() throws Exception {
    ...
    if (ii < 0) {
      throw new Exception("ValidateCustomPermInLib : FAILED");
    }
   ...
   */
  public void ValidateCustomPermFromAppServer() throws Exception {
    ...
    if (ii < 0) {
      throw new Exception("ValidateCustomPermFromAppServer : FAILED");
    }
   ...
   *                 permission as set within app server.
   */
  public void ValidateCustomPermFromAppServerInLib() throws Exception {
    ...
    if (ii < 0) {
      throw new Exception("ValidateCustomPermFromAppServerInLib : FAILED");
    }
  ...
  public void ValidateMissingPermFails() throws Exception {
    ...
    if (ii < 0) {
      throw new Exception("ValidateMissingPermFails : FAILED");
    }
   ...
   */
  public void ValidateMissingPermFailsInLib() throws Exception {
    ...
    if (ii < 0) {
      throw new Exception("ValidateMissingPermFailsInLib : FAILED");
    }
  ...
  public void ValidateRequiredPermSet() throws Exception {
    ...
    if (ii < 0) {
      throw new Exception("ValidateRequiredPermSet : FAILED");
    }
   ...
   * 
   */
  public void ValidateRequiredPermSetInLib() throws Exception {
    ...
    if (ii < 0) {
      throw new Exception("ValidateRequiredPermSetInLib : FAILED");
    }
  ...
  public void ValidateLocalGrantForCustomPerm() throws Exception {
    ...
    if (ii < 0) {
      throw new Exception("ValidateLocalGrantForCustomPerm : FAILED");
    }
   ...
   * 
   */
  public void ValidateLocalGrantForCustomPermInLib() throws Exception {
    ...
    if (ii < 0) {
      throw new Exception("ValidateLocalGrantForCustomPermInLib : FAILED");
    }
  ...
  public void ValidateRestrictedLocalPerm() throws Exception {
    ...
    if (ii < 0) {
      throw new Exception("ValidateRestrictedLocalPerm : FAILED");
    }
   ...
   *
   */
  public void ValidateRestrictedLocalPermInLib() throws Exception {
    ...
    if (ii < 0) {
      throw new Exception("ValidateRestrictedLocalPermInLib : FAILED");
    }
   ...
   *
   */
  public void ValidateLocalPermsInvalidNameInLib() throws Exception {
    ...
    if (ii < 0) {
      throw new Exception("ValidateLocalPermsInvalidNameInLib : FAILED");
    }
  ...
  public void ValidateLocalPermsInvalidName() throws Exception {
    ...
    if (ii < 0) {
      throw new Exception("ValidateLocalPermsInvalidName : FAILED");
    }
